...
pub type blockmap_func = Option::<
    unsafe extern "C" fn(*mut lua_State, int32_t, int32_t, *mut mobj_t) -> uint8_t,
>;
static mut search_opt: [*const libc::c_char; 4] = [
    b"objects\0" as *const u8 as *const libc::c_char,
    b"lines\0" as *const u8 as *const libc::c_char,
    b"polyobjs\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut blockfuncerror: boolean = false_0 as libc::c_int;
unsafe extern "C" fn lib_searchBlockmap_Objects(
    mut L: *mut lua_State,
    mut x: int32_t,
    mut y: int32_t,
    ...
    while !mobj.is_null() {
        ...
        if !(mobj == thing) {
            ...
            if lua_pcall(gL, 2 as libc::c_int, 1 as libc::c_int, 0 as libc::c_int) != 0 {
                if blockfuncerror == 0 || cv_debug & 0x800 as libc::c_int != 0 {
                    CONS_Alert(
                        CONS_WARNING,
                ...
                blockfuncerror = true_0 as libc::c_int;
            ...
            {
                P_SetTarget2(&mut bnext, 0 as *mut mobj_t);
                return (if P_MobjWasRemoved(thing) != 0 {
                    2 as libc::c_int
                } else {
                    1 as libc::c_int
                }) as uint8_t;
...
unsafe extern "C" fn lib_searchBlockmap_Lines(
    mut L: *mut lua_State,
    mut x: int32_t,
    mut y: int32_t,
    mut thing: *mut mobj_t,
        ...
        if (*po).validcount != validcount {
            ...
            while i < (*po).numLines {
                if !((**((*po).lines).offset(i as isize)).validcount == validcount) {
                    ...
                    LUA_PushUserdata(
                        L,
                        *((*po).lines).offset(i as isize) as *mut libc::c_void,
...
unsafe extern "C" fn lib_searchBlockmap_PolyObjs(
    mut L: *mut lua_State,
    mut x: int32_t,
    mut y: int32_t,
    mut thing: *mut mobj_t,
...
unsafe extern "C" fn lib_searchBlockmap(mut L: *mut lua_State) -> libc::c_int {
    let mut searchtype: libc::c_int = luaL_checkoption(
        L,
        1 as libc::c_int,
        b"objects\0" as *const u8 as *const libc::c_char,
        search_opt.as_ptr(),
    ...
    let mut retval: boolean = true_0 as libc::c_int;
    let mut funcret: uint8_t = 0 as libc::c_int as uint8_t;
    let mut searchFunc: blockmap_func = None;
    ...
    if n > 2 as libc::c_int {
        if n < 6 as libc::c_int {
            return luaL_error(
                L,
                b"arguments 4 to 6 not all given (expected 4 fixed-point integers)\0"
                    as *const u8 as *const libc::c_char,
            );
        }
        x1 = luaL_checknumber(L, 3 as libc::c_int);
        x2 = luaL_checknumber(L, 4 as libc::c_int);
        y1 = luaL_checknumber(L, 5 as libc::c_int);
        y2 = luaL_checknumber(L, 6 as libc::c_int);
    } else {
        let mut radius: fixed_t = (*mobj).radius
    ...
    xl = ((x1 - bmaporgx) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
        as int32_t;
    xh = ((x2 - bmaporgx) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
        as int32_t;
    yl = ((y1 - bmaporgy) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
        as int32_t;
    yh = ((y2 - bmaporgy) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
        as int32_t;
    if xl > xh {
        xl = 0 as libc::c_int;
    }
    ...
    blockfuncerror = false_0 as libc::c_int;
    ...
    while bx <= xh {
        by = yl;
        while by <= yh {
            funcret = searchFunc.expect("non-null function pointer")(L, bx, by, mobj);
            if funcret as libc::c_int == 2 as libc::c_int {
                lua_pushboolean(L, false_0 as libc::c_int);
                return 1 as libc::c_int;
            } else if funcret as libc::c_int == 1 as libc::c_int {
                retval = false_0 as libc::c_int;
            }
...
#[no_mangle]
pub unsafe extern "C" fn LUA_BlockmapLib(mut L: *mut lua_State) -> libc::c_int {
    lua_pushcclosure(
        L,
        Some(lib_searchBlockmap as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"searchBlockmap\0" as *const u8 as *const libc::c_char,
    );
