...
extern "C" {
    ...
    static mut t_cam_dist: fixed_t;
    static mut t_cam_height: fixed_t;
    static mut t_cam_rotate: fixed_t;
    static mut t_cam2_dist: fixed_t;
    static mut t_cam2_height: fixed_t;
    static mut t_cam2_rotate: fixed_t;
    ...
    fn P_FindPlayerTrigger(
        player: *mut player_t,
        sourceline: *mut line_t,
    ) -> *mut sector_t;
    fn P_IsPlayerValid(playernum: size_t) -> boolean;
    fn P_CanPlayerTrigger(playernum: size_t) -> boolean;
    ...
    fn P_RunTriggerLinedef(
        triggerline: *mut line_t,
        actor: *mut mobj_t,
        caller: *mut sector_t,
    );
    ...
    fn R_ClearLevelInterpolatorState(thinker: *mut thinker_t);
...
pub const TO_PLAYERNIGHTS: C2RustUnnamed_4 = 4;
pub const TO_PLAYEREMERALDS: C2RustUnnamed_4 = 3;
pub const TO_MOBJ: C2RustUnnamed_4 = 2;
pub const TO_ALLPLAYERS: C2RustUnnamed_4 = 1;
pub const TO_PLAYER: C2RustUnnamed_4 = 0;
pub type C2RustUnnamed_5 = libc::c_uint;
pub const CRUMBLE_RESTORE: C2RustUnnamed_5 = 4;
pub const CRUMBLE_FALL: C2RustUnnamed_5 = 3;
pub const CRUMBLE_ACTIVATED: C2RustUnnamed_5 = 2;
pub const CRUMBLE_WAIT: C2RustUnnamed_5 = 1;
pub const CRUMBLE_NONE: C2RustUnnamed_5 = 0;
...
pub const CF_REVERSE: C2RustUnnamed_6 = 4;
pub const CF_FLOATBOB: C2RustUnnamed_6 = 2;
pub const CF_RETURN: C2RustUnnamed_6 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const RF_DYNAMIC: C2RustUnnamed_7 = 4;
pub const RF_SPINDASH: C2RustUnnamed_7 = 2;
pub const RF_REVERSE: C2RustUnnamed_7 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct raise_t {
    pub thinker: thinker_t,
...
pub type result_e = libc::c_uint;
pub const pastdest: result_e = 2;
pub const crushed: result_e = 1;
pub const planeok: result_e = 0;
...
pub const pd_both: C2RustUnnamed_8 = 2;
pub const pd_ceiling: C2RustUnnamed_8 = 1;
pub const pd_floor: C2RustUnnamed_8 = 0;
...
pub unsafe extern "C" fn T_MovePlane(
    ...
    mut crush: boolean,
    mut ceiling: boolean,
    mut direction: int32_t,
) -> result_e {
    let mut lastpos: fixed_t = 0;
    let mut destheight: fixed_t = 0;
    (*sector).moved = true_0 as libc::c_int;
    if ceiling != 0 {
        lastpos = (*sector).ceilingheight;
        match direction {
            -1 => {
                destheight = if dest > (*sector).floorheight {
                    dest
                } else {
                    (*sector).floorheight
                };
                if (*sector).ceilingheight - speed < destheight {
                    ...
                    if P_CheckSector(sector, crush) != 0 {
            ...
            1 => {
                if (*sector).ceilingheight + speed > dest {
                    ...
                    if P_CheckSector(sector, crush) != 0 && (*sector).numattached != 0 {
                        (*sector).ceilingheight = lastpos;
                        P_CheckSector(sector, crush);
                    }
                    return pastdest;
        ...
        match direction {
            ...
            1 => {
                destheight = if dest < (*sector).ceilingheight {
                    dest
                } else {
...
#[no_mangle]
pub unsafe extern "C" fn T_MoveFloor(mut movefloor: *mut floormove_t) {
    let mut res: result_e = planeok;
    let mut remove: boolean = false_0 as libc::c_int;
    if (*movefloor).delaytimer != 0 {
        (*movefloor).delaytimer -= 1;
    ...
    res = T_MovePlane(
        ...
        (*movefloor).crush as boolean,
        false_0 as libc::c_int,
        (*movefloor).direction,
    );
    if (*movefloor).type_0 as libc::c_uint == bounceFloor as libc::c_int as libc::c_uint
    {
        let origspeed: fixed_t = FixedDiv(
            (*movefloor).origspeed,
            ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int
                / 2 as libc::c_int,
        );
        let fs: fixed_t = abs(
            (*(*movefloor).sector).floorheight
                - (*(*lines.offset((*movefloor).sourceline as isize)).frontsector)
                    .floorheight,
        );
        let bs: fixed_t = abs(
            (*(*movefloor).sector).floorheight
                - (*(*lines.offset((*movefloor).sourceline as isize)).backsector)
                    .floorheight,
        );
        if fs < bs {
            (*movefloor)
    ...
    if res as libc::c_uint == pastdest as libc::c_int as libc::c_uint {
        let mut current_block_37: u64;
        match (*movefloor).type_0 as libc::c_uint {
            2 => {
                if (*movefloor).tag != 0 {
                    P_LinedefExecute(
                        (*movefloor).tag,
                ...
                current_block_37 = 3709678680780759592;
            }
            3 => {
                current_block_37 = 3709678680780759592;
            }
            5 | 6 => {
                if (*movefloor).floordestheight
                    == (*(*lines.offset((*movefloor).sourceline as isize)).frontsector)
                        .floorheight
                {
                    (*movefloor)
                        .floordestheight = (*(*lines
                        .offset((*movefloor).sourceline as isize))
                        .backsector)
                        .floorheight;
                    (*movefloor)
                        .origspeed = (*lines.offset((*movefloor).sourceline as isize))
                ...
                if (*movefloor).type_0 as libc::c_uint
                    == bounceFloorCrush as libc::c_int as libc::c_uint
                {
                    (*movefloor).speed = (*movefloor).origspeed;
                }
                (*movefloor)
                    .direction = if (*movefloor).floordestheight
                    < (*(*movefloor).sector).floorheight
                {
                    -(1 as libc::c_int)
                } else {
                ...
                remove = false_0 as libc::c_int;
                current_block_37 = 9853141518545631134;
            }
            7 => {
                if (*movefloor).direction == 1 as libc::c_int {
                    (*movefloor)
                        .floordestheight = (*(*lines
                        .offset((*movefloor).sourceline as isize))
                        .frontsector)
                        .floorheight;
                    (*movefloor).direction = -(1 as libc::c_int);
                    (*movefloor)
                        .speed = (*lines.offset((*movefloor).sourceline as isize))
                        .args[3 as libc::c_int as usize]
                        << 16 as libc::c_int - 2 as libc::c_int;
                    (*(*movefloor).sector)
                        .soundorg
                        .z = (*(*movefloor).sector).floorheight;
                    S_StartSound(
                        &mut (*(*movefloor).sector).soundorg as *mut degenmobj_t
                            as *const libc::c_void,
                        sfx_pstop,
                    );
                    remove = false_0 as libc::c_int;
                } else {
                    remove = true_0 as libc::c_int;
                }
                current_block_37 = 9853141518545631134;
            }
            _ => {
        ...
        match current_block_37 {
            3709678680780759592 => {
                if (*movefloor).texture > -(1 as libc::c_int) {
    ...
    if remove != 0 {
        (*(*movefloor).sector).floordata = 0 as *mut libc::c_void;
        (*(*movefloor).sector).floorspeed = 0 as libc::c_int;
        P_RemoveThinker(&mut (*movefloor).thinker);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn T_MoveElevator(mut elevator: *mut elevator_t) {
    let mut res1: result_e = planeok;
    let mut res2: result_e = planeok;
    let mut res: result_e = planeok;
    let mut dontupdate: boolean = false_0 as libc::c_int;
    let mut oldfloor: fixed_t = 0;
    let mut oldceiling: fixed_t = 0;
    if (*elevator).delaytimer != 0 {
        (*elevator).delaytimer -= 1;
        (*elevator).delaytimer;
        return;
    }
    if (*elevator).direction < 0 as libc::c_int {
        if (*elevator).type_0 as libc::c_uint
            == elevateContinuous as libc::c_int as libc::c_uint
        {
            let origspeed: fixed_t = FixedDiv(
                (*elevator).origspeed,
                ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int
            ...
            let dh: fixed_t = abs(
                (*(*elevator).sector).floorheight - (*elevator).floordestheight,
            );
            if wh < dh {
                (*elevator)
                    .speed = FixedDiv(
        ...
        if (*elevator).distance != 0
            && (res1 as libc::c_uint == crushed as libc::c_int as libc::c_uint
                || res2 as libc::c_uint == crushed as libc::c_int as libc::c_uint)
        {
            res = crushed;
        ...
        if (*elevator).type_0 as libc::c_uint
            == elevateContinuous as libc::c_int as libc::c_uint
        {
            let origspeed_0: fixed_t = FixedDiv(
                (*elevator).origspeed,
                ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int
                    / 2 as libc::c_int,
            );
            ...
            if (*elevator).origspeed != 0 {
                (*elevator).speed = FixedMul((*elevator).speed, origspeed_0);
                if (*elevator).speed > (*elevator).origspeed {
                    (*elevator).speed = (*elevator).origspeed;
                }
                if (*elevator).speed < 1 as libc::c_int {
        ...
        if res1 as libc::c_uint != crushed as libc::c_int as libc::c_uint {
            res2 = T_MovePlane(
                (*elevator).sector,
                (*elevator).speed,
                (*elevator).ceilingdestheight,
    ...
    if res as libc::c_uint == pastdest as libc::c_int as libc::c_uint
        || res as libc::c_uint == crushed as libc::c_int as libc::c_uint
    {
        if (*elevator).type_0 as libc::c_uint
            == elevateContinuous as libc::c_int as libc::c_uint
        {
            if (*elevator).direction > 0 as libc::c_int {
                (*elevator).high = 1 as libc::c_int;
                (*elevator).low = 0 as libc::c_int;
                (*elevator).direction = -(1 as libc::c_int);
                if (*elevator).origspeed != 0 {
                    (*elevator).speed = (*elevator).origspeed;
                } else {
                    (*elevator)
                ...
                if (*elevator).low != 0 {
                    (*elevator)
                        .floordestheight = P_FindNextHighestFloor(
                        (*elevator).sector,
                        (*(*elevator).sector).floorheight,
                    );
                    (*elevator)
                        .ceilingdestheight = (*elevator).floordestheight
                        + (*(*elevator).sector).ceilingheight
                        - (*(*elevator).sector).floorheight;
                } else {
                    (*elevator)
                        .floordestheight = P_FindNextLowestFloor(
                        (*elevator).sector,
                        (*(*elevator).sector).floorheight,
                    );
                    (*elevator)
                ...
                (*elevator).high = 0 as libc::c_int;
                (*elevator).low = 1 as libc::c_int;
                (*elevator).direction = 1 as libc::c_int;
                if (*elevator).origspeed != 0 {
                    (*elevator).speed = (*elevator).origspeed;
                } else {
            ...
            (*(*elevator).sector).floordata = 0 as *mut libc::c_void;
            (*(*elevator).sector).ceilingdata = 0 as *mut libc::c_void;
            (*(*elevator).sector).ceilspeed = 0 as libc::c_int;
            (*(*elevator).sector).floorspeed = 0 as libc::c_int;
            P_RemoveThinker(&mut (*elevator).thinker);
            dontupdate = true_0 as libc::c_int;
        }
    }
    if dontupdate == 0 {
        (*(*elevator).sector).floorspeed = (*elevator).speed * (*elevator).direction;
        (*(*elevator).sector).ceilspeed = 42 as libc::c_int;
    } else {
        (*(*elevator).sector).floorspeed = 0 as libc::c_int;
        (*(*elevator).sector).ceilspeed = 0 as libc::c_int;
        (*(*elevator).sector).floordata = 0 as *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn T_ContinuousFalling(mut faller: *mut continuousfall_t) {
    (*(*faller).sector).ceilingheight += (*faller).speed * (*faller).direction;
    (*(*faller).sector).floorheight += (*faller).speed * (*faller).direction;
    P_CheckSector((*faller).sector, false_0 as libc::c_int);
    if (*faller).direction == -(1 as libc::c_int)
        && (*(*faller).sector).ceilingheight <= (*faller).destheight
        || (*faller).direction == 1 as libc::c_int
            && (*(*faller).sector).floorheight >= (*faller).destheight
    {
        (*(*faller).sector).ceilingheight = (*faller).ceilingstartheight;
        (*(*faller).sector).floorheight = (*faller).floorstartheight;
        R_ClearLevelInterpolatorState(&mut (*faller).thinker);
    }
    P_CheckSector((*faller).sector, false_0 as libc::c_int);
    (*(*faller).sector).floorspeed = (*faller).speed * (*faller).direction;
    (*(*faller).sector).ceilspeed = 42 as libc::c_int;
    (*(*faller).sector).moved = true_0 as libc::c_int;
}
unsafe extern "C" fn P_SectorCheckWater(
    mut analyzesector: *mut sector_t,
    mut elevatorsec: *mut sector_t,
) -> fixed_t {
    let mut watertop: fixed_t = 0;
    watertop = (*analyzesector).floorheight
        - 512 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    if !((*analyzesector).ffloors).is_null() {
        let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
        rover = (*analyzesector).ffloors;
        while !rover.is_null() {
            ...
            {
                if !(((*elevatorsec).ceilingheight + (*elevatorsec).floorheight
                    >> 1 as libc::c_int) < *(*rover).bottomheight)
                {
                    if !(*(*rover).topheight
                        < (*analyzesector).floorheight
                            + abs(
                                (*elevatorsec).ceilingheight - (*elevatorsec).floorheight
                                    >> 1 as libc::c_int,
                            ))
                    {
                        if *(*rover).topheight > watertop {
...
#[no_mangle]
pub unsafe extern "C" fn T_BounceCheese(mut bouncer: *mut bouncecheese_t) {
    let mut sectorheight: fixed_t = 0;
    let mut halfheight: fixed_t = 0;
    let mut waterheight: fixed_t = 0;
    let mut floorheight: fixed_t = 0;
    let mut actionsector: *mut sector_t = 0 as *mut sector_t;
    let mut remove: boolean = 0;
    let mut i: int32_t = 0;
    if (*(*bouncer).sector).crumblestate == CRUMBLE_RESTORE as libc::c_int
        || (*(*bouncer).sector).crumblestate == CRUMBLE_WAIT as libc::c_int
        || (*(*bouncer).sector).crumblestate == CRUMBLE_ACTIVATED as libc::c_int
    {
        (*(*bouncer).sector).ceilingdata = 0 as *mut libc::c_void;
        (*(*bouncer).sector).ceilspeed = 0 as libc::c_int;
        (*(*bouncer).sector).floordata = 0 as *mut libc::c_void;
        (*(*bouncer).sector).floorspeed = 0 as libc::c_int;
        P_RemoveThinker(&mut (*bouncer).thinker);
        return;
    }
    let mut ICNT_603: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors(
            (*(*bouncer).sourceline).args[0 as libc::c_int as usize] as mtag_t,
            ICNT_603,
        );
        if !(i >= 0 as libc::c_int) {
            break;
        }
        actionsector = &mut *sectors.offset(i as isize) as *mut sector_t;
        (*actionsector).moved = true_0 as libc::c_int;
        sectorheight = abs(
            (*(*bouncer).sector).ceilingheight - (*(*bouncer).sector).floorheight,
        );
        halfheight = sectorheight / 2 as libc::c_int;
        waterheight = P_SectorCheckWater(actionsector, (*bouncer).sector);
        floorheight = P_FloorzAtPos(
            (*actionsector).soundorg.x,
            (*actionsector).soundorg.y,
            (*(*bouncer).sector).floorheight,
            sectorheight,
        );
        remove = false_0 as libc::c_int;
        if waterheight > (*(*bouncer).sector).ceilingheight - halfheight
            && (*(*bouncer).sector).ceilingheight >= (*actionsector).ceilingheight
        {
            (*(*bouncer).sector).ceilingheight = (*actionsector).ceilingheight;
            (*(*bouncer).sector)
                .floorheight = (*actionsector).ceilingheight - sectorheight;
            remove = true_0 as libc::c_int;
        } else if waterheight < (*(*bouncer).sector).floorheight + halfheight
        ...
        if remove != 0 {
            ...
            (*(*bouncer).sector).floorspeed = 0 as libc::c_int;
            (*(*bouncer).sector).ceilspeed = 0 as libc::c_int;
            (*(*bouncer).sector).moved = true_0 as libc::c_int;
            P_RemoveThinker(&mut (*bouncer).thinker);
            return;
        }
        if (*bouncer).speed >= 0 as libc::c_int {
            T_MovePlane(
                (*bouncer).sector,
                (*bouncer).speed / 2 as libc::c_int,
                (*(*bouncer).sector).floorheight
        ...
        (*(*bouncer).sector).floorspeed = -(*bouncer).speed / 2 as libc::c_int;
        (*(*bouncer).sector).ceilspeed = 42 as libc::c_int;
        if (*(*bouncer).sector).ceilingheight < (*bouncer).ceilingwasheight
            && (*bouncer).low == 0
            || (*(*bouncer).sector).ceilingheight > (*bouncer).ceilingwasheight
                && (*bouncer).low != 0
        {
            if abs((*bouncer).speed)
                < 6 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            {
                (*bouncer).speed -= (*bouncer).speed / 3 as libc::c_int;
            } else {
                (*bouncer).speed -= (*bouncer).speed / 2 as libc::c_int;
            }
            (*bouncer).low = ((*bouncer).low == 0) as libc::c_int;
            if abs((*bouncer).speed)
                > 6 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            {
                let mut mp: *mut mobj_t = &mut (*actionsector).soundorg
                    as *mut degenmobj_t as *mut libc::c_void as *mut mobj_t;
                (*actionsector).soundorg.z = (*(*bouncer).sector).floorheight;
                S_StartSound(mp as *const libc::c_void, sfx_splash);
            }
        }
        if (*(*bouncer).sector).ceilingheight < (*bouncer).ceilingwasheight {
            (*bouncer).speed -= (*bouncer).distance;
        } else if (*(*bouncer).sector).ceilingheight > (*bouncer).ceilingwasheight {
            (*bouncer).speed += gravity;
        }
        if abs((*bouncer).speed)
            < 2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            && abs((*(*bouncer).sector).ceilingheight - (*bouncer).ceilingwasheight)
                < ((1 as libc::c_int) << 16 as libc::c_int) / 4 as libc::c_int
        {
        ...
        if (*bouncer).distance > 0 as libc::c_int {
            (*bouncer).distance -= 1;
            (*bouncer).distance;
        }
        if !actionsector.is_null() {
            P_RecalcPrecipInSector(actionsector);
        }
        ICNT_603 = ICNT_603.wrapping_add(1);
        ICNT_603;
    };
}
#[no_mangle]
pub unsafe extern "C" fn T_StartCrumble(mut crumble: *mut crumble_t) {
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut sector: *mut sector_t = 0 as *mut sector_t;
    let mut i: int32_t = 0;
    let mut tag: mtag_t = (*(*crumble).sourceline).args[0 as libc::c_int as usize]
        as mtag_t;
    if ((*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int != 0
        && (*crumble).direction == -(1 as libc::c_int)
        || (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int == 0
            && (*crumble).direction == 1 as libc::c_int)
        && (*crumble).flags as libc::c_int & CF_RETURN as libc::c_int == 0
    {
        (*(*crumble).sector).ceilspeed = 0 as libc::c_int;
        (*(*crumble).sector).floorspeed = 0 as libc::c_int;
        return;
    }
    if (*crumble).timer != 0 as libc::c_int {
        if (*crumble).timer > 0 as libc::c_int {
            (*crumble).timer -= 1;
            if (*crumble).timer <= 0 as libc::c_int {
                (*crumble).timer = -(15 as libc::c_int) * 35 as libc::c_int;
            } else {
                (*(*crumble).sector).ceilspeed = 0 as libc::c_int;
                (*(*crumble).sector).floorspeed = 0 as libc::c_int;
                return;
            ...
            (*crumble).timer += 1;
            if (*crumble).timer == 0 as libc::c_int {
                let mut ICNT_756: size_t = 0 as libc::c_int as size_t;
                loop {
                    i = Tag_Iterate_Sectors(tag, ICNT_756);
                    if !(i >= 0 as libc::c_int) {
                        break;
                    }
                    sector = &mut *sectors.offset(i as isize) as *mut sector_t;
                            ...
                            & FOF_CRUMBLE as libc::c_int as libc::c_uint == 0)
                        {
                                ...
                                & FOF_FLOATBOB as libc::c_int as libc::c_uint == 0)
                            {
                                if !((*rover).master != (*crumble).sourceline) {
                                    ...
                                    if (*rover).alpha == 0xff as libc::c_int {
                                        (*rover)
                    ...
                    ICNT_756 = ICNT_756.wrapping_add(1);
                    ICNT_756;
                }
                if (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int != 0 {
                    (*crumble).direction = -(1 as libc::c_int);
        ...
        if (*crumble).timer > -(224 as libc::c_int)
            && leveltime
                % (abs((*crumble).timer) / 8 as libc::c_int + 1 as libc::c_int) as tic_t
                == 0 as libc::c_int as tic_t
        {
            let mut ICNT_792: size_t = 0 as libc::c_int as size_t;
            loop {
                i = Tag_Iterate_Sectors(tag, ICNT_792);
                if !(i >= 0 as libc::c_int) {
                    break;
                }
                sector = &mut *sectors.offset(i as isize) as *mut sector_t;
                ...
                ICNT_792 = ICNT_792.wrapping_add(1);
                ICNT_792;
            }
        }
        if (*crumble).timer < 0 as libc::c_int && (*crumble).timer > -(3 as libc::c_int)
        {
            (*(*crumble).sector).crumblestate = CRUMBLE_RESTORE as libc::c_int;
        }
    }
    if (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int == 0
        && (*crumble).direction == -(1 as libc::c_int)
        || (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int != 0
            && (*crumble).direction == 1 as libc::c_int
    {
        (*(*crumble).sector).crumblestate = CRUMBLE_FALL as libc::c_int;
        if (*crumble).flags as libc::c_int & CF_FLOATBOB as libc::c_int == 0 {
            (*crumble).speed += gravity;
            if (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int == 0
                && (*(*crumble).sector).ceilingheight
                    >= -(16384 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int)
                || (*crumble).flags as libc::c_int & CF_REVERSE as libc::c_int != 0
                    && (*(*crumble).sector).ceilingheight
                            ...
                            * ((1 as libc::c_int) << 16 as libc::c_int)
            {
                T_MovePlane(
                    ...
                    (*crumble).speed,
                    (*(*crumble).sector).ceilingheight
                        + (*crumble).direction * (*crumble).speed * 2 as libc::c_int,
                    false_0 as libc::c_int,
                    true_0 as libc::c_int,
                    (*crumble).direction,
                );
                T_MovePlane(
                    (*crumble).sector,
                    (*crumble).speed,
                    (*(*crumble).sector).floorheight
                        + (*crumble).direction * (*crumble).speed * 2 as libc::c_int,
                    false_0 as libc::c_int,
                    false_0 as libc::c_int,
                    (*crumble).direction,
                );
                (*(*crumble).sector).ceilspeed = 42 as libc::c_int;
                (*(*crumble).sector)
                    .floorspeed = (*crumble).speed * (*crumble).direction;
            }
        }
    } else {
        (*(*crumble).sector).crumblestate = CRUMBLE_WAIT as libc::c_int;
        (*(*crumble).sector).ceilingheight = (*crumble).ceilingwasheight;
        (*(*crumble).sector).floorheight = (*crumble).floorwasheight;
        (*(*crumble).sector).floordata = 0 as *mut libc::c_void;
        (*(*crumble).sector).ceilingdata = 0 as *mut libc::c_void;
        (*(*crumble).sector).ceilspeed = 0 as libc::c_int;
        (*(*crumble).sector).floorspeed = 0 as libc::c_int;
        (*(*crumble).sector).moved = true_0 as libc::c_int;
        P_RemoveThinker(&mut (*crumble).thinker);
    }
    let mut ICNT_884: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors(tag, ICNT_884);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        sector = &mut *sectors.offset(i as isize) as *mut sector_t;
        ...
        ICNT_884 = ICNT_884.wrapping_add(1);
        ICNT_884;
    };
}
#[no_mangle]
pub unsafe extern "C" fn T_MarioBlock(mut block: *mut mariothink_t) {
    let mut i: int32_t = 0;
    T_MovePlane(
        (*block).sector,
        (*block).speed,
        (*(*block).sector).ceilingheight
            + 70 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
                * (*block).direction,
        false_0 as libc::c_int,
        true_0 as libc::c_int,
    ...
    if (*(*block).sector).ceilingheight
        >= (*block).ceilingstartheight
            + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
    {
        (*block).direction *= -(1 as libc::c_int);
        ...
        P_RemoveThinker(&mut (*block).thinker);
        (*(*block).sector).floordata = 0 as *mut libc::c_void;
        (*(*block).sector).ceilingdata = 0 as *mut libc::c_void;
        (*(*block).sector).floorspeed = 0 as libc::c_int;
        (*(*block).sector).ceilspeed = 0 as libc::c_int;
        (*block).direction = 0 as libc::c_int;
    }
    let mut ICNT_934: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors((*block).tag, ICNT_934);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        P_RecalcPrecipInSector(&mut *sectors.offset(i as isize));
        ICNT_934 = ICNT_934.wrapping_add(1);
        ICNT_934;
    };
}
#[no_mangle]
pub unsafe extern "C" fn T_FloatSector(mut floater: *mut floatthink_t) {
    let mut cheeseheight: fixed_t = 0;
    let mut waterheight: fixed_t = 0;
    let mut actionsector: *mut sector_t = 0 as *mut sector_t;
    let mut secnum: int32_t = 0;
    secnum = Tag_Iterate_Sectors((*floater).tag, 0 as libc::c_int as size_t);
    if secnum < 0 as libc::c_int {
        return;
    }
    actionsector = &mut *sectors.offset(secnum as isize) as *mut sector_t;
    cheeseheight = (*(*floater).sector).ceilingheight + (*(*floater).sector).floorheight
        >> 1 as libc::c_int;
    waterheight = P_SectorCheckWater(actionsector, (*floater).sector);
    if waterheight == cheeseheight {
        return;
    }
    if (*(*floater).sector).floorheight == (*actionsector).floorheight
        && waterheight < cheeseheight
    {
        return;
    }
    if (*(*floater).sector).ceilingheight == (*actionsector).ceilingheight
        && waterheight > cheeseheight
    {
        return;
    }
    if (*(*floater).sector).crumblestate == CRUMBLE_NONE as libc::c_int
        || (*(*floater).sector).crumblestate >= CRUMBLE_FALL as libc::c_int
    {
        EV_BounceSector(
            (*floater).sector,
            (1 as libc::c_int) << 16 as libc::c_int,
...
unsafe extern "C" fn SearchMarioNode(mut node: *mut msecnode_t) -> *mut mobj_t {
    let mut thing: *mut mobj_t = 0 as *mut mobj_t;
    while !node.is_null() {
        match (*(*node).m_thing).type_0 as libc::c_uint {
            0 | 1 | 4 | 2 | 615 | 616 | 126 | 457 | 458 | 459 | 460 | 461 | 462 | 463
            | 464 | 465 | 467 | 468 | 156 | 506 | 507 | 508 | 509 | 510 | 511 | 512 | 516
            | 505 | 517 | 519 | 520 | 521 | 522 | 524 | 525 | 577 | 578 | 580 | 649 => {}
            _ => {
                if !((*(*node).m_thing).health == 0 as libc::c_int
                    || (*(*node).m_thing).flags & MF_MONITOR as libc::c_int as uint32_t
                        == 0
                        && mobjinfo[(*(*node).m_thing).type_0 as usize].flags
                            & MF_MONITOR as libc::c_int as uint32_t != 0)
                {
                    if thing.is_null() || (*(*node).m_thing).x < (*thing).x
                        || (*(*node).m_thing).y < (*thing).y
                    {
                        thing = (*node).m_thing;
                    }
                }
...
#[no_mangle]
pub unsafe extern "C" fn T_MarioBlockChecker(mut block: *mut mariocheck_t) {
    let mut masterline: *mut line_t = (*block).sourceline;
    if !(SearchMarioNode((*(*block).sector).touching_thinglist)).is_null() {
        (*sides.offset((*masterline).sidenum[0 as libc::c_int as usize] as isize))
            .midtexture = (*sides
            .offset((*masterline).sidenum[0 as libc::c_int as usize] as isize))
            .bottomtexture;
        if !((*masterline).backsector).is_null() {
            (*(*block).sector).floorpic = (*(*masterline).backsector).ceilingpic;
            (*(*block).sector).ceilingpic = (*(*block).sector).floorpic;
        }
    } else {
        (*sides.offset((*masterline).sidenum[0 as libc::c_int as usize] as isize))
            .midtexture = (*sides
            ...
            .toptexture;
        if !((*masterline).backsector).is_null() {
            (*(*block).sector).floorpic = (*(*masterline).backsector).floorpic;
            (*(*block).sector).ceilingpic = (*(*block).sector).floorpic;
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn T_ThwompSector(mut thwomp: *mut thwomp_t) {
    let mut thwompx: fixed_t = 0;
    let mut thwompy: fixed_t = 0;
    let mut actionsector: *mut sector_t = 0 as *mut sector_t;
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut secnum: int32_t = 0;
    let mut speed: fixed_t = 0;
    (*thwomp).delay -= 1;
    if (*thwomp).delay > 0 as libc::c_int {
        return;
    }
    secnum = Tag_Iterate_Sectors((*thwomp).tag, 0 as libc::c_int as size_t);
    if secnum < 0 as libc::c_int {
        return;
    }
    actionsector = &mut *sectors.offset(secnum as isize) as *mut sector_t;
    rover = (*actionsector).ffloors;
    while !rover.is_null() {
    ...
    if (*thwomp).direction == 0 as libc::c_int {
        if (*rover).fofflags as libc::c_uint & FOF_EXISTS as libc::c_int as libc::c_uint
            != 0
        {
            let mut i: uint8_t = 0;
            i = 0 as libc::c_int as uint8_t;
            while (i as libc::c_int) < 32 as libc::c_int {
                if !(P_IsPlayerValid(i as size_t) == 0) {
                    if !((*players[i as usize].mo).z > (*(*thwomp).sector).ceilingheight)
                    {
                        if !(P_AproxDistance(
                            thwompx - (*players[i as usize].mo).x,
                            thwompy - (*players[i as usize].mo).y,
                        )
                            > 96 as libc::c_int
                                * ((1 as libc::c_int) << 16 as libc::c_int))
                        {
                            (*thwomp).direction = -(1 as libc::c_int);
                            break;
                        }
                    }
                }
        ...
        (*(*thwomp).sector).ceilspeed = 0 as libc::c_int;
        (*(*thwomp).sector).floorspeed = 0 as libc::c_int;
    } else {
        let mut res: result_e = planeok;
        if (*thwomp).direction > 0 as libc::c_int {
            (*sides
                .offset(
                    (*(*thwomp).sourceline).sidenum[0 as libc::c_int as usize] as isize,
                ))
                .midtexture = (*sides
                .offset(
                    (*(*thwomp).sourceline).sidenum[0 as libc::c_int as usize] as isize,
            ...
            res = T_MovePlane(
                (*thwomp).sector,
                speed,
                (*thwomp).floorstartheight,
                false_0 as libc::c_int,
                false_0 as libc::c_int,
                (*thwomp).direction,
            );
            if res as libc::c_uint == planeok as libc::c_int as libc::c_uint
                || res as libc::c_uint == pastdest as libc::c_int as libc::c_uint
            {
                T_MovePlane(
                    (*thwomp).sector,
                    speed,
                    (*thwomp).ceilingstartheight,
                    false_0 as libc::c_int,
                    true_0 as libc::c_int,
                    (*thwomp).direction,
                );
            ...
            res = T_MovePlane(
                ...
                P_FloorzAtPos(
                    thwompx,
                    thwompy,
                    (*(*thwomp).sector).floorheight,
                    (*(*thwomp).sector).ceilingheight - (*(*thwomp).sector).floorheight,
                ),
                false_0 as libc::c_int,
                false_0 as libc::c_int,
                (*thwomp).direction,
            ...
            if res as libc::c_uint == pastdest as libc::c_int as libc::c_uint {
                ...
                {
                    S_StartSound(
                        &mut (*actionsector).soundorg as *mut degenmobj_t
                            as *mut libc::c_void,
                        (*thwomp).sound as sfxenum_t,
                    );
                }
                (*thwomp).direction = 1 as libc::c_int;
                (*thwomp).delay = 35 as libc::c_int;
            }
        }
        (*(*thwomp).sector).ceilspeed = 42 as libc::c_int;
        (*(*thwomp).sector).floorspeed = speed * (*thwomp).direction;
    }
    P_RecalcPrecipInSector(actionsector);
}
unsafe extern "C" fn T_SectorHasEnemies(mut sec: *mut sector_t) -> boolean {
    let mut node: *mut msecnode_t = (*sec).touching_thinglist;
    let mut mo: *mut mobj_t = 0 as *mut mobj_t;
    while !node.is_null() {
        mo = (*node).m_thing;
        if (*mo).flags & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t
            != 0 && (*mo).health > 0 as libc::c_int && (*mo).z < (*sec).ceilingheight
...
#[no_mangle]
pub unsafe extern "C" fn T_NoEnemiesSector(mut nobaddies: *mut noenemies_t) {
    let mut i: size_t = 0;
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut secnum: int32_t = -(1 as libc::c_int);
    let mut FOFsector: boolean = false_0 as libc::c_int;
    let mut tag: mtag_t = (*(*nobaddies).sourceline).args[0 as libc::c_int as usize]
        as mtag_t;
    let mut ICNT_1229: size_t = 0 as libc::c_int as size_t;
    loop {
        secnum = Tag_Iterate_Sectors(tag, ICNT_1229);
        if !(secnum >= 0 as libc::c_int) {
            break;
        }
        sec = &mut *sectors.offset(secnum as isize) as *mut sector_t;
        FOFsector = false_0 as libc::c_int;
        i = 0 as libc::c_int as size_t;
        while i < (*sec).linecount {
            let mut targetsecnum: int32_t = -(1 as libc::c_int);
            if !(((**((*sec).lines).offset(i as isize)).special as libc::c_int)
                < 100 as libc::c_int
                || (**((*sec).lines).offset(i as isize)).special as libc::c_int
                    >= 300 as libc::c_int)
            {
                FOFsector = true_0 as libc::c_int;
                let mut ICNT_1245: size_t = 0 as libc::c_int as size_t;
                loop {
                    targetsecnum = Tag_Iterate_Sectors(
                        (**((*sec).lines).offset(i as isize))
                            .args[0 as libc::c_int as usize] as mtag_t,
                        ICNT_1245,
                    );
                    if !(targetsecnum >= 0 as libc::c_int) {
                        break;
                    }
                    if T_SectorHasEnemies(&mut *sectors.offset(targetsecnum as isize))
                        != 0
                    {
                        return;
                    }
                    ICNT_1245 = ICNT_1245.wrapping_add(1);
                    ICNT_1245;
                }
            }
            i = i.wrapping_add(1);
        ...
        if FOFsector == 0 && T_SectorHasEnemies(sec) != 0 {
            return;
        }
        ICNT_1229 = ICNT_1229.wrapping_add(1);
        ICNT_1229;
    }
    CONS_Debug(
        0x80 as libc::c_int,
        b"Running no-more-enemies exec with tag of %d\n\0" as *const u8
            as *const libc::c_char,
        tag as libc::c_int,
    );
    P_RunTriggerLinedef((*nobaddies).sourceline, 0 as *mut mobj_t, 0 as *mut sector_t);
    P_RemoveThinker(&mut (*nobaddies).thinker);
}
unsafe extern "C" fn P_CheckAllTrigger(mut eachtime: *mut eachtime_t) -> boolean {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
        if P_CanPlayerTrigger(i) != 0 && (*eachtime).playersInArea[i as usize] == 0 {
            return false_0 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn T_EachTimeThinker(mut eachtime: *mut eachtime_t) {
    let mut i: size_t = 0;
    let mut oldPlayersInArea: [boolean; 32] = [0; 32];
    let mut caller: [*mut sector_t; 32] = [0 as *mut sector_t; 32];
    let mut allPlayersChecked: boolean = false_0 as libc::c_int;
    let mut allPlayersTrigger: boolean = false_0 as libc::c_int;
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
        oldPlayersInArea[i as usize] = (*eachtime).playersInArea[i as usize];
        caller[i
            as usize] = if P_CanPlayerTrigger(i) != 0 {
            P_FindPlayerTrigger(
        ...
        (*eachtime)
            .playersInArea[i
            as usize] = (caller[i as usize] != 0 as *mut libc::c_void as *mut sector_t)
            as libc::c_int;
        i = i.wrapping_add(1);
        i;
    }
    if memcmp(
        ((*eachtime).playersInArea).as_mut_ptr() as *const libc::c_void,
        oldPlayersInArea.as_mut_ptr() as *const libc::c_void,
    ...
    i = 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as size_t {
        if !((*eachtime).playersInArea[i as usize] == oldPlayersInArea[i as usize]) {
            if !((*eachtime).playersInArea[i as usize] == 0
                && ((*eachtime).triggerOnExit == 0 || P_CanPlayerTrigger(i) == 0))
            {
                if !(caller[i as usize]).is_null()
                    && (*caller[i as usize]).triggerer as libc::c_int
                        == TO_ALLPLAYERS as libc::c_int
                {
                    if allPlayersChecked == 0 {
                        allPlayersChecked = true_0 as libc::c_int;
                        allPlayersTrigger = P_CheckAllTrigger(eachtime);
                    }
                    if allPlayersTrigger == 0 {
                        current_block_16 = 13513818773234778473;
                    } else {
                ...
                match current_block_16 {
                    ...
                    _ => {
                        CONS_Debug(
                            0x80 as libc::c_int,
                            b"Trying to activate each time executor with tag %d\n\0"
                                as *const u8 as *const libc::c_char,
                            Tag_FGet(&mut (*(*eachtime).sourceline).tags) as libc::c_int,
                        );
                        P_RunTriggerLinedef(
                            (*eachtime).sourceline,
                        ...
                        if (*(*eachtime).sourceline).special == 0 {
                            P_RemoveThinker(&mut (*eachtime).thinker);
                        }
                    }
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn T_RaiseSector(mut raise: *mut raise_t) {
    let mut node: *mut msecnode_t = 0 as *mut msecnode_t;
    let mut thing: *mut mobj_t = 0 as *mut mobj_t;
    let mut sector: *mut sector_t = 0 as *mut sector_t;
    let mut i: int32_t = 0;
    let mut playeronme: boolean = false_0 as libc::c_int;
    let mut active: boolean = false_0 as libc::c_int;
    let mut moveUp: boolean = 0;
    let mut ceilingdestination: fixed_t = 0;
    let mut floordestination: fixed_t = 0;
    let mut speed: fixed_t = 0;
    let mut origspeed: fixed_t = 0;
    let mut distToNearestEndpoint: fixed_t = 0;
    let mut direction: int32_t = 0;
    let mut res: result_e = planeok;
    let mut tag: mtag_t = (*raise).tag;
    if (*(*raise).sector).crumblestate >= CRUMBLE_FALL as libc::c_int
        || !((*(*raise).sector).ceilingdata).is_null()
    {
        return;
    }
    let mut ICNT_1355: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors(tag, ICNT_1355);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        sector = &mut *sectors.offset(i as isize) as *mut sector_t;
        ...
        while !node.is_null() {
            ...
            if !((*thing).player).is_null() {
                if !(!((*thing).player).is_null() && (*(*thing).player).spectator != 0) {
                    if !((*raise).flags as libc::c_int & RF_SPINDASH as libc::c_int != 0
                            ...
                            & PF_STARTDASH as libc::c_int as libc::c_uint == 0)
                    {
                        if (*thing).z
                            == P_MobjCeilingZ(
                                ...
                                (*thing).y,
                                0 as *mut line_t,
                                ((*raise).sector == sector) as libc::c_int,
                                true_0 as libc::c_int,
                            )
                        {
                            playeronme = true_0 as libc::c_int;
                            break;
                        }
                    }
                }
        ...
        ICNT_1355 = ICNT_1355.wrapping_add(1);
        ICNT_1355;
    }
    if (*raise).flags as libc::c_int & RF_DYNAMIC as libc::c_int != 0 {
        if (*raise).shaketimer as libc::c_int > 10 as libc::c_int {
            if playeronme != 0 {
                (*raise).extraspeed
                ...
                if (*raise).extraspeed <= 0 as libc::c_int {
                    (*raise).extraspeed = 0 as libc::c_int;
                    (*raise).shaketimer = 0 as libc::c_int as uint8_t;
                }
            }
            active = ((*raise).extraspeed > 0 as libc::c_int) as libc::c_int;
        } else if playeronme != 0 || (*raise).shaketimer as libc::c_int != 0 {
            active = true_0 as libc::c_int;
            (*raise).shaketimer = ((*raise).shaketimer).wrapping_add(1);
            if (*raise).shaketimer as libc::c_int > 10 as libc::c_int {
                if playeronme != 0 {
                    (*raise)
                        .extraspeed = (1 as libc::c_int) << 16 as libc::c_int
                        >> 5 as libc::c_int;
                } else {
                    (*raise)
                        .extraspeed = ((1 as libc::c_int) << 16 as libc::c_int)
                ...
                (*raise)
                    .extraspeed = (10 as libc::c_int / 2 as libc::c_int
                    - (*raise).shaketimer as libc::c_int) << 16 as libc::c_int;
                if (*raise).extraspeed < -(*raise).basespeed / 2 as libc::c_int {
                    (*raise).extraspeed = -(*raise).basespeed / 2 as libc::c_int;
                }
            }
        }
    } else {
    ...
    moveUp = active ^ (*raise).flags as libc::c_int & RF_REVERSE as libc::c_int;
    ceilingdestination = if moveUp != 0 {
        (*raise).ceilingtop
    } else {
        (*raise).ceilingbottom
    };
    floordestination = ceilingdestination
        - ((*(*raise).sector).ceilingheight - (*(*raise).sector).floorheight);
    if moveUp != 0 && (*(*raise).sector).ceilingheight >= ceilingdestination
        || moveUp == 0 && (*(*raise).sector).ceilingheight <= ceilingdestination
    {
        (*(*raise).sector).floorheight = floordestination;
        (*(*raise).sector).ceilingheight = ceilingdestination;
        (*(*raise).sector).ceilspeed = 0 as libc::c_int;
        (*(*raise).sector).floorspeed = 0 as libc::c_int;
        return;
    }
    direction = if moveUp != 0 { 1 as libc::c_int } else { -(1 as libc::c_int) };
    origspeed = (*raise).basespeed;
    if active == 0 {
        origspeed /= 2 as libc::c_int;
    }
    distToNearestEndpoint = if (*(*raise).sector).ceilingheight - (*raise).ceilingbottom
    ...
    speed = FixedMul(
        origspeed,
        FixedDiv(
            distToNearestEndpoint,
            (*raise).ceilingtop - (*raise).ceilingbottom >> 5 as libc::c_int,
        ),
    );
    if speed <= origspeed / 16 as libc::c_int {
        speed = origspeed / 16 as libc::c_int;
    ...
    (*(*raise).sector).ceilspeed = 42 as libc::c_int;
    (*(*raise).sector).floorspeed = speed * direction;
    let mut ICNT_1482: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors(tag, ICNT_1482);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        P_RecalcPrecipInSector(&mut *sectors.offset(i as isize));
        ICNT_1482 = ICNT_1482.wrapping_add(1);
        ICNT_1482;
    };
}
#[no_mangle]
pub unsafe extern "C" fn T_CameraScanner(mut elevator: *mut elevator_t) {
    static mut lastleveltime: tic_t = 32000 as libc::c_int as tic_t;
    static mut camerascanned: boolean = 0;
    static mut camerascanned2: boolean = 0;
    if leveltime != lastleveltime {
        camerascanned2 = false_0 as libc::c_int;
        camerascanned = camerascanned2;
        lastleveltime = leveltime;
    }
    if !(players[displayplayer as usize].mo).is_null() {
        if (*(*players[displayplayer as usize].mo).subsector).sector
            == (*elevator).actionsector
        {
            if t_cam_dist == -(42 as libc::c_int) {
                t_cam_dist = cv_cam_dist.value;
            }
            if t_cam_height == -(42 as libc::c_int) {
                t_cam_height = cv_cam_height.value;
            }
            if t_cam_rotate == -(42 as libc::c_int) {
                t_cam_rotate = cv_cam_rotate.value;
            }
            CV_SetValue(&mut cv_cam_height, FixedInt((*(*elevator).sector).floorheight));
            CV_SetValue(&mut cv_cam_dist, FixedInt((*(*elevator).sector).ceilingheight));
            CV_SetValue(&mut cv_cam_rotate, (*elevator).distance);
            camerascanned = true_0 as libc::c_int;
        } else if camerascanned == 0 {
            if t_cam_height != -(42 as libc::c_int)
                && cv_cam_height.value != t_cam_height
            {
                CV_Set(
                    &mut cv_cam_height,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        FixedToFloat(t_cam_height) as libc::c_double,
                    ),
                );
            }
            if t_cam_dist != -(42 as libc::c_int) && cv_cam_dist.value != t_cam_dist {
                CV_Set(
                    &mut cv_cam_dist,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        FixedToFloat(t_cam_dist) as libc::c_double,
                    ),
                );
            }
            if t_cam_rotate != -(42 as libc::c_int)
                && cv_cam_rotate.value != t_cam_rotate
            {
                CV_Set(
                    &mut cv_cam_rotate,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        t_cam_rotate as libc::c_double,
                    ),
                );
            }
            t_cam_rotate = -(42 as libc::c_int);
            t_cam_height = t_cam_rotate;
            t_cam_dist = t_cam_height;
        }
    }
    if splitscreen != 0 && !(players[secondarydisplayplayer as usize].mo).is_null() {
        if (*(*players[secondarydisplayplayer as usize].mo).subsector).sector
            == (*elevator).actionsector
        {
            if t_cam2_rotate == -(42 as libc::c_int) {
            ...
            CV_SetValue(
                &mut cv_cam2_height,
                FixedInt((*(*elevator).sector).floorheight),
            );
            CV_SetValue(
                &mut cv_cam2_dist,
                FixedInt((*(*elevator).sector).ceilingheight),
            );
            CV_SetValue(&mut cv_cam2_rotate, (*elevator).distance);
            camerascanned2 = true_0 as libc::c_int;
        } else if camerascanned2 == 0 {
            if t_cam2_height != -(42 as libc::c_int)
                && cv_cam2_height.value != t_cam2_height
            {
                CV_Set(
                    &mut cv_cam2_height,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        FixedToFloat(t_cam2_height) as libc::c_double,
                    ),
                );
            }
            if t_cam2_dist != -(42 as libc::c_int) && cv_cam2_dist.value != t_cam2_dist {
                CV_Set(
                    &mut cv_cam2_dist,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        FixedToFloat(t_cam2_dist) as libc::c_double,
                    ),
                );
            }
            if t_cam2_rotate != -(42 as libc::c_int)
                && cv_cam2_rotate.value != t_cam2_rotate
            {
                CV_Set(
                    &mut cv_cam2_rotate,
                    va(
                        b"%f\0" as *const u8 as *const libc::c_char,
                        t_cam2_rotate as libc::c_double,
                    ),
                );
            }
            t_cam2_rotate = -(42 as libc::c_int);
            t_cam2_height = t_cam2_rotate;
            t_cam2_dist = t_cam2_height;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn T_PlaneDisplace(mut pd: *mut planedisplace_t) {
    let mut control: *mut sector_t = 0 as *mut sector_t;
    let mut target: *mut sector_t = 0 as *mut sector_t;
    let mut direction: int32_t = 0;
    let mut diff: fixed_t = 0;
    control = &mut *sectors.offset((*pd).control as isize) as *mut sector_t;
    target = &mut *sectors.offset((*pd).affectee as isize) as *mut sector_t;
    if (*control).floorheight == (*pd).last_height {
        return;
    }
    direction = if (*control).floorheight > (*pd).last_height {
        1 as libc::c_int
    } else {
        -(1 as libc::c_int)
    };
    ...
    if (*pd).type_0 as libc::c_uint == pd_floor as libc::c_int as libc::c_uint
        || (*pd).type_0 as libc::c_uint == pd_both as libc::c_int as libc::c_uint
    {
        T_MovePlane(
            target,
            2147483647 as libc::c_int / 2 as libc::c_int,
            (*target).floorheight + diff,
            false_0 as libc::c_int,
            false_0 as libc::c_int,
            direction,
        );
    }
    if (*pd).type_0 as libc::c_uint == pd_ceiling as libc::c_int as libc::c_uint
        || (*pd).type_0 as libc::c_uint == pd_both as libc::c_int as libc::c_uint
    {
        T_MovePlane(
            target,
            2147483647 as libc::c_int / 2 as libc::c_int,
            (*target).ceilingheight + diff,
            false_0 as libc::c_int,
            true_0 as libc::c_int,
            direction,
        );
...
pub unsafe extern "C" fn EV_DoFloor(
    ...
    let mut firstone: int32_t = 1 as libc::c_int;
    let mut secnum: int32_t = -(1 as libc::c_int);
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut dofloor: *mut floormove_t = 0 as *mut floormove_t;
    let mut ICNT_1600: size_t = 0 as libc::c_int as size_t;
    loop {
        secnum = Tag_Iterate_Sectors(tag, ICNT_1600);
        if !(secnum >= 0 as libc::c_int) {
            break;
        }
        sec = &mut *sectors.offset(secnum as isize) as *mut sector_t;
        if ((*sec).floordata).is_null() {
            dofloor = Z_CallocAlign(
                ::core::mem::size_of::<floormove_t>() as libc::c_ulong,
                PU_LEVSPEC as libc::c_int,
                0 as *mut libc::c_void,
                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
            ) as *mut floormove_t;
            P_AddThinker(THINK_MAIN, &mut (*dofloor).thinker);
            (*sec).floordata = dofloor as *mut libc::c_void;
            (*dofloor)
                .thinker
                .function
            ...
            (*dofloor).type_0 = floortype;
            (*dofloor).crush = false_0 as libc::c_int as uint8_t;
            (*dofloor).sector = sec;
            (*dofloor).sourceline = line.offset_from(lines) as libc::c_long as int32_t;
            match floortype as libc::c_uint {
                0 => {
                    (*dofloor).direction = -(1 as libc::c_int);
                    (*dofloor)
                ...
                1 => {
                    (*dofloor).direction = -(1 as libc::c_int);
                    (*dofloor).speed = 2147483647 as libc::c_int / 2 as libc::c_int;
                ...
                3 => {
                    ...
                    (*dofloor)
                        .texture = if (*line).args[2 as libc::c_int as usize] != 0 {
                        (*(*line).frontsector).floorpic
                    } else {
                        -(1 as libc::c_int)
                    };
                }
                2 => {
                    (*dofloor)
                        .speed = (*line).args[2 as libc::c_int as usize]
                    ...
                    (*dofloor)
                        .texture = if (*line).args[4 as libc::c_int as usize] != 0 {
                        (*(*line).frontsector).floorpic
                    } else {
                        -(1 as libc::c_int)
                    };
                ...
                4 => {
                    if (*line).args[4 as libc::c_int as usize] != 0 {
                        ...
                        (*dofloor)
                            .speed = (*line).args[3 as libc::c_int as usize]
                            << 16 as libc::c_int - 3 as libc::c_int;
                    }
                    (*dofloor)
                        .floordestheight = (*sec).floorheight
                        + ((*line).args[2 as libc::c_int as usize] << 16 as libc::c_int);
                    if (*dofloor).floordestheight > (*sec).floorheight {
                        (*dofloor).direction = 1 as libc::c_int;
                    } else {
                        (*dofloor).direction = -(1 as libc::c_int);
                ...
                5 | 6 => {
                    ...
                    (*dofloor).delay = (*line).args[5 as libc::c_int as usize];
                    (*dofloor).delaytimer = (*line).args[4 as libc::c_int as usize];
                }
                7 => {
                    (*dofloor)
                        .origspeed = (*line).args[2 as libc::c_int as usize]
                        << 16 as libc::c_int - 2 as libc::c_int;
                    (*dofloor).speed = (*dofloor).origspeed;
        ...
        ICNT_1600 = ICNT_1600.wrapping_add(1);
        ICNT_1600;
    };
}
#[no_mangle]
pub unsafe extern "C" fn EV_DoElevator(
    mut tag: mtag_t,
    mut line: *mut line_t,
    mut elevtype: elevator_e,
) {
    let mut secnum: int32_t = -(1 as libc::c_int);
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut elevator: *mut elevator_t = 0 as *mut elevator_t;
    let mut ICNT_1737: size_t = 0 as libc::c_int as size_t;
    loop {
        secnum = Tag_Iterate_Sectors(tag, ICNT_1737);
        if !(secnum >= 0 as libc::c_int) {
            break;
        }
        sec = &mut *sectors.offset(secnum as isize) as *mut sector_t;
        if !(!((*sec).floordata).is_null() || !((*sec).ceilingdata).is_null()) {
            ...
            (*sec).floordata = elevator as *mut libc::c_void;
            (*sec).ceilingdata = elevator as *mut libc::c_void;
            (*elevator)
                .thinker
                .function
                .acp1 = ::core::mem::transmute::<
                ...
                actionf_p1,
            >(Some(T_MoveElevator as unsafe extern "C" fn(*mut elevator_t) -> ()));
            (*elevator).type_0 = elevtype;
            (*elevator).sourceline = line;
            (*elevator).distance = 1 as libc::c_int;
            (*elevator).sector = sec;
            match elevtype as libc::c_uint {
                1 => {
                    (*elevator).direction = -(1 as libc::c_int);
                    (*elevator)
                        .speed = ((1 as libc::c_int) << 16 as libc::c_int)
                ...
                2 => {
                    (*elevator)
                        .origspeed = (*line).args[1 as libc::c_int as usize]
                        << 16 as libc::c_int - 2 as libc::c_int;
                    (*elevator).speed = (*elevator).origspeed;
                    (*elevator)
                        .low = ((*line).args[4 as libc::c_int as usize] == 0)
                        as libc::c_int;
                    if (*elevator).low != 0 {
                        (*elevator).direction = 1 as libc::c_int;
                        (*elevator)
                    ...
                    (*elevator).delay = (*line).args[3 as libc::c_int as usize];
                    (*elevator).delaytimer = (*line).args[2 as libc::c_int as usize];
                }
                5 => {
                    (*elevator).direction = -(1 as libc::c_int);
                    (*elevator)
            ...
            (*elevator)
                .ceilingdestheight = (*elevator).floordestheight + (*sec).ceilingheight
                - (*sec).floorheight;
            R_CreateInterpolator_SectorPlane(
                &mut (*elevator).thinker,
                sec,
                false_0 as libc::c_int,
            );
            R_CreateInterpolator_SectorPlane(
        ...
        ICNT_1737 = ICNT_1737.wrapping_add(1);
        ICNT_1737;
    };
}
#[no_mangle]
pub unsafe extern "C" fn EV_CrumbleChain(
    mut sec: *mut sector_t,
    mut rover: *mut ffloor_t,
) {
    let mut i: size_t = 0;
    let mut leftmostvertex: size_t = 0;
    let mut rightmostvertex: size_t = 0;
    let mut topmostvertex: size_t = 0;
    let mut bottommostvertex: size_t = 0;
    let mut leftx: fixed_t = 0;
    let mut rightx: fixed_t = 0;
    let mut topy: fixed_t = 0;
    let mut bottomy: fixed_t = 0;
    let mut topz: fixed_t = 0;
    let mut bottomz: fixed_t = 0;
    let mut widthfactor: fixed_t = 0;
    let mut heightfactor: fixed_t = 0;
    let mut a: fixed_t = 0;
    let mut b: fixed_t = 0;
    let mut c: fixed_t = 0;
    let mut spacing: fixed_t = 0;
    let mut type_0: mobjtype_t = MT_NULL;
    let mut lifetime: tic_t = 0;
    let mut fromcenter: boolean = 0;
    let mut controlsec: *mut sector_t = (*(*rover).master).frontsector;
    let mut tag: mtag_t = Tag_FGet(&mut (*controlsec).tags);
    if sec.is_null() {
        if (*controlsec).numattached != 0 {
            i = 0 as libc::c_int as size_t;
            while i < (*controlsec).numattached {
                sec = &mut *sectors
                    .offset(*((*controlsec).attached).offset(i as isize) as isize)
                    as *mut sector_t;
    ...
    bottommostvertex = 0 as libc::c_int as size_t;
    topmostvertex = bottommostvertex;
    rightmostvertex = topmostvertex;
    leftmostvertex = rightmostvertex;
    heightfactor = (1 as libc::c_int) << 16 as libc::c_int;
    widthfactor = heightfactor;
    spacing = (32 as libc::c_int) << 16 as libc::c_int;
    type_0 = MT_ROCKCRUMBLE1;
    lifetime = (3 as libc::c_int * 35 as libc::c_int) as tic_t;
    fromcenter = false_0 as libc::c_int;
    if tag as libc::c_int != 0 as libc::c_int {
        let mut tagline: int32_t = Tag_FindLineSpecial(
            14 as libc::c_int as int16_t,
            tag,
        );
        if tagline != -(1 as libc::c_int) {
            if !((*lines.offset(tagline as isize)).stringargs[0 as libc::c_int as usize])
                .is_null()
            {
                type_0 = get_number(
                    (*lines.offset(tagline as isize))
                        .stringargs[0 as libc::c_int as usize],
                ) as mobjtype_t;
            }
            if (*lines.offset(tagline as isize)).args[0 as libc::c_int as usize] != 0 {
                spacing = (*lines.offset(tagline as isize))
                    .args[0 as libc::c_int as usize] << 16 as libc::c_int;
            }
            if (*lines.offset(tagline as isize)).args[1 as libc::c_int as usize] != 0 {
                lifetime = (if (*lines.offset(tagline as isize))
                    .args[1 as libc::c_int as usize] != -(1 as libc::c_int)
                {
                    (*lines.offset(tagline as isize)).args[1 as libc::c_int as usize]
                } else {
                    0 as libc::c_int
                }) as tic_t;
            }
            fromcenter = ((*lines.offset(tagline as isize))
                .args[2 as libc::c_int as usize] != 0) as libc::c_int;
        }
    }
    (*sec)
        .soundorg
        .z = ((*controlsec).floorheight + (*controlsec).ceilingheight)
        / 2 as libc::c_int;
    S_StartSound(
        &mut (*sec).soundorg as *mut degenmobj_t as *const libc::c_void,
        mobjinfo[type_0 as usize].activesound,
    );
    i = 0 as libc::c_int as size_t;
    while i < (*sec).linecount {
        if (*(**((*sec).lines).offset(i as isize)).v1).x
            < (*(**((*sec).lines).offset(leftmostvertex as isize)).v1).x
        {
            leftmostvertex = i;
        }
        if (*(**((*sec).lines).offset(i as isize)).v1).x
            > (*(**((*sec).lines).offset(rightmostvertex as isize)).v1).x
        {
            rightmostvertex = i;
        }
        if (*(**((*sec).lines).offset(i as isize)).v1).y
            > (*(**((*sec).lines).offset(topmostvertex as isize)).v1).y
        {
            topmostvertex = i;
        }
        if (*(**((*sec).lines).offset(i as isize)).v1).y
            < (*(**((*sec).lines).offset(bottommostvertex as isize)).v1).y
        {
            bottommostvertex = i;
        }
        i = i.wrapping_add(1);
    ...
    leftx = (*(**((*sec).lines).offset(leftmostvertex as isize)).v1).x
        + (spacing >> 1 as libc::c_int);
    rightx = (*(**((*sec).lines).offset(rightmostvertex as isize)).v1).x;
    topy = (*(**((*sec).lines).offset(topmostvertex as isize)).v1).y
        - (spacing >> 1 as libc::c_int);
    bottomy = (*(**((*sec).lines).offset(bottommostvertex as isize)).v1).y;
    topz = *(*rover).topheight - (spacing >> 1 as libc::c_int);
    bottomz = *(*rover).bottomheight;
    if fromcenter != 0 {
        widthfactor = rightx + topy - leftx - bottomy >> 3 as libc::c_int;
        heightfactor = topz - *(*rover).bottomheight >> 2 as libc::c_int;
    }
    a = leftx;
    while a < rightx {
        b = topy;
        while b > bottomy {
            if (*R_PointInSubsector(a, b)).sector == sec {
                ...
                if !(*(*rover).t_slope).is_null() {
                    topz = P_GetSlopeZAt(*(*rover).t_slope, a, b)
                        - (spacing >> 1 as libc::c_int);
                }
                if !(*(*rover).b_slope).is_null() {
                    bottomz = P_GetSlopeZAt(*(*rover).b_slope, a, b);
                }
                c = topz;
                while c > bottomz {
                    spawned = P_SpawnMobj(a, b, c, type_0);
                    (*spawned)
                        .angle = ((*spawned).angle)
                        .wrapping_add(
                    ...
                    if fromcenter != 0 {
                        P_InstaThrust(
                            spawned,
                            R_PointToAngle2((*sec).soundorg.x, (*sec).soundorg.y, a, b),
                            FixedDiv(
                                P_AproxDistance(
                                    a - (*sec).soundorg.x,
                                    b - (*sec).soundorg.y,
                        ...
                        P_SetObjectMomZ(
                            spawned,
                            FixedDiv(c - bottomz, heightfactor),
                            false_0 as libc::c_int,
                        );
                    }
                    (*spawned).fuse = lifetime as int32_t;
                    c -= spacing;
                }
            }
            b -= spacing;
    ...
    (*rover)
        ...
        libc::c_uint,
        ffloortype_e,
    >((*rover).fofflags as libc::c_uint & !(FOF_EXISTS as libc::c_int) as libc::c_uint);
    (*(*(*rover).master).frontsector).moved = true_0 as libc::c_int;
    P_RecalcPrecipInSector(sec);
}
#[no_mangle]
pub unsafe extern "C" fn EV_BounceSector(
    mut sec: *mut sector_t,
    mut momz: fixed_t,
    mut sourceline: *mut line_t,
) {
    let mut bouncer: *mut bouncecheese_t = 0 as *mut bouncecheese_t;
    if !((*sec).ceilingdata).is_null() {
        return;
    }
    bouncer = Z_CallocAlign(
        ::core::mem::size_of::<bouncecheese_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut bouncecheese_t;
    P_AddThinker(THINK_MAIN, &mut (*bouncer).thinker);
    (*sec).ceilingdata = bouncer as *mut libc::c_void;
    (*bouncer)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut bouncecheese_t) -> ()>,
        actionf_p1,
    >(Some(T_BounceCheese as unsafe extern "C" fn(*mut bouncecheese_t) -> ()));
    (*bouncer).sourceline = sourceline;
    (*bouncer).sector = sec;
    (*bouncer).speed = momz / 2 as libc::c_int;
    (*bouncer).distance = (1 as libc::c_int) << 16 as libc::c_int;
    (*bouncer).low = true_0 as libc::c_int;
    R_CreateInterpolator_SectorPlane(
        &mut (*bouncer).thinker,
        sec,
        false_0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoContinuousFall(
    mut sec: *mut sector_t,
    mut backsector: *mut sector_t,
    mut spd: fixed_t,
    mut backwards: boolean,
) {
    let mut faller: *mut continuousfall_t = 0 as *mut continuousfall_t;
    if backsector.is_null() {
        backsector = sec;
    }
    faller = Z_CallocAlign(
        ::core::mem::size_of::<continuousfall_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut continuousfall_t;
    P_AddThinker(THINK_MAIN, &mut (*faller).thinker);
    (*faller)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut continuousfall_t) -> ()>,
        actionf_p1,
    >(Some(T_ContinuousFalling as unsafe extern "C" fn(*mut continuousfall_t) -> ()));
    (*faller).sector = sec;
    (*faller).speed = spd;
    (*faller).floorstartheight = (*sec).floorheight;
    (*faller).ceilingstartheight = (*sec).ceilingheight;
    (*faller)
        .destheight = if backwards != 0 {
        (*backsector).ceilingheight
    } else {
        (*backsector).floorheight
    };
    (*faller)
        .direction = if backwards != 0 { 1 as libc::c_int } else { -(1 as libc::c_int) };
    R_CreateInterpolator_SectorPlane(
        &mut (*faller).thinker,
        sec,
        false_0 as libc::c_int,
    );
    R_CreateInterpolator_SectorPlane(&mut (*faller).thinker, sec, true_0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EV_StartCrumble(
    mut sec: *mut sector_t,
    mut rover: *mut ffloor_t,
    mut floating: boolean,
    mut player: *mut player_t,
    mut origalpha: fixed_t,
    mut crumblereturn: boolean,
) -> int32_t {
    let mut crumble: *mut crumble_t = 0 as *mut crumble_t;
    let mut foundsec: *mut sector_t = 0 as *mut sector_t;
    let mut i: int32_t = 0;
    let mut tag: mtag_t = (*(*rover).master).args[0 as libc::c_int as usize] as mtag_t;
    if !((*sec).floordata).is_null() {
        return 0 as libc::c_int;
    }
    if (*sec).crumblestate >= CRUMBLE_ACTIVATED as libc::c_int {
        return 0 as libc::c_int;
    }
    crumble = Z_CallocAlign(
        ::core::mem::size_of::<crumble_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut crumble_t;
    P_AddThinker(THINK_MAIN, &mut (*crumble).thinker);
    (*crumble)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        ...
        actionf_p1,
    >(Some(T_StartCrumble as unsafe extern "C" fn(*mut crumble_t) -> ()));
    (*crumble).sector = sec;
    (*crumble).speed = 0 as libc::c_int;
    if !player.is_null() && !((*player).mo).is_null()
        && (*(*player).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
    {
        (*crumble).direction = 1 as libc::c_int;
        (*crumble)
            .flags = ((*crumble).flags as libc::c_int | CF_REVERSE as libc::c_int)
            as uint8_t;
    } else {
        (*crumble).direction = -(1 as libc::c_int);
    }
    ...
    (*crumble).timer = 35 as libc::c_int;
    (*crumble).player = player;
    (*crumble).origalpha = origalpha;
    (*crumble).sourceline = (*rover).master;
    (*sec).floordata = crumble as *mut libc::c_void;
    if crumblereturn != 0 {
        (*crumble)
            .flags = ((*crumble).flags as libc::c_int | CF_RETURN as libc::c_int)
            as uint8_t;
    }
    if floating != 0 {
        (*crumble)
            .flags = ((*crumble).flags as libc::c_int | CF_FLOATBOB as libc::c_int)
            as uint8_t;
    }
    (*(*crumble).sector).crumblestate = CRUMBLE_ACTIVATED as libc::c_int;
    R_CreateInterpolator_SectorPlane(
        &mut (*crumble).thinker,
        sec,
        false_0 as libc::c_int,
    ...
    loop {
        i = Tag_Iterate_Sectors(tag, ICNT_2053);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        foundsec = &mut *sectors.offset(i as isize) as *mut sector_t;
        P_SpawnMobj(
            (*foundsec).soundorg.x,
            (*foundsec).soundorg.y,
            if (*crumble).direction == 1 as libc::c_int {
                (*(*crumble).sector).floorheight
            } else {
                (*(*crumble).sector).ceilingheight
            },
...
#[no_mangle]
pub unsafe extern "C" fn EV_MarioBlock(
    mut rover: *mut ffloor_t,
    mut sector: *mut sector_t,
    mut puncher: *mut mobj_t,
) {
    let mut roversec: *mut sector_t = (*(*rover).master).frontsector;
    let mut topheight: fixed_t = *(*rover).topheight;
    let mut block: *mut mariothink_t = 0 as *mut mariothink_t;
    let mut thing: *mut mobj_t = 0 as *mut mobj_t;
    let mut oldx: fixed_t = 0 as libc::c_int;
    let mut oldy: fixed_t = 0 as libc::c_int;
    let mut oldz: fixed_t = 0 as libc::c_int;
    if !((*roversec).floordata).is_null() || !((*roversec).ceilingdata).is_null() {
        return;
    }
    if (*rover).fofflags as libc::c_uint & FOF_SOLID as libc::c_int as libc::c_uint == 0
    {
        (*rover)
            .fofflags = ::core::mem::transmute::<
            libc::c_uint,
    ...
    if thing.is_null() {
        S_StartSound(puncher as *const libc::c_void, sfx_mario1);
    } else {
        let itsamonitor: boolean = ((*thing).flags
            & MF_MONITOR as libc::c_int as uint32_t
            == MF_MONITOR as libc::c_int as uint32_t) as libc::c_int;
        block = Z_CallocAlign(
            ::core::mem::size_of::<mariothink_t>() as libc::c_ulong,
            PU_LEVSPEC as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut mariothink_t;
        P_AddThinker(THINK_MAIN, &mut (*block).thinker);
        (*roversec).floordata = block as *mut libc::c_void;
        (*roversec).ceilingdata = block as *mut libc::c_void;
        (*block)
            .thinker
            .function
            .acp1 = ::core::mem::transmute::<
            Option::<unsafe extern "C" fn(*mut mariothink_t) -> ()>,
            actionf_p1,
        >(Some(T_MarioBlock as unsafe extern "C" fn(*mut mariothink_t) -> ()));
        (*block).sector = roversec;
        (*block).speed = 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
        (*block).direction = 1 as libc::c_int;
        (*block).floorstartheight = (*(*block).sector).floorheight;
        (*block).ceilingstartheight = (*(*block).sector).ceilingheight;
        (*block).tag = (*(*rover).master).args[0 as libc::c_int as usize] as int16_t;
        R_CreateInterpolator_SectorPlane(
            &mut (*block).thinker,
            roversec,
            false_0 as libc::c_int,
        ...
        (*thing).old_x = (*sector).soundorg.x;
        (*thing).x = (*thing).old_x;
        (*thing).old_y = (*sector).soundorg.y;
        (*thing).y = (*thing).old_y;
        (*thing).old_z = topheight;
        (*thing).z = (*thing).old_z;
        (*thing)
            .momz = FixedMul(
            6 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
        ...
        if (*thing).flags & MF_SHOOTABLE as libc::c_int as uint32_t != 0 {
            ...
            || (*thing).type_0 as libc::c_uint == MT_COIN as libc::c_int as libc::c_uint
            || (*thing).type_0 as libc::c_uint == MT_TOKEN as libc::c_int as libc::c_uint
        {
            (*thing)
                .momz = FixedMul(
                3 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
            ...
            P_TouchSpecialThing(thing, puncher, false_0 as libc::c_int);
            S_StartSound(puncher as *const libc::c_void, sfx_mario1);
        } else {
            S_StartSound(puncher as *const libc::c_void, sfx_mario9);
        }
        if itsamonitor != 0 && !thing.is_null() {
            P_UnsetThingPosition(thing);
            (*thing).old_x = oldx;
            (*thing).x = (*thing).old_x;
            (*thing).old_y = oldy;
            ...
            (*thing).old_z = oldz;
            (*thing).z = (*thing).old_z;
            (*thing).momx = 1 as libc::c_int;
            (*thing).momy = 1 as libc::c_int;
            P_SetThingPosition(thing);
        }
    };
}
