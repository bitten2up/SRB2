...
pub const polyobj_translucency: polyobj_e = 10;
pub const polyobj_flags: polyobj_e = 9;
pub const polyobj_parent: polyobj_e = 2;
pub type polyobj_e = libc::c_uint;
pub const polyobj_rotate: polyobj_e = 16;
pub const polyobj_moveXY: polyobj_e = 15;
pub const polyobj_mobjInside: polyobj_e = 14;
pub const polyobj_mobjTouching: polyobj_e = 13;
pub const polyobj_pointInside: polyobj_e = 12;
pub const polyobj_triggertag: polyobj_e = 11;
pub const polyobj_thrust: polyobj_e = 8;
pub const polyobj_damage: polyobj_e = 7;
pub const polyobj_angle: polyobj_e = 6;
pub const polyobj_sector: polyobj_e = 5;
pub const polyobj_lines: polyobj_e = 4;
pub const polyobj_vertices: polyobj_e = 3;
pub const polyobj_id: polyobj_e = 1;
pub const polyobj_valid: polyobj_e = 0;
#[inline(always)]
...
static mut polyobj_opt: [*const libc::c_char; 18] = [
    ...
    b"vertices\0" as *const u8 as *const libc::c_char,
    ...
    b"thrust\0" as *const u8 as *const libc::c_char,
    b"flags\0" as *const u8 as *const libc::c_char,
    b"translucency\0" as *const u8 as *const libc::c_char,
    b"triggertag\0" as *const u8 as *const libc::c_char,
    b"pointInside\0" as *const u8 as *const libc::c_char,
    b"mobjTouching\0" as *const u8 as *const libc::c_char,
    b"mobjInside\0" as *const u8 as *const libc::c_char,
    b"moveXY\0" as *const u8 as *const libc::c_char,
    b"rotate\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn polyobjvertices_get(mut L: *mut lua_State) -> libc::c_int {
    let mut polyverts: *mut *mut *mut vertex_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*VERTICES\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut *mut *mut vertex_t);
    let mut i: size_t = 0;
    let mut numofverts: size_t = 0 as libc::c_int as size_t;
    ...
    if lua_isnumber(L, 2 as libc::c_int) == 0 {
        ...
        if polyverts.is_null() || (*polyverts).is_null() {
            ...
            return luaL_error(
                L,
                b"accessed polyobj_t.vertices doesn't exist anymore.\0" as *const u8
    ...
    numofverts = *((polyverts as intptr_t as libc::c_ulong)
        .wrapping_sub(88 as libc::c_ulong)
        .wrapping_add(56 as libc::c_ulong) as *mut libc::c_void as *mut size_t);
    if numofverts == 0 {
        return luaL_error(
            L,
            b"no vertices found!\0" as *const u8 as *const libc::c_char,
        );
    }
    ...
    LUA_PushUserdata(
        L,
        *(*polyverts).offset(i as isize) as *mut libc::c_void,
        b"VERTEX_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn polyobjvertices_num(mut L: *mut lua_State) -> libc::c_int {
    let mut polyverts: *mut *mut *mut vertex_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*VERTICES\0" as *const u8 as *const libc::c_char,
    ...
    numofverts = *((polyverts as intptr_t as libc::c_ulong)
        .wrapping_sub(88 as libc::c_ulong)
        .wrapping_add(56 as libc::c_ulong) as *mut libc::c_void as *mut size_t);
    lua_pushnumber(L, numofverts as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn polyobjlines_get(mut L: *mut lua_State) -> libc::c_int {
    let mut polylines: *mut *mut *mut line_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*LINES\0" as *const u8 as *const libc::c_char,
    ...
    if lua_isnumber(L, 2 as libc::c_int) == 0 {
        ...
        if polylines.is_null() || (*polylines).is_null() {
            if field == 0 as libc::c_int {
                lua_pushboolean(L, 0 as libc::c_int);
                return 1 as libc::c_int;
            }
            return luaL_error(
                L,
                b"accessed polyobj_t.lines doesn't exist anymore.\0" as *const u8
                    as *const libc::c_char,
            );
        } else if field == 0 as libc::c_int {
            lua_pushboolean(L, 1 as libc::c_int);
    ...
    numoflines = *((polylines as intptr_t as libc::c_ulong)
        .wrapping_sub(112 as libc::c_ulong)
        .wrapping_add(96 as libc::c_ulong) as *mut libc::c_void as *mut size_t);
    if numoflines == 0 {
    ...
    LUA_PushUserdata(
        L,
        *(*polylines).offset(i as isize) as *mut libc::c_void,
        b"LINE_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn polyobjlines_num(mut L: *mut lua_State) -> libc::c_int {
    let mut polylines: *mut *mut *mut line_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*LINES\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_polyobj_PointInside(mut L: *mut lua_State) -> libc::c_int {
    let mut po: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    if po.is_null() {
        return luaL_error(
            L,
            b"accessed polyobj_t doesn't exist anymore, please check 'valid' before using polyobj_t.\0"
...
unsafe extern "C" fn lib_polyobj_MobjTouching(mut L: *mut lua_State) -> libc::c_int {
    let mut po: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_polyobj_MobjInside(mut L: *mut lua_State) -> libc::c_int {
    let mut po: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_polyobj_moveXY(mut L: *mut lua_State) -> libc::c_int {
    let mut po: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut x: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut checkmobjs: boolean = (lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int
...
unsafe extern "C" fn lib_polyobj_rotate(mut L: *mut lua_State) -> libc::c_int {
    let mut po: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut polyobj_t);
    let mut delta: angle_t = luaL_checknumber(L, 2 as libc::c_int) as angle_t;
    let mut turnplayers: boolean = (lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    let mut turnothers: boolean = (lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 4 as libc::c_int) != 0) as libc::c_int;
    let mut checkmobjs: boolean = (lua_type(L, 5 as libc::c_int) <= 0 as libc::c_int
...
unsafe extern "C" fn polyobj_get(mut L: *mut lua_State) -> libc::c_int {
    let mut polyobj: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut polyobj_t);
    let mut field: polyobj_e = luaL_checkoption(
        L,
        2 as libc::c_int,
        0 as *const libc::c_char,
        polyobj_opt.as_ptr(),
    ...
    if polyobj.is_null() {
        if field as libc::c_uint == polyobj_valid as libc::c_int as libc::c_uint {
    ...
    match field as libc::c_uint {
        ...
        1 => {
            lua_pushnumber(L, (*polyobj).id);
        }
        2 => {
            lua_pushnumber(L, (*polyobj).parent);
        }
        3 => {
            LUA_PushUserdata(
                L,
                &mut (*polyobj).vertices as *mut *mut *mut vertex_t as *mut libc::c_void,
                b"POLYOBJ_T*VERTICES\0" as *const u8 as *const libc::c_char,
            );
        }
        4 => {
            LUA_PushUserdata(
                L,
                &mut (*polyobj).lines as *mut *mut *mut line_s as *mut libc::c_void,
                b"POLYOBJ_T*LINES\0" as *const u8 as *const libc::c_char,
            );
        }
        5 => {
            LUA_PushUserdata(
                L,
                (**((*polyobj).lines).offset(0 as libc::c_int as isize)).backsector
                    as *mut libc::c_void,
                b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        6 => {
            lua_pushnumber(L, (*polyobj).angle as lua_Number);
        }
        7 => {
            lua_pushnumber(L, (*polyobj).damage);
        }
        8 => {
            lua_pushnumber(L, (*polyobj).thrust);
        }
        9 => {
            lua_pushnumber(L, (*polyobj).flags);
        }
        10 => {
            lua_pushnumber(L, (*polyobj).translucency);
        }
        11 => {
            lua_pushnumber(L, (*polyobj).triggertag as lua_Number);
        }
        12 => {
            lua_pushcclosure(
                L,
                Some(
                    lib_polyobj_PointInside
...
unsafe extern "C" fn polyobj_set(mut L: *mut lua_State) -> libc::c_int {
    let mut polyobj: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter polyobj_t in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    match field as libc::c_uint {
        6 => {
            return luaL_error(
                L,
                b"'polyobj_t' field '%s' should not be set directly. Use the function 'polyobj:rotate(angle)' instead.\0"
                    as *const u8 as *const libc::c_char,
                polyobj_opt[field as usize],
            );
        }
        2 => {
            (*polyobj).parent = luaL_checknumber(L, 3 as libc::c_int);
        }
        9 => {
            (*polyobj).flags = luaL_checknumber(L, 3 as libc::c_int);
        }
        10 => {
            (*polyobj).translucency = luaL_checknumber(L, 3 as libc::c_int);
        }
        _ => {
            return luaL_error(
                L,
                b"'polyobj_t' field '%s' cannot be modified.\0" as *const u8
                    as *const libc::c_char,
                polyobj_opt[field as usize],
            );
        }
...
unsafe extern "C" fn polyobj_num(mut L: *mut lua_State) -> libc::c_int {
    let mut polyobj: *mut polyobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    if polyobj.is_null() {
        return luaL_error(
            L,
            b"accessed polyobj_t doesn't exist anymore.\0" as *const u8
                as *const libc::c_char,
        );
    }
    lua_pushnumber(L, polyobj.offset_from(PolyObjects) as libc::c_long as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_iteratePolyObjects(mut L: *mut lua_State) -> libc::c_int {
    let mut i: int32_t = -(1 as libc::c_int);
    if lua_gettop(L) < 2 as libc::c_int {
        lua_pushcclosure(
            L,
            Some(
                lib_iteratePolyObjects
                    as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
            ),
            0 as libc::c_int,
        );
    ...
    if !(lua_type(L, 1 as libc::c_int) == 0 as libc::c_int) {
        i = (*(luaL_checkudata(
            ...
            .offset_from(PolyObjects) as libc::c_long as int32_t;
    }
    i += 1;
    i;
    if i < numPolyObjects {
...
unsafe extern "C" fn lib_PolyObject_getfornum(mut L: *mut lua_State) -> libc::c_int {
    let mut id: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    if numPolyObjects == 0 {
        return 0 as libc::c_int;
    }
    LUA_PushUserdata(
        L,
        Polyobj_GetForNum(id) as *mut libc::c_void,
        b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getPolyObject(mut L: *mut lua_State) -> libc::c_int {
    ...
    if lua_type(L, 2 as libc::c_int) == 3 as libc::c_int {
        ...
        if i < 0 as libc::c_int || i >= numPolyObjects {
            return luaL_error(
                L,
                b"polyobjects[] index %d out of range (0 - %d)\0" as *const u8
                    as *const libc::c_char,
                i,
                numPolyObjects - 1 as libc::c_int,
            );
        }
        LUA_PushUserdata(
            L,
    ...
    if fastcmp(field, b"iterate\0" as *const u8 as *const libc::c_char) != 0 {
        ...
        return 1 as libc::c_int;
    } else if fastcmp(field, b"GetForNum\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushcclosure(
            L,
            Some(
                lib_PolyObject_getfornum
                    as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
            ),
            0 as libc::c_int,
        );
...
unsafe extern "C" fn lib_numPolyObjects(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, numPolyObjects);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_PolyObjLib(mut L: *mut lua_State) -> libc::c_int {
    luaL_newmetatable(L, b"POLYOBJ_T*VERTICES\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(polyobjvertices_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(polyobjvertices_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"POLYOBJ_T*LINES\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(polyobjlines_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(polyobjlines_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(polyobj_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(polyobj_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(polyobj_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    ...
    lua_pushcclosure(
        L,
        Some(lib_getPolyObject as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_numPolyObjects as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    ...
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"polyobjects\0" as *const u8 as *const libc::c_char,
    );
    return 0 as libc::c_int;
}
