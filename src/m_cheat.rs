...
extern "C" {
    ...
    fn P_TransferToAxis(player: *mut player_t, axisnum: int32_t);
    fn P_GetMobjtype(mthingtype: uint16_t) -> mobjtype_t;
    ...
    fn M_ForceSaveSlotSelected(sslot: int32_t);
    static mut SP_LoadDef: menu_t;
    static mut ultimate_selectable: int32_t;
    fn M_StartControlPanel();
    static mut currentMenu: *mut menu_t;
...
pub const MFE_REVERSESUPER: C2RustUnnamed_4 = 12288;
pub const MFE_FORCENOSUPER: C2RustUnnamed_4 = 8192;
pub const MFE_FORCESUPER: C2RustUnnamed_4 = 4096;
pub const MFE_TRACERANGLE: C2RustUnnamed_4 = 2048;
pub const MFE_APPLYPMOMZ: C2RustUnnamed_4 = 1024;
pub const MFE_SPRUNG: C2RustUnnamed_4 = 512;
pub const MFE_PUSHED: C2RustUnnamed_4 = 256;
pub const MFE_TOUCHLAVA: C2RustUnnamed_4 = 128;
pub const MFE_GOOWATER: C2RustUnnamed_4 = 64;
pub const MFE_VERTICALFLIP: C2RustUnnamed_4 = 32;
pub const MFE_JUSTSTEPPEDDOWN: C2RustUnnamed_4 = 16;
pub const MFE_UNDERWATER: C2RustUnnamed_4 = 8;
pub const MFE_TOUCHWATER: C2RustUnnamed_4 = 4;
pub const MFE_JUSTHITFLOOR: C2RustUnnamed_4 = 2;
pub const MFE_ONGROUND: C2RustUnnamed_4 = 1;
pub type C2RustUnnamed_5 = libc::c_uint;
pub const BT_CUSTOM3: C2RustUnnamed_5 = 32768;
pub const BT_CUSTOM2: C2RustUnnamed_5 = 16384;
pub const BT_CUSTOM1: C2RustUnnamed_5 = 8192;
pub const BT_FIRENORMAL: C2RustUnnamed_5 = 4096;
pub const BT_JUMP: C2RustUnnamed_5 = 2048;
pub const BT_TOSSFLAG: C2RustUnnamed_5 = 1024;
pub const BT_CAMRIGHT: C2RustUnnamed_5 = 512;
pub const BT_CAMLEFT: C2RustUnnamed_5 = 256;
pub const BT_SPIN: C2RustUnnamed_5 = 128;
pub const BT_ATTACK: C2RustUnnamed_5 = 64;
pub const BT_WEAPONPREV: C2RustUnnamed_5 = 32;
pub const BT_WEAPONNEXT: C2RustUnnamed_5 = 16;
pub const BT_WEAPONMASK: C2RustUnnamed_5 = 15;
...
pub struct cheatseq_t {
    pub p: *mut uint8_t,
    pub func: Option::<unsafe extern "C" fn() -> uint8_t>,
    pub sequence: [uint8_t; 0],
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const THINK_MOBJ: C2RustUnnamed_8 = 2;
pub const PU_LEVEL: C2RustUnnamed_9 = 50;
pub type subsector_t = subsector_s;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const NUM_THINKERLISTS: C2RustUnnamed_8 = 5;
pub const THINK_PRECIP: C2RustUnnamed_8 = 4;
pub const THINK_DYNSLOPE: C2RustUnnamed_8 = 3;
pub const THINK_MAIN: C2RustUnnamed_8 = 1;
pub const THINK_POLYOBJ: C2RustUnnamed_8 = 0;
...
unsafe extern "C" fn cheatf_ultimate() -> uint8_t {
    if menuactive != 0
        && (currentMenu != &mut MainDef as *mut menu_t
            && currentMenu != &mut SP_LoadDef as *mut menu_t)
    {
    ...
    ultimate_selectable = (ultimate_selectable == 0) as libc::c_int;
    if currentMenu == &mut SP_LoadDef as *mut menu_t {
        M_ForceSaveSlotSelected(0 as libc::c_int);
    }
    return 1 as libc::c_int as uint8_t;
}
unsafe extern "C" fn cheatf_warp() -> uint8_t {
    if menuactive != 0 && currentMenu != &mut MainDef as *mut menu_t {
        return 0 as libc::c_int as uint8_t;
    }
    S_StartSound(0 as *const libc::c_void, sfx_itemup);
    G_SetUsedCheats(false_0 as libc::c_int);
    (*clientGamedata).unlocked[31 as libc::c_int as usize] = true_0 as libc::c_int;
    (*clientGamedata).unlocked[30 as libc::c_int as usize] = true_0 as libc::c_int;
    (*clientGamedata).unlocked[28 as libc::c_int as usize] = true_0 as libc::c_int;
    M_ClearMenus(true_0 as libc::c_int);
    M_StartControlPanel();
    return 1 as libc::c_int as uint8_t;
}
static mut cheat_ultimate: cheatseq_t = unsafe {
    {
        let mut init = cheatseq_t {
            p: 0 as *const uint8_t as *mut uint8_t,
            func: Some(cheatf_ultimate as unsafe extern "C" fn() -> uint8_t),
            sequence: [
                ((('u' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('u' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('u' as i32 & 4 as libc::c_int)
                    + (('u' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('u' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('u' as i32 & 32 as libc::c_int)
                    + (('u' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('u' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('l' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('l' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('l' as i32 & 4 as libc::c_int)
                    + (('l' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('l' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('l' as i32 & 32 as libc::c_int)
                    + (('l' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('l' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('t' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('t' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('t' as i32 & 4 as libc::c_int)
                    + (('t' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('t' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('t' as i32 & 32 as libc::c_int)
                    + (('t' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('t' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('i' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('i' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('i' as i32 & 4 as libc::c_int)
                    + (('i' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('i' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('i' as i32 & 32 as libc::c_int)
                    + (('i' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('i' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('m' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('m' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('m' as i32 & 4 as libc::c_int)
                    + (('m' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('m' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('m' as i32 & 32 as libc::c_int)
                    + (('m' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('m' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('a' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('a' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('a' as i32 & 4 as libc::c_int)
                    + (('a' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('a' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('a' as i32 & 32 as libc::c_int)
                    + (('a' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('a' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('t' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('t' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('t' as i32 & 4 as libc::c_int)
                    ...
                    + (('t' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('e' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('e' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('e' as i32 & 4 as libc::c_int)
                    + (('e' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('e' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('e' as i32 & 32 as libc::c_int)
                    + (('e' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('e' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
...
static mut cheat_ultimate_joy: cheatseq_t = unsafe {
    {
        let mut init = cheatseq_t {
            p: 0 as *const uint8_t as *mut uint8_t,
            func: Some(cheatf_ultimate as unsafe extern "C" fn() -> uint8_t),
            sequence: [
                (((0x80 as libc::c_int + 102 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 2 as libc::c_int)
                        << 5 as libc::c_int)
                    + (0x80 as libc::c_int + 102 as libc::c_int & 4 as libc::c_int)
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 8 as libc::c_int)
                        << 1 as libc::c_int)
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 16 as libc::c_int)
                        >> 1 as libc::c_int)
                    + (0x80 as libc::c_int + 102 as libc::c_int & 32 as libc::c_int)
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 64 as libc::c_int)
                        >> 5 as libc::c_int)
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 128 as libc::c_int)
                ...
                (((0x80 as libc::c_int + 102 as libc::c_int & 1 as libc::c_int)
                    ...
                    + ((0x80 as libc::c_int + 102 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((0x80 as libc::c_int + 110 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 2 as libc::c_int)
                        << 5 as libc::c_int)
                    + (0x80 as libc::c_int + 110 as libc::c_int & 4 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 8 as libc::c_int)
                        << 1 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 16 as libc::c_int)
                        >> 1 as libc::c_int)
                    + (0x80 as libc::c_int + 110 as libc::c_int & 32 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 64 as libc::c_int)
                        >> 5 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((0x80 as libc::c_int + 110 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 2 as libc::c_int)
                    ...
                    + ((0x80 as libc::c_int + 110 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((0x80 as libc::c_int + 105 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 2 as libc::c_int)
                        << 5 as libc::c_int)
                    + (0x80 as libc::c_int + 105 as libc::c_int & 4 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 8 as libc::c_int)
                        << 1 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 16 as libc::c_int)
                        >> 1 as libc::c_int)
                    + (0x80 as libc::c_int + 105 as libc::c_int & 32 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 64 as libc::c_int)
                        >> 5 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((0x80 as libc::c_int + 107 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 2 as libc::c_int)
                        << 5 as libc::c_int)
                    + (0x80 as libc::c_int + 107 as libc::c_int & 4 as libc::c_int)
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 8 as libc::c_int)
                        << 1 as libc::c_int)
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 16 as libc::c_int)
                        >> 1 as libc::c_int)
                    + (0x80 as libc::c_int + 107 as libc::c_int & 32 as libc::c_int)
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 64 as libc::c_int)
                        >> 5 as libc::c_int)
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((0x80 as libc::c_int + 105 as libc::c_int & 1 as libc::c_int)
                    << 7 as libc::c_int)
                    + ((0x80 as libc::c_int + 105 as libc::c_int & 2 as libc::c_int)
                ...
                (((0x80 as libc::c_int + 107 as libc::c_int & 1 as libc::c_int)
                    ...
                    + ((0x80 as libc::c_int + 107 as libc::c_int & 128 as libc::c_int)
                        >> 7 as libc::c_int)) as uint8_t,
                (((13 as libc::c_int & 1 as libc::c_int) << 7 as libc::c_int)
                    + ((13 as libc::c_int & 2 as libc::c_int) << 5 as libc::c_int)
                    + (13 as libc::c_int & 4 as libc::c_int)
                    + ((13 as libc::c_int & 8 as libc::c_int) << 1 as libc::c_int)
                    + ((13 as libc::c_int & 16 as libc::c_int) >> 1 as libc::c_int)
                    + (13 as libc::c_int & 32 as libc::c_int)
                    + ((13 as libc::c_int & 64 as libc::c_int) >> 5 as libc::c_int)
                    + ((13 as libc::c_int & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                0xff as libc::c_int as uint8_t,
            ],
        };
...
static mut cheat_warp: cheatseq_t = unsafe {
    {
        let mut init = cheatseq_t {
            p: 0 as *const uint8_t as *mut uint8_t,
            func: Some(cheatf_warp as unsafe extern "C" fn() -> uint8_t),
            sequence: [
                ((('c' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('c' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('c' as i32 & 4 as libc::c_int)
                    + (('c' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('c' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('c' as i32 & 32 as libc::c_int)
                    + (('c' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('c' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('a' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('a' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('a' as i32 & 4 as libc::c_int)
                    ...
                    + (('a' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('s' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('s' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('s' as i32 & 4 as libc::c_int)
                    + (('s' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('s' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('s' as i32 & 32 as libc::c_int)
                    + (('s' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('s' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('h' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('h' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('h' as i32 & 4 as libc::c_int)
                    + (('h' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('h' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('h' as i32 & 32 as libc::c_int)
                    + (('h' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('h' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('r' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('r' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('r' as i32 & 4 as libc::c_int)
                    + (('r' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('r' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('r' as i32 & 32 as libc::c_int)
                    + (('r' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('r' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('i' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('i' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('i' as i32 & 4 as libc::c_int)
                    ...
                    + (('i' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('d' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('d' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('d' as i32 & 4 as libc::c_int)
                    + (('d' as i32 & 8 as libc::c_int) << 1 as libc::c_int)
                    + (('d' as i32 & 16 as libc::c_int) >> 1 as libc::c_int)
                    + ('d' as i32 & 32 as libc::c_int)
                    + (('d' as i32 & 64 as libc::c_int) >> 5 as libc::c_int)
                    + (('d' as i32 & 128 as libc::c_int) >> 7 as libc::c_int))
                    as uint8_t,
                ((('a' as i32 & 1 as libc::c_int) << 7 as libc::c_int)
                    + (('a' as i32 & 2 as libc::c_int) << 5 as libc::c_int)
                    + ('a' as i32 & 4 as libc::c_int)
...
static mut cheat_warp_joy: cheatseq_t = unsafe {
    {
        let mut init = cheatseq_t {
            p: 0 as *const uint8_t as *mut uint8_t,
            func: Some(cheatf_warp as unsafe extern "C" fn() -> uint8_t),
...
static mut cheat_xlate_table: [uint8_t; 256] = [0; 256];
#[no_mangle]
pub unsafe extern "C" fn cht_Init() {
    let mut i: size_t = 0 as libc::c_int as size_t;
    let mut pi: int16_t = 0 as libc::c_int as int16_t;
    while i < 256 as libc::c_int as size_t {
        let cc: int32_t = ((pi as libc::c_int & 1 as libc::c_int) << 7 as libc::c_int)
            + ((pi as libc::c_int & 2 as libc::c_int) << 5 as libc::c_int)
            + (pi as libc::c_int & 4 as libc::c_int)
            + ((pi as libc::c_int & 8 as libc::c_int) << 1 as libc::c_int)
            + ((pi as libc::c_int & 16 as libc::c_int) >> 1 as libc::c_int)
            + (pi as libc::c_int & 32 as libc::c_int)
            + ((pi as libc::c_int & 64 as libc::c_int) >> 5 as libc::c_int)
            + ((pi as libc::c_int & 128 as libc::c_int) >> 7 as libc::c_int);
        cheat_xlate_table[i as usize] = cc as uint8_t;
        i = i.wrapping_add(1);
        i;
        pi += 1;
        pi;
...
unsafe extern "C" fn cht_CheckCheat(
    mut cht: *mut cheatseq_t,
    mut key: libc::c_char,
) -> uint8_t {
    let mut rc: uint8_t = 0 as libc::c_int as uint8_t;
    if ((*cht).p).is_null() {
        (*cht).p = ((*cht).sequence).as_mut_ptr();
    }
    if *(*cht).p as libc::c_int == 0 as libc::c_int {
        let fresh0 = (*cht).p;
        (*cht).p = ((*cht).p).offset(1);
        *fresh0 = key as uint8_t;
    } else if cheat_xlate_table[key as uint8_t as usize] as libc::c_int
        == *(*cht).p as libc::c_int
    {
        (*cht).p = ((*cht).p).offset(1);
        (*cht).p;
    ...
    if *(*cht).p as libc::c_int == 1 as libc::c_int {
        (*cht).p = ((*cht).p).offset(1);
        (*cht).p;
    } else if *(*cht).p as libc::c_int == 0xff as libc::c_int {
        (*cht).p = ((*cht).sequence).as_mut_ptr();
        rc = ((*cht).func).expect("non-null function pointer")();
    }
    return rc;
}
#[no_mangle]
pub unsafe extern "C" fn cht_Responder(mut ev: *mut event_t) -> boolean {
    let mut ret: uint8_t = 0 as libc::c_int as uint8_t;
    let mut ch: uint8_t = 0 as libc::c_int as uint8_t;
    if (*ev).type_0 as libc::c_uint != ev_keydown as libc::c_int as libc::c_uint {
        return false_0 as libc::c_int;
    }
    if (*ev).key > 0xff as libc::c_int {
        match (*ev).key {
            264 | 266 => {
                ch = 13 as libc::c_int as uint8_t;
            }
            296 => {
                ch = (0x80 as libc::c_int + 102 as libc::c_int) as uint8_t;
            }
            297 => {
                ch = (0x80 as libc::c_int + 110 as libc::c_int) as uint8_t;
            }
            298 => {
                ch = (0x80 as libc::c_int + 105 as libc::c_int) as uint8_t;
            }
            299 => {
                ch = (0x80 as libc::c_int + 107 as libc::c_int) as uint8_t;
            }
            _ => return false_0 as libc::c_int,
        }
    } else {
        ch = (*ev).key as uint8_t;
    }
    ret = (ret as libc::c_int
        + cht_CheckCheat(&mut cheat_ultimate, ch as libc::c_char) as libc::c_int)
        as uint8_t;
    ret = (ret as libc::c_int
        + cht_CheckCheat(&mut cheat_ultimate_joy, ch as libc::c_char) as libc::c_int)
        as uint8_t;
    ret = (ret as libc::c_int
        + cht_CheckCheat(&mut cheat_warp, ch as libc::c_char) as libc::c_int) as uint8_t;
    ret = (ret as libc::c_int
        + cht_CheckCheat(&mut cheat_warp_joy, ch as libc::c_char) as libc::c_int)
        as uint8_t;
    return (ret as libc::c_int != 0 as libc::c_int) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn Command_CheatNoClip_f() {
    let mut plyr: *mut player_t = 0 as *mut player_t;
    ...
    if ultimatemode != 0 {
        CONS_Printf(
            b"You're too good to be cheating!\n\0" as *const u8 as *const libc::c_char,
        );
        return;
    }
    plyr = &mut *players.as_mut_ptr().offset(consoleplayer as isize) as *mut player_t;
    (*plyr)
        .pflags = ::core::mem::transmute::<
        libc::c_uint,
        pflags_t,
    >((*plyr).pflags as libc::c_uint ^ PF_NOCLIP as libc::c_int as libc::c_uint);
    CONS_Printf(
        b"No Clipping %s\n\0" as *const u8 as *const libc::c_char,
        if (*plyr).pflags as libc::c_uint & PF_NOCLIP as libc::c_int as libc::c_uint != 0
        {
...
#[no_mangle]
pub unsafe extern "C" fn Command_CheatGod_f() {
    let mut plyr: *mut player_t = 0 as *mut player_t;
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
    ...
    (*plyr)
        ...
        libc::c_uint,
        pflags_t,
    >((*plyr).pflags as libc::c_uint ^ PF_GODMODE as libc::c_int as libc::c_uint);
    CONS_Printf(
        b"Cheese Mode %s\n\0" as *const u8 as *const libc::c_char,
        if (*plyr).pflags as libc::c_uint & PF_GODMODE as libc::c_int as libc::c_uint
            != 0
        {
            b"On\0" as *const u8 as *const libc::c_char
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn Command_CheatNoTarget_f() {
    let mut plyr: *mut player_t = 0 as *mut player_t;
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
    ...
    (*plyr)
        ...
        libc::c_uint,
        pflags_t,
    >((*plyr).pflags as libc::c_uint ^ PF_INVIS as libc::c_int as libc::c_uint);
    CONS_Printf(
        b"SEP Field %s\n\0" as *const u8 as *const libc::c_char,
        if (*plyr).pflags as libc::c_uint & PF_INVIS as libc::c_int as libc::c_uint != 0
        {
            b"On\0" as *const u8 as *const libc::c_char
        } else {
            b"Off\0" as *const u8 as *const libc::c_char
...
#[no_mangle]
pub unsafe extern "C" fn Command_Scale_f() {
    let scaled: libc::c_double = atof(COM_Argv(1 as libc::c_int as size_t));
    let mut scale: fixed_t = FloatToFixed(scaled as libc::c_float);
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    ...
    if scale < ((1 as libc::c_int) << 16 as libc::c_int) / 100 as libc::c_int
        || scale > 100 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
    {
        CONS_Printf(
            b"scale <value> (0.01-100.0): set player scale size\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    ...
    (*players[consoleplayer as usize].mo).destscale = scale;
    CONS_Printf(
        b"Scale set to %s\n\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn Command_Gravflip_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if !(players[consoleplayer as usize].mo).is_null() {
        (*players[consoleplayer as usize].mo).flags2
            ^= MF2_OBJECTFLIP as libc::c_int as uint32_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn Command_Hurtme_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if COM_Argc() < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"hurtme <damage>: Damage yourself by a specific amount\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    P_DamageMobj(
        ...
        0 as *mut mobj_t,
        0 as *mut mobj_t,
        atoi(COM_Argv(1 as libc::c_int as size_t)),
        0 as libc::c_int as uint8_t,
    );
}
#[no_mangle]
pub unsafe extern "C" fn Command_JumpToAxis_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"jumptoaxis <axisnum>: Jump to axis within current mare.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn Command_Charability_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if COM_Argc() < 3 as libc::c_int as size_t {
        CONS_Printf(
            b"charability <1/2> <value>: change character abilities\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    if atoi(COM_Argv(1 as libc::c_int as size_t)) == 1 as libc::c_int {
        players[consoleplayer as usize]
            .charability = atoi(COM_Argv(2 as libc::c_int as size_t)) as uint8_t;
    } else if atoi(COM_Argv(1 as libc::c_int as size_t)) == 2 as libc::c_int {
        players[consoleplayer as usize]
            .charability2 = atoi(COM_Argv(2 as libc::c_int as size_t)) as uint8_t;
    } else {
        CONS_Printf(
            b"charability <1/2> <value>: change character abilities\n\0" as *const u8
                as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn Command_Charspeed_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if COM_Argc() < 3 as libc::c_int as size_t {
        CONS_Printf(
            b"charspeed <normalspeed/runspeed/thrustfactor/accelstart/acceleration/actionspd> <value>: set character speed\n\0"
    ...
    {
        players[consoleplayer as usize]
            .normalspeed = atoi(COM_Argv(2 as libc::c_int as size_t))
            << 16 as libc::c_int;
    } else if strcasecmp(
        COM_Argv(1 as libc::c_int as size_t),
    ...
    {
        players[consoleplayer as usize]
            .runspeed = atoi(COM_Argv(2 as libc::c_int as size_t)) << 16 as libc::c_int;
    } else if strcasecmp(
        COM_Argv(1 as libc::c_int as size_t),
    ...
    {
        players[consoleplayer as usize]
            .thrustfactor = atoi(COM_Argv(2 as libc::c_int as size_t)) as uint8_t;
    } else if strcasecmp(
        COM_Argv(1 as libc::c_int as size_t),
    ...
    {
        players[consoleplayer as usize]
            .accelstart = atoi(COM_Argv(2 as libc::c_int as size_t)) as uint8_t;
    } else if strcasecmp(
        COM_Argv(1 as libc::c_int as size_t),
    ...
    {
        players[consoleplayer as usize]
            .acceleration = atoi(COM_Argv(2 as libc::c_int as size_t)) as uint8_t;
    } else if strcasecmp(
        COM_Argv(1 as libc::c_int as size_t),
    ...
    {
        players[consoleplayer as usize]
            .actionspd = atoi(COM_Argv(2 as libc::c_int as size_t)) << 16 as libc::c_int;
    } else {
        CONS_Printf(
            b"charspeed <normalspeed/runspeed/thrustfactor/accelstart/acceleration/actionspd> <value>: set character speed\n\0"
                as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn Command_RTeleport_f() {
    let mut intx: fixed_t = 0;
    let mut inty: fixed_t = 0;
    let mut intz: fixed_t = 0;
    let mut i: size_t = 0;
    let mut p: *mut player_t = &mut *players.as_mut_ptr().offset(consoleplayer as isize)
        as *mut player_t;
    ...
    if COM_Argc() < 3 as libc::c_int as size_t || COM_Argc() > 7 as libc::c_int as size_t
    {
        CONS_Printf(
            b"rteleport -x <value> -y <value> -z <value>: relative teleport to a location\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    ...
    i = COM_CheckParm(b"-x\0" as *const u8 as *const libc::c_char);
    if i != 0 {
        intx = atoi(COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)));
    } else {
        intx = 0 as libc::c_int;
    }
    i = COM_CheckParm(b"-y\0" as *const u8 as *const libc::c_char);
    if i != 0 {
        inty = atoi(COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)));
    } else {
        inty = 0 as libc::c_int;
    }
    ss = R_PointInSubsectorOrNull(
        (*(*p).mo).x + intx * ((1 as libc::c_int) << 16 as libc::c_int),
        (*(*p).mo).y + inty * ((1 as libc::c_int) << 16 as libc::c_int),
    );
    if ss.is_null()
        || (*(*ss).sector).ceilingheight - (*(*ss).sector).floorheight
            < (*(*p).mo).height
    {
        CONS_Alert(
            CONS_NOTICE,
            b"Not a valid location.\n\0" as *const u8 as *const libc::c_char,
        );
        return;
    }
    i = COM_CheckParm(b"-z\0" as *const u8 as *const libc::c_char);
    if i != 0 {
        intz = atoi(COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)));
        intz <<= 16 as libc::c_int;
        intz += (*(*p).mo).z;
    ...
    CONS_Printf(
        b"Teleporting by %d, %d, %d...\n\0" as *const u8 as *const libc::c_char,
        intx,
        inty,
        FixedInt(intz - (*(*p).mo).z),
    );
    P_MapStart();
    if P_SetOrigin(
        (*p).mo,
    ...
    ) == 0
    {
        CONS_Alert(
            CONS_WARNING,
            b"Unable to teleport to that spot!\n\0" as *const u8 as *const libc::c_char,
        );
    } else {
        S_StartSound((*p).mo as *const libc::c_void, sfx_mixup);
    }
    P_MapEnd();
}
#[no_mangle]
pub unsafe extern "C" fn Command_Teleport_f() {
    let mut intx: fixed_t = 0;
    let mut inty: fixed_t = 0;
    let mut intz: fixed_t = 0;
    let mut i: size_t = 0;
    ...
    if COM_Argc() < 3 as libc::c_int as size_t
        || COM_Argc() > 11 as libc::c_int as size_t
    {
        CONS_Printf(
            b"teleport -x <value> -y <value> -z <value> -ang <value> -aim <value>: teleport to a location\nteleport -sp <sequence> <placement>: teleport to specified checkpoint\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    ...
    i = COM_CheckParm(b"-sp\0" as *const u8 as *const libc::c_char);
    if i != 0 {
        let mut starpostnum: int32_t = atoi(
            COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)),
        );
        let mut starpostpath: int32_t = atoi(
            COM_Argv(i.wrapping_add(2 as libc::c_int as size_t)),
        );
        if starpostnum < 0 as libc::c_int || starpostpath < 0 as libc::c_int {
            CONS_Alert(
                CONS_NOTICE,
                b"Negative starpost indexing is not valid.\n\0" as *const u8
                    as *const libc::c_char,
            );
            return;
        }
        if starpostnum == 0 {
            ...
            if starpostpath >= numcoopstarts {
                CONS_Alert(
                    CONS_NOTICE,
                    b"Player %d spawnpoint not found (%d max).\n\0" as *const u8
                        as *const libc::c_char,
                    starpostpath + 1 as libc::c_int,
                    numcoopstarts - 1 as libc::c_int,
                );
                return;
            }
            mt = playerstarts[starpostpath as usize];
            intx = ((*mt).x as libc::c_int) << 16 as libc::c_int;
            inty = ((*mt).y as libc::c_int) << 16 as libc::c_int;
            offset = ((*mt).z as libc::c_int) << 16 as libc::c_int;
                    ...
                    < (*(*p).mo).height
            {
                CONS_Alert(
                    CONS_NOTICE,
                    b"Spawnpoint not in a valid location.\n\0" as *const u8
                        as *const libc::c_char,
                );
                return;
            }
            if ((*mt).args[0 as libc::c_int as usize] != 0) as libc::c_int
                ^ ((*mt).options as libc::c_int & 2 as libc::c_int != 0) as libc::c_int
                != 0
            {
            ...
            if (*mt).options as libc::c_int & 2 as libc::c_int != 0 {
                (*(*p).mo)
                    .eflags = ((*(*p).mo).eflags as libc::c_int
                    | MFE_VERTICALFLIP as libc::c_int) as uint16_t;
                (*(*p).mo).flags2 |= MF2_OBJECTFLIP as libc::c_int as uint32_t;
            } else {
                (*(*p).mo)
                    .eflags = ((*(*p).mo).eflags as libc::c_int
                    & !(MFE_VERTICALFLIP as libc::c_int)) as uint16_t;
            ...
            (*p)
                .drawangle = FixedAngle(
                ((*mt).angle as libc::c_int) << 16 as libc::c_int,
            );
            ...
            let mut starpostmax: int32_t = 0 as libc::c_int;
            intz = starpostpath;
                    ...
                    as *mut thinker_t
            {
                if intz == starpostpath {
                    CONS_Alert(
                        CONS_NOTICE,
                        b"No starpost of position %d found (%d max).\n\0" as *const u8
                            as *const libc::c_char,
                        starpostnum,
                        starpostmax,
                    );
                    ...
                    CONS_Alert(
                        CONS_NOTICE,
                        b"Starpost of position %d, %d not found (%d, %d max).\n\0"
                            as *const u8 as *const libc::c_char,
                        starpostnum,
                        starpostpath,
                        starpostmax,
                        starpostpath - intz - 1 as libc::c_int,
                    );
                }
                return;
            }
                    ...
                    < (*(*p).mo).height
            {
                CONS_Alert(
                    CONS_NOTICE,
                    b"Starpost not in a valid location.\n\0" as *const u8
                        as *const libc::c_char,
                );
                return;
            }
            ...
            inty = (*mo2).y;
            intz = (*mo2).z;
            if (*mo2).flags2 & MF2_OBJECTFLIP as libc::c_int as uint32_t != 0 {
                (*(*p).mo)
                    .eflags = ((*(*p).mo).eflags as libc::c_int
                    | MFE_VERTICALFLIP as libc::c_int) as uint16_t;
                (*(*p).mo).flags2 |= MF2_OBJECTFLIP as libc::c_int as uint32_t;
            ...
            (*p).drawangle = (*mo2).angle;
            (*(*p).mo).angle = (*p).drawangle;
            P_SetPlayerAngle(p, (*(*p).mo).angle);
        }
        CONS_Printf(
            b"Teleporting to checkpoint %d, %d...\n\0" as *const u8
                as *const libc::c_char,
            starpostnum,
            starpostpath,
        );
    } else {
        i = COM_CheckParm(b"-nop\0" as *const u8 as *const libc::c_char);
        if i != 0 {
            intx = (*(*p).mo).x;
            inty = (*(*p).mo).y;
        } else {
        ...
        if i != 0 {
            ...
            intz = if (*(*p).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
                != 0
            {
        ...
        i = COM_CheckParm(b"-ang\0" as *const u8 as *const libc::c_char);
        if i != 0 {
            (*(*p).mo)
                .angle = FixedAngle(
                atoi(COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)))
                    << 16 as libc::c_int,
            );
            (*p).drawangle = (*(*p).mo).angle;
            P_SetPlayerAngle(p, (*(*p).mo).angle);
        }
        i = COM_CheckParm(b"-aim\0" as *const u8 as *const libc::c_char);
        if i != 0 {
            let mut aim: angle_t = FixedAngle(
                atoi(COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)))
                    << 16 as libc::c_int,
            );
            if aim >= 0x40000000 as libc::c_int as angle_t
                && aim <= 0xc0000000 as libc::c_uint
            {
                CONS_Alert(
                    CONS_NOTICE,
                    b"Not a valid aiming angle (between +/-90).\n\0" as *const u8
                        as *const libc::c_char,
                );
                return;
            }
            (*p).aiming = aim;
            localaiming = (*p).aiming as int32_t;
        }
        CONS_Printf(
            b"Teleporting to %d, %d, %d...\n\0" as *const u8 as *const libc::c_char,
            FixedInt(intx),
            FixedInt(inty),
            FixedInt(intz),
        );
    ...
    P_MapStart();
    if P_SetOrigin((*p).mo, intx, inty, intz) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Unable to teleport to that spot!\n\0" as *const u8 as *const libc::c_char,
        );
...
#[no_mangle]
pub unsafe extern "C" fn Command_Skynum_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    P_SetupLevelSky(atoi(COM_Argv(1 as libc::c_int as size_t)), false_0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Command_Weather_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"weather <weather#>: change the weather\n\0" as *const u8
                as *const libc::c_char,
        );
        CONS_Printf(
            b"Current weather is %d\n\0" as *const u8 as *const libc::c_char,
            curWeather,
        );
        return;
    }
    CONS_Printf(
        b"Previewing weather %s...\n\0" as *const u8 as *const libc::c_char,
        COM_Argv(1 as libc::c_int as size_t),
    );
    P_SwitchWeather(atoi(COM_Argv(1 as libc::c_int as size_t)));
}
#[no_mangle]
pub unsafe extern "C" fn Command_Toggletwod_f() {
    let mut p: *mut player_t = &mut *players.as_mut_ptr().offset(consoleplayer as isize)
        as *mut player_t;
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
    ...
    if !((*p).mo).is_null() {
        (*(*p).mo).flags2 ^= MF2_TWOD as libc::c_int as uint32_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn Command_Savecheckpoint_f() {
    if cv_debug == 0 {
        CONS_Printf(b"DEVMODE must be enabled.\n\0" as *const u8 as *const libc::c_char);
        return;
    }
    ...
    players[consoleplayer as usize]
        .starposttime = players[consoleplayer as usize].realtime;
    players[consoleplayer as usize]
        .starpostx = ((*players[consoleplayer as usize].mo).x >> 16 as libc::c_int)
        as int16_t;
    players[consoleplayer as usize]
        .starposty = ((*players[consoleplayer as usize].mo).y >> 16 as libc::c_int)
        as int16_t;
    players[consoleplayer as usize]
        .starpostz = ((*players[consoleplayer as usize].mo).floorz >> 16 as libc::c_int)
        as int16_t;
    players[consoleplayer as usize]
        .starpostangle = (*players[consoleplayer as usize].mo).angle;
    players[consoleplayer as usize]
        .starpostscale = (*players[consoleplayer as usize].mo).destscale;
    if (*players[consoleplayer as usize].mo).flags2
        & MF2_OBJECTFLIP as libc::c_int as uint32_t != 0
    {
        players[consoleplayer as usize].starpostscale *= -(1 as libc::c_int);
        players[consoleplayer as usize]
            .starpostz = (players[consoleplayer as usize].starpostz as libc::c_int
            + (*players[consoleplayer as usize].mo).height) as int16_t;
    }
    CONS_Printf(
        b"Temporary checkpoint created at %d, %d, %d\n\0" as *const u8
            as *const libc::c_char,
        players[consoleplayer as usize].starpostx as libc::c_int,
        players[consoleplayer as usize].starposty as libc::c_int,
        players[consoleplayer as usize].starpostz as libc::c_int,
    );
}
#[no_mangle]
pub unsafe extern "C" fn Command_Getallemeralds_f() {
    if netgame != 0 || multiplayer != 0 {
        CONS_Printf(
            b"This only works in single player.\n\0" as *const u8 as *const libc::c_char,
        );
    ...
    if M_SecretUnlocked(-(3 as libc::c_int), serverGamedata) == 0 && cv_debug == 0 {
        CONS_Printf(
    ...
    CONS_Printf(b"You now have all 7 emeralds.\n\0" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn Command_Resetemeralds_f() {
    if netgame != 0 || multiplayer != 0 {
        CONS_Printf(
            b"This only works in single player.\n\0" as *const u8 as *const libc::c_char,
        );
    ...
    CONS_Printf(b"Emeralds reset to zero.\n\0" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn Command_Devmode_f() {
    if netgame != 0 || multiplayer != 0 {
        CONS_Printf(
            b"This only works in single player.\n\0" as *const u8 as *const libc::c_char,
        );
    ...
    if COM_Argc() > 1 as libc::c_int as size_t {
        ...
        {
            cv_debug = axtoi(arg.offset(2 as libc::c_int as isize));
        } else {
            cv_debug = atoi(arg);
        }
    } else {
        CONS_Printf(
            b"devmode <flags>: enable debugging tools and info, prepend with 0x to use hexadecimal\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn Command_Setrings_f() {
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
        CONS_Printf(
    ...
    if COM_Argc() > 1 as libc::c_int as size_t {
        if maptol & TOL_NIGHTS as libc::c_int as uint32_t == 0 {
            players[consoleplayer as usize].rings = 0 as libc::c_int as int16_t;
            P_GivePlayerRings(
                &mut *players.as_mut_ptr().offset(consoleplayer as isize),
                atoi(COM_Argv(1 as libc::c_int as size_t)),
            );
            players[consoleplayer as usize]
                .totalring = (players[consoleplayer as usize].totalring as libc::c_int
                - atoi(COM_Argv(1 as libc::c_int as size_t))) as int16_t;
        } else {
            players[consoleplayer as usize].spheres = 0 as libc::c_int as int16_t;
            P_GivePlayerSpheres(
                &mut *players.as_mut_ptr().offset(consoleplayer as isize),
                atoi(COM_Argv(1 as libc::c_int as size_t)),
            );
...
#[no_mangle]
pub unsafe extern "C" fn Command_Setlives_f() {
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
        CONS_Printf(
    ...
    if COM_Argc() > 1 as libc::c_int as size_t {
        let mut lives: int8_t = atoi(COM_Argv(1 as libc::c_int as size_t)) as int8_t;
        if lives as libc::c_int == -(1 as libc::c_int) {
            players[consoleplayer as usize].lives = 0x7f as libc::c_int as int8_t;
        } else {
            players[consoleplayer as usize].lives = 0 as libc::c_int as int8_t;
            P_GivePlayerLives(
                &mut *players.as_mut_ptr().offset(consoleplayer as isize),
                atoi(COM_Argv(1 as libc::c_int as size_t)),
            );
...
#[no_mangle]
pub unsafe extern "C" fn Command_Setcontinues_f() {
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
        CONS_Printf(
    ...
    {
        CONS_Printf(
            b"This session does not use continues.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    if COM_Argc() > 1 as libc::c_int as size_t {
        let mut numcontinues: int32_t = atoi(COM_Argv(1 as libc::c_int as size_t));
        if numcontinues > 99 as libc::c_int {
            numcontinues = 99 as libc::c_int;
        } else if numcontinues < 0 as libc::c_int {
            numcontinues = 0 as libc::c_int;
        }
        players[consoleplayer as usize].continues = numcontinues as int8_t;
        G_SetUsedCheats(false_0 as libc::c_int);
    }
}
static mut op_mapthing_t: [CV_PossibleValue_t; 3] = [
    {
...
static mut op_speed_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
...
static mut op_flags_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
static mut op_hoopflags_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_mapthingnum: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"op_mapthingnum\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_NOTINNET as libc::c_int,
            PossibleValue: op_mapthing_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_speed: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"op_speed\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"16\0" as *const u8 as *const libc::c_char,
            flags: CV_NOTINNET as libc::c_int,
            PossibleValue: op_speed_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_opflags: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"op_flags\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_NOTINNET as libc::c_int,
            PossibleValue: op_flags_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_ophoopflags: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"op_hoopflags\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"4\0" as *const u8 as *const libc::c_char,
            flags: CV_NOTINNET as libc::c_int,
            PossibleValue: op_hoopflags_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut objectplacing: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut op_currentthing: mobjtype_t = MT_NULL;
#[no_mangle]
pub static mut op_currentdoomednum: uint16_t = 0 as libc::c_int as uint16_t;
#[no_mangle]
pub static mut op_displayflags: uint32_t = 0 as libc::c_int as uint32_t;
static mut op_oldpflags: pflags_t = 0 as pflags_t;
static mut op_oldflags1: mobjflag_t = 0 as mobjflag_t;
static mut op_oldflags2: mobjflag2_t = 0 as mobjflag2_t;
static mut op_oldeflags: uint32_t = 0 as libc::c_int as uint32_t;
static mut op_oldmomx: fixed_t = 0 as libc::c_int;
static mut op_oldmomy: fixed_t = 0 as libc::c_int;
static mut op_oldmomz: fixed_t = 0 as libc::c_int;
static mut op_oldheight: fixed_t = 0 as libc::c_int;
static mut op_oldstate: statenum_t = S_NULL;
static mut op_oldcolor: uint16_t = 0 as libc::c_int as uint16_t;
unsafe extern "C" fn OP_CycleThings(mut amt: int32_t) {
    let mut add: int32_t = if amt > 0 as libc::c_int {
        1 as libc::c_int
    } else {
        -(1 as libc::c_int)
    };
    while amt != 0 {
        loop {
            op_currentthing = ::core::mem::transmute::<
                libc::c_uint,
                mobjtype_t,
            >((op_currentthing as libc::c_uint).wrapping_add(add as libc::c_uint))
                as mobjtype_t;
            if op_currentthing as libc::c_uint <= 0 as libc::c_int as libc::c_uint {
                op_currentthing = (NUMMOBJTYPES as libc::c_int - 1 as libc::c_int)
                    as mobjtype_t;
            }
            if op_currentthing as libc::c_uint
                >= NUMMOBJTYPES as libc::c_int as libc::c_uint
            {
                op_currentthing = MT_NULL;
            }
            if !(mobjinfo[op_currentthing as usize].doomednum == -(1 as libc::c_int)
                || op_currentthing as libc::c_uint
                    == MT_NIGHTSDRONE as libc::c_int as libc::c_uint
                || mobjinfo[op_currentthing as usize].flags
                    & (MF_AMBIENT as libc::c_int | MF_NOSECTOR as libc::c_int)
                        as uint32_t != 0
                || states[mobjinfo[op_currentthing as usize].spawnstate as usize].sprite
                    as libc::c_uint == SPR_NULL as libc::c_int as libc::c_uint
                    && states[mobjinfo[op_currentthing as usize].seestate as usize]
                        .sprite as libc::c_uint
    ...
    if states[mobjinfo[op_currentthing as usize].spawnstate as usize].sprite
        as libc::c_uint == SPR_NULL as libc::c_int as libc::c_uint
    {
        states[S_OBJPLACE_DUMMY as libc::c_int as usize]
            .sprite = states[mobjinfo[op_currentthing as usize].seestate as usize]
            .sprite;
        states[S_OBJPLACE_DUMMY as libc::c_int as usize]
            .frame = states[mobjinfo[op_currentthing as usize].seestate as usize].frame;
    } else {
        states[S_OBJPLACE_DUMMY as libc::c_int as usize]
            .sprite = states[mobjinfo[op_currentthing as usize].spawnstate as usize]
            .sprite;
        states[S_OBJPLACE_DUMMY as libc::c_int as usize]
            .frame = states[mobjinfo[op_currentthing as usize].spawnstate as usize]
            .frame;
    }
    if (*players[0 as libc::c_int as usize].mo).eflags as libc::c_int
        & MFE_VERTICALFLIP as libc::c_int != 0
    {
        (*players[0 as libc::c_int as usize].mo).z
            += (*players[0 as libc::c_int as usize].mo).height
                - FixedMul(
                    mobjinfo[op_currentthing as usize].height,
                    (*players[0 as libc::c_int as usize].mo).scale,
                );
    }
    ...
    P_SetPlayerMobjState(players[0 as libc::c_int as usize].mo, S_OBJPLACE_DUMMY);
    op_currentdoomednum = mobjinfo[op_currentthing as usize].doomednum as uint16_t;
}
unsafe extern "C" fn OP_HeightOkay(
    mut player: *mut player_t,
    mut ceiling: uint8_t,
) -> boolean {
    let mut sec: *mut sector_t = (*(*(*player).mo).subsector).sector;
    if ceiling != 0 {
        let mut cheight: fixed_t = P_GetSectorCeilingZAt(
            sec,
            ((*(*player).mo).x as libc::c_uint & 0xffff0000 as libc::c_uint) as fixed_t,
            ((*(*player).mo).y as libc::c_uint & 0xffff0000 as libc::c_uint) as fixed_t,
        );
        if cheight - (*(*player).mo).z - (*(*player).mo).height >> 16 as libc::c_int
            >= (1 as libc::c_int) << 16 as libc::c_int - 4 as libc::c_int
        {
            CONS_Printf(
                b"Sorry, you're too %s to place this object (max: %d %s).\n\0"
                    as *const u8 as *const libc::c_char,
                b"low\0" as *const u8 as *const libc::c_char,
                (1 as libc::c_int) << 16 as libc::c_int - 4 as libc::c_int,
                b"below top ceiling\0" as *const u8 as *const libc::c_char,
            );
            return false_0 as libc::c_int;
        }
    } else {
        let mut fheight: fixed_t = P_GetSectorFloorZAt(
            sec,
            ((*(*player).mo).x as libc::c_uint & 0xffff0000 as libc::c_uint) as fixed_t,
            ((*(*player).mo).y as libc::c_uint & 0xffff0000 as libc::c_uint) as fixed_t,
        );
        if (*(*player).mo).z - fheight >> 16 as libc::c_int
            >= (1 as libc::c_int) << 16 as libc::c_int - 4 as libc::c_int
        {
            CONS_Printf(
                b"Sorry, you're too %s to place this object (max: %d %s).\n\0"
                ...
                (1 as libc::c_int) << 16 as libc::c_int - 4 as libc::c_int,
                b"above bottom floor\0" as *const u8 as *const libc::c_char,
            );
            return false_0 as libc::c_int;
        }
    }
...
unsafe extern "C" fn OP_CreateNewMapThing(
    mut player: *mut player_t,
    mut type_0: uint16_t,
    mut ceiling: boolean,
) -> *mut mapthing_t {
    ...
    mapthings = Z_ReallocAlign(
        mapthings as *mut libc::c_void,
                ...
                as *mut thinker_t
        {
                ...
                ))
            {
                ...
                if !((*mo).spawnpoint).is_null() {
                    (*mo)
                        .spawnpoint = mapthings
                        .offset(
                            ((*mo).spawnpoint).offset_from(mt) as libc::c_long as isize,
                        );
                }
            }
            th = (*th).next;
    ...
    mt = mapthings.offset(nummapthings as isize).offset(-(1 as libc::c_int as isize));
    (*mt).type_0 = type_0;
    (*mt).x = ((*(*player).mo).x >> 16 as libc::c_int) as int16_t;
    (*mt).y = ((*(*player).mo).y >> 16 as libc::c_int) as int16_t;
    if ceiling != 0 {
        let mut cheight: fixed_t = P_GetSectorCeilingZAt(
            sec,
            ((*mt).x as libc::c_int) << 16 as libc::c_int,
            ((*mt).y as libc::c_int) << 16 as libc::c_int,
        );
        (*mt)
            .z = (cheight - (*(*player).mo).z - (*(*player).mo).height
            >> 16 as libc::c_int) as uint16_t as int16_t;
    } else {
        let mut fheight: fixed_t = P_GetSectorFloorZAt(
            sec,
            ((*mt).x as libc::c_int) << 16 as libc::c_int,
        ...
        (*mt)
            .z = ((*(*player).mo).z - fheight >> 16 as libc::c_int) as uint16_t
            as int16_t;
    }
    (*mt).angle = FixedInt(AngleFixed((*(*player).mo).angle)) as int16_t;
    (*mt)
        .options = (((*mt).z as libc::c_int) << 4 as libc::c_int
        | cv_opflags.value as uint16_t as libc::c_int) as uint16_t;
...
#[no_mangle]
pub unsafe extern "C" fn OP_FreezeObjectplace() -> boolean {
    if objectplacing == 0 {
        return false_0 as libc::c_int;
    }
    if maptol & TOL_NIGHTS as libc::c_int as uint32_t != 0
        && players[consoleplayer as usize].powers[pw_carry as libc::c_int as usize]
...
#[no_mangle]
pub unsafe extern "C" fn OP_ResetObjectplace() {
    objectplacing = false_0 as libc::c_int;
    op_currentthing = MT_NULL;
}
#[no_mangle]
pub unsafe extern "C" fn OP_ObjectplaceMovement(mut player: *mut player_t) {
    ...
    if (*cmd).forwardmove as libc::c_int != 0 as libc::c_int {
        P_Thrust(
            (*player).mo,
            (*(*player).mo).angle,
            (*cmd).forwardmove as libc::c_int * (*(*player).mo).scale / 50 as libc::c_int
                * cv_speed.value,
        );
        P_MoveOrigin(
            (*player).mo,
    ...
    if (*cmd).sidemove as libc::c_int != 0 as libc::c_int {
        P_Thrust(
            ...
            (*cmd).sidemove as libc::c_int * (*(*player).mo).scale / 50 as libc::c_int
                * cv_speed.value,
        );
        P_MoveOrigin(
            (*player).mo,
    ...
    if cv_opflags.value & 2 as libc::c_int != 0 {
        (*(*player).mo)
    ...
    if (*(*player).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        (*player)
            .viewz = (*(*player).mo).z + (*(*player).mo).height - (*player).viewheight;
    } else {
        (*player).viewz = (*(*player).mo).z + (*player).viewheight;
    }
    let mut sec: *mut sector_t = (*(*(*player).mo).subsector).sector;
    if (mobjinfo[op_currentthing as usize].flags
        & MF_SPAWNCEILING as libc::c_int as uint32_t != 0) as libc::c_int
        ^ (cv_opflags.value & 2 as libc::c_int != 0) as libc::c_int != 0
    {
        let mut cheight: fixed_t = P_GetSectorCeilingZAt(
            sec,
            ((*(*player).mo).x as libc::c_uint & 0xffff0000 as libc::c_uint) as fixed_t,
        ...
        op_displayflags = (cheight - (*(*player).mo).z
            - mobjinfo[op_currentthing as usize].height >> 16 as libc::c_int) as uint16_t
            as uint32_t;
    } else {
        let mut fheight: fixed_t = P_GetSectorFloorZAt(
            sec,
        ...
        op_displayflags = ((*(*player).mo).z - fheight >> 16 as libc::c_int) as uint16_t
            as uint32_t;
    }
    op_displayflags <<= 4 as libc::c_int;
    op_displayflags |= cv_opflags.value as uint16_t as uint32_t;
    if (*player).pflags as libc::c_uint & PF_ATTACKDOWN as libc::c_int as libc::c_uint
        != 0
    {
        if (*cmd).buttons as libc::c_int
            & (BT_ATTACK as libc::c_int | BT_TOSSFLAG as libc::c_int
                | BT_WEAPONNEXT as libc::c_int | BT_WEAPONPREV as libc::c_int) == 0
        {
            (*player)
                .pflags = ::core::mem::transmute::<
                libc::c_uint,
    ...
    if (*cmd).buttons as libc::c_int & BT_WEAPONPREV as libc::c_int != 0 {
        OP_CycleThings(-(1 as libc::c_int));
        (*player)
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
    ...
    if (*cmd).buttons as libc::c_int & BT_ATTACK as libc::c_int != 0 {
        let mut mt: *mut mapthing_t = 0 as *mut mapthing_t;
        let mut spawnmid: mobjtype_t = op_currentthing;
        let mut spawnthing: mobjtype_t = op_currentdoomednum as mobjtype_t;
        let mut ceiling: boolean = 0;
        (*player)
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
        ...
        if cv_mapthingnum.value > 0 as libc::c_int
            && cv_mapthingnum.value < 4096 as libc::c_int
        {
            spawnmid = MT_NULL;
            while (spawnmid as libc::c_uint)
                < NUMMOBJTYPES as libc::c_int as libc::c_uint
            {
                if cv_mapthingnum.value == mobjinfo[spawnmid as usize].doomednum {
                    break;
                }
                spawnmid += 1;
                spawnmid;
            }
            if spawnmid as libc::c_uint == NUMMOBJTYPES as libc::c_int as libc::c_uint {
                CONS_Alert(
                    CONS_ERROR,
                    b"Can't place an object with mapthingnum %d.\n\0" as *const u8
                        as *const libc::c_char,
                    cv_mapthingnum.value,
                );
                return;
            }
            spawnthing = mobjinfo[spawnmid as usize].doomednum as mobjtype_t;
        }
        ceiling = (mobjinfo[spawnmid as usize].flags
            & MF_SPAWNCEILING as libc::c_int as uint32_t != 0) as libc::c_int
            ^ (cv_opflags.value & 2 as libc::c_int != 0) as libc::c_int;
        if OP_HeightOkay(player, ceiling as uint8_t) == 0 {
            return;
        }
        mt = OP_CreateNewMapThing(player, spawnthing as uint16_t, ceiling);
        ...
        CONS_Printf(
            b"Placed object type %d at %d, %d, %d, %d\n\0" as *const u8
                as *const libc::c_char,
            (*mt).type_0 as libc::c_int,
            (*mt).x as libc::c_int,
            (*mt).y as libc::c_int,
            (*mt).z as libc::c_int,
            (*mt).angle as libc::c_int,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn Command_ObjectPlace_f() {
    let mut thingarg: size_t = 0;
    let mut silent: size_t = 0;
    if gamestate as libc::c_uint != GS_LEVEL as libc::c_int as libc::c_uint
        || demoplayback != 0
    {
        CONS_Printf(
    ...
    G_SetUsedCheats(false_0 as libc::c_int);
    silent = COM_CheckParm(b"-silent\0" as *const u8 as *const libc::c_char);
    thingarg = (2 as libc::c_int - (silent != 1 as libc::c_int as size_t) as libc::c_int)
        as size_t;
    if objectplacing == 0 || thingarg < COM_Argc() {
        if objectplacing == 0 {
            objectplacing = true_0 as libc::c_int;
            if players[0 as libc::c_int as usize]
            ...
            if silent == 0 {
                HU_SetCEchoFlags(
                    0x20000000 as libc::c_int | 0xc00 as libc::c_int
                        | 0x10000000 as libc::c_int,
                );
                HU_SetCEchoDuration(10 as libc::c_int);
                HU_DoCEcho(
                    va(
                        b"\\\\\\\\\\\\\\\\\\\\\\\\\x82   Objectplace Controls:   \x80\\\\Weapon Next/Prev: Cycle mapthings\\            Jump: Float up       \\            Spin: Float down     \\       Fire Ring: Place object   \\\0"
                            as *const u8 as *const libc::c_char,
                    ),
                );
            }
            op_oldflags1 = (*players[0 as libc::c_int as usize].mo).flags as mobjflag_t;
            op_oldflags2 = (*players[0 as libc::c_int as usize].mo).flags2
                as mobjflag2_t;
            op_oldeflags = (*players[0 as libc::c_int as usize].mo).eflags as uint32_t;
            op_oldpflags = players[0 as libc::c_int as usize].pflags;
            op_oldmomx = (*players[0 as libc::c_int as usize].mo).momx;
            op_oldmomy = (*players[0 as libc::c_int as usize].mo).momy;
            op_oldmomz = (*players[0 as libc::c_int as usize].mo).momz;
            op_oldheight = (*players[0 as libc::c_int as usize].mo).height;
            op_oldstate = S_PLAY_STND;
            op_oldcolor = (*players[0 as libc::c_int as usize].mo).color;
            P_UnsetThingPosition(players[0 as libc::c_int as usize].mo);
            players[0 as libc::c_int as usize].pflags = 0 as pflags_t;
            (*players[0 as libc::c_int as usize].mo)
                .flags2 = 0 as libc::c_int as uint32_t;
            (*players[0 as libc::c_int as usize].mo)
                .eflags = 0 as libc::c_int as uint16_t;
            (*players[0 as libc::c_int as usize].mo)
                .flags = (MF_NOCLIP as libc::c_int | MF_NOGRAVITY as libc::c_int
                | MF_NOBLOCKMAP as libc::c_int) as uint32_t;
            (*players[0 as libc::c_int as usize].mo).momz = 0 as libc::c_int;
            (*players[0 as libc::c_int as usize].mo)
                .momy = (*players[0 as libc::c_int as usize].mo).momz;
            (*players[0 as libc::c_int as usize].mo)
                .momx = (*players[0 as libc::c_int as usize].mo).momy;
            P_SetThingPosition(players[0 as libc::c_int as usize].mo);
            (*players[0 as libc::c_int as usize].mo)
                .color = 0 as libc::c_int as uint16_t;
            if (*players[0 as libc::c_int as usize].mo).health <= 0 as libc::c_int {
                (*players[0 as libc::c_int as usize].mo).health = 1 as libc::c_int;
                players[0 as libc::c_int as usize].deadtimer = 0 as libc::c_int;
                op_oldflags1 = mobjinfo[MT_PLAYER as libc::c_int as usize].flags
                    as mobjflag_t;
                players[0 as libc::c_int as usize].lives += 1;
                players[0 as libc::c_int as usize].lives;
                players[0 as libc::c_int as usize].playerstate = PST_LIVE;
                P_RestoreMusic(
                    &mut *players.as_mut_ptr().offset(0 as libc::c_int as isize),
                );
            } else {
                op_oldstate = ((*players[0 as libc::c_int as usize].mo).state)
                    .offset_from(states.as_mut_ptr()) as libc::c_long as statenum_t;
            }
        }
        if thingarg < COM_Argc() {
            let mut mapthingnum: uint16_t = atoi(COM_Argv(thingarg)) as uint16_t;
            let mut type_0: mobjtype_t = P_GetMobjtype(mapthingnum);
            if type_0 as libc::c_uint == MT_UNKNOWN as libc::c_int as libc::c_uint {
                CONS_Printf(
                    b"No mobj type delegated to thing type %d.\n\0" as *const u8
                        as *const libc::c_char,
                    mapthingnum as libc::c_int,
                );
            } else {
                op_currentthing = type_0;
            }
        }
        if op_currentthing as u64 == 0 {
            op_currentthing = MT_UNKNOWN;
            OP_CycleThings(1 as libc::c_int);
        } else {
            OP_CycleThings(0 as libc::c_int);
        }
        P_SetPlayerMobjState(players[0 as libc::c_int as usize].mo, S_OBJPLACE_DUMMY);
    } else {
        objectplacing = false_0 as libc::c_int;
        ...
        if (*players[0 as libc::c_int as usize].mo).state
            == &mut *states.as_mut_ptr().offset(S_OBJPLACE_DUMMY as libc::c_int as isize)
                as *mut state_t
        {
            P_SetPlayerMobjState(players[0 as libc::c_int as usize].mo, op_oldstate);
        }
        P_UnsetThingPosition(players[0 as libc::c_int as usize].mo);
        (*players[0 as libc::c_int as usize].mo).flags = op_oldflags1 as uint32_t;
        (*players[0 as libc::c_int as usize].mo).flags2 = op_oldflags2 as uint32_t;
        (*players[0 as libc::c_int as usize].mo).eflags = op_oldeflags as uint16_t;
        players[0 as libc::c_int as usize].pflags = op_oldpflags;
        (*players[0 as libc::c_int as usize].mo).momx = op_oldmomx;
        (*players[0 as libc::c_int as usize].mo).momy = op_oldmomy;
        (*players[0 as libc::c_int as usize].mo).momz = op_oldmomz;
        (*players[0 as libc::c_int as usize].mo).height = op_oldheight;
        P_SetThingPosition(players[0 as libc::c_int as usize].mo);
        (*players[0 as libc::c_int as usize].mo).color = op_oldcolor;
        if players[0 as libc::c_int as usize].powers[pw_flashing as libc::c_int as usize]
