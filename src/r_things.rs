...
extern "C" {
    ...
    fn sizeu5(num: size_t) -> *mut libc::c_char;
    ...
    fn P_SnowThinker(mobj: *mut precipmobj_t);
    fn P_RainThinker(mobj: *mut precipmobj_t);
    ...
    static mut PolyObjects: *mut polyobj_t;
    static mut numPolyObjects: int32_t;
    static mut spritecachedinfo: *mut sprcache_t;
    static mut colormaps: *mut lighttable_t;
    static mut numspritelumps: size_t;
    static mut max_spritelumps: size_t;
    static mut sectors: *mut sector_t;
    static mut viewx: fixed_t;
    static mut viewy: fixed_t;
    static mut viewz: fixed_t;
    static mut viewangle: angle_t;
    static mut viewsector: *mut sector_t;
    static mut viewplayer: *mut player_t;
    static mut r_viewmobj: *mut mobj_t;
    static mut xtoviewangle: [angle_t; 1921];
    ...
    static mut projectiony: fixed_t;
    static mut fovtan: fixed_t;
    static mut validcount: size_t;
    static mut rendertimefrac: fixed_t;
    static mut scalelight: [[*mut lighttable_t; 48]; 32];
    fn R_PointOnSegSide(x: fixed_t, y: fixed_t, line: *mut seg_t) -> int32_t;
    ...
    fn R_DoCulling(
        cullheight: *mut line_t,
        viewcullheight: *mut line_t,
        vz: fixed_t,
        bottomh: fixed_t,
        toph: fixed_t,
    ) -> boolean;
    static mut ps_numdrawnodes: ps_metric_t;
    static mut cv_shadow: consvar_t;
    static mut cv_spriteclip: consvar_t;
    static mut cv_translucency: consvar_t;
    static mut cv_drawdist: consvar_t;
    static mut cv_drawdist_nights: consvar_t;
    static mut cv_drawdist_precip: consvar_t;
    static mut drawsegs: *mut drawseg_t;
    static mut ds_p: *mut drawseg_t;
    fn R_RenderMaskedSegRange(ds: *mut drawseg_t, x1: int32_t, x2: int32_t);
    fn R_RenderThickSideRange(
        ds: *mut drawseg_t,
        x1: int32_t,
        x2: int32_t,
        pffloor: *mut ffloor_t,
    );
    ...
    fn R_UsingFrameInterpolation() -> boolean;
    fn R_InterpolateMobjState(
        mobj: *mut mobj_t,
        frac: fixed_t,
        out: *mut interpmobjstate_t,
    );
    fn R_InterpolatePrecipMobjState(
        mobj: *mut precipmobj_t,
        frac: fixed_t,
        out: *mut interpmobjstate_t,
    );
    fn Patch_GetRotatedSprite(
        sprite: *mut spriteframe_t,
        frame: size_t,
        spriteangle: size_t,
        flip: boolean,
        adjustfeet: boolean,
        info: *mut libc::c_void,
        rotationangle: int32_t,
    ) -> *mut patch_t;
    fn R_SpriteRotationAngle(interp: *mut interpmobjstate_t) -> angle_t;
    fn R_GetRollAngle(rollangle: angle_t) -> int32_t;
    static mut portalrender: uint8_t;
    static mut portalclipline: *mut line_t;
    static mut portalclipstart: int32_t;
    static mut portalclipend: int32_t;
    ...
    static mut dc_yl: int32_t;
    static mut ylookup: [*mut uint8_t; 4800];
    static mut dc_source: *mut uint8_t;
    static mut dc_yh: int32_t;
    static mut dc_x: int32_t;
    fn R_GetTranslucencyTable(alphalevel: int32_t) -> *mut uint8_t;
    fn R_ThingBoundingBoxVisible(thing: *mut mobj_t) -> boolean;
    fn R_GetBlendTable(style: libc::c_int, alphalevel: int32_t) -> *mut uint8_t;
    fn R_BlendLevelVisible(blendmode: int32_t, alphalevel: int32_t) -> boolean;
    static mut dc_hires: uint8_t;
    static mut dc_iscale: fixed_t;
    static mut dc_texheight: int32_t;
    static mut dc_colormap: *mut lighttable_t;
    fn R_DrawDropShadowColumn_8();
    static mut dc_transmap: *mut uint8_t;
    fn R_GetTranslationColormap(
        skinnum: int32_t,
        color: skincolornum_t,
        flags: uint8_t,
    ) -> *mut uint8_t;
    static mut dc_translation: *mut uint8_t;
    fn R_DrawThingBoundingBox(spr: *mut vissprite_t);
    fn R_PlaneBounds(plane: *mut visplane_t);
    fn R_DrawSinglePlane(pl: *mut visplane_t);
    fn ST_ReloadSkinFaceGraphics();
    static mut objectsdrawn: uint16_t;
    ...
    static mut rollcosang: [fixed_t; 72];
    static mut rollsinang: [fixed_t; 72];
    fn R_DrawFloorSplat(spr: *mut vissprite_t);
    ...
    fn P_GetLightZAt(light: *const lightlist_t, x: fixed_t, y: fixed_t) -> fixed_t;
...
pub const COLDRAWFUNC_MAX: C2RustUnnamed_8 = 9;
pub const COLDRAWFUNC_FOG: C2RustUnnamed_8 = 8;
pub const COLDRAWFUNC_TWOSMULTIPATCHTRANS: C2RustUnnamed_8 = 7;
pub const COLDRAWFUNC_TWOSMULTIPATCH: C2RustUnnamed_8 = 6;
pub const COLDRAWFUNC_TRANSTRANS: C2RustUnnamed_8 = 5;
pub const COLDRAWFUNC_SHADOWED: C2RustUnnamed_8 = 4;
pub const COLDRAWFUNC_SHADE: C2RustUnnamed_8 = 3;
pub const COLDRAWFUNC_TRANS: C2RustUnnamed_8 = 2;
pub const COLDRAWFUNC_FUZZY: C2RustUnnamed_8 = 1;
pub const COLDRAWFUNC_BASE: C2RustUnnamed_8 = 0;
pub type C2RustUnnamed_9 = libc::c_uint;
pub const POF_SPLAT: C2RustUnnamed_9 = 8192;
pub const POF_NOSPECIALS: C2RustUnnamed_9 = 4096;
pub const POF_ONESIDE: C2RustUnnamed_9 = 2048;
pub const POF_LDEXEC: C2RustUnnamed_9 = 1024;
pub const POF_PUSHABLESTOP: C2RustUnnamed_9 = 512;
pub const POF_INVERTPLANESONLY: C2RustUnnamed_9 = 256;
pub const POF_INVERTPLANES: C2RustUnnamed_9 = 128;
pub const POF_INVERT: C2RustUnnamed_9 = 64;
pub const POF_RENDERALL: C2RustUnnamed_9 = 56;
pub const POF_RENDERPLANES: C2RustUnnamed_9 = 48;
pub const POF_RENDERBOTTOM: C2RustUnnamed_9 = 32;
pub const POF_RENDERTOP: C2RustUnnamed_9 = 16;
pub const POF_RENDERSIDES: C2RustUnnamed_9 = 8;
pub const POF_TESTHEIGHT: C2RustUnnamed_9 = 4;
pub const POF_SOLID: C2RustUnnamed_9 = 3;
pub const POF_CLIPPLANES: C2RustUnnamed_9 = 2;
pub const POF_CLIPLINES: C2RustUnnamed_9 = 1;
...
pub struct drawseg_s {
    ...
    pub silhouette: int32_t,
    pub bsilheight: fixed_t,
    pub tsilheight: fixed_t,
    pub sprtopclip: *mut int16_t,
    pub sprbottomclip: *mut int16_t,
    pub maskedtexturecol: *mut fixed_t,
    pub ffloorplanes: [*mut visplane_s; 40],
    pub numffloorplanes: int32_t,
    pub thicksides: [*mut ffloor_s; 40],
    pub thicksidecol: *mut fixed_t,
    pub numthicksides: int32_t,
    pub frontscale: [fixed_t; 1920],
    pub portalpass: uint8_t,
    pub maskedtextureheight: [fixed_t; 1920],
    pub leftpos: vertex_t,
    pub rightpos: vertex_t,
}
...
pub const RF_DROPSHADOW: C2RustUnnamed_10 = 49664;
pub const RF_SHADOWEFFECTS: C2RustUnnamed_10 = 32768;
pub const RF_SHADOWDRAW: C2RustUnnamed_10 = 16384;
pub const RF_FLOORSPRITE: C2RustUnnamed_10 = 8192;
pub const RF_PAPERSPRITE: C2RustUnnamed_10 = 4096;
pub const RF_SPRITETYPEMASK: C2RustUnnamed_10 = 12288;
pub const RF_NOCOLORMAPS: C2RustUnnamed_10 = 1024;
pub const RF_SEMIBRIGHT: C2RustUnnamed_10 = 768;
pub const RF_FULLDARK: C2RustUnnamed_10 = 512;
pub const RF_FULLBRIGHT: C2RustUnnamed_10 = 256;
pub const RF_BRIGHTMASK: C2RustUnnamed_10 = 768;
pub const RF_NOSPLATROLLANGLE: C2RustUnnamed_10 = 128;
pub const RF_NOSPLATBILLBOARD: C2RustUnnamed_10 = 64;
pub const RF_OBJECTSLOPESPLAT: C2RustUnnamed_10 = 32;
pub const RF_SLOPESPLAT: C2RustUnnamed_10 = 16;
pub const RF_SPLATMASK: C2RustUnnamed_10 = 240;
pub const RF_FLIPOFFSETS: C2RustUnnamed_10 = 8;
pub const RF_ABSOLUTEOFFSETS: C2RustUnnamed_10 = 4;
pub const RF_VERTICALFLIP: C2RustUnnamed_10 = 2;
pub const RF_HORIZONTALFLIP: C2RustUnnamed_10 = 1;
pub type C2RustUnnamed_11 = libc::c_uint;
pub const SRF_NONE: C2RustUnnamed_11 = 255;
pub const SRF_2D: C2RustUnnamed_11 = 12;
pub const SRF_RIGHT: C2RustUnnamed_11 = 8;
pub const SRF_LEFT: C2RustUnnamed_11 = 4;
pub const SRF_3DMASK: C2RustUnnamed_11 = 3;
pub const SRF_3DGE: C2RustUnnamed_11 = 2;
pub const SRF_3D: C2RustUnnamed_11 = 1;
pub const SRF_SINGLE: C2RustUnnamed_11 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const PU_STATIC: C2RustUnnamed_16 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct vissprite_s {
    ...
    pub xscale: fixed_t,
    pub scale: fixed_t,
    pub thingscale: fixed_t,
    pub sortscale: fixed_t,
    pub sortsplat: fixed_t,
    pub linkscale: fixed_t,
    pub scalestep: fixed_t,
    pub paperoffset: fixed_t,
    pub paperdistance: fixed_t,
    pub xiscale: fixed_t,
    pub centerangle: angle_t,
    pub viewpoint: C2RustUnnamed_14,
    pub shear: C2RustUnnamed_13,
    pub texturemid: fixed_t,
    pub patch: *mut patch_t,
    pub colormap: *mut lighttable_t,
    pub transmap: *mut uint8_t,
    pub mobjflags: int32_t,
    pub heightsec: int32_t,
    pub extra_colormap: *mut extracolormap_t,
    pub thingheight: fixed_t,
    pub sector: *mut sector_t,
    pub sz: int16_t,
    pub szt: int16_t,
    pub cut: spritecut_e,
    pub renderflags: uint32_t,
    pub rotateflags: uint8_t,
    pub spritexscale: fixed_t,
    pub spriteyscale: fixed_t,
    pub spritexoffset: fixed_t,
    pub spriteyoffset: fixed_t,
    pub shadowscale: fixed_t,
    pub color: skincolornum_t,
    pub clipbot: [int16_t; 1920],
    pub cliptop: [int16_t; 1920],
    pub dispoffset: int32_t,
}
pub type spritecut_e = libc::c_int;
pub const SC_FLAGMASK: spritecut_e = -8;
pub const SC_CUTMASK: spritecut_e = 7;
pub const SC_BBOX: spritecut_e = 16384;
pub const SC_SPLAT: spritecut_e = 8192;
pub const SC_SHEAR: spritecut_e = 4096;
pub const SC_SHADOW: spritecut_e = 2048;
pub const SC_ISROTATED: spritecut_e = 1024;
pub const SC_ISSCALED: spritecut_e = 512;
pub const SC_VFLIP: spritecut_e = 256;
pub const SC_FULLDARK: spritecut_e = 128;
pub const SC_SEMIBRIGHT: spritecut_e = 64;
pub const SC_FULLBRIGHT: spritecut_e = 32;
pub const SC_LINKDRAW: spritecut_e = 16;
pub const SC_PRECIP: spritecut_e = 8;
pub const SC_NOTVISIBLE: spritecut_e = 4;
pub const SC_BOTTOM: spritecut_e = 2;
pub const SC_TOP: spritecut_e = 1;
pub const SC_NONE: spritecut_e = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const PU_SPRITE: C2RustUnnamed_16 = 18;
pub const PU_LEVEL: C2RustUnnamed_16 = 50;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct maskcount_t {
    pub drawsegs: [size_t; 2],
    pub vissprites: [size_t; 2],
    pub viewx: fixed_t,
    pub viewy: fixed_t,
    pub viewz: fixed_t,
    pub viewsector: *mut sector_t,
}
pub type drawnode_t = drawnode_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct drawnode_s {
    pub plane: *mut visplane_t,
    pub seg: *mut drawseg_t,
    pub thickseg: *mut drawseg_t,
    pub ffloor: *mut ffloor_t,
    pub sprite: *mut vissprite_t,
    pub next: *mut drawnode_s,
    pub prev: *mut drawnode_s,
}
pub const TC_DEFAULT: C2RustUnnamed_15 = -122;
pub const TC_RAINBOW: C2RustUnnamed_15 = -125;
pub const TC_DASHMODE: C2RustUnnamed_15 = -123;
pub const TC_BOSS: C2RustUnnamed_15 = -128;
pub const TC_METALSONIC: C2RustUnnamed_15 = -127;
pub const TC_ALLWHITE: C2RustUnnamed_15 = -126;
pub type drawseg_xrange_item_t = drawseg_xrange_item_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct drawseg_xrange_item_s {
    pub x1: int16_t,
    pub x2: int16_t,
    pub user: *mut drawseg_t,
}
pub type drawsegs_xrange_t = drawsegs_xrange_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct drawsegs_xrange_s {
    pub items: *mut drawseg_xrange_item_t,
    pub count: int32_t,
}
pub type C2RustUnnamed_15 = libc::c_int;
pub const TC_BLINK: C2RustUnnamed_15 = -124;
pub type C2RustUnnamed_16 = libc::c_uint;
pub const PU_HWRMODELTEXTURE_UNLOCKED: C2RustUnnamed_16 = 103;
pub const PU_HWRCACHE_UNLOCKED: C2RustUnnamed_16 = 102;
pub const PU_CACHE_UNLOCKED: C2RustUnnamed_16 = 101;
pub const PU_PURGELEVEL: C2RustUnnamed_16 = 100;
pub const PU_HWRPLANE: C2RustUnnamed_16 = 52;
pub const PU_LEVSPEC: C2RustUnnamed_16 = 51;
pub const PU_CACHE: C2RustUnnamed_16 = 49;
pub const PU_HWRCACHE: C2RustUnnamed_16 = 48;
pub const PU_HWRMODELTEXTURE: C2RustUnnamed_16 = 23;
pub const PU_HWRPATCHCOLMIPMAP: C2RustUnnamed_16 = 22;
pub const PU_HWRPATCHINFO: C2RustUnnamed_16 = 21;
pub const PU_HUDGFX: C2RustUnnamed_16 = 19;
pub const PU_PATCH_DATA: C2RustUnnamed_16 = 17;
pub const PU_PATCH_ROTATED: C2RustUnnamed_16 = 16;
pub const PU_PATCH_LOWPRIORITY: C2RustUnnamed_16 = 15;
pub const PU_PATCH: C2RustUnnamed_16 = 14;
pub const PU_MUSIC: C2RustUnnamed_16 = 12;
pub const PU_SOUND: C2RustUnnamed_16 = 11;
pub const PU_PERFSTATS: C2RustUnnamed_16 = 3;
pub const PU_LUA: C2RustUnnamed_16 = 2;
#[inline(always)]
...
#[inline(always)]
unsafe extern "C" fn R_Rotation2Char(mut rot: uint8_t) -> libc::c_char {
    if rot as libc::c_int <= 9 as libc::c_int {
        return ('0' as i32 + rot as libc::c_int) as libc::c_char;
    }
    if rot as libc::c_int <= 16 as libc::c_int {
        return ('A' as i32 + (rot as libc::c_int - 10 as libc::c_int)) as libc::c_char;
    }
    if rot as libc::c_int == 17 as libc::c_int {
        return 'L' as i32 as libc::c_char;
    }
    if rot as libc::c_int == 18 as libc::c_int {
        return 'R' as i32 as libc::c_char;
    }
    return -1i32 as libc::c_char;
}
#[inline(always)]
unsafe extern "C" fn R_Char2Rotation(mut cn: libc::c_char) -> uint8_t {
    if cn as libc::c_int >= '0' as i32 && cn as libc::c_int <= '9' as i32 {
        return (cn as libc::c_int - '0' as i32) as uint8_t;
    }
    if cn as libc::c_int >= 'A' as i32 && cn as libc::c_int <= 'G' as i32 {
        return (cn as libc::c_int - 'A' as i32 + 10 as libc::c_int) as uint8_t;
    }
    if cn as libc::c_int == 'L' as i32 {
        return 17 as libc::c_int as uint8_t;
    }
    if cn as libc::c_int == 'R' as i32 {
...
static mut spritelights: *mut *mut lighttable_t = 0 as *const *mut lighttable_t
    as *mut *mut lighttable_t;
#[no_mangle]
pub static mut negonearray: [int16_t; 1920] = [0; 1920];
#[no_mangle]
pub static mut screenheightarray: [int16_t; 1920] = [0; 1920];
#[no_mangle]
pub static mut spriteinfo: [spriteinfo_t; 907] = [spriteinfo_t {
    pivot: [spriteframepivot_t { x: 0, y: 0 }; 64],
    available: 0,
}; 907];
#[no_mangle]
pub static mut sprites: *mut spritedef_t = 0 as *const spritedef_t as *mut spritedef_t;
#[no_mangle]
pub static mut numsprites: size_t = 0;
static mut sprtemp: [spriteframe_t; 64] = [spriteframe_t {
    rotate: 0,
    lumppat: [0; 16],
    lumpid: [0; 16],
    flip: 0,
    rotated: [[0 as *const rotsprite_t as *mut rotsprite_t; 16]; 2],
}; 64];
static mut maxframe: size_t = 0;
static mut spritename: *const libc::c_char = 0 as *const libc::c_char;
static mut drawsegs_xranges: [drawsegs_xrange_t; 3] = [drawsegs_xrange_s {
    items: 0 as *const drawseg_xrange_item_t as *mut drawseg_xrange_item_t,
    count: 0,
}; 3];
static mut drawsegs_xrange: *mut drawseg_xrange_item_t = 0
    as *const drawseg_xrange_item_t as *mut drawseg_xrange_item_t;
static mut drawsegs_xrange_size: size_t = 0 as libc::c_int as size_t;
static mut drawsegs_xrange_count: int32_t = 0 as libc::c_int;
unsafe extern "C" fn R_InstallSpriteLump(
    mut wad: uint16_t,
    mut lump: uint16_t,
    mut lumpid: size_t,
    mut frame: uint8_t,
    ...
    let mut cn: libc::c_char = R_Frame2Char(frame);
    let mut cr: libc::c_char = R_Rotation2Char(rotation);
    let mut r: int32_t = 0;
    let mut lumppat: lumpnum_t = wad as lumpnum_t;
    lumppat <<= 16 as libc::c_int;
    lumppat = lumppat.wrapping_add(lump as lumpnum_t);
    if maxframe == -(1 as libc::c_int) as size_t || frame as size_t > maxframe {
        maxframe = frame as size_t;
    }
    r = 0 as libc::c_int;
    while r < 16 as libc::c_int {
        sprtemp[frame as usize]
            .rotated[0 as libc::c_int as usize][r as usize] = 0 as *mut rotsprite_t;
        sprtemp[frame as usize]
            .rotated[1 as libc::c_int as usize][r as usize] = 0 as *mut rotsprite_t;
        r += 1;
        r;
    }
    if rotation as libc::c_int == 0 as libc::c_int {
        if sprtemp[frame as usize].rotate as libc::c_int == SRF_SINGLE as libc::c_int {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has multiple rot = 0 lump\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        } else if sprtemp[frame as usize].rotate as libc::c_int
            != SRF_NONE as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has rotations and a rot = 0 lump\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        }
        sprtemp[frame as usize].rotate = SRF_SINGLE as libc::c_int as uint8_t;
        r = 0 as libc::c_int;
        while r < 16 as libc::c_int {
            sprtemp[frame as usize].lumppat[r as usize] = lumppat;
            sprtemp[frame as usize].lumpid[r as usize] = lumpid;
            r += 1;
            r;
        }
        sprtemp[frame as usize]
            .flip = (if flipped as libc::c_int != 0 {
    ...
    if rotation as libc::c_int == 17 as libc::c_int
        || rotation as libc::c_int == 18 as libc::c_int
    {
        let mut rightfactor: uint8_t = (if rotation as libc::c_int == 18 as libc::c_int {
            4 as libc::c_int
        } else {
            0 as libc::c_int
        }) as uint8_t;
        if sprtemp[frame as usize].rotate as libc::c_int == SRF_NONE as libc::c_int {
            sprtemp[frame as usize].rotate = SRF_SINGLE as libc::c_int as uint8_t;
        } else if sprtemp[frame as usize].rotate as libc::c_int
            == SRF_SINGLE as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has L/R rotations and a rot = 0 lump\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        } else if sprtemp[frame as usize].rotate as libc::c_int == SRF_3D as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has both L/R and 1-8 rotations\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        } else if sprtemp[frame as usize].rotate as libc::c_int
            == SRF_3DGE as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has both L/R and 1-G rotations\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        } else if sprtemp[frame as usize].rotate as libc::c_int & SRF_LEFT as libc::c_int
            != 0 && rotation as libc::c_int == 17 as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has multiple L rotations\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        } else if sprtemp[frame as usize].rotate as libc::c_int
            & SRF_RIGHT as libc::c_int != 0
            && rotation as libc::c_int == 18 as libc::c_int
        {
            CONS_Debug(
                0x400 as libc::c_int,
                b"R_InitSprites: Sprite %s frame %c has multiple R rotations\n\0"
                    as *const u8 as *const libc::c_char,
                spritename,
                cn as libc::c_int,
            );
        ...
        sprtemp[frame as usize]
            .rotate = (sprtemp[frame as usize].rotate as libc::c_int
            | if rotation as libc::c_int == 18 as libc::c_int {
                SRF_RIGHT as libc::c_int
            } else {
                SRF_LEFT as libc::c_int
            }) as uint8_t;
        if sprtemp[frame as usize].rotate as libc::c_int & SRF_2D as libc::c_int
            == SRF_2D as libc::c_int
        {
            sprtemp[frame as usize]
                .rotate = (sprtemp[frame as usize].rotate as libc::c_int
                & !(SRF_3DMASK as libc::c_int)) as uint8_t;
        }
        r = 0 as libc::c_int;
        while r < 4 as libc::c_int {
            sprtemp[frame as usize]
                .lumppat[(r + rightfactor as libc::c_int) as usize] = lumppat;
            sprtemp[frame as usize]
                .lumpid[(r + rightfactor as libc::c_int) as usize] = lumpid;
            sprtemp[frame as usize]
                .lumppat[(r + rightfactor as libc::c_int + 8 as libc::c_int)
                as usize] = lumppat;
            sprtemp[frame as usize]
                .lumpid[(r + rightfactor as libc::c_int + 8 as libc::c_int)
                as usize] = lumpid;
            r += 1;
            r;
        }
        if flipped != 0 {
            sprtemp[frame as usize]
                .flip = (sprtemp[frame as usize].flip as libc::c_int
                | (0xf0f as libc::c_int) << rightfactor as libc::c_int) as uint16_t;
        } else {
            sprtemp[frame as usize]
                .flip = (sprtemp[frame as usize].flip as libc::c_int
                & !((0xf0f as libc::c_int) << rightfactor as libc::c_int)) as uint16_t;
    ...
    if sprtemp[frame as usize].rotate as libc::c_int == SRF_NONE as libc::c_int {
        sprtemp[frame as usize].rotate = SRF_SINGLE as libc::c_int as uint8_t;
    } else if sprtemp[frame as usize].rotate as libc::c_int == SRF_SINGLE as libc::c_int
    {
        CONS_Debug(
            0x400 as libc::c_int,
            b"R_InitSprites: Sprite %s frame %c has 1-8/G rotations and a rot = 0 lump\n\0"
                as *const u8 as *const libc::c_char,
            spritename,
            cn as libc::c_int,
        );
    } else if sprtemp[frame as usize].rotate as libc::c_int & SRF_2D as libc::c_int != 0
    {
        CONS_Debug(
            0x400 as libc::c_int,
            b"R_InitSprites: Sprite %s frame %c has both L/R and 1-8/G rotations\n\0"
                as *const u8 as *const libc::c_char,
            spritename,
            cn as libc::c_int,
        );
    ...
    rotation;
    let mut threedrot: uint8_t = (if rotation as libc::c_int > 7 as libc::c_int {
        SRF_3DGE as libc::c_int
    } else {
        sprtemp[frame as usize].rotate as libc::c_int & SRF_3DMASK as libc::c_int
    }) as uint8_t;
    if threedrot == 0 {
        threedrot = SRF_3D as libc::c_int as uint8_t;
    }
    if rotation as libc::c_int == 0 as libc::c_int
        || rotation as libc::c_int == 4 as libc::c_int
    {
        sprtemp[frame as usize].rotate = threedrot;
    } else if rotation as libc::c_int & 7 as libc::c_int > 3 as libc::c_int {
        sprtemp[frame as usize]
            .rotate = (threedrot as libc::c_int
            | sprtemp[frame as usize].rotate as libc::c_int & SRF_LEFT as libc::c_int)
            as uint8_t;
    } else {
        sprtemp[frame as usize]
            .rotate = (threedrot as libc::c_int
            | sprtemp[frame as usize].rotate as libc::c_int & SRF_RIGHT as libc::c_int)
            as uint8_t;
    }
    if sprtemp[frame as usize].lumppat[rotation as usize] != 4294967295 as libc::c_uint {
        CONS_Debug(
            0x400 as libc::c_int,
            b"R_InitSprites: Sprite %s: %c%c has two lumps mapped to it\n\0" as *const u8
    ...
    sprtemp[frame as usize].lumppat[rotation as usize] = lumppat;
    sprtemp[frame as usize].lumpid[rotation as usize] = lumpid;
    if flipped != 0 {
        sprtemp[frame as usize]
            .flip = (sprtemp[frame as usize].flip as libc::c_int
            | (1 as libc::c_int) << rotation as libc::c_int) as uint16_t;
    } else {
        sprtemp[frame as usize]
            .flip = (sprtemp[frame as usize].flip as libc::c_int
            & !((1 as libc::c_int) << rotation as libc::c_int)) as uint16_t;
...
#[no_mangle]
pub unsafe extern "C" fn R_AddSingleSpriteDef(
    mut sprname: *const libc::c_char,
    mut spritedef: *mut spritedef_t,
    mut wadnum: uint16_t,
    mut startlump: uint16_t,
    mut endlump: uint16_t,
) -> boolean {
    let mut l: uint16_t = 0;
    let mut frame: uint8_t = 0;
    let mut rotation: uint8_t = 0;
    let mut lumpinfo: *mut lumpinfo_t = 0 as *mut lumpinfo_t;
    let mut patch: softwarepatch_t = softwarepatch_t {
        width: 0,
        height: 0,
        leftoffset: 0,
        topoffset: 0,
    ...
    let mut numadded: uint16_t = 0 as libc::c_int as uint16_t;
    memset(
        sprtemp.as_mut_ptr() as *mut libc::c_void,
        0xff as libc::c_int,
        ::core::mem::size_of::<[spriteframe_t; 64]>() as libc::c_ulong,
    );
    maxframe = -(1 as libc::c_int) as size_t;
    spritename = sprname;
    if (*spritedef).numframes != 0 {
        M_Memcpy
            ...
            sprtemp.as_mut_ptr() as *mut libc::c_void,
            (*spritedef).spriteframes as *const libc::c_void,
            ((*spritedef).numframes)
                .wrapping_mul(::core::mem::size_of::<spriteframe_t>() as libc::c_ulong),
        );
        maxframe = ((*spritedef).numframes).wrapping_sub(1 as libc::c_int as size_t);
    }
    lumpinfo = (**wadfiles.offset(wadnum as isize)).lumpinfo;
    if endlump as libc::c_int
        > (**wadfiles.offset(wadnum as isize)).numlumps as libc::c_int
    {
        endlump = (**wadfiles.offset(wadnum as isize)).numlumps;
    }
    let mut current_block_41: u64;
    l = startlump;
    while (l as libc::c_int) < endlump as libc::c_int {
        if memcmp(
            ((*lumpinfo.offset(l as isize)).name).as_mut_ptr() as *const libc::c_void,
            sprname as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
        {
            let mut width: int32_t = 0;
            let mut height: int32_t = 0;
            let mut topoffset: int16_t = 0;
            let mut leftoffset: int16_t = 0;
            let mut isPNG: boolean = false_0 as libc::c_int;
            frame = R_Char2Frame(
                (*lumpinfo.offset(l as isize)).name[4 as libc::c_int as usize],
            );
            rotation = R_Char2Rotation(
                (*lumpinfo.offset(l as isize)).name[5 as libc::c_int as usize],
            );
            if frame as libc::c_int >= 64 as libc::c_int
                || rotation as libc::c_int == 255 as libc::c_int
            {
                CONS_Alert(
                    CONS_WARNING,
            ...
            } else if !(W_LumpLengthPwad(wadnum, l) <= 8 as libc::c_int as size_t) {
                let mut png: *mut softwarepatch_t = W_CacheLumpNumPwad(
                    wadnum,
                    l,
                    PU_STATIC as libc::c_int,
                ) as *mut softwarepatch_t;
                let mut len: size_t = W_LumpLengthPwad(wadnum, l);
                if Picture_IsLumpPNG(png as *mut uint8_t, len) != 0 {
                ...
                if isPNG == 0 {
                    W_ReadLumpHeaderPwad(
                        wadnum,
                        l,
                        &mut patch as *mut softwarepatch_t as *mut libc::c_void,
                        (::core::mem::size_of::<int16_t>() as libc::c_ulong)
                            .wrapping_mul(4 as libc::c_int as libc::c_ulong),
                        0 as libc::c_int as size_t,
                    );
                    width = patch.width as int32_t;
                    height = patch.height as int32_t;
                    topoffset = patch.topoffset;
                    leftoffset = patch.leftoffset;
                }
                (*spritecachedinfo.offset(numspritelumps as isize))
                    .width = width << 16 as libc::c_int;
                (*spritecachedinfo.offset(numspritelumps as isize))
                    .offset = (leftoffset as libc::c_int) << 16 as libc::c_int;
                (*spritecachedinfo.offset(numspritelumps as isize))
                    .topoffset = (topoffset as libc::c_int) << 16 as libc::c_int;
                (*spritecachedinfo.offset(numspritelumps as isize))
                    .height = height << 16 as libc::c_int;
                let ref mut fresh0 = (*spritecachedinfo.offset(numspritelumps as isize))
                    .topoffset;
                *fresh0 += (4 as libc::c_int) << 16 as libc::c_int;
                R_InstallSpriteLump(
                    wadnum,
                    l,
                    numspritelumps,
                ...
                if (*lumpinfo.offset(l as isize)).name[6 as libc::c_int as usize] != 0 {
                    frame = R_Char2Frame(
                        (*lumpinfo.offset(l as isize)).name[6 as libc::c_int as usize],
                    );
                    rotation = R_Char2Rotation(
                        (*lumpinfo.offset(l as isize)).name[7 as libc::c_int as usize],
                    );
                    if frame as libc::c_int >= 64 as libc::c_int
                        || rotation as libc::c_int == 255 as libc::c_int
                    {
                        ...
                        current_block_41 = 11812396948646013369;
                    } else {
                        R_InstallSpriteLump(
                            wadnum,
                            l,
                        ...
                        current_block_41 = 17184638872671510253;
                    }
                } else {
                    current_block_41 = 17184638872671510253;
                }
                match current_block_41 {
                    ...
                    _ => {
                        numspritelumps = numspritelumps.wrapping_add(1);
                        if numspritelumps >= max_spritelumps {
                            max_spritelumps = max_spritelumps
                                * 2 as libc::c_int as size_t;
                            Z_ReallocAlign(
                                spritecachedinfo as *mut libc::c_void,
                                max_spritelumps
                                    .wrapping_mul(
                                        ::core::mem::size_of::<sprcache_t>() as libc::c_ulong,
                                    ),
                                PU_STATIC as libc::c_int,
                                &mut spritecachedinfo as *mut *mut sprcache_t
                                    as *mut libc::c_void,
                                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong
                                    as int32_t,
                            );
                        }
                        numadded = numadded.wrapping_add(1);
                        numadded;
                    }
                }
            }
    ...
    if maxframe == -(1 as libc::c_int) as size_t {
        return false_0 as libc::c_int
    } else if numadded == 0 {
        return false_0 as libc::c_int
    }
    maxframe = maxframe.wrapping_add(1);
    maxframe;
    frame = 0 as libc::c_int as uint8_t;
    while (frame as size_t) < maxframe {
        match sprtemp[frame as usize].rotate as libc::c_int {
            255 => {
                I_Error(
                    b"R_AddSingleSpriteDef: No patches found for %.4s frame %c\0"
                        as *const u8 as *const libc::c_char,
                    sprname,
                    R_Frame2Char(frame) as libc::c_int,
                );
            }
            0 => {}
            12 => {
                if sprtemp[frame as usize].lumppat[2 as libc::c_int as usize]
                    == 4294967295 as libc::c_uint
                    || sprtemp[frame as usize].lumppat[6 as libc::c_int as usize]
                        == 4294967295 as libc::c_uint
                {
                    I_Error(
                        b"R_AddSingleSpriteDef: Sprite %.4s frame %c is missing rotations (L-R mode)\0"
                            as *const u8 as *const libc::c_char,
                        sprname,
                        R_Frame2Char(frame) as libc::c_int,
                    );
            ...
            _ => {
                rotation = (if sprtemp[frame as usize].rotate as libc::c_int
                    & SRF_3DGE as libc::c_int != 0
                {
                    16 as libc::c_int
                } else {
                    8 as libc::c_int
                ...
                loop {
                    ...
                    if sprtemp[frame as usize].lumppat[rotation as usize]
                        == 4294967295 as libc::c_uint
                    {
                        I_Error(
                            b"R_AddSingleSpriteDef: Sprite %.4s frame %c is missing rotations (1-%c mode)\0"
                                as *const u8 as *const libc::c_char,
                            sprname,
                            R_Frame2Char(frame) as libc::c_int,
                            if sprtemp[frame as usize].rotate as libc::c_int
                                & SRF_3DGE as libc::c_int != 0
                            {
                                'G' as i32
                            } else {
    ...
    if (*spritedef).numframes != 0 && (*spritedef).numframes < maxframe {
        Z_Free((*spritedef).spriteframes as *mut libc::c_void);
        (*spritedef).spriteframes = 0 as *mut spriteframe_t;
    }
    if ((*spritedef).spriteframes).is_null() {
        (*spritedef)
            .spriteframes = Z_MallocAlign(
            maxframe
                .wrapping_mul(::core::mem::size_of::<spriteframe_t>() as libc::c_ulong),
            PU_STATIC as libc::c_int,
    ...
    M_Memcpy
        ...
        (*spritedef).spriteframes as *mut libc::c_void,
        sprtemp.as_mut_ptr() as *const libc::c_void,
        maxframe.wrapping_mul(::core::mem::size_of::<spriteframe_t>() as libc::c_ulong),
    );
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_AddSpriteDefs(mut wadnum: uint16_t) {
    let mut i: size_t = 0;
    let mut addsprites: size_t = 0 as libc::c_int as size_t;
    let mut start: uint16_t = 0;
    let mut end: uint16_t = 0;
    let mut wadname: [libc::c_char; 512] = [0; 512];
    match (**wadfiles.offset(wadnum as isize)).type_0 as libc::c_uint {
        0 => {
            start = W_CheckNumForMarkerStartPwad(
                b"S_START\0" as *const u8 as *const libc::c_char,
                wadnum,
                0 as libc::c_int as uint16_t,
            );
            if start as libc::c_int == 32767 as libc::c_int {
                start = W_CheckNumForMarkerStartPwad(
                    b"SS_START\0" as *const u8 as *const libc::c_char,
                    wadnum,
                    0 as libc::c_int as uint16_t,
                );
            }
            end = W_CheckNumForNamePwad(
                b"S_END\0" as *const u8 as *const libc::c_char,
                wadnum,
                start,
            );
            if end as libc::c_int == 32767 as libc::c_int {
                end = W_CheckNumForNamePwad(
                    b"SS_END\0" as *const u8 as *const libc::c_char,
                    wadnum,
                    start,
                );
            }
    ...
    if start as libc::c_int == 32767 as libc::c_int {
        if W_CheckNumForNamePwad(
            b"S_SKIN\0" as *const u8 as *const libc::c_char,
            wadnum,
            0 as libc::c_int as uint16_t,
        ...
        start = 0 as libc::c_int as uint16_t;
    }
    if end as libc::c_int == 32767 as libc::c_int
        || start as libc::c_int >= end as libc::c_int
    {
        CONS_Debug(
            0x400 as libc::c_int,
            b"no sprites in pwad %d\n\0" as *const u8 as *const libc::c_char,
            wadnum as libc::c_int,
        );
        return;
    }
    i = 0 as libc::c_int as size_t;
    while i < numsprites {
        if !(sprnames[i as usize][4 as libc::c_int as usize] as libc::c_int != 0
            && wadnum as libc::c_int
                >= sprnames[i as usize][4 as libc::c_int as usize] as uint16_t
                    as libc::c_int)
        {
            if R_AddSingleSpriteDef(
                (sprnames[i as usize]).as_mut_ptr(),
                &mut *sprites.offset(i as isize),
                wadnum,
                start,
                end,
            ) != 0
            {
                addsprites = addsprites.wrapping_add(1);
                addsprites;
                CONS_Debug(
                    0x400 as libc::c_int,
                    b"sprite %s set in pwad %d\n\0" as *const u8 as *const libc::c_char,
                    (sprnames[i as usize]).as_mut_ptr(),
                    wadnum as libc::c_int,
                );
            }
    ...
    nameonly(
        strcpy(wadname.as_mut_ptr(), (**wadfiles.offset(wadnum as isize)).filename),
    );
    CONS_Printf(
        b"%s added %d frames in %s sprites\n\0" as *const u8 as *const libc::c_char,
        wadname.as_mut_ptr(),
...
#[no_mangle]
pub static mut visspritecount: uint32_t = 0;
#[no_mangle]
pub static mut numvisiblesprites: uint32_t = 0;
static mut clippedvissprites: uint32_t = 0;
static mut visspritechunks: [*mut vissprite_t; 32] = [
    0 as *const vissprite_t as *mut vissprite_t,
    0 as *const vissprite_t as *mut vissprite_t,
    0 as *const vissprite_t as *mut vissprite_t,
    0 as *const vissprite_t as *mut vissprite_t,
    0 as *const vissprite_t as *mut vissprite_t,
...
#[no_mangle]
pub unsafe extern "C" fn R_InitSprites() {
    let mut i: size_t = 0;
    let mut angle: int32_t = 0;
    let mut fa: libc::c_float = 0.;
    i = 0 as libc::c_int as size_t;
    while i < 1920 as libc::c_int as size_t {
        negonearray[i as usize] = -(1 as libc::c_int) as int16_t;
        i = i.wrapping_add(1);
        i;
    }
    angle = 1 as libc::c_int;
    while angle < 72 as libc::c_int {
        fa = (FixedAngle(
            360 as libc::c_int / 72 as libc::c_int * angle << 16 as libc::c_int,
        ) as libc::c_double * 3.14159265358979323846f64) as libc::c_float
            / 0x80000000 as libc::c_uint as libc::c_float;
        rollcosang[angle
            as usize] = FloatToFixed(cos(-fa as libc::c_double) as libc::c_float);
        rollsinang[angle
            as usize] = FloatToFixed(sin(-fa as libc::c_double) as libc::c_float);
        angle += 1;
        angle;
    }
    numsprites = 0 as libc::c_int as size_t;
    i = 0 as libc::c_int as size_t;
    while i < (NUMSPRITES as libc::c_int + 1 as libc::c_int) as size_t {
        if sprnames[i as usize][0 as libc::c_int as usize] as libc::c_int != '\0' as i32
        {
            numsprites = numsprites.wrapping_add(1);
            numsprites;
        }
        i = i.wrapping_add(1);
        i;
    ...
    if numsprites == 0 {
        I_Error(
            b"R_AddSpriteDefs: no sprites in namelist\n\0" as *const u8
                as *const libc::c_char,
        );
    }
    sprites = Z_CallocAlign(
        numsprites.wrapping_mul(::core::mem::size_of::<spritedef_t>() as libc::c_ulong),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut spritedef_t;
    ...
    i = 0 as libc::c_int as size_t;
    while i < numwadfiles as size_t {
        R_AddSkins(i as uint16_t, true_0 as libc::c_int);
        R_PatchSkins(i as uint16_t, true_0 as libc::c_int);
        R_LoadSpriteInfoLumps(i as uint16_t, (**wadfiles.offset(i as isize)).numlumps);
        i = i.wrapping_add(1);
        i;
    }
...
pub unsafe extern "C" fn R_ClearSprites() {
    clippedvissprites = 0 as libc::c_int as uint32_t;
    numvisiblesprites = clippedvissprites;
    visspritecount = numvisiblesprites;
}
static mut overflowsprite: vissprite_t = vissprite_s {
    prev: 0 as *const vissprite_s as *mut vissprite_s,
    next: 0 as *const vissprite_s as *mut vissprite_s,
    linkdraw: 0 as *const vissprite_s as *mut vissprite_s,
    mobj: 0 as *const mobj_t as *mut mobj_t,
    x1: 0,
    x2: 0,
    gx: 0,
    gy: 0,
    ...
    xiscale: 0,
    centerangle: 0,
    viewpoint: C2RustUnnamed_14 {
        x: 0,
        y: 0,
        z: 0,
        angle: 0,
    },
    shear: C2RustUnnamed_13 {
        tan: 0,
        offset: 0,
    },
    texturemid: 0,
    patch: 0 as *const patch_t as *mut patch_t,
    colormap: 0 as *const lighttable_t as *mut lighttable_t,
    transmap: 0 as *const uint8_t as *mut uint8_t,
    mobjflags: 0,
    heightsec: 0,
    extra_colormap: 0 as *const extracolormap_t as *mut extracolormap_t,
    thingheight: 0,
    sector: 0 as *const sector_t as *mut sector_t,
    sz: 0,
    szt: 0,
    cut: SC_NONE,
    renderflags: 0,
...
unsafe extern "C" fn R_GetVisSprite(mut num: uint32_t) -> *mut vissprite_t {
    let mut chunk: uint32_t = num >> 6 as libc::c_int;
    if (visspritechunks[chunk as usize]).is_null() {
        Z_MallocAlign(
            (::core::mem::size_of::<vissprite_t>() as libc::c_ulong)
                .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            &mut *visspritechunks.as_mut_ptr().offset(chunk as isize)
                as *mut *mut vissprite_t as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        );
    }
    return (visspritechunks[chunk as usize])
        .offset(
            (num
                & (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int)
                    as uint32_t) as isize,
        );
}
unsafe extern "C" fn R_NewVisSprite() -> *mut vissprite_t {
    if visspritecount == 2048 as libc::c_int as uint32_t {
        return &mut overflowsprite;
    }
    let fresh2 = visspritecount;
    visspritecount = visspritecount.wrapping_add(1);
    return R_GetVisSprite(fresh2);
}
#[no_mangle]
pub static mut mfloorclip: *mut int16_t = 0 as *const int16_t as *mut int16_t;
#[no_mangle]
pub static mut mceilingclip: *mut int16_t = 0 as *const int16_t as *mut int16_t;
#[no_mangle]
pub static mut spryscale: fixed_t = 0 as libc::c_int;
#[no_mangle]
pub static mut sprtopscreen: fixed_t = 0 as libc::c_int;
#[no_mangle]
pub static mut sprbotscreen: fixed_t = 0 as libc::c_int;
#[no_mangle]
pub static mut windowtop: fixed_t = 0 as libc::c_int;
#[no_mangle]
pub static mut windowbottom: fixed_t = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn R_DrawMaskedColumn(mut column: *mut column_t) {
    let mut topscreen: int32_t = 0;
    let mut bottomscreen: int32_t = 0;
    let mut basetexturemid: fixed_t = 0;
    let mut topdelta: int32_t = 0;
    let mut prevdelta: int32_t = 0 as libc::c_int;
    ...
    while (*column).topdelta as libc::c_int != 0xff as libc::c_int {
        ...
        bottomscreen = topscreen + spryscale * (*column).length as libc::c_int;
        dc_yl = topscreen + ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int
            >> 16 as libc::c_int;
        dc_yh = bottomscreen - 1 as libc::c_int >> 16 as libc::c_int;
        if windowtop != 2147483647 as libc::c_int
            && windowbottom != 2147483647 as libc::c_int
        {
            if windowtop > topscreen {
                dc_yl = windowtop + ((1 as libc::c_int) << 16 as libc::c_int)
                    - 1 as libc::c_int >> 16 as libc::c_int;
            }
            if windowbottom < bottomscreen {
                dc_yh = windowbottom - 1 as libc::c_int >> 16 as libc::c_int;
            }
        }
        if dc_yh >= *mfloorclip.offset(dc_x as isize) as libc::c_int {
            dc_yh = *mfloorclip.offset(dc_x as isize) as libc::c_int - 1 as libc::c_int;
        }
        if dc_yl <= *mceilingclip.offset(dc_x as isize) as libc::c_int {
            dc_yl = *mceilingclip.offset(dc_x as isize) as libc::c_int
                + 1 as libc::c_int;
        }
        if dc_yl < 0 as libc::c_int {
            dc_yl = 0 as libc::c_int;
        }
        if dc_yh >= vid.height {
            dc_yh = vid.height - 1 as libc::c_int;
        }
        if dc_yl <= dc_yh && dc_yh > 0 as libc::c_int {
            dc_source = (column as *mut uint8_t).offset(3 as libc::c_int as isize);
            dc_texturemid = basetexturemid - (topdelta << 16 as libc::c_int);
            if !(ylookup[dc_yl as usize]).is_null() {
...
#[no_mangle]
pub static mut lengthcol: int32_t = 0;
#[no_mangle]
pub unsafe extern "C" fn R_DrawFlippedMaskedColumn(mut column: *mut column_t) {
    let mut topscreen: int32_t = 0;
    let mut bottomscreen: int32_t = 0;
    let mut basetexturemid: fixed_t = dc_texturemid;
    let mut topdelta: int32_t = 0;
    ...
    while (*column).topdelta as libc::c_int != 0xff as libc::c_int {
        ...
        prevdelta = topdelta;
        topdelta = lengthcol - (*column).length as libc::c_int - topdelta;
        topscreen = sprtopscreen + spryscale * topdelta;
        bottomscreen = if sprbotscreen == 2147483647 as libc::c_int {
            topscreen + spryscale * (*column).length as libc::c_int
        } else {
            sprbotscreen + spryscale * (*column).length as libc::c_int
        };
        dc_yl = topscreen + ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int
            >> 16 as libc::c_int;
        dc_yh = bottomscreen - 1 as libc::c_int >> 16 as libc::c_int;
        ...
        if dc_yl <= dc_yh && dc_yh > 0 as libc::c_int {
            dc_source = Z_MallocAlign(
                (*column).length as size_t,
                PU_STATIC as libc::c_int,
                0 as *mut libc::c_void,
                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
            ) as *mut uint8_t;
            s = (column as *mut uint8_t)
                .offset(2 as libc::c_int as isize)
                .offset((*column).length as libc::c_int as isize);
            d = dc_source;
            while d < dc_source.offset((*column).length as libc::c_int as isize) {
                let fresh3 = d;
                d = d.offset(1);
                *fresh3 = *s;
                s = s.offset(-1);
            ...
            Z_Free(dc_source as *mut libc::c_void);
        }
        column = (column as *mut uint8_t)
            .offset((*column).length as libc::c_int as isize)
            .offset(4 as libc::c_int as isize) as *mut column_t;
...
#[no_mangle]
pub unsafe extern "C" fn R_SpriteIsFlashing(mut vis: *mut vissprite_t) -> boolean {
    return ((*vis).cut as libc::c_int & SC_PRECIP as libc::c_int == 0
        && (*(*vis).mobj).flags
            & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t != 0
        && (*(*vis).mobj).flags2 & MF2_FRET as libc::c_int as uint32_t != 0
        && (*(*vis).mobj).flags & MF_GRENADEBOUNCE as libc::c_int as uint32_t == 0
        && leveltime & 1 as libc::c_int as tic_t != 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetSpriteTranslation(
    mut vis: *mut vissprite_t,
) -> *mut uint8_t {
    if R_SpriteIsFlashing(vis) != 0 {
        if (*(*vis).mobj).type_0 as libc::c_uint
            == MT_CYBRAKDEMON as libc::c_int as libc::c_uint
            || (*(*vis).mobj).colorized != 0
        {
        ...
        } else if (*(*vis).mobj).type_0 as libc::c_uint
            == MT_METALSONIC_BATTLE as libc::c_int as libc::c_uint
        {
            return R_GetTranslationColormap(
                TC_METALSONIC as libc::c_int,
                SKINCOLOR_NONE,
                1 as libc::c_int as uint8_t,
            )
        } else {
            return R_GetTranslationColormap(
                TC_BOSS as libc::c_int,
                (*vis).color,
                1 as libc::c_int as uint8_t,
            )
        }
    } else if (*vis).color as u64 != 0 {
        if (*vis).cut as libc::c_int & SC_PRECIP as libc::c_int == 0
            && (*(*vis).mobj).colorized != 0
        {
            return R_GetTranslationColormap(
        ...
        } else if (*vis).cut as libc::c_int & SC_PRECIP as libc::c_int == 0
            && !((*(*vis).mobj).player).is_null()
            && (*(*(*vis).mobj).player).dashmode
                >= (3 as libc::c_int * 35 as libc::c_int) as tic_t
            && (*(*(*vis).mobj).player).charflags
                & SF_DASHMODE as libc::c_int as uint32_t != 0
            && leveltime / 2 as libc::c_int as tic_t & 1 as libc::c_int as tic_t != 0
        {
            if (*(*(*vis).mobj).player).charflags & SF_MACHINE as libc::c_int as uint32_t
                != 0
            {
                return R_GetTranslationColormap(
                    TC_DASHMODE as libc::c_int,
                    SKINCOLOR_NONE,
                    1 as libc::c_int as uint8_t,
                )
            } else {
            ...
            && !((*(*vis).mobj).skin).is_null()
            && (*(*vis).mobj).sprite as libc::c_uint
                == SPR_PLAY as libc::c_int as libc::c_uint
        {
            let mut skinnum: size_t = ((*(*vis).mobj).skin as *mut skin_t)
                .offset_from(skins.as_mut_ptr()) as libc::c_long as size_t;
            return R_GetTranslationColormap(
                skinnum as int32_t,
                (*vis).color,
                1 as libc::c_int as uint8_t,
    ...
    } else if (*(*vis).mobj).sprite as libc::c_uint
        == SPR_PLAY as libc::c_int as libc::c_uint
    {
        return R_GetTranslationColormap(
            TC_DEFAULT as libc::c_int,
...
unsafe extern "C" fn R_DrawVisSprite(mut vis: *mut vissprite_t) {
    let mut column: *mut column_t = 0 as *mut column_t;
    let mut localcolfunc: Option::<unsafe extern "C" fn(*mut column_t) -> ()> = None;
    let mut texturecolumn: int32_t = 0;
    let mut pwidth: int32_t = 0;
    let mut frac: fixed_t = 0;
    let mut patch: *mut patch_t = (*vis).patch;
    let mut this_scale: fixed_t = (*vis).thingscale;
    let mut x1: int32_t = 0;
    let mut x2: int32_t = 0;
    let mut overflow_test: int64_t = 0;
    if patch.is_null() {
        return;
    }
    overflow_test = centeryfrac as int64_t
        - ((*vis).texturemid as int64_t * (*vis).scale as int64_t >> 16 as libc::c_int);
    if overflow_test < 0 as libc::c_int as int64_t {
        overflow_test = -overflow_test;
    }
    if overflow_test as uint64_t as libc::c_ulonglong
        & 0xffffffff80000000 as libc::c_ulonglong != 0
    {
        return;
    }
    if (*vis).scalestep != 0 {
        overflow_test = centeryfrac as int64_t
            - ((*vis).texturemid as int64_t
                * ((*vis).scale + (*vis).scalestep * ((*vis).x2 - (*vis).x1)) as int64_t
                >> 16 as libc::c_int);
        if overflow_test < 0 as libc::c_int as int64_t {
            overflow_test = -overflow_test;
        }
    ...
    if (*vis).startfrac < 0 as libc::c_int
        || (*vis).startfrac > ((*patch).width as libc::c_int) << 16 as libc::c_int
    {
        return;
    }
    colfunc = colfuncs[0 as libc::c_int as usize];
    dc_colormap = (*vis).colormap;
    dc_translation = R_GetSpriteTranslation(vis);
    if R_SpriteIsFlashing(vis) != 0 {
        colfunc = colfuncs[COLDRAWFUNC_TRANS as libc::c_int as usize];
    } else if (*vis).color as libc::c_uint != 0 && !((*vis).transmap).is_null() {
        colfunc = colfuncs[COLDRAWFUNC_TRANSTRANS as libc::c_int as usize];
        dc_transmap = (*vis).transmap;
    } else if !((*vis).transmap).is_null() {
        colfunc = colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize];
        dc_transmap = (*vis).transmap;
    } else if (*vis).color as u64 != 0 {
        colfunc = colfuncs[COLDRAWFUNC_TRANS as libc::c_int as usize];
    } else if (*(*vis).mobj).sprite as libc::c_uint
    ...
    if (*vis).cut as libc::c_int & SC_SHADOW as libc::c_int != 0 {
        colfunc = Some(R_DrawDropShadowColumn_8 as unsafe extern "C" fn() -> ());
    }
    if !((*vis).extra_colormap).is_null()
        && (*vis).renderflags & RF_NOCOLORMAPS as libc::c_int as uint32_t == 0
    {
        if dc_colormap.is_null() {
            dc_colormap = (*(*vis).extra_colormap).colormap;
        } else {
            dc_colormap = &mut *((*(*vis).extra_colormap).colormap)
                .offset(dc_colormap.offset_from(colormaps) as libc::c_long as isize)
                as *mut lighttable_t;
        }
    }
    if dc_colormap.is_null() {
    ...
    dc_texheight = 0 as libc::c_int;
    frac = (*vis).startfrac;
    sprbotscreen = 2147483647 as libc::c_int;
    windowbottom = sprbotscreen;
    windowtop = windowbottom;
    if (*vis).cut as libc::c_int & SC_SHADOW as libc::c_int != 0
        && !((*(*vis).mobj).skin).is_null()
        && (*((*(*vis).mobj).skin as *mut skin_t)).flags as libc::c_uint
            & SF_HIRES as libc::c_int as libc::c_uint != 0
    {
        this_scale = FixedMul(
            this_scale,
            (*((*(*vis).mobj).skin as *mut skin_t)).highresscale,
        );
    }
    if this_scale <= 0 as libc::c_int {
        this_scale = 1 as libc::c_int;
    }
    if this_scale != (1 as libc::c_int) << 16 as libc::c_int {
        if (*vis).cut as libc::c_int & SC_ISSCALED as libc::c_int == 0 {
            (*vis).scale = FixedMul((*vis).scale, this_scale);
            (*vis).scalestep = FixedMul((*vis).scalestep, this_scale);
            (*vis).xiscale = FixedDiv((*vis).xiscale, this_scale);
            (*vis)
                .cut = ::core::mem::transmute::<
                libc::c_int,
                spritecut_e,
            >((*vis).cut as libc::c_int | SC_ISSCALED as libc::c_int);
        }
    ...
    if (*vis).scalestep == 0 {
        ...
        dc_iscale = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, (*vis).scale);
    }
    x1 = (*vis).x1;
    x2 = (*vis).x2;
    if (*vis).x1 < 0 as libc::c_int {
        spryscale += (*vis).scalestep * -(*vis).x1;
        (*vis).x1 = 0 as libc::c_int;
    }
    if (*vis).x2 >= vid.width {
        (*vis).x2 = vid.width - 1 as libc::c_int;
    }
    localcolfunc = if (*vis).cut as libc::c_int & SC_VFLIP as libc::c_int != 0 {
        Some(R_DrawFlippedMaskedColumn as unsafe extern "C" fn(*mut column_t) -> ())
    } else {
        Some(R_DrawMaskedColumn as unsafe extern "C" fn(*mut column_t) -> ())
    };
    lengthcol = (*patch).height as int32_t;
    if (*vis).scalestep != 0 {
        let mut horzscale: fixed_t = FixedMul((*vis).spritexscale, this_scale);
        let mut scalestep: fixed_t = FixedMul((*vis).scalestep, (*vis).spriteyscale);
        pwidth = (*patch).width as int32_t;
        dc_x = (*vis).x1;
        while dc_x <= (*vis).x2 {
            let mut angle: angle_t = ((*vis).centerangle)
                .wrapping_add(xtoviewangle[dc_x as usize]) >> 19 as libc::c_int
                & 0xfff as libc::c_int as angle_t;
            texturecolumn = ((*vis).paperoffset
                - FixedMul(
                    finetangent[angle as usize] >> 16 as libc::c_int - 16 as libc::c_int,
                    (*vis).paperdistance,
                )) / horzscale;
            if !(texturecolumn < 0 as libc::c_int || texturecolumn >= pwidth) {
                if (*vis).xiscale < 0 as libc::c_int {
                    texturecolumn = pwidth - 1 as libc::c_int - texturecolumn;
                }
                sprtopscreen = centeryfrac - FixedMul(dc_texturemid, spryscale);
                dc_iscale = (0xffffffff as libc::c_uint)
                    .wrapping_div(spryscale as libc::c_uint) as fixed_t;
                column = ((*patch).columns)
                    .offset(
                        *((*patch).columnofs).offset(texturecolumn as isize) as isize,
                    ) as *mut column_t;
                localcolfunc.expect("non-null function pointer")(column);
            }
            dc_x += 1;
            dc_x;
            spryscale += scalestep;
        }
    } else if (*vis).cut as libc::c_int & SC_SHEAR as libc::c_int != 0 {
        dc_x = (*vis).x1;
        while dc_x <= (*vis).x2 {
            column = ((*patch).columns)
                .offset(
                    *((*patch).columnofs).offset((frac >> 16 as libc::c_int) as isize)
                        as isize,
                ) as *mut column_t;
            sprtopscreen = centeryfrac - FixedMul(dc_texturemid, spryscale);
            localcolfunc.expect("non-null function pointer")(column);
        ...
        while dc_x <= (*vis).x2 {
            ...
            dc_x;
            frac += (*vis).xiscale;
            sprtopscreen += (*vis).shear.tan;
        }
    }
    colfunc = colfuncs[0 as libc::c_int as usize];
    dc_hires = 0 as libc::c_int as uint8_t;
    (*vis).x1 = x1;
    (*vis).x2 = x2;
}
unsafe extern "C" fn R_DrawPrecipitationVisSprite(mut vis: *mut vissprite_t) {
    let mut column: *mut column_t = 0 as *mut column_t;
    let mut frac: fixed_t = 0;
...
unsafe extern "C" fn R_SplitSprite(mut sprite: *mut vissprite_t) {
    let mut i: int32_t = 0;
    let mut lightnum: int32_t = 0;
    let mut lindex: int32_t = 0;
    let mut cutfrac: int16_t = 0;
    let mut sector: *mut sector_t = 0 as *mut sector_t;
    let mut newsprite: *mut vissprite_t = 0 as *mut vissprite_t;
    sector = (*sprite).sector;
    i = 1 as libc::c_int;
    while i < (*sector).numlights {
        let mut testheight: fixed_t = 0;
        if !((*(*((*sector).lightlist).offset(i as isize)).caster).fofflags
            as libc::c_uint & FOF_CUTSPRITES as libc::c_int as libc::c_uint == 0)
        {
            testheight = P_GetLightZAt(
                &mut *((*sector).lightlist).offset(i as isize),
                (*sprite).gx,
                (*sprite).gy,
            );
            if !(testheight >= (*sprite).gzt) {
                ...
                cutfrac = (centeryfrac
                    - FixedMul(testheight - viewz, (*sprite).linkscale)
                    >> 16 as libc::c_int) as int16_t;
                if !((cutfrac as libc::c_int) < 0 as libc::c_int) {
                    if cutfrac as libc::c_int > viewheight {
                        return;
                    }
                    newsprite = M_Memcpy
                        .expect(
                        ...
                        R_NewVisSprite() as *mut libc::c_void,
                        sprite as *const libc::c_void,
                        ::core::mem::size_of::<vissprite_t>() as libc::c_ulong,
                    ) as *mut vissprite_t;
                    (*newsprite)
                        .cut = ::core::mem::transmute::<
                        ...
                        spritecut_e,
                    >(
                        (*newsprite).cut as libc::c_int
                            | (*sprite).cut as libc::c_int & SC_FLAGMASK as libc::c_int,
                    );
                    (*sprite)
                        .cut = ::core::mem::transmute::<
                        libc::c_int,
                        spritecut_e,
                    >((*sprite).cut as libc::c_int | SC_BOTTOM as libc::c_int);
                    (*sprite).gz = testheight;
                    (*newsprite).gzt = (*sprite).gz;
                    (*sprite).sz = cutfrac;
                    (*newsprite)
                        .szt = ((*sprite).sz as libc::c_int - 1 as libc::c_int)
                        as int16_t;
                    if testheight < (*sprite).pzt && testheight > (*sprite).pz {
                        (*newsprite).pzt = testheight;
                        (*sprite).pz = (*newsprite).pzt;
                    } else {
                        (*newsprite).pz = (*newsprite).gz;
                        (*newsprite).pzt = (*newsprite).gzt;
                    }
                    (*newsprite)
                        .szt = ((*newsprite).szt as libc::c_int - 8 as libc::c_int)
                        as int16_t;
                    (*newsprite)
                        .cut = ::core::mem::transmute::<
                        libc::c_int,
                        spritecut_e,
                    >((*newsprite).cut as libc::c_int | SC_TOP as libc::c_int);
                    if (*(*((*sector).lightlist).offset(i as isize)).caster).fofflags
                        as libc::c_uint & FOF_NOSHADE as libc::c_int as libc::c_uint == 0
                    {
                        lightnum = *(*((*sector).lightlist).offset(i as isize))
                            .lightlevel as libc::c_int >> 3 as libc::c_int;
                        if lightnum < 0 as libc::c_int {
                            spritelights = (scalelight[0 as libc::c_int as usize])
                                .as_mut_ptr();
                        } else if lightnum >= 32 as libc::c_int {
                            spritelights = (scalelight[(32 as libc::c_int
                        ...
                        (*newsprite)
                            .extra_colormap = *(*((*sector).lightlist)
                            .offset(i as isize))
                            .extra_colormap;
                        if (*newsprite).cut as libc::c_int & SC_FULLBRIGHT as libc::c_int
                            == 0
                            || !((*newsprite).extra_colormap).is_null()
                                && (*(*newsprite).extra_colormap).flags as libc::c_int
                                    & 1 as libc::c_int != 0
                        {
                            lindex = FixedMul(
                                (*sprite).xscale,
                                640 as libc::c_int * fovtan / vid.width,
                            ) >> 12 as libc::c_int;
                            if lindex >= 48 as libc::c_int {
                                lindex = 48 as libc::c_int - 1 as libc::c_int;
                            }
                            if (*newsprite).cut as libc::c_int
                                & SC_SEMIBRIGHT as libc::c_int != 0
                            {
                                lindex = 48 as libc::c_int / 2 as libc::c_int
                                    + (lindex >> 1 as libc::c_int);
                            }
                            (*newsprite)
                                .colormap = *spritelights.offset(lindex as isize);
                        }
                    }
                    sprite = newsprite;
                }
...
#[no_mangle]
pub unsafe extern "C" fn R_GetShadowZ(
    mut thing: *mut mobj_t,
    mut shadowslope: *mut *mut pslope_t,
) -> fixed_t {
    let mut halfHeight: fixed_t = 0;
    let mut isflipped: boolean = (*thing).eflags as libc::c_int
        & MFE_VERTICALFLIP as libc::c_int;
    let mut floorz: fixed_t = 0;
    let mut ceilingz: fixed_t = 0;
    let mut z: fixed_t = 0;
    let mut groundz: fixed_t = if isflipped != 0 {
        2147483647 as libc::c_int
    } else {
        -(2147483647 as libc::c_int) - 1 as libc::c_int
    };
    let mut slope: *mut pslope_t = 0 as *mut pslope_t;
    let mut groundslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut node: *mut msecnode_t = 0 as *mut msecnode_t;
    let mut sector: *mut sector_t = 0 as *mut sector_t;
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut interp: interpmobjstate_t = {
        let mut init = interpmobjstate_t {
            x: 0 as libc::c_int,
            y: 0,
            z: 0,
            subsector: 0 as *mut subsector_t,
            angle: 0,
            pitch: 0,
            roll: 0,
            spriteroll: 0,
    ...
    if R_UsingFrameInterpolation() != 0 && paused == 0 {
        R_InterpolateMobjState(thing, rendertimefrac, &mut interp);
    } else {
    ...
    halfHeight = interp.z + (interp.height >> 1 as libc::c_int);
    floorz = P_MobjFloorZ(
        thing,
        (*interp.subsector).sector,
        0 as *mut sector_t,
        interp.x,
        interp.y,
        0 as *mut line_t,
    ...
    node = (*thing).touching_sectorlist;
    while !node.is_null() {
        sector = (*node).m_sector;
        slope = if (*sector).heightsec != -(1 as libc::c_int) {
            0 as *mut pslope_t
        } else if isflipped != 0 {
            (*sector).c_slope
        } else {
        ...
        if (*sector).heightsec != -(1 as libc::c_int) {
            z = if isflipped != 0 {
                (*sectors.offset((*sector).heightsec as isize)).ceilingheight
            } else {
                (*sectors.offset((*sector).heightsec as isize)).floorheight
            };
        } else {
            z = if isflipped != 0 {
                P_GetSectorCeilingZAt(sector, interp.x, interp.y)
            } else {
                P_GetSectorFloorZAt(sector, interp.x, interp.y)
            };
        }
        if if isflipped != 0 {
            (z > halfHeight && z < groundz) as libc::c_int
        } else {
            (z < halfHeight && z > groundz) as libc::c_int
        } != 0
        {
        ...
        if !((*sector).ffloors).is_null() {
            ...
            while !rover.is_null() {
                if !((*rover).fofflags as libc::c_uint
                    ...
                    || (*rover).alpha < 90 as libc::c_int
                        && (*rover).fofflags as libc::c_uint
                            & FOF_SWIMMABLE as libc::c_int as libc::c_uint == 0)
                {
                    z = if isflipped != 0 {
                        P_GetFFloorBottomZAt(rover, interp.x, interp.y)
                    } else {
                        P_GetFFloorTopZAt(rover, interp.x, interp.y)
                    };
                    if if isflipped != 0 {
                        (z > halfHeight && z < groundz) as libc::c_int
                    } else {
    ...
    let mut po: *mut polyobj_t = (*interp.subsector).polyList;
    while !po.is_null() {
        if (*po).flags & POF_RENDERPLANES as libc::c_int == 0
            || P_MobjInsidePolyobj(po, thing) == 0
        {
            po = (*po).link.next as *mut polyobj_t;
        } else {
            z = if isflipped != 0 {
                (*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector)
                    .floorheight
            } else {
                (*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector)
                    .ceilingheight
    ...
    if if isflipped != 0 {
        (ceilingz
            < groundz
                - (if groundslope.is_null() {
                    0 as libc::c_int
                } else {
                    FixedMul(
                        abs((*groundslope).zdelta),
                        interp.radius * 3 as libc::c_int / 2 as libc::c_int,
                    )
                })) as libc::c_int
    } else {
        (floorz
    ...
    {
        groundz = if isflipped != 0 { ceilingz } else { floorz };
        groundslope = 0 as *mut pslope_t;
    }
    if !shadowslope.is_null() {
        *shadowslope = groundslope;
    }
    return groundz;
}
unsafe extern "C" fn R_SkewShadowSprite(
    mut thing: *mut mobj_t,
    mut groundslope: *mut pslope_t,
    mut groundz: fixed_t,
    mut spriteheight: int32_t,
    mut scalemul: fixed_t,
    mut shadowyscale: *mut fixed_t,
    mut shadowskew: *mut fixed_t,
) {
    let mut xslope: fixed_t = 0;
    let mut zslope: fixed_t = 0;
    let mut sloperelang: angle_t = 0;
    let mut interp: interpmobjstate_t = {
        let mut init = interpmobjstate_t {
            x: 0 as libc::c_int,
            y: 0,
    ...
    sloperelang = (R_PointToAngle(interp.x, interp.y))
        .wrapping_sub((*groundslope).xydirection) >> 19 as libc::c_int;
    xslope = FixedMul(
        finesine[sloperelang as usize] >> 16 as libc::c_int - 16 as libc::c_int,
        (*groundslope).zdelta,
    );
    zslope = FixedMul(
        *finecosine.offset(sloperelang as isize)
    ...
    if viewz < groundz {
        *shadowyscale
            += FixedMul(
                FixedMul(interp.radius * 2 as libc::c_int / spriteheight, scalemul),
                zslope,
            );
    } else {
        *shadowyscale
...
unsafe extern "C" fn R_ProjectDropShadow(
    mut thing: *mut mobj_t,
    mut vis: *mut vissprite_t,
    mut scale: fixed_t,
    mut tx: fixed_t,
    ...
    let mut shadow: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut patch: *mut patch_t = 0 as *mut patch_t;
    let mut xscale: fixed_t = 0;
    let mut yscale: fixed_t = 0;
    let mut shadowxscale: fixed_t = 0;
    let mut shadowyscale: fixed_t = 0;
    let mut shadowskew: fixed_t = 0;
    let mut x1: fixed_t = 0;
    let mut x2: fixed_t = 0;
    let mut heightsec: int32_t = 0;
    let mut phs: int32_t = 0;
    let mut light: int32_t = 0 as libc::c_int;
    let mut scalemul: fixed_t = 0;
    let mut trans: uint8_t = 0;
    let mut floordiff: fixed_t = 0;
    let mut groundz: fixed_t = 0;
    let mut groundslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut isflipped: boolean = (*thing).eflags as libc::c_int
        & MFE_VERTICALFLIP as libc::c_int;
    let mut interp: interpmobjstate_t = {
    ...
    groundz = R_GetShadowZ(thing, &mut groundslope);
    if abs(groundz - viewz) / tz > 4 as libc::c_int {
        return;
    }
    if R_UsingFrameInterpolation() != 0 && paused == 0 {
        R_InterpolateMobjState(thing, rendertimefrac, &mut interp);
    ...
    if !((*viewplayer).mo).is_null() && !((*(*viewplayer).mo).subsector).is_null() {
        phs = (*(*(*(*viewplayer).mo).subsector).sector).heightsec;
    } else {
        phs = -(1 as libc::c_int);
    }
    if heightsec != -(1 as libc::c_int) && phs != -(1 as libc::c_int) {
        if if viewz < (*sectors.offset(phs as isize)).floorheight {
            (groundz >= (*sectors.offset(heightsec as isize)).floorheight) as libc::c_int
        } else {
            (groundz < (*sectors.offset(heightsec as isize)).floorheight) as libc::c_int
        } != 0
        {
        ...
        if if viewz > (*sectors.offset(phs as isize)).ceilingheight {
            (groundz < (*sectors.offset(heightsec as isize)).ceilingheight
                && viewz >= (*sectors.offset(heightsec as isize)).ceilingheight)
                as libc::c_int
        } else {
            (groundz >= (*sectors.offset(heightsec as isize)).ceilingheight)
                as libc::c_int
    ...
    floordiff = abs(
        (if isflipped != 0 { interp.height } else { 0 as libc::c_int }) + interp.z
            - groundz,
    );
    trans = (floordiff / (100 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int))
        + 3 as libc::c_int) as uint8_t;
    if trans as libc::c_int >= 9 as libc::c_int {
        return;
    }
    scalemul = FixedMul(
        ((1 as libc::c_int) << 16 as libc::c_int) - floordiff / 640 as libc::c_int,
        scale,
    );
    patch = W_CachePatchName(
        b"DSHADOW\0" as *const u8 as *const libc::c_char,
        PU_SPRITE as libc::c_int,
    ) as *mut patch_t;
    xscale = FixedDiv(projection, tz);
    yscale = FixedDiv(projectiony, tz);
    shadowxscale = FixedMul(interp.radius * 2 as libc::c_int, scalemul);
    shadowyscale = FixedMul(
        FixedMul(interp.radius * 2 as libc::c_int, scalemul),
        FixedDiv(abs(groundz - viewz), tz),
    );
    shadowyscale = (if shadowyscale < shadowxscale {
        shadowyscale
    } else {
        shadowxscale
    }) / (*patch).height as libc::c_int;
    shadowxscale /= (*patch).width as libc::c_int;
    shadowskew = 0 as libc::c_int;
    if !groundslope.is_null() {
        R_SkewShadowSprite(
            thing,
            groundslope,
            groundz,
            (*patch).height as int32_t,
            scalemul,
            &mut shadowyscale,
            &mut shadowskew,
        );
    }
    tx -= (*patch).width as libc::c_int * shadowxscale / 2 as libc::c_int;
    x1 = centerxfrac + FixedMul(tx, xscale) >> 16 as libc::c_int;
    if x1 >= viewwidth {
        return;
    }
    tx += (*patch).width as libc::c_int * shadowxscale;
    x2 = centerxfrac + FixedMul(tx, xscale) >> 16 as libc::c_int;
    x2 -= 1;
    x2;
    if x2 < 0 as libc::c_int || x2 <= x1 {
        return;
    }
    if shadowyscale
        < ((1 as libc::c_int) << 16 as libc::c_int) / (*patch).height as libc::c_int
    {
        return;
    }
    ...
    (*shadow).thingheight = (1 as libc::c_int) << 16 as libc::c_int;
    (*shadow)
        .pz = groundz
        + (if isflipped != 0 { -(*shadow).thingheight } else { 0 as libc::c_int });
    (*shadow).pzt = (*shadow).pz + (*shadow).thingheight;
    (*shadow).mobjflags = 0 as libc::c_int;
    (*shadow).sortscale = (*vis).sortscale;
    (*shadow).dispoffset = (*vis).dispoffset - 5 as libc::c_int;
    (*shadow).gx = interp.x;
    (*shadow).gy = interp.y;
    (*shadow)
        .gzt = (if isflipped != 0 { (*shadow).pzt } else { (*shadow).pz })
        + (*patch).height as libc::c_int * shadowyscale / 2 as libc::c_int;
    (*shadow).gz = (*shadow).gzt - (*patch).height as libc::c_int * shadowyscale;
    (*shadow)
        .texturemid = FixedMul(
        interp.scale,
        FixedDiv((*shadow).gzt - viewz, shadowyscale),
    );
    if !((*thing).skin).is_null()
        && (*((*thing).skin as *mut skin_t)).flags as libc::c_uint
            & SF_HIRES as libc::c_int as libc::c_uint != 0
    {
        (*shadow)
            .texturemid = FixedMul(
            (*shadow).texturemid,
            (*((*thing).skin as *mut skin_t)).highresscale,
        );
    }
    (*shadow).scalestep = 0 as libc::c_int;
    (*shadow).shear.tan = shadowskew;
    (*shadow).mobj = thing;
    (*shadow).color = (*thing).color as skincolornum_t;
    (*shadow).x1 = if x1 < portalclipstart { portalclipstart } else { x1 };
    (*shadow)
        .x2 = if x2 >= portalclipend { portalclipend - 1 as libc::c_int } else { x2 };
    (*shadow).xscale = FixedMul(xscale, shadowxscale);
    (*shadow).scale = FixedMul(yscale, shadowyscale);
    (*shadow).thingscale = interp.scale;
    (*shadow).sector = (*vis).sector;
    (*shadow)
        .szt = (centeryfrac - FixedMul((*shadow).gzt - viewz, yscale)
        >> 16 as libc::c_int) as int16_t;
    (*shadow)
        .sz = (centeryfrac - FixedMul((*shadow).gz - viewz, yscale) >> 16 as libc::c_int)
        as int16_t;
    (*shadow)
        .cut = (SC_ISSCALED as libc::c_int | SC_SHADOW as libc::c_int) as spritecut_e;
    (*shadow).startfrac = 0 as libc::c_int;
    (*shadow)
        .xiscale = (((*patch).width as libc::c_int) << 16 as libc::c_int)
        / (x2 - x1 + 1 as libc::c_int);
    if (*shadow).x1 > x1 {
        (*shadow).startfrac += (*shadow).xiscale * ((*shadow).x1 - x1);
    }
    x1 += (x2 - x1) / 2 as libc::c_int;
    (*shadow).shear.offset = (*shadow).x1 - x1;
    if (*thing).renderflags & RF_NOCOLORMAPS as libc::c_int as uint32_t != 0 {
        (*shadow).extra_colormap = 0 as *mut extracolormap_t;
    } else {
        if (*(*(*thing).subsector).sector).numlights != 0 {
            let mut lightnum: int32_t = 0;
            light = (*(*(*thing).subsector).sector).numlights - 1 as libc::c_int;
            lightnum = 1 as libc::c_int;
            while lightnum < (*(*(*thing).subsector).sector).numlights {
                let mut h: fixed_t = P_GetLightZAt(
                    &mut *((*(*(*thing).subsector).sector).lightlist)
                        .offset(lightnum as isize),
                    interp.x,
                    interp.y,
                );
                if h <= (*shadow).gzt {
                    light = lightnum - 1 as libc::c_int;
                    break;
                } else {
                    lightnum += 1;
                    lightnum;
        ...
        if (*(*(*thing).subsector).sector).numlights != 0 {
            (*shadow)
                .extra_colormap = *(*((*(*(*thing).subsector).sector).lightlist)
                .offset(light as isize))
                .extra_colormap;
        } else {
            (*shadow).extra_colormap = (*(*(*thing).subsector).sector).extra_colormap;
        }
    }
    (*shadow).transmap = R_GetTranslucencyTable(trans as libc::c_int + 1 as libc::c_int);
    (*shadow)
        .colormap = scalelight[0 as libc::c_int as usize][0 as libc::c_int as usize];
    objectsdrawn = objectsdrawn.wrapping_add(1);
    objectsdrawn;
}
unsafe extern "C" fn R_ProjectBoundingBox(
    mut thing: *mut mobj_t,
    mut vis: *mut vissprite_t,
) {
    let mut gx: fixed_t = 0;
    let mut gy: fixed_t = 0;
    let mut tx: fixed_t = 0;
    let mut tz: fixed_t = 0;
    let mut box_0: *mut vissprite_t = 0 as *mut vissprite_t;
    if R_ThingBoundingBoxVisible(thing) == 0 {
        return;
    }
    let mut interpolate: boolean = cv_renderhitboxinterpolation.value;
    let mut interp: interpmobjstate_t = {
        let mut init = interpmobjstate_t {
            x: 0 as libc::c_int,
            y: 0,
    ...
    if R_UsingFrameInterpolation() != 0 && paused == 0 && interpolate != 0 {
        R_InterpolateMobjState(thing, rendertimefrac, &mut interp);
    } else {
        R_InterpolateMobjState(
            thing,
    ...
    if vis.is_null() && abs(tx) > FixedMul(tz, fovtan) << 2 as libc::c_int {
        return;
    }
    box_0 = R_NewVisSprite();
    (*box_0).mobj = thing;
    (*box_0).mobjflags = (*thing).flags as int32_t;
    (*box_0).thingheight = interp.height;
    (*box_0).cut = SC_BBOX;
    (*box_0).gx = tx;
    (*box_0).gy = tz;
    (*box_0).scale = 2 as libc::c_int * FixedMul(interp.radius, viewsin);
    (*box_0).xscale = 2 as libc::c_int * FixedMul(interp.radius, viewcos);
    (*box_0).pz = interp.z;
    (*box_0).pzt = (*box_0).pz + (*box_0).thingheight;
    (*box_0).gzt = (*box_0).pzt;
    (*box_0).gz = (*box_0).pz;
    (*box_0).texturemid = (*box_0).gzt - viewz;
    if !vis.is_null() {
        (*box_0).x1 = (*vis).x1;
        (*box_0).x2 = (*vis).x2;
        (*box_0).szt = (*vis).szt;
        (*box_0).sz = (*vis).sz;
        (*box_0).sortscale = (*vis).sortscale;
        (*box_0).dispoffset = (*vis).dispoffset + 5 as libc::c_int;
        (*box_0)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*box_0).cut as libc::c_int | SC_LINKDRAW as libc::c_int);
    } else {
        let mut xscale: fixed_t = FixedDiv(projection, tz);
        let mut yscale: fixed_t = FixedDiv(projectiony, tz);
        let mut top: fixed_t = centeryfrac - FixedMul((*box_0).texturemid, yscale);
        (*box_0)
            .x1 = (centerxfrac + FixedMul((*box_0).gx, xscale))
            / ((1 as libc::c_int) << 16 as libc::c_int);
        (*box_0).x2 = (*box_0).x1;
        (*box_0).szt = (top / ((1 as libc::c_int) << 16 as libc::c_int)) as int16_t;
        (*box_0)
            .sz = ((top + FixedMul((*box_0).thingheight, yscale))
            / ((1 as libc::c_int) << 16 as libc::c_int)) as int16_t;
        (*box_0).sortscale = yscale;
        (*box_0).dispoffset = 0 as libc::c_int;
    };
}
unsafe extern "C" fn R_ProjectSprite(mut thing: *mut mobj_t) {
    let mut oldthing: *mut mobj_t = thing;
    ...
    let mut sortscale: fixed_t = 0;
    let mut sortsplat: fixed_t = 0 as libc::c_int;
    let mut linkscale: fixed_t = 0 as libc::c_int;
    let mut sort_x: fixed_t = 0 as libc::c_int;
    let mut sort_y: fixed_t = 0 as libc::c_int;
    let mut sort_z: fixed_t = 0;
    let mut x1: int32_t = 0;
    let mut x2: int32_t = 0;
    let mut sprdef: *mut spritedef_t = 0 as *mut spritedef_t;
    let mut sprframe: *mut spriteframe_t = 0 as *mut spriteframe_t;
    let mut sprinfo: *mut spriteinfo_t = 0 as *mut spriteinfo_t;
    let mut lump: size_t = 0;
    let mut frame: size_t = 0;
    let mut rot: size_t = 0;
    let mut flip: uint16_t = 0;
    let mut vflip: boolean = (((*thing).eflags as libc::c_int
        & MFE_VERTICALFLIP as libc::c_int == 0) as libc::c_int
        != (R_ThingVerticallyFlipped(thing) == 0) as libc::c_int) as libc::c_int;
    let mut mirrored: boolean = (*thing).mirrored;
    let mut hflip: boolean = ((R_ThingHorizontallyFlipped(thing) == 0) as libc::c_int
        != (mirrored == 0) as libc::c_int) as libc::c_int;
    let mut lindex: int32_t = 0;
    let mut trans: int32_t = 0;
    let mut vis: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut patch: *mut patch_t = 0 as *mut patch_t;
    let mut cut: spritecut_e = SC_NONE;
    let mut ang: angle_t = 0 as libc::c_int as angle_t;
    let mut iscale: fixed_t = 0;
    let mut scalestep: fixed_t = 0;
    let mut offset: fixed_t = 0;
    let mut offset2: fixed_t = 0;
    let mut sheartan: fixed_t = 0 as libc::c_int;
    let mut shadowscale: fixed_t = (1 as libc::c_int) << 16 as libc::c_int;
    let mut basetx: fixed_t = 0;
    let mut basetz: fixed_t = 0;
    let mut shadowdraw: boolean = 0;
    let mut shadoweffects: boolean = 0;
    let mut shadowskew: boolean = 0;
    let mut splat: boolean = R_ThingIsFloorSprite(thing);
    let mut papersprite: boolean = (R_ThingIsPaperSprite(thing) != 0 && splat == 0)
        as libc::c_int;
    let mut paperoffset: fixed_t = 0 as libc::c_int;
    let mut paperdistance: fixed_t = 0 as libc::c_int;
    let mut centerangle: angle_t = 0 as libc::c_int as angle_t;
    let mut dispoffset: int32_t = (*thing).dispoffset;
    let mut gz: fixed_t = 0 as libc::c_int;
    let mut gzt: fixed_t = 0 as libc::c_int;
    let mut heightsec: int32_t = 0;
    let mut phs: int32_t = 0;
    let mut light: int32_t = 0 as libc::c_int;
    let mut this_scale: fixed_t = 0;
    let mut spritexscale: fixed_t = 0;
    let mut spriteyscale: fixed_t = 0;
    let mut spr_width: fixed_t = 0;
    let mut spr_height: fixed_t = 0;
    let mut spr_offset: fixed_t = 0;
    let mut spr_topoffset: fixed_t = 0;
    let mut rotsprite: *mut patch_t = 0 as *mut patch_t;
    let mut rollangle: int32_t = 0 as libc::c_int;
    let mut spriterotangle: angle_t = 0 as libc::c_int as angle_t;
    let mut interp: interpmobjstate_t = {
        let mut init = interpmobjstate_t {
            x: 0 as libc::c_int,
            y: 0,
    ...
    if R_UsingFrameInterpolation() != 0 && paused == 0 {
        R_InterpolateMobjState(oldthing, rendertimefrac, &mut interp);
    } else {
        R_InterpolateMobjState(
            oldthing,
            (1 as libc::c_int) << 16 as libc::c_int,
    ...
    basetx = tx;
    if papersprite == 0 && abs(tx) > FixedMul(tz, fovtan) << 2 as libc::c_int {
        return;
    }
    xscale = FixedDiv(projection, tz);
    sortscale = FixedDiv(projectiony, tz);
    frame = ((*thing).frame & 0xff as libc::c_int as uint32_t) as size_t;
    if !((*thing).skin).is_null()
        && (*thing).sprite as libc::c_uint == SPR_PLAY as libc::c_int as libc::c_uint
    {
        sprdef = &mut *((*((*thing).skin as *mut skin_t)).sprites)
            .as_mut_ptr()
            .offset((*thing).sprite2 as isize) as *mut spritedef_t;
        sprinfo = &mut *((*((*thing).skin as *mut skin_t)).sprinfo)
            .as_mut_ptr()
            .offset((*thing).sprite2 as isize) as *mut spriteinfo_t;
        if frame >= (*sprdef).numframes {
            CONS_Alert(
                CONS_ERROR,
                b"R_ProjectSprite: invalid skins[\"%s\"].sprites[%sSPR2_%s] frame %s\n\0"
                    as *const u8 as *const libc::c_char,
                ((*((*thing).skin as *mut skin_t)).name).as_mut_ptr(),
                if (*thing).sprite2 as libc::c_int & 0x80 as libc::c_int != 0 {
                    b"FF_SPR2SUPER|\0" as *const u8 as *const libc::c_char
                } else {
                    b"\0" as *const u8 as *const libc::c_char
                },
                (spr2names[((*thing).sprite2 as libc::c_int & !(0x80 as libc::c_int))
                    as usize])
                    .as_mut_ptr(),
                sizeu5(frame),
            );
            (*thing).sprite = states[S_UNKNOWN as libc::c_int as usize].sprite;
            (*thing).frame = states[S_UNKNOWN as libc::c_int as usize].frame;
            sprdef = &mut *sprites.offset((*thing).sprite as isize) as *mut spritedef_t;
            sprinfo = &mut *spriteinfo.as_mut_ptr().offset((*thing).sprite as isize)
                as *mut spriteinfo_t;
            frame = ((*thing).frame & 0xff as libc::c_int as uint32_t) as size_t;
        }
    } else {
        ...
        if frame >= (*sprdef).numframes {
            CONS_Alert(
                CONS_ERROR,
                b"R_ProjectSprite: invalid sprite frame %s/%s for %s\n\0" as *const u8
                    as *const libc::c_char,
                sizeu1(frame),
                sizeu2((*sprdef).numframes),
                (sprnames[(*thing).sprite as usize]).as_mut_ptr(),
            );
            if (*thing).sprite as libc::c_uint
                == (*(*thing).state).sprite as libc::c_uint
                && (*thing).frame == (*(*thing).state).frame
            {
                (*(*thing).state)
                    .sprite = states[S_UNKNOWN as libc::c_int as usize].sprite;
                (*(*thing).state)
                    .frame = states[S_UNKNOWN as libc::c_int as usize].frame;
            }
            (*thing).sprite = states[S_UNKNOWN as libc::c_int as usize].sprite;
            (*thing).frame = states[S_UNKNOWN as libc::c_int as usize].frame;
            sprdef = &mut *sprites.offset((*thing).sprite as isize) as *mut spritedef_t;
    ...
    sprframe = &mut *((*sprdef).spriteframes).offset(frame as isize)
        as *mut spriteframe_t;
    if splat != 0 {
        ang = R_PointToAngle2(0 as libc::c_int, viewz, 0 as libc::c_int, interp.z);
    } else if (*sprframe).rotate as libc::c_int != SRF_SINGLE as libc::c_int
        || papersprite != 0
    {
        ang = (R_PointToAngle(interp.x, interp.y)).wrapping_sub(interp.angle);
        if mirrored != 0 {
            ang = InvAngle(ang);
        }
    }
    if (*sprframe).rotate as libc::c_int == SRF_SINGLE as libc::c_int {
        rot = 0 as libc::c_int as size_t;
        lump = (*sprframe).lumpid[0 as libc::c_int as usize];
        flip = (*sprframe).flip;
    } else {
        if (*sprframe).rotate as libc::c_int & SRF_RIGHT as libc::c_int != 0
            && ang < 0x80000000 as libc::c_uint
        {
            rot = 6 as libc::c_int as size_t;
        } else if (*sprframe).rotate as libc::c_int & SRF_LEFT as libc::c_int != 0
            && ang >= 0x80000000 as libc::c_uint
        {
            rot = 2 as libc::c_int as size_t;
        } else if (*sprframe).rotate as libc::c_int & SRF_3DGE as libc::c_int != 0 {
            rot = (ang
                .wrapping_add(0x80000000 as libc::c_uint)
                .wrapping_add(0x8000000 as libc::c_int as libc::c_uint)
                >> 28 as libc::c_int) as size_t;
            rot = (rot & 1 as libc::c_int as size_t) << 3 as libc::c_int
                | rot >> 1 as libc::c_int;
        } else {
            rot = (ang.wrapping_add(0x90000000 as libc::c_uint) >> 29 as libc::c_int)
                as size_t;
        }
        lump = (*sprframe).lumpid[rot as usize];
        flip = ((*sprframe).flip as libc::c_int & (1 as libc::c_int) << rot) as uint16_t;
    }
    spr_width = (*spritecachedinfo.offset(lump as isize)).width;
    spr_height = (*spritecachedinfo.offset(lump as isize)).height;
    spr_offset = (*spritecachedinfo.offset(lump as isize)).offset;
    spr_topoffset = (*spritecachedinfo.offset(lump as isize)).topoffset;
    patch = W_CachePatchNum((*sprframe).lumppat[rot as usize], PU_SPRITE as libc::c_int)
        as *mut patch_t;
    spriterotangle = R_SpriteRotationAngle(&mut interp);
    if spriterotangle != 0 as libc::c_int as angle_t
        && !(splat != 0
            && (*thing).renderflags & RF_NOSPLATROLLANGLE as libc::c_int as uint32_t
                == 0)
    {
        if papersprite != 0 && ang >= 0x80000000 as libc::c_uint {
        ...
        rotsprite = Patch_GetRotatedSprite(
            sprframe,
            ((*thing).frame & 0xff as libc::c_int as uint32_t) as size_t,
            rot,
            flip as boolean,
            false_0 as libc::c_int,
            sprinfo as *mut libc::c_void,
            rollangle,
        );
        if !rotsprite.is_null() {
            patch = rotsprite;
            cut = ::core::mem::transmute::<
                libc::c_int,
                spritecut_e,
            >(cut as libc::c_int | SC_ISROTATED as libc::c_int);
            spr_width = ((*rotsprite).width as libc::c_int) << 16 as libc::c_int;
            spr_height = ((*rotsprite).height as libc::c_int) << 16 as libc::c_int;
            spr_offset = ((*rotsprite).leftoffset as libc::c_int) << 16 as libc::c_int;
            spr_topoffset = ((*rotsprite).topoffset as libc::c_int) << 16 as libc::c_int;
            spr_topoffset += (4 as libc::c_int) << 16 as libc::c_int;
            flip = 0 as libc::c_int as uint16_t;
        }
    }
    flip = ((flip == 0) as libc::c_int != (hflip == 0) as libc::c_int) as libc::c_int
        as uint16_t;
    ...
    if !((*thing).skin).is_null()
        && (*((*thing).skin as *mut skin_t)).flags as libc::c_uint
            & SF_HIRES as libc::c_int as libc::c_uint != 0
    {
        let mut highresscale: fixed_t = (*((*thing).skin as *mut skin_t)).highresscale;
        spritexscale = FixedMul(spritexscale, highresscale);
        spriteyscale = FixedMul(spriteyscale, highresscale);
    }
    if spritexscale < 1 as libc::c_int || spriteyscale < 1 as libc::c_int {
        return;
    }
    if (*thing).renderflags & RF_ABSOLUTEOFFSETS as libc::c_int as uint32_t != 0 {
        spr_offset = interp.spritexoffset;
        spr_topoffset = interp.spriteyoffset;
    } else {
        let mut flipoffset: int8_t = 1 as libc::c_int as int8_t;
        if (*thing).renderflags & RF_FLIPOFFSETS as libc::c_int as uint32_t != 0
            && flip as libc::c_int != 0
        {
            flipoffset = -(1 as libc::c_int) as int8_t;
        }
        spr_offset += interp.spritexoffset * flipoffset as libc::c_int;
        spr_topoffset += interp.spriteyoffset * flipoffset as libc::c_int;
    }
    if flip != 0 {
    ...
    if papersprite != 0 {
        let mut xscale2: fixed_t = 0;
        let mut yscale2: fixed_t = 0;
        let mut cosmul: fixed_t = 0;
        let mut sinmul: fixed_t = 0;
        let mut tx2: fixed_t = 0;
        let mut tz2: fixed_t = 0;
        let mut range: int32_t = 0;
        if ang >= 0x80000000 as libc::c_uint {
            offset *= -(1 as libc::c_int);
            offset2 *= -(1 as libc::c_int);
        }
        cosmul = *finecosine.offset((interp.angle >> 19 as libc::c_int) as isize)
            >> 16 as libc::c_int - 16 as libc::c_int;
        sinmul = finesine[(interp.angle >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int;
        ...
        {
            let mut div_0: fixed_t = FixedDiv(
                tz - tz2,
                FixedMul(
                    ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int,
                    this_scale,
            ...
            tx2 += FixedDiv(tx - tx2, div_0);
            tz2 = FixedMul(
                ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int,
                this_scale,
            );
        }
        if tx2 < -(FixedMul(tz2, fovtan) << 2 as libc::c_int)
            || tx > FixedMul(tz, fovtan) << 2 as libc::c_int
        {
            return;
        }
        yscale = FixedDiv(projectiony, tz);
        ...
        x2 = centerxfrac + FixedMul(tx2, xscale2) >> 16 as libc::c_int;
        ...
        if scalestep == 0 {
            scalestep = 1 as libc::c_int;
        }
        xscale = FixedDiv(range << 16 as libc::c_int, abs(offset2));
    } else {
        scalestep = 0 as libc::c_int;
        yscale = sortscale;
        tx += offset;
        x1 = centerxfrac + FixedMul(tx, xscale) >> 16 as libc::c_int;
        if x1 > viewwidth {
    ...
    if splat != 0 {
        sort_z = ((*patch).height as libc::c_int - (*patch).topoffset as libc::c_int)
            * ((1 as libc::c_int) << 16 as libc::c_int);
        ang = viewangle >> 19 as libc::c_int;
        sort_x = FixedMul(
            FixedMul(FixedMul(spritexscale, this_scale), sort_z),
            *finecosine.offset(ang as isize) >> 16 as libc::c_int - 16 as libc::c_int,
        );
        sort_y = FixedMul(
            FixedMul(FixedMul(spriteyscale, this_scale), sort_z),
    ...
    if (*thing).flags2 & MF2_LINKDRAW as libc::c_int as uint32_t != 0
        && !((*thing).tracer).is_null()
    {
        let mut tracer_interp: interpmobjstate_t = {
            let mut init = interpmobjstate_t {
                x: 0 as libc::c_int,
                y: 0,
                z: 0,
        ...
        thing = (*thing).tracer;
        if R_ThingVisible(thing) == 0 {
            return;
        }
        if R_UsingFrameInterpolation() != 0 && paused == 0 {
            R_InterpolateMobjState(thing, rendertimefrac, &mut tracer_interp);
        } else {
            R_InterpolateMobjState(
                thing,
                (1 as libc::c_int) << 16 as libc::c_int,
        ...
        radius = tracer_interp.radius;
        height = tracer_interp.height;
        ...
        if sortscale < linkscale {
            dispoffset *= -(1 as libc::c_int);
        }
        cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >(cut as libc::c_int | SC_LINKDRAW as libc::c_int);
    } else {
        linkscale = sortscale;
    }
    if splat != 0 {
    ...
    if portalrender as libc::c_int != 0 && !portalclipline.is_null() {
        if x2 < portalclipstart || x1 >= portalclipend {
            return;
        }
        if P_PointOnLineSide(interp.x, interp.y, portalclipline) != 0 as libc::c_int {
            return;
        }
    }
    let mut blendmode: int32_t = 0;
    if (*oldthing).frame & 0x7000 as libc::c_int as uint32_t != 0 {
        blendmode = (((*oldthing).frame & 0x7000 as libc::c_int as uint32_t)
            >> 12 as libc::c_int)
            .wrapping_add(1 as libc::c_int as uint32_t) as int32_t;
    } else {
        blendmode = (*oldthing).blendmode;
    }
    if (*oldthing).flags2 & MF2_SHADOW as libc::c_int as uint32_t != 0
        || (*thing).flags2 & MF2_SHADOW as libc::c_int as uint32_t != 0
    {
        trans = tr_trans80 as libc::c_int;
    } else if (*oldthing).frame & 0xf0000 as libc::c_int as uint32_t != 0 {
        trans = (((*oldthing).frame & 0xf0000 as libc::c_int as uint32_t)
            >> 16 as libc::c_int) as int32_t;
        if R_BlendLevelVisible(blendmode, trans) == 0 {
            return;
        }
    } else {
        trans = 0 as libc::c_int;
    }
    shadowdraw = ((*thing).renderflags & RF_SHADOWDRAW as libc::c_int as uint32_t != 0
        && !(papersprite != 0 || splat != 0)) as libc::c_int;
    shadoweffects = ((*thing).renderflags & RF_SHADOWEFFECTS as libc::c_int as uint32_t)
        as boolean;
    shadowskew = (shadowdraw != 0 && !((*thing).standingslope).is_null()) as libc::c_int;
    if shadowdraw != 0 || shadoweffects != 0 {
        let mut groundz: fixed_t = R_GetShadowZ(thing, 0 as *mut *mut pslope_t);
        let mut isflipped: boolean = (*thing).eflags as libc::c_int
            & MFE_VERTICALFLIP as libc::c_int;
        if shadoweffects != 0 {
            let mut caster: *mut mobj_t = (*thing).target;
            let mut casterinterp: interpmobjstate_t = {
                let mut init = interpmobjstate_t {
                    x: 0 as libc::c_int,
                    y: 0,
                    z: 0,
            ...
            if R_UsingFrameInterpolation() != 0 && paused == 0 {
                R_InterpolateMobjState(caster, rendertimefrac, &mut casterinterp);
            } else {
                R_InterpolateMobjState(
                    caster,
                    (1 as libc::c_int) << 16 as libc::c_int,
            ...
            if !caster.is_null() && P_MobjWasRemoved(caster) == 0 {
                let mut floordiff: fixed_t = 0;
                if abs(groundz - viewz) / tz > 4 as libc::c_int {
                    return;
                }
                floordiff = abs(
                    (if isflipped != 0 { casterinterp.height } else { 0 as libc::c_int })
                        + casterinterp.z - groundz,
                );
                trans
                    += floordiff
                        / (100 as libc::c_int
                            * ((1 as libc::c_int) << 16 as libc::c_int))
                        + 3 as libc::c_int;
                shadowscale = FixedMul(
                    ((1 as libc::c_int) << 16 as libc::c_int)
                        - floordiff / 640 as libc::c_int,
                    casterinterp.scale,
                );
            } else {
                trans += 3 as libc::c_int;
            }
            if trans >= NUMTRANSMAPS as libc::c_int {
                return;
            }
            trans -= 1;
            trans;
        ...
        if shadowdraw != 0 {
            spritexscale = FixedMul(
                radius * 2 as libc::c_int,
                FixedMul(shadowscale, spritexscale),
            );
            spriteyscale = FixedMul(
                radius * 2 as libc::c_int,
                FixedMul(shadowscale, spriteyscale),
            );
            spriteyscale = FixedMul(spriteyscale, FixedDiv(abs(groundz - viewz), tz));
            spriteyscale = (if spriteyscale < spritexscale {
                spriteyscale
            } else {
                spritexscale
            }) / (*patch).height as libc::c_int;
            spritexscale /= (*patch).width as libc::c_int;
        } else {
        ...
        if shadowskew != 0 {
            ...
            gzt = (if isflipped != 0 { interp.z + height } else { interp.z })
                + (*patch).height as libc::c_int * spriteyscale / 2 as libc::c_int;
            gz = gzt - (*patch).height as libc::c_int * spriteyscale;
            cut = ::core::mem::transmute::<
                libc::c_int,
                spritecut_e,
            >(cut as libc::c_int | SC_SHEAR as libc::c_int);
        }
    }
    if shadowskew == 0 {
        if vflip != 0 {
            gz = interp.z + interp.height
                - FixedMul(spr_topoffset, FixedMul(spriteyscale, this_scale));
    ...
    if !((*(*(*thing).subsector).sector).cullheight).is_null() {
        if R_DoCulling(
            (*(*(*thing).subsector).sector).cullheight,
            (*viewsector).cullheight,
            viewz,
            gz,
            gzt,
        ) != 0
    ...
    if (*(*(*thing).subsector).sector).numlights != 0 {
        let mut lightnum: int32_t = 0;
        let mut top: fixed_t = if splat != 0 { gz } else { gzt };
        light = (*(*(*thing).subsector).sector).numlights - 1 as libc::c_int;
        lightnum = 1 as libc::c_int;
        while lightnum < (*(*(*thing).subsector).sector).numlights {
            let mut h: fixed_t = P_GetLightZAt(
        ...
        lightnum = *(*((*(*(*thing).subsector).sector).lightlist).offset(light as isize))
            .lightlevel as libc::c_int >> 3 as libc::c_int;
        if lightnum < 0 as libc::c_int {
            spritelights = (scalelight[0 as libc::c_int as usize]).as_mut_ptr();
        } else if lightnum >= 32 as libc::c_int {
            spritelights = (scalelight[(32 as libc::c_int - 1 as libc::c_int) as usize])
                .as_mut_ptr();
        } else {
            spritelights = (scalelight[lightnum as usize]).as_mut_ptr();
        }
    ...
    if heightsec != -(1 as libc::c_int) && phs != -(1 as libc::c_int) {
        let mut top_0: fixed_t = gzt;
        let mut bottom: fixed_t = interp.z;
        if splat != 0 {
            top_0 = bottom;
        }
        if if viewz < (*sectors.offset(phs as isize)).floorheight {
            (bottom >= (*sectors.offset(heightsec as isize)).floorheight) as libc::c_int
        } else {
            (top_0 < (*sectors.offset(heightsec as isize)).floorheight) as libc::c_int
        } != 0
        {
            return;
        }
        if if viewz > (*sectors.offset(phs as isize)).ceilingheight {
            (top_0 < (*sectors.offset(heightsec as isize)).ceilingheight
                && viewz >= (*sectors.offset(heightsec as isize)).ceilingheight)
                as libc::c_int
        } else {
            (bottom >= (*sectors.offset(heightsec as isize)).ceilingheight)
                as libc::c_int
        } != 0
        {
            return;
    ...
    (*vis).mobjflags = (*thing).flags as int32_t;
    ...
    (*vis).shear.offset = 0 as libc::c_int;
    (*vis).viewpoint.x = viewx;
    (*vis).viewpoint.y = viewy;
    (*vis).viewpoint.z = viewz;
    (*vis).viewpoint.angle = viewangle;
    (*vis).mobj = thing;
    if (*oldthing).flags2 & MF2_LINKDRAW as libc::c_int as uint32_t != 0
        && !((*oldthing).tracer).is_null()
        && (*oldthing).color as libc::c_int == SKINCOLOR_NONE as libc::c_int
    {
        (*vis).color = (*(*oldthing).tracer).color as skincolornum_t;
    } else {
        (*vis).color = (*oldthing).color as skincolornum_t;
    }
    (*vis).x1 = if x1 < portalclipstart { portalclipstart } else { x1 };
    (*vis).x2 = if x2 >= portalclipend { portalclipend - 1 as libc::c_int } else { x2 };
    (*vis).sector = (*(*thing).subsector).sector;
    (*vis)
        .szt = (centeryfrac - FixedMul((*vis).gzt - viewz, linkscale)
        >> 16 as libc::c_int) as int16_t;
    (*vis)
        .sz = (centeryfrac - FixedMul((*vis).gz - viewz, linkscale) >> 16 as libc::c_int)
        as int16_t;
    (*vis).cut = cut;
    if (*(*(*thing).subsector).sector).numlights != 0 {
        (*vis)
    ...
    (*vis).xscale = FixedMul(spritexscale, xscale);
    (*vis).scale = FixedMul(spriteyscale, yscale);
    ...
    if shadowdraw != 0 || shadoweffects != 0 {
        iscale = (((*patch).width as libc::c_int) << 16 as libc::c_int)
            / (x2 - x1 + 1 as libc::c_int);
        x1 += (x2 - x1) / 2 as libc::c_int;
        (*vis).shear.offset = (*vis).x1 - x1;
    } else {
        iscale = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, (*vis).xscale);
    }
    (*vis).shadowscale = shadowscale;
    if flip != 0 {
        (*vis).startfrac = spr_width - 1 as libc::c_int;
        (*vis).xiscale = -iscale;
    } else {
        (*vis).startfrac = 0 as libc::c_int;
        (*vis).xiscale = iscale;
    }
    if (*vis).x1 > x1 {
    ...
    if blendmode != AST_COPY as libc::c_int && cv_translucency.value != 0 {
        (*vis).transmap = R_GetBlendTable(blendmode, trans);
    } else {
        (*vis).transmap = 0 as *mut uint8_t;
    }
    if R_ThingIsFullBright(oldthing) != 0
        || (*oldthing).flags2 & MF2_SHADOW as libc::c_int as uint32_t != 0
        || (*thing).flags2 & MF2_SHADOW as libc::c_int as uint32_t != 0
    {
        (*vis)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*vis).cut as libc::c_int | SC_FULLBRIGHT as libc::c_int);
    } else if R_ThingIsSemiBright(oldthing) != 0 {
        (*vis)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*vis).cut as libc::c_int | SC_SEMIBRIGHT as libc::c_int);
    } else if R_ThingIsFullDark(oldthing) != 0 {
        (*vis)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*vis).cut as libc::c_int | SC_FULLDARK as libc::c_int);
    }
    if (*vis).cut as libc::c_int & SC_FULLBRIGHT as libc::c_int != 0
        && (((*vis).extra_colormap).is_null()
            || (*(*vis).extra_colormap).flags as libc::c_int & 1 as libc::c_int == 0)
    {
        (*vis).colormap = colormaps;
    } else if (*vis).cut as libc::c_int & SC_FULLDARK as libc::c_int != 0 {
        (*vis)
            .colormap = scalelight[0 as libc::c_int as usize][0 as libc::c_int as usize];
    } else {
        lindex = FixedMul(xscale, 640 as libc::c_int * fovtan / vid.width)
            >> 12 as libc::c_int;
        if lindex >= 48 as libc::c_int {
            lindex = 48 as libc::c_int - 1 as libc::c_int;
        }
        if (*vis).cut as libc::c_int & SC_SEMIBRIGHT as libc::c_int != 0 {
            lindex = 48 as libc::c_int / 2 as libc::c_int + (lindex >> 1 as libc::c_int);
        }
        (*vis).colormap = *spritelights.offset(lindex as isize);
    }
    if vflip != 0 {
        (*vis)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*vis).cut as libc::c_int | SC_VFLIP as libc::c_int);
    }
    if splat != 0 {
        (*vis)
            .cut = ::core::mem::transmute::<
            libc::c_int,
            spritecut_e,
        >((*vis).cut as libc::c_int | SC_SPLAT as libc::c_int);
    }
    (*vis).patch = patch;
    if (*(*(*thing).subsector).sector).numlights != 0 && !(shadowdraw != 0 || splat != 0)
    {
        R_SplitSprite(vis);
    }
    if (*oldthing).shadowscale != 0 && cv_shadow.value != 0 {
...
unsafe extern "C" fn R_ProjectPrecipitationSprite(mut thing: *mut precipmobj_t) {
    ...
    let mut vis: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut iscale: fixed_t = 0;
    let mut gz: fixed_t = 0;
    let mut gzt: fixed_t = 0;
    let mut interp: interpmobjstate_t = {
        let mut init = interpmobjstate_t {
            x: 0 as libc::c_int,
            y: 0,
    ...
    if R_UsingFrameInterpolation() != 0 && paused == 0 {
        R_InterpolatePrecipMobjState(thing, rendertimefrac, &mut interp);
    } else {
        R_InterpolatePrecipMobjState(
            thing,
            (1 as libc::c_int) << 16 as libc::c_int,
            &mut interp,
        );
    ...
    tr_y = interp.y - viewy;
    tz = FixedMul(tr_x, viewcos) + FixedMul(tr_y, viewsin);
    if tz < ((1 as libc::c_int) << 16 as libc::c_int) * 4 as libc::c_int {
        return;
    }
    tx = FixedMul(tr_x, viewsin) - FixedMul(tr_y, viewcos);
    if abs(tx) > FixedMul(tz, fovtan) << 2 as libc::c_int {
        return;
    }
    xscale = FixedDiv(projection, tz);
    yscale = FixedDiv(projectiony, tz);
    ...
    sprframe = &mut *((*sprdef).spriteframes)
        .offset(((*thing).frame & 0xff as libc::c_int as uint32_t) as isize)
        as *mut spriteframe_t;
    lump = (*sprframe).lumpid[0 as libc::c_int as usize];
    tx -= (*spritecachedinfo.offset(lump as isize)).offset;
    x1 = centerxfrac + FixedMul(tx, xscale) >> 16 as libc::c_int;
    if x1 > viewwidth {
        return;
    }
    tx += (*spritecachedinfo.offset(lump as isize)).width;
    x2 = (centerxfrac + FixedMul(tx, xscale) >> 16 as libc::c_int) - 1 as libc::c_int;
    if x2 < 0 as libc::c_int {
        return;
    }
    if portalrender as libc::c_int != 0 && !portalclipline.is_null() {
    ...
    gzt = interp.z + (*spritecachedinfo.offset(lump as isize)).topoffset;
    gz = gzt - (*spritecachedinfo.offset(lump as isize)).height;
    if !((*(*(*thing).subsector).sector).cullheight).is_null() {
        if R_DoCulling(
            (*(*(*thing).subsector).sector).cullheight,
            (*viewsector).cullheight,
        ...
        {
            current_block = 3185434332996782497;
        } else {
    ...
    match current_block {
        5689316957504528238 => {
            vis = R_NewVisSprite();
            (*vis).sortscale = yscale;
            (*vis).scale = (*vis).sortscale;
            (*vis).dispoffset = 0 as libc::c_int;
            (*vis).gx = interp.x;
            (*vis).gy = interp.y;
            (*vis).gz = gz;
            (*vis).gzt = gzt;
            (*vis)
                .thingheight = 4 as libc::c_int
                * ((1 as libc::c_int) << 16 as libc::c_int);
            (*vis).pz = interp.z;
            (*vis).pzt = (*vis).pz + (*vis).thingheight;
            (*vis).texturemid = (*vis).gzt - viewz;
            (*vis).scalestep = 0 as libc::c_int;
            (*vis).paperdistance = 0 as libc::c_int;
            (*vis).shear.tan = 0 as libc::c_int;
            (*vis).shear.offset = 0 as libc::c_int;
            (*vis).x1 = if x1 < portalclipstart { portalclipstart } else { x1 };
            (*vis)
                .x2 = if x2 >= portalclipend {
                portalclipend - 1 as libc::c_int
            } else {
                x2
            };
            (*vis).xscale = xscale;
            (*vis).sector = (*(*thing).subsector).sector;
            (*vis)
                .szt = (centeryfrac - FixedMul((*vis).gzt - viewz, yscale)
                >> 16 as libc::c_int) as int16_t;
            (*vis)
                .sz = (centeryfrac - FixedMul((*vis).gz - viewz, yscale)
                >> 16 as libc::c_int) as int16_t;
            iscale = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, xscale);
            (*vis).startfrac = 0 as libc::c_int;
            (*vis).xiscale = iscale;
            if (*vis).x1 > x1 {
            ...
            if (*thing).frame & 0xf0000 as libc::c_int as uint32_t != 0 {
                (*vis)
                    .transmap = R_GetTranslucencyTable(
                    (((*thing).frame & 0xf0000 as libc::c_int as uint32_t)
                        >> 16 as libc::c_int) as int32_t,
                );
            } else {
                (*vis).transmap = 0 as *mut uint8_t;
            }
            (*vis).mobj = thing as *mut mobj_t;
            (*vis).mobjflags = 0 as libc::c_int;
            (*vis).cut = SC_PRECIP;
            (*vis).extra_colormap = (*(*(*thing).subsector).sector).extra_colormap;
    ...
    if (*thing).precipflags & PCF_THUNK as libc::c_int == 0 {
        if (*thing).precipflags & PCF_RAIN as libc::c_int != 0 {
            P_RainThinker(thing);
        } else {
            P_SnowThinker(thing);
        }
        (*thing).precipflags |= PCF_THUNK as libc::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_AddSprites(mut sec: *mut sector_t, mut lightlevel: int32_t) {
    let mut thing: *mut mobj_t = 0 as *mut mobj_t;
    let mut precipthing: *mut precipmobj_t = 0 as *mut precipmobj_t;
    let mut lightnum: int32_t = 0;
    let mut limit_dist: fixed_t = 0;
    let mut hoop_limit_dist: fixed_t = 0;
    ...
    if (*sec).numlights == 0 {
        if (*sec).heightsec == -(1 as libc::c_int) {
            lightlevel = (*sec).lightlevel as int32_t;
        }
        lightnum = lightlevel >> 3 as libc::c_int;
        if lightnum < 0 as libc::c_int {
            spritelights = (scalelight[0 as libc::c_int as usize]).as_mut_ptr();
        } else if lightnum >= 32 as libc::c_int {
            spritelights = (scalelight[(32 as libc::c_int - 1 as libc::c_int) as usize])
    ...
    limit_dist = cv_drawdist.value << 16 as libc::c_int;
    hoop_limit_dist = cv_drawdist_nights.value << 16 as libc::c_int;
    thing = (*sec).thinglist;
    while !thing.is_null() {
        if R_ThingWithinDist(thing, limit_dist, hoop_limit_dist) != 0 {
            let oldobjectsdrawn: int32_t = objectsdrawn as int32_t;
            if R_ThingVisible(thing) != 0 {
                R_ProjectSprite(thing);
            }
            if objectsdrawn as libc::c_int == oldobjectsdrawn {
                R_ProjectBoundingBox(thing, 0 as *mut vissprite_t);
            }
        }
        thing = (*thing).snext;
    }
    limit_dist = cv_drawdist_precip.value << 16 as libc::c_int;
    if limit_dist != 0 {
        precipthing = (*sec).preciplist;
        while !precipthing.is_null() {
            if R_PrecipThingVisible(precipthing, limit_dist) != 0 {
                R_ProjectPrecipitationSprite(precipthing);
            }
            precipthing = (*precipthing).snext;
        }
    }
}
unsafe extern "C" fn R_SortVisSpriteFunc(
    mut ds: *mut vissprite_t,
    mut bestscale: fixed_t,
    mut bestdispoffset: int32_t,
) -> boolean {
...
unsafe extern "C" fn R_SortVisSprites(
    mut vsprsortedhead: *mut vissprite_t,
    mut start: uint32_t,
    mut end: uint32_t,
) {
    let mut i: uint32_t = 0;
    let mut linkedvissprites: uint32_t = 0 as libc::c_int as uint32_t;
    let mut ds: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut dsprev: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut dsnext: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut dsfirst: *mut vissprite_t = 0 as *mut vissprite_t;
    let mut best: *mut vissprite_t = 0 as *mut vissprite_t;
    ...
    let mut bestdispoffset: int32_t = 0;
    unsorted.prev = &mut unsorted;
    unsorted.next = unsorted.prev;
    dsfirst = R_GetVisSprite(start);
    i = start;
    dsnext = dsfirst;
    ds = 0 as *mut vissprite_t;
    while i < end {
        dsprev = ds;
        ds = dsnext;
        if i < end.wrapping_sub(1 as libc::c_int as uint32_t) {
            dsnext = R_GetVisSprite(i.wrapping_add(1 as libc::c_int as uint32_t));
        }
        (*ds).next = dsnext;
        (*ds).prev = dsprev;
        (*ds).linkdraw = 0 as *mut vissprite_s;
        i = i.wrapping_add(1);
        i;
    }
    (*dsfirst).prev = &mut unsorted;
    unsorted.next = dsfirst;
    if !ds.is_null() {
        (*ds).next = &mut unsorted;
        (*ds).linkdraw = 0 as *mut vissprite_s;
    }
    unsorted.prev = ds;
    ds = unsorted.prev;
    while ds != &mut unsorted as *mut vissprite_t {
        if (*ds).cut as libc::c_int & SC_NOTVISIBLE as libc::c_int != 0 {
            (*(*ds).next).prev = (*ds).prev;
            (*(*ds).prev).next = (*ds).next;
        } else if !((*ds).cut as libc::c_int & SC_LINKDRAW as libc::c_int == 0) {
            if !((*ds).cut as libc::c_int & SC_SHADOW as libc::c_int != 0) {
                dsfirst = unsorted.prev;
                while dsfirst != &mut unsorted as *mut vissprite_t {
                    if !((*dsfirst).cut as libc::c_int & SC_LINKDRAW as libc::c_int != 0)
                    {
                        if !((*dsfirst).cut as libc::c_int & SC_SHADOW as libc::c_int
                            != 0)
                        {
                            if !((*dsfirst).cut as libc::c_int & SC_BBOX as libc::c_int
                                != 0)
                            {
                                if !((*dsfirst).mobj != (*ds).mobj) {
                                    if !((*dsfirst).cut as libc::c_int & SC_TOP as libc::c_int
                                        != 0
                                        && (*dsfirst).szt as libc::c_int > (*ds).szt as libc::c_int)
                                    {
                                        if !((*dsfirst).cut as libc::c_int
                                            & SC_BOTTOM as libc::c_int != 0
                                            && ((*dsfirst).sz as libc::c_int) < (*ds).sz as libc::c_int)
                                        {
                                            if (*ds).cut as libc::c_int & SC_BBOX as libc::c_int != 0
                                                && (*dsfirst).cut as libc::c_int
                                                    & SC_NOTVISIBLE as libc::c_int != 0
                                            {
                                                (*ds)
                                                    .cut = ::core::mem::transmute::<
                                                    libc::c_int,
                                                    spritecut_e,
                                                >((*ds).cut as libc::c_int | SC_NOTVISIBLE as libc::c_int);
                                            }
                                            break;
                                        }
                                    }
                    ...
                    dsfirst = (*dsfirst).prev;
                }
                (*(*ds).next).prev = (*ds).prev;
                (*(*ds).prev).next = (*ds).next;
                if !((*ds).cut as libc::c_int & SC_NOTVISIBLE as libc::c_int != 0) {
                    linkedvissprites = linkedvissprites.wrapping_add(1);
                    linkedvissprites;
                    if dsfirst != &mut unsorted as *mut vissprite_t {
                        if (*ds).cut as libc::c_int & SC_FULLBRIGHT as libc::c_int == 0 {
                            ...
                            ) == true_0 as libc::c_int
                        {
                            ...
                            while !((*dsnext).next).is_null() {
                                if R_SortVisSpriteFunc(
                                    ds,
                                    (*(*dsnext).next).sortscale,
                                    (*(*dsnext).next).dispoffset,
                                ) == true_0 as libc::c_int
                                {
                                    break;
                                }
    ...
    i = start;
    while i < end.wrapping_sub(linkedvissprites) {
        bestdispoffset = 2147483647 as libc::c_int;
        bestscale = bestdispoffset;
        ds = unsorted.next;
        while ds != &mut unsorted as *mut vissprite_t {
            if R_SortVisSpriteFunc(ds, bestscale, bestdispoffset)
                == true_0 as libc::c_int
            {
...
static mut nodebankhead: drawnode_t = drawnode_s {
    plane: 0 as *const visplane_t as *mut visplane_t,
    seg: 0 as *const drawseg_t as *mut drawseg_t,
    thickseg: 0 as *const drawseg_t as *mut drawseg_t,
    ffloor: 0 as *const ffloor_t as *mut ffloor_t,
    sprite: 0 as *const vissprite_t as *mut vissprite_t,
    next: 0 as *const drawnode_s as *mut drawnode_s,
    prev: 0 as *const drawnode_s as *mut drawnode_s,
};
unsafe extern "C" fn R_CreateDrawNodes(
    mut mask: *mut maskcount_t,
    mut head: *mut drawnode_t,
    mut tempskip: boolean,
) {
    let mut entry: *mut drawnode_t = 0 as *mut drawnode_t;
    let mut ds: *mut drawseg_t = 0 as *mut drawseg_t;
    let mut i: int32_t = 0;
    let mut p: int32_t = 0;
    let mut best: int32_t = 0;
    let mut x1: int32_t = 0;
    let mut x2: int32_t = 0;
    let mut bestdelta: fixed_t = 0;
    let mut delta: fixed_t = 0;
    let mut rover: *mut vissprite_t = 0 as *mut vissprite_t;
    static mut vsprsortedhead: vissprite_t = vissprite_s {
        prev: 0 as *const vissprite_s as *mut vissprite_s,
        next: 0 as *const vissprite_s as *mut vissprite_s,
        linkdraw: 0 as *const vissprite_s as *mut vissprite_s,
        mobj: 0 as *const mobj_t as *mut mobj_t,
    ...
    let mut r2: *mut drawnode_t = 0 as *mut drawnode_t;
    let mut plane: *mut visplane_t = 0 as *mut visplane_t;
    let mut sintersect: int32_t = 0;
    let mut scale: fixed_t = 0 as libc::c_int;
    ds = drawsegs.offset((*mask).drawsegs[1 as libc::c_int as usize] as isize);
    loop {
        let fresh4 = ds;
        ds = ds.offset(-1);
        if !(fresh4
            > drawsegs.offset((*mask).drawsegs[0 as libc::c_int as usize] as isize))
        {
            break;
        }
        if (*ds).numthicksides != 0 {
            i = 0 as libc::c_int;
            while i < (*ds).numthicksides {
                entry = R_CreateDrawNode(head);
                (*entry).thickseg = ds;
                (*entry).ffloor = (*ds).thicksides[i as usize];
                i += 1;
                i;
            }
        }
        if !((*(*ds).curline).polyseg).is_null()
            && !((*(*(*ds).curline).polyseg).visplane).is_null()
            && (*(*ds).curline).side == 0
        {
            plane = (*(*(*ds).curline).polyseg).visplane;
            R_PlaneBounds(plane);
            if !((*plane).low < 0 as libc::c_int || (*plane).high > vid.height
                || (*plane).high > (*plane).low)
            {
                entry = R_CreateDrawNode(head);
                (*entry).plane = plane;
                (*entry).seg = ds;
            }
            (*(*(*ds).curline).polyseg).visplane = 0 as *mut visplane_s;
        }
        if !((*ds).maskedtexturecol).is_null() {
            entry = R_CreateDrawNode(head);
            (*entry).seg = ds;
        }
        if (*ds).numffloorplanes != 0 {
            i = 0 as libc::c_int;
            while i < (*ds).numffloorplanes {
                best = -(1 as libc::c_int);
                bestdelta = 0 as libc::c_int;
                p = 0 as libc::c_int;
                while p < (*ds).numffloorplanes {
                    if !((*ds).ffloorplanes[p as usize]).is_null() {
                        plane = (*ds).ffloorplanes[p as usize];
                        R_PlaneBounds(plane);
                        if (*plane).low < 0 as libc::c_int || (*plane).high > vid.height
                            || (*plane).high > (*plane).low
                            || !((*plane).polyobj).is_null()
                        {
                            (*ds).ffloorplanes[p as usize] = 0 as *mut visplane_s;
                        } else {
                ...
                entry = R_CreateDrawNode(head);
                (*entry).plane = (*ds).ffloorplanes[best as usize];
                (*entry).seg = ds;
                (*ds).ffloorplanes[best as usize] = 0 as *mut visplane_s;
                i += 1;
                i;
            }
        }
    ...
    i = 0 as libc::c_int;
    while i < numPolyObjects {
        if !((*PolyObjects.offset(i as isize)).visplane).is_null() {
            plane = (*PolyObjects.offset(i as isize)).visplane;
            R_PlaneBounds(plane);
            if (*plane).low < 0 as libc::c_int || (*plane).high > vid.height
                || (*plane).high > (*plane).low
            {
                let ref mut fresh5 = (*PolyObjects.offset(i as isize)).visplane;
                *fresh5 = 0 as *mut visplane_s;
            } else {
                entry = R_CreateDrawNode(head);
                (*entry).plane = plane;
                let ref mut fresh6 = (*PolyObjects.offset(i as isize)).visplane;
                *fresh6 = 0 as *mut visplane_s;
            }
        }
        i += 1;
        i;
    }
    if ((*mask).vissprites[1 as libc::c_int as usize])
        .wrapping_sub((*mask).vissprites[0 as libc::c_int as usize])
        == 0 as libc::c_int as size_t
    {
        return;
    }
    R_SortVisSprites(
        &mut vsprsortedhead,
        (*mask).vissprites[0 as libc::c_int as usize] as uint32_t,
        (*mask).vissprites[1 as libc::c_int as usize] as uint32_t,
    );
    rover = vsprsortedhead.prev;
    while rover != &mut vsprsortedhead as *mut vissprite_t {
        if !((*rover).szt as libc::c_int > vid.height
            || ((*rover).sz as libc::c_int) < 0 as libc::c_int)
        {
            sintersect = ((*rover).x1 + (*rover).x2) / 2 as libc::c_int;
            let mut current_block_109: u64;
            r2 = (*head).next;
            while r2 != head {
                if !((*r2).plane).is_null() {
                    let mut planeobjectz: fixed_t = 0;
                    let mut planecameraz: fixed_t = 0;
                    if !((*(*r2).plane).minx > (*rover).x2
                        || (*(*r2).plane).maxx < (*rover).x1)
                    {
                        if !((*rover).szt as libc::c_int > (*(*r2).plane).low
                            || ((*rover).sz as libc::c_int) < (*(*r2).plane).high)
                        {
                            planeobjectz = P_GetZAt(
                                (*(*r2).plane).slope,
                                (*rover).gx,
                                (*rover).gy,
                                (*(*r2).plane).height,
                            );
                            planecameraz = P_GetZAt(
                                (*(*r2).plane).slope,
                                viewx,
                                viewy,
                                (*(*r2).plane).height,
                            );
                            if (*rover).mobjflags & MF_NOCLIPHEIGHT as libc::c_int != 0 {
                                if planecameraz < viewz
                                    && (*rover).pz + (*rover).thingheight / 2 as libc::c_int
                                        >= planeobjectz
                                {
                                    current_block_109 = 2706659501864706830;
                                } else if planecameraz > viewz
                                    && (*rover).pzt - (*rover).thingheight / 2 as libc::c_int
                                        <= planeobjectz
                                {
                                    current_block_109 = 2706659501864706830;
                                } else {
                                    current_block_109 = 6367734732029634840;
                                }
                            } else if planecameraz < viewz && (*rover).pz >= planeobjectz
                            {
                                current_block_109 = 2706659501864706830;
                            } else if planecameraz > viewz
                                && (*rover).pzt <= planeobjectz
                            {
                                current_block_109 = 2706659501864706830;
                            } else {
                                current_block_109 = 6367734732029634840;
                            ...
                            match current_block_109 {
                                ...
                                _ => {
                                    ...
                                    if !((*r2).seg).is_null() {
                                        i = x1;
                                        while i <= x2 {
                                            if (*(*r2).seg).frontscale[i as usize] > (*rover).sortscale
                                            {
                                                break;
                                            }
                                            i += 1;
                                        ...
                                        if i > x2 {
                                            ...
                                            current_block_109 = 8716029205547827362;
                                        }
                                    } else {
                                        current_block_109 = 8716029205547827362;
                                    }
                                    match current_block_109 {
                                        2706659501864706830 => {}
                                        _ => {
                                            entry = R_CreateDrawNode(0 as *mut drawnode_t);
                                            (*entry).prev = (*r2).prev;
                ...
                } else if !((*r2).thickseg).is_null() {
                    let mut topplaneobjectz: fixed_t = 0;
                    let mut topplanecameraz: fixed_t = 0;
                    let mut botplaneobjectz: fixed_t = 0;
                    let mut botplanecameraz: fixed_t = 0;
                    if !((*rover).x1 > (*(*r2).thickseg).x2
                        || (*rover).x2 < (*(*r2).thickseg).x1)
                    {
                        scale = if (*(*r2).thickseg).scale1 > (*(*r2).thickseg).scale2 {
                            (*(*r2).thickseg).scale1
                        } else {
                            (*(*r2).thickseg).scale2
                        };
                        if !(scale <= (*rover).sortscale) {
                            scale = (*(*r2).thickseg).scale1
                                + (*(*r2).thickseg).scalestep
                                    * (sintersect - (*(*r2).thickseg).x1);
                            if !(scale <= (*rover).sortscale) {
                                topplaneobjectz = P_GetFFloorTopZAt(
                                    (*r2).ffloor,
                                    (*rover).gx,
                                    (*rover).gy,
                                );
                                topplanecameraz = P_GetFFloorTopZAt(
                                    (*r2).ffloor,
                                    viewx,
                                    viewy,
                                );
                                botplaneobjectz = P_GetFFloorBottomZAt(
                                    (*r2).ffloor,
                                    (*rover).gx,
                                    (*rover).gy,
                                );
                                botplanecameraz = P_GetFFloorBottomZAt(
                                    (*r2).ffloor,
                                    viewx,
                                    viewy,
                                );
                ...
                } else if !((*r2).seg).is_null() {
                    if !((*rover).x1 > (*(*r2).seg).x2 || (*rover).x2 < (*(*r2).seg).x1)
                    {
                        scale = if (*(*r2).seg).scale1 > (*(*r2).seg).scale2 {
                            (*(*r2).seg).scale1
                        } else {
                            (*(*r2).seg).scale2
                        };
                        if !(scale <= (*rover).sortscale) {
                            scale = (*(*r2).seg).scale1
                                + (*(*r2).seg).scalestep * (sintersect - (*(*r2).seg).x1);
                ...
                } else if !((*r2).sprite).is_null() {
                    let mut infront: boolean = ((*(*r2).sprite).sortscale
                        > (*rover).sortscale
                        || (*(*r2).sprite).sortscale == (*rover).sortscale
                            && (*(*r2).sprite).dispoffset > (*rover).dispoffset)
                        as libc::c_int;
                    if (*rover).cut as libc::c_int & SC_SPLAT as libc::c_int != 0
                        || (*(*r2).sprite).cut as libc::c_int & SC_SPLAT as libc::c_int
                            != 0
                    {
                        let mut scale1: fixed_t = if (*rover).cut as libc::c_int
                            & SC_SPLAT as libc::c_int != 0
                        {
                            (*rover).sortsplat
                        } else {
                            (*rover).sortscale
                        };
                        let mut scale2: fixed_t = if (*(*r2).sprite).cut as libc::c_int
                            & SC_SPLAT as libc::c_int != 0
                        {
                            (*(*r2).sprite).sortsplat
                        } else {
                        ...
                        let mut behind: boolean = (scale2 > scale1
                            || scale2 == scale1
                                && (*(*r2).sprite).dispoffset > (*rover).dispoffset)
                            as libc::c_int;
                        if behind == 0 {
                            let mut z1: fixed_t = 0 as libc::c_int;
                            let mut z2: fixed_t = 0 as libc::c_int;
                            if (*(*rover).mobj).z - viewz > 0 as libc::c_int {
                                z1 = (*rover).pz;
                                z2 = (*(*r2).sprite).pz;
                            } else {
                                z1 = (*(*r2).sprite).pz;
                            ...
                            z1 -= viewz;
                            z2 -= viewz;
                            infront = (z1 >= z2) as libc::c_int;
                        }
                        current_block_109 = 1604201581803946138;
                    } else if (*(*r2).sprite).x1 > (*rover).x2
                        || (*(*r2).sprite).x2 < (*rover).x1
                    {
                        current_block_109 = 2706659501864706830;
                    } else if (*(*r2).sprite).szt as libc::c_int
                        > (*rover).sz as libc::c_int
                        || ((*(*r2).sprite).sz as libc::c_int)
                            < (*rover).szt as libc::c_int
                    {
                        current_block_109 = 2706659501864706830;
                    } else {
                        current_block_109 = 1604201581803946138;
...
unsafe extern "C" fn R_CreateDrawNode(mut link: *mut drawnode_t) -> *mut drawnode_t {
    let mut node: *mut drawnode_t = nodebankhead.next;
    if node == &mut nodebankhead as *mut drawnode_t {
        node = malloc(::core::mem::size_of::<drawnode_t>() as libc::c_ulong)
            as *mut drawnode_t;
        if node.is_null() {
            I_Error(
                b"No more free memory to CreateDrawNode\0" as *const u8
                    as *const libc::c_char,
            );
        }
    } else {
        nodebankhead.next = (*node).next;
        (*nodebankhead.next).prev = &mut nodebankhead;
    }
    if !link.is_null() {
        (*node).next = link;
        (*node).prev = (*link).prev;
    ...
    (*node).plane = 0 as *mut visplane_t;
    (*node).seg = 0 as *mut drawseg_t;
    (*node).thickseg = 0 as *mut drawseg_t;
    (*node).ffloor = 0 as *mut ffloor_t;
    (*node).sprite = 0 as *mut vissprite_t;
    ps_numdrawnodes.value.i += 1;
    ps_numdrawnodes.value.i;
    return node;
}
unsafe extern "C" fn R_DoneWithNode(mut node: *mut drawnode_t) {
    (*(*node).next).prev = (*node).prev;
    (*(*(*node).next).prev).next = (*node).next;
    (*node).next = nodebankhead.next;
    (*(*node).next).prev = node;
    (*node).prev = &mut nodebankhead;
    (*(*node).prev).next = node;
}
unsafe extern "C" fn R_ClearDrawNodes(mut head: *mut drawnode_t) {
    let mut rover: *mut drawnode_t = 0 as *mut drawnode_t;
    let mut next: *mut drawnode_t = 0 as *mut drawnode_t;
    rover = (*head).next;
    while rover != head {
        next = (*rover).next;
...
#[no_mangle]
pub unsafe extern "C" fn R_InitDrawNodes() {
    nodebankhead.prev = &mut nodebankhead;
    nodebankhead.next = nodebankhead.prev;
}
unsafe extern "C" fn R_DrawSprite(mut spr: *mut vissprite_t) {
    mfloorclip = ((*spr).clipbot).as_mut_ptr();
    mceilingclip = ((*spr).cliptop).as_mut_ptr();
    if (*spr).cut as libc::c_int & SC_BBOX as libc::c_int != 0 {
        R_DrawThingBoundingBox(spr);
    } else if (*spr).cut as libc::c_int & SC_SPLAT as libc::c_int != 0 {
        R_DrawFloorSplat(spr);
    } else {
        R_DrawVisSprite(spr);
    };
}
unsafe extern "C" fn R_DrawPrecipitationSprite(mut spr: *mut vissprite_t) {
    mfloorclip = ((*spr).clipbot).as_mut_ptr();
    mceilingclip = ((*spr).cliptop).as_mut_ptr();
    R_DrawPrecipitationVisSprite(spr);
}
unsafe extern "C" fn R_HeightSecClip(
    mut spr: *mut vissprite_t,
    mut x1: int32_t,
    mut x2: int32_t,
) {
    let mut mh: fixed_t = 0;
    let mut h: fixed_t = 0;
    let mut x: int32_t = 0;
    let mut phs: int32_t = 0;
    if (*spr).heightsec == -(1 as libc::c_int) {
        return;
    }
    if (*spr).cut as libc::c_int & (SC_SPLAT as libc::c_int | SC_SHADOW as libc::c_int)
        != 0 || (*spr).renderflags & RF_SHADOWDRAW as libc::c_int as uint32_t != 0
    {
        return;
    }
    phs = (*(*(*(*viewplayer).mo).subsector).sector).heightsec;
    mh = (*sectors.offset((*spr).heightsec as isize)).floorheight;
    if mh > (*spr).gz
        && {
            mh -= viewz;
            h = centeryfrac - FixedMul(mh, (*spr).sortscale);
            h >= 0 as libc::c_int
        }
        && {
            h >>= 16 as libc::c_int;
    ...
    {
        if mh <= 0 as libc::c_int
            || phs != -(1 as libc::c_int)
                && viewz > (*sectors.offset(phs as isize)).floorheight
        {
            x = x1;
            while x <= x2 {
                if (*spr).clipbot[x as usize] as libc::c_int == -(2 as libc::c_int)
                    || h < (*spr).clipbot[x as usize] as libc::c_int
                {
                    (*spr).clipbot[x as usize] = h as int16_t;
                }
                x += 1;
                x;
            }
            ...
            x = x1;
            while x <= x2 {
                if (*spr).cliptop[x as usize] as libc::c_int == -(2 as libc::c_int)
                    || h > (*spr).cliptop[x as usize] as libc::c_int
                {
                    (*spr).cliptop[x as usize] = h as int16_t;
                }
                x += 1;
                x;
            }
    ...
    mh = (*sectors.offset((*spr).heightsec as isize)).ceilingheight;
    if mh < (*spr).gzt
        && {
            h = centeryfrac - FixedMul(mh - viewz, (*spr).sortscale);
            h >= 0 as libc::c_int
        }
        && {
            h >>= 16 as libc::c_int;
    ...
    {
        if phs != -(1 as libc::c_int)
            && viewz >= (*sectors.offset(phs as isize)).ceilingheight
        {
            x = x1;
            while x <= x2 {
                if (*spr).clipbot[x as usize] as libc::c_int == -(2 as libc::c_int)
...
unsafe extern "C" fn R_CheckSpriteVisible(
    mut spr: *mut vissprite_t,
    mut x1: int32_t,
    mut x2: int32_t,
) -> boolean {
    let mut sz: int16_t = (*spr).sz;
    let mut szt: int16_t = (*spr).szt;
    let mut texturemid: fixed_t = 0 as libc::c_int;
    let mut yscale: fixed_t = 0 as libc::c_int;
    let mut scalestep: fixed_t = (*spr).scalestep;
    let mut height: int32_t = 0 as libc::c_int;
    if scalestep != 0 {
        height = (*(*spr).patch).height as int32_t;
        yscale = (*spr).scale;
        scalestep = FixedMul(scalestep, (*spr).spriteyscale);
        if (*spr).thingscale != (1 as libc::c_int) << 16 as libc::c_int {
            texturemid = FixedDiv(
                (*spr).texturemid,
                if (*spr).thingscale > 1 as libc::c_int {
                    (*spr).thingscale
                } else {
                    1 as libc::c_int
                },
    ...
    let mut x: int32_t = x1;
    while x <= x2 {
        if scalestep != 0 {
            let mut top: fixed_t = centeryfrac - FixedMul(texturemid, yscale);
            let mut bottom: fixed_t = top + height * yscale;
            szt = (top >> 16 as libc::c_int) as int16_t;
            sz = (bottom >> 16 as libc::c_int) as int16_t;
            yscale += scalestep;
        }
        if ((*spr).cliptop[x as usize] as libc::c_int)
            < (*spr).clipbot[x as usize] as libc::c_int
            && sz as libc::c_int > (*spr).cliptop[x as usize] as libc::c_int
            && (szt as libc::c_int) < (*spr).clipbot[x as usize] as libc::c_int
        {
            return true_0 as libc::c_int;
        }
        x += 1;
...
unsafe extern "C" fn R_ClipVisSprite(
    mut spr: *mut vissprite_t,
    mut x1: int32_t,
    mut x2: int32_t,
    ...
    let mut ds: *mut drawseg_t = 0 as *mut drawseg_t;
    let mut x: int32_t = 0;
    let mut r1: int32_t = 0;
    let mut r2: int32_t = 0;
    let mut scale: fixed_t = 0;
    let mut lowscale: fixed_t = 0;
    let mut silhouette: int32_t = 0;
    x = x1;
    while x <= x2 {
        (*spr).cliptop[x as usize] = -(2 as libc::c_int) as int16_t;
        (*spr).clipbot[x as usize] = (*spr).cliptop[x as usize];
        x += 1;
        x;
    }
    if drawsegs_xrange_size != 0 {
        let mut last: *const drawseg_xrange_item_t = &mut *drawsegs_xrange
            .offset((drawsegs_xrange_count - 1 as libc::c_int) as isize)
            as *mut drawseg_xrange_item_t;
        let mut curr: *mut drawseg_xrange_item_t = &mut *drawsegs_xrange
            .offset(-(1 as libc::c_int) as isize) as *mut drawseg_xrange_item_t;
        loop {
            curr = curr.offset(1);
            if !(curr <= last as *mut drawseg_xrange_item_t) {
                break;
            }
            if !((*curr).x1 as libc::c_int > x2 || ((*curr).x2 as libc::c_int) < x1) {
                ds = (*curr).user;
                if (*ds).portalpass as libc::c_int > 0 as libc::c_int
                    && (*ds).portalpass as libc::c_int <= portalrender as libc::c_int
                {
                    continue;
                }
                ...
                r1 = if (*ds).x1 < x1 { x1 } else { (*ds).x1 };
                r2 = if (*ds).x2 > x2 { x2 } else { (*ds).x2 };
                silhouette = (*ds).silhouette;
                if (*spr).gz >= (*ds).bsilheight {
                    silhouette &= !(1 as libc::c_int);
                }
                if (*spr).gzt <= (*ds).tsilheight {
                    silhouette &= !(2 as libc::c_int);
                }
                if silhouette == 1 as libc::c_int {
                    x = r1;
                    while x <= r2 {
                        if (*spr).clipbot[x as usize] as libc::c_int
                            == -(2 as libc::c_int)
                        {
                            (*spr)
                                .clipbot[x
                                as usize] = *((*ds).sprbottomclip).offset(x as isize);
                        }
                        x += 1;
                        x;
                    }
                } else if silhouette == 2 as libc::c_int {
                    x = r1;
                    while x <= r2 {
                        if (*spr).cliptop[x as usize] as libc::c_int
                            == -(2 as libc::c_int)
                        {
                            (*spr)
                                .cliptop[x
                                as usize] = *((*ds).sprtopclip).offset(x as isize);
                        }
                        x += 1;
                        x;
                    }
                } else if silhouette == 2 as libc::c_int | 1 as libc::c_int {
                    x = r1;
                    while x <= r2 {
                        if (*spr).clipbot[x as usize] as libc::c_int
                            == -(2 as libc::c_int)
    ...
    if (*spr).cut as libc::c_int & SC_TOP as libc::c_int != 0
        && (*spr).cut as libc::c_int & SC_BOTTOM as libc::c_int != 0
    {
        x = x1;
        while x <= x2 {
            if (*spr).cliptop[x as usize] as libc::c_int == -(2 as libc::c_int)
                || (*spr).szt as libc::c_int > (*spr).cliptop[x as usize] as libc::c_int
            {
                (*spr).cliptop[x as usize] = (*spr).szt;
            }
            if (*spr).clipbot[x as usize] as libc::c_int == -(2 as libc::c_int)
                || ((*spr).sz as libc::c_int) < (*spr).clipbot[x as usize] as libc::c_int
            {
                (*spr).clipbot[x as usize] = (*spr).sz;
            }
            x += 1;
            x;
        }
    } else if (*spr).cut as libc::c_int & SC_TOP as libc::c_int != 0 {
        x = x1;
        while x <= x2 {
            if (*spr).cliptop[x as usize] as libc::c_int == -(2 as libc::c_int)
                || (*spr).szt as libc::c_int > (*spr).cliptop[x as usize] as libc::c_int
    ...
    } else if (*spr).cut as libc::c_int & SC_BOTTOM as libc::c_int != 0 {
        x = x1;
        while x <= x2 {
            if (*spr).clipbot[x as usize] as libc::c_int == -(2 as libc::c_int)
                || ((*spr).sz as libc::c_int) < (*spr).clipbot[x as usize] as libc::c_int
    ...
    while x <= x2 {
        if (*spr).clipbot[x as usize] as libc::c_int == -(2 as libc::c_int) {
            (*spr).clipbot[x as usize] = viewheight as int16_t;
        }
        if (*spr).cliptop[x as usize] as libc::c_int == -(2 as libc::c_int) {
            (*spr).cliptop[x as usize] = -(1 as libc::c_int) as int16_t;
        }
        x += 1;
        x;
    }
    if !portal.is_null() {
        let mut start_index: int32_t = if (*portal).start > x1 {
            (*portal).start
        } else {
            x1
        };
        let mut end_index: int32_t = if (*portal).start + (*portal).end - (*portal).start
            < x2
        {
            (*portal).start + (*portal).end - (*portal).start
        } else {
            x2
        };
        x = x1;
        while x < start_index {
            (*spr).clipbot[x as usize] = -(1 as libc::c_int) as int16_t;
            (*spr).cliptop[x as usize] = -(1 as libc::c_int) as int16_t;
            x += 1;
            x;
        }
        ...
        while x <= end_index {
            if (*spr).clipbot[x as usize] as libc::c_int
                > *((*portal).floorclip).offset((x - (*portal).start) as isize)
                    as libc::c_int
            {
                (*spr)
                    .clipbot[x
                    as usize] = *((*portal).floorclip)
                    .offset((x - (*portal).start) as isize);
            }
            if ((*spr).cliptop[x as usize] as libc::c_int)
                < *((*portal).ceilingclip).offset((x - (*portal).start) as isize)
                    as libc::c_int
            {
                (*spr)
                    .cliptop[x
                    as usize] = *((*portal).ceilingclip)
                    .offset((x - (*portal).start) as isize);
            }
            x += 1;
            x;
        }
        x = end_index + 1 as libc::c_int;
        while x <= x2 {
            (*spr).clipbot[x as usize] = -(1 as libc::c_int) as int16_t;
            (*spr).cliptop[x as usize] = -(1 as libc::c_int) as int16_t;
            x += 1;
    ...
    if cv_spriteclip.value != 0
        && (*spr).cut as libc::c_int & SC_SPLAT as libc::c_int == 0 as libc::c_int
    {
        if R_CheckSpriteVisible(spr, x1, x2) == 0 {
            (*spr)
                .cut = ::core::mem::transmute::<
                libc::c_int,
                spritecut_e,
            >((*spr).cut as libc::c_int | SC_NOTVISIBLE as libc::c_int);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_ClipSprites(
    mut dsstart: *mut drawseg_t,
    mut portal: *mut portal_t,
) {
    let maxdrawsegs: size_t = ds_p.offset_from(drawsegs) as libc::c_long as size_t;
    let cx: int32_t = viewwidth / 2 as libc::c_int;
    let mut ds: *mut drawseg_t = 0 as *mut drawseg_t;
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        drawsegs_xranges[i as usize].count = 0 as libc::c_int;
        i += 1;
        i;
    }
    if visspritecount.wrapping_sub(clippedvissprites) <= 0 as libc::c_int as uint32_t {
        return;
    }
    if drawsegs_xrange_size < maxdrawsegs {
        drawsegs_xrange_size = 2 as libc::c_int as size_t * maxdrawsegs;
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            drawsegs_xranges[i as usize]
                .items = Z_ReallocAlign(
                drawsegs_xranges[i as usize].items as *mut libc::c_void,
                drawsegs_xrange_size
                    .wrapping_mul(
                        ::core::mem::size_of::<drawseg_xrange_item_t>() as libc::c_ulong,
                    ),
                PU_STATIC as libc::c_int,
                0 as *mut libc::c_void,
                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ...
    loop {
        ...
        if (*ds).silhouette != 0 || !((*ds).maskedtexturecol).is_null() {
            (*(drawsegs_xranges[0 as libc::c_int as usize].items)
                .offset(drawsegs_xranges[0 as libc::c_int as usize].count as isize))
                .x1 = (*ds).x1 as int16_t;
            (*(drawsegs_xranges[0 as libc::c_int as usize].items)
                .offset(drawsegs_xranges[0 as libc::c_int as usize].count as isize))
                .x2 = (*ds).x2 as int16_t;
            let ref mut fresh8 = (*(drawsegs_xranges[0 as libc::c_int as usize].items)
                .offset(drawsegs_xranges[0 as libc::c_int as usize].count as isize))
                .user;
            *fresh8 = ds;
            if (*ds).x1 < cx {
                *(drawsegs_xranges[1 as libc::c_int as usize].items)
                    .offset(
                        drawsegs_xranges[1 as libc::c_int as usize].count as isize,
                    ) = *(drawsegs_xranges[0 as libc::c_int as usize].items)
                    .offset(drawsegs_xranges[0 as libc::c_int as usize].count as isize);
                drawsegs_xranges[1 as libc::c_int as usize].count += 1;
                drawsegs_xranges[1 as libc::c_int as usize].count;
            }
            if (*ds).x2 >= cx {
                *(drawsegs_xranges[2 as libc::c_int as usize].items)
                    .offset(
                        drawsegs_xranges[2 as libc::c_int as usize].count as isize,
                    ) = *(drawsegs_xranges[0 as libc::c_int as usize].items)
                    .offset(drawsegs_xranges[0 as libc::c_int as usize].count as isize);
                drawsegs_xranges[2 as libc::c_int as usize].count += 1;
                drawsegs_xranges[2 as libc::c_int as usize].count;
            }
            drawsegs_xranges[0 as libc::c_int as usize].count += 1;
            drawsegs_xranges[0 as libc::c_int as usize].count;
        }
    }
    while clippedvissprites < visspritecount {
        let mut spr: *mut vissprite_t = R_GetVisSprite(clippedvissprites);
        if cv_spriteclip.value != 0
            && ((*spr).szt as libc::c_int > vid.height
                || ((*spr).sz as libc::c_int) < 0 as libc::c_int)
            && !((*spr).cut as libc::c_int & SC_SPLAT as libc::c_int != 0
                || (*spr).scalestep != 0)
        {
            (*spr)
                .cut = ::core::mem::transmute::<
                ...
                spritecut_e,
            >((*spr).cut as libc::c_int | SC_NOTVISIBLE as libc::c_int);
        } else if (*spr).cut as libc::c_int & SC_BBOX as libc::c_int != 0 {
            numvisiblesprites = numvisiblesprites.wrapping_add(1);
            numvisiblesprites;
        } else {
            let mut x1: int32_t = if (*spr).cut as libc::c_int & SC_SPLAT as libc::c_int
                != 0
            {
                0 as libc::c_int
            } else {
            ...
            let mut x2: int32_t = if (*spr).cut as libc::c_int & SC_SPLAT as libc::c_int
                != 0
            {
                viewwidth
            } else {
            ...
            if x2 < cx {
                drawsegs_xrange = drawsegs_xranges[1 as libc::c_int as usize].items;
                drawsegs_xrange_count = drawsegs_xranges[1 as libc::c_int as usize]
                    .count;
            } else if x1 >= cx {
                drawsegs_xrange = drawsegs_xranges[2 as libc::c_int as usize].items;
                drawsegs_xrange_count = drawsegs_xranges[2 as libc::c_int as usize]
                    .count;
            } else {
                drawsegs_xrange = drawsegs_xranges[0 as libc::c_int as usize].items;
                drawsegs_xrange_count = drawsegs_xranges[0 as libc::c_int as usize]
                    .count;
            }
            R_ClipVisSprite(spr, x1, x2, portal);
            if (*spr).cut as libc::c_int & SC_NOTVISIBLE as libc::c_int
                == 0 as libc::c_int
            {
                numvisiblesprites = numvisiblesprites.wrapping_add(1);
                numvisiblesprites;
        ...
        clippedvissprites = clippedvissprites.wrapping_add(1);
        clippedvissprites;
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingVisible(mut thing: *mut mobj_t) -> boolean {
    return !((*thing).sprite as libc::c_uint == SPR_NULL as libc::c_int as libc::c_uint
        || (*thing).flags2 & MF2_DONTDRAW as libc::c_int as uint32_t != 0
        || !((*thing).drawonlyforplayer).is_null()
            && (*thing).drawonlyforplayer != viewplayer
        || !r_viewmobj.is_null()
            && (r_viewmobj == thing
                || !((*r_viewmobj).player).is_null()
                    && (*(*r_viewmobj).player).followmobj == thing
                || r_viewmobj == (*thing).dontdrawforviewmobj)) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingWithinDist(
    mut thing: *mut mobj_t,
    mut limit_dist: fixed_t,
    mut hoop_limit_dist: fixed_t,
) -> boolean {
    let approx_dist: fixed_t = P_AproxDistance(viewx - (*thing).x, viewy - (*thing).y);
    if (*thing).sprite as libc::c_uint == SPR_HOOP as libc::c_int as libc::c_uint {
        if hoop_limit_dist != 0 && approx_dist > hoop_limit_dist {
            return false_0 as libc::c_int;
        }
    } else if limit_dist != 0 && approx_dist > limit_dist {
        return false_0 as libc::c_int
    }
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_PrecipThingVisible(
    mut precipthing: *mut precipmobj_t,
    mut limit_dist: fixed_t,
) -> boolean {
    let mut approx_dist: fixed_t = 0;
    if (*precipthing).precipflags & PCF_INVISIBLE as libc::c_int != 0 {
        return false_0 as libc::c_int;
    }
    approx_dist = P_AproxDistance(viewx - (*precipthing).x, viewy - (*precipthing).y);
    return (approx_dist <= limit_dist) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingHorizontallyFlipped(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x2000000 as libc::c_int as uint32_t != 0
        || (*thing).renderflags & RF_HORIZONTALFLIP as libc::c_int as uint32_t != 0)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingVerticallyFlipped(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x1000000 as libc::c_int as uint32_t != 0
        || (*thing).renderflags & RF_VERTICALFLIP as libc::c_int as uint32_t != 0)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingIsPaperSprite(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x400000 as libc::c_int as uint32_t != 0
        || (*thing).renderflags & RF_PAPERSPRITE as libc::c_int as uint32_t != 0)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingIsFloorSprite(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).flags2 & MF2_SPLAT as libc::c_int as uint32_t != 0
        || (*thing).frame & 0x800000 as libc::c_int as uint32_t != 0
        || (*thing).renderflags & RF_FLOORSPRITE as libc::c_int as uint32_t != 0)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingIsFullBright(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x300000 as libc::c_int as uint32_t
        == 0x100000 as libc::c_int as uint32_t
        || (*thing).renderflags & RF_BRIGHTMASK as libc::c_int as uint32_t
            == RF_FULLBRIGHT as libc::c_int as uint32_t) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingIsSemiBright(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x300000 as libc::c_int as uint32_t
        == (0x100000 as libc::c_int | 0x200000 as libc::c_int) as uint32_t
        || (*thing).renderflags & RF_BRIGHTMASK as libc::c_int as uint32_t
            == RF_SEMIBRIGHT as libc::c_int as uint32_t) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ThingIsFullDark(mut thing: *mut mobj_t) -> boolean {
    return ((*thing).frame & 0x300000 as libc::c_int as uint32_t
        == 0x200000 as libc::c_int as uint32_t
        || (*thing).renderflags & RF_BRIGHTMASK as libc::c_int as uint32_t
            == RF_FULLDARK as libc::c_int as uint32_t) as libc::c_int;
}
unsafe extern "C" fn R_DrawMaskedList(mut head: *mut drawnode_t) {
    let mut r2: *mut drawnode_t = 0 as *mut drawnode_t;
    let mut next: *mut drawnode_t = 0 as *mut drawnode_t;
    r2 = (*head).next;
    while r2 != head {
        if !((*r2).plane).is_null() {
            ...
            R_DoneWithNode(r2);
            r2 = next;
        } else if !((*r2).seg).is_null() && !((*(*r2).seg).maskedtexturecol).is_null() {
            next = (*r2).prev;
            R_RenderMaskedSegRange((*r2).seg, (*(*r2).seg).x1, (*(*r2).seg).x2);
            (*(*r2).seg).maskedtexturecol = 0 as *mut fixed_t;
            R_DoneWithNode(r2);
            r2 = next;
        } else if !((*r2).thickseg).is_null() {
            next = (*r2).prev;
            ...
            next = (*r2).prev;
            if (*(*r2).sprite).cut as libc::c_int & SC_PRECIP as libc::c_int != 0 {
                R_DrawPrecipitationSprite((*r2).sprite);
            } else if ((*(*r2).sprite).linkdraw).is_null() {
                R_DrawSprite((*r2).sprite);
            } else {
                let mut ds: *mut vissprite_t = (*(*r2).sprite).linkdraw;
                while !ds.is_null() && (*(*r2).sprite).dispoffset > (*ds).dispoffset {
                    R_DrawSprite(ds);
                    ds = (*ds).next;
                }
                R_DrawSprite((*r2).sprite);
...
pub unsafe extern "C" fn R_DrawMasked(
    mut masks: *mut maskcount_t,
    mut nummasks: int32_t,
) {
    let mut heads: *mut drawnode_t = 0 as *mut drawnode_t;
    let mut i: int32_t = 0;
    heads = calloc(
        nummasks as libc::c_ulong,
        ::core::mem::size_of::<drawnode_t>() as libc::c_ulong,
    ) as *mut drawnode_t;
    i = 0 as libc::c_int;
    while i < nummasks {
        let ref mut fresh9 = (*heads.offset(i as isize)).prev;
        *fresh9 = &mut *heads.offset(i as isize) as *mut drawnode_t;
        let ref mut fresh10 = (*heads.offset(i as isize)).next;
        *fresh10 = *fresh9;
        viewx = (*masks.offset(i as isize)).viewx;
        viewy = (*masks.offset(i as isize)).viewy;
        viewz = (*masks.offset(i as isize)).viewz;
        viewsector = (*masks.offset(i as isize)).viewsector;
        R_CreateDrawNodes(
            &mut *masks.offset(i as isize),
            &mut *heads.offset(i as isize),
            false_0 as libc::c_int,
        );
        i += 1;
        i;
    }
    while nummasks > 0 as libc::c_int {
        viewx = (*masks.offset((nummasks - 1 as libc::c_int) as isize)).viewx;
        viewy = (*masks.offset((nummasks - 1 as libc::c_int) as isize)).viewy;
        viewz = (*masks.offset((nummasks - 1 as libc::c_int) as isize)).viewz;
        viewsector = (*masks.offset((nummasks - 1 as libc::c_int) as isize)).viewsector;
        R_DrawMaskedList(&mut *heads.offset((nummasks - 1 as libc::c_int) as isize));
        R_ClearDrawNodes(&mut *heads.offset((nummasks - 1 as libc::c_int) as isize));
        nummasks -= 1;
        nummasks;
    }
    free(heads as *mut libc::c_void);
}
