...
extern "C" {
    ...
    static mut servermaxping: tic_t;
    ...
    fn AM_Start();
    fn I_GetTime() -> tic_t;
    static mut closedcaptions: [caption_t; 8];
    fn I_GetPrecisePrecision() -> uint64_t;
    fn I_GetPreciseTime() -> precise_t;
    fn I_CPUInfo() -> *const CPUInfoFlags;
    ...
    fn VID_SetMode(modenum: int32_t) -> int32_t;
    fn VID_CheckRenderer() -> boolean;
    fn R_DrawColumn_8();
    fn R_DrawShadeColumn_8();
    fn R_DrawTranslucentColumn_8();
    fn R_DrawTranslatedColumn_8();
    fn R_DrawTranslatedTranslucentColumn_8();
    fn R_Draw2sMultiPatchColumn_8();
    fn R_Draw2sMultiPatchTranslucentColumn_8();
    fn R_DrawFogColumn_8();
    fn R_DrawColumnShadowed_8();
    fn R_DrawSpan_8();
    fn R_DrawTranslucentSpan_8();
    fn R_DrawTiltedSpan_8();
    fn R_DrawTiltedTranslucentSpan_8();
    fn R_DrawSplat_8();
    fn R_DrawTranslucentSplat_8();
    fn R_DrawTiltedSplat_8();
    fn R_DrawFloorSprite_8();
    static mut camera: camera_t;
    fn R_DrawTiltedSpan_NPO2_8();
    fn R_GetFramerateCap() -> uint32_t;
    fn R_DrawTiltedWaterSpan_NPO2_8();
    fn R_DrawWaterSpan_NPO2_8();
    fn R_DrawTiltedTranslucentFloorSprite_NPO2_8();
    fn R_DrawTiltedFloorSprite_NPO2_8();
    fn R_DrawTranslucentFloorSprite_NPO2_8();
    fn R_DrawFloorSprite_NPO2_8();
    fn R_DrawTiltedSplat_NPO2_8();
    fn R_DrawTranslucentSplat_NPO2_8();
    fn R_DrawSplat_NPO2_8();
    fn R_DrawTiltedTranslucentSpan_NPO2_8();
    fn R_DrawTranslucentFloorSprite_8();
    fn R_DrawTiltedFloorSprite_8();
    fn R_DrawTiltedTranslucentFloorSprite_8();
    fn R_DrawWaterSpan_8();
    fn R_DrawTiltedWaterSpan_8();
    fn R_DrawSolidColorSpan_8();
    fn R_DrawTransSolidColorSpan_8();
    fn R_DrawTiltedSolidColorSpan_8();
    fn R_DrawTiltedTransSolidColorSpan_8();
    fn R_DrawWaterSolidColorSpan_8();
    fn R_DrawTiltedWaterSolidColorSpan_8();
    fn R_DrawFogSpan_8();
    fn R_DrawTiltedFogSpan_8();
    fn R_DrawSpan_NPO2_8();
    fn R_DrawTranslucentSpan_NPO2_8();
    ...
    static mut promptactive: boolean;
...
pub const COLDRAWFUNC_MAX: C2RustUnnamed_4 = 9;
pub const COLDRAWFUNC_FOG: C2RustUnnamed_4 = 8;
pub const COLDRAWFUNC_TWOSMULTIPATCHTRANS: C2RustUnnamed_4 = 7;
pub const COLDRAWFUNC_TWOSMULTIPATCH: C2RustUnnamed_4 = 6;
pub const COLDRAWFUNC_TRANSTRANS: C2RustUnnamed_4 = 5;
pub const COLDRAWFUNC_SHADOWED: C2RustUnnamed_4 = 4;
pub const COLDRAWFUNC_SHADE: C2RustUnnamed_4 = 3;
pub const COLDRAWFUNC_TRANS: C2RustUnnamed_4 = 2;
pub const COLDRAWFUNC_FUZZY: C2RustUnnamed_4 = 1;
pub const COLDRAWFUNC_BASE: C2RustUnnamed_4 = 0;
pub type C2RustUnnamed_5 = libc::c_uint;
pub const SPANDRAWFUNC_MAX: C2RustUnnamed_5 = 21;
pub const SPANDRAWFUNC_TILTEDFOG: C2RustUnnamed_5 = 20;
pub const SPANDRAWFUNC_FOG: C2RustUnnamed_5 = 19;
pub const SPANDRAWFUNC_TILTEDWATERSOLID: C2RustUnnamed_5 = 18;
pub const SPANDRAWFUNC_WATERSOLID: C2RustUnnamed_5 = 17;
pub const SPANDRAWFUNC_TILTEDTRANSSOLID: C2RustUnnamed_5 = 16;
pub const SPANDRAWFUNC_TILTEDSOLID: C2RustUnnamed_5 = 15;
pub const SPANDRAWFUNC_TRANSSOLID: C2RustUnnamed_5 = 14;
pub const SPANDRAWFUNC_SOLID: C2RustUnnamed_5 = 13;
pub const SPANDRAWFUNC_TILTEDWATER: C2RustUnnamed_5 = 12;
pub const SPANDRAWFUNC_WATER: C2RustUnnamed_5 = 11;
pub const SPANDRAWFUNC_TILTEDTRANSSPRITE: C2RustUnnamed_5 = 10;
pub const SPANDRAWFUNC_TILTEDSPRITE: C2RustUnnamed_5 = 9;
pub const SPANDRAWFUNC_TRANSSPRITE: C2RustUnnamed_5 = 8;
pub const SPANDRAWFUNC_SPRITE: C2RustUnnamed_5 = 7;
pub const SPANDRAWFUNC_TILTEDSPLAT: C2RustUnnamed_5 = 6;
pub const SPANDRAWFUNC_TRANSSPLAT: C2RustUnnamed_5 = 5;
pub const SPANDRAWFUNC_SPLAT: C2RustUnnamed_5 = 4;
pub const SPANDRAWFUNC_TILTEDTRANS: C2RustUnnamed_5 = 3;
pub const SPANDRAWFUNC_TILTED: C2RustUnnamed_5 = 2;
pub const SPANDRAWFUNC_TRANS: C2RustUnnamed_5 = 1;
pub const SPANDRAWFUNC_BASE: C2RustUnnamed_5 = 0;
...
#[repr(C)]
pub struct CPUInfoFlags {
    #[bitfield(name = "FPU", ty = "libc::c_int", bits = "0..=0")]
    #[bitfield(name = "CPUID", ty = "libc::c_int", bits = "1..=1")]
    #[bitfield(name = "RDTSC", ty = "libc::c_int", bits = "2..=2")]
    #[bitfield(name = "MMX", ty = "libc::c_int", bits = "3..=3")]
    #[bitfield(name = "MMXExt", ty = "libc::c_int", bits = "4..=4")]
    #[bitfield(name = "CMOV", ty = "libc::c_int", bits = "5..=5")]
    #[bitfield(name = "AMD3DNow", ty = "libc::c_int", bits = "6..=6")]
    #[bitfield(name = "AMD3DNowExt", ty = "libc::c_int", bits = "7..=7")]
    #[bitfield(name = "SSE", ty = "libc::c_int", bits = "8..=8")]
    #[bitfield(name = "SSE2", ty = "libc::c_int", bits = "9..=9")]
    #[bitfield(name = "SSE3", ty = "libc::c_int", bits = "10..=10")]
    #[bitfield(name = "IA64", ty = "libc::c_int", bits = "11..=11")]
    #[bitfield(name = "AMD64", ty = "libc::c_int", bits = "12..=12")]
    #[bitfield(name = "AltiVec", ty = "libc::c_int", bits = "13..=13")]
    #[bitfield(name = "FPPE", ty = "libc::c_int", bits = "14..=14")]
    #[bitfield(name = "PFC", ty = "libc::c_int", bits = "15..=15")]
    #[bitfield(name = "cmpxchg", ty = "libc::c_int", bits = "16..=16")]
    #[bitfield(name = "cmpxchg16b", ty = "libc::c_int", bits = "17..=17")]
    #[bitfield(name = "cmp8xchg16", ty = "libc::c_int", bits = "18..=18")]
    #[bitfield(name = "FPE", ty = "libc::c_int", bits = "19..=19")]
    #[bitfield(name = "DEP", ty = "libc::c_int", bits = "20..=20")]
    #[bitfield(name = "PPCMM64", ty = "libc::c_int", bits = "21..=21")]
    #[bitfield(name = "ALPHAbyte", ty = "libc::c_int", bits = "22..=22")]
    #[bitfield(name = "PAE", ty = "libc::c_int", bits = "23..=23")]
    #[bitfield(name = "CPUs", ty = "libc::c_int", bits = "24..=31")]
    pub FPU_CPUID_RDTSC_MMX_MMXExt_CMOV_AMD3DNow_AMD3DNowExt_SSE_SSE2_SSE3_IA64_AMD64_AltiVec_FPPE_PFC_cmpxchg_cmpxchg16b_cmp8xchg16_FPE_DEP_PPCMM64_ALPHAbyte_PAE_CPUs: [u8; 4],
}
...
#[no_mangle]
pub static mut colfuncs: [Option::<unsafe extern "C" fn() -> ()>; 9] = [None; 9];
#[no_mangle]
pub static mut spanfunc: Option::<unsafe extern "C" fn() -> ()> = None;
#[no_mangle]
pub static mut spanfuncs: [Option::<unsafe extern "C" fn() -> ()>; 21] = [None; 21];
#[no_mangle]
pub static mut spanfuncs_npo2: [Option::<unsafe extern "C" fn() -> ()>; 21] = [None; 21];
#[no_mangle]
pub static mut vid: viddef_t = viddef_s {
    modenum: 0,
    buffer: 0 as *const uint8_t as *mut uint8_t,
    rowbytes: 0,
    width: 0,
    height: 0,
    u: C2RustUnnamed_3 { numpages: 0 },
    recalc: 0,
    direct: 0 as *const uint8_t as *mut uint8_t,
    dupx: 0,
    dupy: 0,
    fdupx: 0,
    fdupy: 0,
    bpp: 0,
    baseratio: 0,
    WndParent: 0 as *const libc::c_void as *mut libc::c_void,
    smalldupx: 0,
    smalldupy: 0,
    meddupx: 0,
    meddupy: 0,
...
#[no_mangle]
pub static mut setmodeneeded: int32_t = 0;
#[no_mangle]
pub static mut setrenderneeded: uint8_t = 0 as libc::c_int as uint8_t;
static mut scr_depth_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 8 as libc::c_int,
            strvalue: b"8 bits\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"16 bits\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"24 bits\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"32 bits\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_scr_width: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scr_width\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1280\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_scr_height: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scr_height\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"800\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_Unsigned.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_scr_width_w: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scr_width_w\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"640\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_Unsigned.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_scr_height_w: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scr_height_w\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"400\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_Unsigned.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_scr_depth: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scr_depth\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"16 bits\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: scr_depth_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_renderview: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"renderview\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_renderer_t: [CV_PossibleValue_t; 2] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Software\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_renderer: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"renderer\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Software\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: cv_renderer_t.as_ptr() as *mut _,
            func: Some(SCR_ChangeRenderer as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_fullscreen: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            ...
            func: Some(SCR_ChangeFullscreen as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut scr_bpp: int32_t = 0;
#[no_mangle]
pub static mut scr_borderpatch: *mut uint8_t = 0 as *const uint8_t as *mut uint8_t;
#[no_mangle]
pub static mut walldrawerfunc: Option::<unsafe extern "C" fn() -> ()> = None;
#[no_mangle]
pub static mut R_486: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_586: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_MMX: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_SSE: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_3DNow: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_MMXExt: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut R_SSE2: boolean = false_0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn SCR_SetDrawFuncs() {
    if true_0 as libc::c_int != 0 {
        colfuncs[0 as libc::c_int
            as usize] = Some(R_DrawColumn_8 as unsafe extern "C" fn() -> ());
        spanfuncs[0 as libc::c_int
            as usize] = Some(R_DrawSpan_8 as unsafe extern "C" fn() -> ());
        colfunc = colfuncs[0 as libc::c_int as usize];
        spanfunc = spanfuncs[0 as libc::c_int as usize];
        colfuncs[COLDRAWFUNC_FUZZY as libc::c_int
            as usize] = Some(R_DrawTranslucentColumn_8 as unsafe extern "C" fn() -> ());
        colfuncs[COLDRAWFUNC_TRANS as libc::c_int
            as usize] = Some(R_DrawTranslatedColumn_8 as unsafe extern "C" fn() -> ());
        colfuncs[COLDRAWFUNC_SHADE as libc::c_int
            as usize] = Some(R_DrawShadeColumn_8 as unsafe extern "C" fn() -> ());
        colfuncs[COLDRAWFUNC_SHADOWED as libc::c_int
            as usize] = Some(R_DrawColumnShadowed_8 as unsafe extern "C" fn() -> ());
        colfuncs[COLDRAWFUNC_TRANSTRANS as libc::c_int
            as usize] = Some(
            R_DrawTranslatedTranslucentColumn_8 as unsafe extern "C" fn() -> (),
        );
        colfuncs[COLDRAWFUNC_TWOSMULTIPATCH as libc::c_int
            as usize] = Some(R_Draw2sMultiPatchColumn_8 as unsafe extern "C" fn() -> ());
        colfuncs[COLDRAWFUNC_TWOSMULTIPATCHTRANS as libc::c_int
            as usize] = Some(
            R_Draw2sMultiPatchTranslucentColumn_8 as unsafe extern "C" fn() -> (),
        );
        colfuncs[COLDRAWFUNC_FOG as libc::c_int
            as usize] = Some(R_DrawFogColumn_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TRANS as libc::c_int
            as usize] = Some(R_DrawTranslucentSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTED as libc::c_int
            as usize] = Some(R_DrawTiltedSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTEDTRANS as libc::c_int
            as usize] = Some(
            R_DrawTiltedTranslucentSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_SPLAT as libc::c_int
            as usize] = Some(R_DrawSplat_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TRANSSPLAT as libc::c_int
            as usize] = Some(R_DrawTranslucentSplat_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTEDSPLAT as libc::c_int
            as usize] = Some(R_DrawTiltedSplat_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_SPRITE as libc::c_int
            as usize] = Some(R_DrawFloorSprite_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TRANSSPRITE as libc::c_int
            as usize] = Some(
            R_DrawTranslucentFloorSprite_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_TILTEDSPRITE as libc::c_int
            as usize] = Some(R_DrawTiltedFloorSprite_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTEDTRANSSPRITE as libc::c_int
            as usize] = Some(
            R_DrawTiltedTranslucentFloorSprite_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_WATER as libc::c_int
            as usize] = Some(R_DrawWaterSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTEDWATER as libc::c_int
            as usize] = Some(R_DrawTiltedWaterSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_SOLID as libc::c_int
            as usize] = Some(R_DrawSolidColorSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TRANSSOLID as libc::c_int
            as usize] = Some(
            R_DrawTransSolidColorSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_TILTEDSOLID as libc::c_int
            as usize] = Some(
            R_DrawTiltedSolidColorSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_TILTEDTRANSSOLID as libc::c_int
            as usize] = Some(
            R_DrawTiltedTransSolidColorSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_WATERSOLID as libc::c_int
            as usize] = Some(
            R_DrawWaterSolidColorSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_TILTEDWATERSOLID as libc::c_int
            as usize] = Some(
            R_DrawTiltedWaterSolidColorSpan_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs[SPANDRAWFUNC_FOG as libc::c_int
            as usize] = Some(R_DrawFogSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs[SPANDRAWFUNC_TILTEDFOG as libc::c_int
            as usize] = Some(R_DrawTiltedFogSpan_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[0 as libc::c_int
            as usize] = Some(R_DrawSpan_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_TRANS as libc::c_int
            as usize] = Some(
            R_DrawTranslucentSpan_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_TILTED as libc::c_int
            as usize] = Some(R_DrawTiltedSpan_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_TILTEDTRANS as libc::c_int
            as usize] = Some(
            R_DrawTiltedTranslucentSpan_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_SPLAT as libc::c_int
            as usize] = Some(R_DrawSplat_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_TRANSSPLAT as libc::c_int
            as usize] = Some(
            R_DrawTranslucentSplat_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_TILTEDSPLAT as libc::c_int
            as usize] = Some(R_DrawTiltedSplat_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_SPRITE as libc::c_int
            as usize] = Some(R_DrawFloorSprite_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_TRANSSPRITE as libc::c_int
            as usize] = Some(
            R_DrawTranslucentFloorSprite_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_TILTEDSPRITE as libc::c_int
            as usize] = Some(
            R_DrawTiltedFloorSprite_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_TILTEDTRANSSPRITE as libc::c_int
            as usize] = Some(
            R_DrawTiltedTranslucentFloorSprite_NPO2_8 as unsafe extern "C" fn() -> (),
        );
        spanfuncs_npo2[SPANDRAWFUNC_WATER as libc::c_int
            as usize] = Some(R_DrawWaterSpan_NPO2_8 as unsafe extern "C" fn() -> ());
        spanfuncs_npo2[SPANDRAWFUNC_TILTEDWATER as libc::c_int
            as usize] = Some(
            R_DrawTiltedWaterSpan_NPO2_8 as unsafe extern "C" fn() -> (),
        );
    } else {
        I_Error(
            b"unknown bytes per pixel mode %d\n\0" as *const u8 as *const libc::c_char,
            vid.bpp,
        );
    };
}
#[no_mangle]
pub unsafe extern "C" fn SCR_SetMode() {
    if dedicated != 0 {
        return;
    }
    if !(setmodeneeded != 0 || setrenderneeded as libc::c_int != 0) || WipeInAction != 0
    {
        return;
    }
    if setrenderneeded != 0 {
        if setrenderneeded as libc::c_int != 0
            && moviemode as libc::c_uint == MM_APNG as libc::c_int as libc::c_uint
        {
            M_StopMovie();
        }
        if setmodeneeded == 0 {
        ...
        vid.recalc = 1 as libc::c_int;
    }
    if setmodeneeded != 0 {
        VID_SetMode(setmodeneeded - 1 as libc::c_int);
    }
    V_SetPalette(0 as libc::c_int);
    SCR_SetDrawFuncs();
    setmodeneeded = 0 as libc::c_int;
    setrenderneeded = 0 as libc::c_int as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn SCR_Startup() {
    let mut RCpuInfo: *const CPUInfoFlags = I_CPUInfo();
    if M_CheckParm(b"-NOCPUID\0" as *const u8 as *const libc::c_char) == 0
        && !RCpuInfo.is_null()
    {
        if (*RCpuInfo).RDTSC() != 0 {
            R_586 = true_0 as libc::c_int;
        }
        if (*RCpuInfo).MMX() != 0 {
            R_MMX = true_0 as libc::c_int;
        }
        if (*RCpuInfo).AMD3DNow() != 0 {
            R_3DNow = true_0 as libc::c_int;
        }
        if (*RCpuInfo).MMXExt() != 0 {
            R_MMXExt = true_0 as libc::c_int;
        }
        if (*RCpuInfo).SSE() != 0 {
            R_SSE = true_0 as libc::c_int;
        }
        if (*RCpuInfo).SSE2() != 0 {
            R_SSE2 = true_0 as libc::c_int;
        }
        CONS_Printf(
            b"CPU Info: 486: %i, 586: %i, MMX: %i, 3DNow: %i, MMXExt: %i, SSE2: %i\n\0"
    ...
    if M_CheckParm(b"-486\0" as *const u8 as *const libc::c_char) != 0 {
        R_486 = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-586\0" as *const u8 as *const libc::c_char) != 0 {
        R_586 = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-MMX\0" as *const u8 as *const libc::c_char) != 0 {
        R_MMX = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-3DNow\0" as *const u8 as *const libc::c_char) != 0 {
        R_3DNow = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-MMXExt\0" as *const u8 as *const libc::c_char) != 0 {
        R_MMXExt = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-SSE\0" as *const u8 as *const libc::c_char) != 0 {
        R_SSE = true_0 as libc::c_int;
    }
    if M_CheckParm(b"-noSSE\0" as *const u8 as *const libc::c_char) != 0 {
        R_SSE = false_0 as libc::c_int;
    }
    if M_CheckParm(b"-SSE2\0" as *const u8 as *const libc::c_char) != 0 {
        R_SSE2 = true_0 as libc::c_int;
    }
    M_SetupMemcpy();
    if dedicated != 0 {
    ...
    vid.modenum = 0 as libc::c_int;
    V_Init();
    V_Recalc();
    CV_RegisterVar(&mut cv_ticrate);
    CV_RegisterVar(&mut cv_constextsize);
    V_SetPalette(0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn SCR_Recalc() {
    if dedicated != 0 {
        return;
    }
    scr_bpp = vid.bpp;
...
#[no_mangle]
pub unsafe extern "C" fn SCR_CheckDefaultMode() {
    let mut scr_forcex: int32_t = 0;
    let mut scr_forcey: int32_t = 0;
    if dedicated != 0 {
        return;
    }
    scr_forcey = 0 as libc::c_int;
    scr_forcex = scr_forcey;
    if M_CheckParm(b"-width\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        scr_forcex = atoi(M_GetNextParm());
    }
    if M_CheckParm(b"-height\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        scr_forcey = atoi(M_GetNextParm());
    }
    if scr_forcex != 0 && scr_forcey != 0 {
        CONS_Printf(
            b"Using resolution: %d x %d\n\0" as *const u8 as *const libc::c_char,
            scr_forcex,
            scr_forcey,
        );
        setmodeneeded = VID_GetModeForSize(scr_forcex, scr_forcey) + 1 as libc::c_int;
    } else {
        CONS_Printf(
            b"Default resolution: %d x %d\n\0" as *const u8 as *const libc::c_char,
            cv_scr_width.value,
            cv_scr_height.value,
        );
        CONS_Printf(
            b"Windowed resolution: %d x %d\n\0" as *const u8 as *const libc::c_char,
            cv_scr_width_w.value,
            cv_scr_height_w.value,
        );
        CONS_Printf(
            b"Default bit depth: %d bits\n\0" as *const u8 as *const libc::c_char,
            cv_scr_depth.value,
        );
        ...
        if setmodeneeded <= 0 as libc::c_int {
            CONS_Alert(
                CONS_WARNING,
                b"Invalid resolution given, defaulting to base resolution\n\0"
                    as *const u8 as *const libc::c_char,
            );
        }
    }
    if cv_renderer.value != rendermode as libc::c_int {
        if chosenrendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint
        {
            SCR_ChangeRenderer();
        } else {
            CV_StealthSetValue(&mut cv_renderer, rendermode as int32_t);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn SCR_SetDefaultMode() {
    CV_SetValue(
        if cv_fullscreen.value != 0 { &mut cv_scr_width } else { &mut cv_scr_width_w },
        vid.width,
    );
    CV_SetValue(
        if cv_fullscreen.value != 0 { &mut cv_scr_height } else { &mut cv_scr_height_w },
        vid.height,
    );
}
unsafe extern "C" fn SCR_ChangeFullscreen() {}
#[no_mangle]
pub unsafe extern "C" fn SCR_ChangeRenderer() {
    if chosenrendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint
        || rendermode as libc::c_int == cv_renderer.value
    {
        return;
    }
    setrenderneeded = cv_renderer.value as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn SCR_IsAspectCorrect(
    mut width: int32_t,
    mut height: int32_t,
) -> boolean {
    return (width % 320 as libc::c_int == 0 as libc::c_int
        && height % 200 as libc::c_int == 0 as libc::c_int
        && width / 320 as libc::c_int == height / 200 as libc::c_int) as libc::c_int;
}
#[no_mangle]
pub static mut averageFPS: libc::c_double = 0.0f32 as libc::c_double;
static mut total_frame_time: libc::c_double = 0.0f64;
static mut frame_index: libc::c_int = 0;
static mut fps_init: boolean = false_0 as libc::c_int;
static mut fps_enter: precise_t = 0 as libc::c_int as precise_t;
#[no_mangle]
pub unsafe extern "C" fn SCR_CalculateFPS() {
    let mut fps_finish: precise_t = 0 as libc::c_int as precise_t;
    let mut frameElapsed: libc::c_double = 0.0f64;
    if fps_init == false_0 as libc::c_int {
        fps_enter = I_GetPreciseTime();
        fps_init = true_0 as libc::c_int;
    }
    fps_finish = I_GetPreciseTime();
    frameElapsed = fps_finish.wrapping_sub(fps_enter) as int64_t as libc::c_double
        / I_GetPrecisePrecision() as libc::c_double;
    fps_enter = fps_finish;
    total_frame_time += frameElapsed;
    let fresh0 = frame_index;
    frame_index = frame_index + 1;
    if fresh0 >= 16 as libc::c_int || total_frame_time >= 0.05f64 {
        averageFPS = 1.0f64 / (total_frame_time / frame_index as libc::c_double);
        total_frame_time = 0.0f64;
        frame_index = 0 as libc::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn SCR_DisplayTicRate() {
    let mut ticcntcolor: int32_t = 0 as libc::c_int;
    let h: int32_t = vid.height - 8 as libc::c_int * vid.dupy;
    let mut cap: uint32_t = R_GetFramerateCap();
    let mut fps: libc::c_double = round(averageFPS);
    if gamestate as libc::c_uint == GS_NULL as libc::c_int as libc::c_uint {
        return;
    }
    if cap > 0 as libc::c_int as uint32_t {
        if fps <= cap as libc::c_double / 2.0f64 {
            ticcntcolor = 0x5000 as libc::c_int;
        } else if fps <= cap as libc::c_double * 0.90f64 {
            ticcntcolor = 0x2000 as libc::c_int;
        } else {
            ticcntcolor = 0x3000 as libc::c_int;
        }
    } else {
        ticcntcolor = 0x3000 as libc::c_int;
    }
    if cv_ticrate.value == 2 as libc::c_int {
        V_DrawRightAlignedString(
            vid.width,
            h,
            ticcntcolor | 0x40000000 as libc::c_int
                | 10 as libc::c_int - cv_translucenthud.value << 16 as libc::c_int,
            va(b"%04.2f\0" as *const u8 as *const libc::c_char, averageFPS),
        );
    } else if cv_ticrate.value == 1 as libc::c_int {
        let mut drawnstr: *const libc::c_char = 0 as *const libc::c_char;
        let mut width: int32_t = 0;
        if cap > 0 as libc::c_int as uint32_t {
            drawnstr = va(b"%3.0f/%3u\0" as *const u8 as *const libc::c_char, fps, cap);
        } else {
            drawnstr = va(b"%4.2f\0" as *const u8 as *const libc::c_char, averageFPS);
        }
        width = V_StringWidth(drawnstr, 0x40000000 as libc::c_int);
        V_DrawString(
            vid.width
                - (7 as libc::c_int * 8 as libc::c_int * vid.dupx
                    + V_StringWidth(
...
#[no_mangle]
pub unsafe extern "C" fn SCR_DisplayLocalPing() {
    let mut ping: uint32_t = playerpingtable[consoleplayer as usize];
    if cv_showping.value == 1 as libc::c_int
        || cv_showping.value == 2 as libc::c_int && servermaxping != 0
            && ping > servermaxping
    {
        let mut dispy: int32_t = if cv_ticrate.value != 0 {
            180 as libc::c_int
        } else {
            189 as libc::c_int
        };
        HU_drawPing(
            ...
            0x8000000 as libc::c_int | 0x2000000 as libc::c_int,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn SCR_ClosedCaptions() {
    let mut i: uint8_t = 0;
    let mut gamestopped: boolean = (paused as libc::c_int != 0 || P_AutoPause() != 0)
        as libc::c_int;
    let mut basey: int32_t = 200 as libc::c_int;
    ...
    if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint {
        if promptactive != 0 {
            basey -= 42 as libc::c_int;
        } else if splitscreen != 0 {
            basey -= 8 as libc::c_int;
            ...
            || maptol & TOL_NIGHTS as libc::c_int as uint32_t == 0
                && (cv_powerupdisplay.value == 2 as libc::c_int
                    || cv_powerupdisplay.value == 1 as libc::c_int && camera.chase == 0)
        {
            basey -= 16 as libc::c_int;
        }
    }
    ...
    while (i as libc::c_int) < 8 as libc::c_int {
        ...
        let mut y: int32_t = 0;
        let mut dot: libc::c_char = 0;
        let mut music: boolean = 0;
        if !(closedcaptions[i as usize].s).is_null() {
            music = ((closedcaptions[i as usize].s).offset_from(S_sfx.as_mut_ptr())
                as libc::c_long == sfx_None as libc::c_int as libc::c_long)
                as libc::c_int;
            if !(music != 0 && gamestopped == 0
                && (closedcaptions[i as usize].t as libc::c_int)
                    < flashingtics as libc::c_int
                && closedcaptions[i as usize].t as libc::c_int & 1 as libc::c_int != 0)
            {
                flags = 0x8000000 as libc::c_int | 0x2000000 as libc::c_int
                    | 0x800000 as libc::c_int;
                y = basey - (i as libc::c_int + 2 as libc::c_int) * 10 as libc::c_int;
                if closedcaptions[i as usize].b != 0 {
                    y -= closedcaptions[i as usize].b as libc::c_int * vid.dupy;
                    if renderisnewtic != 0 {
                        closedcaptions[i as usize]
                            .b = (closedcaptions[i as usize].b).wrapping_sub(1);
                        closedcaptions[i as usize].b;
                    }
                }
                if (closedcaptions[i as usize].t as libc::c_int) < 20 as libc::c_int {
                    flags
                        |= (20 as libc::c_int
                            - closedcaptions[i as usize].t as libc::c_int)
                            / 2 as libc::c_int * 0x10000 as libc::c_int;
                }
                if music != 0 {
                    dot = '\u{19}' as i32 as libc::c_char;
                } else if !(closedcaptions[i as usize].c).is_null()
                    && !((*closedcaptions[i as usize].c).origin).is_null()
                {
                    dot = '\u{1e}' as i32 as libc::c_char;
                } else {
                    dot = ' ' as i32 as libc::c_char;
                }
                V_DrawRightAlignedString(
                    320 as libc::c_int - 20 as libc::c_int,
                    y,
                    flags,
                    va(
                        b"%c [%s]\0" as *const u8 as *const libc::c_char,
                        dot as libc::c_int,
                        if (*closedcaptions[i as usize].s)
                            .caption[0 as libc::c_int as usize] as libc::c_int != 0
                        {
                            ((*closedcaptions[i as usize].s).caption).as_mut_ptr()
                                as *const libc::c_char
                        } else {
                            (*closedcaptions[i as usize].s).name
                        },
                    ),
                );
            }
...
#[no_mangle]
pub unsafe extern "C" fn SCR_DisplayMarathonInfo() {
    let mut flags: int32_t = 0x2000000 as libc::c_int;
    static mut entertic: tic_t = 0;
    static mut oldentertics: tic_t = 0 as libc::c_int as tic_t;
    static mut antisplice: [tic_t; 2] = [
        48 as libc::c_int as tic_t,
    ...
    } else if !(marathonmode as libc::c_uint & MA_INGAME as libc::c_int as libc::c_uint
        != 0)
    {
        if marathonmode as libc::c_uint & MA_INIT as libc::c_int as libc::c_uint != 0 {
            marathonmode = ::core::mem::transmute::<
                libc::c_uint,
                marathonmode_t,
            >(marathonmode as libc::c_uint & !(MA_INIT as libc::c_int) as libc::c_uint);
        } else {
            marathontime = marathontime
                .wrapping_add(entertic.wrapping_sub(oldentertics));
        }
    }
    antisplice[0 as libc::c_int
        as usize] = (antisplice[0 as libc::c_int as usize])
        .wrapping_add(entertic.wrapping_sub(oldentertics) * 17 as libc::c_int as tic_t);
    antisplice[0 as libc::c_int
        as usize] = antisplice[0 as libc::c_int as usize]
        % (13 as libc::c_int * (vid.width / vid.dupx + 1 as libc::c_int)) as tic_t;
    antisplice[1 as libc::c_int
        as usize] = (antisplice[1 as libc::c_int as usize])
        .wrapping_add(entertic.wrapping_sub(oldentertics) * 13 as libc::c_int as tic_t);
    antisplice[1 as libc::c_int
        as usize] = antisplice[1 as libc::c_int as usize]
        % (13 as libc::c_int * (vid.width / vid.dupx + 1 as libc::c_int)) as tic_t;
    str = va(
        ...
        G_TicsToMinutes(marathontime, false_0 as libc::c_int),
        G_TicsToSeconds(marathontime),
        G_TicsToCentiseconds(marathontime),
    );
    oldentertics = entertic;
    V_DrawFill(
        (antisplice[0 as libc::c_int as usize] / 13 as libc::c_int as tic_t)
            .wrapping_sub(1 as libc::c_int as tic_t) as int32_t,
        200 as libc::c_int - 8 as libc::c_int,
        1 as libc::c_int,
        8 as libc::c_int,
        0x2000000 as libc::c_int | 0x4000000 as libc::c_int,
    );
    V_DrawFill(
        (antisplice[0 as libc::c_int as usize] / 13 as libc::c_int as tic_t) as int32_t,
        200 as libc::c_int - 8 as libc::c_int,
        1 as libc::c_int,
        8 as libc::c_int,
        0x2000000 as libc::c_int | 0x4000000 as libc::c_int | 31 as libc::c_int,
    );
    V_DrawFill(
        (320 as libc::c_int as tic_t)
            .wrapping_sub(
                (antisplice[1 as libc::c_int as usize] / 13 as libc::c_int as tic_t)
    ...
    V_DrawFill(
        ...
        1 as libc::c_int,
        8 as libc::c_int,
        0x2000000 as libc::c_int | 0x8000000 as libc::c_int | 31 as libc::c_int,
    );
    V_DrawPromptBack(-(8 as libc::c_int), cons_backcolor.value);
