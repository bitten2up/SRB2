...
extern "C" {
    ...
    static mut highcolor: boolean;
    fn P_InitPicAnims();
    static mut extra_colormaps: *mut extracolormap_t;
    static mut numsprites: size_t;
    static mut sprites: *mut spritedef_t;
    static mut numsides: size_t;
    static mut sides: *mut side_t;
    fn P_PrecacheLevelFlats() -> size_t;
    ...
    fn R_GenerateTexture(texnum: size_t) -> *mut uint8_t;
    static mut texturecache: *mut *mut uint8_t;
...
pub const SRF_NONE: C2RustUnnamed_0 = 255;
pub const SRF_2D: C2RustUnnamed_0 = 12;
pub const SRF_RIGHT: C2RustUnnamed_0 = 8;
pub const SRF_LEFT: C2RustUnnamed_0 = 4;
pub const SRF_3DMASK: C2RustUnnamed_0 = 3;
pub const SRF_3DGE: C2RustUnnamed_0 = 2;
pub const SRF_3D: C2RustUnnamed_0 = 1;
pub const SRF_SINGLE: C2RustUnnamed_0 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const THINK_MOBJ: C2RustUnnamed_1 = 2;
pub type C2RustUnnamed_1 = libc::c_uint;
pub const NUM_THINKERLISTS: C2RustUnnamed_1 = 5;
pub const THINK_PRECIP: C2RustUnnamed_1 = 4;
pub const THINK_DYNSLOPE: C2RustUnnamed_1 = 3;
pub const THINK_MAIN: C2RustUnnamed_1 = 1;
pub const THINK_POLYOBJ: C2RustUnnamed_1 = 0;
...
#[no_mangle]
pub static mut numspritelumps: size_t = 0;
#[no_mangle]
pub static mut max_spritelumps: size_t = 0;
#[no_mangle]
pub static mut spritecachedinfo: *mut sprcache_t = 0 as *const sprcache_t
    as *mut sprcache_t;
#[no_mangle]
pub static mut colormaps: *mut lighttable_t = 0 as *const lighttable_t
    as *mut lighttable_t;
#[no_mangle]
pub static mut fadecolormap: *mut lighttable_t = 0 as *const lighttable_t
    as *mut lighttable_t;
#[no_mangle]
pub static mut flatmemory: size_t = 0;
#[no_mangle]
pub static mut spritememory: size_t = 0;
#[no_mangle]
pub static mut texturememory: size_t = 0;
#[no_mangle]
pub static mut color8to16: [int16_t; 256] = [0; 256];
#[no_mangle]
pub static mut hicolormaps: *mut int16_t = 0 as *const int16_t as *mut int16_t;
#[no_mangle]
pub unsafe extern "C" fn ASTBlendPixel(
    mut background: RGBA_t,
    mut foreground: RGBA_t,
    mut style: libc::c_int,
    mut alpha: uint8_t,
) -> uint32_t {
    let mut output: RGBA_t = FColorRGBA { rgba: 0 };
    let mut fullalpha: int16_t = (alpha as libc::c_int
        - (0xff as libc::c_int - foreground.s.alpha as libc::c_int)) as int16_t;
    if style == AST_TRANSLUCENT as libc::c_int {
        if fullalpha as libc::c_int <= 0 as libc::c_int {
            output.rgba = background.rgba;
        } else {
            if fullalpha as libc::c_int >= 0xff as libc::c_int {
                fullalpha = 0xff as libc::c_int as int16_t;
            }
            alpha = fullalpha as uint8_t;
            if background.s.alpha == 0 {
                if alpha as libc::c_int == 0xff as libc::c_int {
                    output.rgba = foreground.rgba;
                } else {
                    output.rgba = 0 as libc::c_int as uint32_t;
                }
            } else {
                let mut beta: uint8_t = (0xff as libc::c_int - alpha as libc::c_int)
                    as uint8_t;
                output
                    .s
                    .red = ((background.s.red as libc::c_int * beta as libc::c_int
                    + foreground.s.red as libc::c_int * alpha as libc::c_int)
                    / 0xff as libc::c_int) as uint8_t;
                output
                    .s
                    .green = ((background.s.green as libc::c_int * beta as libc::c_int
                    + foreground.s.green as libc::c_int * alpha as libc::c_int)
                    / 0xff as libc::c_int) as uint8_t;
                output
                    .s
                    .blue = ((background.s.blue as libc::c_int * beta as libc::c_int
                    + foreground.s.blue as libc::c_int * alpha as libc::c_int)
                    / 0xff as libc::c_int) as uint8_t;
                output.s.alpha = 0xff as libc::c_int as uint8_t;
            }
        }
        return output.rgba;
    } else {
        let mut falpha: libc::c_float = alpha as libc::c_float / 256.0f32;
        let mut fr: libc::c_float = foreground.s.red as libc::c_float * falpha;
        let mut fg: libc::c_float = foreground.s.green as libc::c_float * falpha;
        let mut fb: libc::c_float = foreground.s.blue as libc::c_float * falpha;
        if style == AST_ADD as libc::c_int {
            output
                .s
                .red = (if (if ((background.s.red as libc::c_int as libc::c_float + fr)
                as libc::c_int) < 0xff as libc::c_int
            {
                (background.s.red as libc::c_int as libc::c_float + fr) as libc::c_int
            } else {
                0xff as libc::c_int
            }) > 0 as libc::c_int
            {
                if ((background.s.red as libc::c_int as libc::c_float + fr)
                    as libc::c_int) < 0xff as libc::c_int
                {
                    (background.s.red as libc::c_int as libc::c_float + fr)
                        as libc::c_int
                } else {
                    0xff as libc::c_int
                }
            ...
            output
                .s
                .green = (if (if ((background.s.green as libc::c_int as libc::c_float
                + fg) as libc::c_int) < 0xff as libc::c_int
            {
                (background.s.green as libc::c_int as libc::c_float + fg) as libc::c_int
            } else {
                0xff as libc::c_int
            }) > 0 as libc::c_int
            {
                if ((background.s.green as libc::c_int as libc::c_float + fg)
                    as libc::c_int) < 0xff as libc::c_int
                {
                    (background.s.green as libc::c_int as libc::c_float + fg)
                        as libc::c_int
                } else {
                    0xff as libc::c_int
                }
            ...
            output
                .s
                .blue = (if (if ((background.s.blue as libc::c_int as libc::c_float + fb)
                as libc::c_int) < 0xff as libc::c_int
            {
                (background.s.blue as libc::c_int as libc::c_float + fb) as libc::c_int
            } else {
                0xff as libc::c_int
            }) > 0 as libc::c_int
            {
                if ((background.s.blue as libc::c_int as libc::c_float + fb)
                    as libc::c_int) < 0xff as libc::c_int
                {
                    (background.s.blue as libc::c_int as libc::c_float + fb)
                        as libc::c_int
                } else {
                    0xff as libc::c_int
                }
        ...
        } else if style == AST_SUBTRACT as libc::c_int {
            output
                .s
                .red = (if (if ((background.s.red as libc::c_int as libc::c_float - fr)
                as libc::c_int) < 0xff as libc::c_int
        ...
        } else if style == AST_REVERSESUBTRACT as libc::c_int {
            output
                .s
                .red = (if (if ((-(background.s.red as libc::c_int) as libc::c_float
                + fr) as libc::c_int) < 0xff as libc::c_int
            {
                (-(background.s.red as libc::c_int) as libc::c_float + fr) as libc::c_int
            } else {
                0xff as libc::c_int
            ...
            output
                .s
                .blue = (if (if ((-(background.s.blue as libc::c_int) as libc::c_float
                + fb) as libc::c_int) < 0xff as libc::c_int
            {
                (-(background.s.blue as libc::c_int) as libc::c_float + fb)
                    as libc::c_int
            } else {
        ...
        } else if style == AST_MODULATE as libc::c_int {
            fr = foreground.s.red as libc::c_float / 256.0f32;
            fg = foreground.s.green as libc::c_float / 256.0f32;
            fb = foreground.s.blue as libc::c_float / 256.0f32;
            output
                .s
                .red = (if (if ((background.s.red as libc::c_int as libc::c_float * fr)
                as libc::c_int) < 0xff as libc::c_int
        ...
        } else if style == AST_COPY as libc::c_int {
            output.rgba = foreground.rgba;
        }
        output.s.alpha = 0xff as libc::c_int as uint8_t;
        return output.rgba;
...
#[no_mangle]
pub static mut ASTTextureBlendingThreshold: [int32_t; 2] = [
    255 as libc::c_int / 11 as libc::c_int,
    10 as libc::c_int * 255 as libc::c_int / 11 as libc::c_int,
];
#[no_mangle]
pub unsafe extern "C" fn ASTBlendTexturePixel(
    mut background: RGBA_t,
    mut foreground: RGBA_t,
    mut style: libc::c_int,
    mut alpha: uint8_t,
    ...
    if style == AST_TRANSLUCENT as libc::c_int {
        if alpha as libc::c_int <= ASTTextureBlendingThreshold[1 as libc::c_int as usize]
        {
            if (alpha as libc::c_int)
                < ASTTextureBlendingThreshold[0 as libc::c_int as usize]
            {
...
#[no_mangle]
pub unsafe extern "C" fn ASTBlendPaletteIndexes(
    mut background: uint8_t,
    mut foreground: uint8_t,
    mut style: libc::c_int,
    mut alpha: uint8_t,
) -> uint8_t {
    if style == AST_TRANSLUCENT as libc::c_int {
        if alpha as libc::c_int <= ASTTextureBlendingThreshold[1 as libc::c_int as usize]
        {
            let mut mytransmap: *mut uint8_t = 0 as *mut uint8_t;
            ...
            trans = (8 as libc::c_int * alpha as libc::c_int
                + 255 as libc::c_int / 8 as libc::c_int)
                / (255 as libc::c_int - 255 as libc::c_int / 11 as libc::c_int);
            mytransmap = R_GetTranslucencyTable(trans + 1 as libc::c_int);
            if background as libc::c_int != 0xff as libc::c_int {
                return *mytransmap
                    .offset(((background as libc::c_int) << 8 as libc::c_int) as isize)
                    .offset(foreground as libc::c_int as isize);
            }
        } else {
            return foreground
        }
        ...
        return foreground
    } else if style != AST_TRANSLUCENT as libc::c_int {
        let mut texel: RGBA_t = FColorRGBA { rgba: 0 };
        let mut bg: RGBA_t = *pMasterPalette
            .offset((background as libc::c_int & 0xff as libc::c_int) as isize);
        let mut fg: RGBA_t = *pMasterPalette
            .offset((foreground as libc::c_int & 0xff as libc::c_int) as isize);
...
unsafe extern "C" fn R_InitSpriteLumps() {
    numspritelumps = 0 as libc::c_int as size_t;
    max_spritelumps = 8192 as libc::c_int as size_t;
    Z_MallocAlign(
        max_spritelumps
            .wrapping_mul(::core::mem::size_of::<sprcache_t>() as libc::c_ulong),
        PU_STATIC as libc::c_int,
        &mut spritecachedinfo as *mut *mut sprcache_t as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    );
}
unsafe extern "C" fn R_CreateFadeColormaps() {
    let mut px: uint8_t = 0;
    let mut fade: uint8_t = 0;
    let mut rgba: RGBA_t = FColorRGBA { rgba: 0 };
    let mut r: int32_t = 0;
    let mut g: int32_t = 0;
    let mut b: int32_t = 0;
    let mut len: size_t = 0;
    let mut i: size_t = 0;
    len = (256 as libc::c_int * (256 as libc::c_int / 8 as libc::c_int)) as size_t;
    fadecolormap = Z_MallocAlign(
    ...
    while i < len * 2 as libc::c_int as size_t {
        *fadecolormap
            .offset(i as isize) = (i % 256 as libc::c_int as size_t) as lighttable_t;
        i = i.wrapping_add(1);
        i;
    }
    let mut lump: lumpnum_t = W_CheckNumForName(
        b"FADECMAP\0" as *const u8 as *const libc::c_char,
    );
    let mut wlump: lumpnum_t = W_CheckNumForName(
        b"FADEWMAP\0" as *const u8 as *const libc::c_char,
    );
    if lump != 4294967295 as libc::c_uint {
        W_ReadLumpHeader(
            lump,
            fadecolormap as *mut libc::c_void,
            len,
            0 as libc::c_uint as size_t,
        );
    }
    if wlump != 4294967295 as libc::c_uint {
        W_ReadLumpHeader(
            wlump,
            fadecolormap.offset(len as isize) as *mut libc::c_void,
            len,
            0 as libc::c_uint as size_t,
        );
    }
    if !(lump != 4294967295 as libc::c_uint && wlump == 4294967295 as libc::c_uint) {
        if !(lump == 4294967295 as libc::c_uint && wlump != 4294967295 as libc::c_uint) {
            if lump != 4294967295 as libc::c_uint && wlump != 4294967295 as libc::c_uint
            {
                return;
        ...
        i = 0 as libc::c_int as size_t;
        while i < len {
            px = *colormaps.offset((i % 256 as libc::c_int as size_t) as isize);
            fade = (i / 256 as libc::c_int as size_t
                * (256 as libc::c_int / (256 as libc::c_int / 8 as libc::c_int))
                    as size_t) as uint8_t;
            rgba = *pMasterPalette
                .offset((px as libc::c_int & 0xff as libc::c_int) as isize);
            r = rgba.s.red as libc::c_int
                - 15 as libc::c_int * fade as libc::c_int / 10 as libc::c_int;
            g = rgba.s.green as libc::c_int
                - 15 as libc::c_int * fade as libc::c_int / 10 as libc::c_int;
            b = rgba.s.blue as libc::c_int
                - 10 as libc::c_int * fade as libc::c_int / 10 as libc::c_int;
    ...
    while i < len * 2 as libc::c_int as size_t {
        px = *colormaps.offset((i % 256 as libc::c_int as size_t) as isize);
        fade = (i / 256 as libc::c_int as size_t
            * (256 as libc::c_int / (256 as libc::c_int / 8 as libc::c_int)) as size_t)
            as uint8_t;
        rgba = *pMasterPalette
            .offset((px as libc::c_int & 0xff as libc::c_int) as isize);
        r = rgba.s.red as libc::c_int
...
unsafe extern "C" fn R_InitColormaps() {
    let mut len: size_t = 0;
    let mut lump: lumpnum_t = 0;
    lump = W_GetNumForName(b"COLORMAP\0" as *const u8 as *const libc::c_char);
    ...
    W_ReadLump(lump, colormaps as *mut libc::c_void);
    R_CreateFadeColormaps();
    R_ClearColormaps();
}
#[no_mangle]
pub unsafe extern "C" fn R_ReInitColormaps(mut num: uint16_t) {
    let mut colormap: [libc::c_char; 9] = *::core::mem::transmute::<
        &[u8; 9],
        &mut [libc::c_char; 9],
    >(b"COLORMAP\0");
    let mut lump: lumpnum_t = 0;
    let basecolormaplump: lumpnum_t = W_GetNumForName(colormap.as_mut_ptr());
        ...
        && num as libc::c_int <= 10000 as libc::c_int
    {
        snprintf(
            ...
            b"CLM%04u\0" as *const u8 as *const libc::c_char,
            num as libc::c_int - 1 as libc::c_int,
        );
    }
    lump = W_GetNumForName(colormap.as_mut_ptr());
    if lump == 4294967295 as libc::c_uint {
        lump = basecolormaplump;
    } else if W_LumpLength(lump) != W_LumpLength(basecolormaplump) {
        CONS_Alert(
            CONS_WARNING,
            b"%s lump size does not match COLORMAP, results may be unexpected.\n\0"
    ...
    W_ReadLumpHeader(
        lump,
        colormaps as *mut libc::c_void,
        W_LumpLength(basecolormaplump),
        0 as libc::c_uint as size_t,
    );
    if !fadecolormap.is_null() {
        Z_Free(fadecolormap as *mut libc::c_void);
    }
    R_CreateFadeColormaps();
    R_ClearColormaps();
}
#[no_mangle]
pub unsafe extern "C" fn R_ClearColormaps() {
    extra_colormaps = R_CreateDefaultColormap(true_0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn R_CreateDefaultColormap(
    mut lighttable: boolean,
) -> *mut extracolormap_t {
    let mut exc: *mut extracolormap_t = Z_CallocAlign(
        ::core::mem::size_of::<extracolormap_t>() as libc::c_ulong,
        PU_LEVEL as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut extracolormap_t;
    (*exc).fadestart = 0 as libc::c_int as uint8_t;
    (*exc).fadeend = 31 as libc::c_int as uint8_t;
    (*exc).flags = 0 as libc::c_int as uint8_t;
    (*exc).rgba = 0 as libc::c_int;
    (*exc).fadergba = 0x19000000 as libc::c_int;
    (*exc)
        .colormap = if lighttable != 0 {
        R_CreateLightTable(exc)
    } else {
        0 as *mut lighttable_t
    };
    (*exc).prev = 0 as *mut extracolormap_s;
    (*exc).next = (*exc).prev;
    return exc;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetDefaultColormap() -> *mut extracolormap_t {
    if extra_colormaps.is_null() {
        extra_colormaps = R_CreateDefaultColormap(true_0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn R_CopyColormap(
    mut extra_colormap: *mut extracolormap_t,
    mut lighttable: boolean,
) -> *mut extracolormap_t {
    let mut exc: *mut extracolormap_t = Z_CallocAlign(
        ::core::mem::size_of::<extracolormap_t>() as libc::c_ulong,
    ...
    *exc = *extra_colormap;
    ...
    if lighttable != 0 {
        ...
        (*exc).colormap = 0 as *mut lighttable_t;
    }
    return exc;
}
#[no_mangle]
pub unsafe extern "C" fn R_AddColormapToList(mut extra_colormap: *mut extracolormap_t) {
    let mut exc: *mut extracolormap_t = 0 as *mut extracolormap_t;
    if extra_colormaps.is_null() {
        extra_colormaps = extra_colormap;
        (*extra_colormap).next = 0 as *mut extracolormap_s;
        (*extra_colormap).prev = 0 as *mut extracolormap_s;
        return;
    }
    exc = extra_colormaps;
    while !((*exc).next).is_null() {
        exc = (*exc).next;
    }
...
#[no_mangle]
pub unsafe extern "C" fn R_CheckDefaultColormapByValues(
    mut checkrgba: boolean,
    mut checkfadergba: boolean,
    mut checkparams: boolean,
    mut rgba: int32_t,
    mut fadergba: int32_t,
    mut fadestart: uint8_t,
    mut fadeend: uint8_t,
    mut flags: uint8_t,
) -> boolean {
    return ((if checkparams == 0 {
        true_0 as libc::c_int
    } else {
        (fadestart as libc::c_int == 0 as libc::c_int
            && fadeend as libc::c_int == 31 as libc::c_int && flags == 0) as libc::c_int
    }) != 0
        && (if checkrgba == 0 {
            true_0 as libc::c_int
        } else {
            (rgba == 0 as libc::c_int) as libc::c_int
        }) != 0
        && (if checkfadergba == 0 {
            true_0 as libc::c_int
        } else {
            (fadergba == 0x19000000 as libc::c_int) as libc::c_int
        }) != 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_CheckDefaultColormap(
    mut extra_colormap: *mut extracolormap_t,
    mut checkrgba: boolean,
    mut checkfadergba: boolean,
    mut checkparams: boolean,
    ...
    return R_CheckDefaultColormapByValues(
        checkrgba,
        checkfadergba,
        checkparams,
        (*extra_colormap).rgba,
        (*extra_colormap).fadergba,
        (*extra_colormap).fadestart,
        (*extra_colormap).fadeend,
        (*extra_colormap).flags,
    );
}
#[no_mangle]
pub unsafe extern "C" fn R_CheckEqualColormaps(
    mut exc_a: *mut extracolormap_t,
    mut exc_b: *mut extracolormap_t,
    mut checkrgba: boolean,
    mut checkfadergba: boolean,
    mut checkparams: boolean,
) -> boolean {
    ...
    return ((if checkparams == 0 {
        ...
        ((*exc_a).fadestart as libc::c_int == (*exc_b).fadestart as libc::c_int
            && (*exc_a).fadeend as libc::c_int == (*exc_b).fadeend as libc::c_int
            && (*exc_a).flags as libc::c_int == (*exc_b).flags as libc::c_int)
            as libc::c_int
    }) != 0
        && (if checkrgba == 0 {
            true_0 as libc::c_int
        } else {
            ((*exc_a).rgba == (*exc_b).rgba) as libc::c_int
        }) != 0
        && (if checkfadergba == 0 {
            true_0 as libc::c_int
        } else {
            ((*exc_a).fadergba == (*exc_b).fadergba) as libc::c_int
        }) != 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetColormapFromListByValues(
    mut rgba: int32_t,
    mut fadergba: int32_t,
    mut fadestart: uint8_t,
    mut fadeend: uint8_t,
    ...
    let mut exc: *mut extracolormap_t = 0 as *mut extracolormap_t;
    let mut dbg_i: uint32_t = 0 as libc::c_int as uint32_t;
    exc = extra_colormaps;
    while !exc.is_null() {
        if rgba == (*exc).rgba && fadergba == (*exc).fadergba
            && fadestart as libc::c_int == (*exc).fadestart as libc::c_int
            && fadeend as libc::c_int == (*exc).fadeend as libc::c_int
            && flags as libc::c_int == (*exc).flags as libc::c_int
        {
            CONS_Debug(
                0x8 as libc::c_int,
                b"Found Colormap %d: rgba(%d,%d,%d,%d) fadergba(%d,%d,%d,%d)\n\0"
                    as *const u8 as *const libc::c_char,
                dbg_i,
                rgba & 0xff as libc::c_int,
                rgba >> 8 as libc::c_int & 0xff as libc::c_int,
                rgba >> 16 as libc::c_int & 0xff as libc::c_int,
                rgba >> 24 as libc::c_int & 0xff as libc::c_int,
                fadergba & 0xff as libc::c_int,
                fadergba >> 8 as libc::c_int & 0xff as libc::c_int,
                fadergba >> 16 as libc::c_int & 0xff as libc::c_int,
                fadergba >> 24 as libc::c_int & 0xff as libc::c_int,
            );
            return exc;
        }
        dbg_i = dbg_i.wrapping_add(1);
        dbg_i;
        exc = (*exc).next;
    }
    return 0 as *mut extracolormap_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetColormapFromList(
    mut extra_colormap: *mut extracolormap_t,
) -> *mut extracolormap_t {
    return R_GetColormapFromListByValues(
        (*extra_colormap).rgba,
        (*extra_colormap).fadergba,
        (*extra_colormap).fadestart,
        (*extra_colormap).fadeend,
...
static mut deltas: [[libc::c_double; 3]; 256] = [[0.; 3]; 256];
static mut map: [[libc::c_double; 3]; 256] = [[0.; 3]; 256];
#[no_mangle]
pub unsafe extern "C" fn R_CreateLightTable(
    mut extra_colormap: *mut extracolormap_t,
) -> *mut lighttable_t {
    let mut cmaskr: libc::c_double = 0.;
    let mut cmaskg: libc::c_double = 0.;
    let mut cmaskb: libc::c_double = 0.;
    let mut cdestr: libc::c_double = 0.;
    let mut cdestg: libc::c_double = 0.;
    let mut cdestb: libc::c_double = 0.;
    let mut maskamt: libc::c_double = 0 as libc::c_int as libc::c_double;
    let mut othermask: libc::c_double = 0 as libc::c_int as libc::c_double;
    let mut cr: uint8_t = ((*extra_colormap).rgba & 0xff as libc::c_int) as uint8_t;
    let mut cg: uint8_t = ((*extra_colormap).rgba >> 8 as libc::c_int
        & 0xff as libc::c_int) as uint8_t;
    let mut cb: uint8_t = ((*extra_colormap).rgba >> 16 as libc::c_int
        & 0xff as libc::c_int) as uint8_t;
    let mut ca: uint8_t = ((*extra_colormap).rgba >> 24 as libc::c_int
        & 0xff as libc::c_int) as uint8_t;
    let mut cfr: uint8_t = ((*extra_colormap).fadergba & 0xff as libc::c_int) as uint8_t;
    let mut cfg: uint8_t = ((*extra_colormap).fadergba >> 8 as libc::c_int
        & 0xff as libc::c_int) as uint8_t;
    let mut cfb: uint8_t = ((*extra_colormap).fadergba >> 16 as libc::c_int
        & 0xff as libc::c_int) as uint8_t;
    let mut fadestart: uint8_t = (*extra_colormap).fadestart;
    let mut fadedist: uint8_t = ((*extra_colormap).fadeend as libc::c_int
        - (*extra_colormap).fadestart as libc::c_int) as uint8_t;
    let mut lighttable: *mut lighttable_t = 0 as *mut lighttable_t;
    let mut i: size_t = 0;
    cmaskr = cr as libc::c_double;
    cmaskg = cg as libc::c_double;
    cmaskb = cb as libc::c_double;
    maskamt = (f128::f128::new(ca as libc::c_int) / f128::f128::new(24.0))
        .to_f64()
        .unwrap();
    othermask = 1 as libc::c_int as libc::c_double - maskamt;
    maskamt /= 0xff as libc::c_int as libc::c_double;
    cmaskr *= maskamt;
    cmaskg *= maskamt;
    cmaskb *= maskamt;
    cdestr = cfr as libc::c_double;
    cdestg = cfg as libc::c_double;
    cdestb = cfb as libc::c_double;
    let mut r: libc::c_double = 0.;
    let mut g: libc::c_double = 0.;
    let mut b: libc::c_double = 0.;
    let mut cbrightness: libc::c_double = 0.;
    let mut p: libc::c_int = 0;
    let mut colormap_p: *mut libc::c_char = 0 as *mut libc::c_char;
    i = 0 as libc::c_int as size_t;
    while i < 256 as libc::c_int as size_t {
        r = (*pMasterPalette.offset(i as isize)).s.red as libc::c_double;
        g = (*pMasterPalette.offset(i as isize)).s.green as libc::c_double;
        b = (*pMasterPalette.offset(i as isize)).s.blue as libc::c_double;
        cbrightness = sqrt(r * r + g * g + b * b);
        map[i
            as usize][0 as libc::c_int as usize] = cbrightness * cmaskr + r * othermask;
        if f128::f128::new(map[i as usize][0 as libc::c_int as usize])
            > f128::f128::new(255.0)
        {
            map[i
                as usize][0 as libc::c_int
                as usize] = (f128::f128::new(255.0)).to_f64().unwrap();
        }
        deltas[i
            as usize][0 as libc::c_int
            as usize] = (map[i as usize][0 as libc::c_int as usize] - cdestr)
            / fadedist as libc::c_double;
        map[i
            as usize][1 as libc::c_int as usize] = cbrightness * cmaskg + g * othermask;
        if f128::f128::new(map[i as usize][1 as libc::c_int as usize])
            > f128::f128::new(255.0)
        {
            map[i
        ...
        deltas[i
            as usize][1 as libc::c_int
            as usize] = (map[i as usize][1 as libc::c_int as usize] - cdestg)
            / fadedist as libc::c_double;
        map[i
            as usize][2 as libc::c_int as usize] = cbrightness * cmaskb + b * othermask;
        if f128::f128::new(map[i as usize][2 as libc::c_int as usize])
            > f128::f128::new(255.0)
        {
            map[i
        ...
        deltas[i
            as usize][2 as libc::c_int
            as usize] = (map[i as usize][2 as libc::c_int as usize] - cdestb)
            / fadedist as libc::c_double;
        i = i.wrapping_add(1);
        i;
    }
    colormap_p = Z_MallocAlign(
        (256 as libc::c_int * 34 as libc::c_int + 10 as libc::c_int) as size_t,
        PU_LEVEL as libc::c_int,
        0 as *mut libc::c_void,
        8 as libc::c_int,
    ) as *mut libc::c_char;
    lighttable = colormap_p as *mut uint8_t;
    p = 0 as libc::c_int;
    while p < 34 as libc::c_int {
        i = 0 as libc::c_int as size_t;
        while i < 256 as libc::c_int as size_t {
            *colormap_p = NearestPaletteColor(
                RoundUp(map[i as usize][0 as libc::c_int as usize]) as uint8_t,
                RoundUp(map[i as usize][1 as libc::c_int as usize]) as uint8_t,
                RoundUp(map[i as usize][2 as libc::c_int as usize]) as uint8_t,
                0 as *mut RGBA_t,
            ) as libc::c_char;
            colormap_p = colormap_p.offset(1);
            colormap_p;
            if !((p as uint32_t) < fadestart as uint32_t) {
                if (if map[i as usize][0 as libc::c_int as usize] - cdestr
                    < 0 as libc::c_int as libc::c_double
                {
                    -(map[i as usize][0 as libc::c_int as usize] - cdestr)
                } else {
                    map[i as usize][0 as libc::c_int as usize] - cdestr
                })
                    > (if deltas[i as usize][0 as libc::c_int as usize]
                        < 0 as libc::c_int as libc::c_double
                    {
                        -deltas[i as usize][0 as libc::c_int as usize]
                    } else {
                        deltas[i as usize][0 as libc::c_int as usize]
                    })
                {
                    map[i as usize][0 as libc::c_int as usize]
                        -= deltas[i as usize][0 as libc::c_int as usize];
                } else {
                    map[i as usize][0 as libc::c_int as usize] = cdestr;
                }
                if (if map[i as usize][1 as libc::c_int as usize] - cdestg
                    < 0 as libc::c_int as libc::c_double
                {
                    -(map[i as usize][1 as libc::c_int as usize] - cdestg)
                } else {
                    map[i as usize][1 as libc::c_int as usize] - cdestg
                })
                    > (if deltas[i as usize][1 as libc::c_int as usize]
                        < 0 as libc::c_int as libc::c_double
                    {
                        -deltas[i as usize][1 as libc::c_int as usize]
                    } else {
                        deltas[i as usize][1 as libc::c_int as usize]
                    })
                {
                    map[i as usize][1 as libc::c_int as usize]
                        -= deltas[i as usize][1 as libc::c_int as usize];
                } else {
                    map[i as usize][1 as libc::c_int as usize] = cdestg;
                }
                if (if map[i as usize][2 as libc::c_int as usize] - cdestb
                    < 0 as libc::c_int as libc::c_double
                {
                    -(map[i as usize][2 as libc::c_int as usize] - cdestb)
                } else {
                    map[i as usize][2 as libc::c_int as usize] - cdestb
                })
                    > (if deltas[i as usize][1 as libc::c_int as usize]
                ...
                {
                    map[i as usize][2 as libc::c_int as usize]
                        -= deltas[i as usize][2 as libc::c_int as usize];
                } else {
                    map[i as usize][2 as libc::c_int as usize] = cdestb;
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn R_CreateColormapFromLinedef(
    mut p1: *mut libc::c_char,
    mut p2: *mut libc::c_char,
    mut p3: *mut libc::c_char,
) -> *mut extracolormap_t {
    let mut cr: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cg: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cb: uint8_t = 0 as libc::c_int as uint8_t;
    let mut ca: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cfr: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cfg: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cfb: uint8_t = 0 as libc::c_int as uint8_t;
    let mut cfa: uint8_t = 25 as libc::c_int as uint8_t;
    let mut fadestart: uint32_t = 0 as libc::c_int as uint32_t;
    let mut fadeend: uint32_t = 31 as libc::c_int as uint32_t;
    let mut flags: uint8_t = 0 as libc::c_int as uint8_t;
    let mut rgba: int32_t = 0 as libc::c_int;
    let mut fadergba: int32_t = 0x19000000 as libc::c_int;
    if *p1.offset(0 as libc::c_int as isize) as libc::c_int >= 'a' as i32
        && *p1.offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        && *p1.offset(1 as libc::c_int as isize) == 0
    {
        ca = (*p1.offset(0 as libc::c_int as isize) as libc::c_int - 'a' as i32)
            as uint8_t;
    } else if *p1.offset(0 as libc::c_int as isize) as libc::c_int == '#' as i32
        && *p1.offset(1 as libc::c_int as isize) as libc::c_int >= 'a' as i32
        && *p1.offset(1 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        && *p1.offset(2 as libc::c_int as isize) == 0
    {
        ca = (*p1.offset(1 as libc::c_int as isize) as libc::c_int - 'a' as i32)
            as uint8_t;
    } else if *p1.offset(0 as libc::c_int as isize) as libc::c_int >= 'A' as i32
        && *p1.offset(0 as libc::c_int as isize) as libc::c_int <= 'Z' as i32
        && *p1.offset(1 as libc::c_int as isize) == 0
    {
        ca = (*p1.offset(0 as libc::c_int as isize) as libc::c_int - 'A' as i32)
        ...
        && *p1.offset(2 as libc::c_int as isize) == 0
    {
        ...
        if *p1.offset(1 as libc::c_int as isize) as libc::c_int != 0
            && *p1.offset(2 as libc::c_int as isize) as libc::c_int != 0
        {
            cr = ((if *p1.offset(1 as libc::c_int as isize) as libc::c_int >= '0' as i32
                && *p1.offset(1 as libc::c_int as isize) as libc::c_int <= '9' as i32
            {
                *p1.offset(1 as libc::c_int as isize) as libc::c_int - '0' as i32
            } else {
                (if *p1.offset(1 as libc::c_int as isize) as libc::c_int >= 'a' as i32
                    && *p1.offset(1 as libc::c_int as isize) as libc::c_int <= 'f' as i32
                {
                    *p1.offset(1 as libc::c_int as isize) as libc::c_int - 'a' as i32
                        + 10 as libc::c_int
                } else {
            ...
            }) as uint32_t * 16 as libc::c_int as uint32_t)
                .wrapping_add(
            ...
            if *p1.offset(3 as libc::c_int as isize) as libc::c_int != 0
                && *p1.offset(4 as libc::c_int as isize) as libc::c_int != 0
            {
                cg = ((if *p1.offset(3 as libc::c_int as isize) as libc::c_int
                    >= '0' as i32
                    && *p1.offset(3 as libc::c_int as isize) as libc::c_int <= '9' as i32
                {
                    *p1.offset(3 as libc::c_int as isize) as libc::c_int - '0' as i32
                } else {
                    (if *p1.offset(3 as libc::c_int as isize) as libc::c_int
                        >= 'a' as i32
                        && *p1.offset(3 as libc::c_int as isize) as libc::c_int
                            <= 'f' as i32
                    {
                        *p1.offset(3 as libc::c_int as isize) as libc::c_int - 'a' as i32
                            + 10 as libc::c_int
                    } else {
                        (if *p1.offset(3 as libc::c_int as isize) as libc::c_int
                            >= 'A' as i32
                    ...
                    .wrapping_add(
                        (if *p1.offset(4 as libc::c_int as isize) as libc::c_int
                            >= '0' as i32
                ...
                if *p1.offset(5 as libc::c_int as isize) as libc::c_int != 0
                    && *p1.offset(6 as libc::c_int as isize) as libc::c_int != 0
                {
                    cb = ((if *p1.offset(5 as libc::c_int as isize) as libc::c_int
                        >= '0' as i32
                        && *p1.offset(5 as libc::c_int as isize) as libc::c_int
                            <= '9' as i32
                    {
                        *p1.offset(5 as libc::c_int as isize) as libc::c_int - '0' as i32
                    } else {
                        (if *p1.offset(5 as libc::c_int as isize) as libc::c_int
                            >= 'a' as i32
                            && *p1.offset(5 as libc::c_int as isize) as libc::c_int
                                <= 'f' as i32
                        {
                        ...
                        .wrapping_add(
                            (if *p1.offset(6 as libc::c_int as isize) as libc::c_int
                                >= '0' as i32
                                && *p1.offset(6 as libc::c_int as isize) as libc::c_int
                                    <= '9' as i32
                            {
                                *p1.offset(6 as libc::c_int as isize) as libc::c_int
                                    - '0' as i32
                    ...
                    if *p1.offset(7 as libc::c_int as isize) as libc::c_int >= 'a' as i32
                        && *p1.offset(7 as libc::c_int as isize) as libc::c_int
                            <= 'z' as i32
                    {
                        ca = (*p1.offset(7 as libc::c_int as isize) as libc::c_int
                            - 'a' as i32) as uint8_t;
                    } else if *p1.offset(7 as libc::c_int as isize) as libc::c_int
                        >= 'A' as i32
                        && *p1.offset(7 as libc::c_int as isize) as libc::c_int
                            <= 'Z' as i32
                    {
                        ...
                        ca = 25 as libc::c_int as uint8_t;
                    }
                } else {
                    ca = 25 as libc::c_int as uint8_t;
                }
    ...
    if *p2.offset(0 as libc::c_int as isize) as libc::c_int == '#' as i32 {
        if *p2.offset(1 as libc::c_int as isize) != 0 {
            flags = (if *p2.offset(1 as libc::c_int as isize) as libc::c_int
                >= '0' as i32
                && *p2.offset(1 as libc::c_int as isize) as libc::c_int <= '9' as i32
            {
                *p2.offset(1 as libc::c_int as isize) as libc::c_int - '0' as i32
            } else {
                0 as libc::c_int
            }) as uint8_t;
            if *p2.offset(2 as libc::c_int as isize) as libc::c_int != 0
                && *p2.offset(3 as libc::c_int as isize) as libc::c_int != 0
            {
                fadestart = ((if *p2.offset(3 as libc::c_int as isize) as libc::c_int
                    >= '0' as i32
                    && *p2.offset(3 as libc::c_int as isize) as libc::c_int <= '9' as i32
                {
                    *p2.offset(3 as libc::c_int as isize) as libc::c_int - '0' as i32
                } else {
                    0 as libc::c_int
                })
                    + (if *p2.offset(2 as libc::c_int as isize) as libc::c_int
                        >= '0' as i32
                ...
                if *p2.offset(4 as libc::c_int as isize) as libc::c_int != 0
                    && *p2.offset(5 as libc::c_int as isize) as libc::c_int != 0
                {
                    fadeend = ((if *p2.offset(5 as libc::c_int as isize) as libc::c_int
                        >= '0' as i32
                        && *p2.offset(5 as libc::c_int as isize) as libc::c_int
                            <= '9' as i32
                    {
                        *p2.offset(5 as libc::c_int as isize) as libc::c_int - '0' as i32
                    } else {
                        0 as libc::c_int
                    })
                        + (if *p2.offset(4 as libc::c_int as isize) as libc::c_int
                            >= '0' as i32
        ...
        if fadestart > 30 as libc::c_int as uint32_t {
            fadestart = 0 as libc::c_int as uint32_t;
        }
        if fadeend > 31 as libc::c_int as uint32_t
            || fadeend < 1 as libc::c_int as uint32_t
        {
            fadeend = 31 as libc::c_int as uint32_t;
        }
    }
    if *p3.offset(0 as libc::c_int as isize) as libc::c_int >= 'a' as i32
        && *p3.offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        && *p3.offset(1 as libc::c_int as isize) == 0
    {
        cfa = (*p3.offset(0 as libc::c_int as isize) as libc::c_int - 'a' as i32)
            as uint8_t;
    } else if *p3.offset(0 as libc::c_int as isize) as libc::c_int == '#' as i32
        && *p3.offset(1 as libc::c_int as isize) as libc::c_int >= 'a' as i32
        && *p3.offset(1 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        && *p3.offset(2 as libc::c_int as isize) == 0
    {
        cfa = (*p3.offset(1 as libc::c_int as isize) as libc::c_int - 'a' as i32)
            as uint8_t;
    } else if *p3.offset(0 as libc::c_int as isize) as libc::c_int >= 'A' as i32
        && *p3.offset(0 as libc::c_int as isize) as libc::c_int <= 'Z' as i32
        && *p3.offset(1 as libc::c_int as isize) == 0
    {
        cfa = (*p3.offset(0 as libc::c_int as isize) as libc::c_int - 'A' as i32)
        ...
        && *p3.offset(2 as libc::c_int as isize) == 0
    {
        ...
        if *p3.offset(1 as libc::c_int as isize) as libc::c_int != 0
            && *p3.offset(2 as libc::c_int as isize) as libc::c_int != 0
        {
            cfr = ((if *p3.offset(1 as libc::c_int as isize) as libc::c_int >= '0' as i32
                && *p3.offset(1 as libc::c_int as isize) as libc::c_int <= '9' as i32
            {
                *p3.offset(1 as libc::c_int as isize) as libc::c_int - '0' as i32
            } else {
                (if *p3.offset(1 as libc::c_int as isize) as libc::c_int >= 'a' as i32
                    && *p3.offset(1 as libc::c_int as isize) as libc::c_int <= 'f' as i32
                {
                    *p3.offset(1 as libc::c_int as isize) as libc::c_int - 'a' as i32
                        + 10 as libc::c_int
                } else {
                    (if *p3.offset(1 as libc::c_int as isize) as libc::c_int
                        >= 'A' as i32
                        && *p3.offset(1 as libc::c_int as isize) as libc::c_int
                            <= 'F' as i32
                    {
                        *p3.offset(1 as libc::c_int as isize) as libc::c_int - 'A' as i32
                            + 10 as libc::c_int
                ...
                .wrapping_add(
                    (if *p3.offset(2 as libc::c_int as isize) as libc::c_int
                        >= '0' as i32
                        && *p3.offset(2 as libc::c_int as isize) as libc::c_int
                            <= '9' as i32
                    {
                        *p3.offset(2 as libc::c_int as isize) as libc::c_int - '0' as i32
                    } else {
                        (if *p3.offset(2 as libc::c_int as isize) as libc::c_int
                            >= 'a' as i32
                            && *p3.offset(2 as libc::c_int as isize) as libc::c_int
            ...
            if *p3.offset(3 as libc::c_int as isize) as libc::c_int != 0
                && *p3.offset(4 as libc::c_int as isize) as libc::c_int != 0
            {
                cfg = ((if *p3.offset(3 as libc::c_int as isize) as libc::c_int
                    >= '0' as i32
                    && *p3.offset(3 as libc::c_int as isize) as libc::c_int <= '9' as i32
                {
                    *p3.offset(3 as libc::c_int as isize) as libc::c_int - '0' as i32
                } else {
                    (if *p3.offset(3 as libc::c_int as isize) as libc::c_int
                        >= 'a' as i32
                        && *p3.offset(3 as libc::c_int as isize) as libc::c_int
                            <= 'f' as i32
                    {
                        *p3.offset(3 as libc::c_int as isize) as libc::c_int - 'a' as i32
                            + 10 as libc::c_int
                    } else {
                        (if *p3.offset(3 as libc::c_int as isize) as libc::c_int
                            >= 'A' as i32
                    ...
                    .wrapping_add(
                        (if *p3.offset(4 as libc::c_int as isize) as libc::c_int
                            >= '0' as i32
                            && *p3.offset(4 as libc::c_int as isize) as libc::c_int
                                <= '9' as i32
                        {
                            *p3.offset(4 as libc::c_int as isize) as libc::c_int
                                - '0' as i32
                ...
                if *p3.offset(5 as libc::c_int as isize) as libc::c_int != 0
                    && *p3.offset(6 as libc::c_int as isize) as libc::c_int != 0
                {
                    cfb = ((if *p3.offset(5 as libc::c_int as isize) as libc::c_int
                        >= '0' as i32
                        && *p3.offset(5 as libc::c_int as isize) as libc::c_int
                            <= '9' as i32
                    {
                        *p3.offset(5 as libc::c_int as isize) as libc::c_int - '0' as i32
                    } else {
                        (if *p3.offset(5 as libc::c_int as isize) as libc::c_int
                            >= 'a' as i32
                            && *p3.offset(5 as libc::c_int as isize) as libc::c_int
                                <= 'f' as i32
                        {
                        ...
                        .wrapping_add(
                            (if *p3.offset(6 as libc::c_int as isize) as libc::c_int
                                >= '0' as i32
                                && *p3.offset(6 as libc::c_int as isize) as libc::c_int
                                    <= '9' as i32
                            {
                                *p3.offset(6 as libc::c_int as isize) as libc::c_int
                                    - '0' as i32
                    ...
                    if *p3.offset(7 as libc::c_int as isize) as libc::c_int >= 'a' as i32
                        && *p3.offset(7 as libc::c_int as isize) as libc::c_int
                            <= 'z' as i32
                    {
                        cfa = (*p3.offset(7 as libc::c_int as isize) as libc::c_int
                            - 'a' as i32) as uint8_t;
                    } else if *p3.offset(7 as libc::c_int as isize) as libc::c_int
                        >= 'A' as i32
                        && *p3.offset(7 as libc::c_int as isize) as libc::c_int
                            <= 'Z' as i32
                    {
                        ...
                        cfa = 25 as libc::c_int as uint8_t;
                    }
                } else {
                    cfa = 25 as libc::c_int as uint8_t;
                }
    ...
    fadergba = cfr as libc::c_int + ((cfg as libc::c_int) << 8 as libc::c_int)
        + ((cfb as libc::c_int) << 16 as libc::c_int)
        + ((cfa as libc::c_int) << 24 as libc::c_int);
    return R_CreateColormap(
        rgba,
        fadergba,
...
#[no_mangle]
pub unsafe extern "C" fn R_CreateColormap(
    mut rgba: int32_t,
    mut fadergba: int32_t,
    mut fadestart: uint8_t,
    mut fadeend: uint8_t,
    ...
    let mut extra_colormap: *mut extracolormap_t = 0 as *mut extracolormap_t;
    ...
    CONS_Debug(
        0x8 as libc::c_int,
        b"Creating Colormap: rgba(%x) fadergba(%x)\n\0" as *const u8
            as *const libc::c_char,
        rgba,
        fadergba,
    );
    extra_colormap = Z_CallocAlign(
        ::core::mem::size_of::<extracolormap_t>() as libc::c_ulong,
        PU_LEVEL as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut extracolormap_t;
    (*extra_colormap).fadestart = fadestart as uint16_t as uint8_t;
    (*extra_colormap).fadeend = fadeend as uint16_t as uint8_t;
...
#[no_mangle]
pub unsafe extern "C" fn R_AddColormaps(
    mut exc_augend: *mut extracolormap_t,
    mut exc_addend: *mut extracolormap_t,
    mut subR: boolean,
    mut subG: boolean,
    mut subB: boolean,
    mut subA: boolean,
    mut subFadeR: boolean,
    mut subFadeG: boolean,
    mut subFadeB: boolean,
    mut subFadeA: boolean,
    mut subFadeStart: boolean,
    mut subFadeEnd: boolean,
    mut ignoreFlags: boolean,
    mut lighttable: boolean,
) -> *mut extracolormap_t {
    let mut red: int16_t = 0;
    let mut green: int16_t = 0;
    let mut blue: int16_t = 0;
    let mut alpha: int16_t = 0;
    exc_augend = R_CopyColormap(exc_augend, false_0 as libc::c_int);
    if exc_addend.is_null() {
        exc_addend = R_GetDefaultColormap();
    }
    red = (if (if ((*exc_augend).rgba & 0xff as libc::c_int)
        + (if subR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).rgba & 0xff as libc::c_int) < 255 as libc::c_int
    {
        ((*exc_augend).rgba & 0xff as libc::c_int)
            + (if subR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    }) > 0 as libc::c_int
    {
        if ((*exc_augend).rgba & 0xff as libc::c_int)
            + (if subR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba & 0xff as libc::c_int) < 255 as libc::c_int
        {
            ((*exc_augend).rgba & 0xff as libc::c_int)
    ...
    green = (if (if ((*exc_augend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
        + (if subG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
        < 255 as libc::c_int
    {
        ((*exc_augend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
            + (if subG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    ...
    {
        if ((*exc_augend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
            + (if subG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba >> 8 as libc::c_int & 0xff as libc::c_int)
            < 255 as libc::c_int
        {
    ...
    blue = (if (if ((*exc_augend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
        + (if subB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
        < 255 as libc::c_int
    {
        ((*exc_augend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
            + (if subB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    ...
    {
        if ((*exc_augend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
            + (if subB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).rgba >> 16 as libc::c_int & 0xff as libc::c_int)
            < 255 as libc::c_int
        {
    ...
    alpha = ((*exc_addend).rgba >> 24 as libc::c_int & 0xff as libc::c_int) as int16_t;
    alpha = (if (if (((*exc_augend).rgba >> 24 as libc::c_int & 0xff as libc::c_int)
        + (if subA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * alpha as libc::c_int) < 25 as libc::c_int
    {
        ((*exc_augend).rgba >> 24 as libc::c_int & 0xff as libc::c_int)
            + (if subA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * alpha as libc::c_int
    } else {
        25 as libc::c_int
    ...
    {
        if (((*exc_augend).rgba >> 24 as libc::c_int & 0xff as libc::c_int)
            + (if subA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * alpha as libc::c_int) < 25 as libc::c_int
        {
            ((*exc_augend).rgba >> 24 as libc::c_int & 0xff as libc::c_int)
    ...
    (*exc_augend)
        .rgba = red as libc::c_int + ((green as libc::c_int) << 8 as libc::c_int)
        + ((blue as libc::c_int) << 16 as libc::c_int)
        + ((alpha as libc::c_int) << 24 as libc::c_int);
    red = (if (if ((*exc_augend).fadergba & 0xff as libc::c_int)
        + (if subFadeR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).fadergba & 0xff as libc::c_int) < 255 as libc::c_int
    {
        ((*exc_augend).fadergba & 0xff as libc::c_int)
            + (if subFadeR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    }) > 0 as libc::c_int
    {
        if ((*exc_augend).fadergba & 0xff as libc::c_int)
            + (if subFadeR != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba & 0xff as libc::c_int) < 255 as libc::c_int
        {
            ((*exc_augend).fadergba & 0xff as libc::c_int)
    ...
    green = (if (if ((*exc_augend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
        + (if subFadeG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
        < 255 as libc::c_int
    {
        ((*exc_augend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    ...
    {
        if ((*exc_augend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeG != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba >> 8 as libc::c_int & 0xff as libc::c_int)
            < 255 as libc::c_int
        {
    ...
    blue = (if (if ((*exc_augend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
        + (if subFadeB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * ((*exc_addend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
        < 255 as libc::c_int
    {
        ((*exc_augend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
    } else {
        255 as libc::c_int
    ...
    {
        if ((*exc_augend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeB != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * ((*exc_addend).fadergba >> 16 as libc::c_int & 0xff as libc::c_int)
            < 255 as libc::c_int
        {
    ...
    alpha = ((*exc_addend).fadergba >> 24 as libc::c_int & 0xff as libc::c_int)
        as int16_t;
    if alpha as libc::c_int == 25 as libc::c_int
        && (*exc_addend).fadergba & 0xffffff as libc::c_int == 0
    {
        alpha = 0 as libc::c_int as int16_t;
    }
    alpha = (if (if (((*exc_augend).fadergba >> 24 as libc::c_int & 0xff as libc::c_int)
        + (if subFadeA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * alpha as libc::c_int) < 25 as libc::c_int
    {
        ((*exc_augend).fadergba >> 24 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * alpha as libc::c_int
    } else {
        25 as libc::c_int
    ...
    {
        if (((*exc_augend).fadergba >> 24 as libc::c_int & 0xff as libc::c_int)
            + (if subFadeA != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * alpha as libc::c_int) < 25 as libc::c_int
        {
            ((*exc_augend).fadergba >> 24 as libc::c_int & 0xff as libc::c_int)
    ...
    (*exc_augend)
        .fadergba = red as libc::c_int + ((green as libc::c_int) << 8 as libc::c_int)
        + ((blue as libc::c_int) << 16 as libc::c_int)
        + ((alpha as libc::c_int) << 24 as libc::c_int);
    (*exc_augend)
        .fadestart = (if (if ((*exc_augend).fadestart as libc::c_int
        + (if subFadeStart != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * (*exc_addend).fadestart as libc::c_int) < 31 as libc::c_int
    {
        (*exc_augend).fadestart as libc::c_int
            + (if subFadeStart != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * (*exc_addend).fadestart as libc::c_int
    } else {
        31 as libc::c_int
    }) > 0 as libc::c_int
    {
        if ((*exc_augend).fadestart as libc::c_int
            + (if subFadeStart != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * (*exc_addend).fadestart as libc::c_int) < 31 as libc::c_int
        {
            (*exc_augend).fadestart as libc::c_int
    ...
    (*exc_augend)
        .fadeend = (if (if (*exc_augend).fadeend as libc::c_int
        + (if subFadeEnd != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
            * (if (*exc_addend).fadeend as libc::c_int == 31 as libc::c_int
                && (*exc_addend).fadestart == 0
            {
                0 as libc::c_int
            } else {
                (*exc_addend).fadeend as libc::c_int
            }) < 31 as libc::c_int
    {
        (*exc_augend).fadeend as libc::c_int
            + (if subFadeEnd != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * (if (*exc_addend).fadeend as libc::c_int == 31 as libc::c_int
                    && (*exc_addend).fadestart == 0
                {
    ...
    {
        if (*exc_augend).fadeend as libc::c_int
            + (if subFadeEnd != 0 { -(1 as libc::c_int) } else { 1 as libc::c_int })
                * (if (*exc_addend).fadeend as libc::c_int == 31 as libc::c_int
                    && (*exc_addend).fadestart == 0
                {
    ...
    (*exc_augend)
        .colormap = if lighttable != 0 {
        R_CreateLightTable(exc_augend)
    } else {
        0 as *mut lighttable_t
    };
    (*exc_augend).prev = 0 as *mut extracolormap_s;
    (*exc_augend).next = (*exc_augend).prev;
    return exc_augend;
}
#[no_mangle]
pub unsafe extern "C" fn NearestPaletteColor(
    mut r: uint8_t,
    mut g: uint8_t,
    mut b: uint8_t,
    ...
    let mut dg: libc::c_int = 0;
    let mut db: libc::c_int = 0;
    let mut distortion: libc::c_int = 0;
    let mut bestdistortion: libc::c_int = 256 as libc::c_int * 256 as libc::c_int
        * 4 as libc::c_int;
    let mut bestcolor: libc::c_int = 0 as libc::c_int;
    ...
    while i < 256 as libc::c_int {
        dr = r as libc::c_int - (*palette.offset(i as isize)).s.red as libc::c_int;
        dg = g as libc::c_int - (*palette.offset(i as isize)).s.green as libc::c_int;
        db = b as libc::c_int - (*palette.offset(i as isize)).s.blue as libc::c_int;
    ...
    return bestcolor as uint8_t;
}
unsafe extern "C" fn RoundUp(mut number: libc::c_double) -> libc::c_int {
    if f128::f128::new(number) > f128::f128::new(255.0) {
        return 255 as libc::c_int;
    }
    if f128::f128::new(number) < f128::f128::new(0.0) {
        return 0 as libc::c_int;
    }
    if number as libc::c_int <= (number - 0.5f32 as libc::c_double) as libc::c_int {
        return number as libc::c_int + 1 as libc::c_int;
    }
    return number as libc::c_int;
}
#[inline]
unsafe extern "C" fn makecol15(
    mut r: libc::c_int,
    mut g: libc::c_int,
    mut b: libc::c_int,
) -> libc::c_int {
    return (r >> 3 as libc::c_int) << 10 as libc::c_int
        | (g >> 3 as libc::c_int) << 5 as libc::c_int | b >> 3 as libc::c_int;
}
unsafe extern "C" fn R_Init8to16() {
    let mut palette: *mut uint8_t = 0 as *mut uint8_t;
    let mut i: libc::c_int = 0;
    palette = W_CacheLumpName(
        b"PLAYPAL\0" as *const u8 as *const libc::c_char,
    ...
    while i < 256 as libc::c_int {
        color8to16[i
            as usize] = makecol15(
            *palette.offset(0 as libc::c_int as isize) as libc::c_int,
            *palette.offset(1 as libc::c_int as isize) as libc::c_int,
            *palette.offset(2 as libc::c_int as isize) as libc::c_int,
        ) as int16_t;
        palette = palette.offset(3 as libc::c_int as isize);
        i += 1;
        i;
    }
    hicolormaps = Z_MallocAlign(
    ...
    while i < 16384 as libc::c_int {
        *hicolormaps.offset(i as isize) = (i << 1 as libc::c_int) as int16_t;
        i += 1;
        i;
    }
}
...
pub unsafe extern "C" fn R_InitData() {
    if highcolor != 0 {
        CONS_Printf(b"InitHighColor...\n\0" as *const u8 as *const libc::c_char);
        R_Init8to16();
    }
    CONS_Printf(b"R_LoadTextures()...\n\0" as *const u8 as *const libc::c_char);
    R_LoadTextures();
    CONS_Printf(b"P_InitPicAnims()...\n\0" as *const u8 as *const libc::c_char);
    P_InitPicAnims();
    CONS_Printf(b"R_InitSprites()...\n\0" as *const u8 as *const libc::c_char);
    R_InitSpriteLumps();
    R_InitSprites();
    CONS_Printf(b"R_InitColormaps()...\n\0" as *const u8 as *const libc::c_char);
    R_InitColormaps();
}
#[no_mangle]
pub unsafe extern "C" fn R_PrecacheLevel() {
    let mut texturepresent: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut spritepresent: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: size_t = 0;
    let mut j: size_t = 0;
    let mut k: size_t = 0;
    let mut lump: lumpnum_t = 0;
    let mut th: *mut thinker_t = 0 as *mut thinker_t;
    let mut sf: *mut spriteframe_t = 0 as *mut spriteframe_t;
    if demoplayback != 0 {
        return;
    }
    ...
    texturepresent = calloc(
        numtextures as libc::c_ulong,
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if texturepresent.is_null() {
        I_Error(
            b"%s: Out of memory looking up textures\0" as *const u8
                as *const libc::c_char,
            b"R_PrecacheLevel\0" as *const u8 as *const libc::c_char,
        );
    }
    j = 0 as libc::c_int as size_t;
    while j < numsides {
        if (*sides.offset(j as isize)).toptexture >= 0 as libc::c_int
            && (*sides.offset(j as isize)).toptexture < numtextures
        {
            *texturepresent
                .offset(
                    (*sides.offset(j as isize)).toptexture as isize,
                ) = 1 as libc::c_int as libc::c_char;
        }
        if (*sides.offset(j as isize)).midtexture >= 0 as libc::c_int
            && (*sides.offset(j as isize)).midtexture < numtextures
        {
            *texturepresent
                .offset(
                    (*sides.offset(j as isize)).midtexture as isize,
                ) = 1 as libc::c_int as libc::c_char;
        }
        if (*sides.offset(j as isize)).bottomtexture >= 0 as libc::c_int
            && (*sides.offset(j as isize)).bottomtexture < numtextures
        {
            *texturepresent
                .offset(
                    (*sides.offset(j as isize)).bottomtexture as isize,
                ) = 1 as libc::c_int as libc::c_char;
        }
        j = j.wrapping_add(1);
        j;
    }
    *texturepresent.offset(skytexture as isize) = 1 as libc::c_int as libc::c_char;
    texturememory = 0 as libc::c_int as size_t;
    j = 0 as libc::c_int as size_t;
    while j < numtextures as libc::c_uint as size_t {
        if !(*texturepresent.offset(j as isize) == 0) {
            if (*texturecache.offset(j as isize)).is_null() {
                R_GenerateTexture(j);
            }
        }
        j = j.wrapping_add(1);
    ...
    free(texturepresent as *mut libc::c_void);
    spritepresent = calloc(
        numsprites,
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if spritepresent.is_null() {
        I_Error(
            b"%s: Out of memory looking up sprites\0" as *const u8
                as *const libc::c_char,
            b"R_PrecacheLevel\0" as *const u8 as *const libc::c_char,
        );
    }
            ...
            as *mut thinker_t
    {
            ...
            >(Some(P_RemoveThinkerDelayed as unsafe extern "C" fn(*mut thinker_t) -> ()))
        {
            *spritepresent
                .offset(
                    (*(th as *mut mobj_t)).sprite as isize,
                ) = 1 as libc::c_int as libc::c_char;
        }
        th = (*th).next;
    }
    spritememory = 0 as libc::c_int as size_t;
    i = 0 as libc::c_int as size_t;
    while i < numsprites {
        if !(*spritepresent.offset(i as isize) == 0) {
            j = 0 as libc::c_int as size_t;
            while j < (*sprites.offset(i as isize)).numframes {
                sf = &mut *((*sprites.offset(i as isize)).spriteframes)
                    .offset(j as isize) as *mut spriteframe_t;
                match (*sf).rotate as libc::c_int {
                    0 => {
                        lump = (*sf).lumppat[0 as libc::c_int as usize];
                        if devparm != 0 {
                            spritememory = spritememory.wrapping_add(W_LumpLength(lump));
                        }
                        W_CachePatchNum(lump, PU_SPRITE as libc::c_int);
                    }
                    12 => {
                        lump = (*sf).lumppat[2 as libc::c_int as usize];
                        if devparm != 0 {
                            spritememory = spritememory.wrapping_add(W_LumpLength(lump));
                        }
                        W_CachePatchNum(lump, PU_SPRITE as libc::c_int);
                        lump = (*sf).lumppat[6 as libc::c_int as usize];
                        if devparm != 0 {
                            spritememory = spritememory.wrapping_add(W_LumpLength(lump));
                        }
                        W_CachePatchNum(lump, PU_SPRITE as libc::c_int);
                    ...
                    _ => {
                        k = (if (*sf).rotate as libc::c_int & SRF_3DGE as libc::c_int
                            != 0
                        {
                            16 as libc::c_int
                        } else {
                        ...
                        loop {
                            ...
                            lump = (*sf).lumppat[k as usize];
                            if devparm != 0 {
                                spritememory = spritememory
                                    .wrapping_add(W_LumpLength(lump));
                            }
                            W_CachePatchNum(lump, PU_SPRITE as libc::c_int);
                        }
                    }
    ...
    free(spritepresent as *mut libc::c_void);
    CONS_Debug(
        0x400 as libc::c_int,
        b"Precache level done:\nflatmemory:    %s k\ntexturememory: %s k\nspritememory:  %s k\n\0"
            as *const u8 as *const libc::c_char,
        sizeu1(flatmemory >> 10 as libc::c_int),
        sizeu2(texturememory >> 10 as libc::c_int),
        sizeu3(spritememory >> 10 as libc::c_int),
    );
}
