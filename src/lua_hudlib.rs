...
extern "C" {
    ...
    fn V_NameTagWidth(string: *const libc::c_char) -> int32_t;
    ...
    fn W_LumpExists(name: *const libc::c_char) -> uint8_t;
    ...
    fn LUA_HUD_AddDrawNameTag(
        ...
        flags: int32_t,
        basecolor: uint16_t,
        outlinecolor: uint16_t,
        basecolormap: *mut uint8_t,
        outlinecolormap: *mut uint8_t,
    );
    fn LUA_HUD_AddDrawLevelTitle(
        list: huddrawlist_h,
        x: int32_t,
        y: int32_t,
        str: *const libc::c_char,
    ...
    fn LUA_HUD_AddFadeScreen(list: huddrawlist_h, color: uint16_t, strength: uint8_t);
    fn LUA_HUD_AddDrawScaledNameTag(
        list: huddrawlist_h,
        x: fixed_t,
        y: fixed_t,
        str: *const libc::c_char,
    ...
    fn lib_hudadd(L: *mut lua_State) -> libc::c_int;
}
...
pub const SRF_NONE: C2RustUnnamed_3 = 255;
pub const SRF_2D: C2RustUnnamed_3 = 12;
pub const SRF_RIGHT: C2RustUnnamed_3 = 8;
pub const SRF_LEFT: C2RustUnnamed_3 = 4;
pub const SRF_3DMASK: C2RustUnnamed_3 = 3;
pub const SRF_3DGE: C2RustUnnamed_3 = 2;
pub const SRF_3D: C2RustUnnamed_3 = 1;
pub const SRF_SINGLE: C2RustUnnamed_3 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const TC_DEFAULT: C2RustUnnamed_4 = -122;
pub const TC_DASHMODE: C2RustUnnamed_4 = -123;
pub const TC_BLINK: C2RustUnnamed_4 = -124;
pub const TC_RAINBOW: C2RustUnnamed_4 = -125;
pub const TC_ALLWHITE: C2RustUnnamed_4 = -126;
pub const TC_METALSONIC: C2RustUnnamed_4 = -127;
pub const TC_BOSS: C2RustUnnamed_4 = -128;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const camera_momz: cameraf = 13;
pub const camera_momy: cameraf = 12;
pub const camera_momx: cameraf = 11;
pub const camera_height: cameraf = 10;
pub const camera_radius: cameraf = 9;
pub const camera_angle: cameraf = 5;
pub const camera_z: cameraf = 4;
pub const camera_aiming: cameraf = 1;
pub const camera_chase: cameraf = 0;
pub type cameraf = libc::c_uint;
pub const camera_ceilingz: cameraf = 8;
pub const camera_floorz: cameraf = 7;
pub const camera_subsector: cameraf = 6;
pub const camera_y: cameraf = 3;
pub const camera_x: cameraf = 2;
pub const patch_topoffset: patch = 4;
pub const patch_leftoffset: patch = 3;
pub const patch_height: patch = 2;
pub const patch_width: patch = 1;
pub const patch_valid: patch = 0;
pub type patch = libc::c_uint;
pub const hudinfo_f: hudinfo = 2;
pub const hudinfo_y: hudinfo = 1;
pub const hudinfo_x: hudinfo = 0;
pub type hudinfo = libc::c_uint;
pub const widtht_thin: widtht = 2;
pub const widtht_small: widtht = 1;
pub const widtht_normal: widtht = 0;
pub type widtht = libc::c_uint;
...
pub const hudhook_intermission: C2RustUnnamed_7 = 4;
pub const hudhook_titlecard: C2RustUnnamed_7 = 3;
pub const hudhook_game: C2RustUnnamed_7 = 0;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const hudhook_MAX: C2RustUnnamed_7 = 5;
pub const hudhook_title: C2RustUnnamed_7 = 2;
pub const hudhook_scores: C2RustUnnamed_7 = 1;
#[inline(always)]
...
#[no_mangle]
pub static mut hud_running: boolean = false_0 as libc::c_int;
static mut hud_enabled: [uint8_t; 4] = [0; 4];
static mut hud_disable_options: [*const libc::c_char; 25] = [
    b"stagetitle\0" as *const u8 as *const libc::c_char,
    b"textspectator\0" as *const u8 as *const libc::c_char,
    b"crosshair\0" as *const u8 as *const libc::c_char,
    ...
    b"weaponrings\0" as *const u8 as *const libc::c_char,
    b"powerstones\0" as *const u8 as *const libc::c_char,
    b"teamscores\0" as *const u8 as *const libc::c_char,
    b"nightslink\0" as *const u8 as *const libc::c_char,
    b"nightsdrill\0" as *const u8 as *const libc::c_char,
    b"nightsrings\0" as *const u8 as *const libc::c_char,
    b"nightsscore\0" as *const u8 as *const libc::c_char,
    b"nightstime\0" as *const u8 as *const libc::c_char,
    b"nightsrecords\0" as *const u8 as *const libc::c_char,
    b"rankings\0" as *const u8 as *const libc::c_char,
    b"coopemeralds\0" as *const u8 as *const libc::c_char,
    b"tokens\0" as *const u8 as *const libc::c_char,
    b"tabemblems\0" as *const u8 as *const libc::c_char,
    b"intermissiontally\0" as *const u8 as *const libc::c_char,
    b"intermissiontitletext\0" as *const u8 as *const libc::c_char,
    b"intermissionmessages\0" as *const u8 as *const libc::c_char,
    b"intermissionemeralds\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut hudinfo_opt: [*const libc::c_char; 4] = [
    b"x\0" as *const u8 as *const libc::c_char,
    b"y\0" as *const u8 as *const libc::c_char,
    b"f\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut patch_opt: [*const libc::c_char; 6] = [
    ...
    b"leftoffset\0" as *const u8 as *const libc::c_char,
    b"topoffset\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut patch_fields_ref: libc::c_int = -(2 as libc::c_int);
static mut align_opt: [*const libc::c_char; 25] = [
    ...
    b"fixed-center\0" as *const u8 as *const libc::c_char,
    b"fixed-right\0" as *const u8 as *const libc::c_char,
    b"small\0" as *const u8 as *const libc::c_char,
    b"small-fixed\0" as *const u8 as *const libc::c_char,
    b"small-fixed-center\0" as *const u8 as *const libc::c_char,
    b"small-fixed-right\0" as *const u8 as *const libc::c_char,
    b"small-center\0" as *const u8 as *const libc::c_char,
    b"small-right\0" as *const u8 as *const libc::c_char,
    b"small-thin\0" as *const u8 as *const libc::c_char,
    b"small-thin-center\0" as *const u8 as *const libc::c_char,
    b"small-thin-right\0" as *const u8 as *const libc::c_char,
    b"small-thin-fixed\0" as *const u8 as *const libc::c_char,
    b"small-thin-fixed-center\0" as *const u8 as *const libc::c_char,
    b"small-thin-fixed-right\0" as *const u8 as *const libc::c_char,
    b"thin\0" as *const u8 as *const libc::c_char,
    b"thin-fixed\0" as *const u8 as *const libc::c_char,
    b"thin-fixed-center\0" as *const u8 as *const libc::c_char,
    b"thin-fixed-right\0" as *const u8 as *const libc::c_char,
    b"thin-center\0" as *const u8 as *const libc::c_char,
    b"thin-right\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut widtht_opt: [*const libc::c_char; 4] = [
    b"normal\0" as *const u8 as *const libc::c_char,
    b"small\0" as *const u8 as *const libc::c_char,
    b"thin\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut camera_opt: [*const libc::c_char; 15] = [
    b"chase\0" as *const u8 as *const libc::c_char,
    ...
    b"subsector\0" as *const u8 as *const libc::c_char,
    ...
    b"height\0" as *const u8 as *const libc::c_char,
    b"momx\0" as *const u8 as *const libc::c_char,
    b"momy\0" as *const u8 as *const libc::c_char,
    b"momz\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut camera_fields_ref: libc::c_int = -(2 as libc::c_int);
unsafe extern "C" fn lib_getHudInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i >= NUMHUDITEMS as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"hudinfo[] index %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
            NUMHUDITEMS as libc::c_int - 1 as libc::c_int,
        );
    }
    LUA_PushUserdata(
        L,
        &mut *hudinfo.as_mut_ptr().offset(i as isize) as *mut hudinfo_t
            as *mut libc::c_void,
        b"HUDINFO_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_hudinfolen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMHUDITEMS as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn hudinfo_get(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut hudinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"HUDINFO_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut hudinfo_t);
    let mut field: hudinfo = luaL_checkoption(
        L,
        2 as libc::c_int,
        hudinfo_opt[0 as libc::c_int as usize],
        hudinfo_opt.as_ptr(),
    ) as hudinfo;
    match field as libc::c_uint {
        ...
        2 => {
            lua_pushnumber(L, (*info).f);
        }
        _ => {}
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn hudinfo_set(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut hudinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"HUDINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    match field as libc::c_uint {
        0 => {
            (*info).x = luaL_checknumber(L, 3 as libc::c_int);
        }
        1 => {
            (*info).y = luaL_checknumber(L, 3 as libc::c_int);
        }
        2 => {
            (*info).f = luaL_checknumber(L, 3 as libc::c_int);
        }
        _ => {}
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn hudinfo_num(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut hudinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"HUDINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(
        L,
        info.offset_from(hudinfo.as_mut_ptr()) as libc::c_long as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn colormap_get(mut L: *mut lua_State) -> libc::c_int {
    let mut colormap: *const uint8_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"COLORMAP\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut uint8_t);
    let mut i: uint32_t = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    if i >= 256 as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"colormap index %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
            255 as libc::c_int,
        );
    }
    lua_pushnumber(L, *colormap.offset(i as isize) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn patch_get(mut L: *mut lua_State) -> libc::c_int {
    let mut patch: *mut patch_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PATCH_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut patch_t);
    let mut field: patch = Lua_optoption(
        L,
        2 as libc::c_int,
        -(1 as libc::c_int),
        patch_fields_ref,
    ...
    if patch.is_null() {
        if field as libc::c_uint == patch_valid as libc::c_int as libc::c_uint {
            lua_pushboolean(L, 0 as libc::c_int);
            return 1 as libc::c_int;
        }
        return luaL_error(
            L,
            b"accessed patch_t doesn't exist anymore, please check 'valid' before using patch_t.\0"
    ...
    match field as libc::c_uint {
        0 => {
            lua_pushboolean(
                L,
                (patch != 0 as *mut libc::c_void as *mut patch_t) as libc::c_int,
            );
        }
        1 => {
            lua_pushnumber(L, (*patch).width as lua_Number);
        }
        2 => {
            lua_pushnumber(L, (*patch).height as lua_Number);
        }
        3 => {
            lua_pushnumber(L, (*patch).leftoffset as lua_Number);
        }
        4 => {
            lua_pushnumber(L, (*patch).topoffset as lua_Number);
        }
        _ => {}
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn patch_set(mut L: *mut lua_State) -> libc::c_int {
    return luaL_error(
        L,
        b"'patch_t' struct cannot be edited by Lua.\0" as *const u8
            as *const libc::c_char,
    );
}
unsafe extern "C" fn camera_get(mut L: *mut lua_State) -> libc::c_int {
    let mut cam: *mut camera_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut camera_t);
    let mut field: cameraf = Lua_optoption(
        L,
        2 as libc::c_int,
        -(1 as libc::c_int),
        camera_fields_ref,
    ...
    match field as libc::c_uint {
        ...
        1 => {
            lua_pushnumber(L, (*cam).aiming as lua_Number);
        }
        2 => {
        ...
        5 => {
            lua_pushnumber(L, (*cam).angle as lua_Number);
        }
        6 => {
            LUA_PushUserdata(
                L,
                (*cam).subsector as *mut libc::c_void,
                b"SUBSECTOR_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        7 => {
            lua_pushnumber(L, (*cam).floorz);
        }
        8 => {
            lua_pushnumber(L, (*cam).ceilingz);
        }
        9 => {
            lua_pushnumber(L, (*cam).radius);
        }
        10 => {
            lua_pushnumber(L, (*cam).height);
        }
        11 => {
            lua_pushnumber(L, (*cam).momx);
        }
        12 => {
            lua_pushnumber(L, (*cam).momy);
        }
        13 => {
            lua_pushnumber(L, (*cam).momz);
        }
        _ => {}
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn camera_set(mut L: *mut lua_State) -> libc::c_int {
    let mut cam: *mut camera_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
    ...
    match field as libc::c_uint {
        6 | 7 | 8 | 2 | 3 => {
            return luaL_error(
                L,
                b"'camera_t' field '%s' should not be set directly. Use 'P_TryCameraMove' or 'P_TeleportCameraMove' instead.\0"
                    as *const u8 as *const libc::c_char,
                camera_opt[field as usize],
            );
        }
        0 => {
            let mut chase: int32_t = luaL_checkboolean(L, 3 as libc::c_int);
            if cam == &mut camera as *mut camera_t {
                CV_SetValue(&mut cv_chasecam, chase);
            } else if cam == &mut camera2 as *mut camera_t {
        ...
        1 => {
            (*cam).aiming = luaL_checknumber(L, 3 as libc::c_int) as angle_t;
        }
        4 => {
            (*cam).z = luaL_checknumber(L, 3 as libc::c_int);
            P_CheckCameraPosition((*cam).x, (*cam).y, cam);
            (*cam).floorz = tmfloorz;
            (*cam).ceilingz = tmceilingz;
        }
        5 => {
            (*cam).angle = luaL_checknumber(L, 3 as libc::c_int) as angle_t;
        }
        9 => {
            (*cam).radius = luaL_checknumber(L, 3 as libc::c_int);
            if (*cam).radius < 0 as libc::c_int {
                (*cam).radius = 0 as libc::c_int;
            }
            P_CheckCameraPosition((*cam).x, (*cam).y, cam);
            (*cam).floorz = tmfloorz;
            (*cam).ceilingz = tmceilingz;
        ...
        10 => {
            (*cam).height = luaL_checknumber(L, 3 as libc::c_int);
            if (*cam).height < 0 as libc::c_int {
                (*cam).height = 0 as libc::c_int;
            }
            P_CheckCameraPosition((*cam).x, (*cam).y, cam);
            (*cam).floorz = tmfloorz;
            (*cam).ceilingz = tmceilingz;
        ...
        11 => {
            (*cam).momx = luaL_checknumber(L, 3 as libc::c_int);
        }
        12 => {
            (*cam).momy = luaL_checknumber(L, 3 as libc::c_int);
        }
        13 => {
            (*cam).momz = luaL_checknumber(L, 3 as libc::c_int);
        }
        _ => {
            return luaL_error(
                L,
                b"'camera_t' has no field named '%s'.\0" as *const u8
                    as *const libc::c_char,
...
unsafe extern "C" fn libd_patchExists(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
                as *const u8 as *const libc::c_char,
        );
    }
    lua_pushboolean(
        L,
        W_LumpExists(luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t))
            as libc::c_int,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_cachePatch(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
...
unsafe extern "C" fn libd_getSpritePatch(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    let mut frame: uint32_t = 0 as libc::c_int as uint32_t;
    let mut angle: uint8_t = 0 as libc::c_int as uint8_t;
    ...
    if i == SPR_PLAY as libc::c_int as uint32_t {
        return 0 as libc::c_int;
    }
    sprdef = &mut *sprites.offset(i as isize) as *mut spritedef_t;
    frame = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int) as uint32_t;
    frame &= 0xff as libc::c_int as uint32_t;
    if frame as size_t >= (*sprdef).numframes {
        return 0 as libc::c_int;
    }
    sprframe = &mut *((*sprdef).spriteframes).offset(frame as isize)
        as *mut spriteframe_t;
    angle = luaL_optnumber(L, 3 as libc::c_int, 1 as libc::c_int) as uint8_t;
    if angle as libc::c_int != 0 as libc::c_int {
        angle = angle.wrapping_sub(1);
        angle;
    }
    if angle as libc::c_int
        >= (if (*sprframe).rotate as libc::c_int & SRF_3DGE as libc::c_int != 0 {
            16 as libc::c_int
        } else {
            8 as libc::c_int
        })
    ...
    if lua_isnumber(L, 4 as libc::c_int) != 0 {
        let mut rollangle: angle_t = luaL_checknumber(L, 4 as libc::c_int) as angle_t;
        let mut rot: int32_t = R_GetRollAngle(rollangle);
        if rot != 0 {
            let mut rotsprite: *mut patch_t = Patch_GetRotatedSprite(
                sprframe,
                frame as size_t,
                angle as size_t,
                (*sprframe).flip as libc::c_int
                    & (1 as libc::c_int) << angle as libc::c_int,
    ...
    LUA_PushUserdata(
        L,
        W_CachePatchNum((*sprframe).lumppat[angle as usize], PU_SPRITE as libc::c_int),
        b"PATCH_T*\0" as *const u8 as *const libc::c_char,
    );
    lua_pushboolean(
        L,
        ((*sprframe).flip as libc::c_int & (1 as libc::c_int) << angle as libc::c_int
            != 0 as libc::c_int) as libc::c_int,
    );
    return 2 as libc::c_int;
}
unsafe extern "C" fn libd_getSprite2Patch(mut L: *mut lua_State) -> libc::c_int {
    let mut i: int32_t = 0;
    let mut j: playersprite_t = SPR2_STND;
    let mut frame: uint32_t = 0 as libc::c_int as uint32_t;
    let mut angle: uint8_t = 0 as libc::c_int as uint8_t;
    let mut sprdef: *mut spritedef_t = 0 as *mut spritedef_t;
    let mut sprframe: *mut spriteframe_t = 0 as *mut spriteframe_t;
    ...
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        i = lua_tonumber(L, 1 as libc::c_int);
        if i < 0 as libc::c_int || i >= 32 as libc::c_int {
            return luaL_error(
                L,
                b"skin number %d out of range (0 - %d)\0" as *const u8
                    as *const libc::c_char,
                i,
        ...
        i = 0 as libc::c_int;
        while i < numskins {
            if fastcmp((skins[i as usize].name).as_mut_ptr(), name) != 0 {
                break;
            }
            i += 1;
            i;
    ...
    lua_remove(L, 1 as libc::c_int);
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        j = lua_tonumber(L, 1 as libc::c_int) as playersprite_t;
        if j as libc::c_uint & 0x80 as libc::c_int as libc::c_uint != 0 {
            super_0 = true_0 as libc::c_int;
            j = ::core::mem::transmute::<
                libc::c_uint,
                playersprite_t,
            >(j as libc::c_uint & !(0x80 as libc::c_int) as libc::c_uint);
        }
    ...
    if lua_type(L, 2 as libc::c_int) == 1 as libc::c_int {
        super_0 = lua_toboolean(L, 2 as libc::c_int);
    ...
    j = P_GetSkinSprite2(
        &mut *skins.as_mut_ptr().offset(i as isize),
        j as uint8_t,
        0 as *mut player_t,
    ) as playersprite_t;
    sprdef = &mut *((*skins.as_mut_ptr().offset(i as isize)).sprites)
        .as_mut_ptr()
        .offset(j as isize) as *mut spritedef_t;
    frame = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int) as uint32_t;
    frame &= 0xff as libc::c_int as uint32_t;
    if frame as size_t >= (*sprdef).numframes {
        return 0 as libc::c_int;
        ...
        if rot != 0 {
            let mut rotsprite: *mut patch_t = Patch_GetRotatedSprite(
                ...
                (*sprframe).flip as libc::c_int
                    & (1 as libc::c_int) << angle as libc::c_int,
                true_0 as libc::c_int,
                &mut *((*skins.as_mut_ptr().offset(i as isize)).sprinfo)
                    .as_mut_ptr()
                    .offset(j as isize) as *mut spriteinfo_t as *mut libc::c_void,
                rot,
            );
            LUA_PushUserdata(
                L,
...
unsafe extern "C" fn libd_draw(mut L: *mut lua_State) -> libc::c_int {
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    patch = *(luaL_checkudata(
        L,
        3 as libc::c_int,
        b"PATCH_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut patch_t);
    ...
    flags = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int);
    if !(lua_type(L, 5 as libc::c_int) <= 0 as libc::c_int) {
        colormap = *(luaL_checkudata(
            L,
            5 as libc::c_int,
            b"COLORMAP\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut uint8_t);
    }
    flags &= !(0xff as libc::c_int);
    lua_getfield(
        L,
        -(10000 as libc::c_int),
        b"HUD_DRAW_LIST\0" as *const u8 as *const libc::c_char,
    );
    list = lua_touserdata(L, -(1 as libc::c_int)) as huddrawlist_h;
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    if LUA_HUD_IsDrawListValid(list) != 0 {
...
unsafe extern "C" fn libd_drawScaled(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    scale = luaL_checknumber(L, 3 as libc::c_int);
    if scale < 0 as libc::c_int {
        return luaL_error(L, b"negative scale\0" as *const u8 as *const libc::c_char);
    }
    patch = *(luaL_checkudata(
        L,
        4 as libc::c_int,
    ...
    flags = luaL_optnumber(L, 5 as libc::c_int, 0 as libc::c_int);
    if !(lua_type(L, 6 as libc::c_int) <= 0 as libc::c_int) {
        colormap = *(luaL_checkudata(
            L,
            6 as libc::c_int,
            b"COLORMAP\0" as *const u8 as *const libc::c_char,
    ...
    if LUA_HUD_IsDrawListValid(list) != 0 {
        ...
        V_DrawStretchyFixedPatch(x, y, scale, scale, flags, patch, colormap);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn libd_drawStretched(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    let mut hscale: fixed_t = 0;
    let mut vscale: fixed_t = 0;
    let mut flags: int32_t = 0;
    let mut patch: *mut patch_t = 0 as *mut patch_t;
    let mut colormap: *mut uint8_t = 0 as *mut uint8_t;
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    hscale = luaL_checknumber(L, 3 as libc::c_int);
    if hscale < 0 as libc::c_int {
        return luaL_error(
            L,
            b"negative horizontal scale\0" as *const u8 as *const libc::c_char,
        );
    }
    vscale = luaL_checknumber(L, 4 as libc::c_int);
    if vscale < 0 as libc::c_int {
        return luaL_error(
            L,
            b"negative vertical scale\0" as *const u8 as *const libc::c_char,
        );
    }
    patch = *(luaL_checkudata(
        L,
    ...
    flags = luaL_optnumber(L, 6 as libc::c_int, 0 as libc::c_int);
    if !(lua_type(L, 7 as libc::c_int) <= 0 as libc::c_int) {
        colormap = *(luaL_checkudata(
            L,
            7 as libc::c_int,
            b"COLORMAP\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn libd_drawCropped(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    let mut hscale: fixed_t = 0;
    let mut vscale: fixed_t = 0;
    let mut sx: fixed_t = 0;
    let mut sy: fixed_t = 0;
    let mut w: fixed_t = 0;
    let mut h: fixed_t = 0;
    let mut flags: int32_t = 0;
    let mut patch: *mut patch_t = 0 as *mut patch_t;
    ...
    flags = luaL_checknumber(L, 6 as libc::c_int);
    if !(lua_type(L, 7 as libc::c_int) <= 0 as libc::c_int) {
        colormap = *(luaL_checkudata(
            L,
            7 as libc::c_int,
    ...
    sx = luaL_checknumber(L, 8 as libc::c_int);
    if sx < 0 as libc::c_int {
        return luaL_error(L, b"negative crop sx\0" as *const u8 as *const libc::c_char);
    }
    sy = luaL_checknumber(L, 9 as libc::c_int);
    if sy < 0 as libc::c_int {
        return luaL_error(L, b"negative crop sy\0" as *const u8 as *const libc::c_char);
    }
    w = luaL_checknumber(L, 10 as libc::c_int);
    if w < 0 as libc::c_int {
        return luaL_error(L, b"negative crop w\0" as *const u8 as *const libc::c_char);
    }
    h = luaL_checknumber(L, 11 as libc::c_int);
    if h < 0 as libc::c_int {
        return luaL_error(L, b"negative crop h\0" as *const u8 as *const libc::c_char);
    }
    flags &= !(0xff as libc::c_int);
    lua_getfield(
        L,
...
unsafe extern "C" fn libd_drawNum(mut L: *mut lua_State) -> libc::c_int {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut flags: int32_t = 0;
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    num = luaL_checknumber(L, 3 as libc::c_int);
    flags = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int);
    flags &= !(0xff as libc::c_int);
    lua_getfield(
        L,
...
unsafe extern "C" fn libd_drawPaddedNum(mut L: *mut lua_State) -> libc::c_int {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut flags: int32_t = 0;
    let mut num: int32_t = 0;
    let mut digits: int32_t = 0;
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    if hud_running == 0 {
        return luaL_error(
            L,
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    num = labs(luaL_checknumber(L, 3 as libc::c_int) as libc::c_long) as int32_t;
    digits = luaL_optnumber(L, 4 as libc::c_int, 2 as libc::c_int);
    flags = luaL_optnumber(L, 5 as libc::c_int, 0 as libc::c_int);
    flags &= !(0xff as libc::c_int);
    lua_getfield(
        L,
...
unsafe extern "C" fn libd_drawFill(mut L: *mut lua_State) -> libc::c_int {
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    let mut x: int32_t = luaL_optnumber(L, 1 as libc::c_int, 0 as libc::c_int);
    let mut y: int32_t = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int);
    let mut w: int32_t = luaL_optnumber(L, 3 as libc::c_int, 320 as libc::c_int);
    let mut h: int32_t = luaL_optnumber(L, 4 as libc::c_int, 200 as libc::c_int);
    let mut c: int32_t = luaL_optnumber(L, 5 as libc::c_int, 31 as libc::c_int);
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
...
unsafe extern "C" fn libd_drawString(mut L: *mut lua_State) -> libc::c_int {
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    ...
    let mut flags: int32_t = luaL_optnumber(
        L,
        4 as libc::c_int,
        0x800000 as libc::c_int,
    );
    let mut align: align = luaL_checkoption(
        L,
        5 as libc::c_int,
        b"left\0" as *const u8 as *const libc::c_char,
        align_opt.as_ptr(),
    ...
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    if LUA_HUD_IsDrawListValid(list) != 0 {
        LUA_HUD_AddDrawString(list, x, y, str, flags, align as int32_t);
    } else {
...
unsafe extern "C" fn libd_drawNameTag(mut L: *mut lua_State) -> libc::c_int {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut str: *const libc::c_char = 0 as *const libc::c_char;
    let mut flags: int32_t = 0;
    let mut basecolor: uint16_t = 0;
    let mut outlinecolor: uint16_t = 0;
    let mut basecolormap: *mut uint8_t = 0 as *mut uint8_t;
    let mut outlinecolormap: *mut uint8_t = 0 as *mut uint8_t;
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    if hud_running == 0 {
        return luaL_error(
            L,
    ...
    x = luaL_checknumber(L, 1 as libc::c_int);
    y = luaL_checknumber(L, 2 as libc::c_int);
    str = luaL_checklstring(L, 3 as libc::c_int, 0 as *mut size_t);
    flags = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int);
    basecolor = luaL_optnumber(L, 5 as libc::c_int, SKINCOLOR_BLUE as libc::c_int)
        as uint16_t;
    outlinecolor = luaL_optnumber(L, 6 as libc::c_int, SKINCOLOR_ORANGE as libc::c_int)
        as uint16_t;
    if basecolor as libc::c_int != SKINCOLOR_NONE as libc::c_int {
        basecolormap = R_GetTranslationColormap(
            TC_DEFAULT as libc::c_int,
            basecolor as skincolornum_t,
            1 as libc::c_int as uint8_t,
        );
    }
    if outlinecolor as libc::c_int != SKINCOLOR_NONE as libc::c_int {
        outlinecolormap = R_GetTranslationColormap(
            TC_DEFAULT as libc::c_int,
            outlinecolor as skincolornum_t,
            1 as libc::c_int as uint8_t,
        );
    }
    flags &= !(0xff as libc::c_int);
...
unsafe extern "C" fn libd_drawScaledNameTag(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    let mut str: *const libc::c_char = 0 as *const libc::c_char;
    let mut flags: int32_t = 0;
    ...
    str = luaL_checklstring(L, 3 as libc::c_int, 0 as *mut size_t);
    flags = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int);
    scale = luaL_optnumber(L, 5 as libc::c_int, (1 as libc::c_int) << 16 as libc::c_int);
    if scale < 0 as libc::c_int {
        return luaL_error(L, b"negative scale\0" as *const u8 as *const libc::c_char);
    }
    basecolor = luaL_optnumber(L, 6 as libc::c_int, SKINCOLOR_BLUE as libc::c_int)
        as uint16_t;
    outlinecolor = luaL_optnumber(L, 7 as libc::c_int, SKINCOLOR_ORANGE as libc::c_int)
        as uint16_t;
    if basecolor as libc::c_int != SKINCOLOR_NONE as libc::c_int {
        basecolormap = R_GetTranslationColormap(
            TC_DEFAULT as libc::c_int,
...
unsafe extern "C" fn libd_drawLevelTitle(mut L: *mut lua_State) -> libc::c_int {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut str: *const libc::c_char = 0 as *const libc::c_char;
    let mut flags: int32_t = 0;
...
unsafe extern "C" fn libd_stringWidth(mut L: *mut lua_State) -> libc::c_int {
    let mut str: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    ...
    let mut widtht: widtht = luaL_checkoption(
        L,
        3 as libc::c_int,
        b"normal\0" as *const u8 as *const libc::c_char,
        widtht_opt.as_ptr(),
    ...
    match widtht as libc::c_uint {
        0 => {
            lua_pushnumber(L, V_StringWidth(str, flags));
        }
        1 => {
            lua_pushnumber(L, V_SmallStringWidth(str, flags));
        }
        2 => {
            lua_pushnumber(L, V_ThinStringWidth(str, flags));
        }
        _ => {}
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_nameTagWidth(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(
        L,
        V_NameTagWidth(luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t)),
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_levelTitleWidth(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(
        L,
        V_LevelNameWidth(luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t)),
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_levelTitleHeight(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(
        L,
        V_LevelNameHeight(luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t)),
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_getColormap(mut L: *mut lua_State) -> libc::c_int {
    let mut skinnum: int32_t = TC_DEFAULT as libc::c_int;
    let mut color: skincolornum_t = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int)
        as skincolornum_t;
    let mut colormap: *mut uint8_t = 0 as *mut uint8_t;
    if hud_running == 0 {
        return luaL_error(
    ...
    if !(lua_type(L, 1 as libc::c_int) <= 0 as libc::c_int) {
        if lua_type(L, 1 as libc::c_int) == 3 as libc::c_int {
            skinnum = luaL_checknumber(L, 1 as libc::c_int);
            if skinnum >= 32 as libc::c_int {
                return luaL_error(
                    L,
                    b"skin number %d is out of range (>%d)\0" as *const u8
                        as *const libc::c_char,
                    skinnum,
                    32 as libc::c_int - 1 as libc::c_int,
                )
            } else if skinnum < 0 as libc::c_int && skinnum > TC_DEFAULT as libc::c_int {
                return luaL_error(
                    L,
                    b"translation colormap index is out of range\0" as *const u8
                        as *const libc::c_char,
                )
            }
        } else {
            ...
            let mut i: int32_t = R_SkinAvailable(skinname);
            if i != -(1 as libc::c_int) {
                skinnum = i;
            }
        }
    }
    colormap = R_GetTranslationColormap(skinnum, color, 1 as libc::c_int as uint8_t);
    LUA_PushUserdata(
        L,
        colormap as *mut libc::c_void,
        b"COLORMAP\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_getStringColormap(mut L: *mut lua_State) -> libc::c_int {
    let mut flags: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut colormap: *mut uint8_t = 0 as *mut uint8_t;
    if hud_running == 0 {
        return luaL_error(
            L,
    ...
    colormap = V_GetStringColormap(flags & 0xf000 as libc::c_int);
    if !colormap.is_null() {
        LUA_PushUserdata(
            L,
            colormap as *mut libc::c_void,
...
unsafe extern "C" fn libd_fadeScreen(mut L: *mut lua_State) -> libc::c_int {
    let mut list: huddrawlist_h = 0 as *mut huddrawlist_s;
    let mut color: uint16_t = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    let mut strength: uint8_t = luaL_checknumber(L, 2 as libc::c_int) as uint8_t;
    let maxstrength: uint8_t = (if color as libc::c_int & 0xff00 as libc::c_int != 0 {
        32 as libc::c_int
    } else {
        10 as libc::c_int
    }) as uint8_t;
    ...
    if strength as libc::c_int > maxstrength as libc::c_int {
        return luaL_error(
            L,
            b"%s fade strength %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            if color as libc::c_int & 0xff00 as libc::c_int != 0 {
                b"COLORMAP\0" as *const u8 as *const libc::c_char
            } else {
                b"TRANSMAP\0" as *const u8 as *const libc::c_char
            },
            strength as libc::c_int,
            maxstrength as libc::c_int,
        );
    }
    lua_getfield(
        L,
...
unsafe extern "C" fn libd_width(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, vid.width);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_height(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, vid.height);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_dupx(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, vid.dupx);
    lua_pushnumber(L, vid.fdupx);
    return 2 as libc::c_int;
}
unsafe extern "C" fn libd_dupy(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, vid.dupy);
    lua_pushnumber(L, vid.fdupy);
    return 2 as libc::c_int;
}
unsafe extern "C" fn libd_renderer(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
...
unsafe extern "C" fn libd_RandomFixed(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, M_RandomFixed());
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_RandomByte(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, M_RandomByte() as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_RandomKey(mut L: *mut lua_State) -> libc::c_int {
    ...
    lua_pushnumber(L, M_RandomKey(a));
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_RandomRange(mut L: *mut lua_State) -> libc::c_int {
    let mut a: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    ...
    lua_pushnumber(L, M_RandomRange(a, b));
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_SignedRandom(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, M_RandomByte() as int32_t - 128 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_RandomChance(mut L: *mut lua_State) -> libc::c_int {
    ...
    lua_pushboolean(L, (M_RandomFixed() < p) as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_getlocaltransflag(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(L, (10 as libc::c_int - st_translucency) * 0x10000 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn libd_getusertransflag(mut L: *mut lua_State) -> libc::c_int {
    if hud_running == 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not be called outside of rendering hooks!\0"
    ...
    lua_pushnumber(
        L,
        (10 as libc::c_int - cv_translucenthud.value) * 0x10000 as libc::c_int,
    );
    return 1 as libc::c_int;
}
static mut lib_draw: [luaL_Reg; 36] = unsafe {
    [
        {
            let mut init = luaL_Reg {
                name: b"patchExists\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_patchExists
        ...
        {
            let mut init = luaL_Reg {
                name: b"cachePatch\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_cachePatch
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"getSpritePatch\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_getSpritePatch
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"getSprite2Patch\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_getSprite2Patch
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"getColormap\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_getColormap
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"getStringColormap\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_getStringColormap
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"draw\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_draw as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"drawScaled\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawScaled
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawStretched\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawStretched
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawCropped\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawCropped
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawNum\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawNum as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"drawPaddedNum\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawPaddedNum
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawFill\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawFill as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"drawString\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawString
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawNameTag\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawNameTag
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawScaledNameTag\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"drawLevelTitle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_drawLevelTitle
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"fadeScreen\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_fadeScreen
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"stringWidth\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_stringWidth
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"nameTagWidth\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_nameTagWidth
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"levelTitleWidth\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_levelTitleWidth
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"levelTitleHeight\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_levelTitleHeight
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"RandomFixed\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_RandomFixed
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"RandomByte\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_RandomByte
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    libd_RandomKey as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"RandomRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_RandomRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"SignedRandom\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_SignedRandom
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"RandomChance\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_RandomChance
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    libd_width as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    libd_height as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"dupx\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_dupx as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"dupy\0" as *const u8 as *const libc::c_char,
                func: Some(
                    libd_dupy as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    libd_renderer as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"localTransFlag\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"userTransFlag\0" as *const u8 as *const libc::c_char,
                func: Some(
...
static mut lib_draw_ref: libc::c_int = 0;
unsafe extern "C" fn lib_hudenable(mut L: *mut lua_State) -> libc::c_int {
    let mut option: hud = luaL_checkoption(
        L,
        1 as libc::c_int,
        0 as *const libc::c_char,
        hud_disable_options.as_ptr(),
    ) as hud;
    hud_enabled[(option as libc::c_uint).wrapping_div(8 as libc::c_int as libc::c_uint)
        as usize] = (hud_enabled[(option as libc::c_uint)
        .wrapping_div(8 as libc::c_int as libc::c_uint) as usize] as libc::c_int
        | (1 as libc::c_int)
            << (option as libc::c_uint).wrapping_rem(8 as libc::c_int as libc::c_uint))
        as uint8_t;
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_huddisable(mut L: *mut lua_State) -> libc::c_int {
    let mut option: hud = luaL_checkoption(
        L,
        1 as libc::c_int,
        0 as *const libc::c_char,
...
unsafe extern "C" fn lib_hudenabled(mut L: *mut lua_State) -> libc::c_int {
    let mut option: hud = luaL_checkoption(
        L,
        1 as libc::c_int,
        0 as *const libc::c_char,
    ...
    if hud_enabled[(option as libc::c_uint)
        .wrapping_div(8 as libc::c_int as libc::c_uint) as usize] as libc::c_int
        & (1 as libc::c_int)
            << (option as libc::c_uint).wrapping_rem(8 as libc::c_int as libc::c_uint)
        != 0
...
static mut lib_hud: [luaL_Reg; 5] = unsafe {
    [
        {
            let mut init = luaL_Reg {
                name: b"enable\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_hudenable as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    lib_huddisable as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    lib_hudenabled as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                ...
                func: Some(
                    lib_hudadd as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
...
#[no_mangle]
pub unsafe extern "C" fn LUA_HudLib(mut L: *mut lua_State) -> libc::c_int {
    memset(
        hud_enabled.as_mut_ptr() as *mut libc::c_void,
        0xff as libc::c_int,
        (hud_MAX as libc::c_int / 8 as libc::c_int + 1 as libc::c_int) as libc::c_ulong,
    );
    lua_createtable(L, 0 as libc::c_int, 0 as libc::c_int);
    luaL_register(L, 0 as *const libc::c_char, lib_draw.as_mut_ptr());
    lib_draw_ref = luaL_ref(L, -(10000 as libc::c_int));
    luaL_newmetatable(L, b"HUDINFO_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(hudinfo_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(hudinfo_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(hudinfo_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    ...
    lua_pushcclosure(
        L,
        Some(lib_getHudInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_hudinfolen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    ...
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"hudinfo\0" as *const u8 as *const libc::c_char,
    );
    luaL_newmetatable(L, b"COLORMAP\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(colormap_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"PATCH_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(patch_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(patch_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    patch_fields_ref = Lua_CreateFieldTable(L, patch_opt.as_ptr());
    luaL_newmetatable(L, b"CAMERA_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(camera_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(camera_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    camera_fields_ref = Lua_CreateFieldTable(L, camera_opt.as_ptr());
    luaL_register(L, b"hud\0" as *const u8 as *const libc::c_char, lib_hud.as_mut_ptr());
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_HudEnabled(mut option: hud) -> boolean {
    if gL.is_null()
        || hud_enabled[(option as libc::c_uint)
            .wrapping_div(8 as libc::c_int as libc::c_uint) as usize] as libc::c_int
            & (1 as libc::c_int)
                << (option as libc::c_uint)
                    .wrapping_rem(8 as libc::c_int as libc::c_uint) != 0
    {
...
#[no_mangle]
pub unsafe extern "C" fn LUA_SetHudHook(mut hook: libc::c_int, mut list: huddrawlist_h) {
    lua_rawgeti(gL, -(10000 as libc::c_int), lib_draw_ref);
    lua_pushlightuserdata(gL, list as *mut libc::c_void);
    lua_setfield(
        gL,
        -(10000 as libc::c_int),
        b"HUD_DRAW_LIST\0" as *const u8 as *const libc::c_char,
    ...
    match hook {
        0 => {
            let mut cam: *mut camera_t = if splitscreen != 0
                && stplyr
            ...
            LUA_PushUserdata(
                gL,
                stplyr as *mut libc::c_void,
                b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
            );
            LUA_PushUserdata(
                gL,
                cam as *mut libc::c_void,
                b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        3 => {
            ...
            lua_pushnumber(gL, lt_ticker as lua_Number);
            lua_pushnumber(
                gL,
                lt_endtime.wrapping_add(35 as libc::c_int as tic_t) as lua_Number,
            );
        }
        4 => {
