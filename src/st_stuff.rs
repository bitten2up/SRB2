...
extern "C" {
    ...
    static mut op_currentdoomednum: uint16_t;
    static mut op_displayflags: uint32_t;
    ...
    fn F_GetPromptHideHudAll() -> boolean;
    fn F_GetPromptHideHud(y: fixed_t) -> boolean;
    static mut WipeInAction: boolean;
    static mut WipeStageTitle: boolean;
    static mut tallnum: [*mut patch_t; 10];
    static mut rendermode: rendermode_t;
    fn I_UpdateNoBlit();
    fn V_SetPalette(palettenum: int32_t);
    ...
    fn V_DrawLevelActNum(x: int32_t, y: int32_t, flags: int32_t, num: uint8_t);
    fn V_LevelNameWidth(string: *const libc::c_char) -> int32_t;
    fn V_LevelActNumWidth(num: uint8_t) -> int16_t;
    ...
    fn Z_TagsUsage(lowtag: int32_t, hightag: int32_t) -> size_t;
    static mut nightsnum: [*mut patch_t; 10];
    static mut emeraldpics: [[*mut patch_t; 8]; 3];
    static mut rflagico: *mut patch_t;
    static mut bflagico: *mut patch_t;
    static mut rmatcico: *mut patch_t;
    static mut bmatcico: *mut patch_t;
    static mut tagico: *mut patch_t;
    static mut tallminus: *mut patch_t;
    static mut hu_showscores: boolean;
...
pub const MF_RUNSPAWNFUNC: C2RustUnnamed_0 = 536870912;
pub const MF_GRENADEBOUNCE: C2RustUnnamed_0 = 268435456;
pub const MF_NOCLIPTHING: C2RustUnnamed_0 = 134217728;
pub const MF_NIGHTSITEM: C2RustUnnamed_0 = 67108864;
pub const MF_STICKY: C2RustUnnamed_0 = 33554432;
pub const MF_PAIN: C2RustUnnamed_0 = 16777216;
pub const MF_SCENERY: C2RustUnnamed_0 = 8388608;
pub const MF_ENEMY: C2RustUnnamed_0 = 4194304;
pub const MF_NOCLIPHEIGHT: C2RustUnnamed_0 = 2097152;
pub const MF_FIRE: C2RustUnnamed_0 = 1048576;
pub const MF_NOTHINK: C2RustUnnamed_0 = 524288;
pub const MF_MONITOR: C2RustUnnamed_0 = 262144;
pub const MF_BOUNCE: C2RustUnnamed_0 = 131072;
pub const MF_SPRING: C2RustUnnamed_0 = 65536;
pub const MF_MISSILE: C2RustUnnamed_0 = 32768;
pub const MF_BOXICON: C2RustUnnamed_0 = 16384;
pub const MF_FLOAT: C2RustUnnamed_0 = 8192;
pub const MF_NOCLIP: C2RustUnnamed_0 = 4096;
pub const MF_SLIDEME: C2RustUnnamed_0 = 2048;
pub const MF_AMBIENT: C2RustUnnamed_0 = 1024;
pub const MF_NOGRAVITY: C2RustUnnamed_0 = 512;
pub const MF_SPAWNCEILING: C2RustUnnamed_0 = 256;
pub const MF_BOSS: C2RustUnnamed_0 = 128;
pub const MF_PUSHABLE: C2RustUnnamed_0 = 64;
pub const MF_PAPERCOLLISION: C2RustUnnamed_0 = 32;
...
pub const MFE_REVERSESUPER: C2RustUnnamed_1 = 12288;
pub const MFE_FORCENOSUPER: C2RustUnnamed_1 = 8192;
pub const MFE_FORCESUPER: C2RustUnnamed_1 = 4096;
pub const MFE_TRACERANGLE: C2RustUnnamed_1 = 2048;
pub const MFE_APPLYPMOMZ: C2RustUnnamed_1 = 1024;
pub const MFE_SPRUNG: C2RustUnnamed_1 = 512;
pub const MFE_PUSHED: C2RustUnnamed_1 = 256;
pub const MFE_TOUCHLAVA: C2RustUnnamed_1 = 128;
pub const MFE_GOOWATER: C2RustUnnamed_1 = 64;
pub const MFE_VERTICALFLIP: C2RustUnnamed_1 = 32;
pub const MFE_JUSTSTEPPEDDOWN: C2RustUnnamed_1 = 16;
pub const MFE_UNDERWATER: C2RustUnnamed_1 = 8;
pub const MFE_TOUCHWATER: C2RustUnnamed_1 = 4;
pub const MFE_JUSTHITFLOOR: C2RustUnnamed_1 = 2;
pub const MFE_ONGROUND: C2RustUnnamed_1 = 1;
pub type C2RustUnnamed_2 = libc::c_uint;
pub const BT_CUSTOM3: C2RustUnnamed_2 = 32768;
pub const BT_CUSTOM2: C2RustUnnamed_2 = 16384;
pub const BT_CUSTOM1: C2RustUnnamed_2 = 8192;
pub const BT_FIRENORMAL: C2RustUnnamed_2 = 4096;
pub const BT_JUMP: C2RustUnnamed_2 = 2048;
pub const BT_TOSSFLAG: C2RustUnnamed_2 = 1024;
pub const BT_CAMRIGHT: C2RustUnnamed_2 = 512;
pub const BT_CAMLEFT: C2RustUnnamed_2 = 256;
pub const BT_SPIN: C2RustUnnamed_2 = 128;
pub const BT_ATTACK: C2RustUnnamed_2 = 64;
pub const BT_WEAPONPREV: C2RustUnnamed_2 = 32;
pub const BT_WEAPONNEXT: C2RustUnnamed_2 = 16;
pub const BT_WEAPONMASK: C2RustUnnamed_2 = 15;
...
pub const SH_NOSTACK: C2RustUnnamed_3 = -513;
pub const SH_STACK: C2RustUnnamed_3 = 512;
pub const SH_FIREFLOWER: C2RustUnnamed_3 = 512;
pub const SH_FORCEHP: C2RustUnnamed_3 = 255;
pub const SH_FORCE: C2RustUnnamed_3 = 256;
pub const SH_THUNDERCOIN: C2RustUnnamed_3 = 4098;
pub const SH_BUBBLEWRAP: C2RustUnnamed_3 = 2049;
pub const SH_FLAMEAURA: C2RustUnnamed_3 = 1025;
pub const SH_ELEMENTAL: C2RustUnnamed_3 = 3073;
pub const SH_ATTRACT: C2RustUnnamed_3 = 4097;
pub const SH_PINK: C2RustUnnamed_3 = 4;
pub const SH_ARMAGEDDON: C2RustUnnamed_3 = 3;
pub const SH_WHIRLWIND: C2RustUnnamed_3 = 2;
pub const SH_PITY: C2RustUnnamed_3 = 1;
pub const SH_PROTECTSPIKE: C2RustUnnamed_3 = 8192;
pub const SH_PROTECTELECTRIC: C2RustUnnamed_3 = 4096;
pub const SH_PROTECTWATER: C2RustUnnamed_3 = 2048;
pub const SH_PROTECTFIRE: C2RustUnnamed_3 = 1024;
pub const SH_NONE: C2RustUnnamed_3 = 0;
...
pub const RW_RAIL: C2RustUnnamed_5 = 32;
pub const RW_EXPLODE: C2RustUnnamed_5 = 16;
pub const RW_GRENADE: C2RustUnnamed_5 = 8;
pub const RW_SCATTER: C2RustUnnamed_5 = 4;
pub const RW_BOUNCE: C2RustUnnamed_5 = 2;
pub const RW_AUTO: C2RustUnnamed_5 = 1;
...
pub const CS_SIMPLE: C2RustUnnamed_8 = 3;
pub const CS_STANDARD: C2RustUnnamed_8 = 2;
pub const CS_LMAOGALOG: C2RustUnnamed_8 = 1;
pub const CS_LEGACY: C2RustUnnamed_8 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct viddef_s {
    pub modenum: int32_t,
...
pub const NUM_THINKERLISTS: C2RustUnnamed_10 = 5;
pub const THINK_PRECIP: C2RustUnnamed_10 = 4;
pub const THINK_DYNSLOPE: C2RustUnnamed_10 = 3;
pub const THINK_MOBJ: C2RustUnnamed_10 = 2;
pub const THINK_MAIN: C2RustUnnamed_10 = 1;
pub const THINK_POLYOBJ: C2RustUnnamed_10 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct camera_s {
    pub chase: boolean,
...
pub const TC_DEFAULT: C2RustUnnamed_11 = -122;
pub const TC_DASHMODE: C2RustUnnamed_11 = -123;
pub const TC_BLINK: C2RustUnnamed_11 = -124;
pub const TC_RAINBOW: C2RustUnnamed_11 = -125;
pub const TC_ALLWHITE: C2RustUnnamed_11 = -126;
pub const TC_METALSONIC: C2RustUnnamed_11 = -127;
pub const TC_BOSS: C2RustUnnamed_11 = -128;
...
pub const HUD_LIVES: C2RustUnnamed_12 = 0;
...
pub const hudhook_titlecard: C2RustUnnamed_14 = 3;
pub const PU_HUDGFX: C2RustUnnamed_13 = 19;
pub const hudhook_game: C2RustUnnamed_14 = 0;
pub const HUD_POWERUPS: C2RustUnnamed_12 = 19;
pub const PU_CACHE: C2RustUnnamed_13 = 49;
pub const HUD_HUNTPICS: C2RustUnnamed_12 = 18;
pub const HUD_RINGSNUM: C2RustUnnamed_12 = 2;
pub const HUD_RINGSNUMTICS: C2RustUnnamed_12 = 3;
pub const HUD_RINGS: C2RustUnnamed_12 = 1;
pub const HUD_TICS: C2RustUnnamed_12 = 11;
pub const HUD_TIMETICCOLON: C2RustUnnamed_12 = 10;
pub const HUD_SECONDS: C2RustUnnamed_12 = 9;
pub const HUD_TIMECOLON: C2RustUnnamed_12 = 8;
pub const HUD_MINUTES: C2RustUnnamed_12 = 7;
pub const HUD_TIME: C2RustUnnamed_12 = 6;
pub const HUD_SCORENUM: C2RustUnnamed_12 = 5;
pub const HUD_SCORE: C2RustUnnamed_12 = 4;
...
pub const NUMHUDITEMS: C2RustUnnamed_12 = 20;
pub const HUD_TIMEUP: C2RustUnnamed_12 = 17;
pub const HUD_TIMELEFTNUM: C2RustUnnamed_12 = 16;
pub const HUD_TIMELEFT: C2RustUnnamed_12 = 15;
pub const HUD_GETRINGSNUM: C2RustUnnamed_12 = 14;
pub const HUD_GETRINGS: C2RustUnnamed_12 = 13;
pub const HUD_SS_TOTALRINGS: C2RustUnnamed_12 = 12;
...
pub const hudhook_MAX: C2RustUnnamed_14 = 5;
pub const hudhook_intermission: C2RustUnnamed_14 = 4;
pub const hudhook_title: C2RustUnnamed_14 = 2;
pub const hudhook_scores: C2RustUnnamed_14 = 1;
#[inline(always)]
...
#[no_mangle]
pub static mut objectsdrawn: uint16_t = 0 as libc::c_int as uint16_t;
#[no_mangle]
pub static mut faceprefix: [*mut patch_t; 32] = [0 as *const patch_t
    as *mut patch_t; 32];
#[no_mangle]
pub static mut superprefix: [*mut patch_t; 32] = [0 as *const patch_t
    as *mut patch_t; 32];
#[no_mangle]
pub static mut sboscore: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut sbotime: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut sbocolon: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut sboperiod: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut livesback: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut stlivex: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nrec_timer: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut sborings: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut slidgame: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut slidtime: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut slidover: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut sboredrings: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut sboredtime: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut getall: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut timeup: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut hunthoming: [*mut patch_t; 6] = [0 as *const patch_t as *mut patch_t; 6];
static mut itemhoming: [*mut patch_t; 6] = [0 as *const patch_t as *mut patch_t; 6];
static mut race1: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut race2: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut race3: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut racego: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nightslink: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut curweapon: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut normring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut bouncering: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut infinityring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut autoring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut explosionring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut scatterring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut grenadering: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut railring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut jumpshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut forceshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut ringshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut watershield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut bombshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut pityshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut pinkshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut flameshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut bubbleshield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut thundershield: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut invincibility: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut sneakers: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut gravboots: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nonicon: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nonicon2: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nightopianhelper: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut linkfreeze: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut superparaloop: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut bluestat: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut byelstat: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut orngstat: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut redstat: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut yelstat: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nbracket: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nring: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nhud: [*mut patch_t; 12] = [0 as *const patch_t as *mut patch_t; 12];
static mut nsshud: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut nbon: [*mut patch_t; 12] = [0 as *const patch_t as *mut patch_t; 12];
static mut nssbon: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut narrow: [*mut patch_t; 9] = [0 as *const patch_t as *mut patch_t; 9];
static mut nredar: [*mut patch_t; 8] = [0 as *const patch_t as *mut patch_t; 8];
static mut drillbar: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut drillfill: [*mut patch_t; 3] = [0 as *const patch_t as *mut patch_t; 3];
static mut capsulebar: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut capsulefill: *mut patch_t = 0 as *const patch_t as *mut patch_t;
#[no_mangle]
pub static mut ngradeletters: [*mut patch_t; 7] = [0 as *const patch_t
    as *mut patch_t; 7];
static mut minus5sec: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut minicaps: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut gotrflag: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut gotbflag: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut fnshico: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut facefreed: [boolean; 32] = [0; 32];
#[no_mangle]
pub static mut hudinfo: [hudinfo_t; 20] = [
    {
        let mut init = hudinfo_t {
            x: 16 as libc::c_int,
            y: 176 as libc::c_int,
            f: 0x4000000 as libc::c_int | 0x2000000 as libc::c_int,
        };
        init
    },
    {
        let mut init = hudinfo_t {
            x: 16 as libc::c_int,
            y: 42 as libc::c_int,
            f: 0x4000000 as libc::c_int | 0x1000000 as libc::c_int,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = hudinfo_t {
            x: 288 as libc::c_int,
            y: 176 as libc::c_int,
            f: 0x8000000 as libc::c_int | 0x2000000 as libc::c_int,
        };
        init
    },
];
static mut luahuddrawlist_game: [huddrawlist_h; 2] = [0 as *const huddrawlist_s
    as *mut huddrawlist_s; 2];
static mut luahuddrawlist_titlecard: huddrawlist_h = 0 as *const huddrawlist_s
    as *mut huddrawlist_s;
#[no_mangle]
pub static mut linkColor: [[skincolornum_t; 12]; 3] = [
    [
        SKINCOLOR_SHAMROCK,
        SKINCOLOR_AQUA,
        SKINCOLOR_SKY,
...
#[no_mangle]
pub unsafe extern "C" fn ST_SameTeam(
    mut a: *mut player_t,
    mut b: *mut player_t,
) -> boolean {
    ...
    if (*a).spectator != 0 && (*b).spectator != 0 {
        return true_0 as libc::c_int;
    }
    if G_GametypeHasTeams() != 0 {
        return ((*a).ctfteam == (*b).ctfteam) as libc::c_int;
    }
    if G_TagGametype() != 0 {
        return ((*a).pflags as libc::c_uint & PF_TAGIT as libc::c_int as libc::c_uint
            == (*b).pflags as libc::c_uint & PF_TAGIT as libc::c_int as libc::c_uint)
            as libc::c_int;
    }
    return false_0 as libc::c_int;
}
static mut st_stopped: boolean = true_0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn ST_Ticker(mut run: boolean) {
    if st_stopped != 0 {
        return;
    }
    if run != 0 {
...
#[no_mangle]
pub static mut st_palette: int32_t = 0 as libc::c_int;
#[no_mangle]
pub static mut st_translucency: int32_t = 10 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn ST_doPaletteStuff() {
    let mut palette: int32_t = 0;
    if !stplyr.is_null() && (*stplyr).flashcount as libc::c_int != 0 {
        palette = (*stplyr).flashpal as int32_t;
    } else {
...
pub unsafe extern "C" fn ST_UnloadGraphics() {
    Patch_FreeTags(PU_HUDGFX as libc::c_int, PU_HUDGFX as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ST_LoadGraphics() {
    let mut i: libc::c_int = 0;
    sborings = W_CachePatchName(
        b"STTRINGS\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sboredrings = W_CachePatchName(
        b"STTRRING\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sboscore = W_CachePatchName(
        b"STTSCORE\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sbotime = W_CachePatchName(
        b"STTTIME\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sboredtime = W_CachePatchName(
        b"STTRTIME\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sbocolon = W_CachePatchName(
        b"STTCOLON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sboperiod = W_CachePatchName(
        b"STTPERIO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    slidgame = W_CachePatchName(
        b"SLIDGAME\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    slidtime = W_CachePatchName(
        b"SLIDTIME\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    slidover = W_CachePatchName(
        b"SLIDOVER\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    stlivex = W_CachePatchName(
        b"STLIVEX\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    livesback = W_CachePatchName(
        b"STLIVEBK\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nrec_timer = W_CachePatchName(
        b"NGRTIMER\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    getall = W_CachePatchName(
        b"GETALL\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    timeup = W_CachePatchName(
        b"TIMEUP\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    race1 = W_CachePatchName(
        b"RACE1\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    race2 = W_CachePatchName(
        b"RACE2\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    race3 = W_CachePatchName(
        b"RACE3\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    racego = W_CachePatchName(
        b"RACEGO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nightslink = W_CachePatchName(
        b"NGHTLINK\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        hunthoming[i
            ...
            va(b"HOMING%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        itemhoming[i
            as usize] = W_CachePatchName(
            va(b"HOMITM%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        i += 1;
        i;
    }
    curweapon = W_CachePatchName(
        b"CURWEAP\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    normring = W_CachePatchName(
        b"RINGIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bouncering = W_CachePatchName(
        b"BNCEIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    infinityring = W_CachePatchName(
        b"INFNIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    autoring = W_CachePatchName(
        b"AUTOIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    explosionring = W_CachePatchName(
        b"BOMBIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    scatterring = W_CachePatchName(
        b"SCATIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    grenadering = W_CachePatchName(
        b"GRENIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    railring = W_CachePatchName(
        b"RAILIND\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    jumpshield = W_CachePatchName(
        b"TVWWICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    forceshield = W_CachePatchName(
        b"TVFOICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    ringshield = W_CachePatchName(
        b"TVATICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    watershield = W_CachePatchName(
        b"TVELICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bombshield = W_CachePatchName(
        b"TVARICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    pityshield = W_CachePatchName(
        b"TVPIICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    pinkshield = W_CachePatchName(
        b"TVPPICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    flameshield = W_CachePatchName(
        b"TVFLICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bubbleshield = W_CachePatchName(
        b"TVBBICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    thundershield = W_CachePatchName(
        b"TVZPICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    invincibility = W_CachePatchName(
        b"TVIVICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    sneakers = W_CachePatchName(
        b"TVSSICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    gravboots = W_CachePatchName(
        b"TVGVICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    tagico = W_CachePatchName(
        b"TAGICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    gotrflag = W_CachePatchName(
        b"GOTRFLAG\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    gotbflag = W_CachePatchName(
        b"GOTBFLAG\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    fnshico = W_CachePatchName(
        b"FNSHICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nonicon = W_CachePatchName(
        b"NONICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nonicon2 = W_CachePatchName(
        b"NONICON2\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nightopianhelper = W_CachePatchName(
        b"NHLPICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    linkfreeze = W_CachePatchName(
        b"NLFZICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    superparaloop = W_CachePatchName(
        b"NSPRICON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bluestat = W_CachePatchName(
        b"BLUESTAT\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    byelstat = W_CachePatchName(
        b"BYELSTAT\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    orngstat = W_CachePatchName(
        b"ORNGSTAT\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    redstat = W_CachePatchName(
        b"REDSTAT\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    yelstat = W_CachePatchName(
        b"YELSTAT\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nbracket = W_CachePatchName(
        b"NBRACKET\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nring = W_CachePatchName(
        b"NRNG1\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    i = 0 as libc::c_int;
    while i < 12 as libc::c_int {
        nhud[i
            as usize] = W_CachePatchName(
            va(b"NHUD%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        nbon[i
            as usize] = W_CachePatchName(
            va(b"NBON%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        i += 1;
        i;
    }
    nsshud = W_CachePatchName(
        b"NSSHUD\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    nssbon = W_CachePatchName(
        b"NSSBON\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    minicaps = W_CachePatchName(
        b"MINICAPS\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    i = 0 as libc::c_int;
    while i < 8 as libc::c_int {
        narrow[i
            as usize] = W_CachePatchName(
            va(b"NARROW%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        nredar[i
            as usize] = W_CachePatchName(
            va(b"NREDAR%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        i += 1;
        i;
    }
    narrow[8 as libc::c_int
        as usize] = W_CachePatchName(
        b"NARROW9\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    drillbar = W_CachePatchName(
        b"DRILLBAR\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        drillfill[i
            as usize] = W_CachePatchName(
            va(b"DRILLFI%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        i += 1;
        i;
    }
    capsulebar = W_CachePatchName(
        b"CAPSBAR\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    capsulefill = W_CachePatchName(
        b"CAPSFILL\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    minus5sec = W_CachePatchName(
        b"MINUS5\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    i = 0 as libc::c_int;
    while i < 7 as libc::c_int {
        ngradeletters[i
            as usize] = W_CachePatchName(
            va(b"GRADE%d\0" as *const u8 as *const libc::c_char, i),
            PU_HUDGFX as libc::c_int,
        ) as *mut patch_t;
        i += 1;
        i;
...
#[no_mangle]
pub unsafe extern "C" fn ST_LoadFaceGraphics(mut skinnum: int32_t) {
        ...
        > 0 as libc::c_int as size_t
    {
        ...
        if skins[skinnum as usize]
            .sprites[(SPR2_XTRA as libc::c_int | 0x80 as libc::c_int) as usize]
            .numframes > 0 as libc::c_int as size_t
        {
            sprdef = &mut *((*skins.as_mut_ptr().offset(skinnum as isize)).sprites)
                .as_mut_ptr()
                .offset((SPR2_XTRA as libc::c_int | 0x80 as libc::c_int) as isize)
                as *mut spritedef_t;
            ...
            superprefix[skinnum as usize] = faceprefix[skinnum as usize];
        }
    } else {
        superprefix[skinnum
            as usize] = W_CachePatchName(
        ...
        faceprefix[skinnum as usize] = superprefix[skinnum as usize];
    }
    facefreed[skinnum as usize] = false_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ST_ReloadSkinFaceGraphics() {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < numskins {
...
#[inline]
unsafe extern "C" fn ST_InitData() {
    stplyr = &mut *players.as_mut_ptr().offset(displayplayer as isize) as *mut player_t;
    st_palette = -(1 as libc::c_int);
}
#[inline]
unsafe extern "C" fn ST_Stop() {
    if st_stopped != 0 {
        return;
    }
    V_SetPalette(0 as libc::c_int);
    st_stopped = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ST_Start() {
    ...
    ST_InitData();
    st_stopped = false_0 as libc::c_int;
}
#[no_mangle]
pub static mut st_borderpatchnum: lumpnum_t = 0;
#[no_mangle]
pub unsafe extern "C" fn ST_Init() {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        facefreed[i as usize] = true_0 as libc::c_int;
        i += 1;
        i;
    }
    if dedicated != 0 {
    ...
    ST_LoadGraphics();
    luahuddrawlist_game[0 as libc::c_int as usize] = LUA_HUD_CreateDrawList();
    luahuddrawlist_game[1 as libc::c_int as usize] = LUA_HUD_CreateDrawList();
    luahuddrawlist_titlecard = LUA_HUD_CreateDrawList();
}
#[no_mangle]
pub unsafe extern "C" fn ST_changeDemoView() {
    ST_Start();
}
#[no_mangle]
pub static mut st_overlay: boolean = 0;
unsafe extern "C" fn ST_DrawNightsOverlayNum(
    mut x: fixed_t,
    mut y: fixed_t,
    mut s: fixed_t,
    mut a: int32_t,
    mut num: uint32_t,
    mut numpat: *mut *mut patch_t,
    mut colornum: skincolornum_t,
) {
    let mut w: fixed_t = (**numpat.offset(0 as libc::c_int as isize)).width
        as libc::c_int * s;
    let mut colormap: *const uint8_t = 0 as *const uint8_t;
    if colornum as libc::c_uint == 0 as libc::c_int as libc::c_uint {
        colormap = colormaps;
    } else {
    ...
    loop {
        ...
        V_DrawStretchyFixedPatch(
            ...
            s,
            a,
            *numpat.offset((num % 10 as libc::c_int as uint32_t) as isize),
            colormap,
        );
        num = num / 10 as libc::c_int as uint32_t;
        if !(num != 0) {
            break;
        }
    };
}
unsafe extern "C" fn ST_drawDebugInfo() {
    let mut height: int32_t = 0 as libc::c_int;
    let mut h: int32_t = 8 as libc::c_int;
    let mut w: int32_t = 18 as libc::c_int;
    let mut lowh: int32_t = 0;
    let mut textfunc: Option::<
        unsafe extern "C" fn(int32_t, int32_t, int32_t, *const libc::c_char) -> (),
    > = None;
    if !(!((*stplyr).mo).is_null() && cv_debug != 0) {
        return;
    }
    if moviemode as libc::c_uint == MM_GIF as libc::c_int as libc::c_uint
        && cv_gif_downscale.value != 0 || vid.dupx == 1 as libc::c_int
    {
        textfunc = Some(
        ...
        lowh = vid.height / vid.dupy - 16 as libc::c_int;
    } else {
        textfunc = Some(
        ...
        h /= 2 as libc::c_int;
        w /= 2 as libc::c_int;
        lowh = 0 as libc::c_int;
    }
    if cv_debug & 0x200 as libc::c_int != 0 {
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
                320 as libc::c_int,
                8 as libc::c_int + lowh,
                0xc00 as libc::c_int | 0x1000000 as libc::c_int
                    | 0x8000000 as libc::c_int | 0x5000 as libc::c_int,
                b"SOME INFO NOT VISIBLE\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
        textfunc
            ...
            320 as libc::c_int,
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"Heap: %8sKB\0" as *const u8 as *const libc::c_char,
                sizeu1(
                    Z_TagsUsage(0 as libc::c_int, 2147483647 as libc::c_int)
                        >> 10 as libc::c_int,
                ),
            ),
        );
        height += h;
        height += h / 2 as libc::c_int;
    }
    if cv_debug & 0x1000 as libc::c_int != 0 {
        let mut peekres: fixed_t = P_RandomPeek();
        peekres *= 10000 as libc::c_int;
        peekres >>= 16 as libc::c_int;
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
                320 as libc::c_int,
                8 as libc::c_int + lowh,
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"Init: %08x\0" as *const u8 as *const libc::c_char, P_GetInitSeed()),
        );
        height += h;
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"Seed: %08x\0" as *const u8 as *const libc::c_char, P_GetRandSeed()),
        );
        height += h;
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"==  :    .%04d\0" as *const u8 as *const libc::c_char, peekres),
        );
        height += h;
        height += h / 2 as libc::c_int;
    }
    if cv_debug & 0x4 as libc::c_int != 0 {
        let mut width: int32_t = 320 as libc::c_int;
        let d: fixed_t = AngleFixed((*stplyr).drawangle);
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
                320 as libc::c_int,
                8 as libc::c_int + lowh,
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"SHIELD: %5x\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_shield as libc::c_int as usize] as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"SCALE: %5d%%\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).scale * 100 as libc::c_int >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"CARRY: %5x\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_carry as libc::c_int as usize] as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"AIR: %4d, %3d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_underwater as libc::c_int as usize] as libc::c_int,
                (*stplyr).powers[pw_spacetime as libc::c_int as usize] as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"ABILITY: %3d, %3d\0" as *const u8 as *const libc::c_char,
                (*stplyr).charability as libc::c_int,
                (*stplyr).charability2 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"ACTIONSPD: %5d\0" as *const u8 as *const libc::c_char,
                (*stplyr).actionspd >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"PEEL: %3d\0" as *const u8 as *const libc::c_char, (*stplyr).dashmode),
        );
        height += h;
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"SCOREADD: %3d\0" as *const u8 as *const libc::c_char,
                (*stplyr).scoreadd as libc::c_int,
            ),
        );
        height += h;
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*stplyr).pflags as libc::c_uint
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*stplyr).pflags as libc::c_uint
                    & PF_STARTJUMP as libc::c_int as libc::c_uint != 0
                {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | 0 as libc::c_int,
            b"PF/SF:\0" as *const u8 as *const libc::c_char,
        );
        width -= w;
        height += h;
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*stplyr).charflags & SF_SUPER as libc::c_int as uint32_t != 0 {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
                }),
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*stplyr).pflags as libc::c_uint
                    & PF_APPLYAUTOBRAKE as libc::c_int as libc::c_uint != 0
                {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"DRAWANGLE: %6d\0" as *const u8 as *const libc::c_char, FixedInt(d)),
        );
        height += h;
        height += h / 2 as libc::c_int;
    }
    if cv_debug & 0x2 as libc::c_int != 0 {
        let mut width_0: int32_t = 320 as libc::c_int;
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
                320 as libc::c_int,
                8 as libc::c_int + lowh,
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"CEILINGZ: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).ceilingz >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"FLOORZ: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).floorz >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"CMOMX: %6d\0" as *const u8 as *const libc::c_char,
                (*stplyr).cmomx >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"CMOMY: %6d\0" as *const u8 as *const libc::c_char,
                (*stplyr).cmomy >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"PMOMZ: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).pmomz >> 16 as libc::c_int,
            ),
        );
        height += h;
        width_0 = 320 as libc::c_int;
        textfunc
            .expect(
                "non-null function pointer",
            )(
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int
                    & MFE_APPLYPMOMZ as libc::c_int != 0
                {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int & MFE_SPRUNG as libc::c_int
                    != 0
                {
                    0x3000 as libc::c_int
                } else {
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int & MFE_GOOWATER as libc::c_int
                    != 0
                {
                    0x3000 as libc::c_int
                } else {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int
                    & MFE_JUSTSTEPPEDDOWN as libc::c_int != 0
                {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int
                    & MFE_TOUCHWATER as libc::c_int != 0
                {
                    0x3000 as libc::c_int
                } else {
                    0x5000 as libc::c_int
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | (if (*(*stplyr).mo).eflags as libc::c_int & MFE_ONGROUND as libc::c_int
                    != 0
                {
                    0x3000 as libc::c_int
                } else {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int
                | 0 as libc::c_int,
            b"MFE:\0" as *const u8 as *const libc::c_char,
        );
        width_0 -= w;
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"MOMX: %6d\0" as *const u8 as *const libc::c_char,
                (*stplyr).rmomx >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"MOMY: %6d\0" as *const u8 as *const libc::c_char,
                (*stplyr).rmomy >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"MOMZ: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).momz >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"SPEED: %6d\0" as *const u8 as *const libc::c_char,
                (*stplyr).speed >> 16 as libc::c_int,
            ),
        );
        height += h;
        height += h / 2 as libc::c_int;
    }
    if cv_debug & 0x1 as libc::c_int != 0 {
        let d_0: fixed_t = AngleFixed((*(*stplyr).mo).angle);
        if lowh != 0 && height > lowh {
            V_DrawRightAlignedThinString(
                320 as libc::c_int,
                8 as libc::c_int + lowh,
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"X: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).x >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"Y: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).y >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(
                b"Z: %6d\0" as *const u8 as *const libc::c_char,
                (*(*stplyr).mo).z >> 16 as libc::c_int,
            ),
        );
        height += h;
        if lowh != 0 && height > lowh {
        ...
        textfunc
            ...
            height,
            0xc00 as libc::c_int | 0x1000000 as libc::c_int | 0x8000000 as libc::c_int,
            va(b"A: %6d\0" as *const u8 as *const libc::c_char, FixedInt(d_0)),
        );
        height += h;
    }
}
unsafe extern "C" fn ST_drawScore() {
    if F_GetPromptHideHud(hudinfo[HUD_SCORE as libc::c_int as usize].y) != 0 {
        return;
    }
    V_DrawStretchyFixedPatch(
        hudinfo[HUD_SCORE as libc::c_int as usize].x
            * ((1 as libc::c_int) << 16 as libc::c_int),
        hudinfo[HUD_SCORE as libc::c_int as usize].y << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (hudinfo[HUD_SCORE as libc::c_int as usize].f as libc::c_uint
            | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
            as int32_t,
        sboscore,
        0 as *const uint8_t,
    );
    if objectplacing != 0 {
        if op_displayflags > 65535 as libc::c_int as uint32_t {
            V_DrawStretchyFixedPatch(
                (hudinfo[HUD_SCORENUM as libc::c_int as usize].x
                    - (*tallminus).width as libc::c_int)
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                hudinfo[HUD_SCORENUM as libc::c_int as usize].y << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                tallminus,
                0 as *const uint8_t,
            );
        } else {
            V_DrawTallNum(
                hudinfo[HUD_SCORENUM as libc::c_int as usize].x,
                hudinfo[HUD_SCORENUM as libc::c_int as usize].y,
                (hudinfo[HUD_SCORENUM as libc::c_int as usize].f as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                op_displayflags as int32_t,
            );
        }
    } else {
        V_DrawTallNum(
            ...
            (hudinfo[HUD_SCORENUM as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
                as int32_t,
            (*stplyr).score as int32_t,
        );
    };
}
unsafe extern "C" fn ST_drawRaceNum(mut time: int32_t) {
    let mut height: int32_t = 0;
    let mut bounce: int32_t = 0;
    let mut racenum: *mut patch_t = 0 as *mut patch_t;
    time += 35 as libc::c_int;
    height = (3 as libc::c_int * 200 as libc::c_int >> 2 as libc::c_int)
        - 8 as libc::c_int;
    bounce = 35 as libc::c_int - (1 as libc::c_int + time % 35 as libc::c_int);
    match time / 35 as libc::c_int {
        3 => {
            racenum = race3;
        }
        2 => {
    ...
    if bounce < 3 as libc::c_int {
        height -= 2 as libc::c_int - bounce;
        if !(P_AutoPause() != 0 || paused as libc::c_int != 0) && bounce == 0 {
            S_StartSound(
                0 as *const libc::c_void,
                (if racenum == racego {
                    sfx_s3kad as libc::c_int
                } else {
                    sfx_s3ka7 as libc::c_int
                }) as sfxenum_t,
            );
        }
    }
    V_DrawStretchyFixedPatch(
        (320 as libc::c_int - (*racenum).width as libc::c_int) / 2 as libc::c_int
            * ((1 as libc::c_int) << 16 as libc::c_int),
        height << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        0x80000000 as libc::c_uint as int32_t,
        racenum,
        0 as *const uint8_t,
    );
}
unsafe extern "C" fn ST_drawTime() {
    let mut seconds: int32_t = 0;
    let mut minutes: int32_t = 0;
    let mut tictrn: int32_t = 0;
    let mut tics: int32_t = 0;
    let mut downwards: boolean = false_0 as libc::c_int;
    if objectplacing != 0 {
        tics = objectsdrawn as int32_t;
        seconds = objectsdrawn as libc::c_int % 100 as libc::c_int;
        minutes = objectsdrawn as libc::c_int / 100 as libc::c_int;
        tictrn = 0 as libc::c_int;
    } else {
        if gametyperules & GTR_STARTCOUNTDOWN as libc::c_int as uint32_t != 0
            && (*stplyr).realtime <= hidetime * 35 as libc::c_int as tic_t
        {
            tics = (hidetime * 35 as libc::c_int as tic_t)
                .wrapping_sub((*stplyr).realtime) as int32_t;
            if tics < 3 as libc::c_int * 35 as libc::c_int {
                ST_drawRaceNum(tics);
            }
            tics += 35 as libc::c_int - 1 as libc::c_int;
            downwards = true_0 as libc::c_int;
        } else {
            if gametyperules & GTR_STARTCOUNTDOWN as libc::c_int as uint32_t != 0
                && (*stplyr).realtime
                    < hidetime.wrapping_add(1 as libc::c_int as tic_t)
                        * 35 as libc::c_int as tic_t
            {
                ST_drawRaceNum(
                    (hidetime * 35 as libc::c_int as tic_t)
                        .wrapping_sub((*stplyr).realtime) as int32_t,
                );
            }
            if gametyperules & GTR_TIMELIMIT as libc::c_int as uint32_t != 0
                && cv_timelimit.value != 0
                && timelimitintics > 0 as libc::c_int as uint32_t
            {
                if timelimitintics > (*stplyr).realtime {
                    tics = timelimitintics.wrapping_sub((*stplyr).realtime) as int32_t;
                    if tics < 3 as libc::c_int * 35 as libc::c_int {
                        ST_drawRaceNum(tics);
                    }
                    tics += 35 as libc::c_int - 1 as libc::c_int;
                } else {
                    tics = 0 as libc::c_int;
                }
                downwards = true_0 as libc::c_int;
            } else if gametyperules & GTR_STARTCOUNTDOWN as libc::c_int as uint32_t != 0
            {
                tics = ((*stplyr).realtime)
                    .wrapping_sub(hidetime * 35 as libc::c_int as tic_t) as int32_t;
            } else if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
                as usize])
                .countdown != 0
            {
                tics = countdowntimer as int32_t;
                downwards = true_0 as libc::c_int;
            } else {
                tics = (*stplyr).realtime as int32_t;
            }
        }
        minutes = G_TicsToMinutes(tics as tic_t, true_0 as libc::c_int);
        seconds = G_TicsToSeconds(tics as tic_t);
        tictrn = G_TicsToCentiseconds(tics as tic_t);
    }
    if F_GetPromptHideHud(hudinfo[HUD_TIME as libc::c_int as usize].y) != 0 {
        return;
    }
    downwards = (downwards != 0 && tics < 30 as libc::c_int * 35 as libc::c_int
        && leveltime / 5 as libc::c_int as tic_t & 1 as libc::c_int as tic_t != 0
        && stoppedclock == 0) as libc::c_int;
    V_DrawStretchyFixedPatch(
        hudinfo[HUD_TIME as libc::c_int as usize].x
            * ((1 as libc::c_int) << 16 as libc::c_int),
        hudinfo[HUD_TIME as libc::c_int as usize].y << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (hudinfo[HUD_TIME as libc::c_int as usize].f as libc::c_uint
            | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
            as int32_t,
        if downwards != 0 { sboredtime } else { sbotime },
        0 as *const uint8_t,
    );
    if downwards != 0 {
        return;
    }
    if cv_timetic.value == 3 as libc::c_int {
        V_DrawTallNum(
            hudinfo[HUD_SECONDS as libc::c_int as usize].x,
            hudinfo[HUD_SECONDS as libc::c_int as usize].y,
            (hudinfo[HUD_SECONDS as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
                as int32_t,
            tics,
        );
        ...
        V_DrawTallNum(
            hudinfo[HUD_MINUTES as libc::c_int as usize].x,
            hudinfo[HUD_MINUTES as libc::c_int as usize].y,
            (hudinfo[HUD_MINUTES as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
                as int32_t,
            minutes,
        );
        V_DrawStretchyFixedPatch(
            hudinfo[HUD_TIMECOLON as libc::c_int as usize].x
                * ((1 as libc::c_int) << 16 as libc::c_int),
            hudinfo[HUD_TIMECOLON as libc::c_int as usize].y << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (hudinfo[HUD_TIMECOLON as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
                as int32_t,
            sbocolon,
            0 as *const uint8_t,
        ...
        if cv_timetic.value == 1 as libc::c_int || cv_timetic.value == 2 as libc::c_int
            || modeattacking as libc::c_int != 0 || marathonmode as libc::c_uint != 0
        {
            V_DrawStretchyFixedPatch(
                hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].x
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].y << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].f as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                sboperiod,
                0 as *const uint8_t,
            ...
            V_DrawPaddedTallNum(
                hudinfo[HUD_TICS as libc::c_int as usize].x,
                hudinfo[HUD_TICS as libc::c_int as usize].y,
                (hudinfo[HUD_TICS as libc::c_int as usize].f as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                tictrn,
                2 as libc::c_int,
...
#[inline]
unsafe extern "C" fn ST_drawRings() {
    let mut ringnum: int32_t = 0;
    if F_GetPromptHideHud(hudinfo[HUD_RINGS as libc::c_int as usize].y) != 0 {
        return;
    }
    V_DrawStretchyFixedPatch(
        hudinfo[HUD_RINGS as libc::c_int as usize].x
            * ((1 as libc::c_int) << 16 as libc::c_int),
        hudinfo[HUD_RINGS as libc::c_int as usize].y << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (hudinfo[HUD_RINGS as libc::c_int as usize].f as libc::c_uint
            | 0x80000000 as libc::c_uint
            | (if (*stplyr).spectator != 0 {
                0xa0000 as libc::c_int
            } else {
                0xb0000 as libc::c_int
            }) as libc::c_uint) as int32_t,
        if (*stplyr).spectator == 0 && (*stplyr).rings as libc::c_int <= 0 as libc::c_int
            && leveltime / 5 as libc::c_int as tic_t & 1 as libc::c_int as tic_t != 0
        {
            sboredrings
        } else {
    ...
    if objectplacing != 0 {
        ringnum = op_currentdoomednum as int32_t;
    } else if ((*stplyr).rings as libc::c_int) < 0 as libc::c_int
        || (*stplyr).spectator != 0
        || (*stplyr).playerstate as libc::c_uint
            == PST_REBORN as libc::c_int as libc::c_uint
    {
        ringnum = 0 as libc::c_int;
    } else {
        ringnum = (*stplyr).rings as int32_t;
    }
    if cv_timetic.value == 2 as libc::c_int {
        V_DrawTallNum(
            hudinfo[HUD_RINGSNUMTICS as libc::c_int as usize].x,
            hudinfo[HUD_RINGSNUMTICS as libc::c_int as usize].y,
            (hudinfo[HUD_RINGSNUMTICS as libc::c_int as usize].f as libc::c_uint
        ...
        V_DrawTallNum(
            hudinfo[HUD_RINGSNUM as libc::c_int as usize].x,
            hudinfo[HUD_RINGSNUM as libc::c_int as usize].y,
            (hudinfo[HUD_RINGSNUM as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0x80000000 as libc::c_uint
                | (if (*stplyr).spectator != 0 {
                    0xa0000 as libc::c_int
                } else {
...
unsafe extern "C" fn ST_drawLivesArea() {
    let mut v_colmap: int32_t = 0x2000 as libc::c_int;
    let mut livescount: int32_t = 0;
    let mut notgreyedout: boolean = false_0 as libc::c_int;
    if (*stplyr).skincolor == 0 {
        return;
    }
    if F_GetPromptHideHud(hudinfo[HUD_LIVES as libc::c_int as usize].y) != 0 {
        return;
    }
    V_DrawStretchyFixedPatch(
        hudinfo[HUD_LIVES as libc::c_int as usize].x << 16 as libc::c_int,
        hudinfo[HUD_LIVES as libc::c_int as usize].y << 16 as libc::c_int,
        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
        (hudinfo[HUD_LIVES as libc::c_int as usize].f as libc::c_uint
            | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
            as int32_t,
        livesback,
        0 as *const uint8_t,
    ...
    if (*stplyr).spectator != 0 {
        ...
        V_DrawStretchyFixedPatch(
            ...
            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            (hudinfo[HUD_LIVES as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xa0000 as libc::c_int as libc::c_uint)
                as int32_t,
            faceprefix[(*stplyr).skin as usize],
            colormap,
        );
    } else if !((*stplyr).mo).is_null() && (*(*stplyr).mo).color as libc::c_int != 0 {
        let mut colormap_0: *mut uint8_t = R_GetTranslationColormap(
            (*stplyr).skin,
            (*(*stplyr).mo).color as skincolornum_t,
            1 as libc::c_int as uint8_t,
        );
        let mut face: *mut patch_t = faceprefix[(*stplyr).skin as usize];
        if (*stplyr).powers[pw_super as libc::c_int as usize] as libc::c_int != 0
            && (*stplyr).charflags & SF_NOSUPERSPRITES as libc::c_int as uint32_t == 0
        {
            face = superprefix[(*stplyr).skin as usize];
        }
        V_DrawStretchyFixedPatch(
            hudinfo[HUD_LIVES as libc::c_int as usize].x << 16 as libc::c_int,
            hudinfo[HUD_LIVES as libc::c_int as usize].y << 16 as libc::c_int,
        ...
        if st_translucency == 10 as libc::c_int
            && (*stplyr).powers[pw_super as libc::c_int as usize] as libc::c_int
                == 1 as libc::c_int && !((*(*stplyr).mo).tracer).is_null()
        {
            let mut v_supertrans: int32_t = (((*(*(*stplyr).mo).tracer).frame
                & 0xf0000 as libc::c_int as uint32_t) >> 16 as libc::c_int) as int32_t;
            if v_supertrans < 10 as libc::c_int {
                v_supertrans <<= 16 as libc::c_int;
                colormap_0 = R_GetTranslationColormap(
                    (*stplyr).skin,
                    (*(*(*stplyr).mo).tracer).color as skincolornum_t,
                    1 as libc::c_int as uint8_t,
                );
                V_DrawStretchyFixedPatch(
                    hudinfo[HUD_LIVES as libc::c_int as usize].x << 16 as libc::c_int,
                    ...
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    (hudinfo[HUD_LIVES as libc::c_int as usize].f as libc::c_uint
                        | 0x80000000 as libc::c_uint | v_supertrans as libc::c_uint)
                        as int32_t,
                    face,
                    colormap_0,
                );
    ...
    } else if (*stplyr).skincolor != 0 {
        let mut colormap_1: *mut uint8_t = R_GetTranslationColormap(
            (*stplyr).skin,
            (*stplyr).skincolor as skincolornum_t,
            1 as libc::c_int as uint8_t,
        );
        V_DrawStretchyFixedPatch(
            hudinfo[HUD_LIVES as libc::c_int as usize].x << 16 as libc::c_int,
    ...
    if metalrecording != 0 {
        if 2 as libc::c_int as tic_t * leveltime / 35 as libc::c_int as tic_t
            & 1 as libc::c_int as tic_t != 0
        {
            V_DrawRightAlignedString(
                hudinfo[HUD_LIVES as libc::c_int as usize].x + 58 as libc::c_int,
                hudinfo[HUD_LIVES as libc::c_int as usize].y + 8 as libc::c_int,
                (hudinfo[HUD_LIVES as libc::c_int as usize].f as libc::c_uint
                    | 0x80000000 as libc::c_uint | 0x5000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                b"REC\0" as *const u8 as *const libc::c_char,
            );
        }
    } else if (*stplyr).spectator != 0 {
        v_colmap = 0x6000 as libc::c_int;
    } else {
        let mut candrawlives: boolean = false_0 as libc::c_int;
        if G_TagGametype() != 0
            && (*stplyr).pflags as libc::c_uint & PF_TAGIT as libc::c_int as libc::c_uint
                != 0
        {
            v_colmap = 0x7000 as libc::c_int;
        } else if G_GametypeHasTeams() != 0 {
            if (*stplyr).ctfteam == 1 as libc::c_int {
                v_colmap = 0x5000 as libc::c_int;
            } else if (*stplyr).ctfteam == 2 as libc::c_int {
                v_colmap = 0x4000 as libc::c_int;
            }
        }
        if G_GametypeUsesLives() != 0 {
            ...
            {
                let mut i: int32_t = 0;
                livescount = 0 as libc::c_int;
                notgreyedout = ((*stplyr).lives as libc::c_int > 0 as libc::c_int)
                    as libc::c_int;
                i = 0 as libc::c_int;
                while i < 32 as libc::c_int {
                    if !(playeringame[i as usize] == 0) {
                            ...
                            < 1 as libc::c_int)
                        {
                            if players[i as usize].lives as libc::c_int
                                > 1 as libc::c_int
                            {
                                notgreyedout = true_0 as libc::c_int;
                            }
                            if players[i as usize].lives as libc::c_int
                                == 0x7f as libc::c_int
                            {
                                livescount = 0x7f as libc::c_int;
                                break;
                            } else if livescount < 99 as libc::c_int {
                                livescount += players[i as usize].lives as libc::c_int;
                            }
                        }
                    }
                    i += 1;
                ...
                livescount = if (netgame != 0 || multiplayer != 0)
                    && G_GametypeUsesCoopLives() != 0
                    && cv_cooplives.value == 0 as libc::c_int
                {
                    0x7f as libc::c_int
                } else {
                    (*stplyr).lives as libc::c_int
                };
                notgreyedout = true_0 as libc::c_int;
            }
            candrawlives = true_0 as libc::c_int;
        } else if G_PlatformGametype() != 0
        ...
        if candrawlives != 0 {
            V_DrawStretchyFixedPatch(
                (hudinfo[HUD_LIVES as libc::c_int as usize].x + 22 as libc::c_int)
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                (hudinfo[HUD_LIVES as libc::c_int as usize].y + 10 as libc::c_int)
                    << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (hudinfo[HUD_LIVES as libc::c_int as usize].f as libc::c_uint
            ...
            if livescount == 0x7f as libc::c_int {
                V_DrawCharacter(
                    hudinfo[HUD_LIVES as libc::c_int as usize].x + 50 as libc::c_int,
                    hudinfo[HUD_LIVES as libc::c_int as usize].y + 8 as libc::c_int,
                    (('\u{16}' as i32 | 0x80 as libc::c_int
                        | hudinfo[HUD_LIVES as libc::c_int as usize].f) as libc::c_uint
                        | 0x80000000 as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                ...
                if (*stplyr).playerstate as libc::c_uint
                    == PST_DEAD as libc::c_int as libc::c_uint
                    && (*stplyr).spectator == 0
                    && (livescount != 0
                        || (*stplyr).deadtimer < (35 as libc::c_int) << 1 as libc::c_int)
                    && (*stplyr).pflags as libc::c_uint
                        & PF_FINISHED as libc::c_int as libc::c_uint == 0
                {
                    livescount += 1;
                    livescount;
                }
                if livescount > 99 as libc::c_int {
                    livescount = 99 as libc::c_int;
                }
                V_DrawRightAlignedString(
                    hudinfo[HUD_LIVES as libc::c_int as usize].x + 58 as libc::c_int,
                    hudinfo[HUD_LIVES as libc::c_int as usize].y + 8 as libc::c_int,
                    ...
                    va(b"%d\0" as *const u8 as *const libc::c_char, livescount),
                );
            }
                ...
                != 0
        {
            V_DrawRightAlignedString(
                hudinfo[HUD_LIVES as libc::c_int as usize].x + 58 as libc::c_int,
                hudinfo[HUD_LIVES as libc::c_int as usize].y + 8 as libc::c_int,
                ((0xb0000 as libc::c_int | hudinfo[HUD_LIVES as libc::c_int as usize].f)
                    as libc::c_uint | 0x80000000 as libc::c_uint) as int32_t,
    ...
    v_colmap = (v_colmap as libc::c_uint
        | ((0xb0000 as libc::c_int | hudinfo[HUD_LIVES as libc::c_int as usize].f)
            as libc::c_uint | 0x80000000 as libc::c_uint)) as int32_t;
    if strlen((skins[(*stplyr).skin as usize].hudname).as_mut_ptr())
        <= 5 as libc::c_int as libc::c_ulong
    {
        V_DrawRightAlignedString(
            hudinfo[HUD_LIVES as libc::c_int as usize].x + 58 as libc::c_int,
            hudinfo[HUD_LIVES as libc::c_int as usize].y,
            v_colmap,
            (skins[(*stplyr).skin as usize].hudname).as_mut_ptr(),
        );
    } else if V_StringWidth(
        (skins[(*stplyr).skin as usize].hudname).as_mut_ptr(),
        v_colmap,
    ) <= 48 as libc::c_int
    {
        V_DrawString(
            hudinfo[HUD_LIVES as libc::c_int as usize].x + 18 as libc::c_int,
            hudinfo[HUD_LIVES as libc::c_int as usize].y,
            v_colmap,
            (skins[(*stplyr).skin as usize].hudname).as_mut_ptr(),
        );
    ...
    if G_RingSlingerGametype() != 0 && LUA_HudEnabled(hud_powerstones) != 0 {
        let mut workx: int32_t = hudinfo[HUD_LIVES as libc::c_int as usize].x
            + 1 as libc::c_int;
        let mut j: int32_t = 0;
        if leveltime & 1 as libc::c_int as tic_t != 0
            && (*stplyr).powers[pw_invulnerability as libc::c_int as usize]
                as libc::c_int != 0
            && (*stplyr).powers[pw_sneakers as libc::c_int as usize] as libc::c_int
                == (*stplyr).powers[pw_invulnerability as libc::c_int as usize]
                    as libc::c_int
        {
            j = 0 as libc::c_int;
            while j < 7 as libc::c_int {
                V_DrawStretchyFixedPatch(
                    ...
                    (hudinfo[HUD_LIVES as libc::c_int as usize].y - 9 as libc::c_int)
                        << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    ((0xb0000 as libc::c_int
            ...
            j = 0 as libc::c_int;
            while j < 7 as libc::c_int {
                if (*stplyr).powers[pw_emeralds as libc::c_int as usize] as libc::c_int
                    & (1 as libc::c_int) << j != 0
                {
                    V_DrawStretchyFixedPatch(
                        workx * ((1 as libc::c_int) << 16 as libc::c_int),
...
unsafe extern "C" fn ST_drawInput() {
    let accent: int32_t = 0x4000000 as libc::c_int | 0x2000000 as libc::c_int
        | (if (*stplyr).skincolor as libc::c_int != 0 {
            skincolors[(*stplyr).skincolor as usize].ramp[4 as libc::c_int as usize]
                as libc::c_int
        } else {
            0 as libc::c_int
        });
    let mut col: int32_t = 0;
    let mut offs: uint8_t = 0;
    let mut x: int32_t = hudinfo[HUD_LIVES as libc::c_int as usize].x;
    let mut y: int32_t = hudinfo[HUD_LIVES as libc::c_int as usize].y;
    if (*stplyr).powers[pw_carry as libc::c_int as usize] as libc::c_int
        == CR_NIGHTSMODE as libc::c_int
    {
        y -= 16 as libc::c_int;
    }
    if F_GetPromptHideHud(y) != 0 {
        return;
    }
    V_DrawFill(
        x,
        ...
        16 as libc::c_int,
        16 as libc::c_int,
        hudinfo[HUD_LIVES as libc::c_int as usize].f | 20 as libc::c_int,
    );
    V_DrawFill(
        x,
        y + 15 as libc::c_int,
        16 as libc::c_int,
        1 as libc::c_int,
        hudinfo[HUD_LIVES as libc::c_int as usize].f | 29 as libc::c_int,
    );
    if cv_showinputjoy.value != 0 {
        if (*stplyr).cmd.sidemove as libc::c_int != 0
            || (*stplyr).cmd.forwardmove as libc::c_int != 0
        {
            V_DrawFill(
                x + 5 as libc::c_int,
                y + 4 as libc::c_int,
            ...
            V_DrawFill(
                x + 3 as libc::c_int
                    + (*stplyr).cmd.sidemove as libc::c_int / 12 as libc::c_int,
                y + 2 as libc::c_int
                    - (*stplyr).cmd.forwardmove as libc::c_int / 12 as libc::c_int,
                10 as libc::c_int,
                10 as libc::c_int,
                hudinfo[HUD_LIVES as libc::c_int as usize].f | 29 as libc::c_int,
            );
            V_DrawFill(
                x + 3 as libc::c_int
                    + (*stplyr).cmd.sidemove as libc::c_int / 9 as libc::c_int,
                y + 1 as libc::c_int
                    - (*stplyr).cmd.forwardmove as libc::c_int / 9 as libc::c_int,
                10 as libc::c_int,
                10 as libc::c_int,
                accent,
            );
            ...
            V_DrawFill(
                ...
                10 as libc::c_int,
                10 as libc::c_int,
                hudinfo[HUD_LIVES as libc::c_int as usize].f | 16 as libc::c_int,
            );
        }
    } else {
        if ((*stplyr).cmd.sidemove as libc::c_int) < 0 as libc::c_int {
            offs = 0 as libc::c_int as uint8_t;
            col = accent;
        } else {
            offs = 1 as libc::c_int as uint8_t;
            col = hudinfo[HUD_LIVES as libc::c_int as usize].f | 16 as libc::c_int;
            V_DrawFill(
                x - 2 as libc::c_int,
                y + 10 as libc::c_int,
                6 as libc::c_int,
        ...
        V_DrawFill(
            x - 2 as libc::c_int,
            y + 5 as libc::c_int - offs as libc::c_int,
            6 as libc::c_int,
            6 as libc::c_int,
            col,
        );
        V_DrawFill(
            x + 4 as libc::c_int,
            y + 6 as libc::c_int - offs as libc::c_int,
            1 as libc::c_int,
            4 as libc::c_int,
            col,
        );
        V_DrawFill(
            x + 5 as libc::c_int,
            y + 7 as libc::c_int - offs as libc::c_int,
            1 as libc::c_int,
            2 as libc::c_int,
            col,
        );
        if (*stplyr).cmd.forwardmove as libc::c_int > 0 as libc::c_int {
            offs = 0 as libc::c_int as uint8_t;
            col = accent;
        } else {
            offs = 1 as libc::c_int as uint8_t;
        ...
        V_DrawFill(
            x + 5 as libc::c_int,
            y - 2 as libc::c_int - offs as libc::c_int,
            6 as libc::c_int,
            6 as libc::c_int,
            col,
        );
        V_DrawFill(
            x + 6 as libc::c_int,
            y + 4 as libc::c_int - offs as libc::c_int,
            4 as libc::c_int,
            1 as libc::c_int,
            col,
        );
        ...
        V_DrawFill(
            x + 5 as libc::c_int,
            y + 12 as libc::c_int - offs as libc::c_int,
            6 as libc::c_int,
            6 as libc::c_int,
            col,
        );
        V_DrawFill(
            x + 6 as libc::c_int,
            y + 11 as libc::c_int - offs as libc::c_int,
            4 as libc::c_int,
            1 as libc::c_int,
            col,
        );
        V_DrawFill(
            x + 7 as libc::c_int,
            y + 10 as libc::c_int - offs as libc::c_int,
            2 as libc::c_int,
            1 as libc::c_int,
            col,
        );
    }
    if (*stplyr).cmd.buttons as libc::c_int & BT_JUMP as libc::c_int != 0 {
        offs = 0 as libc::c_int as uint8_t;
        col = accent;
    } else {
        offs = 1 as libc::c_int as uint8_t;
        col = hudinfo[HUD_LIVES as libc::c_int as usize].f | 16 as libc::c_int;
        V_DrawFill(
            x + 16 as libc::c_int + 4 as libc::c_int,
            y + 9 as libc::c_int + -(3 as libc::c_int),
            10 as libc::c_int,
            1 as libc::c_int,
            hudinfo[HUD_LIVES as libc::c_int as usize].f | 29 as libc::c_int,
        );
    ...
    V_DrawFill(
        x + 16 as libc::c_int + 4 as libc::c_int,
        y + -(3 as libc::c_int) - offs as libc::c_int,
        10 as libc::c_int,
        10 as libc::c_int,
        col,
    );
    V_DrawCharacter(
        x + 16 as libc::c_int + 1 as libc::c_int + 4 as libc::c_int,
        y + 1 as libc::c_int + -(3 as libc::c_int) - offs as libc::c_int,
        hudinfo[HUD_LIVES as libc::c_int as usize].f | 'J' as i32,
        false_0 as libc::c_int,
    );
    if (*stplyr).cmd.buttons as libc::c_int & BT_SPIN as libc::c_int != 0 {
        offs = 0 as libc::c_int as uint8_t;
        col = accent;
    } else {
        offs = 1 as libc::c_int as uint8_t;
    ...
    V_DrawCharacter(
        x + 16 as libc::c_int + 1 as libc::c_int + 15 as libc::c_int,
        y + 1 as libc::c_int + -(3 as libc::c_int) - offs as libc::c_int,
        hudinfo[HUD_LIVES as libc::c_int as usize].f | 'S' as i32,
        false_0 as libc::c_int,
    );
    V_DrawFill(
        x + 16 as libc::c_int + 4 as libc::c_int,
    ...
    if !((*stplyr).mo).is_null() {
        let mut i: uint8_t = 0;
        let mut precision: uint8_t = 0;
        let mut ang: angle_t = if (*stplyr).powers[pw_carry as libc::c_int as usize]
            as libc::c_int == CR_NIGHTSMODE as libc::c_int
        {
            FixedAngle(((*stplyr).flyangle - 90 as libc::c_int) << 16 as libc::c_int)
                >> 19 as libc::c_int
        } else {
            ((*(*stplyr).mo).angle)
                .wrapping_sub(R_PointToAngle((*(*stplyr).mo).x, (*(*stplyr).mo).y))
                >> 19 as libc::c_int
        };
        let mut xcomp: fixed_t = finesine[ang as usize]
            >> 16 as libc::c_int - 16 as libc::c_int >> 13 as libc::c_int;
        let mut ycomp: fixed_t = *finecosine.offset(ang as isize)
            >> 16 as libc::c_int - 16 as libc::c_int >> 14 as libc::c_int;
        if ycomp == 4 as libc::c_int {
            ycomp = 3 as libc::c_int;
        }
        if ycomp > 0 as libc::c_int {
            V_DrawFill(
                x + 16 as libc::c_int + 13 as libc::c_int - xcomp,
                y + 11 as libc::c_int - ycomp,
                3 as libc::c_int,
                3 as libc::c_int,
                accent,
            );
        }
        precision = (if 3 as libc::c_int > abs(xcomp) {
            3 as libc::c_int
        } else {
            abs(xcomp)
        }) as uint8_t;
        i = 0 as libc::c_int as uint8_t;
        while (i as libc::c_int) < precision as libc::c_int {
            V_DrawFill(
                x + 16 as libc::c_int + 14 as libc::c_int
                    - i as libc::c_int * xcomp / precision as libc::c_int,
                y + 12 as libc::c_int
                    - i as libc::c_int * ycomp / precision as libc::c_int,
                1 as libc::c_int,
                1 as libc::c_int,
                hudinfo[HUD_LIVES as libc::c_int as usize].f | 16 as libc::c_int,
            );
    ...
    if (*stplyr).powers[pw_carry as libc::c_int as usize] as libc::c_int
        != CR_NIGHTSMODE as libc::c_int
    {
        if (*stplyr).pflags as libc::c_uint & PF_AUTOBRAKE as libc::c_int as libc::c_uint
            != 0
        {
            V_DrawThinString(
                x,
                y,
                hudinfo[HUD_LIVES as libc::c_int as usize].f
                    | (if (*stplyr).powers[pw_carry as libc::c_int as usize] == 0
                        && (*stplyr).pflags as libc::c_uint
                            & PF_APPLYAUTOBRAKE as libc::c_int as libc::c_uint != 0
                        && !((*stplyr).cmd.sidemove as libc::c_int != 0
                            || (*stplyr).cmd.forwardmove as libc::c_int != 0)
                        && ((*stplyr).rmomx != 0 || (*stplyr).rmomy != 0)
                        && (((*stplyr).capsule).is_null()
                            || (*(*stplyr).capsule).reactiontime as libc::c_long
                                != stplyr.offset_from(players.as_mut_ptr()) as libc::c_long
        ...
        match (if (*stplyr).pflags as libc::c_uint
            ...
            })
        {
            1 => {
                V_DrawThinString(
                    ...
                    y,
                    hudinfo[HUD_LIVES as libc::c_int as usize].f,
                    b"ANALOG\0" as *const u8 as *const libc::c_char,
                );
                y -= 8 as libc::c_int;
            }
            3 => {
            ...
            0 => {
                V_DrawThinString(
                    ...
                    y,
                    hudinfo[HUD_LIVES as libc::c_int as usize].f,
                    b"STRAFE\0" as *const u8 as *const libc::c_char,
                );
                y -= 8 as libc::c_int;
            }
            _ => {}
    ...
    if demosynced == 0 {
        V_DrawThinString(
            ...
            b"BAD DEMO!!\0" as *const u8 as *const libc::c_char,
        );
    }
}
static mut lt_patches: [*mut patch_t; 3] = [0 as *const patch_t as *mut patch_t; 3];
static mut lt_scroll: int32_t = 0 as libc::c_int;
static mut lt_mom: int32_t = 0 as libc::c_int;
static mut lt_zigzag: int32_t = 0 as libc::c_int;
#[no_mangle]
pub static mut lt_ticker: tic_t = 0 as libc::c_int as tic_t;
#[no_mangle]
pub static mut lt_lasttic: tic_t = 0 as libc::c_int as tic_t;
#[no_mangle]
pub static mut lt_exitticker: tic_t = 0 as libc::c_int as tic_t;
#[no_mangle]
pub static mut lt_endtime: tic_t = 0 as libc::c_int as tic_t;
unsafe extern "C" fn ST_cacheLevelTitle() {
    let mut patlumpnum: lumpnum_t = 4294967295 as libc::c_uint;
    if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
        .ltactdiamond[0 as libc::c_int as usize] as libc::c_int != '\0' as i32
    {
        patlumpnum = W_CheckNumForName(
            ((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .ltactdiamond)
                .as_mut_ptr(),
        );
        if patlumpnum != 4294967295 as libc::c_uint {
            lt_patches[0 as libc::c_int
                as usize] = W_CachePatchNum(patlumpnum, PU_HUDGFX as libc::c_int)
                as *mut patch_t;
        }
    }
    if patlumpnum == 4294967295 as libc::c_uint {
        if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
            .levelflags as libc::c_int & (1 as libc::c_int) << 7 as libc::c_int == 0
        {
            lt_patches[0 as libc::c_int
                as usize] = W_CachePatchName(
                b"LTACTBLU\0" as *const u8 as *const libc::c_char,
                PU_HUDGFX as libc::c_int,
            ) as *mut patch_t;
        } else {
            lt_patches[0 as libc::c_int
                as usize] = W_CachePatchName(
                b"LTACTRED\0" as *const u8 as *const libc::c_char,
                PU_HUDGFX as libc::c_int,
            ) as *mut patch_t;
        }
    }
    let mut patlumpnum_0: lumpnum_t = 4294967295 as libc::c_uint;
    if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
        .ltzzpatch[0 as libc::c_int as usize] as libc::c_int != '\0' as i32
    {
        patlumpnum_0 = W_CheckNumForName(
            ((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .ltzzpatch)
                .as_mut_ptr(),
        );
        if patlumpnum_0 != 4294967295 as libc::c_uint {
            lt_patches[1 as libc::c_int
                as usize] = W_CachePatchNum(patlumpnum_0, PU_HUDGFX as libc::c_int)
                as *mut patch_t;
        }
    }
    if patlumpnum_0 == 4294967295 as libc::c_uint {
            ...
            .levelflags as libc::c_int & (1 as libc::c_int) << 7 as libc::c_int == 0
        {
            ...
            lt_patches[1 as libc::c_int
                as usize] = W_CachePatchName(
                b"LTZIGRED\0" as *const u8 as *const libc::c_char,
                PU_HUDGFX as libc::c_int,
            ) as *mut patch_t;
        }
    }
    let mut patlumpnum_1: lumpnum_t = 4294967295 as libc::c_uint;
    if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
        .ltzztext[0 as libc::c_int as usize] as libc::c_int != '\0' as i32
    {
        patlumpnum_1 = W_CheckNumForName(
            ((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .ltzztext)
                .as_mut_ptr(),
        );
        if patlumpnum_1 != 4294967295 as libc::c_uint {
            lt_patches[2 as libc::c_int
                as usize] = W_CachePatchNum(patlumpnum_1, PU_HUDGFX as libc::c_int)
                as *mut patch_t;
        }
    }
    if patlumpnum_1 == 4294967295 as libc::c_uint {
            ...
            .levelflags as libc::c_int & (1 as libc::c_int) << 7 as libc::c_int == 0
        {
            lt_patches[2 as libc::c_int
                as usize] = W_CachePatchName(
                b"LTZZTEXT\0" as *const u8 as *const libc::c_char,
                PU_HUDGFX as libc::c_int,
            ) as *mut patch_t;
        } else {
            lt_patches[2 as libc::c_int
                as usize] = W_CachePatchName(
                b"LTZZWARN\0" as *const u8 as *const libc::c_char,
                PU_HUDGFX as libc::c_int,
            ) as *mut patch_t;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ST_startTitleCard() {
    ST_cacheLevelTitle();
    lt_lasttic = 0 as libc::c_int as tic_t;
    lt_exitticker = lt_lasttic;
    lt_ticker = lt_exitticker;
    lt_endtime = (2 as libc::c_int * 35 as libc::c_int
        + 10 as libc::c_int * 1 as libc::c_int) as tic_t;
    lt_scroll = 320 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    lt_zigzag = -((*lt_patches[1 as libc::c_int as usize]).width as libc::c_int
        * ((1 as libc::c_int) << 16 as libc::c_int));
    lt_mom = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ST_preDrawTitleCard() {
    if G_IsTitleCardAvailable() == 0 {
        return;
    }
    if lt_ticker >= lt_endtime.wrapping_add(35 as libc::c_int as tic_t) {
        return;
    }
    if lt_exitticker == 0 {
        st_translucency = 0 as libc::c_int;
    } else {
        st_translucency = if 0 as libc::c_int
            > (if (lt_exitticker as int32_t - 4 as libc::c_int) < cv_translucenthud.value
            {
                lt_exitticker as int32_t - 4 as libc::c_int
            } else {
                cv_translucenthud.value
            })
        {
            0 as libc::c_int
        } else if (lt_exitticker as int32_t - 4 as libc::c_int) < cv_translucenthud.value
        {
            lt_exitticker as int32_t - 4 as libc::c_int
        } else {
            cv_translucenthud.value
...
#[no_mangle]
pub unsafe extern "C" fn ST_runTitleCard() {
    let mut run: boolean = !(paused as libc::c_int != 0 || P_AutoPause() != 0)
        as libc::c_int;
    if G_IsTitleCardAvailable() == 0 {
        return;
    }
    ...
    if run != 0 || lt_ticker < 24 as libc::c_int as tic_t {
        lt_ticker = lt_ticker.wrapping_add(1);
        lt_ticker;
        if lt_ticker >= lt_endtime {
            lt_exitticker = lt_exitticker.wrapping_add(1);
            lt_exitticker;
        }
        if lt_exitticker == 0 {
            if abs(lt_scroll) > (1 as libc::c_int) << 16 as libc::c_int {
                lt_scroll -= lt_scroll >> 2 as libc::c_int;
            } else {
                lt_scroll = 0 as libc::c_int;
            }
        } else {
            lt_mom -= ((1 as libc::c_int) << 16 as libc::c_int) * 6 as libc::c_int;
            lt_scroll += lt_mom;
        }
        if lt_exitticker == 0 {
            if abs(lt_zigzag) > (1 as libc::c_int) << 16 as libc::c_int {
                lt_zigzag -= lt_zigzag >> 2 as libc::c_int;
            } else {
                lt_zigzag = 0 as libc::c_int;
            }
        } else {
            lt_zigzag += lt_mom;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ST_drawTitleCard() {
    let mut lvlttl: *mut libc::c_char = ((*mapheaderinfo[(gamemap as libc::c_int
        - 1 as libc::c_int) as usize])
        .lvlttl)
        .as_mut_ptr();
    let mut subttl: *mut libc::c_char = ((*mapheaderinfo[(gamemap as libc::c_int
        - 1 as libc::c_int) as usize])
        .subttl)
        .as_mut_ptr();
    let mut actnum: uint8_t = (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
        as usize])
        .actnum;
    let mut lvlttlxpos: int32_t = 0;
    let mut ttlnumxpos: int32_t = 0;
    let mut zonexpos: int32_t = 0;
    let mut subttlxpos: int32_t = 320 as libc::c_int / 2 as libc::c_int;
    let mut ttlscroll: int32_t = FixedInt(lt_scroll);
    let mut zzticker: int32_t = 0;
    let mut actpat: *mut patch_t = 0 as *mut patch_t;
    let mut zigzag: *mut patch_t = 0 as *mut patch_t;
    let mut zztext: *mut patch_t = 0 as *mut patch_t;
    ...
    if !(LUA_HudEnabled(hud_stagetitle) == 0) {
        if !(lt_ticker >= lt_endtime.wrapping_add(35 as libc::c_int as tic_t)) {
            if lt_ticker.wrapping_sub(lt_lasttic) > 1 as libc::c_int as tic_t {
                lt_ticker = lt_lasttic.wrapping_add(1 as libc::c_int as tic_t);
            }
            ST_cacheLevelTitle();
            actpat = lt_patches[0 as libc::c_int as usize];
            zigzag = lt_patches[1 as libc::c_int as usize];
            zztext = lt_patches[2 as libc::c_int as usize];
            lvlttlxpos = 320 as libc::c_int / 2 as libc::c_int
                - V_LevelNameWidth(lvlttl) / 2 as libc::c_int;
            if actnum as libc::c_int > 0 as libc::c_int {
                lvlttlxpos -= V_LevelActNumWidth(actnum) as libc::c_int;
            }
            ttlnumxpos = lvlttlxpos + V_LevelNameWidth(lvlttl);
            zonexpos = ttlnumxpos
                - V_LevelNameWidth(b"Zone\0" as *const u8 as *const libc::c_char);
            ttlnumxpos += 1;
            ttlnumxpos;
            if lvlttlxpos < 0 as libc::c_int {
                lvlttlxpos = 0 as libc::c_int;
            }
            if splitscreen == 0
                || splitscreen != 0
                    && stplyr
                        == &mut *players.as_mut_ptr().offset(displayplayer as isize)
                            as *mut player_t
            {
                zzticker = lt_ticker as int32_t;
                V_DrawStretchyFixedPatch(
                    FixedInt(lt_zigzag) << 16 as libc::c_int,
                    (-zzticker % (*zigzag).height as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                ...
                V_DrawStretchyFixedPatch(
                    FixedInt(lt_zigzag) << 16 as libc::c_int,
                    (((*zigzag).height as libc::c_int - zzticker)
                        % (*zigzag).height as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    0x1000000 as libc::c_int | 0x4000000 as libc::c_int,
                    zigzag,
                ...
                V_DrawStretchyFixedPatch(
                    FixedInt(lt_zigzag) << 16 as libc::c_int,
                    ((-((*zztext).height as libc::c_int) + zzticker)
                        % (*zztext).height as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    0x1000000 as libc::c_int | 0x4000000 as libc::c_int,
                    zztext,
                ...
                V_DrawStretchyFixedPatch(
                    FixedInt(lt_zigzag) << 16 as libc::c_int,
                    (zzticker % (*zztext).height as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    0x1000000 as libc::c_int | 0x4000000 as libc::c_int,
                    zztext,
            ...
            if actnum != 0 {
                if splitscreen == 0 {
                    if actnum as libc::c_int > 9 as libc::c_int {
                        V_DrawStretchyFixedPatch(
                            ttlnumxpos
                                + V_LevelActNumWidth(actnum) as libc::c_int
                                    / 4 as libc::c_int + ttlscroll << 16 as libc::c_int,
                            104 as libc::c_int - ttlscroll << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            0 as libc::c_int,
                            actpat,
                        ...
                        V_DrawStretchyFixedPatch(
                            ttlnumxpos + ttlscroll << 16 as libc::c_int,
                            104 as libc::c_int - ttlscroll << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            0 as libc::c_int,
            ...
            V_DrawCenteredString(
                subttlxpos - ttlscroll,
                135 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x800000 as libc::c_int as libc::c_uint)
                    as int32_t,
                subttl,
            );
    ...
    LUA_HookHUD(hudhook_titlecard as libc::c_int, luahuddrawlist_titlecard);
    LUA_HUD_DrawList(luahuddrawlist_titlecard);
}
#[no_mangle]
pub unsafe extern "C" fn ST_preLevelTitleCardDrawer() {
    V_DrawFill(
        0 as libc::c_int,
        0 as libc::c_int,
        320 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn ST_drawWipeTitleCard() {
    stplyr = &mut *players.as_mut_ptr().offset(consoleplayer as isize) as *mut player_t;
    ST_preDrawTitleCard();
    ST_drawTitleCard();
    if splitscreen != 0 {
        stplyr = &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
            as *mut player_t;
        ST_preDrawTitleCard();
        ST_drawTitleCard();
    }
}
unsafe extern "C" fn ST_powerupHUDoffset(mut timer: uint16_t) -> int32_t {
    if timer as libc::c_int > 7 as libc::c_int {
        return 16 as libc::c_int + 4 as libc::c_int
    } else {
        let mut a: uint8_t = (16 as libc::c_int + 4 as libc::c_int) as uint8_t;
        let mut b: uint8_t = (7 as libc::c_int - timer as libc::c_int) as uint8_t;
        loop {
            let fresh0 = b;
            b = b.wrapping_sub(1);
            if !(fresh0 != 0) {
            ...
            a = (2 as libc::c_int * a as libc::c_int / 3 as libc::c_int) as uint8_t;
        }
        return a as int32_t;
    };
}
unsafe extern "C" fn ST_drawPowerupHUD() {
    let mut p: *mut patch_t = 0 as *mut patch_t;
    let mut invulntime: uint16_t = 0 as libc::c_int as uint16_t;
    let mut offs: int32_t = hudinfo[HUD_POWERUPS as libc::c_int as usize].x;
    let q: uint8_t = (if splitscreen != 0
        && stplyr
    ...
    static mut flagoffs: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
    static mut shieldoffs: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
    static mut finishoffs: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
    if F_GetPromptHideHud(hudinfo[HUD_POWERUPS as libc::c_int as usize].y) != 0 {
        return;
    }
    if (*stplyr).spectator != 0
        || (*stplyr).playerstate as libc::c_uint
    ...
    if (*stplyr).pflags as libc::c_uint & PF_FINISHED as libc::c_int as libc::c_uint != 0
        && cv_exitmove.value != 0 && multiplayer != 0
    {
        finishoffs[q as usize] = 16 as libc::c_int + 4 as libc::c_int;
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
            hudinfo[HUD_POWERUPS as libc::c_int as usize].y << 16 as libc::c_int,
            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            (0x80000000 as libc::c_uint
                | hudinfo[HUD_POWERUPS as libc::c_int as usize].f as libc::c_uint
                | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
            fnshico,
            0 as *const uint8_t,
        );
    } else if finishoffs[q as usize] != 0 {
        if finishoffs[q as usize] > 1 as libc::c_int {
            finishoffs[q
                as usize] = 2 as libc::c_int * finishoffs[q as usize] / 3 as libc::c_int;
        } else {
            finishoffs[q as usize] = 0 as libc::c_int;
        }
    }
    offs -= finishoffs[q as usize];
    if (*stplyr).powers[pw_shield as libc::c_int as usize] as libc::c_int
        & SH_NOSTACK as libc::c_int != 0
    {
        shieldoffs[q as usize] = 16 as libc::c_int + 4 as libc::c_int;
        if (*stplyr).powers[pw_shield as libc::c_int as usize] as libc::c_int
            & SH_NOSTACK as libc::c_int & !(SH_FORCEHP as libc::c_int)
            == SH_FORCE as libc::c_int
        {
            let mut i: uint8_t = 0;
            let mut max: uint8_t = ((*stplyr).powers[pw_shield as libc::c_int as usize]
                as libc::c_int & SH_FORCEHP as libc::c_int) as uint8_t;
            i = 0 as libc::c_int as uint8_t;
            while i as libc::c_int <= max as libc::c_int {
                V_DrawStretchyFixedPatch(
                    offs - ((i as libc::c_int) << 1 as libc::c_int) << 16 as libc::c_int,
                    hudinfo[HUD_POWERUPS as libc::c_int as usize].y
                        - ((i as libc::c_int) << 1 as libc::c_int) << 16 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    (0x80000000 as libc::c_uint
                        | hudinfo[HUD_POWERUPS as libc::c_int as usize].f as libc::c_uint
                        | (if i as libc::c_int == max as libc::c_int {
                            0xb0000 as libc::c_int
                        } else {
                            0xa0000 as libc::c_int
                        }) as libc::c_uint) as int32_t,
            ...
            match (*stplyr).powers[pw_shield as libc::c_int as usize] as libc::c_int
    ...
    } else if shieldoffs[q as usize] != 0 {
        if shieldoffs[q as usize] > 1 as libc::c_int {
            shieldoffs[q
                as usize] = 2 as libc::c_int * shieldoffs[q as usize] / 3 as libc::c_int;
        } else {
            shieldoffs[q as usize] = 0 as libc::c_int;
        }
    }
    offs -= shieldoffs[q as usize];
    if (*stplyr).gotflag != 0 {
        flagoffs[q as usize] = 16 as libc::c_int + 4 as libc::c_int;
        p = if (*stplyr).gotflag as libc::c_int & 1 as libc::c_int != 0 {
            gotrflag
        } else {
            gotbflag
        };
    ...
    } else if flagoffs[q as usize] != 0 {
        if flagoffs[q as usize] > 1 as libc::c_int {
            flagoffs[q
                as usize] = 2 as libc::c_int * flagoffs[q as usize] / 3 as libc::c_int;
        } else {
            flagoffs[q as usize] = 0 as libc::c_int;
        }
    }
    offs -= flagoffs[q as usize];
    invulntime = (if (*stplyr).powers[pw_flashing as libc::c_int as usize] as libc::c_int
        != 0
    {
        (*stplyr).powers[pw_flashing as libc::c_int as usize] as libc::c_int
    } else {
        (*stplyr).powers[pw_invulnerability as libc::c_int as usize] as libc::c_int
    }) as uint16_t;
    if (*stplyr).powers[pw_invulnerability as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || invulntime as libc::c_int != 0 && leveltime & 1 as libc::c_int as tic_t != 0
    {
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
            hudinfo[HUD_POWERUPS as libc::c_int as usize].y << 16 as libc::c_int,
        ...
        V_DrawRightAlignedThinString(
            offs + 16 as libc::c_int,
            hudinfo[HUD_POWERUPS as libc::c_int as usize].y + 8 as libc::c_int,
            (0x80000000 as libc::c_uint
                | hudinfo[HUD_POWERUPS as libc::c_int as usize].f as libc::c_uint)
                as int32_t,
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                invulntime as libc::c_int / 35 as libc::c_int,
            ),
        );
    }
    offs -= ST_powerupHUDoffset(invulntime);
    if (*stplyr).powers[pw_sneakers as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || (*stplyr).powers[pw_sneakers as libc::c_int as usize] as libc::c_int != 0
    ...
    offs -= ST_powerupHUDoffset((*stplyr).powers[pw_sneakers as libc::c_int as usize]);
    if (*stplyr).powers[pw_gravityboots as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || (*stplyr).powers[pw_gravityboots as libc::c_int as usize] as libc::c_int != 0
            && leveltime & 1 as libc::c_int as tic_t != 0
    {
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
        ...
        V_DrawRightAlignedThinString(
            ...
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_gravityboots as libc::c_int as usize] as libc::c_int
                    / 35 as libc::c_int,
            ),
        );
    }
    offs
        -= ST_powerupHUDoffset(
            (*stplyr).powers[pw_gravityboots as libc::c_int as usize],
        );
    if (*stplyr).powers[pw_nights_helper as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || (*stplyr).powers[pw_nights_helper as libc::c_int as usize] as libc::c_int != 0
            && leveltime & 1 as libc::c_int as tic_t != 0
    {
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
        ...
        V_DrawRightAlignedThinString(
            ...
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_nights_helper as libc::c_int as usize] as libc::c_int
                    / 35 as libc::c_int,
            ),
        );
    }
    offs
        -= ST_powerupHUDoffset(
            (*stplyr).powers[pw_nights_helper as libc::c_int as usize],
        );
    if (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize] as libc::c_int
            != 0 && leveltime & 1 as libc::c_int as tic_t != 0
    {
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
            hudinfo[HUD_POWERUPS as libc::c_int as usize].y << 16 as libc::c_int,
        ...
        V_DrawRightAlignedThinString(
            ...
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize]
    ...
    if (*stplyr).powers[pw_nights_superloop as libc::c_int as usize] as libc::c_int
        > 3 as libc::c_int * 35 as libc::c_int
        || (*stplyr).powers[pw_nights_superloop as libc::c_int as usize] as libc::c_int
            != 0 && leveltime & 1 as libc::c_int as tic_t != 0
    {
        V_DrawStretchyFixedPatch(
            offs << 16 as libc::c_int,
        ...
        V_DrawRightAlignedThinString(
            ...
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[pw_nights_superloop as libc::c_int as usize]
                    as libc::c_int / 35 as libc::c_int,
            ),
        );
    }
}
unsafe extern "C" fn ST_drawFirstPersonHUD() {
    let mut p: *mut patch_t = 0 as *mut patch_t;
    let mut airtime: uint32_t = 0;
    let mut sprframe: *mut spriteframe_t = 0 as *mut spriteframe_t;
    if (*stplyr).powers[pw_underwater as libc::c_int as usize] as libc::c_int != 0
        && (*stplyr).powers[pw_spacetime as libc::c_int as usize] as libc::c_int != 0
    {
        airtime = (if ((*stplyr).powers[pw_underwater as libc::c_int as usize]
            as libc::c_int)
            < (*stplyr).powers[pw_spacetime as libc::c_int as usize] as libc::c_int
        {
            (*stplyr).powers[pw_underwater as libc::c_int as usize] as libc::c_int
        ...
        airtime = (if (*stplyr).powers[pw_spacetime as libc::c_int as usize]
            as libc::c_int != 0
        {
            (*stplyr).powers[pw_spacetime as libc::c_int as usize] as libc::c_int
        } else {
    ...
    if airtime < 1 as libc::c_int as uint32_t {
        return;
    }
    airtime = airtime.wrapping_sub(1);
    airtime;
    if airtime > (11 as libc::c_int * 35 as libc::c_int) as uint32_t {
        return;
    }
    if !(airtime > (10 as libc::c_int * 35 as libc::c_int - 5 as libc::c_int) as uint32_t
        || airtime <= (9 as libc::c_int * 35 as libc::c_int) as uint32_t
            && airtime
                > (8 as libc::c_int * 35 as libc::c_int - 5 as libc::c_int) as uint32_t
        || airtime <= (7 as libc::c_int * 35 as libc::c_int) as uint32_t
            && airtime
                > (6 as libc::c_int * 35 as libc::c_int - 5 as libc::c_int) as uint32_t
        || airtime <= (5 as libc::c_int * 35 as libc::c_int) as uint32_t
            && airtime
                > (4 as libc::c_int * 35 as libc::c_int - 5 as libc::c_int) as uint32_t
        || airtime <= (3 as libc::c_int * 35 as libc::c_int) as uint32_t
            && airtime
                > (2 as libc::c_int * 35 as libc::c_int - 5 as libc::c_int) as uint32_t
        || airtime <= (1 as libc::c_int * 35 as libc::c_int) as uint32_t)
    {
        return;
    }
    if !((airtime % 10 as libc::c_int as uint32_t) < 5 as libc::c_int as uint32_t) {
        return;
    }
    airtime = airtime / (2 as libc::c_int * 35 as libc::c_int) as uint32_t;
    if (*stplyr).charflags & SF_MACHINE as libc::c_int as uint32_t != 0 {
        airtime = airtime.wrapping_add(6 as libc::c_int as uint32_t);
    }
    sprframe = &mut *((*sprites.offset(SPR_DRWN as libc::c_int as isize)).spriteframes)
        .offset(airtime as isize) as *mut spriteframe_t;
    p = W_CachePatchNum(
        (*sprframe).lumppat[0 as libc::c_int as usize],
        PU_CACHE as libc::c_int,
    ) as *mut patch_t;
    if !p.is_null()
        && F_GetPromptHideHud(60 as libc::c_int - (*p).topoffset as libc::c_int) == 0
    {
        V_DrawStretchyFixedPatch(
            (320 as libc::c_int / 2 as libc::c_int
                - (*p).width as libc::c_int / 2 as libc::c_int
                + (*p).leftoffset as libc::c_int)
                * ((1 as libc::c_int) << 16 as libc::c_int),
            (60 as libc::c_int - (*p).topoffset as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x80000000 as libc::c_uint
                | 0x50000 as libc::c_int as libc::c_uint) as int32_t,
            p,
            0 as *const uint8_t,
        );
    }
}
unsafe extern "C" fn ST_drawNightsRecords() {
    let mut aflag: int32_t = 0x80000000 as libc::c_uint as int32_t;
    if (*stplyr).texttimer == 0 {
        return;
    }
    if ((*stplyr).texttimer as libc::c_int) < 35 as libc::c_int / 2 as libc::c_int {
        aflag
            |= 9 as libc::c_int
                - 9 as libc::c_int * (*stplyr).texttimer as libc::c_int
                    / (35 as libc::c_int / 2 as libc::c_int) << 16 as libc::c_int;
    }
    let mut current_block_27: u64;
    match (*stplyr).textvar as libc::c_int {
        1 => {
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int,
                52 as libc::c_int,
                0x3000 as libc::c_int | aflag,
                b"GET TO THE GOAL!\0" as *const u8 as *const libc::c_char,
            );
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int,
                60 as libc::c_int,
                aflag,
                b"SCORE MULTIPLIER START!\0" as *const u8 as *const libc::c_char,
            );
            if (*stplyr).finishedtime != 0 {
                V_DrawString(
                    320 as libc::c_int / 2 as libc::c_int - 48 as libc::c_int,
                    140 as libc::c_int,
                    aflag,
                ...
                V_DrawString(
                    ...
                    148 as libc::c_int,
                    aflag,
                    b"BONUS:\0" as *const u8 as *const libc::c_char,
                );
                V_DrawRightAlignedString(
                    320 as libc::c_int / 2 as libc::c_int + 48 as libc::c_int,
                    140 as libc::c_int,
                    0x7000 as libc::c_int | aflag,
                    va(
                        b"%d\0" as *const u8 as *const libc::c_char,
                        ((*stplyr).startedtime).wrapping_sub((*stplyr).finishedtime)
                            / 35 as libc::c_int as tic_t,
                    ),
                );
                V_DrawRightAlignedString(
                    ...
                    va(
                        b"%d\0" as *const u8 as *const libc::c_char,
                        (*stplyr).finishedtime / 35 as libc::c_int as tic_t
        ...
        2 => {
            current_block_27 = 13109137661213826276;
        }
        3 => {
            current_block_27 = 13109137661213826276;
        }
        4 => {
            V_DrawString(
                320 as libc::c_int / 2 as libc::c_int - 56 as libc::c_int,
                140 as libc::c_int,
                aflag,
                if G_IsSpecialStage(gamemap as int32_t) != 0 {
                    b"SPHERES:\0" as *const u8 as *const libc::c_char
                } else {
                    b"CHIPS:\0" as *const u8 as *const libc::c_char
                },
            );
            V_DrawString(
                320 as libc::c_int / 2 as libc::c_int - 56 as libc::c_int,
            ...
            V_DrawRightAlignedString(
                ...
                va(
                    b"%d\0" as *const u8 as *const libc::c_char,
                    (*stplyr).finishedspheres as libc::c_int,
                ),
            );
            V_DrawRightAlignedString(
                320 as libc::c_int / 2 as libc::c_int + 56 as libc::c_int,
                ...
                va(
                    b"%d\0" as *const u8 as *const libc::c_char,
                    (*stplyr).finishedspheres as libc::c_int * 50 as libc::c_int,
                ),
            );
            ST_DrawNightsOverlayNum(
                (320 as libc::c_int / 2 as libc::c_int + 56 as libc::c_int)
                    << 16 as libc::c_int,
                (160 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                aflag,
                (*stplyr).lastmarescore,
                nightsnum.as_mut_ptr(),
                SKINCOLOR_AZURE,
            );
            if !(netgame != 0 || multiplayer != 0)
                && G_GetBestNightsScore(
                    gamemap,
                    ((*stplyr).lastmare as libc::c_int + 1 as libc::c_int) as uint8_t,
                    clientGamedata,
                ) <= (*stplyr).lastmarescore
            {
                if (*stplyr).texttimer as libc::c_int & 16 as libc::c_int != 0 {
                    V_DrawCenteredString(
                        320 as libc::c_int / 2 as libc::c_int,
                        184 as libc::c_int,
                        0x2000 as libc::c_int | aflag,
                        b"* NEW RECORD *\0" as *const u8 as *const libc::c_char,
                    );
                }
            }
            if P_HasGrades(
            ...
            {
                let mut grade: uint8_t = P_GetGrade(
                    (*stplyr).lastmarescore,
                    gamemap,
                    (*stplyr).lastmare,
                );
                if modeattacking as libc::c_int != 0
                    || grade as libc::c_int >= 5 as libc::c_int
                {
                    V_DrawStretchyFixedPatch(
    ...
    match current_block_27 {
        13109137661213826276 => {
            ...
            V_DrawCenteredString(
                ...
                aflag,
                va(
                    b"\x80GET\x82 %d\x80 %s%s%s!\0" as *const u8 as *const libc::c_char,
                    (*(*stplyr).capsule).health,
                    if (*stplyr).textvar as libc::c_int == 3 as libc::c_int {
                        b"MORE \0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    },
                    if G_IsSpecialStage(gamemap as int32_t) != 0 {
                        b"SPHERE\0" as *const u8 as *const libc::c_char
                    } else {
                        b"CHIP\0" as *const u8 as *const libc::c_char
                    },
                    if (*(*stplyr).capsule).health > 1 as libc::c_int {
...
unsafe extern "C" fn ST_drawNiGHTSLink() {
    static mut prevsel: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
    static mut prevtime: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
    let q: uint8_t = (if splitscreen != 0
        && stplyr
            == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                as *mut player_t
    ...
    let mut sel: int32_t = ((*stplyr).linkcount - 1 as libc::c_int) / 5 as libc::c_int
        % 12 as libc::c_int;
    let mut aflag: int32_t = 0x80000000 as libc::c_uint as int32_t;
    let mut mag: int32_t = if (*stplyr).linkcount - 1 as libc::c_int
        >= 300 as libc::c_int
    {
        if (*stplyr).linkcount - 1 as libc::c_int >= 600 as libc::c_int {
            2 as libc::c_int
        } else {
            1 as libc::c_int
        }
    ...
    let mut colornum: skincolornum_t = SKINCOLOR_NONE;
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    let mut scale: fixed_t = 0;
    if sel != prevsel[q as usize] {
        prevsel[q as usize] = sel;
        prevtime[q as usize] = 2 as libc::c_int + mag;
    }
    if (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize] as libc::c_int != 0
        && ((*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize] as libc::c_int
            & 2 as libc::c_int == 0
            || (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize]
                as libc::c_int > flashingtics as libc::c_int)
    {
        colornum = SKINCOLOR_ICY;
    } else {
        colornum = linkColor[mag as usize][sel as usize];
    }
    aflag = (aflag as tic_t
        | if (*stplyr).linktimer
            < nightslinktics as uint32_t / 3 as libc::c_int as uint32_t
        {
            (9 as libc::c_int as tic_t)
                .wrapping_sub(
                    9 as libc::c_int as tic_t * (*stplyr).linktimer
                        / (nightslinktics as libc::c_int / 3 as libc::c_int) as tic_t,
                ) << 16 as libc::c_int
        } else {
            0 as libc::c_int as tic_t
        }) as int32_t;
    y = (160 as libc::c_int + 11 as libc::c_int) << 16 as libc::c_int;
    aflag |= 0x2000000 as libc::c_int;
    x = (160 as libc::c_int + 4 as libc::c_int) << 16 as libc::c_int;
    if prevtime[q as usize] != 0 {
        scale = (32 as libc::c_int + prevtime[q as usize] << 16 as libc::c_int)
            / 32 as libc::c_int;
        prevtime[q as usize] -= 1;
        prevtime[q as usize];
    } else {
        scale = (1 as libc::c_int) << 16 as libc::c_int;
    }
    y -= 11 as libc::c_int * scale;
    ST_DrawNightsOverlayNum(
        x - 4 as libc::c_int * scale,
        y,
        scale,
        aflag,
        ((*stplyr).linkcount - 1 as libc::c_int) as uint32_t,
        nightsnum.as_mut_ptr(),
        colornum,
    );
    V_DrawStretchyFixedPatch(
    ...
    if cv_debug & 0x10 as libc::c_int != 0 {
        V_DrawCenteredString(
            320 as libc::c_int / 2 as libc::c_int,
            180 as libc::c_int,
            0x2000000 as libc::c_int,
            va(
                b"End in %d.%02d\0" as *const u8 as *const libc::c_char,
                (*stplyr).linktimer / 35 as libc::c_int as tic_t,
                G_TicsToCentiseconds((*stplyr).linktimer),
            ),
        );
    }
}
unsafe extern "C" fn ST_drawNiGHTSHUD() {
    let mut origamount: int32_t = 0;
    let mut total_spherecount: int32_t = 0;
    let mut total_ringcount: int32_t = 0;
    let oldspecialstage: boolean = (G_IsSpecialStage(gamemap as int32_t) != 0
        && maptol & TOL_NIGHTS as libc::c_int as uint32_t == 0) as libc::c_int;
    if LUA_HudEnabled(hud_nightsdrill) != 0
        && (*stplyr).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_NIGHTSMODE as libc::c_int
    {
        let mut locx: int32_t = 16 as libc::c_int;
        let mut locy: int32_t = 180 as libc::c_int;
        let mut dfill: int32_t = 0;
        let mut fillpatch: uint8_t = 0;
        if (*stplyr).pflags as libc::c_uint & PF_DRILLING as libc::c_int as libc::c_uint
            != 0
        {
            fillpatch = (((*stplyr).drillmeter & 1 as libc::c_int) + 1 as libc::c_int)
                as uint8_t;
        } else {
            fillpatch = 0 as libc::c_int as uint8_t;
        }
        V_DrawStretchyFixedPatch(
            locx * ((1 as libc::c_int) << 16 as libc::c_int),
            locy << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x4000000 as libc::c_int as libc::c_uint
                | 0x2000000 as libc::c_int as libc::c_uint
                | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
            drillbar,
            0 as *const uint8_t,
        );
        dfill = 0 as libc::c_int;
        while dfill < (*stplyr).drillmeter / 20 as libc::c_int
            && dfill < 96 as libc::c_int
        {
            V_DrawStretchyFixedPatch(
                (locx + 2 as libc::c_int + dfill)
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                (locy + 3 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x2000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                drillfill[fillpatch as usize],
                0 as *const uint8_t,
            );
            dfill += 1;
            dfill;
        }
        if splitscreen == 0 && cv_debug & 0x10 as libc::c_int != 0 {
            if (*stplyr).bumpertime != 0 {
                V_DrawString(
                    locx,
                    locy - 8 as libc::c_int,
                    0x5000 as libc::c_int | 0xc00 as libc::c_int,
                    va(
                        b"BUMPER: 0.%02d\0" as *const u8 as *const libc::c_char,
                        G_TicsToCentiseconds((*stplyr).bumpertime),
                    ),
                );
            } else {
                V_DrawString(
                    ...
                    0xc00 as libc::c_int,
                    va(
                        b"Drill: %3d%%\0" as *const u8 as *const libc::c_char,
                        (*stplyr).drillmeter * 100 as libc::c_int
                            / (96 as libc::c_int * 20 as libc::c_int),
                    ),
                );
            }
        }
    }
    if oldspecialstage == 0
        && !((*stplyr).texttimer as libc::c_int != 0
            && (*stplyr).textvar as libc::c_int == 4 as libc::c_int)
        && LUA_HudEnabled(hud_nightslink) != 0
        && (cv_debug & 0x10 as libc::c_int != 0
            || (*stplyr).linkcount > 1 as libc::c_int)
    {
        ST_drawNiGHTSLink();
    }
    ...
    if LUA_HudEnabled(hud_nightsspheres) != 0 {
        V_DrawStretchyFixedPatch(
        ...
        if G_IsSpecialStage(gamemap as int32_t) != 0 {
            V_DrawStretchyFixedPatch(
                ...
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                if (*stplyr).bonustime != 0 && leveltime & 4 as libc::c_int as tic_t != 0
                    && states[S_BLUESPHEREBONUS as libc::c_int as usize].frame
                ...
                *(if (*stplyr).bonustime != 0 {
                    ...
                    .offset(
                        (leveltime / 2 as libc::c_int as tic_t
                            % 12 as libc::c_int as tic_t) as isize,
                    ),
                0 as *const uint8_t,
            );
        }
        if G_IsSpecialStage(gamemap as int32_t) != 0 {
            let mut i: int32_t = 0;
            total_ringcount = 0 as libc::c_int;
            total_spherecount = total_ringcount;
            i = 0 as libc::c_int;
            while i < 32 as libc::c_int {
                if !(playeringame[i as usize] == 0) {
                    total_spherecount += players[i as usize].spheres as libc::c_int;
                    total_ringcount += players[i as usize].rings as libc::c_int;
                }
                i += 1;
                i;
            }
        } else {
            total_spherecount = (*stplyr).spheres as int32_t;
            total_ringcount = (*stplyr).spheres as int32_t;
        }
        if !((*stplyr).capsule).is_null() {
            let mut amount: int32_t = 0;
            let length: int32_t = 88 as libc::c_int;
            origamount = (*(*(*stplyr).capsule).spawnpoint).angle as int32_t;
            V_DrawStretchyFixedPatch(
            ...
            V_DrawStretchyFixedPatch(
                74 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                (8 as libc::c_int + 4 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
            ...
            if (*(*stplyr).capsule).reactiontime != 0 as libc::c_int {
                let mut r: int32_t = 0;
                let orblength: int32_t = 20 as libc::c_int;
                r = 0 as libc::c_int;
                while r < 5 as libc::c_int {
                    V_DrawStretchyFixedPatch(
                        (230 as libc::c_int - 7 as libc::c_int * r)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                    ...
                    V_DrawStretchyFixedPatch(
                        (188 as libc::c_int - 7 as libc::c_int * r)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        (144 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                    ...
                    V_DrawStretchyFixedPatch(
                        (146 as libc::c_int - 7 as libc::c_int * r)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        (144 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                    ...
                    V_DrawStretchyFixedPatch(
                        (104 as libc::c_int - 7 as libc::c_int * r)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        (144 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                ...
                if amount > 0 as libc::c_int {
                    ...
                    while r > 0 as libc::c_int {
                        ...
                        V_DrawStretchyFixedPatch(
                            (69 as libc::c_int + 7 as libc::c_int * t)
                                * ((1 as libc::c_int) << 16 as libc::c_int),
                            (144 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                ...
                let mut cfill: int32_t = 0;
                V_DrawStretchyFixedPatch(
                    15 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                    (8 as libc::c_int + 34 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (0x80000000 as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                ...
                cfill = 0 as libc::c_int;
                while cfill < amount && cfill < length {
                    V_DrawStretchyFixedPatch(
                        (15 as libc::c_int + cfill + 1 as libc::c_int)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        (8 as libc::c_int + 35 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (0x80000000 as libc::c_uint
                            | 0x4000000 as libc::c_int as libc::c_uint
            ...
            if total_spherecount >= (*(*stplyr).capsule).health {
                V_DrawStretchyFixedPatch(
                    ...
                    (8 as libc::c_int + 5 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (0x80000000 as libc::c_uint
                        | 0x1000000 as libc::c_int as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                    nredar[(leveltime & 7 as libc::c_int as tic_t) as usize],
                    0 as *const uint8_t,
                );
            } else {
                V_DrawStretchyFixedPatch(
                    ...
                    (0x80000000 as libc::c_uint
                        ...
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                    narrow[(leveltime / 2 as libc::c_int as tic_t
                        & 7 as libc::c_int as tic_t) as usize],
                    0 as *const uint8_t,
                );
            }
        } else if oldspecialstage != 0 && total_spherecount < ssspheres as int32_t {
            let mut cfill_0: int32_t = 0;
            let mut amount_0: int32_t = 0;
            let length_0: int32_t = 88 as libc::c_int;
            ...
            if em as libc::c_int <= 7 as libc::c_int {
                V_DrawStretchyFixedPatch(
                    80 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                    (8 as libc::c_int + 8 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (0x80000000 as libc::c_uint
                        | 0x1000000 as libc::c_int as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                    emeraldpics[0 as libc::c_int as usize][em as usize],
                    0 as *const uint8_t,
                );
            }
            V_DrawStretchyFixedPatch(
            ...
            amount_0 = ((total_spherecount * length_0) as uint32_t / ssspheres)
                as int32_t;
            cfill_0 = 0 as libc::c_int;
            while cfill_0 < amount_0 && cfill_0 < length_0 {
                V_DrawStretchyFixedPatch(
                    (15 as libc::c_int + cfill_0 + 1 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (8 as libc::c_int + 35 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
            ...
            V_DrawStretchyFixedPatch(
                ...
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                narrow[8 as libc::c_int as usize],
                0 as *const uint8_t,
            );
        }
        if oldspecialstage != 0 {
            total_spherecount = ssspheres.wrapping_sub(total_spherecount as uint32_t)
                as int32_t;
            if total_spherecount < 0 as libc::c_int {
                total_spherecount = 0 as libc::c_int;
            }
            if nummaprings > 0 as libc::c_int {
                total_ringcount = nummaprings - total_ringcount;
                if total_ringcount < 0 as libc::c_int {
                    total_ringcount = 0 as libc::c_int;
                }
            }
            V_DrawStretchyFixedPatch(
                272 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                (8 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
            ...
            V_DrawStretchyFixedPatch(
                280 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                (16 as libc::c_int + 1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
            ...
            V_DrawStretchyFixedPatch(
                ...
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x800000 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x8000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                narrow[8 as libc::c_int as usize],
            ...
            V_DrawTallNum(
                272 as libc::c_int,
                8 as libc::c_int + 11 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                    | 0x8000000 as libc::c_int as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                total_ringcount,
        ...
        if total_spherecount >= 100 as libc::c_int {
            V_DrawTallNum(
                if total_spherecount >= 1000 as libc::c_int {
                    76 as libc::c_int
                } else {
                    72 as libc::c_int
                },
    ...
    if (*stplyr).exiting == 0 && oldspecialstage == 0
        && LUA_HudEnabled(hud_nightsscore) != 0
    {
        ST_DrawNightsOverlayNum(
            (304 as libc::c_int) << 16 as libc::c_int,
            (14 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint
                | 0x8000000 as libc::c_int as libc::c_uint) as int32_t,
            (*stplyr).marescore,
            nightsnum.as_mut_ptr(),
            SKINCOLOR_AZURE,
        );
    }
    if (*stplyr).exiting == 0 && LUA_HudEnabled(hud_nightsscore) != 0 {
        if modeattacking as libc::c_int == 2 as libc::c_int {
            let mut maretime: int32_t = (if ((*stplyr).realtime)
                .wrapping_sub((*stplyr).marebegunat) > 0 as libc::c_int as tic_t
            {
                ((*stplyr).realtime).wrapping_sub((*stplyr).marebegunat)
            } else {
                0 as libc::c_int as tic_t
            }) as int32_t;
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int - 22 as libc::c_int)
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                (200 as libc::c_int - 20 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                ((0x2000000 as libc::c_int | 0x8000000 as libc::c_int) as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                W_CachePatchName(
                    b"NGRTIMER\0" as *const u8 as *const libc::c_char,
            ...
            V_DrawPaddedTallNum(
                320 as libc::c_int - 22 as libc::c_int,
                200 as libc::c_int - 20 as libc::c_int,
                ((0x2000000 as libc::c_int | 0x8000000 as libc::c_int) as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                G_TicsToCentiseconds(maretime as tic_t),
                2 as libc::c_int,
            );
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int - 46 as libc::c_int)
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                (200 as libc::c_int - 20 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
            ...
            if maretime < 60 as libc::c_int * 35 as libc::c_int {
                V_DrawTallNum(
                    320 as libc::c_int - 46 as libc::c_int,
                    200 as libc::c_int - 20 as libc::c_int,
                    ((0x2000000 as libc::c_int | 0x8000000 as libc::c_int)
                        as libc::c_uint | 0x80000000 as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                    G_TicsToSeconds(maretime as tic_t),
                );
            } else {
                V_DrawPaddedTallNum(
                    320 as libc::c_int - 46 as libc::c_int,
                ...
                V_DrawStretchyFixedPatch(
                    (320 as libc::c_int - 70 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (200 as libc::c_int - 20 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                ...
                V_DrawTallNum(
                    ...
                    ((0x2000000 as libc::c_int | 0x8000000 as libc::c_int)
                        as libc::c_uint | 0x80000000 as libc::c_uint
                        | 0xb0000 as libc::c_int as libc::c_uint) as int32_t,
                    G_TicsToMinutes(maretime as tic_t, true_0 as libc::c_int),
                );
            }
        }
    }
    if (*stplyr).exiting == 0 && (*stplyr).nightstime > 0 as libc::c_int as tic_t
        && LUA_HudEnabled(hud_nightstime) != 0
    {
        let mut realnightstime: int32_t = ((*stplyr).nightstime
            / 35 as libc::c_int as tic_t) as int32_t;
        let mut numbersize: int32_t = 0;
        let mut col: uint8_t = (if realnightstime < 10 as libc::c_int {
            SKINCOLOR_RED as libc::c_int
        } else {
            SKINCOLOR_SUPERGOLD4 as libc::c_int
        }) as uint8_t;
        if G_IsSpecialStage(gamemap as int32_t) != 0 {
            let mut lowest_time: tic_t = (*stplyr).nightstime;
            ...
            while i_0 < 32 as libc::c_int {
                if playeringame[i_0 as usize] != 0
                    && players[i_0 as usize].powers[pw_carry as libc::c_int as usize]
                        as libc::c_int == CR_NIGHTSMODE as libc::c_int
                    && players[i_0 as usize].nightstime < lowest_time
                {
                    lowest_time = players[i_0 as usize].nightstime;
                }
                i_0 += 1;
                i_0;
            }
            realnightstime = (lowest_time / 35 as libc::c_int as tic_t) as int32_t;
        }
        if (*stplyr).powers[pw_flashing as libc::c_int as usize] as libc::c_int
            > 35 as libc::c_int
        {
            let mut flashingLeft: uint16_t = ((*stplyr)
                .powers[pw_flashing as libc::c_int as usize] as libc::c_int
                - 35 as libc::c_int) as uint16_t;
            if (flashingLeft as libc::c_int) < 35 as libc::c_int / 2 as libc::c_int {
                let mut fadingFlag: uint32_t = (9 as libc::c_int
                    - 9 as libc::c_int * flashingLeft as libc::c_int
                        / (35 as libc::c_int / 2 as libc::c_int) << 16 as libc::c_int)
                    as uint32_t;
                V_DrawStretchyFixedPatch(
                    (160 as libc::c_int
                        - (*minus5sec).width as libc::c_int / 2 as libc::c_int)
                        << 16 as libc::c_int,
                    (28 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (0x80000000 as libc::c_uint | fadingFlag) as int32_t,
                    minus5sec,
                    0 as *const uint8_t,
                );
            } else {
        ...
        if realnightstime < 10 as libc::c_int {
            numbersize = 16 as libc::c_int / 2 as libc::c_int;
        } else if realnightstime < 100 as libc::c_int {
            numbersize = 32 as libc::c_int / 2 as libc::c_int;
        } else {
            numbersize = 48 as libc::c_int / 2 as libc::c_int;
        }
        if oldspecialstage != 0 && leveltime & 2 as libc::c_int as tic_t != 0
            && ((*(*stplyr).mo).eflags as libc::c_int
                & (MFE_TOUCHWATER as libc::c_int | MFE_UNDERWATER as libc::c_int) != 0
                && (*stplyr).powers[pw_shield as libc::c_int as usize] as libc::c_int
                    & (if (*(*stplyr).mo).eflags as libc::c_int
                        & MFE_TOUCHLAVA as libc::c_int != 0
                    {
                        SH_PROTECTFIRE as libc::c_int
                    } else {
                        SH_PROTECTWATER as libc::c_int
                    }) == 0)
        {
            col = SKINCOLOR_ORANGE as libc::c_int as uint8_t;
        }
        ST_DrawNightsOverlayNum(
            160 as libc::c_int + numbersize << 16 as libc::c_int,
            (14 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x1000000 as libc::c_int as libc::c_uint)
                as int32_t,
            realnightstime as uint32_t,
            nightsnum.as_mut_ptr(),
            col as skincolornum_t,
        );
        if cv_debug & 0x10 as libc::c_int != 0 {
            V_DrawString(
                160 as libc::c_int + numbersize + 8 as libc::c_int,
                24 as libc::c_int,
                ...
                va(
                    ...
                    G_TicsToCentiseconds((*stplyr).nightstime),
                ),
            );
        }
    }
    if oldspecialstage != 0 {
        if leveltime < (5 as libc::c_int * 35 as libc::c_int) as tic_t {
            let mut aflag: int32_t = 0x80000000 as libc::c_uint as int32_t;
            let mut drawtime: tic_t = ((5 as libc::c_int * 35 as libc::c_int) as tic_t)
                .wrapping_sub(leveltime);
            if drawtime < (35 as libc::c_int / 2 as libc::c_int) as tic_t {
                aflag = (aflag as tic_t
                    | (9 as libc::c_int as tic_t)
                        .wrapping_sub(
                            9 as libc::c_int as tic_t * drawtime
            ...
            V_DrawCenteredString(
                ...
                aflag,
                va(
                    b"\x80GET\x82 %d\x80 SPHERE%s!\0" as *const u8
                        as *const libc::c_char,
                    ssspheres,
                    if ssspheres > 1 as libc::c_int as uint32_t {
                        b"S\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    },
        ...
        if cv_debug & 0x10 as libc::c_int != 0 {
            let mut pwr: uint16_t = 0;
            if (*stplyr).powers[pw_nights_superloop as libc::c_int as usize] != 0 {
                pwr = (*stplyr).powers[pw_nights_superloop as libc::c_int as usize];
                V_DrawStretchyFixedPatch(
                    ...
                    0 as libc::c_int,
                    W_CachePatchName(
                        b"NPRUA0\0" as *const u8 as *const libc::c_char,
                        PU_SPRITE as libc::c_int,
                    ) as *mut patch_t,
                    0 as *const uint8_t,
                );
                V_DrawThinString(
                    ...
                    va(
                        ...
                        pwr as libc::c_int / 35 as libc::c_int,
                        G_TicsToCentiseconds(pwr as tic_t),
                    ),
                );
            }
            if (*stplyr).powers[pw_nights_helper as libc::c_int as usize] != 0 {
                pwr = (*stplyr).powers[pw_nights_helper as libc::c_int as usize];
                V_DrawStretchyFixedPatch(
                    (150 as libc::c_int) << 16 as libc::c_int,
                    (44 as libc::c_int) << 16 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    0 as libc::c_int,
                    W_CachePatchName(
                        b"NPRUC0\0" as *const u8 as *const libc::c_char,
                        PU_SPRITE as libc::c_int,
                    ) as *mut patch_t,
                    0 as *const uint8_t,
                );
            ...
            if (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize] != 0 {
                pwr = (*stplyr).powers[pw_nights_linkfreeze as libc::c_int as usize];
                V_DrawStretchyFixedPatch(
                    (190 as libc::c_int) << 16 as libc::c_int,
                    (44 as libc::c_int) << 16 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                    0 as libc::c_int,
                    W_CachePatchName(
                        b"NPRUE0\0" as *const u8 as *const libc::c_char,
                        PU_SPRITE as libc::c_int,
                    ) as *mut patch_t,
                    0 as *const uint8_t,
                );
        ...
        if LUA_HudEnabled(hud_nightsrecords) != 0 {
            ST_drawNightsRecords();
        }
    };
}
unsafe extern "C" fn ST_drawWeaponSelect(mut xoffs: int32_t, mut y: int32_t) {
    let mut q: int32_t = (*stplyr).weapondelay;
    let mut del: int32_t = 0 as libc::c_int;
    let mut p: int32_t = 16 as libc::c_int;
    while q != 0 {
        if q > p {
            del += p;
            q -= p;
    ...
    V_DrawStretchyFixedPatch(
        (6 as libc::c_int + xoffs) * ((1 as libc::c_int) << 16 as libc::c_int),
        (y - 2 as libc::c_int - del / 2 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (1 as libc::c_int) << 16 as libc::c_int,
        (0x80000000 as libc::c_uint | 0x2000000 as libc::c_int as libc::c_uint)
            as int32_t,
        curweapon,
        0 as *const uint8_t,
    );
}
unsafe extern "C" fn ST_drawWeaponRing(
    mut weapon: powertype_t,
    mut rwflag: int32_t,
    mut wepflag: int32_t,
    mut xoffs: int32_t,
    mut y: int32_t,
    ...
    let mut txtflags: int32_t = 0 as libc::c_int;
    let mut patflags: int32_t = 0 as libc::c_int;
    if (*stplyr).powers[weapon as usize] != 0 {
        if (*stplyr).powers[weapon as usize] as libc::c_int
            >= rw_maximums[wepflag as usize] as libc::c_int
        {
            txtflags |= 0x2000 as libc::c_int;
        }
        if !(weapon as libc::c_uint == pw_infinityring as libc::c_int as libc::c_uint
            || (*stplyr).ringweapons & rwflag != 0)
        {
            txtflags |= 0x50000 as libc::c_int;
            patflags = 0x80000 as libc::c_int;
        }
        V_DrawStretchyFixedPatch(
            (8 as libc::c_int + xoffs) * ((1 as libc::c_int) << 16 as libc::c_int),
            y << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x2000000 as libc::c_int as libc::c_uint
                | patflags as libc::c_uint) as int32_t,
            pat,
            0 as *const uint8_t,
        );
        V_DrawRightAlignedThinString(
            24 as libc::c_int + xoffs,
            y + 8 as libc::c_int,
            (0x80000000 as libc::c_uint | 0x2000000 as libc::c_int as libc::c_uint
                | txtflags as libc::c_uint) as int32_t,
            va(
                b"%d\0" as *const u8 as *const libc::c_char,
                (*stplyr).powers[weapon as usize] as libc::c_int,
            ),
        );
        if (*stplyr).currentweapon == wepflag {
            ST_drawWeaponSelect(xoffs, y);
        }
    } else if (*stplyr).ringweapons & rwflag != 0 {
        V_DrawStretchyFixedPatch(
            (8 as libc::c_int + xoffs) * ((1 as libc::c_int) << 16 as libc::c_int),
            y << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
...
unsafe extern "C" fn ST_drawMatchHUD() {
    let mut penaltystr: [libc::c_char; 7] = [0; 7];
    let y: int32_t = 176 as libc::c_int;
    let mut offset: int32_t = 320 as libc::c_int / 2 as libc::c_int
        - 7 as libc::c_int * 10 as libc::c_int - 6 as libc::c_int;
    if F_GetPromptHideHud(y) != 0 {
        return;
    }
    if G_RingSlingerGametype() == 0 {
    ...
    if (*stplyr).powers[pw_infinityring as libc::c_int as usize] != 0 {
        ST_drawWeaponRing(
            pw_infinityring,
            0 as libc::c_int,
            0 as libc::c_int,
        ...
        if (*stplyr).rings as libc::c_int > 0 as libc::c_int {
            V_DrawStretchyFixedPatch(
                (8 as libc::c_int + offset) * ((1 as libc::c_int) << 16 as libc::c_int),
                y << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x2000000 as libc::c_int as libc::c_uint)
            ...
            V_DrawStretchyFixedPatch(
                8 as libc::c_int + offset << 16 as libc::c_int,
                y << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (0x80000000 as libc::c_uint | 0x2000000 as libc::c_int as libc::c_uint
                    | 0x80000 as libc::c_int as libc::c_uint) as int32_t,
                normring,
                0 as *const uint8_t,
            );
        }
    ...
    ST_drawWeaponRing(
        pw_automaticring,
        RW_AUTO as libc::c_int,
        1 as libc::c_int,
        offset + 20 as libc::c_int,
        y,
        autoring,
    );
    ST_drawWeaponRing(
        pw_bouncering,
        RW_BOUNCE as libc::c_int,
        2 as libc::c_int,
    ...
    ST_drawWeaponRing(
        pw_railring,
        RW_RAIL as libc::c_int,
        6 as libc::c_int,
        offset + 120 as libc::c_int,
        y,
        railring,
    );
    if (*stplyr).ammoremovaltimer != 0
        && (leveltime % 8 as libc::c_int as tic_t) < 4 as libc::c_int as tic_t
    {
        sprintf(
            penaltystr.as_mut_ptr(),
            b"-%d\0" as *const u8 as *const libc::c_char,
            (*stplyr).ammoremoval as libc::c_int,
        );
        V_DrawString(
            offset + 8 as libc::c_int + (*stplyr).ammoremovalweapon * 20 as libc::c_int,
            y,
            ((0x5000 as libc::c_int | 0x2000000 as libc::c_int) as libc::c_uint
                | 0x80000000 as libc::c_uint) as int32_t,
            penaltystr.as_mut_ptr(),
        );
    }
}
unsafe extern "C" fn ST_drawTextHUD() {
    let mut y: int32_t = 42 as libc::c_int + 16 as libc::c_int;
    let mut donef12: boolean = false_0 as libc::c_int;
    if F_GetPromptHideHud(y) != 0 {
        return;
    }
    if (*stplyr).spectator != 0
                ...
                == PST_LIVE as libc::c_int as libc::c_uint)
    {
        V_DrawThinString(
            ...
            (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                | 0x4000000 as libc::c_int as libc::c_uint
                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
            b"\x86Spectator mode:\0" as *const u8 as *const libc::c_char,
        );
        y += 8 as libc::c_int;
    }
    if circuitmap != 0 {
        if (*stplyr).exiting != 0 {
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"\x82FINISHED!\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
        } else {
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    ...
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                va(
                    b"Lap:\x82 %u/%d\0" as *const u8 as *const libc::c_char,
                    (*stplyr).laps as libc::c_int + 1 as libc::c_int,
                    cv_numlaps.value,
                ),
            );
            y += 8 as libc::c_int;
    ...
    if G_CoopGametype() == 0
        && ((*stplyr).exiting != 0
            || G_GametypeUsesLives() != 0
                && (*stplyr).lives as libc::c_int <= 0 as libc::c_int
                && countdown != 1 as libc::c_int as uint32_t)
    {
        if splitscreen == 0 && donef12 == 0 {
            V_DrawThinString(
                16 as libc::c_int,
                y,
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"\x82VIEWPOINT:\x80 Switch view\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
            donef12 = true_0 as libc::c_int;
        }
    } else if gametyperules & GTR_RESPAWNDELAY as libc::c_int as uint32_t != 0
        && (*stplyr).playerstate as libc::c_uint
            == PST_DEAD as libc::c_int as libc::c_uint
        && (*stplyr).lives as libc::c_int != 0
    {
        let mut respawntime: int32_t = cv_respawntime.value
            - (*stplyr).deadtimer / 35 as libc::c_int;
        if respawntime > 0 as libc::c_int && (*stplyr).spectator == 0 {
            V_DrawThinString(
                16 as libc::c_int,
                y,
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    ...
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                va(
                    b"Respawn in %d...\0" as *const u8 as *const libc::c_char,
                    respawntime,
                ),
            );
            y += 8 as libc::c_int;
            ...
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"\x82JUMP:\x80 Respawn\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
        }
    } else if (*stplyr).spectator != 0
                ...
                == PST_LIVE as libc::c_int as libc::c_uint)
    {
        ...
        V_DrawThinString(
            ...
            (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                | 0x4000000 as libc::c_int as libc::c_uint
                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
            b"\x82JUMP:\x80 Rise\0" as *const u8 as *const libc::c_char,
        );
        y += 8 as libc::c_int;
        V_DrawThinString(
            16 as libc::c_int,
            ...
            (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                | 0x4000000 as libc::c_int as libc::c_uint
                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
            b"\x82SPIN:\x80 Lower\0" as *const u8 as *const libc::c_char,
        );
        y += 8 as libc::c_int;
        if G_IsSpecialStage(gamemap as int32_t) != 0 {
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"\x82Wait for the stage to end...\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
        } else if G_PlatformGametype() != 0 {
            if G_GametypeUsesCoopLives() != 0 {
                if (*stplyr).lives as libc::c_int <= 0 as libc::c_int
                    && cv_cooplives.value == 2 as libc::c_int
                    && (netgame != 0 || multiplayer != 0)
                {
                    ...
                    while i < 32 as libc::c_int {
                        if !(playeringame[i as usize] == 0) {
                            if !(&mut *players.as_mut_ptr().offset(i as isize)
                                as *mut player_t == stplyr)
                            {
                                if players[i as usize].lives as libc::c_int
                                    > 1 as libc::c_int
                                {
                    ...
                    if i != 32 as libc::c_int {
                        V_DrawThinString(
                            ...
                            y,
                            (0x80000000 as libc::c_uint
                                | 0xb0000 as libc::c_int as libc::c_uint
                                | 0x4000000 as libc::c_int as libc::c_uint
                                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                            b"You'll steal a life on respawn...\0" as *const u8
                                as *const libc::c_char,
                        );
                        y += 8 as libc::c_int;
                    } else {
                        V_DrawThinString(
                            ...
                            (0x80000000 as libc::c_uint
                                ...
                                | 0x4000000 as libc::c_int as libc::c_uint
                                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                            b"Wait to respawn...\0" as *const u8 as *const libc::c_char,
                        );
                        y += 8 as libc::c_int;
                    }
                } else {
            ...
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"\x82FIRE:\x80 Enter game\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
        }
    }
                ...
                & PF_FINISHED as libc::c_int as libc::c_uint != 0)
    {
        ...
        if numneeded != 0 {
            ...
            while i_0 < 32 as libc::c_int {
                if !(playeringame[i_0 as usize] == 0
                    || players[i_0 as usize].spectator != 0
                    || players[i_0 as usize].bot as libc::c_int != 0)
                {
                    if !(players[i_0 as usize].lives as libc::c_int <= 0 as libc::c_int)
                    {
                        total += 1;
                        total;
                        if players[i_0 as usize].exiting != 0
                            || players[i_0 as usize].pflags as libc::c_uint
                                & PF_FINISHED as libc::c_int as libc::c_uint != 0
                        {
                            exiting += 1;
                            exiting;
            ...
            if numneeded as libc::c_int != 4 as libc::c_int {
                total *= cv_playersforexit.value;
                if total & 3 as libc::c_int != 0 {
            ...
            if exiting < total {
                if splitscreen == 0 && donef12 == 0 {
                    V_DrawThinString(
                        ...
                        (0x80000000 as libc::c_uint
                            ...
                            | 0x4000000 as libc::c_int as libc::c_uint
                            | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                        b"\x82VIEWPOINT:\x80 Switch view\0" as *const u8
                            as *const libc::c_char,
                    );
                    y += 8 as libc::c_int;
                    donef12 = true_0 as libc::c_int;
                ...
                V_DrawThinString(
                    ...
                    (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                        ...
                        | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                    va(
                        b"%d player%s remaining\0" as *const u8 as *const libc::c_char,
                        total,
    ...
    } else if gametyperules & GTR_TAG as libc::c_int as uint32_t != 0
        && (*stplyr).spectator == 0
    {
        if leveltime < hidetime * 35 as libc::c_int as tic_t {
            if (*stplyr).pflags as libc::c_uint & PF_TAGIT as libc::c_int as libc::c_uint
                != 0
            {
                if gametyperules & GTR_BLINDFOLDED as libc::c_int as uint32_t != 0 {
                    V_DrawThinString(
                        16 as libc::c_int,
                        y,
                        (0x80000000 as libc::c_uint
                            ...
                            | 0x4000000 as libc::c_int as libc::c_uint
                            | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                        b"\x82You are blindfolded!\0" as *const u8 as *const libc::c_char,
                    );
                    y += 8 as libc::c_int;
                }
                V_DrawThinString(
                    ...
                    (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                    b"Waiting for players to hide...\0" as *const u8
                        as *const libc::c_char,
                );
                y += 8 as libc::c_int;
                ...
                V_DrawThinString(
                    ...
                    (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                    b"Hide before time runs out!\0" as *const u8 as *const libc::c_char,
                );
                y += 8 as libc::c_int;
            } else {
                V_DrawThinString(
                    ...
                    (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                        | 0x4000000 as libc::c_int as libc::c_uint
                        | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                    b"Flee before you are hunted!\0" as *const u8 as *const libc::c_char,
                );
                y += 8 as libc::c_int;
            }
        } else if gametyperules & GTR_HIDEFROZEN as libc::c_int as uint32_t != 0
                ...
                == 0
        {
            ...
            V_DrawThinString(
                ...
                (0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint
                    | 0x4000000 as libc::c_int as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                b"You cannot move while hiding.\0" as *const u8 as *const libc::c_char,
            );
            y += 8 as libc::c_int;
        }
    }
...
#[inline]
unsafe extern "C" fn ST_drawRaceHUD() {
    if leveltime > 35 as libc::c_int as tic_t
        && leveltime <= (5 as libc::c_int * 35 as libc::c_int) as tic_t
    {
        ST_drawRaceNum(
            ((4 as libc::c_int * 35 as libc::c_int) as tic_t).wrapping_sub(leveltime)
                as int32_t,
        );
    }
}
unsafe extern "C" fn ST_drawTeamHUD() {
    if F_GetPromptHideHud(0 as libc::c_int) != 0 {
        return;
    }
    rflagico = W_CachePatchName(
        b"RFLAGICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bflagico = W_CachePatchName(
        b"BFLAGICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    rmatcico = W_CachePatchName(
        b"RMATCICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    bmatcico = W_CachePatchName(
        b"BMATCICO\0" as *const u8 as *const libc::c_char,
        PU_HUDGFX as libc::c_int,
    ) as *mut patch_t;
    if LUA_HudEnabled(hud_teamscores) != 0 {
        if gametyperules & GTR_TEAMFLAGS as libc::c_int as uint32_t != 0 {
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int / 2 as libc::c_int - 20 as libc::c_int
                    - (*bflagico).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (4 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                (0xb0000 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                bflagico,
                0 as *const uint8_t,
            );
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int / 2 as libc::c_int + 20 as libc::c_int
                    - (*rflagico).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (4 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            ...
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int / 2 as libc::c_int - 20 as libc::c_int
                    - (*bmatcico).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (4 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            ...
            V_DrawStretchyFixedPatch(
                (320 as libc::c_int / 2 as libc::c_int + 20 as libc::c_int
                    - (*rmatcico).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (4 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
    ...
    if !(gametyperules & GTR_TEAMFLAGS as libc::c_int as uint32_t == 0) {
        let mut i: int32_t = 0;
        let mut whichflag: uint16_t = 0 as libc::c_int as uint16_t;
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if players[i as usize].gotflag as libc::c_int & 2 as libc::c_int != 0
                && LUA_HudEnabled(hud_teamscores) != 0
            {
                V_DrawStretchyFixedPatch(
                    (320 as libc::c_int / 2 as libc::c_int - 20 as libc::c_int
                        - (*nonicon).width as libc::c_int / 2 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
            ...
            if players[i as usize].gotflag as libc::c_int & 1 as libc::c_int != 0
                && LUA_HudEnabled(hud_teamscores) != 0
            {
                V_DrawStretchyFixedPatch(
                    (320 as libc::c_int / 2 as libc::c_int + 20 as libc::c_int
                        - (*nonicon2).width as libc::c_int / 2 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (0 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
            ...
            whichflag = (whichflag as libc::c_int
                | players[i as usize].gotflag as libc::c_int) as uint16_t;
            if whichflag as libc::c_int & (1 as libc::c_int | 2 as libc::c_int)
        ...
        if !blueflag.is_null() && (*blueflag).fuse > 1 as libc::c_int
            && LUA_HudEnabled(hud_teamscores) != 0
        {
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int - 20 as libc::c_int,
                8 as libc::c_int,
                ((0x2000 as libc::c_int | 0xb0000 as libc::c_int) as libc::c_uint
                    | 0x80000000 as libc::c_uint
                    | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
                va(
                    b"%u\0" as *const u8 as *const libc::c_char,
                    (*blueflag).fuse / 35 as libc::c_int,
                ),
            );
        }
        if !redflag.is_null() && (*redflag).fuse > 1 as libc::c_int
            && LUA_HudEnabled(hud_teamscores) != 0
        {
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int + 20 as libc::c_int,
    ...
    if LUA_HudEnabled(hud_teamscores) != 0 {
        V_DrawCenteredString(
            ...
            (0xb0000 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint
                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
            va(b"%u\0" as *const u8 as *const libc::c_char, bluescore),
        );
    }
    if LUA_HudEnabled(hud_teamscores) != 0 {
        V_DrawCenteredString(
            ...
            (0xb0000 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint
                | 0x1000000 as libc::c_int as libc::c_uint) as int32_t,
            va(b"%u\0" as *const u8 as *const libc::c_char, redscore),
        );
    }
}
unsafe extern "C" fn ST_drawEmeraldHuntIcon(
    mut hunt: *mut mobj_t,
    mut patches: *mut *mut patch_t,
    mut offset: int32_t,
) -> int32_t {
    ...
    let mut dist: uint32_t = P_AproxDistance(
        P_AproxDistance((*(*stplyr).mo).x - (*hunt).x, (*(*stplyr).mo).y - (*hunt).y),
        (*(*stplyr).mo).z - (*hunt).z,
    ) as uint32_t >> 16 as libc::c_int;
    if dist < 128 as libc::c_int as uint32_t {
        i = 5 as libc::c_int;
        interval = 5 as libc::c_int;
    } else if dist < 512 as libc::c_int as uint32_t {
        i = 4 as libc::c_int;
        interval = 10 as libc::c_int;
    } else if dist < 1024 as libc::c_int as uint32_t {
        i = 3 as libc::c_int;
        interval = 20 as libc::c_int;
    } else if dist < 2048 as libc::c_int as uint32_t {
        i = 2 as libc::c_int;
        interval = 30 as libc::c_int;
    } else if dist < 3072 as libc::c_int as uint32_t {
        i = 1 as libc::c_int;
        interval = 35 as libc::c_int;
    } else {
        i = 0 as libc::c_int;
        interval = 0 as libc::c_int;
    }
    if F_GetPromptHideHud(hudinfo[HUD_HUNTPICS as libc::c_int as usize].y) == 0 {
        V_DrawStretchyFixedPatch(
            (hudinfo[HUD_HUNTPICS as libc::c_int as usize].x + offset)
                * ((1 as libc::c_int) << 16 as libc::c_int),
            hudinfo[HUD_HUNTPICS as libc::c_int as usize].y << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (hudinfo[HUD_HUNTPICS as libc::c_int as usize].f as libc::c_uint
                | 0x80000000 as libc::c_uint | 0xb0000 as libc::c_int as libc::c_uint)
                as int32_t,
            *patches.offset(i as isize),
            0 as *const uint8_t,
        );
    }
    return interval;
}
unsafe extern "C" fn ST_doHuntIconsAndSound() {
    let mut interval: int32_t = 0 as libc::c_int;
    let mut newinterval: int32_t = 0 as libc::c_int;
    if !hunt1.is_null() && (*hunt1).health != 0 {
        interval = ST_drawEmeraldHuntIcon(
            hunt1,
            hunthoming.as_mut_ptr(),
            -(20 as libc::c_int),
        );
    }
    if !hunt2.is_null() && (*hunt2).health != 0 {
        newinterval = ST_drawEmeraldHuntIcon(
            hunt2,
            hunthoming.as_mut_ptr(),
            0 as libc::c_int,
        );
        if newinterval != 0 && (interval == 0 || newinterval < interval) {
            interval = newinterval;
        }
    }
    if !hunt3.is_null() && (*hunt3).health != 0 {
        newinterval = ST_drawEmeraldHuntIcon(
            hunt3,
            hunthoming.as_mut_ptr(),
            20 as libc::c_int,
    ...
    if !(P_AutoPause() != 0 || paused as libc::c_int != 0) && interval > 0 as libc::c_int
        && leveltime != 0 && leveltime % interval as tic_t == 0 as libc::c_int as tic_t
        && renderisnewtic != 0
    {
        S_StartSound(0 as *const libc::c_void, sfx_emfind);
    }
}
unsafe extern "C" fn ST_doItemFinderIconsAndSound() -> boolean {
    let mut emblems: [int32_t; 16] = [0; 16];
    let mut th: *mut thinker_t = 0 as *mut thinker_t;
    let mut mo2: *mut mobj_t = 0 as *mut mobj_t;
    let mut stemblems: uint8_t = 0 as libc::c_int as uint8_t;
    let mut stunfound: uint8_t = 0 as libc::c_int as uint8_t;
    let mut i: int32_t = 0;
    let mut interval: int32_t = 0 as libc::c_int;
    let mut newinterval: int32_t = 0 as libc::c_int;
    let mut soffset: int32_t = 0;
    if !(cv_itemfinder.value != 0
        && M_SecretUnlocked(-(5 as libc::c_int), clientGamedata) as libc::c_int != 0)
    {
        return false_0 as libc::c_int;
    }
    i = 0 as libc::c_int;
    while i < numemblems {
        if !(emblemlocations[i as usize].type_0 as libc::c_int > 1 as libc::c_int
            || emblemlocations[i as usize].level as libc::c_int
                != gamemap as libc::c_int)
        {
            let fresh1 = stemblems;
            stemblems = stemblems.wrapping_add(1);
            emblems[fresh1 as usize] = i;
            if P_EmblemWasCollected(i) == 0 && P_CanPickupEmblem(stplyr, i) != 0 {
                stunfound = stunfound.wrapping_add(1);
                stunfound;
            }
            if stemblems as libc::c_int >= 16 as libc::c_int {
                break;
            }
        }
        i += 1;
            ...
            as *mut thinker_t
    {
            ...
            ))
        {
            ...
            {
                if !((*mo2).flags & MF_SPECIAL as libc::c_int as uint32_t == 0) {
                    i = 0 as libc::c_int;
                    while i < stemblems as libc::c_int {
                        if (*mo2).health == emblems[i as usize] + 1 as libc::c_int {
                            if P_EmblemWasCollected(emblems[i as usize]) != 0
                                || P_CanPickupEmblem(stplyr, emblems[i as usize]) == 0
                            {
                                break;
                            }
                            soffset = i * 20 as libc::c_int
                                - (stemblems as libc::c_int - 1 as libc::c_int)
                                    * 10 as libc::c_int;
                            newinterval = ST_drawEmeraldHuntIcon(
                                mo2,
                                itemhoming.as_mut_ptr(),
                                soffset,
                            );
                            if newinterval != 0
                                && (interval == 0 || newinterval < interval)
                            {
                                interval = newinterval;
                            }
                            break;
...
unsafe extern "C" fn ST_overlayDrawer() {
    let mut stagetitle: boolean = false_0 as libc::c_int;
    if G_IsTitleCardAvailable() != 0
        && *((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
            .lvlttl)
            .as_mut_ptr() as libc::c_int != '\0' as i32
        && !(hu_showscores != 0 && (netgame != 0 || multiplayer != 0))
    {
        stagetitle = true_0 as libc::c_int;
        ST_preDrawTitleCard();
    }
    if !(hu_showscores != 0 && (netgame != 0 || multiplayer != 0)) {
        if (maptol & TOL_NIGHTS as libc::c_int as uint32_t != 0
            || G_IsSpecialStage(gamemap as int32_t) != 0) && F_GetPromptHideHudAll() == 0
        {
            ST_drawNiGHTSHUD();
        } else {
            if LUA_HudEnabled(hud_score) != 0 {
                ST_drawScore();
            }
            if LUA_HudEnabled(hud_time) != 0 {
                ST_drawTime();
            }
            if LUA_HudEnabled(hud_rings) != 0 {
                ST_drawRings();
            }
            if modeattacking == 0 && LUA_HudEnabled(hud_lives) != 0 {
                ST_drawLivesArea();
            }
        }
    }
    if !(G_GametypeUsesCoopLives() != 0 && (netgame != 0 || multiplayer != 0)
        && cv_cooplives.value == 0 as libc::c_int)
    {
        if (G_GametypeUsesLives() != 0
            || gametyperules
            ...
            && !(hu_showscores != 0 && (netgame != 0 || multiplayer != 0))
        {
            let mut i: int32_t = 32 as libc::c_int;
            let mut deadtimer: int32_t = if (*stplyr).spectator != 0 {
                35 as libc::c_int
            } else {
                (*stplyr).deadtimer - ((35 as libc::c_int) << 1 as libc::c_int)
            };
            ...
            if i == 32 as libc::c_int && deadtimer >= 0 as libc::c_int {
                let mut lvlttlx: int32_t = if 6 as libc::c_int * deadtimer
                    < 320 as libc::c_int / 2 as libc::c_int
                {
                    6 as libc::c_int * deadtimer
                } else {
                    320 as libc::c_int / 2 as libc::c_int
                };
                let mut flags: uint32_t = 0x80000000 as libc::c_uint
                    | (if (*stplyr).spectator != 0 {
                        0xa0000 as libc::c_int
                    } else {
                        0xb0000 as libc::c_int
                ...
                V_DrawStretchyFixedPatch(
                    (lvlttlx - 8 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (200 as libc::c_int / 2 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    flags as int32_t,
                    if countdown == 1 as libc::c_int as uint32_t {
                        slidtime
                    } else {
                        slidgame
                    },
                ...
                V_DrawStretchyFixedPatch(
                    (320 as libc::c_int + 8 as libc::c_int - lvlttlx)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (200 as libc::c_int / 2 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
    ...
    if hu_showscores == 0 {
        if countdown > 1 as libc::c_int as uint32_t {
            let mut time: tic_t = (countdown / 35 as libc::c_int as uint32_t)
                .wrapping_add(1 as libc::c_int as uint32_t);
            if time < 4 as libc::c_int as tic_t {
                ST_drawRaceNum(countdown as int32_t);
            } else {
                let mut num: tic_t = time;
                let mut sz: int32_t = (*tallnum[0 as libc::c_int as usize]).width
                    as libc::c_int / 2 as libc::c_int;
                let mut width: int32_t = 0 as libc::c_int;
                loop {
                    width += sz;
                    num = num / 10 as libc::c_int as tic_t;
                    if !(num != 0) {
                        break;
                    }
                }
                V_DrawTallNum(
                    320 as libc::c_int / 2 as libc::c_int + width,
                    (3 as libc::c_int * 200 as libc::c_int >> 2 as libc::c_int)
                        - 7 as libc::c_int,
                    0x80000000 as libc::c_uint as int32_t,
                    time as int32_t,
                );
        ...
        if gametyperules & GTR_TIMELIMIT as libc::c_int as uint32_t != 0
            ...
            && leveltime
                > timelimitintics
                    .wrapping_add((35 as libc::c_int / 2 as libc::c_int) as uint32_t)
            && cv_timelimit.value != 0
            && leveltime / 35 as libc::c_int as tic_t % 2 as libc::c_int as tic_t
                == 0 as libc::c_int as tic_t
        {
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int,
        ...
        if (*stplyr).spectator == 0 && LUA_HudEnabled(hud_weaponrings) != 0 {
            ST_drawMatchHUD();
        }
        if gametyperules & GTR_RACE as libc::c_int as uint32_t != 0 {
            ST_drawRaceHUD();
        }
        if ST_doItemFinderIconsAndSound() == 0 {
            ST_doHuntIconsAndSound();
        }
        if P_IsLocalPlayer(stplyr) == 0 {
            let mut name: [libc::c_char; 22] = [0; 22];
            strlcpy(
                name.as_mut_ptr(),
                (player_names[stplyr.offset_from(players.as_mut_ptr()) as libc::c_long
                    as usize])
                    .as_mut_ptr(),
                13 as libc::c_int as libc::c_ulong,
            );
            V_DrawCenteredString(
                320 as libc::c_int / 6 as libc::c_int,
                200 as libc::c_int - 80 as libc::c_int,
                0 as libc::c_int,
                b"Viewpoint:\0" as *const u8 as *const libc::c_char,
            );
            V_DrawCenteredString(
                320 as libc::c_int / 6 as libc::c_int,
                200 as libc::c_int - 64 as libc::c_int,
        ...
        if stplyr
            ...
            || splitscreen != 0
                && stplyr
                    == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                        as *mut player_t && camera2.chase == 0
        {
            ST_drawFirstPersonHUD();
            if cv_powerupdisplay.value != 0 {
                ST_drawPowerupHUD();
            }
        } else if cv_powerupdisplay.value == 2 as libc::c_int {
            ST_drawPowerupHUD();
        }
    } else if !(netgame != 0 || multiplayer != 0)
        && cv_powerupdisplay.value == 2 as libc::c_int
    {
        ST_drawPowerupHUD();
    }
    if !(netgame != 0 || multiplayer != 0) || hu_showscores == 0 {
        let mut hooklistindex: int32_t = if splitscreen != 0
            && stplyr
                == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                    as *mut player_t
        {
        ...
        if renderisnewtic != 0 {
            LUA_HUD_ClearDrawList(luahuddrawlist_game[hooklistindex as usize]);
            LUA_HookHUD(
                hudhook_game as libc::c_int,
                luahuddrawlist_game[hooklistindex as usize],
            );
        }
        LUA_HUD_DrawList(luahuddrawlist_game[hooklistindex as usize]);
    }
    if stagetitle != 0 && WipeInAction == 0 && WipeStageTitle == 0 {
        ST_drawTitleCard();
    }
    if hu_showscores == 0 && (netgame != 0 || multiplayer != 0)
        && LUA_HudEnabled(hud_textspectator) != 0
    {
        ST_drawTextHUD();
    }
    if modeattacking as libc::c_int != 0 && !(demoplayback != 0 && hu_showscores != 0) {
        ST_drawInput();
    }
    ST_drawDebugInfo();
}
#[no_mangle]
pub unsafe extern "C" fn ST_Drawer() {
    if cv_seenames.value != 0 && cv_allowseenames.value != 0
        && displayplayer == consoleplayer && !seenplayer.is_null()
        && !((*seenplayer).mo).is_null()
    {
        let mut c: int32_t = 0 as libc::c_int;
        match cv_seenames.value {
            1 => {}
            2 => {
                if G_GametypeHasTeams() != 0 {
                    c = if (*seenplayer).ctfteam == 1 as libc::c_int {
                        0x5000 as libc::c_int
                    } else {
            ...
            3 | _ => {
                if G_GametypeHasTeams() != 0 {
                    c = if players[consoleplayer as usize].ctfteam
                        == (*seenplayer).ctfteam
                    {
                        0x3000 as libc::c_int
                    } else {
        ...
        V_DrawCenteredString(
            320 as libc::c_int / 2 as libc::c_int,
            200 as libc::c_int / 2 as libc::c_int + 15 as libc::c_int,
            0xa0000 as libc::c_int | c,
            (player_names[seenplayer.offset_from(players.as_mut_ptr()) as libc::c_long
                as usize])
                .as_mut_ptr(),
        );
    }
    ...
    {
        if players[displayplayer as usize].pflags as libc::c_uint
            & PF_TAGIT as libc::c_int as libc::c_uint != 0
        {
            stplyr = &mut *players.as_mut_ptr().offset(displayplayer as isize)
                as *mut player_t;
            V_DrawFill(
                0 as libc::c_int,
                0 as libc::c_int,
                320 as libc::c_int,
                200 as libc::c_int,
                (31 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint)
                    as int32_t,
            );
        } else if splitscreen != 0
            && players[secondarydisplayplayer as usize].pflags as libc::c_uint
                & PF_TAGIT as libc::c_int as libc::c_uint != 0
        {
            stplyr = &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                as *mut player_t;
