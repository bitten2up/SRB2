...
extern "C" {
    ...
    fn P_IsDegeneratedWaypointSequence(sequence: uint8_t) -> boolean;
    fn M_AddToBox(box_0: *mut fixed_t, x: fixed_t, y: fixed_t);
    fn M_QueueInit(queue: *mut mqueue_t);
    fn M_QueueInsert(item: *mut mqueueitem_t, queue: *mut mqueue_t);
    fn M_QueueIterator(queue: *mut mqueue_t) -> *mut mqueueitem_t;
    fn M_QueueFree(queue: *mut mqueue_t);
    ...
    fn R_CreateInterpolator_Polyobj(thinker: *mut thinker_t, polyobj: *mut polyobj_t);
    static mut numsegs: size_t;
...
pub const NUMTRANSMAPS: C2RustUnnamed_1 = 10;
pub const tr_trans90: C2RustUnnamed_1 = 9;
pub const tr_trans80: C2RustUnnamed_1 = 8;
pub const tr_trans70: C2RustUnnamed_1 = 7;
pub const tr_trans60: C2RustUnnamed_1 = 6;
pub const tr_trans50: C2RustUnnamed_1 = 5;
pub const tr_trans40: C2RustUnnamed_1 = 4;
pub const tr_trans30: C2RustUnnamed_1 = 3;
pub const tr_trans20: C2RustUnnamed_1 = 2;
pub const tr_trans10: C2RustUnnamed_1 = 1;
...
pub const BOXRIGHT: C2RustUnnamed_4 = 3;
pub const BOXLEFT: C2RustUnnamed_4 = 2;
pub const BOXBOTTOM: C2RustUnnamed_4 = 1;
pub const BOXTOP: C2RustUnnamed_4 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mqueueitem_s {
    pub next: *mut mqueueitem_s,
}
pub type mqueueitem_t = mqueueitem_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mqueue_s {
    pub head: mqueueitem_t,
    pub tail: *mut mqueueitem_t,
    pub rover: *mut mqueueitem_t,
}
pub type mqueue_t = mqueue_s;
pub type C2RustUnnamed_5 = libc::c_uint;
pub const POF_SPLAT: C2RustUnnamed_5 = 8192;
pub const POF_NOSPECIALS: C2RustUnnamed_5 = 4096;
pub const POF_ONESIDE: C2RustUnnamed_5 = 2048;
pub const POF_LDEXEC: C2RustUnnamed_5 = 1024;
pub const POF_PUSHABLESTOP: C2RustUnnamed_5 = 512;
pub const POF_INVERTPLANESONLY: C2RustUnnamed_5 = 256;
pub const POF_INVERTPLANES: C2RustUnnamed_5 = 128;
pub const POF_INVERT: C2RustUnnamed_5 = 64;
pub const POF_RENDERALL: C2RustUnnamed_5 = 56;
pub const POF_RENDERPLANES: C2RustUnnamed_5 = 48;
pub const POF_RENDERBOTTOM: C2RustUnnamed_5 = 32;
pub const POF_RENDERTOP: C2RustUnnamed_5 = 16;
pub const POF_RENDERSIDES: C2RustUnnamed_5 = 8;
pub const POF_TESTHEIGHT: C2RustUnnamed_5 = 4;
pub const POF_SOLID: C2RustUnnamed_5 = 3;
pub const POF_CLIPPLANES: C2RustUnnamed_5 = 2;
pub const POF_CLIPLINES: C2RustUnnamed_5 = 1;
pub type C2RustUnnamed_6 = libc::c_uint;
pub const TMPF_SPLAT: C2RustUnnamed_6 = 64;
pub const TMPF_CRUSH: C2RustUnnamed_6 = 32;
pub const TMPF_EXECUTOR: C2RustUnnamed_6 = 16;
pub const TMPF_INVISIBLEPLANES: C2RustUnnamed_6 = 8;
pub const TMPF_PUSHABLESTOP: C2RustUnnamed_6 = 4;
pub const TMPF_INTANGIBLE: C2RustUnnamed_6 = 2;
pub const TMPF_NOINSIDES: C2RustUnnamed_6 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type polyrotate_t = polyrotate_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polymove_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub speed: int32_t,
    pub momx: fixed_t,
...
pub type polymove_t = polymove_s;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const PWR_COMEBACK: C2RustUnnamed_7 = 2;
pub const PWR_WRAP: C2RustUnnamed_7 = 1;
pub const PWR_STOP: C2RustUnnamed_7 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polywaypoint_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub speed: int32_t,
    pub sequence: int32_t,
    pub pointnum: int32_t,
    pub direction: int32_t,
    pub returnbehavior: uint8_t,
    pub continuous: uint8_t,
    pub stophere: uint8_t,
}
pub type polywaypoint_t = polywaypoint_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polyslidedoor_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub delay: int32_t,
    pub delayCount: int32_t,
    pub initSpeed: int32_t,
    pub speed: int32_t,
    pub initDistance: int32_t,
    pub distance: int32_t,
    pub initAngle: uint32_t,
    pub angle: uint32_t,
    pub revAngle: uint32_t,
    pub momx: fixed_t,
    pub momy: fixed_t,
    pub closing: uint8_t,
}
pub type polyslidedoor_t = polyslidedoor_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polyswingdoor_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub delay: int32_t,
    pub delayCount: int32_t,
...
pub type polyswingdoor_t = polyswingdoor_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polydisplace_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub controlSector: *mut sector_s,
    pub dx: fixed_t,
    pub dy: fixed_t,
    pub oldHeights: fixed_t,
}
pub type polydisplace_t = polydisplace_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct polyrotdisplace_s {
    pub thinker: thinker_t,
    pub polyObjNum: int32_t,
    pub controlSector: *mut sector_s,
...
pub type polyrotdisplace_t = polyrotdisplace_s;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const TMPR_OVERRIDE: C2RustUnnamed_8 = 8;
pub const TMPR_CONTINUOUS: C2RustUnnamed_8 = 4;
pub const TMPR_ROTATEPLAYERS: C2RustUnnamed_8 = 2;
pub const TMPR_DONTROTATEOTHERS: C2RustUnnamed_8 = 1;
pub type C2RustUnnamed_9 = libc::c_uint;
pub const PTF_OTHERS: C2RustUnnamed_9 = 2;
pub const PTF_PLAYERS: C2RustUnnamed_9 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const POLY_DOOR_SWING: C2RustUnnamed_11 = 1;
pub const POLY_DOOR_SLIDE: C2RustUnnamed_11 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type mobjqitem_t = mobjqitem_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mobjqitem_s {
    pub mqitem: mqueueitem_t,
    pub mo: *mut mobj_t,
}
...
#[inline(always)]
unsafe extern "C" fn M_DLListInsert(
    mut item: *mut mdllistitem_t,
    mut head: *mut *mut mdllistitem_t,
) {
    let mut next: *mut mdllistitem_t = *head;
    (*item).next = next;
    if !((*item).next).is_null() {
        (*next).prev = &mut (*item).next;
    }
    (*item).prev = head;
    *head = item;
}
#[inline(always)]
unsafe extern "C" fn M_DLListRemove(mut item: *mut mdllistitem_t) {
    let mut prev: *mut *mut mdllistitem_t = (*item).prev;
    let mut next: *mut mdllistitem_t = (*item).next;
    *prev = next;
    if !(*prev).is_null() {
        (*next).prev = prev;
    }
...
#[no_mangle]
pub static mut PolyObjects: *mut polyobj_t = 0 as *const polyobj_t as *mut polyobj_t;
#[no_mangle]
pub static mut numPolyObjects: int32_t = 0;
#[no_mangle]
pub static mut polyblocklinks: *mut *mut polymaplink_t = 0 as *const *mut polymaplink_t
    as *mut *mut polymaplink_t;
static mut bmap_freelist: *mut polymaplink_t = 0 as *const polymaplink_t
    as *mut polymaplink_t;
#[inline(always)]
unsafe extern "C" fn Polyobj_bboxAdd(mut bbox: *mut fixed_t, mut add: *mut vertex_t) {
    *bbox.offset(BOXTOP as libc::c_int as isize) += (*add).y;
    *bbox.offset(BOXBOTTOM as libc::c_int as isize) += (*add).y;
    *bbox.offset(BOXLEFT as libc::c_int as isize) += (*add).x;
    *bbox.offset(BOXRIGHT as libc::c_int as isize) += (*add).x;
}
#[inline(always)]
unsafe extern "C" fn Polyobj_bboxSub(mut bbox: *mut fixed_t, mut sub: *mut vertex_t) {
    *bbox.offset(BOXTOP as libc::c_int as isize) -= (*sub).y;
    *bbox.offset(BOXBOTTOM as libc::c_int as isize) -= (*sub).y;
    *bbox.offset(BOXLEFT as libc::c_int as isize) -= (*sub).x;
    *bbox.offset(BOXRIGHT as libc::c_int as isize) -= (*sub).x;
}
#[inline(always)]
unsafe extern "C" fn Polyobj_vecAdd(mut dst: *mut vertex_t, mut add: *mut vertex_t) {
    (*dst).x += (*add).x;
    (*dst).y += (*add).y;
}
#[inline(always)]
unsafe extern "C" fn Polyobj_vecSub(mut dst: *mut vertex_t, mut sub: *mut vertex_t) {
    (*dst).x -= (*sub).x;
    (*dst).y -= (*sub).y;
}
#[inline(always)]
unsafe extern "C" fn Polyobj_vecSub2(
    mut dst: *mut vertex_t,
    mut v1: *mut vertex_t,
    mut v2: *mut vertex_t,
) {
    (*dst).x = (*v1).x - (*v2).x;
...
#[no_mangle]
pub unsafe extern "C" fn P_PointInsidePolyobj(
    ...
    while i < (*po).numLines {
        if P_PointOnLineSide(x, y, *((*po).lines).offset(i as isize)) == 0 as libc::c_int
        {
...
#[no_mangle]
pub unsafe extern "C" fn P_MobjTouchingPolyobj(
    mut po: *mut polyobj_t,
    mut mo: *mut mobj_t,
) -> boolean {
    let mut mbbox: [fixed_t; 4] = [0; 4];
    let mut i: size_t = 0;
    mbbox[BOXTOP as libc::c_int as usize] = (*mo).y + (*mo).radius;
    mbbox[BOXBOTTOM as libc::c_int as usize] = (*mo).y - (*mo).radius;
    mbbox[BOXRIGHT as libc::c_int as usize] = (*mo).x + (*mo).radius;
    mbbox[BOXLEFT as libc::c_int as usize] = (*mo).x - (*mo).radius;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numLines {
        if P_BoxOnLineSide(mbbox.as_mut_ptr(), *((*po).lines).offset(i as isize))
            == -(1 as libc::c_int)
        {
            return true_0 as libc::c_int;
        }
...
#[no_mangle]
pub unsafe extern "C" fn P_MobjInsidePolyobj(
    mut po: *mut polyobj_t,
    mut mo: *mut mobj_t,
) -> boolean {
    let mut mbbox: [fixed_t; 4] = [0; 4];
...
#[no_mangle]
pub unsafe extern "C" fn P_BBoxInsidePolyobj(
    mut po: *mut polyobj_t,
    mut bbox: *mut fixed_t,
) -> boolean {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numLines {
        if P_BoxOnLineSide(bbox, *((*po).lines).offset(i as isize)) == 0 as libc::c_int {
            return false_0 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn Polyobj_GetInfo(mut po: *mut polyobj_t, mut line: *mut line_t) {
    (*po).parent = (*line).args[1 as libc::c_int as usize];
    if (*po).parent == (*po).id {
        (*po).parent = -(1 as libc::c_int);
    }
    (*po)
        .translucency = if (if (*line).args[2 as libc::c_int as usize]
    ...
    {
        if (*line).args[2 as libc::c_int as usize] < NUMTRANSMAPS as libc::c_int {
            (*line).args[2 as libc::c_int as usize]
        } else {
            NUMTRANSMAPS as libc::c_int
        }
    ...
    (*po)
        .flags = POF_SOLID as libc::c_int | POF_TESTHEIGHT as libc::c_int
        | POF_RENDERSIDES as libc::c_int | POF_RENDERPLANES as libc::c_int;
    if (*line).args[3 as libc::c_int as usize] & TMPF_NOINSIDES as libc::c_int != 0 {
        (*po).flags |= POF_ONESIDE as libc::c_int;
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_INTANGIBLE as libc::c_int != 0 {
        (*po).flags &= !(POF_SOLID as libc::c_int);
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_PUSHABLESTOP as libc::c_int != 0 {
        (*po).flags |= POF_PUSHABLESTOP as libc::c_int;
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_INVISIBLEPLANES as libc::c_int != 0
    {
        (*po).flags &= !(POF_RENDERPLANES as libc::c_int);
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_SPLAT as libc::c_int != 0 {
        (*po).flags |= POF_SPLAT as libc::c_int;
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_EXECUTOR as libc::c_int != 0 {
        (*po).flags |= POF_LDEXEC as libc::c_int;
    }
    if (*line).args[3 as libc::c_int as usize] & TMPF_CRUSH as libc::c_int != 0 {
        (*po).damage = 3 as libc::c_int;
    }
    (*po).triggertag = (*line).args[4 as libc::c_int as usize] as int16_t;
}
unsafe extern "C" fn Polyobj_addVertex(mut po: *mut polyobj_t, mut v: *mut vertex_t) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices {
        if *((*po).vertices).offset(i as isize) == v {
            return;
        }
        i = i.wrapping_add(1);
        i;
    ...
    if (*po).numVertices >= (*po).numVerticesAlloc {
        (*po)
            .numVerticesAlloc = if (*po).numVerticesAlloc != 0 {
            (*po).numVerticesAlloc * 2 as libc::c_int as size_t
        } else {
            4 as libc::c_int as size_t
        };
        (*po)
            .vertices = Z_ReallocAlign(
            (*po).vertices as *mut libc::c_void,
            ((*po).numVerticesAlloc)
                .wrapping_mul(::core::mem::size_of::<*mut vertex_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut *mut vertex_t;
        (*po)
            .origVerts = Z_ReallocAlign(
            (*po).origVerts as *mut libc::c_void,
            ((*po).numVerticesAlloc)
                .wrapping_mul(::core::mem::size_of::<vertex_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut vertex_t;
        (*po)
            .tmpVerts = Z_ReallocAlign(
            (*po).tmpVerts as *mut libc::c_void,
            ((*po).numVerticesAlloc)
                .wrapping_mul(::core::mem::size_of::<vertex_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
    ...
    let ref mut fresh0 = *((*po).vertices).offset((*po).numVertices as isize);
    *fresh0 = v;
    *((*po).origVerts).offset((*po).numVertices as isize) = *v;
    (*po).numVertices = ((*po).numVertices).wrapping_add(1);
    (*po).numVertices;
}
unsafe extern "C" fn Polyobj_addLine(mut po: *mut polyobj_t, mut l: *mut line_t) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numLines {
        if *((*po).lines).offset(i as isize) == l {
            return;
        }
        i = i.wrapping_add(1);
        i;
    ...
    if (*po).numLines >= (*po).numLinesAlloc {
        (*po)
            .numLinesAlloc = if (*po).numLinesAlloc != 0 {
            (*po).numLinesAlloc * 2 as libc::c_int as size_t
        } else {
            4 as libc::c_int as size_t
        };
        (*po)
            .lines = Z_ReallocAlign(
            (*po).lines as *mut libc::c_void,
            ((*po).numLinesAlloc)
                .wrapping_mul(::core::mem::size_of::<*mut line_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut *mut line_t;
    ...
    (*l).polyobj = po;
    let fresh1 = (*po).numLines;
    (*po).numLines = ((*po).numLines).wrapping_add(1);
    let ref mut fresh2 = *((*po).lines).offset(fresh1 as isize);
    *fresh2 = l;
}
unsafe extern "C" fn Polyobj_addSeg(mut po: *mut polyobj_t, mut seg: *mut seg_t) {
    if (*po).segCount >= (*po).numSegsAlloc {
        (*po)
            .numSegsAlloc = if (*po).numSegsAlloc != 0 {
            (*po).numSegsAlloc * 2 as libc::c_int as size_t
        } else {
            4 as libc::c_int as size_t
        };
        (*po)
            .segs = Z_ReallocAlign(
            (*po).segs as *mut libc::c_void,
            ((*po).numSegsAlloc)
                .wrapping_mul(::core::mem::size_of::<*mut seg_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut *mut seg_t;
    ...
    (*seg).polyseg = po;
    let fresh3 = (*po).segCount;
    (*po).segCount = ((*po).segCount).wrapping_add(1);
    let ref mut fresh4 = *((*po).segs).offset(fresh3 as isize);
    *fresh4 = seg;
    Polyobj_addVertex(po, (*seg).v1);
    Polyobj_addVertex(po, (*seg).v2);
    Polyobj_addLine(po, (*seg).linedef);
}
unsafe extern "C" fn Polyobj_findSegs(mut po: *mut polyobj_t, mut seg: *mut seg_t) {
    let mut startx: fixed_t = 0;
    let mut starty: fixed_t = 0;
    let mut i: size_t = 0;
    let mut s: size_t = 0;
    Polyobj_addSeg(po, seg);
    if (*po).flags & POF_ONESIDE as libc::c_int == 0 {
        s = 0 as libc::c_int as size_t;
        while s < numsegs {
            let mut r: size_t = 0;
            if !((*segs.offset(s as isize)).glseg != 0) {
                if !((*segs.offset(s as isize)).linedef != (*seg).linedef) {
                    if !((*segs.offset(s as isize)).side != 1 as libc::c_int) {
                        r = 0 as libc::c_int as size_t;
                        while r < (*po).segCount {
                            if *((*po).segs).offset(r as isize)
                                == &mut *segs.offset(s as isize) as *mut seg_t
                            {
                                break;
                            }
                            r = r.wrapping_add(1);
                        ...
                        if !(r != (*po).segCount) {
                            (*segs.offset(s as isize))
                                .dontrenderme = true_0 as libc::c_int;
                            Polyobj_addSeg(po, &mut *segs.offset(s as isize));
                        }
                    }
                }
            }
    ...
    '_newseg: loop {
        ...
        loop {
            ...
            let mut q: size_t = 0;
            if !((*segs.offset(i as isize)).glseg != 0) {
                if !((*segs.offset(i as isize)).side != 0 as libc::c_int) {
                    if !((*(*segs.offset(i as isize)).v1).x != (*(*seg).v2).x) {
                        if !((*(*segs.offset(i as isize)).v1).y != (*(*seg).v2).y) {
                            q = 0 as libc::c_int as size_t;
                            while q < (*po).segCount {
                                if *((*po).segs).offset(q as isize)
                                    == &mut *segs.offset(i as isize) as *mut seg_t
                                {
                                    break;
                                }
                                q = q.wrapping_add(1);
                            ...
                            if !(q != (*po).segCount) {
                                Polyobj_addSeg(po, &mut *segs.offset(i as isize));
                                seg = &mut *segs.offset(i as isize) as *mut seg_t;
                                if (*po).flags & POF_ONESIDE as libc::c_int == 0 {
                                    q = 0 as libc::c_int as size_t;
                                    while q < numsegs {
                                        let mut r_0: size_t = 0;
                                        if !((*segs.offset(q as isize)).glseg != 0) {
                                            if !((*segs.offset(q as isize)).linedef
                                                != (*segs.offset(i as isize)).linedef)
                                            {
                                                if !((*segs.offset(q as isize)).side != 1 as libc::c_int) {
                                                    r_0 = 0 as libc::c_int as size_t;
                                                    while r_0 < (*po).segCount {
                                                        if *((*po).segs).offset(r_0 as isize)
                                                            == &mut *segs.offset(q as isize) as *mut seg_t
                                                        {
                                                            break;
                                                        }
                                                    ...
                                                    if !(r_0 != (*po).segCount) {
                                                        (*segs.offset(q as isize))
                                                            .dontrenderme = true_0 as libc::c_int;
                                                        Polyobj_addSeg(po, &mut *segs.offset(q as isize));
                                                    }
                                                }
                                            }
                                        }
    ...
    (*po).isBad = true_0 as libc::c_int as uint8_t;
    CONS_Debug(
        0x40 as libc::c_int,
        b"Polyobject %d is not closed\n\0" as *const u8 as *const libc::c_char,
        (*po).id,
    );
}
unsafe extern "C" fn Polyobj_spawnPolyObj(
    mut num: int32_t,
    mut spawnSpot: *mut mobj_t,
    mut id: int32_t,
) {
    let mut i: size_t = 0;
    let mut po: *mut polyobj_t = &mut *PolyObjects.offset(num as isize)
        as *mut polyobj_t;
    if (*po).segCount != 0 {
        CONS_Debug(
            0x40 as libc::c_int,
            b"Polyobj %d has more than one spawn spot\0" as *const u8
    ...
    (*po).id = id;
    (*po).thrust = (1 as libc::c_int) << 16 as libc::c_int;
    (*po).flags = 0 as libc::c_int;
    (*po).spawnflags = (*po).flags;
    i = 0 as libc::c_int as size_t;
    while i < numsegs {
        let mut seg: *mut seg_t = &mut *segs.offset(i as isize) as *mut seg_t;
        if !((*seg).glseg != 0) {
            if !((*seg).side != 0 as libc::c_int) {
                if !((*(*seg).linedef).special as libc::c_int != 20 as libc::c_int) {
                    if !((*(*seg).linedef).args[0 as libc::c_int as usize] != (*po).id) {
                        Polyobj_GetInfo(po, (*seg).linedef);
                        (*po).spawnflags = (*po).flags;
    ...
    CONS_Debug(
        0x40 as libc::c_int,
        b"PO ID: %d; Num verts: %s\n\0" as *const u8 as *const libc::c_char,
        (*po).id,
        sizeu1((*po).numVertices),
    );
    if (*po).isBad != 0 {
        return;
    }
    if (*po).segCount == 0 as libc::c_int as size_t {
        (*po).isBad = true_0 as libc::c_int as uint8_t;
        CONS_Debug(
            0x40 as libc::c_int,
            b"Polyobject %d is empty\n\0" as *const u8 as *const libc::c_char,
            (*po).id,
        );
        return;
    }
    ...
    if !(Polyobj_GetForNum((*po).id)).is_null() {
        (*po).isBad = true_0 as libc::c_int as uint8_t;
        CONS_Debug(
            0x40 as libc::c_int,
            b"Polyobject id conflict: %d\n\0" as *const u8 as *const libc::c_char,
            id,
        );
    } else {
        let mut hashkey: int32_t = (*po).id % numPolyObjects;
        (*po).next = (*PolyObjects.offset(hashkey as isize)).first;
        (*PolyObjects.offset(hashkey as isize)).first = num;
    };
}
unsafe extern "C" fn Polyobj_moveToSpawnSpot(mut anchor: *mut mapthing_t) {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut dist: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    let mut sspot: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    let mut i: size_t = 0;
    let mut tag: mtag_t = Tag_FGet(&mut (*anchor).tags);
    po = Polyobj_GetForNum(tag as int32_t);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"Bad polyobject %d for anchor point\n\0" as *const u8
                as *const libc::c_char,
            tag as libc::c_int,
        );
        return;
    ...
    if (*po).attached != 0 {
        CONS_Debug(
            0x40 as libc::c_int,
            b"Polyobj %d has more than one anchor\n\0" as *const u8
                as *const libc::c_char,
            (*po).id,
        );
        return;
    ...
    dist.x = (((*anchor).x as libc::c_int) << 16 as libc::c_int) - sspot.x;
    dist.y = (((*anchor).y as libc::c_int) << 16 as libc::c_int) - sspot.y;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numLines {
        Polyobj_bboxSub(
            ((**((*po).lines).offset(i as isize)).bbox).as_mut_ptr(),
            &mut dist,
        );
        i = i.wrapping_add(1);
        i;
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices {
        Polyobj_vecSub(*((*po).vertices).offset(i as isize), &mut dist);
        Polyobj_vecSub2(
            &mut *((*po).origVerts).offset(i as isize),
            *((*po).vertices).offset(i as isize),
            &mut sspot,
        );
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn Polyobj_attachToSubsec(mut po: *mut polyobj_t) {
    let mut ss: *mut subsector_t = 0 as *mut subsector_t;
    let mut center_x: fixed_t = 0 as libc::c_int;
    let mut center_y: fixed_t = 0 as libc::c_int;
    let mut numVertices: fixed_t = 0;
    let mut i: size_t = 0;
    if (*po).isBad != 0 {
        return;
    }
    numVertices = ((*po).numVertices
        * ((1 as libc::c_int) << 16 as libc::c_int) as size_t) as fixed_t;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices {
        center_x += FixedDiv((**((*po).vertices).offset(i as isize)).x, numVertices);
        center_y += FixedDiv((**((*po).vertices).offset(i as isize)).y, numVertices);
        i = i.wrapping_add(1);
        i;
    }
    ...
    M_DLListInsert(
        &mut (*po).link,
        &mut (*ss).polyList as *mut *mut polyobj_s as *mut libc::c_void
            as *mut *mut mdllistitem_t,
    );
    (*po).attached = true_0 as libc::c_int as uint8_t;
}
unsafe extern "C" fn Polyobj_removeFromSubsec(mut po: *mut polyobj_t) {
    if (*po).attached != 0 {
        M_DLListRemove(&mut (*po).link);
        (*po).attached = false_0 as libc::c_int as uint8_t;
    }
}
unsafe extern "C" fn Polyobj_getLink() -> *mut polymaplink_t {
    let mut l: *mut polymaplink_t = 0 as *mut polymaplink_t;
    if !bmap_freelist.is_null() {
        l = bmap_freelist;
        bmap_freelist = (*l).link.next as *mut polymaplink_t;
    } else {
        l = Z_MallocAlign(
            ::core::mem::size_of::<polymaplink_t>() as libc::c_ulong,
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut polymaplink_t;
...
unsafe extern "C" fn Polyobj_putLink(mut l: *mut polymaplink_t) {
    memset(
        l as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<polymaplink_t>() as libc::c_ulong,
    );
    (*l).link.next = bmap_freelist as *mut mdllistitem_t;
    bmap_freelist = l;
}
unsafe extern "C" fn Polyobj_linkToBlockmap(mut po: *mut polyobj_t) {
    let mut blockbox: *mut fixed_t = ((*po).blockbox).as_mut_ptr();
    let mut i: size_t = 0;
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    if (*po).isBad as libc::c_int != 0 || (*po).linked as libc::c_int != 0 {
        return;
    }
    let ref mut fresh5 = *blockbox.offset(BOXRIGHT as libc::c_int as isize);
    *fresh5 = (**((*po).vertices).offset(0 as libc::c_int as isize)).x;
    *blockbox.offset(BOXLEFT as libc::c_int as isize) = *fresh5;
    let ref mut fresh6 = *blockbox.offset(BOXTOP as libc::c_int as isize);
    *fresh6 = (**((*po).vertices).offset(0 as libc::c_int as isize)).y;
    *blockbox.offset(BOXBOTTOM as libc::c_int as isize) = *fresh6;
    i = 1 as libc::c_int as size_t;
    while i < (*po).numVertices {
        M_AddToBox(
            blockbox,
            (**((*po).vertices).offset(i as isize)).x,
            (**((*po).vertices).offset(i as isize)).y,
        );
        i = i.wrapping_add(1);
        i;
    }
    *blockbox
        .offset(
            BOXRIGHT as libc::c_int as isize,
        ) = ((*blockbox.offset(BOXRIGHT as libc::c_int as isize) - bmaporgx)
        as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    *blockbox
        .offset(
            BOXLEFT as libc::c_int as isize,
        ) = ((*blockbox.offset(BOXLEFT as libc::c_int as isize) - bmaporgx)
        as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    *blockbox
        .offset(
            BOXTOP as libc::c_int as isize,
        ) = ((*blockbox.offset(BOXTOP as libc::c_int as isize) - bmaporgy)
        as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    *blockbox
        .offset(
            BOXBOTTOM as libc::c_int as isize,
        ) = ((*blockbox.offset(BOXBOTTOM as libc::c_int as isize) - bmaporgy)
        as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    y = *blockbox.offset(BOXBOTTOM as libc::c_int as isize);
    while y <= *blockbox.offset(BOXTOP as libc::c_int as isize) {
        x = *blockbox.offset(BOXLEFT as libc::c_int as isize);
        while x <= *blockbox.offset(BOXRIGHT as libc::c_int as isize) {
            if !(x < 0 as libc::c_int || y < 0 as libc::c_int || x >= bmapwidth
                || y >= bmapheight)
            {
                let mut l: *mut polymaplink_t = Polyobj_getLink();
                (*l).po = po;
                M_DLListInsert(
                    &mut (*l).link,
                    &mut *polyblocklinks.offset((y * bmapwidth + x) as isize)
                        as *mut *mut polymaplink_t as *mut *mut mdllistitem_t,
                );
            }
            x += 1;
            x;
    ...
    (*po).linked = true_0 as libc::c_int as uint8_t;
}
unsafe extern "C" fn Polyobj_removeFromBlockmap(mut po: *mut polyobj_t) {
    let mut rover: *mut polymaplink_t = 0 as *mut polymaplink_t;
    let mut blockbox: *mut fixed_t = ((*po).blockbox).as_mut_ptr();
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    if (*po).linked == 0 {
    ...
    while y <= *blockbox.offset(BOXTOP as libc::c_int as isize) {
        ...
        while x <= *blockbox.offset(BOXRIGHT as libc::c_int as isize) {
            if !(x < 0 as libc::c_int || y < 0 as libc::c_int || x >= bmapwidth
                || y >= bmapheight)
            {
                rover = *polyblocklinks.offset((y * bmapwidth + x) as isize);
                while !rover.is_null() && (*rover).po != po {
                    rover = (*rover).link.next as *mut polymaplink_t;
                }
                if !rover.is_null() {
                    M_DLListRemove(&mut (*rover).link);
    ...
    (*po).linked = false_0 as libc::c_int as uint8_t;
}
#[inline]
unsafe extern "C" fn Polyobj_untouched(
    mut ld: *mut line_t,
    mut mo: *mut mobj_t,
) -> boolean {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    let mut ptmbbox: [fixed_t; 4] = [0; 4];
    x = (*mo).x;
    ptmbbox[BOXRIGHT as libc::c_int as usize] = x + (*mo).radius;
    return (ptmbbox[BOXRIGHT as libc::c_int as usize]
        <= (*ld).bbox[BOXLEFT as libc::c_int as usize]
        || {
            ptmbbox[BOXLEFT as libc::c_int as usize] = x - (*mo).radius;
            ptmbbox[BOXLEFT as libc::c_int as usize]
                >= (*ld).bbox[BOXRIGHT as libc::c_int as usize]
        }
        || {
            y = (*mo).y;
            ptmbbox[BOXTOP as libc::c_int as usize] = y + (*mo).radius;
            ptmbbox[BOXTOP as libc::c_int as usize]
                <= (*ld).bbox[BOXBOTTOM as libc::c_int as usize]
        }
        || {
            ptmbbox[BOXBOTTOM as libc::c_int as usize] = y - (*mo).radius;
            ptmbbox[BOXBOTTOM as libc::c_int as usize]
                >= (*ld).bbox[BOXTOP as libc::c_int as usize]
        } || P_BoxOnLineSide(ptmbbox.as_mut_ptr(), ld) != -(1 as libc::c_int))
        as libc::c_int;
}
unsafe extern "C" fn Polyobj_pushThing(
    mut po: *mut polyobj_t,
    mut line: *mut line_t,
    mut mo: *mut mobj_t,
) {
    let mut lineangle: angle_t = 0;
    let mut momx: fixed_t = 0;
    let mut momy: fixed_t = 0;
    let mut closest: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    lineangle = ((*line).angle).wrapping_sub(0x40000000 as libc::c_int as angle_t);
    ...
    P_ClosestPointOnLine((*mo).x, (*mo).y, line, &mut closest);
    (*mo)
        .x = closest.x
        + FixedMul(
            (*mo).radius,
            *finecosine.offset(lineangle as isize)
    ...
    if (*po).damage != 0 && (*mo).flags & MF_SHOOTABLE as libc::c_int as uint32_t != 0 {
...
unsafe extern "C" fn Polyobj_slideThing(
    mut mo: *mut mobj_t,
    mut dx: fixed_t,
    mut dy: fixed_t,
) {
    if !((*mo).player).is_null() {
        let mut cdx: fixed_t = 0;
        let mut cdy: fixed_t = 0;
        cdx = FixedMul(
            dx,
        ...
        if (*(*mo).player).onconveyor == 1 as libc::c_int {
            (*mo).momx += cdx;
            (*mo).momy += cdy;
            (*(*mo).player).cmomx += cdx;
            (*(*mo).player).cmomy += cdy;
        } else {
            if (*(*mo).player).onconveyor == 3 as libc::c_int {
        ...
        dx = FixedMul(dx, ((1 as libc::c_int) << 16 as libc::c_int) - (*mo).friction);
        dy = FixedMul(dy, ((1 as libc::c_int) << 16 as libc::c_int) - (*mo).friction);
        if (*(*mo).player).pflags as libc::c_uint
            & PF_SPINNING as libc::c_int as libc::c_uint != 0
            && ((*(*mo).player).rmomx != 0 || (*(*mo).player).rmomy != 0)
            && (*(*mo).player).pflags as libc::c_uint
                & PF_STARTDASH as libc::c_int as libc::c_uint == 0
        {
            dx = FixedMul(dx, 5184 as libc::c_int);
            dy = FixedMul(dy, 5184 as libc::c_int);
        }
        (*mo).momx += dx;
        (*mo).momy += dy;
        (*(*mo).player).onconveyor = 1 as libc::c_int;
    } else {
        P_TryMove(mo, (*mo).x + dx, (*mo).y + dy, true_0 as libc::c_int);
    };
}
unsafe extern "C" fn Polyobj_carryThings(
    mut po: *mut polyobj_t,
    mut dx: fixed_t,
    mut dy: fixed_t,
) {
    static mut pomovecount: int32_t = 0 as libc::c_int;
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    pomovecount += 1;
    pomovecount;
                        ...
                        if !((*mo).flags & MF_NOGRAVITY as libc::c_int as uint32_t != 0)
                        {
                            if !((*mo).flags & MF_NOCLIP as libc::c_int as uint32_t != 0)
                            {
                                if !((*mo).eflags as libc::c_int
                                    ...
                                    && (*mo).z + (*mo).height
                                        != (*(**((*po).lines).offset(0 as libc::c_int as isize))
                                            .backsector)
                                            .floorheight)
                                {
                                    if !((*mo).eflags as libc::c_int
...
unsafe extern "C" fn Polyobj_clipThings(
    mut po: *mut polyobj_t,
    mut line: *mut line_t,
) -> int32_t {
    let mut hitflags: int32_t = 0 as libc::c_int;
    let mut linebox: [fixed_t; 4] = [0; 4];
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    if (*po).flags & POF_SOLID as libc::c_int == 0 {
        return hitflags;
    }
    linebox[BOXLEFT as libc::c_int
        as usize] = (((*line).bbox[BOXLEFT as libc::c_int as usize] - bmaporgx
        - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    linebox[BOXRIGHT as libc::c_int
        as usize] = (((*line).bbox[BOXRIGHT as libc::c_int as usize] - bmaporgx
        + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    linebox[BOXBOTTOM as libc::c_int
        as usize] = (((*line).bbox[BOXBOTTOM as libc::c_int as usize] - bmaporgy
        - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    linebox[BOXTOP as libc::c_int
        as usize] = (((*line).bbox[BOXTOP as libc::c_int as usize] - bmaporgy
        + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as fixed_t;
    y = linebox[BOXBOTTOM as libc::c_int as usize];
    while y <= linebox[BOXTOP as libc::c_int as usize] {
        x = linebox[BOXLEFT as libc::c_int as usize];
        while x <= linebox[BOXRIGHT as libc::c_int as usize] {
            if !(x < 0 as libc::c_int || y < 0 as libc::c_int || x >= bmapwidth
                || y >= bmapheight)
            {
                let mut mo: *mut mobj_t = *blocklinks
                    .offset((y * bmapwidth + x) as isize);
                while !mo.is_null() {
                    if !((*mo).flags & MF_NOGRAVITY as libc::c_int as uint32_t != 0) {
                        if !((*mo).flags & MF_NOCLIP as libc::c_int as uint32_t != 0) {
                            if !((*mo).z + (*mo).height
                                <= (*(*line).backsector).floorheight)
                            {
                                if !((*mo).z >= (*(*line).backsector).ceilingheight) {
                                    if !(Polyobj_untouched(line, mo) != 0) {
                                        if (*mo).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0
                                            && (*po).flags & POF_PUSHABLESTOP as libc::c_int != 0
                                        {
                                            hitflags |= 2 as libc::c_int;
                                        } else {
                                        ...
                                        if !((*mo).player).is_null()
                                            && (*(**((*po).lines).offset(0 as libc::c_int as isize))
                                                ...
                                                != 0 && (*po).flags & POF_NOSPECIALS as libc::c_int == 0
                                        {
...
#[no_mangle]
pub unsafe extern "C" fn Polyobj_moveXY(
    mut po: *mut polyobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut checkmobjs: boolean,
) -> boolean {
    let mut i: size_t = 0;
    let mut vec: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices {
        Polyobj_vecAdd(*((*po).vertices).offset(i as isize), &mut vec);
        i = i.wrapping_add(1);
        i;
    }
    i = 0 as libc::c_int as size_t;
    ...
    if checkmobjs != 0 {
        i = 0 as libc::c_int as size_t;
        while i < (*po).numLines {
            hitflags |= Polyobj_clipThings(po, *((*po).lines).offset(i as isize));
            i = i.wrapping_add(1);
            i;
        }
    }
    if hitflags & 2 as libc::c_int != 0 {
        i = 0 as libc::c_int as size_t;
        while i < (*po).numVertices {
            Polyobj_vecSub(*((*po).vertices).offset(i as isize), &mut vec);
            i = i.wrapping_add(1);
            i;
        }
        i = 0 as libc::c_int as size_t;
    ...
    return (hitflags & 2 as libc::c_int == 0) as libc::c_int;
}
#[inline]
unsafe extern "C" fn Polyobj_rotatePoint(
    mut v: *mut vertex_t,
    mut c: *const vector2_t,
    mut ang: angle_t,
) {
    let mut tmp: vertex_t = *v;
    (*v)
        .x = FixedMul(
        tmp.x,
        *finecosine.offset(ang as isize) >> 16 as libc::c_int - 16 as libc::c_int,
    ) - FixedMul(tmp.y, finesine[ang as usize] >> 16 as libc::c_int - 16 as libc::c_int);
    (*v)
        .y = FixedMul(
        tmp.x,
...
unsafe extern "C" fn Polyobj_rotateLine(mut ld: *mut line_t) {
    let mut v1: *mut vertex_t = 0 as *mut vertex_t;
    let mut v2: *mut vertex_t = 0 as *mut vertex_t;
    v1 = (*ld).v1;
    v2 = (*ld).v2;
    (*ld).dx = (*v2).x - (*v1).x;
    (*ld).dy = (*v2).y - (*v1).y;
    ...
    if (*v1).x < (*v2).x {
        (*ld).bbox[BOXLEFT as libc::c_int as usize] = (*v1).x;
        (*ld).bbox[BOXRIGHT as libc::c_int as usize] = (*v2).x;
    } else {
        (*ld).bbox[BOXLEFT as libc::c_int as usize] = (*v2).x;
        (*ld).bbox[BOXRIGHT as libc::c_int as usize] = (*v1).x;
    }
    if (*v1).y < (*v2).y {
        (*ld).bbox[BOXBOTTOM as libc::c_int as usize] = (*v1).y;
        (*ld).bbox[BOXTOP as libc::c_int as usize] = (*v2).y;
    } else {
        (*ld).bbox[BOXBOTTOM as libc::c_int as usize] = (*v2).y;
        (*ld).bbox[BOXTOP as libc::c_int as usize] = (*v1).y;
    };
}
unsafe extern "C" fn Polyobj_rotateThings(
    mut po: *mut polyobj_t,
    mut origin: vector2_t,
    mut delta: angle_t,
    mut turnplayers: boolean,
    mut turnothers: boolean,
) {
    static mut pomovecount: int32_t = 10000 as libc::c_int;
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut deltafine: angle_t = (((*po).angle).wrapping_add(delta) >> 19 as libc::c_int)
        .wrapping_sub((*po).angle >> 19 as libc::c_int)
                        ...
                        if !((*mo).flags & MF_NOGRAVITY as libc::c_int as uint32_t != 0)
                        {
                            if !((*mo).flags & MF_NOCLIP as libc::c_int as uint32_t != 0)
                            {
                                            ...
                                            .floorheight)
                                {
                                    ...
                                    {
                                        if !(P_MobjInsidePolyobj(po, mo) == 0) {
                                            let mut oldxoff: fixed_t = 0;
                                            let mut oldyoff: fixed_t = 0;
                                            let mut newxoff: fixed_t = 0;
                                            let mut newyoff: fixed_t = 0;
                                            let mut c: fixed_t = 0;
                                            let mut s: fixed_t = 0;
                                            c = *finecosine.offset(deltafine as isize)
                                                >> 16 as libc::c_int - 16 as libc::c_int;
                                            s = finesine[deltafine as usize]
                                                >> 16 as libc::c_int - 16 as libc::c_int;
                                            ...
                                            if turnplayers != 0 && !((*mo).player).is_null()
                                                || turnothers != 0 && ((*mo).player).is_null()
                                            {
                                                (*mo).angle = ((*mo).angle).wrapping_add(delta);
                                                if !((*mo).player).is_null() {
                                                    P_SetPlayerAngle(
                                                        (*mo).player,
                                                        ((((*(*mo).player).angleturn as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn Polyobj_rotate(
    mut po: *mut polyobj_t,
    mut delta: angle_t,
    mut turnplayers: boolean,
    mut turnothers: boolean,
    ...
    let mut origin: vector2_t = vector2_t { x: 0, y: 0 };
    let mut hitflags: int32_t = 0 as libc::c_int;
    if (*po).isBad != 0 {
        return false_0 as libc::c_int;
    }
    angle = ((*po).angle).wrapping_add(delta) >> 19 as libc::c_int;
    origin.x = (*po).spawnSpot.x;
    origin.y = (*po).spawnSpot.y;
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices {
        *((*po).tmpVerts).offset(i as isize) = **((*po).vertices).offset(i as isize);
        **((*po).vertices).offset(i as isize) = *((*po).origVerts).offset(i as isize);
        Polyobj_rotatePoint(*((*po).vertices).offset(i as isize), &mut origin, angle);
        i = i.wrapping_add(1);
        i;
    }
    i = 0 as libc::c_int as size_t;
    while i < (*po).numLines {
        Polyobj_rotateLine(*((*po).lines).offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
    if checkmobjs != 0 {
    ...
    if hitflags & 2 as libc::c_int != 0 {
        i = 0 as libc::c_int as size_t;
        while i < (*po).numVertices {
            **((*po).vertices).offset(i as isize) = *((*po).tmpVerts).offset(i as isize);
            i = i.wrapping_add(1);
            i;
        }
        i = 0 as libc::c_int as size_t;
        ...
        i = 0 as libc::c_int as size_t;
        while i < (*po).segCount {
            let ref mut fresh7 = (**((*po).segs).offset(i as isize)).angle;
            *fresh7 = (*fresh7).wrapping_add(delta);
            i = i.wrapping_add(1);
            i;
        }
        (*po).angle = ((*po).angle).wrapping_add(delta);
        Polyobj_removeFromBlockmap(po);
        Polyobj_removeFromSubsec(po);
        Polyobj_linkToBlockmap(po);
        Polyobj_attachToSubsec(po);
...
#[no_mangle]
pub unsafe extern "C" fn Polyobj_GetForNum(mut id: int32_t) -> *mut polyobj_t {
    let mut curidx: int32_t = (*PolyObjects.offset((id % numPolyObjects) as isize))
        .first;
    while curidx != numPolyObjects && (*PolyObjects.offset(curidx as isize)).id != id {
        curidx = (*PolyObjects.offset(curidx as isize)).next;
    }
    return if curidx == numPolyObjects {
        0 as *mut polyobj_t
    } else {
        &mut *PolyObjects.offset(curidx as isize) as *mut polyobj_t
    };
}
unsafe extern "C" fn Polyobj_GetChild(
    mut po: *mut polyobj_t,
    mut start: *mut int32_t,
) -> *mut polyobj_t {
    while *start < numPolyObjects {
        if (*PolyObjects.offset(*start as isize)).parent == (*po).id {
            let fresh8 = *start;
            *start = *start + 1;
            return &mut *PolyObjects.offset(fresh8 as isize) as *mut polyobj_t;
        }
        *start += 1;
        *start;
    }
    return 0 as *mut polyobj_t;
}
#[no_mangle]
pub unsafe extern "C" fn Polyobj_InitLevel() {
    let mut th: *mut thinker_t = 0 as *mut thinker_t;
    let mut spawnqueue: mqueue_t = mqueue_s {
        head: mqueueitem_s {
            next: 0 as *mut mqueueitem_s,
        },
        tail: 0 as *mut mqueueitem_t,
        rover: 0 as *mut mqueueitem_t,
    };
    let mut anchorqueue: mqueue_t = mqueue_s {
        head: mqueueitem_s {
            next: 0 as *mut mqueueitem_s,
        },
        tail: 0 as *mut mqueueitem_t,
    ...
    let mut qitem: *mut mobjqitem_t = 0 as *mut mobjqitem_t;
    let mut i: int32_t = 0;
    let mut numAnchors: int32_t = 0 as libc::c_int;
    let mut mo: *mut mobj_t = 0 as *mut mobj_t;
    M_QueueInit(&mut spawnqueue);
    M_QueueInit(&mut anchorqueue);
    PolyObjects = 0 as *mut polyobj_t;
    numPolyObjects = 0 as libc::c_int;
    bmap_freelist = 0 as *mut polymaplink_t;
            ...
            as *mut thinker_t
    {
        ...
        {
            mo = th as *mut mobj_t;
            if (*(*mo).info).doomednum == 761 as libc::c_int {
                numPolyObjects += 1;
                numPolyObjects;
                qitem = malloc(::core::mem::size_of::<mobjqitem_t>() as libc::c_ulong)
                    as *mut mobjqitem_t;
                memset(
                    qitem as *mut libc::c_void,
                    0 as libc::c_int,
                    ::core::mem::size_of::<mobjqitem_t>() as libc::c_ulong,
                );
                (*qitem).mo = mo;
                M_QueueInsert(&mut (*qitem).mqitem, &mut spawnqueue);
            } else if (*(*mo).info).doomednum == 760 as libc::c_int {
                numAnchors += 1;
                numAnchors;
                qitem = malloc(::core::mem::size_of::<mobjqitem_t>() as libc::c_ulong)
                    as *mut mobjqitem_t;
                ...
                (*qitem).mo = mo;
                M_QueueInsert(&mut (*qitem).mqitem, &mut anchorqueue);
            }
        }
        th = (*th).next;
    }
    if numPolyObjects != 0 {
        PolyObjects = Z_CallocAlign(
            (numPolyObjects as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<polyobj_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut polyobj_t;
        ...
        while i < numPolyObjects {
            let ref mut fresh9 = (*PolyObjects.offset(i as isize)).next;
            *fresh9 = numPolyObjects;
            (*PolyObjects.offset(i as isize)).first = *fresh9;
            i += 1;
            i;
        }
        i = 0 as libc::c_int;
        while i < numPolyObjects {
            qitem = M_QueueIterator(&mut spawnqueue) as *mut mobjqitem_t;
            Polyobj_spawnPolyObj(
                i,
                (*qitem).mo,
                Tag_FGet(&mut (*(*(*qitem).mo).spawnpoint).tags) as int32_t,
            );
            i += 1;
            i;
        }
        i = 0 as libc::c_int;
        while i < numAnchors {
            qitem = M_QueueIterator(&mut anchorqueue) as *mut mobjqitem_t;
        ...
        i = 0 as libc::c_int;
        while i < numPolyObjects {
            Polyobj_linkToBlockmap(&mut *PolyObjects.offset(i as isize));
            i += 1;
            i;
        }
    }
    M_QueueFree(&mut spawnqueue);
    M_QueueFree(&mut anchorqueue);
}
#[no_mangle]
pub unsafe extern "C" fn Polyobj_MoveOnLoad(
    mut po: *mut polyobj_t,
    mut angle: angle_t,
    mut x: fixed_t,
    mut y: fixed_t,
    ...
    dx = x - (*po).spawnSpot.x;
    dy = y - (*po).spawnSpot.y;
    Polyobj_moveXY(po, dx, dy, false_0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjRotate(mut th: *mut polyrotate_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjRotate: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
        return;
    }
    if ((*po).thinker).is_null() {
        (*po).thinker = &mut (*th).thinker;
        (*po).thrust = abs((*th).speed) >> 8 as libc::c_int;
        if (*po).thrust < (1 as libc::c_int) << 16 as libc::c_int {
            (*po).thrust = (1 as libc::c_int) << 16 as libc::c_int;
        } else if (*po).thrust
            > 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
        {
            (*po).thrust = 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
        }
    }
    if Polyobj_rotate(
        po,
        (*th).speed as angle_t,
        (*th).turnobjs as libc::c_int & PTF_PLAYERS as libc::c_int,
        (*th).turnobjs as libc::c_int & PTF_OTHERS as libc::c_int,
        true_0 as libc::c_int,
    ) != 0 && (*th).distance != -(1 as libc::c_int)
    {
        let mut avel: int32_t = abs((*th).speed);
        (*th).distance -= avel;
        if (*th).distance <= 0 as libc::c_int {
            if (*po).thinker == &mut (*th).thinker as *mut thinker_t {
                (*po).thinker = 0 as *mut thinker_t;
                (*po).thrust = (1 as libc::c_int) << 16 as libc::c_int;
            }
            P_RemoveThinker(&mut (*th).thinker);
        } else if (*th).distance < avel {
            (*th)
                .speed = if (*th).speed >= 0 as libc::c_int {
                (*th).distance
            } else {
                -(*th).distance
            };
...
#[inline(always)]
unsafe extern "C" fn Polyobj_componentSpeed(
    mut resVel: int32_t,
    mut angle: int32_t,
    mut xVel: *mut fixed_t,
    mut yVel: *mut fixed_t,
) {
    if angle == 0 as libc::c_int {
        *xVel = resVel;
        *yVel = 0 as libc::c_int;
    } else if angle == 0x40000000 as libc::c_int >> 19 as libc::c_int {
        *xVel = 0 as libc::c_int;
        *yVel = resVel;
    } else {
        *xVel = FixedMul(
            resVel,
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjMove(mut th: *mut polymove_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjMove: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    if ((*po).thinker).is_null() {
        (*po).thinker = &mut (*th).thinker;
        (*po).thrust = abs((*th).speed) >> 3 as libc::c_int;
        if (*po).thrust < (1 as libc::c_int) << 16 as libc::c_int {
            (*po).thrust = (1 as libc::c_int) << 16 as libc::c_int;
        } else if (*po).thrust
            > 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
    ...
    if Polyobj_moveXY(po, (*th).momx, (*th).momy, true_0 as libc::c_int) != 0 {
        let mut avel: int32_t = abs((*th).speed);
        (*th).distance -= avel;
        if (*th).distance <= 0 as libc::c_int {
            if (*po).thinker == &mut (*th).thinker as *mut thinker_t {
...
unsafe extern "C" fn T_MovePolyObj(
    mut po: *mut polyobj_t,
    mut distx: fixed_t,
    mut disty: fixed_t,
    mut distz: fixed_t,
) {
    let mut child: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut start: int32_t = 0;
    Polyobj_moveXY(po, distx, disty, true_0 as libc::c_int);
    (*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector).floorheight
        += distz;
    (*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector).ceilingheight
        += distz;
    P_CheckSector(
    ...
    loop {
        child = Polyobj_GetChild(po, &mut start);
        if child.is_null() {
            break;
        }
        if (*child).isBad != 0 {
        ...
        Polyobj_moveXY(child, distx, disty, true_0 as libc::c_int);
        (*(**((*child).lines).offset(0 as libc::c_int as isize)).backsector).floorheight
            += distz;
        (*(**((*child).lines).offset(0 as libc::c_int as isize)).backsector)
            .ceilingheight += distz;
        P_CheckSector(
            (**((*child).lines).offset(0 as libc::c_int as isize)).backsector,
            (*child).damage,
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjWaypoint(mut th: *mut polywaypoint_t) {
    let mut target: *mut mobj_t = 0 as *mut mobj_t;
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    let mut speed: fixed_t = (*th).speed;
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjWaypoint: thinker with invalid id %d removed.\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    target = waypoints[(*th).sequence as usize][(*th).pointnum as usize];
    if target.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjWaypoint: Unable to find target waypoint!\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    while speed > 0 as libc::c_int {
        let mut waypoint: *mut mobj_t = 0 as *mut mobj_t;
        let mut pox: fixed_t = 0;
        let mut poy: fixed_t = 0;
        let mut poz: fixed_t = 0;
        ...
        pox = (*po).centerPt.x;
        poy = (*po).centerPt.y;
        poz = ((*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector)
            .floorheight
            + (*(**((*po).lines).offset(0 as libc::c_int as isize)).backsector)
                .ceilingheight) / 2 as libc::c_int;
        distx = (*target).x - pox;
        disty = (*target).y - poy;
        distz = (*target).z - poz;
        ...
        if speed < dist {
            ...
            if (*th).stophere == 0 {
                ...
                waypoint = if (*th).direction == -(1 as libc::c_int) {
                    P_GetPreviousWaypoint(target, false_0 as libc::c_int)
                } else {
                    P_GetNextWaypoint(target, false_0 as libc::c_int)
                };
                if waypoint.is_null()
                    && (*th).returnbehavior as libc::c_int == PWR_WRAP as libc::c_int
                {
                    if (*th).continuous == 0 {
                        (*th).returnbehavior = PWR_STOP as libc::c_int as uint8_t;
                        (*th).stophere = true_0 as libc::c_int as uint8_t;
                    }
                    waypoint = if (*th).direction == -(1 as libc::c_int) {
                        P_GetLastWaypoint((*th).sequence as uint8_t)
                    } else {
                        P_GetFirstWaypoint((*th).sequence as uint8_t)
                    };
                } else if waypoint.is_null()
                    && (*th).returnbehavior as libc::c_int == PWR_COMEBACK as libc::c_int
                {
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyDoorSlide(mut th: *mut polyslidedoor_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyDoorSlide: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    if Polyobj_moveXY(po, (*th).momx, (*th).momy, true_0 as libc::c_int) != 0 {
        ...
        if (*th).distance <= 0 as libc::c_int {
            if (*th).closing == 0 {
                (*th).closing = true_0 as libc::c_int as uint8_t;
    ...
    } else if (*th).closing as libc::c_int != 0 && (*th).distance != (*th).initDistance {
        ...
        (*th).closing = false_0 as libc::c_int as uint8_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn T_PolyDoorSwing(mut th: *mut polyswingdoor_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyDoorSwing: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjDisplace(mut th: *mut polydisplace_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    let mut newheights: fixed_t = 0;
    ...
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjDisplace: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    newheights = (*(*th).controlSector).floorheight
        + (*(*th).controlSector).ceilingheight;
    ...
    if Polyobj_moveXY(po, dx, dy, true_0 as libc::c_int) != 0 {
        (*th).oldHeights = newheights;
    }
}
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjRotDisplace(mut th: *mut polyrotdisplace_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    let mut newheights: fixed_t = 0;
    let mut delta: fixed_t = 0;
    let mut rotangle: fixed_t = 0;
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjRotDisplace: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
...
#[inline]
unsafe extern "C" fn Polyobj_AngSpeed(mut speed: int32_t) -> int32_t {
    return speed * 0xb60b61 as libc::c_int >> 3 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjRotate(mut prdata: *mut polyrotdata_t) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polyrotate_t = 0 as *mut polyrotate_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*prdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjRotate: bad polyobj %d\n\0" as *const u8
                as *const libc::c_char,
            (*prdata).polyObjNum,
        );
        return false_0 as libc::c_int;
    ...
    if !((*po).thinker).is_null()
        && (*prdata).flags as libc::c_int & TMPR_OVERRIDE as libc::c_int == 0
    {
        return false_0 as libc::c_int;
    }
    th = Z_MallocAlign(
        ::core::mem::size_of::<polyrotate_t>() as libc::c_ulong,
    ...
    (*th)
        ...
        Option::<unsafe extern "C" fn(*mut polyrotate_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjRotate as unsafe extern "C" fn(*mut polyrotate_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*prdata).polyObjNum;
    (*th).speed = Polyobj_AngSpeed((*prdata).speed * (*prdata).direction);
    if (*prdata).flags as libc::c_int & TMPR_CONTINUOUS as libc::c_int != 0 {
        (*th).distance = -(1 as libc::c_int);
    } else if (*prdata).distance == 360 as libc::c_int {
        (*th)
            .distance = (0xffffffff as libc::c_uint)
            .wrapping_sub(1 as libc::c_int as libc::c_uint) as int32_t;
    } else {
        (*th)
            .distance = FixedAngle(
            (*prdata).distance * ((1 as libc::c_int) << 16 as libc::c_int),
        ) as int32_t;
    }
    (*po).thrust = abs((*th).speed) >> 8 as libc::c_int;
    if (*po).thrust < (1 as libc::c_int) << 16 as libc::c_int {
        (*po).thrust = (1 as libc::c_int) << 16 as libc::c_int;
    } else if (*po).thrust > 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
    {
        (*po).thrust = 4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    }
    oldpo = po;
    R_CreateInterpolator_Polyobj(&mut (*th).thinker, po);
    (*th).turnobjs = 0 as libc::c_int as uint8_t;
    if (*prdata).flags as libc::c_int & TMPR_DONTROTATEOTHERS as libc::c_int == 0 {
        (*th)
            .turnobjs = ((*th).turnobjs as libc::c_int | PTF_OTHERS as libc::c_int)
            as uint8_t;
    }
    if (*prdata).flags as libc::c_int & TMPR_ROTATEPLAYERS as libc::c_int != 0 {
        (*th)
            .turnobjs = ((*th).turnobjs as libc::c_int | PTF_PLAYERS as libc::c_int)
            as uint8_t;
    }
    start = 0 as libc::c_int;
    loop {
        po = Polyobj_GetChild(oldpo, &mut start);
        if po.is_null() {
            break;
        }
        (*prdata).polyObjNum = (*po).id;
        EV_DoPolyObjRotate(prdata);
    }
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjMove(mut pmdata: *mut polymovedata_t) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polymove_t = 0 as *mut polymove_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*pmdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjMove: bad polyobj %d\n\0" as *const u8 as *const libc::c_char,
            (*pmdata).polyObjNum,
        );
        return false_0 as libc::c_int;
    }
    ...
    if !((*po).thinker).is_null() && (*pmdata).overRide == 0 {
        return false_0 as libc::c_int;
    }
    th = Z_MallocAlign(
        ::core::mem::size_of::<polymove_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polymove_t;
    (*th)
        ...
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polymove_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjMove as unsafe extern "C" fn(*mut polymove_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*pmdata).polyObjNum;
    (*th).distance = (*pmdata).distance;
    (*th).speed = (*pmdata).speed;
    (*th).angle = (*pmdata).angle >> 19 as libc::c_int;
    Polyobj_componentSpeed(
        (*th).speed,
        (*th).angle as int32_t,
        &mut (*th).momx,
    ...
    loop {
        ...
        (*pmdata).polyObjNum = (*po).id;
        EV_DoPolyObjMove(pmdata);
    }
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjWaypoint(
    mut pwdata: *mut polywaypointdata_t,
) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polywaypoint_t = 0 as *mut polywaypoint_t;
    let mut first: *mut mobj_t = 0 as *mut mobj_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*pwdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjWaypoint: bad polyobj %d\n\0" as *const u8
                as *const libc::c_char,
            (*pwdata).polyObjNum,
        );
        return false_0 as libc::c_int;
    ...
    th = Z_MallocAlign(
        ::core::mem::size_of::<polywaypoint_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polywaypoint_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polywaypoint_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjWaypoint as unsafe extern "C" fn(*mut polywaypoint_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    ...
    (*th)
        .direction = if (*pwdata).flags as libc::c_int & PWF_REVERSE as libc::c_int != 0
    {
        -(1 as libc::c_int)
    } else {
        1 as libc::c_int
    ...
    if (*pwdata).flags as libc::c_int & PWF_LOOP as libc::c_int != 0 {
        (*th).continuous = true_0 as libc::c_int as uint8_t;
    }
    (*th).stophere = false_0 as libc::c_int as uint8_t;
    first = if (*th).direction == -(1 as libc::c_int) {
        P_GetLastWaypoint((*th).sequence as uint8_t)
    } else {
        P_GetFirstWaypoint((*th).sequence as uint8_t)
    };
    if first.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjWaypoint: Missing starting waypoint!\n\0" as *const u8
                as *const libc::c_char,
        );
        (*po).thinker = 0 as *mut thinker_t;
        P_RemoveThinker(&mut (*th).thinker);
    ...
    if (*th).continuous as libc::c_int != 0
        && P_IsDegeneratedWaypointSequence((*th).sequence as uint8_t) != 0
    {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjWaypoint: All waypoints are in the same location!\n\0"
                as *const u8 as *const libc::c_char,
        );
        (*th).continuous = false_0 as libc::c_int as uint8_t;
    }
    R_CreateInterpolator_Polyobj(&mut (*th).thinker, po);
...
unsafe extern "C" fn Polyobj_doSlideDoor(
    mut po: *mut polyobj_t,
    mut doordata: *mut polydoordata_t,
) {
    let mut th: *mut polyslidedoor_t = 0 as *mut polyslidedoor_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut angtemp: angle_t = 0;
    let mut start: int32_t = 0;
    th = Z_MallocAlign(
        ::core::mem::size_of::<polyslidedoor_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polyslidedoor_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polyslidedoor_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyDoorSlide as unsafe extern "C" fn(*mut polyslidedoor_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*po).id;
    (*th).closing = false_0 as libc::c_int as uint8_t;
    ...
    (*th).delayCount = 0 as libc::c_int;
    (*th).initDistance = (*doordata).distance;
    (*th).distance = (*th).initDistance;
    (*th).initSpeed = (*doordata).speed;
    (*th).speed = (*th).initSpeed;
    angtemp = (*doordata).angle;
    (*th).angle = angtemp >> 19 as libc::c_int;
    (*th).initAngle = (*th).angle;
    (*th)
        .revAngle = angtemp.wrapping_add(0x80000000 as libc::c_uint)
        >> 19 as libc::c_int;
    Polyobj_componentSpeed(
        (*th).speed,
        (*th).angle as int32_t,
...
unsafe extern "C" fn Polyobj_doSwingDoor(
    mut po: *mut polyobj_t,
    mut doordata: *mut polydoordata_t,
) {
    let mut th: *mut polyswingdoor_t = 0 as *mut polyswingdoor_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut start: int32_t = 0;
    th = Z_MallocAlign(
        ::core::mem::size_of::<polyswingdoor_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polyswingdoor_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polyswingdoor_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyDoorSwing as unsafe extern "C" fn(*mut polyswingdoor_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*po).id;
    (*th).closing = false_0 as libc::c_int as uint8_t;
    ...
    (*th).delayCount = 0 as libc::c_int;
    (*th)
        .initDistance = FixedAngle(
        (*doordata).distance * ((1 as libc::c_int) << 16 as libc::c_int),
    ) as int32_t;
    (*th).distance = (*th).initDistance;
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyDoor(mut doordata: *mut polydoordata_t) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    po = Polyobj_GetForNum((*doordata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyDoor: bad polyobj %d\n\0" as *const u8 as *const libc::c_char,
            (*doordata).polyObjNum,
        );
        return false_0 as libc::c_int;
    }
    if (*po).isBad as libc::c_int != 0 || !((*po).thinker).is_null() {
        return false_0 as libc::c_int;
    }
    match (*doordata).doorType {
        0 => {
            Polyobj_doSlideDoor(po, doordata);
        }
        1 => {
        ...
        _ => {
            CONS_Debug(
                0x40 as libc::c_int,
                b"EV_DoPolyDoor: unknown door type %d\0" as *const u8
                    as *const libc::c_char,
                (*doordata).doorType,
            );
            return false_0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjDisplace(
    mut prdata: *mut polydisplacedata_t,
) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polydisplace_t = 0 as *mut polydisplace_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*prdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
    ...
    th = Z_MallocAlign(
        ::core::mem::size_of::<polydisplace_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polydisplace_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polydisplace_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjDisplace as unsafe extern "C" fn(*mut polydisplace_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*prdata).polyObjNum;
    (*th).controlSector = (*prdata).controlSector;
    (*th)
        .oldHeights = (*(*th).controlSector).floorheight
        + (*(*th).controlSector).ceilingheight;
    (*th).dx = (*prdata).dx;
    (*th).dy = (*prdata).dy;
    oldpo = po;
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjRotDisplace(
    mut prdata: *mut polyrotdisplacedata_t,
) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polyrotdisplace_t = 0 as *mut polyrotdisplace_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*prdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
    ...
    th = Z_MallocAlign(
        ::core::mem::size_of::<polyrotdisplace_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polyrotdisplace_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut polyrotdisplace_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjRotDisplace as unsafe extern "C" fn(*mut polyrotdisplace_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = (*prdata).polyObjNum;
    (*th).controlSector = (*prdata).controlSector;
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjFlag(mut th: *mut polymove_t) {
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    let mut i: size_t = 0;
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjFlag: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*po).numVertices / 2 as libc::c_int as size_t {
        let mut vec: vertex_t = vertex_t {
            x: 0,
            y: 0,
            floorzset: 0,
        ...
        let mut sine: fixed_t = (finesine[(*th).distance as usize]
            >> 16 as libc::c_int - 16 as libc::c_int) * (*th).momx;
        Polyobj_componentSpeed(sine, (*th).angle as int32_t, &mut vec.x, &mut vec.y);
        (**((*po).vertices).offset(i as isize))
            .x = (*((*po).tmpVerts).offset(i as isize)).x;
        (**((*po).vertices).offset(i as isize))
            .y = (*((*po).tmpVerts).offset(i as isize)).y;
        Polyobj_vecAdd(*((*po).vertices).offset(i as isize), &mut vec);
        (*th).distance += (*th).speed;
        (*th).distance &= 8192 as libc::c_int - 1 as libc::c_int;
        i = i.wrapping_add(1);
        i;
    }
    i = 0 as libc::c_int as size_t;
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjFlag(mut pfdata: *mut polyflagdata_t) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polymove_t = 0 as *mut polymove_t;
    let mut i: size_t = 0;
    let mut start: int32_t = 0;
    let mut tag: mtag_t = (*pfdata).polyObjNum as mtag_t;
    po = Polyobj_GetForNum(tag as int32_t);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyFlag: bad polyobj %d\n\0" as *const u8 as *const libc::c_char,
            tag as libc::c_int,
        );
        return false_0 as libc::c_int;
    }
    ...
    if (*po).numVertices & 1 as libc::c_int as size_t != 0 {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyFlag: Polyobject has odd # of vertices!\n\0" as *const u8
                as *const libc::c_char,
        );
        return false_0 as libc::c_int;
    }
    ...
    (*th)
        ...
        Option::<unsafe extern "C" fn(*mut polymove_t) -> ()>,
        actionf_p1,
    >(Some(T_PolyObjFlag as unsafe extern "C" fn(*mut polymove_t) -> ()));
    P_AddThinker(THINK_POLYOBJ, &mut (*th).thinker);
    (*po).thinker = &mut (*th).thinker;
    (*th).polyObjNum = tag as int32_t;
    (*th).distance = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn T_PolyObjFade(mut th: *mut polyfade_t) {
    let mut stillfading: boolean = false_0 as libc::c_int;
    let mut po: *mut polyobj_t = Polyobj_GetForNum((*th).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"T_PolyObjFade: thinker with invalid id %d removed.\n\0" as *const u8
                as *const libc::c_char,
            (*th).polyObjNum,
        );
        P_RemoveThinker(&mut (*th).thinker);
    ...
    stillfading = if (*th).ticbased != 0 {
        (*th).timer -= 1;
        !((*th).timer <= 0 as libc::c_int) as libc::c_int
    } else {
        (*th).timer -= (*th).duration;
        !((*th).timer <= 0 as libc::c_int) as libc::c_int
    };
    if (*th).timer <= 0 as libc::c_int {
        (*po)
            .translucency = if (if (*th).destvalue < NUMTRANSMAPS as libc::c_int {
            (*th).destvalue
        } else {
            NUMTRANSMAPS as libc::c_int
        }) > 0 as libc::c_int
        {
            if (*th).destvalue < NUMTRANSMAPS as libc::c_int {
                (*th).destvalue
            } else {
                NUMTRANSMAPS as libc::c_int
            }
        ...
        let mut delta: int16_t = abs((*th).destvalue - (*th).sourcevalue) as int16_t;
        let mut duration: int32_t = if (*th).ticbased != 0 {
            (*th).duration
        } else {
            abs(
                FixedMul(
                    FixedDiv(256 as libc::c_int, NUMTRANSMAPS as libc::c_int),
                    NUMTRANSMAPS as libc::c_int - (*th).destvalue,
                )
                    - FixedMul(
                        FixedDiv(256 as libc::c_int, NUMTRANSMAPS as libc::c_int),
                        NUMTRANSMAPS as libc::c_int - (*th).sourcevalue,
                    ),
            )
        };
        let mut factor: fixed_t = if FixedDiv(duration - (*th).timer, duration)
            < 1 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
        {
            FixedDiv(duration - (*th).timer, duration)
        } else {
            1 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
        };
        if (*th).destvalue < (*th).sourcevalue {
            (*po)
                .translucency = if (if (*po).translucency
                < (*th).sourcevalue
    ...
    if stillfading == 0 {
        ...
        if (*th).docollision != 0 {
            if (*th).destvalue > (*th).sourcevalue {
                ...
                (*po).flags |= (*po).spawnflags & POF_SOLID as libc::c_int;
                if (*po).spawnflags & POF_NOSPECIALS as libc::c_int == 0 {
                    (*po).flags &= !(POF_NOSPECIALS as libc::c_int);
                }
            }
        }
        ...
        if (*po).translucency >= NUMTRANSMAPS as libc::c_int {
            (*po).translucency = NUMTRANSMAPS as libc::c_int - 1 as libc::c_int;
        }
        (*po).flags |= (*po).spawnflags & POF_RENDERALL as libc::c_int;
        if (*th).docollision != 0 {
            if (*th).doghostfade != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EV_DoPolyObjFade(mut pfdata: *mut polyfadedata_t) -> boolean {
    let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut oldpo: *mut polyobj_t = 0 as *mut polyobj_t;
    let mut th: *mut polyfade_t = 0 as *mut polyfade_t;
    let mut start: int32_t = 0;
    po = Polyobj_GetForNum((*pfdata).polyObjNum);
    if po.is_null() {
        CONS_Debug(
            0x40 as libc::c_int,
            b"EV_DoPolyObjFade: bad polyobj %d\n\0" as *const u8 as *const libc::c_char,
            (*pfdata).polyObjNum,
        );
        return false_0 as libc::c_int;
    }
    ...
    th = Z_MallocAlign(
        ::core::mem::size_of::<polyfade_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut polyfade_t;
    ...
    if (*pfdata).ticbased != 0 {
        (*th).ticbased = true_0 as libc::c_int;
        (*th).duration = abs((*pfdata).speed);
        (*th).timer = (*th).duration;
    } else {
        (*th).ticbased = false_0 as libc::c_int;
        (*th)
            .timer = abs(
            FixedMul(
                FixedDiv(256 as libc::c_int, NUMTRANSMAPS as libc::c_int),
