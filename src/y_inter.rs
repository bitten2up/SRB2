...
extern "C" {
    ...
    static mut prevmap: int16_t;
    fn G_SaveGameData(data_0: *mut gamedata_t);
    fn G_IsSpecialStage(mapnum: int32_t) -> boolean;
    fn G_GametypeUsesCoopLives() -> boolean;
    fn G_GametypeHasTeams() -> boolean;
    fn G_AfterIntermission();
    fn M_UpdateUnlockablesAndExtraEmblems(data_0: *mut gamedata_t) -> uint8_t;
    fn M_SilentUpdateUnlockablesAndEmblems(data_0: *mut gamedata_t);
    ...
    static mut tokenicon: *mut patch_t;
    static mut rendermode: rendermode_t;
    fn P_DoTeamscrambling();
    ...
    static mut sboscore: *mut patch_t;
    static mut sbotime: *mut patch_t;
    static mut sbocolon: *mut patch_t;
    static mut sboperiod: *mut patch_t;
    ...
    fn V_LevelNameHeight(string: *const libc::c_char) -> int32_t;
    fn V_DrawPatchFill(pat: *mut patch_t);
    fn VID_BlitLinearScreen(
        srcptr: *const uint8_t,
        destptr: *mut uint8_t,
        width: int32_t,
        height: int32_t,
        srcrowbytes: size_t,
...
pub const NUMHUDITEMS: C2RustUnnamed_5 = 20;
pub const HUD_POWERUPS: C2RustUnnamed_5 = 19;
pub const HUD_HUNTPICS: C2RustUnnamed_5 = 18;
pub const HUD_TIMEUP: C2RustUnnamed_5 = 17;
pub const HUD_TIMELEFTNUM: C2RustUnnamed_5 = 16;
pub const HUD_TIMELEFT: C2RustUnnamed_5 = 15;
pub const HUD_GETRINGSNUM: C2RustUnnamed_5 = 14;
pub const HUD_GETRINGS: C2RustUnnamed_5 = 13;
pub const HUD_SS_TOTALRINGS: C2RustUnnamed_5 = 12;
pub const HUD_TICS: C2RustUnnamed_5 = 11;
pub const HUD_TIMETICCOLON: C2RustUnnamed_5 = 10;
pub const HUD_SECONDS: C2RustUnnamed_5 = 9;
pub const HUD_TIMECOLON: C2RustUnnamed_5 = 8;
pub const HUD_MINUTES: C2RustUnnamed_5 = 7;
pub const HUD_TIME: C2RustUnnamed_5 = 6;
pub const HUD_SCORENUM: C2RustUnnamed_5 = 5;
pub const HUD_SCORE: C2RustUnnamed_5 = 4;
pub const HUD_RINGSNUMTICS: C2RustUnnamed_5 = 3;
pub const HUD_RINGSNUM: C2RustUnnamed_5 = 2;
pub const HUD_RINGS: C2RustUnnamed_5 = 1;
pub const HUD_LIVES: C2RustUnnamed_5 = 0;
...
pub struct C2RustUnnamed_6 {
    pub color: [*mut uint16_t; 32],
    pub character: [*mut int32_t; 32],
    pub num: [int32_t; 32],
    pub name: [[libc::c_char; 9]; 32],
    pub times: [uint32_t; 32],
    pub rings: [uint32_t; 32],
    pub maxrings: [uint32_t; 32],
    pub monitors: [uint32_t; 32],
    pub scores: [uint32_t; 32],
    pub points: [uint32_t; 32],
    pub numplayers: int32_t,
    pub levelstring: [libc::c_char; 40],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union y_data {
    pub coop: C2RustUnnamed_9,
    pub spec: C2RustUnnamed_8,
    pub match_0: C2RustUnnamed_7,
    pub competition: C2RustUnnamed_6,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_7 {
    pub scores: [uint32_t; 32],
    pub color: [*mut uint16_t; 32],
    pub spectator: [boolean; 32],
    pub character: [*mut int32_t; 32],
    pub num: [int32_t; 32],
    pub name: [*mut libc::c_char; 32],
    pub result: *mut patch_t,
    pub blueflag: *mut patch_t,
    pub redflag: *mut patch_t,
    pub numplayers: int32_t,
    pub levelstring: [libc::c_char; 40],
}
#[derive(Copy, Clone)]
...
pub struct C2RustUnnamed_8 {
    pub passed1: [libc::c_char; 29],
    pub passed2: [libc::c_char; 17],
    pub passed3: [libc::c_char; 15],
    pub passed4: [libc::c_char; 23],
    pub passedx1: int32_t,
    pub passedx2: int32_t,
    pub passedx3: int32_t,
    pub passedx4: int32_t,
    pub emeraldbounces: int32_t,
    pub emeraldmomy: int32_t,
    pub emeraldy: int32_t,
    pub bonuses: [y_bonus_t; 2],
    pub bonuspatches: [*mut patch_t; 2],
    pub pscore: *mut patch_t,
    pub score: uint32_t,
    pub continues: uint8_t,
    pub pcontinues: *mut patch_t,
    pub playerchar: *mut int32_t,
    pub playercolor: *mut uint16_t,
    pub gotlife: uint8_t,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct y_bonus_t {
    pub patch: [libc::c_char; 9],
    pub points: int32_t,
    pub display: uint8_t,
}
#[derive(Copy, Clone)]
...
pub struct C2RustUnnamed_9 {
    pub passed1: [libc::c_char; 21],
    pub passed2: [libc::c_char; 16],
    pub passedx1: int32_t,
    pub passedx2: int32_t,
    pub bonuses: [y_bonus_t; 4],
    pub bonuspatches: [*mut patch_t; 4],
    pub gotperfbonus: int8_t,
    pub score: uint32_t,
    pub total: uint32_t,
    pub tics: uint32_t,
    pub actnum: uint8_t,
    pub ptotal: *mut patch_t,
    pub gotlife: uint8_t,
}
...
pub const hudhook_intermission: C2RustUnnamed_12 = 4;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct y_buffer_t {
    pub source_width: int32_t,
    pub source_height: int32_t,
    pub source_bpp: int32_t,
    pub source_rowbytes: int32_t,
    pub source_picture: *mut uint8_t,
    pub target_width: int32_t,
    pub target_height: int32_t,
    pub target_bpp: int32_t,
    pub target_rowbytes: int32_t,
    pub target_picture: *mut uint8_t,
}
pub const PU_STATIC: C2RustUnnamed_10 = 1;
pub const hook_IntermissionThinker: C2RustUnnamed_11 = 18;
pub const PU_PATCH: C2RustUnnamed_10 = 14;
pub const PU_HUDGFX: C2RustUnnamed_10 = 19;
pub type bonus_f = Option::<unsafe extern "C" fn(*mut player_t, *mut y_bonus_t) -> ()>;
pub type C2RustUnnamed_10 = libc::c_uint;
pub const PU_HWRMODELTEXTURE_UNLOCKED: C2RustUnnamed_10 = 103;
pub const PU_HWRCACHE_UNLOCKED: C2RustUnnamed_10 = 102;
pub const PU_CACHE_UNLOCKED: C2RustUnnamed_10 = 101;
pub const PU_PURGELEVEL: C2RustUnnamed_10 = 100;
pub const PU_HWRPLANE: C2RustUnnamed_10 = 52;
pub const PU_LEVSPEC: C2RustUnnamed_10 = 51;
pub const PU_LEVEL: C2RustUnnamed_10 = 50;
pub const PU_CACHE: C2RustUnnamed_10 = 49;
pub const PU_HWRCACHE: C2RustUnnamed_10 = 48;
pub const PU_HWRMODELTEXTURE: C2RustUnnamed_10 = 23;
pub const PU_HWRPATCHCOLMIPMAP: C2RustUnnamed_10 = 22;
pub const PU_HWRPATCHINFO: C2RustUnnamed_10 = 21;
pub const PU_SPRITE: C2RustUnnamed_10 = 18;
pub const PU_PATCH_DATA: C2RustUnnamed_10 = 17;
pub const PU_PATCH_ROTATED: C2RustUnnamed_10 = 16;
pub const PU_PATCH_LOWPRIORITY: C2RustUnnamed_10 = 15;
pub const PU_MUSIC: C2RustUnnamed_10 = 12;
pub const PU_SOUND: C2RustUnnamed_10 = 11;
pub const PU_PERFSTATS: C2RustUnnamed_10 = 3;
pub const PU_LUA: C2RustUnnamed_10 = 2;
pub type C2RustUnnamed_11 = libc::c_uint;
pub const hook_MAX: C2RustUnnamed_11 = 30;
pub const hook_KeyUp: C2RustUnnamed_11 = 29;
pub const hook_KeyDown: C2RustUnnamed_11 = 28;
pub const hook_PlayerCanEnterSpinGaps: C2RustUnnamed_11 = 27;
pub const hook_PlayerHeight: C2RustUnnamed_11 = 26;
pub const hook_MusicChange: C2RustUnnamed_11 = 25;
pub const hook_PlayerCmd: C2RustUnnamed_11 = 24;
pub const hook_GameQuit: C2RustUnnamed_11 = 23;
pub const hook_PlayerThink: C2RustUnnamed_11 = 22;
pub const hook_SeenPlayer: C2RustUnnamed_11 = 21;
pub const hook_ViewpointSwitch: C2RustUnnamed_11 = 20;
pub const hook_TeamSwitch: C2RustUnnamed_11 = 19;
pub const hook_PlayerQuit: C2RustUnnamed_11 = 17;
pub const hook_PlayerCanDamage: C2RustUnnamed_11 = 16;
pub const hook_ShieldSpecial: C2RustUnnamed_11 = 15;
pub const hook_ShieldSpawn: C2RustUnnamed_11 = 14;
pub const hook_PlayerSpawn: C2RustUnnamed_11 = 13;
pub const hook_PlayerMsg: C2RustUnnamed_11 = 12;
pub const hook_BotTiccmd: C2RustUnnamed_11 = 11;
pub const hook_JumpSpinSpecial: C2RustUnnamed_11 = 10;
pub const hook_SpinSpecial: C2RustUnnamed_11 = 9;
pub const hook_AbilitySpecial: C2RustUnnamed_11 = 8;
pub const hook_JumpSpecial: C2RustUnnamed_11 = 7;
pub const hook_PostThinkFrame: C2RustUnnamed_11 = 6;
pub const hook_ThinkFrame: C2RustUnnamed_11 = 5;
pub const hook_PreThinkFrame: C2RustUnnamed_11 = 4;
pub const hook_PlayerJoin: C2RustUnnamed_11 = 3;
pub const hook_MapLoad: C2RustUnnamed_11 = 2;
pub const hook_MapChange: C2RustUnnamed_11 = 1;
pub const hook_NetVars: C2RustUnnamed_11 = 0;
pub type C2RustUnnamed_12 = libc::c_uint;
pub const hudhook_MAX: C2RustUnnamed_12 = 5;
pub const hudhook_titlecard: C2RustUnnamed_12 = 3;
pub const hudhook_title: C2RustUnnamed_12 = 2;
pub const hudhook_scores: C2RustUnnamed_12 = 1;
pub const hudhook_game: C2RustUnnamed_12 = 0;
#[inline(always)]
...
static mut data: y_data = y_data {
    coop: C2RustUnnamed_9 {
        passed1: [0; 21],
        passed2: [0; 16],
        passedx1: 0,
        passedx2: 0,
        ...
        bonuspatches: [0 as *const patch_t as *mut patch_t; 4],
        gotperfbonus: 0,
        score: 0,
        total: 0,
        tics: 0,
        actnum: 0,
        ptotal: 0 as *const patch_t as *mut patch_t,
        gotlife: 0,
    },
};
static mut bgpatch: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut bgtile: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut interpic: *mut patch_t = 0 as *const patch_t as *mut patch_t;
static mut usetile: boolean = 0;
static mut timer: int32_t = 0;
#[no_mangle]
pub static mut usebuffer: boolean = false_0 as libc::c_int;
static mut useinterpic: boolean = 0;
static mut y_buffer: *mut y_buffer_t = 0 as *const y_buffer_t as *mut y_buffer_t;
static mut intertic: int32_t = 0;
static mut tallydonetic: int32_t = -(1 as libc::c_int);
static mut endtic: int32_t = -(1 as libc::c_int);
#[no_mangle]
pub static mut intertype: intertype_t = int_none;
#[no_mangle]
pub static mut intermissiontypes: [intertype_t; 136] = [int_none; 136];
static mut luahuddrawlist_intermission: huddrawlist_h = 0 as *const huddrawlist_s
    as *mut huddrawlist_s;
unsafe extern "C" fn Y_IntermissionTokenDrawer() {
    let mut y: int32_t = 0;
    let mut offs: int32_t = 0;
    let mut lowy: int32_t = 0;
    let mut calc: int32_t = 0;
    let mut tokencount: uint32_t = 0;
    let mut temp: int16_t = 0;
    let mut em: uint8_t = 0;
    offs = 0 as libc::c_int;
    lowy = 200 as libc::c_int - 32 as libc::c_int - 8 as libc::c_int;
    temp = ((*tokenicon).height as libc::c_int / 2 as libc::c_int) as int16_t;
    em = 0 as libc::c_int as uint8_t;
    while emeralds as libc::c_int & (1 as libc::c_int) << em as libc::c_int != 0 {
        em = em.wrapping_add(1);
        if em as libc::c_int == 7 as libc::c_int {
            return;
        }
    }
    if tallydonetic != -(1 as libc::c_int) {
        offs = (intertic - tallydonetic) * 2 as libc::c_int;
        if offs > 10 as libc::c_int {
            offs = 8 as libc::c_int;
        }
    }
    V_DrawStretchyFixedPatch(
        (32 as libc::c_int) << 16 as libc::c_int,
        (lowy - 1 as libc::c_int) << 16 as libc::c_int,
        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
        0 as libc::c_int,
        emeraldpics[2 as libc::c_int as usize][em as usize],
        0 as *const uint8_t,
    );
    y = ((lowy + offs + 1 as libc::c_int) as uint32_t)
        .wrapping_sub(
            (temp as uint32_t)
                .wrapping_add(
                    token.wrapping_add(1 as libc::c_int as uint32_t)
                        * 8 as libc::c_int as uint32_t,
                ),
        ) as int32_t;
    tokencount = token;
    while tokencount != 0 {
        if y >= -(temp as libc::c_int) {
            V_DrawStretchyFixedPatch(
                (32 as libc::c_int) << 16 as libc::c_int,
                y << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
        ...
        y += 8 as libc::c_int;
        tokencount = tokencount.wrapping_sub(1);
        tokencount;
    }
    y += offs * (temp as libc::c_int - 1 as libc::c_int) / 8 as libc::c_int;
    calc = (lowy - y) * 2 as libc::c_int;
    if calc > 0 as libc::c_int {
        V_DrawCroppedPatch(
            (32 as libc::c_int) << 16 as libc::c_int,
            y << 16 as libc::c_int,
            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
            ...
            0 as libc::c_int,
            0 as libc::c_int,
            ((*tokenicon).width as libc::c_int) << 16 as libc::c_int,
            calc << 16 as libc::c_int,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn Y_LoadIntermissionData() {
    let mut i: int32_t = 0;
    if dedicated != 0 {
        return;
    }
    let mut current_block_31: u64;
    match intertype as libc::c_uint {
        1 => {
            i = 0 as libc::c_int;
            while i < 4 as libc::c_int {
                if strlen((data.coop.bonuses[i as usize].patch).as_mut_ptr()) != 0 {
                    data
                        .coop
                        .bonuspatches[i
                        as usize] = W_CachePatchName(
                        (data.coop.bonuses[i as usize].patch).as_mut_ptr(),
            ...
            data
                .coop
                .ptotal = W_CachePatchName(
                b"YB_TOTAL\0" as *const u8 as *const libc::c_char,
                PU_PATCH as libc::c_int,
            ) as *mut patch_t;
            if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .interscreen[0 as libc::c_int as usize] as libc::c_int != '#' as i32
            {
                interpic = W_CachePatchName(
                ...
                bgpatch = W_CachePatchName(
                    b"INTERSCR\0" as *const u8 as *const libc::c_char,
                    PU_PATCH as libc::c_int,
                ) as *mut patch_t;
            }
            current_block_31 = 8693738493027456495;
        }
        5 => {
            i = 0 as libc::c_int;
            while i < 2 as libc::c_int {
                data
                    ...
                    .bonuspatches[i
                    as usize] = W_CachePatchName(
                    (data.spec.bonuses[i as usize].patch).as_mut_ptr(),
                    PU_PATCH as libc::c_int,
                ) as *mut patch_t;
                i += 1;
                i;
            ...
            data
                .spec
                .pscore = W_CachePatchName(
                b"YB_SCORE\0" as *const u8 as *const libc::c_char,
                PU_PATCH as libc::c_int,
            ) as *mut patch_t;
            data
                .spec
                .pcontinues = W_CachePatchName(
                b"YB_CONTI\0" as *const u8 as *const libc::c_char,
                PU_PATCH as libc::c_int,
            ) as *mut patch_t;
            if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .interscreen[0 as libc::c_int as usize] as libc::c_int != '#' as i32
            {
                ...
                bgtile = W_CachePatchName(
                    b"SPECTILE\0" as *const u8 as *const libc::c_char,
                    PU_PATCH as libc::c_int,
                ) as *mut patch_t;
            }
            current_block_31 = 8693738493027456495;
        ...
        4 | 3 => {
            ...
            data
                .match_0
                .redflag = if intertype as libc::c_uint
                == int_ctf as libc::c_int as libc::c_uint
            {
                rflagico
            } else {
                rmatcico
            ...
            data
                .match_0
                .blueflag = if intertype as libc::c_uint
                == int_ctf as libc::c_int as libc::c_uint
            {
                bflagico
            } else {
    ...
    match current_block_31 {
        16203760046146113240 => {
            if intertype as libc::c_uint == int_match as libc::c_int as libc::c_uint
                || intertype as libc::c_uint == int_race as libc::c_int as libc::c_uint
            {
                data
                    .match_0
                    .result = W_CachePatchName(
                    b"RESULT\0" as *const u8 as *const libc::c_char,
                    PU_PATCH as libc::c_int,
                ) as *mut patch_t;
            }
            bgtile = W_CachePatchName(
                b"SRB2BACK\0" as *const u8 as *const libc::c_char,
                PU_PATCH as libc::c_int,
            ) as *mut patch_t;
        }
        _ => {}
...
#[no_mangle]
pub unsafe extern "C" fn Y_ConsiderScreenBuffer() {
    if gameaction as libc::c_uint != ga_completed as libc::c_int as libc::c_uint {
        return;
    }
    if y_buffer.is_null() {
        y_buffer = Z_CallocAlign(
            ::core::mem::size_of::<y_buffer_t>() as libc::c_ulong,
    ...
    (*y_buffer).source_rowbytes = vid.rowbytes as int32_t;
    (*y_buffer)
        .source_picture = Z_MallocAlign(
        ((*y_buffer).source_width * vid.bpp * (*y_buffer).source_height) as size_t,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut uint8_t;
    VID_BlitLinearScreen(
        screens[1 as libc::c_int as usize],
        (*y_buffer).source_picture,
        vid.width * vid.bpp,
        vid.height,
...
unsafe extern "C" fn Y_RescaleScreenBuffer() {
    let mut sx: int32_t = 0;
    let mut sy: int32_t = 0;
    let mut dx: int32_t = 0;
    let mut dy: int32_t = 0;
    let mut scalefac: fixed_t = 0;
    let mut yscalefac: fixed_t = 0;
    ...
    if !((*y_buffer).target_picture).is_null() {
        Z_Free((*y_buffer).target_picture as *mut libc::c_void);
    }
    (*y_buffer).target_width = vid.width;
    (*y_buffer).target_height = vid.height;
    (*y_buffer).target_rowbytes = vid.rowbytes as int32_t;
    (*y_buffer).target_bpp = vid.bpp;
    (*y_buffer)
        .target_picture = Z_MallocAlign(
        ((*y_buffer).target_width * vid.bpp * (*y_buffer).target_height) as size_t,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut uint8_t;
    ...
    scalefac = FixedDiv(
        (*y_buffer).target_width * ((1 as libc::c_int) << 16 as libc::c_int),
        (*y_buffer).source_width * ((1 as libc::c_int) << 16 as libc::c_int),
    );
    yscalefac = FixedDiv(
        (*y_buffer).target_height * ((1 as libc::c_int) << 16 as libc::c_int),
        (*y_buffer).source_height * ((1 as libc::c_int) << 16 as libc::c_int),
    );
    rowfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, yscalefac);
    colfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, scalefac);
    sy = 0 as libc::c_int;
    dy = 0 as libc::c_int;
    while sy < (*y_buffer).source_height << 16 as libc::c_int
        && dy < (*y_buffer).target_height
    {
        sx = 0 as libc::c_int;
        dx = 0 as libc::c_int;
        while sx < (*y_buffer).source_width << 16 as libc::c_int
            && dx < (*y_buffer).target_width
        {
            *dest
                .offset(
                    (dy * (*y_buffer).target_rowbytes + dx) as isize,
                ) = *((*y_buffer).source_picture)
                .offset(
                    ((sy >> 16 as libc::c_int) * (*y_buffer).source_width
                        + (sx >> 16 as libc::c_int)) as isize,
                );
            sx += colfrac;
            dx += (*y_buffer).target_bpp;
        }
        sy += rowfrac;
        dy += 1;
        dy;
...
#[no_mangle]
pub unsafe extern "C" fn Y_CleanupScreenBuffer() {
    if y_buffer.is_null() {
        return;
    }
    if !((*y_buffer).target_picture).is_null() {
    ...
    if !((*y_buffer).source_picture).is_null() {
        Z_Free((*y_buffer).source_picture as *mut libc::c_void);
    }
    Z_Free(y_buffer as *mut libc::c_void);
    y_buffer = 0 as *mut y_buffer_t;
}
#[no_mangle]
pub unsafe extern "C" fn Y_IntermissionDrawer() {
    let mut i: int32_t = 0;
    if intertype as libc::c_uint == int_none as libc::c_int as libc::c_uint
        || rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint
    {
        return;
    }
    if useinterpic != 0 {
            ...
            && usebuffer != 0
        {
            if y_buffer.is_null() {
                ...
                if (*y_buffer).target_width != vid.width
                    || (*y_buffer).target_height != vid.height
                {
                    Y_RescaleScreenBuffer();
                }
                VID_BlitLinearScreen(
                    (*y_buffer).target_picture,
                    screens[0 as libc::c_int as usize],
                    vid.width * vid.bpp,
                    vid.height,
                    (vid.width * vid.bpp) as size_t,
        ...
        } else if !bgpatch.is_null() {
            let mut hs: fixed_t = vid.width * ((1 as libc::c_int) << 16 as libc::c_int)
                / 320 as libc::c_int;
            let mut vs: fixed_t = vid.height * ((1 as libc::c_int) << 16 as libc::c_int)
                / 200 as libc::c_int;
            V_DrawStretchyFixedPatch(
                0 as libc::c_int,
                0 as libc::c_int,
    ...
    } else if !bgtile.is_null() {
        V_DrawPatchFill(bgtile);
    }
    if renderisnewtic != 0 {
        LUA_HUD_ClearDrawList(luahuddrawlist_intermission);
        LUA_HookHUD(hudhook_intermission as libc::c_int, luahuddrawlist_intermission);
    }
    LUA_HUD_DrawList(luahuddrawlist_intermission);
    if !(LUA_HudEnabled(hud_intermissiontally) == 0) {
        if intertype as libc::c_uint == int_coop as libc::c_int as libc::c_uint {
            let mut bonusy: int32_t = 0;
            if gottoken != 0 {
            ...
            if splitscreen == 0 {
                V_DrawStretchyFixedPatch(
                    ...
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    hudinfo[HUD_SCORE as libc::c_int as usize].f,
                    sboscore,
                    0 as *const uint8_t,
                );
                V_DrawTallNum(
                    ...
                    hudinfo[HUD_SCORENUM as libc::c_int as usize].f,
                    data.coop.score as int32_t,
                );
                V_DrawStretchyFixedPatch(
                    ...
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    hudinfo[HUD_TIME as libc::c_int as usize].f,
                    sbotime,
                    0 as *const uint8_t,
                );
                if cv_timetic.value == 3 as libc::c_int {
                    V_DrawTallNum(
                        ...
                        hudinfo[HUD_SECONDS as libc::c_int as usize].f,
                        data.coop.tics as int32_t,
                    );
                } else {
                    ...
                    minutes = G_TicsToMinutes(data.coop.tics, true_0 as libc::c_int);
                    ...
                    V_DrawTallNum(
                        ...
                        hudinfo[HUD_MINUTES as libc::c_int as usize].f,
                        minutes,
                    );
                    V_DrawStretchyFixedPatch(
                        hudinfo[HUD_TIMECOLON as libc::c_int as usize].x
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        hudinfo[HUD_TIMECOLON as libc::c_int as usize].y
                            << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        hudinfo[HUD_TIMECOLON as libc::c_int as usize].f,
                        sbocolon,
                        0 as *const uint8_t,
                    );
                    V_DrawPaddedTallNum(
                    ...
                    if cv_timetic.value == 1 as libc::c_int
                        || cv_timetic.value == 2 as libc::c_int
                        ...
                        || marathonmode as libc::c_uint != 0
                    {
                        V_DrawStretchyFixedPatch(
                            hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].x
                                * ((1 as libc::c_int) << 16 as libc::c_int),
                            hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].y
                                << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            hudinfo[HUD_TIMETICCOLON as libc::c_int as usize].f,
                            sboperiod,
                            0 as *const uint8_t,
                        );
                        V_DrawPaddedTallNum(
                            ...
                            hudinfo[HUD_TICS as libc::c_int as usize].f,
                            tictrn,
                            2 as libc::c_int,
                        );
                    }
            ...
            if LUA_HudEnabled(hud_intermissiontitletext) != 0 {
                V_DrawLevelTitle(
                    data.coop.passedx1,
                    49 as libc::c_int,
                    0 as libc::c_int,
                    (data.coop.passed1).as_mut_ptr(),
                );
                let mut h: int32_t = V_LevelNameHeight((data.coop.passed2).as_mut_ptr());
                V_DrawLevelTitle(
                    data.coop.passedx2,
                    49 as libc::c_int + h + 2 as libc::c_int,
                    0 as libc::c_int,
                    (data.coop.passed2).as_mut_ptr(),
                );
                if data.coop.actnum != 0 {
                    V_DrawLevelActNum(
                        244 as libc::c_int,
                        42 as libc::c_int + h,
                        0 as libc::c_int,
            ...
            bonusy = 150 as libc::c_int;
            V_DrawStretchyFixedPatch(
                152 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                bonusy << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                0 as libc::c_int,
                data.coop.ptotal,
            ...
            V_DrawTallNum(
                320 as libc::c_int - 68 as libc::c_int,
                bonusy + 1 as libc::c_int,
                0 as libc::c_int,
                data.coop.total as int32_t,
            );
            bonusy
                -= 3 as libc::c_int
                    * (*tallnum[0 as libc::c_int as usize]).height as libc::c_int
                    / 2 as libc::c_int + 1 as libc::c_int;
            i = 3 as libc::c_int;
            while i >= 0 as libc::c_int {
                if data.coop.bonuses[i as usize].display != 0 {
                    V_DrawStretchyFixedPatch(
                        152 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                        bonusy << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        0 as libc::c_int,
                        data.coop.bonuspatches[i as usize],
                        0 as *const uint8_t,
                    );
                    V_DrawTallNum(
                        320 as libc::c_int - 68 as libc::c_int,
                        bonusy + 1 as libc::c_int,
                        0 as libc::c_int,
                        data.coop.bonuses[i as usize].points,
                    );
                }
                bonusy
                    -= 3 as libc::c_int
        ...
        } else if intertype as libc::c_uint == int_spec as libc::c_int as libc::c_uint {
            static mut animatetic: tic_t = 0 as libc::c_int as tic_t;
            let mut ttheight: int32_t = 16 as libc::c_int;
            let mut xoffset1: int32_t = 0 as libc::c_int;
            let mut xoffset2: int32_t = 0 as libc::c_int;
            let mut xoffset3: int32_t = 0 as libc::c_int;
            let mut xoffset4: int32_t = 0 as libc::c_int;
            let mut xoffset5: int32_t = 0 as libc::c_int;
            let mut xoffset6: int32_t = 0 as libc::c_int;
            let mut drawsection: uint8_t = 0 as libc::c_int as uint8_t;
            if gottoken != 0 {
                Y_IntermissionTokenDrawer();
            }
            if intertic <= 2 as libc::c_int * 35 as libc::c_int {
                animatetic = 0 as libc::c_int as tic_t;
            } else if animatetic == 0
                && data.spec.bonuses[0 as libc::c_int as usize].points
                    == 0 as libc::c_int
                && data.spec.bonuses[1 as libc::c_int as usize].points
                    == 0 as libc::c_int
                && data.spec.passed3[0 as libc::c_int as usize] as libc::c_int
                    != '\0' as i32
            {
                animatetic = (intertic + 35 as libc::c_int) as tic_t;
            }
            if animatetic != 0 && intertic as tic_t >= animatetic {
                let scradjust: int32_t = vid.width / vid.dupx >> 3 as libc::c_int;
                let mut animatetimer: int32_t = (intertic as tic_t)
                    .wrapping_sub(animatetic) as int32_t;
                if animatetimer <= 16 as libc::c_int {
                    xoffset1 = -(animatetimer * scradjust);
                    xoffset2 = -((animatetimer - 2 as libc::c_int) * scradjust);
                    xoffset3 = -((animatetimer - 4 as libc::c_int) * scradjust);
                    xoffset4 = -((animatetimer - 6 as libc::c_int) * scradjust);
                    xoffset5 = -((animatetimer - 8 as libc::c_int) * scradjust);
                    xoffset6 = -((animatetimer - 10 as libc::c_int) * scradjust);
                    if xoffset2 > 0 as libc::c_int {
                        xoffset2 = 0 as libc::c_int;
                    }
                    if xoffset3 > 0 as libc::c_int {
                        xoffset3 = 0 as libc::c_int;
                    }
                    if xoffset4 > 0 as libc::c_int {
                        xoffset4 = 0 as libc::c_int;
                    }
                    if xoffset5 > 0 as libc::c_int {
                        xoffset5 = 0 as libc::c_int;
                    }
                    if xoffset6 > 0 as libc::c_int {
                        xoffset6 = 0 as libc::c_int;
                    }
                } else if animatetimer < 34 as libc::c_int {
                    drawsection = 1 as libc::c_int as uint8_t;
                    xoffset1 = (24 as libc::c_int - animatetimer) * scradjust;
                    xoffset2 = (26 as libc::c_int - animatetimer) * scradjust;
                    xoffset3 = (28 as libc::c_int - animatetimer) * scradjust;
                    xoffset4 = (30 as libc::c_int - animatetimer) * scradjust;
                    xoffset5 = (32 as libc::c_int - animatetimer) * scradjust;
                    xoffset6 = (34 as libc::c_int - animatetimer) * scradjust;
                    if xoffset1 < 0 as libc::c_int {
                        xoffset1 = 0 as libc::c_int;
                    }
                    if xoffset2 < 0 as libc::c_int {
                        xoffset2 = 0 as libc::c_int;
                    }
                    ...
                    drawsection = 1 as libc::c_int as uint8_t;
                    if animatetimer == 32 as libc::c_int {
                        S_StartSound(0 as *const libc::c_void, sfx_s3k68);
                    }
                }
            }
            if drawsection as libc::c_int == 1 as libc::c_int {
                if LUA_HudEnabled(hud_intermissiontitletext) != 0 {
                    let mut ringtext: *const libc::c_char = b"\x8250 rings, no shield\0"
                        as *const u8 as *const libc::c_char;
                    let mut tut1text: *const libc::c_char = b"\x82press \x80spin\0"
                        as *const u8 as *const libc::c_char;
                    let mut tut2text: *const libc::c_char = b"\x82mid-\x80jump\0"
                        as *const u8 as *const libc::c_char;
                    ttheight = 8 as libc::c_int;
                    V_DrawLevelTitle(
                        data.spec.passedx1 + xoffset1,
                        ttheight,
                        0 as libc::c_int,
                        (data.spec.passed1).as_mut_ptr(),
                    );
                    ttheight
                        += V_LevelNameHeight((data.spec.passed3).as_mut_ptr())
                            + 2 as libc::c_int;
                    V_DrawLevelTitle(
                        data.spec.passedx3 + xoffset2,
                        ttheight,
                        0 as libc::c_int,
                        (data.spec.passed3).as_mut_ptr(),
                    );
                    ttheight
                        += V_LevelNameHeight((data.spec.passed4).as_mut_ptr())
                            + 2 as libc::c_int;
                    V_DrawLevelTitle(
                        data.spec.passedx4 + xoffset3,
                        ttheight,
                        0 as libc::c_int,
                        (data.spec.passed4).as_mut_ptr(),
                    );
                    ttheight = 108 as libc::c_int;
                    V_DrawLevelTitle(
                        320 as libc::c_int / 2 as libc::c_int + xoffset4
                            - V_LevelNameWidth(ringtext) / 2 as libc::c_int,
                        ttheight,
                        0 as libc::c_int,
                        ringtext,
                    );
                    ttheight += V_LevelNameHeight(tut1text) + 2 as libc::c_int;
                    V_DrawLevelTitle(
                        320 as libc::c_int / 2 as libc::c_int + xoffset5
                            - V_LevelNameWidth(tut1text) / 2 as libc::c_int,
                        ttheight,
                        0 as libc::c_int,
                        tut1text,
                    );
                    ttheight += V_LevelNameHeight(tut2text) + 2 as libc::c_int;
                    V_DrawLevelTitle(
                        320 as libc::c_int / 2 as libc::c_int + xoffset6
                            - V_LevelNameWidth(tut2text) / 2 as libc::c_int,
                        ttheight,
                        0 as libc::c_int,
                        tut2text,
                    );
                ...
                let mut yoffset: int32_t = 0 as libc::c_int;
                if LUA_HudEnabled(hud_intermissiontitletext) != 0 {
                    if data.spec.passed1[0 as libc::c_int as usize] as libc::c_int
                        != '\0' as i32
                    {
                        ttheight = 24 as libc::c_int;
                        V_DrawLevelTitle(
                            data.spec.passedx1 + xoffset1,
                            ttheight,
                            0 as libc::c_int,
                        ...
                        ttheight
                            += V_LevelNameHeight((data.spec.passed2).as_mut_ptr())
                                + 2 as libc::c_int;
                        V_DrawLevelTitle(
                            data.spec.passedx2 + xoffset2,
                            ttheight,
                            0 as libc::c_int,
                            (data.spec.passed2).as_mut_ptr(),
                        );
                    } else {
                        ttheight = 24 as libc::c_int
                            + V_LevelNameHeight((data.spec.passed2).as_mut_ptr())
                ...
                V_DrawStretchyFixedPatch(
                    (152 as libc::c_int + xoffset3)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    (108 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    0 as libc::c_int,
                    data.spec.bonuspatches[0 as libc::c_int as usize],
                    0 as *const uint8_t,
                );
                V_DrawTallNum(
                    320 as libc::c_int + xoffset3 - 68 as libc::c_int,
                    109 as libc::c_int,
                    0 as libc::c_int,
                    data.spec.bonuses[0 as libc::c_int as usize].points,
                );
                if data.spec.bonuses[1 as libc::c_int as usize].display != 0 {
                    V_DrawStretchyFixedPatch(
                        (152 as libc::c_int + xoffset4)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        (124 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        0 as libc::c_int,
                        data.spec.bonuspatches[1 as libc::c_int as usize],
                        0 as *const uint8_t,
                    );
                    V_DrawTallNum(
                        320 as libc::c_int + xoffset4 - 68 as libc::c_int,
                        125 as libc::c_int,
                        0 as libc::c_int,
                        data.spec.bonuses[1 as libc::c_int as usize].points,
                    );
                    yoffset = 16 as libc::c_int;
                    xoffset4 = xoffset5;
                    xoffset5 = xoffset6;
                }
                V_DrawStretchyFixedPatch(
                    (152 as libc::c_int + xoffset4)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    124 as libc::c_int + yoffset << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    (1 as libc::c_int) << 16 as libc::c_int,
                    0 as libc::c_int,
                    data.spec.pscore,
                ...
                V_DrawTallNum(
                    320 as libc::c_int + xoffset4 - 68 as libc::c_int,
                    125 as libc::c_int + yoffset,
                    0 as libc::c_int,
                    data.spec.score as int32_t,
                );
                if multiplayer == 0
                ...
                {
                    let mut continues: uint8_t = (data.spec.continues as libc::c_int
                        & 0x7f as libc::c_int) as uint8_t;
                    V_DrawStretchyFixedPatch(
                        (152 as libc::c_int + xoffset5)
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        150 as libc::c_int + yoffset << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        (1 as libc::c_int) << 16 as libc::c_int,
                        0 as libc::c_int,
                        data.spec.pcontinues,
                        0 as *const uint8_t,
                    );
                    if continues as libc::c_int > 5 as libc::c_int {
                        let mut leftx: int32_t = if continues as libc::c_int
                            >= 10 as libc::c_int
                        {
                            216 as libc::c_int
                        } else {
                        ...
                        V_DrawContinueIcon(
                            leftx + xoffset5,
                            162 as libc::c_int + yoffset,
                            0 as libc::c_int,
                            *data.spec.playerchar,
                            *data.spec.playercolor,
                        );
                        V_DrawStretchyFixedPatch(
                            (leftx + xoffset5 + 12 as libc::c_int)
                                * ((1 as libc::c_int) << 16 as libc::c_int),
                            160 as libc::c_int + yoffset << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            0 as libc::c_int,
                            stlivex,
                        ...
                        if !(data.spec.continues as libc::c_int & 0x80 as libc::c_int
                            != 0
                            && !(endtic < 0 as libc::c_int
                                || (intertic % 20 as libc::c_int) < 10 as libc::c_int))
                        {
                            V_DrawRightAlignedString(
                                252 as libc::c_int + xoffset5,
                                158 as libc::c_int + yoffset,
                                0 as libc::c_int,
                                va(
                                    b"%d\0" as *const u8 as *const libc::c_char,
                                    if data.spec.continues as libc::c_int & 0x80 as libc::c_int
                                        != 0 && endtic < 0 as libc::c_int
                                    {
                                        continues as libc::c_int - 1 as libc::c_int
                                    } else {
                                        continues as libc::c_int
                                    },
                                ),
                            );
                        }
                        ...
                        i = 0 as libc::c_int;
                        while i < continues as libc::c_int {
                            if data.spec.continues as libc::c_int & 0x80 as libc::c_int
                                != 0 && i == continues as libc::c_int - 1 as libc::c_int
                                && (endtic < 0 as libc::c_int
                                    || (intertic % 20 as libc::c_int) < 10 as libc::c_int)
                            {
                                break;
                            ...
                            V_DrawContinueIcon(
                                246 as libc::c_int + xoffset5 - i * 20 as libc::c_int,
                                162 as libc::c_int + yoffset,
                                0 as libc::c_int,
                                *data.spec.playerchar,
                                *data.spec.playercolor,
            ...
            if LUA_HudEnabled(hud_intermissionemeralds) != 0 {
                let mut drawthistic: boolean = !(emeralds as libc::c_int
                    & (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int
                        | 8 as libc::c_int | 16 as libc::c_int | 32 as libc::c_int
                        | 64 as libc::c_int)
                    == 1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int
                        | 8 as libc::c_int | 16 as libc::c_int | 32 as libc::c_int
                        | 64 as libc::c_int && intertic & 1 as libc::c_int != 0)
                    as libc::c_int;
                let mut emeraldx: int32_t = 152 as libc::c_int
                    - 3 as libc::c_int * 28 as libc::c_int;
                let mut em: int32_t = P_GetNextEmerald() as int32_t;
                if em == 7 as libc::c_int {
                    if stagefailed == 0 {
                        let mut adjust: fixed_t = 2 as libc::c_int
                            * (finesine[(FixedAngle(
                                (intertic + 1 as libc::c_int)
                        ...
                        V_DrawStretchyFixedPatch(
                            ...
                            ((74 as libc::c_int) << 16 as libc::c_int) - adjust,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            0 as libc::c_int,
                ...
                } else if em < 7 as libc::c_int {
                    if drawthistic != 0 {
                        i = 0 as libc::c_int;
                        while i < 7 as libc::c_int {
                            if i != em
                                && emeralds as libc::c_int & (1 as libc::c_int) << i != 0
                            {
                                V_DrawStretchyFixedPatch(
                                    emeraldx * ((1 as libc::c_int) << 16 as libc::c_int),
                                    (74 as libc::c_int) << 16 as libc::c_int,
                                    (1 as libc::c_int) << 16 as libc::c_int,
                                    (1 as libc::c_int) << 16 as libc::c_int,
                                    0 as libc::c_int,
                                    emeraldpics[0 as libc::c_int as usize][i as usize],
                                    0 as *const uint8_t,
                                );
                            }
                            emeraldx += 28 as libc::c_int;
                            i += 1;
                            i;
                        }
                    }
                    emeraldx = 152 as libc::c_int
                        + (em - 3 as libc::c_int) * 28 as libc::c_int;
                    if intertic > 1 as libc::c_int {
                        if stagefailed != 0
                            && data.spec.emeraldy
                                < vid.height / vid.dupy + 16 as libc::c_int
                        {
                            emeraldx += intertic - 6 as libc::c_int;
                        }
                        if drawthistic != 0 {
                            V_DrawStretchyFixedPatch(
                                emeraldx * ((1 as libc::c_int) << 16 as libc::c_int),
                                data.spec.emeraldy << 16 as libc::c_int,
                                (1 as libc::c_int) << 16 as libc::c_int,
                                (1 as libc::c_int) << 16 as libc::c_int,
                                0 as libc::c_int,
                                emeraldpics[0 as libc::c_int as usize][em as usize],
        ...
        } else if intertype as libc::c_uint == int_match as libc::c_int as libc::c_uint
            || intertype as libc::c_uint == int_race as libc::c_int as libc::c_uint
        {
            let mut j: int32_t = 0 as libc::c_int;
            let mut x: int32_t = 4 as libc::c_int;
            let mut y: int32_t = 48 as libc::c_int;
            let mut name: [libc::c_char; 22] = [0; 22];
            let mut strtime: [libc::c_char; 10] = [0; 10];
            V_DrawStretchyFixedPatch(
            ...
            V_DrawCenteredString(
                ...
                20 as libc::c_int,
                0 as libc::c_int,
                (data.match_0.levelstring).as_mut_ptr(),
            );
            V_DrawFill(
                4 as libc::c_int,
                42 as libc::c_int,
            ...
            if data.match_0.numplayers > 9 as libc::c_int {
                V_DrawFill(
                    160 as libc::c_int,
                    32 as libc::c_int,
                    1 as libc::c_int,
                ...
                if intertype as libc::c_uint == int_race as libc::c_int as libc::c_uint {
                    V_DrawRightAlignedString(
                        x + 152 as libc::c_int,
                        32 as libc::c_int,
                ...
                V_DrawCenteredString(
                    x + 320 as libc::c_int / 2 as libc::c_int + 6 as libc::c_int,
                    32 as libc::c_int,
                    0x2000 as libc::c_int,
                    b"#\0" as *const u8 as *const libc::c_char,
                );
                V_DrawString(
                    x + 320 as libc::c_int / 2 as libc::c_int + 36 as libc::c_int,
                    32 as libc::c_int,
                    0x2000 as libc::c_int,
            ...
            if intertype as libc::c_uint == int_race as libc::c_int as libc::c_uint {
                V_DrawRightAlignedString(
                    x + 320 as libc::c_int / 2 as libc::c_int + 152 as libc::c_int,
                    32 as libc::c_int,
                    0x2000 as libc::c_int,
                    b"TIME\0" as *const u8 as *const libc::c_char,
                );
            ...
            i = 0 as libc::c_int;
            while i < data.match_0.numplayers {
                if !(data.match_0.spectator[i as usize] != 0) {
                    V_DrawCenteredString(
                        x + 6 as libc::c_int,
                        y,
                        0 as libc::c_int,
                    ...
                    j += 1;
                    j;
                    if playeringame[data.match_0.num[i as usize] as usize] != 0 {
                        V_DrawStretchyFixedPatch(
                        ...
                        if (data.match_0.color[i as usize]).is_null() {
                            V_DrawStretchyFixedPatch(
                                (x + 16 as libc::c_int) << 16 as libc::c_int,
                                (y - 4 as libc::c_int) << 16 as libc::c_int,
                                ((1 as libc::c_int) << 16 as libc::c_int)
                                ...
                                ((1 as libc::c_int) << 16 as libc::c_int)
                                    / 2 as libc::c_int,
                                0 as libc::c_int,
                                faceprefix[*data.match_0.character[i as usize] as usize],
                                0 as *const uint8_t,
                            );
                        } else {
                            let mut colormap: *mut uint8_t = R_GetTranslationColormap(
                                *data.match_0.character[i as usize],
                                *data.match_0.color[i as usize] as skincolornum_t,
                        ...
                        if data.match_0.numplayers > 9 as libc::c_int {
                            if intertype as libc::c_uint
                                == int_race as libc::c_int as libc::c_uint
                            {
                                strlcpy(
                                    name.as_mut_ptr(),
                                    data.match_0.name[i as usize],
                        ...
                        if data.match_0.numplayers > 9 as libc::c_int {
                            if intertype as libc::c_uint
                                == int_match as libc::c_int as libc::c_uint
                            {
                                V_DrawRightAlignedString(
                                    x + 152 as libc::c_int,
                                    y,
                                    ...
                                    va(
                                        ...
                                        data.match_0.scores[i as usize],
                                    ),
                                );
                            } else if intertype as libc::c_uint
                                == int_race as libc::c_int as libc::c_uint
                            {
                                if players[data.match_0.num[i as usize] as usize].pflags
                                    as libc::c_uint
                                    & PF_GAMETYPEOVER as libc::c_int as libc::c_uint != 0
                                {
                                    snprintf(
                                        ...
                                        ::core::mem::size_of::<[libc::c_char; 10]>()
                                            as libc::c_ulong,
                                        b"DNF\0" as *const u8 as *const libc::c_char,
                                    );
                                } else {
                                    snprintf(
                                        strtime.as_mut_ptr(),
                                        ...
                                        G_TicsToSeconds(data.match_0.scores[i as usize]),
                                        G_TicsToCentiseconds(data.match_0.scores[i as usize]),
                                    );
                                }
                                strtime[(::core::mem::size_of::<[libc::c_char; 10]>()
                                    as libc::c_ulong)
        ...
        } else if intertype as libc::c_uint == int_ctf as libc::c_int as libc::c_uint
            || intertype as libc::c_uint == int_teammatch as libc::c_int as libc::c_uint
        {
            let mut x_0: int32_t = 4 as libc::c_int;
            let mut y_0: int32_t = 0 as libc::c_int;
            let mut redplayers: int32_t = 0 as libc::c_int;
            let mut blueplayers: int32_t = 0 as libc::c_int;
            let mut name_0: [libc::c_char; 22] = [0; 22];
            V_DrawStretchyFixedPatch(
                (128 as libc::c_int
                    - (*data.match_0.blueflag).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (2 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                0 as libc::c_int,
                data.match_0.blueflag,
                0 as *const uint8_t,
            );
            V_DrawCenteredString(
                128 as libc::c_int,
            ...
            V_DrawStretchyFixedPatch(
                (192 as libc::c_int
                    - (*data.match_0.redflag).width as libc::c_int / 4 as libc::c_int)
                    << 16 as libc::c_int,
                (2 as libc::c_int) << 16 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                0 as libc::c_int,
                data.match_0.redflag,
                0 as *const uint8_t,
            );
            V_DrawCenteredString(
                192 as libc::c_int,
            ...
            V_DrawCenteredString(
                x_0 + 320 as libc::c_int / 2 as libc::c_int + 6 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"#\0" as *const u8 as *const libc::c_char,
            );
            V_DrawString(
                x_0 + 36 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"NAME\0" as *const u8 as *const libc::c_char,
            );
            V_DrawString(
                x_0 + 320 as libc::c_int / 2 as libc::c_int + 36 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"NAME\0" as *const u8 as *const libc::c_char,
            );
            V_DrawRightAlignedString(
                x_0 + 152 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"SCORE\0" as *const u8 as *const libc::c_char,
            );
            V_DrawRightAlignedString(
                x_0 + 320 as libc::c_int / 2 as libc::c_int + 152 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"SCORE\0" as *const u8 as *const libc::c_char,
            );
            ...
            while i < data.match_0.numplayers {
                if playeringame[data.match_0.num[i as usize] as usize] != 0
                    && data.match_0.spectator[i as usize] == 0
                {
                    ...
                    if *data.match_0.color[i as usize] as libc::c_int
                        == SKINCOLOR_RED as libc::c_int
                    {
                        let fresh0 = redplayers;
                        redplayers = redplayers + 1;
                        if fresh0 > 9 as libc::c_int {
                            current_block_275 = 17664728594743454682;
                        } else {
                            x_0 = 4 as libc::c_int
                                + 320 as libc::c_int / 2 as libc::c_int;
                            y_0 = redplayers * 16 as libc::c_int + 32 as libc::c_int;
                            V_DrawCenteredString(
                                x_0 + 6 as libc::c_int,
                                y_0,
                                0 as libc::c_int,
                                va(b"%d\0" as *const u8 as *const libc::c_char, redplayers),
                            );
                            current_block_275 = 6249113199971190037;
                        }
                    } else if *data.match_0.color[i as usize] as libc::c_int
                        == SKINCOLOR_BLUE as libc::c_int
                    {
                        let fresh1 = blueplayers;
                        blueplayers = blueplayers + 1;
                        if fresh1 > 9 as libc::c_int {
                            current_block_275 = 17664728594743454682;
                        } else {
                            x_0 = 4 as libc::c_int;
                            y_0 = blueplayers * 16 as libc::c_int + 32 as libc::c_int;
                            V_DrawCenteredString(
                                x_0 + 6 as libc::c_int,
                                y_0,
                                0 as libc::c_int,
                                va(b"%d\0" as *const u8 as *const libc::c_char, blueplayers),
                            );
                            current_block_275 = 6249113199971190037;
                        }
                    } else {
                    ...
                    match current_block_275 {
                        ...
                        _ => {
                            V_DrawStretchyFixedPatch(
                                (x_0 + 16 as libc::c_int) << 16 as libc::c_int,
                                (y_0 - 4 as libc::c_int) << 16 as libc::c_int,
                                ((1 as libc::c_int) << 16 as libc::c_int)
                                    / 2 as libc::c_int,
                                ((1 as libc::c_int) << 16 as libc::c_int)
                                    / 2 as libc::c_int,
        ...
        } else if intertype as libc::c_uint == int_comp as libc::c_int as libc::c_uint {
            let mut x_1: int32_t = 4 as libc::c_int;
            let mut y_1: int32_t = 48 as libc::c_int;
            let mut ptime: uint32_t = 0;
            let mut pring: uint32_t = 0;
            let mut pmaxring: uint32_t = 0;
            let mut pmonitor: uint32_t = 0;
            let mut pscore: uint32_t = 0;
            let mut sstrtime: [libc::c_char; 10] = [0; 10];
            V_DrawCenteredString(
                320 as libc::c_int / 2 as libc::c_int,
                8 as libc::c_int,
                0 as libc::c_int,
                (data.competition.levelstring).as_mut_ptr(),
            );
            V_DrawFill(
                4 as libc::c_int,
                42 as libc::c_int,
            ...
            V_DrawString(
                x_1 + 36 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"NAME\0" as *const u8 as *const libc::c_char,
            );
            V_DrawRightAlignedString(
                x_1 + 160 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"TIME\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                x_1 + 168 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"RING\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                x_1 + 191 as libc::c_int,
                24 as libc::c_int,
                0x2000 as libc::c_int,
                b"TOTAL\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                x_1 + 196 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"RING\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                x_1 + 223 as libc::c_int,
                24 as libc::c_int,
                0x2000 as libc::c_int,
                b"ITEM\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                x_1 + 229 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"BOX\0" as *const u8 as *const libc::c_char,
            );
            V_DrawRightAlignedString(
                x_1 + 288 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"SCORE\0" as *const u8 as *const libc::c_char,
            );
            V_DrawRightAlignedString(
                x_1 + 312 as libc::c_int,
                32 as libc::c_int,
                0x2000 as libc::c_int,
                b"PT\0" as *const u8 as *const libc::c_char,
            );
            i = 0 as libc::c_int;
            while i < data.competition.numplayers {
                ptime = data.competition.times[i as usize]
                    & !(0x80000000 as libc::c_uint);
                pring = data.competition.rings[i as usize]
                    & !(0x80000000 as libc::c_uint);
                pmaxring = data.competition.maxrings[i as usize]
                    & !(0x80000000 as libc::c_uint);
                pmonitor = data.competition.monitors[i as usize]
                    & !(0x80000000 as libc::c_uint);
                pscore = data.competition.scores[i as usize]
                    & !(0x80000000 as libc::c_uint);
                V_DrawCenteredString(
                    x_1 + 6 as libc::c_int,
                    y_1,
                    0 as libc::c_int,
                    va(b"%d\0" as *const u8 as *const libc::c_char, i + 1 as libc::c_int),
                );
                if playeringame[data.competition.num[i as usize] as usize] != 0 {
                    V_DrawStretchyFixedPatch(
                        (x_1 + 16 as libc::c_int) << 16 as libc::c_int,
                        (y_1 - 4 as libc::c_int) << 16 as libc::c_int,
                        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                        ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                        0 as libc::c_int,
                        livesback,
                    ...
                    if (data.competition.color[i as usize]).is_null() {
                        V_DrawStretchyFixedPatch(
                            (x_1 + 16 as libc::c_int) << 16 as libc::c_int,
                            (y_1 - 4 as libc::c_int) << 16 as libc::c_int,
                            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                            ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int,
                            0 as libc::c_int,
                            faceprefix[*data.competition.character[i as usize] as usize],
                            0 as *const uint8_t,
                        );
                    } else {
                        let mut colormap_1: *mut uint8_t = R_GetTranslationColormap(
                            *data.competition.character[i as usize],
                            *data.competition.color[i as usize] as skincolornum_t,
                            1 as libc::c_int as uint8_t,
                        );
                        V_DrawStretchyFixedPatch(
                            (x_1 + 16 as libc::c_int) << 16 as libc::c_int,
                    ...
                    V_DrawString(
                        ...
                        y_1,
                        0x800000 as libc::c_int,
                        (data.competition.name[i as usize]).as_mut_ptr(),
                    );
                    if players[data.competition.num[i as usize] as usize].pflags
                        as libc::c_uint & PF_GAMETYPEOVER as libc::c_int as libc::c_uint
                        != 0
                    {
                        snprintf(
                            sstrtime.as_mut_ptr(),
                            ::core::mem::size_of::<[libc::c_char; 10]>()
                                as libc::c_ulong,
                            b"Time Over\0" as *const u8 as *const libc::c_char,
                        );
                    } else if players[data.competition.num[i as usize] as usize].lives
                        as libc::c_int <= 0 as libc::c_int
                    {
                        snprintf(
                            ...
                            ::core::mem::size_of::<[libc::c_char; 10]>()
                                as libc::c_ulong,
                            b"Game Over\0" as *const u8 as *const libc::c_char,
                        );
                    } else {
                        snprintf(
                            sstrtime.as_mut_ptr(),
                            ::core::mem::size_of::<[libc::c_char; 10]>()
                                as libc::c_ulong,
                            b"%i:%02i.%02i\0" as *const u8 as *const libc::c_char,
                            G_TicsToMinutes(ptime, true_0 as libc::c_int),
                            G_TicsToSeconds(ptime),
                            G_TicsToCentiseconds(ptime),
                        );
                    }
                    sstrtime[(::core::mem::size_of::<[libc::c_char; 10]>()
                        as libc::c_ulong)
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        as usize] = '\0' as i32 as libc::c_char;
                    V_DrawRightAlignedThinString(
                        x_1 + 160 as libc::c_int,
                        y_1,
                        if data.competition.times[i as usize]
                    ...
                    V_DrawRightAlignedThinString(
                        x_1 + 188 as libc::c_int,
                        y_1,
                        0xc00 as libc::c_int
                            | (if data.competition.rings[i as usize]
                                & 0x80000000 as libc::c_uint != 0
                            {
                                0x2000 as libc::c_int
                            } else {
                        ...
                        va(b"%u\0" as *const u8 as *const libc::c_char, pring),
                    );
                    V_DrawRightAlignedThinString(
                        x_1 + 216 as libc::c_int,
                        y_1,
                        0xc00 as libc::c_int
                            | (if data.competition.maxrings[i as usize]
                                & 0x80000000 as libc::c_uint != 0
                            {
                                0x2000 as libc::c_int
                            } else {
                        ...
                        va(b"%u\0" as *const u8 as *const libc::c_char, pmaxring),
                    );
                    V_DrawRightAlignedThinString(
                        x_1 + 244 as libc::c_int,
                        y_1,
                        0xc00 as libc::c_int
                            | (if data.competition.monitors[i as usize]
                                & 0x80000000 as libc::c_uint != 0
                            {
                                0x2000 as libc::c_int
                            } else {
                        ...
                        va(b"%u\0" as *const u8 as *const libc::c_char, pmonitor),
                    );
                    V_DrawRightAlignedThinString(
                        x_1 + 288 as libc::c_int,
                        y_1,
                        0xc00 as libc::c_int
                            | (if data.competition.scores[i as usize]
                                & 0x80000000 as libc::c_uint != 0
                            {
                                0x2000 as libc::c_int
                            } else {
                        ...
                        va(b"%u\0" as *const u8 as *const libc::c_char, pscore),
                    );
                    V_DrawRightAlignedString(
                        x_1 + 312 as libc::c_int,
                        y_1,
                        ...
                        va(
                            b"%d\0" as *const u8 as *const libc::c_char,
                            data.competition.points[i as usize],
                        ),
                    );
                }
                y_1 += 16 as libc::c_int;
                if y_1 > 176 as libc::c_int {
                    break;
                }
                i += 1;
                i;
    ...
    if LUA_HudEnabled(hud_intermissionmessages) == 0 {
        return;
    }
    if timer != 0 {
        V_DrawCenteredString(
            ...
            0x2000 as libc::c_int,
            va(
                b"start in %d seconds\0" as *const u8 as *const libc::c_char,
                timer / 35 as libc::c_int,
            ),
        );
    }
    if cv_scrambleonchange.value != 0 && cv_teamscramble.value != 0
        && intertic / 35 as libc::c_int % 2 as libc::c_int == 0 as libc::c_int
    {
        V_DrawCenteredString(
            320 as libc::c_int / 2 as libc::c_int,
            200 as libc::c_int / 2 as libc::c_int,
            0x2000 as libc::c_int,
            b"Teams will be scrambled next round!\0" as *const u8 as *const libc::c_char,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn Y_Ticker() {
    if intertype as libc::c_uint == int_none as libc::c_int as libc::c_uint {
        return;
    }
    ...
    LUA_HookBool(stagefailed, hook_IntermissionThinker as libc::c_int);
    intertic += 1;
    intertic;
    if G_GametypeHasTeams() != 0 && cv_teamscramble.value != 0
        && cv_scrambleonchange.value == 0 && server != 0
    {
        if intertic % (35 as libc::c_int / 7 as libc::c_int) == 0 as libc::c_int {
            P_DoTeamscrambling();
        }
    }
    if timer != 0 {
    ...
    if endtic != -(1 as libc::c_int) {
        return;
    }
    if intertype as libc::c_uint == int_coop as libc::c_int as libc::c_uint {
        let mut i: int32_t = 0;
        let mut oldscore: uint32_t = data.coop.score;
        let mut skip: boolean = if marathonmode as libc::c_uint != 0 {
            true_0 as libc::c_int
        } else {
            false_0 as libc::c_int
        };
        let mut anybonuses: boolean = false_0 as libc::c_int;
        if intertic == 0 {
            if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .musinterfadeout != 0
            {
                ...
                as usize])
                .musintername[0 as libc::c_int as usize] as libc::c_int != 0
                && S_MusicExists(
                    ((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
                        as usize])
                        .musintername)
                ...
                ) != 0
            {
                ...
                S_ChangeMusicEx(
                    b"_clear\0" as *const u8 as *const libc::c_char,
                    0 as libc::c_int as uint16_t,
                    false_0 as libc::c_int,
                    0 as libc::c_int as uint32_t,
                    0 as libc::c_int as uint32_t,
            ...
            tallydonetic = -(1 as libc::c_int);
        }
        if intertic < 35 as libc::c_int {
            return;
        }
        i = 0 as libc::c_int;
        ...
        i = 0 as libc::c_int;
        while i < 4 as libc::c_int {
            if !(data.coop.bonuses[i as usize].points == 0) {
                data.coop.bonuses[i as usize].points -= 222 as libc::c_int;
                data
                    .coop
                    .total = (data.coop.total)
                    .wrapping_add(222 as libc::c_int as uint32_t);
                data
                    .coop
                    .score = (data.coop.score)
                    .wrapping_add(222 as libc::c_int as uint32_t);
                if data.coop.bonuses[i as usize].points < 0 as libc::c_int
                    || skip == true_0 as libc::c_int
                {
                    data
                        .coop
                        .score = (data.coop.score)
                        .wrapping_add(data.coop.bonuses[i as usize].points as uint32_t);
                    data
                        .coop
                        .total = (data.coop.total)
                        .wrapping_add(data.coop.bonuses[i as usize].points as uint32_t);
                    data.coop.bonuses[i as usize].points = 0 as libc::c_int;
                }
                if data.coop.score > 99999990 as libc::c_int as uint32_t {
                    data.coop.score = 99999990 as libc::c_int as uint32_t;
                }
                if data.coop.bonuses[i as usize].points > 0 as libc::c_int {
                    anybonuses = true_0 as libc::c_int;
                }
            }
            i += 1;
            i;
        ...
        if anybonuses == 0 {
            ...
            endtic = intertic + 3 as libc::c_int * 35 as libc::c_int;
            S_StartSound(
                0 as *const libc::c_void,
                (if gottoken != 0 {
                    sfx_token as libc::c_int
                } else {
        ...
        } else if intertic & 1 as libc::c_int == 0 {
            S_StartSound(0 as *const libc::c_void, sfx_ptally);
        }
        if data.coop.gotlife as libc::c_int > 0 as libc::c_int
            && (skip == true_0 as libc::c_int
                || (data.coop.score % 50000 as libc::c_int as uint32_t)
                    < oldscore % 50000 as libc::c_int as uint32_t)
        {
            P_PlayLivesJingle(0 as *mut player_t);
            data.coop.gotlife = (data.coop.gotlife).wrapping_sub(1);
            data.coop.gotlife;
        }
    } else if intertype as libc::c_uint == int_spec as libc::c_int as libc::c_uint {
        let mut i_0: int32_t = 0;
        let mut oldscore_0: uint32_t = data.spec.score;
        let mut skip_0: boolean = if marathonmode as libc::c_uint != 0 {
            true_0 as libc::c_int
        } else {
            false_0 as libc::c_int
        };
        let mut super_0: boolean = false_0 as libc::c_int;
        let mut anybonuses_0: boolean = false_0 as libc::c_int;
        if intertic == 0 {
            if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .musinterfadeout != 0
            {
        ...
        if !(dedicated != 0 || LUA_HudEnabled(hud_intermissionemeralds) == 0) {
            if intertic <= 1 as libc::c_int {
                data.spec.emeraldbounces = 0 as libc::c_int;
                data.spec.emeraldmomy = 20 as libc::c_int;
                data.spec.emeraldy = -(40 as libc::c_int);
            } else if (P_GetNextEmerald() as libc::c_int) < 7 as libc::c_int {
                if stagefailed == 0 {
                    if data.spec.emeraldbounces < 3 as libc::c_int {
                        data.spec.emeraldmomy += 1;
                        data.spec.emeraldy += data.spec.emeraldmomy;
                        if data.spec.emeraldy > 74 as libc::c_int {
                            S_StartSound(0 as *const libc::c_void, sfx_tink);
                            data.spec.emeraldbounces += 1;
                            data.spec.emeraldbounces;
                            data
                                .spec
                                .emeraldmomy = -(data.spec.emeraldmomy / 2 as libc::c_int);
                            data.spec.emeraldy = 74 as libc::c_int;
                        }
                    }
                } else {
                    if data.spec.emeraldy < vid.height / vid.dupy + 16 as libc::c_int {
                        data.spec.emeraldmomy += 1;
                        data.spec.emeraldy += data.spec.emeraldmomy;
                    }
                    if data.spec.emeraldbounces < 1 as libc::c_int
                        && data.spec.emeraldy > 74 as libc::c_int
                    {
        ...
        while i_0 < 32 as libc::c_int {
            if playeringame[i_0 as usize] != 0 {
                if players[i_0 as usize].cmd.buttons as libc::c_int
                    & BT_SPIN as libc::c_int != 0
                {
                    skip_0 = true_0 as libc::c_int;
                }
                if players[i_0 as usize].charflags & SF_SUPER as libc::c_int as uint32_t
                    != 0
                {
                    super_0 = true_0 as libc::c_int;
                }
            }
            i_0 += 1;
            i_0;
        ...
        if tallydonetic != -(1 as libc::c_int)
            && (data.spec.continues as libc::c_int & 0x80 as libc::c_int != 0
                || super_0 != 0
                            ...
                            | 64 as libc::c_int)
        {
            ...
            {
                endtic = intertic + 4 as libc::c_int * 35 as libc::c_int;
                if data.spec.continues as libc::c_int & 0x80 as libc::c_int != 0 {
        ...
        while i_0 < 2 as libc::c_int {
            if !(data.spec.bonuses[i_0 as usize].points == 0) {
                data.spec.bonuses[i_0 as usize].points -= 222 as libc::c_int;
                data
                    .spec
                    .score = (data.spec.score)
                    .wrapping_add(222 as libc::c_int as uint32_t);
                if data.spec.bonuses[i_0 as usize].points < 0 as libc::c_int
                    || skip_0 == true_0 as libc::c_int
                {
                    data
                        .spec
                        .score = (data.spec.score)
                        .wrapping_add(
                            data.spec.bonuses[i_0 as usize].points as uint32_t,
                        );
                    data.spec.bonuses[i_0 as usize].points = 0 as libc::c_int;
                }
                if data.spec.score > 99999990 as libc::c_int as uint32_t {
                    data.spec.score = 99999990 as libc::c_int as uint32_t;
                }
                if data.spec.bonuses[i_0 as usize].points > 0 as libc::c_int {
                    anybonuses_0 = true_0 as libc::c_int;
                }
            }
            i_0 += 1;
            i_0;
        ...
        if data.spec.gotlife as libc::c_int > 0 as libc::c_int
            && (skip_0 == true_0 as libc::c_int
                || (data.spec.score % 50000 as libc::c_int as uint32_t)
                    < oldscore_0 % 50000 as libc::c_int as uint32_t)
        {
            P_PlayLivesJingle(0 as *mut player_t);
            data.spec.gotlife = (data.spec.gotlife).wrapping_sub(1);
            data.spec.gotlife;
        }
    } else if intertype as libc::c_uint == int_match as libc::c_int as libc::c_uint
        || intertype as libc::c_uint == int_ctf as libc::c_int as libc::c_uint
        || intertype as libc::c_uint == int_teammatch as libc::c_int as libc::c_uint
    {
        if intertic == 0 {
            S_ChangeMusicEx(
                b"_inter\0" as *const u8 as *const libc::c_char,
                0 as libc::c_int as uint16_t,
                true_0 as libc::c_int,
                0 as libc::c_int as uint32_t,
                0 as libc::c_int as uint32_t,
        ...
        if data.match_0.numplayers != D_NumPlayers() {
            Y_CalculateMatchWinners();
        }
    } else if intertype as libc::c_uint == int_race as libc::c_int as libc::c_uint
        || intertype as libc::c_uint == int_comp as libc::c_int as libc::c_uint
    {
        if intertic == 0 {
            S_ChangeMusicEx(
                b"_inter\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn Y_DetermineIntermissionType() {
    intertype = int_none;
    if intermissiontypes[gametype as usize] as libc::c_uint
        != int_none as libc::c_int as libc::c_uint
    {
        intertype = intermissiontypes[gametype as usize];
    } else if gametype as libc::c_int == GT_COOP as libc::c_int {
        intertype = (if G_IsSpecialStage(gamemap as int32_t) != 0 {
            int_spec as libc::c_int
        } else {
            int_coop as libc::c_int
        }) as intertype_t;
    } else if gametype as libc::c_int == GT_TEAMMATCH as libc::c_int {
        intertype = int_teammatch;
    } else if gametype as libc::c_int == GT_MATCH as libc::c_int
        || gametype as libc::c_int == GT_TAG as libc::c_int
        || gametype as libc::c_int == GT_HIDEANDSEEK as libc::c_int
    {
        intertype = int_match;
    } else if gametype as libc::c_int == GT_RACE as libc::c_int {
        intertype = int_race;
    } else if gametype as libc::c_int == GT_COMPETITION as libc::c_int {
        intertype = int_comp;
    } else if gametype as libc::c_int == GT_CTF as libc::c_int {
        intertype = int_ctf;
    }
}
#[no_mangle]
pub unsafe extern "C" fn Y_StartIntermission() {
    intertic = -(1 as libc::c_int);
    if multiplayer == 0 {
        timer = 0 as libc::c_int;
        intertype = (if G_IsSpecialStage(gamemap as int32_t) != 0 {
            int_spec as libc::c_int
        } else {
            int_coop as libc::c_int
        }) as intertype_t;
    } else if cv_inttime.value == 0 as libc::c_int
        && (intertype as libc::c_uint == int_coop as libc::c_int as libc::c_uint
            || intertype as libc::c_uint == int_spec as libc::c_int as libc::c_uint)
    {
        timer = 0 as libc::c_int;
    } else {
        timer = cv_inttime.value * 35 as libc::c_int;
        if timer == 0 {
            timer = 1 as libc::c_int;
        }
    }
    if (mapheaderinfo[prevmap as usize]).is_null() {
        P_AllocMapHeader(prevmap);
    }
    match intertype as libc::c_uint {
        1 => {
            Y_AwardCoopBonuses();
            data.coop.tics = players[consoleplayer as usize].realtime;
            data
                .coop
            ...
            if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
                .interscreen[0 as libc::c_int as usize] as libc::c_int != '#' as i32
            {
                useinterpic = true_0 as libc::c_int;
                usebuffer = false_0 as libc::c_int;
            } else {
                useinterpic = false_0 as libc::c_int;
            }
            usetile = false_0 as libc::c_int;
            if stagefailed != 0 {
                strcpy(
                    (data.coop.passed1).as_mut_ptr(),
                    ((*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
            ...
            ) > 13 as libc::c_int as libc::c_ulong
            {
                strcpy(
                    (data.coop.passed1).as_mut_ptr(),
                    b"you got\0" as *const u8 as *const libc::c_char,
                );
                strcpy(
                    (data.coop.passed2).as_mut_ptr(),
                    if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
                        as usize])
                        .actnum as libc::c_int != 0
                    {
                        b"through act\0" as *const u8 as *const libc::c_char
                    } else {
                        b"through the act\0" as *const u8 as *const libc::c_char
                    },
                );
            } else if strlen(
                (skins[players[consoleplayer as usize].skin as usize].realname)
            ...
            ) > 8 as libc::c_int as libc::c_ulong
            {
                ...
                strcpy(
                    ...
                    if (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int)
                        ...
                        .actnum as libc::c_int != 0
                    {
                        b"passed act\0" as *const u8 as *const libc::c_char
                    } else {
                        b"passed the act\0" as *const u8 as *const libc::c_char
                    },
                );
            } else {
                snprintf(
                    ...
                    b"%s got\0" as *const u8 as *const libc::c_char,
                    (skins[players[consoleplayer as usize].skin as usize].realname)
                        .as_mut_ptr(),
                );
                strcpy(
                ...
                .actnum != 0
            {
                data
                    .coop
                    .passedx1 = 62 as libc::c_int
                    + (176 as libc::c_int
                        - V_LevelNameWidth((data.coop.passed1).as_mut_ptr()))
                        / 2 as libc::c_int;
                data
                    .coop
                    .passedx2 = 62 as libc::c_int
                    + (176 as libc::c_int
                        - V_LevelNameWidth((data.coop.passed2).as_mut_ptr()))
                        / 2 as libc::c_int;
            } else {
                data
                    .coop
                    .passedx1 = (320 as libc::c_int
                    - V_LevelNameWidth((data.coop.passed1).as_mut_ptr()))
                    / 2 as libc::c_int;
                data
                    .coop
                    .passedx2 = (320 as libc::c_int
                    - V_LevelNameWidth((data.coop.passed2).as_mut_ptr()))
                    / 2 as libc::c_int;
            }
            if stagefailed != 0
        ...
        5 => {
            ...
            usetile = (useinterpic == 0) as libc::c_int;
            data.spec.passed3[0 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
            data.spec.passed4[0 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
            if stagefailed != 0 {
                strcpy(
                    (data.spec.passed2).as_mut_ptr(),
                    b"Special Stage\0" as *const u8 as *const libc::c_char,
                );
                data
                    .spec
                    .passed1[0 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
            } else if emeralds as libc::c_int
                & (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int
                    | 8 as libc::c_int | 16 as libc::c_int | 32 as libc::c_int
                    | 64 as libc::c_int)
                == 1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int
                    ...
                    | 64 as libc::c_int
            {
                ...
                data
                    .spec
                    .passed1[(::core::mem::size_of::<[libc::c_char; 29]>()
                    as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as usize] = '\0' as i32 as libc::c_char;
                strcpy(
                    (data.spec.passed2).as_mut_ptr(),
                    b"got them all!\0" as *const u8 as *const libc::c_char,
                );
                if players[consoleplayer as usize].charflags
                    & SF_SUPER as libc::c_int as uint32_t != 0
                {
                    strcpy(
                        (data.spec.passed3).as_mut_ptr(),
                        b"can now become\0" as *const u8 as *const libc::c_char,
                    );
                    if strlen(
                        (skins[players[consoleplayer as usize].skin as usize].supername)
                            .as_mut_ptr(),
                    ) > 20 as libc::c_int as libc::c_ulong
                    {
                        strcpy(
                            (data.spec.passed4).as_mut_ptr(),
                            b"their super form\0" as *const u8 as *const libc::c_char,
                        );
                    } else {
                        strcpy(
                            (data.spec.passed4).as_mut_ptr(),
                            (skins[players[consoleplayer as usize].skin as usize]
                                .supername)
                                .as_mut_ptr(),
                        );
                    }
                ...
                if strlen(
                    (skins[players[consoleplayer as usize].skin as usize].realname)
                        .as_mut_ptr(),
                ) <= (16 as libc::c_int - 5 as libc::c_int) as libc::c_ulong
                {
                    snprintf(
                        (data.spec.passed1).as_mut_ptr(),
                        ::core::mem::size_of::<[libc::c_char; 29]>() as libc::c_ulong,
                ...
                strcpy(
                    (data.spec.passed2).as_mut_ptr(),
                    b"a Chaos Emerald\0" as *const u8 as *const libc::c_char,
                );
                if P_GetNextEmerald() as libc::c_int > 6 as libc::c_int {
                    data
                        .spec
                        .passed2[15 as libc::c_int
                        as usize] = '?' as i32 as libc::c_char;
                    data
                        .spec
                        .passed2[16 as libc::c_int
                        as usize] = '\0' as i32 as libc::c_char;
                }
            }
            data
                .spec
                .passedx1 = (320 as libc::c_int
                - V_LevelNameWidth((data.spec.passed1).as_mut_ptr())) / 2 as libc::c_int;
            data
                .spec
                .passedx2 = (320 as libc::c_int
                - V_LevelNameWidth((data.spec.passed2).as_mut_ptr())) / 2 as libc::c_int;
            data
                .spec
                .passedx3 = (320 as libc::c_int
                - V_LevelNameWidth((data.spec.passed3).as_mut_ptr())) / 2 as libc::c_int;
            data
                .spec
                .passedx4 = (320 as libc::c_int
                - V_LevelNameWidth((data.spec.passed4).as_mut_ptr())) / 2 as libc::c_int;
        }
        2 => {
            Y_CalculateMatchWinners();
            if (*mapheaderinfo[prevmap as usize]).actnum != 0 {
                snprintf(
                    (data.match_0.levelstring).as_mut_ptr(),
                    ::core::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong,
                    b"%.32s * %d *\0" as *const u8 as *const libc::c_char,
                    ((*mapheaderinfo[prevmap as usize]).lvlttl).as_mut_ptr(),
                    (*mapheaderinfo[prevmap as usize]).actnum as libc::c_int,
                );
            } else {
                snprintf(
                    (data.match_0.levelstring).as_mut_ptr(),
                    ::core::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong,
                    b"* %.32s *\0" as *const u8 as *const libc::c_char,
                    ((*mapheaderinfo[prevmap as usize]).lvlttl).as_mut_ptr(),
                );
            }
            data
                .match_0
                .levelstring[(::core::mem::size_of::<[libc::c_char; 40]>()
                as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                as usize] = '\0' as i32 as libc::c_char;
            usetile = true_0 as libc::c_int;
            useinterpic = false_0 as libc::c_int;
        }
        6 => {
...
unsafe extern "C" fn Y_CalculateMatchWinners() {
    let mut i: int32_t = 0;
    let mut j: int32_t = 0;
    let mut completed: [boolean; 32] = [0; 32];
    memset(
        (data.match_0.scores).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[uint32_t; 32]>() as libc::c_ulong,
    );
    memset(
        (data.match_0.color).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[*mut uint16_t; 32]>() as libc::c_ulong,
    );
    memset(
        (data.match_0.character).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[*mut int32_t; 32]>() as libc::c_ulong,
    );
    memset(
        (data.match_0.spectator).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
    ...
    data.match_0.numplayers = 0 as libc::c_int;
    j = 0 as libc::c_int;
    i = j;
    j = 0 as libc::c_int;
            ...
            while i < 32 as libc::c_int {
                if !(playeringame[i as usize] == 0) {
                    if players[i as usize].score
                        >= data.match_0.scores[data.match_0.numplayers as usize]
                        && completed[i as usize] == false_0 as libc::c_int
                    {
                        data
                            .match_0
                            .scores[data.match_0.numplayers
                            as usize] = players[i as usize].score;
                        data
                            .match_0
                            .color[data.match_0.numplayers
                            as usize] = &mut (*players.as_mut_ptr().offset(i as isize))
                            .skincolor;
                        data
                            .match_0
                            .character[data.match_0.numplayers
                            as usize] = &mut (*players.as_mut_ptr().offset(i as isize))
                            .skin;
                        data
                            .match_0
                            .name[data.match_0.numplayers
                            as usize] = (player_names[i as usize]).as_mut_ptr();
                        data
                            .match_0
                            .spectator[data.match_0.numplayers
                            as usize] = players[i as usize].spectator;
                        data.match_0.num[data.match_0.numplayers as usize] = i;
                    }
                }
                i += 1;
                i;
            }
            completed[data.match_0.num[data.match_0.numplayers as usize]
                as usize] = true_0 as libc::c_int;
            data.match_0.numplayers += 1;
            data.match_0.numplayers;
        }
        j += 1;
        j;
    }
}
unsafe extern "C" fn Y_CalculateTimeRaceWinners() {
    let mut i: int32_t = 0;
    let mut j: int32_t = 0;
    let mut completed: [boolean; 32] = [0; 32];
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        data.match_0.scores[i as usize] = 2147483647 as libc::c_int as uint32_t;
        i += 1;
        i;
    }
    memset(
    ...
    while j < 32 as libc::c_int {
        if !(playeringame[j as usize] == 0) {
            ...
            while i < 32 as libc::c_int {
                if !(playeringame[i as usize] == 0) {
                    if players[i as usize].realtime
                        <= data.match_0.scores[data.match_0.numplayers as usize]
                        && completed[i as usize] == false_0 as libc::c_int
                    {
                        data
                            .match_0
                            .scores[data.match_0.numplayers
                            as usize] = players[i as usize].realtime;
                        data
                            .match_0
                            .color[data.match_0.numplayers
                            as usize] = &mut (*players.as_mut_ptr().offset(i as isize))
...
unsafe extern "C" fn Y_CalculateCompetitionWinners() {
    let mut i: int32_t = 0;
    let mut j: int32_t = 0;
    let mut bestat: [boolean; 5] = [0; 5];
    let mut completed: [boolean; 32] = [0; 32];
    let mut winner: int32_t = 0;
    let mut points: [uint32_t; 32] = [0; 32];
    let mut times: [uint32_t; 32] = [0; 32];
    let mut rings: [uint32_t; 32] = [0; 32];
    let mut maxrings: [uint32_t; 32] = [0; 32];
    let mut monitors: [uint32_t; 32] = [0; 32];
    let mut scores: [uint32_t; 32] = [0; 32];
    let mut tempname: [libc::c_char; 9] = [0; 9];
    memset(
        (data.competition.points).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[uint32_t; 32]>() as libc::c_ulong,
    );
    memset(
        points.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[uint32_t; 32]>() as libc::c_ulong,
    );
    memset(
    ...
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0) {
            ...
            while j < 5 as libc::c_int {
                bestat[j as usize] = true_0 as libc::c_int;
                j += 1;
                j;
            }
            ...
            times[i as usize] = players[i as usize].realtime;
            rings[i
                as usize] = (if players[i as usize].rings as libc::c_int
                > 0 as libc::c_int
            {
            ...
            maxrings[i as usize] = players[i as usize].totalring as uint32_t;
            monitors[i as usize] = players[i as usize].numboxes as uint32_t;
            scores[i
                as usize] = if players[i as usize].score
            ...
            j = 0 as libc::c_int;
            while j < 32 as libc::c_int {
                if !(playeringame[j as usize] == 0 || j == i) {
                    if players[i as usize].realtime <= players[j as usize].realtime {
                        points[i as usize] = (points[i as usize]).wrapping_add(1);
                        points[i as usize];
                    } else {
                        bestat[0 as libc::c_int as usize] = false_0 as libc::c_int;
                    }
                    if (if players[i as usize].rings as libc::c_int > 0 as libc::c_int {
                        players[i as usize].rings as libc::c_int
                    } else {
                        0 as libc::c_int
                    })
                        >= (if players[j as usize].rings as libc::c_int
                            > 0 as libc::c_int
                        {
                            players[j as usize].rings as libc::c_int
                        } else {
                            0 as libc::c_int
                        })
                    {
                        ...
                        bestat[1 as libc::c_int as usize] = false_0 as libc::c_int;
                    }
                    if players[i as usize].totalring as libc::c_int
                        >= players[j as usize].totalring as libc::c_int
                    {
                        points[i as usize] = (points[i as usize]).wrapping_add(1);
                        points[i as usize];
                    } else {
                        bestat[2 as libc::c_int as usize] = false_0 as libc::c_int;
                    }
                    if players[i as usize].numboxes as libc::c_int
                        >= players[j as usize].numboxes as libc::c_int
                    {
                        points[i as usize] = (points[i as usize]).wrapping_add(1);
                        points[i as usize];
                    } else {
                        bestat[3 as libc::c_int as usize] = false_0 as libc::c_int;
                    }
                    if players[i as usize].score >= players[j as usize].score {
                        points[i as usize] = (points[i as usize]).wrapping_add(1);
                        points[i as usize];
                    } else {
                        bestat[4 as libc::c_int as usize] = false_0 as libc::c_int;
                    }
                }
                j += 1;
                j;
            }
            if bestat[0 as libc::c_int as usize] != 0 {
                times[i as usize] |= 0x80000000 as libc::c_uint;
            }
            if bestat[1 as libc::c_int as usize] != 0 {
                rings[i as usize] |= 0x80000000 as libc::c_uint;
            }
            if bestat[2 as libc::c_int as usize] != 0 {
                maxrings[i as usize] |= 0x80000000 as libc::c_uint;
            }
            if bestat[3 as libc::c_int as usize] != 0 {
                monitors[i as usize] |= 0x80000000 as libc::c_uint;
            }
            if bestat[4 as libc::c_int as usize] != 0 {
                scores[i as usize] |= 0x80000000 as libc::c_uint;
            }
        }
        i += 1;
        i;
    }
    data.competition.numplayers = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0) {
            winner = 0 as libc::c_int;
            j = 0 as libc::c_int;
            while j < 32 as libc::c_int {
                if !(playeringame[j as usize] == 0) {
                    if points[j as usize]
                        >= data.competition.points[data.competition.numplayers as usize]
                        && completed[j as usize] == false_0 as libc::c_int
                    {
                        data
                            .competition
                            .points[data.competition.numplayers
                            as usize] = points[j as usize];
                        winner = j;
                        data
                            .competition
                            .num[data.competition.numplayers as usize] = winner;
                    }
                }
                j += 1;
                j;
            ...
            data
                .competition
                .times[data.competition.numplayers as usize] = times[winner as usize];
            data
                .competition
                .rings[data.competition.numplayers as usize] = rings[winner as usize];
            data
                .competition
                .maxrings[data.competition.numplayers
                as usize] = maxrings[winner as usize];
            data
                .competition
                .monitors[data.competition.numplayers
                as usize] = monitors[winner as usize];
            data
                .competition
                .scores[data.competition.numplayers as usize] = scores[winner as usize];
            strncpy(
                tempname.as_mut_ptr(),
                (player_names[winner as usize]).as_mut_ptr(),
                8 as libc::c_int as libc::c_ulong,
            );
            tempname[8 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
            strncpy(
                (data.competition.name[data.competition.numplayers as usize])
                    .as_mut_ptr(),
                tempname.as_mut_ptr(),
                9 as libc::c_int as libc::c_ulong,
            );
            data
                .competition
                .color[data.competition.numplayers
                as usize] = &mut (*players.as_mut_ptr().offset(winner as isize))
                .skincolor;
            data
                .competition
                .character[data.competition.numplayers
                as usize] = &mut (*players.as_mut_ptr().offset(winner as isize)).skin;
            completed[winner as usize] = true_0 as libc::c_int;
            data.competition.numplayers += 1;
...
unsafe extern "C" fn Y_SetNullBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    memset(
        bstruct as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<y_bonus_t>() as libc::c_ulong,
    );
}
unsafe extern "C" fn Y_SetTimeBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    let mut secs: int32_t = 0;
    let mut bonus: int32_t = 0;
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_TIME\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    if stagefailed == true_0 as libc::c_int {
        bonus = 0 as libc::c_int;
    } else {
        secs = ((*player).realtime / 35 as libc::c_int as tic_t) as int32_t;
        if secs < 30 as libc::c_int {
            bonus = 50000 as libc::c_int;
        } else if secs < 60 as libc::c_int {
            bonus = 10000 as libc::c_int;
        } else if secs < 90 as libc::c_int {
            bonus = 5000 as libc::c_int;
        } else if secs < 120 as libc::c_int {
            bonus = 4000 as libc::c_int;
        } else if secs < 180 as libc::c_int {
            bonus = 3000 as libc::c_int;
        } else if secs < 240 as libc::c_int {
            bonus = 2000 as libc::c_int;
        } else if secs < 300 as libc::c_int {
            bonus = 1000 as libc::c_int;
        } else if secs < 360 as libc::c_int {
            bonus = 500 as libc::c_int;
        } else if secs < 420 as libc::c_int {
            bonus = 400 as libc::c_int;
        } else if secs < 480 as libc::c_int {
            bonus = 300 as libc::c_int;
        } else if secs < 540 as libc::c_int {
            bonus = 200 as libc::c_int;
        } else if secs < 600 as libc::c_int {
            bonus = 100 as libc::c_int;
        } else {
            bonus = 0 as libc::c_int;
        }
    }
...
unsafe extern "C" fn Y_SetRingBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_RING\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    (*bstruct)
        .points = if 0 as libc::c_int
        > (*player).rings as libc::c_int * 100 as libc::c_int
    {
        0 as libc::c_int
    } else {
        (*player).rings as libc::c_int * 100 as libc::c_int
...
unsafe extern "C" fn Y_SetNightsBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_NIGHT\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    (*bstruct).points = (*player).totalmarescore as int32_t;
}
unsafe extern "C" fn Y_SetLapBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_LAP\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    (*bstruct)
        .points = if 0 as libc::c_int
        > (*player).totalmarebonuslap as libc::c_int * 1000 as libc::c_int
    {
        0 as libc::c_int
    } else {
        (*player).totalmarebonuslap as libc::c_int * 1000 as libc::c_int
...
unsafe extern "C" fn Y_SetLinkBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_LINK\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    (*bstruct)
        .points = if 0 as libc::c_int
        > ((*player).maxlink - 1 as libc::c_int) * 100 as libc::c_int
    {
        0 as libc::c_int
    } else {
        ((*player).maxlink - 1 as libc::c_int) * 100 as libc::c_int
...
unsafe extern "C" fn Y_SetGuardBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    let mut bonus: int32_t = 0;
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_GUARD\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    (*bstruct).display = true_0 as libc::c_int as uint8_t;
    if stagefailed == true_0 as libc::c_int {
        bonus = 0 as libc::c_int;
    } else if (*player).timeshit as libc::c_int == 0 as libc::c_int {
        bonus = 10000 as libc::c_int;
    } else if (*player).timeshit as libc::c_int == 1 as libc::c_int {
        bonus = 5000 as libc::c_int;
    } else if (*player).timeshit as libc::c_int == 2 as libc::c_int {
        bonus = 1000 as libc::c_int;
    } else if (*player).timeshit as libc::c_int == 3 as libc::c_int {
        bonus = 500 as libc::c_int;
    } else if (*player).timeshit as libc::c_int == 4 as libc::c_int {
        bonus = 100 as libc::c_int;
    } else {
        bonus = 0 as libc::c_int;
    }
...
unsafe extern "C" fn Y_SetPerfectBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    let mut i: int32_t = 0;
    ...
    strncpy(
        ((*bstruct).patch).as_mut_ptr(),
        b"YB_PERFE\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    if intertype as libc::c_uint != int_coop as libc::c_int as libc::c_uint
        || data.coop.gotperfbonus as libc::c_int == -(1 as libc::c_int)
    {
        let mut sharedringtotal: int32_t = 0 as libc::c_int;
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if !(playeringame[i as usize] == 0) {
                sharedringtotal += players[i as usize].rings as libc::c_int;
            }
            i += 1;
            i;
        }
        if sharedringtotal == 0 || nummaprings == -(1 as libc::c_int)
            || sharedringtotal < nummaprings
        {
            (*bstruct).display = false_0 as libc::c_int as uint8_t;
        } else {
            (*bstruct).display = true_0 as libc::c_int as uint8_t;
            (*bstruct).points = 50000 as libc::c_int;
        }
    }
    if intertype as libc::c_uint != int_coop as libc::c_int as libc::c_uint {
        return;
    ...
    data
        .coop
        .gotperfbonus = (if (*bstruct).display as libc::c_int != 0 {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    }) as int8_t;
}
unsafe extern "C" fn Y_SetSpecialRingBonus(
    mut player: *mut player_t,
    mut bstruct: *mut y_bonus_t,
) {
    let mut i: int32_t = 0;
    ...
    (*bstruct)
        .points = if 0 as libc::c_int > sharedringtotal * 100 as libc::c_int {
        0 as libc::c_int
    } else {
        sharedringtotal * 100 as libc::c_int
    };
}
#[no_mangle]
pub static mut bonuses_list: [[bonus_f; 4]; 6] = unsafe {
    [
        [
            Some(
                Y_SetNullBonus
                    as unsafe extern "C" fn(*mut player_t, *mut y_bonus_t) -> (),
            ),
            Some(
                Y_SetNullBonus
                    as unsafe extern "C" fn(*mut player_t, *mut y_bonus_t) -> (),
...
unsafe extern "C" fn Y_AwardCoopBonuses() {
    let mut i: int32_t = 0;
    let mut j: int32_t = 0;
    let mut bonusnum: int32_t = 0;
    let mut oldscore: int32_t = 0;
    let mut ptlives: int32_t = 0;
    let mut localbonuses: [y_bonus_t; 4] = [y_bonus_t {
        patch: [0; 9],
        points: 0,
        display: 0,
    }; 4];
    data.coop.total = players[consoleplayer as usize].recordscore;
    data.coop.score = players[consoleplayer as usize].score;
    data.coop.gotperfbonus = -(1 as libc::c_int) as int8_t;
    memset(
        (data.coop.bonuses).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[y_bonus_t; 4]>() as libc::c_ulong,
    );
    memset(
        (data.coop.bonuspatches).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[*mut patch_t; 4]>() as libc::c_ulong,
    );
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playeringame[i as usize] == 0
        ...
        {
            bonusnum = 0 as libc::c_int;
        } else {
            bonusnum = (*mapheaderinfo[prevmap as usize]).bonustype as libc::c_int
                + 1 as libc::c_int;
        }
        oldscore = players[i as usize].score as int32_t;
        j = 0 as libc::c_int;
        while j < 4 as libc::c_int {
            (bonuses_list[bonusnum as usize][j as usize])
                .expect(
                    "non-null function pointer",
                )(
                &mut *players.as_mut_ptr().offset(i as isize),
                &mut *localbonuses.as_mut_ptr().offset(j as isize),
            );
            players[i as usize]
                .score = (players[i as usize].score)
                .wrapping_add(localbonuses[j as usize].points as uint32_t);
            if players[i as usize].score > 99999990 as libc::c_int as uint32_t {
                players[i as usize].score = 99999990 as libc::c_int as uint32_t;
            }
            players[i as usize]
                .recordscore = (players[i as usize].recordscore)
                .wrapping_add(localbonuses[j as usize].points as uint32_t);
            if players[i as usize].recordscore > 99999990 as libc::c_int as uint32_t {
                players[i as usize].recordscore = 99999990 as libc::c_int as uint32_t;
            }
            j += 1;
            j;
        }
        ptlives = if (if ultimatemode == 0 && modeattacking == 0
            && players[i as usize].lives as libc::c_int != 0x7f as libc::c_int
        {
            (if (players[i as usize].score / 50000 as libc::c_int as uint32_t)
                .wrapping_sub((oldscore / 50000 as libc::c_int) as uint32_t) as int32_t
                > 0 as libc::c_int
            {
                (players[i as usize].score / 50000 as libc::c_int as uint32_t)
                    .wrapping_sub((oldscore / 50000 as libc::c_int) as uint32_t)
                    as int32_t
            } else {
                0 as libc::c_int
            })
            ...
            < (if ((*mapheaderinfo[prevmap as usize]).maxbonuslives as libc::c_int)
                < 0 as libc::c_int
            {
                2147483647 as libc::c_int
            } else {
                (*mapheaderinfo[prevmap as usize]).maxbonuslives as libc::c_int
            })
        {
        ...
        } else if ((*mapheaderinfo[prevmap as usize]).maxbonuslives as libc::c_int)
            < 0 as libc::c_int
        {
            2147483647 as libc::c_int
        } else {
        ...
        if ptlives != 0 {
            P_GivePlayerLives(&mut *players.as_mut_ptr().offset(i as isize), ptlives);
        }
        if i == consoleplayer {
            data
                .coop
                .gotlife = (if (netgame != 0 || multiplayer != 0)
            ...
            M_Memcpy
                ...
                &mut data.coop.bonuses as *mut [y_bonus_t; 4] as *mut libc::c_void,
                &mut localbonuses as *mut [y_bonus_t; 4] as *const libc::c_void,
                ::core::mem::size_of::<[y_bonus_t; 4]>() as libc::c_ulong,
            );
        }
        i += 1;
    ...
    if (data.coop.gotperfbonus as libc::c_int) < 0 as libc::c_int {
        data.coop.gotperfbonus = 0 as libc::c_int as int8_t;
    }
}
unsafe extern "C" fn Y_AwardSpecialStageBonus() {
    let mut i: int32_t = 0;
    let mut oldscore: int32_t = 0;
    let mut ptlives: int32_t = 0;
    let mut localbonuses: [y_bonus_t; 2] = [y_bonus_t {
        patch: [0; 9],
        points: 0,
        display: 0,
    }; 2];
    data.spec.score = players[consoleplayer as usize].score;
    memset(
        (data.spec.bonuses).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[y_bonus_t; 2]>() as libc::c_ulong,
    );
    memset(
        (data.spec.bonuspatches).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[*mut patch_t; 2]>() as libc::c_ulong,
    );
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        oldscore = players[i as usize].score as int32_t;
            ...
            || players[i as usize].bot as libc::c_int == BOT_2PHUMAN as libc::c_int
        {
            Y_SetNullBonus(
                &mut *players.as_mut_ptr().offset(i as isize),
                &mut *localbonuses.as_mut_ptr().offset(0 as libc::c_int as isize),
            );
            Y_SetNullBonus(
                &mut *players.as_mut_ptr().offset(i as isize),
                &mut *localbonuses.as_mut_ptr().offset(1 as libc::c_int as isize),
            );
        ...
        players[i as usize]
            .score = (players[i as usize].score)
            .wrapping_add(localbonuses[0 as libc::c_int as usize].points as uint32_t);
        players[i as usize]
            .score = (players[i as usize].score)
            .wrapping_add(localbonuses[1 as libc::c_int as usize].points as uint32_t);
        if players[i as usize].score > 99999990 as libc::c_int as uint32_t {
            players[i as usize].score = 99999990 as libc::c_int as uint32_t;
        }
        players[i as usize]
        ...
        if i == consoleplayer {
            ...
            M_Memcpy
                ...
                &mut data.spec.bonuses as *mut [y_bonus_t; 2] as *mut libc::c_void,
                &mut localbonuses as *mut [y_bonus_t; 2] as *const libc::c_void,
                ::core::mem::size_of::<[y_bonus_t; 2]>() as libc::c_ulong,
            );
            data
                .spec
                .continues = (if (players[i as usize].continues as libc::c_int)
                < 8 as libc::c_int
            {
                players[i as usize].continues as libc::c_int
            } else {
                8 as libc::c_int
            }) as uint8_t;
            if players[i as usize].gotcontinue != 0 {
                data
                    .spec
                    .continues = (data.spec.continues as libc::c_int
                    | 0x80 as libc::c_int) as uint8_t;
            }
            data
                .spec
                .playercolor = &mut (*players.as_mut_ptr().offset(i as isize)).skincolor;
            data.spec.playerchar = &mut (*players.as_mut_ptr().offset(i as isize)).skin;
        }
        i += 1;
        i;
    }
...
#[no_mangle]
pub unsafe extern "C" fn Y_EndIntermission() {
    if dedicated == 0 {
        Y_UnloadData();
    }
    endtic = -(1 as libc::c_int);
    intertype = int_none;
    usebuffer = false_0 as libc::c_int;
}
unsafe extern "C" fn Y_UnloadData() {
    if !bgpatch.is_null() {
        Patch_Free(bgpatch);
    }
    bgpatch = 0 as *mut patch_t;
    if !bgtile.is_null() {
        Patch_Free(bgtile);
    }
    bgtile = 0 as *mut patch_t;
    if !interpic.is_null() {
        Patch_Free(interpic);
    }
    interpic = 0 as *mut patch_t;
    match intertype as libc::c_uint {
        1 => {
            if !(data.coop.bonuspatches[3 as libc::c_int as usize]).is_null() {
                Patch_Free(data.coop.bonuspatches[3 as libc::c_int as usize]);
            }
            data.coop.bonuspatches[3 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.coop.bonuspatches[2 as libc::c_int as usize]).is_null() {
                Patch_Free(data.coop.bonuspatches[2 as libc::c_int as usize]);
            }
            data.coop.bonuspatches[2 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.coop.bonuspatches[1 as libc::c_int as usize]).is_null() {
                Patch_Free(data.coop.bonuspatches[1 as libc::c_int as usize]);
            }
            data.coop.bonuspatches[1 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.coop.bonuspatches[0 as libc::c_int as usize]).is_null() {
                Patch_Free(data.coop.bonuspatches[0 as libc::c_int as usize]);
            }
            data.coop.bonuspatches[0 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.coop.ptotal).is_null() {
                Patch_Free(data.coop.ptotal);
            }
            data.coop.ptotal = 0 as *mut patch_t;
        }
        5 => {
            if !(data.spec.bonuspatches[1 as libc::c_int as usize]).is_null() {
                Patch_Free(data.spec.bonuspatches[1 as libc::c_int as usize]);
            }
            data.spec.bonuspatches[1 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.spec.bonuspatches[0 as libc::c_int as usize]).is_null() {
                Patch_Free(data.spec.bonuspatches[0 as libc::c_int as usize]);
            }
            data.spec.bonuspatches[0 as libc::c_int as usize] = 0 as *mut patch_t;
            if !(data.spec.pscore).is_null() {
                Patch_Free(data.spec.pscore);
            }
            data.spec.pscore = 0 as *mut patch_t;
            if !(data.spec.pcontinues).is_null() {
                Patch_Free(data.spec.pcontinues);
            }
            data.spec.pcontinues = 0 as *mut patch_t;
        }
        2 | 6 => {
            if !(data.match_0.result).is_null() {
                Patch_Free(data.match_0.result);
            }
            data.match_0.result = 0 as *mut patch_t;
        }
        4 => {
            if !(data.match_0.blueflag).is_null() {
                Patch_Free(data.match_0.blueflag);
            }
            data.match_0.blueflag = 0 as *mut patch_t;
            if !(data.match_0.redflag).is_null() {
                Patch_Free(data.match_0.redflag);
            }
            data.match_0.redflag = 0 as *mut patch_t;
        }
        _ => {}
    };
}
