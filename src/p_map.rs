...
extern "C" {
    ...
    static mut cv_touchtag: consvar_t;
    ...
    fn P_InstaThrustEvenIn2D(mo: *mut mobj_t, angle: angle_t, move_0: fixed_t);
    ...
    fn P_BBoxInsidePolyobj(po: *mut polyobj_t, bbox: *mut fixed_t) -> boolean;
    ...
    fn P_CameraLineOpening(plinedef: *mut line_t);
    ...
    static mut highceiling: fixed_t;
    static mut openbottomslope: *mut pslope_t;
    static mut openfloorrover: *mut ffloor_t;
    static mut openbottom: fixed_t;
    static mut opentopslope: *mut pslope_t;
    static mut openceilingrover: *mut ffloor_t;
    static mut opentop: fixed_t;
    fn P_LineOpening(plinedef: *mut line_t, mobj: *mut mobj_t);
    ...
    fn P_SetPitchRollFromSlope(mo: *mut mobj_t, slope: *mut pslope_t);
    fn P_BlockThingsIterator(
        x: int32_t,
        y: int32_t,
        func: Option::<unsafe extern "C" fn(*mut mobj_t) -> boolean>,
    ) -> boolean;
    fn P_TouchSpecialThing(
        special: *mut mobj_t,
        toucher: *mut mobj_t,
        heightcheck: boolean,
    );
    ...
    fn P_ProcessSpecialSector(
        player: *mut player_t,
        sector: *mut sector_t,
        roversector: *mut sector_t,
    );
    fn P_RunNightsLapExecutors(actor: *mut mobj_t);
    fn P_PlayerTouchingSectorSpecialFlag(
        player: *mut player_t,
        flag: sectorspecialflags_t,
    ) -> *mut sector_t;
    fn T_StartCrumble(crumble: *mut crumble_t);
    fn P_ReloadRings();
    static mut lines: *mut line_t;
    static mut ps_checkposition_calls: ps_metric_t;
    ...
    fn LUA_Hook2Mobj(_: *mut mobj_t, _: *mut mobj_t, hook: libc::c_int) -> libc::c_int;
    fn LUA_HookMobjLineCollide(_: *mut mobj_t, _: *mut line_t) -> libc::c_int;
    fn LUA_HookSeenPlayer(
        player: *mut player_t,
        seenfriend: *mut player_t,
    ) -> libc::c_int;
}
...
pub const MF2_SPLAT: C2RustUnnamed_1 = 1073741824;
pub const MF2_SHIELD: C2RustUnnamed_1 = 536870912;
pub const MF2_LINKDRAW: C2RustUnnamed_1 = 268435456;
pub const MF2_AMBUSH: C2RustUnnamed_1 = 134217728;
pub const MF2_BOSSDEAD: C2RustUnnamed_1 = 67108864;
pub const MF2_BOSSFLEE: C2RustUnnamed_1 = 33554432;
pub const MF2_BOSSNOTRAP: C2RustUnnamed_1 = 16777216;
pub const MF2_FRET: C2RustUnnamed_1 = 8388608;
pub const MF2_SKULLFLY: C2RustUnnamed_1 = 4194304;
pub const MF2_OBJECTFLIP: C2RustUnnamed_1 = 2097152;
pub const MF2_STRONGBOX: C2RustUnnamed_1 = 1048576;
pub const MF2_SHADOW: C2RustUnnamed_1 = 524288;
pub const MF2_SUPERFIRE: C2RustUnnamed_1 = 262144;
pub const MF2_FIRING: C2RustUnnamed_1 = 131072;
pub const MF2_JUSTATTACKED: C2RustUnnamed_1 = 65536;
pub const MF2_NIGHTSPULL: C2RustUnnamed_1 = 32768;
pub const MF2_DEBRIS: C2RustUnnamed_1 = 16384;
pub const MF2_INFLOAT: C2RustUnnamed_1 = 8192;
pub const MF2_INVERTAIMABLE: C2RustUnnamed_1 = 4096;
pub const MF2_CLASSICPUSH: C2RustUnnamed_1 = 2048;
pub const MF2_SLIDEPUSH: C2RustUnnamed_1 = 1024;
pub const MF2_BEYONDTHEGRAVE: C2RustUnnamed_1 = 512;
pub const MF2_SCATTER: C2RustUnnamed_1 = 256;
pub const MF2_EXPLOSION: C2RustUnnamed_1 = 128;
pub const MF2_BOUNCERING: C2RustUnnamed_1 = 64;
pub const MF2_RAILRING: C2RustUnnamed_1 = 32;
pub const MF2_AUTOMATIC: C2RustUnnamed_1 = 16;
pub const MF2_DONTDRAW: C2RustUnnamed_1 = 8;
pub const MF2_DONTRESPAWN: C2RustUnnamed_1 = 4;
pub const MF2_TWOD: C2RustUnnamed_1 = 2;
pub const MF2_AXIS: C2RustUnnamed_1 = 1;
...
pub const BT_CUSTOM3: C2RustUnnamed_3 = 32768;
pub const BT_CUSTOM2: C2RustUnnamed_3 = 16384;
pub const BT_CUSTOM1: C2RustUnnamed_3 = 8192;
pub const BT_FIRENORMAL: C2RustUnnamed_3 = 4096;
pub const BT_JUMP: C2RustUnnamed_3 = 2048;
pub const BT_TOSSFLAG: C2RustUnnamed_3 = 1024;
pub const BT_CAMRIGHT: C2RustUnnamed_3 = 512;
pub const BT_CAMLEFT: C2RustUnnamed_3 = 256;
pub const BT_SPIN: C2RustUnnamed_3 = 128;
pub const BT_ATTACK: C2RustUnnamed_3 = 64;
pub const BT_WEAPONPREV: C2RustUnnamed_3 = 32;
pub const BT_WEAPONNEXT: C2RustUnnamed_3 = 16;
pub const BT_WEAPONMASK: C2RustUnnamed_3 = 15;
pub type C2RustUnnamed_4 = libc::c_uint;
pub const SF_NOSHIELDABILITY: C2RustUnnamed_4 = 524288;
pub const SF_CANBUSTWALLS: C2RustUnnamed_4 = 262144;
pub const SF_NOSUPERJUMPBOOST: C2RustUnnamed_4 = 131072;
pub const SF_NOSUPERSPRITES: C2RustUnnamed_4 = 65536;
pub const SF_NONIGHTSSUPER: C2RustUnnamed_4 = 32768;
pub const SF_NONIGHTSROTATION: C2RustUnnamed_4 = 16384;
pub const SF_MULTIABILITY: C2RustUnnamed_4 = 8192;
pub const SF_FASTEDGE: C2RustUnnamed_4 = 4096;
pub const SF_DASHMODE: C2RustUnnamed_4 = 2048;
pub const SF_MACHINE: C2RustUnnamed_4 = 1024;
pub const SF_MARIODAMAGE: C2RustUnnamed_4 = 768;
pub const SF_STOMPDAMAGE: C2RustUnnamed_4 = 512;
pub const SF_NOJUMPDAMAGE: C2RustUnnamed_4 = 256;
pub const SF_NOJUMPSPIN: C2RustUnnamed_4 = 128;
pub const SF_RUNONWATER: C2RustUnnamed_4 = 64;
pub const SF_NOSPEEDADJUST: C2RustUnnamed_4 = 32;
pub const SF_NOSKID: C2RustUnnamed_4 = 16;
pub const SF_HIRES: C2RustUnnamed_4 = 8;
pub const SF_NOSPINDASHDUST: C2RustUnnamed_4 = 4;
pub const SF_NOSUPERSPIN: C2RustUnnamed_4 = 2;
pub const SF_SUPER: C2RustUnnamed_4 = 1;
pub type C2RustUnnamed_5 = libc::c_uint;
pub const CA_TWINSPIN: C2RustUnnamed_5 = 15;
pub const CA_BOUNCE: C2RustUnnamed_5 = 14;
pub const CA_JUMPTHOK: C2RustUnnamed_5 = 13;
pub const CA_AIRDRILL: C2RustUnnamed_5 = 12;
pub const CA_JUMPBOOST: C2RustUnnamed_5 = 11;
pub const CA_FALLSWITCH: C2RustUnnamed_5 = 10;
pub const CA_TELEKINESIS: C2RustUnnamed_5 = 9;
pub const CA_SLOWFALL: C2RustUnnamed_5 = 8;
pub const CA_FLOAT: C2RustUnnamed_5 = 7;
pub const CA_DOUBLEJUMP: C2RustUnnamed_5 = 6;
pub const CA_SWIM: C2RustUnnamed_5 = 5;
pub const CA_HOMINGTHOK: C2RustUnnamed_5 = 4;
pub const CA_GLIDEANDCLIMB: C2RustUnnamed_5 = 3;
pub const CA_FLY: C2RustUnnamed_5 = 2;
pub const CA_THOK: C2RustUnnamed_5 = 1;
pub const CA_NONE: C2RustUnnamed_5 = 0;
pub type C2RustUnnamed_6 = libc::c_uint;
pub const CA2_MELEE: C2RustUnnamed_6 = 3;
pub const CA2_GUNSLINGER: C2RustUnnamed_6 = 2;
pub const CA2_SPINDASH: C2RustUnnamed_6 = 1;
pub const CA2_NONE: C2RustUnnamed_6 = 0;
pub type C2RustUnnamed_7 = libc::c_int;
pub const SH_NOSTACK: C2RustUnnamed_7 = -513;
pub const SH_STACK: C2RustUnnamed_7 = 512;
pub const SH_FIREFLOWER: C2RustUnnamed_7 = 512;
pub const SH_FORCEHP: C2RustUnnamed_7 = 255;
pub const SH_FORCE: C2RustUnnamed_7 = 256;
pub const SH_THUNDERCOIN: C2RustUnnamed_7 = 4098;
pub const SH_BUBBLEWRAP: C2RustUnnamed_7 = 2049;
pub const SH_FLAMEAURA: C2RustUnnamed_7 = 1025;
pub const SH_ELEMENTAL: C2RustUnnamed_7 = 3073;
pub const SH_ATTRACT: C2RustUnnamed_7 = 4097;
pub const SH_PINK: C2RustUnnamed_7 = 4;
pub const SH_ARMAGEDDON: C2RustUnnamed_7 = 3;
pub const SH_WHIRLWIND: C2RustUnnamed_7 = 2;
pub const SH_PITY: C2RustUnnamed_7 = 1;
pub const SH_PROTECTSPIKE: C2RustUnnamed_7 = 8192;
pub const SH_PROTECTELECTRIC: C2RustUnnamed_7 = 4096;
pub const SH_PROTECTWATER: C2RustUnnamed_7 = 2048;
pub const SH_PROTECTFIRE: C2RustUnnamed_7 = 1024;
pub const SH_NONE: C2RustUnnamed_7 = 0;
...
pub const STR_METAL: C2RustUnnamed_9 = 4224;
pub const STR_BOUNCE: C2RustUnnamed_9 = 521;
pub const STR_MELEE: C2RustUnnamed_9 = 6979;
pub const STR_TWINSPIN: C2RustUnnamed_9 = 7967;
pub const STR_GLIDE: C2RustUnnamed_9 = 3;
pub const STR_FLY: C2RustUnnamed_9 = 17;
pub const STR_BUST: C2RustUnnamed_9 = 1792;
pub const STR_ATTACK: C2RustUnnamed_9 = 30;
pub const STR_SPIKE: C2RustUnnamed_9 = 4096;
pub const STR_SPRING: C2RustUnnamed_9 = 2048;
pub const STR_CEILING: C2RustUnnamed_9 = 1024;
pub const STR_FLOOR: C2RustUnnamed_9 = 512;
pub const STR_WALL: C2RustUnnamed_9 = 256;
pub const STR_DASH: C2RustUnnamed_9 = 128;
pub const STR_HEAVY: C2RustUnnamed_9 = 64;
pub const STR_GUARD: C2RustUnnamed_9 = 32;
pub const STR_UPPER: C2RustUnnamed_9 = 16;
pub const STR_STOMP: C2RustUnnamed_9 = 8;
pub const STR_TAIL: C2RustUnnamed_9 = 4;
pub const STR_PUNCH: C2RustUnnamed_9 = 2;
pub const STR_ANIM: C2RustUnnamed_9 = 1;
pub const STR_NONE: C2RustUnnamed_9 = 0;
pub type C2RustUnnamed_10 = libc::c_uint;
pub const NUMPOWERS: C2RustUnnamed_10 = 30;
pub const pw_strong: C2RustUnnamed_10 = 29;
pub const pw_ignorelatch: C2RustUnnamed_10 = 28;
pub const pw_justlaunched: C2RustUnnamed_10 = 27;
pub const pw_dye: C2RustUnnamed_10 = 26;
pub const pw_nocontrol: C2RustUnnamed_10 = 25;
pub const pw_nights_linkfreeze: C2RustUnnamed_10 = 24;
pub const pw_nights_helper: C2RustUnnamed_10 = 23;
pub const pw_nights_superloop: C2RustUnnamed_10 = 22;
pub const pw_emeralds: C2RustUnnamed_10 = 21;
pub const pw_railring: C2RustUnnamed_10 = 20;
pub const pw_explosionring: C2RustUnnamed_10 = 19;
pub const pw_grenadering: C2RustUnnamed_10 = 18;
pub const pw_scatterring: C2RustUnnamed_10 = 17;
pub const pw_bouncering: C2RustUnnamed_10 = 16;
pub const pw_automaticring: C2RustUnnamed_10 = 15;
pub const pw_infinityring: C2RustUnnamed_10 = 14;
pub const pw_gravityboots: C2RustUnnamed_10 = 13;
pub const pw_super: C2RustUnnamed_10 = 12;
pub const pw_noautobrake: C2RustUnnamed_10 = 11;
pub const pw_justsprung: C2RustUnnamed_10 = 10;
pub const pw_pushing: C2RustUnnamed_10 = 9;
pub const pw_extralife: C2RustUnnamed_10 = 8;
pub const pw_spacetime: C2RustUnnamed_10 = 7;
pub const pw_underwater: C2RustUnnamed_10 = 6;
pub const pw_tailsfly: C2RustUnnamed_10 = 5;
pub const pw_carry: C2RustUnnamed_10 = 4;
pub const pw_shield: C2RustUnnamed_10 = 3;
pub const pw_flashing: C2RustUnnamed_10 = 2;
pub const pw_sneakers: C2RustUnnamed_10 = 1;
pub const pw_invulnerability: C2RustUnnamed_10 = 0;
...
pub const CS_SIMPLE: C2RustUnnamed_13 = 3;
pub const CS_STANDARD: C2RustUnnamed_13 = 2;
pub const CS_LMAOGALOG: C2RustUnnamed_13 = 1;
pub const CS_LEGACY: C2RustUnnamed_13 = 0;
pub type C2RustUnnamed_14 = libc::c_uint;
pub const BOXRIGHT: C2RustUnnamed_14 = 3;
pub const BOXLEFT: C2RustUnnamed_14 = 2;
pub const BOXBOTTOM: C2RustUnnamed_14 = 1;
pub const BOXTOP: C2RustUnnamed_14 = 0;
pub type C2RustUnnamed_15 = libc::c_uint;
pub const POF_SPLAT: C2RustUnnamed_15 = 8192;
pub const POF_NOSPECIALS: C2RustUnnamed_15 = 4096;
pub const POF_ONESIDE: C2RustUnnamed_15 = 2048;
pub const POF_LDEXEC: C2RustUnnamed_15 = 1024;
pub const POF_PUSHABLESTOP: C2RustUnnamed_15 = 512;
pub const POF_INVERTPLANESONLY: C2RustUnnamed_15 = 256;
pub const POF_INVERTPLANES: C2RustUnnamed_15 = 128;
pub const POF_INVERT: C2RustUnnamed_15 = 64;
pub const POF_RENDERALL: C2RustUnnamed_15 = 56;
pub const POF_RENDERPLANES: C2RustUnnamed_15 = 48;
pub const POF_RENDERBOTTOM: C2RustUnnamed_15 = 32;
pub const POF_RENDERTOP: C2RustUnnamed_15 = 16;
pub const POF_RENDERSIDES: C2RustUnnamed_15 = 8;
pub const POF_TESTHEIGHT: C2RustUnnamed_15 = 4;
pub const POF_SOLID: C2RustUnnamed_15 = 3;
pub const POF_CLIPPLANES: C2RustUnnamed_15 = 2;
pub const POF_CLIPLINES: C2RustUnnamed_15 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const SD_SPECIALSTAGE: C2RustUnnamed_16 = 10;
pub const SD_INSTAKILL: C2RustUnnamed_16 = 9;
pub const SD_DEATHPITNOTILT: C2RustUnnamed_16 = 8;
pub const SD_DEATHPITTILT: C2RustUnnamed_16 = 7;
pub const SD_SPIKE: C2RustUnnamed_16 = 6;
pub const SD_ELECTRIC: C2RustUnnamed_16 = 5;
pub const SD_LAVA: C2RustUnnamed_16 = 4;
pub const SD_FIRE: C2RustUnnamed_16 = 3;
pub const SD_WATER: C2RustUnnamed_16 = 2;
pub const SD_GENERIC: C2RustUnnamed_16 = 1;
pub const SD_NONE: C2RustUnnamed_16 = 0;
...
pub const PU_LEVEL: C2RustUnnamed_20 = 50;
pub const mobjhook_MobjCollide: C2RustUnnamed_21 = 1;
pub const mobjhook_MobjMoveCollide: C2RustUnnamed_21 = 3;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const NUM_THINKERLISTS: C2RustUnnamed_19 = 5;
pub const THINK_PRECIP: C2RustUnnamed_19 = 4;
pub const THINK_DYNSLOPE: C2RustUnnamed_19 = 3;
pub const THINK_MOBJ: C2RustUnnamed_19 = 2;
pub const THINK_MAIN: C2RustUnnamed_19 = 1;
pub const THINK_POLYOBJ: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct camera_s {
    pub chase: boolean,
...
pub const PU_HWRMODELTEXTURE_UNLOCKED: C2RustUnnamed_20 = 103;
pub const PU_HWRCACHE_UNLOCKED: C2RustUnnamed_20 = 102;
pub const PU_CACHE_UNLOCKED: C2RustUnnamed_20 = 101;
pub const PU_PURGELEVEL: C2RustUnnamed_20 = 100;
pub const PU_HWRPLANE: C2RustUnnamed_20 = 52;
pub const PU_LEVSPEC: C2RustUnnamed_20 = 51;
pub const PU_CACHE: C2RustUnnamed_20 = 49;
pub const PU_HWRCACHE: C2RustUnnamed_20 = 48;
pub const PU_HWRMODELTEXTURE: C2RustUnnamed_20 = 23;
pub const PU_HWRPATCHCOLMIPMAP: C2RustUnnamed_20 = 22;
pub const PU_HWRPATCHINFO: C2RustUnnamed_20 = 21;
pub const PU_HUDGFX: C2RustUnnamed_20 = 19;
pub const PU_SPRITE: C2RustUnnamed_20 = 18;
pub const PU_PATCH_DATA: C2RustUnnamed_20 = 17;
pub const PU_PATCH_ROTATED: C2RustUnnamed_20 = 16;
pub const PU_PATCH_LOWPRIORITY: C2RustUnnamed_20 = 15;
pub const PU_PATCH: C2RustUnnamed_20 = 14;
pub const PU_MUSIC: C2RustUnnamed_20 = 12;
pub const PU_SOUND: C2RustUnnamed_20 = 11;
pub const PU_PERFSTATS: C2RustUnnamed_20 = 3;
pub const PU_LUA: C2RustUnnamed_20 = 2;
pub const PU_STATIC: C2RustUnnamed_20 = 1;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const mobjhook_MAX: C2RustUnnamed_21 = 18;
pub const mobjhook_HurtMsg: C2RustUnnamed_21 = 17;
pub const mobjhook_FollowMobj: C2RustUnnamed_21 = 16;
pub const mobjhook_MapThingSpawn: C2RustUnnamed_21 = 15;
pub const mobjhook_MobjMoveBlocked: C2RustUnnamed_21 = 14;
pub const mobjhook_BotRespawn: C2RustUnnamed_21 = 13;
pub const mobjhook_MobjRemoved: C2RustUnnamed_21 = 12;
pub const mobjhook_BossDeath: C2RustUnnamed_21 = 11;
pub const mobjhook_MobjDeath: C2RustUnnamed_21 = 10;
pub const mobjhook_MobjDamage: C2RustUnnamed_21 = 9;
pub const mobjhook_ShouldDamage: C2RustUnnamed_21 = 8;
pub const mobjhook_BossThinker: C2RustUnnamed_21 = 7;
pub const mobjhook_MobjThinker: C2RustUnnamed_21 = 6;
pub const mobjhook_MobjFuse: C2RustUnnamed_21 = 5;
pub const mobjhook_TouchSpecial: C2RustUnnamed_21 = 4;
pub const mobjhook_MobjLineCollide: C2RustUnnamed_21 = 2;
pub const mobjhook_MobjSpawn: C2RustUnnamed_21 = 0;
#[inline(always)]
...
#[no_mangle]
pub static mut tmthing: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
static mut tmflags: int32_t = 0;
#[no_mangle]
pub static mut tmx: fixed_t = 0;
#[no_mangle]
pub static mut tmy: fixed_t = 0;
static mut tmprecipthing: *mut precipmobj_t = 0 as *const precipmobj_t
    as *mut precipmobj_t;
static mut preciptmbbox: [fixed_t; 4] = [0; 4];
#[no_mangle]
...
static mut tmdrpoffceilz: fixed_t = 0;
#[no_mangle]
pub static mut tmfloorthing: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
#[no_mangle]
pub static mut tmhitthing: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
#[no_mangle]
pub static mut tmfloorrover: *mut ffloor_t = 0 as *const ffloor_t as *mut ffloor_t;
#[no_mangle]
pub static mut tmceilingrover: *mut ffloor_t = 0 as *const ffloor_t as *mut ffloor_t;
#[no_mangle]
pub static mut tmfloorslope: *mut pslope_t = 0 as *const pslope_t as *mut pslope_t;
#[no_mangle]
pub static mut tmceilingslope: *mut pslope_t = 0 as *const pslope_t as *mut pslope_t;
#[no_mangle]
pub static mut ceilingline: *mut line_t = 0 as *const line_t as *mut line_t;
#[no_mangle]
pub static mut blockingline: *mut line_t = 0 as *const line_t as *mut line_t;
#[no_mangle]
pub static mut sector_list: *mut msecnode_t = 0 as *const msecnode_t as *mut msecnode_t;
#[no_mangle]
pub static mut precipsector_list: *mut mprecipsecnode_t = 0 as *const mprecipsecnode_t
    as *mut mprecipsecnode_t;
#[no_mangle]
pub static mut mapcampointer: *mut camera_t = 0 as *const camera_t as *mut camera_t;
unsafe extern "C" fn P_TeleportMove(
...
#[no_mangle]
pub unsafe extern "C" fn P_SetOrigin(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
) -> boolean {
    let mut result: boolean = P_TeleportMove(thing, x, y, z);
    if result == true_0 as libc::c_int {
        (*thing).old_x = (*thing).x;
        (*thing).old_y = (*thing).y;
        (*thing).old_z = (*thing).z;
    }
...
#[no_mangle]
pub unsafe extern "C" fn P_MoveOrigin(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
...
#[no_mangle]
pub unsafe extern "C" fn P_DoSpring(
    mut spring: *mut mobj_t,
    mut object: *mut mobj_t,
) -> boolean {
    let mut vertispeed: fixed_t = (*(*spring).info).mass;
    let mut horizspeed: fixed_t = (*(*spring).info).damage;
    let mut final_0: boolean = false_0 as libc::c_int;
    let mut strong: uint8_t = 0 as libc::c_int as uint8_t;
    if (*object).eflags as libc::c_int & MFE_SPRUNG as libc::c_int != 0 {
        return false_0 as libc::c_int;
    }
    if !((*object).player).is_null() && (*(*object).player).spectator != 0 {
        return false_0 as libc::c_int;
    }
    if (*spring).health == 0 || (*object).health == 0 {
        return false_0 as libc::c_int;
    }
    if !((*object).player).is_null() {
        if !((*(*spring).info).painchance == 3 as libc::c_int) {
            if (*(*object).player).powers[pw_strong as libc::c_int as usize]
                as libc::c_int & STR_SPRING as libc::c_int != 0
            {
                strong = 1 as libc::c_int as uint8_t;
            }
        }
    }
    if (*(*spring).info).painchance == -(1 as libc::c_int) {
        let mut horizangle: angle_t = 0;
        let mut vertiangle: angle_t = 0;
        if vertispeed == 0 {
            return false_0 as libc::c_int;
        }
        if !((*object).player).is_null()
            && (*(*object).player).homing as libc::c_int != 0
        {
            horizangle = 0 as libc::c_int as angle_t;
            vertiangle = (if (*object).eflags as libc::c_int
            ...
            (*(*object).player)
                ...
                pflags_t,
            >(
                (*(*object).player).pflags as libc::c_uint
                    & !(PF_THOKKED as libc::c_int) as libc::c_uint,
            );
            if (*spring).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
                (*object).z = (*spring).z - (*object).height - 1 as libc::c_int;
            } else {
                (*object).z = (*spring).z + (*spring).height + 1 as libc::c_int;
            }
        } else {
            horizangle = R_PointToAngle2(
                (*spring).x,
                (*spring).y,
                (*object).x,
                (*object).y,
            ...
            vertiangle = R_PointToAngle2(
                0 as libc::c_int,
                (*spring).z + (*spring).height / 2 as libc::c_int,
                FixedHypot((*object).x - (*spring).x, (*object).y - (*spring).y),
                (*object).z + (*object).height / 2 as libc::c_int,
            ) >> 19 as libc::c_int & (8192 as libc::c_int - 1 as libc::c_int) as angle_t;
        }
        if !((*spring).spawnpoint).is_null()
            && (*(*spring).spawnpoint).angle as libc::c_int > 0 as libc::c_int
        {
            vertispeed = (((*(*spring).spawnpoint).angle as libc::c_int)
                << 16 as libc::c_int - 1 as libc::c_int) / 5 as libc::c_int;
        }
        vertispeed = FixedMul(vertispeed, FixedMul((*object).scale, (*spring).scale));
        if !((*object).player).is_null() {
            let mut playervelocity: fixed_t = 0;
            if strong != 0 {
                vertispeed <<= 1 as libc::c_int;
            }
            if (*(*object).player).pflags as libc::c_uint
                & PF_THOKKED as libc::c_int as libc::c_uint == 0
                && (*(*object).player).homing == 0
                && {
                    playervelocity = FixedDiv(
                        9 as libc::c_int
                            * FixedHypot((*(*object).player).speed, (*object).momz),
                        (10 as libc::c_int) << 16 as libc::c_int,
                    );
                    playervelocity > vertispeed
                }
            {
                vertispeed = playervelocity;
            }
            if (*(*object).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int == CR_NIGHTSMODE as libc::c_int
            {
                let mut nightsangle: angle_t = 0 as libc::c_int as angle_t;
                if (*(*object).player).bumpertime
                ...
                if (*(*object).player).pflags as libc::c_uint
                    ...
                    && !((*(*object).player).axis1).is_null()
                    && !((*(*object).player).axis2).is_null()
                {
                    nightsangle = R_PointToAngle2(
                        (*(*(*object).player).axis1).x,
                        (*(*(*object).player).axis1).y,
                        (*(*(*object).player).axis2).x,
                        (*(*(*object).player).axis2).y,
                    );
                    nightsangle = nightsangle
                        .wrapping_add(0x40000000 as libc::c_int as angle_t);
                } else if !((*object).target).is_null() {
                    if (*(*object).target).flags2 & MF2_AMBUSH as libc::c_int as uint32_t
                        != 0
                    {
                        nightsangle = R_PointToAngle2(
                            (*(*object).target).x,
                ...
                (*(*object).player)
                    ...
                    R_PointToAngle2(
                        ...
                        (*spring).z + (*spring).height / 2 as libc::c_int,
                        FixedMul(
                            finesine[(nightsangle.wrapping_sub(horizangle)
                                >> 19 as libc::c_int
                ...
                (*(*object).player)
                    .bumpertime = (35 as libc::c_int / 2 as libc::c_int) as tic_t;
            } else {
                let mut pflags: int32_t = ((*(*object).player).pflags as libc::c_uint
                    & (PF_JUMPED as libc::c_int | PF_NOJUMPDAMAGE as libc::c_int
                        | PF_SPINNING as libc::c_int | PF_THOKKED as libc::c_int
                        | PF_BOUNCING as libc::c_int | PF_CANCARRY as libc::c_int)
                        as libc::c_uint) as int32_t;
                let mut secondjump: uint8_t = (*(*object).player).secondjump;
                let mut tailsfly: uint16_t = (*(*object).player)
                    .powers[pw_tailsfly as libc::c_int as usize];
                if (*(*object).player).pflags as libc::c_uint
                ...
                (*(*object).player)
                    ...
                    libc::c_uint,
                    pflags_t,
                >((*(*object).player).pflags as libc::c_uint | pflags as libc::c_uint);
                (*(*object).player).secondjump = secondjump;
                (*(*object).player)
                    .powers[pw_tailsfly as libc::c_int as usize] = tailsfly;
            }
        }
        if P_IsObjectOnGround(object) == 0 {
            (*object)
                .momz = FixedMul(
                vertispeed,
                finesine[vertiangle as usize] >> 16 as libc::c_int - 16 as libc::c_int,
            );
        }
        P_InstaThrust(
            object,
            ...
            FixedMul(
                vertispeed,
                *finecosine.offset(vertiangle as isize)
                    >> 16 as libc::c_int - 16 as libc::c_int,
            ),
        );
        (*object)
            .eflags = ((*object).eflags as libc::c_int | MFE_SPRUNG as libc::c_int)
            as uint16_t;
    } else {
        if vertispeed == 0 && horizspeed == 0 {
            return false_0 as libc::c_int;
        }
        (*object).standingslope = 0 as *mut pslope_s;
        if (*spring).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            vertispeed *= -(1 as libc::c_int);
        }
        if !((*object).player).is_null()
            && (*(*object).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int == CR_NIGHTSMODE as libc::c_int
        {
            return false_0 as libc::c_int;
        }
        ...
        (*object)
            ...
            as uint16_t;
        (*spring).flags
            &= !(MF_SPRING as libc::c_int | MF_SPECIAL as libc::c_int) as uint32_t;
        if (*(*spring).info).painchance != 2 as libc::c_int {
            if !((*object).player).is_null() {
                (*(*object).player)
                    .pflags = ::core::mem::transmute::<
                    libc::c_uint,
                ...
                if horizspeed != 0 {
                    (*(*object).player)
                        ...
                        as usize] = ((horizspeed * 35 as libc::c_int
                        >> 16 as libc::c_int + 3 as libc::c_int) / 9 as libc::c_int)
                        as uint16_t;
                } else if P_MobjFlip(object) as libc::c_int
                    == P_MobjFlip(spring) as libc::c_int
                {
                    (*(*object).player)
                        .powers[pw_justsprung as libc::c_int
                        as usize] = ((*(*object).player)
                        .powers[pw_justsprung as libc::c_int as usize] as libc::c_int
                        | (1 as libc::c_int) << 15 as libc::c_int) as uint16_t;
                }
            }
            if horizspeed != 0 && vertispeed != 0
                || !((*object).player).is_null()
                    && (*(*object).player).homing as libc::c_int != 0
            {
                (*object).momy = 0 as libc::c_int;
                (*object).momx = (*object).momy;
                P_TryMove(object, (*spring).x, (*spring).y, true_0 as libc::c_int);
            }
            if vertispeed > 0 as libc::c_int {
                (*object).z = (*spring).z + (*spring).height + 1 as libc::c_int;
            } else if vertispeed < 0 as libc::c_int {
                (*object).z = (*spring).z - (*object).height - 1 as libc::c_int;
            } else {
                let mut offx: fixed_t = 0;
                let mut offy: fixed_t = 0;
                (*object).momy = 0 as libc::c_int;
                (*object).momx = (*object).momy;
                offx = P_ReturnThrustX(
                    spring,
                    (*spring).angle,
                    ((*spring).radius + (*object).radius + 1 as libc::c_int)
                        * 2 as libc::c_int,
                );
                offy = P_ReturnThrustY(
                    spring,
                    (*spring).angle,
                    ((*spring).radius + (*object).radius + 1 as libc::c_int)
                        * 2 as libc::c_int,
                );
                if offx > (*spring).radius + (*object).radius + 1 as libc::c_int {
                    offx = (*spring).radius + (*object).radius + 1 as libc::c_int;
                } else if offx
                    < -((*spring).radius + (*object).radius + 1 as libc::c_int)
                {
                    offx = -((*spring).radius + (*object).radius + 1 as libc::c_int);
                }
                if offy > (*spring).radius + (*object).radius + 1 as libc::c_int {
                    offy = (*spring).radius + (*object).radius + 1 as libc::c_int;
                } else if offy
                    < -((*spring).radius + (*object).radius + 1 as libc::c_int)
                {
                    offy = -((*spring).radius + (*object).radius + 1 as libc::c_int);
                ...
                if (*(*spring).info).painchance == 3 as libc::c_int {
                    (*object).z = (*spring).z;
                    if (*spring).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
                        != 0
                    {
                        (*object).z -= (*object).height;
                    }
                    (*object).momz = 0 as libc::c_int;
                }
            }
        }
        if vertispeed != 0 {
            (*object)
                .momz = FixedMul(
                vertispeed,
                FixedSqrt(FixedMul((*object).scale, (*spring).scale)),
            );
        }
        if horizspeed != 0 {
        ...
        (*spring).flags
            |= (*(*spring).info).flags
                & (MF_SPRING as libc::c_int | MF_SPECIAL as libc::c_int) as uint32_t;
        if !((*object).player).is_null() {
            let mut pflags_0: int32_t = 0;
            let mut secondjump_0: uint8_t = 0;
            let mut washoming: boolean = 0;
            if (*spring).flags & MF_ENEMY as libc::c_int as uint32_t != 0 {
                P_SetTarget2(&mut (*spring).target, object);
            }
            if horizspeed != 0 {
                (*(*object).player).drawangle = (*spring).angle;
                (*object).angle = (*(*object).player).drawangle;
                if demoplayback == 0
                    || (if (*(*object).player).pflags as libc::c_uint
            ...
            if (*(*spring).info).painchance == 3 as libc::c_int {
                pflags_0 = ((*(*object).player).pflags as libc::c_uint
                    & PF_SPINNING as libc::c_int as libc::c_uint) as int32_t;
                if pflags_0 == 0
                    && ((*(*object).player).charability2 as libc::c_int
                        == CA2_SPINDASH as libc::c_int
                        && (*(*object).player).cmd.buttons as libc::c_int
                            & BT_SPIN as libc::c_int != 0
                        || (*spring).flags2 & MF2_AMBUSH as libc::c_int as uint32_t != 0)
                {
                    pflags_0 = PF_SPINNING as libc::c_int;
                    P_SetPlayerMobjState(object, S_PLAY_ROLL);
                    S_StartSound(object as *const libc::c_void, sfx_spin);
                } else {
                    P_SetPlayerMobjState(object, S_PLAY_ROLL);
                }
            } else {
                let mut wasSpindashing: boolean = ((*(*object).player).dashspeed
                    > 0 as libc::c_int
                    && (*(*object).player).charability2 as libc::c_int
                        == CA2_SPINDASH as libc::c_int) as libc::c_int;
                pflags_0 = ((*(*object).player).pflags as libc::c_uint
                ...
                if (*(*object).player).charability as libc::c_int
                    == CA_GLIDEANDCLIMB as libc::c_int
                    && (*(*object).player).skidtime != 0
                    && pflags_0 & PF_JUMPED as libc::c_int != 0
                {
                    (*(*object).player).skidtime = 0 as libc::c_int as tic_t;
                    pflags_0 &= !(PF_JUMPED as libc::c_int);
                }
            }
            secondjump_0 = (*(*object).player).secondjump;
            washoming = (*(*object).player).homing as boolean;
            P_ResetPlayer((*object).player);
            if (*(*spring).info).painchance == 1 as libc::c_int {
                (*(*object).player)
                    .pflags = ::core::mem::transmute::<
                ...
                >(
                    (*(*object).player).pflags as libc::c_uint
                        | P_GetJumpFlags((*object).player) as libc::c_uint,
                );
                P_SetPlayerMobjState(object, S_PLAY_JUMP);
            } else if (*(*spring).info).painchance == 2 as libc::c_int
                || (*(*spring).info).painchance != 3 as libc::c_int
                    && pflags_0 & PF_BOUNCING as libc::c_int != 0
            {
                (*(*object).player)
                    .pflags = ::core::mem::transmute::<
                    libc::c_uint,
                ...
                >(
                    (*(*object).player).pflags as libc::c_uint
                        | (pflags_0 & !(PF_STARTJUMP as libc::c_int)) as libc::c_uint,
                );
                (*(*object).player).secondjump = secondjump_0;
                if washoming != 0 {
                    (*(*object).player)
                        .pflags = ::core::mem::transmute::<
                        libc::c_uint,
                ...
                if pflags_0 & (PF_JUMPED as libc::c_int | PF_SPINNING as libc::c_int)
                    != 0
                {
                    (*(*object).player)
                        .pflags = ::core::mem::transmute::<
                    ...
                    >(
                        (*(*object).player).pflags as libc::c_uint
                            | pflags_0 as libc::c_uint,
                    );
                    (*(*object).player).secondjump = secondjump_0;
                } else if (*(*object).player).dashmode
                    >= (3 as libc::c_int * 35 as libc::c_int) as tic_t
                {
                    P_SetPlayerMobjState(object, S_PLAY_DASH);
                } else if P_IsObjectOnGround(object) != 0 {
                    P_SetPlayerMobjState(
                        object,
                        (if horizspeed
                            >= FixedMul((*(*object).player).runspeed, (*object).scale)
                        {
                            S_PLAY_RUN as libc::c_int
                        } else {
                            S_PLAY_WALK as libc::c_int
                        }) as statenum_t,
                    );
                } else {
                    P_SetPlayerMobjState(
                        object,
                        (if (*object).momz > 0 as libc::c_int {
                            S_PLAY_SPRING as libc::c_int
                        } else {
                            S_PLAY_FALL as libc::c_int
                        }) as statenum_t,
                    );
                }
            } else if P_MobjFlip(object) as libc::c_int * vertispeed > 0 as libc::c_int {
                P_SetPlayerMobjState(object, S_PLAY_SPRING);
            } else {
                P_SetPlayerMobjState(object, S_PLAY_FALL);
            }
        } else if horizspeed != 0 && !((*object).tracer).is_null()
            && !((*(*object).tracer).player).is_null()
            && (*(*(*object).tracer).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int != CR_NONE as libc::c_int
            && (*(*object).tracer).tracer == object
            && (demoplayback == 0
                || (if (*(*(*object).tracer).player).pflags as libc::c_uint
                    & PF_ANALOGMODE as libc::c_int as libc::c_uint != 0
                {
                    CS_LMAOGALOG as libc::c_int
                } else {
        ...
        (*object).standingslope = 0 as *mut pslope_s;
        final_0 = true_0 as libc::c_int;
    }
    if (((*spring).state).offset_from(states.as_mut_ptr()) as libc::c_long as statenum_t
        as libc::c_uint) < (*(*spring).info).raisestate as libc::c_uint
    {
        P_SetMobjState(spring, (*(*spring).info).raisestate);
        if !((*object).player).is_null() && (*spring).reactiontime != 0
            && (*(*spring).info).flags & MF_ENEMY as libc::c_int as uint32_t == 0
        {
            if (*(*object).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int != CR_NIGHTSMODE as libc::c_int
            {
                P_SetMobjState(
                    ...
                    (mobjinfo[MT_SCORE as libc::c_int as usize].spawnstate
                        as libc::c_uint)
                        .wrapping_add(11 as libc::c_int as libc::c_uint) as statenum_t,
                );
            }
            P_AddPlayerScore((*object).player, 10 as libc::c_int as uint32_t);
            (*spring).reactiontime -= 1;
            (*spring).reactiontime;
        }
        if strong != 0 {
            if (*(*object).player).charability as libc::c_int
                    ...
                    == CA2_MELEE as libc::c_int
            {
                P_TwinSpinRejuvenate(
                    ...
                    (if (*(*object).player).charability as libc::c_int
                        == CA_TWINSPIN as libc::c_int
                    {
                        (*(*object).player).thokitem as libc::c_uint
                    } else {
                        (*(*object).player).revitem as libc::c_uint
                    }) as mobjtype_t,
                );
            }
            S_StartSound(object as *const libc::c_void, sfx_sprong);
        }
    }
    return final_0;
}
unsafe extern "C" fn P_DoFanAndGasJet(mut spring: *mut mobj_t, mut object: *mut mobj_t) {
    let mut p: *mut player_t = (*object).player;
    let mut zdist: fixed_t = 0;
    let mut speed: fixed_t = (*(*spring).info).mass;
    let mut flipval: int8_t = P_MobjFlip(spring);
    if !p.is_null()
        && (*object).state
            == &mut *states.as_mut_ptr().offset((*(*object).info).painstate as isize)
                as *mut state_t
    {
        return;
    }
    ...
    (*object).standingslope = 0 as *mut pslope_s;
    match (*spring).type_0 as libc::c_uint {
        128 => {
            if !(zdist > (*spring).health << 16 as libc::c_int) {
                if !(flipval as libc::c_int * (*object).momz
                    >= FixedMul(speed, (*spring).scale))
                {
                    if !(!p.is_null()
                    ...
                    {
                        (*object).momz
                            += flipval as libc::c_int
                                * FixedMul(speed / 4 as libc::c_int, (*spring).scale);
                        if flipval as libc::c_int * (*object).momz
                            > FixedMul(speed, (*spring).scale)
                        {
                            (*object)
                                .momz = flipval as libc::c_int
                                * FixedMul(speed, (*spring).scale);
                        }
                        if !p.is_null()
                            && (*p).powers[pw_tailsfly as libc::c_int as usize] == 0
                            && (*p).powers[pw_carry as libc::c_int as usize] == 0
                        {
                            P_ResetPlayer(p);
                            P_SetPlayerMobjState(object, S_PLAY_FALL);
                            P_SetTarget2(&mut (*object).tracer, spring);
                            (*p)
        ...
        129 => {
            ...
            {
                if !((*spring).state
                    != &mut *states.as_mut_ptr().offset(S_STEAM1 as libc::c_int as isize)
                        as *mut state_t)
                {
                    (*object)
                        .eflags = ((*object).eflags as libc::c_int
                        | MFE_SPRUNG as libc::c_int) as uint16_t;
                    (*object)
                        .momz = flipval as libc::c_int
                        * FixedMul(
                            speed,
                            FixedSqrt(FixedMul((*spring).scale, (*object).scale)),
                        );
                    if !p.is_null() {
                        P_ResetPlayer(p);
                        if (*p).panim as libc::c_uint
                            != PA_FALL as libc::c_int as libc::c_uint
                        {
                            P_SetPlayerMobjState(object, S_PLAY_FALL);
                        }
                    }
...
unsafe extern "C" fn P_DoPterabyteCarry(
    mut player: *mut player_t,
    mut ptera: *mut mobj_t,
) {
    ...
    if (*ptera).extravalue1 != 1 as libc::c_int {
        return;
    }
    ...
    if (*(*player).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
        != (*ptera).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
    {
        return;
    }
    if (*ptera).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        if (*ptera).ceilingz - ((*ptera).z + (*ptera).height)
            < (*(*player).mo).height
                - FixedMul(
    ...
    P_SetTarget2(&mut (*(*player).mo).tracer, ptera);
    (*player)
        .pflags = ::core::mem::transmute::<
        libc::c_uint,
        pflags_t,
    ...
    (*player)
        .powers[pw_carry as libc::c_int
        as usize] = CR_PTERABYTE as libc::c_int as uint16_t;
    S_StartSound((*player).mo as *const libc::c_void, sfx_s3k4a);
    P_UnsetThingPosition((*player).mo);
    (*(*player).mo).x = (*ptera).x;
    (*(*player).mo).y = (*ptera).y;
    P_SetThingPosition((*player).mo);
    (*ptera).movefactor = 3 as libc::c_int * 35 as libc::c_int;
    (*ptera).cusval = 0 as libc::c_int;
    (*ptera).waterbottom = (*ptera).cusval;
    (*ptera).watertop = (*ptera).waterbottom;
}
unsafe extern "C" fn P_DoTailsCarry(mut sonic: *mut player_t, mut tails: *mut player_t) {
    let mut p: int32_t = 0;
    let mut zdist: fixed_t = 0;
    if (*tails).powers[pw_carry as libc::c_int as usize] != 0 {
        return;
    }
    if (*sonic).powers[pw_carry as libc::c_int as usize] != 0 {
        return;
    }
    if (*tails).spectator != 0 {
        return;
    }
    if (*sonic).spectator != 0 {
        return;
    }
    if (*tails).pflags as libc::c_uint & PF_CANCARRY as libc::c_int as libc::c_uint == 0
    {
        return;
    }
    if (*(*sonic).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
        != (*(*tails).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
    {
        return;
    }
    if (*(*tails).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        if (*(*tails).mo).ceilingz - ((*(*tails).mo).z + (*(*tails).mo).height)
            < (*(*sonic).mo).height
                - FixedMul(
                    2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                    (*(*sonic).mo).scale,
    ...
    } else if (*(*tails).mo).z - (*(*tails).mo).floorz
        < (*(*sonic).mo).height
            - FixedMul(
                2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                (*(*sonic).mo).scale,
    ...
    p = 0 as libc::c_int;
    while p < 32 as libc::c_int {
        if playeringame[p as usize] != 0 && !(players[p as usize].mo).is_null()
            && players[p as usize].powers[pw_carry as libc::c_int as usize]
                as libc::c_int == CR_PLAYER as libc::c_int
            && (*players[p as usize].mo).tracer == (*tails).mo
        {
            return;
        }
        p += 1;
    ...
    if (*(*tails).mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        zdist = (*(*sonic).mo).z + (*(*sonic).mo).height
            - ((*(*tails).mo).z + (*(*tails).mo).height);
    } else {
        zdist = (*(*tails).mo).z - (*(*sonic).mo).z;
    }
    if zdist <= (*(*sonic).mo).height + (*(*sonic).mo).scale
        && zdist > (*(*sonic).mo).height * 2 as libc::c_int / 3 as libc::c_int
        && P_MobjFlip((*tails).mo) as libc::c_int * (*(*sonic).mo).momz
            <= 0 as libc::c_int
        && (*sonic).powers[pw_ignorelatch as libc::c_int as usize] as libc::c_int
            & (1 as libc::c_int) << 15 as libc::c_int == 0
    {
        if sonic.offset_from(players.as_mut_ptr()) as libc::c_long
        ...
        P_ResetPlayer(sonic);
        P_SetTarget2(&mut (*(*sonic).mo).tracer, (*tails).mo);
        (*sonic)
            .powers[pw_carry as libc::c_int
            as usize] = CR_PLAYER as libc::c_int as uint16_t;
        S_StartSound((*sonic).mo as *const libc::c_void, sfx_s3k4a);
        ...
        P_SetTarget2(&mut (*(*sonic).mo).tracer, 0 as *mut mobj_t);
        (*sonic)
            .powers[pw_carry as libc::c_int
            as usize] = CR_NONE as libc::c_int as uint16_t;
    };
}
unsafe extern "C" fn P_SlapStick(mut fang: *mut mobj_t, mut pole: *mut mobj_t) {
    let mut momx1: fixed_t = 0;
    let mut momx2: fixed_t = 0;
    let mut momy1: fixed_t = 0;
    let mut momy2: fixed_t = 0;
    momx1 = (*pole).momx / 3 as libc::c_int;
    momy1 = (*pole).momy / 3 as libc::c_int;
    momx2 = (*fang).momx / 3 as libc::c_int;
    momy2 = (*fang).momy / 3 as libc::c_int;
    (*(*(*pole).tracer).tracer)
        .momx = momx1 + (3 as libc::c_int - 1 as libc::c_int) * momx2;
    (*(*(*pole).tracer).tracer)
        .momy = momy1 + (3 as libc::c_int - 1 as libc::c_int) * momy2;
    (*fang).momx = (3 as libc::c_int - 1 as libc::c_int) * momx1 + momx2;
    (*fang).momy = (3 as libc::c_int - 1 as libc::c_int) * momy1 + momy2;
    P_SetObjectMomZ(
        (*(*pole).tracer).tracer,
        6 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
        false_0 as libc::c_int,
    );
    (*(*(*pole).tracer).tracer).flags
        &= !(MF_NOGRAVITY as libc::c_int | MF_NOCLIP as libc::c_int) as uint32_t;
    (*(*(*pole).tracer).tracer).movedir = 0x30000000 as libc::c_int as angle_t;
    if (R_PointToAngle(
        (*fang).x - (*(*(*pole).tracer).tracer).x,
        (*fang).y - (*(*(*pole).tracer).tracer).y,
    ))
        .wrapping_sub((*pole).angle) > 0x80000000 as libc::c_uint
    {
    ...
    (*pole).tics = (*fang).tics;
    (*(*pole).tracer).tics = (*pole).tics;
    (*(*(*pole).tracer).tracer).tics = (*(*pole).tracer).tics;
    var2 = 0 as libc::c_int;
    var1 = var2;
    A_Scream((*(*pole).tracer).tracer);
    S_StartSound(fang as *const libc::c_void, sfx_altdi1);
    P_SetTarget2(&mut (*(*pole).tracer).tracer, 0 as *mut mobj_t);
    P_SetMobjState((*pole).tracer, (*(*pole).info).xdeathstate);
    P_SetTarget2(&mut (*pole).tracer, 0 as *mut mobj_t);
    P_SetMobjState(pole, (*(*pole).info).deathstate);
}
unsafe extern "C" fn P_PlayerBarrelCollide(
    mut toucher: *mut mobj_t,
    mut barrel: *mut mobj_t,
) {
    if (*toucher).momz < 0 as libc::c_int {
        if (*toucher).z + (*toucher).momz > (*barrel).z + (*barrel).height {
            return;
        }
    } else if (*toucher).z > (*barrel).z + (*barrel).height {
        return
    }
    if (*toucher).momz > 0 as libc::c_int {
    ...
    } else if (*toucher).z + (*toucher).height < (*barrel).z {
        return
    }
    if P_PlayerCanDamage((*toucher).player, barrel) != 0 {
        P_DamageMobj(
            barrel,
            toucher,
            toucher,
...
unsafe extern "C" fn PIT_CheckThing(mut thing: *mut mobj_t) -> boolean {
    let mut blockdist: fixed_t = 0;
    if thing == tmthing {
        return true_0 as libc::c_int;
    }
    if tmthing.is_null() || thing.is_null() || P_MobjWasRemoved(thing) != 0 {
        return true_0 as libc::c_int;
    }
    if !((*tmthing).player).is_null() && (*(*tmthing).player).spectator != 0
        || !((*thing).player).is_null() && (*(*thing).player).spectator != 0
    {
        return true_0 as libc::c_int;
    }
    if (*tmthing).type_0 as libc::c_uint == MT_NAMECHECK as libc::c_int as libc::c_uint {
        if ((*thing).player).is_null()
            || !(!((*tmthing).target).is_null()
                && !((*(*tmthing).target).player).is_null())
            || (*(*thing).player).spectator != 0
            || !((*tmthing).target).is_null()
                && (*thing).player == (*(*tmthing).target).player
        {
            return true_0 as libc::c_int;
        }
        ...
        if LUA_HookSeenPlayer((*(*tmthing).target).player, (*thing).player) == 0 {
            return false_0 as libc::c_int;
        }
        seenplayer = (*thing).player;
        return false_0 as libc::c_int;
    }
    if (*tmthing).type_0 as libc::c_uint
        == MT_METALSONIC_RACE as libc::c_int as libc::c_uint
        && ((*thing).flags
            & (MF_MISSILE as libc::c_int | MF_ENEMY as libc::c_int
                | MF_BOSS as libc::c_int) as uint32_t != 0
            || ((*thing).type_0 as libc::c_uint
                == MT_SPIKE as libc::c_int as libc::c_uint
                || (*thing).type_0 as libc::c_uint
                    == MT_WALLSPIKE as libc::c_int as libc::c_uint))
    {
        if (*thing).flags
            & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t != 0
            && ((*thing).health <= 0 as libc::c_int
                || (*thing).flags & MF_SHOOTABLE as libc::c_int as uint32_t == 0)
        {
            return true_0 as libc::c_int;
        }
        blockdist = (*thing).radius + (*tmthing).radius;
        ...
        if (*thing).type_0 as libc::c_uint == MT_SPIKE as libc::c_int as libc::c_uint
            || (*thing).type_0 as libc::c_uint
                == MT_WALLSPIKE as libc::c_int as libc::c_uint
        {
            let mut iter: *mut mobj_t = 0 as *mut mobj_t;
            if (*thing).flags & MF_SOLID as libc::c_int as uint32_t != 0 {
                S_StartSound(
                    tmthing as *const libc::c_void,
                    (*(*thing).info).deathsound,
                );
            }
            iter = (*(*(*thing).subsector).sector).thinglist;
            while !iter.is_null() {
                if (*iter).type_0 as libc::c_uint == (*thing).type_0 as libc::c_uint
                    && (*iter).health > 0 as libc::c_int
                    && (*iter).flags & MF_SOLID as libc::c_int as uint32_t != 0
                    && (iter == thing
                        || P_AproxDistance(
                            P_AproxDistance(
                                (*thing).x - (*iter).x,
                            ...
                            (*thing).z - (*iter).z,
                        ) < 56 as libc::c_int * (*thing).scale)
                {
                    P_KillMobj(iter, tmthing, tmthing, 0 as libc::c_int as uint8_t);
                }
                iter = (*iter).snext;
            }
        } else {
            (*thing).health = 0 as libc::c_int;
            P_KillMobj(thing, tmthing, tmthing, 0 as libc::c_int as uint8_t);
        }
        return true_0 as libc::c_int;
    }
    if !((*tmthing).player).is_null()
        && ((*(*tmthing).player).powers[pw_strong as libc::c_int as usize] as libc::c_int
            & STR_SPIKE as libc::c_int != 0
            && ((*thing).type_0 as libc::c_uint
                == MT_SPIKE as libc::c_int as libc::c_uint
                || (*thing).type_0 as libc::c_uint
                    == MT_WALLSPIKE as libc::c_int as libc::c_uint))
    {
        let mut iter_0: *mut mobj_t = 0 as *mut mobj_t;
        blockdist = (*thing).radius + (*tmthing).radius;
        if abs((*thing).x - tmx) >= blockdist || abs((*thing).y - tmy) >= blockdist {
            return true_0 as libc::c_int;
        }
        ...
        if (*thing).flags & MF_SOLID as libc::c_int as uint32_t != 0 {
            S_StartSound(tmthing as *const libc::c_void, (*(*thing).info).deathsound);
        }
        iter_0 = (*(*(*thing).subsector).sector).thinglist;
        while !iter_0.is_null() {
            if (*iter_0).type_0 as libc::c_uint == (*thing).type_0 as libc::c_uint
                && (*iter_0).health > 0 as libc::c_int
                && (*iter_0).flags & MF_SOLID as libc::c_int as uint32_t != 0
                && (iter_0 == thing
                    || P_AproxDistance(
                        P_AproxDistance(
                            (*thing).x - (*iter_0).x,
            ...
            {
                P_KillMobj(iter_0, tmthing, tmthing, 0 as libc::c_int as uint8_t);
            }
            iter_0 = (*iter_0).snext;
        }
        return true_0 as libc::c_int;
    ...
    if (*thing).type_0 as libc::c_uint
        ...
        && (*tmthing).flags & MF_MISSILE as libc::c_int as uint32_t != 0
                ...
                as *mut state_t
    {
        ...
        (*thing).flags2 |= MF2_CLASSICPUSH as libc::c_int as uint32_t;
        return true_0 as libc::c_int;
    }
    if (*thing).flags & MF_NOCLIPTHING as libc::c_int as uint32_t != 0
        || (*thing).flags
            & (MF_SOLID as libc::c_int | MF_SPECIAL as libc::c_int
                | MF_PAIN as libc::c_int | MF_SHOOTABLE as libc::c_int
                | MF_SPRING as libc::c_int) as uint32_t == 0
    {
        return true_0 as libc::c_int;
    }
    if !((*tmthing).player).is_null() && !((*thing).player).is_null()
        && maptol & TOL_NIGHTS as libc::c_int as uint32_t != 0
        && ((*(*tmthing).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
    ...
    if (*thing).flags & MF_PAPERCOLLISION as libc::c_int as uint32_t != 0 {
        let mut cosradius: fixed_t = 0;
        let mut sinradius: fixed_t = 0;
        ...
        cosradius = FixedMul(
            (*thing).radius,
            *finecosine.offset(((*thing).angle >> 19 as libc::c_int) as isize)
                >> 16 as libc::c_int - 16 as libc::c_int,
        );
        sinradius = FixedMul(
            (*thing).radius,
            finesine[((*thing).angle >> 19 as libc::c_int) as usize]
                >> 16 as libc::c_int - 16 as libc::c_int,
        );
        ...
        junk.v1 = &mut v1;
        junk.v2 = &mut v2;
        junk.dx = 2 as libc::c_int * cosradius;
        junk.dy = 2 as libc::c_int * sinradius;
        if (*tmthing).flags & MF_PAPERCOLLISION as libc::c_int as uint32_t != 0 {
            let mut check1: int32_t = 0;
            let mut check2: int32_t = 0;
            let mut check3: int32_t = 0;
            let mut check4: int32_t = 0;
            let mut tmcosradius: fixed_t = FixedMul(
                (*tmthing).radius,
                *finecosine.offset(((*tmthing).angle >> 19 as libc::c_int) as isize)
                    >> 16 as libc::c_int - 16 as libc::c_int,
            );
            let mut tmsinradius: fixed_t = FixedMul(
                (*tmthing).radius,
                finesine[((*tmthing).angle >> 19 as libc::c_int) as usize]
                    >> 16 as libc::c_int - 16 as libc::c_int,
            );
            if abs((*thing).x - tmx) >= abs(tmcosradius) + abs(cosradius)
                || abs((*thing).y - tmy) >= abs(tmsinradius) + abs(sinradius)
            {
                return true_0 as libc::c_int;
            }
            check1 = P_PointOnLineSide(tmx - tmcosradius, tmy - tmsinradius, &mut junk);
            check2 = P_PointOnLineSide(tmx + tmcosradius, tmy + tmsinradius, &mut junk);
            check3 = P_PointOnLineSide(
                tmx + (*tmthing).momx - tmcosradius,
                tmy + (*tmthing).momy - tmsinradius,
                &mut junk,
            );
            check4 = P_PointOnLineSide(
                tmx + (*tmthing).momx + tmcosradius,
                tmy + (*tmthing).momy + tmsinradius,
                &mut junk,
            );
            ...
            if abs((*thing).x - tmx) >= (*tmthing).radius + abs(cosradius)
                || abs((*thing).y - tmy) >= (*tmthing).radius + abs(sinradius)
            {
                return true_0 as libc::c_int;
            }
    ...
    } else if (*tmthing).flags & MF_PAPERCOLLISION as libc::c_int as uint32_t != 0 {
        let mut tmcosradius_0: fixed_t = 0;
        let mut tmsinradius_0: fixed_t = 0;
        let mut v1_0: vertex_t = vertex_t {
            x: 0,
            y: 0,
            floorzset: 0,
            ceilingzset: 0,
        ...
        let mut v2_0: vertex_t = vertex_t {
            x: 0,
            y: 0,
            floorzset: 0,
            ceilingzset: 0,
        ...
        tmcosradius_0 = FixedMul(
            (*tmthing).radius,
            *finecosine.offset(((*tmthing).angle >> 19 as libc::c_int) as isize)
                >> 16 as libc::c_int - 16 as libc::c_int,
        );
        tmsinradius_0 = FixedMul(
            (*tmthing).radius,
            finesine[((*tmthing).angle >> 19 as libc::c_int) as usize]
                >> 16 as libc::c_int - 16 as libc::c_int,
        );
        if abs((*thing).x - tmx) >= (*thing).radius + abs(tmcosradius_0)
            || abs((*thing).y - tmy) >= (*thing).radius + abs(tmsinradius_0)
        {
            return true_0 as libc::c_int;
        }
        v1_0.x = tmx - tmcosradius_0;
        v1_0.y = tmy - tmsinradius_0;
        v2_0.x = tmx + tmcosradius_0;
        v2_0.y = tmy + tmsinradius_0;
        junk_0.v1 = &mut v1_0;
        junk_0.v2 = &mut v2_0;
        junk_0.dx = 2 as libc::c_int * tmcosradius_0;
        junk_0.dy = 2 as libc::c_int * tmsinradius_0;
        if P_PointOnLineSide(
    ...
    let mut shouldCollide: uint8_t = LUA_Hook2Mobj(
        thing,
        tmthing,
        mobjhook_MobjCollide as libc::c_int,
    ) as uint8_t;
    if P_MobjWasRemoved(tmthing) != 0 || P_MobjWasRemoved(thing) != 0 {
        return true_0 as libc::c_int;
    }
    ...
    shouldCollide = LUA_Hook2Mobj(
        tmthing,
        thing,
        mobjhook_MobjMoveCollide as libc::c_int,
    ) as uint8_t;
    if P_MobjWasRemoved(tmthing) != 0 || P_MobjWasRemoved(thing) != 0 {
        return true_0 as libc::c_int;
    }
    ...
    if (*tmthing).type_0 as libc::c_uint
        == MT_LAVAFALL_LAVA as libc::c_int as libc::c_uint
        && ((*thing).type_0 as libc::c_uint == MT_RING as libc::c_int as libc::c_uint
            || (*thing).type_0 as libc::c_uint
    ...
    {
        if (*tmthing).z > (*thing).z + (*thing).height
            || (*thing).z > (*tmthing).z + (*tmthing).height || (*thing).health == 0
        {
            return true_0 as libc::c_int;
        }
        P_KillMobj(thing, tmthing, tmthing, 2 as libc::c_int as uint8_t);
    }
    if (*tmthing).type_0 as libc::c_uint == MT_MINECART as libc::c_int as libc::c_uint {
        if (*tmthing).z > (*thing).z + (*thing).height
            || (*thing).z > (*tmthing).z + (*tmthing).height || (*thing).health == 0
        {
            return true_0 as libc::c_int;
        }
        if (*thing).type_0 as libc::c_uint == MT_TNTBARREL as libc::c_int as libc::c_uint
        {
            P_KillMobj(thing, tmthing, (*tmthing).target, 0 as libc::c_int as uint8_t);
        } else if (*thing).flags & MF_MONITOR as libc::c_int as uint32_t != 0
            || (*thing).flags & MF_ENEMY as libc::c_int as uint32_t != 0
        {
            P_KillMobj(thing, tmthing, (*tmthing).target, 0 as libc::c_int as uint8_t);
            if ((*tmthing).momz * P_MobjFlip(tmthing) as libc::c_int) < 0 as libc::c_int
            {
                (*tmthing)
                    .momz = abs((*tmthing).momz) * P_MobjFlip(tmthing) as libc::c_int;
            }
        }
    }
    if (*thing).type_0 as libc::c_uint == MT_SALOONDOOR as libc::c_int as libc::c_uint
        && !((*tmthing).player).is_null()
    {
        let mut ref_0: *mut mobj_t = if (*(*tmthing).player)
            .powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_MINECART as libc::c_int && !((*tmthing).tracer).is_null()
            && P_MobjWasRemoved((*tmthing).tracer) == 0
        {
            (*tmthing).tracer
        } else {
            tmthing
        };
        if (*thing).flags2 & MF2_AMBUSH as libc::c_int as uint32_t != 0
            && (*tmthing).z <= (*thing).z + (*thing).height
            && (*tmthing).z + (*tmthing).height >= (*thing).z || ref_0 != tmthing
        {
            let mut dm: fixed_t = if FixedHypot((*ref_0).momx, (*ref_0).momy)
                < 16 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            {
                FixedHypot((*ref_0).momx, (*ref_0).momy)
            } else {
                16 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            };
            ...
            let mut s: fixed_t = finesine[(ang >> 19 as libc::c_int
                & (8192 as libc::c_int - 1 as libc::c_int) as angle_t) as usize]
                >> 16 as libc::c_int - 16 as libc::c_int;
            S_StartSound(tmthing as *const libc::c_void, (*(*thing).info).activesound);
            (*thing).extravalue2
                += 2 as libc::c_int * FixedMul(s, dm) / 3 as libc::c_int;
            return true_0 as libc::c_int;
        }
    }
    if (*thing).type_0 as libc::c_uint
        == MT_SALOONDOORCENTER as libc::c_int as libc::c_uint
        && !((*tmthing).player).is_null()
    {
        if (*thing).flags2 & MF2_AMBUSH as libc::c_int as uint32_t != 0
            && (*tmthing).z <= (*thing).z + (*thing).height
            && (*tmthing).z + (*tmthing).height >= (*thing).z
            || (*(*tmthing).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int == CR_MINECART as libc::c_int
                && !((*tmthing).tracer).is_null()
                && P_MobjWasRemoved((*tmthing).tracer) == 0
        {
            return true_0 as libc::c_int;
        }
    }
    if (*thing).type_0 as libc::c_uint == MT_ROLLOUTROCK as libc::c_int as libc::c_uint
        && !((*tmthing).player).is_null() && (*tmthing).health != 0
    {
        if (*(*tmthing).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_ROLLOUT as libc::c_int
        {
            return true_0 as libc::c_int;
        }
        if (*thing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0
            && (*(*tmthing).player).powers[pw_carry as libc::c_int as usize]
                as libc::c_int == CR_NONE as libc::c_int
            && (*(*tmthing).player).powers[pw_ignorelatch as libc::c_int as usize]
                as libc::c_int & (1 as libc::c_int) << 15 as libc::c_int == 0
            && (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
                == (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
            && P_MobjFlip(tmthing) as libc::c_int * (*tmthing).momz <= 0 as libc::c_int
            && ((*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int == 0
                && abs((*thing).z + (*thing).height - (*tmthing).z)
                    < (*thing).height >> 2 as libc::c_int
                || (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
                    != 0
                    && abs((*tmthing).z + (*tmthing).height - (*thing).z)
                        < (*thing).height >> 2 as libc::c_int)
        {
            (*thing).flags &= !(MF_PUSHABLE as libc::c_int) as uint32_t;
            (*thing).flags2 &= !(MF2_DONTDRAW as libc::c_int) as uint32_t;
            P_SetTarget2(&mut (*thing).tracer, tmthing);
            P_ResetPlayer((*tmthing).player);
            P_SetPlayerMobjState(tmthing, S_PLAY_WALK);
            (*(*tmthing).player)
                .powers[pw_carry as libc::c_int
                as usize] = CR_ROLLOUT as libc::c_int as uint16_t;
            P_SetTarget2(&mut (*tmthing).tracer, thing);
            if P_IsObjectOnGround(thing) == 0 {
                (*thing).momz += (*tmthing).momz;
            }
            return true_0 as libc::c_int;
        }
    } else if (*tmthing).type_0 as libc::c_uint
        == MT_ROLLOUTROCK as libc::c_int as libc::c_uint
    {
        if (*tmthing).z > (*thing).z + (*thing).height
            || (*thing).z > (*tmthing).z + (*tmthing).height || (*thing).health == 0
        {
        ...
        if thing == (*tmthing).tracer {
            return true_0 as libc::c_int;
        }
        if (*thing).flags & MF_SPRING as libc::c_int as uint32_t != 0 {
            P_DoSpring(thing, tmthing);
            return true_0 as libc::c_int;
        } else if (*thing).flags
            & (MF_MONITOR as libc::c_int | MF_SHOOTABLE as libc::c_int) as uint32_t
            == (MF_MONITOR as libc::c_int | MF_SHOOTABLE as libc::c_int) as uint32_t
            && (*tmthing).flags & MF_PUSHABLE as libc::c_int as uint32_t == 0
        {
            P_KillMobj(thing, tmthing, (*tmthing).tracer, 0 as libc::c_int as uint8_t);
            return true_0 as libc::c_int;
        }
        if (*thing).type_0 as libc::c_uint == (*tmthing).type_0 as libc::c_uint
            && ((*tmthing).momx != 0 || (*tmthing).momy != 0 || (*thing).momx != 0
                || (*thing).momy != 0)
        {
            let mut tempmomx: fixed_t = (*thing).momx;
            let mut tempmomy: fixed_t = (*thing).momy;
            (*thing).momx = (*tmthing).momx;
            (*thing).momy = (*tmthing).momy;
            (*tmthing).momx = tempmomx;
            (*tmthing).momy = tempmomy;
            S_StartSound(thing as *const libc::c_void, (*(*thing).info).painsound);
        }
    }
    if (*thing).type_0 as libc::c_uint == MT_PTERABYTE as libc::c_int as libc::c_uint
        && !((*tmthing).player).is_null()
    {
    ...
    if (*thing).type_0 as libc::c_uint == MT_VULTURE as libc::c_int as libc::c_uint
        && (*tmthing).type_0 as libc::c_uint == MT_VULTURE as libc::c_int as libc::c_uint
    {
        let mut dx: fixed_t = (*thing).x - (*tmthing).x;
        let mut dy: fixed_t = (*thing).y - (*tmthing).y;
        let mut dz: fixed_t = (*thing).z - (*tmthing).z;
        let mut dm_0: fixed_t = FixedHypot(dz, FixedHypot(dx, dy));
        (*thing).momx += FixedDiv(dx, dm_0);
        (*thing).momy += FixedDiv(dy, dm_0);
        (*thing).momz += FixedDiv(dz, dm_0);
    }
    if (*tmthing).type_0 as libc::c_uint == MT_FANG as libc::c_int as libc::c_uint
        && (*thing).type_0 as libc::c_uint == MT_FSGNB as libc::c_int as libc::c_uint
    {
        ...
        if ((*thing).tracer).is_null() || ((*(*thing).tracer).tracer).is_null() {
            return true_0 as libc::c_int;
        }
        P_SlapStick(tmthing, thing);
    }
    if (*thing).type_0 as libc::c_uint == MT_BIGMINE as libc::c_int as libc::c_uint {
        if (*tmthing).type_0 as libc::c_uint == MT_BIGMINE as libc::c_int as libc::c_uint
        {
            if (*tmthing).momx == 0 && (*tmthing).momy == 0 {
                return true_0 as libc::c_int;
            }
            if ((*thing).state).offset_from(states.as_mut_ptr()) as libc::c_long
                as statenum_t as libc::c_uint
                >= (*(*thing).info).meleestate as libc::c_uint
            {
                return true_0 as libc::c_int;
            }
            if (*thing).z > (*tmthing).z + (*tmthing).height {
            ...
            (*thing).momx = (*tmthing).momx / 3 as libc::c_int;
            (*thing).momy = (*tmthing).momy / 3 as libc::c_int;
            (*thing).momz = (*tmthing).momz / 3 as libc::c_int;
            (*tmthing).momx /= -(8 as libc::c_int);
            (*tmthing).momy /= -(8 as libc::c_int);
            (*tmthing).momz /= -(8 as libc::c_int);
            if (*(*thing).info).activesound as u64 != 0 {
                S_StartSound(thing as *const libc::c_void, (*(*thing).info).activesound);
            }
            P_SetMobjState(thing, (*(*thing).info).meleestate);
            P_SetTarget2(&mut (*thing).tracer, (*tmthing).tracer);
            return true_0 as libc::c_int;
        } else if (*tmthing).type_0 as libc::c_uint
            == MT_CRUSHCLAW as libc::c_int as libc::c_uint
        {
            if (*tmthing).extravalue1 <= 0 as libc::c_int {
                return true_0 as libc::c_int;
            }
            if ((*thing).state).offset_from(states.as_mut_ptr()) as libc::c_long
                as statenum_t as libc::c_uint
            ...
            (*thing)
                .momx = P_ReturnThrustX(
                tmthing,
                (*tmthing).angle,
                2 as libc::c_int * (*tmthing).extravalue1 * (*tmthing).scale
                    / 3 as libc::c_int,
            );
            (*thing)
                .momy = P_ReturnThrustY(
                tmthing,
                (*tmthing).angle,
                2 as libc::c_int * (*tmthing).extravalue1 * (*tmthing).scale
                    / 3 as libc::c_int,
            ...
            P_SetMobjState(thing, (*(*thing).info).meleestate);
            if !((*tmthing).tracer).is_null() {
                P_SetTarget2(&mut (*thing).tracer, (*(*tmthing).tracer).target);
            }
            return false_0 as libc::c_int;
        }
    }
    if (*tmthing).type_0 as libc::c_uint == MT_SPIKE as libc::c_int as libc::c_uint
        && (*thing).flags & MF_SOLID as libc::c_int as uint32_t != 0
        && (*tmthing).flags & MF_SOLID as libc::c_int as uint32_t != 0
    {
        if (*thing).z > (*tmthing).z + (*tmthing).height {
            return true_0 as libc::c_int;
        }
        ...
        if (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            P_SetOrigin(
                thing,
                (*thing).x,
                (*thing).y,
                (*tmthing).z - (*thing).height
                    - FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*tmthing).scale),
            );
        } else {
            P_SetOrigin(
                thing,
        ...
        if (*thing).flags & MF_SHOOTABLE as libc::c_int as uint32_t != 0 {
            P_DamageMobj(
                thing,
                tmthing,
                tmthing,
    ...
    if (*thing).flags & MF_PAIN as libc::c_int as uint32_t != 0
        && !((*tmthing).player).is_null()
    {
        if (*thing).z > (*tmthing).z + (*tmthing).height {
            return true_0 as libc::c_int;
        ...
        if (*tmthing).flags & MF_SHOOTABLE as libc::c_int as uint32_t != 0
            && (*thing).health > 0 as libc::c_int
        {
            let mut damagetype: uint32_t = ((*(*thing).info).mass & 0xff as libc::c_int)
                as uint32_t;
            if damagetype == 0
                && (*thing).flags & MF_FIRE as libc::c_int as uint32_t != 0
            {
                damagetype = 2 as libc::c_int as uint32_t;
            }
            if P_DamageMobj(
                tmthing,
                thing,
                thing,
                1 as libc::c_int,
                damagetype as uint8_t,
            ) != 0
                && {
                    damagetype = ((*(*thing).info).mass >> 8 as libc::c_int) as uint32_t;
                    damagetype != 0
                }
            {
                S_StartSound(thing as *const libc::c_void, damagetype as sfxenum_t);
            }
        }
        return true_0 as libc::c_int;
    } else if (*tmthing).flags & MF_PAIN as libc::c_int as uint32_t != 0
        && !((*thing).player).is_null()
    {
        if (*tmthing).z > (*thing).z + (*thing).height {
            return true_0 as libc::c_int;
        }
        ...
        if (*thing).flags & MF_SHOOTABLE as libc::c_int as uint32_t != 0
            && (*tmthing).health > 0 as libc::c_int
        {
            let mut damagetype_0: uint32_t = ((*(*tmthing).info).mass
                & 0xff as libc::c_int) as uint32_t;
            if damagetype_0 == 0
                && (*tmthing).flags & MF_FIRE as libc::c_int as uint32_t != 0
            {
                damagetype_0 = 2 as libc::c_int as uint32_t;
            }
            if P_DamageMobj(
                thing,
                tmthing,
                tmthing,
                1 as libc::c_int,
                damagetype_0 as uint8_t,
            ) != 0
                && {
                    damagetype_0 = ((*(*tmthing).info).mass >> 8 as libc::c_int)
                        as uint32_t;
                    damagetype_0 != 0
                }
            {
                S_StartSound(tmthing as *const libc::c_void, damagetype_0 as sfxenum_t);
            }
        }
        return true_0 as libc::c_int;
    }
    if (*thing).type_0 as libc::c_uint == MT_HOOPCOLLIDE as libc::c_int as libc::c_uint
        && (*thing).flags & MF_SPECIAL as libc::c_int as uint32_t != 0
        && !((*tmthing).player).is_null()
    {
        P_TouchSpecialThing(thing, tmthing, true_0 as libc::c_int);
        return true_0 as libc::c_int;
    }
    if (*tmthing).flags2 & MF2_SKULLFLY as libc::c_int as uint32_t != 0 {
        if (*tmthing).type_0 as libc::c_uint
            == MT_EGGMOBILE as libc::c_int as libc::c_uint
        {
            ...
            (*tmthing).flags2 &= !(MF2_SKULLFLY as libc::c_int) as uint32_t;
            (*tmthing).momz = 0 as libc::c_int;
            (*tmthing).momy = (*tmthing).momz;
            (*tmthing).momx = (*tmthing).momy;
            return false_0 as libc::c_int;
        }
    }
    if ((*thing).type_0 as libc::c_uint == MT_SPRINGSHELL as libc::c_int as libc::c_uint
        || (*thing).type_0 as libc::c_uint
            == MT_YELLOWSHELL as libc::c_int as libc::c_uint)
        && (*thing).health > 0 as libc::c_int
        && (!((*tmthing).player).is_null()
            || (*tmthing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0)
        && (*tmthing).health > 0 as libc::c_int
    {
        let mut tmz: fixed_t = if (*thing).eflags as libc::c_int
            & MFE_VERTICALFLIP as libc::c_int != 0
        {
            -((*tmthing).z + (*tmthing).height)
        } else {
        ...
        let mut tmznext: fixed_t = (if (*thing).eflags as libc::c_int
            & MFE_VERTICALFLIP as libc::c_int != 0
        {
            -(*tmthing).momz
        } else {
        ...
        let mut thzh: fixed_t = if (*thing).eflags as libc::c_int
            & MFE_VERTICALFLIP as libc::c_int != 0
        {
            -(*thing).z
        } else {
        ...
        let mut sprarea: fixed_t = FixedMul(
            8 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
            (*thing).scale,
        ) * P_MobjFlip(thing) as libc::c_int;
        if tmznext <= thzh && tmz > thzh || tmznext > thzh - sprarea && tmznext < thzh {
            P_DoSpring(thing, tmthing);
            return true_0 as libc::c_int;
        } else if tmz > thzh - sprarea && tmz < thzh {
            return true_0 as libc::c_int
        }
    }
    if (*tmthing).flags & MF_MISSILE as libc::c_int as uint32_t != 0
        || (*tmthing).type_0 as libc::c_uint == MT_SHELL as libc::c_int as libc::c_uint
    {
        if (*tmthing).z > (*thing).z + (*thing).height {
            return true_0 as libc::c_int;
        }
        ...
        if (*tmthing).type_0 as libc::c_uint != MT_SHELL as libc::c_int as libc::c_uint
            && !((*tmthing).target).is_null()
            && (*(*tmthing).target).type_0 as libc::c_uint
                == (*thing).type_0 as libc::c_uint
        {
        ...
        if (*tmthing).type_0 as libc::c_uint
            ...
            && (*tmthing).fuse > 8 as libc::c_int * 35 as libc::c_int
            && (*thing).flags & MF_SOLID as libc::c_int as uint32_t != 0
        {
            return true_0 as libc::c_int;
        }
        if (*thing).type_0 as libc::c_uint
            == MT_BLACKEGGMAN_HELPER as libc::c_int as libc::c_uint
        {
            return true_0 as libc::c_int;
        }
        if (*tmthing).type_0 as libc::c_uint
            ...
            && (*tmthing).target != thing
        {
            if !((*thing).state
                >= &mut *states
                    .as_mut_ptr()
                    .offset(S_BLACKEGG_PAIN1 as libc::c_int as isize) as *mut state_t
                && (*thing).state
                    <= &mut *states
                        .as_mut_ptr()
                        .offset(S_BLACKEGG_PAIN35 as libc::c_int as isize)
                        as *mut state_t)
            {
        ...
        {
            return ((*thing).flags & MF_SOLID as libc::c_int as uint32_t == 0)
                as libc::c_int;
        }
        if (*tmthing).flags & MF_MISSILE as libc::c_int as uint32_t != 0
            && !((*thing).player).is_null() && !((*tmthing).target).is_null()
            && !((*(*tmthing).target).player).is_null()
            && (*(*thing).player).ctfteam == (*(*(*tmthing).target).player).ctfteam
            && (*(*thing).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
                == CR_PLAYER as libc::c_int && (*thing).tracer == (*tmthing).target
        {
            return true_0 as libc::c_int;
        }
        if (*thing).type_0 as libc::c_uint == MT_EGGSHIELD as libc::c_int as libc::c_uint
        {
            let mut angle: angle_t = (R_PointToAngle2(
                (*thing).x,
                (*thing).y,
                (*tmthing).x - (*tmthing).momx,
                (*tmthing).y - (*tmthing).momy,
            ))
                .wrapping_sub((*thing).angle)
        ...
        if (*tmthing).flags & MF_ENEMY as libc::c_int as uint32_t != 0 {
            P_DamageMobj(
                thing,
                tmthing,
                tmthing,
            ...
            && (*(*thing).player).powers[pw_flashing as libc::c_int as usize] == 0
            && (*(*thing).player).powers[pw_ignorelatch as libc::c_int as usize] == 0
            && (*thing).tracer != tmthing && (*tmthing).target != thing
        {
            (*(*thing).player)
                .powers[pw_carry as libc::c_int
            ...
            P_SetTarget2(&mut (*thing).tracer, tmthing);
            P_SetTarget2(&mut (*tmthing).target, thing);
            P_SetTarget2(&mut (*tmthing).tracer, 0 as *mut mobj_t);
            (*tmthing).momz = 0 as libc::c_int;
        ...
        {
            if (*tmthing).type_0 as libc::c_uint
                == MT_BLACKEGGMAN_GOOPFIRE as libc::c_int as libc::c_uint
            {
                ...
                && !((*thing).player).is_null())
            {
                let mut damagetype_1: uint8_t = (*(*tmthing).info).mass as uint8_t;
                if damagetype_1 == 0
                    && (*tmthing).flags & MF_FIRE as libc::c_int as uint32_t != 0
                {
                    damagetype_1 = 2 as libc::c_int as uint8_t;
                }
                P_DamageMobj(
                    thing,
                    tmthing,
    ...
    if (*thing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0
        ...
        && (*tmthing).z + (*tmthing).height > (*thing).z
        && (*tmthing).z < (*thing).z + (*thing).height
        && !(netgame != 0 && !((*tmthing).player).is_null()
            && (*(*tmthing).player).spectator != 0)
    {
        if (*thing).flags2 & MF2_SLIDEPUSH as libc::c_int as uint32_t != 0 {
            if (*tmthing).momy > 0 as libc::c_int
                && (*tmthing).momy
                    > FixedMul(
                        4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                        (*thing).scale,
            ...
            } else if (*tmthing).momy < 0 as libc::c_int
                && (*tmthing).momy
                    < FixedMul(
                        -(4 as libc::c_int) * ((1 as libc::c_int) << 16 as libc::c_int),
                        (*thing).scale,
            ...
            if (*tmthing).momx > 0 as libc::c_int
                && (*tmthing).momx
                    > FixedMul(
                        4 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                        (*thing).scale,
            ...
            } else if (*tmthing).momx < 0 as libc::c_int
                && (*tmthing).momx
                    < FixedMul(
                        -(4 as libc::c_int) * ((1 as libc::c_int) << 16 as libc::c_int),
                        (*thing).scale,
        ...
        if (*thing).type_0 as libc::c_uint != MT_GARGOYLE as libc::c_int as libc::c_uint
            || P_IsObjectOnGround(thing) != 0
        {
            S_StartSound(thing as *const libc::c_void, (*(*thing).info).activesound);
        }
        P_SetTarget2(&mut (*thing).target, tmthing);
    }
    if ((*tmthing).type_0 as libc::c_uint
        == MT_NIGHTSDRONE as libc::c_int as libc::c_uint
        || (*thing).type_0 as libc::c_uint
            == MT_NIGHTSDRONE as libc::c_int as libc::c_uint)
        && (!((*tmthing).player).is_null() || !((*thing).player).is_null())
    {
        let mut droneobj: *mut mobj_t = if (*tmthing).type_0 as libc::c_uint
            == MT_NIGHTSDRONE as libc::c_int as libc::c_uint
        {
            tmthing
        } else {
        ...
        let mut pl: *mut player_t = if droneobj == thing {
            (*tmthing).player
        } else {
            (*thing).player
        };
        if (*pl).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_NIGHTSMODE as libc::c_int
            && leveltime as int32_t > (*droneobj).extravalue2
            && !((*pl).flyangle > 90 as libc::c_int
                && (*pl).flyangle < 270 as libc::c_int) as libc::c_int
                ^ ((*droneobj).extravalue1 > 90 as libc::c_int
                    && (*droneobj).extravalue1 < 270 as libc::c_int) as libc::c_int != 0
        {
            (*pl).marelap = ((*pl).marelap).wrapping_add(1);
            (*pl).marelap;
            (*pl).totalmarelap = ((*pl).totalmarelap).wrapping_add(1);
            (*pl).totalmarelap;
            (*pl).lapbegunat = leveltime;
            (*pl).lapstartedtime = (*pl).nightstime;
            if (*pl).bonustime != 0 {
                (*pl).marebonuslap = ((*pl).marebonuslap).wrapping_add(1);
                (*pl).marebonuslap;
                (*pl).totalmarebonuslap = ((*pl).totalmarebonuslap).wrapping_add(1);
        ...
        (*droneobj).extravalue2 = leveltime as int32_t + 35 as libc::c_int;
    }
    if (*thing).flags & MF_SPECIAL as libc::c_int as uint32_t != 0
        && !((*tmthing).player).is_null()
    {
        P_TouchSpecialThing(thing, tmthing, true_0 as libc::c_int);
        return true_0 as libc::c_int;
    }
    if (*tmthing).flags & MF_SPECIAL as libc::c_int as uint32_t != 0
        && !((*thing).player).is_null()
    {
        P_TouchSpecialThing(tmthing, thing, true_0 as libc::c_int);
        return true_0 as libc::c_int;
    }
    if (*tmthing).type_0 as libc::c_uint == MT_SPIKE as libc::c_int as libc::c_uint
        && (*tmthing).flags & MF_SOLID as libc::c_int as uint32_t != 0
    ...
    {
        if (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            if (*thing).z + (*thing).height
                <= (*tmthing).z
                    + FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*tmthing).scale)
                && (*thing).z + (*thing).height + (*thing).momz
                    >= (*tmthing).z
                        + FixedMul(
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (*tmthing).scale,
                        ) + (*tmthing).momz
                && !((*(*thing).player).charability as libc::c_int
                    == CA_BOUNCE as libc::c_int
                    && (*(*thing).player).panim as libc::c_uint
            ...
            && !((*(*thing).player).charability as libc::c_int
                ...
                && (*(*thing).player).panim as libc::c_uint
                    == PA_ABILITY as libc::c_int as libc::c_uint
                && (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int == 0)
        {
            P_DamageMobj(
                thing,
                tmthing,
    ...
    } else if (*thing).type_0 as libc::c_uint == MT_SPIKE as libc::c_int as libc::c_uint
        && (*thing).flags & MF_SOLID as libc::c_int as uint32_t != 0
        && !((*tmthing).player).is_null()
    {
        if (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            if (*tmthing).z + (*tmthing).height
                <= (*thing).z
                    - FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*thing).scale)
                && (*tmthing).z + (*tmthing).height + (*tmthing).momz
                    >= (*thing).z
                        - FixedMul(
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (*thing).scale,
                        )
                && !((*(*tmthing).player).charability as libc::c_int
                    == CA_BOUNCE as libc::c_int
                    && (*(*tmthing).player).panim as libc::c_uint
                        == PA_ABILITY as libc::c_int as libc::c_uint
                    && (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int
                        != 0)
            {
    ...
    if (*tmthing).type_0 as libc::c_uint == MT_WALLSPIKE as libc::c_int as libc::c_uint
        && (*tmthing).flags & MF_SOLID as libc::c_int as uint32_t != 0
        && !((*thing).player).is_null()
    {
        let mut bottomz: fixed_t = 0;
        let mut topz: fixed_t = 0;
        bottomz = (*tmthing).z;
        ...
        if (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            ...
            topz += FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*tmthing).scale);
        }
        if (*thing).z + (*thing).height > bottomz && (*thing).z < topz {
            P_DamageMobj(
                thing,
                tmthing,
                tmthing,
        ...
        && !((*tmthing).player).is_null()
    {
        let mut bottomz_0: fixed_t = 0;
        let mut topz_0: fixed_t = 0;
        let mut touchangle: angle_t = R_PointToAngle2(
            (*(*thing).tracer).x,
            (*(*thing).tracer).y,
            (*tmthing).x,
            (*tmthing).y,
        );
        if P_PlayerInPain((*tmthing).player) != 0
            && ((*tmthing).momx != 0 || (*tmthing).momy != 0)
        {
            let mut playerangle: angle_t = (R_PointToAngle2(
                0 as libc::c_int,
                0 as libc::c_int,
                (*tmthing).momx,
                (*tmthing).momy,
            ))
                .wrapping_sub(touchangle);
            if playerangle > 0x80000000 as libc::c_uint {
                playerangle = InvAngle(playerangle);
            }
            if playerangle < 0x40000000 as libc::c_int as angle_t {
                return true_0 as libc::c_int;
            }
        }
        bottomz_0 = (*thing).z;
        topz_0 = (*thing).z + (*thing).height;
        if (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            bottomz_0
                -= FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*thing).scale);
        } else {
            topz_0 += FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*thing).scale);
        }
        if (*tmthing).z + (*tmthing).height > bottomz_0 && (*tmthing).z < topz_0
            && P_MobjWasRemoved((*thing).tracer) == 0
        {
            touchangle = ((*thing).angle).wrapping_sub(touchangle);
            if touchangle > 0x80000000 as libc::c_uint {
                touchangle = InvAngle(touchangle);
            }
            if touchangle <= 0x10000000 as libc::c_int as angle_t {
                P_DamageMobj(
                    tmthing,
                    thing,
                    thing,
    ...
    if (*thing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0 {
        if (*tmthing).type_0 as libc::c_uint == MT_FAN as libc::c_int as libc::c_uint
            || (*tmthing).type_0 as libc::c_uint
                == MT_STEAM as libc::c_int as libc::c_uint
        {
            P_DoFanAndGasJet(tmthing, thing);
        }
    }
    if (*tmthing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0 {
        if (*thing).type_0 as libc::c_uint == MT_FAN as libc::c_int as libc::c_uint
            || (*thing).type_0 as libc::c_uint == MT_STEAM as libc::c_int as libc::c_uint
        {
            P_DoFanAndGasJet(thing, tmthing);
            return true_0 as libc::c_int;
        } else if (*thing).flags & MF_SPRING as libc::c_int as uint32_t != 0 {
            if (*thing).z <= (*tmthing).z + (*tmthing).height
                && (*tmthing).z <= (*thing).z + (*thing).height
            {
                if P_DoSpring(thing, tmthing) != 0 {
                    return false_0 as libc::c_int;
                }
            }
            return true_0 as libc::c_int;
    ...
    if (*thing).flags & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t
        != 0
        && (*tmthing).flags
            & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t != 0
    {
            ...
            || (*thing).z > (*tmthing).z + (*tmthing).height)
    {
        ...
        {
            if ((*(*tmthing).player).powers[pw_invulnerability as libc::c_int as usize]
                as libc::c_int != 0
                || (*(*tmthing).player).powers[pw_super as libc::c_int as usize]
                    as libc::c_int != 0
                || (*(*tmthing).player).powers[pw_shield as libc::c_int as usize]
                    as libc::c_int & SH_NOSTACK as libc::c_int
                    == SH_ELEMENTAL as libc::c_int
                    && (*(*tmthing).player).pflags as libc::c_uint
                        & PF_SHIELDABILITY as libc::c_int as libc::c_uint != 0)
                && (*(*thing).player).powers[pw_super as libc::c_int as usize] == 0
            {
                P_DamageMobj(
                    thing,
                    tmthing,
                ...
                || (*(*thing).player).powers[pw_super as libc::c_int as usize]
                    as libc::c_int != 0
                || (*(*thing).player).powers[pw_shield as libc::c_int as usize]
                    as libc::c_int & SH_NOSTACK as libc::c_int
                    == SH_ELEMENTAL as libc::c_int
                    && (*(*thing).player).pflags as libc::c_uint
                        & PF_SHIELDABILITY as libc::c_int as libc::c_uint != 0)
                && (*(*tmthing).player).powers[pw_super as libc::c_int as usize] == 0
            {
                P_DamageMobj(
                    tmthing,
                    thing,
        ...
        if G_TagGametype() != 0 && cv_touchtag.value != 0
            && (*(*thing).player).pflags as libc::c_uint
                & PF_TAGIT as libc::c_int as libc::c_uint
                != (*(*tmthing).player).pflags as libc::c_uint
                    & PF_TAGIT as libc::c_int as libc::c_uint
        {
            if (*(*tmthing).player).pflags as libc::c_uint
            ...
            } else if (*(*thing).player).pflags as libc::c_uint
                & PF_TAGIT as libc::c_int as libc::c_uint != 0
                && (*(*tmthing).player).pflags as libc::c_uint
                    & PF_TAGIT as libc::c_int as libc::c_uint == 0
            {
        ...
        && gametyperules & GTR_HIDEFROZEN as libc::c_int as uint32_t == 0
    {
    ...
    } else if !((*thing).player).is_null() {
        if ((*thing).player).offset_from(players.as_mut_ptr()) as libc::c_long
            == consoleplayer as libc::c_long && botingame != 0
        {
            CV_SetValue(
                &mut *cv_analog.as_mut_ptr().offset(1 as libc::c_int as isize),
        ...
        if (*(*thing).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
    ...
    if !((*thing).player).is_null() {
                    ...
                    >= (*thing).z + (*thing).height))
        {
            ...
            {
                if P_IsObjectOnGround(thing) != 0 && P_IsObjectOnGround(tmthing) == 0
                    && (*tmthing).flags & MF_SOLID as libc::c_int as uint32_t != 0
                {
                    if (*tmthing).flags
                        & (MF_MONITOR as libc::c_int | MF_PUSHABLE as libc::c_int)
                            as uint32_t != 0
                    {
                        if thing != (*tmthing).target {
                            P_DamageMobj(
                        ...
                        (*tmthing).momz = -(*tmthing).momz / 2 as libc::c_int;
                    }
                }
            }
        }
    ...
    if !((*tmthing).player).is_null() {
                ...
                as libc::c_int != CR_MINECART as libc::c_int
        {
            ...
            && !((*thing).type_0 as libc::c_uint
                ...
                && (*(*tmthing).player).ctfteam != 1 as libc::c_int
                || (*thing).type_0 as libc::c_uint
                    == MT_RING_BLUEBOX as libc::c_int as libc::c_uint
                    && (*(*tmthing).player).ctfteam != 2 as libc::c_int)
            && ((*thing).flags & MF_SOLID as libc::c_int as uint32_t == 0
                || P_PlayerCanDamage((*tmthing).player, thing) != 0)
        {
            if (*thing).z - (*thing).scale <= (*tmthing).z + (*tmthing).height
                && (*thing).z + (*thing).height + (*thing).scale >= (*tmthing).z
            {
                let mut player: *mut player_t = (*tmthing).player;
                let mut elementalpierce: uint8_t = (if ((*player)
                ...
                let mut flipval: int8_t = P_MobjFlip(thing);
                let mut momz: *mut fixed_t = &mut (*tmthing).momz;
                let mut z: *mut fixed_t = &mut (*tmthing).z;
                if P_DamageMobj(
                    thing,
                    tmthing,
                    tmthing,
                    1 as libc::c_int,
                    0 as libc::c_int as uint8_t,
                ) != 0 && flipval as libc::c_int * *momz < 0 as libc::c_int
                        ...
                        & STR_HEAVY as libc::c_int == 0
                {
                    ...
                    *momz = setmomz;
                    ...
                    if elementalpierce as libc::c_int == 2 as libc::c_int {
                        let mut underwater: boolean = (*tmthing).eflags as libc::c_int
                            & MFE_UNDERWATER as libc::c_int;
                        if underwater != 0 {
                            *momz /= 2 as libc::c_int;
                        }
                        *momz
                            -= *momz
                                / (if underwater != 0 {
                ...
                if !(elementalpierce as libc::c_int == 1 as libc::c_int
                    && (*thing).flags & MF_GRENADEBOUNCE as libc::c_int as uint32_t != 0)
                {
    ...
    if !(((*tmthing).flags & MF_SPRING as libc::c_int as uint32_t != 0
        || (*tmthing).type_0 as libc::c_uint == MT_STEAM as libc::c_int as libc::c_uint
        || (*tmthing).type_0 as libc::c_uint == MT_SPIKE as libc::c_int as libc::c_uint
        || (*tmthing).type_0 as libc::c_uint
            == MT_WALLSPIKE as libc::c_int as libc::c_uint)
        && !((*thing).player).is_null())
    {
        if (*thing).flags
            & (MF_SOLID as libc::c_int | MF_NOCLIP as libc::c_int) as uint32_t
            == MF_SOLID as libc::c_int as uint32_t
            && (*tmthing).flags
                & (MF_SOLID as libc::c_int | MF_NOCLIP as libc::c_int) as uint32_t
                == MF_SOLID as libc::c_int as uint32_t
        {
            let mut topz_1: fixed_t = 0;
            let mut tmtopz: fixed_t = 0;
            if (*tmthing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
                tmtopz = (*tmthing).z;
                if tmtopz > (*thing).z + (*thing).height {
                    if (*thing).z + (*thing).height > tmfloorz {
                        tmfloorz = (*thing).z + (*thing).height;
                        tmfloorrover = 0 as *mut ffloor_t;
                        tmfloorslope = 0 as *mut pslope_t;
                    }
                    return true_0 as libc::c_int;
                }
                topz_1 = (*thing).z - (*thing).scale;
                if !((*tmthing).player).is_null()
                    && (*tmthing).z + (*tmthing).height > topz_1
                    && (*tmthing).z + (*tmthing).height < (*tmthing).ceilingz
                {
                    if (*thing).flags & MF_GRENADEBOUNCE as libc::c_int as uint32_t != 0
                        && ((*thing).flags & MF_MONITOR as libc::c_int as uint32_t != 0
                            || (*(*thing).info).flags
                    ...
                    tmceilingz = topz_1;
                    tmfloorz = tmceilingz;
                    tmceilingrover = 0 as *mut ffloor_t;
                    tmceilingslope = 0 as *mut pslope_t;
                    tmfloorthing = thing;
                } else if topz_1 < tmceilingz
                    && (*tmthing).z <= (*thing).z + (*thing).height
                {
                    tmceilingz = topz_1;
                    tmceilingrover = 0 as *mut ffloor_t;
                ...
                topz_1 = (*thing).z + (*thing).height + (*thing).scale;
                if !((*tmthing).player).is_null() && (*tmthing).z < topz_1
...
unsafe extern "C" fn PIT_CheckCameraLine(mut ld: *mut line_t) -> boolean {
    if !((*ld).polyobj).is_null()
        && (*(*ld).polyobj).flags & POF_SOLID as libc::c_int == 0
    {
        return true_0 as libc::c_int;
    }
    if tmbbox[BOXRIGHT as libc::c_int as usize]
        <= (*ld).bbox[BOXLEFT as libc::c_int as usize]
        || tmbbox[BOXLEFT as libc::c_int as usize]
            >= (*ld).bbox[BOXRIGHT as libc::c_int as usize]
        || tmbbox[BOXTOP as libc::c_int as usize]
            <= (*ld).bbox[BOXBOTTOM as libc::c_int as usize]
        || tmbbox[BOXBOTTOM as libc::c_int as usize]
            >= (*ld).bbox[BOXTOP as libc::c_int as usize]
    {
        return true_0 as libc::c_int;
    }
    if P_BoxOnLineSide(tmbbox.as_mut_ptr(), ld) != -(1 as libc::c_int) {
        return true_0 as libc::c_int;
    }
    blockingline = ld;
    if ((*ld).backsector).is_null() {
        if P_PointOnLineSide((*mapcampointer).x, (*mapcampointer).y, ld) != 0 {
            return true_0 as libc::c_int;
        }
        return false_0 as libc::c_int;
    }
...
unsafe extern "C" fn PIT_CheckLine(mut ld: *mut line_t) -> boolean {
    if !((*ld).polyobj).is_null()
        && (*(*ld).polyobj).flags & POF_SOLID as libc::c_int == 0
    {
        return true_0 as libc::c_int;
    ...
    blockingline = ld;
    let mut shouldCollide: uint8_t = LUA_HookMobjLineCollide(tmthing, blockingline)
        as uint8_t;
    if P_MobjWasRemoved(tmthing) != 0 {
        return true_0 as libc::c_int;
    }
    if shouldCollide as libc::c_int == 1 as libc::c_int {
        return false_0 as libc::c_int
    ...
    if ((*ld).backsector).is_null() {
        if P_PointOnLineSide((*tmthing).x, (*tmthing).y, ld) != 0 {
            return true_0 as libc::c_int;
        }
        return false_0 as libc::c_int;
    }
    if (*tmthing).flags & MF_MISSILE as libc::c_int as uint32_t == 0 {
        if (*ld).flags as libc::c_int & 1 as libc::c_int != 0 {
            return false_0 as libc::c_int;
        }
        if (*tmthing).flags
            & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t != 0
            && (*ld).flags as libc::c_int & 2 as libc::c_int != 0
        {
            return false_0 as libc::c_int;
        }
    }
...
pub unsafe extern "C" fn P_CheckPosition(
    ...
    let mut blockval: boolean = true_0 as libc::c_int;
    ps_checkposition_calls.value.i += 1;
    ps_checkposition_calls.value.i;
    P_SetTarget2(&mut tmthing, thing);
    tmflags = (*thing).flags as int32_t;
    tmx = x;
    tmy = y;
    tmbbox[BOXTOP as libc::c_int as usize] = y + (*tmthing).radius;
    tmbbox[BOXBOTTOM as libc::c_int as usize] = y - (*tmthing).radius;
    tmbbox[BOXRIGHT as libc::c_int as usize] = x + (*tmthing).radius;
    tmbbox[BOXLEFT as libc::c_int as usize] = x - (*tmthing).radius;
    newsubsec = R_PointInSubsector(x, y);
    blockingline = 0 as *mut line_t;
    ceilingline = blockingline;
    tmdropoffz = P_MobjFloorZ(
        thing,
        (*newsubsec).sector,
        0 as *mut sector_t,
        x,
    ...
    if !((*(*newsubsec).sector).ffloors).is_null() {
        ...
        let mut thingtop: int32_t = (*thing).z + (*thing).height;
        ...
        while !rover.is_null() {
                ...
                & FOF_EXISTS as libc::c_int as libc::c_uint == 0)
            {
                ...
                if (*rover).fofflags as libc::c_uint
                    ...
                    == (FOF_SWIMMABLE as libc::c_int | FOF_GOOWATER as libc::c_int)
                        as libc::c_uint
                    && (*thing).flags & MF_NOGRAVITY as libc::c_int as uint32_t == 0
                {
                    let mut sinklevel: fixed_t = FixedMul(
                        (*(*thing).info).height / 6 as libc::c_int,
                        (*thing).scale,
                    );
                    let mut minspeed: fixed_t = FixedMul(
                        (*(*thing).info).height / 9 as libc::c_int,
                        (*thing).scale,
                    );
                        ...
                        && abs((*thing).momz) < minspeed
                    {
                        if (*thing).eflags as libc::c_int
                            & MFE_VERTICALFLIP as libc::c_int == 0
                            && (*thing).z > topheight - sinklevel
                            && (*thing).momz >= 0 as libc::c_int
                            && (*thing).momz < minspeed >> 2 as libc::c_int
                        {
                            (*thing).momz += minspeed >> 2 as libc::c_int;
                        } else if (*thing).eflags as libc::c_int
                            & MFE_VERTICALFLIP as libc::c_int != 0
                            && thingtop < bottomheight + sinklevel
                            && (*thing).momz <= 0 as libc::c_int
                            && (*thing).momz > -(minspeed >> 2 as libc::c_int)
                        {
                            (*thing).momz -= minspeed >> 2 as libc::c_int;
                    ...
                    if !((*thing).player).is_null()
                        && (P_CheckSolidLava(rover) != 0
                            || P_CanRunOnWater((*thing).player, rover) != 0)
                    {
                        current_block_68 = 3934796541983872331;
                    } else if (*thing).type_0 as libc::c_uint
                        == MT_SKIM as libc::c_int as libc::c_uint
                    ...
                    {
                        current_block_68 = 12349973810996921269;
                    } else {
                        current_block_68 = 3934796541983872331;
                    }
                    match current_block_68 {
                        ...
                        _ => {
                                ...
                                & FOF_QUICKSAND as libc::c_int as libc::c_uint != 0
                            {
                                if (*thing).eflags as libc::c_int
                                    & MFE_VERTICALFLIP as libc::c_int == 0
                                    && (*thing).z < topheight && bottomheight < thingtop
                                {
                                    if tmfloorz < (*thing).z {
                                        tmfloorz = (*thing).z;
                                        tmfloorrover = rover;
                                ...
                                if bottomheight < tmceilingz && abs(delta1) >= abs(delta2)
                                    ...
                                    && !((*thing).type_0 as libc::c_uint
                                        ...
                                        && (*rover).fofflags as libc::c_uint
                                            & FOF_SWIMMABLE as libc::c_int as libc::c_uint != 0)
                                {
                                    tmdrpoffceilz = bottomheight;
                                    tmceilingz = tmdrpoffceilz;
                                    tmceilingrover = rover;
                                    tmceilingslope = *(*rover).b_slope;
                                }
                            }
    ...
    xl = ((tmbbox[BOXLEFT as libc::c_int as usize] - bmaporgx
        - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    xh = ((tmbbox[BOXRIGHT as libc::c_int as usize] - bmaporgx
        + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    yl = ((tmbbox[BOXBOTTOM as libc::c_int as usize] - bmaporgy
        - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    yh = ((tmbbox[BOXTOP as libc::c_int as usize] - bmaporgy
        + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    if xl > xh {
        xl = 0 as libc::c_int;
                ...
                || by >= bmapheight)
            {
                ...
                while !plink.is_null() {
                    ...
                    if (*po).validcount != validcount {
                        ...
                        if P_BBoxInsidePolyobj(po, tmbbox.as_mut_ptr()) == 0
                            || (*po).flags & POF_SOLID as libc::c_int == 0
                        {
                            ...
                            thingtop_0 = (*thing).z + (*thing).height;
                            delta1_0 = (*thing).z
                                - (polybottom + (polytop - polybottom) / 2 as libc::c_int);
                            delta2_0 = thingtop_0
                                - (polybottom + (polytop - polybottom) / 2 as libc::c_int);
                            if polytop > tmfloorz && abs(delta1_0) < abs(delta2_0) {
                                tmdropoffz = polytop;
                                tmfloorz = tmdropoffz;
                                tmfloorslope = 0 as *mut pslope_t;
                                tmfloorrover = 0 as *mut ffloor_t;
                            }
                            if polybottom < tmceilingz && abs(delta1_0) >= abs(delta2_0)
                            {
                                tmdrpoffceilz = polybottom;
                                tmceilingz = tmdrpoffceilz;
                                tmceilingslope = 0 as *mut pslope_t;
                                tmceilingrover = 0 as *mut ffloor_t;
                            }
    ...
    tmfloorthing = 0 as *mut mobj_t;
    tmhitthing = 0 as *mut mobj_t;
    validcount = validcount.wrapping_add(1);
    validcount;
    if tmflags & MF_NOCLIP as libc::c_int != 0 {
        return true_0 as libc::c_int;
    }
    if (*thing).flags & MF_NOCLIPTHING as libc::c_int as uint32_t == 0 {
        bx = xl;
        while bx <= xh {
            ...
            while by <= yh {
                ...
                {
                    blockval = false_0 as libc::c_int;
                } else {
...
static mut hoopblockdist: fixed_t = 16 as libc::c_int
    * ((1 as libc::c_int) << 16 as libc::c_int)
    + 8 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
static mut hoophalfheight: fixed_t = 56 as libc::c_int
    * ((1 as libc::c_int) << 16 as libc::c_int) / 2 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn P_CheckHoopPosition(
    mut hoopthing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
    mut radius: fixed_t,
    ...
    while i < 32 as libc::c_int {
        ...
        {
            if !(abs((*players[i as usize].mo).x - x) >= hoopblockdist
                || abs((*players[i as usize].mo).y - y) >= hoopblockdist
                || abs((*players[i as usize].mo).z + hoophalfheight - z)
                    >= hoopblockdist)
            {
                P_TouchSpecialThing(
                    hoopthing,
...
#[no_mangle]
pub unsafe extern "C" fn P_CheckCameraPosition(
    mut x: fixed_t,
    mut y: fixed_t,
    ...
    tmx = x;
    tmy = y;
    tmbbox[BOXTOP as libc::c_int as usize] = y + (*thiscam).radius;
    tmbbox[BOXBOTTOM as libc::c_int as usize] = y - (*thiscam).radius;
    tmbbox[BOXRIGHT as libc::c_int as usize] = x + (*thiscam).radius;
    tmbbox[BOXLEFT as libc::c_int as usize] = x - (*thiscam).radius;
    newsubsec = R_PointInSubsector(x, y);
    blockingline = 0 as *mut line_t;
    ceilingline = blockingline;
    mapcampointer = thiscam;
    if (*(*newsubsec).sector).flags as libc::c_uint
        & MSF_NOCLIPCAMERA as libc::c_int as libc::c_uint != 0
    {
        tmdropoffz = (*thiscam).z;
        tmfloorz = tmdropoffz;
        tmdrpoffceilz = (*thiscam).z + (*thiscam).height;
        tmceilingz = tmdrpoffceilz;
        return true_0 as libc::c_int;
    }
    tmdropoffz = P_CameraFloorZ(
        thiscam,
        (*newsubsec).sector,
        0 as *mut sector_t,
        x,
    ...
    if (*(*newsubsec).sector).heightsec >= 0 as libc::c_int {
        tmdropoffz = (*sectors.offset((*(*newsubsec).sector).heightsec as isize))
            .floorheight;
        tmfloorz = tmdropoffz;
        tmdrpoffceilz = (*sectors.offset((*(*newsubsec).sector).heightsec as isize))
            .ceilingheight;
        tmceilingz = tmdrpoffceilz;
    }
    if (*(*newsubsec).sector).camsec >= 0 as libc::c_int {
        tmdropoffz = (*sectors.offset((*(*newsubsec).sector).camsec as isize))
            .floorheight;
        tmfloorz = tmdropoffz;
        tmdrpoffceilz = (*sectors.offset((*(*newsubsec).sector).camsec as isize))
            .ceilingheight;
        tmceilingz = tmdrpoffceilz;
    }
    if !((*(*newsubsec).sector).ffloors).is_null() {
        ...
        let mut delta1: fixed_t = 0;
        let mut delta2: fixed_t = 0;
        let mut thingtop: int32_t = (*thiscam).z + (*thiscam).height;
        rover = (*(*newsubsec).sector).ffloors;
        while !rover.is_null() {
            let mut topheight: fixed_t = 0;
            let mut bottomheight: fixed_t = 0;
                    ...
                    if (*po).validcount != validcount {
                            ...
                            || (*po).flags & POF_SOLID as libc::c_int == 0
                        {
                                ...
                                & MSF_NOCLIPCAMERA as libc::c_int as libc::c_uint != 0
                            {
                                ...
                                thingtop_0 = (*thiscam).z + (*thiscam).height;
                                delta1_0 = (*thiscam).z
                                    - (polybottom + (polytop - polybottom) / 2 as libc::c_int);
                                delta2_0 = thingtop_0
                                    - (polybottom + (polytop - polybottom) / 2 as libc::c_int);
    ...
    while bx <= xh {
        ...
        while by <= yh {
            if P_BlockLinesIterator(
                bx,
                by,
                Some(PIT_CheckCameraLine as unsafe extern "C" fn(*mut line_t) -> boolean),
            ) == 0
            {
                return false_0 as libc::c_int;
            }
...
#[no_mangle]
pub unsafe extern "C" fn P_TryCameraMove(
    mut x: fixed_t,
    mut y: fixed_t,
    mut thiscam: *mut camera_t,
) -> boolean {
    let mut s: *mut subsector_t = R_PointInSubsector(x, y);
    let mut itsatwodlevel: boolean = false_0 as libc::c_int;
    floatok = false_0 as libc::c_int;
    ...
    if itsatwodlevel == 0 && !(players[displayplayer as usize].mo).is_null() {
        let mut tryx: fixed_t = (*thiscam).x;
        let mut tryy: fixed_t = (*thiscam).y;
        if thiscam == &mut camera as *mut camera_t
            && (players[displayplayer as usize].pflags as libc::c_uint
                ...
                || players[displayplayer as usize]
                    .powers[pw_carry as libc::c_int as usize] as libc::c_int
                    == CR_NIGHTSMODE as libc::c_int)
            || thiscam == &mut camera2 as *mut camera_t
        ...
        loop {
            if x - tryx > 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int) {
                tryx += 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
            } else if x - tryx
            ...
            if y - tryy > 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int) {
                tryy += 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
            } else if y - tryy
                < -(32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int))
            {
                tryy -= 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
            ...
            if P_CheckCameraPosition(tryx, tryy, thiscam) == 0 {
                return false_0 as libc::c_int;
            }
        ...
        tmfloorz = P_CameraFloorZ(
            thiscam,
            (*(*thiscam).subsector).sector,
            0 as *mut sector_t,
            x,
            y,
            0 as *mut line_t,
...
static mut stand: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
static mut standx: fixed_t = 0;
static mut standy: fixed_t = 0;
#[no_mangle]
pub unsafe extern "C" fn PIT_PushableMoved(mut thing: *mut mobj_t) -> boolean {
    let mut blockdist: fixed_t = 0;
    if (*thing).flags & MF_SOLID as libc::c_int as uint32_t == 0
        || (*thing).flags & MF_NOGRAVITY as libc::c_int as uint32_t != 0
    {
    ...
    if abs((*thing).x - (*stand).x) >= blockdist
        || abs((*thing).y - (*stand).y) >= blockdist
    {
        return true_0 as libc::c_int;
    }
    if (*stand).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int == 0
        && (*thing).z
            != (*stand).z + (*stand).height
                + FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*stand).scale)
        || (*stand).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
            && (*thing).z + (*thing).height
                != (*stand).z
                    - FixedMul((1 as libc::c_int) << 16 as libc::c_int, (*stand).scale)
    {
    ...
    if (*stand).momx == 0 && (*stand).momy == 0 {
        return true_0 as libc::c_int;
    }
    if !((*thing).player).is_null() {
        let mut oldfltok: boolean = floatok;
        let mut oldflrz: fixed_t = tmfloorz;
        let mut oldceilz: fixed_t = tmceilingz;
        let mut oldflrthing: *mut mobj_t = tmfloorthing;
        let mut oldthing: *mut mobj_t = tmthing;
        let mut oldceilline: *mut line_t = ceilingline;
        let mut oldblockline: *mut line_t = blockingline;
        let mut oldflrrover: *mut ffloor_t = tmfloorrover;
        let mut oldceilrover: *mut ffloor_t = tmceilingrover;
        let mut oldfslope: *mut pslope_t = tmfloorslope;
        let mut oldcslope: *mut pslope_t = tmceilingslope;
        P_TryMove(
            thing,
            (*thing).x + (*stand).momx,
            (*thing).y + (*stand).momy,
        ...
        P_SetTarget2(&mut tmthing, oldthing);
...
unsafe extern "C" fn increment_move(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut allowdropoff: boolean,
) -> boolean {
    let mut tryx: fixed_t = (*thing).x;
    let mut tryy: fixed_t = (*thing).y;
    let mut radius: fixed_t = (*thing).radius;
    let mut thingtop: fixed_t = 0;
    floatok = false_0 as libc::c_int;
    radius = if radius > (*thing).scale { radius } else { (*thing).scale };
    radius = if radius < 16 as libc::c_int * (*thing).scale {
        radius
    } else {
        16 as libc::c_int * (*thing).scale
    };
    loop {
        ...
        if P_CheckPosition(thing, tryx, tryy) == 0 {
            return false_0 as libc::c_int;
        }
        if (*thing).flags & MF_NOCLIP as libc::c_int as uint32_t == 0 {
            let mut maxstep: fixed_t = FixedMul(
                24 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                (*thing).scale,
            );
            if !((*thing).player).is_null() {
                if !(P_PlayerTouchingSectorSpecialFlag(
                    (*thing).player,
                    SSF_DOUBLESTEPUP,
                ))
                    .is_null()
                    || (*(*R_PointInSubsector(x, y)).sector).specialflags as libc::c_uint
                        & SSF_DOUBLESTEPUP as libc::c_int as libc::c_uint != 0
                {
                    maxstep <<= 1 as libc::c_int;
                }
                ...
                {
                    maxstep = 0 as libc::c_int;
                }
                if (*(*thing).player).panim as libc::c_uint
                    == PA_SPRING as libc::c_int as libc::c_uint
                    && P_MobjFlip(thing) as libc::c_int * (*thing).momz
                        > FixedMul(
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (*thing).scale,
                        )
            ...
            } else if (*thing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0 {
                if (*(*R_PointInSubsector(x, y)).sector).specialflags as libc::c_uint
                    & SSF_DOUBLESTEPUP as libc::c_int as libc::c_uint != 0
                {
                    maxstep <<= 1 as libc::c_int;
                }
            ...
            if (*thing).type_0 as libc::c_uint == MT_SKIM as libc::c_int as libc::c_uint
            {
                maxstep = 0 as libc::c_int;
            }
            if tmceilingz - tmfloorz < (*thing).height
                || !((*thing).player).is_null()
                    && tmceilingz - tmfloorz
                        < FixedMul(
                            (*(*thing).player).height,
                            (*(*(*thing).player).mo).scale,
                        ) && P_PlayerCanEnterSpinGaps((*thing).player) == 0
            {
            ...
            if (*thing).z < tmfloorz {
                if maxstep > 0 as libc::c_int && tmfloorz - (*thing).z <= maxstep {
                    (*thing).floorz = tmfloorz;
                    (*thing).z = (*thing).floorz;
                    (*thing).floorrover = tmfloorrover;
                    (*thing)
                        .eflags = ((*thing).eflags as libc::c_int
                        | MFE_JUSTSTEPPEDDOWN as libc::c_int) as uint16_t;
                } else {
                    return false_0 as libc::c_int
                }
            } else if tmceilingz < thingtop {
                if maxstep > 0 as libc::c_int && thingtop - tmceilingz <= maxstep {
                    (*thing).ceilingz = tmceilingz;
            ...
            } else if maxstep > 0 as libc::c_int {
                if thingtop == (*thing).ceilingz && tmceilingz > thingtop
                    && tmceilingz - thingtop <= maxstep
                {
                    (*thing).ceilingz = tmceilingz;
                    (*thing).z = (*thing).ceilingz - (*thing).height;
                    (*thing).ceilingrover = tmceilingrover;
                    (*thing)
                        .eflags = ((*thing).eflags as libc::c_int
                        | MFE_JUSTSTEPPEDDOWN as libc::c_int) as uint16_t;
                } else if (*thing).z == (*thing).floorz && tmfloorz < (*thing).z
                    && (*thing).z - tmfloorz <= maxstep
                {
                    (*thing).floorz = tmfloorz;
                    (*thing).z = (*thing).floorz;
                    (*thing).floorrover = tmfloorrover;
            ...
            if allowdropoff == 0
                && (*thing).flags & MF_FLOAT as libc::c_int as uint32_t == 0
                && (*thing).type_0 as libc::c_uint
                    != MT_SKIM as libc::c_int as libc::c_uint && tmfloorthing.is_null()
            {
                if (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
                {
...
#[no_mangle]
pub unsafe extern "C" fn P_CheckMove(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut allowdropoff: boolean,
) -> boolean {
    let mut moveok: boolean = 0;
    let mut hack: *mut mobj_t = P_SpawnMobjFromMobj(
        thing,
        0 as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
...
pub unsafe extern "C" fn P_TryMove(
    ...
    let mut startingonground: fixed_t = P_IsObjectOnGround(thing);
    if increment_move(thing, x, y, allowdropoff) == 0 {
        return false_0 as libc::c_int;
    }
    if (*thing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0 {
        let mut bx: int32_t = 0;
        ...
        let mut yl: int32_t = 0;
        let mut yh: int32_t = 0;
        yh = (((*thing).y + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            - bmaporgy) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
            as int32_t;
        yl = (((*thing).y - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            - bmaporgy) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
            as int32_t;
        xh = (((*thing).x + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            - bmaporgx) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
            as int32_t;
        xl = (((*thing).x - 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int)
            - bmaporgx) as libc::c_uint >> 16 as libc::c_int + 7 as libc::c_int)
            as int32_t;
        if xl > xh {
            xl = 0 as libc::c_int;
        ...
        while by <= yh {
            ...
            while bx <= xh {
                P_BlockThingsIterator(
                    ...
                    by,
                    Some(
                        PIT_PushableMoved as unsafe extern "C" fn(*mut mobj_t) -> boolean,
                    ),
                );
                bx += 1;
                bx;
    ...
    (*thing).floorrover = tmfloorrover;
    (*thing).ceilingrover = tmceilingrover;
    if (*thing).flags & MF_NOCLIPHEIGHT as libc::c_int as uint32_t == 0 {
        if (*thing).z <= tmfloorz
            && (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int == 0
        {
            if startingonground == 0 && !tmfloorslope.is_null() {
                P_HandleSlopeLanding(thing, tmfloorslope);
            }
            if (*thing).momz <= 0 as libc::c_int {
                (*thing).standingslope = tmfloorslope;
                P_SetPitchRollFromSlope(thing, (*thing).standingslope);
                if (*thing).momz == 0 as libc::c_int && !((*thing).player).is_null()
                    && startingonground == 0
                {
                    P_PlayerHitFloor((*thing).player, true_0 as libc::c_int);
                }
            }
        } else if (*thing).z + (*thing).height >= tmceilingz
            && (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
        {
            if startingonground == 0 && !tmceilingslope.is_null() {
        ...
        (*thing).standingslope = 0 as *mut pslope_s;
    }
    (*thing).x = x;
    (*thing).y = y;
    if !tmfloorthing.is_null() {
        (*thing)
            .eflags = ((*thing).eflags as libc::c_int & !(MFE_ONGROUND as libc::c_int))
            as uint16_t;
    } else {
        (*thing)
            .eflags = ((*thing).eflags as libc::c_int | MFE_ONGROUND as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn P_SceneryTryMove(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> boolean {
    ...
    loop {
        ...
        if (*thing).flags & MF_NOCLIP as libc::c_int as uint32_t == 0 {
            let maxstep: fixed_t = 24 as libc::c_int
                * ((1 as libc::c_int) << 16 as libc::c_int);
            if tmceilingz - tmfloorz < (*thing).height {
                return false_0 as libc::c_int;
            }
...
unsafe extern "C" fn P_ThingHeightClip(mut thing: *mut mobj_t) -> boolean {
    let mut floormoved: boolean = 0;
    let mut oldfloorz: fixed_t = (*thing).floorz;
    let mut oldz: fixed_t = (*thing).z;
    let mut oldfloorrover: *mut ffloor_t = (*thing).floorrover;
    let mut oldceilingrover: *mut ffloor_t = (*thing).ceilingrover;
    let mut onfloor: boolean = P_IsObjectOnGround(thing);
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut bouncing: boolean = 0;
    let mut hitfloor: boolean = false_0 as libc::c_int;
    if (*thing).flags & MF_NOCLIPHEIGHT as libc::c_int as uint32_t != 0 {
        return true_0 as libc::c_int;
    }
    P_CheckPosition(thing, (*thing).x, (*thing).y);
    ...
    floormoved = ((*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
        && tmceilingz != (*thing).ceilingz
        || (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int == 0
            && tmfloorz != (*thing).floorz) as libc::c_int;
    (*thing).floorz = tmfloorz;
    (*thing).ceilingz = tmceilingz;
    (*thing).floorrover = tmfloorrover;
    (*thing).ceilingrover = tmceilingrover;
    ...
    bouncing = (!((*thing).player).is_null()
        && ((*thing).state).offset_from(states.as_mut_ptr()) as libc::c_long
            == S_PLAY_BOUNCE_LANDING as libc::c_int as libc::c_long
        && P_IsObjectOnGround(thing) != 0) as libc::c_int;
    if (onfloor != 0 || bouncing != 0)
        && (*thing).flags & MF_NOGRAVITY as libc::c_int as uint32_t == 0
        && floormoved != 0
    {
        rover = if (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
        {
            oldceilingrover
        } else {
            oldfloorrover
        ...
        if (*thing).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            if onfloor == 0 && (*thing).z < tmfloorz {
                (*thing).z = (*thing).floorz;
            }
        } else if onfloor == 0 && (*thing).z + (*thing).height > tmceilingz {
            (*thing).z = (*thing).ceilingz - (*thing).height;
        }
    }
    if (P_MobjFlip(thing) as libc::c_int * ((*thing).z - oldz) > 0 as libc::c_int
        || hitfloor != 0) && !((*thing).player).is_null()
    {
        P_PlayerHitFloor((*thing).player, (onfloor == 0) as libc::c_int);
    }
    (*thing)
        .eflags = ((*thing).eflags as libc::c_int & !(MFE_ONGROUND as libc::c_int))
        as uint16_t;
...
static mut bestslideline: *mut line_t = 0 as *const line_t as *mut line_t;
static mut secondslideline: *mut line_t = 0 as *const line_t as *mut line_t;
static mut slidemo: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
static mut tmxmove: fixed_t = 0;
static mut tmymove: fixed_t = 0;
unsafe extern "C" fn P_HitCameraSlideLine(
    mut ld: *mut line_t,
    mut thiscam: *mut camera_t,
) {
    ...
    if (*ld).slopetype as libc::c_uint == ST_HORIZONTAL as libc::c_int as libc::c_uint {
        tmymove = 0 as libc::c_int;
        return;
    }
    if (*ld).slopetype as libc::c_uint == ST_VERTICAL as libc::c_int as libc::c_uint {
        tmxmove = 0 as libc::c_int;
        return;
    }
    side = P_PointOnLineSide((*thiscam).x, (*thiscam).y, ld);
    lineangle = (*ld).angle;
    if side == 1 as libc::c_int {
        lineangle = (lineangle as libc::c_uint).wrapping_add(0x80000000 as libc::c_uint)
            as angle_t as angle_t;
    }
    moveangle = R_PointToAngle2(0 as libc::c_int, 0 as libc::c_int, tmxmove, tmymove);
    deltaangle = moveangle.wrapping_sub(lineangle);
    if deltaangle > 0x80000000 as libc::c_uint {
        deltaangle = (deltaangle as libc::c_uint)
            .wrapping_add(0x80000000 as libc::c_uint) as angle_t as angle_t;
    }
    lineangle >>= 19 as libc::c_int;
    deltaangle >>= 19 as libc::c_int;
    movelen = P_AproxDistance(tmxmove, tmymove);
    newlen = FixedMul(
        movelen,
        *finecosine.offset(deltaangle as isize) >> 16 as libc::c_int - 16 as libc::c_int,
    );
    tmxmove = FixedMul(
        newlen,
        *finecosine.offset(lineangle as isize) >> 16 as libc::c_int - 16 as libc::c_int,
    );
    tmymove = FixedMul(
        newlen,
        finesine[lineangle as usize] >> 16 as libc::c_int - 16 as libc::c_int,
    );
}
unsafe extern "C" fn P_HitSlideLine(mut ld: *mut line_t) {
    let mut side: int32_t = 0;
    let mut lineangle: angle_t = 0;
    let mut moveangle: angle_t = 0;
    let mut deltaangle: angle_t = 0;
    ...
    lineangle >>= 19 as libc::c_int;
    deltaangle >>= 19 as libc::c_int;
    movelen = R_PointToDist2(0 as libc::c_int, 0 as libc::c_int, tmxmove, tmymove);
    newlen = FixedMul(
        movelen,
        *finecosine.offset(deltaangle as isize) >> 16 as libc::c_int - 16 as libc::c_int,
    );
...
unsafe extern "C" fn P_HitBounceLine(mut ld: *mut line_t) {
    let mut lineangle: angle_t = 0;
    let mut moveangle: angle_t = 0;
    let mut deltaangle: angle_t = 0;
    let mut movelen: fixed_t = 0;
    ...
    lineangle = (*ld).angle;
    if lineangle >= 0x80000000 as libc::c_uint {
        lineangle = (lineangle as libc::c_uint).wrapping_sub(0x80000000 as libc::c_uint)
            as angle_t as angle_t;
    }
    moveangle = R_PointToAngle2(0 as libc::c_int, 0 as libc::c_int, tmxmove, tmymove);
    deltaangle = moveangle
        .wrapping_add(2 as libc::c_int as angle_t * lineangle.wrapping_sub(moveangle));
    lineangle >>= 19 as libc::c_int;
    deltaangle >>= 19 as libc::c_int;
    movelen = P_AproxDistance(tmxmove, tmymove);
    tmxmove = FixedMul(
    ...
    tmymove = FixedMul(
        movelen,
        finesine[deltaangle as usize] >> 16 as libc::c_int - 16 as libc::c_int,
    );
    deltaangle = R_PointToAngle2(0 as libc::c_int, 0 as libc::c_int, tmxmove, tmymove);
}
unsafe extern "C" fn PTR_SlideCameraTraverse(mut in_0: *mut intercept_t) -> boolean {
    let mut li: *mut line_t = 0 as *mut line_t;
    li = (*in_0).d.line;
    if ((*li).backsector).is_null() {
        if P_PointOnLineSide((*mapcampointer).x, (*mapcampointer).y, li) != 0 {
            return true_0 as libc::c_int;
        }
    } else {
        ...
        if !(openrange < (*mapcampointer).height) {
            if !(opentop - (*mapcampointer).z < (*mapcampointer).height) {
                if !(openbottom - (*mapcampointer).z > 0 as libc::c_int) {
                    return true_0 as libc::c_int;
                }
            }
        }
...
unsafe extern "C" fn P_IsClimbingValid(
    mut player: *mut player_t,
    mut angle: angle_t,
) -> boolean {
    let mut platx: fixed_t = 0;
    let mut platy: fixed_t = 0;
    let mut glidesector: *mut sector_t = 0 as *mut sector_t;
    let mut floorz: fixed_t = 0;
    let mut ceilingz: fixed_t = 0;
    ...
    if glidesector != (*(*mo).subsector).sector {
                    ...
                    & FOF_BLOCKPLAYER as libc::c_int as libc::c_uint == 0)
            {
                ...
                if (*mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
                    if topheight < (*mo).z + (*mo).height
                        && (*mo).z + (*mo).height + (*mo).momz < topheight
                    {
                        floorclimb = true_0 as libc::c_int;
                    }
                    if topheight < (*mo).z {
        ...
        if (*mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
            ...
            if floorz > (*mo).z && (*glidesector).floorpic == skyflatnum {
                return false_0 as libc::c_int;
            }
            if (*mo).z + (*mo).height
                - FixedMul(
                    16 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                    (*mo).scale,
                ) > ceilingz || (*mo).z + (*mo).height <= floorz
            {
                floorclimb = true_0 as libc::c_int;
            }
        } else {
            if ceilingz >= (*mo).z && (*mo).z - (*mo).momz >= ceilingz {
                floorclimb = true_0 as libc::c_int;
            }
...
unsafe extern "C" fn PTR_LineIsBlocking(mut li: *mut line_t) -> boolean {
    if ((*li).backsector).is_null() {
        return (P_PointOnLineSide((*slidemo).x, (*slidemo).y, li) == 0) as libc::c_int;
    }
    if (*slidemo).flags & MF_MISSILE as libc::c_int as uint32_t == 0 {
        if (*li).flags as libc::c_int & 1 as libc::c_int != 0 {
            return true_0 as libc::c_int;
        }
        if (*slidemo).flags
            & (MF_ENEMY as libc::c_int | MF_BOSS as libc::c_int) as uint32_t != 0
            && (*li).flags as libc::c_int & 2 as libc::c_int != 0
        {
            return true_0 as libc::c_int;
        }
    }
    ...
    if !((*slidemo).player).is_null()
        && openrange
            < FixedMul((*(*slidemo).player).height, (*(*(*slidemo).player).mo).scale)
        && P_PlayerCanEnterSpinGaps((*slidemo).player) == 0
    {
        return true_0 as libc::c_int;
    }
    return false_0 as libc::c_int;
}
unsafe extern "C" fn PTR_GlideClimbTraverse(mut li: *mut line_t) {
    let mut checkline: *mut line_t = li;
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut topheight: fixed_t = 0;
    let mut bottomheight: fixed_t = 0;
    let mut fofline: boolean = false_0 as libc::c_int;
    let mut checksector: *mut sector_t = if !((*li).backsector).is_null()
        && P_PointOnLineSide((*slidemo).x, (*slidemo).y, li) == 0
    {
        (*li).backsector
    } else {
        (*li).frontsector
    };
    if !((*checksector).ffloors).is_null() {
        rover = (*checksector).ffloors;
        while !rover.is_null() {
            if !((*rover).fofflags as libc::c_uint
                & FOF_EXISTS as libc::c_int as libc::c_uint == 0
                || (*rover).fofflags as libc::c_uint
                        ...
                        & SF_CANBUSTWALLS as libc::c_int as uint32_t != 0)
            {
                ...
                if !(topheight < (*slidemo).z) {
                    if !(bottomheight > (*slidemo).z + (*slidemo).height) {
                        if (*(*rover).master).flags as libc::c_int & 32768 as libc::c_int
                            != 0
                        {
                            let mut linenum: size_t = li
                                .offset_from(
                                    *((*checksector).lines).offset(0 as libc::c_int as isize),
                                ) as libc::c_long as size_t;
                            checkline = (*((*(*(*rover).master).frontsector).lines)
                                .offset(0 as libc::c_int as isize))
                                .offset(linenum as isize);
                            fofline = true_0 as libc::c_int;
                        }
                        break;
                    }
                }
    ...
    if (*checkline).flags as libc::c_int & 64 as libc::c_int == 0
        && (*checkline).special as libc::c_int != 41 as libc::c_int
    {
        let mut canclimb: boolean = 0;
        let mut climbangle: angle_t = 0;
        let mut climbline: angle_t = 0;
        let mut whichside: int32_t = P_PointOnLineSide((*slidemo).x, (*slidemo).y, li);
        climbline = R_PointToAngle2(
            (*(*li).v1).x,
            (*(*li).v1).y,
            (*(*li).v2).x,
            (*(*li).v2).y,
        );
        climbangle = climbline;
        if whichside != 0 {
            climbline = (climbline as libc::c_uint)
                .wrapping_add(0x80000000 as libc::c_uint) as angle_t as angle_t;
        }
        ...
        canclimb = if !((*li).backsector).is_null() {
            P_IsClimbingValid((*slidemo).player, climbangle)
        } else {
            true_0 as libc::c_int
        };
        if ((*(*slidemo).player).climbing == 0
            && abs(
                ((*slidemo).angle)
                    .wrapping_sub(0x40000000 as libc::c_int as angle_t)
                    .wrapping_sub(climbline) as libc::c_int,
            ) < 0x20000000 as libc::c_int
            || (*(*slidemo).player).climbing as libc::c_int == 1 as libc::c_int
                && abs(((*slidemo).angle).wrapping_sub(climbline) as libc::c_int)
                    < 0x60000000 as libc::c_int) && canclimb != 0
        {
            (*slidemo).angle = climbangle;
            if (*(*slidemo).player).climbing == 0 {
                S_StartSound(slidemo as *const libc::c_void, sfx_s3k4a);
                (*(*slidemo).player).climbing = 5 as libc::c_int as uint8_t;
                if (*(*slidemo).player).powers[pw_super as libc::c_int as usize] != 0 {
                    P_Earthquake(
                        slidemo,
                        slidemo,
                        256 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
                    );
                    S_StartSound(slidemo as *const libc::c_void, sfx_s3k49);
                }
            }
            (*(*slidemo).player)
                .pflags = ::core::mem::transmute::<
                ...
                pflags_t,
            >(
                (*(*slidemo).player).pflags as libc::c_uint
                    & !(PF_GLIDING as libc::c_int | PF_SPINNING as libc::c_int
                        | PF_JUMPED as libc::c_int | PF_NOJUMPDAMAGE as libc::c_int
                        | PF_THOKKED as libc::c_int) as libc::c_uint,
            );
            (*(*slidemo).player).glidetime = 0 as libc::c_int as tic_t;
            (*(*slidemo).player).secondjump = 0 as libc::c_int as uint8_t;
            if (*(*slidemo).player).climbing as libc::c_int > 1 as libc::c_int {
                (*slidemo).momy = 0 as libc::c_int;
                (*slidemo).momx = (*slidemo).momy;
                (*slidemo).momz = (*slidemo).momx;
            }
            if fofline != 0 {
                whichside = 0 as libc::c_int;
            }
            (*(*slidemo).player)
                .lastsidehit = (*checkline).sidenum[whichside as usize] as int16_t;
            (*(*slidemo).player)
                .lastlinehit = checkline.offset_from(lines) as libc::c_long as int16_t;
            P_Thrust(
                slidemo,
                (*slidemo).angle,
                FixedMul(
...
unsafe extern "C" fn PTR_SlideTraverse(mut in_0: *mut intercept_t) -> boolean {
    let mut li: *mut line_t = 0 as *mut line_t;
    li = (*in_0).d.line;
    if PTR_LineIsBlocking(li) == 0 {
        return true_0 as libc::c_int;
    }
    if !((*li).polyobj).is_null() && !((*slidemo).player).is_null() {
        if (*(**((*(*li).polyobj).lines).offset(0 as libc::c_int as isize)).backsector)
            .flags as libc::c_uint
            & MSF_TRIGGERSPECIAL_TOUCH as libc::c_int as libc::c_uint != 0
            && (*(*li).polyobj).flags & POF_NOSPECIALS as libc::c_int == 0
        {
            P_ProcessSpecialSector(
                (*slidemo).player,
                (*(*slidemo).subsector).sector,
                (**((*(*li).polyobj).lines).offset(0 as libc::c_int as isize)).backsector,
            );
        }
    }
    if !((*slidemo).player).is_null() {
        if (*(*slidemo).player).charability as libc::c_int
            == CA_GLIDEANDCLIMB as libc::c_int
            && ((*(*slidemo).player).pflags as libc::c_uint
                & PF_GLIDING as libc::c_int as libc::c_uint != 0
                || (*(*slidemo).player).climbing as libc::c_int != 0)
        {
            PTR_GlideClimbTraverse(li);
        } else {
            (*(*slidemo).player)
                .lastsidehit = (*li)
                .sidenum[P_PointOnLineSide((*slidemo).x, (*slidemo).y, li) as usize]
                as int16_t;
            (*(*slidemo).player)
                .lastlinehit = li.offset_from(lines) as libc::c_long as int16_t;
        }
    }
    if (*in_0).frac < bestslidefrac
        && (((*slidemo).player).is_null() || (*(*slidemo).player).climbing == 0)
    {
        secondslidefrac = bestslidefrac;
        secondslideline = bestslideline;
        bestslidefrac = (*in_0).frac;
...
#[no_mangle]
pub unsafe extern "C" fn P_SlideCameraMove(mut thiscam: *mut camera_t) {
    ...
    let mut hitcount: int32_t = 0 as libc::c_int;
    let mut retval: int32_t = 0 as libc::c_int;
    bestslideline = 0 as *mut line_t;
    loop {
        hitcount += 1;
        if hitcount == 3 as libc::c_int {
            break;
        }
        if (*thiscam).momx > 0 as libc::c_int {
        ...
        if (*thiscam).momy > 0 as libc::c_int {
        ...
        bestslidefrac = ((1 as libc::c_int) << 16 as libc::c_int) + 1 as libc::c_int;
        mapcampointer = thiscam;
        P_PathTraverse(
            leadx,
            leady,
            ...
            Some(
                PTR_SlideCameraTraverse
                    as unsafe extern "C" fn(*mut intercept_t) -> boolean,
            ),
        );
        P_PathTraverse(
            trailx,
        ...
        if bestslidefrac == ((1 as libc::c_int) << 16 as libc::c_int) + 1 as libc::c_int
        {
            retval = P_TryCameraMove(
                (*thiscam).x,
            ...
            bestslidefrac -= 0x800 as libc::c_int;
            if bestslidefrac > 0 as libc::c_int {
            ...
            bestslidefrac = ((1 as libc::c_int) << 16 as libc::c_int)
                - (bestslidefrac + 0x800 as libc::c_int);
            if bestslidefrac > (1 as libc::c_int) << 16 as libc::c_int {
                bestslidefrac = (1 as libc::c_int) << 16 as libc::c_int;
            }
            if bestslidefrac <= 0 as libc::c_int {
                return;
            ...
            P_HitCameraSlideLine(bestslideline, thiscam);
...
unsafe extern "C" fn P_CheckLavaWall(mut mo: *mut mobj_t, mut sec: *mut sector_t) {
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut topheight: fixed_t = 0;
    let mut bottomheight: fixed_t = 0;
                    ...
                    != SD_LAVA as libc::c_int)
                {
                    ...
                    if (*mo).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0
                    {
                        if topheight < (*mo).z - (*mo).height {
                            ...
                            current_block_4 = 1917311967535052937;
                        }
                    } else if topheight < (*mo).z {
                        current_block_4 = 16668937799742929182;
                    } else {
                        current_block_4 = 1917311967535052937;
                    }
                        ...
                        _ => {
                                ...
                                & MFE_VERTICALFLIP as libc::c_int != 0
                            {
                                if bottomheight > (*mo).z {
                                    ...
                                    current_block_4 = 17860125682698302841;
                                }
                            } else if bottomheight > (*mo).z + (*mo).height {
                                current_block_4 = 16668937799742929182;
                            } else {
                                current_block_4 = 17860125682698302841;
                            }
...
pub unsafe extern "C" fn P_SlideMove(mut mo: *mut mobj_t) {
    ...
    let mut newx: fixed_t = 0;
    let mut newy: fixed_t = 0;
    let mut hitcount: int16_t = 0 as libc::c_int as int16_t;
    let mut success: boolean = false_0 as libc::c_int;
    let mut papercol: boolean = false_0 as libc::c_int;
    let mut v1: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
    ...
    memset(
        &mut junk as *mut line_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<line_t>() as libc::c_ulong,
    );
    if !tmhitthing.is_null() && (*mo).z + (*mo).height > (*tmhitthing).z
        && (*mo).z < (*tmhitthing).z + (*tmhitthing).height
    {
        if (*tmhitthing).flags & MF_PUSHABLE as libc::c_int as uint32_t != 0 {
            return;
        }
        if (*tmhitthing).flags & MF_PAPERCOLLISION as libc::c_int as uint32_t != 0 {
            let mut cosradius: fixed_t = 0;
            let mut sinradius: fixed_t = 0;
            let mut num: fixed_t = 0;
            let mut den: fixed_t = 0;
            if (*mo).momx > 0 as libc::c_int {
            ...
            papercol = true_0 as libc::c_int;
            slidemo = mo;
            bestslideline = &mut junk;
            cosradius = FixedMul(
                (*tmhitthing).radius,
                *finecosine.offset(((*tmhitthing).angle >> 19 as libc::c_int) as isize)
                    >> 16 as libc::c_int - 16 as libc::c_int,
            );
            sinradius = FixedMul(
                (*tmhitthing).radius,
                finesine[((*tmhitthing).angle >> 19 as libc::c_int) as usize]
                    >> 16 as libc::c_int - 16 as libc::c_int,
            );
            ...
            if sinradius != 0
                && (*mo).y + (*mo).radius <= (if v1.y < v2.y { v1.y } else { v2.y })
            {
                (*mo).momy = 0 as libc::c_int;
                P_TryMove(
                    mo,
                    (*mo).x + (*mo).momx,
                    (if v1.y < v2.y { v1.y } else { v2.y }) - (*mo).radius,
                    true_0 as libc::c_int,
                );
                return;
            } else if sinradius != 0
                && (*mo).y - (*mo).radius >= (if v1.y > v2.y { v1.y } else { v2.y })
            {
                ...
                && (*mo).x + (*mo).radius <= (if v1.x < v2.x { v1.x } else { v2.x })
            {
                (*mo).momx = 0 as libc::c_int;
                P_TryMove(
                    mo,
                    (if v1.x < v2.x { v1.x } else { v2.x }) - (*mo).radius,
                    (*mo).y + (*mo).momy,
                    true_0 as libc::c_int,
                );
                return;
            ...
            junk.dy = 2 as libc::c_int * sinradius;
            junk
                .slopetype = (if cosradius == 0 {
                ST_VERTICAL as libc::c_int
            } else if sinradius == 0 {
                ST_HORIZONTAL as libc::c_int
            } else if (sinradius > 0 as libc::c_int) as libc::c_int
                == (cosradius > 0 as libc::c_int) as libc::c_int
            {
                ST_POSITIVE as libc::c_int
            } else {
                ST_NEGATIVE as libc::c_int
            }) as slopetype_t;
            bestslidefrac = ((1 as libc::c_int) << 16 as libc::c_int) + 1 as libc::c_int;
            den = FixedMul(junk.dy >> 8 as libc::c_int, (*mo).momx)
                - FixedMul(junk.dx >> 8 as libc::c_int, (*mo).momy);
            if den == 0 {
                bestslidefrac = 0 as libc::c_int;
            } else {
                let mut frac: fixed_t = 0;
                num = FixedMul(v1.x - leadx >> 8 as libc::c_int, junk.dy)
                    + FixedMul(leady - v1.y >> 8 as libc::c_int, junk.dx);
            ...
            if (*mo).y + (*mo).radius <= (*tmhitthing).y - (*tmhitthing).radius {
                ...
                P_TryMove(
                    mo,
                    (*mo).x + (*mo).momx,
                    (*tmhitthing).y - (*tmhitthing).radius - (*mo).radius,
                    true_0 as libc::c_int,
                );
                ...
                P_TryMove(
                    mo,
                    (*tmhitthing).x - (*tmhitthing).radius - (*mo).radius,
                    (*mo).y + (*mo).momy,
                    true_0 as libc::c_int,
                );
            } else if (*mo).x - (*mo).radius >= (*tmhitthing).x + (*tmhitthing).radius {
        ...
        current_block = 5862636949496759020;
    } else {
        slidemo = mo;
        bestslideline = 0 as *mut line_t;
        current_block = 14827806442638985454;
    }
    '_retry: loop {
        match current_block {
            14827806442638985454 => {
                hitcount += 1;
                if hitcount as libc::c_int == 3 as libc::c_int || papercol != 0 {
                    break;
                }
                if (*mo).momx > 0 as libc::c_int {
                    leadx = (*mo).x + (*mo).radius;
                ...
                if !bestslideline.is_null() && !((*mo).player).is_null()
                    && (*bestslideline).sidenum[1 as libc::c_int as usize] as libc::c_int
                        != 0xffff as libc::c_int
                {
                    let mut sec: *mut sector_t = if P_PointOnLineSide(
                        (*mo).x,
                        (*mo).y,
                        bestslideline,
                    ) != 0
                    {
                        (*bestslideline).frontsector
                    } else {
                        (*bestslideline).backsector
                    };
                    P_CheckLavaWall(mo, sec);
                }
                if !bestslideline.is_null()
                    && (*bestslideline).flags as libc::c_int & 16384 as libc::c_int != 0
                {
                    P_BounceMove(mo);
                    return;
                }
            ...
            _ => {
                ...
                loop {
                    ...
                    if P_TryMove(mo, newx, newy, true_0 as libc::c_int) == 0 {
                        if !(success != 0) {
                            current_block = 14827806442638985454;
                            continue '_retry;
                        }
    ...
    if P_TryMove(mo, (*mo).x, (*mo).y + (*mo).momy, true_0 as libc::c_int) == 0 {
        P_TryMove(mo, (*mo).x + (*mo).momx, (*mo).y, true_0 as libc::c_int);
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_BounceMove(mut mo: *mut mobj_t) {
    let mut current_block: u64;
    let mut leadx: fixed_t = 0;
    let mut leady: fixed_t = 0;
    let mut trailx: fixed_t = 0;
    ...
    let mut newx: fixed_t = 0;
    let mut newy: fixed_t = 0;
    let mut hitcount: int32_t = 0;
    let mut mmomx: fixed_t = 0 as libc::c_int;
    let mut mmomy: fixed_t = 0 as libc::c_int;
    slidemo = mo;
    hitcount = 0 as libc::c_int;
    loop {
        hitcount += 1;
        if !(hitcount == 3 as libc::c_int) {
                ...
                == ((1 as libc::c_int) << 16 as libc::c_int) + 1 as libc::c_int)
            {
                ...
                if bestslidefrac > 0 as libc::c_int {
                    ...
                    ) == 0
                    {
                        ...
                        current_block = 10202410476779750774;
                    } else {
        ...
        if P_TryMove(mo, (*mo).x - mmomx, (*mo).y - mmomy, true_0 as libc::c_int) != 0 {
            ...
            if !((*mo).player).is_null() {
                (*(*mo).player).cmomx *= -(1 as libc::c_int);
                (*(*mo).player).cmomy *= -(1 as libc::c_int);
                (*(*mo).player)
                    .cmomx = FixedMul(
                    (*(*mo).player).cmomx,
                    ((1 as libc::c_int) << 16 as libc::c_int)
...
static mut bombdamage: fixed_t = 0;
static mut bombsource: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
static mut bombspot: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
static mut bombdamagetype: uint8_t = 0;
static mut bombsightcheck: boolean = 0;
unsafe extern "C" fn PIT_RadiusAttack(mut thing: *mut mobj_t) -> boolean {
    ...
    if !bombsource.is_null()
        && (*thing).type_0 as libc::c_uint == (*bombsource).type_0 as libc::c_uint
        && bombdamagetype as libc::c_int & 0x40 as libc::c_int == 0
    {
        return true_0 as libc::c_int;
    }
    if (*thing).type_0 as libc::c_uint == MT_MINUS as libc::c_int as libc::c_uint
        && (*thing).flags
            & (MF_SPECIAL as libc::c_int | MF_SHOOTABLE as libc::c_int) as uint32_t == 0
        && bombsightcheck == 0
    {
        (*thing)
            .flags = (*thing).flags & !(MF_NOCLIPTHING as libc::c_int) as uint32_t
            | MF_SPECIAL as libc::c_int as uint32_t
            | MF_SHOOTABLE as libc::c_int as uint32_t;
    }
    if (*thing).type_0 as libc::c_uint == MT_EGGGUARD as libc::c_int as libc::c_uint
        && !((*thing).tracer).is_null()
    {
    ...
    dz = abs((*thing).z + ((*thing).height >> 1 as libc::c_int) - (*bombspot).z);
    dist_0 = P_AproxDistance(P_AproxDistance(dx, dy), dz);
    dist_0 -= (*thing).radius;
    if dist_0 < 0 as libc::c_int {
        dist_0 = 0 as libc::c_int;
    }
    if dist_0 >= bombdamage {
        return true_0 as libc::c_int;
    }
    ...
    if bombsightcheck == 0 || P_CheckSight(thing, bombspot) != 0 {
        P_DamageMobj(thing, bombspot, bombsource, 1 as libc::c_int, bombdamagetype);
    }
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn P_RadiusAttack(
    ...
    mut damagedist: fixed_t,
    mut damagetype: uint8_t,
    mut sightcheck: boolean,
) {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut xl: int32_t = 0;
    ...
    let mut yh: int32_t = 0;
    let mut dist_0: fixed_t = 0;
    dist_0 = FixedMul(damagedist, (*spot).scale)
        + 32 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    yh = (((*spot).y + dist_0 - bmaporgy) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    yl = (((*spot).y - dist_0 - bmaporgy) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    xh = (((*spot).x + dist_0 - bmaporgx) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    xl = (((*spot).x - dist_0 - bmaporgx) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    if xl > xh {
        xl = 0 as libc::c_int;
    }
...
unsafe extern "C" fn PIT_ChangeSector(
    mut thing: *mut mobj_t,
    mut realcrush: boolean,
    mut crunch: boolean,
) -> boolean {
    let mut killer: *mut mobj_t = 0 as *mut mobj_t;
    let mut immunepushable: boolean = ((*thing).flags
        & (MF_PUSHABLE as libc::c_int | MF_SHOOTABLE as libc::c_int) as uint32_t
        == MF_PUSHABLE as libc::c_int as uint32_t) as libc::c_int;
    if P_ThingHeightClip(thing) != 0 {
        return true_0 as libc::c_int;
    }
    if (*thing).flags
        & (MF_SHOOTABLE as libc::c_int | MF_PUSHABLE as libc::c_int) as uint32_t == 0
        || (*thing).flags & MF_NOCLIPHEIGHT as libc::c_int as uint32_t != 0
    {
        return true_0 as libc::c_int;
    }
        ...
        && (*thing).z <= (*thing).ceilingz
    {
        if immunepushable != 0
            && (*thing).z + (*thing).height
                > (*(*(*thing).subsector).sector).ceilingheight
        {
            return false_0 as libc::c_int;
        }
        if !((*(*(*thing).subsector).sector).ffloors).is_null()
            && (realcrush != 0 || immunepushable != 0)
        {
            let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
            let mut topheight: fixed_t = 0;
            let mut bottomheight: fixed_t = 0;
            ...
            let mut delta2: fixed_t = 0;
            let mut thingtop: int32_t = (*thing).z + (*thing).height;
            rover = (*(*(*thing).subsector).sector).ffloors;
            while !rover.is_null() {
                            ...
                            & FOF_BLOCKPLAYER as libc::c_int as libc::c_uint == 0)
                    {
                                ...
                                & FOF_BLOCKOTHERS as libc::c_int as libc::c_uint == 0)
                        {
                            ...
                            if !(bottomheight > (*thing).ceilingz) {
                                delta1 = (*thing).z
                                    - (bottomheight + topheight) / 2 as libc::c_int;
                                delta2 = thingtop
                                    - (bottomheight + topheight) / 2 as libc::c_int;
                                if !(abs(delta1) < abs(delta2)) {
                                    ...
                                    if !(realcrush == 0) {
                                        think = (*thlist
                                            .as_mut_ptr()
                                            .offset(THINK_MAIN as libc::c_int as isize))
                                            .next;
                                        while think
                                            != &mut *thlist
                                                .as_mut_ptr()
                                                ...
                                                as *mut thinker_t
                                        {
                                            let mut crumbler: *mut crumble_t = 0 as *mut crumble_t;
                                            if !((*think).function.acp1
                                                != ::core::mem::transmute::<
                                                    Option::<unsafe extern "C" fn(*mut crumble_t) -> ()>,
                                                    actionf_p1,
                                                >(
                                                    Some(
                                                        T_StartCrumble as unsafe extern "C" fn(*mut crumble_t) -> (),
                                                    ),
                                                ))
                                            {
                                                crumbler = think as *mut crumble_t;
                                                if !((*crumbler).player).is_null() {
                                                    if !((*(*crumbler).player).mo).is_null() {
                                                        if !((*(*crumbler).player).mo == thing) {
                                                            if !((*crumbler).actionsector
        ...
        if realcrush != 0 {
            if netgame != 0 && !((*thing).player).is_null()
                && (*(*thing).player).spectator != 0
            {
                P_DamageMobj(
                    thing,
...
unsafe extern "C" fn P_CheckSectorPolyObjects(
    ...
    while i < (*sector).linecount {
        let mut x: int32_t = 0;
        let mut y: int32_t = 0;
        let mut po: *mut polyobj_t = (**((*sector).lines).offset(i as isize)).polyobj;
        if !po.is_null() {
            if !((*po).validcount == validcount) {
                if !((*po).flags & POF_SOLID as libc::c_int == 0) {
                    if !((**((*po).lines).offset(0 as libc::c_int as isize)).backsector
                        != sector)
                    {
                        (*po).validcount = validcount;
                        y = (*po).blockbox[BOXBOTTOM as libc::c_int as usize];
                        while y <= (*po).blockbox[BOXTOP as libc::c_int as usize] {
                            x = (*po).blockbox[BOXLEFT as libc::c_int as usize];
                            while x <= (*po).blockbox[BOXRIGHT as libc::c_int as usize] {
                                let mut mo: *mut mobj_t = 0 as *mut mobj_t;
                                if !(x < 0 as libc::c_int || y < 0 as libc::c_int
                                    || x >= bmapwidth || y >= bmapheight)
                                {
                                    mo = *blocklinks.offset((y * bmapwidth + x) as isize);
                                    while !mo.is_null() {
                                        if !(P_MobjInsidePolyobj(po, mo) == 0) {
                                            if PIT_ChangeSector(mo, realcrush, crunch) == 0
                                                && realcrush == 0
                                            {
                                                return false_0 as libc::c_int;
                                            }
...
unsafe extern "C" fn P_CheckTouchingThinglist(
    mut sector: *mut sector_t,
    mut realcrush: boolean,
    mut crunch: boolean,
) -> boolean {
    let mut n: *mut msecnode_t = 0 as *mut msecnode_t;
    n = (*sector).touching_thinglist;
    while !n.is_null() {
        (*n).visited = false_0 as libc::c_int;
        n = (*n).m_thinglist_next;
    }
    loop {
        n = (*sector).touching_thinglist;
        while !n.is_null() {
            if !((*n).visited != 0) {
                (*n).visited = true_0 as libc::c_int;
                if !((*(*n).m_thing).flags & MF_NOBLOCKMAP as libc::c_int as uint32_t
                    != 0)
                {
                    if PIT_ChangeSector((*n).m_thing, realcrush, crunch) == 0
                        && realcrush == 0
                    {
                        return false_0 as libc::c_int;
                    }
...
unsafe extern "C" fn P_CheckSectorFFloors(
    mut sector: *mut sector_t,
    mut realcrush: boolean,
    mut crunch: boolean,
) -> boolean {
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*sector).numattached {
        sec = &mut *sectors.offset(*((*sector).attached).offset(i as isize) as isize)
            as *mut sector_t;
        (*sec).moved = true_0 as libc::c_int;
        P_RecalcPrecipInSector(sec);
        if !(*((*sector).attachedsolid).offset(i as isize) == 0) {
            if P_CheckTouchingThinglist(sec, realcrush, crunch) == 0 {
                return false_0 as libc::c_int;
            }
        }
        i = i.wrapping_add(1);
...
unsafe extern "C" fn P_CheckSectorHelper(
    mut sector: *mut sector_t,
    mut realcrush: boolean,
    mut crunch: boolean,
) -> boolean {
    if P_CheckSectorPolyObjects(sector, realcrush, crunch) == 0 {
        return false_0 as libc::c_int;
    }
    if P_CheckSectorFFloors(sector, realcrush, crunch) == 0 {
        return false_0 as libc::c_int;
    }
...
#[no_mangle]
pub unsafe extern "C" fn P_CheckSector(
    mut sector: *mut sector_t,
    mut crunch: boolean,
) -> boolean {
    if P_CheckSectorHelper(sector, false_0 as libc::c_int, crunch) == 0 {
        return true_0 as libc::c_int;
    }
    P_CheckSectorHelper(sector, true_0 as libc::c_int, crunch);
    return false_0 as libc::c_int;
}
static mut headsecnode: *mut msecnode_t = 0 as *const msecnode_t as *mut msecnode_t;
static mut headprecipsecnode: *mut mprecipsecnode_t = 0 as *const mprecipsecnode_t
    as *mut mprecipsecnode_t;
#[no_mangle]
pub unsafe extern "C" fn P_Initsecnode() {
    headsecnode = 0 as *mut msecnode_t;
    headprecipsecnode = 0 as *mut mprecipsecnode_t;
}
unsafe extern "C" fn P_GetSecnode() -> *mut msecnode_t {
    let mut node: *mut msecnode_t = 0 as *mut msecnode_t;
    if !headsecnode.is_null() {
        node = headsecnode;
        headsecnode = (*headsecnode).m_thinglist_next;
    } else {
        node = Z_CallocAlign(
            ::core::mem::size_of::<msecnode_t>() as libc::c_ulong,
...
unsafe extern "C" fn P_GetPrecipSecnode() -> *mut mprecipsecnode_t {
    let mut node: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    if !headprecipsecnode.is_null() {
        node = headprecipsecnode;
        headprecipsecnode = (*headprecipsecnode).m_thinglist_next;
    } else {
        node = Z_CallocAlign(
            ::core::mem::size_of::<mprecipsecnode_t>() as libc::c_ulong,
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut mprecipsecnode_t;
...
#[inline]
unsafe extern "C" fn P_PutSecnode(mut node: *mut msecnode_t) {
    (*node).m_thinglist_next = headsecnode;
    headsecnode = node;
}
#[inline]
unsafe extern "C" fn P_PutPrecipSecnode(mut node: *mut mprecipsecnode_t) {
    (*node).m_thinglist_next = headprecipsecnode;
    headprecipsecnode = node;
}
unsafe extern "C" fn P_AddSecnode(
    mut s: *mut sector_t,
    mut thing: *mut mobj_t,
    mut nextnode: *mut msecnode_t,
) -> *mut msecnode_t {
    let mut node: *mut msecnode_t = 0 as *mut msecnode_t;
    node = nextnode;
    while !node.is_null() {
    ...
    node = P_GetSecnode();
    (*node).visited = 0 as libc::c_int;
    (*node).m_sector = s;
    (*node).m_thing = thing;
    (*node).m_sectorlist_prev = 0 as *mut msecnode_s;
    (*node).m_sectorlist_next = nextnode;
    if !nextnode.is_null() {
        (*nextnode).m_sectorlist_prev = node;
    }
    (*node).m_thinglist_prev = 0 as *mut msecnode_s;
    (*node).m_thinglist_next = (*s).touching_thinglist;
    if !((*s).touching_thinglist).is_null() {
        (*(*node).m_thinglist_next).m_thinglist_prev = node;
    }
    (*s).touching_thinglist = node;
    return node;
}
unsafe extern "C" fn P_AddPrecipSecnode(
    mut s: *mut sector_t,
    mut thing: *mut precipmobj_t,
    mut nextnode: *mut mprecipsecnode_t,
) -> *mut mprecipsecnode_t {
    let mut node: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    node = nextnode;
    while !node.is_null() {
        if (*node).m_sector == s {
    ...
    (*node).m_sector = s;
    (*node).m_thing = thing;
    (*node).m_sectorlist_prev = 0 as *mut mprecipsecnode_s;
    (*node).m_sectorlist_next = nextnode;
    if !nextnode.is_null() {
        (*nextnode).m_sectorlist_prev = node;
    }
    (*node).m_thinglist_prev = 0 as *mut mprecipsecnode_s;
    (*node).m_thinglist_next = (*s).touching_preciplist;
    if !((*s).touching_preciplist).is_null() {
        (*(*node).m_thinglist_next).m_thinglist_prev = node;
    }
    (*s).touching_preciplist = node;
    return node;
}
unsafe extern "C" fn P_DelSecnode(mut node: *mut msecnode_t) -> *mut msecnode_t {
    let mut tp: *mut msecnode_t = 0 as *mut msecnode_t;
    let mut tn: *mut msecnode_t = 0 as *mut msecnode_t;
    let mut sp: *mut msecnode_t = 0 as *mut msecnode_t;
    let mut sn: *mut msecnode_t = 0 as *mut msecnode_t;
    if node.is_null() {
        return 0 as *mut msecnode_t;
    }
...
unsafe extern "C" fn P_DelPrecipSecnode(
    mut node: *mut mprecipsecnode_t,
) -> *mut mprecipsecnode_t {
    let mut tp: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    let mut tn: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    let mut sp: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    let mut sn: *mut mprecipsecnode_t = 0 as *mut mprecipsecnode_t;
    if node.is_null() {
        return 0 as *mut mprecipsecnode_t;
    }
    tp = (*node).m_sectorlist_prev;
    tn = (*node).m_sectorlist_next;
    if !tp.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn P_DelSeclist(mut node: *mut msecnode_t) {
    while !node.is_null() {
        node = P_DelSecnode(node);
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_DelPrecipSeclist(mut node: *mut mprecipsecnode_t) {
    while !node.is_null() {
        node = P_DelPrecipSecnode(node);
    }
}
#[inline]
unsafe extern "C" fn PIT_GetSectors(mut ld: *mut line_t) -> boolean {
    if tmbbox[BOXRIGHT as libc::c_int as usize]
        <= (*ld).bbox[BOXLEFT as libc::c_int as usize]
        || tmbbox[BOXLEFT as libc::c_int as usize]
            >= (*ld).bbox[BOXRIGHT as libc::c_int as usize]
...
#[inline]
unsafe extern "C" fn PIT_GetPrecipSectors(mut ld: *mut line_t) -> boolean {
    if preciptmbbox[BOXRIGHT as libc::c_int as usize]
        <= (*ld).bbox[BOXLEFT as libc::c_int as usize]
        || preciptmbbox[BOXLEFT as libc::c_int as usize]
            >= (*ld).bbox[BOXRIGHT as libc::c_int as usize]
        || preciptmbbox[BOXTOP as libc::c_int as usize]
            <= (*ld).bbox[BOXBOTTOM as libc::c_int as usize]
        || preciptmbbox[BOXBOTTOM as libc::c_int as usize]
            >= (*ld).bbox[BOXTOP as libc::c_int as usize]
    {
        return true_0 as libc::c_int;
    }
    if P_BoxOnLineSide(preciptmbbox.as_mut_ptr(), ld) != -(1 as libc::c_int) {
        return true_0 as libc::c_int;
    }
    if !((*ld).polyobj).is_null() {
        return true_0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn P_CreateSecNodeList(
    mut thing: *mut mobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
) {
    ...
    let mut bx: int32_t = 0;
    let mut by: int32_t = 0;
    let mut node: *mut msecnode_t = sector_list;
    let mut saved_tmthing: *mut mobj_t = tmthing;
    let mut saved_tmx: fixed_t = tmx;
    let mut saved_tmy: fixed_t = tmy;
    while !node.is_null() {
        (*node).m_thing = 0 as *mut mobj_s;
        node = (*node).m_sectorlist_next;
    }
    P_SetTarget2(&mut tmthing, thing);
    tmflags = (*thing).flags as int32_t;
    ...
    while bx <= xh {
        ...
        while by <= yh {
            P_BlockLinesIterator(
                bx,
                by,
                Some(PIT_GetSectors as unsafe extern "C" fn(*mut line_t) -> boolean),
            );
            by += 1;
            by;
        }
    ...
    P_SetTarget2(&mut tmthing, saved_tmthing);
    tmx = saved_tmx;
    tmy = saved_tmy;
    if !tmthing.is_null() {
        tmbbox[BOXTOP as libc::c_int as usize] = tmy + (*tmthing).radius;
        tmbbox[BOXBOTTOM as libc::c_int as usize] = tmy - (*tmthing).radius;
        tmbbox[BOXRIGHT as libc::c_int as usize] = tmx + (*tmthing).radius;
        tmbbox[BOXLEFT as libc::c_int as usize] = tmx - (*tmthing).radius;
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_CreatePrecipSecNodeList(
    mut thing: *mut precipmobj_t,
    mut x: fixed_t,
    mut y: fixed_t,
) {
    ...
    let mut bx: int32_t = 0;
    let mut by: int32_t = 0;
    let mut node: *mut mprecipsecnode_t = precipsector_list;
    let mut saved_tmthing: *mut precipmobj_t = tmprecipthing;
    while !node.is_null() {
        (*node).m_thing = 0 as *mut precipmobj_s;
        node = (*node).m_sectorlist_next;
    }
    tmprecipthing = thing;
    preciptmbbox[BOXTOP as libc::c_int
        as usize] = y + 2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    preciptmbbox[BOXBOTTOM as libc::c_int
        as usize] = y - 2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    preciptmbbox[BOXRIGHT as libc::c_int
        as usize] = x + 2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    preciptmbbox[BOXLEFT as libc::c_int
        as usize] = x - 2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
    validcount = validcount.wrapping_add(1);
    validcount;
    xl = ((preciptmbbox[BOXLEFT as libc::c_int as usize] - bmaporgx) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    xh = ((preciptmbbox[BOXRIGHT as libc::c_int as usize] - bmaporgx) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    yl = ((preciptmbbox[BOXBOTTOM as libc::c_int as usize] - bmaporgy) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    yh = ((preciptmbbox[BOXTOP as libc::c_int as usize] - bmaporgy) as libc::c_uint
        >> 16 as libc::c_int + 7 as libc::c_int) as int32_t;
    if xl > xh {
        xl = 0 as libc::c_int;
    }
    ...
    while bx <= xh {
        ...
        while by <= yh {
            P_BlockLinesIterator(
                ...
                by,
                Some(
                    PIT_GetPrecipSectors as unsafe extern "C" fn(*mut line_t) -> boolean,
                ),
            );
            by += 1;
            by;
...
#[no_mangle]
pub unsafe extern "C" fn P_MapStart() {
    if !tmthing.is_null() {
        I_Error(b"P_MapStart: tmthing set!\0" as *const u8 as *const libc::c_char);
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_MapEnd() {
    P_SetTarget2(&mut tmthing, 0 as *mut mobj_t);
}
#[no_mangle]
pub unsafe extern "C" fn P_FloorzAtPos(
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
    mut height: fixed_t,
    ...
    let mut floorz: fixed_t = P_GetSectorFloorZAt(sec, x, y);
    if !((*sec).ffloors).is_null() {
        let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
        let mut delta1: fixed_t = 0;
        let mut delta2: fixed_t = 0;
        let mut thingtop: fixed_t = z + height;
        rover = (*sec).ffloors;
        while !rover.is_null() {
            let mut topheight: fixed_t = 0;
            let mut bottomheight: fixed_t = 0;
...
#[no_mangle]
pub unsafe extern "C" fn P_CeilingzAtPos(
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
    mut height: fixed_t,
    ...
    let mut sec: *mut sector_t = (*R_PointInSubsector(x, y)).sector;
    let mut ceilingz: fixed_t = P_GetSectorCeilingZAt(sec, x, y);
    if !((*sec).ffloors).is_null() {
        let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
        let mut delta1: fixed_t = 0;
        let mut delta2: fixed_t = 0;
