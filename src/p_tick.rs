...
extern "C" {
    ...
    static mut cv_freedemocamera: consvar_t;
    ...
    fn OP_FreezeObjectplace() -> boolean;
    fn OP_ObjectplaceMovement(player: *mut player_t);
    static mut clientGamedata: *mut gamedata_t;
    static mut serverGamedata: *mut gamedata_t;
    fn G_WriteMetalTic(metal: *mut mobj_t);
    fn G_ReadMetalTic(metal: *mut mobj_t);
    fn G_GhostTicker();
    fn G_ConsGhostTic();
    fn G_WriteGhostTic(ghost: *mut mobj_t);
    fn G_WriteDemoTiccmd(cmd: *mut ticcmd_t, playernum: int32_t);
    fn G_ReadDemoTiccmd(cmd: *mut ticcmd_t, playernum: int32_t);
    ...
    fn P_PrecipitationEffects();
    fn P_RespawnSpecials();
    fn P_RunOverlays();
    fn P_RunShields();
    fn P_PlayerAfterThink(player: *mut player_t);
    ...
    fn LUA_HookVoid(hook: libc::c_int);
    fn LUA_HookThinkFrame();
    static mut ps_playerthink_time: ps_metric_t;
    static mut ps_thinkertime: ps_metric_t;
    static mut ps_thlist_times: [ps_metric_t; 0];
    static mut ps_checkposition_calls: ps_metric_t;
    static mut ps_lua_thinkframe_time: ps_metric_t;
    static mut ps_lua_mobjhooks: ps_metric_t;
    fn I_GetPreciseTime() -> precise_t;
    fn R_SetupFrame(player: *mut player_t);
    fn R_SkyboxFrame(player: *mut player_t);
    static mut cv_skybox: consvar_t;
    fn R_UpdateViewInterpolation();
    fn R_ResetViewInterpolation(p: uint8_t);
    fn R_UpdateLevelInterpolators();
    fn R_DestroyLevelInterpolators(thinker: *mut thinker_t);
...
pub const SH_NOSTACK: C2RustUnnamed_1 = -513;
pub const SH_STACK: C2RustUnnamed_1 = 512;
pub const SH_FIREFLOWER: C2RustUnnamed_1 = 512;
pub const SH_FORCEHP: C2RustUnnamed_1 = 255;
pub const SH_FORCE: C2RustUnnamed_1 = 256;
pub const SH_THUNDERCOIN: C2RustUnnamed_1 = 4098;
pub const SH_BUBBLEWRAP: C2RustUnnamed_1 = 2049;
pub const SH_FLAMEAURA: C2RustUnnamed_1 = 1025;
pub const SH_ELEMENTAL: C2RustUnnamed_1 = 3073;
pub const SH_ATTRACT: C2RustUnnamed_1 = 4097;
pub const SH_PINK: C2RustUnnamed_1 = 4;
pub const SH_ARMAGEDDON: C2RustUnnamed_1 = 3;
pub const SH_WHIRLWIND: C2RustUnnamed_1 = 2;
pub const SH_PITY: C2RustUnnamed_1 = 1;
pub const SH_PROTECTSPIKE: C2RustUnnamed_1 = 8192;
pub const SH_PROTECTELECTRIC: C2RustUnnamed_1 = 4096;
pub const SH_PROTECTWATER: C2RustUnnamed_1 = 2048;
pub const SH_PROTECTFIRE: C2RustUnnamed_1 = 1024;
pub const SH_NONE: C2RustUnnamed_1 = 0;
...
pub const hook_PostThinkFrame: C2RustUnnamed_6 = 6;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const hook_PreThinkFrame: C2RustUnnamed_6 = 4;
...
pub const hook_MAX: C2RustUnnamed_6 = 30;
pub const hook_KeyUp: C2RustUnnamed_6 = 29;
pub const hook_KeyDown: C2RustUnnamed_6 = 28;
pub const hook_PlayerCanEnterSpinGaps: C2RustUnnamed_6 = 27;
pub const hook_PlayerHeight: C2RustUnnamed_6 = 26;
pub const hook_MusicChange: C2RustUnnamed_6 = 25;
pub const hook_PlayerCmd: C2RustUnnamed_6 = 24;
pub const hook_GameQuit: C2RustUnnamed_6 = 23;
pub const hook_PlayerThink: C2RustUnnamed_6 = 22;
pub const hook_SeenPlayer: C2RustUnnamed_6 = 21;
pub const hook_ViewpointSwitch: C2RustUnnamed_6 = 20;
pub const hook_TeamSwitch: C2RustUnnamed_6 = 19;
pub const hook_IntermissionThinker: C2RustUnnamed_6 = 18;
pub const hook_PlayerQuit: C2RustUnnamed_6 = 17;
pub const hook_PlayerCanDamage: C2RustUnnamed_6 = 16;
pub const hook_ShieldSpecial: C2RustUnnamed_6 = 15;
pub const hook_ShieldSpawn: C2RustUnnamed_6 = 14;
pub const hook_PlayerSpawn: C2RustUnnamed_6 = 13;
pub const hook_PlayerMsg: C2RustUnnamed_6 = 12;
pub const hook_BotTiccmd: C2RustUnnamed_6 = 11;
pub const hook_JumpSpinSpecial: C2RustUnnamed_6 = 10;
pub const hook_SpinSpecial: C2RustUnnamed_6 = 9;
pub const hook_AbilitySpecial: C2RustUnnamed_6 = 8;
pub const hook_JumpSpecial: C2RustUnnamed_6 = 7;
pub const hook_ThinkFrame: C2RustUnnamed_6 = 5;
pub const hook_PlayerJoin: C2RustUnnamed_6 = 3;
pub const hook_MapLoad: C2RustUnnamed_6 = 2;
pub const hook_MapChange: C2RustUnnamed_6 = 1;
pub const hook_NetVars: C2RustUnnamed_6 = 0;
#[inline]
...
#[no_mangle]
pub static mut leveltime: tic_t = 0;
#[no_mangle]
pub static mut thlist: [thinker_t; 5] = [thinker_s {
...
#[no_mangle]
pub unsafe extern "C" fn Command_Numthinkers_f() {
    let mut num: int32_t = 0;
    let mut count: int32_t = 0 as libc::c_int;
    let mut action: actionf_p1 = None;
    let mut think: *mut thinker_t = 0 as *mut thinker_t;
    let mut start: thinklistnum_t = THINK_POLYOBJ;
    let mut end: thinklistnum_t = (NUM_THINKERLISTS as libc::c_int - 1 as libc::c_int)
        as thinklistnum_t;
    let mut i: thinklistnum_t = THINK_POLYOBJ;
    ...
    if COM_Argc() < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"numthinkers <#>: Count number of thinkers\n\0" as *const u8
                as *const libc::c_char,
        );
        CONS_Printf(
    ...
    num = atoi(COM_Argv(1 as libc::c_int as size_t));
    match num {
        1 => {
            end = THINK_MOBJ;
            start = end;
            ...
            CONS_Printf(
                b"Number of %s: \0" as *const u8 as *const libc::c_char,
                b"P_MobjThinker\0" as *const u8 as *const libc::c_char,
            );
        }
        2 => {
            end = THINK_PRECIP;
            ...
            >(
                Some(
                    P_NullPrecipThinker as unsafe extern "C" fn(*mut precipmobj_t) -> (),
                ),
            );
            CONS_Printf(
                b"Number of %s: \0" as *const u8 as *const libc::c_char,
                b"P_NullPrecipThinker\0" as *const u8 as *const libc::c_char,
            );
        }
        3 => {
            end = THINK_MAIN;
            ...
            CONS_Printf(
                b"Number of %s: \0" as *const u8 as *const libc::c_char,
                b"T_Friction\0" as *const u8 as *const libc::c_char,
            );
        }
        4 => {
            end = THINK_MAIN;
            ...
            CONS_Printf(
                b"Number of %s: \0" as *const u8 as *const libc::c_char,
                b"T_Pusher\0" as *const u8 as *const libc::c_char,
            );
        }
        5 => {
            action = ::core::mem::transmute::<
            ...
            CONS_Printf(
                b"Number of %s: \0" as *const u8 as *const libc::c_char,
                b"P_RemoveThinkerDelayed\0" as *const u8 as *const libc::c_char,
            );
        }
        _ => {
            CONS_Printf(
                b"That is not a valid number.\n\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
    }
    i = start;
    while i as libc::c_uint <= end as libc::c_uint {
        think = thlist[i as usize].next;
        while think != &mut *thlist.as_mut_ptr().offset(i as isize) as *mut thinker_t {
...
#[no_mangle]
pub unsafe extern "C" fn Command_CountMobjs_f() {
    ...
    if COM_Argc() >= 2 as libc::c_int as size_t {
        ...
        while j < COM_Argc() {
            i = atoi(COM_Argv(j)) as mobjtype_t;
            if i as libc::c_uint >= NUMMOBJTYPES as libc::c_int as libc::c_uint {
                CONS_Printf(
                    b"Object number %d out of range (max %d).\n\0" as *const u8
                        as *const libc::c_char,
                    i as libc::c_uint,
                ...
                th = thlist[THINK_MOBJ as libc::c_int as usize].next;
                while th
                    != &mut *thlist
                        .as_mut_ptr()
                        .offset(THINK_MOBJ as libc::c_int as isize) as *mut thinker_t
                {
                    ...
                    {
                        if (*(th as *mut mobj_t)).type_0 as libc::c_uint
                            == i as libc::c_uint
                        {
                            count += 1;
                            count;
                ...
                CONS_Printf(
                    b"There are %d objects of type %d currently in the level.\n\0"
                        as *const u8 as *const libc::c_char,
                    count,
                    i as libc::c_uint,
                );
    ...
    CONS_Printf(
        b"Count of active objects in level:\n\0" as *const u8 as *const libc::c_char,
    );
    i = MT_NULL;
    while (i as libc::c_uint) < NUMMOBJTYPES as libc::c_int as libc::c_uint {
                ...
                as *mut thinker_t
        {
            ...
            {
                if (*(th as *mut mobj_t)).type_0 as libc::c_uint == i as libc::c_uint {
                    count += 1;
                    count;
                }
            }
...
pub unsafe extern "C" fn P_InitThinkers() {
    ...
    while (i as libc::c_int) < NUM_THINKERLISTS as libc::c_int {
        thlist[i as usize]
            .next = &mut *thlist.as_mut_ptr().offset(i as isize) as *mut thinker_t;
        thlist[i as usize].prev = thlist[i as usize].next;
        i = i.wrapping_add(1);
        i;
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_AddThinker(n: thinklistnum_t, mut thinker: *mut thinker_t) {
    (*thlist[n as usize].prev).next = thinker;
    (*thinker).next = &mut *thlist.as_mut_ptr().offset(n as isize) as *mut thinker_t;
    (*thinker).prev = thlist[n as usize].prev;
    thlist[n as usize].prev = thinker;
    (*thinker).references = 0 as libc::c_int;
}
static mut currentthinker: *mut thinker_t = 0 as *const thinker_t as *mut thinker_t;
#[no_mangle]
pub unsafe extern "C" fn P_RemoveThinkerDelayed(mut thinker: *mut thinker_t) {
    let mut next: *mut thinker_t = 0 as *mut thinker_t;
    if (*thinker).references != 0 as libc::c_int {
        return;
    }
    next = (*thinker).next;
    currentthinker = (*thinker).prev;
    (*next).prev = currentthinker;
    (*(*next).prev).next = next;
...
pub unsafe extern "C" fn P_RemoveThinker(mut thinker: *mut thinker_t) {
    LUA_InvalidateUserdata(thinker as *mut libc::c_void);
    (*thinker)
        .function
...
#[no_mangle]
pub unsafe extern "C" fn P_SetTarget2(
    mut mop: *mut *mut mobj_t,
    mut targ: *mut mobj_t,
) -> *mut mobj_t {
    if !(*mop).is_null() {
        (**mop).thinker.references -= 1;
        (**mop).thinker.references;
    }
    if !targ.is_null() {
        (*targ).thinker.references += 1;
...
#[inline]
unsafe extern "C" fn P_RunThinkers() {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < NUM_THINKERLISTS as libc::c_int as size_t {
        (*ps_thlist_times.as_mut_ptr().offset(i as isize)).value.p = I_GetPreciseTime();
        currentthinker = thlist[i as usize].next;
        while currentthinker
            != &mut *thlist.as_mut_ptr().offset(i as isize) as *mut thinker_t
        {
            ((*currentthinker).function.acp1)
                .expect(
                    "non-null function pointer",
                )(currentthinker as *mut libc::c_void);
            currentthinker = (*currentthinker).next;
        }
        (*ps_thlist_times.as_mut_ptr().offset(i as isize))
            .value
            .p = (I_GetPreciseTime())
            .wrapping_sub((*ps_thlist_times.as_mut_ptr().offset(i as isize)).value.p);
        i = i.wrapping_add(1);
        i;
    }
}
unsafe extern "C" fn P_DoAutobalanceTeams() {
    ...
    let mut redarray: [int32_t; 32] = [0; 32];
    let mut bluearray: [int32_t; 32] = [0; 32];
    let mut redflagcarrier: int32_t = 0 as libc::c_int;
    let mut blueflagcarrier: int32_t = 0 as libc::c_int;
    let mut totalred: int32_t = 0 as libc::c_int;
    let mut totalblue: int32_t = 0 as libc::c_int;
    NetPacket.value.b = 0 as libc::c_int as uint16_t;
    NetPacket.value.l = NetPacket.value.b;
    memset(
        redarray.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[int32_t; 32]>() as libc::c_ulong,
    );
    memset(
        bluearray.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[int32_t; 32]>() as libc::c_ulong,
    );
    if ::core::mem::size_of::<uint16_t>() as libc::c_ulong
        > GetFreeXCmdSize() as libc::c_ulong
    {
        return;
    }
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playeringame[i as usize] != 0 && players[i as usize].ctfteam != 0 {
            if players[i as usize].ctfteam == 1 as libc::c_int {
                if players[i as usize].gotflag == 0 {
                    redarray[red as usize] = i;
                    red += 1;
                    red;
                } else {
                    redflagcarrier += 1;
            ...
            } else if players[i as usize].gotflag == 0 {
                bluearray[blue as usize] = i;
                blue += 1;
                blue;
            } else {
                blueflagcarrier += 1;
    ...
    if abs(totalred - totalblue)
        > (if 1 as libc::c_int > (totalred + totalblue) / 8 as libc::c_int {
            1 as libc::c_int
        } else {
            (totalred + totalblue) / 8 as libc::c_int
        })
    {
        if totalred > totalblue {
            i = M_RandomKey(red);
            (NetPacket.packet).set_newteam(2 as libc::c_int as uint32_t);
            (NetPacket.packet).set_playernum(redarray[i as usize] as uint32_t);
            (NetPacket.packet).set_verification(true_0 as libc::c_int as uint32_t);
            (NetPacket.packet).set_autobalance(true_0 as libc::c_int as uint32_t);
            ...
            (NetPacket.packet).set_playernum(bluearray[i as usize] as uint32_t);
            (NetPacket.packet).set_verification(true_0 as libc::c_int as uint32_t);
            (NetPacket.packet).set_autobalance(true_0 as libc::c_int as uint32_t);
            usvalue = (NetPacket.value.l as libc::c_int
                | NetPacket.value.b as libc::c_int) as int16_t as uint16_t;
...
#[no_mangle]
pub unsafe extern "C" fn P_DoTeamscrambling() {
    let mut NetPacket: changeteam_union = changeteam_union {
        packet: changeteam_packet_t {
            playernum_newteam_verification_autobalance_scrambled: [0; 2],
        },
    ...
    if (scramblecount as libc::c_int) < scrambletotal as libc::c_int {
        if players[scrambleplayers[scramblecount as usize] as usize].ctfteam
            != scrambleteams[scramblecount as usize] as libc::c_int
        {
            (NetPacket.packet)
                .set_newteam(scrambleteams[scramblecount as usize] as uint32_t);
            (NetPacket.packet)
                .set_playernum(scrambleplayers[scramblecount as usize] as uint32_t);
            (NetPacket.packet).set_verification(true_0 as libc::c_int as uint32_t);
            (NetPacket.packet).set_scrambled(true_0 as libc::c_int as uint32_t);
            usvalue = (NetPacket.value.l as libc::c_int
                | NetPacket.value.b as libc::c_int) as int16_t as uint16_t;
            SendNetXCmd(
                XD_TEAMCHANGE,
        ...
        CV_SetValue(&mut cv_teamscramble, 0 as libc::c_int);
    };
}
#[inline]
unsafe extern "C" fn P_DoSpecialStageStuff() {
    let mut stillalive: boolean = false_0 as libc::c_int;
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0 || players[i as usize].spectator != 0) {
            ...
            players[i as usize]
                ...
                .powers[pw_spacetime as libc::c_int as usize];
        }
        i += 1;
        i;
    }
    if sstimer != 0 && objectplacing == 0 {
        let mut countspheres: uint16_t = 0 as libc::c_int as uint16_t;
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if playeringame[i as usize] != 0 {
                let mut oldnightstime: tic_t = players[i as usize].nightstime;
                countspheres = (countspheres as libc::c_int
                    + players[i as usize].spheres as libc::c_int) as uint16_t;
                if !(oldnightstime == 0) {
                            ...
                            }) == 0
                    {
                        players[i as usize]
                            ...
                            .wrapping_sub(5 as libc::c_int as tic_t);
                    }
                    players[i as usize]
                        .nightstime = (players[i as usize].nightstime).wrapping_sub(1);
                    if players[i as usize].nightstime > 6 as libc::c_int as tic_t {
                        if P_IsLocalPlayer(&mut *players.as_mut_ptr().offset(i as isize))
                            != 0
                            && oldnightstime
                        ...
                        stillalive = true_0 as libc::c_int;
                    } else if players[i as usize].exiting == 0 {
                        players[i as usize]
                        ...
                        players[i as usize].nightstime = 0 as libc::c_int as tic_t;
                        if P_IsLocalPlayer(&mut *players.as_mut_ptr().offset(i as isize))
                            != 0
                        {
        ...
        if stillalive != 0 {
            if countspheres as uint32_t >= ssspheres {
                i = 0 as libc::c_int;
                while i < 32 as libc::c_int {
                    if playeringame[i as usize] != 0 && players[i as usize].exiting == 0
                    {
                        (*players[i as usize].mo).momy = 0 as libc::c_int;
                ...
                sstimer = 0 as libc::c_int;
                P_GiveEmerald(true_0 as libc::c_int);
                P_RestoreMusic(
...
#[inline]
unsafe extern "C" fn P_DoTagStuff() {
    let mut i: int32_t = 0;
    ...
    {
        let mut participants: int32_t = 0 as libc::c_int;
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if playeringame[i as usize] != 0 && players[i as usize].spectator == 0 {
                participants += 1;
        ...
        while i < 32 as libc::c_int {
                        ...
                        as libc::c_uint == 0
            {
                P_AddPlayerScore(
                    ...
                    (participants / 2 as libc::c_int) as uint32_t,
                );
            }
            i += 1;
            i;
...
#[inline]
unsafe extern "C" fn P_DoCTFStuff() {
    if leveltime % (35 as libc::c_int * 5 as libc::c_int) as tic_t
        == 0 as libc::c_int as tic_t
    {
        if cv_autobalance.value != 0 && cv_teamscramble.value == 0
            && cv_allowteamchange.value != 0 && server != 0
        {
    ...
    if leveltime % (35 as libc::c_int / 7 as libc::c_int) as tic_t
        == 0 as libc::c_int as tic_t
    {
        if cv_teamscramble.value != 0 && server != 0 {
            P_DoTeamscrambling();
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn P_Ticker(mut run: boolean) {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playeringame[i as usize] != 0 {
            players[i as usize]
                .jointime = (players[i as usize].jointime).wrapping_add(1);
            players[i as usize].jointime;
            if players[i as usize].quittime != 0 {
                players[i as usize]
                    .quittime = (players[i as usize].quittime).wrapping_add(1);
                ...
                if server != 0
                    && players[i as usize].quittime
                        >= FixedMul(
                            cv_rejointimeout.value,
                            60 as libc::c_int * 35 as libc::c_int,
                        ) as tic_t
                    && players[i as usize].quittime % 35 as libc::c_int as tic_t == 0
                {
                    SendKick(i as uint8_t, 3 as libc::c_int as uint8_t);
                }
            }
        }
        i += 1;
    ...
    if run != 0 {
        ...
        if demorecording != 0 {
            G_WriteDemoTiccmd(
                &mut (*players.as_mut_ptr().offset(consoleplayer as isize)).cmd,
                0 as libc::c_int,
            );
        }
        if demoplayback != 0 {
            ...
            G_ReadDemoTiccmd(&mut (*p).cmd, 0 as libc::c_int);
            if cv_freedemocamera.value == 0 {
                P_ForceLocalAngle(
                    p,
                    (((*p).cmd.angleturn as libc::c_int) << 16 as libc::c_int) as angle_t,
                );
                localaiming = (*p).aiming as int32_t;
            }
        }
        ps_lua_mobjhooks.value.i = 0 as libc::c_int;
        ps_checkposition_calls.value.i = 0 as libc::c_int;
        LUA_HookVoid(hook_PreThinkFrame as libc::c_int);
        ps_playerthink_time.value.p = I_GetPreciseTime();
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if playeringame[i as usize] != 0 && !(players[i as usize].mo).is_null()
                && P_MobjWasRemoved(players[i as usize].mo) == 0
            {
                P_PlayerThink(&mut *players.as_mut_ptr().offset(i as isize));
            }
            i += 1;
            i;
        }
        ps_playerthink_time
            .value
            .p = (I_GetPreciseTime()).wrapping_sub(ps_playerthink_time.value.p);
    }
    if demoplayback == 0 {
        (*clientGamedata)
            .totalplaytime = ((*clientGamedata).totalplaytime).wrapping_add(1);
        (*clientGamedata).totalplaytime;
        (*serverGamedata)
            .totalplaytime = ((*serverGamedata).totalplaytime).wrapping_add(1);
    ...
    if runemeraldmanager != 0 {
        P_EmeraldManager();
    }
    if run != 0 {
        ps_thinkertime.value.p = I_GetPreciseTime();
        P_RunThinkers();
        ps_thinkertime
            .value
            .p = (I_GetPreciseTime()).wrapping_sub(ps_thinkertime.value.p);
        i = 0 as libc::c_int;
        while i < 32 as libc::c_int {
            if playeringame[i as usize] != 0 && !(players[i as usize].mo).is_null()
                && P_MobjWasRemoved(players[i as usize].mo) == 0
            {
                P_PlayerAfterThink(&mut *players.as_mut_ptr().offset(i as isize));
            }
            i += 1;
            i;
        }
        ps_lua_thinkframe_time.value.p = I_GetPreciseTime();
        LUA_HookThinkFrame();
        ps_lua_thinkframe_time
            .value
            .p = (I_GetPreciseTime()).wrapping_sub(ps_lua_thinkframe_time.value.p);
    }
    P_RunShields();
    P_RunOverlays();
    P_UpdateSpecials();
    ...
    timeinmap = timeinmap.wrapping_add(1);
    timeinmap;
    if G_TagGametype() != 0 {
        P_DoTagStuff();
    }
    ...
    if run != 0 {
        ...
        if countdown2 != 0 {
            countdown2 = countdown2.wrapping_sub(1);
            countdown2;
        }
        if quake.time != 0 {
            let mut ir: fixed_t = quake.intensity >> 1 as libc::c_int;
            quake.x = M_RandomRange(-ir, ir);
            quake.y = M_RandomRange(-ir, ir);
            quake.z = M_RandomRange(-ir, ir);
            quake.time = (quake.time).wrapping_sub(1);
            quake.time;
        } else {
            quake.z = 0 as libc::c_int;
            quake.y = quake.z;
            quake.x = quake.y;
        }
        ...
        if metalrecording != 0 {
            G_WriteMetalTic(players[consoleplayer as usize].mo);
        }
        if demorecording != 0 {
            G_WriteGhostTic(players[consoleplayer as usize].mo);
        }
        if demoplayback != 0 {
            G_ConsGhostTic();
        }
        ...
        LUA_HookVoid(hook_PostThinkFrame as libc::c_int);
    }
    if run != 0 {
        R_UpdateLevelInterpolators();
        R_UpdateViewInterpolation();
        if rendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint {
            let mut player1: *mut player_t = &mut *players
                .as_mut_ptr()
                .offset(displayplayer as isize) as *mut player_t;
            if !((*player1).mo).is_null()
                && !(skyboxmo[0 as libc::c_int as usize]).is_null()
                && cv_skybox.value != 0
            {
            ...
            if splitscreen != 0 {
                let mut player2: *mut player_t = &mut *players
                    .as_mut_ptr()
                    .offset(secondarydisplayplayer as isize) as *mut player_t;
                if !((*player2).mo).is_null()
                    && !(skyboxmo[0 as libc::c_int as usize]).is_null()
                    && cv_skybox.value != 0
                {
...
#[no_mangle]
pub unsafe extern "C" fn P_PreTicker(mut frames: int32_t) {
    let mut i: int32_t = 0;
    let mut framecnt: int32_t = 0;
    let mut temptic: ticcmd_t = ticcmd_t {
        forwardmove: 0,
        sidemove: 0,
        angleturn: 0,
        aiming: 0,
    ...
    while framecnt < frames {
        ...
        while i < 32 as libc::c_int {
            ...
            {
                memcpy(
                    &mut temptic as *mut ticcmd_t as *mut libc::c_void,
                    &mut (*players.as_mut_ptr().offset(i as isize)).cmd as *mut ticcmd_t
                ...
                players[i as usize]
                    ...
                    + (temptic.angleturn as libc::c_int
                        - players[i as usize].oldrelangleturn as libc::c_int))
                    as int16_t;
                players[i as usize].oldrelangleturn = temptic.angleturn;
                players[i as usize].cmd.angleturn = players[i as usize].angleturn;
                P_PlayerThink(&mut *players.as_mut_ptr().offset(i as isize));
                memcpy(
                    &mut (*players.as_mut_ptr().offset(i as isize)).cmd as *mut ticcmd_t
                        as *mut libc::c_void,
                    &mut temptic as *mut ticcmd_t as *const libc::c_void,
                    ::core::mem::size_of::<ticcmd_t>() as libc::c_ulong,
                );
            }
            i += 1;
