...
extern "C" {
    ...
    static mut actionsoverridden: [[libc::c_int; 30]; 267];
    ...
    fn P_GetFFloorID(fflr: *mut ffloor_t) -> uint16_t;
    fn P_GetFFloorByID(sec: *mut sector_t, id: uint16_t) -> *mut ffloor_t;
    ...
    fn LUA_GetActionNumByName(actiontocompare: *const libc::c_char) -> actionnum;
    fn LUA_InputLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_HudLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_BlockmapLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_PolyObjLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_TagLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_MapLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_ThinkerLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_SkinLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_PlayerLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_MobjLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_InfoLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_ConsoleLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_HookLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_MathLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_BaseLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_SOCLib(L: *mut lua_State) -> libc::c_int;
    fn LUA_EnumLib(L: *mut lua_State) -> libc::c_int;
    static mut wadfiles: *mut *mut wadfile_t;
    fn W_ReadLumpPwad(wad: uint16_t, lump: uint16_t, dest: *mut libc::c_void);
    fn W_LumpLengthPwad(wad: uint16_t, lump: uint16_t) -> size_t;
    static mut skins: [skin_t; 32];
    fn LUA_HookNetArchive(archFunc: lua_CFunction);
    fn LUA_InsertTaggroupIterator(
        L: *mut lua_State,
    ...
    fn P_FindNewPosition(oldposition: uint32_t) -> *mut mobj_t;
    static mut save_p: *mut uint8_t;
    static mut slopelist: *mut pslope_t;
    fn P_SlopeById(id: uint16_t) -> *mut pslope_t;
}
...
pub const NUM_THINKERLISTS: C2RustUnnamed_4 = 5;
pub const THINK_PRECIP: C2RustUnnamed_4 = 4;
pub const THINK_DYNSLOPE: C2RustUnnamed_4 = 3;
pub const THINK_MOBJ: C2RustUnnamed_4 = 2;
pub const THINK_MAIN: C2RustUnnamed_4 = 1;
pub const THINK_POLYOBJ: C2RustUnnamed_4 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct camera_s {
    pub chase: boolean,
...
pub const ARCH_TEND: C2RustUnnamed_6 = 255;
pub const ARCH_NULL: C2RustUnnamed_6 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct skin_t {
...
pub const ARCH_SKIN: C2RustUnnamed_6 = 25;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mouse_t {
    pub dx: int32_t,
...
pub const ARCH_MOUSE: C2RustUnnamed_6 = 24;
pub const ARCH_SKINCOLOR: C2RustUnnamed_6 = 23;
pub const ARCH_MAPHEADER: C2RustUnnamed_6 = 22;
pub const ARCH_SLOPE: C2RustUnnamed_6 = 21;
pub const ARCH_POLYOBJ: C2RustUnnamed_6 = 20;
pub const ARCH_FFLOOR: C2RustUnnamed_6 = 19;
pub const ARCH_SECTOR: C2RustUnnamed_6 = 18;
pub const ARCH_SUBSECTOR: C2RustUnnamed_6 = 17;
pub const ARCH_SIDE: C2RustUnnamed_6 = 16;
pub const ARCH_LINE: C2RustUnnamed_6 = 15;
pub const ARCH_VERTEX: C2RustUnnamed_6 = 14;
pub const ARCH_MAPTHING: C2RustUnnamed_6 = 13;
pub const ARCH_PLAYER: C2RustUnnamed_6 = 12;
pub const ARCH_MOBJ: C2RustUnnamed_6 = 11;
pub const ARCH_STATE: C2RustUnnamed_6 = 10;
pub const ARCH_MOBJINFO: C2RustUnnamed_6 = 9;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const ARCH_TABLE: C2RustUnnamed_6 = 8;
pub const ARCH_LARGESTRING: C2RustUnnamed_6 = 7;
pub const ARCH_SMALLSTRING: C2RustUnnamed_6 = 6;
pub const ARCH_INT32: C2RustUnnamed_6 = 5;
pub const ARCH_INT16: C2RustUnnamed_6 = 4;
pub const ARCH_INT8: C2RustUnnamed_6 = 3;
pub const ARCH_FALSE: C2RustUnnamed_6 = 2;
pub const ARCH_TRUE: C2RustUnnamed_6 = 1;
pub const LPUSHED_NEW: lpushed_t = 1;
pub type lpushed_t = libc::c_uint;
pub const LPUSHED_EXISTING: lpushed_t = 2;
pub const LPUSHED_NIL: lpushed_t = 0;
...
#[no_mangle]
pub static mut gL: *mut lua_State = 0 as *const lua_State as *mut lua_State;
static mut liblist: [lua_CFunction; 18] = unsafe {
    [
        Some(LUA_EnumLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_SOCLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_BaseLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_MathLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_HookLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_ConsoleLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_InfoLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_MobjLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_PlayerLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_SkinLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_ThinkerLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_MapLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_TagLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_PolyObjLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_BlockmapLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_HudLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        Some(LUA_InputLib as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        None,
    ]
};
unsafe extern "C" fn LUA_Alloc(
    ...
    if nsize == 0 as libc::c_int as size_t {
        if osize != 0 as libc::c_int as size_t {
            Z_Free(ptr);
        }
        return 0 as *mut libc::c_void;
    } else {
        return Z_ReallocAlign(
            ptr,
            nsize,
            PU_LUA as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        )
    };
}
unsafe extern "C" fn LUA_Panic(mut L: *mut lua_State) -> ! {
    CONS_Alert(
        CONS_ERROR,
    ...
    I_Error(
        b"An unfortunate Lua processing error occurred in the exe itself. This is not a scripting error on your part.\0"
            as *const u8 as *const libc::c_char,
    );
}
#[no_mangle]
pub unsafe extern "C" fn LUA_GetErrorMessage(mut L: *mut lua_State) -> libc::c_int {
    let mut level: libc::c_int = 1 as libc::c_int;
    let mut firstpart: libc::c_int = 1 as libc::c_int;
    ...
    lua_pushlstring(
        L,
        b"\nstack traceback:\0" as *const u8 as *const libc::c_char,
    ...
    loop {
        let fresh0 = level;
        level = level + 1;
        if !(lua_getstack(L, fresh0, &mut ar) != 0) {
            break;
        }
        if level > 12 as libc::c_int && firstpart != 0 {
            ...
            lua_getinfo(L, b"Snl\0" as *const u8 as *const libc::c_char, &mut ar);
            lua_pushfstring(
                L,
            ...
            if *ar.namewhat as libc::c_int != '\0' as i32 {
                lua_pushfstring(
                    L,
                    b" in function '%s'\0" as *const u8 as *const libc::c_char,
                    ar.name,
                );
            } else if *ar.what as libc::c_int == 'm' as i32 {
                lua_pushfstring(
                    L,
                    b" in main chunk\0" as *const u8 as *const libc::c_char,
                );
            } else if *ar.what as libc::c_int == 'C' as i32
                || *ar.what as libc::c_int == 't' as i32
            {
                lua_pushlstring(
                    L,
                ...
                lua_pushfstring(
                    L,
                    b" in function <%s:%d>\0" as *const u8 as *const libc::c_char,
                    (ar.short_src).as_mut_ptr(),
                    ar.linedefined,
                );
            }
...
pub unsafe extern "C" fn LUA_Call(
    ...
    mut errorhandlerindex: libc::c_int,
) -> libc::c_int {
    let mut err: libc::c_int = lua_pcall(L, nargs, nresults, errorhandlerindex);
    if err != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"%s\n\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn LUA_PushGlobals(
    mut L: *mut lua_State,
    mut word: *const libc::c_char,
) -> libc::c_int {
    if fastcmp(word, b"gamemap\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, gamemap as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"udmf\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, udmf);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"maptol\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, maptol as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"ultimatemode\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(
            L,
            (ultimatemode as libc::c_int != 0 as libc::c_int) as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mariomode\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(
            L,
            (maptol & TOL_MARIO as libc::c_int as uint32_t
                != 0 as libc::c_int as uint32_t) as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"twodlevel\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(
            L,
            (maptol & TOL_2D as libc::c_int as uint32_t != 0 as libc::c_int as uint32_t)
                as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"circuitmap\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, circuitmap);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"stoppedclock\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, stoppedclock);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"netgame\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, netgame);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"multiplayer\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, multiplayer);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"modeattacking\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushboolean(L, modeattacking as libc::c_int);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"metalrecording\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushboolean(L, metalrecording);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"splitscreen\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, splitscreen);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gamecomplete\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(
            L,
            (gamecomplete as libc::c_int != 0 as libc::c_int) as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"marathonmode\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, marathonmode as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"devparm\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, devparm);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"modifiedgame\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, (modifiedgame != 0 && savemoddata == 0) as libc::c_int);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"usedCheats\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, usedCheats);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"menuactive\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, menuactive);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"paused\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, paused as libc::c_int);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"bluescore\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, bluescore as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"redscore\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, redscore as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"timelimit\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, cv_timelimit.value);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"pointlimit\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, cv_pointlimit.value);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"redflag\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            redflag as *mut libc::c_void,
            b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"blueflag\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            blueflag as *mut libc::c_void,
            b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"rflagpoint\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            rflagpoint as *mut libc::c_void,
            b"MAPTHING_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"bflagpoint\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            bflagpoint as *mut libc::c_void,
            b"MAPTHING_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"spstage_start\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, spstage_start as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"spmarathon_start\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, spmarathon_start as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"sstage_start\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, sstage_start as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"sstage_end\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, sstage_end as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"smpstage_start\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, smpstage_start as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"smpstage_end\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, smpstage_end as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"titlemap\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, titlemap as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"titlemapinaction\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushboolean(
            L,
            (titlemapinaction as libc::c_int != TITLEMAP_OFF as libc::c_int)
                as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"bootmap\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, bootmap as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"tutorialmap\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, tutorialmap as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"tutorialmode\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, tutorialmode);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"skincolor_redteam\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, skincolor_redteam as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"skincolor_blueteam\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, skincolor_blueteam as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"skincolor_redring\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, skincolor_redring as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"skincolor_bluering\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, skincolor_bluering as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"invulntics\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, invulntics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"sneakertics\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, sneakertics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"flashingtics\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, flashingtics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"tailsflytics\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, tailsflytics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"underwatertics\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, underwatertics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"spacetimetics\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, spacetimetics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"extralifetics\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, extralifetics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"nightslinktics\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, nightslinktics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gameovertics\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, gameovertics);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"ammoremovaltics\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, ammoremovaltics as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"use1upSound\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, use1upSound as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"maxXtraLife\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, maxXtraLife as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"useContinues\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, useContinues as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"shareEmblems\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, shareEmblems as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gametype\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, gametype as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gametyperules\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, gametyperules as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"leveltime\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, leveltime as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"sstimer\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, sstimer);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"curWeather\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, curWeather);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"globalweather\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, globalweather as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"levelskynum\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, levelskynum);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"globallevelskynum\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushnumber(L, globallevelskynum);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mapmusname\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushstring(L, mapmusname.as_mut_ptr());
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mapmusflags\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, mapmusflags as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mapmusposition\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushnumber(L, mapmusposition as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"consoleplayer\0" as *const u8 as *const libc::c_char) != 0
    {
        if addedtogame == 0 || consoleplayer < 0 as libc::c_int
            || playeringame[consoleplayer as usize] == 0
        {
        ...
        return 1 as libc::c_int;
    } else if fastcmp(word, b"displayplayer\0" as *const u8 as *const libc::c_char) != 0
    {
        if displayplayer < 0 as libc::c_int || playeringame[displayplayer as usize] == 0
        {
            return 0 as libc::c_int;
        }
        LUA_PushUserdata(
        ...
        word,
        b"secondarydisplayplayer\0" as *const u8 as *const libc::c_char,
    ) != 0
    {
        if splitscreen == 0 || secondarydisplayplayer < 0 as libc::c_int
            || playeringame[secondarydisplayplayer as usize] == 0
        {
            return 0 as libc::c_int;
        }
        LUA_PushUserdata(
            ...
            &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                as *mut player_t as *mut libc::c_void,
            b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"isserver\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, server);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"isdedicatedserver\0" as *const u8 as *const libc::c_char)
        != 0
    {
        lua_pushboolean(L, dedicated);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"server\0" as *const u8 as *const libc::c_char) != 0 {
        if (multiplayer == 0 || netgame == 0) && playeringame[serverplayer as usize] == 0
        {
            return 0 as libc::c_int;
        }
        LUA_PushUserdata(
            L,
            &mut *players.as_mut_ptr().offset(serverplayer as isize) as *mut player_t
                as *mut libc::c_void,
            b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"emeralds\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, emeralds as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gravity\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, gravity);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"VERSION\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, VERSION);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"SUBVERSION\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, SUBVERSION);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"VERSIONSTRING\0" as *const u8 as *const libc::c_char) != 0
    {
        lua_pushstring(L, b"v2.2.13\0" as *const u8 as *const libc::c_char);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"token\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, token as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"gamestate\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, gamestate as lua_Number);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"stagefailed\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushboolean(L, stagefailed);
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mouse\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            &mut mouse as *mut mouse_t as *mut libc::c_void,
            b"MOUSE_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"mouse2\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            &mut mouse2 as *mut mouse_t as *mut libc::c_void,
            b"MOUSE_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"camera\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            &mut camera as *mut camera_t as *mut libc::c_void,
            b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    } else if fastcmp(word, b"camera2\0" as *const u8 as *const libc::c_char) != 0 {
        if splitscreen == 0 {
            return 0 as libc::c_int;
        }
        LUA_PushUserdata(
            L,
            &mut camera2 as *mut camera_t as *mut libc::c_void,
            b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
        );
        return 1 as libc::c_int;
    }
...
#[no_mangle]
pub unsafe extern "C" fn LUA_CheckGlobals(
    mut L: *mut lua_State,
    mut word: *const libc::c_char,
) -> libc::c_int {
    if fastcmp(word, b"redscore\0" as *const u8 as *const libc::c_char) != 0 {
        redscore = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    } else if fastcmp(word, b"bluescore\0" as *const u8 as *const libc::c_char) != 0 {
        bluescore = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    } else if fastcmp(word, b"skincolor_redteam\0" as *const u8 as *const libc::c_char)
        != 0
    {
        skincolor_redteam = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"skincolor_blueteam\0" as *const u8 as *const libc::c_char)
        != 0
    {
        skincolor_blueteam = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"skincolor_redring\0" as *const u8 as *const libc::c_char)
        != 0
    {
        skincolor_redring = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"skincolor_bluering\0" as *const u8 as *const libc::c_char)
        != 0
    {
        skincolor_bluering = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"emeralds\0" as *const u8 as *const libc::c_char) != 0 {
        emeralds = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"token\0" as *const u8 as *const libc::c_char) != 0 {
        token = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    } else if fastcmp(word, b"gravity\0" as *const u8 as *const libc::c_char) != 0 {
        gravity = luaL_checknumber(L, 2 as libc::c_int);
    } else if fastcmp(word, b"stoppedclock\0" as *const u8 as *const libc::c_char) != 0 {
        stoppedclock = luaL_checkboolean(L, 2 as libc::c_int);
    } else if fastcmp(word, b"displayplayer\0" as *const u8 as *const libc::c_char) != 0
    {
        ...
        if !player.is_null() {
            displayplayer = player.offset_from(players.as_mut_ptr()) as libc::c_long
                as int32_t;
        }
    } else if fastcmp(word, b"mapmusname\0" as *const u8 as *const libc::c_char) != 0 {
        ...
        if strlength > 6 as libc::c_int as size_t {
            return luaL_error(
                L,
                b"string length out of range (maximum 6 characters)\0" as *const u8
        ...
        if strlen(str) < strlength {
            return luaL_error(
                L,
                b"string must not contain embedded zeros!\0" as *const u8
                    as *const libc::c_char,
            );
        }
        strlcpy(
        ...
        mapmusflags = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    } else if fastcmp(word, b"stagefailed\0" as *const u8 as *const libc::c_char) != 0 {
        stagefailed = luaL_checkboolean(L, 2 as libc::c_int);
    } else {
        return 0 as libc::c_int
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn setglobals(mut L: *mut lua_State) -> libc::c_int {
    let mut csname: *const libc::c_char = 0 as *const libc::c_char;
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut actionnum: actionnum = A_EXPLODE;
    lua_remove(L, 1 as libc::c_int);
    csname = lua_tolstring(L, 1 as libc::c_int, 0 as *mut size_t);
    name = Z_StrDup(csname);
    strupr(name);
    if fastncmp(
        name,
        b"A_\0" as *const u8 as *const libc::c_char,
        2 as libc::c_int as uint16_t,
    ) != 0 && lua_type(L, 2 as libc::c_int) == 6 as libc::c_int
    {
        lua_getfield(
            L,
            -(10000 as libc::c_int),
            b"MOBJ_ACTION\0" as *const u8 as *const libc::c_char,
        );
        lua_pushstring(L, name);
        lua_pushvalue(L, 2 as libc::c_int);
        lua_rawset(L, -(3 as libc::c_int));
        actionnum = LUA_GetActionNumByName(name);
        if (actionnum as libc::c_uint) < NUMACTIONS as libc::c_int as libc::c_uint {
            let mut i: libc::c_int = 0;
            i = 30 as libc::c_int - 1 as libc::c_int;
            while i > 0 as libc::c_int {
                actionsoverridden[actionnum
                    as usize][i
                    as usize] = actionsoverridden[actionnum
                    as usize][(i - 1 as libc::c_int) as usize];
                i -= 1;
                i;
            }
            lua_pushvalue(L, 2 as libc::c_int);
            actionsoverridden[actionnum
                ...
                as usize] = luaL_ref(L, -(10000 as libc::c_int));
        }
        Z_Free(name as *mut libc::c_void);
        return 0 as libc::c_int;
    }
    if LUA_CheckGlobals(L, csname) != 0 {
        return 0 as libc::c_int;
    }
    Z_Free(name as *mut libc::c_void);
    return luaL_error(
        L,
        b"Implicit global '%s' prevented. Create a local variable instead.\0"
            as *const u8 as *const libc::c_char,
        csname,
    );
}
unsafe extern "C" fn LUA_ClearState() {
    let mut L: *mut lua_State = 0 as *mut lua_State;
    let mut i: libc::c_int = 0;
    if !gL.is_null() {
        lua_close(gL);
    }
    gL = 0 as *mut lua_State;
    CONS_Printf(
        b"Pardon me while I initialize the Lua scripting interface...\n\0" as *const u8
            as *const libc::c_char,
    );
    L = lua_newstate(
        Some(
    ...
    lua_atpanic(
        L,
        ::core::mem::transmute::<
            Option::<unsafe extern "C" fn(*mut lua_State) -> !>,
            lua_CFunction,
        >(Some(LUA_Panic as unsafe extern "C" fn(*mut lua_State) -> !)),
    );
    luaL_openlibs(L);
    ...
    lua_setfield(
        L,
        -(10000 as libc::c_int),
        b"VALID_USERDATA\0" as *const u8 as *const libc::c_char,
    );
    lua_createtable(L, 0 as libc::c_int, 0 as libc::c_int);
    lua_setfield(
        L,
    ...
    i = 0 as libc::c_int;
    while (liblist[i as usize]).is_some() {
        lua_pushcclosure(L, liblist[i as usize], 0 as libc::c_int);
        lua_call(L, 0 as libc::c_int, 0 as libc::c_int);
        i += 1;
        i;
    }
    lua_getmetatable(L, -(10002 as libc::c_int));
    lua_pushcclosure(
        L,
        Some(setglobals as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
...
#[no_mangle]
pub static mut lua_lumploading: int32_t = 0 as libc::c_int;
#[inline]
unsafe extern "C" fn LUA_LoadFile(
    mut f: *mut MYFILE,
    mut name: *mut libc::c_char,
    mut noresults: boolean,
) {
    let mut errorhandlerindex: libc::c_int = 0;
    if name.is_null() {
        name = (**wadfiles.offset((*f).wad as isize)).filename;
    }
    CONS_Printf(
        b"Loading Lua script from %s\n\0" as *const u8 as *const libc::c_char,
        name,
    );
    if gL.is_null() {
        LUA_ClearState();
    }
    lua_pushnumber(gL, (*f).wad as lua_Number);
    lua_setfield(
        gL,
        -(10000 as libc::c_int),
    ...
    if luaL_loadbuffer(
        ...
        (*f).data,
        (*f).size,
        va(b"@%s\0" as *const u8 as *const libc::c_char, name),
    ) != 0
        || lua_pcall(
            gL,
            0 as libc::c_int,
            (if noresults != 0 { 0 as libc::c_int } else { -(1 as libc::c_int) }),
            lua_gettop(gL) - 1 as libc::c_int,
        ) != 0
    {
        CONS_Alert(
            CONS_WARNING,
            b"%s\n\0" as *const u8 as *const libc::c_char,
            lua_tolstring(gL, -(1 as libc::c_int), 0 as *mut size_t),
        );
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    }
    lua_gc(gL, 2 as libc::c_int, 0 as libc::c_int);
    lua_remove(gL, errorhandlerindex);
    lua_lumploading -= 1;
    lua_lumploading;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_LoadLump(
    mut wad: uint16_t,
    mut lump: uint16_t,
    mut noresults: boolean,
) {
    let mut f: MYFILE = MYFILE {
        data: 0 as *mut libc::c_char,
        curpos: 0 as *mut libc::c_char,
        size: 0,
        wad: 0,
    };
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    W_ReadLumpPwad(wad, lump, f.data as *mut libc::c_void);
    f.curpos = f.data;
    len = strlen((**wadfiles.offset(wad as isize)).filename);
    if (**wadfiles.offset(wad as isize)).type_0 as libc::c_uint
        == RET_LUA as libc::c_int as libc::c_uint
    {
        name = malloc(len.wrapping_add(1 as libc::c_int as size_t)) as *mut libc::c_char;
        strcpy(name, (**wadfiles.offset(wad as isize)).filename);
    } else {
        let mut lump_p: *mut lumpinfo_t = &mut *((**wadfiles.offset(wad as isize))
            .lumpinfo)
            .offset(lump as isize) as *mut lumpinfo_t;
        ...
        sprintf(
            ...
            (**wadfiles.offset(wad as isize)).filename,
            (*lump_p).fullname,
        );
        *name.offset(len as isize) = '\0' as i32 as libc::c_char;
    }
    LUA_LoadFile(&mut f, name, noresults);
    free(name as *mut libc::c_void);
    Z_Free(f.data as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn LUA_EvalMath(mut word: *const libc::c_char) -> fixed_t {
    static mut L: *mut lua_State = 0 as *const lua_State as *mut lua_State;
    let mut buf: [libc::c_char; 1024] = [0; 1024];
    let mut b: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    let mut res: fixed_t = 0 as libc::c_int;
    if L.is_null() {
        L = lua_newstate(
            Some(
                LUA_Alloc
    ...
    strcpy(buf.as_mut_ptr(), b"return \0" as *const u8 as *const libc::c_char);
    b = buf.as_mut_ptr().offset(strlen(buf.as_mut_ptr()) as isize);
    p = word;
    while *p as libc::c_int != 0
        && b
            < &mut *buf.as_mut_ptr().offset(1022 as libc::c_int as isize)
                as *mut libc::c_char
    {
        let fresh1 = b;
        b = b.offset(1);
    ...
    *b = '\0' as i32 as libc::c_char;
    lua_settop(L, 0 as libc::c_int);
    if luaL_loadstring(L, buf.as_mut_ptr()) != 0
        || lua_pcall(L, 0 as libc::c_int, -(1 as libc::c_int), 0 as libc::c_int) != 0
    {
        p = lua_tolstring(L, -(1 as libc::c_int), 0 as *mut size_t);
        loop {
            let fresh3 = p;
            p = p.offset(1);
            if !(*fresh3 as libc::c_int != ':' as i32 && *p as libc::c_int != 0) {
                break;
            }
        }
        p = p.offset(3 as libc::c_int as isize);
        CONS_Alert(CONS_WARNING, b"%s\n\0" as *const u8 as *const libc::c_char, p);
    } else {
        res = lua_tonumber(L, -(1 as libc::c_int));
    }
    return res;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_PushUserdata(
    mut L: *mut lua_State,
    mut data: *mut libc::c_void,
    mut meta: *const libc::c_char,
) {
    if LUA_RawPushUserdata(L, data) as libc::c_uint
        == LPUSHED_NEW as libc::c_int as libc::c_uint
    {
        lua_getfield(L, -(10000 as libc::c_int), meta);
        lua_setmetatable(L, -(2 as libc::c_int));
    }
}
#[no_mangle]
pub unsafe extern "C" fn LUA_RawPushUserdata(
    mut L: *mut lua_State,
    mut data: *mut libc::c_void,
) -> lpushed_t {
    let mut status: lpushed_t = LPUSHED_NIL;
    let mut userdata: *mut *mut libc::c_void = 0 as *mut *mut libc::c_void;
    if data.is_null() {
        lua_pushnil(L);
        return status;
    }
...
#[no_mangle]
pub unsafe extern "C" fn LUA_InvalidateUserdata(mut data: *mut libc::c_void) {
    let mut userdata: *mut *mut libc::c_void = 0 as *mut *mut libc::c_void;
    if gL.is_null() {
        return;
    }
    ...
    lua_rawget(gL, -(2 as libc::c_int));
    if lua_type(gL, -(1 as libc::c_int)) == 0 as libc::c_int {
        lua_settop(gL, -(2 as libc::c_int) - 1 as libc::c_int);
        return;
    }
    lua_getfield(
        gL,
    ...
    lua_pushlightuserdata(gL, data);
    lua_pushnil(gL);
    lua_rawset(gL, -(3 as libc::c_int));
    lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    userdata = lua_touserdata(gL, -(1 as libc::c_int)) as *mut *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn LUA_InvalidateLevel() {
    ...
    while i < NUM_THINKERLISTS as libc::c_int as size_t {
        th = (*thlist.as_mut_ptr().offset(i as isize)).next;
        while !th.is_null()
            && th != &mut *thlist.as_mut_ptr().offset(i as isize) as *mut thinker_t
        {
            LUA_InvalidateUserdata(th as *mut libc::c_void);
            th = (*th).next;
        }
        i = i.wrapping_add(1);
        i;
    ...
    while i < numsectors {
        ...
        LUA_InvalidateUserdata(
            &mut (*sectors.offset(i as isize)).lines as *mut *mut *mut line_s
                as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            &mut (*sectors.offset(i as isize)).tags as *mut taglist_t
                as *mut libc::c_void,
        );
        if !((*sectors.offset(i as isize)).ffloors).is_null() {
            rover = (*sectors.offset(i as isize)).ffloors;
            while !rover.is_null() {
                LUA_InvalidateUserdata(rover as *mut libc::c_void);
                rover = (*rover).next;
            }
        }
        i = i.wrapping_add(1);
    ...
    while i < numlines {
        ...
        LUA_InvalidateUserdata(
            &mut (*lines.offset(i as isize)).tags as *mut taglist_t as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            ((*lines.offset(i as isize)).args).as_mut_ptr() as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            ((*lines.offset(i as isize)).stringargs).as_mut_ptr() as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            ((*lines.offset(i as isize)).sidenum).as_mut_ptr() as *mut libc::c_void,
        );
        i = i.wrapping_add(1);
        i;
    }
    ...
    i = 0 as libc::c_int as size_t;
    while i < numPolyObjects as size_t {
        LUA_InvalidateUserdata(
            &mut *PolyObjects.offset(i as isize) as *mut polyobj_t as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            &mut (*PolyObjects.offset(i as isize)).vertices as *mut *mut *mut vertex_t
                as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            &mut (*PolyObjects.offset(i as isize)).lines as *mut *mut *mut line_s
                as *mut libc::c_void,
        );
        i = i.wrapping_add(1);
        i;
    }
    let mut slope: *mut pslope_t = slopelist;
    while !slope.is_null() {
        LUA_InvalidateUserdata(slope as *mut libc::c_void);
        LUA_InvalidateUserdata(
            &mut (*slope).normal as *mut vector3_t as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(&mut (*slope).o as *mut vector3_t as *mut libc::c_void);
        LUA_InvalidateUserdata(&mut (*slope).d as *mut vector2_t as *mut libc::c_void);
        slope = (*slope).next;
    }
}
#[no_mangle]
pub unsafe extern "C" fn LUA_InvalidateMapthings() {
    let mut i: size_t = 0;
    if gL.is_null() {
        return;
    }
    ...
    while i < nummapthings {
        LUA_InvalidateUserdata(
            &mut *mapthings.offset(i as isize) as *mut mapthing_t as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            &mut (*mapthings.offset(i as isize)).tags as *mut taglist_t
                as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            ((*mapthings.offset(i as isize)).args).as_mut_ptr() as *mut libc::c_void,
        );
        LUA_InvalidateUserdata(
            ((*mapthings.offset(i as isize)).stringargs).as_mut_ptr()
                as *mut libc::c_void,
        );
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn LUA_InvalidatePlayer(mut player: *mut player_t) {
    if gL.is_null() {
        return;
    }
    LUA_InvalidateUserdata(player as *mut libc::c_void);
    LUA_InvalidateUserdata(((*player).powers).as_mut_ptr() as *mut libc::c_void);
    LUA_InvalidateUserdata(&mut (*player).cmd as *mut ticcmd_t as *mut libc::c_void);
}
static mut meta2arch: [C2RustUnnamed_5; 18] = [
    {
        let mut init = C2RustUnnamed_5 {
            meta: b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
            arch: ARCH_MOBJINFO as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_STATE as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_MOBJ as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_PLAYER as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_MAPTHING as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_VERTEX as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_LINE as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SIDE as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SUBSECTOR as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SECTOR as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_FFLOOR as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_POLYOBJ as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SLOPE as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_MAPHEADER as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SKINCOLOR as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_MOUSE as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_SKIN as libc::c_int as uint8_t,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_5 {
            ...
            arch: ARCH_NULL as libc::c_int as uint8_t,
        };
        init
    },
];
unsafe extern "C" fn GetUserdataArchType(mut index: libc::c_int) -> uint8_t {
    let mut i: uint8_t = 0;
    lua_getmetatable(gL, index);
    i = 0 as libc::c_int as uint8_t;
    while !(meta2arch[i as usize].meta).is_null() {
        lua_getfield(gL, -(10000 as libc::c_int), meta2arch[i as usize].meta);
        if lua_rawequal(gL, -(1 as libc::c_int), -(2 as libc::c_int)) != 0 {
            lua_settop(gL, -(2 as libc::c_int) - 1 as libc::c_int);
            return meta2arch[i as usize].arch;
        }
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        i = i.wrapping_add(1);
        i;
    ...
    lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    return ARCH_NULL as libc::c_int as uint8_t;
}
unsafe extern "C" fn ArchiveValue(
    mut TABLESINDEX: libc::c_int,
    mut myindex: libc::c_int,
) -> uint8_t {
    if myindex < 0 as libc::c_int {
        myindex = lua_gettop(gL) + 1 as libc::c_int + myindex;
    }
    match lua_type(gL, myindex) {
        -1 | 0 => {
            let mut p_tmp: *mut uint8_t = save_p as *mut libc::c_void as *mut uint8_t;
            let tv: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
            memcpy(
        ...
        2 | 8 | 6 => {
            ...
            let tv_0: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
            memcpy(
                save_p as *mut libc::c_void,
        ...
        1 => {
            let mut p_tmp_1: *mut uint8_t = save_p as *mut libc::c_void as *mut uint8_t;
            let tv_1: uint8_t = (if lua_toboolean(gL, myindex) != 0 {
                ARCH_TRUE as libc::c_int
            } else {
                ARCH_FALSE as libc::c_int
            }) as uint8_t;
            memcpy(
                save_p as *mut libc::c_void,
        ...
        3 => {
            let mut number: lua_Number = lua_tonumber(gL, myindex);
            if number >= -(128 as libc::c_int) && number <= 127 as libc::c_int {
                let mut p_tmp_2: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_2: uint8_t = ARCH_INT8 as libc::c_int as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                ...
                let mut p_tmp_3: *mut int8_t = save_p as *mut libc::c_void
                    as *mut int8_t;
                let tv_3: int8_t = number as uint8_t as int8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                    &tv_3 as *const int8_t as *const libc::c_void,
                    ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                );
                p_tmp_3 = p_tmp_3.offset(1);
                p_tmp_3;
                save_p = p_tmp_3 as *mut libc::c_void as *mut uint8_t;
            } else if number >= -(32767 as libc::c_int) - 1 as libc::c_int
                && number <= 32767 as libc::c_int
            {
                let mut p_tmp_4: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_4: uint8_t = ARCH_INT16 as libc::c_int as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                ...
                let mut p_tmp_5: *mut int16_t = save_p as *mut libc::c_void
                    as *mut int16_t;
                let tv_5: int16_t = number as int16_t;
                memcpy(
                    save_p as *mut libc::c_void,
                    &tv_5 as *const int16_t as *const libc::c_void,
                ...
                let mut p_tmp_6: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_6: uint8_t = ARCH_INT32 as libc::c_int as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                ...
                let mut p_tmp_7: *mut fixed_t = save_p as *mut libc::c_void
                    as *mut fixed_t;
                let tv_7: fixed_t = number;
                memcpy(
                    save_p as *mut libc::c_void,
                    &tv_7 as *const fixed_t as *const libc::c_void,
        ...
        4 => {
            let mut len: uint32_t = lua_objlen(gL, myindex) as uint32_t;
            let mut s: *const libc::c_char = lua_tolstring(
                gL,
                myindex,
                0 as *mut size_t,
            );
            let mut i: uint32_t = 0 as libc::c_int as uint32_t;
            if len < 255 as libc::c_int as uint32_t {
                let mut p_tmp_8: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_8: uint8_t = ARCH_SMALLSTRING as libc::c_int as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                ...
                let mut p_tmp_9: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_9: uint8_t = len as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
                ...
                let mut p_tmp_10: *mut uint8_t = save_p as *mut libc::c_void
                    as *mut uint8_t;
                let tv_10: uint8_t = ARCH_LARGESTRING as libc::c_int as uint8_t;
                memcpy(
                    save_p as *mut libc::c_void,
            ...
            while i < len {
                let mut p_tmp_12: *mut libc::c_char = save_p as *mut libc::c_void
                    as *mut libc::c_char;
                let fresh4 = i;
                i = i.wrapping_add(1);
                let tv_12: libc::c_char = *s.offset(fresh4 as isize);
                memcpy(
                    save_p as *mut libc::c_void,
                    &tv_12 as *const libc::c_char as *const libc::c_void,
                    ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
                );
        ...
        5 => {
            ...
            let mut t: uint16_t = lua_objlen(gL, TABLESINDEX) as uint16_t;
            i_0 = 1 as libc::c_int;
            while i_0 <= t as libc::c_int && found == 0 {
                lua_rawgeti(gL, TABLESINDEX, i_0);
                if lua_rawequal(gL, myindex, -(1 as libc::c_int)) != 0 {
                    t = i_0 as uint16_t;
            ...
            if found == 0 {
                ...
                if t as libc::c_int == 0 as libc::c_int {
                    CONS_Alert(
                        CONS_ERROR,
                        b"Too many tables to archive!\n\0" as *const u8
                            as *const libc::c_char,
                    );
                    let mut p_tmp_13: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_13: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
            ...
            let mut p_tmp_14: *mut uint8_t = save_p as *mut libc::c_void as *mut uint8_t;
            let tv_14: uint8_t = ARCH_TABLE as libc::c_int as uint8_t;
            memcpy(
                save_p as *mut libc::c_void,
            ...
            if found == 0 {
                ...
                lua_rawseti(gL, TABLESINDEX, t as libc::c_int);
                return 1 as libc::c_int as uint8_t;
            }
        }
        7 => {
            match GetUserdataArchType(myindex) as libc::c_int {
                9 => {
                    let mut info: *mut mobjinfo_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut mobjinfo_t);
                    let mut p_tmp_16: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_16: uint8_t = ARCH_MOBJINFO as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                    ...
                    let mut p_tmp_17: *mut uint16_t = save_p as *mut libc::c_void
                        as *mut uint16_t;
                    let tv_17: uint16_t = info.offset_from(mobjinfo.as_mut_ptr())
                        as libc::c_long as uint16_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_17 as *const uint16_t as *const libc::c_void,
                        ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                    );
                ...
                10 => {
                    let mut state: *mut state_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut state_t);
                    let mut p_tmp_18: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_18: uint8_t = ARCH_STATE as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                    ...
                    let mut p_tmp_19: *mut uint16_t = save_p as *mut libc::c_void
                        as *mut uint16_t;
                    let tv_19: uint16_t = state.offset_from(states.as_mut_ptr())
                        as libc::c_long as uint16_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_19 as *const uint16_t as *const libc::c_void,
                        ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                    );
                ...
                11 => {
                    let mut mobj: *mut mobj_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut mobj_t);
                    if mobj.is_null() {
                        let mut p_tmp_20: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_20: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                        ...
                        let mut p_tmp_21: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_21: uint8_t = ARCH_MOBJ as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                        ...
                        let mut p_tmp_22: *mut uint32_t = save_p as *mut libc::c_void
                            as *mut uint32_t;
                        let tv_22: uint32_t = (*mobj).mobjnum;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_22 as *const uint32_t as *const libc::c_void,
                            ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                        );
                        p_tmp_22 = p_tmp_22.offset(1);
                        p_tmp_22;
                        save_p = p_tmp_22 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                12 => {
                    let mut player: *mut player_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut player_t);
                    if player.is_null() {
                        let mut p_tmp_23: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_23: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_23 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_23 = p_tmp_23.offset(1);
                        p_tmp_23;
                        save_p = p_tmp_23 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_24: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_24: uint8_t = ARCH_PLAYER as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_24 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_24 = p_tmp_24.offset(1);
                        p_tmp_24;
                        save_p = p_tmp_24 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_25: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_25: uint8_t = player.offset_from(players.as_mut_ptr())
                            as libc::c_long as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_25 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_25 = p_tmp_25.offset(1);
                        p_tmp_25;
                        save_p = p_tmp_25 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                13 => {
                    let mut mapthing: *mut mapthing_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut mapthing_t);
                    if mapthing.is_null() {
                        let mut p_tmp_26: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_26: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                        ...
                        p_tmp_26;
                        save_p = p_tmp_26 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_27: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_27: uint8_t = ARCH_MAPTHING as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_27 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_27 = p_tmp_27.offset(1);
                        p_tmp_27;
                        save_p = p_tmp_27 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_28: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_28: uint16_t = mapthing.offset_from(mapthings)
                            as libc::c_long as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_28 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_28 = p_tmp_28.offset(1);
                        p_tmp_28;
                        save_p = p_tmp_28 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                14 => {
                    let mut vertex: *mut vertex_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut vertex_t);
                    if vertex.is_null() {
                        let mut p_tmp_29: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_29: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                        ...
                        p_tmp_29;
                        save_p = p_tmp_29 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_30: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_30: uint8_t = ARCH_VERTEX as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_30 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_30 = p_tmp_30.offset(1);
                        p_tmp_30;
                        save_p = p_tmp_30 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_31: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_31: uint16_t = vertex.offset_from(vertexes)
                            as libc::c_long as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_31 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_31 = p_tmp_31.offset(1);
                        p_tmp_31;
                        save_p = p_tmp_31 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                15 => {
                    let mut line: *mut line_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut line_t);
                    if line.is_null() {
                        let mut p_tmp_32: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_32: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_32 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_32 = p_tmp_32.offset(1);
                        p_tmp_32;
                        save_p = p_tmp_32 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_33: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_33: uint8_t = ARCH_LINE as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_33 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_33 = p_tmp_33.offset(1);
                        p_tmp_33;
                        save_p = p_tmp_33 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_34: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_34: uint16_t = line.offset_from(lines) as libc::c_long
                            as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_34 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_34 = p_tmp_34.offset(1);
                        p_tmp_34;
                        save_p = p_tmp_34 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                16 => {
                    let mut side: *mut side_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut side_t);
                    if side.is_null() {
                        let mut p_tmp_35: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_35: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_35 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_35 = p_tmp_35.offset(1);
                        p_tmp_35;
                        save_p = p_tmp_35 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_36: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_36: uint8_t = ARCH_SIDE as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_36 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_36 = p_tmp_36.offset(1);
                        p_tmp_36;
                        save_p = p_tmp_36 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_37: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_37: uint16_t = side.offset_from(sides) as libc::c_long
                            as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_37 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_37 = p_tmp_37.offset(1);
                        p_tmp_37;
                        save_p = p_tmp_37 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                17 => {
                    let mut subsector: *mut subsector_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut subsector_t);
                    if subsector.is_null() {
                        let mut p_tmp_38: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_38: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_38 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_38 = p_tmp_38.offset(1);
                        p_tmp_38;
                        save_p = p_tmp_38 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_39: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_39: uint8_t = ARCH_SUBSECTOR as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_39 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_39 = p_tmp_39.offset(1);
                        p_tmp_39;
                        save_p = p_tmp_39 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_40: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_40: uint16_t = subsector.offset_from(subsectors)
                            as libc::c_long as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_40 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_40 = p_tmp_40.offset(1);
                        p_tmp_40;
                        save_p = p_tmp_40 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                18 => {
                    let mut sector: *mut sector_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut sector_t);
                    if sector.is_null() {
                        let mut p_tmp_41: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_41: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_41 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_41 = p_tmp_41.offset(1);
                        p_tmp_41;
                        save_p = p_tmp_41 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_42: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_42: uint8_t = ARCH_SECTOR as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_42 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_42 = p_tmp_42.offset(1);
                        p_tmp_42;
                        save_p = p_tmp_42 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_43: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_43: uint16_t = sector.offset_from(sectors) as libc::c_long
                            as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_43 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_43 = p_tmp_43.offset(1);
                        p_tmp_43;
                        save_p = p_tmp_43 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                19 => {
                    let mut rover: *mut ffloor_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut ffloor_t);
                    if rover.is_null() {
                        let mut p_tmp_44: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_44: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_44 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_44 = p_tmp_44.offset(1);
                        p_tmp_44;
                        save_p = p_tmp_44 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut i_1: uint16_t = P_GetFFloorID(rover);
                        if i_1 as libc::c_int == 65535 as libc::c_int {
                            let mut p_tmp_45: *mut uint8_t = save_p as *mut libc::c_void
                                as *mut uint8_t;
                            let tv_45: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                            memcpy(
                                save_p as *mut libc::c_void,
                                &tv_45 as *const uint8_t as *const libc::c_void,
                                ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                            );
                            p_tmp_45 = p_tmp_45.offset(1);
                            p_tmp_45;
                            save_p = p_tmp_45 as *mut libc::c_void as *mut uint8_t;
                        } else {
                            let mut p_tmp_46: *mut uint8_t = save_p as *mut libc::c_void
                                as *mut uint8_t;
                            let tv_46: uint8_t = ARCH_FFLOOR as libc::c_int as uint8_t;
                            memcpy(
                                save_p as *mut libc::c_void,
                                &tv_46 as *const uint8_t as *const libc::c_void,
                                ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                            );
                            p_tmp_46 = p_tmp_46.offset(1);
                            p_tmp_46;
                            save_p = p_tmp_46 as *mut libc::c_void as *mut uint8_t;
                            let mut p_tmp_47: *mut uint16_t = save_p as *mut libc::c_void
                                as *mut uint16_t;
                            let tv_47: uint16_t = ((*rover).target).offset_from(sectors)
                                as libc::c_long as uint16_t;
                            memcpy(
                                save_p as *mut libc::c_void,
                                &tv_47 as *const uint16_t as *const libc::c_void,
                                ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                            );
                            p_tmp_47 = p_tmp_47.offset(1);
                            p_tmp_47;
                            save_p = p_tmp_47 as *mut libc::c_void as *mut uint8_t;
                            let mut p_tmp_48: *mut uint16_t = save_p as *mut libc::c_void
                                as *mut uint16_t;
                            let tv_48: uint16_t = i_1;
                            memcpy(
                                save_p as *mut libc::c_void,
                                &tv_48 as *const uint16_t as *const libc::c_void,
                                ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                            );
                            p_tmp_48 = p_tmp_48.offset(1);
                            p_tmp_48;
                            save_p = p_tmp_48 as *mut libc::c_void as *mut uint8_t;
                        }
                    }
                }
                20 => {
                    let mut polyobj: *mut polyobj_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut polyobj_t);
                    if polyobj.is_null() {
                        let mut p_tmp_49: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_49: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_49 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_49 = p_tmp_49.offset(1);
                        p_tmp_49;
                        save_p = p_tmp_49 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_50: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_50: uint8_t = ARCH_POLYOBJ as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_50 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_50 = p_tmp_50.offset(1);
                        p_tmp_50;
                        save_p = p_tmp_50 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_51: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_51: uint16_t = polyobj.offset_from(PolyObjects)
                            as libc::c_long as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_51 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_51 = p_tmp_51.offset(1);
                        p_tmp_51;
                        save_p = p_tmp_51 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                21 => {
                    let mut slope: *mut pslope_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut pslope_t);
                    if slope.is_null() {
                        let mut p_tmp_52: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_52: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_52 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_52 = p_tmp_52.offset(1);
                        p_tmp_52;
                        save_p = p_tmp_52 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_53: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_53: uint8_t = ARCH_SLOPE as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_53 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_53 = p_tmp_53.offset(1);
                        p_tmp_53;
                        save_p = p_tmp_53 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_54: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_54: uint16_t = (*slope).id;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_54 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_54 = p_tmp_54.offset(1);
                        p_tmp_54;
                        save_p = p_tmp_54 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                22 => {
                    let mut header: *mut mapheader_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut mapheader_t);
                    if header.is_null() {
                        let mut p_tmp_55: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_55: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_55 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_55 = p_tmp_55.offset(1);
                        p_tmp_55;
                        save_p = p_tmp_55 as *mut libc::c_void as *mut uint8_t;
                    } else {
                        let mut p_tmp_56: *mut uint8_t = save_p as *mut libc::c_void
                            as *mut uint8_t;
                        let tv_56: uint8_t = ARCH_MAPHEADER as libc::c_int as uint8_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_56 as *const uint8_t as *const libc::c_void,
                            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                        );
                        p_tmp_56 = p_tmp_56.offset(1);
                        p_tmp_56;
                        save_p = p_tmp_56 as *mut libc::c_void as *mut uint8_t;
                        let mut p_tmp_57: *mut uint16_t = save_p as *mut libc::c_void
                            as *mut uint16_t;
                        let tv_57: uint16_t = header
                            .offset_from(*mapheaderinfo.as_mut_ptr()) as libc::c_long
                            as uint16_t;
                        memcpy(
                            save_p as *mut libc::c_void,
                            &tv_57 as *const uint16_t as *const libc::c_void,
                            ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                        );
                        p_tmp_57 = p_tmp_57.offset(1);
                        p_tmp_57;
                        save_p = p_tmp_57 as *mut libc::c_void as *mut uint8_t;
                    }
                }
                23 => {
                    let mut info_0: *mut skincolor_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut skincolor_t);
                    let mut p_tmp_58: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_58: uint8_t = ARCH_SKINCOLOR as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_58 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_58 = p_tmp_58.offset(1);
                    p_tmp_58;
                    save_p = p_tmp_58 as *mut libc::c_void as *mut uint8_t;
                    let mut p_tmp_59: *mut uint16_t = save_p as *mut libc::c_void
                        as *mut uint16_t;
                    let tv_59: uint16_t = info_0.offset_from(skincolors.as_mut_ptr())
                        as libc::c_long as uint16_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_59 as *const uint16_t as *const libc::c_void,
                        ::core::mem::size_of::<uint16_t>() as libc::c_ulong,
                    );
                    p_tmp_59 = p_tmp_59.offset(1);
                    p_tmp_59;
                    save_p = p_tmp_59 as *mut libc::c_void as *mut uint8_t;
                }
                24 => {
                    let mut m: *mut mouse_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut mouse_t);
                    let mut p_tmp_60: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_60: uint8_t = ARCH_MOUSE as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_60 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_60 = p_tmp_60.offset(1);
                    p_tmp_60;
                    save_p = p_tmp_60 as *mut libc::c_void as *mut uint8_t;
                    let mut p_tmp_61: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_61: uint8_t = (if m == &mut mouse as *mut mouse_t {
                        1 as libc::c_int
                    } else {
                        2 as libc::c_int
                    }) as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_61 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_61 = p_tmp_61.offset(1);
                    p_tmp_61;
                    save_p = p_tmp_61 as *mut libc::c_void as *mut uint8_t;
                }
                25 => {
                    let mut skin: *mut skin_t = *(lua_touserdata(gL, myindex)
                        as *mut *mut skin_t);
                    let mut p_tmp_62: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_62: uint8_t = ARCH_SKIN as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_62 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_62 = p_tmp_62.offset(1);
                    p_tmp_62;
                    save_p = p_tmp_62 as *mut libc::c_void as *mut uint8_t;
                    let mut p_tmp_63: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_63: uint8_t = skin.offset_from(skins.as_mut_ptr())
                        as libc::c_long as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_63 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_63 = p_tmp_63.offset(1);
                    p_tmp_63;
                    save_p = p_tmp_63 as *mut libc::c_void as *mut uint8_t;
                }
                _ => {
                    let mut p_tmp_64: *mut uint8_t = save_p as *mut libc::c_void
                        as *mut uint8_t;
                    let tv_64: uint8_t = ARCH_NULL as libc::c_int as uint8_t;
                    memcpy(
                        save_p as *mut libc::c_void,
                        &tv_64 as *const uint8_t as *const libc::c_void,
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
                    );
                    p_tmp_64 = p_tmp_64.offset(1);
                    p_tmp_64;
                    save_p = p_tmp_64 as *mut libc::c_void as *mut uint8_t;
                    return 2 as libc::c_int as uint8_t;
                }
            }
        }
...
unsafe extern "C" fn ArchiveExtVars(
    mut pointer: *mut libc::c_void,
    mut ptype: *const libc::c_char,
) {
    let mut TABLESINDEX: libc::c_int = 0;
    let mut i: uint16_t = 0;
    if gL.is_null() {
        if fastcmp(ptype, b"player\0" as *const u8 as *const libc::c_char) != 0 {
            let mut p_tmp: *mut uint16_t = save_p as *mut libc::c_void as *mut uint16_t;
    ...
    lua_rawget(gL, -(2 as libc::c_int));
    lua_remove(gL, -(2 as libc::c_int));
    if !(lua_type(gL, -(1 as libc::c_int)) == 5 as libc::c_int) {
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        if fastcmp(ptype, b"player\0" as *const u8 as *const libc::c_char) != 0 {
            let mut p_tmp_0: *mut uint16_t = save_p as *mut libc::c_void
                as *mut uint16_t;
            let tv_0: uint16_t = 0 as libc::c_int as uint16_t;
            memcpy(
                save_p as *mut libc::c_void,
    ...
    while lua_next(gL, -(2 as libc::c_int)) != 0 {
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        i = i.wrapping_add(1);
        i;
    }
    if i as libc::c_int == 0 as libc::c_int {
        if fastcmp(ptype, b"player\0" as *const u8 as *const libc::c_char) != 0 {
            let mut p_tmp_1: *mut uint16_t = save_p as *mut libc::c_void
                as *mut uint16_t;
            let tv_1: uint16_t = 0 as libc::c_int as uint16_t;
            memcpy(
                save_p as *mut libc::c_void,
    ...
    if fastcmp(ptype, b"mobj\0" as *const u8 as *const libc::c_char) != 0 {
        let mut p_tmp_2: *mut uint32_t = save_p as *mut libc::c_void as *mut uint32_t;
        let tv_2: uint32_t = (*(pointer as *mut mobj_t)).mobjnum;
        memcpy(
            save_p as *mut libc::c_void,
    ...
    let mut p_tmp_3: *mut uint16_t = save_p as *mut libc::c_void as *mut uint16_t;
    let tv_3: uint16_t = i;
    memcpy(
        save_p as *mut libc::c_void,
    ...
    while lua_next(gL, -(2 as libc::c_int)) != 0 {
        ...
        while *(lua_tolstring(gL, -(2 as libc::c_int), 0 as *mut size_t))
            .offset(tmp_i as isize) as libc::c_int != '\0' as i32
        {
            let mut p_tmp_4: *mut libc::c_char = save_p as *mut libc::c_void
                as *mut libc::c_char;
            let tv_4: libc::c_char = *(lua_tolstring(
                gL,
                -(2 as libc::c_int),
                0 as *mut size_t,
            ))
                .offset(tmp_i as isize);
            memcpy(
                save_p as *mut libc::c_void,
        ...
        let mut p_tmp_5: *mut libc::c_char = save_p as *mut libc::c_void
            as *mut libc::c_char;
        ...
        p_tmp_5;
        save_p = p_tmp_5 as *mut libc::c_void as *mut uint8_t;
        if ArchiveValue(TABLESINDEX, -(1 as libc::c_int)) as libc::c_int
            == 2 as libc::c_int
        {
            CONS_Alert(
                CONS_ERROR,
                b"Type of value for %s entry '%s' (%s) could not be archived!\n\0"
                    as *const u8 as *const libc::c_char,
                ptype,
                lua_tolstring(gL, -(2 as libc::c_int), 0 as *mut size_t),
                lua_typename(gL, lua_type(gL, -(1 as libc::c_int))),
            );
        }
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    }
...
unsafe extern "C" fn NetArchive(mut L: *mut lua_State) -> libc::c_int {
    let mut TABLESINDEX: libc::c_int = -(10002 as libc::c_int) - 1 as libc::c_int;
    let mut i: libc::c_int = 0;
...
unsafe extern "C" fn ArchiveTables() {
    let mut TABLESINDEX: libc::c_int = 0;
    let mut i: uint16_t = 0;
    ...
    TABLESINDEX = lua_gettop(gL);
    n = lua_objlen(gL, TABLESINDEX) as uint16_t;
    i = 1 as libc::c_int as uint16_t;
    while i as libc::c_int <= n as libc::c_int {
        lua_rawgeti(gL, TABLESINDEX, i as libc::c_int);
        lua_pushnil(gL);
        while lua_next(gL, -(2 as libc::c_int)) != 0 {
            e = ArchiveValue(TABLESINDEX, -(2 as libc::c_int));
            if e as libc::c_int == 2 as libc::c_int {
                CONS_Alert(
                    CONS_ERROR,
                    b"Index '%s' (%s) of table %d could not be archived!\n\0"
                        as *const u8 as *const libc::c_char,
                    lua_tolstring(gL, -(2 as libc::c_int), 0 as *mut size_t),
                    lua_typename(gL, lua_type(gL, -(2 as libc::c_int))),
                    i as libc::c_int,
                );
            }
            e = ArchiveValue(TABLESINDEX, -(1 as libc::c_int));
            if e as libc::c_int == 1 as libc::c_int {
                n = n.wrapping_add(1);
                n;
            } else if e as libc::c_int == 2 as libc::c_int {
                CONS_Alert(
                    CONS_ERROR,
                    b"Type of value for table %d entry '%s' (%s) could not be archived!\n\0"
                        as *const u8 as *const libc::c_char,
                    i as libc::c_int,
                    lua_tolstring(gL, -(2 as libc::c_int), 0 as *mut size_t),
                    lua_typename(gL, lua_type(gL, -(1 as libc::c_int))),
        ...
        let mut p_tmp: *mut uint8_t = save_p as *mut libc::c_void as *mut uint8_t;
        let tv: uint8_t = ARCH_TEND as libc::c_int as uint8_t;
        memcpy(
            save_p as *mut libc::c_void,
            &tv as *const uint8_t as *const libc::c_void,
            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
        ...
        p_tmp;
        save_p = p_tmp as *mut libc::c_void as *mut uint8_t;
        if lua_getmetatable(gL, -(1 as libc::c_int)) != 0 {
            lua_getfield(
                gL,
                -(10000 as libc::c_int),
                b"METATABLES\0" as *const u8 as *const libc::c_char,
            );
            lua_pushvalue(gL, -(2 as libc::c_int));
            lua_gettable(gL, -(2 as libc::c_int));
            let mut p_tmp_0: *mut uint16_t = save_p as *mut libc::c_void
                as *mut uint16_t;
            let tv_0: uint16_t = (if lua_type(gL, -(1 as libc::c_int))
                == 0 as libc::c_int
            {
                0 as libc::c_int
            } else {
                lua_tonumber(gL, -(1 as libc::c_int))
            }) as uint16_t;
            memcpy(
                save_p as *mut libc::c_void,
                &tv_0 as *const uint16_t as *const libc::c_void,
            ...
            p_tmp_0;
            save_p = p_tmp_0 as *mut libc::c_void as *mut uint8_t;
            lua_settop(gL, -(3 as libc::c_int) - 1 as libc::c_int);
        } else {
            let mut p_tmp_1: *mut uint16_t = save_p as *mut libc::c_void
                as *mut uint16_t;
            let tv_1: uint16_t = 0 as libc::c_int as uint16_t;
...
unsafe extern "C" fn UnArchiveValue(mut TABLESINDEX: libc::c_int) -> uint8_t {
    ...
    match type_0 as libc::c_int {
        ...
        1 => {
            lua_pushboolean(gL, true_0 as libc::c_int);
        }
        2 => {
            lua_pushboolean(gL, false_0 as libc::c_int);
        }
        3 => {
            lua_pushnumber(
                gL,
                ({
                    let mut p_tmp: *mut int8_t = save_p as *mut libc::c_void
                        as *mut int8_t;
                    let mut b: int8_t = 0;
                    memcpy(
        ...
        4 => {
            lua_pushnumber(
                gL,
                ({
                    let mut p_tmp: *mut int16_t = save_p as *mut libc::c_void
                        as *mut int16_t;
                    let mut b: int16_t = 0;
                    memcpy(
        ...
        5 => {
            lua_pushnumber(
                gL,
                ({
                    let mut p_tmp: *mut fixed_t = save_p as *mut libc::c_void
                        as *mut fixed_t;
                    let mut b: fixed_t = 0;
                    memcpy(
        ...
        6 | 7 => {
            ...
            let mut i: uint32_t = 0 as libc::c_int as uint32_t;
            if type_0 as libc::c_int == ARCH_SMALLSTRING as libc::c_int {
                len = ({
            ...
            value = malloc(len as libc::c_ulong) as *mut libc::c_char;
            while i < len {
                let fresh5 = i;
                i = i.wrapping_add(1);
                *value
                    ...
                    let mut p_tmp: *mut libc::c_char = save_p as *mut libc::c_void
                        as *mut libc::c_char;
            ...
            lua_pushlstring(gL, value, len as size_t);
            free(value as *mut libc::c_void);
        }
        8 => {
            let mut tid: uint16_t = ({
            ...
            lua_rawgeti(gL, TABLESINDEX, tid as libc::c_int);
            if lua_type(gL, -(1 as libc::c_int)) == 0 as libc::c_int {
                lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
                lua_createtable(gL, 0 as libc::c_int, 0 as libc::c_int);
                lua_pushvalue(gL, -(1 as libc::c_int));
                lua_rawseti(gL, TABLESINDEX, tid as libc::c_int);
                return 2 as libc::c_int as uint8_t;
            }
        }
        9 => {
            LUA_PushUserdata(
                ...
                &mut *mobjinfo
                    ...
                    ) as *mut mobjinfo_t as *mut libc::c_void,
                b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        10 => {
            LUA_PushUserdata(
                ...
                &mut *states
                    ...
                    ) as *mut state_t as *mut libc::c_void,
                b"STATE_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        11 => {
            LUA_PushUserdata(
        ...
        13 => {
            LUA_PushUserdata(
                ...
                &mut *mapthings
                    ...
                    ) as *mut mapthing_t as *mut libc::c_void,
                b"MAPTHING_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        14 => {
            LUA_PushUserdata(
                ...
                &mut *vertexes
                    ...
                    ) as *mut vertex_t as *mut libc::c_void,
        ...
        15 => {
            LUA_PushUserdata(
                ...
                &mut *lines
                    ...
                    ) as *mut line_t as *mut libc::c_void,
        ...
        17 => {
            LUA_PushUserdata(
                ...
                &mut *subsectors
                    ...
                    ) as *mut subsector_t as *mut libc::c_void,
        ...
        18 => {
            LUA_PushUserdata(
                ...
                &mut *sectors
                    ...
                    ) as *mut sector_t as *mut libc::c_void,
        ...
        19 => {
            ...
            let mut rover: *mut ffloor_t = P_GetFFloorByID(sector, id);
            if !rover.is_null() {
                LUA_PushUserdata(
                    gL,
                    rover as *mut libc::c_void,
        ...
        20 => {
            LUA_PushUserdata(
                ...
                &mut *PolyObjects
                    ...
                    ) as *mut polyobj_t as *mut libc::c_void,
        ...
        23 => {
            LUA_PushUserdata(
                ...
                &mut *skincolors
                    ...
                    ) as *mut skincolor_t as *mut libc::c_void,
                b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        24 => {
            LUA_PushUserdata(
                ...
                {
                    &mut mouse as *mut mouse_t
                } else {
                    &mut mouse2 as *mut mouse_t
                }) as *mut libc::c_void,
                b"MOUSE_T*\0" as *const u8 as *const libc::c_char,
            );
        }
        ...
        255 => return 1 as libc::c_int as uint8_t,
        _ => {}
    }
    return 0 as libc::c_int as uint8_t;
}
unsafe extern "C" fn UnArchiveExtVars(mut pointer: *mut libc::c_void) {
    let mut TABLESINDEX: libc::c_int = 0;
    let mut field_count: uint16_t = ({
        let mut p_tmp: *mut uint16_t = save_p as *mut libc::c_void as *mut uint16_t;
        let mut b: uint16_t = 0;
        memcpy(
            &mut b as *mut uint16_t as *mut libc::c_void,
    ...
    let mut i: uint16_t = 0;
    let mut field: [libc::c_char; 1024] = [0; 1024];
    if field_count as libc::c_int == 0 as libc::c_int {
        return;
    }
    TABLESINDEX = lua_gettop(gL);
    lua_createtable(gL, 0 as libc::c_int, field_count as libc::c_int);
    i = 0 as libc::c_int as uint16_t;
    while (i as libc::c_int) < field_count as libc::c_int {
        ...
        loop {
            ...
            if !(field[tmp_i as usize] as libc::c_int != '\0' as i32) {
                break;
            }
            tmp_i = tmp_i.wrapping_add(1);
            tmp_i;
        }
        field[tmp_i as usize] = '\0' as i32 as libc::c_char;
        UnArchiveValue(TABLESINDEX);
        lua_setfield(gL, -(2 as libc::c_int), field.as_mut_ptr());
        i = i.wrapping_add(1);
        i;
    }
    lua_getfield(
...
unsafe extern "C" fn NetUnArchive(mut L: *mut lua_State) -> libc::c_int {
    let mut TABLESINDEX: libc::c_int = -(10002 as libc::c_int) - 1 as libc::c_int;
    let mut i: libc::c_int = 0;
    let mut n: libc::c_int = lua_gettop(L);
    i = 1 as libc::c_int;
...
unsafe extern "C" fn UnArchiveTables() {
    let mut TABLESINDEX: libc::c_int = 0;
    let mut i: uint16_t = 0;
    let mut n: uint16_t = 0;
    let mut metatableid: uint16_t = 0;
    if gL.is_null() {
        return;
    }
    TABLESINDEX = lua_gettop(gL);
    ...
    while i as libc::c_int <= n as libc::c_int {
        ...
        while true_0 as libc::c_int != 0 {
            if UnArchiveValue(TABLESINDEX) as libc::c_int == 1 as libc::c_int {
                break;
            }
            if UnArchiveValue(TABLESINDEX) as libc::c_int == 2 as libc::c_int {
                n = n.wrapping_add(1);
                n;
            }
            if lua_type(gL, -(2 as libc::c_int)) == 0 as libc::c_int {
                CONS_Alert(
                    CONS_ERROR,
                    b"A nil key in table %d was found! (Invalid key type or corrupted save?)\n\0"
                        as *const u8 as *const libc::c_char,
                    i as libc::c_int,
                );
                lua_settop(gL, -(2 as libc::c_int) - 1 as libc::c_int);
        ...
        if metatableid != 0 {
            ...
            lua_rawgeti(gL, -(1 as libc::c_int), metatableid as libc::c_int);
            if lua_type(gL, -(1 as libc::c_int)) == 0 as libc::c_int {
                I_Error(
                    b"Unknown metatable ID %d\n\0" as *const u8 as *const libc::c_char,
                    metatableid as libc::c_int,
                );
            }
            lua_setmetatable(gL, -(3 as libc::c_int));
            lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        }
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        i = i.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn LUA_Step() {
    if gL.is_null() {
        return;
    }
    lua_settop(gL, 0 as libc::c_int);
    lua_gc(gL, 5 as libc::c_int, 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn LUA_Archive() {
    let mut i: int32_t = 0;
    let mut th: *mut thinker_t = 0 as *mut thinker_t;
    if !gL.is_null() {
        lua_createtable(gL, 0 as libc::c_int, 0 as libc::c_int);
    ...
    let tv: uint32_t = 4294967295 as libc::c_uint;
    memcpy(
        save_p as *mut libc::c_void,
    ...
    save_p = p_tmp as *mut libc::c_void as *mut uint8_t;
    LUA_HookNetArchive(
        Some(NetArchive as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
    );
    ArchiveTables();
    if !gL.is_null() {
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn LUA_UnArchive() {
    let mut mobjnum: uint32_t = 0;
    let mut i: int32_t = 0;
    let mut th: *mut thinker_t = 0 as *mut thinker_t;
    if !gL.is_null() {
        lua_createtable(gL, 0 as libc::c_int, 0 as libc::c_int);
    ...
    loop {
                ...
                as *mut thinker_t
        {
            ...
            {
                if !((*(th as *mut mobj_t)).mobjnum != mobjnum) {
                    UnArchiveExtVars(th as *mut libc::c_void);
                }
            }
            th = (*th).next;
        }
        if !(mobjnum != 4294967295 as libc::c_uint) {
            break;
        }
    }
    LUA_HookNetArchive(
        Some(NetUnArchive as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
    );
    UnArchiveTables();
    if !gL.is_null() {
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn Lua_optoption(
    mut L: *mut lua_State,
    mut narg: libc::c_int,
    mut def: libc::c_int,
    mut list_ref: libc::c_int,
) -> libc::c_int {
    if lua_type(L, narg) <= 0 as libc::c_int {
        return def;
    }
    luaL_checklstring(L, narg, 0 as *mut size_t);
    lua_rawgeti(L, -(10000 as libc::c_int), list_ref);
    lua_pushvalue(L, narg);
    lua_rawget(L, -(2 as libc::c_int));
    if lua_isnumber(L, -(1 as libc::c_int)) != 0 {
        return lua_tonumber(L, -(1 as libc::c_int));
    }
    return -(1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Lua_CreateFieldTable(
    mut L: *mut lua_State,
    ...
    while !(*lst.offset(i as isize)).is_null() {
        lua_pushstring(L, *lst.offset(i as isize));
        lua_pushnumber(L, i);
        lua_settable(L, -(3 as libc::c_int));
        i += 1;
        i;
    }
    return luaL_ref(L, -(10000 as libc::c_int));
}
#[no_mangle]
pub unsafe extern "C" fn LUA_PushTaggableObjectArray(
    mut L: *mut lua_State,
    mut field: *const libc::c_char,
    mut iterator: lua_CFunction,
    mut indexer: lua_CFunction,
    mut counter: lua_CFunction,
    mut garray: *mut *mut taggroup_t,
    mut max_elements: *mut size_t,
    mut element_array: *mut libc::c_void,
    mut sizeof_element: size_t,
    mut meta: *const libc::c_char,
) {
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(L, iterator, 0 as libc::c_int);
    lua_setfield(
        L,
        -(2 as libc::c_int),
        b"iterate\0" as *const u8 as *const libc::c_char,
    );
    LUA_InsertTaggroupIterator(
        L,
        garray,
        max_elements,
        element_array,
    ...
    lua_pushcclosure(L, indexer, 0 as libc::c_int);
    lua_setfield(
        L,
        -(2 as libc::c_int),
    ...
    lua_pushcclosure(L, counter, 0 as libc::c_int);
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(L, -(10002 as libc::c_int), field);
}
