...
extern "C" {
    ...
    fn SlopeDivEx(num: libc::c_uint, den: libc::c_uint) -> uint64_t;
    ...
    static mut scaledviewwidth: int32_t;
    ...
    fn NetUpdate();
    fn CL_AddSplitscreenPlayer();
    fn CL_RemoveSplitscreenPlayer();
    ...
    fn R_InitDrawNodes();
    fn R_InitTranslucencyTables();
    fn R_InitPlanes();
    static mut ds_szp: *mut floatv3_t;
    static mut ds_svp: *mut floatv3_t;
    static mut ds_sup: *mut floatv3_t;
    static mut ds_sz: *mut floatv3_t;
    static mut ds_sv: *mut floatv3_t;
    static mut ds_su: *mut floatv3_t;
    static mut yslopetab: [fixed_t; 19200];
    fn R_SetSkyScale();
    static mut screenheightarray: [int16_t; 1920];
    static mut focallengthf: libc::c_float;
    fn R_InitViewBuffer(width: int32_t, height: int32_t);
    fn R_UsingFrameInterpolation() -> boolean;
    fn R_InterpolateView(frac: fixed_t);
    static mut newview: *mut viewvars_t;
    fn R_ResetViewInterpolation(p: uint8_t);
    fn R_SetViewContext(_viewcontext: viewcontext_e);
    fn R_DrawMasked(masks: *mut maskcount_t, nummasks: int32_t);
    fn R_DrawPlanes();
    fn Portal_Remove(portal: *mut portal_t);
    static mut ds_p: *mut drawseg_t;
    fn R_ClipSprites(dsstart: *mut drawseg_t, portal: *mut portal_t);
    static mut visspritecount: uint32_t;
    static mut drawsegs: *mut drawseg_t;
    fn R_RenderBSPNode(bspnum: int32_t);
    static mut curdrawsegs: *mut drawseg_t;
    fn Portal_ClipApply(portal: *const portal_t);
    fn R_PortalClearClipSegs(start: int32_t, end: int32_t);
    static mut portalcullsector: *mut sector_t;
    static mut portalclipline: *mut line_t;
    static mut portalclipend: int32_t;
    static mut portalclipstart: int32_t;
    fn R_ClearFFloorClips();
    static mut portalrender: uint8_t;
    static mut portal_base: *mut portal_t;
    fn Portal_AddSkyboxPortals();
    static mut numvisiblesprites: uint32_t;
    fn Portal_InitList();
    fn R_ClearSprites();
    fn R_ClearSegTables();
    fn R_ClearDrawSegs();
...
pub const CR_FAN: C2RustUnnamed_0 = 13;
pub const CR_DUSTDEVIL: C2RustUnnamed_0 = 12;
pub const CR_PTERABYTE: C2RustUnnamed_0 = 11;
pub const CR_ROLLOUT: C2RustUnnamed_0 = 10;
pub const CR_MINECART: C2RustUnnamed_0 = 9;
pub const CR_MACESPIN: C2RustUnnamed_0 = 8;
pub const CR_ROPEHANG: C2RustUnnamed_0 = 7;
pub const CR_ZOOMTUBE: C2RustUnnamed_0 = 6;
pub const CR_BRAKGOOP: C2RustUnnamed_0 = 5;
pub const CR_NIGHTSFALL: C2RustUnnamed_0 = 4;
pub const CR_NIGHTSMODE: C2RustUnnamed_0 = 3;
pub const CR_PLAYER: C2RustUnnamed_0 = 2;
pub const CR_GENERIC: C2RustUnnamed_0 = 1;
pub const CR_NONE: C2RustUnnamed_0 = 0;
...
pub struct C2RustUnnamed_7 {
    pub rollangle: angle_t,
    pub zoomneeded: fixed_t,
    pub scrmap: *mut int32_t,
    pub scrmapsize: int32_t,
    pub x1: int32_t,
    pub ceilingclip: [int16_t; 1920],
    pub floorclip: [int16_t; 1920],
    pub use_0: boolean,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type viewcontext_e = libc::c_uint;
pub const VIEWCONTEXT_SKY2: viewcontext_e = 3;
pub const VIEWCONTEXT_SKY1: viewcontext_e = 2;
pub const VIEWCONTEXT_PLAYER2: viewcontext_e = 1;
pub const VIEWCONTEXT_PLAYER1: viewcontext_e = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut validcount: size_t = 1 as libc::c_int as size_t;
#[no_mangle]
pub static mut centerx: int32_t = 0;
#[no_mangle]
pub static mut centery: int32_t = 0;
#[no_mangle]
...
#[no_mangle]
pub static mut projectiony: fixed_t = 0;
#[no_mangle]
pub static mut fovtan: fixed_t = 0;
#[no_mangle]
pub static mut framecount: size_t = 0;
#[no_mangle]
pub static mut loopcount: size_t = 0;
#[no_mangle]
...
#[no_mangle]
pub static mut aimingangle: angle_t = 0;
#[no_mangle]
pub static mut viewcos: fixed_t = 0;
#[no_mangle]
pub static mut viewsin: fixed_t = 0;
#[no_mangle]
pub static mut viewsector: *mut sector_t = 0 as *const sector_t as *mut sector_t;
#[no_mangle]
pub static mut viewplayer: *mut player_t = 0 as *const player_t as *mut player_t;
#[no_mangle]
pub static mut r_viewmobj: *mut mobj_t = 0 as *const mobj_t as *mut mobj_t;
#[no_mangle]
pub static mut rendertimefrac: fixed_t = 0;
#[no_mangle]
pub static mut renderdeltatics: fixed_t = 0;
#[no_mangle]
pub static mut renderisnewtic: boolean = 0;
#[no_mangle]
pub static mut clipangle: angle_t = 0;
#[no_mangle]
pub static mut doubleclipangle: angle_t = 0;
#[no_mangle]
pub static mut viewangletox: [int32_t; 4096] = [0; 4096];
#[no_mangle]
pub static mut xtoviewangle: [angle_t; 1921] = [0; 1921];
#[no_mangle]
pub static mut scalelight: [[*mut lighttable_t; 48]; 32] = [[0 as *const lighttable_t
    as *mut lighttable_t; 48]; 32];
#[no_mangle]
pub static mut scalelightfixed: [*mut lighttable_t; 48] = [0 as *const lighttable_t
    as *mut lighttable_t; 48];
#[no_mangle]
pub static mut zlight: [[*mut lighttable_t; 128]; 32] = [[0 as *const lighttable_t
    as *mut lighttable_t; 128]; 32];
#[no_mangle]
pub static mut extra_colormaps: *mut extracolormap_t = 0 as *const extracolormap_t
    as *mut extracolormap_t;
#[no_mangle]
pub static mut ps_prevframetime: precise_t = 0 as libc::c_int as precise_t;
#[no_mangle]
pub static mut ps_rendercalltime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
        history: 0 as *const libc::c_void as *mut libc::c_void,
    };
    init
};
#[no_mangle]
pub static mut ps_otherrendertime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_uitime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_swaptime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_bsptime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_sw_spritecliptime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_sw_portaltime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_sw_planetime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_sw_maskedtime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_numbspcalls: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_numsprites: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_numdrawnodes: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_numpolyobjects: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_6 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut drawdist_cons_t: [CV_PossibleValue_t; 12] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 256 as libc::c_int,
            strvalue: b"256\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 512 as libc::c_int,
    ...
    {
        let mut init = CV_PossibleValue_s {
            value: 768 as libc::c_int,
            strvalue: b"768\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"1024\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1536 as libc::c_int,
            strvalue: b"1536\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2048 as libc::c_int,
            strvalue: b"2048\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3072 as libc::c_int,
            strvalue: b"3072\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 4096 as libc::c_int,
            strvalue: b"4096\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 6144 as libc::c_int,
            strvalue: b"6144\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 8192 as libc::c_int,
            strvalue: b"8192\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut drawdist_precip_cons_t: [CV_PossibleValue_t; 8] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 256 as libc::c_int,
            strvalue: b"256\0" as *const u8 as *const libc::c_char,
...
static mut fov_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
    ...
    {
        let mut init = CV_PossibleValue_s {
            value: 179 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
...
static mut translucenthud_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
static mut maxportals_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
static mut homremoval_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Flash\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_tailspickup: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tailspickup\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_chasecam: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"chasecam\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(ChaseCam_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_chasecam2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"chasecam2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(ChaseCam2_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_flipcam: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"flipcam\0" as *const u8 as *const libc::c_char,
            ...
            func: Some(FlipCam_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_flipcam2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"flipcam2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"No\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int
                | CV_NOINIT as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
            func: Some(FlipCam2_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_shadow: consvar_t = unsafe {
    {
        let mut init = consvar_s {
...
#[no_mangle]
pub static mut cv_skybox: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"skybox\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_ffloorclip: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"r_ffloorclip\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_spriteclip: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"r_spriteclip\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_allowmlook: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"allowmlook\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_showhud: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"showhud\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
            func: Some(R_SetViewSize as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_translucenthud: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"translucenthud\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: translucenthud_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_translucency: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"translucency\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_drawdist: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"drawdist\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Infinite\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: drawdist_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_drawdist_nights: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"drawdist_nights\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"2048\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: drawdist_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_drawdist_precip: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"drawdist_precip\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1024\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: drawdist_precip_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_fov: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"fov\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"90\0" as *const u8 as *const libc::c_char,
            flags: CV_FLOAT as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: fov_cons_t.as_ptr() as *mut _,
            func: Some(Fov_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_homremoval: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"homremoval\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"No\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: homremoval_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_maxportals: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"maxportals\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"2\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: maxportals_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_renderstats: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"renderstats\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn SplitScreen_OnChange() {
    if cv_debug == 0 && netgame != 0 {
        if splitscreen != 0 {
            CONS_Alert(
                CONS_NOTICE,
                b"Splitscreen not supported in netplay, sorry!\n\0" as *const u8
...
unsafe extern "C" fn Fov_OnChange() {
    R_SetViewSize();
}
unsafe extern "C" fn ChaseCam_OnChange() {
    if cv_chasecam.value == 0 || cv_useranalog[0 as libc::c_int as usize].value == 0 {
        CV_SetValue(
...
unsafe extern "C" fn ChaseCam2_OnChange() {
    if botingame != 0 {
        return;
    }
    if cv_chasecam2.value == 0 || cv_useranalog[1 as libc::c_int as usize].value == 0 {
        CV_SetValue(
...
unsafe extern "C" fn FlipCam_OnChange() {
    SendWeaponPref();
}
unsafe extern "C" fn FlipCam2_OnChange() {
    SendWeaponPref2();
}
#[no_mangle]
pub unsafe extern "C" fn R_PointOnSide(
    ...
    if (*node).dx == 0 {
        return if x <= (*node).x {
            ((*node).dy > 0 as libc::c_int) as libc::c_int
        } else {
            ((*node).dy < 0 as libc::c_int) as libc::c_int
        };
    }
    if (*node).dy == 0 {
        return if y <= (*node).y {
            ((*node).dx < 0 as libc::c_int) as libc::c_int
        } else {
            ((*node).dx > 0 as libc::c_int) as libc::c_int
        };
    }
    let mut dx: fixed_t = (x >> 1 as libc::c_int) - ((*node).x >> 1 as libc::c_int);
    let mut dy: fixed_t = (y >> 1 as libc::c_int) - ((*node).y >> 1 as libc::c_int);
    if (*node).dy ^ (*node).dx ^ dx ^ dy < 0 as libc::c_int {
        return ((*node).dy ^ dx < 0 as libc::c_int) as libc::c_int;
    }
    return (FixedMul(dy, (*node).dx >> 16 as libc::c_int)
        >= FixedMul((*node).dy >> 16 as libc::c_int, dx)) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_PointOnSegSide(
    ...
    let mut lx: fixed_t = (*(*line).v1).x;
    let mut ly: fixed_t = (*(*line).v1).y;
    let mut ldx: fixed_t = (*(*line).v2).x - lx;
    let mut ldy: fixed_t = (*(*line).v2).y - ly;
    if ldx == 0 {
        return if x <= lx {
            (ldy > 0 as libc::c_int) as libc::c_int
        } else {
            (ldy < 0 as libc::c_int) as libc::c_int
        };
    }
    if ldy == 0 {
        return if y <= ly {
            (ldx < 0 as libc::c_int) as libc::c_int
        } else {
            (ldx > 0 as libc::c_int) as libc::c_int
        };
    }
    let mut dx: fixed_t = (x >> 1 as libc::c_int) - (lx >> 1 as libc::c_int);
    let mut dy: fixed_t = (y >> 1 as libc::c_int) - (ly >> 1 as libc::c_int);
    if ldy ^ ldx ^ dx ^ dy < 0 as libc::c_int {
        return (ldy ^ dx < 0 as libc::c_int) as libc::c_int;
    }
    return (FixedMul(dy, ldx >> 16 as libc::c_int)
        >= FixedMul(ldy >> 16 as libc::c_int, dx)) as libc::c_int;
}
#[no_mangle]
    ...
    return if x != 0 || y != 0 {
        if x >= 0 as libc::c_int {
            if y >= 0 as libc::c_int {
                if x > y {
                    tantoangle[SlopeDiv(y as libc::c_uint, x as libc::c_uint) as usize]
                } else {
                    (0x40000000 as libc::c_int as angle_t)
                        .wrapping_sub(
                            tantoangle[SlopeDiv(x as libc::c_uint, y as libc::c_uint)
                                as usize],
                        )
                }
            } else {
                ...
                if x > y {
                    (0 as libc::c_int as angle_t)
                        .wrapping_sub(
                            tantoangle[SlopeDiv(y as libc::c_uint, x as libc::c_uint)
                                as usize],
                        )
                } else {
...
#[no_mangle]
pub unsafe extern "C" fn R_PointToAngle64(mut x: int64_t, mut y: int64_t) -> angle_t {
    y -= viewy as int64_t;
    x -= viewx as int64_t;
    return if x != 0 || y != 0 {
        if x >= 0 as libc::c_int as int64_t {
            if y >= 0 as libc::c_int as int64_t {
                if x > y {
                    tantoangle[SlopeDivEx(y as libc::c_uint, x as libc::c_uint) as usize]
                } else {
                    (0x40000000 as libc::c_int as angle_t)
                        .wrapping_sub(
                            tantoangle[SlopeDivEx(x as libc::c_uint, y as libc::c_uint)
                                as usize],
                        )
                }
            } else {
                ...
                if x > y {
                    (0 as libc::c_int as angle_t)
                        .wrapping_sub(
                            tantoangle[SlopeDivEx(y as libc::c_uint, x as libc::c_uint)
                                as usize],
                        )
                } else {
                    (0xc0000000 as libc::c_uint)
        ...
        } else if y >= 0 as libc::c_int as int64_t {
            x = -x;
            if x > y {
                (0x80000000 as libc::c_uint)
                    .wrapping_sub(
...
#[no_mangle]
pub unsafe extern "C" fn R_PointToDist2(
    mut px2: fixed_t,
    mut py2: fixed_t,
    mut px1: fixed_t,
    mut py1: fixed_t,
    ...
    angle = (tantoangle[(FixedDiv(dy, dx) >> 16 as libc::c_int - 11 as libc::c_int)
        as usize])
...
#[no_mangle]
pub unsafe extern "C" fn R_PointToAngleEx(
    mut x2: int32_t,
    mut y2: int32_t,
    mut x1: int32_t,
    mut y1: int32_t,
) -> angle_t {
    let mut dx: int64_t = (x1 - x2) as int64_t;
    let mut dy: int64_t = (y1 - y2) as int64_t;
    if dx < (-(2147483647 as libc::c_int) - 1 as libc::c_int) as int64_t
        || dx > 2147483647 as libc::c_int as int64_t
        || dy < (-(2147483647 as libc::c_int) - 1 as libc::c_int) as int64_t
        || dy > 2147483647 as libc::c_int as int64_t
    {
        x1 = (dx / 2 as libc::c_int as int64_t + x2 as int64_t) as libc::c_int;
        y1 = (dy / 2 as libc::c_int as int64_t + y2 as int64_t) as libc::c_int;
    }
    y1 -= y2;
    x1 -= x2;
    return if x1 != 0 || y1 != 0 {
        if x1 >= 0 as libc::c_int {
            if y1 >= 0 as libc::c_int {
                if x1 > y1 {
                    tantoangle[SlopeDivEx(y1 as libc::c_uint, x1 as libc::c_uint)
                        as usize]
                } else {
                    (0x40000000 as libc::c_int as angle_t)
                        .wrapping_sub(
                            tantoangle[SlopeDivEx(x1 as libc::c_uint, y1 as libc::c_uint)
                                as usize],
                        )
                }
            } else {
...
pub unsafe extern "C" fn R_ScaleFromGlobalAngle(mut visangle: angle_t) -> fixed_t {
    let mut anglea: angle_t = (0x40000000 as libc::c_int as angle_t)
        .wrapping_add(visangle.wrapping_sub(viewangle));
    let mut angleb: angle_t = (0x40000000 as libc::c_int as angle_t)
        .wrapping_add(visangle.wrapping_sub(rw_normalangle));
    let mut den: fixed_t = FixedMul(
        rw_distance,
        finesine[(anglea >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int,
    );
    let mut num: fixed_t = FixedMul(
        projectiony,
        finesine[(angleb >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int,
    );
    if den > num >> 16 as libc::c_int {
        num = FixedDiv(num, den);
        if num > 64 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int) {
            return 64 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
        }
...
#[no_mangle]
pub unsafe extern "C" fn R_DoCulling(
    mut cullheight: *mut line_t,
    mut viewcullheight: *mut line_t,
    mut vz: fixed_t,
    mut bottomh: fixed_t,
    mut toph: fixed_t,
) -> boolean {
    let mut cullplane: fixed_t = 0;
    if cullheight.is_null() {
        return false_0 as libc::c_int;
    }
    cullplane = (*(*cullheight).frontsector).floorheight;
    if (*cullheight).args[1 as libc::c_int as usize] != 0 {
        if viewcullheight.is_null() {
            return false_0 as libc::c_int;
        }
        if (*viewcullheight).frontsector == (*cullheight).frontsector {
            if vz > cullplane && toph < cullplane {
                return true_0 as libc::c_int;
            }
            if bottomh > cullplane && vz <= cullplane {
                return true_0 as libc::c_int;
            }
        }
    } else {
...
unsafe extern "C" fn R_InitTextureMapping() {
    let mut i: int32_t = 0;
    let mut x: int32_t = 0;
    let mut t: int32_t = 0;
    ...
    focallength = FixedDiv(
        projection,
        finetangent[(8192 as libc::c_int / 4 as libc::c_int
            + 2048 as libc::c_int / 2 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int,
    );
    focallengthf = FixedToFloat(focallength);
    i = 0 as libc::c_int;
    while i < 8192 as libc::c_int / 2 as libc::c_int {
        if finetangent[i as usize] >> 16 as libc::c_int - 16 as libc::c_int
            > fovtan * 2 as libc::c_int
        {
            t = -(1 as libc::c_int);
        } else if (finetangent[i as usize] >> 16 as libc::c_int - 16 as libc::c_int)
            < -fovtan * 2 as libc::c_int
        {
            t = viewwidth + 1 as libc::c_int;
        } else {
            t = FixedMul(
                finetangent[i as usize] >> 16 as libc::c_int - 16 as libc::c_int,
                focallength,
            );
            t = centerxfrac - t + ((1 as libc::c_int) << 16 as libc::c_int)
                - 1 as libc::c_int >> 16 as libc::c_int;
            if t < -(1 as libc::c_int) {
                t = -(1 as libc::c_int);
            } else if t > viewwidth + 1 as libc::c_int {
                t = viewwidth + 1 as libc::c_int;
            }
        }
    ...
    while x <= viewwidth {
        ...
        xtoviewangle[x
            as usize] = ((i << 19 as libc::c_int) - 0x40000000 as libc::c_int)
            as angle_t;
        x += 1;
        x;
    }
    i = 0 as libc::c_int;
    while i < 8192 as libc::c_int / 2 as libc::c_int {
        if viewangletox[i as usize] == -(1 as libc::c_int) {
            viewangletox[i as usize] = 0 as libc::c_int;
        } else if viewangletox[i as usize] == viewwidth + 1 as libc::c_int {
            viewangletox[i as usize] = viewwidth;
        }
        i += 1;
        i;
    }
    clipangle = xtoviewangle[0 as libc::c_int as usize];
    doubleclipangle = clipangle * 2 as libc::c_int as angle_t;
}
#[inline]
unsafe extern "C" fn R_InitLightTables() {
    let mut i: int32_t = 0;
    let mut j: int32_t = 0;
    let mut level: int32_t = 0;
    let mut startmapl: int32_t = 0;
    let mut scale: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        startmapl = (32 as libc::c_int - 1 as libc::c_int - i) * 2 as libc::c_int
        ...
        while j < 128 as libc::c_int {
            scale = FixedDiv(
                320 as libc::c_int / 2 as libc::c_int
                    * ((1 as libc::c_int) << 16 as libc::c_int),
                (j + 1 as libc::c_int) << 20 as libc::c_int,
            );
            scale >>= 12 as libc::c_int;
            level = startmapl - scale / 2 as libc::c_int;
            if level < 0 as libc::c_int {
                level = 0 as libc::c_int;
            }
            if level >= 32 as libc::c_int {
                level = 32 as libc::c_int - 1 as libc::c_int;
            }
            zlight[i
                as usize][j
                as usize] = colormaps.offset((level * 256 as libc::c_int) as isize);
            j += 1;
            j;
        }
        i += 1;
...
static mut viewmorph: C2RustUnnamed_7 = {
    let mut init = C2RustUnnamed_7 {
        rollangle: 0 as libc::c_int as angle_t,
        zoomneeded: (1 as libc::c_int) << 16 as libc::c_int,
        scrmap: 0 as *const int32_t as *mut int32_t,
        scrmapsize: 0 as libc::c_int,
        x1: 0 as libc::c_int,
        ceilingclip: [
        ...
        use_0: false_0 as libc::c_int,
    };
    init
};
#[no_mangle]
pub unsafe extern "C" fn R_CheckViewMorph() {
    let mut zoomfactor: libc::c_float = 0.;
    let mut rollcos: libc::c_float = 0.;
    let mut rollsin: libc::c_float = 0.;
    let mut x1: libc::c_float = 0.;
    let mut y1: libc::c_float = 0.;
    let mut x2: libc::c_float = 0.;
    let mut y2: libc::c_float = 0.;
    let mut temp: fixed_t = 0;
    let mut end: int32_t = 0;
    let mut vx: int32_t = 0;
    let mut vy: int32_t = 0;
    let mut pos: int32_t = 0;
    let mut usedpos: int32_t = 0;
    let mut usedx: int32_t = 0;
    let mut usedy: int32_t = 0;
    let mut halfwidth: int32_t = vid.width / 2 as libc::c_int;
    let mut halfheight: int32_t = vid.height / 2 as libc::c_int;
    let mut rollangle: angle_t = players[displayplayer as usize].viewrollangle;
    rollangle >>= 19 as libc::c_int;
    rollangle = rollangle.wrapping_add(2 as libc::c_int as angle_t)
        & !(3 as libc::c_int) as angle_t
    ...
    if viewmorph.rollangle == 0 as libc::c_int as angle_t {
        viewmorph.use_0 = false_0 as libc::c_int;
        viewmorph.x1 = 0 as libc::c_int;
        if viewmorph.zoomneeded != (1 as libc::c_int) << 16 as libc::c_int {
            R_SetViewSize();
        }
        viewmorph.zoomneeded = (1 as libc::c_int) << 16 as libc::c_int;
        return;
    }
    if viewmorph.scrmapsize != vid.width * vid.height {
        if !(viewmorph.scrmap).is_null() {
            free(viewmorph.scrmap as *mut libc::c_void);
        }
        viewmorph
            .scrmap = malloc(
    ...
    temp = *finecosine.offset(rollangle as isize)
        >> 16 as libc::c_int - 16 as libc::c_int;
    rollcos = FixedToFloat(temp);
    temp = finesine[rollangle as usize] >> 16 as libc::c_int - 16 as libc::c_int;
    rollsin = FixedToFloat(temp);
    x1 = (vid.width as libc::c_float * fabsf(rollcos)
        + vid.height as libc::c_float * fabsf(rollsin)) / vid.width as libc::c_float;
    y1 = (vid.height as libc::c_float * fabsf(rollcos)
        + vid.width as libc::c_float * fabsf(rollsin)) / vid.height as libc::c_float;
    temp = ((if x1 > y1 { x1 } else { y1 })
        * ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_float) as fixed_t;
    if temp < (1 as libc::c_int) << 16 as libc::c_int {
        temp = (1 as libc::c_int) << 16 as libc::c_int;
    } else {
        temp |= 0x3fff as libc::c_int;
    }
    if temp != viewmorph.zoomneeded {
        viewmorph.zoomneeded = temp;
        R_SetViewSize();
    }
    zoomfactor = FixedToFloat(viewmorph.zoomneeded);
    end = vid.width * vid.height - 1 as libc::c_int;
    pos = 0 as libc::c_int;
    rollcos /= zoomfactor;
    rollsin /= zoomfactor;
    x1 = -(halfwidth as libc::c_float * rollcos - halfheight as libc::c_float * rollsin);
    y1 = -(halfheight as libc::c_float * rollcos + halfwidth as libc::c_float * rollsin);
    viewmorph
        .x1 = (halfwidth as libc::c_float
        - (halfwidth as libc::c_float * fabsf(rollcos)
            + halfheight as libc::c_float * fabsf(rollsin))) as int32_t;
    vx = 0 as libc::c_int;
    while vx < vid.width {
        viewmorph.ceilingclip[vx as usize] = vid.height as int16_t;
        viewmorph.floorclip[vx as usize] = -(1 as libc::c_int) as int16_t;
        vx += 1;
        vx;
    }
    x2 = x1;
    ...
    vx = 0 as libc::c_int;
    while vx < vid.width {
        let mut xa: int16_t = 0;
        let mut ya: int16_t = 0;
        let mut xb: int16_t = 0;
        let mut yb: int16_t = 0;
        xa = (x2 + halfwidth as libc::c_float) as int16_t;
        ya = (y2 + halfheight as libc::c_float - 1 as libc::c_int as libc::c_float)
            as int16_t;
        xb = (vid.width - 1 as libc::c_int - xa as libc::c_int) as int16_t;
        yb = (vid.height - 1 as libc::c_int - ya as libc::c_int) as int16_t;
        viewmorph
            .ceilingclip[xa
            as usize] = (if (viewmorph.ceilingclip[xa as usize] as libc::c_int)
            < ya as libc::c_int
        {
            viewmorph.ceilingclip[xa as usize] as libc::c_int
        } else {
            ya as libc::c_int
        }) as int16_t;
        viewmorph
            .floorclip[xa
            as usize] = (if viewmorph.floorclip[xa as usize] as libc::c_int
            > ya as libc::c_int
        {
            viewmorph.floorclip[xa as usize] as libc::c_int
        } else {
            ya as libc::c_int
        }) as int16_t;
        viewmorph
            .ceilingclip[xb
            as usize] = (if (viewmorph.ceilingclip[xb as usize] as libc::c_int)
            < yb as libc::c_int
        {
            viewmorph.ceilingclip[xb as usize] as libc::c_int
        } else {
            yb as libc::c_int
        }) as int16_t;
        viewmorph
            .floorclip[xb
            as usize] = (if viewmorph.floorclip[xb as usize] as libc::c_int
            > yb as libc::c_int
        {
            viewmorph.floorclip[xb as usize] as libc::c_int
        } else {
            yb as libc::c_int
        }) as int16_t;
        x2 += rollcos;
    ...
    vy = 0 as libc::c_int;
    while vy < vid.height {
        let mut xa_0: int16_t = 0;
        let mut ya_0: int16_t = 0;
        let mut xb_0: int16_t = 0;
        let mut yb_0: int16_t = 0;
        xa_0 = (x2 + halfwidth as libc::c_float) as int16_t;
        ya_0 = (y2 + halfheight as libc::c_float) as int16_t;
        xb_0 = (vid.width - 1 as libc::c_int - xa_0 as libc::c_int) as int16_t;
        yb_0 = (vid.height - 1 as libc::c_int - ya_0 as libc::c_int) as int16_t;
        viewmorph
            .ceilingclip[xa_0
            as usize] = (if (viewmorph.ceilingclip[xa_0 as usize] as libc::c_int)
            < ya_0 as libc::c_int
        {
            viewmorph.ceilingclip[xa_0 as usize] as libc::c_int
        } else {
            ya_0 as libc::c_int
        }) as int16_t;
        viewmorph
            .floorclip[xa_0
            as usize] = (if viewmorph.floorclip[xa_0 as usize] as libc::c_int
            > ya_0 as libc::c_int
        {
            viewmorph.floorclip[xa_0 as usize] as libc::c_int
        } else {
            ya_0 as libc::c_int
        }) as int16_t;
        viewmorph
            .ceilingclip[xb_0
            as usize] = (if (viewmorph.ceilingclip[xb_0 as usize] as libc::c_int)
            < yb_0 as libc::c_int
        {
            viewmorph.ceilingclip[xb_0 as usize] as libc::c_int
        } else {
            yb_0 as libc::c_int
        }) as int16_t;
        viewmorph
            .floorclip[xb_0
            as usize] = (if viewmorph.floorclip[xb_0 as usize] as libc::c_int
            > yb_0 as libc::c_int
        {
            viewmorph.floorclip[xb_0 as usize] as libc::c_int
        } else {
            yb_0 as libc::c_int
        }) as int16_t;
        x2 -= rollsin;
    ...
    while vy < halfheight {
        ...
        while vx < vid.width {
            ...
            *(viewmorph.scrmap).offset(pos as isize) = usedpos;
            *(viewmorph.scrmap).offset((end - pos) as isize) = end - usedpos;
            x2 += rollcos;
            y2 += rollsin;
            pos += 1;
            pos;
    ...
    viewmorph.use_0 = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ApplyViewMorph() {
    let mut tmpscr: *mut uint8_t = screens[4 as libc::c_int as usize];
    let mut srcscr: *mut uint8_t = screens[0 as libc::c_int as usize];
    let mut p: int32_t = 0;
    let mut end: int32_t = vid.width * vid.height;
    if viewmorph.use_0 == 0 {
        return;
    }
    if cv_debug & 0x2000 as libc::c_int != 0 {
        let mut border: uint8_t = 32 as libc::c_int as uint8_t;
        let mut grid: uint8_t = 160 as libc::c_int as uint8_t;
        let mut ws: int32_t = vid.width / 4 as libc::c_int;
        let mut hs: int32_t = vid.width * (vid.height / 4 as libc::c_int);
        memcpy(
            tmpscr as *mut libc::c_void,
            srcscr as *const libc::c_void,
            (vid.width * vid.height) as libc::c_ulong,
        );
        p = 0 as libc::c_int;
        while p < vid.width {
            *tmpscr.offset(*(viewmorph.scrmap).offset(p as isize) as isize) = border;
            *tmpscr
                .offset(*(viewmorph.scrmap).offset((p + hs) as isize) as isize) = grid;
            *tmpscr
                .offset(
                    *(viewmorph.scrmap).offset((p + hs * 2 as libc::c_int) as isize)
                        as isize,
                ) = grid;
            *tmpscr
                .offset(
                    *(viewmorph.scrmap).offset((p + hs * 3 as libc::c_int) as isize)
                        as isize,
                ) = grid;
            *tmpscr
                .offset(
                    *(viewmorph.scrmap).offset((end - 1 as libc::c_int - p) as isize)
                        as isize,
                ) = border;
            p += 1;
            p;
        ...
        while p < end {
            *tmpscr.offset(*(viewmorph.scrmap).offset(p as isize) as isize) = border;
            *tmpscr
                .offset(*(viewmorph.scrmap).offset((p + ws) as isize) as isize) = grid;
            *tmpscr
                .offset(
                    *(viewmorph.scrmap).offset((p + ws * 2 as libc::c_int) as isize)
                        as isize,
                ) = grid;
            *tmpscr
                .offset(
                    *(viewmorph.scrmap).offset((p + ws * 3 as libc::c_int) as isize)
                        as isize,
                ) = grid;
            *tmpscr
                .offset(
        ...
        while p < end {
            *tmpscr
                .offset(
                    p as isize,
                ) = *srcscr.offset(*(viewmorph.scrmap).offset(p as isize) as isize);
            p += 1;
            p;
        }
    }
...
pub unsafe extern "C" fn R_SetViewSize() {
    setsizeneeded = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ExecuteSetViewSize() {
    ...
    let mut level: int32_t = 0;
    let mut startmapl: int32_t = 0;
    let mut fov: angle_t = 0;
    setsizeneeded = false_0 as libc::c_int;
    ...
    if splitscreen != 0 {
        viewheight >>= 1 as libc::c_int;
    }
    viewwidth = scaledviewwidth;
    centerx = viewwidth / 2 as libc::c_int;
    centery = viewheight / 2 as libc::c_int;
    centerxfrac = centerx << 16 as libc::c_int;
    centeryfrac = centery << 16 as libc::c_int;
    fov = (FixedAngle(cv_fov.value / 2 as libc::c_int))
        .wrapping_add(0x40000000 as libc::c_int as angle_t);
    fovtan = FixedMul(
        finetangent[(fov >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int,
        viewmorph.zoomneeded,
    );
    if splitscreen == 1 as libc::c_int {
        fovtan = 17 as libc::c_int * fovtan / 10 as libc::c_int;
    }
    projectiony = FixedDiv(centerxfrac, fovtan);
    projection = projectiony;
    R_InitViewBuffer(scaledviewwidth, viewheight);
    R_InitTextureMapping();
    i = 0 as libc::c_int;
    while i < viewwidth {
        screenheightarray[i as usize] = viewheight as int16_t;
        i += 1;
        i;
    }
    R_SetSkyScale();
    if rendermode as libc::c_uint == render_soft as libc::c_int as libc::c_uint {
        j = viewheight * 16 as libc::c_int;
        i = 0 as libc::c_int;
        while i < j {
            dy = (i - viewheight * 8 as libc::c_int) << 16 as libc::c_int;
            dy = FixedMul(abs(dy), fovtan);
            yslopetab[i
                as usize] = FixedDiv(
                centerx * ((1 as libc::c_int) << 16 as libc::c_int),
                dy,
            );
            i += 1;
            i;
        ...
        if !ds_su.is_null() {
            Z_Free(ds_su as *mut libc::c_void);
        }
        if !ds_sv.is_null() {
            Z_Free(ds_sv as *mut libc::c_void);
        }
        if !ds_sz.is_null() {
            Z_Free(ds_sz as *mut libc::c_void);
        }
        ds_sz = 0 as *mut floatv3_t;
        ds_sv = ds_sz;
        ds_su = ds_sv;
        ds_szp = 0 as *mut floatv3_t;
        ds_svp = ds_szp;
        ds_sup = ds_svp;
    }
    memset(
        scalelight.as_mut_ptr() as *mut libc::c_void,
        0xff as libc::c_int,
        ::core::mem::size_of::<[[*mut lighttable_t; 48]; 32]>() as libc::c_ulong,
    );
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        startmapl = (32 as libc::c_int - 1 as libc::c_int - i) * 2 as libc::c_int
            * 32 as libc::c_int / 32 as libc::c_int;
        j = 0 as libc::c_int;
        while j < 48 as libc::c_int {
            level = startmapl - j * vid.width / viewwidth / 2 as libc::c_int;
            if level < 0 as libc::c_int {
                level = 0 as libc::c_int;
            }
            if level >= 32 as libc::c_int {
    ...
    am_recalc = true_0 as libc::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn R_PointInSubsector(
    ...
    let mut nodenum: size_t = numnodes.wrapping_sub(1 as libc::c_int as size_t);
    while nodenum & 0x8000 as libc::c_int as size_t == 0 {
        nodenum = (*nodes.offset(nodenum as isize))
            .children[R_PointOnSide(x, y, nodes.offset(nodenum as isize)) as usize]
            as size_t;
    }
    return &mut *subsectors
        .offset((nodenum & !(0x8000 as libc::c_int) as size_t) as isize)
        as *mut subsector_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_PointInSubsectorOrNull(
    mut x: fixed_t,
    mut y: fixed_t,
) -> *mut subsector_t {
    ...
    let mut i: int32_t = 0;
    let mut nodenum: size_t = 0;
    let mut ret: *mut subsector_t = 0 as *mut subsector_t;
    let mut seg: *mut seg_t = 0 as *mut seg_t;
    if numnodes == 0 as libc::c_int as size_t {
        return subsectors;
    }
    nodenum = numnodes.wrapping_sub(1 as libc::c_int as size_t);
    while nodenum & 0x8000 as libc::c_int as size_t == 0 {
        node = &mut *nodes.offset(nodenum as isize) as *mut node_t;
        side = R_PointOnSide(x, y, node);
        nodenum = (*node).children[side as usize] as size_t;
    }
    ret = &mut *subsectors
        .offset((nodenum & !(0x8000 as libc::c_int) as size_t) as isize)
        as *mut subsector_t;
    i = 0 as libc::c_int;
    seg = &mut *segs.offset((*ret).firstline as isize) as *mut seg_t;
    while i < (*ret).numlines as libc::c_int {
        if !((*seg).glseg != 0) {
            if P_PointOnLineSide(x, y, (*seg).linedef) != (*seg).side {
                return 0 as *mut subsector_t;
            }
        }
        i += 1;
        i;
...
pub unsafe extern "C" fn R_SetupFrame(mut player: *mut player_t) {
    ...
    let mut chasecam: boolean = R_ViewpointHasChasecam(player);
    if splitscreen != 0
        && player
    ...
    (*newview).sky = false_0 as libc::c_int;
    if (*player).awayviewtics != 0 {
        r_viewmobj = (*player).awayviewmobj;
        (*newview)
            .z = (*r_viewmobj).z
            + 20 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
        (*newview).aim = (*player).awayviewaiming;
        (*newview).angle = (*r_viewmobj).angle;
    } else if (*player).spectator == 0 && chasecam != 0 {
        r_viewmobj = 0 as *mut mobj_t;
        (*newview).z = (*thiscam).z + ((*thiscam).height >> 1 as libc::c_int);
                ...
                != PST_DEAD as libc::c_int as libc::c_uint
        {
            if player
                == &mut *players.as_mut_ptr().offset(consoleplayer as isize)
                    as *mut player_t
            {
                (*newview).angle = localangle;
                (*newview).aim = localaiming as angle_t;
            } else if player
                == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                    as *mut player_t
            {
                (*newview).angle = localangle2;
                (*newview).aim = localaiming2 as angle_t;
            }
        }
    }
    (*newview).z += quake.z;
    (*newview).player = player;
    if chasecam != 0 && (*player).awayviewtics == 0 && (*player).spectator == 0 {
        (*newview).x = (*thiscam).x;
        (*newview).y = (*thiscam).y;
        (*newview).x += quake.x;
        (*newview).y += quake.y;
        if !((*thiscam).subsector).is_null() {
        ...
        (*newview).x += quake.x;
        (*newview).y += quake.y;
        if !((*r_viewmobj).subsector).is_null() {
    ...
    R_InterpolateView(
        if R_UsingFrameInterpolation() != 0 {
            rendertimefrac
        } else {
            (1 as libc::c_int) << 16 as libc::c_int
        },
...
#[no_mangle]
pub unsafe extern "C" fn R_SkyboxFrame(mut player: *mut player_t) {
    let mut thiscam: *mut camera_t = 0 as *mut camera_t;
    if splitscreen != 0
        && player
            == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
    ...
    (*newview).sky = true_0 as libc::c_int;
    r_viewmobj = skyboxmo[0 as libc::c_int as usize];
    if (*player).awayviewtics != 0 {
        (*newview).aim = (*player).awayviewaiming;
        (*newview).angle = (*(*player).awayviewmobj).angle;
    } else if (*thiscam).chase != 0 {
        (*newview).aim = (*thiscam).aiming;
        (*newview).angle = (*thiscam).angle;
    } else {
        (*newview).aim = (*player).aiming;
    ...
    (*newview).angle = ((*newview).angle).wrapping_add((*r_viewmobj).angle);
    (*newview).player = player;
    (*newview).x = (*r_viewmobj).x;
    (*newview).y = (*r_viewmobj).y;
    (*newview).z = (*r_viewmobj).z;
    if !(mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize]).is_null() {
        let mut mh: *mut mapheader_t = mapheaderinfo[(gamemap as libc::c_int
            - 1 as libc::c_int) as usize];
        let mut campos: vector3_t = {
        ...
        if (*player).awayviewtics != 0 {
            ...
            campos
                .z = (*(*player).awayviewmobj).z
                + 20 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int);
        } else if (*thiscam).chase != 0 {
            campos.x = (*thiscam).x;
            campos.y = (*thiscam).y;
            campos.z = (*thiscam).z + ((*thiscam).height >> 1 as libc::c_int);
        } else {
        ...
        if !(skyboxmo[1 as libc::c_int as usize]).is_null() {
            ...
            if (*mh).skybox_scalex as libc::c_int > 0 as libc::c_int {
                x = (campos.x - (*skyboxmo[1 as libc::c_int as usize]).x)
            ...
            if (*mh).skybox_scaley as libc::c_int > 0 as libc::c_int {
                y = (campos.y - (*skyboxmo[1 as libc::c_int as usize]).y)
                    / (*mh).skybox_scaley as libc::c_int;
            } else if ((*mh).skybox_scaley as libc::c_int) < 0 as libc::c_int {
                y = (campos.y - (*skyboxmo[1 as libc::c_int as usize]).y)
                    * -((*mh).skybox_scaley as libc::c_int);
            }
            if (*r_viewmobj).angle == 0 as libc::c_int as angle_t {
                (*newview).x += x;
                (*newview).y += y;
            } else if (*r_viewmobj).angle == 0x40000000 as libc::c_int as angle_t {
                (*newview).x -= y;
                (*newview).y += x;
            } else if (*r_viewmobj).angle == 0x80000000 as libc::c_uint {
                (*newview).x -= x;
                (*newview).y -= y;
            } else if (*r_viewmobj).angle == 0xc0000000 as libc::c_uint {
                (*newview).x += y;
                (*newview).y -= x;
            } else {
                let mut ang: angle_t = (*r_viewmobj).angle >> 19 as libc::c_int;
                (*newview).x
                    += FixedMul(
                        x,
        ...
        if (*mh).skybox_scalez as libc::c_int > 0 as libc::c_int {
            (*newview).z += campos.z / (*mh).skybox_scalez as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn R_ViewpointHasChasecam(mut player: *mut player_t) -> boolean {
    let mut thiscam: *mut camera_t = 0 as *mut camera_t;
    let mut chasecam: boolean = false_0 as libc::c_int;
    let mut isplayer2: boolean = (splitscreen != 0
        && player
            == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                as *mut player_t
        && player
    ...
    if isplayer2 != 0 {
        thiscam = &mut camera2;
        chasecam = (cv_chasecam2.value != 0 as libc::c_int) as libc::c_int;
    } else {
        thiscam = &mut camera;
        chasecam = (cv_chasecam.value != 0 as libc::c_int) as libc::c_int;
    }
    if (*player).climbing as libc::c_int != 0
        ...
        || tutorialmode != 0
    {
        chasecam = true_0 as libc::c_int;
    } else if (*player).spectator != 0 {
        chasecam = false_0 as libc::c_int;
    }
    if chasecam != 0 && (*thiscam).chase == 0 {
        P_ResetCamera(player, thiscam);
        (*thiscam).chase = true_0 as libc::c_int;
    } else if chasecam == 0 && (*thiscam).chase != 0 {
        P_ResetCamera(player, thiscam);
        (*thiscam).chase = false_0 as libc::c_int;
    }
    if isplayer2 != 0 {
        R_SetViewContext(VIEWCONTEXT_PLAYER2);
        if (*thiscam).reset != 0 {
            R_ResetViewInterpolation(2 as libc::c_int as uint8_t);
            (*thiscam).reset = false_0 as libc::c_int;
        }
    } else {
        R_SetViewContext(VIEWCONTEXT_PLAYER1);
        if (*thiscam).reset != 0 {
            R_ResetViewInterpolation(1 as libc::c_int as uint8_t);
            (*thiscam).reset = false_0 as libc::c_int;
        }
    }
    return chasecam;
...
#[no_mangle]
pub unsafe extern "C" fn R_IsViewpointThirdPerson(
    mut player: *mut player_t,
    mut skybox: boolean,
) -> boolean {
    let mut chasecam: boolean = R_ViewpointHasChasecam(player);
    if (*player).awayviewtics != 0 || skybox != 0 {
        return chasecam
    } else if (*player).spectator == 0 && chasecam != 0 {
        return true_0 as libc::c_int
    }
...
unsafe extern "C" fn R_PortalFrame(mut portal: *mut portal_t) {
    viewx = (*portal).viewx;
    viewy = (*portal).viewy;
    viewz = (*portal).viewz;
    viewangle = (*portal).viewangle;
    viewsin = finesine[(viewangle >> 19 as libc::c_int) as usize]
        >> 16 as libc::c_int - 16 as libc::c_int;
    viewcos = *finecosine.offset((viewangle >> 19 as libc::c_int) as isize)
        >> 16 as libc::c_int - 16 as libc::c_int;
    portalclipstart = (*portal).start;
    portalclipend = (*portal).end;
    if (*portal).clipline != -(1 as libc::c_int) {
        portalclipline = &mut *lines.offset((*portal).clipline as isize) as *mut line_t;
        portalcullsector = (*portalclipline).frontsector;
        viewsector = (*portalclipline).frontsector;
    } else {
        portalclipline = 0 as *mut line_t;
        portalcullsector = 0 as *mut sector_t;
        viewsector = (*R_PointInSubsector(viewx, viewy)).sector;
    };
}
unsafe extern "C" fn Mask_Pre(mut m: *mut maskcount_t) {
    (*m)
        .drawsegs[0 as libc::c_int
        as usize] = ds_p.offset_from(drawsegs) as libc::c_long as size_t;
    (*m).vissprites[0 as libc::c_int as usize] = visspritecount as size_t;
    (*m).viewx = viewx;
    (*m).viewy = viewy;
    (*m).viewz = viewz;
    (*m).viewsector = viewsector;
}
unsafe extern "C" fn Mask_Post(mut m: *mut maskcount_t) {
    (*m)
        .drawsegs[1 as libc::c_int
        as usize] = ds_p.offset_from(drawsegs) as libc::c_long as size_t;
    (*m).vissprites[1 as libc::c_int as usize] = visspritecount as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_RenderPlayerView(mut player: *mut player_t) {
    let mut nummasks: int32_t = 1 as libc::c_int;
    let mut masks: *mut maskcount_t = malloc(
        ::core::mem::size_of::<maskcount_t>() as libc::c_ulong,
    ) as *mut maskcount_t;
    if cv_homremoval.value != 0
        && player
            == &mut *players.as_mut_ptr().offset(displayplayer as isize) as *mut player_t
    {
        if cv_homremoval.value == 1 as libc::c_int {
            V_DrawFill(
                0 as libc::c_int,
                0 as libc::c_int,
                320 as libc::c_int,
            ...
            V_DrawFill(
                ...
                320 as libc::c_int,
                200 as libc::c_int,
                (32 as libc::c_int as tic_t)
                    .wrapping_add(timeinmap & 15 as libc::c_int as tic_t) as int32_t,
            );
        }
    }
    R_SetupFrame(player);
    ...
    if viewmorph.use_0 != 0 {
        ...
        portalclipend = viewwidth - viewmorph.x1 - 1 as libc::c_int;
        R_PortalClearClipSegs(portalclipstart, portalclipend);
        memcpy(
            ceilingclip.as_mut_ptr() as *mut libc::c_void,
            (viewmorph.ceilingclip).as_mut_ptr() as *const libc::c_void,
            (::core::mem::size_of::<int16_t>() as libc::c_ulong)
                .wrapping_mul(vid.width as libc::c_ulong),
        );
        memcpy(
            floorclip.as_mut_ptr() as *mut libc::c_void,
            (viewmorph.floorclip).as_mut_ptr() as *const libc::c_void,
            (::core::mem::size_of::<int16_t>() as libc::c_ulong)
                .wrapping_mul(vid.width as libc::c_ulong),
        );
    } else {
        portalclipstart = 0 as libc::c_int;
    ...
    Portal_InitList();
    NetUpdate();
    Mask_Pre(&mut *masks.offset((nummasks - 1 as libc::c_int) as isize));
    curdrawsegs = ds_p;
    ps_numdrawnodes.value.i = 0 as libc::c_int;
    ps_numpolyobjects.value.i = ps_numdrawnodes.value.i;
    ps_numbspcalls.value.i = ps_numpolyobjects.value.i;
    ps_bsptime.value.p = I_GetPreciseTime();
    R_RenderBSPNode(numnodes as int32_t - 1 as libc::c_int);
    ps_bsptime.value.p = (I_GetPreciseTime()).wrapping_sub(ps_bsptime.value.p);
    Mask_Post(&mut *masks.offset((nummasks - 1 as libc::c_int) as isize));
    ps_sw_spritecliptime.value.p = I_GetPreciseTime();
    R_ClipSprites(drawsegs, 0 as *mut portal_t);
    ps_sw_spritecliptime
        .value
        .p = (I_GetPreciseTime()).wrapping_sub(ps_sw_spritecliptime.value.p);
    ps_numsprites.value.i = numvisiblesprites as int32_t;
    if cv_skybox.value != 0 && !(skyboxmo[0 as libc::c_int as usize]).is_null() {
        Portal_AddSkyboxPortals();
    }
    ps_sw_portaltime.value.p = I_GetPreciseTime();
    if !portal_base.is_null() {
        let mut portal: *mut portal_t = 0 as *mut portal_t;
        portal = portal_base;
        while !portal.is_null() {
            ...
            nummasks += 1;
            masks = realloc(
                masks as *mut libc::c_void,
                (nummasks as libc::c_ulong)
                    .wrapping_mul(::core::mem::size_of::<maskcount_t>() as libc::c_ulong),
            ) as *mut maskcount_t;
            Mask_Pre(&mut *masks.offset((nummasks - 1 as libc::c_int) as isize));
            curdrawsegs = ds_p;
            R_RenderBSPNode(numnodes as int32_t - 1 as libc::c_int);
            ...
            R_ClipSprites(
                ds_p
                    .offset(
                        -(((*masks.offset((nummasks - 1 as libc::c_int) as isize))
                            .drawsegs[1 as libc::c_int as usize])
                            .wrapping_sub(
                                (*masks.offset((nummasks - 1 as libc::c_int) as isize))
                                    .drawsegs[0 as libc::c_int as usize],
                            ) as isize),
                    ),
                portal,
            );
    ...
    ps_sw_portaltime
        .value
        .p = (I_GetPreciseTime()).wrapping_sub(ps_sw_portaltime.value.p);
    ps_sw_planetime.value.p = I_GetPreciseTime();
    R_DrawPlanes();
    ps_sw_planetime.value.p = (I_GetPreciseTime()).wrapping_sub(ps_sw_planetime.value.p);
    ps_sw_maskedtime.value.p = I_GetPreciseTime();
    R_DrawMasked(masks, nummasks);
    ps_sw_maskedtime
        .value
        .p = (I_GetPreciseTime()).wrapping_sub(ps_sw_maskedtime.value.p);
    free(masks as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn R_RegisterEngineStuff() {
    CV_RegisterVar(&mut cv_gravity);
    CV_RegisterVar(&mut cv_tailspickup);
    CV_RegisterVar(&mut cv_allowmlook);
    CV_RegisterVar(&mut cv_homremoval);
    CV_RegisterVar(&mut cv_flipcam);
    CV_RegisterVar(&mut cv_flipcam2);
    if dedicated != 0 {
        return;
    }
    CV_RegisterVar(&mut cv_translucency);
    CV_RegisterVar(&mut cv_drawdist);
    CV_RegisterVar(&mut cv_drawdist_nights);
    CV_RegisterVar(&mut cv_drawdist_precip);
    CV_RegisterVar(&mut cv_fov);
    CV_RegisterVar(&mut cv_chasecam);
    CV_RegisterVar(&mut cv_chasecam2);
    CV_RegisterVar(&mut cv_shadow);
    CV_RegisterVar(&mut cv_skybox);
    CV_RegisterVar(&mut cv_ffloorclip);
    CV_RegisterVar(&mut cv_spriteclip);
    CV_RegisterVar(&mut cv_cam_dist);
    CV_RegisterVar(&mut cv_cam_still);
    CV_RegisterVar(&mut cv_cam_height);
    CV_RegisterVar(&mut cv_cam_speed);
    CV_RegisterVar(&mut cv_cam_rotate);
    CV_RegisterVar(&mut cv_cam_rotspeed);
    CV_RegisterVar(&mut cv_cam_turnmultiplier);
    CV_RegisterVar(&mut cv_cam_orbit);
    CV_RegisterVar(&mut cv_cam_adjust);
    CV_RegisterVar(&mut cv_cam2_dist);
    CV_RegisterVar(&mut cv_cam2_still);
    CV_RegisterVar(&mut cv_cam2_height);
    CV_RegisterVar(&mut cv_cam2_speed);
    CV_RegisterVar(&mut cv_cam2_rotate);
    CV_RegisterVar(&mut cv_cam2_rotspeed);
    CV_RegisterVar(&mut cv_cam2_turnmultiplier);
    CV_RegisterVar(&mut cv_cam2_orbit);
    CV_RegisterVar(&mut cv_cam2_adjust);
    CV_RegisterVar(
        &mut *(*cv_cam_savedist.as_mut_ptr().offset(0 as libc::c_int as isize))
            .as_mut_ptr()
    ...
    CV_RegisterVar(
        &mut *(*cv_cam_savedist.as_mut_ptr().offset(1 as libc::c_int as isize))
            .as_mut_ptr()
            .offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
    ...
    CV_RegisterVar(
        &mut *(*cv_cam_saveheight.as_mut_ptr().offset(0 as libc::c_int as isize))
            .as_mut_ptr()
            .offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
    ...
    CV_RegisterVar(
        &mut *(*cv_cam_saveheight.as_mut_ptr().offset(1 as libc::c_int as isize))
            .as_mut_ptr()
            .offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
    ...
    CV_RegisterVar(&mut cv_showhud);
    CV_RegisterVar(&mut cv_translucenthud);
    CV_RegisterVar(&mut cv_maxportals);
    CV_RegisterVar(&mut cv_movebob);
    CV_RegisterVar(&mut cv_fpscap);
}
