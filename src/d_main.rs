...
extern "C" {
    ...
    fn endswith(base: *const libc::c_char, tag: *const libc::c_char) -> libc::c_int;
    fn startswith(base: *const libc::c_char, tag: *const libc::c_char) -> libc::c_int;
    ...
    static mut con_startup: boolean;
    ...
    static mut sendbps: int32_t;
    static mut lostpercent: libc::c_float;
    static mut gamelostpercent: libc::c_float;
    fn Net_GetNetStat() -> boolean;
    fn D_CheckNetGame() -> boolean;
    static mut hidetitlemap: boolean;
    static mut curbghide: boolean;
    fn F_InitMenuPresValues();
    fn F_WaitingPlayersDrawer();
    fn F_ContinueDrawer();
    ...
    static mut cv_netstat: consvar_t;
    static mut cv_perfstats: consvar_t;
    fn D_RegisterServerCommands();
    fn D_RegisterClientCommands();
    fn Command_ExitGame_f();
    fn D_GameTypeChanged(lastgametype: int32_t);
    fn D_MapChange(
        pmapnum: int32_t,
        pgametype: int32_t,
        pultmode: boolean,
    ...
    fn D_SetPassword(pw: *const libc::c_char);
    static mut ms_RoomId: int16_t;
    fn GetMODVersion_Console();
    ...
    fn TryRunTics(realtic: tic_t) -> boolean;
    static mut hu_stopped: boolean;
    fn G_RecordDemo(name: *const libc::c_char);
    fn G_RecordMetal();
    fn G_DeferedPlayDemo(demo: *const libc::c_char);
    fn G_TimeDemo(name: *const libc::c_char);
    fn cht_Responder(ev: *mut event_t) -> boolean;
    fn cht_Init();
    static mut clientGamedata: *mut gamedata_t;
    static mut serverGamedata: *mut gamedata_t;
    fn M_NewGameDataStruct() -> *mut gamedata_t;
    ...
    static mut levelstarttic: tic_t;
    ...
    fn G_ClearExitGameFlag();
    fn G_GetGametypeByName(gametypestr: *const libc::c_char) -> int32_t;
    fn G_Responder(ev: *mut event_t) -> boolean;
    fn G_LuaResponder(ev: *mut event_t) -> boolean;
    fn G_GetExitGameFlag() -> boolean;
    fn G_SetGamestate(newstate: gamestate_t);
    fn G_LoadGameData(data: *mut gamedata_t);
    fn G_LoadGameSettings();
    fn G_SetUsedCheats(silent: boolean);
    fn W_InitMultipleFiles(list: *mut addfilelist_t);
    ...
    fn W_VerifyFileMD5(wadfilenum: uint16_t, matchmd5: *const libc::c_char);
    ...
    static mut setrenderneeded: uint8_t;
    ...
    fn I_Quit() -> !;
    fn I_RegisterSysCommands();
    fn I_GetEnv(name: *const libc::c_char) -> *mut libc::c_char;
    fn I_LocateWad() -> *const libc::c_char;
    ...
    fn S_RegisterSoundStuff();
    fn S_InitSfxChannels(sfxVolume: int32_t);
    fn S_InitMusicDefs();
    fn S_StopMusic();
    fn S_UpdateSounds();
    fn S_UpdateClosedCaptions();
    static mut g_time: timestate_t;
    fn I_GetTime() -> tic_t;
    fn I_InitializeTime();
    fn I_UpdateTime(timescale: fixed_t);
    fn I_SleepDuration(duration: precise_t);
    static mut rendermode: rendermode_t;
    static mut chosenrendermode: rendermode_t;
    fn I_StartupGraphics();
    fn VID_PrepareModeList();
    fn I_UpdateNoBlit();
    fn I_FinishUpdate();
    static mut myargc: int32_t;
    static mut myargv: *mut *mut libc::c_char;
    fn M_GetUrlProtocolArg() -> *const libc::c_char;
    fn M_CheckParm(check: *const libc::c_char) -> int32_t;
    fn M_PushSpecialParameters();
    ...
    fn LUA_Step();
    fn M_InitPlayerSetupColors();
    fn M_DrawPerfStats();
    static mut cv_fpscap: consvar_t;
    static mut ps_interp_frac: ps_metric_t;
    static mut ps_interp_lag: ps_metric_t;
    fn R_GetFramerateCap() -> uint32_t;
    fn R_UsingFrameInterpolation() -> boolean;
    fn R_UpdateViewInterpolation();
    fn R_ApplyLevelInterpolators(frac: fixed_t);
    fn R_RestoreLevelInterpolators();
    fn R_GetSkinAvailabilities() -> uint32_t;
    fn M_InitMenuPresTables();
    fn M_Responder(ev: *mut event_t) -> boolean;
    fn M_Drawer();
    fn M_Init();
    fn M_InitCharacterTables();
    ...
    fn M_TutorialSaveControlResponse(ch: int32_t);
    ...
    fn M_DoScreenShot();
    fn M_ScreenshotResponder(ev: *mut event_t) -> boolean;
    fn M_FirstLoadConfig();
    fn strcatbf(s1: *mut libc::c_char, s2: *const libc::c_char, s3: *const libc::c_char);
    fn M_IsPathAbsolute(path: *const libc::c_char) -> boolean;
    ...
    static mut ps_rendercalltime: ps_metric_t;
    static mut ps_uitime: ps_metric_t;
    static mut ps_swaptime: ps_metric_t;
    ...
    fn R_RegisterEngineStuff();
    fn SplitScreen_OnChange();
    static mut ylookup: [*mut uint8_t; 4800];
    static mut ylookup1: [*mut uint8_t; 4800];
    static mut ylookup2: [*mut uint8_t; 4800];
    static mut topleft: *mut uint8_t;
    fn ST_Drawer();
    fn ST_Init();
    fn ST_preLevelTitleCardDrawer();
    static mut lt_ticker: tic_t;
    static mut lt_lasttic: tic_t;
    ...
    fn V_DoPostProcessor(view: int32_t, type_0: postimg_t, param: int32_t);
    ...
    fn Z_Init();
    static mut downloaddir: [libc::c_char; 512];
    static mut luafiledir: [libc::c_char; 272];
    static mut usebuffer: boolean;
    fn Y_IntermissionDrawer();
    fn Y_ConsiderScreenBuffer();
    ...
    fn M_RandomSeedFromOS() -> boolean;
    fn M_RandomSeed(a: uint32_t);
...
pub const gcs_custom: C2RustUnnamed_7 = 0;
...
pub const num_gamecontrolschemes: C2RustUnnamed_7 = 3;
pub const gcs_platform: C2RustUnnamed_7 = 2;
pub const gcs_fps: C2RustUnnamed_7 = 1;
#[inline]
...
#[no_mangle]
pub static mut VERSION: libc::c_int = 0;
#[no_mangle]
pub static mut SUBVERSION: libc::c_int = 0;
#[no_mangle]
pub static mut window_notinfocus: uint8_t = false_0 as libc::c_int as uint8_t;
static mut startupwadfiles: addfilelist_t = addfilelist_t {
    files: 0 as *const *mut libc::c_char as *mut *mut libc::c_char,
    numfiles: 0,
};
static mut startuppwads: addfilelist_t = addfilelist_t {
    files: 0 as *const *mut libc::c_char as *mut *mut libc::c_char,
    numfiles: 0,
};
#[no_mangle]
pub static mut devparm: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut singletics: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut lastdraw: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut postimgtype: postimg_t = postimg_none;
#[no_mangle]
pub static mut postimgparam: int32_t = 0;
#[no_mangle]
pub static mut postimgtype2: postimg_t = postimg_none;
#[no_mangle]
pub static mut postimgparam2: int32_t = 0;
#[no_mangle]
pub static mut midi_disabled: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut sound_disabled: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut digital_disabled: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut advancedemo: boolean = 0;
#[no_mangle]
pub static mut debugload: int32_t = 0 as libc::c_int;
#[no_mangle]
pub static mut numskincolors: uint16_t = 0;
#[no_mangle]
pub static mut menucolorhead: *mut menucolor_t = 0 as *const menucolor_t
    as *mut menucolor_t;
#[no_mangle]
pub static mut menucolortail: *mut menucolor_t = 0 as *const menucolor_t
    as *mut menucolor_t;
#[no_mangle]
pub static mut savegamename: [libc::c_char; 256] = [0; 256];
#[no_mangle]
pub static mut liveeventbackup: [libc::c_char; 256] = [0; 256];
#[no_mangle]
pub static mut srb2home: [libc::c_char; 256] = unsafe {
    *::core::mem::transmute::<
        &[u8; 256],
        &mut [libc::c_char; 256],
    >(
...
#[no_mangle]
pub static mut srb2path: [libc::c_char; 256] = unsafe {
    *::core::mem::transmute::<
        &[u8; 256],
        &mut [libc::c_char; 256],
    >(
...
#[no_mangle]
pub static mut usehome: boolean = true_0 as libc::c_int;
#[no_mangle]
pub static mut pandf: *const libc::c_char = b"%s/%s\0" as *const u8
    as *const libc::c_char;
static mut addonsdir: [libc::c_char; 512] = [0; 512];
#[no_mangle]
pub static mut events: [event_t; 128] = [event_t {
    type_0: ev_keydown,
    key: 0,
    x: 0,
    y: 0,
...
#[no_mangle]
pub static mut eventhead: int32_t = 0;
#[no_mangle]
pub static mut eventtail: int32_t = 0;
#[no_mangle]
pub static mut dedicated: boolean = false_0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn D_PostEvent(mut ev: *const event_t) {
    events[eventhead as usize] = *ev;
    eventhead = eventhead + 1 as libc::c_int & 128 as libc::c_int - 1 as libc::c_int;
}
#[no_mangle]
pub static mut shiftdown: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut ctrldown: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut altdown: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut capslock: boolean = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn D_ProcessEvents() {
    let mut ev: *mut event_t = 0 as *mut event_t;
    let mut eaten: boolean = 0;
    ...
    mouse
        .buttons = (mouse.buttons as libc::c_int
        & !(0x100 as libc::c_int | 0x200 as libc::c_int)) as uint16_t;
    mouse2
        .buttons = (mouse2.buttons as libc::c_int
        & !(0x100 as libc::c_int | 0x200 as libc::c_int)) as uint16_t;
    let mut current_block_28: u64;
    while eventtail != eventhead {
        let mut hooked: boolean = false_0 as libc::c_int;
        ev = &mut *events.as_mut_ptr().offset(eventtail as isize) as *mut event_t;
        if (*ev).type_0 as libc::c_uint == ev_keydown as libc::c_int as libc::c_uint
            || (*ev).type_0 as libc::c_uint == ev_keyup as libc::c_int as libc::c_uint
        {
            if (((*ev).key - KEY_MOUSE1 as libc::c_int) as uint32_t)
                < 8 as libc::c_int as uint32_t
            {
                if (*ev).type_0 as libc::c_uint
                    == ev_keydown as libc::c_int as libc::c_uint
                {
                    mouse
                        .buttons = (mouse.buttons as libc::c_int
                        | (1 as libc::c_int) << (*ev).key - KEY_MOUSE1 as libc::c_int)
                        as uint16_t;
                } else {
                    mouse
                        .buttons = (mouse.buttons as libc::c_int
            ...
            } else if (((*ev).key - KEY_2MOUSE1 as libc::c_int) as uint32_t)
                < 8 as libc::c_int as uint32_t
            {
                if (*ev).type_0 as libc::c_uint
                    == ev_keydown as libc::c_int as libc::c_uint
                {
                    mouse2
                        .buttons = (mouse2.buttons as libc::c_int
                        | (1 as libc::c_int) << (*ev).key - KEY_2MOUSE1 as libc::c_int)
                        as uint16_t;
                } else {
                    mouse2
                        .buttons = (mouse2.buttons as libc::c_int
                        & !((1 as libc::c_int)
                            << (*ev).key - KEY_2MOUSE1 as libc::c_int)) as uint16_t;
                }
            } else {
                match (*ev).key {
                    480 => {
        ...
        if !(M_ScreenshotResponder(ev) != 0) {
            ...
            {
                if cht_Responder(ev) != 0 {
                    current_block_28 = 4644295000439058019;
                } else {
            ...
            match current_block_28 {
                4644295000439058019 => {}
                _ => {
                    if CON_Ready() == 0 && menuactive == 0 {
                        if G_LuaResponder(ev) != 0 {
                            current_block_28 = 4644295000439058019;
                        } else {
                            hooked = true_0 as libc::c_int;
                    ...
                    match current_block_28 {
                        ...
                        _ => {
                            ...
                            if !(eaten != 0) {
                                if hooked == 0 && CON_Ready() == 0 {
                                    if G_LuaResponder(ev) != 0 {
                                        current_block_28 = 4644295000439058019;
                                    } else {
                                        hooked = true_0 as libc::c_int;
                                        current_block_28 = 9853141518545631134;
                                    }
                                } else {
                                    current_block_28 = 9853141518545631134;
                                }
        ...
        eventtail = eventtail + 1 as libc::c_int & 128 as libc::c_int - 1 as libc::c_int;
    }
    if mouse.rdx != 0 || mouse.rdy != 0 {
        G_SetMouseDeltas(mouse.rdx, mouse.rdy, 1 as libc::c_int as uint8_t);
    }
    if mouse2.rdx != 0 || mouse2.rdy != 0 {
        G_SetMouseDeltas(mouse2.rdx, mouse2.rdy, 2 as libc::c_int as uint8_t);
    }
}
#[no_mangle]
pub static mut wipegamestate: gamestate_t = GS_LEVEL;
#[no_mangle]
pub static mut wipetypepre: int16_t = -(1 as libc::c_int) as int16_t;
#[no_mangle]
pub static mut wipetypepost: int16_t = -(1 as libc::c_int) as int16_t;
unsafe extern "C" fn D_Display() {
    let mut forcerefresh: boolean = false_0 as libc::c_int;
    static mut wipe: boolean = false_0 as libc::c_int;
    let mut wipedefindex: int32_t = 0 as libc::c_int;
    if dedicated != 0 {
        return;
    }
    if nodrawers != 0 {
    ...
    if (setrenderneeded as libc::c_int != 0 || setmodeneeded != 0) && wipe == 0 {
        SCR_SetMode();
    }
    if vid.recalc != 0 {
        SCR_Recalc();
    ...
    if setsizeneeded != 0 {
        ...
        forcerefresh = true_0 as libc::c_int;
    }
    I_UpdateNoBlit();
    wipe = (gamestate as libc::c_uint != wipegamestate as libc::c_uint) as libc::c_int;
    if wipe != 0 && wipetypepre as libc::c_int != 32767 as libc::c_int {
        wipedefindex = gamestate as int32_t;
        if gamestate as libc::c_uint == GS_INTERMISSION as libc::c_int as libc::c_uint {
            if intertype as libc::c_uint == int_spec as libc::c_int as libc::c_uint {
                wipedefindex = wipe_specinter_toblack as libc::c_int;
            } else if intertype as libc::c_uint
                != int_coop as libc::c_int as libc::c_uint
            {
                wipedefindex = wipe_multinter_toblack as libc::c_int;
            }
        }
        if (wipetypepre as libc::c_int) < 0 as libc::c_int
            || F_WipeExists(wipetypepre as uint8_t) == 0
        {
            wipetypepre = wipedefs[wipedefindex as usize] as int16_t;
        }
        if rendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint {
            if (wipegamestate as libc::c_uint
                == 4294967293 as gamestate_t as libc::c_uint
                || wipegamestate as libc::c_uint
                    != 4294967294 as gamestate_t as libc::c_uint
                    && !(gamestate as libc::c_uint
                        == GS_LEVEL as libc::c_int as libc::c_uint
                        || gamestate as libc::c_uint
                            == GS_TITLESCREEN as libc::c_int as libc::c_uint
                            && titlemapinaction as libc::c_int != 0))
                && wipetypepre as libc::c_int != 255 as libc::c_int
            {
                F_WipeStartScreen();
                ...
                } else if F_TryColormapFade(31 as libc::c_int as uint8_t) != 0 {
                    wipetypepost = -(1 as libc::c_int) as int16_t;
                }
                F_WipeEndScreen();
                F_RunWipe(
                    wipetypepre as uint8_t,
                    (gamestate as libc::c_uint
    ...
    match gamestate as libc::c_uint {
        4 => {
            if titlemapinaction == 0 || curbghide == 0 {
                F_TitleScreenDrawer();
                current_block_69 = 5597585068398118923;
            } else {
                current_block_69 = 15256017093120544322;
            }
        }
        1 => {
            current_block_69 = 15256017093120544322;
        ...
        9 => {
            F_IntroDrawer();
            if wipegamestate as libc::c_uint == 4294967295 as gamestate_t as libc::c_uint
            {
                wipe = true_0 as libc::c_int;
            }
            current_block_69 = 5597585068398118923;
        }
        10 => {
    ...
    if wipegamestate as libc::c_uint == GS_INTRO as libc::c_int as libc::c_uint
        && gamestate as libc::c_uint == GS_TITLESCREEN as libc::c_int as libc::c_uint
    {
        ...
        if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
            || gamestate as libc::c_uint == GS_TITLESCREEN as libc::c_int as libc::c_uint
                && titlemapinaction as libc::c_int != 0 && curbghide != 0
                && hidetitlemap == 0
        {
            if automapactive == 0 && dedicated == 0 && cv_renderview.value != 0 {
                R_ApplyLevelInterpolators(
                ...
                ps_rendercalltime.value.p = I_GetPreciseTime();
                if !(players[displayplayer as usize].mo).is_null()
                    || players[displayplayer as usize].playerstate as libc::c_uint
                        == PST_DEAD as libc::c_int as libc::c_uint
                {
                    topleft = (screens[0 as libc::c_int as usize])
                        .offset((viewwindowy * vid.width) as isize)
                        .offset(viewwindowx as isize);
                    objectsdrawn = 0 as libc::c_int as uint16_t;
                    if rendermode as libc::c_uint
                        != render_none as libc::c_int as libc::c_uint
                    {
                        R_RenderPlayerView(
                    ...
                    && !(players[secondarydisplayplayer as usize].mo).is_null()
                {
                    if rendermode as libc::c_uint
                        != render_none as libc::c_int as libc::c_uint
                    {
                        viewwindowy = vid.height / 2 as libc::c_int;
                        M_Memcpy
                            .expect(
                                "non-null function pointer",
                            )(
                            ylookup.as_mut_ptr() as *mut libc::c_void,
                            ylookup2.as_mut_ptr() as *const libc::c_void,
                            (viewheight as libc::c_ulong)
                                .wrapping_mul(
                        ...
                        R_RenderPlayerView(
                            &mut *players
                                .as_mut_ptr()
                                .offset(secondarydisplayplayer as isize),
                        );
                        ...
                        M_Memcpy
                            ...
                            ylookup.as_mut_ptr() as *mut libc::c_void,
                            ylookup1.as_mut_ptr() as *const libc::c_void,
                            (viewheight as libc::c_ulong)
                                .wrapping_mul(
                                    ::core::mem::size_of::<*mut uint8_t>() as libc::c_ulong,
                                ),
                ...
                if rendermode as libc::c_uint
                    == render_soft as libc::c_int as libc::c_uint
                {
                    if splitscreen == 0 {
                        R_ApplyViewMorph();
                    }
                    if postimgtype as u64 != 0 {
                        V_DoPostProcessor(0 as libc::c_int, postimgtype, postimgparam);
                    }
                    if postimgtype2 as u64 != 0 {
                        V_DoPostProcessor(1 as libc::c_int, postimgtype2, postimgparam2);
                    }
                }
                ps_rendercalltime
                    .value
                    .p = (I_GetPreciseTime()).wrapping_sub(ps_rendercalltime.value.p);
            ...
            if lastdraw != 0 {
                    ...
                    == render_soft as libc::c_int as libc::c_uint
                {
                    ...
                    usebuffer = true_0 as libc::c_int;
                }
                lastdraw = false_0 as libc::c_int;
            }
            ps_uitime.value.p = I_GetPreciseTime();
            if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint {
                ST_Drawer();
                F_TextPromptDrawer();
                HU_Drawer();
    ...
    if paused as libc::c_int != 0 && cv_showhud.value != 0
        && (menuactive == 0 || netgame != 0)
    {
        let mut y: int32_t = if automapactive != 0 {
            32 as libc::c_int
        } else {
    ...
    vid.recalc = 0 as libc::c_int;
    M_Drawer();
    CON_Drawer();
    ps_uitime.value.p = (I_GetPreciseTime()).wrapping_sub(ps_uitime.value.p);
    if wipe != 0 && wipetypepost as libc::c_int != 32767 as libc::c_int {
        wipedefindex += WIPEFINALSHIFT as libc::c_int;
        if (wipetypepost as libc::c_int) < 0 as libc::c_int
            || F_WipeExists(wipetypepost as uint8_t) == 0
        {
            wipetypepost = wipedefs[wipedefindex as usize] as int16_t;
        }
        if rendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint {
            F_WipeEndScreen();
            if WipeStageTitle != 0 && st_overlay != 0 {
                lt_ticker = lt_ticker.wrapping_sub(1);
                lt_ticker;
            ...
            if F_ShouldColormapFade() != 0 {
                ...
                >(
                    wipestyleflags as libc::c_uint
                        | WSF_FADEIN as libc::c_int as libc::c_uint,
                );
                wipestyleflags = ::core::mem::transmute::<
                    libc::c_uint,
                    wipestyleflags_t,
                >(
                    wipestyleflags as libc::c_uint
                        & !(WSF_FADEOUT as libc::c_int) as libc::c_uint,
                );
            }
            F_RunWipe(
                wipetypepost as uint8_t,
                (gamestate as libc::c_uint
                    != GS_TIMEATTACK as libc::c_int as libc::c_uint
                    && gamestate as libc::c_uint
                        != GS_TITLESCREEN as libc::c_int as libc::c_uint) as libc::c_int,
            );
        }
        if timingdemo != 0 {
    ...
    NetUpdate();
    if G_GetExitGameFlag() != 0 {
        Command_ExitGame_f();
        G_ClearExitGameFlag();
    }
    if wipe == 0 {
        if cv_netstat.value != 0 {
            let mut s: [libc::c_char; 50] = [0; 50];
            Net_GetNetStat();
            s[(::core::mem::size_of::<[libc::c_char; 50]>() as libc::c_ulong)
            ...
            snprintf(
                ...
                (::core::mem::size_of::<[libc::c_char; 50]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                b"get %d b/s\0" as *const u8 as *const libc::c_char,
                getbps,
            );
            V_DrawRightAlignedString(
                320 as libc::c_int,
                200 as libc::c_int - 32 as libc::c_int - 40 as libc::c_int,
                0x2000 as libc::c_int,
                s.as_mut_ptr(),
            );
            snprintf(
                ...
                (::core::mem::size_of::<[libc::c_char; 50]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                b"send %d b/s\0" as *const u8 as *const libc::c_char,
                sendbps,
            );
            V_DrawRightAlignedString(
                320 as libc::c_int,
                200 as libc::c_int - 32 as libc::c_int - 30 as libc::c_int,
                0x2000 as libc::c_int,
                s.as_mut_ptr(),
            );
            snprintf(
                ...
                (::core::mem::size_of::<[libc::c_char; 50]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                b"GameMiss %.2f%%\0" as *const u8 as *const libc::c_char,
                gamelostpercent as libc::c_double,
            );
            V_DrawRightAlignedString(
                320 as libc::c_int,
                200 as libc::c_int - 32 as libc::c_int - 20 as libc::c_int,
                0x2000 as libc::c_int,
                s.as_mut_ptr(),
            );
            snprintf(
                ...
                (::core::mem::size_of::<[libc::c_char; 50]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                b"SysMiss %.2f%%\0" as *const u8 as *const libc::c_char,
                lostpercent as libc::c_double,
            );
            V_DrawRightAlignedString(
                320 as libc::c_int,
                200 as libc::c_int - 32 as libc::c_int - 10 as libc::c_int,
                0x2000 as libc::c_int,
                s.as_mut_ptr(),
            );
        }
        if cv_perfstats.value != 0 {
            M_DrawPerfStats();
        }
        ps_swaptime.value.p = I_GetPreciseTime();
        I_FinishUpdate();
        ps_swaptime.value.p = (I_GetPreciseTime()).wrapping_sub(ps_swaptime.value.p);
    }
}
#[no_mangle]
pub static mut rendergametic: tic_t = 0;
#[no_mangle]
pub unsafe extern "C" fn D_SRB2Loop() -> ! {
    let mut entertic: tic_t = 0 as libc::c_int as tic_t;
    let mut oldentertics: tic_t = 0 as libc::c_int as tic_t;
    let mut realtics: tic_t = 0 as libc::c_int as tic_t;
    let mut rendertimeout: tic_t = 4294967295 as libc::c_uint;
    let mut deltatics: libc::c_double = 0.0f64;
    let mut deltasecs: libc::c_double = 0.0f64;
    static mut gstartuplumpnum: lumpnum_t = 0;
    let mut interp: boolean = false_0 as libc::c_int;
    let mut doDisplay: boolean = false_0 as libc::c_int;
    if dedicated != 0 {
    ...
    COM_ImmedExecute(b"cls;version\0" as *const u8 as *const libc::c_char);
    I_FinishUpdate();
    if gamestate as libc::c_uint != GS_TITLESCREEN as libc::c_int as libc::c_uint {
        gstartuplumpnum = W_CheckNumForName(
            b"STARTUP\0" as *const u8 as *const libc::c_char,
        );
        if gstartuplumpnum == 4294967295 as libc::c_uint {
            gstartuplumpnum = W_GetNumForName(
        ...
        V_DrawStretchyFixedPatch(
            ...
            (1 as libc::c_int) << 16 as libc::c_int,
            0 as libc::c_int,
            W_CachePatchNum(gstartuplumpnum, PU_PATCH as libc::c_int) as *mut patch_t,
            0 as *const uint8_t,
        );
    }
    loop {
        let mut capbudget: precise_t = 0;
        let mut enterprecise: precise_t = I_GetPreciseTime();
        let mut finishprecise: precise_t = enterprecise;
        let mut budget: libc::c_double = round(
            1.0f64 / R_GetFramerateCap() as libc::c_double
                * I_GetPrecisePrecision() as libc::c_double,
        );
        capbudget = budget as precise_t;
        I_UpdateTime(cv_timescale.value);
        if lastwipetic != 0 {
            oldentertics = lastwipetic as tic_t;
            lastwipetic = 0 as libc::c_int;
        }
        entertic = I_GetTime();
        realtics = entertic.wrapping_sub(oldentertics);
        oldentertics = entertic;
        if demoplayback != 0
            && gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        {
            realtics = realtics * cv_playbackspeed.value as tic_t;
        }
        if realtics == 0 {
            if debugload != 0 {
                debugload -= 1;
        ...
        interp = (R_UsingFrameInterpolation() != 0 && dedicated == 0) as libc::c_int;
        doDisplay = false_0 as libc::c_int;
        refreshdirmenu = 0 as libc::c_int as uint8_t;
        if realtics > 0 as libc::c_int as tic_t || singletics != 0 {
            if realtics > 8 as libc::c_int as tic_t {
                realtics = 1 as libc::c_int as tic_t;
            }
            TryRunTics(realtics);
            if lastdraw != 0 || singletics != 0 || gametic > rendergametic {
                rendergametic = gametic;
                rendertimeout = entertic
                    .wrapping_add((35 as libc::c_int / 17 as libc::c_int) as tic_t);
                doDisplay = true_0 as libc::c_int;
            } else if rendertimeout < entertic {
                if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
                    && netgame != 0
                {
                    let mut chasecamtics: tic_t = 0 as libc::c_int as tic_t;
                    while chasecamtics < realtics {
                        if splitscreen != 0 && camera2.chase != 0 {
                            P_MoveChaseCamera(
                                &mut *players
                                    .as_mut_ptr()
                                    .offset(secondarydisplayplayer as isize),
                        ...
                        chasecamtics = chasecamtics.wrapping_add(1);
                        chasecamtics;
                    }
            ...
            renderisnewtic = true_0 as libc::c_int;
        } else {
            renderisnewtic = false_0 as libc::c_int;
        }
        if interp != 0 {
            ps_interp_frac
                .value
                .p = (FixedToFloat(g_time.timefrac) * 1000.0f32) as precise_t;
            ps_interp_lag
                .value
                .p = (deltasecs * 1000.0f32 as libc::c_double) as precise_t;
            renderdeltatics = FloatToFixed(deltatics as libc::c_float);
            if !(paused as libc::c_int != 0 || P_AutoPause() != 0) && deltatics < 1.0f64
                && hu_stopped == 0
            {
                rendertimefrac = g_time.timefrac;
            } else {
                rendertimefrac = (1 as libc::c_int) << 16 as libc::c_int;
            }
        } else {
            renderdeltatics = (realtics
                * ((1 as libc::c_int) << 16 as libc::c_int) as tic_t) as fixed_t;
            rendertimefrac = (1 as libc::c_int) << 16 as libc::c_int;
        }
        if interp != 0 || doDisplay != 0 {
            D_Display();
        }
        ...
        if singletics == 0 {
            let mut elapsed: int64_t = finishprecise.wrapping_sub(enterprecise)
                as int64_t;
            let vsync_with_match_refresh: boolean = (cv_vidwait.value != 0
                && cv_fpscap.value == 0 as libc::c_int) as libc::c_int;
            if elapsed > 0 as libc::c_int as int64_t && capbudget as int64_t > elapsed
                && vsync_with_match_refresh == 0
            {
                I_SleepDuration(
                    capbudget.wrapping_sub(finishprecise.wrapping_sub(enterprecise)),
                );
            }
        }
        finishprecise = I_GetPreciseTime();
        deltasecs = finishprecise.wrapping_sub(enterprecise) as int64_t as libc::c_double
            / I_GetPrecisePrecision() as libc::c_double;
        deltatics = deltasecs * (35 as libc::c_int * 1 as libc::c_int) as libc::c_double;
    };
}
#[no_mangle]
pub unsafe extern "C" fn D_AdvanceDemo() {
    advancedemo = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn D_StartTitle() {
    ...
    if netgame != 0 {
        if gametyperules & GTR_CAMPAIGN as libc::c_int as uint32_t != 0 {
            ...
            if server != 0 {
                ...
                strlcpy(
                    mapname.as_mut_ptr(),
                    G_BuildMapName(spstage_start as int32_t),
    ...
    lastmaploaded = 0 as libc::c_int as int16_t;
    modeattacking = 0 as libc::c_int as uint8_t;
    marathonmode = 0 as marathonmode_t;
    maptol = 0 as libc::c_int as uint32_t;
    ...
    advancedemo = false_0 as libc::c_int;
    ...
    if tutorialmode != 0 && tutorialgcs != 0 {
        ...
        M_StartMessage(
            b"Do you want to \x82save the recommended \x82movement controls?\x80\n\nPress 'Y' or 'Enter' to confirm\nPress 'N' or any key to keep \nyour current controls\0"
                as *const u8 as *const libc::c_char,
            ::core::mem::transmute::<
            ...
            >(
                Some(
                    M_TutorialSaveControlResponse as unsafe extern "C" fn(int32_t) -> (),
                ),
            ),
            MM_YESNO,
        );
...
unsafe extern "C" fn D_AddFile(
    mut list: *mut addfilelist_t,
    mut file: *const libc::c_char,
) {
    let mut newfile: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut index: size_t = 0 as libc::c_int as size_t;
    if ((*list).files).is_null() {
        (*list)
            .files = calloc(
            ::core::mem::size_of::<*mut *mut libc::c_char>() as libc::c_ulong,
            2 as libc::c_int as libc::c_ulong,
        ) as *mut *mut libc::c_char;
        (*list).numfiles = 1 as libc::c_int as size_t;
    } else {
        index = (*list).numfiles;
        (*list).numfiles = ((*list).numfiles).wrapping_add(1);
        (*list)
            .files = realloc(
            (*list).files as *mut libc::c_void,
            (::core::mem::size_of::<*mut *mut libc::c_char>() as libc::c_ulong)
                .wrapping_mul(
                    ((*list).numfiles).wrapping_add(1 as libc::c_int as size_t),
                ),
        ) as *mut *mut libc::c_char;
        if ((*list).files).is_null() {
            I_Error(
                b"%s: No more free memory to add file %s\0" as *const u8
                    as *const libc::c_char,
                (*::core::mem::transmute::<
                    &[u8; 10],
                    &[libc::c_char; 10],
    ...
    newfile = malloc((strlen(file)).wrapping_add(1 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    if newfile.is_null() {
        I_Error(
            b"D_AddFile: No more free memory to add file %s\0" as *const u8
                as *const libc::c_char,
            file,
        );
    }
    strcpy(newfile, file);
    let ref mut fresh0 = *((*list).files).offset(index as isize);
    *fresh0 = newfile;
}
unsafe extern "C" fn D_AddFolder(
    mut list: *mut addfilelist_t,
    mut file: *const libc::c_char,
) {
    let mut newfile: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    newfile = malloc((strlen(file)).wrapping_add(2 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    if newfile.is_null() {
        I_Error(
            b"D_AddFolder: No more free memory to add folder %s\0" as *const u8
                as *const libc::c_char,
            file,
        );
    }
    strcpy(newfile, file);
    strcat(newfile, b"/\0" as *const u8 as *const libc::c_char);
    let ref mut fresh1 = *((*list).files).offset(index as isize);
    *fresh1 = newfile;
}
#[inline]
unsafe extern "C" fn D_CleanFile(mut list: *mut addfilelist_t) {
    if !((*list).files).is_null() {
        let mut pnumwadfiles: size_t = 0 as libc::c_int as size_t;
        while pnumwadfiles < (*list).numfiles {
            free(*((*list).files).offset(pnumwadfiles as isize) as *mut libc::c_void);
            pnumwadfiles = pnumwadfiles.wrapping_add(1);
            pnumwadfiles;
        }
        free((*list).files as *mut libc::c_void);
        (*list).files = 0 as *mut *mut libc::c_char;
    }
    (*list).numfiles = 0 as libc::c_int as size_t;
}
unsafe extern "C" fn ChangeDirForUrlHandler() {
    if !(M_GetUrlProtocolArg()).is_null()
        && M_CheckParm(b"-nochdir\0" as *const u8 as *const libc::c_char) == 0
    {
        let mut i: size_t = 0;
        CONS_Printf(
            b"%s connect links load game files from the SRB2 application's stored directory. Switching to \0"
                as *const u8 as *const libc::c_char,
            b"srb2://\0" as *const u8 as *const libc::c_char,
        );
        strlcpy(
            srb2path.as_mut_ptr(),
            *myargv.offset(0 as libc::c_int as isize),
            ::core::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong,
        );
        i = (strlen(srb2path.as_mut_ptr()))
            .wrapping_sub(1 as libc::c_int as libc::c_ulong);
        while i > 0 as libc::c_int as size_t {
            if srb2path[i as usize] as libc::c_int == '/' as i32
                || srb2path[i as usize] as libc::c_int == '\\' as i32
            {
                srb2path[i as usize] = '\0' as i32 as libc::c_char;
                break;
            } else {
                i = i.wrapping_sub(1);
                i;
        ...
        if chdir(srb2path.as_mut_ptr()) == -(1 as libc::c_int) {
            I_OutputMsg(
                b"Couldn't change working directory\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
}
unsafe extern "C" fn IdentifyVersion() {
    let mut srb2wad: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut srb2waddir: *const libc::c_char = 0 as *const libc::c_char;
    srb2waddir = I_LocateWad();
    if !srb2waddir.is_null() {
        strlcpy(
            srb2path.as_mut_ptr(),
            srb2waddir,
            ::core::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong,
        );
    } else if !(getcwd(srb2path.as_mut_ptr(), 256 as libc::c_int as size_t)).is_null() {
        srb2waddir = srb2path.as_mut_ptr();
    } else {
        srb2waddir = b".\0" as *const u8 as *const libc::c_char;
    }
    srb2wad = malloc(
        (strlen(srb2waddir))
    ...
    if srb2wad.is_null() {
        I_Error(
            b"No more free memory to look in %s\0" as *const u8 as *const libc::c_char,
            srb2waddir,
        );
    } else {
        sprintf(
            ...
            pandf,
            srb2waddir,
            b"srb2.pk3\0" as *const u8 as *const libc::c_char,
        );
    }
    snprintf(
        configfile.as_mut_ptr(),
        ::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong,
        b"%s/config.cfg\0" as *const u8 as *const libc::c_char,
        srb2waddir,
    );
    configfile[(::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong)
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        as usize] = '\0' as i32 as libc::c_char;
    if !srb2wad.is_null() && FIL_ReadFileOK(srb2wad) != 0 {
        D_AddFile(&mut startupwadfiles, srb2wad);
    } else {
        I_Error(
            b"srb2.pk3 not found! Expected in %s, ss file: %s\n\0" as *const u8
                as *const libc::c_char,
            srb2waddir,
            srb2wad,
        );
    ...
    if !srb2wad.is_null() {
        free(srb2wad as *mut libc::c_void);
    }
    D_AddFile(
        &mut startupwadfiles,
        va(pandf, srb2waddir, b"zones.pk3\0" as *const u8 as *const libc::c_char),
    );
    D_AddFile(
        &mut startupwadfiles,
        va(pandf, srb2waddir, b"player.dta\0" as *const u8 as *const libc::c_char),
    );
    D_AddFile(
        &mut startupwadfiles,
        va(pandf, srb2waddir, b"patch.pk3\0" as *const u8 as *const libc::c_char),
    );
    let mut musicpath: *const libc::c_char = va(
        pandf,
        srb2waddir,
        b"music.dta\0" as *const u8 as *const libc::c_char,
    );
    let mut ms: libc::c_int = W_VerifyNMUSlumps(musicpath, false_0 as libc::c_int);
    if ms == 1 as libc::c_int {
        D_AddFile(&mut startupwadfiles, musicpath);
    } else if ms == 0 as libc::c_int {
        I_Error(
            b"File music.dta has been modified with non-music/sound lumps\0" as *const u8
                as *const libc::c_char,
        );
    }
}
unsafe extern "C" fn D_ConvertVersionNumbers() {
    ...
    VERSION = major * 100 as libc::c_int + minor;
}
unsafe extern "C" fn Command_assert() {
    CONS_Printf(
        b"No, assertions are NOT enabled.\n\0" as *const u8 as *const libc::c_char,
    );
}
#[no_mangle]
pub unsafe extern "C" fn D_SRB2Main() {
    let mut p: int32_t = 0;
    let mut pstartmap: int32_t = 1 as libc::c_int;
    let mut autostart: boolean = false_0 as libc::c_int;
    D_ConvertVersionNumbers();
    if strcmp(compbranch, b"\0" as *const u8 as *const libc::c_char) == 0 {
        compbranch = b"detached HEAD\0" as *const u8 as *const libc::c_char;
    }
    CONS_Printf(
    ...
    {
        I_OutputMsg(b"setvbuf didnt work\n\0" as *const u8 as *const libc::c_char);
    }
    M_StartupLocale();
    M_FindResponseFile();
    G_LoadGameSettings();
    ...
    devparm = (M_CheckParm(b"-debug\0" as *const u8 as *const libc::c_char)
        != 0 as libc::c_int) as libc::c_int;
    dedicated = (M_CheckParm(b"-dedicated\0" as *const u8 as *const libc::c_char)
        != 0 as libc::c_int) as libc::c_int;
    if devparm != 0 {
        CONS_Printf(b"Development mode ON.\n\0" as *const u8 as *const libc::c_char);
    }
    strcpy(
        savegamename.as_mut_ptr(),
        b"srb2sav%u.ssg\0" as *const u8 as *const libc::c_char,
    );
    strcpy(
        liveeventbackup.as_mut_ptr(),
        b"livesrb2sav.bkp\0" as *const u8 as *const libc::c_char,
    );
    let mut userhome: *const libc::c_char = D_Home();
    if userhome.is_null() {
        I_Error(
            b"Please set $HOME to your home directory\n\0" as *const u8
                as *const libc::c_char,
        );
    } else {
        snprintf(
            srb2home.as_mut_ptr(),
            ::core::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong,
            b"%s/.srb2\0" as *const u8 as *const libc::c_char,
            userhome,
        );
        snprintf(
            downloaddir.as_mut_ptr(),
            ::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong,
            b"%s/DOWNLOAD\0" as *const u8 as *const libc::c_char,
            srb2home.as_mut_ptr(),
        );
        if dedicated != 0 {
            snprintf(
                configfile.as_mut_ptr(),
                ::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong,
                b"%s/dconfig.cfg\0" as *const u8 as *const libc::c_char,
                srb2home.as_mut_ptr(),
            );
        } else {
            snprintf(
        ...
        snprintf(
            ...
            ::core::mem::size_of::<[libc::c_char; 272]>() as libc::c_ulong,
            b"%s/luafiles\0" as *const u8 as *const libc::c_char,
            srb2home.as_mut_ptr(),
        );
    }
    configfile[(::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong)
        ...
        as usize] = '\0' as i32 as libc::c_char;
    snprintf(
        addonsdir.as_mut_ptr(),
        ::core::mem::size_of::<[libc::c_char; 512]>() as libc::c_ulong,
        b"%s%s%s\0" as *const u8 as *const libc::c_char,
        srb2home.as_mut_ptr(),
        b"/\0" as *const u8 as *const libc::c_char,
        b"addons\0" as *const u8 as *const libc::c_char,
    );
    I_mkdir(addonsdir.as_mut_ptr(), 0o755 as libc::c_int);
    if M_RandomSeedFromOS() == 0 {
        M_RandomSeed(time(0 as *mut time_t) as uint32_t);
    }
    P_SetRandSeed(M_RandomizedSeed());
    if M_CheckParm(b"-password\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
    ...
    COM_AddCommand(
        ...
        Some(Command_assert as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    if !((!(M_GetUrlProtocolArg()).is_null()
        || M_CheckParm(b"-connect\0" as *const u8 as *const libc::c_char) != 0)
        && M_CheckParm(b"-server\0" as *const u8 as *const libc::c_char) == 0)
    {
        let mut addontype: int32_t = 0 as libc::c_int;
        let mut i: int32_t = 0;
        i = 1 as libc::c_int;
        while i < myargc {
            if strcasecmp(
                *myargv.offset(i as isize),
                b"-file\0" as *const u8 as *const libc::c_char,
            ) == 0
            {
                addontype = 1 as libc::c_int;
            } else if strcasecmp(
                *myargv.offset(i as isize),
                b"-folder\0" as *const u8 as *const libc::c_char,
            ) == 0
            {
                addontype = 2 as libc::c_int;
            } else if *(*myargv.offset(i as isize)).offset(0 as libc::c_int as isize)
                as libc::c_int == '-' as i32
                || *(*myargv.offset(i as isize)).offset(0 as libc::c_int as isize)
                    as libc::c_int == '+' as i32
            {
                addontype = 0 as libc::c_int;
            } else if addontype == 1 as libc::c_int {
                D_AddFile(&mut startuppwads, *myargv.offset(i as isize));
            } else if addontype == 2 as libc::c_int {
                D_AddFolder(&mut startuppwads, *myargv.offset(i as isize));
            }
            i += 1;
            i;
        }
    ...
    CONS_Printf(b"I_InitializeTime()...\n\0" as *const u8 as *const libc::c_char);
    I_InitializeTime();
    P_BackupTables();
    M_InitCharacterTables();
    mainwads = 3 as libc::c_int as uint16_t;
    mainwads = mainwads.wrapping_add(1);
    mainwads;
    CONS_Printf(
        b"W_InitMultipleFiles(): Adding IWAD and main PWADs.\n\0" as *const u8
            as *const libc::c_char,
    );
    W_InitMultipleFiles(&mut startupwadfiles);
    D_CleanFile(&mut startupwadfiles);
    W_VerifyFileMD5(
        0 as libc::c_int as uint16_t,
        b"ad911f29a28a18968ee5b2d11c2acb39\0" as *const u8 as *const libc::c_char,
    );
    W_VerifyFileMD5(
        1 as libc::c_int as uint16_t,
        b"1c8adf8d079ecb87d00081f158acf3c7\0" as *const u8 as *const libc::c_char,
    );
    W_VerifyFileMD5(
        2 as libc::c_int as uint16_t,
        b"2e7aaae8a6b1b77d90ffe7606ceadb6c\0" as *const u8 as *const libc::c_char,
    );
    W_VerifyFileMD5(
        3 as libc::c_int as uint16_t,
        b"3c7b73f34af7e9a7bceb2d5260f76172\0" as *const u8 as *const libc::c_char,
    );
    cht_Init();
    CONS_Printf(b"I_StartupGraphics()...\n\0" as *const u8 as *const libc::c_char);
    I_StartupGraphics();
    SCR_Startup();
    HU_Init();
    CON_Init();
    ...
    CON_StopRefresh();
    if startuppwads.numfiles != 0 {
        CONS_Printf(
            b"W_InitMultipleFiles(): Adding extra PWADs.\n\0" as *const u8
                as *const libc::c_char,
        );
        W_InitMultipleFiles(&mut startuppwads);
        D_CleanFile(&mut startuppwads);
    }
    CON_StartRefresh();
    CONS_Printf(b"HU_LoadGraphics()...\n\0" as *const u8 as *const libc::c_char);
    HU_LoadGraphics();
    M_FirstLoadConfig();
    if M_CheckParm(b"-gamedata\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        strlcpy(
    ...
    if M_CheckParm(b"-warp\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        let mut word: *const libc::c_char = M_GetNextParm();
        pstartmap = G_FindMapByNameOrCode(word, 0 as *mut *mut libc::c_char);
        if pstartmap == 0 {
            I_Error(
                b"Cannot find a map remotely named '%s'\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        } else {
            ...
            autostart = true_0 as libc::c_int;
        }
    }
    if M_CheckParm(b"-noupload\0" as *const u8 as *const libc::c_char) != 0 {
        COM_BufAddTextEx(
            b"downloading 0\n\0" as *const u8 as *const libc::c_char,
            0 as com_flags_t,
        );
    ...
    M_Init();
    CONS_Printf(
        b"R_Init(): Init SRB2 refresh daemon.\n\0" as *const u8 as *const libc::c_char,
    );
    R_Init();
    if dedicated != 0 {
        sound_disabled = true_0 as libc::c_int;
        digital_disabled = true_0 as libc::c_int;
        midi_disabled = digital_disabled;
    }
    if M_CheckParm(b"-noaudio\0" as *const u8 as *const libc::c_char) != 0 {
        sound_disabled = true_0 as libc::c_int;
        digital_disabled = true_0 as libc::c_int;
        ...
        if M_CheckParm(b"-nomusic\0" as *const u8 as *const libc::c_char) != 0 {
            ...
            if M_CheckParm(b"-nomidimusic\0" as *const u8 as *const libc::c_char) != 0 {
                midi_disabled = true_0 as libc::c_int;
            }
            if M_CheckParm(b"-nodigmusic\0" as *const u8 as *const libc::c_char) != 0 {
                digital_disabled = true_0 as libc::c_int;
            }
        }
    }
    if !(sound_disabled != 0 && digital_disabled != 0 && midi_disabled != 0) {
        CONS_Printf(
            b"S_InitSfxChannels(): Setting up sound channels.\n\0" as *const u8
                as *const libc::c_char,
        );
        I_StartupSound();
        I_InitMusic();
    ...
    S_InitMusicDefs();
    CONS_Printf(b"ST_Init(): Init status bar.\n\0" as *const u8 as *const libc::c_char);
    ST_Init();
    if M_CheckParm(b"-room\0" as *const u8 as *const libc::c_char) != 0 {
        if M_IsNextParm() == 0 {
            I_Error(
                b"usage: -room <room_id>\nCheck the Master Server's webpage for room ID numbers.\n\0"
                    as *const u8 as *const libc::c_char,
            );
        }
        ms_RoomId = atoi(M_GetNextParm()) as int16_t;
    ...
    if M_CheckParm(b"-metal\0" as *const u8 as *const libc::c_char) != 0 {
        G_RecordMetal();
        autostart = true_0 as libc::c_int;
    } else if M_CheckParm(b"-record\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
    ...
    p = M_CheckParm(b"-playdemo\0" as *const u8 as *const libc::c_char);
    if p == 0 {
        p = M_CheckParm(b"-timedemo\0" as *const u8 as *const libc::c_char);
    }
    if p != 0 && M_IsNextParm() != 0 {
        let mut tmp: [libc::c_char; 512] = [0; 512];
        strcpy(tmp.as_mut_ptr(), M_GetNextParm());
        while M_IsNextParm() != 0 {
            strcat(tmp.as_mut_ptr(), b" \0" as *const u8 as *const libc::c_char);
            strcat(tmp.as_mut_ptr(), M_GetNextParm());
        }
        FIL_DefaultExtension(
            tmp.as_mut_ptr(),
            b".lmp\0" as *const u8 as *const libc::c_char,
        );
        CONS_Printf(
            b"Playing demo %s.\n\0" as *const u8 as *const libc::c_char,
            tmp.as_mut_ptr(),
        );
        if M_CheckParm(b"-playdemo\0" as *const u8 as *const libc::c_char) != 0 {
            singledemo = true_0 as libc::c_int;
            G_DeferedPlayDemo(tmp.as_mut_ptr());
        } else {
            G_TimeDemo(tmp.as_mut_ptr());
        }
        G_SetGamestate(GS_NULL);
        wipegamestate = GS_NULL;
        return;
    }
    if M_CheckParm(b"-ultimatemode\0" as *const u8 as *const libc::c_char) != 0 {
        autostart = true_0 as libc::c_int;
        ultimatemode = true_0 as libc::c_int as uint8_t;
    }
    if M_CheckParm(b"-splitscreen\0" as *const u8 as *const libc::c_char) != 0 {
        autostart = true_0 as libc::c_int;
        splitscreen = true_0 as libc::c_int;
    }
    if bootmap as libc::c_int != 0
        && !(M_CheckParm(b"-warp\0" as *const u8 as *const libc::c_char) != 0
            && M_IsNextParm() != 0)
    {
        pstartmap = bootmap as int32_t;
        if pstartmap < 1 as libc::c_int || pstartmap > 1035 as libc::c_int {
            I_Error(
                b"Cannot warp to map %d (out of range)\n\0" as *const u8
                    as *const libc::c_char,
                pstartmap,
            );
        } else {
    ...
    if autostart != 0 || netgame != 0 {
        ...
        M_PushSpecialParameters();
        COM_BufExecute();
        if M_CheckParm(b"-gametype\0" as *const u8 as *const libc::c_char) != 0
            && M_IsNextParm() != 0
        {
            let mut j: int32_t = 0;
            let mut newgametype: int16_t = -(1 as libc::c_int) as int16_t;
            let mut sgametype: *const libc::c_char = M_GetNextParm();
            newgametype = G_GetGametypeByName(sgametype) as int16_t;
            if newgametype as libc::c_int == -(1 as libc::c_int) {
                j = atoi(sgametype);
                if j >= 0 as libc::c_int && j < gametypecount as libc::c_int {
                    newgametype = j as int16_t;
                }
            }
            if newgametype as libc::c_int != -(1 as libc::c_int) {
                j = gametype as int32_t;
                G_SetGametype(newgametype);
                D_GameTypeChanged(j);
            }
        }
        if server != 0 && M_CheckParm(b"+map\0" as *const u8 as *const libc::c_char) == 0
        {
            if W_CheckNumForName(G_BuildMapName(pstartmap)) == 4294967295 as libc::c_uint
            {
                I_Error(
                    b"Could not warp to %s (map not found)\n\0" as *const u8
                        as *const libc::c_char,
                    G_BuildMapName(pstartmap),
                );
            } else {
                if M_CampaignWarpIsCheat(gametype as int32_t, pstartmap, serverGamedata)
                    != 0
                {
    ...
    } else if M_CheckParm(b"-skipintro\0" as *const u8 as *const libc::c_char) != 0 {
        F_InitMenuPresValues();
        F_StartTitleScreen();
    } else {
        F_StartIntro();
...
#[no_mangle]
pub unsafe extern "C" fn D_Home() -> *const libc::c_char {
    let mut userhome: *const libc::c_char = 0 as *const libc::c_char;
    if M_CheckParm(b"-home\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        userhome = M_GetNextParm();
    } else {
        userhome = I_GetEnv(b"HOME\0" as *const u8 as *const libc::c_char);
    }
    if usehome != 0 { return userhome } else { return 0 as *const libc::c_char };
}
unsafe extern "C" fn check_top_dir(
    mut path: *mut *const libc::c_char,
    mut top: *const libc::c_char,
) -> boolean {
    if strcmp(top, b"\0" as *const u8 as *const libc::c_char) == 0 {
        return false_0 as libc::c_int;
    }
    if startswith(*path, top) == 0 {
        return false_0 as libc::c_int;
    }
    *path = (*path).offset(strlen(top) as isize);
    if endswith(top, b"/\0" as *const u8 as *const libc::c_char) == 0 {
        if startswith(*path, b"/\0" as *const u8 as *const libc::c_char) != 0 {
            *path = (*path)
...
unsafe extern "C" fn cmp_strlen_desc(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    return strlen(*(b as *const *const libc::c_char)) as libc::c_int
        - strlen(*(a as *const *const libc::c_char)) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn D_IsPathAllowed(mut path: *const libc::c_char) -> boolean {
    let mut paths: [*const libc::c_char; 3] = [
        srb2home.as_mut_ptr() as *const libc::c_char,
        srb2path.as_mut_ptr() as *const libc::c_char,
        cv_addons_folder.string,
    ];
    let n_paths: size_t = (::core::mem::size_of::<[*const libc::c_char; 3]>()
        as libc::c_ulong)
        .wrapping_div(::core::mem::size_of::<*const libc::c_char>() as libc::c_ulong);
    let mut i: size_t = 0;
    qsort(
        paths.as_mut_ptr() as *mut libc::c_void,
        n_paths,
    ...
    while i < n_paths {
        if check_top_dir(&mut path, paths[i as usize]) != 0 {
            break;
        }
        i = i.wrapping_add(1);
        i;
    ...
    if i == n_paths {
        if M_IsPathAbsolute(path) != 0 {
            return false_0 as libc::c_int;
        }
    }
    if !(strstr(path, b"..\0" as *const u8 as *const libc::c_char)).is_null() {
        return false_0 as libc::c_int;
    }
    return true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn D_CheckPathAllowed(
    mut path: *const libc::c_char,
    mut why: *const libc::c_char,
) -> boolean {
    if D_IsPathAllowed(path) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"%s: %s, location is not allowed\n\0" as *const u8 as *const libc::c_char,
            why,
            path,
        );
        return false_0 as libc::c_int;
