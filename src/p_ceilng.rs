...
#[no_mangle]
pub static mut ceilmovesound: int32_t = sfx_None as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn T_MoveCeiling(mut ceiling: *mut ceiling_t) {
    let mut res: result_e = planeok;
    if (*ceiling).delaytimer != 0 {
        (*ceiling).delaytimer -= 1;
        (*ceiling).delaytimer;
        return;
    }
    res = T_MovePlane(
        (*ceiling).sector,
        (*ceiling).speed,
        if (*ceiling).direction == 1 as libc::c_int {
            (*ceiling).topheight
        } else {
    ...
    if (*ceiling).type_0 as libc::c_uint == bounceCeiling as libc::c_int as libc::c_uint
    {
        ...
        let fs: fixed_t = abs(
            (*(*ceiling).sector).ceilingheight
                - (*(*lines.offset((*ceiling).sourceline as isize)).frontsector)
                    .ceilingheight,
        );
        let bs: fixed_t = abs(
            (*(*ceiling).sector).ceilingheight
                - (*(*lines.offset((*ceiling).sourceline as isize)).backsector)
                    .ceilingheight,
        );
        if fs < bs {
            (*ceiling)
    ...
    if res as libc::c_uint == pastdest as libc::c_int as libc::c_uint {
        ...
        match (*ceiling).type_0 as libc::c_uint {
            8 => {
                if (*ceiling).texture > -(1 as libc::c_int) {
                    (*(*ceiling).sector).ceilingpic = (*ceiling).texture;
                }
                (*(*ceiling).sector).ceilingdata = 0 as *mut libc::c_void;
                (*(*ceiling).sector).ceilspeed = 0 as libc::c_int;
                P_RemoveThinker(&mut (*ceiling).thinker);
                return;
            }
            7 => {
                if (*ceiling).tag != 0 {
                ...
                current_block_41 = 18310620160517087985;
            }
            0 | 9 => {
                current_block_41 = 18310620160517087985;
            }
            10 | 11 => {
                let mut dest: fixed_t = if (*ceiling).direction == 1 as libc::c_int {
                    (*ceiling).topheight
                } else {
                    (*ceiling).bottomheight
                };
                if dest
                    == (*(*lines.offset((*ceiling).sourceline as isize)).frontsector)
                        .ceilingheight
                {
                    dest = (*(*lines.offset((*ceiling).sourceline as isize)).backsector)
                        .ceilingheight;
                    (*ceiling)
                        .origspeed = (*lines.offset((*ceiling).sourceline as isize))
                        .args[3 as libc::c_int as usize]
                        << 16 as libc::c_int - 2 as libc::c_int;
                } else {
                    dest = (*(*lines.offset((*ceiling).sourceline as isize)).frontsector)
                        .ceilingheight;
                    (*ceiling)
                        .origspeed = (*lines.offset((*ceiling).sourceline as isize))
                ...
                if (*ceiling).type_0 as libc::c_uint
                    == bounceCeilingCrush as libc::c_int as libc::c_uint
                {
                    (*ceiling).speed = (*ceiling).origspeed;
                }
                if dest < (*(*ceiling).sector).ceilingheight {
                    (*ceiling).direction = -(1 as libc::c_int);
                ...
                current_block_41 = 11048769245176032998;
            }
            _ => {
                current_block_41 = 11048769245176032998;
            }
...
#[no_mangle]
pub unsafe extern "C" fn T_CrushCeiling(mut ceiling: *mut ceiling_t) {
    let mut res: result_e = planeok;
    match (*ceiling).direction {
        1 => {
            if (*ceiling).type_0 as libc::c_uint
                == crushBothOnce as libc::c_int as libc::c_uint
            {
                T_MovePlane(
                    (*ceiling).sector,
                    (*ceiling).speed,
            ...
            if res as libc::c_uint == pastdest as libc::c_int as libc::c_uint {
                (*ceiling).direction = -(1 as libc::c_int);
                (*ceiling)
                    .speed = (*lines.offset((*ceiling).sourceline as isize))
                    .args[2 as libc::c_int as usize]
                    << 16 as libc::c_int - 2 as libc::c_int;
                if (*ceiling).type_0 as libc::c_uint
                    == crushCeilOnce as libc::c_int as libc::c_uint
                    || (*ceiling).type_0 as libc::c_uint
                        == crushBothOnce as libc::c_int as libc::c_uint
                {
                    match (*ceiling).type_0 as libc::c_uint {
                        5 => {
                        ...
                        6 => {
                            (*(*ceiling).sector).floorspeed = 0 as libc::c_int;
                            (*(*ceiling).sector).ceilspeed = 0 as libc::c_int;
                            (*(*ceiling).sector).ceilingdata = 0 as *mut libc::c_void;
                        }
                        _ => {}
    ...
    if (*ceiling).type_0 as libc::c_uint == crushBothOnce as libc::c_int as libc::c_uint
    {
...
pub unsafe extern "C" fn EV_DoCeiling(
    ...
    let mut rtn: int32_t = 0 as libc::c_int;
    let mut firstone: int32_t = 1 as libc::c_int;
    let mut secnum: int32_t = -(1 as libc::c_int);
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut ceiling: *mut ceiling_t = 0 as *mut ceiling_t;
    let mut ICNT_215: size_t = 0 as libc::c_int as size_t;
    loop {
        secnum = Tag_Iterate_Sectors(tag, ICNT_215);
        ...
        if ((*sec).ceilingdata).is_null() {
            rtn = 1 as libc::c_int;
            ceiling = Z_CallocAlign(
                ::core::mem::size_of::<ceiling_t>() as libc::c_ulong,
                PU_LEVSPEC as libc::c_int,
                0 as *mut libc::c_void,
                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
            ) as *mut ceiling_t;
            P_AddThinker(THINK_MAIN, &mut (*ceiling).thinker);
            (*sec).ceilingdata = ceiling as *mut libc::c_void;
            (*ceiling)
                .thinker
                .function
            ...
            (*ceiling).sector = sec;
            (*ceiling).crush = false_0 as libc::c_int as uint8_t;
            (*ceiling).sourceline = line.offset_from(lines) as libc::c_long as int32_t;
            match type_0 as libc::c_uint {
                0 => {
                    (*ceiling).topheight = P_FindHighestCeilingSurrounding(sec);
                    (*ceiling).direction = 1 as libc::c_int;
                    (*ceiling).speed = (1 as libc::c_int) << 16 as libc::c_int;
                }
                1 => {
                    (*ceiling).bottomheight = P_FindLowestCeilingSurrounding(sec);
                    (*ceiling).direction = -(1 as libc::c_int);
                    (*ceiling)
                        .speed = 4 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int);
                }
                2 => {
                    (*ceiling).topheight = P_FindHighestCeilingSurrounding(sec);
                    (*ceiling).direction = 1 as libc::c_int;
                    (*ceiling).speed = 2147483647 as libc::c_int / 2 as libc::c_int;
                }
                7 => {
                    (*ceiling)
                        .speed = (*line).args[2 as libc::c_int as usize]
                        << 16 as libc::c_int - 3 as libc::c_int;
                    if (*(*line).frontsector).ceilingheight >= (*sec).ceilingheight {
                        (*ceiling).direction = 1 as libc::c_int;
                ...
                9 => {
                    ...
                    if (*line).args[2 as libc::c_int as usize] > 0 as libc::c_int {
                        (*ceiling).direction = 1 as libc::c_int;
                        (*ceiling)
                ...
                10 | 11 => {
                    ...
                    (*ceiling).delay = (*line).args[5 as libc::c_int as usize];
                    (*ceiling).delaytimer = (*line).args[4 as libc::c_int as usize];
                }
                _ => {}
            }
        ...
        ICNT_215 = ICNT_215.wrapping_add(1);
        ICNT_215;
    }
    return rtn;
}
#[no_mangle]
pub unsafe extern "C" fn EV_DoCrush(
    mut tag: mtag_t,
    mut line: *mut line_t,
    mut type_0: ceiling_e,
) -> int32_t {
    ...
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut ceiling: *mut ceiling_t = 0 as *mut ceiling_t;
    let mut ICNT_361: size_t = 0 as libc::c_int as size_t;
    loop {
        secnum = Tag_Iterate_Sectors(tag, ICNT_361);
        if !(secnum >= 0 as libc::c_int) {
            break;
        }
        sec = &mut *sectors.offset(secnum as isize) as *mut sector_t;
        if ((*sec).ceilingdata).is_null() {
            ...
            (*ceiling)
                ...
                Option::<unsafe extern "C" fn(*mut ceiling_t) -> ()>,
                actionf_p1,
            >(Some(T_CrushCeiling as unsafe extern "C" fn(*mut ceiling_t) -> ()));
            (*ceiling).sector = sec;
            (*ceiling).crush = true_0 as libc::c_int as uint8_t;
            (*ceiling).sourceline = line.offset_from(lines) as libc::c_long as int32_t;
            (*ceiling)
            ...
            match type_0 as libc::c_uint {
                4 => {
                    ...
                    (*ceiling).direction = 1 as libc::c_int;
                    if udmf == 0
                        && (*line).flags as libc::c_int & 512 as libc::c_int == 0
                    {
                        (*ceiling).speed /= 2 as libc::c_int;
                    } else {
                        (*ceiling)
                            .speed = (*line).args[3 as libc::c_int as usize]
                            << 16 as libc::c_int - 2 as libc::c_int;
                ...
                6 => {
                    ...
                    (*ceiling)
                        .bottomheight = (*sec).floorheight
                        + ((*sec).ceilingheight - (*sec).floorheight) / 2 as libc::c_int;
                    (*ceiling).direction = -(1 as libc::c_int);
                }
                5 | _ => {
                    (*ceiling).topheight = (*sec).ceilingheight;
        ...
        ICNT_361 = ICNT_361.wrapping_add(1);
        ICNT_361;
    }
    return rtn;
}
