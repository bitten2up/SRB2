...
extern "C" {
    ...
    static mut compdate: *const libc::c_char;
    static mut comptime: *const libc::c_char;
    ...
    fn COM_CheckPartialParm(check: *const libc::c_char) -> size_t;
    fn COM_FirstOption() -> size_t;
    fn COM_Argc() -> size_t;
    fn COM_Argv(arg: size_t) -> *const libc::c_char;
    fn COM_CheckParm(check: *const libc::c_char) -> size_t;
    fn COM_BufAddTextEx(btext: *const libc::c_char, flags: com_flags_t);
    fn CV_IsSetToDefault(v: *mut consvar_t) -> boolean;
    fn CV_ResetCheatNetVars();
    ...
    static mut cv_numChannels: consvar_t;
    fn S_StopSounds();
    fn S_StartSound(origin: *const libc::c_void, sound_id: sfxenum_t);
    fn Command_ObjectPlace_f();
    static mut cv_speed: consvar_t;
    static mut cv_opflags: consvar_t;
    static mut cv_ophoopflags: consvar_t;
    static mut cv_mapthingnum: consvar_t;
    fn Command_CheatNoClip_f();
    fn Command_CheatGod_f();
    fn Command_CheatNoTarget_f();
    fn Command_Getallemeralds_f();
    fn Command_Resetemeralds_f();
    fn Command_Setrings_f();
    fn Command_Setlives_f();
    fn Command_Setcontinues_f();
    fn Command_Devmode_f();
    fn Command_Savecheckpoint_f();
    ...
    static mut autobalance: int16_t;
    static mut teamscramble: int16_t;
    static mut scrambleplayers: [int16_t; 32];
    static mut scrambleteams: [int16_t; 32];
    static mut scrambletotal: int16_t;
    static mut scramblecount: int16_t;
    static mut hidetime: tic_t;
    static mut debugfile: *mut FILE;
    static mut precache: boolean;
    fn Command_Scale_f();
    fn Command_Gravflip_f();
    fn Command_Hurtme_f();
    fn Command_JumpToAxis_f();
    fn Command_Charability_f();
    fn Command_Charspeed_f();
    fn Command_Teleport_f();
    fn HSendPacket(
        node: int32_t,
        reliable: boolean,
        acknum: uint8_t,
    ...
    fn Command_RTeleport_f();
    fn SendNetXCmd(id: netxcmd_t, param: *const libc::c_void, nparam: size_t);
    fn Command_Skynum_f();
    fn Command_Weather_f();
    fn Command_Toggletwod_f();
    static mut unlockables: [unlockable_t; 80];
    static mut players: [player_t; 32];
    static mut timingdemo: boolean;
    fn G_DoneLevelLoad();
    fn G_BeginMetal();
    static mut demorecording: boolean;
    fn G_BeginRecording();
    static mut demo_start: boolean;
    static mut cv_netticbuffer: consvar_t;
    fn G_CheckDemoStatus() -> boolean;
    fn G_TimeDemo(name: *const libc::c_char);
    fn G_StopMetalDemo();
    ...
    fn SendNetXCmd2(id: netxcmd_t, param: *const libc::c_void, nparam: size_t);
    static mut adminpassmd5: [uint8_t; 16];
    static mut adminpasswordset: boolean;
    fn Playing() -> boolean;
    fn D_MD5PasswordPass(
    ...
    static mut motd: [libc::c_char; 254];
    fn SendKick(playernum: uint8_t, msg: uint8_t);
    fn M_CampaignWarpIsCheat(
        gt: int32_t,
        mapnum: int32_t,
        data: *mut gamedata_t,
    ) -> uint8_t;
    static mut connectiontimeout: tic_t;
    fn SV_SpawnServer() -> boolean;
    fn D_QuitNetGame();
    fn CL_Reset();
    fn CL_ClearPlayer(playernum: int32_t);
    static mut clientGamedata: *mut gamedata_t;
    fn M_SecretUnlocked(type_0: int32_t, data: *mut gamedata_t) -> uint8_t;
    static mut serverGamedata: *mut gamedata_t;
    static mut jointimeout: tic_t;
    fn Command_Ping_f();
    static mut cv_dedicatedidletime: consvar_t;
    static mut cv_blamecfail: consvar_t;
    static mut cv_showjoinaddress: consvar_t;
    static mut cv_joinnextround: consvar_t;
    ...
    static mut cv_playbackspeed: consvar_t;
    fn AddMServCommands();
    ...
    fn G_GetGametypeByName(gametypestr: *const libc::c_char) -> int32_t;
    fn G_FindMapByNameOrCode(
        query: *const libc::c_char,
        foundmapnamep: *mut *mut libc::c_char,
    ) -> int32_t;
    ...
    fn G_TOLFlag(pgametype: int32_t) -> uint32_t;
    ...
    fn W_IsPathToFolderValid(path: *const libc::c_char) -> int32_t;
    fn W_GetFullFolderPath(path: *const libc::c_char) -> *mut libc::c_char;
    static mut cv_renderview: consvar_t;
    static mut cv_renderhitboxinterpolation: consvar_t;
    static mut cv_renderhitboxgldepth: consvar_t;
    static mut cv_renderhitbox: consvar_t;
    static mut cv_renderer: consvar_t;
    static mut cv_scr_depth: consvar_t;
    ...
    fn Command_Setcontrol_f();
    fn Command_Setcontrol2_f();
    fn G_CopyControls(
        setupcontrols: *mut [int32_t; 2],
    ...
    fn Command_Numthinkers_f();
    fn Command_CountMobjs_f();
    fn F_StartIntro();
    static mut cv_showfocuslost: consvar_t;
    ...
    fn Got_Luacmd(cp: *mut *mut uint8_t, playernum: int32_t);
    fn P_DamageMobj(
        target: *mut mobj_t,
    ...
    fn P_RunSOC(socfilename: *const libc::c_char) -> boolean;
    fn PS_SampleSize_OnChange();
    fn PS_PerfStats_OnChange();
    fn P_SetTarget2(mo: *mut *mut mobj_t, target: *mut mobj_t) -> *mut mobj_t;
    fn P_SpectatorJoinGame(player: *mut player_t) -> boolean;
    fn GetPlayerDefaultSkin(playernum: int32_t) -> int32_t;
    static mut numskins: int32_t;
    fn R_GetSkinAvailabilities() -> uint32_t;
    ...
    fn P_PlayerMoving(pnum: int32_t) -> boolean;
    ...
    static mut cv_apng_delay: consvar_t;
    ...
    fn M_ScreenShot();
    fn Command_SaveConfig_f();
    fn Command_LoadConfig_f();
    fn Command_ChangeConfig_f();
    fn M_IsStringEmpty(s: *const libc::c_char) -> boolean;
    static mut automapactive: boolean;
    fn Got_LuaFile(cp: *mut *mut uint8_t, playernum: int32_t);
    fn Command_Downloads_f();
    fn findfile(
        filename: *mut libc::c_char,
        wantedmd5sum: *const uint8_t,
        completepath: boolean,
    ) -> filestatus_t;
    fn findfolder(path: *const libc::c_char) -> filestatus_t;
...
pub const NUMSUPERCOLORS: C2RustUnnamed_1 = 9;
pub const MAXSKINCOLORS: C2RustUnnamed_1 = 1182;
pub const SKINCOLOR_LASTFREESLOT: C2RustUnnamed_1 = 1181;
pub const SKINCOLOR_FIRSTFREESLOT: C2RustUnnamed_1 = 158;
pub const SKINCOLOR_SUPERTAN5: C2RustUnnamed_1 = 157;
pub const SKINCOLOR_SUPERTAN4: C2RustUnnamed_1 = 156;
pub const SKINCOLOR_SUPERTAN3: C2RustUnnamed_1 = 155;
pub const SKINCOLOR_SUPERTAN2: C2RustUnnamed_1 = 154;
pub const SKINCOLOR_SUPERTAN1: C2RustUnnamed_1 = 153;
pub const SKINCOLOR_SUPERRUST5: C2RustUnnamed_1 = 152;
pub const SKINCOLOR_SUPERRUST4: C2RustUnnamed_1 = 151;
pub const SKINCOLOR_SUPERRUST3: C2RustUnnamed_1 = 150;
pub const SKINCOLOR_SUPERRUST2: C2RustUnnamed_1 = 149;
pub const SKINCOLOR_SUPERRUST1: C2RustUnnamed_1 = 148;
pub const SKINCOLOR_SUPERPURPLE5: C2RustUnnamed_1 = 147;
pub const SKINCOLOR_SUPERPURPLE4: C2RustUnnamed_1 = 146;
pub const SKINCOLOR_SUPERPURPLE3: C2RustUnnamed_1 = 145;
pub const SKINCOLOR_SUPERPURPLE2: C2RustUnnamed_1 = 144;
pub const SKINCOLOR_SUPERPURPLE1: C2RustUnnamed_1 = 143;
pub const SKINCOLOR_SUPERSKY5: C2RustUnnamed_1 = 142;
pub const SKINCOLOR_SUPERSKY4: C2RustUnnamed_1 = 141;
pub const SKINCOLOR_SUPERSKY3: C2RustUnnamed_1 = 140;
pub const SKINCOLOR_SUPERSKY2: C2RustUnnamed_1 = 139;
pub const SKINCOLOR_SUPERSKY1: C2RustUnnamed_1 = 138;
pub const SKINCOLOR_SUPERPERIDOT5: C2RustUnnamed_1 = 137;
pub const SKINCOLOR_SUPERPERIDOT4: C2RustUnnamed_1 = 136;
pub const SKINCOLOR_SUPERPERIDOT3: C2RustUnnamed_1 = 135;
pub const SKINCOLOR_SUPERPERIDOT2: C2RustUnnamed_1 = 134;
pub const SKINCOLOR_SUPERPERIDOT1: C2RustUnnamed_1 = 133;
pub const SKINCOLOR_SUPERGOLD5: C2RustUnnamed_1 = 132;
pub const SKINCOLOR_SUPERGOLD4: C2RustUnnamed_1 = 131;
pub const SKINCOLOR_SUPERGOLD3: C2RustUnnamed_1 = 130;
pub const SKINCOLOR_SUPERGOLD2: C2RustUnnamed_1 = 129;
pub const SKINCOLOR_SUPERGOLD1: C2RustUnnamed_1 = 128;
pub const SKINCOLOR_SUPERORANGE5: C2RustUnnamed_1 = 127;
pub const SKINCOLOR_SUPERORANGE4: C2RustUnnamed_1 = 126;
pub const SKINCOLOR_SUPERORANGE3: C2RustUnnamed_1 = 125;
pub const SKINCOLOR_SUPERORANGE2: C2RustUnnamed_1 = 124;
pub const SKINCOLOR_SUPERORANGE1: C2RustUnnamed_1 = 123;
pub const SKINCOLOR_SUPERRED5: C2RustUnnamed_1 = 122;
pub const SKINCOLOR_SUPERRED4: C2RustUnnamed_1 = 121;
pub const SKINCOLOR_SUPERRED3: C2RustUnnamed_1 = 120;
pub const SKINCOLOR_SUPERRED2: C2RustUnnamed_1 = 119;
pub const SKINCOLOR_SUPERRED1: C2RustUnnamed_1 = 118;
pub const SKINCOLOR_SUPERSILVER5: C2RustUnnamed_1 = 117;
pub const SKINCOLOR_SUPERSILVER4: C2RustUnnamed_1 = 116;
pub const SKINCOLOR_SUPERSILVER3: C2RustUnnamed_1 = 115;
pub const SKINCOLOR_SUPERSILVER2: C2RustUnnamed_1 = 114;
pub const SKINCOLOR_SUPERSILVER1: C2RustUnnamed_1 = 113;
pub const FIRSTSUPERCOLOR: C2RustUnnamed_1 = 113;
pub const SKINCOLOR_VOLCANIC: C2RustUnnamed_1 = 112;
pub const SKINCOLOR_SANGRIA: C2RustUnnamed_1 = 111;
pub const SKINCOLOR_FANCY: C2RustUnnamed_1 = 110;
pub const SKINCOLOR_ROSY: C2RustUnnamed_1 = 109;
pub const SKINCOLOR_TAFFY: C2RustUnnamed_1 = 108;
pub const SKINCOLOR_RASPBERRY: C2RustUnnamed_1 = 107;
pub const SKINCOLOR_PLUM: C2RustUnnamed_1 = 106;
pub const SKINCOLOR_EVENTIDE: C2RustUnnamed_1 = 105;
pub const SKINCOLOR_MAUVE: C2RustUnnamed_1 = 104;
pub const SKINCOLOR_LILAC: C2RustUnnamed_1 = 103;
pub const SKINCOLOR_ROYAL: C2RustUnnamed_1 = 102;
pub const SKINCOLOR_VIOLET: C2RustUnnamed_1 = 101;
pub const SKINCOLOR_NEON: C2RustUnnamed_1 = 100;
pub const SKINCOLOR_MAGENTA: C2RustUnnamed_1 = 99;
pub const SKINCOLOR_SIBERITE: C2RustUnnamed_1 = 98;
pub const SKINCOLOR_BUBBLEGUM: C2RustUnnamed_1 = 97;
pub const SKINCOLOR_FUCHSIA: C2RustUnnamed_1 = 96;
pub const SKINCOLOR_NOBLE: C2RustUnnamed_1 = 95;
pub const SKINCOLOR_PURPLE: C2RustUnnamed_1 = 94;
pub const SKINCOLOR_PASTEL: C2RustUnnamed_1 = 93;
pub const SKINCOLOR_MAJESTY: C2RustUnnamed_1 = 92;
pub const SKINCOLOR_DUSK: C2RustUnnamed_1 = 91;
pub const SKINCOLOR_VAPOR: C2RustUnnamed_1 = 90;
pub const SKINCOLOR_GALAXY: C2RustUnnamed_1 = 89;
pub const SKINCOLOR_MIDNIGHT: C2RustUnnamed_1 = 88;
pub const SKINCOLOR_COBALT: C2RustUnnamed_1 = 87;
pub const SKINCOLOR_BLUE: C2RustUnnamed_1 = 86;
pub const SKINCOLOR_CORNFLOWER: C2RustUnnamed_1 = 85;
pub const SKINCOLOR_ARCTIC: C2RustUnnamed_1 = 84;
pub const SKINCOLOR_SAPPHIRE: C2RustUnnamed_1 = 83;
pub const SKINCOLOR_DAYBREAK: C2RustUnnamed_1 = 82;
pub const SKINCOLOR_ICY: C2RustUnnamed_1 = 81;
pub const SKINCOLOR_DREAM: C2RustUnnamed_1 = 80;
pub const SKINCOLOR_CERULEAN: C2RustUnnamed_1 = 79;
pub const SKINCOLOR_MARINE: C2RustUnnamed_1 = 78;
pub const SKINCOLOR_SKY: C2RustUnnamed_1 = 77;
pub const SKINCOLOR_AQUAMARINE: C2RustUnnamed_1 = 76;
pub const SKINCOLOR_TURQUOISE: C2RustUnnamed_1 = 75;
pub const SKINCOLOR_CYAN: C2RustUnnamed_1 = 74;
pub const SKINCOLOR_WAVE: C2RustUnnamed_1 = 73;
pub const SKINCOLOR_OCEAN: C2RustUnnamed_1 = 72;
pub const SKINCOLOR_TEAL: C2RustUnnamed_1 = 71;
pub const SKINCOLOR_AQUA: C2RustUnnamed_1 = 70;
pub const SKINCOLOR_BOTTLE: C2RustUnnamed_1 = 69;
pub const SKINCOLOR_ISLAND: C2RustUnnamed_1 = 68;
pub const SKINCOLOR_SEAFOAM: C2RustUnnamed_1 = 67;
pub const SKINCOLOR_EMERALD: C2RustUnnamed_1 = 66;
pub const SKINCOLOR_MASTER: C2RustUnnamed_1 = 65;
pub const SKINCOLOR_MINT: C2RustUnnamed_1 = 64;
pub const SKINCOLOR_JADE: C2RustUnnamed_1 = 63;
pub const SKINCOLOR_SHAMROCK: C2RustUnnamed_1 = 62;
pub const SKINCOLOR_FOREST: C2RustUnnamed_1 = 61;
pub const SKINCOLOR_GREEN: C2RustUnnamed_1 = 60;
pub const SKINCOLOR_CHARTREUSE: C2RustUnnamed_1 = 59;
pub const SKINCOLOR_HEADLIGHT: C2RustUnnamed_1 = 58;
pub const SKINCOLOR_APPLE: C2RustUnnamed_1 = 57;
pub const SKINCOLOR_PERIDOT: C2RustUnnamed_1 = 56;
pub const SKINCOLOR_LIME: C2RustUnnamed_1 = 55;
pub const SKINCOLOR_LEMON: C2RustUnnamed_1 = 54;
pub const SKINCOLOR_PEAR: C2RustUnnamed_1 = 53;
pub const SKINCOLOR_OLIVE: C2RustUnnamed_1 = 52;
pub const SKINCOLOR_YELLOW: C2RustUnnamed_1 = 51;
pub const SKINCOLOR_GOLDENROD: C2RustUnnamed_1 = 50;
pub const SKINCOLOR_SANDY: C2RustUnnamed_1 = 49;
pub const SKINCOLOR_GOLD: C2RustUnnamed_1 = 48;
pub const SKINCOLOR_TOPAZ: C2RustUnnamed_1 = 47;
pub const SKINCOLOR_TANGERINE: C2RustUnnamed_1 = 46;
pub const SKINCOLOR_RUST: C2RustUnnamed_1 = 45;
pub const SKINCOLOR_ORANGE: C2RustUnnamed_1 = 44;
pub const SKINCOLOR_APRICOT: C2RustUnnamed_1 = 43;
pub const SKINCOLOR_COPPER: C2RustUnnamed_1 = 42;
pub const SKINCOLOR_SUNSET: C2RustUnnamed_1 = 41;
pub const SKINCOLOR_FOUNDATION: C2RustUnnamed_1 = 40;
pub const SKINCOLOR_QUAIL: C2RustUnnamed_1 = 39;
pub const SKINCOLOR_PEACHY: C2RustUnnamed_1 = 38;
pub const SKINCOLOR_KETCHUP: C2RustUnnamed_1 = 37;
pub const SKINCOLOR_GARNET: C2RustUnnamed_1 = 36;
pub const SKINCOLOR_FLAME: C2RustUnnamed_1 = 35;
pub const SKINCOLOR_CRIMSON: C2RustUnnamed_1 = 34;
pub const SKINCOLOR_RED: C2RustUnnamed_1 = 33;
pub const SKINCOLOR_PEPPER: C2RustUnnamed_1 = 32;
pub const SKINCOLOR_SALMON: C2RustUnnamed_1 = 31;
pub const SKINCOLOR_CHERRY: C2RustUnnamed_1 = 30;
pub const SKINCOLOR_RUBY: C2RustUnnamed_1 = 29;
pub const SKINCOLOR_LAVENDER: C2RustUnnamed_1 = 28;
pub const SKINCOLOR_EGGPLANT: C2RustUnnamed_1 = 27;
pub const SKINCOLOR_AZURE: C2RustUnnamed_1 = 26;
pub const SKINCOLOR_MOSS: C2RustUnnamed_1 = 25;
pub const SKINCOLOR_ROSEBUSH: C2RustUnnamed_1 = 24;
pub const SKINCOLOR_BEIGE: C2RustUnnamed_1 = 23;
pub const SKINCOLOR_TAN: C2RustUnnamed_1 = 22;
pub const SKINCOLOR_ECRU: C2RustUnnamed_1 = 21;
pub const SKINCOLOR_SEPIA: C2RustUnnamed_1 = 20;
pub const SKINCOLOR_BRONZE: C2RustUnnamed_1 = 19;
pub const SKINCOLOR_BOULDER: C2RustUnnamed_1 = 18;
pub const SKINCOLOR_BROWN: C2RustUnnamed_1 = 17;
pub const SKINCOLOR_LATTE: C2RustUnnamed_1 = 16;
pub const SKINCOLOR_YOGURT: C2RustUnnamed_1 = 15;
pub const SKINCOLOR_ROSEWOOD: C2RustUnnamed_1 = 14;
pub const SKINCOLOR_PINK: C2RustUnnamed_1 = 13;
pub const SKINCOLOR_BLUEBELL: C2RustUnnamed_1 = 12;
pub const SKINCOLOR_MOONSTONE: C2RustUnnamed_1 = 11;
pub const SKINCOLOR_SLATE: C2RustUnnamed_1 = 10;
pub const SKINCOLOR_AETHER: C2RustUnnamed_1 = 9;
pub const SKINCOLOR_BLACK: C2RustUnnamed_1 = 8;
pub const SKINCOLOR_JET: C2RustUnnamed_1 = 7;
pub const SKINCOLOR_CARBON: C2RustUnnamed_1 = 6;
pub const SKINCOLOR_SILVER: C2RustUnnamed_1 = 5;
pub const SKINCOLOR_GREY: C2RustUnnamed_1 = 4;
pub const SKINCOLOR_CLOUDY: C2RustUnnamed_1 = 3;
pub const SKINCOLOR_BONE: C2RustUnnamed_1 = 2;
pub const SKINCOLOR_WHITE: C2RustUnnamed_1 = 1;
pub const SKINCOLOR_NONE: C2RustUnnamed_1 = 0;
...
pub const hook_GameQuit: C2RustUnnamed_10 = 23;
...
pub type addedfile_t = addedfile_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct addedfile_s {
    pub next: *mut addedfile_s,
    pub prev: *mut addedfile_s,
...
pub struct listitem_s {
    pub next: *mut listitem_s,
    pub prev: *mut listitem_s,
}
pub const PU_STATIC: C2RustUnnamed_9 = 1;
pub const gcs_custom: C2RustUnnamed_8 = 0;
pub const PT_LOGIN: C2RustUnnamed_7 = 31;
#[derive(Copy, Clone)]
#[repr(C, packed)]
...
pub const hook_MapChange: C2RustUnnamed_10 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const NUMPACKETTYPE: C2RustUnnamed_7 = 35;
pub const PT_PING: C2RustUnnamed_7 = 34;
pub const PT_MOREFILESNEEDED: C2RustUnnamed_7 = 33;
pub const PT_TELLFILESNEEDED: C2RustUnnamed_7 = 32;
pub const PT_NODETIMEOUT: C2RustUnnamed_7 = 30;
pub const PT_CLIENTJOIN: C2RustUnnamed_7 = 29;
pub const PT_TEXTCMD2: C2RustUnnamed_7 = 28;
pub const PT_TEXTCMD: C2RustUnnamed_7 = 27;
pub const PT_FILERECEIVED: C2RustUnnamed_7 = 26;
pub const PT_FILEACK: C2RustUnnamed_7 = 25;
pub const PT_FILEFRAGMENT: C2RustUnnamed_7 = 24;
pub const PT_CANFAIL: C2RustUnnamed_7 = 24;
pub const PT_BASICKEEPALIVE: C2RustUnnamed_7 = 23;
pub const PT_HASLUAFILE: C2RustUnnamed_7 = 22;
pub const PT_ASKLUAFILE: C2RustUnnamed_7 = 21;
pub const PT_SENDINGLUAFILE: C2RustUnnamed_7 = 20;
pub const PT_RECEIVEDGAMESTATE: C2RustUnnamed_7 = 19;
pub const PT_CANRECEIVEGAMESTATE: C2RustUnnamed_7 = 18;
pub const PT_WILLRESENDGAMESTATE: C2RustUnnamed_7 = 17;
pub const PT_ASKINFOVIAMS: C2RustUnnamed_7 = 16;
pub const PT_REQUESTFILE: C2RustUnnamed_7 = 15;
pub const PT_PLAYERINFO: C2RustUnnamed_7 = 14;
pub const PT_SERVERINFO: C2RustUnnamed_7 = 13;
pub const PT_ASKINFO: C2RustUnnamed_7 = 12;
pub const PT_CLIENTQUIT: C2RustUnnamed_7 = 11;
pub const PT_SERVERSHUTDOWN: C2RustUnnamed_7 = 10;
pub const PT_SERVERREFUSE: C2RustUnnamed_7 = 9;
pub const PT_SERVERTICS: C2RustUnnamed_7 = 8;
pub const PT_NODEKEEPALIVEMIS: C2RustUnnamed_7 = 7;
pub const PT_NODEKEEPALIVE: C2RustUnnamed_7 = 6;
pub const PT_CLIENT2MIS: C2RustUnnamed_7 = 5;
pub const PT_CLIENT2CMD: C2RustUnnamed_7 = 4;
pub const PT_CLIENTMIS: C2RustUnnamed_7 = 3;
pub const PT_CLIENTCMD: C2RustUnnamed_7 = 2;
pub const PT_SERVERCFG: C2RustUnnamed_7 = 1;
pub const PT_NOTHING: C2RustUnnamed_7 = 0;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const num_gamecontrolschemes: C2RustUnnamed_8 = 3;
pub const gcs_platform: C2RustUnnamed_8 = 2;
pub const gcs_fps: C2RustUnnamed_8 = 1;
...
pub const hook_MAX: C2RustUnnamed_10 = 30;
pub const hook_KeyUp: C2RustUnnamed_10 = 29;
pub const hook_KeyDown: C2RustUnnamed_10 = 28;
pub const hook_PlayerCanEnterSpinGaps: C2RustUnnamed_10 = 27;
pub const hook_PlayerHeight: C2RustUnnamed_10 = 26;
pub const hook_MusicChange: C2RustUnnamed_10 = 25;
pub const hook_PlayerCmd: C2RustUnnamed_10 = 24;
pub const hook_PlayerThink: C2RustUnnamed_10 = 22;
pub const hook_SeenPlayer: C2RustUnnamed_10 = 21;
pub const hook_ViewpointSwitch: C2RustUnnamed_10 = 20;
pub const hook_TeamSwitch: C2RustUnnamed_10 = 19;
pub const hook_IntermissionThinker: C2RustUnnamed_10 = 18;
pub const hook_PlayerQuit: C2RustUnnamed_10 = 17;
pub const hook_PlayerCanDamage: C2RustUnnamed_10 = 16;
pub const hook_ShieldSpecial: C2RustUnnamed_10 = 15;
pub const hook_ShieldSpawn: C2RustUnnamed_10 = 14;
pub const hook_PlayerSpawn: C2RustUnnamed_10 = 13;
pub const hook_PlayerMsg: C2RustUnnamed_10 = 12;
pub const hook_BotTiccmd: C2RustUnnamed_10 = 11;
pub const hook_JumpSpinSpecial: C2RustUnnamed_10 = 10;
pub const hook_SpinSpecial: C2RustUnnamed_10 = 9;
pub const hook_AbilitySpecial: C2RustUnnamed_10 = 8;
pub const hook_JumpSpecial: C2RustUnnamed_10 = 7;
pub const hook_PostThinkFrame: C2RustUnnamed_10 = 6;
pub const hook_ThinkFrame: C2RustUnnamed_10 = 5;
pub const hook_PreThinkFrame: C2RustUnnamed_10 = 4;
pub const hook_PlayerJoin: C2RustUnnamed_10 = 3;
pub const hook_MapLoad: C2RustUnnamed_10 = 2;
pub const hook_NetVars: C2RustUnnamed_10 = 0;
#[inline]
...
static mut usemouse_cons_t: [CV_PossibleValue_t; 4] = [
    {
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Force\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut mouse2port_cons_t: [CV_PossibleValue_t; 6] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"/dev/gpmdata\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"/dev/ttyS0\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"/dev/ttyS1\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"/dev/ttyS2\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"/dev/ttyS3\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut teamscramble_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Off\0" as *const u8 as *const libc::c_char,
...
static mut startingliveslimit_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
...
static mut sleeping_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = CV_PossibleValue_s {
            value: 1000 as libc::c_int / 35 as libc::c_int,
            strvalue: b"MAX\0" as *const u8 as *const libc::c_char,
        };
        init
    },
...
static mut competitionboxes_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Normal\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Mystery\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut matchboxes_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Normal\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Unchanging\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut chances_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
static mut pause_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Server\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"All\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_showinputjoy: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"showinputjoy\0" as *const u8 as *const libc::c_char,
...
static mut cv_dummyconsvar: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"dummyconsvar\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_NOSHOWHELP as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(DummyConsvar_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_restrictskinchange: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"restrictskinchange\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_allowteamchange: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"allowteamchange\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
...
#[no_mangle]
pub static mut cv_startinglives: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"startinglives\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"3\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: startingliveslimit_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut respawntime_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_respawntime: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"respawndelay\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"3\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: respawntime_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_competitionboxes: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"competitionboxes\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Mystery\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: competitionboxes_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut seenames_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Off\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Colorless\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Team\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"Ally/Foe\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_seenames: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"seenames\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Ally/Foe\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: seenames_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_allowseenames: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"allowseenames\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_playername: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            ...
            func: Some(Name_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_playername2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"name2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Tails\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int
                | CV_NOINIT as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(Name2_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut lastgoodcolor: uint16_t = SKINCOLOR_BLUE as libc::c_int as uint16_t;
#[no_mangle]
pub static mut lastgoodcolor2: uint16_t = SKINCOLOR_BLUE as libc::c_int as uint16_t;
#[no_mangle]
pub static mut cv_playercolor: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"color\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Blue\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: Color_cons_t.as_ptr() as *mut _,
            func: Some(Color_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_playercolor2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"color2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Orange\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: Color_cons_t.as_ptr() as *mut _,
            func: Some(Color2_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_skin: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"skin\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"sonic\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(Skin_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_skin2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"skin2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"tails\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(Skin2_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_defaultplayercolor: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"defaultcolor\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Blue\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_defaultplayercolor2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"defaultcolor2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Orange\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: Color_cons_t.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_defaultskin: consvar_t = {
    let mut init = consvar_s {
        name: b"defaultskin\0" as *const u8 as *const libc::c_char,
        defaultvalue: b"sonic\0" as *const u8 as *const libc::c_char,
        flags: CV_SAVE as libc::c_int,
        PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
        func: None,
...
#[no_mangle]
pub static mut cv_defaultskin2: consvar_t = {
    let mut init = consvar_s {
        name: b"defaultskin2\0" as *const u8 as *const libc::c_char,
        defaultvalue: b"tails\0" as *const u8 as *const libc::c_char,
        flags: CV_SAVE as libc::c_int,
        PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
        func: None,
...
#[no_mangle]
pub static mut cv_skipmapcheck: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"skipmapcheck\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_debug: int32_t = 0;
#[no_mangle]
pub static mut cv_usemouse: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"use_mouse\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: usemouse_cons_t.as_ptr() as *mut _,
            func: Some(I_StartupMouse as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_usemouse2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"use_mouse2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: usemouse_cons_t.as_ptr() as *mut _,
            func: Some(I_StartupMouse2 as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_usejoystick: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"use_gamepad\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(I_InitJoystick as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_usejoystick2: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"use_gamepad2\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"2\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(I_InitJoystick2 as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_joyscale: consvar_t = {
    let mut init = consvar_s {
        name: b"padscale\0" as *const u8 as *const libc::c_char,
        defaultvalue: b"1\0" as *const u8 as *const libc::c_char,
        flags: CV_SAVE as libc::c_int | CV_HIDEN as libc::c_int,
        PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
        func: None,
        value: 0 as libc::c_int,
        string: 0 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_joyscale2: consvar_t = {
    let mut init = consvar_s {
        name: b"padscale2\0" as *const u8 as *const libc::c_char,
        defaultvalue: b"1\0" as *const u8 as *const libc::c_char,
        flags: CV_SAVE as libc::c_int | CV_HIDEN as libc::c_int,
        PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
        func: None,
...
#[no_mangle]
pub static mut cv_mouse2port: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"mouse2port\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"/dev/gpmdata\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: mouse2port_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_mouse2opt: consvar_t = {
    let mut init = consvar_s {
        name: b"mouse2opt\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_matchboxes: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"matchboxes\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Normal\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: matchboxes_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_specialrings: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"specialrings\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_powerstones: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"powerstones\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_recycler: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_recycler\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_teleporters: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_teleporter\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_superring: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_superring\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_supersneakers: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_supersneaker\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_invincibility: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_invincibility\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_jumpshield: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_jumpshield\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_watershield: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_watershield\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_ringshield: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_ringshield\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_forceshield: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_forceshield\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_bombshield: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_bombshield\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_1up: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_1up\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_eggmanbox: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"tv_eggman\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"5\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: chances_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_ringslinger: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ringslinger\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"No\0" as *const u8 as *const libc::c_char,
            flags: CV_NETVAR as libc::c_int | CV_NOSHOWHELP as libc::c_int
                | CV_CALL as libc::c_int | CV_CHEAT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
            func: Some(Ringslinger_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_gravity: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"gravity\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0.5\0" as *const u8 as *const libc::c_char,
            flags: 0 as libc::c_int | CV_FLOAT as libc::c_int | CV_CALL as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(Gravity_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_soundtest: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"soundtest\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(SoundTest_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut minitimelimit_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_countdowntime: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"countdowntime\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"60\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: minitimelimit_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_touchtag: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"touchtag\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_hidetime: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"hidetime\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"30\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: minitimelimit_cons_t.as_ptr() as *mut _,
            func: Some(Hidetime_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_autobalance: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"autobalance\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(AutoBalance_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_teamscramble: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"teamscramble\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: teamscramble_cons_t.as_ptr() as *mut _,
            func: Some(TeamScramble_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_scrambleonchange: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"scrambleonchange\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: teamscramble_cons_t.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_friendlyfire: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"friendlyfire\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_itemfinder: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"itemfinder\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(ItemFinder_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_overtime: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"overtime\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_rollingdemos: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"rollingdemos\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
static mut timetic_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Classic\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Centiseconds\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Mania\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"Tics\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_timetic: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"timerres\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Classic\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: timetic_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut powerupdisplay_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Never\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"First-person only\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Always\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_powerupdisplay: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"powerupdisplay\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"First-person only\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: powerupdisplay_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut pointlimit_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_pointlimit: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"pointlimit\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"None\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: pointlimit_cons_t.as_ptr() as *mut _,
            func: Some(PointLimit_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut timelimit_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_timelimit: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"timelimit\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"None\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_NOINIT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: timelimit_cons_t.as_ptr() as *mut _,
            func: Some(TimeLimit_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut numlaps_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_numlaps: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"numlaps\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"4\0" as *const u8 as *const libc::c_char,
            flags: CV_NETVAR as libc::c_int | CV_CALL as libc::c_int
                | CV_NOINIT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: numlaps_cons_t.as_ptr() as *mut _,
            func: Some(NumLaps_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut basenumlaps_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Map default\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_basenumlaps: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"basenumlaps\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Map default\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_CHEAT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: basenumlaps_cons_t.as_ptr() as *mut _,
            func: Some(BaseNumLaps_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut pointlimits: [int32_t; 136] = [0; 136];
#[no_mangle]
pub static mut timelimits: [int32_t; 136] = [0; 136];
#[no_mangle]
pub static mut cv_hazardlog: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"hazardlog\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_forceskin: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"forceskin\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"None\0" as *const u8 as *const libc::c_char,
            flags: CV_NETVAR as libc::c_int | CV_CALL as libc::c_int
                | CV_CHEAT as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
            func: Some(ForceSkin_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_downloading: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"downloading\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: 0 as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_allowexitlevel: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"allowexitlevel\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"No\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
...
#[no_mangle]
pub static mut cv_killingdead: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"killingdead\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_NETVAR as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_netstat: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"netstat\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: 0 as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
static mut nettimeout_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 35 as libc::c_int / 7 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 60 as libc::c_int * 35 as libc::c_int,
            strvalue: b"MAX\0" as *const u8 as *const libc::c_char,
        };
        init
    },
...
#[no_mangle]
pub static mut cv_nettimeout: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"nettimeout\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"350\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_SAVE as libc::c_int,
            PossibleValue: nettimeout_cons_t.as_ptr() as *mut _,
            func: Some(NetTimeout_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut jointimeout_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 5 as libc::c_int * 35 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
        };
        init
    },
...
#[no_mangle]
pub static mut cv_jointimeout: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"jointimeout\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"350\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int | CV_SAVE as libc::c_int
                | CV_NETVAR as libc::c_int,
            PossibleValue: jointimeout_cons_t.as_ptr() as *mut _,
            func: Some(JoinTimeout_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_maxping: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"maxping\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int,
...
static mut pingtimeout_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
...
#[no_mangle]
pub static mut cv_pingtimeout: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"pingtimeout\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int,
            PossibleValue: pingtimeout_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut showping_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Off\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Warning\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_showping: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"showping\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Warning\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: showping_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut inttime_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_inttime: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"inttime\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: inttime_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut coopstarposts_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Per-player\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Shared\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Teamwork\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_coopstarposts: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"coopstarposts\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Per-player\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: coopstarposts_cons_t.as_ptr() as *mut _,
            func: Some(CoopStarposts_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut cooplives_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Avoid Game Over\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"Single pool\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_cooplives: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"cooplives\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Avoid Game Over\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_CHEAT as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: cooplives_cons_t.as_ptr() as *mut _,
            func: Some(CoopLives_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut advancemap_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Off\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Next\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_advancemap: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"advancemap\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Next\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: advancemap_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut playersforexit_cons_t: [CV_PossibleValue_t; 6] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"1/4\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Half\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"3/4\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_playersforexit: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"playersforexit\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"All\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: playersforexit_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_exitmove: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"exitmove\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"On\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_CALL as libc::c_int | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(ExitMove_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_runscripts: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"runscripts\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Yes\0" as *const u8 as *const libc::c_char,
            flags: CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_YesNo.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_pause: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"pausepermission\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Server\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_NETVAR as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: pause_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_mute: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"mute\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_NETVAR as libc::c_int | CV_CALL as libc::c_int
                | CV_ALLOWLUA as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: Some(Mute_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_sleep: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"cpusleep\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: sleeping_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut perfstats_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Off\0" as *const u8 as *const libc::c_char,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Rendering\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Logic\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"ThinkFrame\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_perfstats: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"perfstats\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int,
            PossibleValue: perfstats_cons_t.as_ptr() as *mut _,
            func: Some(PS_PerfStats_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut ps_samplesize_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_ps_samplesize: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ps_samplesize\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1\0" as *const u8 as *const libc::c_char,
            flags: CV_CALL as libc::c_int,
            PossibleValue: ps_samplesize_cons_t.as_ptr() as *mut _,
            func: Some(PS_SampleSize_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut ps_descriptor_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Average\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"SD\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"Minimum\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 4 as libc::c_int,
            strvalue: b"Maximum\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_ps_descriptor: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ps_descriptor\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Average\0" as *const u8 as *const libc::c_char,
            flags: 0 as libc::c_int,
            PossibleValue: ps_descriptor_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_freedemocamera: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"freedemocamera\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Off\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: CV_OnOff.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut timedemo_name: [libc::c_char; 256] = [0; 256];
#[no_mangle]
pub static mut timedemo_csv: boolean = 0;
#[no_mangle]
pub static mut timedemo_csv_id: [libc::c_char; 256] = [0; 256];
#[no_mangle]
pub static mut timedemo_quit: boolean = 0;
#[no_mangle]
pub static mut gametype: int16_t = GT_COOP as libc::c_int as int16_t;
#[no_mangle]
pub static mut gametyperules: uint32_t = 0 as libc::c_int as uint32_t;
#[no_mangle]
pub static mut gametypecount: int16_t = (GT_CTF as libc::c_int + 1 as libc::c_int)
    as int16_t;
#[no_mangle]
pub static mut splitscreen: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut circuitmap: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut adminplayers: [int32_t; 32] = [0; 32];
#[no_mangle]
pub static mut netxcmdnames: [*const libc::c_char; 24] = [
    b"NAMEANDCOLOR\0" as *const u8 as *const libc::c_char,
    b"WEAPONPREF\0" as *const u8 as *const libc::c_char,
    b"KICK\0" as *const u8 as *const libc::c_char,
    b"NETVAR\0" as *const u8 as *const libc::c_char,
    b"SAY\0" as *const u8 as *const libc::c_char,
    b"MAP\0" as *const u8 as *const libc::c_char,
    b"EXITLEVEL\0" as *const u8 as *const libc::c_char,
    b"ADDFILE\0" as *const u8 as *const libc::c_char,
    b"ADDFOLDER\0" as *const u8 as *const libc::c_char,
    b"PAUSE\0" as *const u8 as *const libc::c_char,
    b"ADDPLAYER\0" as *const u8 as *const libc::c_char,
    b"TEAMCHANGE\0" as *const u8 as *const libc::c_char,
    b"CLEARSCORES\0" as *const u8 as *const libc::c_char,
    b"VERIFIED\0" as *const u8 as *const libc::c_char,
    b"RANDOMSEED\0" as *const u8 as *const libc::c_char,
    b"RUNSOC\0" as *const u8 as *const libc::c_char,
    b"REQADDFILE\0" as *const u8 as *const libc::c_char,
    b"REQADDFOLDER\0" as *const u8 as *const libc::c_char,
    b"SETMOTD\0" as *const u8 as *const libc::c_char,
    b"SUICIDE\0" as *const u8 as *const libc::c_char,
    b"LUACMD\0" as *const u8 as *const libc::c_char,
    b"LUAVAR\0" as *const u8 as *const libc::c_char,
    b"LUAFILE\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
#[no_mangle]
pub unsafe extern "C" fn D_RegisterServerCommands() {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < NUMGAMETYPES as libc::c_int {
    ...
    *fresh1 = 0 as *const libc::c_char;
    RegisterNetXCmd(
        XD_NAMEANDCOLOR,
        Some(Got_NameAndColor as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_WEAPONPREF,
        Some(Got_WeaponPref as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_MAP,
        Some(Got_Mapcmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_EXITLEVEL,
        Some(Got_ExitLevelcmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_ADDFILE,
        Some(Got_Addfilecmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_ADDFOLDER,
        Some(Got_Addfoldercmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_REQADDFILE,
        Some(
            Got_RequestAddfilecmd
                as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> (),
        ),
    );
    RegisterNetXCmd(
        XD_REQADDFOLDER,
        Some(
            Got_RequestAddfoldercmd
                as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> (),
        ),
    );
    RegisterNetXCmd(
        XD_PAUSE,
        Some(Got_Pause as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_SUICIDE,
        Some(Got_Suicide as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_RUNSOC,
        Some(Got_RunSOCcmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_LUACMD,
        Some(Got_Luacmd as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_LUAFILE,
        Some(Got_LuaFile as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    COM_AddCommand(
        b"password\0" as *const u8 as *const libc::c_char,
        Some(Command_Changepassword_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"login\0" as *const u8 as *const libc::c_char,
        Some(Command_Login_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"promote\0" as *const u8 as *const libc::c_char,
        Some(Command_Verify_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    RegisterNetXCmd(
        XD_VERIFIED,
        Some(Got_Verification as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    COM_AddCommand(
        b"demote\0" as *const u8 as *const libc::c_char,
        Some(Command_RemoveAdmin_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    RegisterNetXCmd(
        XD_DEMOTED,
        Some(Got_Removal as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    COM_AddCommand(
        b"motd\0" as *const u8 as *const libc::c_char,
        Some(Command_MotD_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    RegisterNetXCmd(
        XD_SETMOTD,
        Some(Got_MotD_f as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    RegisterNetXCmd(
        XD_TEAMCHANGE,
        Some(Got_Teamchange as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    COM_AddCommand(
        b"serverchangeteam\0" as *const u8 as *const libc::c_char,
        Some(Command_ServerTeamChange_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    RegisterNetXCmd(
        XD_CLEARSCORES,
        Some(Got_Clearscores as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    COM_AddCommand(
        b"clearscores\0" as *const u8 as *const libc::c_char,
        Some(Command_Clearscores_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"map\0" as *const u8 as *const libc::c_char,
        Some(Command_Map_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"exitgame\0" as *const u8 as *const libc::c_char,
        Some(Command_ExitGame_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"retry\0" as *const u8 as *const libc::c_char,
        Some(Command_Retry_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"exitlevel\0" as *const u8 as *const libc::c_char,
        Some(Command_ExitLevel_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"showmap\0" as *const u8 as *const libc::c_char,
        Some(Command_Showmap_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"mapmd5\0" as *const u8 as *const libc::c_char,
        Some(Command_Mapmd5_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"addfolder\0" as *const u8 as *const libc::c_char,
        Some(Command_Addfolder as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"addfile\0" as *const u8 as *const libc::c_char,
        Some(Command_Addfile as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"listwad\0" as *const u8 as *const libc::c_char,
        Some(Command_ListWADS_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"runsoc\0" as *const u8 as *const libc::c_char,
        Some(Command_RunSOC as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"pause\0" as *const u8 as *const libc::c_char,
        Some(Command_Pause as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"suicide\0" as *const u8 as *const libc::c_char,
        Some(Command_Suicide as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"gametype\0" as *const u8 as *const libc::c_char,
        Some(Command_ShowGametype_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"version\0" as *const u8 as *const libc::c_char,
        Some(Command_Version_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"mod_details\0" as *const u8 as *const libc::c_char,
        Some(Command_ModDetails_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        ...
        ::core::mem::transmute::<
            ...
            com_func_t,
        >(Some(Command_Quit_f as unsafe extern "C" fn() -> !)),
        COM_LUA,
    );
    COM_AddCommand(
        b"saveconfig\0" as *const u8 as *const libc::c_char,
        Some(Command_SaveConfig_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"loadconfig\0" as *const u8 as *const libc::c_char,
        Some(Command_LoadConfig_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"changeconfig\0" as *const u8 as *const libc::c_char,
        Some(Command_ChangeConfig_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"isgamemodified\0" as *const u8 as *const libc::c_char,
        Some(Command_Isgamemodified_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"showscores\0" as *const u8 as *const libc::c_char,
        Some(Command_ShowScores_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"showtime\0" as *const u8 as *const libc::c_char,
        Some(Command_ShowTime_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"cheats\0" as *const u8 as *const libc::c_char,
        Some(Command_Cheats_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"downloads\0" as *const u8 as *const libc::c_char,
        Some(Command_Downloads_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    AddMServCommands();
    CV_RegisterVar(&mut cv_itemrespawntime);
    CV_RegisterVar(&mut cv_itemrespawn);
    CV_RegisterVar(&mut cv_flagtime);
    CV_RegisterVar(&mut cv_friendlyfire);
    CV_RegisterVar(&mut cv_pointlimit);
    CV_RegisterVar(&mut cv_numlaps);
    CV_RegisterVar(&mut cv_basenumlaps);
    CV_RegisterVar(&mut cv_hazardlog);
    CV_RegisterVar(&mut cv_autobalance);
    CV_RegisterVar(&mut cv_teamscramble);
    CV_RegisterVar(&mut cv_scrambleonchange);
    CV_RegisterVar(&mut cv_touchtag);
    CV_RegisterVar(&mut cv_hidetime);
    CV_RegisterVar(&mut cv_inttime);
    CV_RegisterVar(&mut cv_advancemap);
    CV_RegisterVar(&mut cv_playersforexit);
    CV_RegisterVar(&mut cv_exitmove);
    CV_RegisterVar(&mut cv_timelimit);
    CV_RegisterVar(&mut cv_playbackspeed);
    CV_RegisterVar(&mut cv_forceskin);
    CV_RegisterVar(&mut cv_downloading);
    CV_RegisterVar(&mut cv_coopstarposts);
    CV_RegisterVar(&mut cv_cooplives);
    CV_RegisterVar(&mut cv_specialrings);
    CV_RegisterVar(&mut cv_powerstones);
    CV_RegisterVar(&mut cv_competitionboxes);
    CV_RegisterVar(&mut cv_matchboxes);
    CV_RegisterVar(&mut cv_recycler);
    CV_RegisterVar(&mut cv_teleporters);
    CV_RegisterVar(&mut cv_superring);
    CV_RegisterVar(&mut cv_supersneakers);
    CV_RegisterVar(&mut cv_invincibility);
    CV_RegisterVar(&mut cv_jumpshield);
    CV_RegisterVar(&mut cv_watershield);
    CV_RegisterVar(&mut cv_ringshield);
    CV_RegisterVar(&mut cv_forceshield);
    CV_RegisterVar(&mut cv_bombshield);
    CV_RegisterVar(&mut cv_1up);
    CV_RegisterVar(&mut cv_eggmanbox);
    CV_RegisterVar(&mut cv_ringslinger);
    CV_RegisterVar(&mut cv_startinglives);
    CV_RegisterVar(&mut cv_countdowntime);
    CV_RegisterVar(&mut cv_runscripts);
    CV_RegisterVar(&mut cv_overtime);
    CV_RegisterVar(&mut cv_pause);
    CV_RegisterVar(&mut cv_mute);
    RegisterNetXCmd(
        XD_RANDOMSEED,
        Some(Got_RandomSeed as unsafe extern "C" fn(*mut *mut uint8_t, int32_t) -> ()),
    );
    CV_RegisterVar(&mut cv_allowexitlevel);
    CV_RegisterVar(&mut cv_restrictskinchange);
    CV_RegisterVar(&mut cv_allowteamchange);
    CV_RegisterVar(&mut cv_respawntime);
    CV_RegisterVar(&mut cv_killingdead);
    CV_RegisterVar(&mut cv_maxplayers);
    CV_RegisterVar(&mut cv_joindelay);
    CV_RegisterVar(&mut cv_rejointimeout);
    CV_RegisterVar(&mut cv_resynchattempts);
    CV_RegisterVar(&mut cv_maxsend);
    CV_RegisterVar(&mut cv_noticedownload);
    CV_RegisterVar(&mut cv_downloadspeed);
    CV_RegisterVar(&mut cv_allownewplayer);
    CV_RegisterVar(&mut cv_joinnextround);
    CV_RegisterVar(&mut cv_showjoinaddress);
    CV_RegisterVar(&mut cv_blamecfail);
    CV_RegisterVar(&mut cv_dedicatedidletime);
    COM_AddCommand(
        b"ping\0" as *const u8 as *const libc::c_char,
        Some(Command_Ping_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    CV_RegisterVar(&mut cv_nettimeout);
    CV_RegisterVar(&mut cv_jointimeout);
    CV_RegisterVar(&mut cv_skipmapcheck);
    CV_RegisterVar(&mut cv_sleep);
    CV_RegisterVar(&mut cv_maxping);
    CV_RegisterVar(&mut cv_pingtimeout);
    CV_RegisterVar(&mut cv_showping);
    CV_RegisterVar(&mut cv_allowseenames);
    CV_RegisterVar(&mut cv_addons_option);
    CV_RegisterVar(&mut cv_addons_folder);
    CV_RegisterVar(&mut cv_dummyconsvar);
}
#[no_mangle]
pub unsafe extern "C" fn D_RegisterClientCommands() {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < MAXSKINCOLORS as libc::c_int {
        (*Color_cons_t.as_mut_ptr().offset(i as isize)).value = i;
        let ref mut fresh2 = (*Color_cons_t.as_mut_ptr().offset(i as isize)).strvalue;
        *fresh2 = (skincolors[i as usize].name).as_mut_ptr();
        i += 1;
        i;
    }
    (*Color_cons_t.as_mut_ptr().offset(MAXSKINCOLORS as libc::c_int as isize))
        .value = 0 as libc::c_int;
    let ref mut fresh3 = (*Color_cons_t
        .as_mut_ptr()
        .offset(MAXSKINCOLORS as libc::c_int as isize))
        .strvalue;
    *fresh3 = 0 as *const libc::c_char;
    ...
    COM_AddCommand(
        b"numthinkers\0" as *const u8 as *const libc::c_char,
        Some(Command_Numthinkers_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"countmobjs\0" as *const u8 as *const libc::c_char,
        Some(Command_CountMobjs_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"changeteam\0" as *const u8 as *const libc::c_char,
        Some(Command_Teamchange_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"changeteam2\0" as *const u8 as *const libc::c_char,
        Some(Command_Teamchange2_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"playdemo\0" as *const u8 as *const libc::c_char,
        Some(Command_Playdemo_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"timedemo\0" as *const u8 as *const libc::c_char,
        Some(Command_Timedemo_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"stopdemo\0" as *const u8 as *const libc::c_char,
        Some(Command_Stopdemo_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"playintro\0" as *const u8 as *const libc::c_char,
        Some(Command_Playintro_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"resetcamera\0" as *const u8 as *const libc::c_char,
        Some(Command_ResetCamera_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"setcontrol\0" as *const u8 as *const libc::c_char,
        Some(Command_Setcontrol_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"setcontrol2\0" as *const u8 as *const libc::c_char,
        Some(Command_Setcontrol2_f as unsafe extern "C" fn() -> ()),
        0 as com_flags_t,
    );
    COM_AddCommand(
        b"screenshot\0" as *const u8 as *const libc::c_char,
        Some(M_ScreenShot as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"startmovie\0" as *const u8 as *const libc::c_char,
        Some(Command_StartMovie_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"stopmovie\0" as *const u8 as *const libc::c_char,
        Some(Command_StopMovie_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    CV_RegisterVar(&mut cv_screenshot_option);
    CV_RegisterVar(&mut cv_screenshot_folder);
    CV_RegisterVar(&mut cv_screenshot_colorprofile);
    CV_RegisterVar(&mut cv_moviemode);
    CV_RegisterVar(&mut cv_movie_option);
    CV_RegisterVar(&mut cv_movie_folder);
    CV_RegisterVar(&mut cv_zlib_level);
    CV_RegisterVar(&mut cv_zlib_memory);
    CV_RegisterVar(&mut cv_zlib_strategy);
    CV_RegisterVar(&mut cv_zlib_window_bits);
    CV_RegisterVar(&mut cv_zlib_levela);
    CV_RegisterVar(&mut cv_zlib_memorya);
    CV_RegisterVar(&mut cv_zlib_strategya);
    CV_RegisterVar(&mut cv_zlib_window_bitsa);
    CV_RegisterVar(&mut cv_apng_delay);
    CV_RegisterVar(&mut cv_apng_downscale);
    CV_RegisterVar(&mut cv_gif_optimize);
    CV_RegisterVar(&mut cv_gif_downscale);
    CV_RegisterVar(&mut cv_gif_dynamicdelay);
    CV_RegisterVar(&mut cv_gif_localcolortable);
    CV_RegisterVar(&mut cv_playername);
    CV_RegisterVar(&mut cv_playercolor);
    CV_RegisterVar(&mut cv_skin);
    CV_RegisterVar(&mut cv_playername2);
    CV_RegisterVar(&mut cv_playercolor2);
    CV_RegisterVar(&mut cv_skin2);
    CV_RegisterVar(&mut cv_defaultplayercolor);
    CV_RegisterVar(&mut cv_defaultskin);
    CV_RegisterVar(&mut cv_defaultplayercolor2);
    CV_RegisterVar(&mut cv_defaultskin2);
    CV_RegisterVar(&mut cv_seenames);
    CV_RegisterVar(&mut cv_rollingdemos);
    CV_RegisterVar(&mut cv_netstat);
    CV_RegisterVar(&mut cv_netticbuffer);
    CV_RegisterVar(&mut cv_timetic);
    CV_RegisterVar(&mut cv_powerupdisplay);
    CV_RegisterVar(&mut cv_itemfinder);
    CV_RegisterVar(&mut cv_showinputjoy);
    CV_RegisterVar(&mut cv_ghost_bestscore);
    CV_RegisterVar(&mut cv_ghost_besttime);
    CV_RegisterVar(&mut cv_ghost_bestrings);
    CV_RegisterVar(&mut cv_ghost_last);
    CV_RegisterVar(&mut cv_ghost_guest);
    COM_AddCommand(
        b"displayplayer\0" as *const u8 as *const libc::c_char,
        Some(Command_Displayplayer_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    CV_RegisterVar(&mut cv_globalgamma);
    CV_RegisterVar(&mut cv_globalsaturation);
    CV_RegisterVar(&mut cv_rhue);
    CV_RegisterVar(&mut cv_yhue);
    CV_RegisterVar(&mut cv_ghue);
    CV_RegisterVar(&mut cv_chue);
    CV_RegisterVar(&mut cv_bhue);
    CV_RegisterVar(&mut cv_mhue);
    CV_RegisterVar(&mut cv_rgamma);
    CV_RegisterVar(&mut cv_ygamma);
    CV_RegisterVar(&mut cv_ggamma);
    CV_RegisterVar(&mut cv_cgamma);
    CV_RegisterVar(&mut cv_bgamma);
    CV_RegisterVar(&mut cv_mgamma);
    CV_RegisterVar(&mut cv_rsaturation);
    CV_RegisterVar(&mut cv_ysaturation);
    CV_RegisterVar(&mut cv_gsaturation);
    CV_RegisterVar(&mut cv_csaturation);
    CV_RegisterVar(&mut cv_bsaturation);
    CV_RegisterVar(&mut cv_msaturation);
    CV_RegisterVar(&mut cv_compactscoreboard);
    CV_RegisterVar(&mut cv_chatheight);
    CV_RegisterVar(&mut cv_chatwidth);
    CV_RegisterVar(&mut cv_chattime);
    CV_RegisterVar(&mut cv_chatspamprotection);
    CV_RegisterVar(&mut cv_chatbacktint);
    CV_RegisterVar(&mut cv_consolechat);
    CV_RegisterVar(&mut cv_chatnotifications);
    CV_RegisterVar(&mut cv_crosshair);
    CV_RegisterVar(&mut cv_crosshair2);
    CV_RegisterVar(&mut cv_alwaysfreelook);
    CV_RegisterVar(&mut cv_alwaysfreelook2);
    CV_RegisterVar(&mut cv_chasefreelook);
    CV_RegisterVar(&mut cv_chasefreelook2);
    CV_RegisterVar(&mut cv_tutorialprompt);
    CV_RegisterVar(&mut cv_showfocuslost);
    CV_RegisterVar(&mut cv_pauseifunfocused);
    CV_RegisterVar(&mut cv_instantretry);
    CV_RegisterVar(&mut cv_sideaxis);
    CV_RegisterVar(&mut cv_sideaxis2);
    CV_RegisterVar(&mut cv_turnaxis);
    CV_RegisterVar(&mut cv_turnaxis2);
    CV_RegisterVar(&mut cv_moveaxis);
    CV_RegisterVar(&mut cv_moveaxis2);
    CV_RegisterVar(&mut cv_lookaxis);
    CV_RegisterVar(&mut cv_lookaxis2);
    CV_RegisterVar(&mut cv_jumpaxis);
    CV_RegisterVar(&mut cv_jumpaxis2);
    CV_RegisterVar(&mut cv_spinaxis);
    CV_RegisterVar(&mut cv_spinaxis2);
    CV_RegisterVar(&mut cv_fireaxis);
    CV_RegisterVar(&mut cv_fireaxis2);
    CV_RegisterVar(&mut cv_firenaxis);
    CV_RegisterVar(&mut cv_firenaxis2);
    CV_RegisterVar(&mut cv_deadzone);
    CV_RegisterVar(&mut cv_deadzone2);
    CV_RegisterVar(&mut cv_digitaldeadzone);
    CV_RegisterVar(&mut cv_digitaldeadzone2);
    CV_RegisterVar(&mut cv_addons_md5);
    CV_RegisterVar(&mut cv_addons_showall);
    CV_RegisterVar(&mut cv_addons_search_type);
    CV_RegisterVar(&mut cv_addons_search_case);
    CV_RegisterVar(&mut cv_mouse2port);
    CV_RegisterVar(&mut cv_mouse2opt);
    CV_RegisterVar(&mut cv_controlperkey);
    CV_RegisterVar(&mut cv_usemouse);
    CV_RegisterVar(&mut cv_usemouse2);
    CV_RegisterVar(&mut cv_invertmouse);
    CV_RegisterVar(&mut cv_invertmouse2);
    CV_RegisterVar(&mut cv_mousesens);
    CV_RegisterVar(&mut cv_mousesens2);
    CV_RegisterVar(&mut cv_mouseysens);
    CV_RegisterVar(&mut cv_mouseysens2);
    CV_RegisterVar(&mut cv_mousemove);
    CV_RegisterVar(&mut cv_mousemove2);
    CV_RegisterVar(&mut cv_usejoystick);
    CV_RegisterVar(&mut cv_usejoystick2);
    CV_RegisterVar(&mut cv_joyscale);
    CV_RegisterVar(&mut cv_joyscale2);
    CV_RegisterVar(&mut *cv_analog.as_mut_ptr().offset(0 as libc::c_int as isize));
    CV_RegisterVar(&mut *cv_analog.as_mut_ptr().offset(1 as libc::c_int as isize));
    CV_RegisterVar(&mut *cv_useranalog.as_mut_ptr().offset(0 as libc::c_int as isize));
    CV_RegisterVar(&mut *cv_useranalog.as_mut_ptr().offset(1 as libc::c_int as isize));
    CV_RegisterVar(
    ...
    CV_RegisterVar(&mut cv_autobrake);
    CV_RegisterVar(&mut cv_autobrake2);
    CV_RegisterVar(
        &mut *cv_cam_shiftfacing.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_shiftfacing.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacing.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacing.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacingability.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacingability.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacingspindash.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacingspindash.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacinginput.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_turnfacinginput.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_centertoggle.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_centertoggle.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_lockedinput.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_lockedinput.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_lockonboss.as_mut_ptr().offset(0 as libc::c_int as isize),
    );
    CV_RegisterVar(
        &mut *cv_cam_lockonboss.as_mut_ptr().offset(1 as libc::c_int as isize),
    );
    CV_RegisterVar(&mut cv_soundvolume);
    CV_RegisterVar(&mut cv_closedcaptioning);
    CV_RegisterVar(&mut cv_digmusicvolume);
    CV_RegisterVar(&mut cv_midimusicvolume);
    CV_RegisterVar(&mut cv_numChannels);
    CV_RegisterVar(&mut cv_fullscreen);
    CV_RegisterVar(&mut cv_renderview);
    CV_RegisterVar(&mut cv_renderhitboxinterpolation);
    CV_RegisterVar(&mut cv_renderhitboxgldepth);
    CV_RegisterVar(&mut cv_renderhitbox);
    CV_RegisterVar(&mut cv_renderer);
    CV_RegisterVar(&mut cv_scr_depth);
    CV_RegisterVar(&mut cv_scr_width);
    CV_RegisterVar(&mut cv_scr_height);
    CV_RegisterVar(&mut cv_scr_width_w);
    CV_RegisterVar(&mut cv_scr_height_w);
    CV_RegisterVar(&mut cv_soundtest);
    CV_RegisterVar(&mut cv_perfstats);
    CV_RegisterVar(&mut cv_ps_samplesize);
    CV_RegisterVar(&mut cv_ps_descriptor);
    COM_AddCommand(
        b"objectplace\0" as *const u8 as *const libc::c_char,
        Some(Command_ObjectPlace_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    CV_RegisterVar(&mut cv_speed);
    CV_RegisterVar(&mut cv_opflags);
    CV_RegisterVar(&mut cv_ophoopflags);
    CV_RegisterVar(&mut cv_mapthingnum);
    CV_RegisterVar(&mut cv_freedemocamera);
    COM_AddCommand(
        b"noclip\0" as *const u8 as *const libc::c_char,
        Some(Command_CheatNoClip_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"god\0" as *const u8 as *const libc::c_char,
        Some(Command_CheatGod_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"notarget\0" as *const u8 as *const libc::c_char,
        Some(Command_CheatNoTarget_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"getallemeralds\0" as *const u8 as *const libc::c_char,
        Some(Command_Getallemeralds_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"resetemeralds\0" as *const u8 as *const libc::c_char,
        Some(Command_Resetemeralds_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"setrings\0" as *const u8 as *const libc::c_char,
        Some(Command_Setrings_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"setlives\0" as *const u8 as *const libc::c_char,
        Some(Command_Setlives_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"setcontinues\0" as *const u8 as *const libc::c_char,
        Some(Command_Setcontinues_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"devmode\0" as *const u8 as *const libc::c_char,
        Some(Command_Devmode_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"savecheckpoint\0" as *const u8 as *const libc::c_char,
        Some(Command_Savecheckpoint_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"scale\0" as *const u8 as *const libc::c_char,
        Some(Command_Scale_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"gravflip\0" as *const u8 as *const libc::c_char,
        Some(Command_Gravflip_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"hurtme\0" as *const u8 as *const libc::c_char,
        Some(Command_Hurtme_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"jumptoaxis\0" as *const u8 as *const libc::c_char,
        Some(Command_JumpToAxis_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"charability\0" as *const u8 as *const libc::c_char,
        Some(Command_Charability_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"charspeed\0" as *const u8 as *const libc::c_char,
        Some(Command_Charspeed_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"teleport\0" as *const u8 as *const libc::c_char,
        Some(Command_Teleport_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"rteleport\0" as *const u8 as *const libc::c_char,
        Some(Command_RTeleport_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"skynum\0" as *const u8 as *const libc::c_char,
        Some(Command_Skynum_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"weather\0" as *const u8 as *const libc::c_char,
        Some(Command_Weather_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
    COM_AddCommand(
        b"toggletwod\0" as *const u8 as *const libc::c_char,
        Some(Command_Toggletwod_f as unsafe extern "C" fn() -> ()),
        COM_LUA,
    );
}
#[no_mangle]
pub unsafe extern "C" fn EnsurePlayerNameIsGood(
    mut name: *mut libc::c_char,
    mut playernum: int32_t,
) -> boolean {
    let mut ix: int32_t = 0;
    if strlen(name) == 0 as libc::c_int as libc::c_ulong
        || strlen(name) > 21 as libc::c_int as libc::c_ulong
    {
    ...
    if *(*__ctype_b_loc())
        .offset(*name.offset(0 as libc::c_int as isize) as libc::c_int as isize)
    ...
    ix = 0 as libc::c_int;
    while *name.offset(ix as isize) as libc::c_int != '\0' as i32 {
        if *(*__ctype_b_loc()).offset(*name.offset(ix as isize) as libc::c_int as isize)
            as libc::c_int & _ISprint as libc::c_int as libc::c_ushort as libc::c_int
            == 0 || *name.offset(ix as isize) as libc::c_int == ';' as i32
            || *name.offset(ix as isize) as uint8_t as libc::c_int >= 0x80 as libc::c_int
        {
            return false_0 as libc::c_int;
        }
        ix += 1;
    ...
    while ix < 32 as libc::c_int {
        if ix != playernum && playeringame[ix as usize] != 0
            && strcasecmp(name, (player_names[ix as usize]).as_mut_ptr())
                == 0 as libc::c_int
        {
            ...
            if len > 1 as libc::c_int as size_t {
                *name
                ...
                if EnsurePlayerNameIsGood(name, playernum) == 0 {
                    return false_0 as libc::c_int;
                }
...
#[no_mangle]
pub unsafe extern "C" fn CleanupPlayerName(
    mut playernum: int32_t,
    ...
    let mut i: int32_t = 0;
    let mut namefailed: boolean = true_0 as libc::c_int;
            ...
            & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int != 0)
        {
            if !(*p as libc::c_int == '@' as i32 || *p as libc::c_int == '~' as i32) {
                ...
                while !(*(*__ctype_b_loc()).offset(*p as libc::c_int as isize)
                    ...
                    || *p as uint8_t as libc::c_int >= 0x80 as libc::c_int)
                {
                    p = p.offset(1);
                    if !(*p != 0) {
                        break;
                        ...
                        .offset(
                            ((strlen
                                as unsafe extern "C" fn(
                                    *const libc::c_char,
                                ) -> libc::c_ulong)(tmpname))
                                .wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize,
                        ) as *mut libc::c_char;
                    while *p as libc::c_int == ' ' as i32 && p >= tmpname {
                        *p = '\0' as i32 as libc::c_char;
                        p = p.offset(-1);
                        p;
                    }
                    if !(strlen(tmpname) == 0 as libc::c_int as libc::c_ulong) {
                        if strlen(tmpname) > 21 as libc::c_int as libc::c_ulong {
                            *tmpname
                                .offset(
                        ...
                        i = 0 as libc::c_int;
                        while i < 32 as libc::c_int {
                            if i != playernum && playeringame[i as usize] != 0
                                && strcasecmp(
                                    tmpname,
                                    (player_names[i as usize]).as_mut_ptr(),
                                ) == 0 as libc::c_int
                        ...
                        if !(i < 32 as libc::c_int) {
                            namefailed = false_0 as libc::c_int;
                        }
                    }
                }
            }
    ...
    if namefailed != 0 {
        tmpname = (player_names[playernum as usize]).as_mut_ptr();
    }
    if playernum == consoleplayer {
        CV_StealthSet(&mut cv_playername, tmpname);
    } else if playernum == secondarydisplayplayer
        || netgame == 0 && playernum == 1 as libc::c_int
    {
        CV_StealthSet(&mut cv_playername2, tmpname);
    }
    Z_Free(buf as *mut libc::c_void);
}
unsafe extern "C" fn SetPlayerName(
    mut playernum: int32_t,
    mut newname: *mut libc::c_char,
) {
    if EnsurePlayerNameIsGood(newname, playernum) != 0 {
        if strcasecmp(newname, (player_names[playernum as usize]).as_mut_ptr())
            != 0 as libc::c_int
        {
            if netgame != 0 {
                HU_AddChatText(
                    va(
                        b"\x82*%s renamed to %s\0" as *const u8 as *const libc::c_char,
            ...
            player_name_changes[playernum as usize] += 1;
            player_name_changes[playernum as usize];
            strcpy((player_names[playernum as usize]).as_mut_ptr(), newname);
        }
    } else {
        CONS_Printf(
            b"Player %d sent a bad name change\n\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn CanChangeSkin(mut playernum: int32_t) -> uint8_t {
    if Playing() == 0 || addedtogame == 0 {
        return true_0 as libc::c_int as uint8_t;
    }
    if cv_forceskin.value != -(1 as libc::c_int)
    ...
    if cv_restrictskinchange.value != 0 {
        ...
        if G_TagGametype() != 0 {
            ...
            if players[playernum as usize].pflags as libc::c_uint
        ...
        if players[playernum as usize].spectator != 0
            || players[playernum as usize].playerstate as libc::c_uint
...
unsafe extern "C" fn ForceAllSkins(mut forcedskin: int32_t) {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0) {
            ...
            if dedicated == 0 {
                if i == consoleplayer {
                    CV_StealthSet(
                        &mut cv_skin,
                        (skins[forcedskin as usize].name).as_mut_ptr(),
                    );
...
static mut snacpending: int32_t = 0 as libc::c_int;
static mut snac2pending: int32_t = 0 as libc::c_int;
static mut chmappending: int32_t = 0 as libc::c_int;
unsafe extern "C" fn SendNameAndColor() {
    let mut buf: [libc::c_char; 27] = [0; 27];
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    p = buf.as_mut_ptr();
    if G_GametypeHasTeams() != 0 {
        if players[consoleplayer as usize].ctfteam == 1 as libc::c_int
            && cv_playercolor.value != skincolor_redteam as libc::c_int
        {
            CV_StealthSetValue(&mut cv_playercolor, skincolor_redteam as int32_t);
        } else if players[consoleplayer as usize].ctfteam == 2 as libc::c_int
            && cv_playercolor.value != skincolor_blueteam as libc::c_int
        {
            CV_StealthSetValue(&mut cv_playercolor, skincolor_blueteam as int32_t);
        }
    }
    if skincolors[cv_playercolor.value as usize].accessible == 0 {
        if players[consoleplayer as usize].skincolor as libc::c_int != 0
            && skincolors[players[consoleplayer as usize].skincolor as usize].accessible
                != 0
        {
            CV_StealthSetValue(
                &mut cv_playercolor,
                players[consoleplayer as usize].skincolor as int32_t,
            );
        } else if skincolors[atoi(cv_playercolor.defaultvalue) as usize].accessible != 0
        {
            CV_StealthSet(&mut cv_playercolor, cv_playercolor.defaultvalue);
        } else if skins[players[consoleplayer as usize].skin as usize].prefcolor
            as libc::c_int != 0
            && skincolors[skins[players[consoleplayer as usize].skin as usize].prefcolor
                    as usize]
                .accessible != 0
        {
            CV_StealthSetValue(
            ...
            while (i as libc::c_int) < numskincolors as libc::c_int
                && skincolors[i as usize].accessible == 0
            {
                i = i.wrapping_add(1);
                i;
            }
            CV_StealthSetValue(
                &mut cv_playercolor,
                if i as libc::c_int != numskincolors as libc::c_int {
                    i as libc::c_int
                } else {
                    SKINCOLOR_BLUE as libc::c_int
                },
            );
        }
    }
    if strcmp(cv_playername.string, (player_names[consoleplayer as usize]).as_mut_ptr())
        == 0
        && cv_playercolor.value
            == players[consoleplayer as usize].skincolor as libc::c_int
        && strcmp(
            cv_skin.string,
            (skins[players[consoleplayer as usize].skin as usize].name).as_mut_ptr(),
        ) == 0
    {
        return;
    }
    players[consoleplayer as usize].availabilities = R_GetSkinAvailabilities();
    if Playing() == 0 {
        return;
    }
    if netgame == 0 {
        let mut foundskin: int32_t = 0;
        CleanupPlayerName(consoleplayer, cv_playername.zstring);
        strcpy(
            (player_names[consoleplayer as usize]).as_mut_ptr(),
            cv_playername.zstring,
        );
        players[consoleplayer as usize].skincolor = cv_playercolor.value as uint16_t;
        if !(players[consoleplayer as usize].mo).is_null()
            && players[consoleplayer as usize].powers[pw_dye as libc::c_int as usize]
                == 0
        {
            (*players[consoleplayer as usize].mo)
                .color = players[consoleplayer as usize].skincolor;
        }
        if metalrecording != 0 {
            SetPlayerSkinByNum(consoleplayer, 5 as libc::c_int);
            CV_StealthSet(
                &mut cv_skin,
                (skins[5 as libc::c_int as usize].name).as_mut_ptr(),
            );
        } else {
            foundskin = R_SkinAvailable(cv_skin.string);
            if foundskin != -(1 as libc::c_int)
                && R_SkinUsable(consoleplayer, foundskin) != 0
            {
                cv_skin.value = foundskin;
                SetPlayerSkin(consoleplayer, cv_skin.string);
                CV_StealthSet(
                    &mut cv_skin,
                    (skins[cv_skin.value as usize].name).as_mut_ptr(),
                );
            } else {
                cv_skin.value = players[consoleplayer as usize].skin;
                CV_StealthSet(
                    &mut cv_skin,
                    (skins[players[consoleplayer as usize].skin as usize].name)
                        .as_mut_ptr(),
                );
                SetPlayerSkin(consoleplayer, cv_skin.string);
            }
    ...
    snacpending += 1;
    snacpending;
    if player_name_changes[consoleplayer as usize] >= 5 as libc::c_int {
        CV_StealthSet(
            &mut cv_playername,
            (player_names[consoleplayer as usize]).as_mut_ptr(),
        );
        HU_AddChatText(
            b"\x85*You must wait to change your name again\0" as *const u8
                as *const libc::c_char,
            false_0 as libc::c_int,
        );
    } else if cv_mute.value != 0 && !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        CV_StealthSet(
            &mut cv_playername,
            (player_names[consoleplayer as usize]).as_mut_ptr(),
        );
    ...
    if cv_skin.value < 0 as libc::c_int
        || R_SkinUsable(consoleplayer, cv_skin.value) == 0
    {
        let mut defaultSkinNum: int32_t = GetPlayerDefaultSkin(consoleplayer);
        CV_StealthSet(&mut cv_skin, (skins[defaultSkinNum as usize].name).as_mut_ptr());
        cv_skin.value = defaultSkinNum;
    }
    let mut tmp_i: size_t = 0;
    tmp_i = 0 as libc::c_int as size_t;
    while tmp_i < 21 as libc::c_int as size_t
        && *(cv_playername.zstring).offset(tmp_i as isize) as libc::c_int != '\0' as i32
    {
        let mut p_tmp: *mut libc::c_char = p as *mut libc::c_void as *mut libc::c_char;
        let tv: libc::c_char = *(cv_playername.zstring).offset(tmp_i as isize);
        memcpy(
    ...
    if tmp_i < 21 as libc::c_int as size_t {
        let mut p_tmp_0: *mut libc::c_char = p as *mut libc::c_void as *mut libc::c_char;
    ...
    let mut p_tmp_1: *mut uint32_t = p as *mut libc::c_void as *mut uint32_t;
    let tv_1: uint32_t = players[consoleplayer as usize].availabilities;
    memcpy(
        p as *mut libc::c_void,
    ...
    p_tmp_1;
    p = p_tmp_1 as *mut libc::c_void as *mut libc::c_char;
    let mut p_tmp_2: *mut uint16_t = p as *mut libc::c_void as *mut uint16_t;
    let tv_2: uint16_t = cv_playercolor.value as uint16_t;
    memcpy(
        p as *mut libc::c_void,
    ...
    p_tmp_2;
    p = p_tmp_2 as *mut libc::c_void as *mut libc::c_char;
    let mut p_tmp_3: *mut uint8_t = p as *mut libc::c_void as *mut uint8_t;
    let tv_3: uint8_t = cv_skin.value as uint8_t;
    memcpy(
        p as *mut libc::c_void,
    ...
    p_tmp_3;
    p = p_tmp_3 as *mut libc::c_void as *mut libc::c_char;
    SendNetXCmd(
        XD_NAMEANDCOLOR,
...
unsafe extern "C" fn SendNameAndColor2() {
    ...
    if G_GametypeHasTeams() != 0 {
        if players[secondplaya as usize].ctfteam == 1 as libc::c_int
            && cv_playercolor2.value != skincolor_redteam as libc::c_int
        {
            CV_StealthSetValue(&mut cv_playercolor2, skincolor_redteam as int32_t);
        } else if players[secondplaya as usize].ctfteam == 2 as libc::c_int
            && cv_playercolor2.value != skincolor_blueteam as libc::c_int
        {
            CV_StealthSetValue(&mut cv_playercolor2, skincolor_blueteam as int32_t);
        }
    }
    if skincolors[cv_playercolor2.value as usize].accessible == 0 {
        if players[secondplaya as usize].skincolor as libc::c_int != 0
            && skincolors[players[secondplaya as usize].skincolor as usize].accessible
                != 0
        {
            CV_StealthSetValue(
                &mut cv_playercolor2,
                players[secondplaya as usize].skincolor as int32_t,
            );
        } else if skincolors[atoi(cv_playercolor2.defaultvalue) as usize].accessible != 0
        {
            CV_StealthSet(&mut cv_playercolor, cv_playercolor2.defaultvalue);
        } else if skins[players[secondplaya as usize].skin as usize].prefcolor
            as libc::c_int != 0
            && skincolors[skins[players[secondplaya as usize].skin as usize].prefcolor
                    as usize]
                .accessible != 0
        {
            CV_StealthSetValue(
                &mut cv_playercolor2,
                skins[players[secondplaya as usize].skin as usize].prefcolor as int32_t,
            );
        } else {
            let mut i: uint16_t = 0 as libc::c_int as uint16_t;
            while (i as libc::c_int) < numskincolors as libc::c_int
    ...
    players[secondplaya as usize].availabilities = R_GetSkinAvailabilities();
    if Playing() == 0 {
        return;
    }
    if botingame != 0 {
        players[secondplaya as usize].skincolor = botcolor;
        if !(players[secondplaya as usize].mo).is_null()
            && players[secondplaya as usize].powers[pw_dye as libc::c_int as usize] == 0
        {
            (*players[secondplaya as usize].mo)
                .color = players[secondplaya as usize].skincolor;
        }
        SetPlayerSkinByNum(secondplaya, botskin as libc::c_int - 1 as libc::c_int);
        return;
    } else if netgame == 0 {
        let mut foundskin: int32_t = 0;
        CleanupPlayerName(secondplaya, cv_playername2.zstring);
        strcpy(
            (player_names[secondplaya as usize]).as_mut_ptr(),
            cv_playername2.zstring,
        );
        players[secondplaya as usize].skincolor = cv_playercolor2.value as uint16_t;
        if !(players[secondplaya as usize].mo).is_null()
            && players[secondplaya as usize].powers[pw_dye as libc::c_int as usize] == 0
        {
            (*players[secondplaya as usize].mo)
        ...
        if cv_forceskin.value >= 0 as libc::c_int && (netgame != 0 || multiplayer != 0) {
            let forcedskin: int32_t = cv_forceskin.value;
            SetPlayerSkinByNum(secondplaya, forcedskin);
            CV_StealthSet(&mut cv_skin2, (skins[forcedskin as usize].name).as_mut_ptr());
        } else {
            foundskin = R_SkinAvailable(cv_skin2.string);
            if foundskin != -(1 as libc::c_int)
                && R_SkinUsable(secondplaya, foundskin) != 0
            {
                cv_skin2.value = foundskin;
                SetPlayerSkin(secondplaya, cv_skin2.string);
                CV_StealthSet(
                    &mut cv_skin2,
                    (skins[cv_skin2.value as usize].name).as_mut_ptr(),
                );
            } else {
                cv_skin2.value = players[secondplaya as usize].skin;
                CV_StealthSet(
                    &mut cv_skin2,
                    (skins[players[secondplaya as usize].skin as usize].name)
                        .as_mut_ptr(),
                );
                SetPlayerSkin(secondplaya, cv_skin2.string);
            }
...
unsafe extern "C" fn Got_NameAndColor(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut p: *mut player_t = &mut *players.as_mut_ptr().offset(playernum as isize)
        as *mut player_t;
    let mut name: [libc::c_char; 22] = [0; 22];
    let mut color: uint16_t = 0;
    let mut skin: uint8_t = 0;
    if playernum == consoleplayer {
        snacpending -= 1;
        snacpending;
    } else if playernum == secondarydisplayplayer {
    ...
    while tmp_i < 21 as libc::c_int as size_t
        && {
            name[tmp_i
                as usize] = ({
                let mut p_tmp: *mut libc::c_char = *cp as *mut libc::c_void
                    as *mut libc::c_char;
            ...
            name[tmp_i as usize] as libc::c_int != '\0' as i32
        }
    {
        tmp_i = tmp_i.wrapping_add(1);
        tmp_i;
    }
    name[tmp_i as usize] = '\0' as i32 as libc::c_char;
    (*p)
        .availabilities = ({
        let mut p_tmp: *mut uint32_t = *cp as *mut libc::c_void as *mut uint32_t;
    ...
    color = ({
        let mut p_tmp: *mut uint16_t = *cp as *mut libc::c_void as *mut uint16_t;
    ...
    if player_name_changes[playernum as usize] < 5 as libc::c_int {
        if strcasecmp((player_names[playernum as usize]).as_mut_ptr(), name.as_mut_ptr())
            != 0 as libc::c_int
        {
            SetPlayerName(playernum, name.as_mut_ptr());
        }
    }
    (*p).skincolor = (color as libc::c_int % numskincolors as libc::c_int) as uint16_t;
    if !((*p).mo).is_null() {
        ...
        && (p
            ...
            && p
                != &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                    as *mut player_t)
    {
        let mut kick: boolean = false_0 as libc::c_int;
        let mut unlockShift: uint32_t = 0 as libc::c_int as uint32_t;
        let mut i: uint32_t = 0;
        if G_GametypeHasTeams() != 0 {
            if (*p).ctfteam == 1 as libc::c_int
                && (*p).skincolor as libc::c_int != skincolor_redteam as libc::c_int
            {
                kick = true_0 as libc::c_int;
        ...
        if skincolors[(*p).skincolor as usize].accessible == false_0 as libc::c_int {
            kick = true_0 as libc::c_int;
        }
        i = 0 as libc::c_int as uint32_t;
        while i < 80 as libc::c_int as uint32_t {
            if !(unlockables[i as usize].type_0 as libc::c_int != 5 as libc::c_int) {
                unlockShift = unlockShift.wrapping_add(1);
                unlockShift;
            }
            i = i.wrapping_add(1);
            i;
        }
        if unlockShift < 32 as libc::c_int as uint32_t {
            let mut illegalMask: uint32_t = 4294967295 as libc::c_uint;
            i = 0 as libc::c_int as uint32_t;
            while i < unlockShift {
                illegalMask &= !((1 as libc::c_int) << i) as uint32_t;
                i = i.wrapping_add(1);
                i;
            }
            if (*p).availabilities & illegalMask != 0 as libc::c_int as uint32_t {
                kick = true_0 as libc::c_int;
            }
        }
        if kick != 0 {
            CONS_Alert(
                CONS_WARNING,
                b"Illegal color change received from %s (team: %d), color: %d)\n\0"
                    as *const u8 as *const libc::c_char,
                (player_names[playernum as usize]).as_mut_ptr(),
                (*p).ctfteam,
                (*p).skincolor as libc::c_int,
            );
            SendKick(
                playernum as uint8_t,
                (2 as libc::c_int | 0x80 as libc::c_int) as uint8_t,
    ...
    if cv_forceskin.value >= 0 as libc::c_int && (netgame != 0 || multiplayer != 0) {
        ...
        if playernum == consoleplayer {
            CV_StealthSet(&mut cv_skin, (skins[forcedskin as usize].name).as_mut_ptr());
        } else if playernum == secondarydisplayplayer {
            CV_StealthSet(&mut cv_skin2, (skins[forcedskin as usize].name).as_mut_ptr());
        }
    } else {
        SetPlayerSkinByNum(playernum, skin as int32_t);
    };
}
#[no_mangle]
pub unsafe extern "C" fn SendWeaponPref() {
    ...
    if cv_analog[0 as libc::c_int as usize].value != 0
        && cv_directionchar[0 as libc::c_int as usize].value != 2 as libc::c_int
    {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
            | 2 as libc::c_int) as uint8_t;
    }
    if cv_directionchar[0 as libc::c_int as usize].value == 1 as libc::c_int {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn SendWeaponPref2() {
    let mut buf: [uint8_t; 1] = [0; 1];
    buf[0 as libc::c_int as usize] = 0 as libc::c_int as uint8_t;
    if cv_flipcam2.value != 0 {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
            | 1 as libc::c_int) as uint8_t;
    }
    if cv_analog[1 as libc::c_int as usize].value != 0
        && cv_directionchar[1 as libc::c_int as usize].value != 2 as libc::c_int
    {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
            | 2 as libc::c_int) as uint8_t;
    }
    if cv_directionchar[1 as libc::c_int as usize].value == 1 as libc::c_int {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
            | 4 as libc::c_int) as uint8_t;
    }
    if cv_autobrake2.value != 0 {
        buf[0 as libc::c_int
            as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
            | 8 as libc::c_int) as uint8_t;
    }
...
unsafe extern "C" fn Got_WeaponPref(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut prefs: uint8_t = ({
        let mut p_tmp: *mut uint8_t = *cp as *mut libc::c_void as *mut uint8_t;
        let mut b: uint8_t = 0;
        memcpy(
            &mut b as *mut uint8_t as *mut libc::c_void,
    ...
    if prefs as libc::c_int & 1 as libc::c_int != 0 {
        players[playernum as usize]
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
        >(
            players[playernum as usize].pflags as libc::c_uint
                | PF_FLIPCAM as libc::c_int as libc::c_uint,
        );
    }
    if prefs as libc::c_int & 2 as libc::c_int != 0 {
        players[playernum as usize]
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
        >(
            players[playernum as usize].pflags as libc::c_uint
                | PF_ANALOGMODE as libc::c_int as libc::c_uint,
        );
    }
    if prefs as libc::c_int & 4 as libc::c_int != 0 {
        players[playernum as usize]
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
        >(
            players[playernum as usize].pflags as libc::c_uint
                | PF_DIRECTIONCHAR as libc::c_int as libc::c_uint,
        );
    }
    if prefs as libc::c_int & 8 as libc::c_int != 0 {
        players[playernum as usize]
            .pflags = ::core::mem::transmute::<
            libc::c_uint,
            pflags_t,
        >(
            players[playernum as usize].pflags as libc::c_uint
                | PF_AUTOBRAKE as libc::c_int as libc::c_uint,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn D_SendPlayerConfig() {
    SendNameAndColor();
    if splitscreen != 0 || botingame != 0 {
        SendNameAndColor2();
    }
...
unsafe extern "C" fn Command_Playdemo_f() {
    ...
    if netgame != 0 {
        CONS_Printf(
            b"You can't play a demo while in a netgame.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    ...
    strcpy(name.as_mut_ptr(), COM_Argv(1 as libc::c_int as size_t));
    CONS_Printf(
        b"Playing back demo '%s'.\n\0" as *const u8 as *const libc::c_char,
        name.as_mut_ptr(),
    );
    demofileoverride = DFILE_OVERRIDE_NONE;
    if strcmp(
        COM_Argv(2 as libc::c_int as size_t),
        b"-addfiles\0" as *const u8 as *const libc::c_char,
    ) == 0 as libc::c_int
    {
    ...
    if FIL_CheckExtension(name.as_mut_ptr()) != 0 {
        G_DoPlayDemo(
            va(
        ...
        G_DoPlayDemo(name.as_mut_ptr());
    };
}
unsafe extern "C" fn Command_Timedemo_f() {
    let mut i: size_t = 0 as libc::c_int as size_t;
    if COM_Argc() < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"timedemo <demoname> [-csv [<trialid>]] [-quit]: time a demo\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    ...
    strcpy(timedemo_name.as_mut_ptr(), COM_Argv(1 as libc::c_int as size_t));
    i = COM_CheckParm(b"-csv\0" as *const u8 as *const libc::c_char);
    timedemo_csv = (i > 0 as libc::c_int as size_t) as libc::c_int;
    if COM_CheckParm(b"-quit\0" as *const u8 as *const libc::c_char)
        != i.wrapping_add(1 as libc::c_int as size_t)
    {
        strcpy(
            timedemo_csv_id.as_mut_ptr(),
            COM_Argv(i.wrapping_add(1 as libc::c_int as size_t)),
        );
    } else {
        timedemo_csv_id[0 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
    }
    timedemo_quit = (COM_CheckParm(b"-quit\0" as *const u8 as *const libc::c_char)
        > 0 as libc::c_int as size_t) as libc::c_int;
    CONS_Printf(
        b"Timing demo '%s'.\n\0" as *const u8 as *const libc::c_char,
        timedemo_name.as_mut_ptr(),
    );
    G_TimeDemo(timedemo_name.as_mut_ptr());
}
unsafe extern "C" fn Command_Stopdemo_f() {
    G_CheckDemoStatus();
    CONS_Printf(b"Stopped demo.\n\0" as *const u8 as *const libc::c_char);
}
unsafe extern "C" fn Command_StartMovie_f() {
    M_StartMovie();
}
unsafe extern "C" fn Command_StopMovie_f() {
    M_StopMovie();
}
#[no_mangle]
pub static mut mapchangepending: int32_t = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn D_MapChange(
    mut mapnum: int32_t,
    mut newgametype: int32_t,
    mut pultmode: boolean,
    mut resetplayers: boolean,
    mut delay: int32_t,
    mut skipprecutscene: boolean,
    mut FLS: boolean,
) {
    static mut buf: [libc::c_char; 519] = [0; 519];
    static mut buf_p: *mut libc::c_char = unsafe { buf.as_ptr() as *mut _ };
    if mapnum != -(1 as libc::c_int) {
        CV_SetValue(&mut cv_nextmap, mapnum);
        if botskin != 0 {
            if G_IsSpecialStage(mapnum) != 0
                || !(mapheaderinfo[(mapnum - 1 as libc::c_int) as usize]).is_null()
                    && (*mapheaderinfo[(mapnum - 1 as libc::c_int) as usize]).typeoflevel
                        & TOL_NIGHTS as libc::c_int as uint32_t != 0
            {
                if botingame != 0 {
                    botingame = false_0 as libc::c_int;
                    playeringame[1 as libc::c_int as usize] = false_0 as libc::c_int;
                }
            } else if botingame == 0 {
                botingame = true_0 as libc::c_int;
                secondarydisplayplayer = 1 as libc::c_int;
                playeringame[1 as libc::c_int as usize] = true_0 as libc::c_int;
                players[1 as libc::c_int as usize].bot = 1 as libc::c_int as uint8_t;
                SendNameAndColor2();
            }
        }
    }
    CONS_Debug(
        0x80 as libc::c_int,
        b"Map change: mapnum=%d gametype=%d ultmode=%d resetplayers=%d delay=%d skipprecutscene=%d\n\0"
            as *const u8 as *const libc::c_char,
        mapnum,
        newgametype,
        pultmode,
    ...
    if (netgame != 0 || multiplayer != 0)
        && !(gametype as libc::c_int == newgametype
            && gametypedefaultrules[newgametype as usize]
                & GTR_CAMPAIGN as libc::c_int as uint32_t != 0)
    {
        FLS = false_0 as libc::c_int;
    }
    if delay != 2 as libc::c_int {
        let mut flags: uint8_t = 0 as libc::c_int as uint8_t;
        let mut mapname: *const libc::c_char = G_BuildMapName(mapnum);
        buf_p = buf.as_mut_ptr();
        if pultmode != 0 {
            flags = (flags as libc::c_int | 1 as libc::c_int) as uint8_t;
        }
        if resetplayers == 0 {
            flags = (flags as libc::c_int | (1 as libc::c_int) << 1 as libc::c_int)
                as uint8_t;
        }
        if skipprecutscene != 0 {
            flags = (flags as libc::c_int | (1 as libc::c_int) << 2 as libc::c_int)
                as uint8_t;
        }
        if FLS != 0 {
            flags = (flags as libc::c_int | (1 as libc::c_int) << 3 as libc::c_int)
                as uint8_t;
        }
        let mut p_tmp: *mut uint8_t = buf_p as *mut libc::c_void as *mut uint8_t;
        let tv: uint8_t = flags;
        memcpy(
            buf_p as *mut libc::c_void,
            &tv as *const uint8_t as *const libc::c_void,
            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
        );
        p_tmp = p_tmp.offset(1);
        p_tmp;
        buf_p = p_tmp as *mut libc::c_void as *mut libc::c_char;
        let mut p_tmp_0: *mut uint8_t = buf_p as *mut libc::c_void as *mut uint8_t;
        let tv_0: uint8_t = newgametype as uint8_t;
        memcpy(
            buf_p as *mut libc::c_void,
        ...
        p_tmp_0 = p_tmp_0.offset(1);
        p_tmp_0;
        buf_p = p_tmp_0 as *mut libc::c_void as *mut libc::c_char;
        let mut tmp_i: size_t = 0;
        tmp_i = 0 as libc::c_int as size_t;
        while tmp_i < 512 as libc::c_int as size_t
            && *mapname.offset(tmp_i as isize) as libc::c_int != '\0' as i32
        {
            let mut p_tmp_1: *mut libc::c_char = buf_p as *mut libc::c_void
                as *mut libc::c_char;
            let tv_1: libc::c_char = *mapname.offset(tmp_i as isize);
            memcpy(
                buf_p as *mut libc::c_void,
            ...
            p_tmp_1 = p_tmp_1.offset(1);
            p_tmp_1;
            buf_p = p_tmp_1 as *mut libc::c_void as *mut libc::c_char;
            tmp_i = tmp_i.wrapping_add(1);
            tmp_i;
        }
        if tmp_i < 512 as libc::c_int as size_t {
            let mut p_tmp_2: *mut libc::c_char = buf_p as *mut libc::c_void
                as *mut libc::c_char;
            ...
            p_tmp_2 = p_tmp_2.offset(1);
            p_tmp_2;
            buf_p = p_tmp_2 as *mut libc::c_void as *mut libc::c_char;
        }
    }
    if delay == 1 as libc::c_int {
        mapchangepending = 1 as libc::c_int;
    } else {
        mapchangepending = 0 as libc::c_int;
        if IsPlayerAdmin(consoleplayer) == 0 {
            if SV_SpawnServer() != 0 {
                buf[0 as libc::c_int
                    as usize] = (buf[0 as libc::c_int as usize] as libc::c_int
        ...
        chmappending;
        if netgame != 0 {
            let mut p_tmp_3: *mut uint32_t = buf_p as *mut libc::c_void as *mut uint32_t;
            let tv_3: uint32_t = M_RandomizedSeed();
            memcpy(
                buf_p as *mut libc::c_void,
            ...
            p_tmp_3 = p_tmp_3.offset(1);
            p_tmp_3;
            buf_p = p_tmp_3 as *mut libc::c_void as *mut libc::c_char;
        }
        SendNetXCmd(
            XD_MAP,
            buf.as_mut_ptr() as *const libc::c_void,
            buf_p.offset_from(buf.as_mut_ptr()) as libc::c_long as size_t,
        );
    };
}
unsafe extern "C" fn ConcatCommandArgv(
    ...
    while i < end {
        size = (size as libc::c_ulong)
            .wrapping_add(
                (strlen(COM_Argv(i as size_t)))
                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as size_t as size_t;
        i += 1;
        i;
    }
    final_0 = Z_MallocAlign(
        size,
        ...
        p = p
            .offset(
                sprintf(
                    ...
                    COM_Argv(i as size_t),
                ) as isize,
            );
        i += 1;
        i;
    }
    strcpy(p, COM_Argv(end as size_t));
    return final_0;
}
unsafe extern "C" fn Command_Map_f() {
    let mut first_option: size_t = 0;
    let mut option_force: size_t = 0;
    let mut option_gametype: size_t = 0;
    let mut gametypename: *const libc::c_char = 0 as *const libc::c_char;
    let mut newresetplayers: boolean = 0;
    let mut prevent_cheat: boolean = 0;
    let mut set_cheated: boolean = 0;
    ...
    let mut newgametype: int32_t = gametype as int32_t;
    let mut d: int32_t = 0;
    ...
    option_force = COM_CheckPartialParm(b"-f\0" as *const u8 as *const libc::c_char);
    option_gametype = COM_CheckPartialParm(b"-g\0" as *const u8 as *const libc::c_char);
    newresetplayers = (COM_CheckParm(
        b"-noresetplayers\0" as *const u8 as *const libc::c_char,
    ) == 0) as libc::c_int;
    prevent_cheat = (usedCheats == 0 && !(option_force != 0 || cv_debug != 0))
        as libc::c_int;
    set_cheated = false_0 as libc::c_int;
    if !(netgame != 0 || multiplayer != 0) {
        if prevent_cheat != 0 {
            CONS_Printf(
                b"Cheats must be enabled to level change in single player.\n\0"
                    as *const u8 as *const libc::c_char,
            );
            return;
        } else {
            set_cheated = true_0 as libc::c_int;
        }
    }
    if newresetplayers == 0 {
        if prevent_cheat != 0 {
            CONS_Printf(
                b"Cheats must be enabled to use -noresetplayers.\n\0" as *const u8
                    as *const libc::c_char,
            );
            return;
        } else {
    ...
    if option_gametype != 0 {
        if multiplayer == 0 {
            CONS_Printf(
                b"You can't switch gametypes in single player!\n\0" as *const u8
                    as *const libc::c_char,
            );
            return;
        } else if COM_Argc() < option_gametype.wrapping_add(2 as libc::c_int as size_t) {
            CONS_Alert(
                CONS_ERROR,
                b"No gametype name follows parameter '%s'.\n\0" as *const u8
                    as *const libc::c_char,
    ...
    first_option = COM_FirstOption();
    if first_option == 0 {
        first_option = COM_Argc();
    }
    if first_option < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"map <name / [MAP]code / number> [-gametype <type>] [-force]:\n\0"
                as *const u8 as *const libc::c_char,
        );
        CONS_Printf(
            b"Warp to a map, by its name, two character code, with optional \"MAP\" prefix, or by its number (though why would you).\nAll parameters are case-insensitive and may be abbreviated.\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    mapname = ConcatCommandArgv(1 as libc::c_int, first_option as libc::c_int);
    newmapnum = G_FindMapByNameOrCode(mapname, &mut realmapname);
    if newmapnum == 0 as libc::c_int {
        CONS_Alert(
            CONS_ERROR,
            b"Could not find any map described as '%s'.\n\0" as *const u8
                as *const libc::c_char,
            mapname,
        );
    ...
    if option_gametype != 0 {
        gametypename = COM_Argv(
            option_gametype.wrapping_add(1 as libc::c_int as size_t),
        );
        newgametype = G_GetGametypeByName(gametypename);
        if newgametype == -(1 as libc::c_int) {
            if *(*__ctype_b_loc())
                .offset(
                    *gametypename.offset(0 as libc::c_int as isize) as libc::c_int
                        as isize,
                ) as libc::c_int
                & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
            {
                d = atoi(gametypename);
                if d >= 0 as libc::c_int && d < gametypecount as libc::c_int {
                    newgametype = d;
                } else {
                    CONS_Alert(
                        CONS_ERROR,
                        b"Gametype number %d is out of range. Use a number between 0 and %d inclusive. ...Or just use the name. :v\n\0"
                            as *const u8 as *const libc::c_char,
                        d,
                        gametypecount as libc::c_int - 1 as libc::c_int,
                    );
    ...
    if !(!(mapheaderinfo[(newmapnum - 1 as libc::c_int) as usize]).is_null()
        && (*mapheaderinfo[(newmapnum - 1 as libc::c_int) as usize]).typeoflevel
            & G_TOLFlag(newgametype) != 0)
    {
        if prevent_cheat != 0 && cv_skipmapcheck.value == 0 {
            CONS_Alert(
                CONS_WARNING,
                b"%s (%s) doesn't support %s mode!\n(Use -force to override)\n\0"
                    as *const u8 as *const libc::c_char,
                realmapname,
                G_BuildMapName(newmapnum),
                if multiplayer != 0 {
                    (*gametype_cons_t.as_mut_ptr().offset(newgametype as isize)).strvalue
                } else {
                    b"Single Player\0" as *const u8 as *const libc::c_char
                },
            );
            Z_Free(realmapname as *mut libc::c_void);
            Z_Free(mapname as *mut libc::c_void);
            ...
            set_cheated = (gametypedefaultrules[newgametype as usize]
                & GTR_CAMPAIGN as libc::c_int as uint32_t
                == GTR_CAMPAIGN as libc::c_int as uint32_t) as libc::c_int;
        }
    } else {
        fromlevelselect = ((netgame != 0 || multiplayer != 0)
            && newgametype == gametype as libc::c_int
            && gametypedefaultrules[newgametype as usize]
                & GTR_CAMPAIGN as libc::c_int as uint32_t != 0) as libc::c_int;
    }
    if M_CampaignWarpIsCheat(newgametype, newmapnum, serverGamedata) != 0 {
        if prevent_cheat != 0 {
            CONS_Alert(
                CONS_NOTICE,
                b"Cheats must be enabled to warp to a locked level!\n\0" as *const u8
                    as *const libc::c_char,
            );
            Z_Free(realmapname as *mut libc::c_void);
            Z_Free(mapname as *mut libc::c_void);
    ...
    if netgame != 0 || multiplayer != 0 {
        ultimatemode = false_0 as libc::c_int as uint8_t;
    }
    if tutorialmode != 0 && tutorialgcs != 0 {
        ...
        CV_SetValue(&mut cv_usemouse, tutorialusemouse);
        CV_SetValue(&mut cv_alwaysfreelook, tutorialfreelook);
        CV_SetValue(&mut cv_mousemove, tutorialmousemove);
        CV_SetValue(
            &mut *cv_analog.as_mut_ptr().offset(0 as libc::c_int as isize),
            tutorialanalog,
        );
    }
    tutorialmode = false_0 as libc::c_int;
    if set_cheated != 0 && usedCheats == 0 {
...
unsafe extern "C" fn Got_Mapcmd(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut mapname: [libc::c_char; 513] = [0; 513];
    let mut flags: uint8_t = 0;
    let mut resetplayer: int32_t = 1 as libc::c_int;
    let mut lastgametype: int32_t = 0;
    let mut skipprecutscene: uint8_t = 0;
    let mut FLS: uint8_t = 0;
    let mut mapnumber: int16_t = 0;
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal map change received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    ultimatemode = (flags as libc::c_int & 1 as libc::c_int != 0 as libc::c_int)
        as libc::c_int as uint8_t;
    if netgame != 0 || multiplayer != 0 {
        ultimatemode = false_0 as libc::c_int as uint8_t;
    }
    resetplayer = (flags as libc::c_int & (1 as libc::c_int) << 1 as libc::c_int
        == 0 as libc::c_int) as libc::c_int;
    lastgametype = gametype as int32_t;
    gametype = ({
        let mut p_tmp: *mut uint8_t = *cp as *mut libc::c_void as *mut uint8_t;
        let mut b: uint8_t = 0;
        memcpy(
    ...
    {
        gametype = lastgametype as int16_t;
    } else {
        G_SetGametype(gametype);
    }
    if gametype as libc::c_int != lastgametype {
        D_GameTypeChanged(lastgametype);
    }
    skipprecutscene = (flags as libc::c_int & (1 as libc::c_int) << 2 as libc::c_int
        != 0 as libc::c_int) as libc::c_int as uint8_t;
    FLS = (flags as libc::c_int & (1 as libc::c_int) << 3 as libc::c_int
        != 0 as libc::c_int) as libc::c_int as uint8_t;
    let mut tmp_i: size_t = 0 as libc::c_int as size_t;
    while tmp_i < 512 as libc::c_int as size_t
        && {
            ...
            mapname[tmp_i as usize] as libc::c_int != '\0' as i32
        }
    {
        tmp_i = tmp_i.wrapping_add(1);
        tmp_i;
    }
    mapname[tmp_i as usize] = '\0' as i32 as libc::c_char;
    if netgame != 0 {
        P_SetRandSeed(
            ({
                let mut p_tmp: *mut uint32_t = *cp as *mut libc::c_void as *mut uint32_t;
    ...
    if skipprecutscene == 0 {
        if !debugfile.is_null() {
            fputs(
                va(
                    b"Warping to %s [resetplayer=%d lastgametype=%d gametype=%d cpnd=%d]\n\0"
                        as *const u8 as *const libc::c_char,
                    mapname.as_mut_ptr(),
                    resetplayer,
                    lastgametype,
                    gametype as libc::c_int,
                    chmappending,
                ),
                debugfile,
            );
        ...
        CONS_Printf(b"Speeding off to level...\n\0" as *const u8 as *const libc::c_char);
    }
    if demoplayback != 0 && timingdemo == 0 {
        precache = false_0 as libc::c_int;
    }
    if modeattacking != 0 {
        SetPlayerSkinByNum(0 as libc::c_int, cv_chooseskin.value - 1 as libc::c_int);
        players[0 as libc::c_int as usize]
            .skincolor = skins[players[0 as libc::c_int as usize].skin as usize]
            .prefcolor;
        CV_StealthSetValue(
            &mut cv_playercolor,
    ...
    mapnumber = M_MapNumber(
        mapname[3 as libc::c_int as usize],
        mapname[4 as libc::c_int as usize],
    ) as int16_t;
    LUA_HookInt(mapnumber as int32_t, hook_MapChange as libc::c_int);
    G_InitNew(
        ultimatemode,
        mapname.as_mut_ptr(),
        resetplayer,
        skipprecutscene as boolean,
        FLS as boolean,
    );
    if demoplayback != 0 && timingdemo == 0 {
        precache = true_0 as libc::c_int;
    }
    if timingdemo != 0 {
        G_DoneLevelLoad();
    }
...
unsafe extern "C" fn Command_Pause() {
    let mut buf: [uint8_t; 2] = [0; 2];
    let mut cp: *mut uint8_t = buf.as_mut_ptr();
    if COM_Argc() > 1 as libc::c_int as size_t {
        let mut p_tmp: *mut uint8_t = cp as *mut libc::c_void as *mut uint8_t;
        let tv: uint8_t = (atoi(COM_Argv(1 as libc::c_int as size_t))
            != 0 as libc::c_int) as libc::c_int as libc::c_char as uint8_t;
        memcpy(
        ...
        let mut p_tmp_0: *mut uint8_t = cp as *mut libc::c_void as *mut uint8_t;
        let tv_0: uint8_t = (paused == 0) as libc::c_int as libc::c_char as uint8_t;
        memcpy(
            cp as *mut libc::c_void,
            &tv_0 as *const uint8_t as *const libc::c_void,
            ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
        ...
        p_tmp_0 = p_tmp_0.offset(1);
        p_tmp_0;
        cp = p_tmp_0 as *mut libc::c_void as *mut uint8_t;
    }
    if dedicated != 0 {
        let mut p_tmp_1: *mut uint8_t = cp as *mut libc::c_void as *mut uint8_t;
        let tv_1: uint8_t = 1 as libc::c_int as uint8_t;
        memcpy(
            cp as *mut libc::c_void,
        ...
        p_tmp_1 = p_tmp_1.offset(1);
        p_tmp_1;
        cp = p_tmp_1 as *mut libc::c_void as *mut uint8_t;
    } else {
        let mut p_tmp_2: *mut uint8_t = cp as *mut libc::c_void as *mut uint8_t;
        ...
        p_tmp_2 = p_tmp_2.offset(1);
        p_tmp_2;
        cp = p_tmp_2 as *mut libc::c_void as *mut uint8_t;
    }
    if cv_pause.value != 0 || server != 0 || IsPlayerAdmin(consoleplayer) != 0 {
        if modeattacking as libc::c_int != 0
            || !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
                ...
                || gamestate as libc::c_uint
                    == GS_WAITINGPLAYERS as libc::c_int as libc::c_uint)
            || marathonmode as libc::c_uint != 0
                && gamestate as libc::c_uint
                    == GS_INTERMISSION as libc::c_int as libc::c_uint
        {
            CONS_Printf(
                b"You can't pause here.\n\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
        SendNetXCmd(
...
unsafe extern "C" fn Got_Pause(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut dedicatedpause: uint8_t = false_0 as libc::c_int as uint8_t;
    let mut playername: *const libc::c_char = 0 as *const libc::c_char;
    if netgame != 0 && cv_pause.value == 0 && playernum != serverplayer
        && IsPlayerAdmin(playernum) == 0
    {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal pause command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    if demoplayback == 0 {
        if netgame != 0 {
            if dedicatedpause != 0 {
                playername = b"SERVER\0" as *const u8 as *const libc::c_char;
            } else {
                playername = (player_names[playernum as usize]).as_mut_ptr();
            }
            if paused != 0 {
                CONS_Printf(
                    b"Game paused by %s\n\0" as *const u8 as *const libc::c_char,
                ...
                CONS_Printf(
                    b"Game unpaused by %s\n\0" as *const u8 as *const libc::c_char,
                    playername,
                );
            }
        }
        if paused != 0 {
            if menuactive == 0 || netgame != 0 {
                S_PauseAudio();
            }
        } else {
            S_ResumeAudio();
...
unsafe extern "C" fn Command_Suicide() {
    ...
    {
        CONS_Printf(
            b"You must be in a level to use this.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    if G_PlatformGametype() == 0 {
        CONS_Printf(
            b"You may only use this in co-op, race, and competition!\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    if !(netgame != 0 || multiplayer != 0) {
        CONS_Printf(
            b"You can't use this in Single Player! Use \"retry\" instead.\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    let mut p_tmp: *mut int32_t = cp as *mut libc::c_void as *mut int32_t;
    let tv: int32_t = consoleplayer;
    memcpy(
        cp as *mut libc::c_void,
        &tv as *const int32_t as *const libc::c_void,
    ...
    SendNetXCmd(
        XD_SUICIDE,
        &mut buf as *mut [uint8_t; 4] as *const libc::c_void,
        4 as libc::c_int as size_t,
    );
}
unsafe extern "C" fn Got_Suicide(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut suicideplayer: int32_t = ({
        let mut p_tmp: *mut int32_t = *cp as *mut libc::c_void as *mut int32_t;
        let mut b: int32_t = 0;
        memcpy(
    ...
    if suicideplayer != playernum || G_PlatformGametype() == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal suicide command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    if !(players[suicideplayer as usize].mo).is_null() {
        P_DamageMobj(
            players[suicideplayer as usize].mo,
            0 as *mut mobj_t,
            0 as *mut mobj_t,
            1 as libc::c_int,
...
unsafe extern "C" fn Got_RandomSeed(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
...
unsafe extern "C" fn Command_Clearscores_f() {
    if !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        return;
    }
    SendNetXCmd(XD_CLEARSCORES, 0 as *const libc::c_void, 1 as libc::c_int as size_t);
}
unsafe extern "C" fn Got_Clearscores(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut i: int32_t = 0;
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal clear scores command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    while i < 32 as libc::c_int {
        ...
        players[i as usize].score = players[i as usize].recordscore;
        i += 1;
        i;
    }
    CONS_Printf(
        b"Scores have been reset by the server.\n\0" as *const u8 as *const libc::c_char,
    );
}
unsafe extern "C" fn Command_Teamchange_f() {
    ...
    let mut error: boolean = false_0 as libc::c_int;
    ...
    if COM_Argc() <= 1 as libc::c_int as size_t {
        if G_GametypeHasTeams() != 0 {
            CONS_Printf(
                b"changeteam <team>: switch to a new team (%s)\n\0" as *const u8
                    as *const libc::c_char,
                b"red, blue or spectator\0" as *const u8 as *const libc::c_char,
            );
        } else if G_GametypeHasSpectators() != 0 {
            CONS_Printf(
                b"changeteam <team>: switch to a new team (%s)\n\0" as *const u8
                    as *const libc::c_char,
                b"spectator or playing\0" as *const u8 as *const libc::c_char,
            );
        } else {
            CONS_Alert(
                CONS_NOTICE,
                b"This command cannot be used in this gametype.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        return;
    ...
    if G_GametypeHasTeams() != 0 {
        ...
        {
            (NetPacket.packet).set_newteam(1 as libc::c_int as uint32_t);
        } else if strcasecmp(
            COM_Argv(1 as libc::c_int as size_t),
        ...
        {
            (NetPacket.packet).set_newteam(2 as libc::c_int as uint32_t);
        } else if strcasecmp(
            COM_Argv(1 as libc::c_int as size_t),
        ...
        {
            (NetPacket.packet).set_newteam(0 as libc::c_int as uint32_t);
        } else {
            error = true_0 as libc::c_int;
        }
    } else if G_GametypeHasSpectators() != 0 {
        if strcasecmp(
            COM_Argv(1 as libc::c_int as size_t),
        ...
        {
            (NetPacket.packet).set_newteam(3 as libc::c_int as uint32_t);
        } else {
            error = true_0 as libc::c_int;
        }
    } else {
    ...
    if G_GametypeHasTeams() != 0 {
        if (NetPacket.packet).newteam()
            == players[consoleplayer as usize].ctfteam as libc::c_uint
        ...
        if players[consoleplayer as usize].spectator != 0
            && (NetPacket.packet).newteam() == 0
            || players[consoleplayer as usize].spectator == 0
                && (NetPacket.packet).newteam() as libc::c_int == 3 as libc::c_int
        {
            error = true_0 as libc::c_int;
        }
    }
    if error != 0 {
        CONS_Alert(
            CONS_NOTICE,
            b"You're already on that team!\n\0" as *const u8 as *const libc::c_char,
        );
        return;
    }
    if cv_allowteamchange.value == 0 && (NetPacket.packet).newteam() as libc::c_int != 0
    {
        CONS_Alert(
            CONS_NOTICE,
            b"The server is not allowing team changes at the moment.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
        ...
        && leveltime >= hidetime * 35 as libc::c_int as tic_t
    {
        CONS_Alert(
            CONS_NOTICE,
            b"Hiding time expired; no Hide and Seek status changes allowed!\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    usvalue = (NetPacket.value.l as libc::c_int | NetPacket.value.b as libc::c_int)
...
unsafe extern "C" fn Command_Teamchange2_f() {
    let mut NetPacket: changeteam_union = changeteam_union {
        packet: changeteam_packet_t {
            playernum_newteam_verification_autobalance_scrambled: [0; 2],
        },
    ...
    if error != 0 {
        if G_GametypeHasTeams() != 0 {
            CONS_Printf(
                b"changeteam2 <team>: switch to a new team (%s)\n\0" as *const u8
                    as *const libc::c_char,
                b"red, blue or spectator\0" as *const u8 as *const libc::c_char,
            );
        } else if G_GametypeHasSpectators() != 0 {
    ...
    if G_GametypeHasTeams() != 0 {
        if (NetPacket.packet).newteam()
            == players[secondarydisplayplayer as usize].ctfteam as libc::c_uint
            || players[secondarydisplayplayer as usize].spectator != 0
                && (NetPacket.packet).newteam() == 0
        {
            error = true_0 as libc::c_int;
        }
...
unsafe extern "C" fn Command_ServerTeamChange_f() {
    let mut NetPacket: changeteam_union = changeteam_union {
        packet: changeteam_packet_t {
            playernum_newteam_verification_autobalance_scrambled: [0; 2],
        },
    ...
    if COM_Argc() < 3 as libc::c_int as size_t {
        if G_TagGametype() != 0 {
            CONS_Printf(
                b"serverchangeteam <playernum> <team>: switch player to a new team (%s)\n\0"
                    as *const u8 as *const libc::c_char,
                b"it, notit, playing, or spectator\0" as *const u8 as *const libc::c_char,
            );
    ...
    if G_TagGametype() != 0 {
            ...
            ) == 0
        {
            ...
            COM_Argv(2 as libc::c_int as size_t),
            b"notit\0" as *const u8 as *const libc::c_char,
        ) == 0
            || strcasecmp(
                COM_Argv(2 as libc::c_int as size_t),
                b"2\0" as *const u8 as *const libc::c_char,
    ...
    (NetPacket.packet)
        .set_playernum(atoi(COM_Argv(1 as libc::c_int as size_t)) as uint32_t);
    if playeringame[(NetPacket.packet).playernum() as usize] == 0 {
        CONS_Alert(
            CONS_NOTICE,
            b"There is no player %d!\n\0" as *const u8 as *const libc::c_char,
            (NetPacket.packet).playernum() as libc::c_int,
        );
        return;
    }
    if G_TagGametype() != 0 {
        if players[(NetPacket.packet).playernum() as usize].pflags as libc::c_uint
            & PF_TAGIT as libc::c_int as libc::c_uint != 0
            && (NetPacket.packet).newteam() as libc::c_int == 1 as libc::c_int
            || players[(NetPacket.packet).playernum() as usize].pflags as libc::c_uint
                & PF_TAGIT as libc::c_int as libc::c_uint == 0
                && (NetPacket.packet).newteam() as libc::c_int == 2 as libc::c_int
            || players[(NetPacket.packet).playernum() as usize].spectator != 0
                && (NetPacket.packet).newteam() == 0
            || players[(NetPacket.packet).playernum() as usize].spectator == 0
                && (NetPacket.packet).newteam() as libc::c_int == 3 as libc::c_int
        {
        ...
        if (NetPacket.packet).newteam()
            == players[(NetPacket.packet).playernum() as usize].ctfteam as libc::c_uint
            || players[(NetPacket.packet).playernum() as usize].spectator != 0
                && (NetPacket.packet).newteam() == 0
        {
            error = true_0 as libc::c_int;
        ...
        if players[(NetPacket.packet).playernum() as usize].spectator != 0
            && (NetPacket.packet).newteam() == 0
            || players[(NetPacket.packet).playernum() as usize].spectator == 0
                && (NetPacket.packet).newteam() as libc::c_int == 3 as libc::c_int
        {
    ...
    if error != 0 {
        CONS_Alert(
            CONS_NOTICE,
            b"That player is already on that team!\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
...
unsafe extern "C" fn Got_Teamchange(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut NetPacket: changeteam_union = changeteam_union {
        packet: changeteam_packet_t {
            playernum_newteam_verification_autobalance_scrambled: [0; 2],
        },
    ...
    NetPacket
        .value
        .b = ({
        let mut p_tmp: *mut int16_t = *cp as *mut libc::c_void as *mut int16_t;
        let mut b: int16_t = 0;
        memcpy(
    ...
    NetPacket.value.l = NetPacket.value.b;
    if G_GametypeHasTeams() == 0 && G_GametypeHasSpectators() == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal team change received from player %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    if (NetPacket.packet).verification() != 0 {
        if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 {
            CONS_Alert(
                CONS_WARNING,
                b"Illegal team change received from player %s\n\0" as *const u8
        ...
        playernum = (NetPacket.packet).playernum() as int32_t;
    }
    if G_TagGametype() != 0 {
        if players[playernum as usize].pflags as libc::c_uint
            & PF_TAGIT as libc::c_int as libc::c_uint != 0
            ...
            || players[playernum as usize].pflags as libc::c_uint
                & PF_TAGIT as libc::c_int as libc::c_uint == 0
                && (NetPacket.packet).newteam() as libc::c_int == 2 as libc::c_int
            || players[playernum as usize].spectator != 0
                && (NetPacket.packet).newteam() as libc::c_int == 0 as libc::c_int
            || players[playernum as usize].spectator == 0
                && (NetPacket.packet).newteam() as libc::c_int == 3 as libc::c_int
        {
            return;
        ...
        if (NetPacket.packet).newteam() as libc::c_int != 0
            && (NetPacket.packet).newteam()
                == players[playernum as usize].ctfteam as libc::c_uint
            || players[playernum as usize].spectator != 0
                && (NetPacket.packet).newteam() == 0
        {
            return;
    ...
    if LUA_HookTeamSwitch(
        ...
        (NetPacket.packet).newteam() as libc::c_int,
        players[playernum as usize].spectator,
        (NetPacket.packet).autobalance() as boolean,
        (NetPacket.packet).scrambled() as boolean,
    ) == 0
    {
        return;
    }
    ...
    match gametype as libc::c_int {
        6 => {
            if leveltime >= hidetime * 35 as libc::c_int as tic_t {
                error = true_0 as libc::c_int;
                current_block_47 = 14447253356787937536;
            } else {
                current_block_47 = 11650502995543125672;
            }
        }
        5 => {
            current_block_47 = 11650502995543125672;
        ...
        _ => {
            if cv_allowteamchange.value == 0 {
                if (NetPacket.packet).verification() == 0
                    && (NetPacket.packet).newteam() as libc::c_int != 0
                {
                    error = true_0 as libc::c_int;
                }
            }
    ...
    match current_block_47 {
        11650502995543125672 => {
            match (NetPacket.packet).newteam() as libc::c_int {
                1 | 2 => {
                    if (NetPacket.packet).verification() == 0 {
                        error = true_0 as libc::c_int;
                    }
    ...
    if !(players[playernum as usize].mo).is_null() {
        if players[playernum as usize].spectator == 0 {
            ...
            players[playernum as usize].mo = 0 as *mut mobj_t;
            players[playernum as usize].playerstate = PST_REBORN;
        }
    } else {
        players[playernum as usize].playerstate = PST_REBORN;
    }
    if G_TagGametype() != 0 {
        if (NetPacket.packet).newteam() == 0 {
            players[playernum as usize].spectator = true_0 as libc::c_int;
            players[playernum as usize]
                .pflags = ::core::mem::transmute::<
                libc::c_uint,
                pflags_t,
        ...
        } else if (NetPacket.packet).newteam() as libc::c_int != 3 as libc::c_int {
            players[playernum as usize].spectator = false_0 as libc::c_int;
            players[playernum as usize]
                .pflags = ::core::mem::transmute::<
                libc::c_uint,
                pflags_t,
            ...
            if (NetPacket.packet).newteam() as libc::c_int == 1 as libc::c_int {
                players[playernum as usize]
                    .pflags = ::core::mem::transmute::<
                    libc::c_uint,
                    pflags_t,
        ...
        if (NetPacket.packet).newteam() == 0 {
            players[playernum as usize].ctfteam = 0 as libc::c_int;
            players[playernum as usize].spectator = true_0 as libc::c_int;
        } else {
            players[playernum as usize]
                .ctfteam = (NetPacket.packet).newteam() as int32_t;
            players[playernum as usize].spectator = false_0 as libc::c_int;
        }
    } else if G_GametypeHasSpectators() != 0 {
        if (NetPacket.packet).newteam() == 0 {
    ...
    if (NetPacket.packet).autobalance() != 0 {
        if (NetPacket.packet).newteam() as libc::c_int == 1 as libc::c_int {
            CONS_Printf(
                b"%s was autobalanced to the %c%s%c.\n\0" as *const u8
                    as *const libc::c_char,
                (player_names[playernum as usize]).as_mut_ptr(),
                -123i32,
        ...
        } else if (NetPacket.packet).newteam() as libc::c_int == 2 as libc::c_int {
            CONS_Printf(
                b"%s was autobalanced to the %c%s%c.\n\0" as *const u8
                    as *const libc::c_char,
                (player_names[playernum as usize]).as_mut_ptr(),
    ...
    } else if (NetPacket.packet).scrambled() != 0 {
        if (NetPacket.packet).newteam() as libc::c_int == 1 as libc::c_int {
            CONS_Printf(
                b"%s was scrambled to the %c%s%c.\n\0" as *const u8
                    as *const libc::c_char,
                (player_names[playernum as usize]).as_mut_ptr(),
                -123i32,
                b"Red Team\0" as *const u8 as *const libc::c_char,
    ...
    } else if (NetPacket.packet).newteam() as libc::c_int == 1 as libc::c_int {
        if G_TagGametype() != 0 {
            CONS_Printf(
                b"%s is now IT!\n\0" as *const u8 as *const libc::c_char,
                (player_names[playernum as usize]).as_mut_ptr(),
    ...
    if G_GametypeHasTeams() != 0 {
        if (NetPacket.packet).newteam() != 0 {
            if playernum == consoleplayer {
                CV_SetValue(
                    &mut cv_playercolor,
                    (NetPacket.packet).newteam() as libc::c_int + 5 as libc::c_int,
                );
            } else if playernum == secondarydisplayplayer {
                CV_SetValue(
                    &mut cv_playercolor2,
...
#[no_mangle]
pub unsafe extern "C" fn D_SetPassword(mut pw: *const libc::c_char) {
    D_MD5PasswordPass(
        pw as *const uint8_t,
        strlen(pw),
        b"basepasswordstorage\0" as *const u8 as *const libc::c_char,
        &mut adminpassmd5 as *mut [uint8_t; 16] as *mut libc::c_void,
    );
    adminpasswordset = true_0 as libc::c_int;
}
unsafe extern "C" fn Command_Changepassword_f() {
    if server == 0 {
        CONS_Printf(
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"password <password>: change remote admin password\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    D_SetPassword(COM_Argv(1 as libc::c_int as size_t));
    CONS_Printf(b"Password set.\n\0" as *const u8 as *const libc::c_char);
}
unsafe extern "C" fn Command_Login_f() {
    let mut pw: *const libc::c_char = 0 as *const libc::c_char;
    if netgame == 0 {
        CONS_Printf(
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"login <password>: Administrator login\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    pw = COM_Argv(1 as libc::c_int as size_t);
    D_MD5PasswordPass(
        pw as *const uint8_t,
        strlen(pw),
        b"basepasswordstorage\0" as *const u8 as *const libc::c_char,
        &mut (*netbuffer).u.md5sum as *mut [uint8_t; 16] as *mut libc::c_void,
    );
    D_MD5PasswordPass(
        ((*netbuffer).u.md5sum).as_mut_ptr(),
        16 as libc::c_int as size_t,
        va(b"PNUM%02d\0" as *const u8 as *const libc::c_char, consoleplayer),
        &mut (*netbuffer).u.md5sum as *mut [uint8_t; 16] as *mut libc::c_void,
    );
    CONS_Printf(
        b"Sending login... (Notice only given if password is correct.)\n\0" as *const u8
            as *const libc::c_char,
    );
    (*netbuffer).packettype = PT_LOGIN as libc::c_int as uint8_t;
    HSendPacket(
...
#[no_mangle]
pub unsafe extern "C" fn IsPlayerAdmin(mut playernum: int32_t) -> boolean {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playernum == adminplayers[i as usize] {
            return true_0 as libc::c_int;
        }
        i += 1;
        i;
...
#[no_mangle]
pub unsafe extern "C" fn SetAdminPlayer(mut playernum: int32_t) {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playernum == adminplayers[i as usize] {
        ...
        if adminplayers[i as usize] == -(1 as libc::c_int) {
            adminplayers[i as usize] = playernum;
            break;
        } else {
            i += 1;
            i;
...
#[no_mangle]
pub unsafe extern "C" fn ClearAdminPlayers() {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn RemoveAdminPlayer(mut playernum: int32_t) {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < 32 as libc::c_int {
        if playernum == adminplayers[i as usize] {
...
unsafe extern "C" fn Command_Verify_f() {
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"promote <playernum>: give admin privileges to a player\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    ...
    playernum = atoi(buf.as_mut_ptr());
    temp = buf.as_mut_ptr();
    let mut p_tmp: *mut uint8_t = temp as *mut libc::c_void as *mut uint8_t;
    let tv: uint8_t = playernum as uint8_t;
    memcpy(
    ...
    p_tmp = p_tmp.offset(1);
    p_tmp;
    temp = p_tmp as *mut libc::c_void as *mut libc::c_char;
...
unsafe extern "C" fn Got_Verification(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut num: int16_t = ({
    ...
    if playernum != serverplayer {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal verification received from %s (serverplayer is %s)\n\0"
                as *const u8 as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
            (player_names[serverplayer as usize]).as_mut_ptr(),
        );
        if server != 0 {
            SendKick(
                playernum as uint8_t,
    ...
    SetAdminPlayer(num as int32_t);
    if num as libc::c_int != consoleplayer {
        return;
    }
    CONS_Printf(
        b"You are now a server administrator.\n\0" as *const u8 as *const libc::c_char,
    );
}
unsafe extern "C" fn Command_RemoveAdmin_f() {
    let mut buf: [libc::c_char; 8] = [0; 8];
    let mut temp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut playernum: int32_t = 0;
    if server == 0 {
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"demote <playernum>: remove admin privileges from a player\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
...
unsafe extern "C" fn Got_Removal(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut num: int16_t = ({
        let mut p_tmp: *mut uint8_t = *cp as *mut libc::c_void as *mut uint8_t;
        let mut b: uint8_t = 0;
        memcpy(
    ...
    if playernum != serverplayer {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal demotion received from %s (serverplayer is %s)\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
            (player_names[serverplayer as usize]).as_mut_ptr(),
        );
    ...
    RemoveAdminPlayer(num as int32_t);
    if num as libc::c_int != consoleplayer {
        return;
    }
    CONS_Printf(
        b"You are no longer a server administrator.\n\0" as *const u8
            as *const libc::c_char,
    );
}
unsafe extern "C" fn Command_MotD_f() {
    let mut i: size_t = 0;
    let mut j: size_t = 0;
    let mut mymotd: *mut libc::c_char = 0 as *mut libc::c_char;
    j = COM_Argc();
    if j < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"motd <message>: Set a message that clients see upon join.\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    ...
    mymotd = Z_MallocAlign(
        ::core::mem::size_of::<[libc::c_char; 254]>() as libc::c_ulong,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut libc::c_char;
    ...
    while *mymotd.offset(i as isize) as libc::c_int != '\0' as i32 {
        if *(*__ctype_b_loc()).offset(*mymotd.offset(i as isize) as libc::c_int as isize)
            as libc::c_int & _ISprint as libc::c_int as libc::c_ushort as libc::c_int
            == 0 || *mymotd.offset(i as isize) as libc::c_int == ';' as i32
        {
            Z_Free(mymotd as *mut libc::c_void);
            return;
        }
        i = i.wrapping_add(1);
        i;
    }
    if (netgame != 0 || multiplayer != 0) && server == 0 {
        SendNetXCmd(XD_SETMOTD, mymotd as *const libc::c_void, i);
    } else {
        strcpy(motd.as_mut_ptr(), mymotd);
        CONS_Printf(b"Message of the day set.\n\0" as *const u8 as *const libc::c_char);
    }
    Z_Free(mymotd as *mut libc::c_void);
}
unsafe extern "C" fn Got_MotD_f(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut mymotd: *mut libc::c_char = Z_MallocAlign(
        ::core::mem::size_of::<[libc::c_char; 254]>() as libc::c_ulong,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ...
    let mut kick: boolean = false_0 as libc::c_int;
    let mut tmp_i: size_t = 0 as libc::c_int as size_t;
    while tmp_i < ::core::mem::size_of::<[libc::c_char; 254]>() as libc::c_ulong
        && {
            let ref mut fresh4 = *mymotd.offset(tmp_i as isize);
            *fresh4 = ({
                let mut p_tmp: *mut libc::c_char = *cp as *mut libc::c_void
                    as *mut libc::c_char;
                let mut b: libc::c_char = 0;
            ...
            *fresh4 as libc::c_int != '\0' as i32
        }
    {
        tmp_i = tmp_i.wrapping_add(1);
        tmp_i;
    }
    *mymotd.offset(tmp_i as isize) = '\0' as i32 as libc::c_char;
    i = 0 as libc::c_int;
    while *mymotd.offset(i as isize) as libc::c_int != '\0' as i32 {
        if *(*__ctype_b_loc()).offset(*mymotd.offset(i as isize) as libc::c_int as isize)
            as libc::c_int & _ISprint as libc::c_int as libc::c_ushort as libc::c_int
    ...
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 || kick != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal motd change received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
...
unsafe extern "C" fn Command_RunSOC() {
    ...
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"runsoc <socfile.soc> or <lumpname>: run a soc\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    } else {
        fn_0 = COM_Argv(1 as libc::c_int as size_t);
    }
    if netgame != 0 && !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        CONS_Printf(
            b"Only the server or a remote admin can use this.\n\0" as *const u8
                as *const libc::c_char,
        );
    ...
    if !(netgame != 0 || multiplayer != 0) {
        if P_RunSOC(fn_0) == 0 {
            CONS_Printf(b"Could not find SOC.\n\0" as *const u8 as *const libc::c_char);
        } else {
            G_SetGameModified(multiplayer);
        }
        return;
    }
    nameonly(strcpy(buf.as_mut_ptr(), fn_0));
    length = (strlen(buf.as_mut_ptr())).wrapping_add(1 as libc::c_int as libc::c_ulong);
    SendNetXCmd(XD_RUNSOC, buf.as_mut_ptr() as *const libc::c_void, length);
}
unsafe extern "C" fn Got_RunSOCcmd(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut filename: [libc::c_char; 256] = [0; 256];
    let mut ncs: filestatus_t = FS_NOTCHECKED;
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal runsoc command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    let mut tmp_i: size_t = 0 as libc::c_int as size_t;
    while tmp_i < 255 as libc::c_int as size_t
        && {
            filename[tmp_i
                as usize] = ({
                let mut p_tmp: *mut libc::c_char = *cp as *mut libc::c_void
            ...
            filename[tmp_i as usize] as libc::c_int != '\0' as i32
        }
    {
        tmp_i = tmp_i.wrapping_add(1);
        tmp_i;
    ...
    if !(strstr(filename.as_mut_ptr(), b".soc\0" as *const u8 as *const libc::c_char))
        .is_null()
    {
        ncs = findfile(
            filename.as_mut_ptr(),
        ...
        if ncs as libc::c_uint != FS_FOUND as libc::c_int as libc::c_uint {
            Command_ExitGame_f();
            if ncs as libc::c_uint == FS_NOTFOUND as libc::c_int as libc::c_uint {
                CONS_Printf(
                    b"The server tried to add %s,\nbut you don't have this file.\nYou need to find it in order\nto play on this server.\n\0"
                        as *const u8 as *const libc::c_char,
                    filename.as_mut_ptr(),
                );
                M_StartMessage(
                    va(
                        b"The server added a file\n(%s)\nthat you do not have.\n\nPress ESC\n\0"
                            as *const u8 as *const libc::c_char,
                        filename.as_mut_ptr(),
                    ),
                    0 as *mut libc::c_void,
                ...
                CONS_Printf(
                    b"Unknown error finding soc file (%s) the server added.\n\0"
                        as *const u8 as *const libc::c_char,
                    filename.as_mut_ptr(),
                );
                M_StartMessage(
                    va(
                        b"Unknown error trying to load a file\nthat the server added\n(%s).\n\nPress ESC\n\0"
                            as *const u8 as *const libc::c_char,
                        filename.as_mut_ptr(),
                    ),
                    0 as *mut libc::c_void,
    ...
    P_RunSOC(filename.as_mut_ptr());
    G_SetGameModified(true_0 as libc::c_int);
}
unsafe extern "C" fn AddedFileContains(
    mut list: *mut addedfile_t,
    mut value: *const libc::c_char,
) -> boolean {
    let mut node: *mut addedfile_t = 0 as *mut addedfile_t;
    node = list;
    while !node.is_null() {
...
unsafe extern "C" fn AddedFilesAdd(
    mut list: *mut *mut addedfile_t,
    mut value: *const libc::c_char,
) {
    let mut item: *mut addedfile_t = Z_CallocAlign(
        ::core::mem::size_of::<addedfile_t>() as libc::c_ulong,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut addedfile_t;
    (*item).value = Z_StrDup(value);
    ListAdd(item as *mut libc::c_void, list as *mut *mut listitem_t);
}
unsafe extern "C" fn AddedFilesRemove(
    mut pItem: *mut libc::c_void,
    mut itemHead: *mut *mut addedfile_t,
) {
    let mut item: *mut addedfile_t = pItem as *mut addedfile_t;
    if item == *itemHead {
        *itemHead = (*item).next;
        if !(*itemHead).is_null() {
            (**itemHead).prev = 0 as *mut addedfile_s;
        }
    } else if ((*item).next).is_null() {
        (*(*item).prev).next = 0 as *mut addedfile_s;
    } else {
        (*(*item).prev).next = (*item).next;
        (*(*item).next).prev = (*item).prev;
    }
    Z_Free((*item).value as *mut libc::c_void);
    Z_Free(item as *mut libc::c_void);
}
unsafe extern "C" fn AddedFilesClearList(mut itemHead: *mut *mut addedfile_t) {
    let mut item: *mut addedfile_t = 0 as *mut addedfile_t;
    let mut next: *mut addedfile_t = 0 as *mut addedfile_t;
    item = *itemHead;
    while !item.is_null() {
        next = (*item).next;
        AddedFilesRemove(item as *mut libc::c_void, itemHead);
        item = next;
    }
}
unsafe extern "C" fn Command_Addfile() {
    let mut argc: size_t = COM_Argc();
    let mut curarg: size_t = 0;
    let mut addedfiles: *mut addedfile_t = 0 as *mut addedfile_t;
    if argc < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"addfile <filename.pk3/wad/lua/soc> [filename2...] [...]: Load add-ons\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    let mut current_block_58: u64;
    curarg = 1 as libc::c_int as size_t;
    while curarg < argc {
        let mut fn_0: *const libc::c_char = 0 as *const libc::c_char;
        let mut p: *const libc::c_char = 0 as *const libc::c_char;
        let mut buf: [libc::c_char; 256] = [0; 256];
        let mut buf_p: *mut libc::c_char = buf.as_mut_ptr();
        let mut i: int32_t = 0;
        let mut musiconly: libc::c_int = 0;
        let mut fileadded: boolean = false_0 as libc::c_int;
        fn_0 = COM_Argv(curarg);
        fileadded = AddedFileContains(addedfiles, fn_0);
        if fileadded != 0 {
            CONS_Alert(
                CONS_WARNING,
                b"Already processed %s, skipping\n\0" as *const u8
                    as *const libc::c_char,
                fn_0,
            );
        } else {
            i = 0 as libc::c_int;
            while *fn_0.offset(i as isize) as libc::c_int != '\0' as i32 {
                if *(*__ctype_b_loc())
                    .offset(*fn_0.offset(i as isize) as libc::c_int as isize)
                    as libc::c_int
                    & _ISprint as libc::c_int as libc::c_ushort as libc::c_int == 0
                    || *fn_0.offset(i as isize) as libc::c_int == ';' as i32
                {
                    AddedFilesClearList(&mut addedfiles);
                    return;
                }
                i += 1;
                i;
            }
            musiconly = W_VerifyNMUSlumps(fn_0, false_0 as libc::c_int);
            if musiconly == -(1 as libc::c_int) {
                AddedFilesAdd(&mut addedfiles, fn_0);
            } else {
                if musiconly == 0 {
                    if netgame != 0
                        && !(server != 0 || IsPlayerAdmin(consoleplayer) != 0)
                    {
                        ...
                        current_block_58 = 715039052867723359;
                    } else {
                        G_SetGameModified(multiplayer);
                        current_block_58 = 18317007320854588510;
                    }
                } else {
                    current_block_58 = 18317007320854588510;
                }
                match current_block_58 {
                    715039052867723359 => {}
                    _ => {
                        if !(netgame != 0 || multiplayer != 0) || musiconly != 0 {
                            P_AddWadFile(fn_0);
                            AddedFilesAdd(&mut addedfiles, fn_0);
                        } else {
                            p = fn_0.offset(strlen(fn_0) as isize);
                            loop {
                                p = p.offset(-1);
                                if !(p >= fn_0) {
                                    break;
                            ...
                            if numwadfiles as libc::c_int >= 65535 as libc::c_int {
                                CONS_Alert(
                                    CONS_ERROR,
                                    b"Too many files loaded to add %s\n\0" as *const u8
                                        as *const libc::c_char,
                                    fn_0,
                                );
                                AddedFilesClearList(&mut addedfiles);
                            ...
                            let mut tmp_i: size_t = 0;
                            tmp_i = 0 as libc::c_int as size_t;
                            while tmp_i < 240 as libc::c_int as size_t
                                && *p.offset(tmp_i as isize) as libc::c_int != '\0' as i32
                            {
                                let mut p_tmp: *mut libc::c_char = buf_p
                                    as *mut libc::c_void as *mut libc::c_char;
                                let tv: libc::c_char = *p.offset(tmp_i as isize);
                                memcpy(
                                    buf_p as *mut libc::c_void,
                                    &tv as *const libc::c_char as *const libc::c_void,
                                    ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
                            ...
                            if tmp_i < 240 as libc::c_int as size_t {
                                let mut p_tmp_0: *mut libc::c_char = buf_p
                                    as *mut libc::c_void as *mut libc::c_char;
                                let tv_0: libc::c_char = '\0' as i32 as libc::c_char;
                                memcpy(
                                    buf_p as *mut libc::c_void,
                            ...
                            fhandle = W_OpenWadFile(&mut fn_0, true_0 as libc::c_int);
                            if !fhandle.is_null() {
                                ...
                                CONS_Debug(
                                    0x400 as libc::c_int,
                                    b"MD5 calc for %s took %f second\n\0" as *const u8
                                        as *const libc::c_char,
                                    fn_0,
                                    ((I_GetTime()).wrapping_sub(t) as libc::c_float
                                        / 35 as libc::c_int as libc::c_float) as libc::c_double,
                                );
                                fclose(fhandle);
                                i = 0 as libc::c_int;
                                while i < numwadfiles as libc::c_int {
                                ...
                                buf_p = buf_p.offset(16 as libc::c_int as isize);
                                AddedFilesAdd(&mut addedfiles, fn_0);
                                if IsPlayerAdmin(consoleplayer) != 0 && server == 0 {
                                    SendNetXCmd(
                                        XD_REQADDFILE,
                                        buf.as_mut_ptr() as *const libc::c_void,
                                        buf_p.offset_from(buf.as_mut_ptr()) as libc::c_long
                                            as size_t,
                                    );
                                } else {
                                    SendNetXCmd(
        ...
        curarg = curarg.wrapping_add(1);
        curarg;
    }
    AddedFilesClearList(&mut addedfiles);
}
unsafe extern "C" fn Command_Addfolder() {
    let mut argc: size_t = COM_Argc();
    let mut curarg: size_t = 0;
    let mut addedfolders: *mut addedfile_t = 0 as *mut addedfile_t;
    if argc < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"addfolder <path> [path2...] [...]: Load add-ons\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    ...
    while curarg < argc {
        ...
        let mut folderadded: boolean = false_0 as libc::c_int;
        fn_0 = COM_Argv(curarg);
        folderadded = AddedFileContains(addedfolders, fn_0);
        if folderadded != 0 {
            CONS_Alert(
                CONS_WARNING,
                b"Already processed %s, skipping\n\0" as *const u8
            ...
            while *fn_0.offset(i as isize) as libc::c_int != '\0' as i32 {
                if *(*__ctype_b_loc())
                    ...
                    || *fn_0.offset(i as isize) as libc::c_int == ';' as i32
                {
                    AddedFilesClearList(&mut addedfolders);
                    return;
                }
                i += 1;
                i;
            ...
            if !(netgame != 0 || multiplayer != 0) {
                P_AddFolder(fn_0);
                AddedFilesAdd(&mut addedfolders, fn_0);
            } else {
                p = fn_0.offset(strlen(fn_0) as isize);
                loop {
                    p = p.offset(-1);
                ...
                if M_IsStringEmpty(fn_0) != 0 {
                    CONS_Alert(
                        CONS_WARNING,
                        b"Folder name is empty, skipping\n\0" as *const u8
                            as *const libc::c_char,
                    );
                } else {
                    if numwadfiles as libc::c_int >= 65535 as libc::c_int {
                    ...
                    if stat == 0 as libc::c_int {
                        ...
                        CONS_Alert(
                            CONS_WARNING,
                            b"Error accessing %s (%s), skipping\n\0" as *const u8
                                as *const libc::c_char,
                            fn_0,
                            strerror(direrror),
                        );
...
unsafe extern "C" fn Got_RequestAddfilecmd(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut filename: [libc::c_char; 241] = [0; 241];
    let mut ncs: filestatus_t = FS_NOTCHECKED;
    let mut md5sum: [uint8_t; 16] = [0; 16];
    let mut kick: boolean = false_0 as libc::c_int;
    ...
    *cp = (*cp).offset(16 as libc::c_int as isize);
    if server == 0 {
        return;
    }
    i = 0 as libc::c_int;
    while filename[i as usize] as libc::c_int != '\0' as i32 {
        if *(*__ctype_b_loc()).offset(filename[i as usize] as libc::c_int as isize)
            as libc::c_int & _ISprint as libc::c_int as libc::c_ushort as libc::c_int
            == 0 || filename[i as usize] as libc::c_int == ';' as i32
        {
            kick = true_0 as libc::c_int;
        }
        i += 1;
    ...
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 || kick != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal addfile command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        SendKick(
    ...
    if ncs as libc::c_uint != FS_FOUND as libc::c_int as libc::c_uint || toomany != 0 {
        ...
        if toomany != 0 {
        ...
        } else if ncs as libc::c_uint == FS_NOTFOUND as libc::c_int as libc::c_uint {
            sprintf(
                message.as_mut_ptr(),
                b"The server doesn't have %s\n\0" as *const u8 as *const libc::c_char,
                filename.as_mut_ptr(),
            );
        } else if ncs as libc::c_uint == FS_MD5SUMBAD as libc::c_int as libc::c_uint {
            sprintf(
                message.as_mut_ptr(),
            ...
            sprintf(
                message.as_mut_ptr(),
                b"Unknown error finding wad file (%s)\n\0" as *const u8
                    as *const libc::c_char,
                filename.as_mut_ptr(),
            );
        }
        CONS_Printf(b"%s\0" as *const u8 as *const libc::c_char, message.as_mut_ptr());
        j = 0 as libc::c_int;
        while j < 32 as libc::c_int {
            if adminplayers[j as usize] != 0 {
                COM_BufAddTextEx(
                    va(
                        b"sayto %d %s\0" as *const u8 as *const libc::c_char,
                        adminplayers[j as usize],
                        message.as_mut_ptr(),
                    ),
                    0 as com_flags_t,
                );
    ...
    COM_BufAddTextEx(
        va(b"addfile %s\n\0" as *const u8 as *const libc::c_char, filename.as_mut_ptr()),
        0 as com_flags_t,
    );
}
unsafe extern "C" fn Got_RequestAddfoldercmd(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut path: [libc::c_char; 241] = [0; 241];
    let mut ncs: filestatus_t = FS_NOTCHECKED;
    let mut kick: boolean = false_0 as libc::c_int;
    let mut toomany: boolean = false_0 as libc::c_int;
    let mut i: int32_t = 0;
    ...
    while tmp_i < 240 as libc::c_int as size_t
        && {
            ...
            path[tmp_i as usize] as libc::c_int != '\0' as i32
        }
    {
        tmp_i = tmp_i.wrapping_add(1);
        tmp_i;
    }
    path[tmp_i as usize] = '\0' as i32 as libc::c_char;
    if server == 0 {
        return;
    }
    i = 0 as libc::c_int;
    while path[i as usize] as libc::c_int != '\0' as i32 {
        if *(*__ctype_b_loc()).offset(path[i as usize] as libc::c_int as isize)
            as libc::c_int & _ISprint as libc::c_int as libc::c_ushort as libc::c_int
            == 0 || path[i as usize] as libc::c_int == ';' as i32
        {
            kick = true_0 as libc::c_int;
        }
        i += 1;
    ...
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 || kick != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal addfolder command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        SendKick(
    ...
    if numwadfiles as libc::c_int >= 65535 as libc::c_int {
        ...
        ncs = findfolder(path.as_mut_ptr());
    }
    if ncs as libc::c_uint != FS_FOUND as libc::c_int as libc::c_uint || toomany != 0 {
        let mut message: [libc::c_char; 256] = [0; 256];
        if toomany != 0 {
            ...
            sprintf(
                message.as_mut_ptr(),
                b"Unknown error finding folder (%s)\n\0" as *const u8
                    as *const libc::c_char,
                path.as_mut_ptr(),
            );
        }
...
unsafe extern "C" fn Got_Addfilecmd(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut filename: [libc::c_char; 241] = [0; 241];
    let mut ncs: filestatus_t = FS_NOTCHECKED;
    let mut md5sum: [uint8_t; 16] = [0; 16];
    let mut tmp_i: size_t = 0 as libc::c_int as size_t;
    ...
    *cp = (*cp).offset(16 as libc::c_int as isize);
    ...
    ncs = findfile(filename.as_mut_ptr(), md5sum.as_mut_ptr(), true_0 as libc::c_int);
    if ncs as libc::c_uint != FS_FOUND as libc::c_int as libc::c_uint
        || P_AddWadFile(filename.as_mut_ptr()) == 0
    {
        Command_ExitGame_f();
        if ncs as libc::c_uint == FS_FOUND as libc::c_int as libc::c_uint {
            CONS_Printf(
                b"The server tried to add %s,\nbut you have too many files added.\nRestart the game to clear loaded files\nand play on this server.\0"
                    as *const u8 as *const libc::c_char,
                filename.as_mut_ptr(),
            );
            M_StartMessage(
            ...
            CONS_Printf(
                b"Unknown error finding wad file (%s) the server added.\n\0" as *const u8
                    as *const libc::c_char,
                filename.as_mut_ptr(),
            );
            M_StartMessage(
...
unsafe extern "C" fn Got_Addfoldercmd(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut path: [libc::c_char; 241] = [0; 241];
        ...
        || P_AddFolder(path.as_mut_ptr()) == 0
    {
        ...
        if ncs as libc::c_uint == FS_FOUND as libc::c_int as libc::c_uint {
            ...
            CONS_Printf(
                b"Unknown error finding folder (%s) the server added.\n\0" as *const u8
                    as *const libc::c_char,
                path.as_mut_ptr(),
            );
            M_StartMessage(
                va(
                    b"Unknown error trying to load a folder\nthat the server added \n(%s).\n\nPress ESC\n\0"
                        as *const u8 as *const libc::c_char,
                    path.as_mut_ptr(),
                ),
                0 as *mut libc::c_void,
...
unsafe extern "C" fn Command_ListWADS_f() {
    let mut i: int32_t = numwadfiles as int32_t;
    let mut tempname: *mut libc::c_char = 0 as *mut libc::c_char;
    CONS_Printf(
        b"There are %d files loaded:\n\0" as *const u8 as *const libc::c_char,
        numwadfiles as libc::c_int,
    );
    i -= 1;
    i;
    while i >= 0 as libc::c_int {
        ...
        } else if i < mainwads as libc::c_int {
            CONS_Printf(
                b"\x82 * %.2d\x80: %s\n\0" as *const u8 as *const libc::c_char,
                i,
                tempname,
            );
        } else if (**wadfiles.offset(i as isize)).important == 0 {
            CONS_Printf(
                b"\x86   %.2d: %s\n\0" as *const u8 as *const libc::c_char,
                i,
                tempname,
...
unsafe extern "C" fn Command_Version_f() {
    CONS_Printf(
        b"Sonic Robo Blast 2 %s (%s %s %s %s) \0" as *const u8 as *const libc::c_char,
    ...
    CONS_Printf(b"Linux \0" as *const u8 as *const libc::c_char);
    if ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong
        == 4 as libc::c_int as libc::c_ulong
    {
        CONS_Printf(b"32-bit \0" as *const u8 as *const libc::c_char);
    } else if ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong
        == 8 as libc::c_int as libc::c_ulong
    {
        CONS_Printf(b"64-bit \0" as *const u8 as *const libc::c_char);
    } else {
        CONS_Printf(b"Bits Unknown \0" as *const u8 as *const libc::c_char);
    }
    CONS_Printf(b"\n\0" as *const u8 as *const libc::c_char);
}
unsafe extern "C" fn Command_ModDetails_f() {
    CONS_Printf(
        b"Mod ID: %d\nMod Version: %d\nCode Base:%d\n\0" as *const u8
            as *const libc::c_char,
        18 as libc::c_int,
...
unsafe extern "C" fn Command_ShowGametype_f() {
    let mut gametypestr: *const libc::c_char = 0 as *const libc::c_char;
    if !(netgame != 0 || multiplayer != 0) {
        CONS_Printf(
            b"Current gametype is %s\n\0" as *const u8 as *const libc::c_char,
            b"Single player\0" as *const u8 as *const libc::c_char,
        );
        return;
    }
    if gametype as libc::c_int >= 0 as libc::c_int
        && (gametype as libc::c_int) < gametypecount as libc::c_int
    {
        gametypestr = Gametype_Names[gametype as usize];
    }
    if !gametypestr.is_null() {
        CONS_Printf(
            b"Current gametype is %s\n\0" as *const u8 as *const libc::c_char,
            gametypestr,
        );
        ...
        CONS_Printf(
            b"Unknown gametype set (%d)\n\0" as *const u8 as *const libc::c_char,
            gametype as libc::c_int,
        );
    };
}
unsafe extern "C" fn Command_Playintro_f() {
    if netgame != 0 {
        return;
    }
    if !dirmenu.is_null() {
...
unsafe extern "C" fn Command_Quit_f() -> ! {
    LUA_HookBool(true_0 as libc::c_int, hook_GameQuit as libc::c_int);
    I_Quit();
}
#[no_mangle]
pub unsafe extern "C" fn ItemFinder_OnChange() {
    if cv_itemfinder.value == 0 {
        return;
    }
    if M_SecretUnlocked(-(5 as libc::c_int), clientGamedata) == 0 {
        CONS_Printf(
            b"You haven't earned this yet.\n\0" as *const u8 as *const libc::c_char,
        );
        CV_StealthSetValue(&mut cv_itemfinder, 0 as libc::c_int);
        return;
    }
}
unsafe extern "C" fn PointLimit_OnChange() {
    if server != 0 && Playing() != 0
        && gametyperules & GTR_POINTLIMIT as libc::c_int as uint32_t == 0
    {
        if cv_pointlimit.value != 0 {
            CV_StealthSetValue(&mut cv_pointlimit, 0 as libc::c_int);
        }
        return;
    }
    if cv_pointlimit.value != 0 {
        CONS_Printf(
            b"Levels will end after %s scores %d point%s.\n\0" as *const u8
                as *const libc::c_char,
            if G_GametypeHasTeams() != 0 {
                b"a team\0" as *const u8 as *const libc::c_char
            } else {
                b"someone\0" as *const u8 as *const libc::c_char
            },
            cv_pointlimit.value,
            if cv_pointlimit.value > 1 as libc::c_int {
                b"s\0" as *const u8 as *const libc::c_char
            } else {
                b"\0" as *const u8 as *const libc::c_char
            },
        ...
        CONS_Printf(b"Point limit disabled\n\0" as *const u8 as *const libc::c_char);
    }
}
unsafe extern "C" fn NumLaps_OnChange() {
    if gametyperules & (GTR_RACE as libc::c_int | GTR_LIVES as libc::c_int) as uint32_t
        == GTR_RACE as libc::c_int as uint32_t
    {
        CONS_Printf(
            b"Number of laps set to %d\n\0" as *const u8 as *const libc::c_char,
            cv_numlaps.value,
        );
    }
}
unsafe extern "C" fn NetTimeout_OnChange() {
    connectiontimeout = cv_nettimeout.value as tic_t;
}
unsafe extern "C" fn JoinTimeout_OnChange() {
    jointimeout = cv_jointimeout.value as tic_t;
}
unsafe extern "C" fn CoopStarposts_OnChange() {
    let mut i: int32_t = 0;
    if !(netgame != 0 || multiplayer != 0) || G_GametypeUsesCoopStarposts() == 0 {
        return;
    }
    match cv_coopstarposts.value {
        0 => {
            CONS_Printf(
                b"Starposts are now per-player.\n\0" as *const u8 as *const libc::c_char,
            );
        }
        1 => {
            CONS_Printf(
                b"Starposts are now shared between players.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        2 => {
            CONS_Printf(
                b"Players now only spawn when starposts are hit.\n\0" as *const u8
                    as *const libc::c_char,
            );
            return;
        }
    ...
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0) {
            if !(players[i as usize].spectator == 0) {
                ...
                {
                    P_SpectatorJoinGame(&mut *players.as_mut_ptr().offset(i as isize));
                }
            }
        }
        i += 1;
...
unsafe extern "C" fn CoopLives_OnChange() {
    let mut i: int32_t = 0;
    if !(netgame != 0 || multiplayer != 0) || G_GametypeUsesCoopLives() == 0 {
        return;
    }
    match cv_cooplives.value {
        0 => {
            CONS_Printf(
                b"Players can now respawn indefinitely.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        1 => {
            CONS_Printf(
                b"Lives are now per-player.\n\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
        2 => {
            CONS_Printf(
                b"Players can now steal lives to avoid game over.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        3 => {
            CONS_Printf(
                b"Lives are now shared between players.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        _ => {}
...
unsafe extern "C" fn ExitMove_OnChange() {
    let mut i: uint8_t = 0;
    if !(netgame != 0 || multiplayer != 0)
    ...
    if cv_exitmove.value != 0 {
        ...
        while (i as libc::c_int) < 32 as libc::c_int {
            if playeringame[i as usize] != 0 && !(players[i as usize].mo).is_null() {
                if !((*players[i as usize].mo).target).is_null()
                    && (*(*players[i as usize].mo).target).type_0 as libc::c_uint
                        == MT_SIGN as libc::c_int as libc::c_uint
                {
                    P_SetTarget2(
                        &mut (*(*players.as_mut_ptr().offset(i as isize)).mo).target,
                        0 as *mut mobj_t,
                    );
                }
                ...
                {
                    P_GiveFinishFlags(&mut *players.as_mut_ptr().offset(i as isize));
                }
            }
            i = i.wrapping_add(1);
            i;
        ...
        CONS_Printf(
            b"Players can now move after completing the level.\n\0" as *const u8
                as *const libc::c_char,
        );
    } else {
        CONS_Printf(
            b"Players can no longer move after completing the level.\n\0" as *const u8
                as *const libc::c_char,
        );
    };
}
#[no_mangle]
pub static mut timelimitintics: uint32_t = 0 as libc::c_int as uint32_t;
unsafe extern "C" fn TimeLimit_OnChange() {
    if server != 0 && Playing() != 0 && cv_timelimit.value != 0 as libc::c_int
        && gametyperules & GTR_TIMELIMIT as libc::c_int as uint32_t == 0
    {
        CV_SetValue(&mut cv_timelimit, 0 as libc::c_int);
        return;
    }
    if cv_timelimit.value != 0 as libc::c_int {
        CONS_Printf(
            b"Levels will end after %d minute%s.\n\0" as *const u8
                as *const libc::c_char,
            cv_timelimit.value,
            if cv_timelimit.value == 1 as libc::c_int {
                b"\0" as *const u8 as *const libc::c_char
            } else {
                b"s\0" as *const u8 as *const libc::c_char
            },
        );
        timelimitintics = (cv_timelimit.value * 60 as libc::c_int * 35 as libc::c_int)
            as uint32_t;
        if G_TagGametype() != 0 {
            timelimitintics = timelimitintics
                .wrapping_add(hidetime * 35 as libc::c_int as tic_t);
        }
    } else if netgame != 0 || multiplayer != 0 {
        CONS_Printf(b"Time limit disabled\n\0" as *const u8 as *const libc::c_char);
    }
}
#[no_mangle]
pub unsafe extern "C" fn D_GameTypeChanged(mut lastgametype: int32_t) {
    if netgame != 0 {
        let mut oldgt: *const libc::c_char = 0 as *const libc::c_char;
        let mut newgt: *const libc::c_char = 0 as *const libc::c_char;
        if lastgametype >= 0 as libc::c_int
            && lastgametype < gametypecount as libc::c_int
        {
            oldgt = Gametype_Names[lastgametype as usize];
        }
        if gametype as libc::c_int >= 0 as libc::c_int
            && lastgametype < gametypecount as libc::c_int
        {
            newgt = Gametype_Names[gametype as usize];
        }
        if !oldgt.is_null() && !newgt.is_null() {
            CONS_Printf(
                b"Gametype was changed from %s to %s\n\0" as *const u8
                    as *const libc::c_char,
                oldgt,
                newgt,
            );
    ...
    if server != 0 && (multiplayer != 0 || netgame != 0) {
        if gametype as libc::c_int == GT_COMPETITION as libc::c_int {
            CV_SetValue(&mut cv_itemrespawn, 0 as libc::c_int);
        } else if cv_itemrespawn.changed == 0
            || lastgametype == GT_COMPETITION as libc::c_int
        {
            CV_SetValue(&mut cv_itemrespawn, 1 as libc::c_int);
        }
        match gametype as libc::c_int {
            0 => {
                if cv_itemrespawntime.changed == 0 {
                    CV_Set(&mut cv_itemrespawntime, cv_itemrespawntime.defaultvalue);
                }
            }
            3 | 4 => {
                if cv_timelimit.changed == 0 && cv_pointlimit.changed == 0 {
                    CV_SetValue(&mut cv_pointlimit, 0 as libc::c_int);
                    CV_SetValue(&mut cv_timelimit, 10 as libc::c_int);
                }
                if cv_itemrespawntime.changed == 0 {
                    CV_Set(&mut cv_itemrespawntime, cv_itemrespawntime.defaultvalue);
                }
            ...
            5 | 6 => {
                if cv_timelimit.changed == 0 && cv_pointlimit.changed == 0 {
                    CV_SetValue(&mut cv_timelimit, 5 as libc::c_int);
                    CV_SetValue(&mut cv_pointlimit, 0 as libc::c_int);
                }
                if cv_itemrespawntime.changed == 0 {
                    CV_Set(&mut cv_itemrespawntime, cv_itemrespawntime.defaultvalue);
            ...
            7 => {
                if cv_timelimit.changed == 0 && cv_pointlimit.changed == 0 {
                    CV_SetValue(&mut cv_timelimit, 0 as libc::c_int);
                    CV_SetValue(&mut cv_pointlimit, 5 as libc::c_int);
                }
                if cv_itemrespawntime.changed == 0 {
                    CV_Set(&mut cv_itemrespawntime, cv_itemrespawntime.defaultvalue);
                }
            ...
            _ => {
                if cv_timelimit.changed == 0 && cv_pointlimit.changed == 0 {
                    CV_SetValue(&mut cv_timelimit, timelimits[gametype as usize]);
                    CV_SetValue(&mut cv_pointlimit, pointlimits[gametype as usize]);
                }
                if cv_itemrespawntime.changed == 0 {
                    CV_Set(&mut cv_itemrespawntime, cv_itemrespawntime.defaultvalue);
                }
    ...
    if server != 0 {
        ...
        } else if (cv_pointlimit.changed as libc::c_int != 0
            || cv_timelimit.changed as libc::c_int != 0) && cv_pointlimit.value != 0
        {
            if lastgametype != GT_CTF as libc::c_int
                && gametype as libc::c_int == GT_CTF as libc::c_int
            {
                CV_SetValue(
                    &mut cv_pointlimit,
                    cv_pointlimit.value / 500 as libc::c_int,
                );
            } else if lastgametype == GT_CTF as libc::c_int
                && gametype as libc::c_int != GT_CTF as libc::c_int
            {
                CV_SetValue(
                    &mut cv_pointlimit,
    ...
    if splitscreen == 0 && G_GametypeHasSpectators() != 0 {
        ...
        while i < 32 as libc::c_int {
            if playeringame[i as usize] != 0 {
                players[i as usize].ctfteam = 0 as libc::c_int;
                players[i as usize]
    ...
    if G_GametypeHasTeams() != 0 {
        ...
        while i_0 < 32 as libc::c_int {
            if playeringame[i_0 as usize] != 0 {
                players[i_0 as usize].ctfteam = 0 as libc::c_int;
            }
            i_0 += 1;
            i_0;
        }
        if server != 0 || IsPlayerAdmin(consoleplayer) != 0 {
            CV_StealthSetValue(&mut cv_teamscramble, 0 as libc::c_int);
            teamscramble = 0 as libc::c_int as int16_t;
        }
    }
}
unsafe extern "C" fn Ringslinger_OnChange() {
    if M_SecretUnlocked(-(3 as libc::c_int), serverGamedata) == 0 && netgame == 0
        && cv_ringslinger.value != 0 && cv_debug == 0
    {
        CONS_Printf(
            b"You haven't earned this yet.\n\0" as *const u8 as *const libc::c_char,
        );
        CV_StealthSetValue(&mut cv_ringslinger, 0 as libc::c_int);
        return;
    }
    if cv_ringslinger.value != 0 {
        G_SetUsedCheats(false_0 as libc::c_int);
    }
}
unsafe extern "C" fn Gravity_OnChange() {
    if M_SecretUnlocked(-(3 as libc::c_int), serverGamedata) == 0 && netgame == 0
        && cv_debug == 0 && strcmp(cv_gravity.string, cv_gravity.defaultvalue) != 0
    {
        CONS_Printf(
            b"You haven't earned this yet.\n\0" as *const u8 as *const libc::c_char,
        );
        CV_StealthSet(&mut cv_gravity, cv_gravity.defaultvalue);
        return;
    }
    if netgame != 0 {
        CV_StealthSet(&mut cv_gravity, cv_gravity.defaultvalue);
    ...
    if CV_IsSetToDefault(&mut cv_gravity) == 0 {
        G_SetUsedCheats(false_0 as libc::c_int);
    }
    gravity = cv_gravity.value;
}
unsafe extern "C" fn SoundTest_OnChange() {
    let mut sfxfreeint: int32_t = sfxfree as int32_t;
    if cv_soundtest.value < 0 as libc::c_int {
        CV_SetValue(&mut cv_soundtest, sfxfreeint - 1 as libc::c_int);
        return;
    }
    if cv_soundtest.value >= sfxfreeint {
        CV_SetValue(&mut cv_soundtest, 0 as libc::c_int);
        return;
    }
    S_StopSounds();
    S_StartSound(0 as *const libc::c_void, cv_soundtest.value as sfxenum_t);
}
unsafe extern "C" fn AutoBalance_OnChange() {
    autobalance = cv_autobalance.value as int16_t;
}
unsafe extern "C" fn TeamScramble_OnChange() {
    let mut i: int16_t = 0 as libc::c_int as int16_t;
    let mut j: int16_t = 0 as libc::c_int as int16_t;
    let mut playercount: int16_t = 0 as libc::c_int as int16_t;
    let mut repick: boolean = true_0 as libc::c_int;
    let mut blue: int32_t = 0 as libc::c_int;
    let mut red: int32_t = 0 as libc::c_int;
    let mut maxcomposition: int32_t = 0 as libc::c_int;
    let mut newteam: int16_t = 0 as libc::c_int as int16_t;
    let mut retries: int32_t = 0 as libc::c_int;
    let mut success: boolean = false_0 as libc::c_int;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || gamestate as libc::c_uint == GS_INTERMISSION as libc::c_int as libc::c_uint)
    {
        return;
    }
    if cv_teamscramble.value == 0 {
        teamscramble = 0 as libc::c_int as int16_t;
    }
    if G_GametypeHasTeams() == 0 && (server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        CONS_Alert(
            CONS_NOTICE,
            b"This command cannot be used in this gametype.\n\0" as *const u8
                as *const libc::c_char,
    ...
    loop {
        memset(
            &mut scrambleplayers as *mut [int16_t; 32] as *mut libc::c_void,
            0 as libc::c_int,
            ::core::mem::size_of::<[int16_t; 32]>() as libc::c_ulong,
        );
        memset(
            &mut scrambleteams as *mut [int16_t; 32] as *mut libc::c_void,
            0 as libc::c_int,
            ::core::mem::size_of::<[int16_t; 32]>() as libc::c_ulong,
        );
        scramblecount = 0 as libc::c_int as int16_t;
        scrambletotal = scramblecount;
        playercount = 0 as libc::c_int as int16_t;
        newteam = playercount;
        maxcomposition = newteam as int32_t;
        red = maxcomposition;
        blue = red;
        repick = true_0 as libc::c_int;
        i = 0 as libc::c_int as int16_t;
        while (i as libc::c_int) < 32 as libc::c_int {
            if playeringame[i as usize] != 0 && players[i as usize].spectator == 0 {
                scrambleplayers[playercount as usize] = i;
                playercount += 1;
                playercount;
            }
            i += 1;
        ...
        if (playercount as libc::c_int) < 2 as libc::c_int {
            CV_StealthSetValue(&mut cv_teamscramble, 0 as libc::c_int);
            return;
        }
        if cv_teamscramble.value == 1 as libc::c_int {
            maxcomposition = playercount as libc::c_int / 2 as libc::c_int;
            i = 0 as libc::c_int as int16_t;
            while (i as libc::c_int) < playercount as libc::c_int {
                if repick != 0 {
                    newteam = (M_RandomByte() as libc::c_int % 2 as libc::c_int
                        + 1 as libc::c_int) as int16_t;
                }
                if red == maxcomposition || blue == maxcomposition {
                    if red == maxcomposition {
                        newteam = 2 as libc::c_int as int16_t;
                    } else {
                        newteam = 1 as libc::c_int as int16_t;
                    }
                    repick = false_0 as libc::c_int;
                }
                scrambleteams[i as usize] = newteam;
                if newteam as libc::c_int == 1 as libc::c_int {
                    red += 1;
                    red;
                } else {
                    blue += 1;
        ...
        } else if cv_teamscramble.value == 2 as libc::c_int {
            i = 1 as libc::c_int as int16_t;
            while (i as libc::c_int) < playercount as libc::c_int {
                j = i;
                while (j as libc::c_int) < playercount as libc::c_int {
                    let mut tempplayer: int16_t = 0 as libc::c_int as int16_t;
                    if players[scrambleplayers[(i as libc::c_int - 1 as libc::c_int)
                            as usize] as usize]
                        .score > players[scrambleplayers[j as usize] as usize].score
                    {
                        tempplayer = scrambleplayers[(i as libc::c_int
                            - 1 as libc::c_int) as usize];
                        scrambleplayers[(i as libc::c_int - 1 as libc::c_int)
                            as usize] = scrambleplayers[j as usize];
                        scrambleplayers[j as usize] = tempplayer;
                    }
                    j += 1;
                    j;
                }
            ...
            while (i as libc::c_int) < playercount as libc::c_int {
                if repick != 0 {
                    newteam = (M_RandomByte() as libc::c_int % 2 as libc::c_int
                        + 1 as libc::c_int) as int16_t;
                    repick = false_0 as libc::c_int;
                } else if i as libc::c_int != 2 as libc::c_int {
                    newteam = (3 as libc::c_int - newteam as libc::c_int) as int16_t;
                }
                scrambleteams[i as usize] = newteam;
                i += 1;
                i;
        ...
        i = 0 as libc::c_int as int16_t;
        while (i as libc::c_int) < playercount as libc::c_int {
            if players[scrambleplayers[i as usize] as usize].ctfteam
                != scrambleteams[i as usize] as libc::c_int
            {
                success = true_0 as libc::c_int;
            }
            i += 1;
            i;
        }
        if !(success == 0 && retries < 5 as libc::c_int) {
            break;
        }
        retries += 1;
        retries;
    ...
    if cv_teamscramble.value != 0 {
        ...
        teamscramble = cv_teamscramble.value as int16_t;
        if !(gamestate as libc::c_uint == GS_INTERMISSION as libc::c_int as libc::c_uint
            && cv_scrambleonchange.value != 0)
        {
            CONS_Printf(
                b"Teams will be scrambled next round.\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
}
unsafe extern "C" fn Hidetime_OnChange() {
    if Playing() != 0 && G_TagGametype() != 0
        && leveltime >= hidetime * 35 as libc::c_int as tic_t
    {
        CV_StealthSetValue(&mut cv_hidetime, hidetime as int32_t);
        return;
    }
    hidetime = cv_hidetime.value as tic_t;
    if G_TagGametype() != 0 {
        timelimitintics = ((cv_timelimit.value * 60 as libc::c_int * 35 as libc::c_int)
            as tic_t)
            .wrapping_add(hidetime * 35 as libc::c_int as tic_t);
...
unsafe extern "C" fn Command_Showmap_f() {
    if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn Command_Mapmd5_f() {
    if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint {
        let mut i: int32_t = 0;
        ...
        while i < 16 as libc::c_int {
            sprintf(
                &mut *md5tmp.as_mut_ptr().offset((i * 2 as libc::c_int) as isize)
                    as *mut libc::c_char,
                b"%02x\0" as *const u8 as *const libc::c_char,
                mapmd5[i as usize] as libc::c_int,
            );
            i += 1;
            i;
        }
...
#[no_mangle]
pub unsafe extern "C" fn D_SendExitLevel(mut cheat: boolean) {
    let mut buf: [uint8_t; 8] = [0; 8];
    let mut buf_p: *mut uint8_t = buf.as_mut_ptr();
    let mut p_tmp: *mut uint8_t = buf_p as *mut libc::c_void as *mut uint8_t;
    let tv: uint8_t = cheat as uint8_t;
    memcpy(
        buf_p as *mut libc::c_void,
        &tv as *const uint8_t as *const libc::c_void,
        ::core::mem::size_of::<uint8_t>() as libc::c_ulong,
    ...
    p_tmp = p_tmp.offset(1);
    p_tmp;
    buf_p = p_tmp as *mut libc::c_void as *mut uint8_t;
    SendNetXCmd(
        XD_EXITLEVEL,
        &mut buf as *mut [uint8_t; 8] as *const libc::c_void,
        buf_p.offset_from(buf.as_mut_ptr()) as libc::c_long as size_t,
    );
}
unsafe extern "C" fn Command_ExitLevel_f() {
    if !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        CONS_Printf(
            b"Only the server or a remote admin can use this.\n\0" as *const u8
                as *const libc::c_char,
        ...
        || demoplayback != 0
    {
        ...
        D_SendExitLevel(true_0 as libc::c_int);
    };
}
unsafe extern "C" fn Got_ExitLevelcmd(
    mut cp: *mut *mut uint8_t,
    mut playernum: int32_t,
) {
    let mut cheat: boolean = false_0 as libc::c_int;
    cheat = ({
        let mut p_tmp: *mut uint8_t = *cp as *mut libc::c_void as *mut uint8_t;
        let mut b: uint8_t = 0;
        memcpy(
    ...
    if playernum != serverplayer && IsPlayerAdmin(playernum) == 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Illegal exitlevel command received from %s\n\0" as *const u8
                as *const libc::c_char,
            (player_names[playernum as usize]).as_mut_ptr(),
        );
        if server != 0 {
    ...
    if G_CoopGametype() != 0 && cheat != 0 {
        G_SetUsedCheats(false_0 as libc::c_int);
    }
    G_ExitLevel();
}
unsafe extern "C" fn Command_Displayplayer_f() {
    CONS_Printf(
        b"Displayplayer is %d\n\0" as *const u8 as *const libc::c_char,
        displayplayer,
    );
}
#[no_mangle]
pub unsafe extern "C" fn Command_ExitGame_f() {
    let mut i: int32_t = 0;
    ...
    players[1 as libc::c_int as usize].availabilities = R_GetSkinAvailabilities();
    players[consoleplayer as usize]
        .availabilities = players[1 as libc::c_int as usize].availabilities;
...
#[no_mangle]
pub unsafe extern "C" fn Command_Retry_f() {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || gamestate as libc::c_uint == GS_INTERMISSION as libc::c_int as libc::c_uint)
    {
        CONS_Printf(
        ...
        CONS_Printf(
            b"This only works in single player.\n\0" as *const u8 as *const libc::c_char,
        );
    } else if players[consoleplayer as usize].lives as libc::c_int <= 1 as libc::c_int {
        CONS_Printf(
            b"You can't retry without any lives remaining!\n\0" as *const u8
                as *const libc::c_char,
        );
    } else if G_IsSpecialStage(gamemap as int32_t) != 0 {
        CONS_Printf(
            b"You can't retry special stages!\n\0" as *const u8 as *const libc::c_char,
        );
    } else {
...
unsafe extern "C" fn Command_Isgamemodified_f() {
    if savemoddata != 0 {
        CONS_Printf(
            b"modifiedgame is true, but you can save time data in this mod.\n\0"
                as *const u8 as *const libc::c_char,
        );
    } else if modifiedgame != 0 {
        CONS_Printf(
            b"modifiedgame is true, time data can't be saved\n\0" as *const u8
                as *const libc::c_char,
        );
    } else {
        CONS_Printf(
            b"modifiedgame is false, you can save time data\n\0" as *const u8
                as *const libc::c_char,
        );
    };
}
unsafe extern "C" fn Command_Cheats_f() {
    if COM_CheckParm(b"off\0" as *const u8 as *const libc::c_char) != 0 {
        if !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
            CONS_Printf(
                b"Only the server or a remote admin can use this.\n\0" as *const u8
                    as *const libc::c_char,
    ...
    if CV_CheatsEnabled() != 0 {
        CONS_Printf(
            b"At least one CHEAT-marked variable has been changed -- Cheats are enabled.\n\0"
                as *const u8 as *const libc::c_char,
        );
        if server != 0 || IsPlayerAdmin(consoleplayer) != 0 {
            CONS_Printf(
                b"Type CHEATS OFF to reset all cheat variables to default.\n\0"
                    as *const u8 as *const libc::c_char,
            );
        }
    } else {
        CONS_Printf(
            b"No CHEAT-marked variables are changed -- Cheats are disabled.\n\0"
                as *const u8 as *const libc::c_char,
        );
    };
}
unsafe extern "C" fn ForceSkin_OnChange() {
    if (server != 0 || IsPlayerAdmin(consoleplayer) != 0)
        && (cv_forceskin.value < -(1 as libc::c_int) || cv_forceskin.value >= numskins)
    {
        if cv_forceskin.value == -(2 as libc::c_int) {
            CV_SetValue(&mut cv_forceskin, numskins - 1 as libc::c_int);
        } else {
            if menuactive == 0 {
                CONS_Printf(
                    b"Valid skin numbers are 0 to %d (-1 disables)\n\0" as *const u8
                        as *const libc::c_char,
                    numskins - 1 as libc::c_int,
                );
            }
            CV_SetValue(&mut cv_forceskin, -(1 as libc::c_int));
        }
        return;
    }
    if !(netgame != 0 || multiplayer != 0) {
    ...
    if cv_forceskin.value < 0 as libc::c_int {
        CONS_Printf(
            b"The server has lifted the forced skin restrictions.\n\0" as *const u8
                as *const libc::c_char,
        );
    } else {
        CONS_Printf(
            b"The server is restricting all players to skin \"%s\".\n\0" as *const u8
                as *const libc::c_char,
            (skins[cv_forceskin.value as usize].name).as_mut_ptr(),
        );
        ForceAllSkins(cv_forceskin.value);
    };
}
unsafe extern "C" fn Name_OnChange() {
    if cv_mute.value != 0 && !(server != 0 || IsPlayerAdmin(consoleplayer) != 0) {
        CONS_Alert(
            CONS_NOTICE,
            b"You may not change your name when chat is muted.\n\0" as *const u8
                as *const libc::c_char,
        );
        CV_StealthSet(
            &mut cv_playername,
...
unsafe extern "C" fn Name2_OnChange() {
    if cv_mute.value != 0 {
        CONS_Alert(
            CONS_NOTICE,
            b"You may not change your name when chat is muted.\n\0" as *const u8
        ...
        CV_StealthSet(
            &mut cv_playername2,
            (player_names[secondarydisplayplayer as usize]).as_mut_ptr(),
        );
    } else {
        SendNameAndColor2();
    };
}
unsafe extern "C" fn Skin_OnChange() {
    if Playing() == 0 {
        return;
    }
    if !(cv_debug != 0 || devparm != 0) && !(multiplayer != 0 || netgame != 0)
    ...
    if CanChangeSkin(consoleplayer) as libc::c_int != 0
        && P_PlayerMoving(consoleplayer) == 0
    {
        SendNameAndColor();
    } else {
        CONS_Alert(
            CONS_NOTICE,
            b"You can't change your skin at the moment.\n\0" as *const u8
                as *const libc::c_char,
        );
        CV_StealthSet(
            &mut cv_skin,
...
unsafe extern "C" fn Skin2_OnChange() {
    if Playing() == 0 || splitscreen == 0 {
        return;
    }
    if CanChangeSkin(secondarydisplayplayer) as libc::c_int != 0
        && P_PlayerMoving(secondarydisplayplayer) == 0
    {
        SendNameAndColor2();
    } else {
        CONS_Alert(
        ...
        CV_StealthSet(
            &mut cv_skin2,
            (skins[players[secondarydisplayplayer as usize].skin as usize].name)
                .as_mut_ptr(),
        );
    };
}
unsafe extern "C" fn Color_OnChange() {
    if Playing() == 0 {
        if cv_playercolor.value == 0
            || skincolors[cv_playercolor.value as usize].accessible == 0
        {
            CV_StealthSetValue(&mut cv_playercolor, lastgoodcolor as int32_t);
        }
    } else {
        if !(cv_debug != 0 || devparm != 0) && !(multiplayer != 0 || netgame != 0) {
            CV_StealthSet(
        ...
        if P_PlayerMoving(consoleplayer) == 0
            && skincolors[players[consoleplayer as usize].skincolor as usize].accessible
                == true_0 as libc::c_int
        {
            SendNameAndColor();
    ...
    lastgoodcolor = cv_playercolor.value as uint16_t;
}
unsafe extern "C" fn Color2_OnChange() {
    if Playing() == 0 || splitscreen == 0 {
        if cv_playercolor2.value == 0
            || skincolors[cv_playercolor2.value as usize].accessible == 0
        {
            CV_StealthSetValue(&mut cv_playercolor2, lastgoodcolor2 as int32_t);
        }
    } else if P_PlayerMoving(secondarydisplayplayer) == 0
        && skincolors[players[secondarydisplayplayer as usize].skincolor as usize]
            .accessible == true_0 as libc::c_int
    {
        SendNameAndColor2();
    } else {
        CV_StealthSetValue(
            &mut cv_playercolor2,
            players[secondarydisplayplayer as usize].skincolor as int32_t,
        );
    }
    lastgoodcolor2 = cv_playercolor2.value as uint16_t;
}
unsafe extern "C" fn Mute_OnChange() {
    if server != 0 || IsPlayerAdmin(consoleplayer) != 0 {
        return;
    }
    if cv_mute.value != 0 {
        CONS_Printf(b"Chat has been muted.\n\0" as *const u8 as *const libc::c_char);
    } else {
        CONS_Printf(b"Chat is no longer muted.\n\0" as *const u8 as *const libc::c_char);
    };
}
unsafe extern "C" fn DummyConsvar_OnChange() {
    if cv_dummyconsvar.value == 1 as libc::c_int {
        CV_SetValue(&mut cv_dummyconsvar, 0 as libc::c_int);
        CV_ClearChangedFlags();
    }
}
unsafe extern "C" fn Command_ShowScores_f() {
    let mut i: uint8_t = 0;
    if !(netgame != 0 || multiplayer != 0) {
        CONS_Printf(
            b"This only works in a netgame.\n\0" as *const u8 as *const libc::c_char,
    ...
    CONS_Printf(
        b"The pointlimit is %d\n\0" as *const u8 as *const libc::c_char,
        cv_pointlimit.value,
    );
}
unsafe extern "C" fn Command_ShowTime_f() {
    if !(netgame != 0 || multiplayer != 0) {
        CONS_Printf(
            b"This only works in a netgame.\n\0" as *const u8 as *const libc::c_char,
        );
    ...
    CONS_Printf(
        b"The current time is %f.\nThe timelimit is %f\n\0" as *const u8
            as *const libc::c_char,
        leveltime as libc::c_double / 35 as libc::c_int as libc::c_double,
        timelimitintics as libc::c_double / 35 as libc::c_int as libc::c_double,
    );
}
unsafe extern "C" fn BaseNumLaps_OnChange() {
    if gametyperules & (GTR_RACE as libc::c_int | GTR_LIVES as libc::c_int) as uint32_t
        == GTR_RACE as libc::c_int as uint32_t
    {
        if cv_basenumlaps.value != 0 {
            CONS_Printf(
                b"Number of laps will be changed to map defaults next round.\n\0"
                    as *const u8 as *const libc::c_char,
            );
        } else {
            CONS_Printf(
                b"Number of laps will be changed to %d next round.\n\0" as *const u8
                    as *const libc::c_char,
