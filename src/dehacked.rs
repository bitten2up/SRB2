...
extern "C" {
    ...
    fn clear_levels();
    fn clear_conditionsets();
    fn clear_emblems();
    fn clear_unlockables();
    fn readconditionset(f: *mut MYFILE, setnum: uint8_t);
    fn readunlockable(f: *mut MYFILE, num: int32_t);
    fn readmenu(f: *mut MYFILE, num: int32_t);
    fn get_menutype(word: *const libc::c_char) -> menutype_t;
    fn readhuditem(f: *mut MYFILE, num: int32_t);
    fn get_huditem(word: *const libc::c_char) -> hudnum_t;
    fn readsound(f: *mut MYFILE, num: int32_t);
    fn get_sfx(word: *const libc::c_char) -> sfxenum_t;
    fn readframe(f: *mut MYFILE, num: int32_t);
    fn get_state(word: *const libc::c_char) -> statenum_t;
    fn readtextprompt(f: *mut MYFILE, num: int32_t);
    fn readcutscene(f: *mut MYFILE, num: int32_t);
    fn readgametype(f: *mut MYFILE, gtname: *mut libc::c_char);
    fn readlevelheader(f: *mut MYFILE, num: int32_t);
    fn M_MapNumber(first: libc::c_char, second: libc::c_char) -> int32_t;
    fn readspriteinfo(f: *mut MYFILE, num: int32_t, sprite2: boolean);
    fn get_sprite2(word: *const libc::c_char) -> playersprite_t;
    fn get_sprite(word: *const libc::c_char) -> spritenum_t;
    static mut free_spr2: playersprite_t;
    fn readsprite2(f: *mut MYFILE, num: int32_t);
    fn readskincolor(f: *mut MYFILE, num: int32_t);
    fn get_skincolor(word: *const libc::c_char) -> skincolornum_t;
    fn readthing(f: *mut MYFILE, num: int32_t);
    fn get_mobjtype(word: *const libc::c_char) -> mobjtype_t;
    fn readextraemblemdata(f: *mut MYFILE, num: int32_t);
    fn reademblemdata(f: *mut MYFILE, num: int32_t);
    fn readPlayer(f: *mut MYFILE, num: int32_t);
    fn readwipes(f: *mut MYFILE);
    fn readmaincfg(f: *mut MYFILE);
    fn readfreeslots(f: *mut MYFILE);
...
#[no_mangle]
pub static mut deh_loaded: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut gamedataadded: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut titlechanged: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut introchanged: boolean = false_0 as libc::c_int;
static mut dbg_line: libc::c_int = 0;
static mut deh_num_warning: int32_t = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn deh_warning(mut first: *const libc::c_char, mut args: ...) {
    let mut argptr: ::core::ffi::VaListImpl;
    let mut buf: *mut libc::c_char = Z_MallocAlign(
    ...
    argptr = args.clone();
    vsnprintf(buf, 1000 as libc::c_int as libc::c_ulong, first, argptr.as_va_list());
    if dbg_line == -(1 as libc::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn deh_strlcpy(
    mut dst: *mut libc::c_char,
    mut src: *const libc::c_char,
    mut size: size_t,
    mut warntext: *const libc::c_char,
) {
    let mut len: size_t = (strlen(src)).wrapping_add(1 as libc::c_int as libc::c_ulong);
    if len > size {
        deh_warning(
            b"%s exceeds max length of %s\0" as *const u8 as *const libc::c_char,
            warntext,
            sizeu1(size.wrapping_sub(1 as libc::c_int as size_t)),
        );
    }
    strlcpy(dst, src, size);
}
#[inline(always)]
unsafe extern "C" fn myfget_color(mut f: *mut MYFILE) -> libc::c_char {
    let fresh0 = (*f).curpos;
    (*f).curpos = ((*f).curpos).offset(1);
    let mut c: libc::c_char = *fresh0;
    if c as libc::c_int == '^' as i32 {
        return '^' as i32 as libc::c_char;
    }
    if c as libc::c_int >= '0' as i32 && c as libc::c_int <= '9' as i32 {
        return (0x80 as libc::c_int + (c as libc::c_int - '0' as i32)) as libc::c_char;
    }
    c = ({
    ...
    if c as libc::c_int >= 'a' as i32 && c as libc::c_int <= 'f' as i32 {
        return (0x80 as libc::c_int + 10 as libc::c_int
            + (c as libc::c_int - 'a' as i32)) as libc::c_char;
    }
    return 0x80 as libc::c_int as libc::c_char;
}
#[inline(always)]
unsafe extern "C" fn myfget_hex(mut f: *mut MYFILE) -> libc::c_char {
    let fresh1 = (*f).curpos;
    (*f).curpos = ((*f).curpos).offset(1);
    let mut c: libc::c_char = *fresh1;
    let mut endchr: libc::c_char = 0 as libc::c_int as libc::c_char;
    if c as libc::c_int == '\\' as i32 {
        return '\\' as i32 as libc::c_char;
    }
    if c as libc::c_int >= '0' as i32 && c as libc::c_int <= '9' as i32 {
        endchr = (endchr as libc::c_int
            + ((c as libc::c_int - '0' as i32) << 4 as libc::c_int)) as libc::c_char;
    } else if c as libc::c_int >= 'A' as i32 && c as libc::c_int <= 'F' as i32 {
        endchr = (endchr as libc::c_int
            + ((c as libc::c_int - 'A' as i32 + 10 as libc::c_int) << 4 as libc::c_int))
            as libc::c_char;
    } else if c as libc::c_int >= 'a' as i32 && c as libc::c_int <= 'f' as i32 {
        endchr = (endchr as libc::c_int
            + ((c as libc::c_int - 'a' as i32 + 10 as libc::c_int) << 4 as libc::c_int))
    ...
    c = *fresh2;
    if c as libc::c_int >= '0' as i32 && c as libc::c_int <= '9' as i32 {
        endchr = (endchr as libc::c_int + (c as libc::c_int - '0' as i32))
            as libc::c_char;
    } else if c as libc::c_int >= 'A' as i32 && c as libc::c_int <= 'F' as i32 {
        endchr = (endchr as libc::c_int
            + (c as libc::c_int - 'A' as i32 + 10 as libc::c_int)) as libc::c_char;
    } else if c as libc::c_int >= 'a' as i32 && c as libc::c_int <= 'f' as i32 {
        endchr = (endchr as libc::c_int
            + (c as libc::c_int - 'a' as i32 + 10 as libc::c_int)) as libc::c_char;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn myfgets(
    ...
    bufsize = bufsize.wrapping_sub(1);
    bufsize;
    while i < bufsize && !(((*f).data).offset((*f).size as isize) <= (*f).curpos) {
        let fresh3 = (*f).curpos;
        (*f).curpos = ((*f).curpos).offset(1);
        ...
        if c as libc::c_int == '^' as i32 {
            let fresh4 = i;
            i = i.wrapping_add(1);
            *buf.offset(fresh4 as isize) = myfget_color(f);
        } else if c as libc::c_int == '\\' as i32 {
            let fresh5 = i;
            i = i.wrapping_add(1);
            *buf.offset(fresh5 as isize) = myfget_hex(f);
...
#[no_mangle]
pub unsafe extern "C" fn myhashfgets(
    mut buf: *mut libc::c_char,
    mut bufsize: size_t,
    mut f: *mut MYFILE,
) -> *mut libc::c_char {
    ...
    while i < bufsize && !(((*f).data).offset((*f).size as isize) <= (*f).curpos) {
        ...
        if c as libc::c_int == '^' as i32 {
            let fresh8 = i;
            i = i.wrapping_add(1);
            *buf.offset(fresh8 as isize) = myfget_color(f);
        } else if c as libc::c_int == '\\' as i32 {
            let fresh9 = i;
            i = i.wrapping_add(1);
            *buf.offset(fresh9 as isize) = myfget_hex(f);
        } else if c as libc::c_int != '\r' as i32 {
            let fresh10 = i;
            i = i.wrapping_add(1);
...
unsafe extern "C" fn ignorelines(mut f: *mut MYFILE) {
...
unsafe extern "C" fn DEH_LoadDehackedFile(mut f: *mut MYFILE, mut mainfile: boolean) {
    let mut s: *mut libc::c_char = Z_MallocAlign(
        1024 as libc::c_int as size_t,
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
    ...
    let mut textline: [libc::c_char; 1024] = [0; 1024];
    let mut word: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut word2: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: int32_t = 0;
    if deh_loaded == 0 {
        memset(
            FREE_STATES.as_mut_ptr() as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                .wrapping_mul((512 as libc::c_int * 8 as libc::c_int) as libc::c_ulong),
        );
        memset(
            FREE_MOBJS.as_mut_ptr() as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                .wrapping_mul(512 as libc::c_int as libc::c_ulong),
        );
        memset(
            FREE_SKINCOLORS.as_mut_ptr() as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                .wrapping_mul(1024 as libc::c_int as libc::c_ulong),
        );
        memset(
            used_spr.as_mut_ptr() as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<uint8_t>() as libc::c_ulong)
                .wrapping_mul(
                    (512 as libc::c_int / 8 as libc::c_int + 1 as libc::c_int)
                        as libc::c_ulong,
                ),
        );
        memset(
            actionsoverridden.as_mut_ptr() as *mut libc::c_void,
            -(1 as libc::c_int),
            ::core::mem::size_of::<[[libc::c_int; 30]; 267]>() as libc::c_ulong,
        );
    }
    deh_num_warning = 0 as libc::c_int;
    introchanged = false_0 as libc::c_int;
    titlechanged = introchanged;
    gamedataadded = titlechanged;
    dbg_line = -(1 as libc::c_int);
    while !(((*f).data).offset((*f).size as isize) <= (*f).curpos) {
        myfgets(s, 1024 as libc::c_int as size_t, f);
        memcpy(
            textline.as_mut_ptr() as *mut libc::c_void,
        ...
        if !word.is_null() {
            ...
            if *word
                .offset(
                    (strlen(word)).wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        as isize,
                ) as libc::c_int == '\n' as i32
            {
                *word
        ...
        if !word.is_null() {
            if fastcmp(word, b"FREESLOT\0" as *const u8 as *const libc::c_char) != 0 {
                readfreeslots(f);
            } else if fastcmp(word, b"MAINCFG\0" as *const u8 as *const libc::c_char)
                != 0
            {
                readmaincfg(f);
            } else if fastcmp(word, b"WIPES\0" as *const u8 as *const libc::c_char) != 0
            {
                readwipes(f);
            } else {
                word2 = strtok(
                ...
                if fastcmp(word, b"CHARACTER\0" as *const u8 as *const libc::c_char) != 0
                {
                    if i >= 0 as libc::c_int && i < 32 as libc::c_int {
                        readPlayer(f, i);
                    } else {
                        deh_warning(
                            b"Character %d out of range (0 - 31)\0" as *const u8
                                as *const libc::c_char,
                            i,
                        );
                        ignorelines(f);
                    }
                } else if fastcmp(word, b"EMBLEM\0" as *const u8 as *const libc::c_char)
                    != 0
                {
                    if mainfile == 0 && gamedataadded == 0 {
                        deh_warning(
                            b"You must define a custom gamedata to use \"%s\"\0"
                        ...
                        if word2.is_null() {
                            i = numemblems + 1 as libc::c_int;
                        }
                        if i > 0 as libc::c_int && i <= 512 as libc::c_int {
                            if numemblems < i {
                                numemblems = i;
                            }
                            reademblemdata(f, i);
                            ...
                            deh_warning(
                                b"Emblem number %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                                512 as libc::c_int,
                            );
                ...
                ) != 0
                {
                    if mainfile == 0 && gamedataadded == 0 {
                        ...
                        if word2.is_null() {
                            i = numextraemblems + 1 as libc::c_int;
                        }
                        if i > 0 as libc::c_int && i <= 48 as libc::c_int {
                            ...
                            deh_warning(
                                b"Extra emblem number %d out of range (1 - %d)\0"
                                    as *const u8 as *const libc::c_char,
                                i,
                                48 as libc::c_int,
                            );
                ...
                } else if !word2.is_null() {
                    if fastcmp(word, b"THING\0" as *const u8 as *const libc::c_char) != 0
                        || fastcmp(word, b"MOBJ\0" as *const u8 as *const libc::c_char)
                            != 0
                        || fastcmp(word, b"OBJECT\0" as *const u8 as *const libc::c_char)
                            != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_mobjtype(word2) as int32_t;
                        }
                        if i < NUMMOBJTYPES as libc::c_int && i > 0 as libc::c_int {
                            readthing(f, i);
                        } else {
                            deh_warning(
                                b"Thing %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                        ...
                        || fastcmp(word, b"COLOR\0" as *const u8 as *const libc::c_char)
                            != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_skincolor(word2) as int32_t;
                        }
                        if i != 0 && i < numskincolors as libc::c_int {
                            readskincolor(f, i);
                        } else {
                            deh_warning(
                                b"Skincolor %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                    ...
                    ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_sprite2(word2) as int32_t;
                        }
                        if i < free_spr2 as int32_t
                            && i >= SPR2_FIRSTFREESLOT as libc::c_int
                        {
                            readsprite2(f, i);
                        } else {
                            deh_warning(
                                b"Sprite2 number %d out of range (%d - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                        ...
                        ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_sprite(word2) as int32_t;
                        }
                        if i < NUMSPRITES as libc::c_int && i > 0 as libc::c_int {
                            readspriteinfo(f, i, false_0 as libc::c_int);
                        } else {
                            deh_warning(
                                b"Sprite number %d out of range (0 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                        ...
                        word,
                        b"SPRITE2INFO\0" as *const u8 as *const libc::c_char,
                    ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                        ...
                        if i < NUMPLAYERSPRITES as libc::c_int && i >= 0 as libc::c_int {
                            readspriteinfo(f, i, true_0 as libc::c_int);
                        } else {
                            deh_warning(
                                b"Sprite2 number %d out of range (0 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                                NUMPLAYERSPRITES as libc::c_int - 1 as libc::c_int,
                            );
                            ignorelines(f);
                        }
                    } else if fastcmp(
                    ...
                    ) != 0
                    {
                        ...
                        if i > 0 as libc::c_int && i <= 1035 as libc::c_int {
                            readlevelheader(f, i);
                        } else {
                            deh_warning(
                    ...
                    ) != 0
                    {
                        let mut c: int32_t = 0;
                        c = 0 as libc::c_int;
                        while c < 1024 as libc::c_int {
                            if textline[c as usize] as libc::c_int == '\0' as i32 {
                                break;
                            }
                            if textline[c as usize] as libc::c_int == ' ' as i32 {
                                let mut gtname: *mut libc::c_char = textline
                                    .as_mut_ptr()
                                    .offset(c as isize)
                                ...
                                if !gtname.is_null() {
                                    let mut j: int32_t = 0;
                                    j = 0 as libc::c_int;
                                    while j < 1024 as libc::c_int - c {
                                        if *gtname.offset(j as isize) as libc::c_int == '\0' as i32
                                        {
                                            break;
                                        }
                                        if (*gtname.offset(j as isize) as libc::c_int)
                                            < 32 as libc::c_int
                                        {
                                            *gtname.offset(j as isize) = '\0' as i32 as libc::c_char;
                                        }
                                        j += 1;
                                        j;
                                    }
                        ...
                        word,
                        b"CUTSCENE\0" as *const u8 as *const libc::c_char,
                    ) != 0
                    {
                        if i > 0 as libc::c_int && i < 129 as libc::c_int {
                            readcutscene(f, i - 1 as libc::c_int);
                        } else {
                            deh_warning(
                                b"Cutscene number %d out of range (1 - 128)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                            );
                            ignorelines(f);
                    ...
                    ) != 0
                    {
                        ...
                        {
                            readtextprompt(f, i - 1 as libc::c_int);
                        } else {
                            deh_warning(
                                b"Prompt number %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                                201 as libc::c_int
                                    + 6 as libc::c_int * 5 as libc::c_int * 3 as libc::c_int,
                        ...
                        || fastcmp(word, b"STATE\0" as *const u8 as *const libc::c_char)
                            != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_state(word2) as int32_t;
                        }
                        if i < NUMSTATES as libc::c_int && i >= 0 as libc::c_int {
                            readframe(f, i);
                        } else {
                            deh_warning(
                                b"Frame %d out of range (0 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                    ...
                    ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_sfx(word2) as int32_t;
                        }
                        if i < NUMSFX as libc::c_int && i > 0 as libc::c_int {
                            readsound(f, i);
                        } else {
                            deh_warning(
                                b"Sound %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                        ...
                        word,
                        b"HUDITEM\0" as *const u8 as *const libc::c_char,
                    ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_huditem(word2) as int32_t;
                        }
                        if i >= 0 as libc::c_int && i < NUMHUDITEMS as libc::c_int {
                            readhuditem(f, i);
                        } else {
                            deh_warning(
                                b"HUD item number %d out of range (0 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                    ...
                    ) != 0
                    {
                        if i == 0 as libc::c_int
                            && *word2.offset(0 as libc::c_int as isize) as libc::c_int
                                != '0' as i32
                        {
                            i = get_menutype(word2) as int32_t;
                        }
                        if i >= 1 as libc::c_int && i < NUMMENUTYPES as libc::c_int {
                            readmenu(f, i);
                        } else {
                            deh_warning(
                                b"Menu number %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                                NUMMENUTYPES as libc::c_int - 1 as libc::c_int,
                            );
                            ignorelines(f);
                        }
                    } else if fastcmp(
                    ...
                    ) != 0
                    {
                        if mainfile == 0 && gamedataadded == 0 {
                            ...
                            ignorelines(f);
                        } else if i > 0 as libc::c_int && i <= 80 as libc::c_int {
                            readunlockable(f, i - 1 as libc::c_int);
                        } else {
                            deh_warning(
                                b"Unlockable number %d out of range (1 - %d)\0" as *const u8
                                    as *const libc::c_char,
                                i,
                                80 as libc::c_int,
                            );
                    ...
                    ) != 0
                    {
                        if mainfile == 0 && gamedataadded == 0 {
                            ...
                            ignorelines(f);
                        } else if i > 0 as libc::c_int && i <= 128 as libc::c_int {
                            readconditionset(f, i as uint8_t);
                        } else {
                            deh_warning(
                                b"Condition set number %d out of range (1 - %d)\0"
                                    as *const u8 as *const libc::c_char,
                                i,
                                128 as libc::c_int,
                            );
                    ...
                    ) != 0
                    {
                        ...
                        {
                            i = atoi(word2);
                            if i != 220 as libc::c_int {
                                deh_warning(
                                    b"Patch is for SRB2 version %d, only version %d is supported\0"
                                        as *const u8 as *const libc::c_char,
                                    i,
                                    220 as libc::c_int,
                                );
                            ...
                            deh_warning(
                                b"SRB2 version definition has incorrect format, use \"SRB2 %d\"\0"
                                    as *const u8 as *const libc::c_char,
                                220 as libc::c_int,
                            );
                        }
                    ...
                    {
                        let mut clearall: boolean = fastcmp(
                            word2,
                        ...
                        if mainfile == 0 && gamedataadded == 0 {
                            ...
                            if clearall != 0
                                || fastcmp(
                                    word2,
                                    b"UNLOCKABLES\0" as *const u8 as *const libc::c_char,
                                ) != 0
                            {
                                clear_unlockables();
                            }
                            ...
                            if clearall != 0
                                || fastcmp(
                                    word2,
                                    b"EXTRAEMBLEMS\0" as *const u8 as *const libc::c_char,
                                ) != 0
                            {
                                memset(
                                    &mut extraemblems as *mut [extraemblem_t; 48]
                                        as *mut libc::c_void,
                                    0 as libc::c_int,
                                    ::core::mem::size_of::<[extraemblem_t; 48]>()
                                        as libc::c_ulong,
                                );
                                numextraemblems = 0 as libc::c_int;
                            }
                            if clearall != 0
                                || fastcmp(
                                    word2,
                                    b"CONDITIONSETS\0" as *const u8 as *const libc::c_char,
                                ) != 0
                            {
                                clear_conditionsets();
                            }
                            if clearall != 0
                                || fastcmp(
                                    word2,
                                    b"LEVELS\0" as *const u8 as *const libc::c_char,
                                ) != 0
                            {
                                clear_levels();
                            }
                        ...
                        deh_warning(
                            b"Unknown word: %s\0" as *const u8 as *const libc::c_char,
                            word,
                        );
                    }
                } else {
                    deh_warning(
                        b"missing argument for '%s'\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                }
            ...
            deh_warning(
                b"No word in this line: %s\0" as *const u8 as *const libc::c_char,
                s,
            );
        }
    }
    ...
    dbg_line = -(1 as libc::c_int);
    if deh_num_warning != 0 {
        CONS_Printf(
            b"%d warning%s in the SOC lump\n\0" as *const u8 as *const libc::c_char,
            deh_num_warning,
            if deh_num_warning == 1 as libc::c_int {
                b"\0" as *const u8 as *const libc::c_char
            } else {
        ...
        if devparm != 0 {
            I_Error(
                ...
                b"See log.txt for details.\n\0" as *const u8 as *const libc::c_char,
            );
        }
    }
    deh_loaded = true_0 as libc::c_int;
    Z_Free(s as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn DEH_LoadDehackedLumpPwad(
    mut wad: uint16_t,
    mut lump: uint16_t,
    ...
    f
        .data = Z_MallocAlign(
        (f.size).wrapping_add(1 as libc::c_int as size_t),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut libc::c_char;
    ...
    f.curpos = f.data;
    *(f.data).offset(f.size as isize) = 0 as libc::c_int as libc::c_char;
    DEH_LoadDehackedFile(&mut f, mainfile);
    Z_Free(f.data as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn DEH_LoadDehackedLump(mut lumpnum: lumpnum_t) {
