...
extern "C" {
    ...
    fn R_GetFlatSize(length: size_t) -> uint16_t;
    fn R_GetFlatBits(size: int32_t) -> uint8_t;
    ...
    static mut st_translucency: int32_t;
    static mut tallnum: [*mut patch_t; 10];
    static mut tallminus: *mut patch_t;
    static mut ttlnum: [*mut patch_t; 10];
    static mut cred_font: [*mut patch_t; 58];
    static mut ntb_font: [*mut patch_t; 58];
    static mut nto_font: [*mut patch_t; 58];
    static mut lt_font: [*mut patch_t; 90];
    ...
    static mut tny_font: [*mut patch_t; 105];
    fn W_LumpLength(lumpnum: lumpnum_t) -> size_t;
    fn W_GetNumForName(name: *const libc::c_char) -> lumpnum_t;
    static mut con_recalc: boolean;
    static mut con_refresh: boolean;
    static mut cons_backcolor: consvar_t;
    static mut yellowmap: *mut uint8_t;
    static mut magentamap: *mut uint8_t;
    static mut lgreenmap: *mut uint8_t;
    static mut bluemap: *mut uint8_t;
    static mut graymap: *mut uint8_t;
    static mut redmap: *mut uint8_t;
    static mut orangemap: *mut uint8_t;
    static mut skymap: *mut uint8_t;
    static mut purplemap: *mut uint8_t;
    static mut aquamap: *mut uint8_t;
    static mut peridotmap: *mut uint8_t;
    static mut azuremap: *mut uint8_t;
    static mut brownmap: *mut uint8_t;
    static mut rosymap: *mut uint8_t;
    static mut invertmap: *mut uint8_t;
    static mut consolebgmap: *mut uint8_t;
    static mut promptbgmap: *mut uint8_t;
    fn CON_SetupBackColormapEx(color: int32_t, prompt: boolean);
    static mut rendermode: rendermode_t;
    fn I_SetPalette(palette: *mut RGBA_t);
...
#[no_mangle]
pub static mut screens: [*mut uint8_t; 5] = [0 as *const uint8_t as *mut uint8_t; 5];
static mut ticrate_cons_t: [CV_PossibleValue_t; 4] = [
    {
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Compact\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_ticrate: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"showfps\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"No\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: ticrate_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
static mut gamma_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
...
#[no_mangle]
pub static mut cv_globalgamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            ...
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
static mut saturation_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_globalsaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"saturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
static mut hue_cons_t: [CV_PossibleValue_t; 3] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"MIN\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = CV_PossibleValue_s {
            value: 4 as libc::c_int * 6 as libc::c_int - 1 as libc::c_int,
            strvalue: b"MAX\0" as *const u8 as *const libc::c_char,
        };
        init
    },
...
#[no_mangle]
pub static mut cv_rhue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"rhue\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: hue_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_yhue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"yhue\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_ghue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ghue\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_chue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"chue\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"12\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: hue_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_bhue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"bhue\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_mhue: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"mhue\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_rgamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"rgamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_ygamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ygamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_ggamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ggamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_cgamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"cgamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_bgamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"bgamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_mgamma: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"mgamma\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"0\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: gamma_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_rsaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"rsaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_ysaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"ysaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_gsaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"gsaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_csaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"csaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_bsaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"bsaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
#[no_mangle]
pub static mut cv_msaturation: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"msaturation\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"10\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: saturation_cons_t.as_ptr() as *mut _,
            func: Some(CV_palette_OnChange as unsafe extern "C" fn() -> ()),
...
static mut constextsize_cons_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0x100 as libc::c_int,
            strvalue: b"Small\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Medium\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 0x300 as libc::c_int,
            strvalue: b"Large\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"Huge\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_constextsize: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"con_textsize\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Medium\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: constextsize_cons_t.as_ptr() as *mut _,
            func: Some(CV_constextsize_OnChange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut pLocalPalette: *mut RGBA_t = 0 as *const RGBA_t as *mut RGBA_t;
#[no_mangle]
pub static mut pMasterPalette: *mut RGBA_t = 0 as *const RGBA_t as *mut RGBA_t;
#[no_mangle]
pub static mut Cubepal: [[[[libc::c_float; 3]; 2]; 2]; 2] = [[[[0.; 3]; 2]; 2]; 2];
#[no_mangle]
pub static mut Cubeapply: boolean = false_0 as libc::c_int;
unsafe extern "C" fn InitCube() -> boolean {
    let mut apply: boolean = false_0 as libc::c_int;
    let mut q: uint8_t = 0;
    let mut working: [[[[libc::c_float; 3]; 2]; 2]; 2] = [
        [
            [
                [
    ...
    let mut desatur: [libc::c_float; 3] = [0.; 3];
    let mut globalgammamul: libc::c_float = 0.;
    let mut globalgammaoffs: libc::c_float = 0.;
    let mut doinggamma: boolean = 0;
    doinggamma = (cv_globalgamma.value != atoi(cv_globalgamma.defaultvalue))
        as libc::c_int;
    globalgammamul = (if cv_globalgamma.value != 0 {
        (255 as libc::c_int - 8 as libc::c_int * abs(cv_globalgamma.value))
            as libc::c_double / 255.0f64
    } else {
        1.0f64
    }) as libc::c_float;
    globalgammaoffs = (if cv_globalgamma.value > 0 as libc::c_int {
        (8 as libc::c_int * cv_globalgamma.value) as libc::c_double / 255.0f64
    } else {
        0.0f64
    }) as libc::c_float;
    desatur[2 as libc::c_int
        as usize] = (globalgammaoffs as libc::c_double
        + 0.33f64 * globalgammamul as libc::c_double) as libc::c_float;
    desatur[1 as libc::c_int as usize] = desatur[2 as libc::c_int as usize];
    desatur[0 as libc::c_int as usize] = desatur[1 as libc::c_int as usize];
    if doinggamma != 0 || cv_rhue.value != atoi(cv_rhue.defaultvalue)
        || cv_yhue.value != atoi(cv_yhue.defaultvalue)
        || cv_ghue.value != atoi(cv_ghue.defaultvalue)
        || cv_chue.value != atoi(cv_chue.defaultvalue)
        || cv_bhue.value != atoi(cv_bhue.defaultvalue)
        || cv_mhue.value != atoi(cv_mhue.defaultvalue)
        || cv_rgamma.value != atoi(cv_rgamma.defaultvalue)
        || cv_ygamma.value != atoi(cv_ygamma.defaultvalue)
        || cv_ggamma.value != atoi(cv_ggamma.defaultvalue)
        || cv_cgamma.value != atoi(cv_cgamma.defaultvalue)
        || cv_bgamma.value != atoi(cv_bgamma.defaultvalue)
        || cv_mgamma.value != atoi(cv_mgamma.defaultvalue)
    {
        let mut mod_0: libc::c_float = 0.;
        let mut tempgammamul: libc::c_float = 0.;
        let mut tempgammaoffs: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        working[0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][2 as libc::c_int as usize] = globalgammaoffs;
        working[0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][1 as libc::c_int
            as usize] = working[0 as libc::c_int
            as usize][0 as libc::c_int
        ...
        working[1 as libc::c_int
            as usize][1 as libc::c_int
            as usize][1 as libc::c_int
            as usize][2 as libc::c_int as usize] = globalgammaoffs + globalgammamul;
        working[1 as libc::c_int
            as usize][1 as libc::c_int
            as usize][1 as libc::c_int
            as usize][1 as libc::c_int
            as usize] = working[1 as libc::c_int
            as usize][1 as libc::c_int
        ...
        tempgammamul = (if cv_rgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_rgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_rgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_rgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_rhue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_rhue.value / 4 as libc::c_int {
            1 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize] = tempgammaoffs + tempgammamul - mod_0;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int as usize] = tempgammaoffs + tempgammamul;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][2 as libc::c_int as usize] = tempgammaoffs;
            }
            2 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int as usize] = tempgammaoffs;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int as usize] = tempgammaoffs + tempgammamul;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][2 as libc::c_int as usize] = tempgammaoffs + mod_0;
            }
            3 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                ...
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][2 as libc::c_int as usize] = tempgammaoffs + tempgammamul;
            }
            4 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int as usize] = tempgammaoffs + mod_0;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int as usize] = tempgammaoffs;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][2 as libc::c_int as usize] = tempgammaoffs + tempgammamul;
            ...
            5 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int as usize] = tempgammaoffs + tempgammamul;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int as usize] = tempgammaoffs;
            ...
            0 | _ => {
                ...
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int as usize] = tempgammaoffs + mod_0;
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][2 as libc::c_int as usize] = tempgammaoffs;
        ...
        tempgammamul = (if cv_ygamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_ygamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_ygamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_ygamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_yhue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_yhue.value / 4 as libc::c_int {
            1 => {
                working[1 as libc::c_int
                    as usize][1 as libc::c_int
                    as usize][0 as libc::c_int
        ...
        tempgammamul = (if cv_ggamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_ggamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_ggamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_ggamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_ghue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_ghue.value / 4 as libc::c_int {
            1 => {
                working[0 as libc::c_int
                    as usize][1 as libc::c_int
                    as usize][0 as libc::c_int
        ...
        tempgammamul = (if cv_cgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_cgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_cgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_cgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_chue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_chue.value / 4 as libc::c_int {
            1 => {
                working[0 as libc::c_int
                    as usize][1 as libc::c_int
                    as usize][1 as libc::c_int
        ...
        tempgammamul = (if cv_bgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_bgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_bgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_bgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_bhue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_bhue.value / 4 as libc::c_int {
            1 => {
                working[0 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int
        ...
        tempgammamul = (if cv_mgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_mgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs = (if cv_mgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_mgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        mod_0 = (cv_mhue.value % 4 as libc::c_int) as libc::c_float * tempgammamul
            / 4 as libc::c_int as libc::c_float;
        match cv_mhue.value / 4 as libc::c_int {
            1 => {
                working[1 as libc::c_int
                    as usize][0 as libc::c_int
                    as usize][1 as libc::c_int
    ...
    if cv_rsaturation.value != atoi(cv_rsaturation.defaultvalue) {
        let mut work: libc::c_float = 0.;
        let mut mod_1: libc::c_float = 0.;
        let mut tempgammamul_0: libc::c_float = 0.;
        let mut tempgammaoffs_0: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work = (cv_rsaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_1 = ((cv_rhue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_rhue.value & 4 as libc::c_int != 0 {
            mod_1 = 2 as libc::c_int as libc::c_float - mod_1;
        } else {
            mod_1 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_0 = (if cv_rgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_rgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_0 = (if cv_rgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_rgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        }) as libc::c_float;
        q = 0 as libc::c_int as uint8_t;
        while (q as libc::c_int) < 3 as libc::c_int {
            working[1 as libc::c_int
                as usize][0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work)
                * (tempgammaoffs_0 + desatur[q as usize] * mod_1 * tempgammamul_0)
                + work
                    * working[1 as libc::c_int
                        as usize][0 as libc::c_int
                        as usize][0 as libc::c_int as usize][q as usize];
            q = q.wrapping_add(1);
            q;
        }
    }
    if cv_ysaturation.value != atoi(cv_ysaturation.defaultvalue) {
        let mut work_0: libc::c_float = 0.;
        let mut mod_2: libc::c_float = 0.;
        let mut tempgammamul_1: libc::c_float = 0.;
        let mut tempgammaoffs_1: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work_0 = (cv_ysaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_2 = ((cv_yhue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_yhue.value & 4 as libc::c_int != 0 {
            mod_2 = 2 as libc::c_int as libc::c_float - mod_2;
        } else {
            mod_2 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_1 = (if cv_ygamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_ygamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_1 = (if cv_ygamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_ygamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[1 as libc::c_int
                ...
                as usize][0 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_0)
                * (tempgammaoffs_1 + desatur[q as usize] * mod_2 * tempgammamul_1)
                + work_0
                    * working[1 as libc::c_int
                        as usize][1 as libc::c_int
                        as usize][0 as libc::c_int as usize][q as usize];
    ...
    if cv_gsaturation.value != atoi(cv_gsaturation.defaultvalue) {
        let mut work_1: libc::c_float = 0.;
        let mut mod_3: libc::c_float = 0.;
        let mut tempgammamul_2: libc::c_float = 0.;
        let mut tempgammaoffs_2: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work_1 = (cv_gsaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_3 = ((cv_ghue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_ghue.value & 4 as libc::c_int != 0 {
            mod_3 = 2 as libc::c_int as libc::c_float - mod_3;
        } else {
            mod_3 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_2 = (if cv_ggamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_ggamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_2 = (if cv_ggamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_ggamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[0 as libc::c_int
                ...
                as usize][0 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_1)
                * (tempgammaoffs_2 + desatur[q as usize] * mod_3 * tempgammamul_2)
                + work_1
                    * working[0 as libc::c_int
                        as usize][1 as libc::c_int
                        as usize][0 as libc::c_int as usize][q as usize];
    ...
    if cv_csaturation.value != atoi(cv_csaturation.defaultvalue) {
        let mut work_2: libc::c_float = 0.;
        let mut mod_4: libc::c_float = 0.;
        let mut tempgammamul_3: libc::c_float = 0.;
        let mut tempgammaoffs_3: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work_2 = (cv_csaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_4 = ((cv_chue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_chue.value & 4 as libc::c_int != 0 {
            mod_4 = 2 as libc::c_int as libc::c_float - mod_4;
        } else {
            mod_4 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_3 = (if cv_cgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_cgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_3 = (if cv_cgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_cgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[0 as libc::c_int
                ...
                as usize][1 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_2)
                * (tempgammaoffs_3 + desatur[q as usize] * mod_4 * tempgammamul_3)
                + work_2
                    * working[0 as libc::c_int
                        as usize][1 as libc::c_int
                        as usize][1 as libc::c_int as usize][q as usize];
            q = q.wrapping_add(1);
            q;
        }
    }
    if cv_bsaturation.value != atoi(cv_bsaturation.defaultvalue) {
        let mut work_3: libc::c_float = 0.;
        let mut mod_5: libc::c_float = 0.;
        let mut tempgammamul_4: libc::c_float = 0.;
        let mut tempgammaoffs_4: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work_3 = (cv_bsaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_5 = ((cv_bhue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_bhue.value & 4 as libc::c_int != 0 {
            mod_5 = 2 as libc::c_int as libc::c_float - mod_5;
        } else {
            mod_5 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_4 = (if cv_bgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_bgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_4 = (if cv_bgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_bgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[0 as libc::c_int
                ...
                as usize][1 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_3)
                * (tempgammaoffs_4 + desatur[q as usize] * mod_5 * tempgammamul_4)
                + work_3
                    * working[0 as libc::c_int
                        as usize][0 as libc::c_int
                        as usize][1 as libc::c_int as usize][q as usize];
    ...
    if cv_msaturation.value != atoi(cv_msaturation.defaultvalue) {
        let mut work_4: libc::c_float = 0.;
        let mut mod_6: libc::c_float = 0.;
        let mut tempgammamul_5: libc::c_float = 0.;
        let mut tempgammaoffs_5: libc::c_float = 0.;
        apply = true_0 as libc::c_int;
        work_4 = (cv_msaturation.value as libc::c_double / 10.0f64) as libc::c_float;
        mod_6 = ((cv_mhue.value % 4 as libc::c_int) as libc::c_double * 1.0f64
            / 4 as libc::c_int as libc::c_double) as libc::c_float;
        if cv_mhue.value & 4 as libc::c_int != 0 {
            mod_6 = 2 as libc::c_int as libc::c_float - mod_6;
        } else {
            mod_6 += 1 as libc::c_int as libc::c_float;
        }
        tempgammamul_5 = (if cv_mgamma.value != 0 {
            (255 as libc::c_int - 8 as libc::c_int * abs(cv_mgamma.value))
                as libc::c_double / 255.0f64 * globalgammamul as libc::c_double
        } else {
            globalgammamul as libc::c_double
        }) as libc::c_float;
        tempgammaoffs_5 = (if cv_mgamma.value > 0 as libc::c_int {
            (8 as libc::c_int * cv_mgamma.value) as libc::c_double / 255.0f64
                + globalgammaoffs as libc::c_double
        } else {
            globalgammaoffs as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[1 as libc::c_int
                ...
                as usize][1 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_4)
                * (tempgammaoffs_5 + desatur[q as usize] * mod_6 * tempgammamul_5)
                + work_4
                    * working[1 as libc::c_int
                        as usize][0 as libc::c_int
                        as usize][1 as libc::c_int as usize][q as usize];
    ...
    if cv_globalsaturation.value != atoi(cv_globalsaturation.defaultvalue) {
        let mut work_5: libc::c_float = (cv_globalsaturation.value as libc::c_double
        ...
        while (q as libc::c_int) < 3 as libc::c_int {
            working[1 as libc::c_int
                ...
                as usize][0 as libc::c_int
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_5)
                * desatur[q as usize]
                + work_5
                    * working[1 as libc::c_int
                        as usize][0 as libc::c_int
            ...
            working[1 as libc::c_int
                ...
                as usize][q
                as usize] = (1 as libc::c_int as libc::c_float - work_5)
                * 2 as libc::c_int as libc::c_float * desatur[q as usize]
                + work_5
                    * working[1 as libc::c_int
                        as usize][1 as libc::c_int
                        as usize][0 as libc::c_int as usize][q as usize];
    ...
    q = 0 as libc::c_int as uint8_t;
    while (q as libc::c_int) < 3 as libc::c_int {
        if working[0 as libc::c_int
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize]
            as libc::c_double > 1.0f64
        {
            working[0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][q as usize] = 1.0f64 as libc::c_float;
        } else if (working[0 as libc::c_int
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize]
            as libc::c_double) < 0.0f64
        {
            working[0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][q as usize] = 0.0f64 as libc::c_float;
        }
        Cubepal[0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][0 as libc::c_int
            as usize][q
            as usize] = working[0 as libc::c_int
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize];
        if working[1 as libc::c_int
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize]
            as libc::c_double > 1.0f64
        {
            working[1 as libc::c_int
                ...
                as usize][0 as libc::c_int
                as usize][q as usize] = 1.0f64 as libc::c_float;
        } else if (working[1 as libc::c_int
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize]
            as libc::c_double) < 0.0f64
        {
            working[1 as libc::c_int
        ...
        Cubepal[1 as libc::c_int
            ...
            as usize][0 as libc::c_int as usize][0 as libc::c_int as usize][q as usize];
        if working[0 as libc::c_int
            as usize][1 as libc::c_int as usize][0 as libc::c_int as usize][q as usize]
            as libc::c_double > 1.0f64
        {
            working[0 as libc::c_int
                as usize][1 as libc::c_int
        ...
        Cubepal[1 as libc::c_int
            ...
            as usize][1 as libc::c_int as usize][0 as libc::c_int as usize][q as usize];
        if working[0 as libc::c_int
            as usize][0 as libc::c_int as usize][1 as libc::c_int as usize][q as usize]
            as libc::c_double > 1.0f64
        {
            working[0 as libc::c_int
                as usize][0 as libc::c_int
        ...
        Cubepal[1 as libc::c_int
            ...
            as usize][0 as libc::c_int as usize][1 as libc::c_int as usize][q as usize];
        if working[0 as libc::c_int
            as usize][1 as libc::c_int as usize][1 as libc::c_int as usize][q as usize]
            as libc::c_double > 1.0f64
        {
            working[0 as libc::c_int
                as usize][1 as libc::c_int
...
unsafe extern "C" fn LoadPalette(mut lumpname: *const libc::c_char) {
    let mut lumpnum: lumpnum_t = W_GetNumForName(lumpname);
    let mut i: size_t = 0;
    let mut palsize: size_t = W_LumpLength(lumpnum) / 3 as libc::c_int as size_t;
    let mut pal: *mut uint8_t = 0 as *mut uint8_t;
    Cubeapply = InitCube();
    Z_Free(pLocalPalette as *mut libc::c_void);
    Z_Free(pMasterPalette as *mut libc::c_void);
    pLocalPalette = Z_MallocAlign(
        (::core::mem::size_of::<RGBA_t>() as libc::c_ulong).wrapping_mul(palsize),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut RGBA_t;
    pMasterPalette = Z_MallocAlign(
        (::core::mem::size_of::<RGBA_t>() as libc::c_ulong).wrapping_mul(palsize),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut RGBA_t;
    pal = W_CacheLumpNum(lumpnum, PU_CACHE as libc::c_int) as *mut uint8_t;
    i = 0 as libc::c_int as size_t;
    while i < palsize {
        let fresh0 = pal;
        pal = pal.offset(1);
        let ref mut fresh1 = (*pLocalPalette.offset(i as isize)).s.red;
        *fresh1 = *fresh0;
        (*pMasterPalette.offset(i as isize)).s.red = *fresh1;
        let fresh2 = pal;
        pal = pal.offset(1);
        let ref mut fresh3 = (*pLocalPalette.offset(i as isize)).s.green;
        *fresh3 = *fresh2;
        (*pMasterPalette.offset(i as isize)).s.green = *fresh3;
        let fresh4 = pal;
        pal = pal.offset(1);
        let ref mut fresh5 = (*pLocalPalette.offset(i as isize)).s.blue;
        *fresh5 = *fresh4;
        (*pMasterPalette.offset(i as isize)).s.blue = *fresh5;
        let ref mut fresh6 = (*pLocalPalette.offset(i as isize)).s.alpha;
        *fresh6 = 0xff as libc::c_int as uint8_t;
        (*pMasterPalette.offset(i as isize)).s.alpha = *fresh6;
        if Cubeapply != 0 {
            V_CubeApply(
                &mut (*pLocalPalette.offset(i as isize)).s.red,
                &mut (*pLocalPalette.offset(i as isize)).s.green,
                &mut (*pLocalPalette.offset(i as isize)).s.blue,
            );
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn V_CubeApply(
    mut red: *mut uint8_t,
    mut green: *mut uint8_t,
    mut blue: *mut uint8_t,
) {
    let mut working: [[libc::c_float; 3]; 4] = [[0.; 3]; 4];
    let mut linear: libc::c_float = 0.;
    let mut q: uint8_t = 0;
    if Cubeapply == 0 {
        return;
    }
    linear = (*red as libc::c_int as libc::c_double / 255.0f64) as libc::c_float;
    q = 0 as libc::c_int as uint8_t;
    while (q as libc::c_int) < 3 as libc::c_int {
        working[0 as libc::c_int
            as usize][q
            as usize] = (1 as libc::c_int as libc::c_float - linear)
            * Cubepal[0 as libc::c_int
                as usize][0 as libc::c_int
                as usize][0 as libc::c_int as usize][q as usize]
            + linear
    ...
    linear = (*green as libc::c_int as libc::c_double / 255.0f64) as libc::c_float;
    q = 0 as libc::c_int as uint8_t;
    while (q as libc::c_int) < 3 as libc::c_int {
        working[0 as libc::c_int
            as usize][q
            as usize] = (1 as libc::c_int as libc::c_float - linear)
            * working[0 as libc::c_int as usize][q as usize]
            + linear * working[1 as libc::c_int as usize][q as usize];
        working[1 as libc::c_int
            as usize][q
            as usize] = (1 as libc::c_int as libc::c_float - linear)
            * working[2 as libc::c_int as usize][q as usize]
            + linear * working[3 as libc::c_int as usize][q as usize];
        q = q.wrapping_add(1);
        q;
    }
    linear = (*blue as libc::c_int as libc::c_double / 255.0f64) as libc::c_float;
    q = 0 as libc::c_int as uint8_t;
    while (q as libc::c_int) < 3 as libc::c_int {
        working[0 as libc::c_int
            as usize][q
            as usize] = 255 as libc::c_int as libc::c_float
            * ((1 as libc::c_int as libc::c_float - linear)
                * working[0 as libc::c_int as usize][q as usize]
                + linear * working[1 as libc::c_int as usize][q as usize]);
        if working[0 as libc::c_int as usize][q as usize] as libc::c_double > 255.0f64 {
            working[0 as libc::c_int as usize][q as usize] = 255.0f64 as libc::c_float;
        } else if (working[0 as libc::c_int as usize][q as usize] as libc::c_double)
            < 0.0f64
        {
            working[0 as libc::c_int as usize][q as usize] = 0.0f64 as libc::c_float;
        }
        q = q.wrapping_add(1);
        q;
    }
    *red = working[0 as libc::c_int as usize][0 as libc::c_int as usize] as uint8_t;
    *green = working[0 as libc::c_int as usize][1 as libc::c_int as usize] as uint8_t;
    *blue = working[0 as libc::c_int as usize][2 as libc::c_int as usize] as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetPalname(mut num: uint16_t) -> *const libc::c_char {
    static mut palname: [libc::c_char; 9] = [0; 9];
    let mut newpal: [libc::c_char; 9] = *::core::mem::transmute::<
        &[u8; 9],
        &mut [libc::c_char; 9],
    >(b"PLAYPAL\0\0");
    if num as libc::c_int > 0 as libc::c_int
        && num as libc::c_int <= 10000 as libc::c_int
    {
        snprintf(
            newpal.as_mut_ptr(),
            8 as libc::c_int as libc::c_ulong,
            b"PAL%04u\0" as *const u8 as *const libc::c_char,
            num as libc::c_int - 1 as libc::c_int,
        );
    }
    strncpy(
        palname.as_mut_ptr(),
    ...
    return palname.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn GetPalette() -> *const libc::c_char {
    ...
    return b"PLAYPAL\0" as *const u8 as *const libc::c_char;
}
unsafe extern "C" fn LoadMapPalette() {
    LoadPalette(GetPalette());
}
#[no_mangle]
pub unsafe extern "C" fn V_SetPalette(mut palettenum: int32_t) {
    if pLocalPalette.is_null() {
        LoadMapPalette();
    }
    if rendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint {
        I_SetPalette(
            &mut *pLocalPalette.offset((palettenum * 256 as libc::c_int) as isize),
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_SetPaletteLump(mut pal: *const libc::c_char) {
    LoadPalette(pal);
    if rendermode as libc::c_uint != render_none as libc::c_int as libc::c_uint {
        I_SetPalette(pLocalPalette);
    }
}
unsafe extern "C" fn CV_palette_OnChange() {
    LoadMapPalette();
    V_SetPalette(0 as libc::c_int);
}
unsafe extern "C" fn CV_constextsize_OnChange() {
    if con_refresh == 0 {
        con_recalc = true_0 as libc::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn VID_BlitLinearScreen(
    mut srcptr: *const uint8_t,
    mut destptr: *mut uint8_t,
    mut width: int32_t,
    mut height: int32_t,
    mut srcrowbytes: size_t,
    mut destrowbytes: size_t,
) {
    if srcrowbytes == destrowbytes {
        ...
        loop {
            ...
            destptr = destptr.offset(destrowbytes as isize);
            srcptr = srcptr.offset(srcrowbytes as isize);
        }
    };
}
static mut hudplusalpha: [uint8_t; 11] = [
...
static mut hudminusalpha: [uint8_t; 11] = [
    10 as libc::c_int as uint8_t,
...
static mut v_colormap: *const uint8_t = 0 as *const uint8_t;
static mut v_translevel: *const uint8_t = 0 as *const uint8_t;
#[inline]
unsafe extern "C" fn standardpdraw(
    mut dest: *const uint8_t,
    mut source: *const uint8_t,
    mut ofs: fixed_t,
) -> uint8_t {
    return *source.offset((ofs >> 16 as libc::c_int) as isize);
}
#[inline]
unsafe extern "C" fn mappedpdraw(
    mut dest: *const uint8_t,
    mut source: *const uint8_t,
    mut ofs: fixed_t,
) -> uint8_t {
    return *v_colormap
        .offset(
            *source.offset((ofs >> 16 as libc::c_int) as isize) as libc::c_int as isize,
        );
}
#[inline]
unsafe extern "C" fn translucentpdraw(
    mut dest: *const uint8_t,
    mut source: *const uint8_t,
    mut ofs: fixed_t,
) -> uint8_t {
    return *v_translevel
        .offset(
            ((*source.offset((ofs >> 16 as libc::c_int) as isize) as libc::c_int)
                << 8 as libc::c_int & 0xff00 as libc::c_int) as isize,
        )
        .offset((*dest as libc::c_int & 0xff as libc::c_int) as isize);
}
#[inline]
unsafe extern "C" fn transmappedpdraw(
    mut dest: *const uint8_t,
    mut source: *const uint8_t,
    mut ofs: fixed_t,
) -> uint8_t {
        ...
        .offset(
            ((*v_colormap
                .offset(
                    *source.offset((ofs >> 16 as libc::c_int) as isize) as libc::c_int
                        as isize,
                ) as libc::c_int) << 8 as libc::c_int & 0xff00 as libc::c_int) as isize,
        )
        .offset((*dest as libc::c_int & 0xff as libc::c_int) as isize);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawStretchyFixedPatch(
    mut x: fixed_t,
    mut y: fixed_t,
    mut pscale: fixed_t,
    mut vscale: fixed_t,
    ...
    mut colormap: *const uint8_t,
) {
    let mut patchdrawfunc: Option::<
        unsafe extern "C" fn(*const uint8_t, *const uint8_t, fixed_t) -> uint8_t,
    > = None;
    let mut alphalevel: uint32_t = ((scrn & 0xf0000 as libc::c_int) >> 16 as libc::c_int)
        as uint32_t;
    let mut blendmode: uint32_t = ((scrn & 0x700000 as libc::c_int) >> 20 as libc::c_int)
        as uint32_t;
    let mut col: fixed_t = 0;
    let mut ofs: fixed_t = 0;
    let mut colfrac: fixed_t = 0;
    let mut rowfrac: fixed_t = 0;
    let mut fdup: fixed_t = 0;
    let mut vdup: fixed_t = 0;
    let mut dupx: int32_t = 0;
    let mut dupy: int32_t = 0;
    let mut column: *const column_t = 0 as *const column_t;
    let mut desttop: *mut uint8_t = 0 as *mut uint8_t;
    let mut dest: *mut uint8_t = 0 as *mut uint8_t;
    let mut deststart: *mut uint8_t = 0 as *mut uint8_t;
    let mut destend: *mut uint8_t = 0 as *mut uint8_t;
    let mut source: *const uint8_t = 0 as *const uint8_t;
    let mut deststop: *const uint8_t = 0 as *const uint8_t;
    let mut pwidth: fixed_t = 0;
    let mut offx: fixed_t = 0 as libc::c_int;
    let mut perplayershuffle: uint8_t = 0 as libc::c_int as uint8_t;
    if rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint {
        return;
    }
    patchdrawfunc = Some(
        standardpdraw
            as unsafe extern "C" fn(*const uint8_t, *const uint8_t, fixed_t) -> uint8_t,
    );
    v_translevel = 0 as *const uint8_t;
    if alphalevel != 0 || blendmode != 0 {
        if alphalevel == 10 as libc::c_int as uint32_t {
            alphalevel = hudminusalpha[st_translucency as usize] as uint32_t;
        } else if alphalevel == 11 as libc::c_int as uint32_t {
            alphalevel = (10 as libc::c_int - st_translucency) as uint32_t;
        } else if alphalevel == 12 as libc::c_int as uint32_t {
            alphalevel = hudplusalpha[st_translucency as usize] as uint32_t;
        }
        if alphalevel >= 10 as libc::c_int as uint32_t {
            return;
        }
        if alphalevel != 0 || blendmode != 0 {
            v_translevel = R_GetBlendTable(
                blendmode.wrapping_add(1 as libc::c_int as uint32_t) as libc::c_int,
                alphalevel as int32_t,
            );
            patchdrawfunc = Some(
                translucentpdraw
    ...
    v_colormap = 0 as *const uint8_t;
    if !colormap.is_null() {
        v_colormap = colormap;
        patchdrawfunc = if !v_translevel.is_null() {
            Some(
                transmappedpdraw
                    as unsafe extern "C" fn(
                        *const uint8_t,
    ...
    dupx = vid.dupx;
    dupy = vid.dupy;
    if scrn & 0x300 as libc::c_int != 0 {
        match (scrn & 0x300 as libc::c_int) >> 8 as libc::c_int {
            1 => {
                dupy = 1 as libc::c_int;
                dupx = dupy;
            }
            2 => {
                dupx = vid.smalldupx as int32_t;
                dupy = vid.smalldupy as int32_t;
            }
            3 => {
                dupx = vid.meddupx as int32_t;
                dupy = vid.meddupy as int32_t;
            }
            _ => {}
        }
    }
    dupy = if dupx < dupy { dupx } else { dupy };
    dupx = dupy;
    vdup = FixedMul(dupx << 16 as libc::c_int, pscale);
    fdup = vdup;
    if vscale != pscale {
        vdup = FixedMul(dupx << 16 as libc::c_int, vscale);
    }
    colfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, fdup);
    rowfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, vdup);
    let mut offsetx: fixed_t = 0 as libc::c_int;
    let mut offsety: fixed_t = 0 as libc::c_int;
    if scrn & 0x800000 as libc::c_int != 0 {
        offsetx = FixedMul(
            ((*patch).width as libc::c_int - (*patch).leftoffset as libc::c_int)
                << 16 as libc::c_int,
            pscale,
        ) + 1 as libc::c_int;
    } else {
        offsetx = FixedMul(
            ((*patch).leftoffset as libc::c_int) << 16 as libc::c_int,
            pscale,
        );
    }
    offsety = FixedMul(((*patch).topoffset as libc::c_int) << 16 as libc::c_int, vscale);
    x -= offsetx;
    y -= offsety;
    if splitscreen != 0 && scrn as libc::c_uint & 0x80000000 as libc::c_uint != 0 {
        let mut adjusty: fixed_t = (if scrn & 0x40000000 as libc::c_int != 0 {
            vid.height
        } else {
            200 as libc::c_int
        }) << 16 as libc::c_int - 1 as libc::c_int;
        vdup >>= 1 as libc::c_int;
        rowfrac <<= 1 as libc::c_int;
        y >>= 1 as libc::c_int;
        if stplyr
            == &mut *players.as_mut_ptr().offset(displayplayer as isize) as *mut player_t
        {
            if scrn & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = 1 as libc::c_int as uint8_t;
            }
            scrn &= !(0x2000000 as libc::c_int);
        } else {
            if scrn & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = 2 as libc::c_int as uint8_t;
            }
            y += adjusty;
            scrn &= !(0x1000000 as libc::c_int);
        }
    }
    desttop = screens[(scrn & 0xff as libc::c_int) as usize];
    if desttop.is_null() {
        return;
    }
    deststop = desttop.offset((vid.rowbytes * vid.height as size_t) as isize);
    if scrn & 0x40000000 as libc::c_int != 0 {
        x >>= 16 as libc::c_int;
        y >>= 16 as libc::c_int;
        desttop = desttop.offset((y * vid.width + x) as isize);
    } else {
        x = FixedMul(x, dupx << 16 as libc::c_int);
        y = FixedMul(y, dupy << 16 as libc::c_int);
        x >>= 16 as libc::c_int;
        y >>= 16 as libc::c_int;
        if scrn & 0x300 as libc::c_int == 0 {
            if x == 0 as libc::c_int
                && (*patch).width as libc::c_int == 320 as libc::c_int
                && y == 0 as libc::c_int
                && (*patch).height as libc::c_int == 200 as libc::c_int
            {
                column = ((*patch).columns as *const uint8_t)
                    .offset(
                        *((*patch).columnofs).offset(0 as libc::c_int as isize) as isize,
                    ) as *const column_t;
                if (*column).topdelta == 0 {
                    source = (column as *const uint8_t)
                    ...
                    V_DrawFill(
                        ...
                        320 as libc::c_int,
                        200 as libc::c_int,
                        *source.offset(0 as libc::c_int as isize) as int32_t,
                    );
                }
            }
            if vid.width != 320 as libc::c_int * dupx {
                if scrn & 0x8000000 as libc::c_int != 0 {
                    x += vid.width - 320 as libc::c_int * dupx;
                } else if scrn & 0x4000000 as libc::c_int == 0 {
                    x += (vid.width - 320 as libc::c_int * dupx) / 2 as libc::c_int;
                }
                if perplayershuffle as libc::c_int & 4 as libc::c_int != 0 {
                    x -= (vid.width - 320 as libc::c_int * dupx) / 4 as libc::c_int;
                } else if perplayershuffle as libc::c_int & 8 as libc::c_int != 0 {
                    x += (vid.width - 320 as libc::c_int * dupx) / 4 as libc::c_int;
                }
            }
            if vid.height != 200 as libc::c_int * dupy {
                if scrn & 0x2000000 as libc::c_int != 0 {
                    y += vid.height - 200 as libc::c_int * dupy;
                } else if scrn & 0x1000000 as libc::c_int == 0 {
                    y += (vid.height - 200 as libc::c_int * dupy) / 2 as libc::c_int;
                }
                if perplayershuffle as libc::c_int & 1 as libc::c_int != 0 {
                    y -= (vid.height - 200 as libc::c_int * dupy) / 4 as libc::c_int;
                } else if perplayershuffle as libc::c_int & 2 as libc::c_int != 0 {
                    y += (vid.height - 200 as libc::c_int * dupy) / 4 as libc::c_int;
                }
            }
        }
    ...
    if pscale != (1 as libc::c_int) << 16 as libc::c_int {
        pwidth = ((*patch).width as libc::c_int) << 16 as libc::c_int;
        pwidth = FixedMul(pwidth, pscale);
        pwidth = FixedMul(pwidth, dupx << 16 as libc::c_int);
        pwidth >>= 16 as libc::c_int;
    } else {
        pwidth = (*patch).width as libc::c_int * dupx;
    }
    deststart = desttop;
    destend = desttop.offset(pwidth as isize);
    let mut current_block_133: u64;
    col = 0 as libc::c_int;
    while (col >> 16 as libc::c_int) < (*patch).width as libc::c_int {
        let mut topdelta: int32_t = 0;
        let mut prevdelta: int32_t = -(1 as libc::c_int);
        if scrn & 0x800000 as libc::c_int != 0 {
            if x + pwidth - offx < 0 as libc::c_int {
                break;
            } else if x + pwidth - offx >= vid.width {
                current_block_133 = 6014157347423944569;
            } else {
                current_block_133 = 5706507068631705000;
            }
        } else if x + offx < 0 as libc::c_int {
            current_block_133 = 6014157347423944569;
        } else {
            if x + offx >= vid.width {
                break;
        ...
        match current_block_133 {
            5706507068631705000 => {
                column = ((*patch).columns as *const uint8_t)
                    .offset(
                        *((*patch).columnofs).offset((col >> 16 as libc::c_int) as isize)
                            as isize,
                    ) as *const column_t;
                while (*column).topdelta as libc::c_int != 0xff as libc::c_int {
                    ...
                    if scrn & 0x800000 as libc::c_int != 0 {
                        dest = deststart
                            .offset(
                                destend.offset_from(desttop) as libc::c_long as isize,
                            );
                    }
                    dest = dest
                        .offset(
                            (FixedInt(FixedMul(topdelta << 16 as libc::c_int, vdup))
                                * vid.width) as isize,
                        );
                    ofs = 0 as libc::c_int;
                    while dest < deststop as *mut uint8_t
                        && (ofs >> 16 as libc::c_int) < (*column).length as libc::c_int
                    {
                        if dest >= screens[(scrn & 0xff as libc::c_int) as usize] {
                            *dest = patchdrawfunc
                                .expect("non-null function pointer")(dest, source, ofs);
                        }
                        dest = dest.offset(vid.width as isize);
                        ofs += rowfrac;
                    }
                    column = (column as *const uint8_t)
                        .offset((*column).length as libc::c_int as isize)
                        .offset(4 as libc::c_int as isize) as *const column_t;
                }
            }
            _ => {}
        }
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCroppedPatch(
    mut x: fixed_t,
    mut y: fixed_t,
    mut pscale: fixed_t,
    mut vscale: fixed_t,
    ...
    colfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, fdup);
    rowfrac = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, vdup);
    x -= FixedMul(((*patch).leftoffset as libc::c_int) << 16 as libc::c_int, pscale);
    y -= FixedMul(((*patch).topoffset as libc::c_int) << 16 as libc::c_int, vscale);
    if splitscreen != 0 && scrn as libc::c_uint & 0x80000000 as libc::c_uint != 0 {
        let mut adjusty: fixed_t = (if scrn & 0x40000000 as libc::c_int != 0 {
            vid.height
        } else {
        ...
        {
            if scrn & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = (perplayershuffle as libc::c_int | 1 as libc::c_int)
                    as uint8_t;
            }
            scrn &= !(0x2000000 as libc::c_int);
        } else {
            if scrn & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = (perplayershuffle as libc::c_int | 2 as libc::c_int)
                    as uint8_t;
            }
            y += adjusty;
            scrn &= !(0x1000000 as libc::c_int);
    ...
    if splitscreen != 0 && scrn as libc::c_uint & 0x80000000 as libc::c_uint != 0 {
            ...
            == &mut *players.as_mut_ptr().offset(displayplayer as isize) as *mut player_t
        {
            deststop = deststop
                .offset(
                    -((vid.rowbytes * (vid.height >> 1 as libc::c_int) as size_t)
                        as isize),
                );
        } else if y < vid.height >> 1 as libc::c_int {
            sy += ((vid.height >> 1 as libc::c_int) - y) * rowfrac;
            h -= ((vid.height >> 1 as libc::c_int) - y) * rowfrac;
            desttop = desttop
                .offset((((vid.height >> 1 as libc::c_int) - y) * vid.width) as isize);
        }
    }
    col = sx;
    while (col >> 16 as libc::c_int) < (*patch).width as libc::c_int && col - sx < w {
        let mut topdelta: int32_t = 0;
        let mut prevdelta: int32_t = -(1 as libc::c_int);
        if !(x < 0 as libc::c_int) {
            if x >= vid.width {
            ...
            while (*column).topdelta as libc::c_int != 0xff as libc::c_int {
                ...
                prevdelta = topdelta;
                source = (column as *const uint8_t).offset(3 as libc::c_int as isize);
                dest = desttop;
                if (topdelta << 16 as libc::c_int) - sy > 0 as libc::c_int {
                    dest = dest
                        .offset(
                            (FixedInt(
                                FixedMul((topdelta << 16 as libc::c_int) - sy, vdup),
                            ) * vid.width) as isize,
                        );
                    ofs = 0 as libc::c_int;
                } else {
                    ofs = sy - (topdelta << 16 as libc::c_int);
                }
                while dest < deststop as *mut uint8_t
                    && (ofs >> 16 as libc::c_int) < (*column).length as libc::c_int
                    && ofs - sy + (topdelta << 16 as libc::c_int) < h
                {
                    if dest >= screens[(scrn & 0xff as libc::c_int) as usize] {
                        *dest = patchdrawfunc
                            .expect("non-null function pointer")(dest, source, ofs);
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawContinueIcon(
    mut x: int32_t,
    mut y: int32_t,
    mut flags: int32_t,
    mut skinnum: int32_t,
    ...
    if skinnum >= 0 as libc::c_int && skinnum < numskins
        && skins[skinnum as usize].sprites[SPR2_XTRA as libc::c_int as usize].numframes
            > 2 as libc::c_int as size_t
    {
        ...
        let mut sprframe: *mut spriteframe_t = &mut *((*sprdef).spriteframes)
            .offset(2 as libc::c_int as isize) as *mut spriteframe_t;
        let mut patch: *mut patch_t = W_CachePatchNum(
            (*sprframe).lumppat[0 as libc::c_int as usize],
            PU_PATCH as libc::c_int,
        ) as *mut patch_t;
        let mut colormap: *const uint8_t = R_GetTranslationColormap(
            skinnum,
            skincolor as skincolornum_t,
        ...
        V_DrawStretchyFixedPatch(
            ...
            (y - 14 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            flags,
            W_CachePatchName(
                b"CONTINS\0" as *const u8 as *const libc::c_char,
                PU_PATCH as libc::c_int,
            ) as *mut patch_t,
            0 as *const uint8_t,
        );
...
pub unsafe extern "C" fn V_DrawBlock(
    ...
    let mut dest: *mut uint8_t = 0 as *mut uint8_t;
    let mut deststop: *const uint8_t = 0 as *const uint8_t;
    dest = (screens[scrn as usize]).offset((y * vid.width) as isize).offset(x as isize);
    deststop = (screens[scrn as usize])
    ...
    loop {
        ...
        M_Memcpy
            .expect(
                "non-null function pointer",
            )(dest as *mut libc::c_void, src as *const libc::c_void, width as size_t);
        src = src.offset(width as isize);
        dest = dest.offset(vid.width as isize);
        if dest > deststop as *mut uint8_t {
            return;
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawScaledPic(
    mut rx1: int32_t,
    mut ry1: int32_t,
    mut scrn: int32_t,
    mut lumpnum: int32_t,
    ...
    V_BlitScaledPic(
        ...
        ry1,
        scrn,
        W_CacheLumpNum(lumpnum as lumpnum_t, PU_CACHE as libc::c_int) as *mut pic_t,
    );
}
unsafe extern "C" fn V_BlitScaledPic(
    mut rx1: int32_t,
    mut ry1: int32_t,
    mut scrn: int32_t,
    mut pic: *mut pic_t,
    ...
    width = (*pic).width as int32_t;
    height = (*pic).height as int32_t;
    scrn &= 0xff as libc::c_int;
    if (*pic).mode as libc::c_int != 0 as libc::c_int {
        CONS_Debug(
            0x8 as libc::c_int,
            b"pic mode %d not supported in Software\n\0" as *const u8
                as *const libc::c_char,
            (*pic).mode as libc::c_int,
        );
        return;
    }
    dest = (screens[scrn as usize])
        .offset(
            (if 0 as libc::c_int > ry1 * vid.width {
                0 as libc::c_int
            } else {
                ry1 * vid.width
            }) as isize,
        )
        .offset((if 0 as libc::c_int > rx1 { 0 as libc::c_int } else { rx1 }) as isize);
    if ry1 + height * vid.dupy >= vid.width {
        height = (vid.width - ry1) / vid.dupy - 1 as libc::c_int;
    }
    y = if 0 as libc::c_int > -ry1 / vid.dupy {
        0 as libc::c_int
    } else {
        -ry1 / vid.dupy
    };
    while y < height {
        dupy = vid.dupy;
        while dupy != 0 {
            src = ((*pic).data).as_mut_ptr().offset((y * width) as isize);
            x = 0 as libc::c_int;
            while x < width {
                dupx = vid.dupx;
                while dupx != 0 {
            ...
            dest = dest.offset((vid.width - vid.dupx * width) as isize);
            dupy -= 1;
            dupy;
        }
        y += 1;
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawFill(
    mut x: int32_t,
    mut y: int32_t,
    mut w: int32_t,
    mut h: int32_t,
    ...
    if splitscreen != 0 && c as libc::c_uint & 0x80000000 as libc::c_uint != 0 {
        let mut adjusty: fixed_t = (if c & 0x40000000 as libc::c_int != 0 {
            vid.height
        } else {
            200 as libc::c_int
        }) >> 1 as libc::c_int;
        ...
        if stplyr
            == &mut *players.as_mut_ptr().offset(displayplayer as isize) as *mut player_t
        {
            if c & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = (perplayershuffle as libc::c_int | 1 as libc::c_int)
                    as uint8_t;
            }
            c &= !(0x2000000 as libc::c_int);
        } else {
            if c & (0x1000000 as libc::c_int | 0x2000000 as libc::c_int) == 0 {
                perplayershuffle = (perplayershuffle as libc::c_int | 2 as libc::c_int)
                    as uint8_t;
    ...
    if c & 0x40000000 as libc::c_int == 0 {
        let mut dupx: int32_t = vid.dupx;
        let mut dupy: int32_t = vid.dupy;
        if x == 0 as libc::c_int && y == 0 as libc::c_int && w == 320 as libc::c_int
            && h == 200 as libc::c_int
        {
            memset(
                screens[0 as libc::c_int as usize] as *mut libc::c_void,
                c & 255 as libc::c_int,
                (vid.width * vid.height * vid.bpp) as libc::c_ulong,
            );
            return;
        }
        x *= dupx;
        ...
        h *= dupy;
        if vid.width != 320 as libc::c_int * dupx {
            if c & 0x8000000 as libc::c_int != 0 {
                x += vid.width - 320 as libc::c_int * dupx;
            } else if c & 0x4000000 as libc::c_int == 0 {
                x += (vid.width - 320 as libc::c_int * dupx) / 2 as libc::c_int;
            }
            if perplayershuffle as libc::c_int & 4 as libc::c_int != 0 {
                x -= (vid.width - 320 as libc::c_int * dupx) / 4 as libc::c_int;
    ...
    dest = (screens[0 as libc::c_int as usize])
        .offset((y * vid.width) as isize)
        .offset(x as isize);
    deststop = (screens[0 as libc::c_int as usize])
        .offset((vid.rowbytes * vid.height as size_t) as isize);
    c &= 255 as libc::c_int;
    loop {
        h -= 1;
        if !(h >= 0 as libc::c_int && dest < deststop as *mut uint8_t) {
            break;
        }
        memset(dest as *mut libc::c_void, c, (w * vid.bpp) as libc::c_ulong);
        dest = dest.offset(vid.width as isize);
    };
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawFillConsoleMap(
    mut x: int32_t,
    mut y: int32_t,
    mut w: int32_t,
    mut h: int32_t,
    ...
    let mut deststop: *const uint8_t = 0 as *const uint8_t;
    let mut u: int32_t = 0;
    let mut fadetable: *mut uint8_t = 0 as *mut uint8_t;
    let mut alphalevel: uint32_t = 0 as libc::c_int as uint32_t;
    let mut perplayershuffle: uint8_t = 0 as libc::c_int as uint8_t;
    if rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint {
        return;
    }
    alphalevel = ((c & 0xf0000 as libc::c_int) >> 16 as libc::c_int) as uint32_t;
    if alphalevel != 0 {
        if alphalevel == 10 as libc::c_int as uint32_t {
            alphalevel = hudminusalpha[st_translucency as usize] as uint32_t;
        } else if alphalevel == 11 as libc::c_int as uint32_t {
    ...
    c &= 255 as libc::c_int;
    if alphalevel != 0 {
        fadetable = (R_GetTranslucencyTable(alphalevel as int32_t))
            .offset((c * 256 as libc::c_int) as isize);
        loop {
            h -= 1;
            if !(h >= 0 as libc::c_int && dest < deststop as *mut uint8_t) {
                break;
            ...
            while u < w {
                *dest
                    ...
                    .offset(
                        *consolebgmap.offset(*dest.offset(u as isize) as isize) as isize,
                    );
                u += 1;
                u;
            }
        ...
        loop {
            ...
            while u < w {
                *dest
                    .offset(
                        u as isize,
                    ) = *consolebgmap.offset(*dest.offset(u as isize) as isize);
                u += 1;
                u;
            }
            dest = dest.offset(vid.width as isize);
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawFadeFill(
    mut x: int32_t,
    mut y: int32_t,
    mut w: int32_t,
    mut h: int32_t,
    ...
    deststop = (screens[0 as libc::c_int as usize])
        .offset((vid.rowbytes * vid.height as size_t) as isize);
    c &= 255 as libc::c_int;
    fadetable = if color as libc::c_int & 0xff00 as libc::c_int != 0 {
        (colormaps as *mut uint8_t)
            .offset((strength as libc::c_int * 256 as libc::c_int) as isize)
    } else {
        (R_GetTranslucencyTable(
            9 as libc::c_int - strength as libc::c_int + 1 as libc::c_int,
        ))
            .offset((color as libc::c_int * 256 as libc::c_int) as isize)
    };
    loop {
        h -= 1;
        if !(h >= 0 as libc::c_int && dest < deststop as *mut uint8_t) {
        ...
        while u < w {
            *dest
                .offset(
                    u as isize,
                ) = *fadetable.offset(*dest.offset(u as isize) as isize);
            u += 1;
            u;
        }
        dest = dest.offset(vid.width as isize);
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawFlatFill(
    mut x: int32_t,
    mut y: int32_t,
    mut w: int32_t,
    mut h: int32_t,
    mut flatnum: lumpnum_t,
) {
    let mut u: int32_t = 0;
    let mut v: int32_t = 0;
    let mut dupx: int32_t = 0;
    ...
    let mut xfrac: fixed_t = 0;
    let mut yfrac: fixed_t = 0;
    let mut src: *const uint8_t = 0 as *const uint8_t;
    let mut deststop: *const uint8_t = 0 as *const uint8_t;
    let mut flat: *mut uint8_t = 0 as *mut uint8_t;
    let mut dest: *mut uint8_t = 0 as *mut uint8_t;
    let mut lflatsize: size_t = 0;
    let mut flatshift: size_t = 0;
    lflatsize = R_GetFlatSize(W_LumpLength(flatnum)) as size_t;
    flatshift = R_GetFlatBits(lflatsize as int32_t) as size_t;
    flat = W_CacheLumpNum(flatnum, PU_CACHE as libc::c_int) as *mut uint8_t;
    dupy = if vid.dupx < vid.dupy { vid.dupx } else { vid.dupy };
    dupx = dupy;
    dest = (screens[0 as libc::c_int as usize])
        .offset((y * dupy * vid.width) as isize)
        .offset((x * dupx) as isize);
    deststop = (screens[0 as libc::c_int as usize])
        .offset((vid.rowbytes * vid.height as size_t) as isize);
    if vid.width != 320 as libc::c_int * dupx {
        dest = dest
            .offset(
                ((vid.width - 320 as libc::c_int * dupx) / 2 as libc::c_int) as isize,
            );
    }
    if vid.height != 200 as libc::c_int * dupy {
        dest = dest
            .offset(
                ((vid.height - 200 as libc::c_int * dupy) * vid.width / 2 as libc::c_int)
                    as isize,
            );
    }
    w *= dupx;
    ...
    dx = FixedDiv(
        (1 as libc::c_int) << 16 as libc::c_int,
        dupx << 16 as libc::c_int - 2 as libc::c_int,
    );
    dy = FixedDiv(
        (1 as libc::c_int) << 16 as libc::c_int,
        dupy << 16 as libc::c_int - 2 as libc::c_int,
    );
    yfrac = 0 as libc::c_int;
    v = 0 as libc::c_int;
    while v < h {
        xfrac = 0 as libc::c_int;
        src = flat
            .offset(
                (((yfrac >> 16 as libc::c_int) as size_t
                    & lflatsize.wrapping_sub(1 as libc::c_int as size_t)) << flatshift)
                    as isize,
            );
        u = 0 as libc::c_int;
        while u < w {
            if &mut *dest.offset(u as isize) as *mut uint8_t > deststop as *mut uint8_t {
                return;
            }
            *dest
                .offset(
                ...
                .offset(
                    ((xfrac >> 16 as libc::c_int) as size_t
                        & lflatsize.wrapping_sub(1 as libc::c_int as size_t)) as isize,
                );
            xfrac += dx;
            u += 1;
            u;
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawPatchFill(mut pat: *mut patch_t) {
    let mut dupz: int32_t = if vid.dupx < vid.dupy { vid.dupx } else { vid.dupy };
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut pw: int32_t = (*pat).width as libc::c_int * dupz;
    let mut ph: int32_t = (*pat).height as libc::c_int * dupz;
    x = 0 as libc::c_int;
    while x < vid.width {
        y = 0 as libc::c_int;
        while y < vid.height {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawFadeScreen(mut color: uint16_t, mut strength: uint8_t) {
    let mut fadetable: *const uint8_t = if color as libc::c_int & 0xff00 as libc::c_int
        != 0
    {
        ((if color as libc::c_int & 0xf00 as libc::c_int == 0xa00 as libc::c_int {
            fadecolormap
        } else {
            (if color as libc::c_int & 0xf00 as libc::c_int == 0xb00 as libc::c_int {
                fadecolormap
                    .offset(
                        (256 as libc::c_int * (256 as libc::c_int / 8 as libc::c_int))
                            as isize,
                    )
            } else {
                colormaps
    ...
    let mut deststop: *const uint8_t = (screens[0 as libc::c_int as usize])
        .offset((vid.rowbytes * vid.height as size_t) as isize);
    let mut buf: *mut uint8_t = screens[0 as libc::c_int as usize];
    while buf < deststop as *mut uint8_t {
        *buf = *fadetable.offset(*buf as isize);
        buf = buf.offset(1);
        buf;
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawFadeConsBack(mut plines: int32_t) {
    let mut deststop: *mut uint8_t = 0 as *mut uint8_t;
    let mut buf: *mut uint8_t = 0 as *mut uint8_t;
    deststop = (screens[0 as libc::c_int as usize])
        .offset(
            (vid.rowbytes
                * (if plines < vid.height { plines } else { vid.height }) as size_t)
                as isize,
        );
    buf = screens[0 as libc::c_int as usize];
    while buf < deststop {
        *buf = *consolebgmap.offset(*buf as isize);
        buf = buf.offset(1);
        buf;
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawPromptBack(mut boxheight: int32_t, mut color: int32_t) {
    let mut deststop: *mut uint8_t = 0 as *mut uint8_t;
    let mut buf: *mut uint8_t = 0 as *mut uint8_t;
    if color >= 256 as libc::c_int && color < 512 as libc::c_int {
        if boxheight < 0 as libc::c_int {
            boxheight = -boxheight;
        } else {
            boxheight = boxheight * 4 as libc::c_int
                + boxheight / 2 as libc::c_int * 5 as libc::c_int;
        }
        V_DrawFill(
            (320 as libc::c_int - vid.width / vid.dupx) / 2 as libc::c_int,
            200 as libc::c_int - boxheight,
            vid.width / vid.dupx,
            boxheight,
            color - 256 as libc::c_int | 0x2000000 as libc::c_int,
        );
        return;
    }
    boxheight *= vid.dupy;
    ...
    CON_SetupBackColormapEx(color, true_0 as libc::c_int);
    deststop = (screens[0 as libc::c_int as usize])
        .offset((vid.rowbytes * vid.height as size_t) as isize);
    buf = deststop;
    if boxheight < 0 as libc::c_int {
        buf = buf.offset((vid.rowbytes * boxheight as size_t) as isize);
    } else {
        buf = buf
            .offset(
                -((vid.rowbytes
                    * (boxheight * 4 as libc::c_int
                        + boxheight / 2 as libc::c_int * 5 as libc::c_int) as size_t)
                    as isize),
            );
    }
    while buf < deststop {
        *buf = *promptbgmap.offset(*buf as isize);
        buf = buf.offset(1);
        buf;
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_GetStringColormap(mut colorflags: int32_t) -> *mut uint8_t {
    match (colorflags & 0xf000 as libc::c_int) >> 12 as libc::c_int {
        1 => return magentamap,
        2 => return yellowmap,
        3 => return lgreenmap,
        4 => return bluemap,
        ...
        9 => return purplemap,
        10 => return aquamap,
        11 => return peridotmap,
        12 => return azuremap,
        13 => return brownmap,
        14 => return rosymap,
        15 => return invertmap,
        _ => return 0 as *mut uint8_t,
    };
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawCharacter(
    mut x: int32_t,
    mut y: int32_t,
    mut c: int32_t,
    mut lowercaseallowed: boolean,
) {
    let mut w: int32_t = 0;
    let mut flags: int32_t = 0;
    let mut colormap: *const uint8_t = V_GetStringColormap(c);
    flags = c & !(0xf000 as libc::c_int | 0xff as libc::c_int);
    c &= 0x7f as libc::c_int;
    if lowercaseallowed != 0 {
        c -= '\u{16}' as i32;
    } else {
        c = ({
    ...
    if c < 0 as libc::c_int || c >= '~' as i32 - '\u{16}' as i32 + 1 as libc::c_int
        || (hu_font[c as usize]).is_null()
    {
        return;
    }
    w = (*hu_font[c as usize]).width as int32_t;
    if x + w > vid.width {
        return;
    }
    if !colormap.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawChatCharacter(
    mut x: int32_t,
    mut y: int32_t,
    mut c: int32_t,
    mut lowercaseallowed: boolean,
    ...
    w = if vid.width < 640 as libc::c_int {
        (*hu_font[c as usize]).width as libc::c_int / 2 as libc::c_int
    } else {
        (*hu_font[c as usize]).width as libc::c_int
    };
    if x + w > vid.width {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn V_WordWrap(
    mut x: int32_t,
    mut w: int32_t,
    mut option: int32_t,
    ...
    let mut spacewidth: int32_t = 4 as libc::c_int;
    let mut charwidth: int32_t = 0 as libc::c_int;
    slen = strlen(string);
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 8 as libc::c_int;
            current_block_7 = 17318695777156444051;
        }
        2048 => {
            current_block_7 = 17318695777156444051;
        }
        1024 => {
            spacewidth = 6 as libc::c_int;
            current_block_7 = 11812396948646013369;
        }
        _ => {
            current_block_7 = 11812396948646013369;
        }
    ...
    match current_block_7 {
        17318695777156444051 => {
            charwidth = 8 as libc::c_int;
        }
        _ => {}
    }
    i = 0 as libc::c_int as size_t;
    while i < slen {
        c = *newstring.offset(i as isize) as libc::c_int;
        if !(c as uint8_t as libc::c_int & 0x80 as libc::c_int != 0) {
            if c == '\n' as i32 {
                x = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    let mut w: int32_t = 0;
    let mut c: int32_t = 0;
    let mut cx: int32_t = x;
    let mut cy: int32_t = y;
    let mut dupx: int32_t = 0;
    let mut dupy: int32_t = 0;
    let mut scrwidth: int32_t = 0;
    let mut center: int32_t = 0 as libc::c_int;
    let mut left: int32_t = 0 as libc::c_int;
    let mut ch: *const libc::c_char = string;
    let mut charflags: int32_t = option & 0xf000 as libc::c_int;
    let mut colormap: *const uint8_t = 0 as *const uint8_t;
    let mut spacewidth: int32_t = 4 as libc::c_int;
    let mut charwidth: int32_t = 0 as libc::c_int;
    let mut lowercase: int32_t = option & 0x800000 as libc::c_int;
    option &= !(0x800000 as libc::c_int);
    if option & 0x40000000 as libc::c_int != 0 {
        dupx = vid.dupx;
        dupy = vid.dupy;
        scrwidth = vid.width;
    } else {
        ...
        left = (scrwidth - 320 as libc::c_int) / 2 as libc::c_int;
        scrwidth -= left;
    }
    if option & 0x100 as libc::c_int != 0 {
        scrwidth *= vid.dupx;
    }
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 8 as libc::c_int;
            current_block_15 = 7879707902969054342;
        }
        2048 => {
            current_block_15 = 7879707902969054342;
        }
    ...
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            if option & 0xf000 as libc::c_int == 0 {
                charflags = (*ch as libc::c_int & 0x7f as libc::c_int)
                    << 12 as libc::c_int & 0xf000 as libc::c_int;
            }
        } else if *ch as libc::c_int == '\n' as i32 {
            cx = x;
            if option & 0x20000000 as libc::c_int != 0 {
                cy += 8 as libc::c_int * dupy;
            } else {
                cy += 12 as libc::c_int * dupy;
            }
        } else {
            c = *ch as int32_t;
            if lowercase == 0 {
                ...
                || (hu_font[c as usize]).is_null()
            {
                ...
                if charwidth != 0 {
                    w = charwidth * dupx;
                    center = w / 2 as libc::c_int
                        - (*hu_font[c as usize]).width as libc::c_int * dupx
                            / 2 as libc::c_int;
                } else {
                    w = (*hu_font[c as usize]).width as libc::c_int * dupx;
                }
                if !(cx > scrwidth) {
                    if cx + left + w < 0 as libc::c_int {
                        cx += w;
                    } else {
                        colormap = V_GetStringColormap(charflags);
                        V_DrawStretchyFixedPatch(
                            cx + center << 16 as libc::c_int,
                            cy << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            (1 as libc::c_int) << 16 as libc::c_int,
                            option,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_StringWidth(string, option) / 2 as libc::c_int;
    V_DrawString(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawSmallString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    let mut colormap: *const uint8_t = 0 as *const uint8_t;
    let mut spacewidth: int32_t = 2 as libc::c_int;
    let mut charwidth: int32_t = 0 as libc::c_int;
    let mut lowercase: int32_t = option & 0x800000 as libc::c_int;
    option &= !(0x800000 as libc::c_int);
    if option & 0x40000000 as libc::c_int != 0 {
    ...
    charflags = option & 0xf000 as libc::c_int;
    let mut current_block_16: u64;
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 4 as libc::c_int;
            current_block_16 = 14787643187829317577;
        }
        2048 => {
            current_block_16 = 14787643187829317577;
        }
        1024 => {
            spacewidth = 3 as libc::c_int;
            current_block_16 = 5143058163439228106;
        }
        _ => {
            current_block_16 = 5143058163439228106;
        }
    ...
    match current_block_16 {
        14787643187829317577 => {
            charwidth = 4 as libc::c_int;
        }
        _ => {}
    }
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            ...
            cx = x;
            if option & 0x20000000 as libc::c_int != 0 {
                cy += 4 as libc::c_int * dupy;
            } else {
                cy += 6 as libc::c_int * dupy;
            }
        } else {
            c = *ch as int32_t;
            if lowercase == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredSmallString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_SmallStringWidth(string, option) / 2 as libc::c_int;
    V_DrawSmallString(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedSmallString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 5 as libc::c_int;
            current_block_16 = 17076911773233403273;
        }
        2048 => {
            current_block_16 = 17076911773233403273;
        }
    ...
    match current_block_16 {
        17076911773233403273 => {
            charwidth = 5 as libc::c_int;
        }
        _ => {}
    }
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            ...
            c = *ch as int32_t;
            if lowercase == 0 || (tny_font[(c - '\u{16}' as i32) as usize]).is_null() {
                c = ({
                    let mut __res: libc::c_int = 0;
                    if ::core::mem::size_of::<int32_t>() as libc::c_ulong
                        > 1 as libc::c_int as libc::c_ulong
                ...
                || (tny_font[c as usize]).is_null()
            {
                ...
                if charwidth != 0 {
                    ...
                    w = (*tny_font[c as usize]).width as libc::c_int * dupx;
                }
                if !(cx > scrwidth) {
                    if cx + left + w < 0 as libc::c_int {
                        cx += w;
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_ThinStringWidth(string, option) / 2 as libc::c_int;
    V_DrawThinString(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawSmallThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredSmallThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    x <<= 16 as libc::c_int;
    y <<= 16 as libc::c_int;
    V_DrawCenteredSmallThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedSmallThinString(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    x <<= 16 as libc::c_int;
    y <<= 16 as libc::c_int;
    V_DrawRightAlignedSmallThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    let mut cx: fixed_t = x;
    let mut cy: fixed_t = y;
    let mut w: int32_t = 0;
    let mut c: int32_t = 0;
    let mut dupx: int32_t = 0;
    let mut dupy: int32_t = 0;
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 8 as libc::c_int;
            current_block_16 = 3922472285499926031;
        }
        2048 => {
            current_block_16 = 3922472285499926031;
        }
    ...
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            ...
            cx = x;
            if option & 0x20000000 as libc::c_int != 0 {
                cy += 8 as libc::c_int * dupy << 16 as libc::c_int;
            } else {
                cy += 12 as libc::c_int * dupy << 16 as libc::c_int;
            }
        } else {
            c = *ch as int32_t;
            if lowercase == 0 {
            ...
            if c < 0 as libc::c_int
                ...
                || (hu_font[c as usize]).is_null()
            {
                cx += spacewidth * dupx << 16 as libc::c_int;
            } else {
                if charwidth != 0 {
                    w = charwidth * dupx;
                    center = w / 2 as libc::c_int
                        - (*hu_font[c as usize]).width as libc::c_int
                            * (dupx / 2 as libc::c_int);
                } else {
                    w = (*hu_font[c as usize]).width as libc::c_int * dupx;
                }
                if !(cx >> 16 as libc::c_int > scrwidth) {
                    if (cx >> 16 as libc::c_int) + left + w < 0 as libc::c_int {
                        cx += w << 16 as libc::c_int;
                    } else {
                        colormap = V_GetStringColormap(charflags);
                        V_DrawStretchyFixedPatch(
                            cx + (center << 16 as libc::c_int),
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= (V_StringWidth(string, option) / 2 as libc::c_int) << 16 as libc::c_int;
    V_DrawStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_StringWidth(string, option) << 16 as libc::c_int;
    V_DrawStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawSmallStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 4 as libc::c_int;
            current_block_16 = 16858732679435153749;
        }
        2048 => {
            current_block_16 = 16858732679435153749;
        }
    ...
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            ...
            cx = x;
            if option & 0x20000000 as libc::c_int != 0 {
                cy += 4 as libc::c_int * dupy << 16 as libc::c_int;
            } else {
                cy += 6 as libc::c_int * dupy << 16 as libc::c_int;
            }
        } else {
            c = *ch as int32_t;
            if lowercase == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredSmallStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= (V_SmallStringWidth(string, option) / 2 as libc::c_int) << 16 as libc::c_int;
    V_DrawSmallStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedSmallStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_SmallStringWidth(string, option) << 16 as libc::c_int;
    V_DrawSmallStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 8 as libc::c_int;
            current_block_16 = 5388413221444471196;
        }
        2048 => {
            current_block_16 = 5388413221444471196;
        }
        ...
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
                ...
                || (tny_font[c as usize]).is_null()
            {
                ...
                if charwidth != 0 {
                    w = charwidth * dupx;
                    center = w / 2 as libc::c_int
                        - (*tny_font[c as usize]).width as libc::c_int
                            * (dupx / 2 as libc::c_int);
                } else {
                    w = (*tny_font[c as usize]).width as libc::c_int * dupx;
                }
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= (V_ThinStringWidth(string, option) / 2 as libc::c_int) << 16 as libc::c_int;
    V_DrawThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_ThinStringWidth(string, option) << 16 as libc::c_int;
    V_DrawThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawSmallThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    let mut charflags: int32_t = 0 as libc::c_int;
    let mut colormap: *const uint8_t = 0 as *const uint8_t;
    let mut spacewidth: int32_t = (2 as libc::c_int) << 16 as libc::c_int;
    let mut charwidth: int32_t = 0 as libc::c_int;
    let mut lowercase: int32_t = option & 0x800000 as libc::c_int;
    option &= !(0x800000 as libc::c_int);
    if option & 0x40000000 as libc::c_int != 0 {
        dupx = vid.dupx << 16 as libc::c_int;
        dupy = vid.dupy << 16 as libc::c_int;
        scrwidth = vid.width;
    } else {
        dupy = (1 as libc::c_int) << 16 as libc::c_int;
        dupx = dupy;
        scrwidth = FixedDiv(vid.width << 16 as libc::c_int, vid.dupx);
        left = (scrwidth - ((320 as libc::c_int) << 16 as libc::c_int))
            / 2 as libc::c_int;
        scrwidth -= left;
    }
    if option & 0x100 as libc::c_int != 0 {
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = (4 as libc::c_int) << 16 as libc::c_int;
            current_block_16 = 5948659367362059652;
        }
        2048 => {
            current_block_16 = 5948659367362059652;
        }
        1024 => {
            spacewidth = (3 as libc::c_int) << 16 as libc::c_int;
            current_block_16 = 4956146061682418353;
        }
        _ => {
            current_block_16 = 4956146061682418353;
    ...
    match current_block_16 {
        5948659367362059652 => {
            charwidth = (4 as libc::c_int) << 16 as libc::c_int;
        }
        _ => {}
    }
    while !(*ch == 0) {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawCenteredSmallThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_SmallThinStringWidth(string, option) / 4 as libc::c_int;
    V_DrawSmallThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawRightAlignedSmallThinStringAtFixed(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
) {
    x -= V_SmallThinStringWidth(string, option) / 2 as libc::c_int;
    V_DrawSmallThinStringAtFixed(x, y, option, string);
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawTallNum(
    mut x: int32_t,
    mut y: int32_t,
    mut flags: int32_t,
    mut num: int32_t,
) {
    let mut w: int32_t = (*tallnum[0 as libc::c_int as usize]).width as int32_t;
    let mut neg: boolean = 0;
    if flags & (0x40000000 as libc::c_int | 0x100 as libc::c_int) != 0 {
        w *= vid.dupx;
    }
    neg = (num < 0 as libc::c_int) as libc::c_int;
    if neg != 0 {
        num = -num;
    }
    loop {
        ...
        V_DrawStretchyFixedPatch(
            ...
            (1 as libc::c_int) << 16 as libc::c_int,
            flags,
            tallnum[(num % 10 as libc::c_int) as usize],
            0 as *const uint8_t,
        );
    ...
    if neg != 0 {
        V_DrawStretchyFixedPatch(
            (x - w) * ((1 as libc::c_int) << 16 as libc::c_int),
            y << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            (1 as libc::c_int) << 16 as libc::c_int,
            flags,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawPaddedTallNum(
    mut x: int32_t,
    mut y: int32_t,
    mut flags: int32_t,
    mut num: int32_t,
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawLevelActNum(
    mut x: int32_t,
    mut y: int32_t,
    mut flags: int32_t,
    mut num: uint8_t,
) {
    if num as libc::c_int > 99 as libc::c_int {
        return;
    }
    while num as libc::c_int > 0 as libc::c_int {
        if num as libc::c_int > 9 as libc::c_int {
            V_DrawStretchyFixedPatch(
                (x
                    + (V_LevelActNumWidth(num) as libc::c_int
                        - V_LevelActNumWidth(
                            (num as libc::c_int % 10 as libc::c_int) as uint8_t,
                        ) as libc::c_int)) * ((1 as libc::c_int) << 16 as libc::c_int),
                y << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                (1 as libc::c_int) << 16 as libc::c_int,
                flags,
                ttlnum[(num as libc::c_int % 10 as libc::c_int) as usize],
                0 as *const uint8_t,
            );
        } else {
            V_DrawStretchyFixedPatch(
        ...
        num = (num as libc::c_int / 10 as libc::c_int) as uint8_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_DrawCreditString(
    mut x: fixed_t,
    mut y: fixed_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    let mut dupx: int32_t = 0;
    let mut dupy: int32_t = 0;
    let mut scrwidth: int32_t = 320 as libc::c_int;
    let mut cx: fixed_t = x;
    let mut cy: fixed_t = y;
    let mut ch: *const libc::c_char = string;
    if string.is_null() {
    ...
    loop {
        ...
        if c == '\n' as i32 {
            ...
            if c < 0 as libc::c_int || c >= 'Z' as i32 - '!' as i32 + 1 as libc::c_int {
                cx += 16 as libc::c_int * dupx << 16 as libc::c_int;
            } else {
                w = (*cred_font[c as usize]).width as libc::c_int * dupx;
                if cx >> 16 as libc::c_int > scrwidth {
                    continue;
                }
                V_DrawStretchyFixedPatch(
...
unsafe extern "C" fn V_DrawNameTagLine(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut scale: fixed_t,
    ...
    let mut cx: fixed_t = 0;
    let mut cy: fixed_t = 0;
    let mut w: fixed_t = 0;
    let mut c: int32_t = 0;
    let mut dupx: int32_t = 0;
    let mut dupy: int32_t = 0;
    ...
    if option & 0x800000 as libc::c_int != 0 {
        x
            -= FixedInt(
                FixedMul(
                    V_NameTagWidth(string) / 2 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    scale,
                ),
            );
    ...
    option &= !(0x800000 as libc::c_int);
    cx = x << 16 as libc::c_int;
    cy = y << 16 as libc::c_int;
    if option & 0x40000000 as libc::c_int != 0 {
        dupx = vid.dupx;
        dupy = vid.dupy;
        scrwidth = vid.width;
    ...
    while !(*ch == 0) {
        if *ch as libc::c_int == '\n' as i32 {
            ...
            cy
                += FixedMul(
                    21 as libc::c_int * dupy * ((1 as libc::c_int) << 16 as libc::c_int),
                    scale,
                );
        } else {
            c = ({
                ...
                {
                    if 0 != 0 {
                        let mut __c: libc::c_int = *ch as libc::c_int;
                        __res = if __c < -(128 as libc::c_int)
                            || __c > 255 as libc::c_int
                        {
                            __c
                        ...
                        __res = toupper(*ch as libc::c_int);
                    }
                } else {
            ...
            c -= '!' as i32;
            if c < 0 as libc::c_int || c >= 'Z' as i32 - '!' as i32 + 1 as libc::c_int
                || (ntb_font[c as usize]).is_null() || (nto_font[c as usize]).is_null()
            {
                cx
                    += FixedMul(
                        4 as libc::c_int * dupx
                            * ((1 as libc::c_int) << 16 as libc::c_int),
                        scale,
                    );
            } else {
                w = FixedMul(
                    ((*ntb_font[c as usize]).width as libc::c_int
                        + 2 as libc::c_int * dupx)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    scale,
                );
                if !(FixedInt(cx) > scrwidth) {
                    if cx + left * ((1 as libc::c_int) << 16 as libc::c_int) + w
                        < 0 as libc::c_int
                    {
                        cx += w;
                    } else {
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawNameTag(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut scale: fixed_t,
    ...
    let mut text: *const libc::c_char = string;
    let mut first_token: *const libc::c_char = text;
    let mut last_token: *mut libc::c_char = strchr(text, '\n' as i32);
    let lbreakheight: int32_t = 21 as libc::c_int;
    let mut ntlines: int32_t = 0;
    if option & 0x800000 as libc::c_int != 0 {
        ntlines = V_CountNameTagLines(string);
        y
            -= FixedInt(
                FixedMul(
                    lbreakheight / 2 as libc::c_int * (ntlines - 1 as libc::c_int)
                        * ((1 as libc::c_int) << 16 as libc::c_int),
                    scale,
                ),
            );
    ...
    if last_token.is_null() {
        ...
        while true_0 as libc::c_int != 0 {
            if !last_token.is_null() {
                let mut shift: size_t = 0 as libc::c_int as size_t;
                if !str.is_null() {
                    Z_Free(str as *mut libc::c_void);
                }
                len = (last_token.offset_from(first_token) as libc::c_long
                ...
                strncpy(str, first_token, (len - 1 as libc::c_int) as libc::c_ulong);
                *str
                    .offset(
                ...
                V_DrawNameTagLine(
                    ...
                    basecolormap,
                    outlinecolormap,
                    str.offset(shift as isize),
                );
                y
                    += FixedInt(
                        FixedMul(
                            lbreakheight * ((1 as libc::c_int) << 16 as libc::c_int),
                            scale,
                        ),
                    );
                if last_token.offset_from(text) as libc::c_long
                    + 1 as libc::c_int as libc::c_long
                    >= strlen(text) as libc::c_int as libc::c_long
                {
                    last_token = 0 as *mut libc::c_char;
                } else {
                    first_token = last_token;
                    last_token = strchr(
                        first_token.offset(1 as libc::c_int as isize),
                        '\n' as i32,
                    );
                }
            } else {
                if strlen(first_token) >= 2 as libc::c_int as libc::c_ulong
                    && *first_token.offset(0 as libc::c_int as isize) as libc::c_int
                        == '\n' as i32
                    && *first_token.offset(1 as libc::c_int as isize) as libc::c_int
                        != '\n' as i32
                {
                    first_token = first_token.offset(1);
                    first_token;
                }
                V_DrawNameTagLine(
                    x,
...
#[no_mangle]
pub unsafe extern "C" fn V_CountNameTagLines(
    mut string: *const libc::c_char,
) -> int32_t {
    let mut ntlines: int32_t = 1 as libc::c_int;
    let mut text: *const libc::c_char = string;
    let mut first_token: *const libc::c_char = text;
    let mut last_token: *mut libc::c_char = strchr(text, '\n' as i32);
    if last_token.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn V_NameTagWidth(mut string: *const libc::c_char) -> int32_t {
    let mut c: int32_t = 0;
    let mut w: int32_t = 0 as libc::c_int;
    let mut i: size_t = 0;
    if string.is_null() {
    ...
    while i < strlen(string) {
        c = ({
            ...
            {
                if 0 != 0 {
                    let mut __c: libc::c_int = *string.offset(i as isize) as libc::c_int;
                    __res = (if __c < -(128 as libc::c_int) || __c > 255 as libc::c_int {
                        __c
                    } else {
                        *(*__ctype_toupper_loc()).offset(__c as isize)
                    ...
                    __res = toupper(*string.offset(i as isize) as libc::c_int);
                }
            } else {
                __res = *(*__ctype_toupper_loc())
                    .offset(*string.offset(i as isize) as libc::c_int as isize);
            }
            __res
        }) - '!' as i32;
        if c < 0 as libc::c_int || c >= 'Z' as i32 - '!' as i32 + 1 as libc::c_int
            || (ntb_font[c as usize]).is_null() || (nto_font[c as usize]).is_null()
        {
            ...
            w += (*ntb_font[c as usize]).width as libc::c_int + 2 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
    }
...
#[no_mangle]
pub unsafe extern "C" fn V_CreditStringWidth(
    mut string: *const libc::c_char,
) -> int32_t {
    let mut c: int32_t = 0;
    let mut w: int32_t = 0 as libc::c_int;
    ...
    while i < strlen(string) {
        ...
        if c < 0 as libc::c_int || c >= 'Z' as i32 - '!' as i32 + 1 as libc::c_int {
            ...
            w += (*cred_font[c as usize]).width as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
    }
...
#[no_mangle]
pub unsafe extern "C" fn V_DrawLevelTitle(
    mut x: int32_t,
    mut y: int32_t,
    mut option: int32_t,
    mut string: *const libc::c_char,
    ...
    while !(*ch == 0) {
        if *ch as libc::c_int & 0x80 as libc::c_int != 0 {
            ...
            c = *ch as libc::c_int - '!' as i32;
            if c < 0 as libc::c_int || c >= 'z' as i32 - '!' as i32 + 1 as libc::c_int
                || (lt_font[c as usize]).is_null()
            {
                cx += 16 as libc::c_int * dupx;
            } else {
                w = (*lt_font[c as usize]).width as libc::c_int * dupx;
                if !(cx > scrwidth) {
                    if cx + left + w < 0 as libc::c_int {
                        cx += w;
                    } else {
...
#[no_mangle]
pub unsafe extern "C" fn V_LevelNameWidth(mut string: *const libc::c_char) -> int32_t {
    let mut c: int32_t = 0;
    let mut w: int32_t = 0 as libc::c_int;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < strlen(string) {
        if !(*string.offset(i as isize) as libc::c_int & 0x80 as libc::c_int != 0) {
            c = *string.offset(i as isize) as libc::c_int - '!' as i32;
            if c < 0 as libc::c_int || c >= 'z' as i32 - '!' as i32 + 1 as libc::c_int
                || (lt_font[c as usize]).is_null()
            {
                w += 16 as libc::c_int;
            } else {
                w += (*lt_font[c as usize]).width as libc::c_int;
            }
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn V_LevelNameHeight(mut string: *const libc::c_char) -> int32_t {
    let mut c: int32_t = 0;
    let mut w: int32_t = 0 as libc::c_int;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < strlen(string) {
        ...
        if !(c < 0 as libc::c_int || c >= 'z' as i32 - '!' as i32 + 1 as libc::c_int
            || (lt_font[c as usize]).is_null())
        {
            if (*lt_font[c as usize]).height as libc::c_int > w {
                w = (*lt_font[c as usize]).height as int32_t;
            }
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn V_LevelActNumWidth(mut num: uint8_t) -> int16_t {
    let mut result: int16_t = 0 as libc::c_int as int16_t;
    if num as libc::c_int == 0 as libc::c_int {
        result = (*ttlnum[num as usize]).width;
    }
    while num as libc::c_int > 0 as libc::c_int
        && num as libc::c_int <= 99 as libc::c_int
    {
        result = (result as libc::c_int
            + (*ttlnum[(num as libc::c_int % 10 as libc::c_int) as usize]).width
...
#[no_mangle]
pub unsafe extern "C" fn V_StringWidth(
    mut string: *const libc::c_char,
    mut option: int32_t,
) -> int32_t {
    let mut c: int32_t = 0;
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 8 as libc::c_int;
            current_block_2 = 7881209859921981377;
        }
        2048 => {
            current_block_2 = 7881209859921981377;
        }
    ...
    while i < strlen(string) {
        if !(*string.offset(i as isize) as libc::c_int & 0x80 as libc::c_int != 0) {
            c = ({
                ...
                {
                    if 0 != 0 {
                        let mut __c: libc::c_int = *string.offset(i as isize)
                            as libc::c_int;
                        __res = (if __c < -(128 as libc::c_int)
                            || __c > 255 as libc::c_int
                        {
    ...
    if option & (0x40000000 as libc::c_int | 0x100 as libc::c_int) != 0 {
        w *= vid.dupx;
    }
    return w;
}
#[no_mangle]
pub unsafe extern "C" fn V_SmallStringWidth(
    mut string: *const libc::c_char,
    mut option: int32_t,
) -> int32_t {
    let mut c: int32_t = 0;
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 4 as libc::c_int;
            current_block_2 = 11035326544810235037;
        }
        2048 => {
            current_block_2 = 11035326544810235037;
        }
...
#[no_mangle]
pub unsafe extern "C" fn V_ThinStringWidth(
    mut string: *const libc::c_char,
    mut option: int32_t,
) -> int32_t {
    let mut c: int32_t = 0;
    ...
    match option & 0xc00 as libc::c_int {
        3072 => {
            spacewidth = 5 as libc::c_int;
            current_block_2 = 13255005969008850868;
        }
        2048 => {
            current_block_2 = 13255005969008850868;
        }
...
#[no_mangle]
pub unsafe extern "C" fn V_SmallThinStringWidth(
    mut string: *const libc::c_char,
    mut option: int32_t,
) -> int32_t {
    let mut w: int32_t = V_ThinStringWidth(string, option) << 16 as libc::c_int;
    return w / 2 as libc::c_int + ((1 as libc::c_int) << 16 as libc::c_int);
}
#[no_mangle]
pub static mut heatshifter: *mut boolean = 0 as *const boolean as *mut boolean;
#[no_mangle]
pub static mut lastheight: int32_t = 0 as libc::c_int;
#[no_mangle]
pub static mut heatindex: [int32_t; 2] = [0 as libc::c_int, 0 as libc::c_int];
#[no_mangle]
pub unsafe extern "C" fn V_DoPostProcessor(
    mut view: int32_t,
    mut type_0: postimg_t,
    mut param: int32_t,
) {
    let mut height: int32_t = 0;
    let mut yoffset: int32_t = 0;
    if view < 0 as libc::c_int || view >= 2 as libc::c_int
        || view == 1 as libc::c_int && splitscreen == 0
    {
        return;
    }
    if splitscreen != 0 {
        height = vid.height / 2 as libc::c_int;
    } else {
        height = vid.height;
    }
    if view == 1 as libc::c_int {
        yoffset = vid.height / 2 as libc::c_int;
    } else {
        yoffset = 0 as libc::c_int;
    }
    if type_0 as libc::c_uint == postimg_water as libc::c_int as libc::c_uint {
        let mut tmpscr: *mut uint8_t = screens[4 as libc::c_int as usize];
        let mut srcscr: *mut uint8_t = screens[0 as libc::c_int as usize];
        let mut y: int32_t = 0;
        let mut disStart: angle_t = (leveltime.wrapping_sub(1 as libc::c_int as tic_t)
            * 128 as libc::c_int as tic_t)
            .wrapping_add(
                (rendertimefrac
                    / (((1 as libc::c_int) << 16 as libc::c_int) / 128 as libc::c_int))
                    as tic_t,
            ) & (8192 as libc::c_int - 1 as libc::c_int) as tic_t;
        let mut newpix: int32_t = 0;
        let mut sine: int32_t = 0;
        y = yoffset;
        while y < yoffset + height {
            sine = (finesine[disStart as usize] >> 16 as libc::c_int - 16 as libc::c_int)
                * 5 as libc::c_int >> 16 as libc::c_int;
            newpix = abs(sine);
            if sine < 0 as libc::c_int {
                M_Memcpy
                    .expect(
                        "non-null function pointer",
                    )(
                    &mut *tmpscr.offset((y * vid.width + newpix) as isize)
                        as *mut uint8_t as *mut libc::c_void,
                    &mut *srcscr.offset((y * vid.width) as isize) as *mut uint8_t
                        as *const libc::c_void,
                    (vid.width - newpix) as size_t,
                );
                while newpix != 0 {
                    *tmpscr
                        .offset(
                            (y * vid.width + newpix) as isize,
                        ) = *srcscr.offset((y * vid.width) as isize);
                    newpix -= 1;
                    newpix;
                }
            } else {
                M_Memcpy
                    ...
                    &mut *tmpscr.offset((y * vid.width + 0 as libc::c_int) as isize)
                        as *mut uint8_t as *mut libc::c_void,
                    &mut *srcscr.offset((y * vid.width + sine) as isize) as *mut uint8_t
                        as *const libc::c_void,
                    (vid.width - newpix) as size_t,
                );
                while newpix != 0 {
                    *tmpscr
                        .offset(
                            (y * vid.width + vid.width - newpix) as isize,
                        ) = *srcscr
                        .offset(
                            (y * vid.width + (vid.width - 1 as libc::c_int)) as isize,
                        );
                    newpix -= 1;
                    newpix;
                }
            }
            disStart = disStart.wrapping_add(22 as libc::c_int as angle_t);
            disStart &= (8192 as libc::c_int - 1 as libc::c_int) as angle_t;
            y += 1;
            y;
        }
        VID_BlitLinearScreen(
            tmpscr.offset((vid.width * vid.bpp * yoffset) as isize),
            (screens[0 as libc::c_int as usize])
                .offset((vid.width * vid.bpp * yoffset) as isize),
            vid.width * vid.bpp,
            height,
            (vid.width * vid.bpp) as size_t,
            vid.width as size_t,
        );
    } else if type_0 as libc::c_uint == postimg_motion as libc::c_int as libc::c_uint {
        let mut tmpscr_0: *mut uint8_t = screens[4 as libc::c_int as usize];
        let mut srcscr_0: *mut uint8_t = screens[0 as libc::c_int as usize];
        let mut x: int32_t = 0;
        let mut y_0: int32_t = 0;
        let mut transme: *mut uint8_t = R_GetTranslucencyTable(param);
        y_0 = yoffset;
        while y_0 < yoffset + height {
            x = 0 as libc::c_int;
            while x < vid.width {
                *tmpscr_0
                    .offset(
                        (y_0 * vid.width + x) as isize,
                    ) = *colormaps
                    .offset(
                        *transme
                            .offset(
                                ((*srcscr_0.offset((y_0 * vid.width + x) as isize)
                                    as libc::c_int) << 8 as libc::c_int) as isize,
                            )
                            .offset(
                                *tmpscr_0.offset((y_0 * vid.width + x) as isize)
        ...
        VID_BlitLinearScreen(
            tmpscr_0.offset((vid.width * vid.bpp * yoffset) as isize),
            (screens[0 as libc::c_int as usize])
                .offset((vid.width * vid.bpp * yoffset) as isize),
            vid.width * vid.bpp,
            height,
    ...
    } else if type_0 as libc::c_uint == postimg_flip as libc::c_int as libc::c_uint {
        let mut tmpscr_1: *mut uint8_t = screens[4 as libc::c_int as usize];
        let mut srcscr_1: *mut uint8_t = screens[0 as libc::c_int as usize];
        let mut y_1: int32_t = 0;
        let mut y2: int32_t = 0;
        y_1 = yoffset;
        y2 = yoffset + height - 1 as libc::c_int;
        while y_1 < yoffset + height {
            M_Memcpy
                .expect(
                    "non-null function pointer",
                )(
                &mut *tmpscr_1.offset((y2 * vid.width) as isize) as *mut uint8_t
                    as *mut libc::c_void,
                &mut *srcscr_1.offset((y_1 * vid.width) as isize) as *mut uint8_t
                    as *const libc::c_void,
                vid.width as size_t,
            );
            y_1 += 1;
        ...
        VID_BlitLinearScreen(
            tmpscr_1.offset((vid.width * vid.bpp * yoffset) as isize),
            (screens[0 as libc::c_int as usize])
                .offset((vid.width * vid.bpp * yoffset) as isize),
            vid.width * vid.bpp,
            height,
    ...
    } else if type_0 as libc::c_uint == postimg_heat as libc::c_int as libc::c_uint {
        let mut tmpscr_2: *mut uint8_t = screens[4 as libc::c_int as usize];
        let mut srcscr_2: *mut uint8_t = screens[0 as libc::c_int as usize];
        let mut y_2: int32_t = 0;
        if heatshifter.is_null() || lastheight != height {
            if !heatshifter.is_null() {
                Z_Free(heatshifter as *mut libc::c_void);
            }
            heatshifter = Z_CallocAlign(
                (height as libc::c_ulong)
                    .wrapping_mul(::core::mem::size_of::<boolean>() as libc::c_ulong),
                PU_STATIC as libc::c_int,
                0 as *mut libc::c_void,
                ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
            ) as *mut boolean;
            ...
            while y_2 < height {
                ...
                {
                    *heatshifter.offset(y_2 as isize) = true_0 as libc::c_int;
                }
                y_2 += 1;
                y_2;
            }
            heatindex[1 as libc::c_int as usize] = 0 as libc::c_int;
            heatindex[0 as libc::c_int as usize] = heatindex[1 as libc::c_int as usize];
            lastheight = height;
        }
        y_2 = yoffset;
        while y_2 < yoffset + height {
            let fresh11 = heatindex[view as usize];
            heatindex[view as usize] = heatindex[view as usize] + 1;
            if *heatshifter.offset(fresh11 as isize) != 0 {
                *tmpscr_2
                    .offset(
                        (y_2 * vid.width) as isize,
                    ) = *srcscr_2.offset((y_2 * vid.width) as isize);
                M_Memcpy
                    .expect(
                        "non-null function pointer",
                    )(
                    &mut *tmpscr_2.offset((y_2 * vid.width + vid.dupx) as isize)
                        as *mut uint8_t as *mut libc::c_void,
                    &mut *srcscr_2.offset((y_2 * vid.width) as isize) as *mut uint8_t
                        as *const libc::c_void,
                    (vid.width - vid.dupx) as size_t,
                );
            } else {
                M_Memcpy
                    .expect(
                    ...
                    &mut *tmpscr_2.offset((y_2 * vid.width) as isize) as *mut uint8_t
                        as *mut libc::c_void,
                    &mut *srcscr_2.offset((y_2 * vid.width) as isize) as *mut uint8_t
                        as *const libc::c_void,
                    vid.width as size_t,
            ...
            heatindex[view as usize] %= height;
            y_2 += 1;
            y_2;
        }
        if renderisnewtic != 0 {
            heatindex[view as usize] += 1;
            heatindex[view as usize];
            heatindex[view as usize] %= vid.height;
        }
        VID_BlitLinearScreen(
            tmpscr_2.offset((vid.width * vid.bpp * yoffset) as isize),
            (screens[0 as libc::c_int as usize])
                .offset((vid.width * vid.bpp * yoffset) as isize),
            vid.width * vid.bpp,
            height,
...
#[no_mangle]
pub unsafe extern "C" fn InitColorLUT(
    mut lut: *mut colorlookup_t,
    mut palette: *mut RGBA_t,
    mut makecolors: boolean,
) {
    let mut palsize: size_t = (::core::mem::size_of::<RGBA_t>() as libc::c_ulong)
        .wrapping_mul(256 as libc::c_int as libc::c_ulong);
    if (*lut).init == 0
        || memcmp(
            ((*lut).palette).as_mut_ptr() as *const libc::c_void,
            palette as *const libc::c_void,
            palsize,
        ) != 0
    {
        let mut i: int32_t = 0;
        (*lut).init = true_0 as libc::c_int;
        memcpy(
            ((*lut).palette).as_mut_ptr() as *mut libc::c_void,
            palette as *const libc::c_void,
            palsize,
        );
        i = 0 as libc::c_int;
        while i < 0xffff as libc::c_int {
            (*lut).table[i as usize] = 0xffff as libc::c_int as uint16_t;
            i += 1;
            i;
        }
        if makecolors != 0 {
            ...
            while (r as libc::c_int) < 0xff as libc::c_int {
                g = 0 as libc::c_int as uint8_t;
                while (g as libc::c_int) < 0xff as libc::c_int {
                    b = 0 as libc::c_int as uint8_t;
                    while (b as libc::c_int) < 0xff as libc::c_int {
                        i = (r as libc::c_int >> 3 as libc::c_int) << 11 as libc::c_int
                            | (g as libc::c_int >> 2 as libc::c_int) << 5 as libc::c_int
                            | b as libc::c_int >> 3 as libc::c_int;
                        if (*lut).table[i as usize] as libc::c_int
                            == 0xffff as libc::c_int
                        {
                            (*lut)
                                .table[i
                                as usize] = NearestPaletteColor(r, g, b, palette)
                                as uint16_t;
                        }
                        b = b.wrapping_add(1);
                        b;
...
#[no_mangle]
pub unsafe extern "C" fn GetColorLUT(
    mut lut: *mut colorlookup_t,
    mut r: uint8_t,
    mut g: uint8_t,
    mut b: uint8_t,
) -> uint8_t {
    let mut i: int32_t = (r as libc::c_int >> 3 as libc::c_int) << 11 as libc::c_int
        | (g as libc::c_int >> 2 as libc::c_int) << 5 as libc::c_int
        | b as libc::c_int >> 3 as libc::c_int;
    if (*lut).table[i as usize] as libc::c_int == 0xffff as libc::c_int {
        (*lut)
            .table[i
            as usize] = NearestPaletteColor(r, g, b, ((*lut).palette).as_mut_ptr())
            as uint16_t;
    }
    return (*lut).table[i as usize] as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn GetColorLUTDirect(
    mut lut: *mut colorlookup_t,
    mut r: uint8_t,
    mut g: uint8_t,
    mut b: uint8_t,
...
pub unsafe extern "C" fn V_Init() {
    let mut i: int32_t = 0;
    let mut base: *mut uint8_t = vid.buffer;
    let screensize: int32_t = (vid.rowbytes * vid.height as size_t) as int32_t;
    LoadMapPalette();
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        screens[i as usize] = 0 as *mut uint8_t;
        i += 1;
        i;
    }
    if !base.is_null() {
        i = 0 as libc::c_int;
        while i < 5 as libc::c_int {
            screens[i as usize] = base.offset((i * screensize) as isize);
            i += 1;
            i;
        }
    }
    if !(vid.direct).is_null() {
        screens[0 as libc::c_int as usize] = vid.direct;
    }
}
#[no_mangle]
pub unsafe extern "C" fn V_Recalc() {
    vid.dupx = vid.width / 320 as libc::c_int;
    vid.dupy = vid.height / 200 as libc::c_int;
    vid.dupy = if vid.dupx < vid.dupy { vid.dupx } else { vid.dupy };
    vid.dupx = vid.dupy;
    vid
        .fdupx = FixedDiv(
        vid.width * ((1 as libc::c_int) << 16 as libc::c_int),
        320 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
    );
    vid
        .fdupy = FixedDiv(
        vid.height * ((1 as libc::c_int) << 16 as libc::c_int),
        200 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int),
    );
    vid.fdupy = if vid.fdupx < vid.fdupy { vid.fdupx } else { vid.fdupy };
    vid.fdupx = vid.fdupy;
    vid
        .meddupx = ((vid.dupx >> 1 as libc::c_int) as uint8_t as libc::c_int
        + 1 as libc::c_int) as uint8_t;
    vid
        .meddupy = ((vid.dupy >> 1 as libc::c_int) as uint8_t as libc::c_int
        + 1 as libc::c_int) as uint8_t;
    vid
        .smalldupx = ((vid.dupx / 3 as libc::c_int) as uint8_t as libc::c_int
        + 1 as libc::c_int) as uint8_t;
    vid
        .smalldupy = ((vid.dupy / 3 as libc::c_int) as uint8_t as libc::c_int
        + 1 as libc::c_int) as uint8_t;
}
