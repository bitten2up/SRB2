...
extern "C" {
    ...
    static mut luaactionstack: uint8_t;
    static mut luaactions: [*const libc::c_char; 30];
    ...
    fn LUA_GetActionName(action: *mut libc::c_void) -> *const libc::c_char;
    fn LUA_SetActionByName(
...
pub const sfxinfow_caption: sfxinfo_write = 3;
pub const sfxinfow_flags: sfxinfo_write = 2;
pub const sfxinfow_priority: sfxinfo_write = 1;
pub const sfxinfow_singular: sfxinfo_write = 0;
pub type sfxinfo_write = libc::c_uint;
pub const sfxinfor_skinsound: sfxinfo_read = 5;
pub const sfxinfor_caption: sfxinfo_read = 4;
pub const sfxinfor_flags: sfxinfo_read = 3;
pub const sfxinfor_priority: sfxinfo_read = 2;
pub const sfxinfor_singular: sfxinfo_read = 1;
pub const sfxinfor_name: sfxinfo_read = 0;
pub type sfxinfo_read = libc::c_uint;
pub const mobjinfo_raisestate: mobjinfo_e = 23;
pub const mobjinfo_flags: mobjinfo_e = 22;
pub const mobjinfo_activesound: mobjinfo_e = 21;
pub const mobjinfo_damage: mobjinfo_e = 20;
pub const mobjinfo_mass: mobjinfo_e = 19;
pub const mobjinfo_dispoffset: mobjinfo_e = 18;
pub const mobjinfo_height: mobjinfo_e = 17;
pub const mobjinfo_radius: mobjinfo_e = 16;
pub const mobjinfo_speed: mobjinfo_e = 15;
pub const mobjinfo_deathsound: mobjinfo_e = 14;
pub const mobjinfo_xdeathstate: mobjinfo_e = 13;
pub const mobjinfo_deathstate: mobjinfo_e = 12;
pub const mobjinfo_missilestate: mobjinfo_e = 11;
pub const mobjinfo_meleestate: mobjinfo_e = 10;
pub const mobjinfo_painsound: mobjinfo_e = 9;
pub const mobjinfo_painchance: mobjinfo_e = 8;
pub const mobjinfo_painstate: mobjinfo_e = 7;
pub const mobjinfo_attacksound: mobjinfo_e = 6;
pub const mobjinfo_reactiontime: mobjinfo_e = 5;
pub const mobjinfo_seesound: mobjinfo_e = 4;
pub const mobjinfo_seestate: mobjinfo_e = 3;
pub const mobjinfo_spawnhealth: mobjinfo_e = 2;
pub const mobjinfo_spawnstate: mobjinfo_e = 1;
pub const mobjinfo_doomednum: mobjinfo_e = 0;
pub type mobjinfo_e = libc::c_uint;
#[inline]
...
#[no_mangle]
pub static mut astate: *mut state_t = 0 as *const state_t as *mut state_t;
#[no_mangle]
pub static mut sfxinfo_ropt: [*const libc::c_char; 7] = [
    b"name\0" as *const u8 as *const libc::c_char,
    b"singular\0" as *const u8 as *const libc::c_char,
    ...
    b"skinsound\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
#[no_mangle]
pub static mut sfxinfo_wopt: [*const libc::c_char; 5] = [
    b"singular\0" as *const u8 as *const libc::c_char,
    b"priority\0" as *const u8 as *const libc::c_char,
    b"flags\0" as *const u8 as *const libc::c_char,
    b"caption\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut actionsoverridden: [[libc::c_int; 30]; 267] = [[0; 30]; 267];
unsafe extern "C" fn lib_getSprname(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        i = lua_tonumber(L, 1 as libc::c_int) as uint32_t;
        if i > NUMSPRITES as libc::c_int as uint32_t {
        ...
        while i < NUMSPRITES as libc::c_int as uint32_t {
            if fastcmp(name, (sprnames[i as usize]).as_mut_ptr()) != 0 {
...
unsafe extern "C" fn lib_sprnamelen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMSPRITES as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getSpr2name(mut L: *mut lua_State) -> libc::c_int {
    let mut i: playersprite_t = SPR2_STND;
    lua_remove(L, 1 as libc::c_int);
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        i = lua_tonumber(L, 1 as libc::c_int) as playersprite_t;
        if i as libc::c_uint >= free_spr2 as libc::c_uint {
            return 0 as libc::c_int;
        }
        lua_pushlstring(
            L,
            (spr2names[i as usize]).as_mut_ptr(),
            4 as libc::c_int as size_t,
        );
        return 1 as libc::c_int;
    } else if lua_isstring(L, 1 as libc::c_int) != 0 {
        ...
        i = SPR2_STND;
        while (i as libc::c_uint) < free_spr2 as libc::c_uint {
            if fastcmp(name, (spr2names[i as usize]).as_mut_ptr()) != 0 {
                lua_pushnumber(L, i as lua_Number);
                return 1 as libc::c_int;
            }
            i += 1;
...
unsafe extern "C" fn lib_getSpr2default(mut L: *mut lua_State) -> libc::c_int {
    let mut i: playersprite_t = SPR2_STND;
    lua_remove(L, 1 as libc::c_int);
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        i = lua_tonumber(L, 1 as libc::c_int) as playersprite_t;
        ...
        return luaL_error(
            L,
            b"spr2defaults[] invalid index\0" as *const u8 as *const libc::c_char,
        )
    }
    if i as libc::c_uint >= free_spr2 as libc::c_uint {
        return luaL_error(
            L,
            b"spr2defaults[] index %d out of range (%d - %d)\0" as *const u8
                as *const libc::c_char,
            i as libc::c_uint,
            0 as libc::c_int,
            (free_spr2 as libc::c_uint).wrapping_sub(1 as libc::c_int as libc::c_uint),
        );
    }
    lua_pushnumber(L, spr2defaults[i as usize] as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_setSpr2default(mut L: *mut lua_State) -> libc::c_int {
    let mut i: playersprite_t = SPR2_STND;
    let mut j: uint8_t = 0 as libc::c_int as uint8_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spr2defaults[] in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spr2defaults[] in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if free_spr2 as libc::c_uint == SPR2_FIRSTFREESLOT as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"You can only modify the spr2defaults[] entries of sprite2 freeslots, and none are currently added.\0"
    ...
    if (i as libc::c_uint) < SPR2_FIRSTFREESLOT as libc::c_int as libc::c_uint
        || i as libc::c_uint >= free_spr2 as libc::c_uint
    {
        return luaL_error(
            L,
            b"spr2defaults[] index %d out of range (%d - %d)\0" as *const u8
    ...
    if lua_isnumber(L, 2 as libc::c_int) != 0 {
        j = lua_tonumber(L, 2 as libc::c_int) as uint8_t;
    } else if lua_isstring(L, 2 as libc::c_int) != 0 {
        let mut name_0: *const libc::c_char = lua_tolstring(
            L,
            2 as libc::c_int,
            0 as *mut size_t,
        );
        j = 0 as libc::c_int as uint8_t;
        while (j as libc::c_uint) < free_spr2 as libc::c_uint {
            if fastcmp(name_0, (spr2names[j as usize]).as_mut_ptr()) != 0 {
                break;
            }
            j = j.wrapping_add(1);
            j;
        }
        if j as libc::c_uint == free_spr2 as libc::c_uint {
            return luaL_error(
                L,
                b"spr2defaults[] invalid set\0" as *const u8 as *const libc::c_char,
            );
        }
    } else {
        return luaL_error(
    ...
    if j as libc::c_uint >= free_spr2 as libc::c_uint {
        return luaL_error(
            L,
            b"spr2defaults[] set %d out of range (%d - %d)\0" as *const u8
                as *const libc::c_char,
            j as libc::c_int,
            0 as libc::c_int,
            (free_spr2 as libc::c_uint).wrapping_sub(1 as libc::c_int as libc::c_uint),
    ...
    spr2defaults[i as usize] = j as playersprite_t;
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_spr2namelen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, free_spr2 as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getSpriteInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = NUMSPRITES as libc::c_int as uint32_t;
    lua_remove(L, 1 as libc::c_int);
    if lua_isstring(L, 1 as libc::c_int) != 0 {
        ...
        let mut spr: int32_t = 0;
        spr = 0 as libc::c_int;
        while spr < NUMSPRITES as libc::c_int {
            if fastcmp(name, (sprnames[spr as usize]).as_mut_ptr()) != 0 {
                i = spr as uint32_t;
                break;
            } else {
                spr += 1;
        ...
        if i == NUMSPRITES as libc::c_int as uint32_t {
            let mut check: *mut libc::c_char = 0 as *mut libc::c_char;
            i = strtol(name, &mut check, 10 as libc::c_int) as uint32_t;
            if check == name as *mut libc::c_char || *check as libc::c_int != '\0' as i32
            {
                return luaL_error(
                    L,
                    b"unknown sprite name %s\0" as *const u8 as *const libc::c_char,
                    name,
                );
            }
        }
    } else {
        i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    }
    if i == 0 as libc::c_int as uint32_t || i >= NUMSPRITES as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"spriteinfo[] index %d out of range (1 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
            NUMSPRITES as libc::c_int - 1 as libc::c_int,
        );
    }
    LUA_PushUserdata(
        L,
        &mut *spriteinfo.as_mut_ptr().offset(i as isize) as *mut spriteinfo_t
            as *mut libc::c_void,
        b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn PopPivotSubTable(
    mut pivot: *mut spriteframepivot_t,
    mut L: *mut lua_State,
    mut stk: libc::c_int,
    mut idx: libc::c_int,
) -> libc::c_int {
    let mut okcool: libc::c_int = 0 as libc::c_int;
    match lua_type(L, stk) {
        5 => {
            lua_pushnil(L);
            while lua_next(L, stk) != 0 {
                let mut key: *const libc::c_char = 0 as *const libc::c_char;
                let mut ikey: lua_Number = -(1 as libc::c_int);
                let mut value: lua_Number = 0 as libc::c_int;
                match lua_type(L, stk + 1 as libc::c_int) {
                    4 => {
                        key = lua_tolstring(L, stk + 1 as libc::c_int, 0 as *mut size_t);
                    }
                    3 => {
                        ikey = lua_tonumber(L, stk + 1 as libc::c_int);
                    }
                    _ => {
                        luaL_error(
                            L,
                            b"bad value for 'pivot key' in table passed to spriteinfo[] (%s)\0"
                                as *const u8 as *const libc::c_char,
                            va(
                                b"string or number expected, got %s\0" as *const u8
                                    as *const libc::c_char,
                                lua_typename(L, lua_type(L, stk + 1 as libc::c_int)),
                            ),
                        );
                    }
                }
                match lua_type(L, stk + 2 as libc::c_int) {
                    3 => {
                        value = lua_tonumber(L, stk + 2 as libc::c_int);
                    }
                    1 => {
                        value = lua_toboolean(L, stk + 2 as libc::c_int) as uint8_t
                            as lua_Number;
                    }
                    _ => {
                        luaL_error(
                            L,
                            b"bad value for 'pivot value' in table passed to spriteinfo[] (%s)\0"
                                as *const u8 as *const libc::c_char,
                            va(
                                b"%s expected, got %s\0" as *const u8
                                    as *const libc::c_char,
                                lua_typename(L, 3 as libc::c_int),
                                lua_typename(L, lua_type(L, stk + 2 as libc::c_int)),
                            ),
                        );
                    }
                }
                if ikey == 1 as libc::c_int
                    || !key.is_null()
                        && fastcmp(key, b"x\0" as *const u8 as *const libc::c_char) != 0
                {
                    (*pivot.offset(idx as isize)).x = value;
                } else if ikey == 2 as libc::c_int
                    || !key.is_null()
                        && fastcmp(key, b"y\0" as *const u8 as *const libc::c_char) != 0
                {
                    (*pivot.offset(idx as isize)).y = value;
                } else if ikey == 3 as libc::c_int
                    || !key.is_null()
                        && fastcmp(key, b"rotaxis\0" as *const u8 as *const libc::c_char)
                            != 0
                {
                    ...
                    if seen == 0 {
                        ...
                        CONS_Alert(
                            ...
                            b"\"rotaxis\" is deprecated and will be removed.\0"
                                as *const u8 as *const libc::c_char,
                        );
                    }
                } else if ikey == -(1 as libc::c_int) && !key.is_null() {
                    luaL_error(
                        L,
                        b"bad value for 'pivot key' in table passed to spriteinfo[] (%s)\0"
                            as *const u8 as *const libc::c_char,
        ...
        _ => {
            luaL_error(
                L,
                b"bad value for 'sprite pivot' in table passed to spriteinfo[] (%s)\0"
                    as *const u8 as *const libc::c_char,
                va(
                    b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                    lua_typename(L, 5 as libc::c_int),
                    lua_typename(L, lua_type(L, stk)),
                ),
            );
        }
    }
...
unsafe extern "C" fn PopPivotTable(
    mut info: *mut spriteinfo_t,
    mut L: *mut lua_State,
    mut stk: libc::c_int,
) -> libc::c_int {
    if !(lua_type(L, stk) == 5 as libc::c_int) {
        luaL_error(
            L,
            b"bad value for 'pivot table' in table passed to spriteinfo[] (%s)\0"
                as *const u8 as *const libc::c_char,
            va(
                b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                lua_typename(L, 5 as libc::c_int),
    ...
    while lua_next(L, stk) != 0 {
        ...
        let mut framestr: *const libc::c_char = 0 as *const libc::c_char;
        match lua_type(L, stk + 1 as libc::c_int) {
            4 => {
                framestr = lua_tolstring(L, stk + 1 as libc::c_int, 0 as *mut size_t);
                idx = R_Char2Frame(*framestr.offset(0 as libc::c_int as isize))
                    as libc::c_int;
            }
            3 => {
                idx = lua_tonumber(L, stk + 1 as libc::c_int);
            }
            _ => {
                luaL_error(
                    L,
                    b"bad value for 'pivot frame' in table passed to spriteinfo[] (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
        ...
        if idx < 0 as libc::c_int || idx >= 64 as libc::c_int {
            return luaL_error(
                L,
                b"pivot frame %d out of range (0 - %d)\0" as *const u8
                    as *const libc::c_char,
                idx,
                63 as libc::c_int,
            );
        }
        if PopPivotSubTable(((*info).pivot).as_mut_ptr(), L, stk + 2 as libc::c_int, idx)
            != 0
        {
...
unsafe extern "C" fn lib_setSpriteInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut spriteinfo_t = 0 as *mut spriteinfo_t;
    if lua_lumploading == 0 {
        return luaL_error(
            L,
            b"Do not alter spriteinfo_t from within a hook or coroutine!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spriteinfo_t in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spriteinfo_t in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    lua_remove(L, 1 as libc::c_int);
    let mut i: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i == 0 as libc::c_int as uint32_t || i >= NUMSPRITES as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"spriteinfo[] index %d out of range (1 - %d)\0" as *const u8
    ...
    info = &mut *spriteinfo.as_mut_ptr().offset(i as isize) as *mut spriteinfo_t;
    luaL_checktype(L, 2 as libc::c_int, 5 as libc::c_int);
    lua_remove(L, 1 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        let mut i_0: lua_Number = 0 as libc::c_int;
        let mut str: *const libc::c_char = 0 as *const libc::c_char;
        if lua_isnumber(L, 2 as libc::c_int) != 0 {
            i_0 = lua_tonumber(L, 2 as libc::c_int);
        } else {
            str = luaL_checklstring(L, 2 as libc::c_int, 0 as *mut size_t);
        }
        if i_0 == 1 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"pivot\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_type(L, 3 as libc::c_int) == 5 as libc::c_int {
                return PopPivotTable(info, L, 3 as libc::c_int)
            } else {
                luaL_error(
                    L,
                    b"bad value for 'pivot' in table passed to spriteinfo[] (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 5 as libc::c_int),
...
unsafe extern "C" fn lib_spriteinfolen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMSPRITES as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn spriteinfo_get(mut L: *mut lua_State) -> libc::c_int {
    let mut sprinfo: *mut spriteinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut spriteinfo_t);
    let mut field: *const libc::c_char = luaL_checklstring(
        L,
        2 as libc::c_int,
        0 as *mut size_t,
    );
    if fastcmp(field, b"pivot\0" as *const u8 as *const libc::c_char) != 0 {
        let mut userdata: *mut *mut libc::c_void = lua_newuserdata(
            L,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong,
        ) as *mut *mut libc::c_void;
        *userdata = &mut (*sprinfo).pivot as *mut [spriteframepivot_t; 64]
            as *mut libc::c_void;
        lua_getfield(
            L,
            -(10000 as libc::c_int),
            b"SPRITEFRAMEPIVOT_T[]\0" as *const u8 as *const libc::c_char,
        );
        ...
        return luaL_error(
            L,
            b"'spriteinfo_t' has no field named '%s'\0" as *const u8
                as *const libc::c_char,
            field,
        )
    };
}
unsafe extern "C" fn spriteinfo_set(mut L: *mut lua_State) -> libc::c_int {
    let mut sprinfo: *mut spriteinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    if fastcmp(field, b"pivot\0" as *const u8 as *const libc::c_char) != 0 {
        if lua_type(L, 1 as libc::c_int) == 5 as libc::c_int {
            return PopPivotTable(sprinfo, L, 1 as libc::c_int)
        } else if lua_isuserdata(L, 1 as libc::c_int) != 0 {
            let mut pivot: *mut spriteframepivot_t = *(luaL_checkudata(
                L,
                1 as libc::c_int,
                b"SPRITEFRAMEPIVOT_T[]\0" as *const u8 as *const libc::c_char,
            ) as *mut *mut spriteframepivot_t);
            memcpy(
                &mut (*sprinfo).pivot as *mut [spriteframepivot_t; 64]
                    as *mut libc::c_void,
                pivot as *const libc::c_void,
                ::core::mem::size_of::<spriteframepivot_t>() as libc::c_ulong,
            );
            (*sprinfo).available = true_0 as libc::c_int;
        }
    } else {
        return luaL_error(
            L,
            va(
                b"Field %s does not exist in spriteinfo_t\0" as *const u8
                    as *const libc::c_char,
                field,
            ),
        )
...
unsafe extern "C" fn spriteinfo_num(mut L: *mut lua_State) -> libc::c_int {
    let mut sprinfo: *mut spriteinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(
        L,
        sprinfo.offset_from(spriteinfo.as_mut_ptr()) as libc::c_long as uint32_t
            as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn pivotlist_get(mut L: *mut lua_State) -> libc::c_int {
    let mut userdata: *mut *mut libc::c_void = 0 as *mut *mut libc::c_void;
    let mut framepivot: *mut spriteframepivot_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEFRAMEPIVOT_T[]\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut spriteframepivot_t);
    ...
    frame = R_Char2Frame(*field.offset(0 as libc::c_int as isize));
    if frame as libc::c_int == 255 as libc::c_int {
        luaL_error(L, b"invalid frame %s\0" as *const u8 as *const libc::c_char, field);
    }
    userdata = lua_newuserdata(
        L,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong,
    ) as *mut *mut libc::c_void;
    *userdata = &mut *framepivot.offset(frame as isize) as *mut spriteframepivot_t
        as *mut libc::c_void;
    lua_getfield(
        L,
        -(10000 as libc::c_int),
...
unsafe extern "C" fn pivotlist_set(mut L: *mut lua_State) -> libc::c_int {
    let mut pivotlist: *mut spriteframepivot_t = *(lua_touserdata(L, 1 as libc::c_int)
        as *mut *mut spriteframepivot_t);
    let mut field: *const libc::c_char = luaL_checklstring(
        L,
        2 as libc::c_int,
    ...
    if lua_lumploading == 0 {
        return luaL_error(
            L,
            b"Do not alter spriteframepivot_t from within a hook or coroutine!\0"
                as *const u8 as *const libc::c_char,
        );
    }
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spriteframepivot_t in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter spriteframepivot_t in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    frame = R_Char2Frame(*field.offset(0 as libc::c_int as isize));
    ...
    if lua_type(L, 3 as libc::c_int) == 5 as libc::c_int {
        return PopPivotSubTable(pivotlist, L, 3 as libc::c_int, frame as libc::c_int)
    } else if lua_isuserdata(L, 3 as libc::c_int) != 0 {
        let mut copypivot: *mut spriteframepivot_t = *(luaL_checkudata(
            L,
            3 as libc::c_int,
            b"SPRITEFRAMEPIVOT_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut spriteframepivot_t);
        memcpy(
            &mut *pivotlist.offset(frame as isize) as *mut spriteframepivot_t
                as *mut libc::c_void,
            copypivot as *const libc::c_void,
            ::core::mem::size_of::<spriteframepivot_t>() as libc::c_ulong,
        );
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn pivotlist_num(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, 64 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn framepivot_get(mut L: *mut lua_State) -> libc::c_int {
    let mut framepivot: *mut spriteframepivot_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEFRAMEPIVOT_T*\0" as *const u8 as *const libc::c_char,
    ...
    if fastcmp(b"x\0" as *const u8 as *const libc::c_char, field) != 0 {
        lua_pushnumber(L, (*framepivot).x);
    } else if fastcmp(b"y\0" as *const u8 as *const libc::c_char, field) != 0 {
        lua_pushnumber(L, (*framepivot).y);
    } else if fastcmp(b"rotaxis\0" as *const u8 as *const libc::c_char, field) != 0 {
        static mut seen: uint8_t = 0 as libc::c_int as uint8_t;
        if seen == 0 {
            seen = 1 as libc::c_int as uint8_t;
            CONS_Alert(
                CONS_WARNING,
                b"%s\n\0" as *const u8 as *const libc::c_char,
                b"\"rotaxis\" is deprecated and will be removed.\0" as *const u8
                    as *const libc::c_char,
            );
        }
        ...
        return luaL_error(
            L,
            va(
                b"Field %s does not exist in spriteframepivot_t\0" as *const u8
                    as *const libc::c_char,
                field,
            ),
        )
...
unsafe extern "C" fn framepivot_set(mut L: *mut lua_State) -> libc::c_int {
    let mut framepivot: *mut spriteframepivot_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SPRITEFRAMEPIVOT_T*\0" as *const u8 as *const libc::c_char,
    ...
    if fastcmp(b"x\0" as *const u8 as *const libc::c_char, field) != 0 {
        (*framepivot).x = luaL_checknumber(L, 3 as libc::c_int);
    } else if fastcmp(b"y\0" as *const u8 as *const libc::c_char, field) != 0 {
        (*framepivot).y = luaL_checknumber(L, 3 as libc::c_int);
    } else if fastcmp(b"rotaxis\0" as *const u8 as *const libc::c_char, field) != 0 {
        static mut seen: uint8_t = 0 as libc::c_int as uint8_t;
        if seen == 0 {
            seen = 1 as libc::c_int as uint8_t;
...
unsafe extern "C" fn framepivot_num(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, 2 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn A_Lua(mut actor: *mut mobj_t) {
    ...
    lua_getfield(
        gL,
        -(10000 as libc::c_int),
        b"STATE_ACTION\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(gL, astate as *mut libc::c_void);
    ...
    while lua_next(gL, -(2 as libc::c_int)) != 0 {
        if lua_rawequal(gL, -(1 as libc::c_int), -(4 as libc::c_int)) != 0 {
            found = true_0 as libc::c_int;
            luaactions[luaactionstack
                as usize] = lua_tolstring(gL, -(2 as libc::c_int), 0 as *mut size_t);
            luaactionstack = luaactionstack.wrapping_add(1);
            luaactionstack;
    ...
    lua_pushnumber(gL, var1);
    lua_pushnumber(gL, var2);
    LUA_Call(gL, 3 as libc::c_int, 0 as libc::c_int, 1 as libc::c_int);
    if found != 0 {
        luaactionstack = luaactionstack.wrapping_sub(1);
        luaactionstack;
        luaactions[luaactionstack as usize] = 0 as *const libc::c_char;
    }
}
unsafe extern "C" fn lib_getState(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i >= NUMSTATES as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"states[] index %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
    ...
    LUA_PushUserdata(
        L,
        &mut *states.as_mut_ptr().offset(i as isize) as *mut state_t
            as *mut libc::c_void,
        b"STATE_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_setState(mut L: *mut lua_State) -> libc::c_int {
    ...
    state = &mut *states.as_mut_ptr().offset(i as isize) as *mut state_t;
    luaL_checktype(L, 2 as libc::c_int, 5 as libc::c_int);
    lua_remove(L, 1 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter states in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter states in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<state_t>() as libc::c_ulong,
    );
    (*state).tics = -(1 as libc::c_int);
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        let mut i_0: lua_Number = 0 as libc::c_int;
        let mut str: *const libc::c_char = 0 as *const libc::c_char;
        let mut value: lua_Number = 0;
        if lua_isnumber(L, 2 as libc::c_int) != 0 {
            i_0 = lua_tonumber(L, 2 as libc::c_int);
        } else {
            str = luaL_checklstring(L, 2 as libc::c_int, 0 as *mut size_t);
        ...
        if i_0 == 1 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"sprite\0" as *const u8 as *const libc::c_char) != 0
        {
            value = luaL_checknumber(L, 3 as libc::c_int);
            if value < SPR_NULL as libc::c_int || value >= NUMSPRITES as libc::c_int {
                return luaL_error(
                    L,
                    b"sprite number %d is invalid.\0" as *const u8
                        as *const libc::c_char,
                    value,
                );
            }
            (*state).sprite = value as spritenum_t;
        } else if i_0 == 2 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"frame\0" as *const u8 as *const libc::c_char) != 0
        {
            (*state).frame = luaL_checknumber(L, 3 as libc::c_int) as uint32_t;
        } else if i_0 == 3 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"tics\0" as *const u8 as *const libc::c_char) != 0
        {
            (*state).tics = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 4 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"action\0" as *const u8 as *const libc::c_char) != 0
        {
            match lua_type(L, 3 as libc::c_int) {
                0 => {
                    (*state).action.acp1 = None;
                }
                4 => {
                    LUA_SetActionByName(
                        state as *mut libc::c_void,
                ...
                7 => {
                    let mut action: *mut actionf_t = *(luaL_checkudata(
                        L,
                        3 as libc::c_int,
                        b"ACTIONF_T*\0" as *const u8 as *const libc::c_char,
                    ) as *mut *mut actionf_t);
                    if action.is_null() {
                        return luaL_error(
                            L,
                            b"not a valid action?\0" as *const u8 as *const libc::c_char,
                        );
                    }
                    (*state).action = *action;
                ...
                6 => {
                    ...
                    lua_pushlightuserdata(L, state as *mut libc::c_void);
                    ...
                    (*state)
                        ...
                        actionf_p1,
                    >(Some(A_Lua as unsafe extern "C" fn(*mut mobj_t) -> ()));
                }
                _ => {
                    return luaL_typerror(
                        L,
                        3 as libc::c_int,
            ...
            || !str.is_null()
                && fastcmp(str, b"var1\0" as *const u8 as *const libc::c_char) != 0
        {
            (*state).var1 = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 6 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"var2\0" as *const u8 as *const libc::c_char) != 0
        {
            (*state).var2 = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 7 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"nextstate\0" as *const u8 as *const libc::c_char) != 0
        {
            value = luaL_checknumber(L, 3 as libc::c_int);
            if value < S_NULL as libc::c_int || value >= NUMSTATES as libc::c_int {
                return luaL_error(
                    L,
                    b"nextstate number %d is invalid.\0" as *const u8
                        as *const libc::c_char,
                    value,
                );
            }
            (*state).nextstate = value as statenum_t;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_statelen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMSTATES as libc::c_int);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_SetLuaAction(
    mut stv: *mut libc::c_void,
    mut action: *const libc::c_char,
) -> boolean {
    let mut st: *mut state_t = stv as *mut state_t;
    if gL.is_null() {
    ...
    lua_getfield(gL, -(1 as libc::c_int), action);
...
static mut superstack: [uint8_t; 267] = [0; 267];
#[no_mangle]
pub unsafe extern "C" fn LUA_CallAction(
    mut actionnum: actionnum,
    mut actor: *mut mobj_t,
) -> boolean {
    if actionsoverridden[actionnum as usize][0 as libc::c_int as usize]
        == -(1 as libc::c_int)
    {
        return false_0 as libc::c_int;
    }
    if luaactionstack as libc::c_int != 0
        && fasticmp(
            (*actionpointers.as_mut_ptr().offset(actionnum as isize)).name,
            luaactions[(luaactionstack as libc::c_int - 1 as libc::c_int) as usize],
        ) != 0
    {
        superstack[actionnum
            as usize] = (superstack[actionnum as usize]).wrapping_add(1);
        superstack[actionnum as usize];
        if superstack[actionnum as usize] as libc::c_int >= 30 as libc::c_int {
            CONS_Alert(
                CONS_WARNING,
                b"Max Lua super recursion reached! Cool it on calling super!\n\0"
                    as *const u8 as *const libc::c_char,
            );
            superstack[actionnum as usize] = 0 as libc::c_int as uint8_t;
            return false_0 as libc::c_int;
        }
    }
    if actionsoverridden[actionnum as usize][superstack[actionnum as usize] as usize]
        == -(1 as libc::c_int)
    {
        if superstack[actionnum as usize] != 0 {
            superstack[actionnum
                as usize] = (superstack[actionnum as usize]).wrapping_sub(1);
            superstack[actionnum as usize];
        }
        return false_0 as libc::c_int;
    }
    ...
    lua_rawgeti(
        gL,
        -(10000 as libc::c_int),
        actionsoverridden[actionnum as usize][superstack[actionnum as usize] as usize],
    );
    if lua_type(gL, -(1 as libc::c_int)) == 0 as libc::c_int {
        lua_settop(gL, -(2 as libc::c_int) - 1 as libc::c_int);
        return false_0 as libc::c_int;
    }
    if luaactionstack as libc::c_int >= 30 as libc::c_int {
        CONS_Alert(
            CONS_WARNING,
            b"Max Lua Action recursion reached! Cool it on the calling A_Action functions from inside A_Action functions!\n\0"
                as *const u8 as *const libc::c_char,
        );
        lua_settop(gL, -(2 as libc::c_int) - 1 as libc::c_int);
        return true_0 as libc::c_int;
    ...
    lua_pushnumber(gL, var2);
    luaactions[luaactionstack
        as usize] = (*actionpointers.as_mut_ptr().offset(actionnum as isize)).name;
    luaactionstack = luaactionstack.wrapping_add(1);
    luaactionstack;
    LUA_Call(
        gL,
...
unsafe extern "C" fn state_get(mut L: *mut lua_State) -> libc::c_int {
    let mut st: *mut state_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"STATE_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut state_t);
    ...
    let mut number: lua_Number = 0;
    if fastcmp(field, b"sprite\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).sprite as lua_Number;
    } else if fastcmp(field, b"frame\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).frame as lua_Number;
    } else if fastcmp(field, b"tics\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).tics;
    } else if fastcmp(field, b"action\0" as *const u8 as *const libc::c_char) != 0 {
        let mut name: *const libc::c_char = 0 as *const libc::c_char;
        if ((*st).action.acp1).is_none() {
            return 0 as libc::c_int;
        }
        if (*st).action.acp1
            == ::core::mem::transmute::<
            ...
            >(Some(A_Lua as unsafe extern "C" fn(*mut mobj_t) -> ()))
        {
            ...
            lua_pushlightuserdata(L, st as *mut libc::c_void);
            lua_rawget(L, -(2 as libc::c_int));
            lua_remove(L, -(2 as libc::c_int));
            return 1 as libc::c_int;
        }
        name = LUA_GetActionName(
            &mut (*st).action as *mut actionf_t as *mut libc::c_void,
        );
        if name.is_null() {
            return 0 as libc::c_int;
        }
        ...
        return 1 as libc::c_int;
    } else if fastcmp(field, b"var1\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).var1;
    } else if fastcmp(field, b"var2\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).var2;
    } else if fastcmp(field, b"nextstate\0" as *const u8 as *const libc::c_char) != 0 {
        number = (*st).nextstate as lua_Number;
    } else if devparm != 0 {
        return luaL_error(
            L,
            b"'state_t' has no field named '%s'\0" as *const u8 as *const libc::c_char,
            field,
        )
    } else {
        return 0 as libc::c_int
...
unsafe extern "C" fn state_set(mut L: *mut lua_State) -> libc::c_int {
    let mut st: *mut state_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"STATE_T*\0" as *const u8 as *const libc::c_char,
    ...
    if fastcmp(field, b"sprite\0" as *const u8 as *const libc::c_char) != 0 {
        ...
        if value < SPR_NULL as libc::c_int || value >= NUMSPRITES as libc::c_int {
            return luaL_error(
                L,
                b"sprite number %d is invalid.\0" as *const u8 as *const libc::c_char,
                value,
            );
        }
        (*st).sprite = value as spritenum_t;
    } else if fastcmp(field, b"frame\0" as *const u8 as *const libc::c_char) != 0 {
        (*st).frame = luaL_checknumber(L, 3 as libc::c_int) as uint32_t;
    } else if fastcmp(field, b"tics\0" as *const u8 as *const libc::c_char) != 0 {
        (*st).tics = luaL_checknumber(L, 3 as libc::c_int);
    } else if fastcmp(field, b"action\0" as *const u8 as *const libc::c_char) != 0 {
        match lua_type(L, 3 as libc::c_int) {
            0 => {
                (*st).action.acp1 = None;
        ...
        (*st).var1 = luaL_checknumber(L, 3 as libc::c_int);
    } else if fastcmp(field, b"var2\0" as *const u8 as *const libc::c_char) != 0 {
        (*st).var2 = luaL_checknumber(L, 3 as libc::c_int);
    } else if fastcmp(field, b"nextstate\0" as *const u8 as *const libc::c_char) != 0 {
        value = luaL_checknumber(L, 3 as libc::c_int);
        if value < S_NULL as libc::c_int || value >= NUMSTATES as libc::c_int {
            return luaL_error(
                L,
                b"nextstate number %d is invalid.\0" as *const u8 as *const libc::c_char,
                value,
            );
        }
        (*st).nextstate = value as statenum_t;
    } else {
        return luaL_error(
            L,
            b"'state_t' has no field named '%s'\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn state_num(mut L: *mut lua_State) -> libc::c_int {
    let mut state: *mut state_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"STATE_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut state_t);
    lua_pushnumber(
        L,
        state.offset_from(states.as_mut_ptr()) as libc::c_long as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getMobjInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i >= NUMMOBJTYPES as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"mobjinfo[] index %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
    ...
    LUA_PushUserdata(
        L,
        &mut *mobjinfo.as_mut_ptr().offset(i as isize) as *mut mobjinfo_t
            as *mut libc::c_void,
        b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_setMobjInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut mobjinfo_t = 0 as *mut mobjinfo_t;
    lua_remove(L, 1 as libc::c_int);
    let mut i: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i >= NUMMOBJTYPES as libc::c_int as uint32_t {
        return luaL_error(
    ...
    info = &mut *mobjinfo.as_mut_ptr().offset(i as isize) as *mut mobjinfo_t;
    luaL_checktype(L, 2 as libc::c_int, 5 as libc::c_int);
    lua_remove(L, 1 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter mobjinfo in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter mobjinfo in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<mobjinfo_t>() as libc::c_ulong,
    );
    (*info).doomednum = -(1 as libc::c_int);
    (*info).spawnhealth = 1 as libc::c_int;
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        let mut i_0: lua_Number = 0 as libc::c_int;
        let mut str: *const libc::c_char = 0 as *const libc::c_char;
        ...
        if i_0 == 1 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"doomednum\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).doomednum = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 2 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"spawnstate\0" as *const u8 as *const libc::c_char) != 0
        {
            value = luaL_checknumber(L, 3 as libc::c_int);
            if value < S_NULL as libc::c_int || value >= NUMSTATES as libc::c_int {
                return luaL_error(
                    L,
                    b"spawnstate number %d is invalid.\0" as *const u8
                        as *const libc::c_char,
                    value,
                );
            }
            (*info).spawnstate = value as statenum_t;
        } else if i_0 == 3 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"spawnhealth\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).spawnhealth = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 4 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"seestate\0" as *const u8 as *const libc::c_char) != 0
        {
            value = luaL_checknumber(L, 3 as libc::c_int);
            if value < S_NULL as libc::c_int || value >= NUMSTATES as libc::c_int {
                return luaL_error(
                    L,
                    b"seestate number %d is invalid.\0" as *const u8
                        as *const libc::c_char,
                    value,
                );
            }
            (*info).seestate = value as statenum_t;
        } else if i_0 == 5 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"seesound\0" as *const u8 as *const libc::c_char) != 0
        {
            value = luaL_checknumber(L, 3 as libc::c_int);
            if value < sfx_None as libc::c_int || value >= NUMSFX as libc::c_int {
                return luaL_error(
                    L,
                    b"seesound number %d is invalid.\0" as *const u8
                        as *const libc::c_char,
                    value,
                );
            }
            (*info).seesound = value as sfxenum_t;
        } else if i_0 == 6 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"reactiontime\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).reactiontime = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 7 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"attacksound\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).attacksound = luaL_checknumber(L, 3 as libc::c_int) as sfxenum_t;
        } else if i_0 == 8 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"painstate\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).painstate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        } else if i_0 == 9 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"painchance\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).painchance = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 10 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"painsound\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).painsound = luaL_checknumber(L, 3 as libc::c_int) as sfxenum_t;
        } else if i_0 == 11 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"meleestate\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).meleestate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        } else if i_0 == 12 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"missilestate\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).missilestate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        } else if i_0 == 13 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"deathstate\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).deathstate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        } else if i_0 == 14 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"xdeathstate\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).xdeathstate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        } else if i_0 == 15 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"deathsound\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).deathsound = luaL_checknumber(L, 3 as libc::c_int) as sfxenum_t;
        } else if i_0 == 16 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"speed\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).speed = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 17 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"radius\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).radius = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 18 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"height\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).height = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 19 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"dispoffset\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).dispoffset = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 20 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"mass\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).mass = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 21 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"damage\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).damage = luaL_checknumber(L, 3 as libc::c_int);
        } else if i_0 == 22 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"activesound\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            (*info).activesound = luaL_checknumber(L, 3 as libc::c_int) as sfxenum_t;
        } else if i_0 == 23 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"flags\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).flags = luaL_checknumber(L, 3 as libc::c_int) as uint32_t;
        } else if i_0 == 24 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"raisestate\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).raisestate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_mobjinfolen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMMOBJTYPES as libc::c_int);
    return 1 as libc::c_int;
}
#[no_mangle]
pub static mut mobjinfo_opt: [*const libc::c_char; 25] = [
    b"doomednum\0" as *const u8 as *const libc::c_char,
    ...
    b"damage\0" as *const u8 as *const libc::c_char,
    b"activesound\0" as *const u8 as *const libc::c_char,
    b"flags\0" as *const u8 as *const libc::c_char,
    b"raisestate\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut mobjinfo_fields_ref: libc::c_int = -(2 as libc::c_int);
unsafe extern "C" fn mobjinfo_get(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut mobjinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobjinfo_t);
    let mut field: mobjinfo_e = Lua_optoption(
        L,
        2 as libc::c_int,
        mobjinfo_doomednum as libc::c_int,
        mobjinfo_fields_ref,
    ) as mobjinfo_e;
    match field as libc::c_uint {
        0 => {
            lua_pushnumber(L, (*info).doomednum);
        }
        1 => {
            lua_pushnumber(L, (*info).spawnstate as lua_Number);
        }
        2 => {
            lua_pushnumber(L, (*info).spawnhealth);
        }
        3 => {
            lua_pushnumber(L, (*info).seestate as lua_Number);
        }
        4 => {
            lua_pushnumber(L, (*info).seesound as lua_Number);
        }
        5 => {
            lua_pushnumber(L, (*info).reactiontime);
        }
        6 => {
            lua_pushnumber(L, (*info).attacksound as lua_Number);
        }
        7 => {
            lua_pushnumber(L, (*info).painstate as lua_Number);
        }
        8 => {
            lua_pushnumber(L, (*info).painchance);
        }
        9 => {
            lua_pushnumber(L, (*info).painsound as lua_Number);
        }
        10 => {
            lua_pushnumber(L, (*info).meleestate as lua_Number);
        }
        11 => {
            lua_pushnumber(L, (*info).missilestate as lua_Number);
        }
        12 => {
            lua_pushnumber(L, (*info).deathstate as lua_Number);
        }
        13 => {
            lua_pushnumber(L, (*info).xdeathstate as lua_Number);
        }
        14 => {
            lua_pushnumber(L, (*info).deathsound as lua_Number);
        }
        15 => {
            lua_pushnumber(L, (*info).speed);
        }
        16 => {
            lua_pushnumber(L, (*info).radius);
        }
        17 => {
            lua_pushnumber(L, (*info).height);
        }
        18 => {
            lua_pushnumber(L, (*info).dispoffset);
        }
        19 => {
            lua_pushnumber(L, (*info).mass);
        }
        20 => {
            lua_pushnumber(L, (*info).damage);
        }
        21 => {
            lua_pushnumber(L, (*info).activesound as lua_Number);
        }
        22 => {
            lua_pushnumber(L, (*info).flags as lua_Number);
        }
        23 => {
            lua_pushnumber(L, (*info).raisestate as lua_Number);
        }
        _ => {
            lua_getfield(
                L,
            ...
            lua_pushlightuserdata(L, info as *mut libc::c_void);
            lua_rawget(L, -(2 as libc::c_int));
            if !(lua_type(L, -(1 as libc::c_int)) == 5 as libc::c_int) {
                CONS_Debug(
                    0x800 as libc::c_int,
                    b"'%s' has no field named '%s'; returning nil.\n\0" as *const u8
                        as *const libc::c_char,
                    b"mobjinfo_t\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn mobjinfo_set(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut mobjinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    match field as libc::c_uint {
        ...
        1 => {
            (*info).spawnstate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        }
        2 => {
            (*info).spawnhealth = luaL_checknumber(L, 3 as libc::c_int);
        }
        3 => {
            (*info).seestate = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
        }
        4 => {
            (*info).seesound = luaL_checknumber(L, 3 as libc::c_int) as sfxenum_t;
        }
        5 => {
            (*info).reactiontime = luaL_checknumber(L, 3 as libc::c_int);
        }
        ...
        _ => {
            ...
            if lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int {
                ...
                CONS_Debug(
                    0x800 as libc::c_int,
                    b"'%s' has no field named '%s'; adding it as Lua data.\n\0"
                        as *const u8 as *const libc::c_char,
                    b"mobjinfo_t\0" as *const u8 as *const libc::c_char,
                    lua_tolstring(L, 2 as libc::c_int, 0 as *mut size_t),
                );
...
unsafe extern "C" fn mobjinfo_num(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut mobjinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(
        L,
        info.offset_from(mobjinfo.as_mut_ptr()) as libc::c_long as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getSfxInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i == 0 as libc::c_int as uint32_t || i >= NUMSFX as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"sfxinfo[] index %d out of range (1 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
    ...
    LUA_PushUserdata(
        L,
        &mut *S_sfx.as_mut_ptr().offset(i as isize) as *mut sfxinfo_t
            as *mut libc::c_void,
        b"SFXINFO_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_setSfxInfo(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut sfxinfo_t = 0 as *mut sfxinfo_t;
    lua_remove(L, 1 as libc::c_int);
    let mut i: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i == 0 as libc::c_int as uint32_t || i >= NUMSFX as libc::c_int as uint32_t {
        return luaL_error(
    ...
    info = &mut *S_sfx.as_mut_ptr().offset(i as isize) as *mut sfxinfo_t;
    luaL_checktype(L, 2 as libc::c_int, 5 as libc::c_int);
    lua_remove(L, 1 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter sfxinfo in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter sfxinfo in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        let mut i_0: sfxinfo_write = sfxinfow_singular;
        if lua_isnumber(L, 2 as libc::c_int) != 0 {
            i_0 = (lua_tonumber(L, 2 as libc::c_int) - 1 as libc::c_int)
                as sfxinfo_write;
        } else {
            i_0 = luaL_checkoption(
                L,
                2 as libc::c_int,
                0 as *const libc::c_char,
                sfxinfo_wopt.as_ptr(),
        ...
        match i_0 as libc::c_uint {
            0 => {
                (*info).singularity = luaL_checkboolean(L, 3 as libc::c_int);
            }
            1 => {
                (*info).priority = luaL_checknumber(L, 3 as libc::c_int);
            }
            2 => {
                (*info).pitch = luaL_checknumber(L, 3 as libc::c_int);
            }
            3 => {
                strlcpy(
                    ((*info).caption).as_mut_ptr(),
...
unsafe extern "C" fn lib_sfxlen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, NUMSFX as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn sfxinfo_get(mut L: *mut lua_State) -> libc::c_int {
    let mut sfx: *mut sfxinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SFXINFO_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut sfxinfo_t);
    let mut field: sfxinfo_read = luaL_checkoption(
        L,
        2 as libc::c_int,
        0 as *const libc::c_char,
        sfxinfo_ropt.as_ptr(),
    ...
    match field as libc::c_uint {
        ...
        2 => {
            lua_pushnumber(L, (*sfx).priority);
            return 1 as libc::c_int;
        }
        3 => {
            lua_pushnumber(L, (*sfx).pitch);
            return 1 as libc::c_int;
        }
        4 => {
            lua_pushstring(L, ((*sfx).caption).as_mut_ptr());
            return 1 as libc::c_int;
        }
        5 => {
            lua_pushnumber(L, (*sfx).skinsound);
            return 1 as libc::c_int;
        }
        _ => {
            return luaL_error(
                L,
                b"Field does not exist in sfxinfo_t\0" as *const u8
                    as *const libc::c_char,
            );
        }
    };
}
unsafe extern "C" fn sfxinfo_set(mut L: *mut lua_State) -> libc::c_int {
    let mut sfx: *mut sfxinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SFXINFO_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut sfxinfo_t);
    let mut field: sfxinfo_write = luaL_checkoption(
        L,
        2 as libc::c_int,
        0 as *const libc::c_char,
        sfxinfo_wopt.as_ptr(),
    ...
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter S_sfx in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter S_sfx in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    lua_remove(L, 1 as libc::c_int);
    ...
    match field as libc::c_uint {
        0 => {
            (*sfx).singularity = luaL_checkboolean(L, 1 as libc::c_int);
        }
        1 => {
            (*sfx).priority = luaL_checknumber(L, 1 as libc::c_int);
        }
        2 => {
            (*sfx).pitch = luaL_checknumber(L, 1 as libc::c_int);
        }
        3 => {
            strlcpy(
...
unsafe extern "C" fn sfxinfo_num(mut L: *mut lua_State) -> libc::c_int {
    let mut sfx: *mut sfxinfo_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SFXINFO_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(
        L,
        sfx.offset_from(S_sfx.as_mut_ptr()) as libc::c_long as uint32_t as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getluabanks(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint8_t = 0;
    lua_remove(L, 1 as libc::c_int);
    if lua_isnumber(L, 1 as libc::c_int) != 0 {
        i = lua_tonumber(L, 1 as libc::c_int) as uint8_t;
    } else {
        return luaL_error(
            L,
            b"luabanks[] invalid index\0" as *const u8 as *const libc::c_char,
        )
    }
    if i as libc::c_int >= 16 as libc::c_int {
        luaL_error(
            L,
            b"luabanks[] index %d out of range (%d - %d)\0" as *const u8
                as *const libc::c_char,
            i as libc::c_int,
            0 as libc::c_int,
    ...
    lua_pushnumber(L, luabanks[i as usize]);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_setluabanks(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint8_t = 0;
    let mut j: int32_t = 0 as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter luabanks[] in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter luabanks[] in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    lua_remove(L, 1 as libc::c_int);
    ...
    if lua_isnumber(L, 2 as libc::c_int) != 0 {
        j = lua_tonumber(L, 2 as libc::c_int);
    } else {
        return luaL_error(
            L,
            b"luabanks[] invalid set\0" as *const u8 as *const libc::c_char,
        )
    }
    luabanks[i as usize] = j;
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_luabankslen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, 16 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getSkinColor(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    lua_remove(L, 1 as libc::c_int);
    i = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    if i == 0 || i >= numskincolors as uint32_t {
        return luaL_error(
            L,
            b"skincolors[] index %d out of range (1 - %d)\0" as *const u8
                as *const libc::c_char,
            i,
    ...
    LUA_PushUserdata(
        L,
        &mut *skincolors.as_mut_ptr().offset(i as isize) as *mut skincolor_t
            as *mut libc::c_void,
        b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn setRamp(mut L: *mut lua_State, mut c: *mut skincolor_t) {
    let mut i: uint32_t = 0;
    lua_pushnil(L);
    i = 0 as libc::c_int as uint32_t;
    while i < 16 as libc::c_int as uint32_t {
        if lua_objlen(L, -(2 as libc::c_int)) != 16 as libc::c_int as size_t {
            luaL_error(
                L,
                b"'skincolor_t' field 'ramp' must be %d entries long; got %d.\0"
                    as *const u8 as *const libc::c_char,
                16 as libc::c_int,
                lua_objlen(L, -(2 as libc::c_int)),
            );
            break;
        } else {
            if lua_next(L, -(2 as libc::c_int)) != 0 as libc::c_int {
                (*c)
                    .ramp[i
                    as usize] = (if lua_isnumber(L, -(1 as libc::c_int)) != 0 {
                    luaL_checknumber(L, -(1 as libc::c_int)) as uint8_t as libc::c_int
                } else {
                    120 as libc::c_int
                }) as uint8_t;
                lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            } else {
                (*c).ramp[i as usize] = 120 as libc::c_int as uint8_t;
            }
            i = i.wrapping_add(1);
            i;
        }
...
unsafe extern "C" fn lib_setSkinColor(mut L: *mut lua_State) -> libc::c_int {
    let mut j: uint32_t = 0;
    let mut info: *mut skincolor_t = 0 as *mut skincolor_t;
    let mut cnum: uint16_t = 0;
    lua_remove(L, 1 as libc::c_int);
    cnum = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    if cnum == 0 || cnum as libc::c_int >= numskincolors as libc::c_int {
        return luaL_error(
            L,
            b"skincolors[] index %d out of range (1 - %d)\0" as *const u8
                as *const libc::c_char,
    ...
    info = &mut *skincolors.as_mut_ptr().offset(cnum as isize) as *mut skincolor_t;
    luaL_checktype(L, 2 as libc::c_int, 5 as libc::c_int);
    lua_remove(L, 1 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter skincolors in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter skincolors in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    memset(
        info as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<skincolor_t>() as libc::c_ulong,
    );
    (*Color_cons_t.as_mut_ptr().offset(cnum as isize)).value = cnum as int32_t;
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        let mut i: lua_Number = 0 as libc::c_int;
        let mut str: *const libc::c_char = 0 as *const libc::c_char;
        if lua_isnumber(L, 2 as libc::c_int) != 0 {
        ...
        if i == 1 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"name\0" as *const u8 as *const libc::c_char) != 0
        {
            let mut n: *const libc::c_char = luaL_checklstring(
                L,
                3 as libc::c_int,
                0 as *mut size_t,
            );
            ...
            if strlen(n) > 32 as libc::c_int as libc::c_ulong {
                CONS_Alert(
                    CONS_WARNING,
                    b"skincolor_t field 'name' ('%s') longer than %d chars; clipped to %s.\n\0"
                        as *const u8 as *const libc::c_char,
                    n,
                    32 as libc::c_int,
                    ((*info).name).as_mut_ptr(),
            ...
            if (*info).name[0 as libc::c_int as usize] as libc::c_int != '\0' as i32 {
                let mut dupecheck: uint16_t = R_GetColorByName(
                    ((*info).name).as_mut_ptr(),
                );
                if strcasecmp(
                    ((*info).name).as_mut_ptr(),
                    ...
                    || dupecheck as libc::c_int != 0
                        && dupecheck as libc::c_long
                            != info.offset_from(skincolors.as_mut_ptr()) as libc::c_long
                {
                    CONS_Alert(
                        CONS_WARNING,
                        b"skincolor_t field 'name' ('%s') is a duplicate of another skincolor's name.\n\0"
                            as *const u8 as *const libc::c_char,
                        ((*info).name).as_mut_ptr(),
                    );
                }
            ...
            || !str.is_null()
                && fastcmp(str, b"ramp\0" as *const u8 as *const libc::c_char) != 0
        {
            if !(lua_type(L, 3 as libc::c_int) == 5 as libc::c_int)
                && (luaL_checkudata(
                    L,
                    3 as libc::c_int,
                    b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
                ))
                    .is_null()
            {
                return luaL_error(
                    L,
                    b"'skincolor_t' field 'ramp' must be a table or array.\0"
                        as *const u8 as *const libc::c_char,
                )
            } else if lua_type(L, 3 as libc::c_int) == 5 as libc::c_int {
                setRamp(L, info);
            } else {
                j = 0 as libc::c_int as uint32_t;
                while j < 16 as libc::c_int as uint32_t {
                    (*info)
                        .ramp[j
                        as usize] = *(*(luaL_checkudata(
                        L,
                        3 as libc::c_int,
                        b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
                    ) as *mut *mut uint8_t))
            ...
            *skincolor_modified
                .as_mut_ptr()
                .offset(cnum as isize) = true_0 as libc::c_int as uint8_t;
        } else if i == 3 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"invcolor\0" as *const u8 as *const libc::c_char) != 0
        {
            let mut v: uint16_t = luaL_checknumber(L, 3 as libc::c_int) as uint16_t;
            if v as libc::c_int >= numskincolors as libc::c_int {
                return luaL_error(
                    L,
                    b"skincolor_t field 'invcolor' out of range (1 - %d)\0" as *const u8
                        as *const libc::c_char,
                    numskincolors as libc::c_int - 1 as libc::c_int,
                );
            }
            ...
            || !str.is_null()
                && fastcmp(str, b"invshade\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info)
                .invshade = (luaL_checknumber(L, 3 as libc::c_int) as uint8_t
                as libc::c_int % 16 as libc::c_int) as uint8_t;
        } else if i == 5 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"chatcolor\0" as *const u8 as *const libc::c_char) != 0
        {
            (*info).chatcolor = luaL_checknumber(L, 3 as libc::c_int) as uint16_t;
        } else if i == 6 as libc::c_int
            || !str.is_null()
                && fastcmp(str, b"accessible\0" as *const u8 as *const libc::c_char) != 0
        {
            let mut v_0: boolean = lua_toboolean(L, 3 as libc::c_int);
            if (cnum as libc::c_int) < FIRSTSUPERCOLOR as libc::c_int
                && v_0 != skincolors[cnum as usize].accessible
            {
                CONS_Alert(
                    CONS_WARNING,
                    b"skincolors[] index %d is a standard color; accessibility changes are prohibited.\0"
                        as *const u8 as *const libc::c_char,
                    cnum as libc::c_int,
                );
            } else {
...
unsafe extern "C" fn lib_skincolorslen(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, numskincolors as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn skincolor_get(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut skincolor_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char,
    ...
    if fastcmp(field, b"name\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushstring(L, ((*info).name).as_mut_ptr());
    } else if fastcmp(field, b"ramp\0" as *const u8 as *const libc::c_char) != 0 {
        LUA_PushUserdata(
            L,
            ((*info).ramp).as_mut_ptr() as *mut libc::c_void,
            b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
        );
    } else if fastcmp(field, b"invcolor\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, (*info).invcolor as lua_Number);
    } else if fastcmp(field, b"invshade\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, (*info).invshade as lua_Number);
    } else if fastcmp(field, b"chatcolor\0" as *const u8 as *const libc::c_char) != 0 {
        lua_pushnumber(L, (*info).chatcolor as lua_Number);
    } else if fastcmp(field, b"accessible\0" as *const u8 as *const libc::c_char) != 0 {
...
unsafe extern "C" fn skincolor_set(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    let mut info: *mut skincolor_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    let mut cnum: uint16_t = info.offset_from(skincolors.as_mut_ptr()) as libc::c_long
        as uint16_t;
    if cnum == 0 || cnum as libc::c_int >= numskincolors as libc::c_int {
        return luaL_error(
            L,
    ...
    if fastcmp(field, b"name\0" as *const u8 as *const libc::c_char) != 0 {
        ...
        if (*info).name[0 as libc::c_int as usize] as libc::c_int != '\0' as i32 {
            let mut dupecheck: uint16_t = R_GetColorByName(((*info).name).as_mut_ptr());
            if strcasecmp(
                ((*info).name).as_mut_ptr(),
                (skincolors[SKINCOLOR_NONE as libc::c_int as usize].name).as_mut_ptr(),
            ) == 0
                || dupecheck as libc::c_int != 0
                    && dupecheck as libc::c_int != cnum as libc::c_int
            {
                CONS_Alert(
                    CONS_WARNING,
                    b"skincolor_t field 'name' ('%s') is a duplicate of another skincolor's name.\n\0"
                ...
                .is_null()
        {
            return luaL_error(
                L,
                b"'skincolor_t' field 'ramp' must be a table or array.\0" as *const u8
                    as *const libc::c_char,
            )
        } else if lua_type(L, 3 as libc::c_int) == 5 as libc::c_int {
            setRamp(L, info);
        ...
        *skincolor_modified
        ...
        (*info)
            .invshade = (luaL_checknumber(L, 3 as libc::c_int) as uint8_t as libc::c_int
...
unsafe extern "C" fn skincolor_num(mut L: *mut lua_State) -> libc::c_int {
    let mut info: *mut skincolor_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(
        L,
        info.offset_from(skincolors.as_mut_ptr()) as libc::c_long as lua_Number,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn colorramp_get(mut L: *mut lua_State) -> libc::c_int {
    let mut colorramp: *mut uint8_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut uint8_t);
    let mut n: uint32_t = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    if n >= 16 as libc::c_int as uint32_t {
        return luaL_error(
            L,
            b"'skincolor_t' field 'ramp' index %d out of range (0 - %d)\0" as *const u8
                as *const libc::c_char,
            n,
            16 as libc::c_int - 1 as libc::c_int,
        );
    }
    lua_pushnumber(L, *colorramp.offset(n as isize) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn colorramp_set(mut L: *mut lua_State) -> libc::c_int {
    let mut colorramp: *mut uint8_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut uint8_t);
    let mut cnum: uint16_t = (colorramp
        .offset_from((skincolors[0 as libc::c_int as usize].ramp).as_mut_ptr())
        as libc::c_long as libc::c_ulong)
        .wrapping_div(::core::mem::size_of::<skincolor_t>() as libc::c_ulong)
        as uint16_t;
    let mut n: uint32_t = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    let mut i: uint8_t = luaL_checknumber(L, 3 as libc::c_int) as uint8_t;
    if cnum == 0 || cnum as libc::c_int >= numskincolors as libc::c_int {
        return luaL_error(
            L,
            b"skincolors[] index %d out of range (1 - %d)\0" as *const u8
    ...
    if hud_running != 0 {
        return luaL_error(
            L,
            b"Do not alter skincolor_t in HUD rendering code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"Do not alter skincolor_t in CMD building code!\0" as *const u8
                as *const libc::c_char,
        );
    }
    *colorramp.offset(n as isize) = i;
    *skincolor_modified
        .as_mut_ptr()
        .offset(cnum as isize) = true_0 as libc::c_int as uint8_t;
    return 0 as libc::c_int;
}
unsafe extern "C" fn colorramp_len(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, 16 as libc::c_int);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn LUA_InfoLib(mut L: *mut lua_State) -> libc::c_int {
    lua_createtable(L, 0 as libc::c_int, 0 as libc::c_int);
    lua_setfield(
        L,
        -(10000 as libc::c_int),
    ...
    luaL_newmetatable(L, b"STATE_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(state_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(state_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(state_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(mobjinfo_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(mobjinfo_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(mobjinfo_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    mobjinfo_fields_ref = Lua_CreateFieldTable(L, mobjinfo_opt.as_ptr());
    luaL_newmetatable(L, b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(skincolor_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(skincolor_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(skincolor_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(colorramp_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(colorramp_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(colorramp_len as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"SFXINFO_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(sfxinfo_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(sfxinfo_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(sfxinfo_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(spriteinfo_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(spriteinfo_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(spriteinfo_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    luaL_newmetatable(L, b"SPRITEFRAMEPIVOT_T[]\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(pivotlist_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(pivotlist_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(pivotlist_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    ...
    lua_pushcclosure(
        L,
        Some(framepivot_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(framepivot_set as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(framepivot_num as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    ...
    lua_pushcclosure(
        L,
        Some(lib_getSprname as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_sprnamelen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"sprnames\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getSpr2name as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_spr2namelen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"spr2names\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getSpr2default as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setSpr2default as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"spr2defaults\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getState as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setState as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_statelen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"states\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getMobjInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setMobjInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_mobjinfolen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"mobjinfo\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getSkinColor as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setSkinColor as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_skincolorslen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"skincolors\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getSfxInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setSfxInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_sfxlen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    ...
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"S_sfx\0" as *const u8 as *const libc::c_char,
    );
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"sfxinfo\0" as *const u8 as *const libc::c_char,
    );
    lua_newuserdata(L, 0 as libc::c_int as size_t);
    lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
    lua_pushcclosure(
        L,
        Some(lib_getSpriteInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setSpriteInfo as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_spriteinfolen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_setmetatable(L, -(2 as libc::c_int));
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"spriteinfo\0" as *const u8 as *const libc::c_char,
    );
    luaL_newmetatable(L, b"LUABANKS[]*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(lib_getluabanks as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_setluabanks as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_luabankslen as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__len\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
