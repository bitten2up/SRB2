...
extern "C" {
    ...
    fn FV3_Divide(a_i: *mut vector3_t, a_c: fixed_t) -> *mut vector3_t;
    fn FV3_Normalize(a_normal: *mut vector3_t) -> fixed_t;
    fn FV3_Negate(a_1: *mut vector3_t) -> *mut vector3_t;
    fn FV3_Cross(
        a_1: *const vector3_t,
        a_2: *const vector3_t,
        a_o: *mut vector3_t,
    ...
    fn FV3_Rotate(rotVec: *mut vector3_t, axisVec: *const vector3_t, angle: angle_t);
    ...
    fn FV3_Copy(a_o: *mut vector3_t, a_i: *const vector3_t) -> *mut vector3_t;
    fn FV3_SubEx(
        a_i: *const vector3_t,
        a_c: *const vector3_t,
        a_o: *mut vector3_t,
    ...
    fn FV2_Copy(a_o: *mut vector2_t, a_i: *const vector2_t) -> *mut vector2_t;
    ...
    fn R_CreateInterpolator_DynSlope(thinker: *mut thinker_t, slope: *mut pslope_t);
}
...
pub const SL_DYNAMIC: C2RustUnnamed_2 = 2;
pub const SL_NOPHYSICS: C2RustUnnamed_2 = 1;
pub type subsector_t = subsector_s;
pub type C2RustUnnamed_3 = libc::c_uint;
pub const NUMPOWERS: C2RustUnnamed_3 = 30;
pub const pw_strong: C2RustUnnamed_3 = 29;
pub const pw_ignorelatch: C2RustUnnamed_3 = 28;
pub const pw_justlaunched: C2RustUnnamed_3 = 27;
pub const pw_dye: C2RustUnnamed_3 = 26;
pub const pw_nocontrol: C2RustUnnamed_3 = 25;
pub const pw_nights_linkfreeze: C2RustUnnamed_3 = 24;
pub const pw_nights_helper: C2RustUnnamed_3 = 23;
pub const pw_nights_superloop: C2RustUnnamed_3 = 22;
pub const pw_emeralds: C2RustUnnamed_3 = 21;
pub const pw_railring: C2RustUnnamed_3 = 20;
pub const pw_explosionring: C2RustUnnamed_3 = 19;
pub const pw_grenadering: C2RustUnnamed_3 = 18;
pub const pw_scatterring: C2RustUnnamed_3 = 17;
pub const pw_bouncering: C2RustUnnamed_3 = 16;
pub const pw_automaticring: C2RustUnnamed_3 = 15;
pub const pw_infinityring: C2RustUnnamed_3 = 14;
pub const pw_gravityboots: C2RustUnnamed_3 = 13;
pub const pw_super: C2RustUnnamed_3 = 12;
pub const pw_noautobrake: C2RustUnnamed_3 = 11;
pub const pw_justsprung: C2RustUnnamed_3 = 10;
pub const pw_pushing: C2RustUnnamed_3 = 9;
pub const pw_extralife: C2RustUnnamed_3 = 8;
pub const pw_spacetime: C2RustUnnamed_3 = 7;
pub const pw_underwater: C2RustUnnamed_3 = 6;
pub const pw_tailsfly: C2RustUnnamed_3 = 5;
pub const pw_carry: C2RustUnnamed_3 = 4;
pub const pw_shield: C2RustUnnamed_3 = 3;
pub const pw_flashing: C2RustUnnamed_3 = 2;
pub const pw_sneakers: C2RustUnnamed_3 = 1;
pub const pw_invulnerability: C2RustUnnamed_3 = 0;
...
pub const TMSP_BACKCEILING: C2RustUnnamed_5 = 3;
pub const TMSP_BACKFLOOR: C2RustUnnamed_5 = 2;
pub const TMSP_FRONTCEILING: C2RustUnnamed_5 = 1;
pub const TMSP_FRONTFLOOR: C2RustUnnamed_5 = 0;
pub type C2RustUnnamed_6 = libc::c_uint;
pub const TMSC_BACKTOFRONTCEILING: C2RustUnnamed_6 = 8;
pub const TMSC_FRONTTOBACKCEILING: C2RustUnnamed_6 = 4;
pub const TMSC_BACKTOFRONTFLOOR: C2RustUnnamed_6 = 2;
pub const TMSC_FRONTTOBACKFLOOR: C2RustUnnamed_6 = 1;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const TMS_BACK: C2RustUnnamed_7 = 2;
pub const TMS_FRONT: C2RustUnnamed_7 = 1;
pub const TMS_NONE: C2RustUnnamed_7 = 0;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const TMSL_COPY: C2RustUnnamed_8 = 4;
pub const TMSL_DYNAMIC: C2RustUnnamed_8 = 2;
pub const TMSL_NOPHYSICS: C2RustUnnamed_8 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dynvertexplanethink_t {
    pub thinker: thinker_t,
    pub slope: *mut pslope_t,
    pub secs: [*mut sector_t; 3],
    pub vex: [vector3_t; 3],
    pub origsecheights: [fixed_t; 3],
    pub origvecheights: [fixed_t; 3],
    pub relative: uint8_t,
}
pub type dynplanetype_t = libc::c_uint;
pub const DP_BACKCEIL: dynplanetype_t = 3;
pub const DP_BACKFLOOR: dynplanetype_t = 2;
pub const DP_FRONTCEIL: dynplanetype_t = 1;
pub const DP_FRONTFLOOR: dynplanetype_t = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dynlineplanethink_t {
    pub thinker: thinker_t,
    pub slope: *mut pslope_t,
    pub type_0: dynplanetype_t,
...
#[no_mangle]
pub static mut slopelist: *mut pslope_t = 0 as *const pslope_t as *mut pslope_t;
#[no_mangle]
pub static mut slopecount: uint16_t = 0 as libc::c_int as uint16_t;
#[no_mangle]
pub unsafe extern "C" fn P_CalculateSlopeNormal(mut slope: *mut pslope_t) {
    (*slope)
        .normal
        .z = *finecosine.offset(((*slope).zangle >> 19 as libc::c_int) as isize)
        >> 16 as libc::c_int - 16 as libc::c_int;
    (*slope)
        .normal
        .x = FixedMul(
        finesine[((*slope).zangle >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int,
        (*slope).d.x,
    );
    (*slope)
...
unsafe extern "C" fn ReconfigureViaVertexes(
    mut slope: *mut pslope_t,
    v1: vector3_t,
    v2: vector3_t,
    v3: vector3_t,
) {
    let mut vec1: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    let mut vec2: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    FV3_Copy(&mut (*slope).o, &v1);
    FV3_SubEx(&v2, &v1, &mut vec1);
    FV3_SubEx(&v3, &v1, &mut vec2);
    if vec1.z == 0 as libc::c_int && vec2.z == 0 as libc::c_int {
        (*slope).xydirection = 0 as libc::c_int as angle_t;
        (*slope).zangle = (*slope).xydirection;
        (*slope).d.y = 0 as libc::c_int;
        (*slope).d.x = (*slope).d.y;
        (*slope).zdelta = (*slope).d.x;
        (*slope).normal.y = 0 as libc::c_int;
        (*slope).normal.x = (*slope).normal.y;
        (*slope).normal.z = (1 as libc::c_int) << 16 as libc::c_int;
    } else {
        let mut m: fixed_t = (if (if (if abs(vec1.x) > abs(vec1.y) {
            abs(vec1.x)
        } else {
            abs(vec1.y)
        }) > abs(vec1.z)
        {
            (if abs(vec1.x) > abs(vec1.y) { abs(vec1.x) } else { abs(vec1.y) })
        } else {
            abs(vec1.z)
        })
            > (if (if abs(vec2.x) > abs(vec2.y) { abs(vec2.x) } else { abs(vec2.y) })
                > abs(vec2.z)
            {
                (if abs(vec2.x) > abs(vec2.y) { abs(vec2.x) } else { abs(vec2.y) })
            } else {
                abs(vec2.z)
            })
        {
            (if (if abs(vec1.x) > abs(vec1.y) { abs(vec1.x) } else { abs(vec1.y) })
                > abs(vec1.z)
            {
                (if abs(vec1.x) > abs(vec1.y) { abs(vec1.x) } else { abs(vec1.y) })
            } else {
        ...
        FV3_Cross(
            FV3_Divide(&mut vec1, m),
            FV3_Divide(&mut vec2, m),
            &mut (*slope).normal,
        );
        m = R_PointToDist2(
            0 as libc::c_int,
        ...
        if (*slope).normal.z < 0 as libc::c_int {
            m = -m;
        }
        FV3_Divide(&mut (*slope).normal, m);
...
unsafe extern "C" fn ReconfigureViaConstants(
    mut slope: *mut pslope_t,
    a: fixed_t,
    b: fixed_t,
    c: fixed_t,
    ...
    let mut m: fixed_t = 0;
    let mut o: fixed_t = 0 as libc::c_int;
    let mut normal: *mut vector3_t = &mut (*slope).normal;
    if c != 0 {
        o = if abs(c) <= (1 as libc::c_int) << 16 as libc::c_int {
            -FixedMul(d, FixedDiv((1 as libc::c_int) << 16 as libc::c_int, c))
        } else {
            -FixedDiv(d, c)
        };
    }
    FV3_Load(&mut (*slope).o, 0 as libc::c_int, 0 as libc::c_int, o);
    FV3_Load(normal, a, b, c);
    FV3_Normalize(normal);
    if (*normal).z < 0 as libc::c_int {
        FV3_Negate(normal);
    }
...
#[no_mangle]
pub unsafe extern "C" fn T_DynamicSlopeLine(mut th: *mut dynlineplanethink_t) {
    let mut slope: *mut pslope_t = (*th).slope;
    let mut srcline: *mut line_t = (*th).sourceline;
    let mut zdelta: fixed_t = 0;
    match (*th).type_0 as libc::c_uint {
        0 => {
            zdelta = (*(*srcline).backsector).floorheight
                - (*(*srcline).frontsector).floorheight;
            (*slope).o.z = (*(*srcline).frontsector).floorheight;
        }
        1 => {
            zdelta = (*(*srcline).backsector).ceilingheight
                - (*(*srcline).frontsector).ceilingheight;
            (*slope).o.z = (*(*srcline).frontsector).ceilingheight;
        }
        2 => {
            zdelta = (*(*srcline).frontsector).floorheight
                - (*(*srcline).backsector).floorheight;
            (*slope).o.z = (*(*srcline).backsector).floorheight;
        }
        3 => {
            zdelta = (*(*srcline).frontsector).ceilingheight
                - (*(*srcline).backsector).ceilingheight;
...
#[no_mangle]
pub unsafe extern "C" fn T_DynamicSlopeVert(mut th: *mut dynvertexplanethink_t) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < 3 as libc::c_int as size_t {
        if !((*th).secs[i as usize]).is_null() {
            if (*th).relative as libc::c_int & (1 as libc::c_int) << i != 0 {
                (*th)
                    .vex[i as usize]
                    .z = (*th).origvecheights[i as usize]
                    + ((*(*th).secs[i as usize]).floorheight
                        - (*th).origsecheights[i as usize]);
            } else {
                (*th).vex[i as usize].z = (*(*th).secs[i as usize]).floorheight;
            }
        }
        i = i.wrapping_add(1);
        i;
    }
    ReconfigureViaVertexes(
        (*th).slope,
        (*th).vex[0 as libc::c_int as usize],
        (*th).vex[1 as libc::c_int as usize],
        (*th).vex[2 as libc::c_int as usize],
    );
}
#[inline]
unsafe extern "C" fn P_AddDynLineSlopeThinker(
    mut slope: *mut pslope_t,
    mut type_0: dynplanetype_t,
    mut sourceline: *mut line_t,
    mut extent: fixed_t,
) {
    let mut th: *mut dynlineplanethink_t = Z_CallocAlign(
        ::core::mem::size_of::<dynlineplanethink_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut dynlineplanethink_t;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut dynlineplanethink_t) -> ()>,
        actionf_p1,
    >(Some(T_DynamicSlopeLine as unsafe extern "C" fn(*mut dynlineplanethink_t) -> ()));
    (*th).slope = slope;
    (*th).type_0 = type_0;
    (*th).sourceline = sourceline;
    (*th).extent = extent;
    P_AddThinker(THINK_DYNSLOPE, &mut (*th).thinker);
    R_CreateInterpolator_DynSlope(&mut (*th).thinker, slope);
}
#[inline]
unsafe extern "C" fn P_AddDynVertexSlopeThinker(
    mut slope: *mut pslope_t,
    mut tags: *const int16_t,
    mut vx: *const vector3_t,
) {
    let mut th: *mut dynvertexplanethink_t = Z_CallocAlign(
        ::core::mem::size_of::<dynvertexplanethink_t>() as libc::c_ulong,
        PU_LEVSPEC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut dynvertexplanethink_t;
    let mut i: size_t = 0;
    let mut l: int32_t = 0;
    (*th)
        .thinker
        .function
        .acp1 = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut dynvertexplanethink_t) -> ()>,
        actionf_p1,
    >(
        Some(
            T_DynamicSlopeVert as unsafe extern "C" fn(*mut dynvertexplanethink_t) -> (),
        ),
    );
    (*th).slope = slope;
    i = 0 as libc::c_int as size_t;
    while i < 3 as libc::c_int as size_t {
        l = Tag_FindLineSpecial(799 as libc::c_int as int16_t, *tags.offset(i as isize));
        (*th)
            .secs[i
            as usize] = if l == -(1 as libc::c_int) {
            0 as *mut sector_t
        } else {
            (*lines.offset(l as isize)).frontsector
        };
        (*th).vex[i as usize] = *vx.offset(i as isize);
        (*th)
            .origsecheights[i
            as usize] = if l == -(1 as libc::c_int) {
            0 as libc::c_int
        } else {
            (*(*lines.offset(l as isize)).frontsector).floorheight
        };
        (*th).origvecheights[i as usize] = (*vx.offset(i as isize)).z;
        if l != -(1 as libc::c_int)
            && (*lines.offset(l as isize)).args[0 as libc::c_int as usize] != 0
        {
            (*th)
                .relative = ((*th).relative as libc::c_int | (1 as libc::c_int) << i)
                as uint8_t;
        }
        i = i.wrapping_add(1);
        i;
...
#[inline]
unsafe extern "C" fn Slope_Add(flags: uint8_t) -> *mut pslope_t {
    let mut ret: *mut pslope_t = Z_CallocAlign(
    ...
    (*ret).next = slopelist;
    slopelist = ret;
    slopecount = slopecount.wrapping_add(1);
    slopecount;
    (*ret).id = slopecount;
    return ret;
}
unsafe extern "C" fn MakeViaVectors(
    mut o: *const vector3_t,
    mut d: *const vector2_t,
    zdelta: fixed_t,
    mut flags: uint8_t,
) -> *mut pslope_t {
    let mut ret: *mut pslope_t = Slope_Add(flags);
    FV3_Copy(&mut (*ret).o, o);
    FV2_Copy(&mut (*ret).d, d);
    (*ret).zdelta = zdelta;
    (*ret).flags = flags;
    return ret;
}
unsafe extern "C" fn GetExtent(
    mut sector: *mut sector_t,
    mut line: *mut line_t,
) -> fixed_t {
    let mut fardist: fixed_t = -((1 as libc::c_int) << 16 as libc::c_int);
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < (*sector).linecount {
        let mut li: *mut line_t = *((*sector).lines).offset(i as isize);
        let mut tempv: vertex_t = vertex_t {
            x: 0,
            y: 0,
            floorzset: 0,
            ceilingzset: 0,
        ...
        if !(li == line) {
            P_ClosestPointOnLine((*(*li).v1).x, (*(*li).v1).y, line, &mut tempv);
            dist = R_PointToDist2(tempv.x, tempv.y, (*(*li).v1).x, (*(*li).v1).y);
            if dist > fardist {
                fardist = dist;
            }
            P_ClosestPointOnLine((*(*li).v2).x, (*(*li).v2).y, line, &mut tempv);
...
unsafe extern "C" fn P_CopySlope(
    mut toslope: *mut *mut pslope_t,
    mut fromslope: *mut pslope_t,
) -> boolean {
    if !(*toslope).is_null() || fromslope.is_null() {
        return true_0 as libc::c_int;
    }
    *toslope = fromslope;
    return true_0 as libc::c_int;
}
unsafe extern "C" fn P_UpdateHasSlope(mut sec: *mut sector_t) {
    let mut i: size_t = 0;
    (*sec).hasslope = true_0 as libc::c_int;
    if (*sec).numattached != 0 {
        i = 0 as libc::c_int as size_t;
        while i < (*sec).numattached {
            (*sectors.offset(*((*sec).attached).offset(i as isize) as isize))
                .hasslope = true_0 as libc::c_int;
            i = i.wrapping_add(1);
            i;
        }
    }
}
unsafe extern "C" fn line_SpawnViaLine(linenum: libc::c_int, spawnthinker: boolean) {
    let mut line: *mut line_t = lines.offset(linenum as isize);
    let mut fslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut cslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut origin: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    let mut point: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    let mut direction: vector2_t = vector2_t { x: 0, y: 0 };
    let mut nx: fixed_t = 0;
    let mut ny: fixed_t = 0;
    let mut dz: fixed_t = 0;
    let mut extent: fixed_t = 0;
    let mut frontfloor: boolean = ((*line).args[0 as libc::c_int as usize]
        == TMS_FRONT as libc::c_int) as libc::c_int;
    let mut backfloor: boolean = ((*line).args[0 as libc::c_int as usize]
        == TMS_BACK as libc::c_int) as libc::c_int;
    let mut frontceil: boolean = ((*line).args[1 as libc::c_int as usize]
        == TMS_FRONT as libc::c_int) as libc::c_int;
    let mut backceil: boolean = ((*line).args[1 as libc::c_int as usize]
        == TMS_BACK as libc::c_int) as libc::c_int;
    let mut flags: uint8_t = 0 as libc::c_int as uint8_t;
    if (*line).args[2 as libc::c_int as usize] & TMSL_NOPHYSICS as libc::c_int != 0 {
        flags = (flags as libc::c_int | SL_NOPHYSICS as libc::c_int) as uint8_t;
    }
    if (*line).args[2 as libc::c_int as usize] & TMSL_DYNAMIC as libc::c_int != 0 {
        flags = (flags as libc::c_int | SL_DYNAMIC as libc::c_int) as uint8_t;
    }
    if frontfloor == 0 && backfloor == 0 && frontceil == 0 && backceil == 0 {
        CONS_Printf(
            b"line_SpawnViaLine: Unused slope special with nothing to do on line number %i\n\0"
                as *const u8 as *const libc::c_char,
            linenum,
        );
        return;
    }
    if ((*line).frontsector).is_null() || ((*line).backsector).is_null() {
        CONS_Debug(
            0x400 as libc::c_int,
            b"line_SpawnViaLine: Slope special used on a line without two sides. (line number %i)\n\0"
                as *const u8 as *const libc::c_char,
            linenum,
        );
        return;
    }
    let mut len: fixed_t = R_PointToDist2(
        0 as libc::c_int,
        0 as libc::c_int,
        (*line).dx,
        (*line).dy,
    ...
    origin.x = (*(*line).v1).x + ((*(*line).v2).x - (*(*line).v1).x) / 2 as libc::c_int;
    origin.y = (*(*line).v1).y + ((*(*line).v2).y - (*(*line).v1).y) / 2 as libc::c_int;
    if frontfloor != 0 || frontceil != 0 {
        (*(*line).frontsector).hasslope = true_0 as libc::c_int;
        origin.z = (*(*line).backsector).floorheight;
        direction.x = nx;
        direction.y = ny;
        extent = GetExtent((*line).frontsector, line);
        if extent < 0 as libc::c_int {
            CONS_Printf(
                b"line_SpawnViaLine failed to get frontsector extent on line number %i\n\0"
                    as *const u8 as *const libc::c_char,
                linenum,
            );
            return;
        ...
        if frontfloor != 0 {
            point.z = (*(*line).frontsector).floorheight;
            dz = FixedDiv(origin.z - point.z, extent);
            (*(*line).frontsector)
                .f_slope = MakeViaVectors(&mut point, &mut direction, dz, flags);
            fslope = (*(*line).frontsector).f_slope;
            (*fslope)
                .zangle = R_PointToAngle2(0 as libc::c_int, origin.z, extent, point.z);
            (*fslope)
                .xydirection = R_PointToAngle2(origin.x, origin.y, point.x, point.y);
            P_CalculateSlopeNormal(fslope);
            if spawnthinker != 0 && flags as libc::c_int & SL_DYNAMIC as libc::c_int != 0
            {
        ...
        if frontceil != 0 {
            ...
            dz = FixedDiv(origin.z - point.z, extent);
            (*(*line).frontsector)
                .c_slope = MakeViaVectors(&mut point, &mut direction, dz, flags);
    ...
    if backfloor != 0 || backceil != 0 {
        (*(*line).backsector).hasslope = true_0 as libc::c_int;
        ...
        if extent < 0 as libc::c_int {
            CONS_Printf(
                b"line_SpawnViaLine failed to get backsector extent on line number %i\n\0"
                    as *const u8 as *const libc::c_char,
                linenum,
            );
            return;
    ...
    if (*line).args[2 as libc::c_int as usize] & TMSL_COPY as libc::c_int != 0 {
        if frontfloor != 0 {
            P_CopySlope(
                &mut (*(*line).backsector).f_slope,
                (*(*line).frontsector).f_slope,
            );
        }
        if backfloor != 0 {
            P_CopySlope(
                &mut (*(*line).frontsector).f_slope,
                (*(*line).backsector).f_slope,
            );
        }
        if frontceil != 0 {
            P_CopySlope(
                &mut (*(*line).backsector).c_slope,
                (*(*line).frontsector).c_slope,
            );
        }
        if backceil != 0 {
            P_CopySlope(
                &mut (*(*line).frontsector).c_slope,
                (*(*line).backsector).c_slope,
            );
        }
        if backfloor != 0 || backceil != 0 {
...
unsafe extern "C" fn MakeViaMapthings(
    mut tag1: int16_t,
    mut tag2: int16_t,
    mut tag3: int16_t,
    mut flags: uint8_t,
    spawnthinker: boolean,
) -> *mut pslope_t {
    let mut i: size_t = 0;
    let mut mt: *mut mapthing_t = mapthings;
    let mut vertices: [*mut mapthing_t; 3] = [
        0 as *mut mapthing_t,
        0 as *mut mapthing_t,
        0 as *mut mapthing_t,
    ];
    let mut tags: [int16_t; 3] = [tag1, tag2, tag3];
    let mut vx: [vector3_t; 3] = [vector3_t { x: 0, y: 0, z: 0 }; 3];
    let mut ret: *mut pslope_t = Slope_Add(flags);
    i = 0 as libc::c_int as size_t;
    while i < nummapthings {
        if !((*mt).type_0 as libc::c_int != 750 as libc::c_int) {
            if (vertices[0 as libc::c_int as usize]).is_null()
                && Tag_Find(&mut (*mt).tags, tag1) != 0
            {
                vertices[0 as libc::c_int as usize] = mt;
            } else if (vertices[1 as libc::c_int as usize]).is_null()
                && Tag_Find(&mut (*mt).tags, tag2) != 0
            {
                vertices[1 as libc::c_int as usize] = mt;
            } else if (vertices[2 as libc::c_int as usize]).is_null()
                && Tag_Find(&mut (*mt).tags, tag3) != 0
            {
                vertices[2 as libc::c_int as usize] = mt;
            }
        }
        i = i.wrapping_add(1);
        i;
    ...
    i = 0 as libc::c_int as size_t;
    while i < 3 as libc::c_int as size_t {
        mt = vertices[i as usize];
        if mt.is_null() {
            I_Error(
                b"MakeViaMapthings: Slope vertex %s (for linedef tag %d) not found!\0"
                    as *const u8 as *const libc::c_char,
                sizeu1(i),
                tag1 as libc::c_int,
            );
        }
        vx[i as usize].x = ((*mt).x as libc::c_int) << 16 as libc::c_int;
        vx[i as usize].y = ((*mt).y as libc::c_int) << 16 as libc::c_int;
        vx[i as usize].z = ((*mt).z as libc::c_int) << 16 as libc::c_int;
        if (*mt).args[0 as libc::c_int as usize] == 0 {
            vx[i as usize].z
                += (*(*R_PointInSubsector(vx[i as usize].x, vx[i as usize].y)).sector)
                    .floorheight;
        }
        i = i.wrapping_add(1);
        i;
    ...
    ReconfigureViaVertexes(
        ret,
        vx[0 as libc::c_int as usize],
        vx[1 as libc::c_int as usize],
        vx[2 as libc::c_int as usize],
    );
    if spawnthinker != 0 && flags as libc::c_int & SL_DYNAMIC as libc::c_int != 0 {
        P_AddDynVertexSlopeThinker(
            ret,
            tags.as_mut_ptr() as *const int16_t,
            vx.as_mut_ptr() as *const vector3_t,
        );
    }
    return ret;
}
unsafe extern "C" fn line_SpawnViaMapthingVertexes(
    linenum: libc::c_int,
    spawnthinker: boolean,
) {
    let mut line: *mut line_t = lines.offset(linenum as isize);
    let mut side: *mut side_t = 0 as *mut side_t;
    let mut slopetoset: *mut *mut pslope_t = 0 as *mut *mut pslope_t;
    let mut tag1: uint16_t = (*line).args[1 as libc::c_int as usize] as uint16_t;
    let mut tag2: uint16_t = (*line).args[2 as libc::c_int as usize] as uint16_t;
    let mut tag3: uint16_t = (*line).args[3 as libc::c_int as usize] as uint16_t;
    let mut flags: uint8_t = 0 as libc::c_int as uint8_t;
    if (*line).args[4 as libc::c_int as usize] & TMSL_NOPHYSICS as libc::c_int != 0 {
        flags = (flags as libc::c_int | SL_NOPHYSICS as libc::c_int) as uint8_t;
    }
    if (*line).args[4 as libc::c_int as usize] & TMSL_DYNAMIC as libc::c_int != 0 {
        flags = (flags as libc::c_int | SL_DYNAMIC as libc::c_int) as uint8_t;
    }
    match (*line).args[0 as libc::c_int as usize] {
        0 => {
            slopetoset = &mut (*(*line).frontsector).f_slope;
            side = &mut *sides
                .offset(
        ...
        1 => {
            slopetoset = &mut (*(*line).frontsector).c_slope;
            side = &mut *sides
                .offset(
                    *((*line).sidenum).as_mut_ptr().offset(0 as libc::c_int as isize)
                        as isize,
        ...
        2 => {
            slopetoset = &mut (*(*line).backsector).f_slope;
            side = &mut *sides
                .offset(
        ...
        3 => {
            slopetoset = &mut (*(*line).backsector).c_slope;
            side = &mut *sides
                .offset(
                    *((*line).sidenum).as_mut_ptr().offset(1 as libc::c_int as isize)
                        as isize,
    ...
    *slopetoset = MakeViaMapthings(
    ...
    (*(*side).sector).hasslope = true_0 as libc::c_int;
}
unsafe extern "C" fn SpawnVertexSlopes() {
    let mut l1: *mut line_t = 0 as *mut line_t;
    let mut l2: *mut line_t = 0 as *mut line_t;
    ...
    let mut v3: *mut vertex_t = 0 as *mut vertex_t;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    sc = sectors;
    while i < numsectors {
        if !((*sc).linecount != 3 as libc::c_int as size_t) {
            l1 = *((*sc).lines).offset(0 as libc::c_int as isize);
            l2 = *((*sc).lines).offset(1 as libc::c_int as isize);
            v1 = (*l1).v1;
            v2 = (*l1).v2;
            ...
            if (*v1).floorzset != 0 || (*v2).floorzset != 0 || (*v3).floorzset != 0 {
                let mut vtx: [vector3_t; 3] = [
                    {
                ...
                let mut slop: *mut pslope_t = Slope_Add(0 as libc::c_int as uint8_t);
                (*sc).f_slope = slop;
                (*sc).hasslope = true_0 as libc::c_int;
                ReconfigureViaVertexes(
                    slop,
                    vtx[0 as libc::c_int as usize],
                    vtx[1 as libc::c_int as usize],
                    vtx[2 as libc::c_int as usize],
                );
            }
            if (*v1).ceilingzset != 0 || (*v2).ceilingzset != 0 || (*v3).ceilingzset != 0
            {
                let mut vtx_0: [vector3_t; 3] = [
                    {
                        let mut init = vector3_t {
                            x: (*v1).x,
                            y: (*v1).y,
                            z: if (*v1).ceilingzset != 0 {
                                (*v1).ceilingz
                            } else {
                                (*sc).ceilingheight
                            },
                ...
                let mut slop_0: *mut pslope_t = Slope_Add(0 as libc::c_int as uint8_t);
                (*sc).c_slope = slop_0;
                (*sc).hasslope = true_0 as libc::c_int;
                ReconfigureViaVertexes(
                    slop_0,
                    vtx_0[0 as libc::c_int as usize],
                    vtx_0[1 as libc::c_int as usize],
                    vtx_0[2 as libc::c_int as usize],
                );
            }
        }
        i = i.wrapping_add(1);
...
unsafe extern "C" fn P_SetSlopeFromTag(
    mut sec: *mut sector_t,
    mut tag: int32_t,
    mut ceiling: boolean,
) -> boolean {
    let mut i: int32_t = 0;
    let mut secslope: *mut *mut pslope_t = if ceiling != 0 {
        &mut (*sec).c_slope
    } else {
        &mut (*sec).f_slope
    };
    if tag == 0 || !(*secslope).is_null() {
        return false_0 as libc::c_int;
    }
    let mut ICNT_636: size_t = 0 as libc::c_int as size_t;
    loop {
        i = Tag_Iterate_Sectors(tag as mtag_t, ICNT_636);
        if !(i >= 0 as libc::c_int) {
            break;
        }
        let mut srcslope: *mut pslope_t = if ceiling != 0 {
            (*sectors.offset(i as isize)).c_slope
        } else {
            (*sectors.offset(i as isize)).f_slope
        };
        if !srcslope.is_null() {
            *secslope = srcslope;
            return true_0 as libc::c_int;
        }
        ICNT_636 = ICNT_636.wrapping_add(1);
        ICNT_636;
    }
    return false_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn P_CopySectorSlope(mut line: *mut line_t) {
    let mut fsec: *mut sector_t = (*line).frontsector;
    let mut bsec: *mut sector_t = (*line).backsector;
    let mut setfront: boolean = false_0 as libc::c_int;
    let mut setback: boolean = false_0 as libc::c_int;
    setfront
        |= P_SetSlopeFromTag(
            fsec,
    ...
    if !bsec.is_null() {
        ...
        if (*line).args[4 as libc::c_int as usize] & TMSC_FRONTTOBACKFLOOR as libc::c_int
            != 0
        {
            setback |= P_CopySlope(&mut (*bsec).f_slope, (*fsec).f_slope);
        }
        if (*line).args[4 as libc::c_int as usize] & TMSC_BACKTOFRONTFLOOR as libc::c_int
            != 0
        {
            setfront |= P_CopySlope(&mut (*fsec).f_slope, (*bsec).f_slope);
        }
        if (*line).args[4 as libc::c_int as usize]
            & TMSC_FRONTTOBACKCEILING as libc::c_int != 0
        {
            setback |= P_CopySlope(&mut (*bsec).c_slope, (*fsec).c_slope);
        }
        if (*line).args[4 as libc::c_int as usize]
            & TMSC_BACKTOFRONTCEILING as libc::c_int != 0
        {
            setfront |= P_CopySlope(&mut (*fsec).c_slope, (*bsec).c_slope);
        }
    }
    if setfront != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn P_SlopeById(mut id: uint16_t) -> *mut pslope_t {
    let mut ret: *mut pslope_t = 0 as *mut pslope_t;
    ret = slopelist;
    while !ret.is_null() && (*ret).id as libc::c_int != id as libc::c_int {
        ret = (*ret).next;
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn MakeViaEquationConstants(
    a: fixed_t,
    b: fixed_t,
    c: fixed_t,
    d: fixed_t,
) -> *mut pslope_t {
    let mut ret: *mut pslope_t = Slope_Add(0 as libc::c_int as uint8_t);
    ReconfigureViaConstants(ret, a, b, c, d);
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn P_SpawnSlopes(fromsave: boolean) {
    let mut i: size_t = 0;
    SpawnVertexSlopes();
    i = 0 as libc::c_int as size_t;
    while i < numlines {
        match (*lines.offset(i as isize)).special as libc::c_int {
            700 => {
                line_SpawnViaLine(i as libc::c_int, (fromsave == 0) as libc::c_int);
            }
            704 => {
                line_SpawnViaMapthingVertexes(
                    i as libc::c_int,
                    (fromsave == 0) as libc::c_int,
                );
            }
            _ => {}
        }
    ...
    while i < numlines {
        match (*lines.offset(i as isize)).special as libc::c_int {
            720 => {
                P_CopySectorSlope(&mut *lines.offset(i as isize));
            }
            _ => {}
        }
        i = i.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn P_InitSlopes() {
    slopelist = 0 as *mut pslope_t;
    slopecount = 0 as libc::c_int as uint16_t;
}
#[no_mangle]
pub unsafe extern "C" fn P_GetSlopeZAt(
    mut slope: *const pslope_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    let mut dist: fixed_t = FixedMul(x - (*slope).o.x, (*slope).d.x)
        + FixedMul(y - (*slope).o.y, (*slope).d.y);
    return (*slope).o.z + FixedMul(dist, (*slope).zdelta);
}
#[no_mangle]
pub unsafe extern "C" fn P_GetZAt(
    mut slope: *const pslope_t,
    mut x: fixed_t,
    mut y: fixed_t,
    mut z: fixed_t,
) -> fixed_t {
    return if !slope.is_null() { P_GetSlopeZAt(slope, x, y) } else { z };
}
#[no_mangle]
pub unsafe extern "C" fn P_GetSectorFloorZAt(
    mut sector: *const sector_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    return if !((*sector).f_slope).is_null() {
        P_GetSlopeZAt((*sector).f_slope, x, y)
    } else {
        (*sector).floorheight
    };
}
#[no_mangle]
pub unsafe extern "C" fn P_GetSectorCeilingZAt(
    mut sector: *const sector_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    return if !((*sector).c_slope).is_null() {
        P_GetSlopeZAt((*sector).c_slope, x, y)
    } else {
        (*sector).ceilingheight
    };
}
#[no_mangle]
pub unsafe extern "C" fn P_GetFFloorTopZAt(
    mut ffloor: *const ffloor_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    return if !(*(*ffloor).t_slope).is_null() {
        P_GetSlopeZAt(*(*ffloor).t_slope, x, y)
    } else {
        *(*ffloor).topheight
    };
}
#[no_mangle]
pub unsafe extern "C" fn P_GetFFloorBottomZAt(
    mut ffloor: *const ffloor_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    return if !(*(*ffloor).b_slope).is_null() {
        P_GetSlopeZAt(*(*ffloor).b_slope, x, y)
    } else {
        *(*ffloor).bottomheight
    };
}
#[no_mangle]
pub unsafe extern "C" fn P_GetLightZAt(
    mut light: *const lightlist_t,
    mut x: fixed_t,
    mut y: fixed_t,
) -> fixed_t {
    return if !((*light).slope).is_null() {
        P_GetSlopeZAt((*light).slope, x, y)
    } else {
        (*light).height
    };
}
#[no_mangle]
pub unsafe extern "C" fn P_QuantizeMomentumToSlope(
    mut momentum: *mut vector3_t,
    mut slope: *mut pslope_t,
) {
    let mut axis: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    if (*slope).flags as libc::c_int & SL_NOPHYSICS as libc::c_int != 0 {
        return;
    }
    axis.x = -(*slope).d.y;
    axis.y = (*slope).d.x;
    axis.z = 0 as libc::c_int;
    FV3_Rotate(momentum, &mut axis, (*slope).zangle >> 19 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn P_ReverseQuantizeMomentumToSlope(
    mut momentum: *mut vector3_t,
    mut slope: *mut pslope_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn P_SlopeLaunch(mut mo: *mut mobj_t) {
    if (*(*mo).standingslope).flags as libc::c_int & SL_NOPHYSICS as libc::c_int == 0
        && ((*(*mo).standingslope).normal.x != 0 as libc::c_int
            || (*(*mo).standingslope).normal.y != 0 as libc::c_int)
    {
        let mut slopemom: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
        slopemom.x = (*mo).momx;
        slopemom.y = (*mo).momy;
        slopemom.z = (*mo).momz * 2 as libc::c_int;
        P_QuantizeMomentumToSlope(&mut slopemom, (*mo).standingslope);
        (*mo).momx = slopemom.x;
        (*mo).momy = slopemom.y;
        (*mo).momz = slopemom.z / 2 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn P_GetWallTransferMomZ(
    mut mo: *mut mobj_t,
    mut slope: *mut pslope_t,
) -> fixed_t {
    let mut slopemom: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    ...
    ang = ((*slope).zangle)
        .wrapping_add(
            (0xaaaaaab as libc::c_int
                * (if (*slope).zangle > 0 as libc::c_int as angle_t {
                    1 as libc::c_int
                } else {
                    -(1 as libc::c_int)
                })) as angle_t,
        );
    if ang > 0x40000000 as libc::c_int as angle_t && ang < 0x80000000 as libc::c_uint {
        ang = if (*slope).zangle > 0 as libc::c_int as angle_t {
            0x40000000 as libc::c_int as angle_t
        } else {
            InvAngle(0x40000000 as libc::c_int as angle_t)
        };
    }
    slopemom.x = (*mo).momx;
    slopemom.y = (*mo).momy;
    slopemom.z = 3 as libc::c_int * ((*mo).momz / 2 as libc::c_int);
    axis.x = -(*slope).d.y;
    axis.y = (*slope).d.x;
    axis.z = 0 as libc::c_int;
    FV3_Rotate(&mut slopemom, &mut axis, ang >> 19 as libc::c_int);
    return 2 as libc::c_int * (slopemom.z / 3 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn P_HandleSlopeLanding(
    mut thing: *mut mobj_t,
    mut slope: *mut pslope_t,
) {
    let mut mom: vector3_t = vector3_t { x: 0, y: 0, z: 0 };
    if (*slope).flags as libc::c_int & SL_NOPHYSICS as libc::c_int != 0
        || (*slope).normal.x == 0 as libc::c_int && (*slope).normal.y == 0 as libc::c_int
    {
        if P_MobjFlip(thing) as libc::c_int * (*thing).momz < 0 as libc::c_int {
            ...
            {
                (*thing).momz = -(P_MobjFlip(thing) as libc::c_int);
            }
        }
        return;
    }
    mom.x = (*thing).momx;
    mom.y = (*thing).momy;
    mom.z = (*thing).momz * 2 as libc::c_int;
    P_ReverseQuantizeMomentumToSlope(&mut mom, slope);
    if P_MobjFlip(thing) as libc::c_int * mom.z < 0 as libc::c_int {
        (*thing).momx = mom.x;
        (*thing).momy = mom.y;
        (*thing).standingslope = slope;
        P_SetPitchRollFromSlope(thing, slope);
...
#[no_mangle]
pub unsafe extern "C" fn P_ButteredSlope(mut mo: *mut mobj_t) {
    ...
    if (*mo).flags
        & (MF_NOCLIPHEIGHT as libc::c_int | MF_NOGRAVITY as libc::c_int) as uint32_t != 0
    {
        return;
    }
    if !((*mo).player).is_null() {
        if abs((*(*mo).standingslope).zdelta)
    ...
    thrust = (finesine[((*(*mo).standingslope).zangle >> 19 as libc::c_int) as usize]
        >> 16 as libc::c_int - 16 as libc::c_int) * 3 as libc::c_int / 2 as libc::c_int
    ...
    if !((*mo).player).is_null()
        && (*(*mo).player).pflags as libc::c_uint
            & PF_SPINNING as libc::c_int as libc::c_uint != 0
    {
        let mut mult: fixed_t = 0 as libc::c_int;
        if (*mo).momx != 0 || (*mo).momy != 0 {
            let mut angle: angle_t = (R_PointToAngle2(
                ...
                .wrapping_sub((*(*mo).standingslope).xydirection);
            if P_MobjFlip(mo) as libc::c_int * (*(*mo).standingslope).zdelta
                < 0 as libc::c_int
            {
                angle ^= 0x80000000 as libc::c_uint;
            }
            mult = *finecosine.offset((angle >> 19 as libc::c_int) as isize)
                >> 16 as libc::c_int - 16 as libc::c_int;
        }
        thrust = FixedMul(
            thrust,
            ((1 as libc::c_int) << 16 as libc::c_int) * 2 as libc::c_int
                / 3 as libc::c_int + mult / 8 as libc::c_int,
        );
    }
    if (*mo).momx != 0 || (*mo).momy != 0 {
        thrust = FixedMul(
            thrust,
            ((1 as libc::c_int) << 16 as libc::c_int)
                + P_AproxDistance((*mo).momx, (*mo).momy) / 16 as libc::c_int,
        );
    }
