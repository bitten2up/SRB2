...
extern "C" {
    ...
    static mut cv_maxportals: consvar_t;
    static mut clipangle: angle_t;
    static mut doubleclipangle: angle_t;
    static mut viewangletox: [int32_t; 4096];
    static mut rw_angle1: angle_t;
    static mut leveltime: tic_t;
    static mut camera: camera_t;
    static mut camera2: camera_t;
    fn R_PointOnSide(x: fixed_t, y: fixed_t, node: *mut node_t) -> int32_t;
    fn R_PointToAngle(x: fixed_t, y: fixed_t) -> angle_t;
    fn R_PointToAngle64(x: int64_t, y: int64_t) -> angle_t;
    ...
    static mut ps_numbspcalls: ps_metric_t;
    static mut ps_numpolyobjects: ps_metric_t;
    static mut portalline: boolean;
    fn R_StoreWallRange(start: int32_t, stop: int32_t);
    static mut skyflatnum: int32_t;
    fn Portal_Add2Lines(line1: int32_t, line2: int32_t, x1: int32_t, x2: int32_t);
    static mut portalrender: uint8_t;
    fn R_AddSprites(sec: *mut sector_t, lightlevel: int32_t);
    ...
    fn R_FindPlane(
        ...
        yoff: fixed_t,
        plangle: angle_t,
        planecolormap: *mut extracolormap_t,
        ffloor_0: *mut ffloor_t,
        polyobj: *mut polyobj_t,
        slope: *mut pslope_t,
    ) -> *mut visplane_t;
...
pub const BOXRIGHT: C2RustUnnamed_2 = 3;
pub const BOXLEFT: C2RustUnnamed_2 = 2;
pub const BOXBOTTOM: C2RustUnnamed_2 = 1;
pub const BOXTOP: C2RustUnnamed_2 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const POF_SPLAT: C2RustUnnamed_3 = 8192;
pub const POF_NOSPECIALS: C2RustUnnamed_3 = 4096;
pub const POF_ONESIDE: C2RustUnnamed_3 = 2048;
pub const POF_LDEXEC: C2RustUnnamed_3 = 1024;
pub const POF_PUSHABLESTOP: C2RustUnnamed_3 = 512;
pub const POF_INVERTPLANESONLY: C2RustUnnamed_3 = 256;
pub const POF_INVERTPLANES: C2RustUnnamed_3 = 128;
pub const POF_INVERT: C2RustUnnamed_3 = 64;
pub const POF_RENDERALL: C2RustUnnamed_3 = 56;
pub const POF_RENDERPLANES: C2RustUnnamed_3 = 48;
pub const POF_RENDERBOTTOM: C2RustUnnamed_3 = 32;
pub const POF_RENDERTOP: C2RustUnnamed_3 = 16;
pub const POF_RENDERSIDES: C2RustUnnamed_3 = 8;
pub const POF_TESTHEIGHT: C2RustUnnamed_3 = 4;
pub const POF_SOLID: C2RustUnnamed_3 = 3;
pub const POF_CLIPPLANES: C2RustUnnamed_3 = 2;
pub const POF_CLIPLINES: C2RustUnnamed_3 = 1;
...
#[no_mangle]
pub static mut curline: *mut seg_t = 0 as *const seg_t as *mut seg_t;
#[no_mangle]
pub static mut sidedef: *mut side_t = 0 as *const side_t as *mut side_t;
#[no_mangle]
pub static mut linedef: *mut line_t = 0 as *const line_t as *mut line_t;
#[no_mangle]
pub static mut frontsector: *mut sector_t = 0 as *const sector_t as *mut sector_t;
#[no_mangle]
pub static mut backsector: *mut sector_t = 0 as *const sector_t as *mut sector_t;
#[no_mangle]
pub static mut curdrawsegs: *mut drawseg_t = 0 as *const drawseg_t as *mut drawseg_t;
#[no_mangle]
pub static mut drawsegs: *mut drawseg_t = 0 as *const drawseg_t as *mut drawseg_t;
#[no_mangle]
pub static mut ds_p: *mut drawseg_t = 0 as *const drawseg_t as *mut drawseg_t;
#[no_mangle]
pub static mut doorclosed: int32_t = 0;
#[no_mangle]
pub unsafe extern "C" fn R_ClearDrawSegs() {
    ds_p = drawsegs;
}
static mut newend: *mut cliprange_t = 0 as *const cliprange_t as *mut cliprange_t;
static mut solidsegs: [cliprange_t; 961] = [cliprange_t { first: 0, last: 0 }; 961];
unsafe extern "C" fn R_ClipSolidWallSegment(mut first: int32_t, mut last: int32_t) {
    let mut current_block: u64;
    let mut next: *mut cliprange_t = 0 as *mut cliprange_t;
    let mut start: *mut cliprange_t = 0 as *mut cliprange_t;
    start = solidsegs.as_mut_ptr();
    while (*start).last < first - 1 as libc::c_int {
        start = start.offset(1);
        start;
    }
    if first < (*start).first {
        if last < (*start).first - 1 as libc::c_int {
            R_StoreWallRange(first, last);
            next = newend;
            newend = newend.offset(1);
            newend;
            if newend.offset_from(solidsegs.as_mut_ptr()) as libc::c_long
                > (1920 as libc::c_int / 2 as libc::c_int + 1 as libc::c_int)
                    as libc::c_long
            {
                I_Error(
                    b"R_ClipSolidWallSegment: Solid Segs overflow!\n\0" as *const u8
        ...
        R_StoreWallRange(first, (*start).first - 1 as libc::c_int);
        (*start).first = first;
    }
    if last <= (*start).last {
        return;
    ...
    next = start;
    loop {
        if !(last >= (*next.offset(1 as libc::c_int as isize)).first - 1 as libc::c_int)
        {
            current_block = 18317007320854588510;
            break;
        }
        R_StoreWallRange(
            (*next).last + 1 as libc::c_int,
            (*next.offset(1 as libc::c_int as isize)).first - 1 as libc::c_int,
        );
        next = next.offset(1);
        next;
        if !(last <= (*next).last) {
        ...
        current_block = 4798213874867660585;
        break;
    }
    match current_block {
        18317007320854588510 => {
            R_StoreWallRange((*next).last + 1 as libc::c_int, last);
            (*start).last = last;
        }
        _ => {}
    }
    ...
    newend = start.offset(1 as libc::c_int as isize);
    if newend.offset_from(solidsegs.as_mut_ptr()) as libc::c_long
        > (1920 as libc::c_int / 2 as libc::c_int + 1 as libc::c_int) as libc::c_long
    {
        I_Error(
            b"R_ClipSolidWallSegment: Solid Segs overflow!\n\0" as *const u8
                as *const libc::c_char,
...
#[inline]
unsafe extern "C" fn R_ClipPassWallSegment(mut first: int32_t, mut last: int32_t) {
    let mut start: *mut cliprange_t = 0 as *mut cliprange_t;
    start = solidsegs.as_mut_ptr();
    while (*start).last < first - 1 as libc::c_int {
        start = start.offset(1);
    ...
    while last >= (*start.offset(1 as libc::c_int as isize)).first - 1 as libc::c_int {
        R_StoreWallRange(
            (*start).last + 1 as libc::c_int,
            (*start.offset(1 as libc::c_int as isize)).first - 1 as libc::c_int,
        );
        start = start.offset(1);
        start;
        if last <= (*start).last {
    ...
    R_StoreWallRange((*start).last + 1 as libc::c_int, last);
}
#[no_mangle]
pub unsafe extern "C" fn R_ClearClipSegs() {
    solidsegs[0 as libc::c_int as usize].first = -(0x7fffffff as libc::c_int);
    solidsegs[0 as libc::c_int as usize].last = -(1 as libc::c_int);
    solidsegs[1 as libc::c_int as usize].first = viewwidth;
    solidsegs[1 as libc::c_int as usize].last = 0x7fffffff as libc::c_int;
    newend = solidsegs.as_mut_ptr().offset(2 as libc::c_int as isize);
}
#[no_mangle]
pub unsafe extern "C" fn R_PortalClearClipSegs(mut start: int32_t, mut end: int32_t) {
    solidsegs[0 as libc::c_int as usize].first = -(0x7fffffff as libc::c_int);
    solidsegs[0 as libc::c_int as usize].last = start - 1 as libc::c_int;
    solidsegs[1 as libc::c_int as usize].first = end;
    solidsegs[1 as libc::c_int as usize].last = 0x7fffffff as libc::c_int;
    newend = solidsegs.as_mut_ptr().offset(2 as libc::c_int as isize);
}
unsafe extern "C" fn R_DoorClosed() -> int32_t {
    return ((*backsector).ceilingheight <= (*backsector).floorheight
        && ((*backsector).ceilingheight >= (*frontsector).ceilingheight
            || (*(*curline).sidedef).toptexture != 0)
        && ((*backsector).floorheight <= (*frontsector).floorheight
            || (*(*curline).sidedef).bottomtexture != 0)) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_FakeFlat(
    mut sec: *mut sector_t,
    mut tempsec: *mut sector_t,
    mut floorlightlevel: *mut int32_t,
    mut ceilinglightlevel: *mut int32_t,
    mut back: boolean,
) -> *mut sector_t {
    if !floorlightlevel.is_null() {
        *floorlightlevel = if (*sec).floorlightsec == -(1 as libc::c_int) {
            if (*sec).floorlightabsolute != 0 {
                (*sec).floorlightlevel as libc::c_int
            } else if 0 as libc::c_int
                > (if (255 as libc::c_int)
                    < (*sec).lightlevel as libc::c_int
                        + (*sec).floorlightlevel as libc::c_int
                {
                    255 as libc::c_int
                } else {
                    ...
                    + (*sec).floorlightlevel as libc::c_int
            {
                ...
                (*sec).lightlevel as libc::c_int + (*sec).floorlightlevel as libc::c_int
            }
        } else {
            (*sectors.offset((*sec).floorlightsec as isize)).lightlevel as libc::c_int
        };
    }
    if !ceilinglightlevel.is_null() {
        *ceilinglightlevel = if (*sec).ceilinglightsec == -(1 as libc::c_int) {
            if (*sec).ceilinglightabsolute != 0 {
                (*sec).ceilinglightlevel as libc::c_int
            } else if 0 as libc::c_int
                > (if (255 as libc::c_int)
                    < (*sec).lightlevel as libc::c_int
                        + (*sec).ceilinglightlevel as libc::c_int
            ...
            (*sectors.offset((*sec).ceilinglightsec as isize)).lightlevel as libc::c_int
        };
    }
    if ((*sec).extra_colormap).is_null() && (*sec).heightsec != -(1 as libc::c_int) {
        let mut s: *const sector_t = &mut *sectors.offset((*sec).heightsec as isize)
            as *mut sector_t;
        let mut viewmobj: *mut mobj_t = (*viewplayer).mo;
        let mut heightsec: int32_t = 0;
        let mut underwater: boolean = 0;
        if splitscreen != 0
            && viewplayer
        ...
        } else if !viewmobj.is_null() {
            heightsec = (*(*R_PointInSubsector((*viewmobj).x, (*viewmobj).y)).sector)
                .heightsec;
        } else {
            return sec
        }
        underwater = (heightsec != -(1 as libc::c_int)
            && viewz <= (*sectors.offset(heightsec as isize)).floorheight)
            as libc::c_int;
        *tempsec = *sec;
        ...
        if underwater != 0
            && {
                ...
                (*tempsec).ceilingheight = (*s).floorheight - 1 as libc::c_int;
                back == 0
            } || viewz <= (*s).floorheight
        {
            ...
            if underwater != 0 {
                if (*s).ceilingpic == skyflatnum {
                    (*tempsec).floorheight = (*tempsec).ceilingheight + 1 as libc::c_int;
            ...
            if !floorlightlevel.is_null() {
                *floorlightlevel = if (*s).floorlightsec == -(1 as libc::c_int) {
                    if (*s).floorlightabsolute != 0 {
                        (*s).floorlightlevel as libc::c_int
                    } else if 0 as libc::c_int
                        > (if (255 as libc::c_int)
                            < (*s).lightlevel as libc::c_int
                                + (*s).floorlightlevel as libc::c_int
                        {
                            255 as libc::c_int
                        } else {
                    ...
                    (*sectors.offset((*s).floorlightsec as isize)).lightlevel
                        as libc::c_int
                };
            }
            if !ceilinglightlevel.is_null() {
                *ceilinglightlevel = if (*s).ceilinglightsec == -(1 as libc::c_int) {
                    if (*s).ceilinglightabsolute != 0 {
                        (*s).ceilinglightlevel as libc::c_int
                    } else if 0 as libc::c_int
                        > (if (255 as libc::c_int)
                            < (*s).lightlevel as libc::c_int
                                + (*s).ceilinglightlevel as libc::c_int
                    ...
                    (*sectors.offset((*s).ceilinglightsec as isize)).lightlevel
                        as libc::c_int
                };
            }
        } else if heightsec != -(1 as libc::c_int)
            && viewz >= (*sectors.offset(heightsec as isize)).ceilingheight
            && (*sec).ceilingheight > (*s).ceilingheight
        {
            (*tempsec).ceilingheight = (*s).ceilingheight;
            (*tempsec).floorheight = (*s).ceilingheight + 1 as libc::c_int;
            (*tempsec).ceilingpic = (*s).ceilingpic;
            ...
            if (*s).floorpic == skyflatnum {
                (*tempsec).ceilingheight = (*tempsec).floorheight - 1 as libc::c_int;
                (*tempsec).floorpic = (*tempsec).ceilingpic;
                (*tempsec).floorxoffset = (*tempsec).ceilingxoffset;
                (*tempsec).flooryoffset = (*tempsec).ceilingyoffset;
                (*tempsec).floorangle = (*tempsec).ceilingangle;
...
#[no_mangle]
pub unsafe extern "C" fn R_IsEmptyLine(
    mut line: *mut seg_t,
    mut front: *mut sector_t,
    mut back: *mut sector_t,
) -> boolean {
    return (((*line).polyseg).is_null() && (*back).ceilingpic == (*front).ceilingpic
        && (*back).floorpic == (*front).floorpic && (*back).f_slope == (*front).f_slope
        && (*back).c_slope == (*front).c_slope
        && (*back).lightlevel as libc::c_int == (*front).lightlevel as libc::c_int
        ...
        && (*back).floorlightlevel as libc::c_int
            == (*front).floorlightlevel as libc::c_int
        && (*back).floorlightabsolute == (*front).floorlightabsolute
        && (*back).ceilinglightlevel as libc::c_int
            == (*front).ceilinglightlevel as libc::c_int
        ...
        && (((*front).ffloors).is_null() && ((*back).ffloors).is_null()
            || Tag_Compare(&mut (*front).tags, &mut (*back).tags) != 0)) as libc::c_int;
}
unsafe extern "C" fn R_AddLine(mut line: *mut seg_t) {
    let mut current_block: u64;
    ...
    static mut tempsec: sector_t = sector_s {
        floorheight: 0,
        ceilingheight: 0,
        floorpic: 0,
        ceilingpic: 0,
        ...
        special: 0,
        tags: taglist_t {
            tags: 0 as *const mtag_t as *mut mtag_t,
            count: 0,
        },
        ...
        validcount: 0,
        thinglist: 0 as *const mobj_t as *mut mobj_t,
        floordata: 0 as *const libc::c_void as *mut libc::c_void,
        ceilingdata: 0 as *const libc::c_void as *mut libc::c_void,
        lightingdata: 0 as *const libc::c_void as *mut libc::c_void,
        fadecolormapdata: 0 as *const libc::c_void as *mut libc::c_void,
        floorxoffset: 0,
        flooryoffset: 0,
        ceilingxoffset: 0,
        ceilingyoffset: 0,
        ...
        ceilinglightsec: 0,
        crumblestate: 0,
        touching_thinglist: 0 as *const msecnode_s as *mut msecnode_s,
        linecount: 0,
        lines: 0 as *const *mut line_s as *mut *mut line_s,
        ffloors: 0 as *const ffloor_t as *mut ffloor_t,
        attached: 0 as *const size_t as *mut size_t,
        attachedsolid: 0 as *const boolean as *mut boolean,
        numattached: 0,
        maxattached: 0,
        lightlist: 0 as *const lightlist_t as *mut lightlist_t,
        numlights: 0,
        moved: 0,
        extra_colormap: 0 as *const extracolormap_t as *mut extracolormap_t,
        colormap_protected: 0,
        gravity: 0,
        gravityptr: 0 as *const fixed_t as *mut fixed_t,
        ...
        triggerer: 0,
        friction: 0,
        cullheight: 0 as *const line_s as *mut line_s,
        floorspeed: 0,
        ceilspeed: 0,
        preciplist: 0 as *const precipmobj_t as *mut precipmobj_t,
        touching_preciplist: 0 as *const mprecipsecnode_s as *mut mprecipsecnode_s,
        f_slope: 0 as *const pslope_t as *mut pslope_t,
        c_slope: 0 as *const pslope_t as *mut pslope_t,
        hasslope: 0,
        spawn_lightlevel: 0,
        spawn_extra_colormap: 0 as *const extracolormap_t as *mut extracolormap_t,
    };
    let mut bothceilingssky: boolean = false_0 as libc::c_int;
    let mut bothfloorssky: boolean = false_0 as libc::c_int;
    portalline = false_0 as libc::c_int;
    if !((*line).polyseg).is_null()
        && (*(*line).polyseg).flags & POF_RENDERSIDES as libc::c_int == 0
    {
        return;
    }
    angle1 = R_PointToAngle64((*(*line).v1).x as int64_t, (*(*line).v1).y as int64_t);
    angle2 = R_PointToAngle64((*(*line).v2).x as int64_t, (*(*line).v2).y as int64_t);
    curline = line;
    span = angle1.wrapping_sub(angle2);
    if span >= 0x80000000 as libc::c_uint {
        return;
    }
    rw_angle1 = angle1;
    ...
    if tspan > doubleclipangle {
        tspan = tspan.wrapping_sub(doubleclipangle);
        if tspan >= span {
            return;
        }
        angle1 = clipangle;
    ...
    if tspan > doubleclipangle {
        ...
        angle2 = -(clipangle as libc::c_int) as angle_t;
    }
    angle1 = angle1.wrapping_add(0x40000000 as libc::c_int as angle_t)
        >> 19 as libc::c_int;
    angle2 = angle2.wrapping_add(0x40000000 as libc::c_int as angle_t)
        >> 19 as libc::c_int;
    ...
    if (*(*line).linedef).special as libc::c_int == 40 as libc::c_int
        && (*line).side == 0 as libc::c_int
    {
        if (portalrender as libc::c_int) < cv_maxportals.value {
            let mut p: size_t = 0;
            let mut tag: mtag_t = Tag_FGet(&mut (*(*line).linedef).tags);
            let mut li1: int32_t = ((*line).linedef).offset_from(lines) as libc::c_long
                as int32_t;
            let mut li2: int32_t = 0;
            p = 0 as libc::c_int as size_t;
            loop {
                li2 = Tag_Iterate_Lines(tag, p);
                if !(li2 >= 0 as libc::c_int) {
                    current_block = 2891135413264362348;
                    break;
                }
                if tag as libc::c_int
                    != Tag_FGet(&mut (*lines.offset(li2 as isize)).tags) as libc::c_int
                    || (*lines.offset(li1 as isize)).special as libc::c_int
                        != (*lines.offset(li2 as isize)).special as libc::c_int
                    || li1 == li2
                {
                    p = p.wrapping_add(1);
                    p;
                    ...
                    current_block = 6824275918783123292;
                    break;
                }
            }
        } else {
        ...
        2891135413264362348 => {
            if !backsector.is_null() {
                ...
                if bothceilingssky != 0 && bothfloorssky != 0 {
                    if ((*line).polyseg).is_null() && (*(*line).sidedef).midtexture == 0
                        && (((*frontsector).ffloors).is_null()
                            && ((*backsector).ffloors).is_null()
                            || Tag_Compare(
                                &mut (*frontsector).tags,
                                &mut (*backsector).tags,
                            ) != 0)
                    {
                        return;
                    }
                    current_block = 5648667862719434053;
                } else {
                    if !((*frontsector).f_slope).is_null()
                        || !((*frontsector).c_slope).is_null()
                        || !((*backsector).f_slope).is_null()
                        || !((*backsector).c_slope).is_null()
                    {
                        let mut frontf1: fixed_t = 0;
                        let mut frontf2: fixed_t = 0;
                        let mut frontc1: fixed_t = 0;
                        let mut frontc2: fixed_t = 0;
                        let mut backf1: fixed_t = 0;
                        let mut backf2: fixed_t = 0;
                        let mut backc1: fixed_t = 0;
                        let mut backc2: fixed_t = 0;
                        frontf1 = P_GetZAt(
                            (*frontsector).f_slope,
                            (*(*line).v1).x,
                            (*(*line).v1).y,
                    ...
                    match current_block {
                        ...
                        6824275918783123292 => {}
                        _ => {
                            if R_IsEmptyLine(line, frontsector, backsector) != 0 {
                                return;
                            }
                            current_block = 5648667862719434053;
                        }
                ...
                match current_block {
                    6824275918783123292 => {}
                    _ => {
                        R_ClipPassWallSegment(x1, x2 - 1 as libc::c_int);
                        return;
                    }
                }
            }
    ...
    R_ClipSolidWallSegment(x1, x2 - 1 as libc::c_int);
}
#[no_mangle]
pub static mut checkcoord: [[int32_t; 4]; 12] = [
    [3 as libc::c_int, 0 as libc::c_int, 2 as libc::c_int, 1 as libc::c_int],
    [3 as libc::c_int, 0 as libc::c_int, 2 as libc::c_int, 0 as libc::c_int],
    [3 as libc::c_int, 1 as libc::c_int, 2 as libc::c_int, 0 as libc::c_int],
    [0 as libc::c_int, 0, 0, 0],
    [2 as libc::c_int, 0 as libc::c_int, 2 as libc::c_int, 1 as libc::c_int],
    [0 as libc::c_int, 0, 0, 0],
    [3 as libc::c_int, 1 as libc::c_int, 3 as libc::c_int, 0 as libc::c_int],
    [0 as libc::c_int, 0, 0, 0],
    [2 as libc::c_int, 0 as libc::c_int, 3 as libc::c_int, 1 as libc::c_int],
    [2 as libc::c_int, 1 as libc::c_int, 3 as libc::c_int, 1 as libc::c_int],
    [2 as libc::c_int, 1 as libc::c_int, 3 as libc::c_int, 0 as libc::c_int],
    [0; 4],
];
unsafe extern "C" fn R_CheckBBox(mut bspcoord: *const fixed_t) -> boolean {
    let mut angle1: angle_t = 0;
    let mut angle2: angle_t = 0;
    let mut sx1: int32_t = 0;
    let mut sx2: int32_t = 0;
    let mut boxpos: int32_t = 0;
    let mut check: *const int32_t = 0 as *const int32_t;
    let mut start: *mut cliprange_t = 0 as *mut cliprange_t;
    boxpos = (if viewx <= *bspcoord.offset(BOXLEFT as libc::c_int as isize) {
        0 as libc::c_int
    } else {
        (if viewx < *bspcoord.offset(BOXRIGHT as libc::c_int as isize) {
            1 as libc::c_int
        } else {
            2 as libc::c_int
        })
    })
        + (if viewy >= *bspcoord.offset(BOXTOP as libc::c_int as isize) {
            0 as libc::c_int
        } else {
            (if viewy > *bspcoord.offset(BOXBOTTOM as libc::c_int as isize) {
                4 as libc::c_int
            } else {
                8 as libc::c_int
            })
        });
    if boxpos == 5 as libc::c_int {
        return true_0 as libc::c_int;
    }
    check = (checkcoord[boxpos as usize]).as_mut_ptr();
    angle1 = (R_PointToAngle64(
        *bspcoord.offset(*check.offset(0 as libc::c_int as isize) as isize) as int64_t,
        *bspcoord.offset(*check.offset(1 as libc::c_int as isize) as isize) as int64_t,
    ))
        .wrapping_sub(viewangle);
    angle2 = (R_PointToAngle64(
        *bspcoord.offset(*check.offset(2 as libc::c_int as isize) as isize) as int64_t,
        *bspcoord.offset(*check.offset(3 as libc::c_int as isize) as isize) as int64_t,
    ))
        .wrapping_sub(viewangle);
    if (angle1 as libc::c_int) < angle2 as libc::c_int {
        if angle1 >= 0x80000000 as libc::c_uint && angle1 < 0xc0000000 as libc::c_uint {
            angle1 = (0x80000000 as libc::c_uint)
                .wrapping_sub(1 as libc::c_int as libc::c_uint);
        } else {
            angle2 = 0x80000000 as libc::c_uint;
        }
    }
    if angle2 as libc::c_int >= clipangle as libc::c_int {
        return false_0 as libc::c_int;
    }
    if angle1 as libc::c_int <= -(clipangle as libc::c_int) {
        return false_0 as libc::c_int;
    }
    if angle1 as libc::c_int >= clipangle as libc::c_int {
        angle1 = clipangle;
    ...
    if angle2 as libc::c_int <= -(clipangle as libc::c_int) {
        angle2 = (0 as libc::c_int as angle_t).wrapping_sub(clipangle);
    }
    angle1 = angle1.wrapping_add(0x40000000 as libc::c_int as angle_t)
        >> 19 as libc::c_int;
    angle2 = angle2.wrapping_add(0x40000000 as libc::c_int as angle_t)
...
#[no_mangle]
pub static mut numpolys: size_t = 0;
#[no_mangle]
pub static mut num_po_ptrs: size_t = 0;
#[no_mangle]
pub static mut po_ptrs: *mut *mut polyobj_t = 0 as *const *mut polyobj_t
    as *mut *mut polyobj_t;
unsafe extern "C" fn R_PolyobjCompare(
    mut p1: *const libc::c_void,
    mut p2: *const libc::c_void,
) -> libc::c_int {
    let mut po1: *const polyobj_t = *(p1 as *const *const polyobj_t);
    let mut po2: *const polyobj_t = *(p2 as *const *const polyobj_t);
    return (*po1).zdist - (*po2).zdist;
}
#[no_mangle]
pub unsafe extern "C" fn R_SortPolyObjects(mut sub: *mut subsector_t) {
    if numpolys != 0 {
        let mut po: *mut polyobj_t = 0 as *mut polyobj_t;
        let mut i: int32_t = 0 as libc::c_int;
        if num_po_ptrs < numpolys * 2 as libc::c_int as size_t {
            free(po_ptrs as *mut libc::c_void);
            num_po_ptrs = numpolys * 2 as libc::c_int as size_t;
            po_ptrs = malloc(
                num_po_ptrs
                    .wrapping_mul(
                        ::core::mem::size_of::<*mut polyobj_t>() as libc::c_ulong,
                    ),
            ) as *mut *mut polyobj_t;
        }
        po = (*sub).polyList;
        while !po.is_null() {
            ...
            let fresh1 = i;
            i = i + 1;
            let ref mut fresh2 = *po_ptrs.offset(fresh1 as isize);
            *fresh2 = po;
            po = (*po).link.next as *mut polyobj_t;
        }
        if numpolys >= 2 as libc::c_int as size_t {
            qsort(
                po_ptrs as *mut libc::c_void,
                numpolys,
                ::core::mem::size_of::<*mut polyobj_t>() as libc::c_ulong,
                Some(
                    R_PolyobjCompare
...
unsafe extern "C" fn R_PolysegCompare(
    mut p1: *const libc::c_void,
    mut p2: *const libc::c_void,
) -> libc::c_int {
    let mut seg1: *const seg_t = *(p1 as *const *const seg_t);
    let mut seg2: *const seg_t = *(p2 as *const *const seg_t);
    let mut dist1v1: fixed_t = 0;
    let mut dist1v2: fixed_t = 0;
    let mut dist2v1: fixed_t = 0;
    let mut dist2v2: fixed_t = 0;
    dist1v1 = FixedMul(
        R_PointToDist((*(*seg1).v1).x, (*(*seg1).v1).y),
        *finecosine
            .offset(
                ((R_PointToAngle((*(*seg1).v1).x, (*(*seg1).v1).y))
                    .wrapping_sub(viewangle) >> 19 as libc::c_int) as isize,
            ) >> 16 as libc::c_int - 16 as libc::c_int,
    ) + 0xfffffff as libc::c_int;
    dist1v2 = FixedMul(
        R_PointToDist((*(*seg1).v2).x, (*(*seg1).v2).y),
        *finecosine
            .offset(
                ((R_PointToAngle((*(*seg1).v2).x, (*(*seg1).v2).y))
                    .wrapping_sub(viewangle) >> 19 as libc::c_int) as isize,
            ) >> 16 as libc::c_int - 16 as libc::c_int,
    ) + 0xfffffff as libc::c_int;
    dist2v1 = FixedMul(
        R_PointToDist((*(*seg2).v1).x, (*(*seg2).v1).y),
        *finecosine
            .offset(
                ((R_PointToAngle((*(*seg2).v1).x, (*(*seg2).v1).y))
                    .wrapping_sub(viewangle) >> 19 as libc::c_int) as isize,
            ) >> 16 as libc::c_int - 16 as libc::c_int,
    ) + 0xfffffff as libc::c_int;
    dist2v2 = FixedMul(
        R_PointToDist((*(*seg2).v2).x, (*(*seg2).v2).y),
        *finecosine
            .offset(
                ((R_PointToAngle((*(*seg2).v2).x, (*(*seg2).v2).y))
                    .wrapping_sub(viewangle) >> 19 as libc::c_int) as isize,
            ) >> 16 as libc::c_int - 16 as libc::c_int,
    ) + 0xfffffff as libc::c_int;
    if (if dist1v1 < dist1v2 { dist1v1 } else { dist1v2 })
        != (if dist2v1 < dist2v2 { dist2v1 } else { dist2v2 })
    {
        return (if dist1v1 < dist1v2 { dist1v1 } else { dist1v2 })
            - (if dist2v1 < dist2v2 { dist2v1 } else { dist2v2 });
    }
    ...
    let mut near1: *mut vertex_t = 0 as *mut vertex_t;
    let mut near2: *mut vertex_t = 0 as *mut vertex_t;
    let mut far1: *mut vertex_t = 0 as *mut vertex_t;
    let mut far2: *mut vertex_t = 0 as *mut vertex_t;
    delta1 = R_PointToDist2(
        (*(*seg1).v1).x,
        (*(*seg1).v1).y,
        (*(*seg1).v2).x,
        (*(*seg1).v2).y,
    );
    delta2 = R_PointToDist2(
        (*(*seg2).v1).x,
        (*(*seg2).v1).y,
        (*(*seg2).v2).x,
        (*(*seg2).v2).y,
    );
    delta1 = FixedDiv((128 as libc::c_int) << 16 as libc::c_int, delta1);
    delta2 = FixedDiv((128 as libc::c_int) << 16 as libc::c_int, delta2);
    if dist1v1 < dist1v2 {
        near1 = (*seg1).v1;
        far1 = (*seg1).v2;
    } else {
    ...
    return FixedMul(
        ...
        *finecosine
            .offset(
                ((R_PointToAngle(x1, y1)).wrapping_sub(viewangle) >> 19 as libc::c_int)
                    as isize,
            ) >> 16 as libc::c_int - 16 as libc::c_int,
    ) + 0xfffffff as libc::c_int
        - (FixedMul(
            ...
            *finecosine
                .offset(
                    ((R_PointToAngle(x2, y2)).wrapping_sub(viewangle)
                        >> 19 as libc::c_int) as isize,
                ) >> 16 as libc::c_int - 16 as libc::c_int,
        ) + 0xfffffff as libc::c_int);
}
unsafe extern "C" fn R_AddPolyObjects(mut sub: *mut subsector_t) {
    let mut po: *mut polyobj_t = (*sub).polyList;
    let mut i: size_t = 0;
    let mut j: size_t = 0;
    numpolys = 0 as libc::c_int as size_t;
    while !po.is_null() {
        numpolys = numpolys.wrapping_add(1);
        numpolys;
        po = (*po).link.next as *mut polyobj_t;
    }
    ps_numpolyobjects
        .value
        .i = (ps_numpolyobjects.value.i as size_t).wrapping_add(numpolys) as int32_t
        as int32_t;
    R_SortPolyObjects(sub);
    i = 0 as libc::c_int as size_t;
    while i < numpolys {
        qsort(
            (**po_ptrs.offset(i as isize)).segs as *mut libc::c_void,
            (**po_ptrs.offset(i as isize)).segCount,
            ::core::mem::size_of::<*mut seg_t>() as libc::c_ulong,
            Some(
                R_PolysegCompare
                    as unsafe extern "C" fn(
                        *const libc::c_void,
        ...
        while j < (**po_ptrs.offset(i as isize)).segCount {
            R_AddLine(*((**po_ptrs.offset(i as isize)).segs).offset(j as isize));
            j = j.wrapping_add(1);
            j;
        }
        i = i.wrapping_add(1);
...
#[no_mangle]
pub static mut firstseg: *mut drawseg_t = 0 as *const drawseg_t as *mut drawseg_t;
unsafe extern "C" fn R_Subsector(mut num: size_t) {
    let mut count: int32_t = 0;
    let mut floorlightlevel: int32_t = 0;
    let mut ceilinglightlevel: int32_t = 0;
    let mut light: int32_t = 0;
    let mut line: *mut seg_t = 0 as *mut seg_t;
    let mut sub: *mut subsector_t = 0 as *mut subsector_t;
    static mut tempsec: sector_t = sector_s {
        floorheight: 0,
        ceilingheight: 0,
        floorpic: 0,
    ...
    let mut floorcolormap: *mut extracolormap_t = 0 as *mut extracolormap_t;
    let mut ceilingcolormap: *mut extracolormap_t = 0 as *mut extracolormap_t;
    let mut floorcenterz: fixed_t = 0;
    let mut ceilingcenterz: fixed_t = 0;
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    if num >= numsubsectors {
        return;
    }
    sub = &mut *subsectors.offset(num as isize) as *mut subsector_t;
    frontsector = (*sub).sector;
    count = (*sub).numlines as int32_t;
    line = &mut *segs.offset((*sub).firstline as isize) as *mut seg_t;
    frontsector = R_FakeFlat(
        frontsector,
        &mut tempsec,
        &mut floorlightlevel,
        &mut ceilinglightlevel,
        false_0 as libc::c_int,
    );
    ceilingcolormap = (*frontsector).extra_colormap;
    floorcolormap = ceilingcolormap;
    floorcenterz = P_GetSectorFloorZAt(
        frontsector,
        (*frontsector).soundorg.x,
        (*frontsector).soundorg.y,
    );
    ceilingcenterz = P_GetSectorCeilingZAt(
        frontsector,
        (*frontsector).soundorg.x,
        (*frontsector).soundorg.y,
    );
    if !((*frontsector).ffloors).is_null() {
        let mut anyMoved: boolean = (*frontsector).moved;
        if anyMoved == false_0 as libc::c_int {
            rover = (*frontsector).ffloors;
            while !rover.is_null() {
                let mut controlSec: *mut sector_t = &mut *sectors
                    .offset((*rover).secnum as isize) as *mut sector_t;
                if (*controlSec).moved == true_0 as libc::c_int {
                    anyMoved = true_0 as libc::c_int;
                    break;
                } else {
                    rover = (*rover).next;
                }
        ...
        if anyMoved == true_0 as libc::c_int {
            (*(*sub).sector).numlights = 0 as libc::c_int;
            (*frontsector).numlights = (*(*sub).sector).numlights;
            R_Prep3DFloors(frontsector);
            (*(*sub).sector).lightlist = (*frontsector).lightlist;
            (*(*sub).sector).numlights = (*frontsector).numlights;
            (*frontsector).moved = false_0 as libc::c_int;
            (*(*sub).sector).moved = (*frontsector).moved;
        }
        light = R_GetPlaneLight(frontsector, floorcenterz, false_0 as libc::c_int);
        if (*frontsector).floorlightsec == -(1 as libc::c_int)
            && (*frontsector).floorlightabsolute == 0
        {
            floorlightlevel = if 0 as libc::c_int
                > (if (255 as libc::c_int)
                    < *(*((*frontsector).lightlist).offset(light as isize)).lightlevel
                        as libc::c_int + (*frontsector).floorlightlevel as libc::c_int
                {
                    255 as libc::c_int
                } else {
                    *(*((*frontsector).lightlist).offset(light as isize)).lightlevel
        ...
        floorcolormap = *(*((*frontsector).lightlist).offset(light as isize))
            .extra_colormap;
        light = R_GetPlaneLight(frontsector, ceilingcenterz, false_0 as libc::c_int);
        if (*frontsector).ceilinglightsec == -(1 as libc::c_int)
            && (*frontsector).ceilinglightabsolute == 0
        {
            ceilinglightlevel = if 0 as libc::c_int
                > (if (255 as libc::c_int)
                    < *(*((*frontsector).lightlist).offset(light as isize)).lightlevel
                        as libc::c_int + (*frontsector).ceilinglightlevel as libc::c_int
                {
                    255 as libc::c_int
                } else {
                    *(*((*frontsector).lightlist).offset(light as isize)).lightlevel
        ...
        ceilingcolormap = *(*((*frontsector).lightlist).offset(light as isize))
            .extra_colormap;
    }
    ...
    if P_GetSectorFloorZAt(frontsector, viewx, viewy) < viewz
        ...
        || (*frontsector).heightsec != -(1 as libc::c_int)
            && (*sectors.offset((*frontsector).heightsec as isize)).ceilingpic
                == skyflatnum
    {
        floorplane = R_FindPlane(
            ...
            floorlightlevel,
            (*frontsector).floorxoffset,
            (*frontsector).flooryoffset,
            (*frontsector).floorangle,
            floorcolormap,
            0 as *mut ffloor_t,
            0 as *mut polyobj_t,
            (*frontsector).f_slope,
        ...
        floorplane = 0 as *mut visplane_t;
    }
    if P_GetSectorCeilingZAt(frontsector, viewx, viewy) > viewz
        || (*frontsector).ceilingpic == skyflatnum
        || (*frontsector).heightsec != -(1 as libc::c_int)
            && (*sectors.offset((*frontsector).heightsec as isize)).floorpic
                == skyflatnum
    {
        ceilingplane = R_FindPlane(
            ...
            ceilinglightlevel,
            (*frontsector).ceilingxoffset,
            (*frontsector).ceilingyoffset,
            (*frontsector).ceilingangle,
            ceilingcolormap,
            0 as *mut ffloor_t,
            0 as *mut polyobj_t,
            (*frontsector).c_slope,
        ...
        ceilingplane = 0 as *mut visplane_t;
    }
    numffloors = 0 as libc::c_int;
    ffloor[numffloors as usize].slope = 0 as *mut pslope_s;
    ffloor[numffloors as usize].plane = 0 as *mut visplane_t;
    ffloor[numffloors as usize].polyobj = 0 as *mut polyobj_t;
    if !((*frontsector).ffloors).is_null() {
        let mut heightcheck: fixed_t = 0;
        let mut planecenterz: fixed_t = 0;
        let mut current_block_74: u64;
        rover = (*frontsector).ffloors;
        while !rover.is_null() && numffloors < 40 as libc::c_int {
            ...
            {
                if !((*frontsector).cullheight).is_null() {
                    if R_DoCulling(
                        (*frontsector).cullheight,
                    ...
                    ) != 0
                    {
                        ...
                        current_block_74 = 15090052786889560393;
                    } else {
                        current_block_74 = 16799951812150840583;
                    }
                } else {
                    current_block_74 = 16799951812150840583;
                }
                match current_block_74 {
                    ...
                    _ => {
                        ...
                        planecenterz = P_GetFFloorBottomZAt(
                            rover,
                            (*frontsector).soundorg.x,
                            (*frontsector).soundorg.y,
                        );
                        if planecenterz <= ceilingcenterz && planecenterz >= floorcenterz
                            && (viewz < heightcheck
                                && ((*rover).fofflags as libc::c_uint
                                ...
                                || viewz > heightcheck
                                    && ((*rover).fofflags as libc::c_uint
                                        ...
                                        || (*rover).fofflags as libc::c_uint
                                            & FOF_INVERTPLANES as libc::c_int as libc::c_uint != 0))
                        {
                            light = R_GetPlaneLight(
                                frontsector,
                                planecenterz,
                                (viewz < heightcheck) as libc::c_int,
                            );
                            ffloor[numffloors as usize]
                                .plane = R_FindPlane(
                                *(*rover).bottomheight,
                                *(*rover).bottompic,
                                *(*((*frontsector).lightlist).offset(light as isize))
                                    .lightlevel as int32_t,
                                *(*rover).bottomxoffs,
                                *(*rover).bottomyoffs,
                                *(*rover).bottomangle,
                                *(*((*frontsector).lightlist).offset(light as isize))
                            ...
                            ffloor[numffloors as usize].slope = *(*rover).b_slope;
                            if !(ffloor[numffloors as usize].slope).is_null() {
                                (*frontsector).hasslope = true_0 as libc::c_int;
                            }
                            ffloor[numffloors as usize].height = heightcheck;
                            ffloor[numffloors as usize].ffloor = rover;
                            numffloors += 1;
                            numffloors;
                        }
                        if numffloors >= 40 as libc::c_int {
                            break;
                        }
                        ffloor[numffloors as usize].plane = 0 as *mut visplane_t;
                        ffloor[numffloors as usize].polyobj = 0 as *mut polyobj_t;
                        heightcheck = P_GetFFloorTopZAt(rover, viewx, viewy);
                        planecenterz = P_GetFFloorTopZAt(
                            rover,
                            (*frontsector).soundorg.x,
                            (*frontsector).soundorg.y,
                        );
                        if planecenterz >= floorcenterz && planecenterz <= ceilingcenterz
                            && (viewz > heightcheck
                                && ((*rover).fofflags as libc::c_uint
                                    & FOF_BOTHPLANES as libc::c_int as libc::c_uint != 0
                                    || (*rover).fofflags as libc::c_uint
                                            ...
                                            & FOF_INVERTPLANES as libc::c_int as libc::c_uint != 0))
                        {
                            ...
                            ffloor[numffloors as usize].slope = *(*rover).t_slope;
                            if !(ffloor[numffloors as usize].slope).is_null() {
                                (*frontsector).hasslope = true_0 as libc::c_int;
                            }
                            ffloor[numffloors as usize].height = heightcheck;
            ...
            if (*po).flags & POF_RENDERPLANES as libc::c_int == 0 {
                    ...
                    && viewz < (*polysec).floorheight
                {
                    light = R_GetPlaneLight(
                        frontsector,
                        (*polysec).floorheight,
                        (viewz < (*polysec).floorheight) as libc::c_int,
                    );
                    ffloor[numffloors as usize]
                        .plane = R_FindPlane(
                        (*polysec).floorheight,
                        ...
                        if light == -(1 as libc::c_int) {
                            ...
                            *(*((*frontsector).lightlist).offset(light as isize))
                                .lightlevel as libc::c_int
                        },
                        (*polysec).floorxoffset,
                        (*polysec).flooryoffset,
                        ((*polysec).floorangle).wrapping_sub((*po).angle),
                        if light == -(1 as libc::c_int) {
                    ...
                    ffloor[numffloors as usize].height = (*polysec).floorheight;
                    ffloor[numffloors as usize].polyobj = po;
                    ffloor[numffloors as usize].slope = 0 as *mut pslope_s;
                    (*po).visplane = ffloor[numffloors as usize].plane;
                    numffloors += 1;
                    numffloors;
                }
                if numffloors >= 40 as libc::c_int {
                    ...
                    && viewz > (*polysec).ceilingheight
                {
                    ...
                    ffloor[numffloors as usize]
                        ...
                        (*polysec).ceilingxoffset,
                        (*polysec).ceilingyoffset,
                        ((*polysec).ceilingangle).wrapping_sub((*po).angle),
                        if light == -(1 as libc::c_int) {
                            (*frontsector).extra_colormap
                        } else {
                            *(*((*frontsector).lightlist).offset(light as isize))
                    ...
                    ffloor[numffloors as usize].polyobj = po;
                    ffloor[numffloors as usize].height = (*polysec).ceilingheight;
                    ffloor[numffloors as usize].slope = 0 as *mut pslope_s;
                    (*po).visplane = ffloor[numffloors as usize].plane;
                    numffloors += 1;
                    numffloors;
    ...
    R_AddSprites(
        (*sub).sector,
        (floorlightlevel + ceilinglightlevel) / 2 as libc::c_int,
    );
    firstseg = 0 as *mut drawseg_t;
    if !((*sub).polyList).is_null() {
    ...
    loop {
        ...
        if (*line).glseg == 0 && ((*line).polyseg).is_null() {
            R_AddLine(line);
        }
        line = line.offset(1);
        line;
        curline = 0 as *mut seg_t;
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_Prep3DFloors(mut sector: *mut sector_t) {
    let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut best: *mut ffloor_t = 0 as *mut ffloor_t;
    let mut bestheight: fixed_t = 0;
    let mut maxheight: fixed_t = 0;
    let mut count: int32_t = 0;
    let mut i: int32_t = 0;
    let mut sec: *mut sector_t = 0 as *mut sector_t;
    let mut bestslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut heighttest: fixed_t = 0;
    ...
    while !rover.is_null() {
        if (*rover).fofflags as libc::c_uint & FOF_EXISTS as libc::c_int as libc::c_uint
            ...
            && ((*rover).fofflags as libc::c_uint
                ...
                || (*rover).fofflags as libc::c_uint
                    & FOF_CUTSPRITES as libc::c_int as libc::c_uint != 0)
        {
            count += 1;
            count;
            if (*rover).fofflags as libc::c_uint
                & FOF_DOUBLESHADOW as libc::c_int as libc::c_uint != 0
            {
                count += 1;
                count;
            }
    ...
    if count != (*sector).numlights {
        Z_Free((*sector).lightlist as *mut libc::c_void);
        (*sector)
            .lightlist = Z_CallocAlign(
            (::core::mem::size_of::<lightlist_t>() as libc::c_ulong)
        ...
        memset(
            (*sector).lightlist as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<lightlist_t>() as libc::c_ulong)
                .wrapping_mul(count as libc::c_ulong),
        );
    }
    heighttest = P_GetSectorCeilingZAt(
        sector,
        (*sector).soundorg.x,
        (*sector).soundorg.y,
    );
    (*((*sector).lightlist).offset(0 as libc::c_int as isize))
        .height = heighttest + 1 as libc::c_int;
    let ref mut fresh4 = (*((*sector).lightlist).offset(0 as libc::c_int as isize))
        .slope;
    *fresh4 = (*sector).c_slope;
    let ref mut fresh5 = (*((*sector).lightlist).offset(0 as libc::c_int as isize))
        .lightlevel;
    *fresh5 = &mut (*sector).lightlevel;
    let ref mut fresh6 = (*((*sector).lightlist).offset(0 as libc::c_int as isize))
        .caster;
    *fresh6 = 0 as *mut ffloor_t;
    let ref mut fresh7 = (*((*sector).lightlist).offset(0 as libc::c_int as isize))
        .extra_colormap;
    *fresh7 = &mut (*sector).extra_colormap;
    (*((*sector).lightlist).offset(0 as libc::c_int as isize)).flags = 0 as libc::c_int;
    maxheight = 2147483647 as libc::c_int;
    i = 1 as libc::c_int;
    while i < count {
        bestheight = 2147483647 as libc::c_int * -(1 as libc::c_int);
        best = 0 as *mut ffloor_t;
        rover = (*sector).ffloors;
        while !rover.is_null() {
            (*rover).lastlight = 0 as libc::c_int;
            if !((*rover).fofflags as libc::c_uint
                & FOF_EXISTS as libc::c_int as libc::c_uint == 0
                || (*rover).fofflags as libc::c_uint
                    & FOF_NOSHADE as libc::c_int as libc::c_uint != 0
                        ...
                        & FOF_CUTSPRITES as libc::c_int as libc::c_uint == 0)
            {
                ...
                if heighttest > bestheight && heighttest < maxheight {
                    ...
                    & FOF_DOUBLESHADOW as libc::c_int as libc::c_uint != 0
                {
                    heighttest = P_GetFFloorBottomZAt(
                        rover,
                        (*sector).soundorg.x,
                        (*sector).soundorg.y,
                    );
        ...
        (*((*sector).lightlist).offset(i as isize)).height = maxheight;
        let ref mut fresh8 = (*((*sector).lightlist).offset(i as isize)).caster;
        *fresh8 = best;
        (*((*sector).lightlist).offset(i as isize)).flags = (*best).fofflags as int32_t;
        let ref mut fresh9 = (*((*sector).lightlist).offset(i as isize)).slope;
        *fresh9 = bestslope;
        sec = &mut *sectors.offset((*best).secnum as isize) as *mut sector_t;
        if (*best).fofflags as libc::c_uint & FOF_NOSHADE as libc::c_int as libc::c_uint
            != 0
        {
            let ref mut fresh10 = (*((*sector).lightlist).offset(i as isize)).lightlevel;
            *fresh10 = (*((*sector).lightlist).offset((i - 1 as libc::c_int) as isize))
                .lightlevel;
            let ref mut fresh11 = (*((*sector).lightlist).offset(i as isize))
                .extra_colormap;
            *fresh11 = (*((*sector).lightlist).offset((i - 1 as libc::c_int) as isize))
                .extra_colormap;
        } else if (*best).fofflags as libc::c_uint
            & FOF_COLORMAPONLY as libc::c_int as libc::c_uint != 0
        {
            let ref mut fresh12 = (*((*sector).lightlist).offset(i as isize)).lightlevel;
            *fresh12 = (*((*sector).lightlist).offset((i - 1 as libc::c_int) as isize))
                .lightlevel;
            let ref mut fresh13 = (*((*sector).lightlist).offset(i as isize))
                .extra_colormap;
            *fresh13 = &mut (*sec).extra_colormap;
        } else {
            let ref mut fresh14 = (*((*sector).lightlist).offset(i as isize)).lightlevel;
            *fresh14 = (*best).toplightlevel;
            let ref mut fresh15 = (*((*sector).lightlist).offset(i as isize))
                .extra_colormap;
            *fresh15 = &mut (*sec).extra_colormap;
        }
        if (*best).fofflags as libc::c_uint
            & FOF_DOUBLESHADOW as libc::c_int as libc::c_uint != 0
        {
            heighttest = P_GetFFloorBottomZAt(
                best,
            ...
            if bestheight == heighttest {
                let ref mut fresh16 = (*((*sector).lightlist).offset(i as isize))
                    .lightlevel;
                *fresh16 = (*((*sector).lightlist).offset((*best).lastlight as isize))
                    .lightlevel;
                let ref mut fresh17 = (*((*sector).lightlist).offset(i as isize))
                    .extra_colormap;
                *fresh17 = (*((*sector).lightlist).offset((*best).lastlight as isize))
                    .extra_colormap;
            } else {
                (*best).lastlight = i - 1 as libc::c_int;
            }
        }
        i += 1;
        i;
...
#[no_mangle]
pub unsafe extern "C" fn R_GetPlaneLight(
    mut sector: *mut sector_t,
    mut planeheight: fixed_t,
    mut underside: boolean,
) -> int32_t {
    let mut i: int32_t = 0;
    if underside == 0 {
        i = 1 as libc::c_int;
        while i < (*sector).numlights {
            if (*((*sector).lightlist).offset(i as isize)).height <= planeheight {
                return i - 1 as libc::c_int;
            }
            i += 1;
            i;
        }
        return (*sector).numlights - 1 as libc::c_int;
    }
    i = 1 as libc::c_int;
    while i < (*sector).numlights {
        if (*((*sector).lightlist).offset(i as isize)).height < planeheight {
...
#[no_mangle]
pub unsafe extern "C" fn R_RenderBSPNode(mut bspnum: int32_t) {
    let mut bsp: *mut node_t = 0 as *mut node_t;
    let mut side: int32_t = 0;
    ps_numbspcalls.value.i += 1;
    ps_numbspcalls.value.i;
    while bspnum & 0x8000 as libc::c_int == 0 {
        bsp = &mut *nodes.offset(bspnum as isize) as *mut node_t;
        side = R_PointOnSide(viewx, viewy, bsp);
        R_RenderBSPNode((*bsp).children[side as usize] as int32_t);
        if R_CheckBBox(((*bsp).bbox[(side ^ 1 as libc::c_int) as usize]).as_mut_ptr())
            == 0
        {
            return;
        }
        bspnum = (*bsp).children[(side ^ 1 as libc::c_int) as usize] as int32_t;
    }
    if !portalcullsector.is_null() {
        let mut sect: *mut sector_t = (*subsectors
            .offset((bspnum & !(0x8000 as libc::c_int)) as isize))
            .sector;
    ...
    R_Subsector(
        (if bspnum == -(1 as libc::c_int) {
            0 as libc::c_int
        } else {
            bspnum & !(0x8000 as libc::c_int)
        }) as size_t,
    );
}
