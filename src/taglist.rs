...
#[inline]
unsafe extern "C" fn unset_bit_array(array: *mut bitarray_t, value: libc::c_int) {
    let ref mut fresh1 = *array.offset((value >> 3 as libc::c_int) as isize);
    *fresh1 = (*fresh1 as libc::c_int
        & !((1 as libc::c_int) << (value & 7 as libc::c_int))) as bitarray_t;
}
#[no_mangle]
pub static mut tags_available: [bitarray_t; 8192] = [0; 8192];
#[no_mangle]
pub static mut num_tags: size_t = 0;
#[no_mangle]
pub static mut tags_sectors: [*mut taggroup_t; 65536] = [0 as *const taggroup_t
    as *mut taggroup_t; 65536];
#[no_mangle]
pub static mut tags_lines: [*mut taggroup_t; 65536] = [0 as *const taggroup_t
    as *mut taggroup_t; 65536];
#[no_mangle]
pub static mut tags_mapthings: [*mut taggroup_t; 65536] = [0 as *const taggroup_t
    as *mut taggroup_t; 65536];
#[no_mangle]
pub unsafe extern "C" fn Tag_Add(mut list: *mut taglist_t, tag: mtag_t) {
    ...
    (*list)
        ...
        (((*list).count as libc::c_int + 1 as libc::c_int) as libc::c_ulong)
    ...
    let fresh2 = (*list).count;
    (*list).count = ((*list).count).wrapping_add(1);
    *((*list).tags).offset(fresh2 as isize) = tag;
}
#[no_mangle]
pub unsafe extern "C" fn Tag_Remove(mut list: *mut taglist_t, tag: mtag_t) {
    let mut i: uint16_t = 0;
    i = 0 as libc::c_int as uint16_t;
    while (i as libc::c_int) < (*list).count as libc::c_int {
        if *((*list).tags).offset(i as isize) as libc::c_int != tag as libc::c_int {
            i = i.wrapping_add(1);
            i;
        } else {
            while (i as libc::c_int + 1 as libc::c_int) < (*list).count as libc::c_int {
                *((*list).tags)
                    .offset(
                        i as isize,
                    ) = *((*list).tags)
...
#[no_mangle]
pub unsafe extern "C" fn Tag_FSet(mut list: *mut taglist_t, tag: mtag_t) {
    if (*list).count == 0 {
        Tag_Add(list, tag);
        return;
    }
    *((*list).tags).offset(0 as libc::c_int as isize) = tag;
}
#[no_mangle]
pub unsafe extern "C" fn Tag_FGet(mut list: *const taglist_t) -> mtag_t {
    if (*list).count != 0 {
        return *((*list).tags).offset(0 as libc::c_int as isize);
    }
    return 0 as libc::c_int as mtag_t;
}
#[no_mangle]
pub unsafe extern "C" fn Tag_Find(mut list: *const taglist_t, tag: mtag_t) -> boolean {
    let mut i: size_t = 0;
...
#[no_mangle]
pub unsafe extern "C" fn Tag_Share(
    mut list1: *const taglist_t,
    mut list2: *const taglist_t,
) -> boolean {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < (*list1).count as size_t {
        if Tag_Find(list2, *((*list1).tags).offset(i as isize)) != 0 {
            return true_0 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn Tag_Compare(
    mut list1: *const taglist_t,
    mut list2: *const taglist_t,
) -> boolean {
    let mut i: size_t = 0;
    if (*list1).count as libc::c_int != (*list2).count as libc::c_int {
        return false_0 as libc::c_int;
    }
    i = 0 as libc::c_int as size_t;
    while i < (*list1).count as size_t {
        if *((*list1).tags).offset(i as isize) as libc::c_int
            != *((*list2).tags).offset(i as isize) as libc::c_int
        {
            return false_0 as libc::c_int;
        }
        i = i.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn Taggroup_Find(
    mut group: *const taggroup_t,
    id: size_t,
) -> size_t {
    let mut i: size_t = 0;
    if group.is_null() {
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*group).count {
        if *((*group).elements).offset(i as isize) == id {
            return i;
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn Taggroup_Count(mut group: *const taggroup_t) -> size_t {
    return if !group.is_null() { (*group).count } else { 0 as libc::c_int as size_t };
}
#[no_mangle]
pub unsafe extern "C" fn Taggroup_Iterate(
    mut garray: *mut *mut taggroup_t,
    max_elements: size_t,
    tag: mtag_t,
    p: size_t,
) -> int32_t {
    let mut group: *const taggroup_t = 0 as *const taggroup_t;
    ...
    group = *garray.offset(tag as uint16_t as isize);
    if !group.is_null() {
        if p < (*group).count {
            return *((*group).elements).offset(p as isize) as int32_t;
        }
        return -(1 as libc::c_int);
    }
    return -(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn Taggroup_Add(
    mut garray: *mut *mut taggroup_t,
    tag: mtag_t,
    mut id: size_t,
) {
    let mut group: *mut taggroup_t = 0 as *mut taggroup_t;
    let mut i: size_t = 0;
    if tag as libc::c_int == -(1 as libc::c_int) {
        return;
    }
    group = *garray.offset(tag as uint16_t as isize);
    if Taggroup_Find(group, id) != -(1 as libc::c_int) as size_t {
        return;
    }
    if in_bit_array(tags_available.as_mut_ptr(), tag as libc::c_int) == 0 {
        num_tags = num_tags.wrapping_add(1);
        num_tags;
        set_bit_array(tags_available.as_mut_ptr(), tag as libc::c_int);
    }
    if group.is_null() {
        i = 0 as libc::c_int as size_t;
        let ref mut fresh3 = *garray.offset(tag as uint16_t as isize);
        *fresh3 = Z_CallocAlign(
            ::core::mem::size_of::<taggroup_t>() as libc::c_ulong,
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut taggroup_t;
    ...
    (*group)
        .elements = Z_ReallocAlign(
        (*group).elements as *mut libc::c_void,
        ((*group).count)
    ...
    if i < (*group).count {
        memmove(
            ...
            &mut *((*group).elements).offset(i as isize) as *mut size_t
                as *const libc::c_void,
            ((*group).count).wrapping_sub(i),
        );
    }
    (*group).count = ((*group).count).wrapping_add(1);
    (*group).count;
    *((*group).elements).offset(i as isize) = id;
}
unsafe extern "C" fn Taggroup_Add_Init(
    mut garray: *mut *mut taggroup_t,
    tag: mtag_t,
    mut id: size_t,
) {
    ...
    if group.is_null() {
        let ref mut fresh4 = *garray.offset(tag as uint16_t as isize);
        *fresh4 = Z_CallocAlign(
        ...
        .offset(((*group).count).wrapping_sub(1 as libc::c_int as size_t) as isize) == id
    {
        return
    }
    (*group).count = ((*group).count).wrapping_add(1);
    ...
    if (*group).count > (*group).capacity {
        (*group).capacity = 2 as libc::c_int as size_t * (*group).count;
        (*group)
            .elements = Z_ReallocAlign(
            (*group).elements as *mut libc::c_void,
            ((*group).capacity)
...
unsafe extern "C" fn total_elements_with_tag(tag: mtag_t) -> size_t {
    return (Taggroup_Count(tags_sectors[tag as usize]))
        .wrapping_add(Taggroup_Count(tags_lines[tag as usize]))
        .wrapping_add(Taggroup_Count(tags_mapthings[tag as usize]));
}
#[no_mangle]
pub unsafe extern "C" fn Taggroup_Remove(
    mut garray: *mut *mut taggroup_t,
    tag: mtag_t,
    mut id: size_t,
) {
    let mut group: *mut taggroup_t = 0 as *mut taggroup_t;
    let mut rempos: size_t = 0;
    let mut oldcount: size_t = 0;
    if tag as libc::c_int == -(1 as libc::c_int) {
        return;
    }
    group = *garray.offset(tag as uint16_t as isize);
    rempos = Taggroup_Find(group, id);
    if rempos == -(1 as libc::c_int) as size_t {
        return;
    }
    if (*group).count == 1 as libc::c_int as size_t
        && total_elements_with_tag(tag) == 1 as libc::c_int as size_t
    {
        num_tags = num_tags.wrapping_sub(1);
        num_tags;
        unset_bit_array(tags_available.as_mut_ptr(), tag as libc::c_int);
    }
    let fresh5 = (*group).count;
    (*group).count = ((*group).count).wrapping_sub(1);
    oldcount = fresh5;
    if oldcount == 0 {
        Z_Free((*group).elements as *mut libc::c_void);
        Z_Free(group as *mut libc::c_void);
        let ref mut fresh6 = *garray.offset(tag as uint16_t as isize);
        *fresh6 = 0 as *mut taggroup_t;
    } else {
        let mut newelements: *mut size_t = Z_MallocAlign(
            ((*group).count)
                .wrapping_mul(::core::mem::size_of::<size_t>() as libc::c_ulong),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
        ...
        i = 0 as libc::c_int as size_t;
        while i < rempos {
            *newelements.offset(i as isize) = *((*group).elements).offset(i as isize);
            i = i.wrapping_add(1);
            i;
        }
        i = rempos.wrapping_add(1 as libc::c_int as size_t);
        while i < oldcount {
            *newelements
                .offset(
                    i.wrapping_sub(1 as libc::c_int as size_t) as isize,
                ) = *((*group).elements).offset(i as isize);
            i = i.wrapping_add(1);
            i;
        }
        Z_Free((*group).elements as *mut libc::c_void);
...
unsafe extern "C" fn Taglist_AddToSectors(tag: mtag_t, itemid: size_t) {
    Taggroup_Add_Init(tags_sectors.as_mut_ptr(), tag, itemid);
}
unsafe extern "C" fn Taglist_AddToLines(tag: mtag_t, itemid: size_t) {
    Taggroup_Add_Init(tags_lines.as_mut_ptr(), tag, itemid);
}
unsafe extern "C" fn Taglist_AddToMapthings(tag: mtag_t, itemid: size_t) {
    Taggroup_Add_Init(tags_mapthings.as_mut_ptr(), tag, itemid);
}
#[no_mangle]
pub unsafe extern "C" fn Taglist_InitGlobalTables() {
    let mut i: size_t = 0;
    let mut j: size_t = 0;
    memset(
        tags_available.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[bitarray_t; 8192]>() as libc::c_ulong,
    );
    num_tags = 0 as libc::c_int as size_t;
    i = 0 as libc::c_int as size_t;
    while i < 65535 as libc::c_int as size_t {
        tags_sectors[i as usize] = 0 as *mut taggroup_t;
        tags_lines[i as usize] = 0 as *mut taggroup_t;
        tags_mapthings[i as usize] = 0 as *mut taggroup_t;
        i = i.wrapping_add(1);
        i;
    }
    i = 0 as libc::c_int as size_t;
    while i < numsectors {
        ...
        while j < (*sectors.offset(i as isize)).tags.count as size_t {
            Taglist_AddToSectors(
                *((*sectors.offset(i as isize)).tags.tags).offset(j as isize),
                i,
            );
            j = j.wrapping_add(1);
            j;
    ...
    while i < numlines {
        j = 0 as libc::c_int as size_t;
        while j < (*lines.offset(i as isize)).tags.count as size_t {
            Taglist_AddToLines(
                *((*lines.offset(i as isize)).tags.tags).offset(j as isize),
                i,
            );
            j = j.wrapping_add(1);
            j;
    ...
    while i < nummapthings {
        j = 0 as libc::c_int as size_t;
        while j < (*mapthings.offset(i as isize)).tags.count as size_t {
            Taglist_AddToMapthings(
                *((*mapthings.offset(i as isize)).tags.tags).offset(j as isize),
                i,
            );
            j = j.wrapping_add(1);
            j;
...
#[no_mangle]
pub unsafe extern "C" fn Tag_Iterate_Sectors(tag: mtag_t, p: size_t) -> int32_t {
    return Taggroup_Iterate(tags_sectors.as_mut_ptr(), numsectors, tag, p);
}
#[no_mangle]
pub unsafe extern "C" fn Tag_Iterate_Lines(tag: mtag_t, p: size_t) -> int32_t {
    return Taggroup_Iterate(tags_lines.as_mut_ptr(), numlines, tag, p);
}
#[no_mangle]
pub unsafe extern "C" fn Tag_Iterate_Things(tag: mtag_t, p: size_t) -> int32_t {
    return Taggroup_Iterate(tags_mapthings.as_mut_ptr(), nummapthings, tag, p);
}
#[no_mangle]
pub unsafe extern "C" fn Tag_FindLineSpecial(special: int16_t, tag: mtag_t) -> int32_t {
    let mut i: size_t = 0;
    if tag as libc::c_int == -(1 as libc::c_int) {
        i = 0 as libc::c_int as size_t;
        while i < numlines {
            if (*lines.offset(i as isize)).special as libc::c_int
                == special as libc::c_int
            {
                return i as int32_t;
            }
            i = i.wrapping_add(1);
    ...
    } else if !(tags_lines[tag as uint16_t as usize]).is_null() {
        let mut tagged: *mut taggroup_t = tags_lines[tag as uint16_t as usize];
        i = 0 as libc::c_int as size_t;
        while i < (*tagged).count {
            if (*lines.offset(*((*tagged).elements).offset(i as isize) as isize)).special
                as libc::c_int == special as libc::c_int
            {
                return *((*tagged).elements).offset(i as isize) as int32_t;
            }
            i = i.wrapping_add(1);
            i;
        }
...
#[no_mangle]
pub unsafe extern "C" fn P_FindSpecialLineFromTag(
    mut special: int16_t,
    mut tag: int16_t,
    mut start: int32_t,
) -> int32_t {
    if tag as libc::c_int == -(1 as libc::c_int) {
        start += 1;
        start;
        if start >= numlines as int32_t {
            return -(1 as libc::c_int);
        }
        while start < numlines as int32_t
            && (*lines.offset(start as isize)).special as libc::c_int
                != special as libc::c_int
        {
            start += 1;
            start;
        ...
        let mut p: size_t = 0 as libc::c_int as size_t;
        let mut id: int32_t = 0;
        if start != -(1 as libc::c_int) {
            loop {
                id = Tag_Iterate_Lines(tag, p);
        ...
        loop {
            ...
            if (*lines.offset(id as isize)).special as libc::c_int
                == special as libc::c_int
            {
                return id;
            }
...
#[no_mangle]
pub unsafe extern "C" fn Tag_SectorAdd(id: size_t, tag: mtag_t) {
    let mut sec: *mut sector_t = &mut *sectors.offset(id as isize) as *mut sector_t;
    Tag_Add(&mut (*sec).tags, tag);
    Taggroup_Add(tags_sectors.as_mut_ptr(), tag, id);
}
#[no_mangle]
pub unsafe extern "C" fn Tag_SectorRemove(id: size_t, tag: mtag_t) {
    let mut sec: *mut sector_t = &mut *sectors.offset(id as isize) as *mut sector_t;
    Tag_Remove(&mut (*sec).tags, tag);
    Taggroup_Remove(tags_sectors.as_mut_ptr(), tag, id);
}
#[no_mangle]
pub unsafe extern "C" fn Tag_SectorFSet(id: size_t, tag: mtag_t) {
    let mut sec: *mut sector_t = &mut *sectors.offset(id as isize) as *mut sector_t;
    let mut curtag: mtag_t = Tag_FGet(&mut (*sec).tags);
    if curtag as libc::c_int == tag as libc::c_int {
        return;
    }
    Taggroup_Remove(tags_sectors.as_mut_ptr(), curtag, id);
    Taggroup_Add(tags_sectors.as_mut_ptr(), tag, id);
    Tag_FSet(&mut (*sec).tags, tag);
    if udmf == 0
        && (*sec).special as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn Tag_NextUnused(mut start: mtag_t) -> mtag_t {
    while (start as uint16_t as libc::c_int) < 65535 as libc::c_int {
        if in_bit_array(tags_available.as_mut_ptr(), start as uint16_t as libc::c_int)
            == 0
        {
            return start;
        }
    ...
    return 65535 as libc::c_int as mtag_t;
}
