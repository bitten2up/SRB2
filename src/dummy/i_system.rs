...
#[no_mangle]
pub static mut logstream: *mut FILE = 0 as *const FILE as *mut FILE;
#[no_mangle]
pub static mut graphics_started: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut keyboard_started: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub unsafe extern "C" fn I_GetFreeMem(mut total: *mut size_t) -> size_t {
    *total = 0 as libc::c_int as size_t;
    return 0 as libc::c_int as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn I_Sleep(mut ms: uint32_t) {}
#[no_mangle]
pub unsafe extern "C" fn I_GetPreciseTime() -> precise_t {
    return 0 as libc::c_int as precise_t;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetPrecisePrecision() -> uint64_t {
    return 1000000 as libc::c_int as uint64_t;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetEvent() {}
#[no_mangle]
pub unsafe extern "C" fn I_OsPolling() {}
#[no_mangle]
pub unsafe extern "C" fn I_BaseTiccmd() -> *mut ticcmd_t {
    return 0 as *mut ticcmd_t;
}
#[no_mangle]
pub unsafe extern "C" fn I_BaseTiccmd2() -> *mut ticcmd_t {
    return 0 as *mut ticcmd_t;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn I_Error(mut error: *const libc::c_char, mut args: ...) -> ! {
    exit(-(1 as libc::c_int));
}
#[no_mangle]
pub unsafe extern "C" fn I_Tactile(mut Type: FFType, mut Effect: *const JoyFF_t) {}
#[no_mangle]
pub unsafe extern "C" fn I_Tactile2(mut Type: FFType, mut Effect: *const JoyFF_t) {}
#[no_mangle]
pub unsafe extern "C" fn I_JoyScale() {}
#[no_mangle]
pub unsafe extern "C" fn I_JoyScale2() {}
#[no_mangle]
pub unsafe extern "C" fn I_InitJoystick() {}
#[no_mangle]
pub unsafe extern "C" fn I_InitJoystick2() {}
#[no_mangle]
pub unsafe extern "C" fn I_NumJoys() -> int32_t {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetJoyName(mut joyindex: int32_t) -> *const libc::c_char {
    return 0 as *const libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn I_UpdateMumble(mut mobj: *const mobj_t, listener: listener_t) {}
#[no_mangle]
pub unsafe extern "C" fn I_OutputMsg(mut error: *const libc::c_char, mut args: ...) {}
#[no_mangle]
pub unsafe extern "C" fn I_StartupMouse() {}
#[no_mangle]
pub unsafe extern "C" fn I_StartupMouse2() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetKey() -> int32_t {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn I_StartupTimer() {}
#[no_mangle]
pub unsafe extern "C" fn I_AddExitFunc(
    mut func: Option::<unsafe extern "C" fn() -> ()>,
) {}
#[no_mangle]
pub unsafe extern "C" fn I_RemoveExitFunc(
    mut func: Option::<unsafe extern "C" fn() -> ()>,
) {}
#[no_mangle]
pub unsafe extern "C" fn I_StartupSystem() -> int32_t {
    return -(1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn I_ShutdownSystem() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetDiskFreeSpace(mut freespace: *mut int64_t) {
    *freespace = 0 as libc::c_int as int64_t;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetUserName() -> *mut libc::c_char {
    return 0 as *mut libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn I_mkdir(
    mut dirname: *const libc::c_char,
    mut unixright: int32_t,
) -> int32_t {
    return -(1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn I_CPUInfo() -> *const CPUInfoFlags {
    return 0 as *const CPUInfoFlags;
}
#[no_mangle]
pub unsafe extern "C" fn I_LocateWad() -> *const libc::c_char {
    return 0 as *const libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetJoystickEvents() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetJoystick2Events() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetMouseEvents() {}
#[no_mangle]
pub unsafe extern "C" fn I_UpdateMouseGrab() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetEnv(mut name: *const libc::c_char) -> *mut libc::c_char {
    return 0 as *mut libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn I_PutEnv(mut variable: *mut libc::c_char) -> int32_t {
    return -(1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn I_ClipboardCopy(
...
#[no_mangle]
pub unsafe extern "C" fn I_ClipboardPaste() -> *const libc::c_char {
    return 0 as *const libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn I_GetRandomBytes(
...
#[no_mangle]
pub unsafe extern "C" fn I_RegisterSysCommands() {}
#[no_mangle]
pub unsafe extern "C" fn I_GetCursorPosition(mut x: *mut int32_t, mut y: *mut int32_t) {}
#[no_mangle]
pub unsafe extern "C" fn strupr(mut n: *mut libc::c_char) -> libc::c_int {
    while *n as libc::c_int != '\0' as i32 {
        *n = ({
            ...
            {
                if 0 != 0 {
                    let mut __c: libc::c_int = *n as libc::c_int;
                    ...
                    __res = toupper(*n as libc::c_int);
                }
            } else {
                __res = *(*__ctype_toupper_loc()).offset(*n as libc::c_int as isize);
            }
            __res
        }) as libc::c_char;
        n = n.offset(1);
...
#[no_mangle]
pub unsafe extern "C" fn strlwr(mut n: *mut libc::c_char) -> libc::c_int {
    while *n as libc::c_int != '\0' as i32 {
        *n = ({
            let mut __res: libc::c_int = 0;
            if ::core::mem::size_of::<libc::c_char>() as libc::c_ulong
                > 1 as libc::c_int as libc::c_ulong
            {
                if 0 != 0 {
                    ...
                    __res = tolower(*n as libc::c_int);
                }
            } else {
                __res = *(*__ctype_tolower_loc()).offset(*n as libc::c_int as isize);
            }
            __res
        }) as libc::c_char;
        n = n.offset(1);
