...
extern "C" {
    ...
    fn P_MobjTouchingSectorSpecial(
        mo: *mut mobj_t,
        section: int32_t,
        number: int32_t,
    ) -> *mut sector_t;
    fn P_ThingOnSpecial3DFloor(mo: *mut mobj_t) -> *mut sector_t;
    fn P_MobjTouchingSectorSpecialFlag(
        mo: *mut mobj_t,
        flag: sectorspecialflags_t,
    ) -> *mut sector_t;
    fn P_PlayerTouchingSectorSpecial(
        player: *mut player_t,
        section: int32_t,
        number: int32_t,
    ) -> *mut sector_t;
    ...
    fn P_FindNextLowestFloor(sec: *mut sector_t, currentheight: fixed_t) -> fixed_t;
    fn P_FindLowestCeilingSurrounding(sec: *mut sector_t) -> fixed_t;
    fn P_FindHighestCeilingSurrounding(sec: *mut sector_t) -> fixed_t;
    fn P_IsFlagAtBase(flag: mobjtype_t) -> boolean;
    fn P_SwitchWeather(weathernum: int32_t);
    ...
    fn P_CreateFloorSpriteSlope(mobj: *mut mobj_t) -> *mut libc::c_void;
    fn P_RemoveFloorSpriteSlope(mobj: *mut mobj_t);
    ...
    fn P_RingXYMovement(mo: *mut mobj_t);
    fn P_SceneryXYMovement(mo: *mut mobj_t);
    fn P_ZMovement(mo: *mut mobj_t) -> boolean;
    fn P_RingZMovement(mo: *mut mobj_t);
    fn P_SceneryZMovement(mo: *mut mobj_t) -> boolean;
    fn P_PlayerZMovement(mo: *mut mobj_t);
    fn P_SetTarget2(mo: *mut *mut mobj_t, target: *mut mobj_t) -> *mut mobj_t;
    fn P_AproxDistance(dx: fixed_t, dy: fixed_t) -> fixed_t;
    fn P_ClosestPointOnLine(
        x: fixed_t,
        y: fixed_t,
        line: *mut line_t,
        result: *mut vertex_t,
    ...
    fn P_GetPlayerControlDirection(player: *mut player_t) -> int32_t;
    ...
    fn P_GetJumpFlags(player: *mut player_t) -> pflags_t;
    ...
    fn P_PlayerCanEnterSpinGaps(player: *mut player_t) -> boolean;
    fn P_PlayerShouldUseSpinHeight(player: *mut player_t) -> boolean;
    fn P_IsObjectInGoop(mo: *mut mobj_t) -> boolean;
    fn P_IsObjectOnGround(mo: *mut mobj_t) -> boolean;
    fn P_InSpaceSector(mo: *mut mobj_t) -> boolean;
    fn P_InQuicksand(mo: *mut mobj_t) -> boolean;
    fn P_InJumpFlipSector(mo: *mut mobj_t) -> boolean;
    ...
    fn P_DoJumpShield(player: *mut player_t);
    fn P_DoBubbleBounce(player: *mut player_t);
    fn P_BlackOw(player: *mut player_t);
    fn P_ElementalFire(player: *mut player_t, cropcircle: boolean);
    fn P_SpawnSkidDust(player: *mut player_t, radius: fixed_t, sound: boolean);
    ...
    fn P_NukeEnemies(inflictor: *mut mobj_t, source: *mut mobj_t, radius: fixed_t);
    fn P_Earthquake(inflictor: *mut mobj_t, source: *mut mobj_t, radius: fixed_t);
    fn P_HomingAttack(source: *mut mobj_t, enemy: *mut mobj_t) -> boolean;
    fn P_SuperReady(player: *mut player_t) -> boolean;
    fn P_DoJump(player: *mut player_t, soundandstate: boolean);
    fn P_SpawnThokMobj(player: *mut player_t);
    fn P_SpawnSpinMobj(player: *mut player_t, type_0: mobjtype_t);
    fn P_Telekinesis(player: *mut player_t, thrust: fixed_t, range: fixed_t);
    fn P_PlayLivesJingle(player: *mut player_t);
    fn P_PlayJingle(player: *mut player_t, jingletype: jingletype_t);
    fn P_PlayJingleMusic(
        player: *mut player_t,
    ...
    fn P_InsideANonSolidFFloor(mobj: *mut mobj_t, rover: *mut ffloor_t) -> boolean;
    ...
    fn P_GetMobjGravity(mo: *mut mobj_t) -> fixed_t;
    fn P_WeaponOrPanel(type_0: mobjtype_t) -> boolean;
    fn P_GetClosestAxis(source: *mut mobj_t) -> *mut mobj_t;
    fn P_CanRunOnWater(player: *mut player_t, rover: *mut ffloor_t) -> boolean;
    fn P_MaceRotate(center: *mut mobj_t, baserot: int32_t, baseprevrot: int32_t);
    fn P_FlashPal(pl: *mut player_t, type_0: uint16_t, duration: uint16_t);
    fn P_CheckMeleeRange(actor: *mut mobj_t) -> boolean;
    fn P_JetbCheckMeleeRange(actor: *mut mobj_t) -> boolean;
    fn P_FaceStabCheckMeleeRange(actor: *mut mobj_t) -> boolean;
    fn P_SkimCheckMeleeRange(actor: *mut mobj_t) -> boolean;
    fn P_CheckMissileRange(actor: *mut mobj_t) -> boolean;
    ...
    fn P_Move(actor: *mut mobj_t, speed: fixed_t) -> boolean;
    ...
    fn P_CheckHoopPosition(
        hoopthing: *mut mobj_t,
        x: fixed_t,
        y: fixed_t,
        z: fixed_t,
        radius: fixed_t,
    ...
    fn P_CanPickupItem(player: *mut player_t, weapon: boolean) -> boolean;
    fn P_DoNightsScore(player: *mut player_t);
    fn P_DoMatchSuper(player: *mut player_t);
    fn P_PlayerFlagBurst(player: *mut player_t, toss: boolean);
    fn P_PlayerEmeraldBurst(player: *mut player_t, toss: boolean);
    fn P_PlayerWeaponPanelOrAmmoBurst(player: *mut player_t);
    fn P_PlayerWeaponAmmoBurst(player: *mut player_t);
    fn P_PlayerWeaponPanelBurst(player: *mut player_t);
    fn P_PlayerRingBurst(player: *mut player_t, num_rings: int32_t);
    fn P_KillMobj(
        target: *mut mobj_t,
        inflictor: *mut mobj_t,
        source: *mut mobj_t,
    ...
    fn P_RemoveShield(player: *mut player_t);
    ...
    fn P_DoSpring(spring: *mut mobj_t, object: *mut mobj_t) -> boolean;
    static mut nextmapoverride: int16_t;
    static mut skipstats: uint8_t;
    static mut nextgametype: int16_t;
    static mut quake: quake;
    static mut Gametype_Names: [*const libc::c_char; 136];
    static mut pointlimits: [int32_t; 136];
    static mut timelimits: [int32_t; 136];
    ...
    fn P_GetZAt(slope: *const pslope_t, x: fixed_t, y: fixed_t, z: fixed_t) -> fixed_t;
    ...
    fn lua_isuserdata(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
    ...
    fn R_CheckTextureNameForNum(num: int32_t) -> *const libc::c_char;
    fn R_TextureNameForNum(num: int32_t) -> *const libc::c_char;
    ...
    static mut lua_lumploading: int32_t;
    fn LUA_PushUserdata(
        L: *mut lua_State,
    ...
    fn R_GetColorByName(name: *const libc::c_char) -> uint16_t;
    fn R_GetSuperColorByName(name: *const libc::c_char) -> uint16_t;
    ...
    fn S_MusicPlaying() -> boolean;
    fn S_MusicPaused() -> boolean;
    fn S_MusicType() -> musictype_t;
    ...
    fn S_IdPlaying(id: sfxenum_t) -> int32_t;
    fn S_SoundPlaying(origin: *mut libc::c_void, id: sfxenum_t) -> int32_t;
    fn S_StopSoundByID(origin: *mut libc::c_void, sfx_id: sfxenum_t);
    ...
    fn G_FindMap(
        ...
        freqp: *mut *mut mapsearchfreq_t,
        freqc: *mut int32_t,
    ) -> int32_t;
    fn G_FreeMapSearch(freq: *mut mapsearchfreq_t, freqc: int32_t);
    fn G_FindMapByNameOrCode(
        query: *const libc::c_char,
        foundmapnamep: *mut *mut libc::c_char,
    ) -> int32_t;
    static mut gametyperankings: [int16_t; 136];
    fn G_AddGametype(rules: uint32_t) -> int16_t;
    fn G_AddGametypeConstant(gtype: int16_t, newgtconst: *const libc::c_char);
    fn G_UpdateGametypeSelections();
    fn G_AddGametypeTOL(gtype: int16_t, newtol: uint32_t);
    fn G_SetGametypeDescription(
        gtype: int16_t,
        descriptiontext: *mut libc::c_char,
        leftcolor: uint8_t,
        rightcolor: uint8_t,
    );
    ...
    fn M_MoveColorBefore(color: uint16_t, targ: uint16_t);
    fn M_MoveColorAfter(color: uint16_t, targ: uint16_t);
    fn M_GetColorBefore(color: uint16_t) -> uint16_t;
    fn M_GetColorAfter(color: uint16_t) -> uint16_t;
    static mut intermissiontypes: [intertype_t; 136];
    fn HU_AddChatText(text: *const libc::c_char, playsound: boolean);
    fn M_MapNumber(first: libc::c_char, second: libc::c_char) -> int32_t;
    fn B_UpdateBotleader(player: *mut player_t);
    fn I_GetPreciseTime() -> precise_t;
    fn I_GetPrecisePrecision() -> uint64_t;
    static mut hud_running: boolean;
    static mut hook_cmd_running: boolean;
}
...
pub const MF2_SPLAT: C2RustUnnamed_0 = 1073741824;
pub const MF2_SHIELD: C2RustUnnamed_0 = 536870912;
pub const MF2_LINKDRAW: C2RustUnnamed_0 = 268435456;
pub const MF2_AMBUSH: C2RustUnnamed_0 = 134217728;
pub const MF2_BOSSDEAD: C2RustUnnamed_0 = 67108864;
pub const MF2_BOSSFLEE: C2RustUnnamed_0 = 33554432;
pub const MF2_BOSSNOTRAP: C2RustUnnamed_0 = 16777216;
pub const MF2_FRET: C2RustUnnamed_0 = 8388608;
pub const MF2_SKULLFLY: C2RustUnnamed_0 = 4194304;
pub const MF2_OBJECTFLIP: C2RustUnnamed_0 = 2097152;
pub const MF2_STRONGBOX: C2RustUnnamed_0 = 1048576;
pub const MF2_SHADOW: C2RustUnnamed_0 = 524288;
pub const MF2_SUPERFIRE: C2RustUnnamed_0 = 262144;
pub const MF2_FIRING: C2RustUnnamed_0 = 131072;
pub const MF2_JUSTATTACKED: C2RustUnnamed_0 = 65536;
pub const MF2_NIGHTSPULL: C2RustUnnamed_0 = 32768;
pub const MF2_DEBRIS: C2RustUnnamed_0 = 16384;
pub const MF2_INFLOAT: C2RustUnnamed_0 = 8192;
pub const MF2_INVERTAIMABLE: C2RustUnnamed_0 = 4096;
pub const MF2_CLASSICPUSH: C2RustUnnamed_0 = 2048;
pub const MF2_SLIDEPUSH: C2RustUnnamed_0 = 1024;
pub const MF2_BEYONDTHEGRAVE: C2RustUnnamed_0 = 512;
pub const MF2_SCATTER: C2RustUnnamed_0 = 256;
pub const MF2_EXPLOSION: C2RustUnnamed_0 = 128;
pub const MF2_BOUNCERING: C2RustUnnamed_0 = 64;
pub const MF2_RAILRING: C2RustUnnamed_0 = 32;
pub const MF2_AUTOMATIC: C2RustUnnamed_0 = 16;
pub const MF2_DONTDRAW: C2RustUnnamed_0 = 8;
pub const MF2_DONTRESPAWN: C2RustUnnamed_0 = 4;
pub const MF2_TWOD: C2RustUnnamed_0 = 2;
pub const MF2_AXIS: C2RustUnnamed_0 = 1;
...
pub const BOT_MPAI: C2RustUnnamed_1 = 3;
pub const BOT_2PHUMAN: C2RustUnnamed_1 = 2;
pub const BOT_2PAI: C2RustUnnamed_1 = 1;
pub const BOT_NONE: C2RustUnnamed_1 = 0;
...
pub const PU_HWRMODELTEXTURE_UNLOCKED: C2RustUnnamed_2 = 103;
pub const PU_HWRCACHE_UNLOCKED: C2RustUnnamed_2 = 102;
pub const PU_CACHE_UNLOCKED: C2RustUnnamed_2 = 101;
pub const PU_PURGELEVEL: C2RustUnnamed_2 = 100;
pub const PU_HWRPLANE: C2RustUnnamed_2 = 52;
pub const PU_LEVSPEC: C2RustUnnamed_2 = 51;
pub const PU_LEVEL: C2RustUnnamed_2 = 50;
pub const PU_CACHE: C2RustUnnamed_2 = 49;
pub const PU_HWRCACHE: C2RustUnnamed_2 = 48;
pub const PU_HWRMODELTEXTURE: C2RustUnnamed_2 = 23;
pub const PU_HWRPATCHCOLMIPMAP: C2RustUnnamed_2 = 22;
pub const PU_HWRPATCHINFO: C2RustUnnamed_2 = 21;
pub const PU_HUDGFX: C2RustUnnamed_2 = 19;
pub const PU_SPRITE: C2RustUnnamed_2 = 18;
pub const PU_PATCH_DATA: C2RustUnnamed_2 = 17;
pub const PU_PATCH_ROTATED: C2RustUnnamed_2 = 16;
pub const PU_PATCH_LOWPRIORITY: C2RustUnnamed_2 = 15;
pub const PU_PATCH: C2RustUnnamed_2 = 14;
pub const PU_MUSIC: C2RustUnnamed_2 = 12;
pub const PU_SOUND: C2RustUnnamed_2 = 11;
pub const PU_PERFSTATS: C2RustUnnamed_2 = 3;
pub const PU_LUA: C2RustUnnamed_2 = 2;
...
pub type musictype_t = libc::c_uint;
pub const MU_MID_EX: musictype_t = 9;
pub const MU_MOD_EX: musictype_t = 8;
pub const MU_GME: musictype_t = 7;
pub const MU_FLAC: musictype_t = 6;
pub const MU_MP3: musictype_t = 5;
pub const MU_OGG: musictype_t = 4;
pub const MU_MID: musictype_t = 3;
pub const MU_MOD: musictype_t = 2;
pub const MU_WAV: musictype_t = 1;
pub const MU_NONE: musictype_t = 0;
#[derive(Copy, Clone)]
#[repr(C)]
    ...
    while *s as libc::c_int != 0
        && ({
                ...
                > 1 as libc::c_int as libc::c_ulong
            {
                ...
                __res = *(*__ctype_toupper_loc()).offset(*s as libc::c_int as isize);
            }
            __res
        })
            == ({
...
#[inline(always)]
unsafe extern "C" fn R_Frame2Char(mut frame: uint8_t) -> libc::c_char {
    if (frame as libc::c_int) < 26 as libc::c_int {
        return ('A' as i32 + frame as libc::c_int) as libc::c_char;
    }
    if (frame as libc::c_int) < 36 as libc::c_int {
        return ('0' as i32 + (frame as libc::c_int - 26 as libc::c_int)) as libc::c_char;
    }
    if (frame as libc::c_int) < 62 as libc::c_int {
        return ('a' as i32 + (frame as libc::c_int - 36 as libc::c_int)) as libc::c_char;
    }
    if frame as libc::c_int == 62 as libc::c_int {
        return '!' as i32 as libc::c_char;
    }
    if frame as libc::c_int == 63 as libc::c_int {
        return '@' as i32 as libc::c_char;
    }
...
#[no_mangle]
pub unsafe extern "C" fn luaL_checkboolean(
    mut L: *mut lua_State,
    mut narg: libc::c_int,
) -> boolean {
    luaL_checktype(L, narg, 1 as libc::c_int);
    return lua_toboolean(L, narg);
}
unsafe extern "C" fn lib_concat(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut i: libc::c_int = 0;
    let mut r: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut rl: size_t = 0 as libc::c_int as size_t;
    let mut sl: size_t = 0;
    lua_getfield(
        L,
        -(10002 as libc::c_int),
    ...
    while i <= n {
        ...
        s = lua_tolstring(L, -(1 as libc::c_int), &mut sl);
        if s.is_null() {
            return luaL_error(
                L,
                b"'tostring' must return a string to '__add'\0" as *const u8
        ...
        M_Memcpy
            ...
            )(r.offset(rl as isize) as *mut libc::c_void, s as *const libc::c_void, sl);
        rl = rl.wrapping_add(sl);
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        i += 1;
        i;
    }
    lua_pushlstring(L, r, rl);
    Z_Free(r as *mut libc::c_void);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_print(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut i: libc::c_int = 0;
    lua_getfield(
        L,
    ...
    while i <= n {
        ...
        CONS_Printf(b"%s\0" as *const u8 as *const libc::c_char, s);
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        i += 1;
        i;
    }
...
unsafe extern "C" fn lib_chatprint(mut L: *mut lua_State) -> libc::c_int {
    let mut str: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut sound: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    let mut len: libc::c_int = strlen(str) as libc::c_int;
    if str.is_null() {
        return luaL_error(
            L,
            b"'tostring' must return a string to 'chatprint'\0" as *const u8
                as *const libc::c_char,
        );
    }
    if len > 255 as libc::c_int {
        return luaL_error(
            L,
            b"String exceeds the 255 characters limit of the chat buffer.\0" as *const u8
                as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_chatprintf(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut str: *const libc::c_char = luaL_checklstring(
        L,
        2 as libc::c_int,
    ...
    let mut sound: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    let mut len: libc::c_int = strlen(str) as libc::c_int;
    let mut plr: *mut player_t = 0 as *mut player_t;
    if n < 2 as libc::c_int {
        return luaL_error(
            L,
            b"chatprintf requires at least two arguments: player and text.\0"
    ...
    plr = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    if plr.is_null() {
        return luaL_error(
            L,
            b"accessed player_t doesn't exist anymore, please check 'valid' before using player_t.\0"
                as *const u8 as *const libc::c_char,
        );
    }
    if plr != &mut *players.as_mut_ptr().offset(consoleplayer as isize) as *mut player_t
    {
        return 0 as libc::c_int;
    }
    if str.is_null() {
        return luaL_error(
            L,
            b"'tostring' must return a string to 'chatprintf'\0" as *const u8
                as *const libc::c_char,
        );
    }
    if len > 255 as libc::c_int {
...
static mut meta2utype: [C2RustUnnamed_3; 49] = [
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"STATE_T*\0" as *const u8 as *const libc::c_char,
            utype: b"state_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MOBJINFO_T*\0" as *const u8 as *const libc::c_char,
            utype: b"mobjinfo_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SFXINFO_T*\0" as *const u8 as *const libc::c_char,
            utype: b"sfxinfo_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SKINCOLOR_T*\0" as *const u8 as *const libc::c_char,
            utype: b"skincolor_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SKINCOLOR_T*RAMP\0" as *const u8 as *const libc::c_char,
            utype: b"skincolor_t.ramp\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SPRITEINFO_T*\0" as *const u8 as *const libc::c_char,
            utype: b"spriteinfo_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SPRITEFRAMEPIVOT_T[]\0" as *const u8 as *const libc::c_char,
            utype: b"spriteframepivot_t[]\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
    ...
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"TAGLIST\0" as *const u8 as *const libc::c_char,
            utype: b"taglist\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
            utype: b"mobj_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MAPTHING_T*\0" as *const u8 as *const libc::c_char,
            utype: b"mapthing_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
            utype: b"player_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"TICCMD_T*\0" as *const u8 as *const libc::c_char,
            utype: b"ticcmd_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SKIN_T*\0" as *const u8 as *const libc::c_char,
            utype: b"skin_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"PLAYER_T*POWERS\0" as *const u8 as *const libc::c_char,
            utype: b"player_t.powers\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SKIN_T*SOUNDSID\0" as *const u8 as *const libc::c_char,
            utype: b"skin_t.soundsid\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SKIN_T*SPRITES\0" as *const u8 as *const libc::c_char,
            utype: b"skin_t.sprites\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
    ...
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"VERTEX_T*\0" as *const u8 as *const libc::c_char,
            utype: b"vertex_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"LINE_T*\0" as *const u8 as *const libc::c_char,
            utype: b"line_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SIDE_T*\0" as *const u8 as *const libc::c_char,
            utype: b"side_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SUBSECTOR_T*\0" as *const u8 as *const libc::c_char,
            utype: b"subsector_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
            utype: b"sector_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"FFLOOR_T*\0" as *const u8 as *const libc::c_char,
            utype: b"ffloor_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"PSLOPE_T*\0" as *const u8 as *const libc::c_char,
            utype: b"slope_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"VECTOR2_T\0" as *const u8 as *const libc::c_char,
            utype: b"vector2_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"VECTOR3_T\0" as *const u8 as *const libc::c_char,
            utype: b"vector3_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MAPHEADER_T*\0" as *const u8 as *const libc::c_char,
            utype: b"mapheader_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"POLYOBJ_T*\0" as *const u8 as *const libc::c_char,
            utype: b"polyobj_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"POLYOBJ_T*VERTICES\0" as *const u8 as *const libc::c_char,
            utype: b"polyobj_t.vertices\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"POLYOBJ_T*LINES\0" as *const u8 as *const libc::c_char,
            utype: b"polyobj_t.lines\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
            utype: b"consvar_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"SECTOR_T*LINES\0" as *const u8 as *const libc::c_char,
            utype: b"sector_t.lines\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"sector_t.taglist\0" as *const u8 as *const libc::c_char,
            utype: b"sector_t.taglist\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"LINE_T*SIDENUM\0" as *const u8 as *const libc::c_char,
            utype: b"line_t.sidenum\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"LINE_T*ARGS\0" as *const u8 as *const libc::c_char,
            utype: b"line_t.args\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"LINE_T*STRINGARGS\0" as *const u8 as *const libc::c_char,
            utype: b"line_t.stringargs\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MAPTHING_T*ARGS\0" as *const u8 as *const libc::c_char,
            utype: b"mapthing.args\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MAPTHING_T*STRINGARGS\0" as *const u8 as *const libc::c_char,
            utype: b"mapthing.stringargs\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"BOUNDING_BOX\0" as *const u8 as *const libc::c_char,
            utype: b"bbox\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"HUDINFO_T*\0" as *const u8 as *const libc::c_char,
            utype: b"hudinfo_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"PATCH_T*\0" as *const u8 as *const libc::c_char,
            utype: b"patch_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"COLORMAP\0" as *const u8 as *const libc::c_char,
            utype: b"colormap\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
            utype: b"camera_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"ACTIONF_T*\0" as *const u8 as *const libc::c_char,
            utype: b"action\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"LUABANKS[]*\0" as *const u8 as *const libc::c_char,
            utype: b"luabanks[]\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"KEYEVENT_T*\0" as *const u8 as *const libc::c_char,
            utype: b"keyevent_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: b"MOUSE_T*\0" as *const u8 as *const libc::c_char,
            utype: b"mouse_t\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_3 {
            meta: 0 as *const libc::c_char,
            utype: 0 as *const libc::c_char,
        };
        init
    },
];
unsafe extern "C" fn GetUserdataUType(mut L: *mut lua_State) -> *const libc::c_char {
    let mut i: uint8_t = 0;
    lua_getmetatable(L, -(1 as libc::c_int));
    i = 0 as libc::c_int as uint8_t;
    while !(meta2utype[i as usize].meta).is_null() {
        lua_getfield(L, -(10000 as libc::c_int), meta2utype[i as usize].meta);
        if lua_rawequal(L, -(1 as libc::c_int), -(2 as libc::c_int)) != 0 {
            lua_settop(L, -(2 as libc::c_int) - 1 as libc::c_int);
            return meta2utype[i as usize].utype;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn lib_userdataType(mut L: *mut lua_State) -> libc::c_int {
    lua_settop(L, 1 as libc::c_int);
    luaL_checktype(L, 1 as libc::c_int, 7 as libc::c_int);
    lua_pushstring(L, GetUserdataUType(L));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_registerMetatable(mut L: *mut lua_State) -> libc::c_int {
    static mut nextid: uint16_t = 1 as libc::c_int as uint16_t;
    if lua_lumploading == 0 {
        return luaL_error(
            L,
            b"This function cannot be called from within a hook or coroutine!\0"
                as *const u8 as *const libc::c_char,
        );
    }
    luaL_checktype(L, 1 as libc::c_int, 5 as libc::c_int);
    if nextid as libc::c_int == 0 as libc::c_int {
        return luaL_error(
            L,
            b"Too many metatables registered?! Please consider rewriting your script once you are sober again.\n\0"
                as *const u8 as *const libc::c_char,
        );
    }
    lua_getfield(
        L,
        -(10000 as libc::c_int),
        b"METATABLES\0" as *const u8 as *const libc::c_char,
    );
    lua_pushvalue(L, 1 as libc::c_int);
    lua_pushnumber(L, nextid as lua_Number);
    lua_settable(L, 2 as libc::c_int);
    lua_pushnumber(L, nextid as lua_Number);
    lua_pushvalue(L, 1 as libc::c_int);
    lua_settable(L, 2 as libc::c_int);
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
...
unsafe extern "C" fn lib_userdataMetatable(mut L: *mut lua_State) -> libc::c_int {
    let mut i: uint32_t = 0;
    let mut udname: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    ...
    while !(meta2utype[i as usize].meta).is_null() {
        if strcmp(udname, meta2utype[i as usize].utype) == 0 {
            lua_getfield(L, -(10000 as libc::c_int), meta2utype[i as usize].meta);
            return 1 as libc::c_int;
        }
        i = i.wrapping_add(1);
...
unsafe extern "C" fn lib_isPlayerAdmin(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
...
unsafe extern "C" fn lib_reserveLuabanks(mut L: *mut lua_State) -> libc::c_int {
    static mut reserved: boolean = false_0 as libc::c_int;
    if lua_lumploading == 0 {
        return luaL_error(
            L,
            b"luabanks[] cannot be reserved from within a hook or coroutine!\0"
                as *const u8 as *const libc::c_char,
        );
    }
    if reserved != 0 {
        return luaL_error(
            L,
            b"luabanks[] has already been reserved! Only one savedata-enabled mod at a time may use this feature.\0"
                as *const u8 as *const libc::c_char,
        );
    }
    reserved = true_0 as libc::c_int;
    LUA_PushUserdata(
        L,
        &mut luabanks as *mut [int32_t; 16] as *mut libc::c_void,
        b"LUABANKS[]*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pMoveColorBefore(mut L: *mut lua_State) -> libc::c_int {
    let mut color: uint16_t = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    let mut targ: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
                as *const libc::c_char,
        )
    } else if hook_cmd_running != 0 {
        return luaL_error(
            L,
            b"CMD building code should not call this function!\0" as *const u8
                as *const libc::c_char,
        )
    }
...
unsafe extern "C" fn lib_pMoveColorAfter(mut L: *mut lua_State) -> libc::c_int {
    let mut color: uint16_t = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    let mut targ: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    if hud_running != 0 {
        return luaL_error(
...
unsafe extern "C" fn lib_pGetColorBefore(mut L: *mut lua_State) -> libc::c_int {
    let mut color: uint16_t = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    lua_pushnumber(L, M_GetColorBefore(color) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pGetColorAfter(mut L: *mut lua_State) -> libc::c_int {
    let mut color: uint16_t = luaL_checknumber(L, 1 as libc::c_int) as uint16_t;
    lua_pushnumber(L, M_GetColorAfter(color) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_mMapNumber(mut L: *mut lua_State) -> libc::c_int {
    let mut arg: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut len: size_t = strlen(arg);
    if len == 2 as libc::c_int as size_t || len == 5 as libc::c_int as size_t {
        let mut first: libc::c_char = *arg
            .offset(len.wrapping_sub(2 as libc::c_int as size_t) as isize);
        let mut second: libc::c_char = *arg
            .offset(len.wrapping_sub(1 as libc::c_int as size_t) as isize);
        lua_pushnumber(L, M_MapNumber(first, second));
    } else {
        lua_pushnumber(L, 0 as libc::c_int);
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRandomFixed(mut L: *mut lua_State) -> libc::c_int {
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    lua_pushnumber(L, P_RandomFixed());
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRandomByte(mut L: *mut lua_State) -> libc::c_int {
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    lua_pushnumber(L, P_RandomByte() as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRandomKey(mut L: *mut lua_State) -> libc::c_int {
    let mut a: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if a > 65536 as libc::c_int {
        ...
        if seen == 0 {
            ...
            CONS_Alert(
                CONS_WARNING,
                b"%s\n\0" as *const u8 as *const libc::c_char,
                b"P_RandomKey: range > 65536 is undefined behavior\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
    lua_pushnumber(L, P_RandomKey(a));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRandomRange(mut L: *mut lua_State) -> libc::c_int {
    let mut a: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut b: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if b - a + 1 as libc::c_int > 65536 as libc::c_int {
        static mut seen: uint8_t = 0 as libc::c_int as uint8_t;
        if seen == 0 {
            seen = 1 as libc::c_int as uint8_t;
            CONS_Alert(
                CONS_WARNING,
                b"%s\n\0" as *const u8 as *const libc::c_char,
                b"P_RandomRange: range > 65536 is undefined behavior\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
    lua_pushnumber(L, P_RandomRange(a, b));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSignedRandom(mut L: *mut lua_State) -> libc::c_int {
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    lua_pushnumber(L, P_RandomByte() as int32_t - 128 as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRandomChance(mut L: *mut lua_State) -> libc::c_int {
    let mut p: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    lua_pushboolean(L, (P_RandomFixed() < p) as libc::c_int);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pAproxDistance(mut L: *mut lua_State) -> libc::c_int {
    let mut dx: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut dy: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    lua_pushnumber(L, P_AproxDistance(dx, dy));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pClosestPointOnLine(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut result: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    if lua_isuserdata(L, 3 as libc::c_int) != 0 {
        let mut line: *mut line_t = *(luaL_checkudata(
            L,
            3 as libc::c_int,
            b"LINE_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut line_t);
        if line.is_null() {
            return luaL_error(
                L,
                b"accessed line_t doesn't exist anymore, please check 'valid' before using line_t.\0"
                    as *const u8 as *const libc::c_char,
            );
        }
        P_ClosestPointOnLine(x, y, line, &mut result);
    } else {
        ...
        if n < 6 as libc::c_int {
            return luaL_error(
                L,
                b"arguments 3 to 6 not all given (expected 4 fixed-point integers)\0"
                    as *const u8 as *const libc::c_char,
            );
        }
        v1.x = luaL_checknumber(L, 3 as libc::c_int);
        v1.y = luaL_checknumber(L, 4 as libc::c_int);
        v2.x = luaL_checknumber(L, 5 as libc::c_int);
        v2.y = luaL_checknumber(L, 6 as libc::c_int);
        junk.v1 = &mut v1;
        junk.v2 = &mut v2;
        junk.dx = v2.x - v1.x;
        junk.dy = v2.y - v1.y;
        P_ClosestPointOnLine(x, y, &mut junk, &mut result);
    }
    lua_pushnumber(L, result.x);
    lua_pushnumber(L, result.y);
    return 2 as libc::c_int;
}
unsafe extern "C" fn lib_pPointOnLineSide(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    if lua_isuserdata(L, 3 as libc::c_int) != 0 {
        ...
        lua_pushnumber(L, P_PointOnLineSide(x, y, line));
    } else {
        let mut v1: vertex_t = vertex_t {
            x: 0,
            y: 0,
        ...
        junk.dx = v2.x - v1.x;
        junk.dy = v2.y - v1.y;
        lua_pushnumber(L, P_PointOnLineSide(x, y, &mut junk));
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pCheckMeleeRange(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    if hud_running != 0 {
        return luaL_error(
            L,
        ...
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
            L,
            b"This can only be used in a level!\0" as *const u8 as *const libc::c_char,
        );
    }
    if actor.is_null() {
        return luaL_error(
            L,
            b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
                as *const u8 as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_pJetbCheckMeleeRange(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pFaceStabCheckMeleeRange(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSkimCheckMeleeRange(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pCheckMissileRange(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pNewChaseDir(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pLookForPlayers(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut dist: fixed_t = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int);
    let mut allaround: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    let mut tracer: boolean = (!(lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 4 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pSpawnMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut type_0: mobjtype_t = luaL_checknumber(L, 4 as libc::c_int) as mobjtype_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if type_0 as libc::c_uint >= NUMMOBJTYPES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"mobj type %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            type_0 as libc::c_uint,
            NUMMOBJTYPES as libc::c_int - 1 as libc::c_int,
        );
    }
    LUA_PushUserdata(
        L,
        P_SpawnMobj(x, y, z, type_0) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnMobjFromMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut x: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut type_0: mobjtype_t = luaL_checknumber(L, 5 as libc::c_int) as mobjtype_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    LUA_PushUserdata(
        L,
        P_SpawnMobjFromMobj(actor, x, y, z, type_0) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRemoveMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut th: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    if !((*th).player).is_null() {
        return luaL_error(
            L,
            b"Attempt to remove player mobj with P_RemoveMobj.\0" as *const u8
                as *const libc::c_char,
        );
    }
    P_RemoveMobj(th);
...
unsafe extern "C" fn lib_pIsValidSprite2(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut spr2: uint8_t = luaL_checknumber(L, 2 as libc::c_int) as uint8_t;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
    ...
    lua_pushboolean(
        L,
        (!((*mobj).skin).is_null()
            && (*((*mobj).skin as *mut skin_t)).sprites[spr2 as usize].numframes != 0)
            as libc::c_int,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnLockOn(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut lockon: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut state: statenum_t = luaL_checknumber(L, 3 as libc::c_int) as statenum_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if state as libc::c_uint >= NUMSTATES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"state %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            state as libc::c_uint,
            NUMSTATES as libc::c_int - 1 as libc::c_int,
        );
    }
    if P_IsLocalPlayer(player) != 0 {
        ...
        (*visual).flags2 |= MF2_DONTDRAW as libc::c_int as uint32_t;
        (*visual).drawonlyforplayer = player;
        P_SetMobjStateNF(visual, state);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut dest: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut type_0: mobjtype_t = luaL_checknumber(L, 3 as libc::c_int) as mobjtype_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    LUA_PushUserdata(
        L,
        P_SpawnMissile(source, dest, type_0) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnXYZMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut type_0: mobjtype_t = luaL_checknumber(L, 3 as libc::c_int) as mobjtype_t;
    let mut x: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 5 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 6 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    LUA_PushUserdata(
        L,
        P_SpawnXYZMissile(source, dest, type_0, x, y, z) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnPointMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut xa: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut ya: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut za: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut type_0: mobjtype_t = luaL_checknumber(L, 5 as libc::c_int) as mobjtype_t;
    let mut x: fixed_t = luaL_checknumber(L, 6 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 7 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 8 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    LUA_PushUserdata(
        L,
        P_SpawnPointMissile(source, xa, ya, za, type_0, x, y, z) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnAlteredDirectionMissile(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
    ...
    let mut type_0: mobjtype_t = luaL_checknumber(L, 2 as libc::c_int) as mobjtype_t;
    let mut x: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 5 as libc::c_int);
    let mut shiftingAngle: int32_t = luaL_checknumber(L, 5 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    LUA_PushUserdata(
        L,
        P_SpawnAlteredDirectionMissile(source, type_0, x, y, z, shiftingAngle)
            as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pColorTeamMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut missile: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut source: *mut player_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
...
unsafe extern "C" fn lib_pSPMAngle(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut type_0: mobjtype_t = luaL_checknumber(L, 2 as libc::c_int) as mobjtype_t;
    let mut angle: angle_t = luaL_checknumber(L, 3 as libc::c_int) as angle_t;
    let mut allowaim: uint8_t = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int)
        as uint8_t;
    let mut flags2: uint32_t = luaL_optnumber(L, 5 as libc::c_int, 0 as libc::c_int)
        as uint32_t;
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    LUA_PushUserdata(
        L,
        P_SPMAngle(source, type_0, angle, allowaim, flags2) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnPlayerMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut type_0: mobjtype_t = luaL_checknumber(L, 2 as libc::c_int) as mobjtype_t;
    let mut flags2: uint32_t = luaL_optnumber(L, 3 as libc::c_int, 0 as libc::c_int)
        as uint32_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pMobjFlip(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(L, P_MobjFlip(mobj) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pGetMobjGravity(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(L, P_GetMobjGravity(mobj));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pWeaponOrPanel(mut L: *mut lua_State) -> libc::c_int {
    let mut type_0: mobjtype_t = luaL_checknumber(L, 1 as libc::c_int) as mobjtype_t;
    if type_0 as libc::c_uint >= NUMMOBJTYPES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"mobj type %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushboolean(L, P_WeaponOrPanel(type_0));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFlashPal(mut L: *mut lua_State) -> libc::c_int {
    let mut pl: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut type_0: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    let mut duration: uint16_t = luaL_checknumber(L, 3 as libc::c_int) as uint16_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    P_FlashPal(pl, type_0, duration);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pGetClosestAxis(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    LUA_PushUserdata(
        L,
        P_GetClosestAxis(source) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnParaloop(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut radius: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut number: int32_t = luaL_checknumber(L, 5 as libc::c_int);
    let mut type_0: mobjtype_t = luaL_checknumber(L, 6 as libc::c_int) as mobjtype_t;
    let mut rotangle: angle_t = luaL_checknumber(L, 7 as libc::c_int) as angle_t;
    let mut nstate: statenum_t = luaL_optnumber(
        L,
        8 as libc::c_int,
        S_NULL as libc::c_int,
    ) as statenum_t;
    let mut spawncenter: boolean = (!(lua_type(L, 9 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 9 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if nstate as libc::c_uint >= NUMSTATES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"state %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            nstate as libc::c_uint,
            NUMSTATES as libc::c_int - 1 as libc::c_int,
        );
    }
    P_SpawnParaloop(x, y, z, radius, number, type_0, nstate, rotangle, spawncenter);
    P_SetTarget2(&mut tmthing, ptmthing);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pBossTargetPlayer(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut closest: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pSupermanLook4Players(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSetScale(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut newscale: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if newscale < ((1 as libc::c_int) << 16 as libc::c_int) / 100 as libc::c_int {
        newscale = ((1 as libc::c_int) << 16 as libc::c_int) / 100 as libc::c_int;
    }
    P_SetScale(mobj, newscale);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pInsideANonSolidFFloor(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut rover: *mut ffloor_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"FFLOOR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut ffloor_t);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
    ...
    if rover.is_null() {
        return luaL_error(
            L,
            b"accessed ffloor_t doesn't exist anymore, please check 'valid' before using ffloor_t.\0"
                as *const u8 as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_pCheckDeathPitCollide(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
...
unsafe extern "C" fn lib_pCheckSolidLava(mut L: *mut lua_State) -> libc::c_int {
    let mut rover: *mut ffloor_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"FFLOOR_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pCanRunOnWater(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pMaceRotate(mut L: *mut lua_State) -> libc::c_int {
    let mut center: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut baserot: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut baseprevrot: int32_t = luaL_checknumber(L, 3 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pCreateFloorSpriteSlope(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    LUA_PushUserdata(
        L,
        P_CreateFloorSpriteSlope(mobj) as *mut pslope_t as *mut libc::c_void,
        b"PSLOPE_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pRemoveFloorSpriteSlope(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pRailThinker(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pXYMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pRingXYMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSceneryXYMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pZMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pRingZMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSceneryZMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayerZMovement(mut L: *mut lua_State) -> libc::c_int {
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pGetPlayerHeight(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(L, FixedMul((*player).height, (*(*player).mo).scale));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pGetPlayerSpinHeight(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(L, FixedMul((*player).spinheight, (*(*player).mo).scale));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pGetPlayerControlDirection(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
    ...
    lua_pushnumber(L, P_GetPlayerControlDirection(player));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pAddPlayerScore(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut amount: uint32_t = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pStealPlayerScore(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pGetJumpFlags(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    lua_pushnumber(L, P_GetJumpFlags(player) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayerInPain(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoPlayerPain(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut inflictor: *mut mobj_t = 0 as *mut mobj_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if !(lua_type(L, 2 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 2 as libc::c_int) != 0
    {
        source = *(luaL_checkudata(
            L,
            2 as libc::c_int,
            b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut mobj_t);
    }
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    {
        inflictor = *(luaL_checkudata(
            L,
            3 as libc::c_int,
            b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut mobj_t);
...
unsafe extern "C" fn lib_pResetPlayer(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayerCanDamage(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
...
unsafe extern "C" fn lib_pPlayerFullbright(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pIsObjectInGoop(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pIsObjectOnGround(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pInSpaceSector(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pInQuicksand(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pInJumpFlipSector(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSetObjectMomZ(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut value: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut relative: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pPlayJingle(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    let mut jingletype: jingletype_t = luaL_checknumber(L, 2 as libc::c_int)
        as jingletype_t;
    if !(lua_type(L, 1 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 1 as libc::c_int) != 0
    {
        player = *(luaL_checkudata(
            L,
            1 as libc::c_int,
            b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut player_t);
    ...
    if jingletype as libc::c_uint >= NUMJINGLES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"jingletype %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            jingletype as libc::c_uint,
            NUMJINGLES as libc::c_int - 1 as libc::c_int,
        );
    }
    P_PlayJingle(player, jingletype);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayJingleMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    let mut musnamearg: *const libc::c_char = luaL_checklstring(
        L,
        2 as libc::c_int,
        0 as *mut size_t,
    );
    let mut musname: [libc::c_char; 7] = [0; 7];
    let mut p: *mut libc::c_char = musname.as_mut_ptr();
    let mut musflags: uint16_t = luaL_optnumber(L, 3 as libc::c_int, 0 as libc::c_int)
        as uint16_t;
    let mut looping: boolean = (lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 4 as libc::c_int) != 0) as libc::c_int;
    let mut jingletype: jingletype_t = luaL_optnumber(
        L,
        5 as libc::c_int,
        JT_OTHER as libc::c_int,
    ) as jingletype_t;
    if !(lua_type(L, 1 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 1 as libc::c_int) != 0
    {
    ...
    musname[6 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
    strncpy(musname.as_mut_ptr(), musnamearg, 6 as libc::c_int as libc::c_ulong);
    while *p != 0 {
        *p = ({
            let mut __res: libc::c_int = 0;
            if ::core::mem::size_of::<libc::c_char>() as libc::c_ulong
...
unsafe extern "C" fn lib_pRestoreMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSpawnShieldOrb(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSpawnGhostMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    LUA_PushUserdata(
        L,
        P_SpawnGhostMobj(mobj) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pGivePlayerRings(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut num_rings: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pGivePlayerLives(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut numlives: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pGiveCoopLives(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pResetScore(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoJumpShield(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoBubbleBounce(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pBlackOw(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pElementalFire(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut cropcircle: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pSpawnSkidDust(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut radius: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut sound: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
...
unsafe extern "C" fn lib_pMovePlayer(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoPlayerFinish(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoPlayerExit(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pInstaThrust(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut angle: angle_t = luaL_checknumber(L, 2 as libc::c_int) as angle_t;
    let mut move_0: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    P_InstaThrust(mo, angle, move_0);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pReturnThrustX(mut L: *mut lua_State) -> libc::c_int {
    let mut angle: angle_t = 0;
    let mut move_0: fixed_t = 0;
    if lua_type(L, 1 as libc::c_int) == 0 as libc::c_int
        || lua_isuserdata(L, 1 as libc::c_int) != 0
    {
        lua_remove(L, 1 as libc::c_int);
    }
    angle = luaL_checknumber(L, 1 as libc::c_int) as angle_t;
    move_0 = luaL_checknumber(L, 2 as libc::c_int);
    lua_pushnumber(L, P_ReturnThrustX(0 as *mut mobj_t, angle, move_0));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pReturnThrustY(mut L: *mut lua_State) -> libc::c_int {
    let mut angle: angle_t = 0;
    let mut move_0: fixed_t = 0;
    if lua_type(L, 1 as libc::c_int) == 0 as libc::c_int
        || lua_isuserdata(L, 1 as libc::c_int) != 0
    ...
    angle = luaL_checknumber(L, 1 as libc::c_int) as angle_t;
    move_0 = luaL_checknumber(L, 2 as libc::c_int);
    lua_pushnumber(L, P_ReturnThrustY(0 as *mut mobj_t, angle, move_0));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pLookForEnemies(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut nonenemies: boolean = (lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    let mut bullet: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    LUA_PushUserdata(
        L,
        P_LookForEnemies(player, nonenemies, bullet) as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pNukeEnemies(mut L: *mut lua_State) -> libc::c_int {
    let mut inflictor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    let mut radius: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if inflictor.is_null() || source.is_null() {
        return luaL_error(
            L,
            b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
                as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pEarthquake(mut L: *mut lua_State) -> libc::c_int {
    let mut inflictor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pHomingAttack(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut enemy: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    if source.is_null() || enemy.is_null() {
        return luaL_error(
            L,
            b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
                as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSuperReady(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoJump(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut soundandstate: boolean = (lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pSpawnThokMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pSpawnSpinMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    P_SpawnSpinMobj(player, type_0);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pTelekinesis(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut thrust: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut range: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pSwitchShield(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut shield: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pPlayerCanEnterSpinGaps(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayerShouldUseSpinHeight(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
...
unsafe extern "C" fn lib_pCheckPosition(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    LUA_PushUserdata(
        L,
        tmthing as *mut libc::c_void,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    );
    P_SetTarget2(&mut tmthing, ptmthing);
    return 2 as libc::c_int;
}
unsafe extern "C" fn lib_pTryMove(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    let mut x: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut allowdropoff: boolean = (!(lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 4 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pMove(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut actor: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    let mut speed: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pTeleportMove(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
    ...
    if seen == 0 {
        ...
        CONS_Alert(
            ...
            b"\"%s\" is deprecated and will be removed.\nUse \"%s\" instead.\n\0"
                as *const u8 as *const libc::c_char,
            b"P_TeleportMove\0" as *const u8 as *const libc::c_char,
            b"P_SetOrigin\" or \"P_MoveOrigin\0" as *const u8 as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_pSetOrigin(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
...
unsafe extern "C" fn lib_pMoveOrigin(mut L: *mut lua_State) -> libc::c_int {
    let mut ptmthing: *mut mobj_t = tmthing;
    let mut thing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
...
unsafe extern "C" fn lib_pSlideMove(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pBounceMove(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pCheckSight(mut L: *mut lua_State) -> libc::c_int {
    let mut t1: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut t2: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
...
unsafe extern "C" fn lib_pCheckHoopPosition(mut L: *mut lua_State) -> libc::c_int {
    let mut hoopthing: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    let mut radius: fixed_t = luaL_checknumber(L, 5 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pRadiusAttack(mut L: *mut lua_State) -> libc::c_int {
    let mut spot: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    let mut damagedist: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut damagetype: uint8_t = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int)
        as uint8_t;
    let mut sightcheck: boolean = (lua_type(L, 5 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 5 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if spot.is_null() || source.is_null() {
        return luaL_error(
            L,
            b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
                as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pFloorzAtPos(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut height: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
    ...
    lua_pushnumber(L, P_FloorzAtPos(x, y, z, height));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pCeilingzAtPos(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut z: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut height: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    ...
    lua_pushnumber(L, P_CeilingzAtPos(x, y, z, height));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pDoSpring(mut L: *mut lua_State) -> libc::c_int {
    let mut spring: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut object: *mut mobj_t = *(luaL_checkudata(
        L,
        2 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    ...
    if spring.is_null() || object.is_null() {
        return luaL_error(
            L,
            b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
                as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pTryCameraMove(mut L: *mut lua_State) -> libc::c_int {
    let mut cam: *mut camera_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut camera_t);
    let mut x: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    if cam.is_null() {
        return luaL_error(
            L,
            b"accessed camera_t doesn't exist anymore, please check 'valid' before using camera_t.\0"
                as *const u8 as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_pTeleportCameraMove(mut L: *mut lua_State) -> libc::c_int {
    let mut cam: *mut camera_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CAMERA_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pRemoveShield(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDamageMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut target: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut inflictor: *mut mobj_t = 0 as *mut mobj_t;
    let mut source: *mut mobj_t = 0 as *mut mobj_t;
    let mut damage: int32_t = 0;
    let mut damagetype: uint8_t = 0;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    damage = luaL_optnumber(L, 4 as libc::c_int, 1 as libc::c_int);
    damagetype = luaL_optnumber(L, 5 as libc::c_int, 0 as libc::c_int) as uint8_t;
    lua_pushboolean(L, P_DamageMobj(target, inflictor, source, damage, damagetype));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pKillMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut target: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    damagetype = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int) as uint8_t;
    P_KillMobj(target, inflictor, source, damagetype);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayerRingBurst(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut num_rings: int32_t = luaL_optnumber(
        L,
        2 as libc::c_int,
        -(1 as libc::c_int),
    );
    ...
    if num_rings == -(1 as libc::c_int) {
        num_rings = (*player).rings as int32_t;
    }
    P_PlayerRingBurst(player, num_rings);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayerWeaponPanelBurst(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayerWeaponAmmoBurst(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayerWeaponPanelOrAmmoBurst(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
...
unsafe extern "C" fn lib_pPlayerEmeraldBurst(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut toss: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pPlayerFlagBurst(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayRinglossSound(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayDeathSound(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayVictorySound(mut L: *mut lua_State) -> libc::c_int {
    let mut source: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pPlayLivesJingle(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 1 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 1 as libc::c_int) != 0
    {
...
unsafe extern "C" fn lib_pCanPickupItem(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut weapon: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
...
unsafe extern "C" fn lib_pDoNightsScore(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pDoMatchSuper(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pThrust(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    P_Thrust(mo, angle, move_0);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pSetMobjStateNF(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut mobj_t);
    let mut state: statenum_t = luaL_checknumber(L, 2 as libc::c_int) as statenum_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if !((*mobj).player).is_null()
        && state as libc::c_uint == S_NULL as libc::c_int as libc::c_uint
    {
        return luaL_error(
            L,
            b"Attempt to remove player mobj with S_NULL.\0" as *const u8
                as *const libc::c_char,
        );
    }
...
unsafe extern "C" fn lib_pDoSuperTransformation(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut player_t);
    let mut giverings: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_pExplodeMissile(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pMobjTouchingSectorSpecial(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
    ...
    let mut section: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut number: int32_t = luaL_checknumber(L, 3 as libc::c_int);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
    ...
    LUA_PushUserdata(
        L,
        P_MobjTouchingSectorSpecial(mo, section, number) as *mut libc::c_void,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pThingOnSpecial3DFloor(mut L: *mut lua_State) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
    ...
    if seen == 0 {
        ...
        CONS_Alert(
            ...
            b"\"%s\" is deprecated and will be removed.\nUse \"%s\" instead.\n\0"
                as *const u8 as *const libc::c_char,
            b"P_ThingOnSpecial3DFloor\0" as *const u8 as *const libc::c_char,
            b"P_MobjTouchingSectorSpecial\" or \"P_MobjTouchingSectorSpecialFlag\0"
                as *const u8 as *const libc::c_char,
        );
    }
    LUA_PushUserdata(
        L,
        P_ThingOnSpecial3DFloor(mo) as *mut libc::c_void,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pMobjTouchingSectorSpecialFlag(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut mo: *mut mobj_t = *(luaL_checkudata(
        L,
    ...
    let mut flag: sectorspecialflags_t = luaL_checknumber(L, 2 as libc::c_int)
    ...
    LUA_PushUserdata(
        L,
        P_MobjTouchingSectorSpecialFlag(mo, flag) as *mut libc::c_void,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayerTouchingSectorSpecial(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
    ...
    LUA_PushUserdata(
        L,
        P_PlayerTouchingSectorSpecial(player, section, number) as *mut libc::c_void,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pPlayerTouchingSectorSpecialFlag(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
    ...
    LUA_PushUserdata(
        L,
        P_PlayerTouchingSectorSpecialFlag(player, flag) as *mut libc::c_void,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindLowestFloorSurrounding(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut sector_t);
    ...
    if sector.is_null() {
        return luaL_error(
            L,
            b"accessed sector_t doesn't exist anymore, please check 'valid' before using sector_t.\0"
                as *const u8 as *const libc::c_char,
        );
    }
    lua_pushnumber(L, P_FindLowestFloorSurrounding(sector));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindHighestFloorSurrounding(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
    ...
    lua_pushnumber(L, P_FindHighestFloorSurrounding(sector));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindNextHighestFloor(mut L: *mut lua_State) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut sector_t);
    let mut currentheight: fixed_t = 0;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
    ...
    currentheight = luaL_optnumber(L, 2 as libc::c_int, (*sector).floorheight);
    lua_pushnumber(L, P_FindNextHighestFloor(sector, currentheight));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindNextLowestFloor(mut L: *mut lua_State) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    ...
    currentheight = luaL_optnumber(L, 2 as libc::c_int, (*sector).floorheight);
    lua_pushnumber(L, P_FindNextLowestFloor(sector, currentheight));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindLowestCeilingSurrounding(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
    ...
    lua_pushnumber(L, P_FindLowestCeilingSurrounding(sector));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindHighestCeilingSurrounding(
    mut L: *mut lua_State,
) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
    ...
    lua_pushnumber(L, P_FindHighestCeilingSurrounding(sector));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pFindSpecialLineFromTag(mut L: *mut lua_State) -> libc::c_int {
    let mut special: int16_t = luaL_checknumber(L, 1 as libc::c_int) as int16_t;
    let mut line: int16_t = luaL_checknumber(L, 2 as libc::c_int) as int16_t;
    let mut start: int32_t = luaL_optnumber(L, 3 as libc::c_int, -(1 as libc::c_int));
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    lua_pushnumber(L, P_FindSpecialLineFromTag(special, line, start));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pSwitchWeather(mut L: *mut lua_State) -> libc::c_int {
    let mut weathernum: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut user: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if user.is_null() {
        globalweather = weathernum as uint8_t;
    }
    if user.is_null() || P_IsLocalPlayer(user) != 0 {
        P_SwitchWeather(weathernum);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pLinedefExecute(mut L: *mut lua_State) -> libc::c_int {
    let mut tag: int32_t = luaL_checknumber(L, 1 as libc::c_int) as int16_t as int32_t;
    let mut actor: *mut mobj_t = 0 as *mut mobj_t;
    ...
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    {
        caller = *(luaL_checkudata(
            L,
            3 as libc::c_int,
            b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut sector_t);
    }
    P_LinedefExecute(tag as int16_t, actor, caller);
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pSpawnLightningFlash(mut L: *mut lua_State) -> libc::c_int {
    let mut sector: *mut sector_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_pFadeLight(mut L: *mut lua_State) -> libc::c_int {
    let mut tag: int16_t = luaL_checknumber(L, 1 as libc::c_int) as int16_t;
    let mut destvalue: int32_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut speed: int32_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut ticbased: boolean = (!(lua_type(L, 4 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 4 as libc::c_int) != 0) as libc::c_int;
    let mut force: boolean = (!(lua_type(L, 5 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 5 as libc::c_int) != 0) as libc::c_int;
    let mut relative: boolean = (!(lua_type(L, 6 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 6 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_pIsFlagAtBase(mut L: *mut lua_State) -> libc::c_int {
    let mut flag: mobjtype_t = luaL_checknumber(L, 1 as libc::c_int) as mobjtype_t;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
    ...
    if flag as libc::c_uint >= NUMMOBJTYPES as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"mobj type %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            flag as libc::c_uint,
...
unsafe extern "C" fn lib_pSetupLevelSky(mut L: *mut lua_State) -> libc::c_int {
    let mut skynum: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut user: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    if user.is_null() {
        P_SetupLevelSky(skynum, true_0 as libc::c_int);
    } else if P_IsLocalPlayer(user) != 0 {
        P_SetupLevelSky(skynum, false_0 as libc::c_int);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pSetSkyboxMobj(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    ...
    if !(n == 1 as libc::c_int) {
        if lua_isuserdata(L, 2 as libc::c_int) != 0 {
            user = *(luaL_checkudata(
                L,
                2 as libc::c_int,
                b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
            ) as *mut *mut player_t);
        } else if lua_type(L, 2 as libc::c_int) == 0 as libc::c_int {
            w = 0 as libc::c_int;
        } else if lua_type(L, 2 as libc::c_int) == 1 as libc::c_int {
            ...
            w = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int);
        }
    }
    if n > 2 as libc::c_int && lua_isuserdata(L, 3 as libc::c_int) != 0 {
        user = *(luaL_checkudata(
            L,
            3 as libc::c_int,
            b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    if w > 1 as libc::c_int || w < 0 as libc::c_int {
        return luaL_error(
            L,
            b"skybox mobj index %d is out of range for P_SetSkyboxMobj argument #2 (expected 0 or 1)\0"
                as *const u8 as *const libc::c_char,
            w,
        );
    }
    if user.is_null() || P_IsLocalPlayer(user) != 0 {
        skyboxmo[w as usize] = mo;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pStartQuake(mut L: *mut lua_State) -> libc::c_int {
    let mut q_intensity: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut q_time: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    static mut q_epicenter: mappoint_t = {
    ...
    if !(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int) {
        luaL_checktype(L, 3 as libc::c_int, 5 as libc::c_int);
        lua_getfield(L, 3 as libc::c_int, b"x\0" as *const u8 as *const libc::c_char);
        if lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int {
            lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            lua_rawgeti(L, 3 as libc::c_int, 1 as libc::c_int);
        }
        if !(lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int) {
            q_epicenter.x = luaL_checknumber(L, -(1 as libc::c_int));
        } else {
            q_epicenter.x = 0 as libc::c_int;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        lua_getfield(L, 3 as libc::c_int, b"y\0" as *const u8 as *const libc::c_char);
        if lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int {
            lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            lua_rawgeti(L, 3 as libc::c_int, 2 as libc::c_int);
        }
        if !(lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int) {
            q_epicenter.y = luaL_checknumber(L, -(1 as libc::c_int));
        } else {
            q_epicenter.y = 0 as libc::c_int;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
        lua_getfield(L, 3 as libc::c_int, b"z\0" as *const u8 as *const libc::c_char);
        if lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int {
            lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            lua_rawgeti(L, 3 as libc::c_int, 3 as libc::c_int);
        }
        if !(lua_type(L, -(1 as libc::c_int)) == 0 as libc::c_int) {
            q_epicenter.z = luaL_checknumber(L, -(1 as libc::c_int));
        } else {
            q_epicenter.z = 0 as libc::c_int;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
...
unsafe extern "C" fn lib_evCrumbleChain(mut L: *mut lua_State) -> libc::c_int {
...
unsafe extern "C" fn lib_evStartCrumble(mut L: *mut lua_State) -> libc::c_int {
    let mut sec: *mut sector_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut sector_t);
    ...
    let mut floating: boolean = (!(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    let mut player: *mut player_t = 0 as *mut player_t;
    let mut origalpha: fixed_t = 0;
    let mut crumblereturn: boolean = (!(lua_type(L, 6 as libc::c_int)
        <= 0 as libc::c_int) && lua_toboolean(L, 6 as libc::c_int) != 0) as libc::c_int;
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    if !(lua_type(L, 4 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 4 as libc::c_int) != 0
    {
        player = *(luaL_checkudata(
            L,
            4 as libc::c_int,
    ...
    if !(lua_type(L, 5 as libc::c_int) == -(1 as libc::c_int)) {
        origalpha = luaL_checknumber(L, 5 as libc::c_int);
    } else {
        origalpha = (*rover).alpha;
    }
    lua_pushboolean(
        L,
        (EV_StartCrumble(sec, rover, floating, player, origalpha, crumblereturn)
            != 0 as libc::c_int) as libc::c_int,
    );
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_pGetZAt(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    if lua_type(L, 1 as libc::c_int) == 0 as libc::c_int {
        let mut z: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
        lua_pushnumber(L, P_GetZAt(0 as *const pslope_t, x, y, z));
    } else {
        let mut slope: *mut pslope_t = *(luaL_checkudata(
            L,
            1 as libc::c_int,
            b"PSLOPE_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut pslope_t);
        lua_pushnumber(L, P_GetSlopeZAt(slope, x, y));
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_pButteredSlope(mut L: *mut lua_State) -> libc::c_int {
    let mut mobj: *mut mobj_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn lib_rPointToAngle(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    lua_pushnumber(L, R_PointToAngle(x, y) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rPointToAngle2(mut L: *mut lua_State) -> libc::c_int {
    let mut px2: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut py2: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut px1: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut py1: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    lua_pushnumber(L, R_PointToAngle2(px2, py2, px1, py1) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rPointToDist(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    lua_pushnumber(L, R_PointToDist(x, y));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rPointToDist2(mut L: *mut lua_State) -> libc::c_int {
    let mut px2: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut py2: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut px1: fixed_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut py1: fixed_t = luaL_checknumber(L, 4 as libc::c_int);
    lua_pushnumber(L, R_PointToDist2(px2, py2, px1, py1));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rPointInSubsector(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    ...
    LUA_PushUserdata(
        L,
        R_PointInSubsector(x, y) as *mut libc::c_void,
        b"SUBSECTOR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rPointInSubsectorOrNil(mut L: *mut lua_State) -> libc::c_int {
    let mut x: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut y: fixed_t = luaL_checknumber(L, 2 as libc::c_int);
    let mut sub: *mut subsector_t = R_PointInSubsectorOrNull(x, y);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_rChar2Frame(mut L: *mut lua_State) -> libc::c_int {
    let mut p: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    lua_pushnumber(L, R_Char2Frame(*p) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rFrame2Char(mut L: *mut lua_State) -> libc::c_int {
    let mut ch: uint8_t = luaL_checknumber(L, 1 as libc::c_int) as uint8_t;
    let mut c: [libc::c_char; 2] = *::core::mem::transmute::<
        &[u8; 2],
        &mut [libc::c_char; 2],
    >(b"\0\0");
    c[0 as libc::c_int as usize] = R_Frame2Char(ch);
    c[1 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
    lua_pushstring(L, c.as_mut_ptr());
    lua_pushnumber(L, c[0 as libc::c_int as usize] as lua_Number);
    return 2 as libc::c_int;
}
unsafe extern "C" fn lib_rSetPlayerSkin(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    let mut j: int32_t = -(1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
    ...
    j = player.offset_from(players.as_mut_ptr()) as libc::c_long as int32_t;
    if lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int {
        return luaL_error(
            L,
            b"argument #2 not given (expected number or string)\0" as *const u8
                as *const libc::c_char,
        )
    } else if lua_type(L, 2 as libc::c_int) == 3 as libc::c_int {
        i = luaL_checknumber(L, 2 as libc::c_int);
        if i < 0 as libc::c_int || i >= numskins {
            return luaL_error(
                L,
                b"skin %d (argument #2) out of range (0 - %d)\0" as *const u8
                    as *const libc::c_char,
                i,
        ...
        let mut skinname: *const libc::c_char = luaL_checklstring(
            L,
            2 as libc::c_int,
            0 as *mut size_t,
        );
        ...
        if i == -(1 as libc::c_int) {
            return luaL_error(
                L,
                b"skin %s (argument 2) is not loaded\0" as *const u8
                    as *const libc::c_char,
                skinname,
            );
        }
    }
    if R_SkinUsable(j, i) == 0 {
        return luaL_error(
            L,
            b"skin %d (argument 2) not usable - check with R_SkinUsable(player_t, skin) first.\0"
                as *const u8 as *const libc::c_char,
            i,
        );
    }
...
unsafe extern "C" fn lib_rSkinUsable(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    ...
    if !player.is_null() {
        ...
        return luaL_error(
            L,
            b"player_t (argument #1) must be provided in multiplayer games\0"
                as *const u8 as *const libc::c_char,
        )
    }
    if lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int {
...
unsafe extern "C" fn lib_rCheckTextureNumForName(mut L: *mut lua_State) -> libc::c_int {
    let mut name: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    lua_pushnumber(L, R_CheckTextureNumForName(name));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rTextureNumForName(mut L: *mut lua_State) -> libc::c_int {
    let mut name: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    lua_pushnumber(L, R_TextureNumForName(name));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rCheckTextureNameForNum(mut L: *mut lua_State) -> libc::c_int {
    let mut num: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    lua_pushstring(L, R_CheckTextureNameForNum(num));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rTextureNameForNum(mut L: *mut lua_State) -> libc::c_int {
    let mut num: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    lua_pushstring(L, R_TextureNameForNum(num));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rGetColorByName(mut L: *mut lua_State) -> libc::c_int {
    let mut colorname: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    lua_pushnumber(L, R_GetColorByName(colorname) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rGetSuperColorByName(mut L: *mut lua_State) -> libc::c_int {
    let mut colorname: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    lua_pushnumber(L, R_GetSuperColorByName(colorname) as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_rGetNameByColor(mut L: *mut lua_State) -> libc::c_int {
    ...
    lua_pushstring(L, (skincolors[colornum as usize].name).as_mut_ptr());
    return 1 as libc::c_int;
}
unsafe extern "C" fn GetValidSoundOrigin(
    mut L: *mut lua_State,
    mut origin: *mut *mut libc::c_void,
) -> libc::c_int {
    let mut type_0: *const libc::c_char = 0 as *const libc::c_char;
    lua_settop(L, 1 as libc::c_int);
    type_0 = GetUserdataUType(L);
    if fasticmp(type_0, b"mobj_t\0" as *const u8 as *const libc::c_char) != 0 {
        *origin = *(luaL_checkudata(
            L,
            1 as libc::c_int,
            b"MOBJ_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut mobj_t) as *mut libc::c_void;
        if (*origin).is_null() {
            return luaL_error(
                L,
                b"accessed mobj_t doesn't exist anymore, please check 'valid' before using mobj_t.\0"
        ...
        return 1 as libc::c_int;
    } else if fasticmp(type_0, b"sector_t\0" as *const u8 as *const libc::c_char) != 0 {
        *origin = *(luaL_checkudata(
            L,
            1 as libc::c_int,
            b"SECTOR_T*\0" as *const u8 as *const libc::c_char,
        ) as *mut *mut sector_t) as *mut libc::c_void;
        if (*origin).is_null() {
            return luaL_error(
                L,
                b"accessed sector_t doesn't exist anymore, please check 'valid' before using sector_t.\0"
        ...
        *origin = &mut (*(*origin as *mut sector_t)).soundorg as *mut degenmobj_t
            as *mut libc::c_void;
        return 1 as libc::c_int;
    }
    return luaL_error(
        L,
        b"accessed mobj_t/sector_t doesn't exist anymore, please check 'valid' before using mobj_t/sector_t.\0"
            as *const u8 as *const libc::c_char,
    );
}
unsafe extern "C" fn lib_sStartSound(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sound_id: sfxenum_t = luaL_checknumber(L, 2 as libc::c_int) as sfxenum_t;
    let mut player: *mut player_t = 0 as *mut player_t;
    if sound_id as libc::c_uint >= NUMSFX as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"sfx %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            sound_id as libc::c_uint,
            NUMSFX as libc::c_int - 1 as libc::c_int,
        );
    }
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    ...
    if !(lua_type(L, 1 as libc::c_int) == 0 as libc::c_int) {
        if GetValidSoundOrigin(L, &mut origin) == 0 {
            return 0 as libc::c_int;
        }
    }
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        if hud_running != 0 || hook_cmd_running != 0 {
            origin = 0 as *mut libc::c_void;
        }
        S_StartSound(origin, sound_id);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_sStartSoundAtVolume(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sound_id: sfxenum_t = luaL_checknumber(L, 2 as libc::c_int) as sfxenum_t;
    let mut volume: int32_t = luaL_checknumber(L, 3 as libc::c_int);
    let mut player: *mut player_t = 0 as *mut player_t;
    if sound_id as libc::c_uint >= NUMSFX as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sStopSound(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    if GetValidSoundOrigin(L, &mut origin) == 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sStopSoundByID(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sound_id: sfxenum_t = luaL_checknumber(L, 2 as libc::c_int) as sfxenum_t;
    if sound_id as libc::c_uint >= NUMSFX as libc::c_int as libc::c_uint {
        return luaL_error(
...
unsafe extern "C" fn lib_sChangeMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut position: uint32_t = 0;
    let mut prefadems: uint32_t = 0;
    let mut fadeinms: uint32_t = 0;
    let mut music_name: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut looping: boolean = (lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    let mut player: *mut player_t = 0 as *mut player_t;
    let mut music_flags: uint16_t = 0 as libc::c_int as uint16_t;
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    {
        player = *(luaL_checkudata(
    ...
    music_flags = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int) as uint16_t;
    position = luaL_optnumber(L, 5 as libc::c_int, 0 as libc::c_int) as uint32_t;
    prefadems = luaL_optnumber(L, 6 as libc::c_int, 0 as libc::c_int) as uint32_t;
    fadeinms = luaL_optnumber(L, 7 as libc::c_int, 0 as libc::c_int) as uint32_t;
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        S_ChangeMusicEx(music_name, music_flags, looping, position, prefadems, fadeinms);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_sSpeedMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut fixedspeed: fixed_t = luaL_checknumber(L, 1 as libc::c_int);
    let mut speed: libc::c_float = FixedToFloat(fixedspeed);
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 2 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 2 as libc::c_int) != 0
    {
...
unsafe extern "C" fn lib_sStopMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 1 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 1 as libc::c_int) != 0
    {
...
unsafe extern "C" fn lib_sSetInternalMusicVolume(mut L: *mut lua_State) -> libc::c_int {
    let mut volume: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 2 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 2 as libc::c_int) != 0
    {
    ...
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        S_SetInternalMusicVolume(volume as int32_t);
        lua_pushboolean(L, true_0 as libc::c_int);
    } else {
        lua_pushnil(L);
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sStopFadingMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 1 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 1 as libc::c_int) != 0
    {
...
unsafe extern "C" fn lib_sFadeMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut target_volume: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    let mut ms: uint32_t = 0;
    let mut source_volume: int32_t = 0;
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    {
        ...
        ms = luaL_checknumber(L, 2 as libc::c_int) as uint32_t;
        source_volume = -(1 as libc::c_int);
    } else if !(lua_type(L, 4 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 4 as libc::c_int) != 0
    {
        player = *(luaL_checkudata(
            L,
        ...
        source_volume = luaL_checknumber(L, 2 as libc::c_int);
        ms = luaL_checknumber(L, 3 as libc::c_int) as uint32_t;
    } else if luaL_optnumber(L, 3 as libc::c_int, 2147483647 as libc::c_int)
    ...
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        lua_pushboolean(
            L,
            S_FadeMusicFromVolume(target_volume as uint8_t, source_volume as int16_t, ms),
        );
    } else {
        lua_pushnil(L);
    }
...
unsafe extern "C" fn lib_sFadeOutStopMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut ms: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    let mut player: *mut player_t = 0 as *mut player_t;
    if !(lua_type(L, 2 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 2 as libc::c_int) != 0
    {
...
unsafe extern "C" fn lib_sGetMusicLength(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, S_GetMusicLength() as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sGetMusicPosition(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(L, S_GetMusicPosition() as lua_Number);
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sSetMusicPosition(mut L: *mut lua_State) -> libc::c_int {
    let mut pos: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    lua_pushboolean(L, S_SetMusicPosition(pos));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sOriginPlaying(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
...
unsafe extern "C" fn lib_sIdPlaying(mut L: *mut lua_State) -> libc::c_int {
    let mut id: sfxenum_t = luaL_checknumber(L, 1 as libc::c_int) as sfxenum_t;
    if id as libc::c_uint >= NUMSFX as libc::c_int as libc::c_uint {
        return luaL_error(
            L,
            b"sfx %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            id as libc::c_uint,
...
unsafe extern "C" fn lib_sSoundPlaying(mut L: *mut lua_State) -> libc::c_int {
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut id: sfxenum_t = luaL_checknumber(L, 2 as libc::c_int) as sfxenum_t;
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_sStartMusicCaption(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    let mut caption: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut lifespan: uint16_t = luaL_checknumber(L, 2 as libc::c_int) as uint16_t;
    if !(lua_type(L, 3 as libc::c_int) == -(1 as libc::c_int))
        && lua_isuserdata(L, 3 as libc::c_int) != 0
    {
        player = *(luaL_checkudata(
    ...
    if lifespan as libc::c_int != 0 && (player.is_null() || P_IsLocalPlayer(player) != 0)
    {
        strlcpy(
        ...
        S_StartCaption(sfx_None, -(1 as libc::c_int), lifespan);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_sMusicType(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        lua_pushnumber(L, S_MusicType() as lua_Number);
    } else {
        lua_pushnil(L);
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sMusicPlaying(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sMusicPaused(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sMusicName(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sMusicExists(mut L: *mut lua_State) -> libc::c_int {
    let mut checkMIDI: boolean = (lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    let mut checkDigi: boolean = (lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int
        || lua_toboolean(L, 3 as libc::c_int) != 0) as libc::c_int;
    let mut music_name: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
...
unsafe extern "C" fn lib_sSetMusicLoopPoint(mut L: *mut lua_State) -> libc::c_int {
    let mut looppoint: uint32_t = luaL_checknumber(L, 1 as libc::c_int) as uint32_t;
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sGetMusicLoopPoint(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    if player.is_null() || P_IsLocalPlayer(player) != 0 {
        lua_pushnumber(L, S_GetMusicLoopPoint() as libc::c_int);
    } else {
        lua_pushnil(L);
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_sPauseMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_sResumeMusic(mut L: *mut lua_State) -> libc::c_int {
    let mut player: *mut player_t = 0 as *mut player_t;
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_gAddGametype(mut L: *mut lua_State) -> libc::c_int {
    let mut k: *const libc::c_char = 0 as *const libc::c_char;
    let mut i: lua_Number = 0;
    let mut gtname: *const libc::c_char = 0 as *const libc::c_char;
    let mut gtconst: *const libc::c_char = 0 as *const libc::c_char;
    let mut gtdescription: *const libc::c_char = 0 as *const libc::c_char;
    let mut newgtidx: int16_t = 0 as libc::c_int as int16_t;
    let mut newgtrules: uint32_t = 0 as libc::c_int as uint32_t;
    let mut newgttol: uint32_t = 0 as libc::c_int as uint32_t;
    let mut newgtpointlimit: int32_t = 0 as libc::c_int;
    let mut newgttimelimit: int32_t = 0 as libc::c_int;
    let mut newgtleftcolor: uint8_t = 0 as libc::c_int as uint8_t;
    let mut newgtrightcolor: uint8_t = 0 as libc::c_int as uint8_t;
    let mut newgtrankingstype: int16_t = -(1 as libc::c_int) as int16_t;
    let mut newgtinttype: libc::c_int = 0 as libc::c_int;
    luaL_checktype(L, 1 as libc::c_int, 5 as libc::c_int);
    lua_settop(L, 1 as libc::c_int);
    if lua_lumploading == 0 {
        return luaL_error(
    ...
    if gametypecount as libc::c_int == 128 as libc::c_int {
        return luaL_error(
            L,
            b"Ran out of free gametype slots!\0" as *const u8 as *const libc::c_char,
        );
    }
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        i = 0 as libc::c_int;
        k = 0 as *const libc::c_char;
        if lua_isnumber(L, 2 as libc::c_int) != 0 {
            i = lua_tonumber(L, 2 as libc::c_int);
        } else if lua_isstring(L, 2 as libc::c_int) != 0 {
            k = lua_tolstring(L, 2 as libc::c_int, 0 as *mut size_t);
        }
        if i == 1 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"name\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isstring(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'name' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 4 as libc::c_int),
                        lua_typename(L, lua_type(L, -(1 as libc::c_int))),
                    ),
                );
            }
            gtname = Z_StrDup(lua_tolstring(L, 3 as libc::c_int, 0 as *mut size_t));
        } else if i == 2 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"identifier\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isstring(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'identifier' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 4 as libc::c_int),
            ...
            gtconst = Z_StrDup(lua_tolstring(L, 3 as libc::c_int, 0 as *mut size_t));
        } else if i == 3 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"rules\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'rules' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
                        lua_typename(L, lua_type(L, -(1 as libc::c_int))),
                    ),
                );
            }
            newgtrules = lua_tonumber(L, 3 as libc::c_int) as uint32_t;
        } else if i == 4 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"typeoflevel\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'typeoflevel' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgttol = lua_tonumber(L, 3 as libc::c_int) as uint32_t;
        } else if i == 5 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"rankingtype\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'rankingtype' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtrankingstype = lua_tonumber(L, 3 as libc::c_int) as int16_t;
        } else if i == 6 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"intermissiontype\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'intermissiontype' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtinttype = lua_tonumber(L, 3 as libc::c_int);
        } else if i == 7 as libc::c_int
            || !k.is_null()
                && fasticmp(
                    k,
                    b"defaultpointlimit\0" as *const u8 as *const libc::c_char,
                ) != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'defaultpointlimit' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtpointlimit = lua_tonumber(L, 3 as libc::c_int);
        } else if i == 8 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"defaulttimelimit\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'defaulttimelimit' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgttimelimit = lua_tonumber(L, 3 as libc::c_int);
        } else if i == 9 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"description\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isstring(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'description' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 4 as libc::c_int),
            ...
            gtdescription = Z_StrDup(
                lua_tolstring(L, 3 as libc::c_int, 0 as *mut size_t),
            );
        } else if i == 10 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"headerleftcolor\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'headerleftcolor' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtleftcolor = lua_tonumber(L, 3 as libc::c_int) as uint8_t;
        } else if i == 11 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"headerrightcolor\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'headerrightcolor' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtrightcolor = lua_tonumber(L, 3 as libc::c_int) as uint8_t;
        } else if i == 0
            && (!k.is_null()
                && fasticmp(k, b"headercolor\0" as *const u8 as *const libc::c_char)
                    != 0)
        {
            if lua_isnumber(L, 3 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'headercolor' in table passed to 'G_AddGametype' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 3 as libc::c_int),
            ...
            newgtrightcolor = lua_tonumber(L, 3 as libc::c_int) as uint8_t;
            newgtleftcolor = newgtrightcolor;
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    }
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    if gtname.is_null() {
        gtname = Z_StrDup(b"Unnamed gametype\0" as *const u8 as *const libc::c_char);
    }
    if gtdescription.is_null() {
        gtdescription = Z_StrDup(b"???\0" as *const u8 as *const libc::c_char);
    }
    ...
    strncpy(
        (gametypedesc[newgtidx as usize].notes).as_mut_ptr(),
        gtdescription,
        441 as libc::c_int as libc::c_ulong,
    );
    if newgtrankingstype as libc::c_int == -(1 as libc::c_int) {
        newgtrankingstype = newgtidx;
    }
    gametyperankings[newgtidx as usize] = newgtrankingstype;
    intermissiontypes[newgtidx as usize] = newgtinttype as intertype_t;
    pointlimits[newgtidx as usize] = newgtpointlimit;
    timelimits[newgtidx as usize] = newgttimelimit;
    Gametype_Names[newgtidx as usize] = gtname;
    if gtconst.is_null() {
        gtconst = gtname;
    }
    ...
    CONS_Printf(
        b"Added gametype %s\n\0" as *const u8 as *const libc::c_char,
        Gametype_Names[newgtidx as usize],
    );
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_gAddPlayer(mut L: *mut lua_State) -> libc::c_int {
    let mut i: int16_t = 0;
    let mut newplayernum: int16_t = 0;
    let mut newplayer: *mut player_t = 0 as *mut player_t;
    let mut skinnum: int8_t = 0 as libc::c_int as int8_t;
    let mut bot: int8_t = 0;
    ...
    if !(lua_type(L, 1 as libc::c_int) <= 0 as libc::c_int) {
        skinnum = R_SkinAvailable(
            luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t),
        ) as int8_t;
        skinnum = (if (skinnum as libc::c_int) < 0 as libc::c_int {
            0 as libc::c_int
        } else {
            skinnum as libc::c_int
        }) as int8_t;
    }
    if !(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int) {
        (*newplayer)
            .skincolor = R_GetColorByName(
            luaL_checklstring(L, 2 as libc::c_int, 0 as *mut size_t),
        );
    } else {
        (*newplayer).skincolor = skins[skinnum as usize].prefcolor;
    }
    strcpy(
        (player_names[newplayernum as usize]).as_mut_ptr(),
        (skins[skinnum as usize].realname).as_mut_ptr(),
    );
    if !(lua_type(L, 3 as libc::c_int) <= 0 as libc::c_int) {
        strlcpy(
            (player_names[newplayernum as usize]).as_mut_ptr(),
            luaL_checklstring(L, 3 as libc::c_int, 0 as *mut size_t),
            ::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong,
        );
    }
    bot = luaL_optnumber(L, 4 as libc::c_int, 3 as libc::c_int) as int8_t;
    (*newplayer)
        .bot = (if bot as libc::c_int >= BOT_NONE as libc::c_int
        && bot as libc::c_int <= BOT_MPAI as libc::c_int
    {
        bot as libc::c_int
    } else {
        BOT_MPAI as libc::c_int
    }) as uint8_t;
    if (*newplayer).bot as libc::c_int == BOT_2PAI as libc::c_int
        || (*newplayer).bot as libc::c_int == BOT_2PHUMAN as libc::c_int
    {
        B_UpdateBotleader(newplayer);
    }
    SetPlayerSkinByNum(newplayernum as int32_t, skinnum as int32_t);
    if netgame != 0 {
        let mut joinmsg: [libc::c_char; 256] = [0; 256];
        player_names[newplayernum
            as usize][(::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
            .wrapping_sub(8 as libc::c_int as libc::c_ulong)
            as usize] = '\0' as i32 as libc::c_char;
        strcpy(
            joinmsg.as_mut_ptr(),
            b"\x82*Bot %s has joined the game (player %d)\0" as *const u8
                as *const libc::c_char,
        );
        strcpy(
            joinmsg.as_mut_ptr(),
        ...
        strlcat(
            (player_names[newplayernum as usize]).as_mut_ptr(),
            b"\x84[BOT]\x80\0" as *const u8 as *const libc::c_char,
            ::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong,
        );
    }
    LUA_PushUserdata(
        L,
        newplayer as *mut libc::c_void,
        b"PLAYER_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gRemovePlayer(mut L: *mut lua_State) -> libc::c_int {
    let mut pnum: uint8_t = -(1 as libc::c_int) as uint8_t;
    if !(lua_type(L, 1 as libc::c_int) <= 0 as libc::c_int) {
        pnum = luaL_checknumber(L, 1 as libc::c_int) as uint8_t;
    } else {
        return luaL_error(
            L,
            b"argument #1 not given (expected number)\0" as *const u8
                as *const libc::c_char,
        )
    }
    if pnum as libc::c_int >= 32 as libc::c_int {
        return luaL_error(
            L,
            b"playernum %d out of range (0 - %d)\0" as *const u8 as *const libc::c_char,
            pnum as libc::c_int,
            32 as libc::c_int - 1 as libc::c_int,
        );
    }
    if playeringame[pnum as usize] != 0 {
        if players[pnum as usize].bot as libc::c_int == BOT_NONE as libc::c_int {
            return luaL_error(
                L,
                b"G_RemovePlayer can only be used on players with a bot value other than BOT_NONE.\0"
                    as *const u8 as *const libc::c_char,
            )
        } else {
            players[pnum as usize].removing = true_0 as libc::c_int;
            lua_pushboolean(L, true_0 as libc::c_int);
            return 1 as libc::c_int;
        }
    }
...
unsafe extern "C" fn lib_gSetUsedCheats(mut L: *mut lua_State) -> libc::c_int {
    let mut silent: boolean = (!(lua_type(L, 1 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 1 as libc::c_int) != 0) as libc::c_int;
    G_SetUsedCheats(silent);
    return 0 as libc::c_int;
}
unsafe extern "C" fn Lcheckmapnumber(
    mut L: *mut lua_State,
    mut idx: libc::c_int,
    mut fun: *const libc::c_char,
) -> libc::c_int {
    if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0
    {
        return luaL_optnumber(L, idx, gamemap as lua_Number)
    } else if lua_type(L, idx) <= 0 as libc::c_int {
        return luaL_error(
            L,
            b"%s can only be used without a parameter while in a level.\0" as *const u8
                as *const libc::c_char,
            fun,
        )
    } else {
...
unsafe extern "C" fn lib_gBuildMapName(mut L: *mut lua_State) -> libc::c_int {
    let mut map: int32_t = Lcheckmapnumber(
        L,
        1 as libc::c_int,
        b"G_BuildMapName\0" as *const u8 as *const libc::c_char,
    );
    lua_pushstring(L, G_BuildMapName(map));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gBuildMapTitle(mut L: *mut lua_State) -> libc::c_int {
    let mut map: int32_t = Lcheckmapnumber(
        L,
        1 as libc::c_int,
        b"G_BuildMapTitle\0" as *const u8 as *const libc::c_char,
    );
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    if map < 1 as libc::c_int || map > 1035 as libc::c_int {
        return luaL_error(
            L,
            b"map number %d out of range (1 - %d)\0" as *const u8 as *const libc::c_char,
            map,
            1035 as libc::c_int,
        );
    }
    ...
    Z_Free(name as *mut libc::c_void);
    return 1 as libc::c_int;
}
unsafe extern "C" fn Lpushdim(
    mut L: *mut lua_State,
    mut c: libc::c_int,
    mut v: *mut searchdim,
) {
    let mut i: libc::c_int = 0;
    lua_createtable(L, c, 0 as libc::c_int);
    i = 0 as libc::c_int;
    while i < c {
        lua_createtable(L, 0 as libc::c_int, 2 as libc::c_int);
        lua_pushnumber(L, (*v.offset(i as isize)).pos as lua_Number);
        lua_setfield(
            L,
            -(2 as libc::c_int),
            b"pos\0" as *const u8 as *const libc::c_char,
        );
        lua_pushnumber(L, (*v.offset(i as isize)).siz as lua_Number);
        lua_setfield(
            L,
            -(2 as libc::c_int),
            b"siz\0" as *const u8 as *const libc::c_char,
        );
        lua_rawseti(L, -(2 as libc::c_int), 1 as libc::c_int + i);
        i += 1;
        i;
    }
}
unsafe extern "C" fn lib_gFindMap(mut L: *mut lua_State) -> libc::c_int {
    let mut query: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut map: int32_t = 0;
    let mut realname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut frc: int32_t = 0;
    let mut frv: *mut mapsearchfreq_t = 0 as *mut mapsearchfreq_t;
    let mut i: int32_t = 0;
    map = G_FindMap(query, &mut realname, &mut frv, &mut frc);
    lua_settop(L, 0 as libc::c_int);
    lua_pushnumber(L, map);
    lua_pushstring(L, realname);
    lua_createtable(L, frc, 0 as libc::c_int);
    i = 0 as libc::c_int;
    while i < frc {
        lua_createtable(L, 0 as libc::c_int, 4 as libc::c_int);
        lua_pushnumber(L, (*frv.offset(i as isize)).mapnum as lua_Number);
        lua_setfield(
            L,
            -(2 as libc::c_int),
            b"mapnum\0" as *const u8 as *const libc::c_char,
        );
        Lpushdim(
            L,
            (*frv.offset(i as isize)).matchc as libc::c_int,
            (*frv.offset(i as isize)).matchd,
        );
        lua_setfield(
            L,
            -(2 as libc::c_int),
            b"matchd\0" as *const u8 as *const libc::c_char,
        );
        Lpushdim(
            L,
            (*frv.offset(i as isize)).keywhc as libc::c_int,
            (*frv.offset(i as isize)).keywhd,
        );
        lua_setfield(
            L,
            -(2 as libc::c_int),
            b"keywhd\0" as *const u8 as *const libc::c_char,
        );
        lua_pushnumber(L, (*frv.offset(i as isize)).total as lua_Number);
        lua_setfield(
            L,
            -(2 as libc::c_int),
...
unsafe extern "C" fn lib_gFindMapByNameOrCode(mut L: *mut lua_State) -> libc::c_int {
    let mut query: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    ...
    let mut map: int32_t = 0;
    let mut realname: *mut libc::c_char = 0 as *mut libc::c_char;
    map = G_FindMapByNameOrCode(query, &mut realname);
    lua_pushnumber(L, map);
    if map != 0 {
        lua_pushstring(L, realname);
        Z_Free(realname as *mut libc::c_void);
...
unsafe extern "C" fn lib_gDoReborn(mut L: *mut lua_State) -> libc::c_int {
    let mut playernum: int32_t = luaL_checknumber(L, 1 as libc::c_int);
    if hud_running != 0 {
        return luaL_error(
            L,
            b"HUD rendering code should not call this function!\0" as *const u8
...
unsafe extern "C" fn lib_gSetCustomExitVars(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    if hud_running != 0 {
        return luaL_error(
            L,
    ...
    if n >= 1 as libc::c_int {
        nextmapoverride = luaL_optnumber(L, 1 as libc::c_int, 0 as libc::c_int)
            as int16_t;
        skipstats = luaL_optnumber(L, 2 as libc::c_int, 0 as libc::c_int) as int16_t
            as uint8_t;
        nextgametype = luaL_optnumber(L, 3 as libc::c_int, -(1 as libc::c_int))
            as int16_t;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_gEnoughPlayersFinished(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gExitLevel(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    if hud_running != 0 {
        return luaL_error(
            L,
...
unsafe extern "C" fn lib_gIsSpecialStage(mut L: *mut lua_State) -> libc::c_int {
    let mut mapnum: int32_t = luaL_optnumber(L, 1 as libc::c_int, gamemap as lua_Number);
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gGametypeUsesLives(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gGametypeUsesCoopLives(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gGametypeUsesCoopStarposts(
    mut L: *mut lua_State,
) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
...
unsafe extern "C" fn lib_gGametypeHasTeams(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gGametypeHasSpectators(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gRingSlingerGametype(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gPlatformGametype(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gCoopGametype(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gTagGametype(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gCompetitionGametype(mut L: *mut lua_State) -> libc::c_int {
    if !(gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || titlemapinaction as libc::c_int != 0)
    {
        return luaL_error(
...
unsafe extern "C" fn lib_gTicsToHours(mut L: *mut lua_State) -> libc::c_int {
    let mut rtic: tic_t = luaL_checknumber(L, 1 as libc::c_int) as tic_t;
    lua_pushnumber(L, G_TicsToHours(rtic));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gTicsToMinutes(mut L: *mut lua_State) -> libc::c_int {
    let mut rtic: tic_t = luaL_checknumber(L, 1 as libc::c_int) as tic_t;
    let mut rfull: boolean = (!(lua_type(L, 2 as libc::c_int) <= 0 as libc::c_int)
        && lua_toboolean(L, 2 as libc::c_int) != 0) as libc::c_int;
    lua_pushnumber(L, G_TicsToMinutes(rtic, rfull));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gTicsToSeconds(mut L: *mut lua_State) -> libc::c_int {
    let mut rtic: tic_t = luaL_checknumber(L, 1 as libc::c_int) as tic_t;
    lua_pushnumber(L, G_TicsToSeconds(rtic));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gTicsToCentiseconds(mut L: *mut lua_State) -> libc::c_int {
    let mut rtic: tic_t = luaL_checknumber(L, 1 as libc::c_int) as tic_t;
    lua_pushnumber(L, G_TicsToCentiseconds(rtic));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_gTicsToMilliseconds(mut L: *mut lua_State) -> libc::c_int {
    let mut rtic: tic_t = luaL_checknumber(L, 1 as libc::c_int) as tic_t;
    lua_pushnumber(L, G_TicsToMilliseconds(rtic));
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_getTimeMicros(mut L: *mut lua_State) -> libc::c_int {
    lua_pushnumber(
        L,
        (I_GetPreciseTime()
...
static mut lib: [luaL_Reg; 248] = unsafe {
    [
        {
            let mut init = luaL_Reg {
                name: b"print\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_print as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"chatprint\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_chatprint as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"chatprintf\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_chatprintf as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"userdataType\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_userdataType
        ...
        {
            let mut init = luaL_Reg {
                name: b"registerMetatable\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"userdataMetatable\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_userdataMetatable
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"IsPlayerAdmin\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_isPlayerAdmin
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"reserveLuabanks\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_reserveLuabanks
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"M_MoveColorAfter\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMoveColorAfter
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"M_MoveColorBefore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMoveColorBefore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"M_GetColorAfter\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetColorAfter
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"M_GetColorBefore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetColorBefore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"M_MapNumber\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_mMapNumber as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_RandomFixed\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRandomFixed
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RandomByte\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRandomByte
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RandomKey\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRandomKey as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_RandomRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRandomRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SignedRandom\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSignedRandom
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RandomChance\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRandomChance
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_AproxDistance\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pAproxDistance
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ClosestPointOnLine\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pClosestPointOnLine
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PointOnLineSide\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPointOnLineSide
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckMeleeRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckMeleeRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_JetbCheckMeleeRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pJetbCheckMeleeRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FaceStabCheckMeleeRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFaceStabCheckMeleeRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SkimCheckMeleeRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSkimCheckMeleeRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckMissileRange\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckMissileRange
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_NewChaseDir\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pNewChaseDir
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_LookForPlayers\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pLookForPlayers
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnMobj as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnMobjFromMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnMobjFromMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RemoveMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRemoveMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_IsValidSprite2\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pIsValidSprite2
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnLockOn\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnLockOn
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnXYZMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnXYZMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnPointMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnPointMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnAlteredDirectionMissile\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pSpawnAlteredDirectionMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ColorTeamMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pColorTeamMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SPMAngle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSPMAngle as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnPlayerMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnPlayerMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_MobjFlip\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMobjFlip as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_GetMobjGravity\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetMobjGravity
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_WeaponOrPanel\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pWeaponOrPanel
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FlashPal\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFlashPal as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_GetClosestAxis\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetClosestAxis
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnParaloop\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnParaloop
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_BossTargetPlayer\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pBossTargetPlayer
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SupermanLook4Players\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSupermanLook4Players
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SetScale\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetScale as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_InsideANonSolidFFloor\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pInsideANonSolidFFloor
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckDeathPitCollide\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckDeathPitCollide
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckSolidLava\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckSolidLava
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CanRunOnWater\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCanRunOnWater
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_MaceRotate\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMaceRotate
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CreateFloorSpriteSlope\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCreateFloorSpriteSlope
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RemoveFloorSpriteSlope\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRemoveFloorSpriteSlope
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RailThinker\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRailThinker
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_XYMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pXYMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RingXYMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRingXYMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SceneryXYMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSceneryXYMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ZMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pZMovement as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_RingZMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRingZMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SceneryZMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSceneryZMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerZMovement\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerZMovement
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GetPlayerHeight\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetPlayerHeight
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GetPlayerSpinHeight\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetPlayerSpinHeight
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GetPlayerControlDirection\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pGetPlayerControlDirection
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_AddPlayerScore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pAddPlayerScore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_StealPlayerScore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pStealPlayerScore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GetJumpFlags\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetJumpFlags
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerInPain\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerInPain
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoPlayerPain\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoPlayerPain
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ResetPlayer\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pResetPlayer
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerCanDamage\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerCanDamage
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerFullbright\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerFullbright
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_IsObjectInGoop\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pIsObjectInGoop
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_IsObjectOnGround\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pIsObjectOnGround
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_InSpaceSector\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pInSpaceSector
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_InQuicksand\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pInQuicksand
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_InJumpFlipSector\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pInJumpFlipSector
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SetObjectMomZ\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetObjectMomZ
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayJingle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayJingle
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayJingleMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayJingleMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RestoreMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRestoreMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnShieldOrb\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnShieldOrb
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnGhostMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnGhostMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GivePlayerRings\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGivePlayerRings
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GivePlayerLives\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGivePlayerLives
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GiveCoopLives\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGiveCoopLives
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ResetScore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pResetScore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoJumpShield\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoJumpShield
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoBubbleBounce\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoBubbleBounce
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_BlackOw\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pBlackOw as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_ElementalFire\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pElementalFire
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnSkidDust\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnSkidDust
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_MovePlayer\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMovePlayer
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoPlayerFinish\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoPlayerFinish
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoPlayerExit\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoPlayerExit
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_InstaThrust\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pInstaThrust
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ReturnThrustX\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pReturnThrustX
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ReturnThrustY\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pReturnThrustY
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_LookForEnemies\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pLookForEnemies
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_NukeEnemies\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pNukeEnemies
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_Earthquake\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pEarthquake
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_HomingAttack\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pHomingAttack
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SuperReady\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSuperReady
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoJump\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoJump as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnThokMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnThokMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnSpinMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnSpinMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_Telekinesis\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pTelekinesis
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SwitchShield\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSwitchShield
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerCanEnterSpinGaps\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerCanEnterSpinGaps
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerShouldUseSpinHeight\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pPlayerShouldUseSpinHeight
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckPosition\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckPosition
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_TryMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pTryMove as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_Move\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMove as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_TeleportMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pTeleportMove
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SetOrigin\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetOrigin as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_MoveOrigin\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pMoveOrigin
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SlideMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSlideMove as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_BounceMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pBounceMove
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckSight\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckSight
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CheckHoopPosition\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCheckHoopPosition
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RadiusAttack\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRadiusAttack
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FloorzAtPos\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFloorzAtPos
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CeilingzAtPos\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCeilingzAtPos
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoSpring\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoSpring as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_TryCameraMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pTryCameraMove
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_TeleportCameraMove\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pTeleportCameraMove
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_RemoveShield\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pRemoveShield
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DamageMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDamageMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_KillMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pKillMobj as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerRingBurst\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerRingBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerWeaponPanelBurst\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerWeaponPanelBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerWeaponAmmoBurst\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerWeaponAmmoBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerWeaponPanelOrAmmoBurst\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pPlayerWeaponPanelOrAmmoBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerEmeraldBurst\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerEmeraldBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerFlagBurst\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayerFlagBurst
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayRinglossSound\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayRinglossSound
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayDeathSound\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayDeathSound
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayVictorySound\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayVictorySound
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayLivesJingle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pPlayLivesJingle
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_CanPickupItem\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pCanPickupItem
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoNightsScore\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoNightsScore
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoMatchSuper\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pDoMatchSuper
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_Thrust\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pThrust as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_SetMobjStateNF\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetMobjStateNF
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_DoSuperTransformation\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ExplodeMissile\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pExplodeMissile
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_MobjTouchingSectorSpecial\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pMobjTouchingSectorSpecial
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_ThingOnSpecial3DFloor\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pThingOnSpecial3DFloor
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_MobjTouchingSectorSpecialFlag\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pMobjTouchingSectorSpecialFlag
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerTouchingSectorSpecial\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pPlayerTouchingSectorSpecial
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_PlayerTouchingSectorSpecialFlag\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pPlayerTouchingSectorSpecialFlag
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindLowestFloorSurrounding\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pFindLowestFloorSurrounding
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindHighestFloorSurrounding\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pFindHighestFloorSurrounding
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindNextHighestFloor\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFindNextHighestFloor
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindNextLowestFloor\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFindNextLowestFloor
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindLowestCeilingSurrounding\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pFindLowestCeilingSurrounding
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindHighestCeilingSurrounding\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_pFindHighestCeilingSurrounding
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FindSpecialLineFromTag\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFindSpecialLineFromTag
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SwitchWeather\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSwitchWeather
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_LinedefExecute\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pLinedefExecute
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SpawnLightningFlash\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSpawnLightningFlash
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_FadeLight\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pFadeLight as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_IsFlagAtBase\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pIsFlagAtBase
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SetupLevelSky\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetupLevelSky
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_SetSkyboxMobj\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pSetSkyboxMobj
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_StartQuake\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pStartQuake
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"EV_CrumbleChain\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_evCrumbleChain
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"EV_StartCrumble\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_evStartCrumble
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"P_GetZAt\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pGetZAt as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"P_ButteredSlope\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_pButteredSlope
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointToAngle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointToAngle
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointToAngle2\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointToAngle2
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointToDist\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointToDist
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointToDist2\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointToDist2
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointInSubsector\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointInSubsector
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_PointInSubsectorOrNil\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rPointInSubsectorOrNil
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_Char2Frame\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rChar2Frame
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_Frame2Char\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rFrame2Char
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_SetPlayerSkin\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rSetPlayerSkin
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_SkinUsable\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rSkinUsable
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_CheckTextureNumForName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rCheckTextureNumForName
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_TextureNumForName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rTextureNumForName
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_CheckTextureNameForNum\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rCheckTextureNameForNum
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_TextureNameForNum\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rTextureNameForNum
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_GetColorByName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rGetColorByName
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_GetSuperColorByName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rGetSuperColorByName
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"R_GetNameByColor\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_rGetNameByColor
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StartSound\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStartSound
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StartSoundAtVolume\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStartSoundAtVolume
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StopSound\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStopSound as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_StopSoundByID\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStopSoundByID
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_ChangeMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sChangeMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_SpeedMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sSpeedMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StopMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStopMusic as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_SetInternalMusicVolume\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StopFadingMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_FadeMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sFadeMusic as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_FadeOutStopMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sFadeOutStopMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_GetMusicLength\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sGetMusicLength
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_GetMusicPosition\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sGetMusicPosition
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_SetMusicPosition\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sSetMusicPosition
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_OriginPlaying\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sOriginPlaying
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_IdPlaying\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sIdPlaying as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_SoundPlaying\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sSoundPlaying
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_StartMusicCaption\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sStartMusicCaption
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_MusicType\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sMusicType as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_MusicPlaying\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sMusicPlaying
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_MusicPaused\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sMusicPaused
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_MusicName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sMusicName as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"S_MusicExists\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sMusicExists
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_SetMusicLoopPoint\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sSetMusicLoopPoint
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_GetMusicLoopPoint\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sGetMusicLoopPoint
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_PauseMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sPauseMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"S_ResumeMusic\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_sResumeMusic
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_AddGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gAddGametype
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_AddPlayer\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gAddPlayer as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"G_RemovePlayer\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gRemovePlayer
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_SetUsedCheats\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gSetUsedCheats
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_BuildMapName\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gBuildMapName
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_BuildMapTitle\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gBuildMapTitle
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_FindMap\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gFindMap as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"G_FindMapByNameOrCode\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_DoReborn\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gDoReborn as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"G_SetCustomExitVars\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_EnoughPlayersFinished\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_ExitLevel\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gExitLevel as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"G_IsSpecialStage\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gIsSpecialStage
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_GametypeUsesLives\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gGametypeUsesLives
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_GametypeUsesCoopLives\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gGametypeUsesCoopLives
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_GametypeUsesCoopStarposts\0" as *const u8
                    as *const libc::c_char,
                func: Some(
                    lib_gGametypeUsesCoopStarposts
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_GametypeHasTeams\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gGametypeHasTeams
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_GametypeHasSpectators\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gGametypeHasSpectators
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_RingSlingerGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gRingSlingerGametype
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_PlatformGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_CoopGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gCoopGametype
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TagGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTagGametype
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_CompetitionGametype\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gCompetitionGametype
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TicsToHours\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTicsToHours
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TicsToMinutes\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTicsToMinutes
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TicsToSeconds\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTicsToSeconds
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TicsToCentiseconds\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTicsToCentiseconds
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"G_TicsToMilliseconds\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_gTicsToMilliseconds
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        ...
        {
            let mut init = luaL_Reg {
                name: b"getTimeMicros\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_getTimeMicros
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
...
#[no_mangle]
pub unsafe extern "C" fn LUA_BaseLib(mut L: *mut lua_State) -> libc::c_int {
    lua_pushlstring(
        L,
    ...
    lua_pushcclosure(
        L,
        Some(lib_concat as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(L, -(2 as libc::c_int), b"__add\0" as *const u8 as *const libc::c_char);
    lua_settop(L, -(2 as libc::c_int) - 1 as libc::c_int);
    lua_createtable(L, 0 as libc::c_int, 0 as libc::c_int);
    lua_setfield(
        L,
        -(10000 as libc::c_int),
        b"LUA_VARS\0" as *const u8 as *const libc::c_char,
    );
    lua_pushvalue(L, -(10002 as libc::c_int));
    luaL_register(L, 0 as *const libc::c_char, lib.as_mut_ptr());
    return 0 as libc::c_int;
}
