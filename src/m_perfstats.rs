...
extern "C" {
    ...
    static mut cv_ps_samplesize: consvar_t;
    static mut cv_ps_descriptor: consvar_t;
    static mut ps_prevframetime: precise_t;
    static mut ps_rendercalltime: ps_metric_t;
    static mut ps_otherrendertime: ps_metric_t;
    static mut ps_uitime: ps_metric_t;
    static mut ps_swaptime: ps_metric_t;
    static mut ps_bsptime: ps_metric_t;
    static mut ps_sw_portaltime: ps_metric_t;
    static mut ps_sw_planetime: ps_metric_t;
    static mut ps_sw_maskedtime: ps_metric_t;
    static mut ps_numbspcalls: ps_metric_t;
    static mut ps_numsprites: ps_metric_t;
    static mut ps_numdrawnodes: ps_metric_t;
    static mut ps_numpolyobjects: ps_metric_t;
    static mut ps_sw_spritecliptime: ps_metric_t;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ps_hookinfo_t {
    pub time_taken: ps_metric_t,
    pub short_src: [libc::c_char; 60],
}
pub const PU_STATIC: C2RustUnnamed_6 = 1;
pub const PU_PERFSTATS: C2RustUnnamed_6 = 3;
pub type perfstatrow_t = perfstatrow;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct perfstatrow {
    pub lores_label: *const libc::c_char,
    pub hires_label: *const libc::c_char,
    pub metric: *mut ps_metric_t,
    pub flags: uint8_t,
}
...
static mut ps_frametime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
...
#[no_mangle]
pub static mut ps_tictime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_playerthink_time: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_thinkertime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_thlist_times: [ps_metric_t; 5] = [ps_metric_t {
    value: C2RustUnnamed_5 { p: 0 },
    history: 0 as *const libc::c_void as *mut libc::c_void,
}; 5];
static mut ps_thinkercount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_polythcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_mainthcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_mobjcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_regularcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_scenerycount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_nothinkcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_dynslopethcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_precipcount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
static mut ps_removecount: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_checkposition_calls: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_lua_thinkframe_time: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_lua_mobjhooks: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut ps_otherlogictime: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_5 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub static mut rendertime_rows: [perfstatrow_t; 11] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"frmtime\0" as *const u8 as *const libc::c_char,
                hires_label: b"Frame time:    \0" as *const u8 as *const libc::c_char,
                metric: &ps_frametime as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"drwtime\0" as *const u8 as *const libc::c_char,
                hires_label: b"3d rendering:  \0" as *const u8 as *const libc::c_char,
                metric: &ps_rendercalltime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" bsptime\0" as *const u8 as *const libc::c_char,
                hires_label: b" RenderBSPNode: \0" as *const u8 as *const libc::c_char,
                metric: &ps_bsptime as *const ps_metric_t as *mut ps_metric_t,
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" sprclip\0" as *const u8 as *const libc::c_char,
                hires_label: b" R_ClipSprites: \0" as *const u8 as *const libc::c_char,
                metric: &ps_sw_spritecliptime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int)
                    as uint8_t,
            };
            init
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" portals\0" as *const u8 as *const libc::c_char,
                hires_label: b" Portals+Skybox:\0" as *const u8 as *const libc::c_char,
                metric: &ps_sw_portaltime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int)
                    as uint8_t,
            };
            init
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" planes \0" as *const u8 as *const libc::c_char,
                hires_label: b" R_DrawPlanes:  \0" as *const u8 as *const libc::c_char,
                metric: &ps_sw_planetime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int)
                    as uint8_t,
            };
            init
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" masked \0" as *const u8 as *const libc::c_char,
                hires_label: b" R_DrawMasked:  \0" as *const u8 as *const libc::c_char,
                metric: &ps_sw_maskedtime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int)
                    as uint8_t,
            };
            init
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" other  \0" as *const u8 as *const libc::c_char,
                hires_label: b" Other:         \0" as *const u8 as *const libc::c_char,
                metric: &ps_otherrendertime as *const ps_metric_t as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int)
                    as uint8_t,
            };
            init
        ...
        {
            let mut init = perfstatrow {
                lores_label: b"ui     \0" as *const u8 as *const libc::c_char,
                hires_label: b"UI render:     \0" as *const u8 as *const libc::c_char,
                metric: &ps_uitime as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"finupdt\0" as *const u8 as *const libc::c_char,
                hires_label: b"I_FinishUpdate:\0" as *const u8 as *const libc::c_char,
                metric: &ps_swaptime as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: 0 as *const libc::c_char,
                hires_label: 0 as *const libc::c_char,
                metric: 0 as *const ps_metric_t as *mut ps_metric_t,
                flags: 0,
            };
            init
        },
...
#[no_mangle]
pub static mut gamelogicbrief_row: [perfstatrow_t; 2] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"logic  \0" as *const u8 as *const libc::c_char,
                hires_label: b"Game logic:    \0" as *const u8 as *const libc::c_char,
                metric: &ps_tictime as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
...
#[no_mangle]
pub static mut commoncounter_rows: [perfstatrow_t; 5] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"bspcall\0" as *const u8 as *const libc::c_char,
                hires_label: b"BSP calls:   \0" as *const u8 as *const libc::c_char,
                metric: &ps_numbspcalls as *const ps_metric_t as *mut ps_metric_t,
        ...
        {
            let mut init = perfstatrow {
                lores_label: b"sprites\0" as *const u8 as *const libc::c_char,
                hires_label: b"Sprites:     \0" as *const u8 as *const libc::c_char,
                metric: &ps_numsprites as *const ps_metric_t as *mut ps_metric_t,
                flags: 0 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"drwnode\0" as *const u8 as *const libc::c_char,
                hires_label: b"Drawnodes:   \0" as *const u8 as *const libc::c_char,
                metric: &ps_numdrawnodes as *const ps_metric_t as *mut ps_metric_t,
                flags: 0 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"plyobjs\0" as *const u8 as *const libc::c_char,
                hires_label: b"Polyobjects: \0" as *const u8 as *const libc::c_char,
                metric: &ps_numpolyobjects as *const ps_metric_t as *mut ps_metric_t,
                flags: 0 as libc::c_int as uint8_t,
            };
            init
        },
...
#[no_mangle]
pub static mut interpolation_rows: [perfstatrow_t; 3] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"intpfrc\0" as *const u8 as *const libc::c_char,
                hires_label: b"Interp frac: \0" as *const u8 as *const libc::c_char,
                metric: &ps_interp_frac as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"intplag\0" as *const u8 as *const libc::c_char,
                hires_label: b"Interp lag:  \0" as *const u8 as *const libc::c_char,
                metric: &ps_interp_lag as *const ps_metric_t as *mut ps_metric_t,
                flags: 1 as libc::c_int as uint8_t,
            };
            init
        },
...
#[no_mangle]
pub static mut gamelogic_rows: [perfstatrow_t; 11] = [perfstatrow {
    lores_label: 0 as *const libc::c_char,
    hires_label: 0 as *const libc::c_char,
    metric: 0 as *const ps_metric_t as *mut ps_metric_t,
    flags: 0,
...
#[no_mangle]
pub static mut thinkercount_rows: [perfstatrow_t; 11] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"thnkers\0" as *const u8 as *const libc::c_char,
                hires_label: b"Thinkers:       \0" as *const u8 as *const libc::c_char,
                metric: &ps_thinkercount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" plyobjs\0" as *const u8 as *const libc::c_char,
                hires_label: b" Polyobjects:    \0" as *const u8 as *const libc::c_char,
                metric: &ps_polythcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" main   \0" as *const u8 as *const libc::c_char,
                hires_label: b" Main:           \0" as *const u8 as *const libc::c_char,
                metric: &ps_mainthcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" mobjs  \0" as *const u8 as *const libc::c_char,
                hires_label: b" Mobjs:          \0" as *const u8 as *const libc::c_char,
                metric: &ps_mobjcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"  regular\0" as *const u8 as *const libc::c_char,
                hires_label: b"  Regular:        \0" as *const u8 as *const libc::c_char,
                metric: &ps_regularcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"  scenery\0" as *const u8 as *const libc::c_char,
                hires_label: b"  Scenery:        \0" as *const u8 as *const libc::c_char,
                metric: &ps_scenerycount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"  nothink\0" as *const u8 as *const libc::c_char,
                hires_label: b"  Nothink:        \0" as *const u8 as *const libc::c_char,
                metric: &ps_nothinkcount as *const ps_metric_t as *mut ps_metric_t,
                flags: (32 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" dynslop\0" as *const u8 as *const libc::c_char,
                hires_label: b" Dynamic slopes: \0" as *const u8 as *const libc::c_char,
                metric: &ps_dynslopethcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" precip \0" as *const u8 as *const libc::c_char,
                hires_label: b" Precipitation:  \0" as *const u8 as *const libc::c_char,
                metric: &ps_precipcount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" remove \0" as *const u8 as *const libc::c_char,
                hires_label: b" Pending removal:\0" as *const u8 as *const libc::c_char,
                metric: &ps_removecount as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
...
#[no_mangle]
pub static mut misc_calls_rows: [perfstatrow_t; 3] = unsafe {
    [
        {
            let mut init = perfstatrow {
                lores_label: b"lmhook\0" as *const u8 as *const libc::c_char,
                hires_label: b"Lua mobj hooks: \0" as *const u8 as *const libc::c_char,
                metric: &ps_lua_mobjhooks as *const ps_metric_t as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"chkpos\0" as *const u8 as *const libc::c_char,
                hires_label: b"P_CheckPosition:\0" as *const u8 as *const libc::c_char,
                metric: &ps_checkposition_calls as *const ps_metric_t
                    as *mut ps_metric_t,
                flags: 2 as libc::c_int as uint8_t,
            };
            init
...
#[no_mangle]
pub static mut ps_frame_samples_left: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut ps_tick_samples_left: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut ps_frame_index: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut ps_tick_index: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut thinkframe_hooks: *mut ps_hookinfo_t = 0 as *const ps_hookinfo_t
    as *mut ps_hookinfo_t;
#[no_mangle]
pub static mut thinkframe_hooks_length: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut thinkframe_hooks_capacity: libc::c_int = 16 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn PS_SetThinkFrameHookInfo(
    mut index: libc::c_int,
    mut time_taken: precise_t,
    mut short_src: *mut libc::c_char,
) {
    if thinkframe_hooks.is_null() {
        thinkframe_hooks = Z_CallocAlign(
            (::core::mem::size_of::<ps_hookinfo_t>() as libc::c_ulong)
                .wrapping_mul(thinkframe_hooks_capacity as libc::c_ulong),
    ...
    if index >= thinkframe_hooks_capacity {
        let mut new_capacity: libc::c_int = thinkframe_hooks_capacity * 2 as libc::c_int;
        thinkframe_hooks = Z_ReallocAlign(
            thinkframe_hooks as *mut libc::c_void,
            (::core::mem::size_of::<ps_hookinfo_t>() as libc::c_ulong)
        ...
        memset(
            &mut *thinkframe_hooks.offset(thinkframe_hooks_capacity as isize)
                as *mut ps_hookinfo_t as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<ps_hookinfo_t>() as libc::c_ulong)
                .wrapping_mul(thinkframe_hooks_capacity as libc::c_ulong),
        );
    ...
    (*thinkframe_hooks.offset(index as isize)).time_taken.value.p = time_taken;
    memcpy(
        ((*thinkframe_hooks.offset(index as isize)).short_src).as_mut_ptr()
            as *mut libc::c_void,
        short_src as *const libc::c_void,
        (60 as libc::c_int as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<libc::c_char>() as libc::c_ulong),
    );
    thinkframe_hooks_length = index + 1 as libc::c_int;
}
unsafe extern "C" fn PS_HighResolution() -> boolean {
    return (vid.width >= 640 as libc::c_int && vid.height >= 400 as libc::c_int)
        as libc::c_int;
}
unsafe extern "C" fn PS_IsLevelActive() -> boolean {
    return (gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        || gamestate as libc::c_uint == GS_TITLESCREEN as libc::c_int as libc::c_uint
            && titlemapinaction as libc::c_int != 0) as libc::c_int;
}
unsafe extern "C" fn PS_IsRowValid(mut row: *mut perfstatrow_t) -> boolean {
    return !((*row).flags as libc::c_int & 2 as libc::c_int != 0
        && PS_IsLevelActive() == 0
        || (*row).flags as libc::c_int & 4 as libc::c_int != 0
            && rendermode as libc::c_uint != render_soft as libc::c_int as libc::c_uint
        || (*row).flags as libc::c_int & 8 as libc::c_int != 0
            && rendermode as libc::c_uint
                != render_opengl as libc::c_int as libc::c_uint) as libc::c_int;
}
unsafe extern "C" fn PS_IsRowVisible(mut row: *mut perfstatrow_t) -> boolean {
    let mut value_is_zero: boolean = 0;
    if (*row).flags as libc::c_int & 1 as libc::c_int != 0 {
        value_is_zero = ((*(*row).metric).value.p == 0 as libc::c_int as precise_t)
            as libc::c_int;
    } else {
        value_is_zero = ((*(*row).metric).value.i == 0 as libc::c_int) as libc::c_int;
    }
    return !(PS_IsRowValid(row) == 0
        || (*row).flags as libc::c_int & 32 as libc::c_int != 0 && value_is_zero != 0)
        as libc::c_int;
}
unsafe extern "C" fn PS_GetMetricAverage(
    mut metric: *mut ps_metric_t,
    mut time_metric: boolean,
) -> int32_t {
    let mut history_read_pos: *mut libc::c_char = (*metric).history as *mut libc::c_char;
    let mut sum: int64_t = 0 as libc::c_int as int64_t;
    let mut i: libc::c_int = 0;
    let mut value_size: libc::c_int = (if time_metric != 0 {
        ::core::mem::size_of::<precise_t>() as libc::c_ulong
    } else {
        ::core::mem::size_of::<int32_t>() as libc::c_ulong
    }) as libc::c_int;
    i = 0 as libc::c_int;
    while i < cv_ps_samplesize.value {
        if time_metric != 0 {
            sum = (sum as uint64_t)
                .wrapping_add(
                    *(history_read_pos as *mut precise_t)
                        / (I_GetPrecisePrecision() / 1000000 as libc::c_int as uint64_t),
                ) as int64_t as int64_t;
        } else {
            sum += *(history_read_pos as *mut int32_t) as int64_t;
        }
        history_read_pos = history_read_pos.offset(value_size as isize);
        i += 1;
        i;
    }
    return (sum / cv_ps_samplesize.value as int64_t) as int32_t;
}
unsafe extern "C" fn PS_GetMetricMinOrMax(
    mut metric: *mut ps_metric_t,
    mut time_metric: boolean,
    mut get_max: boolean,
) -> int32_t {
    let mut history_read_pos: *mut libc::c_char = (*metric).history as *mut libc::c_char;
    let mut found_value: int32_t = if get_max != 0 {
    ...
    while i < cv_ps_samplesize.value {
        ...
        if time_metric != 0 {
            value = (*(history_read_pos as *mut precise_t)
                / (I_GetPrecisePrecision() / 1000000 as libc::c_int as uint64_t))
                as int32_t;
        } else {
            value = *(history_read_pos as *mut int32_t);
        }
        if get_max != 0 && value > found_value || get_max == 0 && value < found_value {
            found_value = value;
        }
        history_read_pos = history_read_pos.offset(value_size as isize);
        i += 1;
...
unsafe extern "C" fn PS_GetMetricSD(
    mut metric: *mut ps_metric_t,
    mut time_metric: boolean,
) -> int32_t {
    let mut history_read_pos: *mut libc::c_char = (*metric).history as *mut libc::c_char;
    ...
    let mut avg: int32_t = PS_GetMetricAverage(metric, time_metric);
    i = 0 as libc::c_int;
    while i < cv_ps_samplesize.value {
        ...
        if time_metric != 0 {
            ...
            value = *(history_read_pos as *mut int32_t) as int64_t;
        }
        value -= avg as int64_t;
        sum += value * value;
        history_read_pos = history_read_pos.offset(value_size as isize);
        i += 1;
        i;
    }
    return round(sqrt((sum / cv_ps_samplesize.value as int64_t) as libc::c_double))
        as int32_t;
}
unsafe extern "C" fn PS_GetMetricScreenValue(
    mut metric: *mut ps_metric_t,
    mut time_metric: boolean,
) -> int32_t {
    if cv_ps_samplesize.value > 1 as libc::c_int && !((*metric).history).is_null() {
        if cv_ps_descriptor.value == 1 as libc::c_int {
            return PS_GetMetricAverage(metric, time_metric)
        } else if cv_ps_descriptor.value == 2 as libc::c_int {
            return PS_GetMetricSD(metric, time_metric)
        } else if cv_ps_descriptor.value == 3 as libc::c_int {
            return PS_GetMetricMinOrMax(metric, time_metric, false_0 as libc::c_int)
        } else {
            return PS_GetMetricMinOrMax(metric, time_metric, true_0 as libc::c_int)
        }
    } else if time_metric != 0 {
        return ((*metric).value.p
            / (I_GetPrecisePrecision() / 1000000 as libc::c_int as uint64_t)) as int32_t
    } else {
        return (*metric).value.i
    };
}
unsafe extern "C" fn PS_DrawPerfRows(
    mut x: libc::c_int,
    mut y: libc::c_int,
    mut color: libc::c_int,
    mut rows: *mut perfstatrow_t,
) -> libc::c_int {
    let hires: boolean = PS_HighResolution();
    let mut draw_flags: int32_t = 0xc00 as libc::c_int | color;
    let mut row: *mut perfstatrow_t = 0 as *mut perfstatrow_t;
    let mut draw_y: libc::c_int = y;
    if hires != 0 {
        draw_flags |= 0x800000 as libc::c_int;
    }
    row = rows;
    while !((*row).lores_label).is_null() {
        let mut label: *const libc::c_char = 0 as *const libc::c_char;
        let mut value: int32_t = 0;
        let mut final_str: *mut libc::c_char = 0 as *mut libc::c_char;
        if !(PS_IsRowVisible(row) == 0) {
            label = if hires != 0 { (*row).hires_label } else { (*row).lores_label };
            value = PS_GetMetricScreenValue(
                (*row).metric,
                ((*row).flags as libc::c_int & 1 as libc::c_int != 0) as libc::c_int,
            );
            final_str = va(b"%s %d\0" as *const u8 as *const libc::c_char, label, value);
            if hires != 0 {
                V_DrawSmallString(x, draw_y, draw_flags, final_str);
                draw_y += 5 as libc::c_int;
            } else {
                V_DrawThinString(x, draw_y, draw_flags, final_str);
                draw_y += 8 as libc::c_int;
            }
        }
        row = row.offset(1);
        row;
...
unsafe extern "C" fn PS_UpdateMetricHistory(
    mut metric: *mut ps_metric_t,
    mut time_metric: boolean,
    mut frame_metric: boolean,
    mut set_user: boolean,
) {
    let mut index: libc::c_int = if frame_metric != 0 {
        ps_frame_index
    } else {
        ps_tick_index
    };
    if ((*metric).history).is_null() {
        let mut value_size: libc::c_int = (if time_metric != 0 {
            ::core::mem::size_of::<precise_t>() as libc::c_ulong
        } else {
            ::core::mem::size_of::<int32_t>() as libc::c_ulong
        }) as libc::c_int;
        let mut memory_user: *mut *mut libc::c_void = if set_user != 0 {
            &mut (*metric).history
        } else {
            0 as *mut *mut libc::c_void
        };
        (*metric)
            .history = Z_CallocAlign(
            (value_size * cv_ps_samplesize.value) as size_t,
            PU_PERFSTATS as libc::c_int,
            memory_user as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        );
        if frame_metric != 0 {
    ...
    if time_metric != 0 {
        let mut history: *mut precise_t = (*metric).history as *mut precise_t;
        *history.offset(index as isize) = (*metric).value.p;
    } else {
        let mut history_0: *mut int32_t = (*metric).history as *mut int32_t;
        *history_0.offset(index as isize) = (*metric).value.i;
    };
}
unsafe extern "C" fn PS_UpdateRowHistories(
    mut rows: *mut perfstatrow_t,
    mut frame_metric: boolean,
) {
    let mut row: *mut perfstatrow_t = 0 as *mut perfstatrow_t;
...
unsafe extern "C" fn PS_UpdateFrameStats() {
    let mut currenttime: precise_t = I_GetPreciseTime();
    ps_frametime.value.p = currenttime.wrapping_sub(ps_prevframetime);
    ps_prevframetime = currenttime;
    if PS_IsLevelActive() != 0 {
        ps_otherrendertime
            .value
            .p = (ps_rendercalltime.value.p).wrapping_sub(ps_bsptime.value.p);
        ps_otherrendertime
            .value
            .p = (ps_otherrendertime.value.p)
            .wrapping_sub(
                (ps_sw_spritecliptime.value.p)
                    .wrapping_add(ps_sw_portaltime.value.p)
                    .wrapping_add(ps_sw_planetime.value.p)
                    .wrapping_add(ps_sw_maskedtime.value.p),
            );
    }
    if cv_ps_samplesize.value > 1 as libc::c_int {
        PS_UpdateRowHistories(rendertime_rows.as_mut_ptr(), true_0 as libc::c_int);
        if PS_IsLevelActive() != 0 {
            PS_UpdateRowHistories(
                commoncounter_rows.as_mut_ptr(),
                true_0 as libc::c_int,
            );
        }
        if R_UsingFrameInterpolation() != 0 {
            PS_UpdateRowHistories(
                interpolation_rows.as_mut_ptr(),
                true_0 as libc::c_int,
            );
        }
        ps_frame_index += 1;
        ...
        if ps_frame_index >= cv_ps_samplesize.value {
            ps_frame_index = 0 as libc::c_int;
        }
        if ps_frame_samples_left != 0 {
            ps_frame_samples_left -= 1;
            ps_frame_samples_left;
        }
    }
}
unsafe extern "C" fn PS_CountThinkers() {
    let mut i: libc::c_int = 0;
    let mut thinker: *mut thinker_t = 0 as *mut thinker_t;
    ps_thinkercount.value.i = 0 as libc::c_int;
    ps_polythcount.value.i = 0 as libc::c_int;
    ps_mainthcount.value.i = 0 as libc::c_int;
    ps_mobjcount.value.i = 0 as libc::c_int;
    ps_regularcount.value.i = 0 as libc::c_int;
    ps_scenerycount.value.i = 0 as libc::c_int;
    ps_nothinkcount.value.i = 0 as libc::c_int;
    ps_dynslopethcount.value.i = 0 as libc::c_int;
    ps_precipcount.value.i = 0 as libc::c_int;
    ps_removecount.value.i = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < NUM_THINKERLISTS as libc::c_int {
        thinker = (*thlist.as_mut_ptr().offset(i as isize)).next;
        while thinker != &mut *thlist.as_mut_ptr().offset(i as isize) as *mut thinker_t {
            ps_thinkercount.value.i += 1;
            ...
            {
                ps_removecount.value.i += 1;
                ps_removecount.value.i;
            } else if i == THINK_POLYOBJ as libc::c_int {
                ps_polythcount.value.i += 1;
                ps_polythcount.value.i;
            } else if i == THINK_MAIN as libc::c_int {
                ps_mainthcount.value.i += 1;
                ps_mainthcount.value.i;
            } else if i == THINK_MOBJ as libc::c_int {
                if (*thinker).function.acp1
                    == ::core::mem::transmute::<
                ...
                {
                    let mut mobj: *mut mobj_t = thinker as *mut mobj_t;
                    ps_mobjcount.value.i += 1;
                    ps_mobjcount.value.i;
                    if (*mobj).flags & MF_NOTHINK as libc::c_int as uint32_t != 0 {
                        ps_nothinkcount.value.i += 1;
                        ps_nothinkcount.value.i;
                    } else if (*mobj).flags & MF_SCENERY as libc::c_int as uint32_t != 0
                    {
                        ps_scenerycount.value.i += 1;
                        ps_scenerycount.value.i;
                    } else {
                        ps_regularcount.value.i += 1;
                        ps_regularcount.value.i;
                    }
                }
            } else if i == THINK_DYNSLOPE as libc::c_int {
                ps_dynslopethcount.value.i += 1;
                ps_dynslopethcount.value.i;
            } else if i == THINK_PRECIP as libc::c_int {
                ps_precipcount.value.i += 1;
...
#[no_mangle]
pub unsafe extern "C" fn PS_UpdateTickStats() {
    if cv_perfstats.value == 1 as libc::c_int
        && cv_ps_samplesize.value > 1 as libc::c_int
    {
        PS_UpdateRowHistories(gamelogicbrief_row.as_mut_ptr(), false_0 as libc::c_int);
    }
    if cv_perfstats.value == 2 as libc::c_int {
        if PS_IsLevelActive() != 0 {
            ps_otherlogictime
                .value
                .p = (ps_tictime.value.p)
                .wrapping_sub(ps_playerthink_time.value.p)
                .wrapping_sub(ps_thinkertime.value.p)
                .wrapping_sub(ps_lua_thinkframe_time.value.p);
            PS_CountThinkers();
        }
        if cv_ps_samplesize.value > 1 as libc::c_int {
            PS_UpdateRowHistories(gamelogic_rows.as_mut_ptr(), false_0 as libc::c_int);
            PS_UpdateRowHistories(
                thinkercount_rows.as_mut_ptr(),
                false_0 as libc::c_int,
            );
            PS_UpdateRowHistories(misc_calls_rows.as_mut_ptr(), false_0 as libc::c_int);
        }
    }
    if cv_perfstats.value == 3 as libc::c_int
        && cv_ps_samplesize.value > 1 as libc::c_int && PS_IsLevelActive() != 0
    {
        let mut i: libc::c_int = 0;
        i = 0 as libc::c_int;
        while i < thinkframe_hooks_length {
            PS_UpdateMetricHistory(
                &mut (*thinkframe_hooks.offset(i as isize)).time_taken,
                true_0 as libc::c_int,
                false_0 as libc::c_int,
                false_0 as libc::c_int,
            );
    ...
    if cv_perfstats.value != 0 && cv_ps_samplesize.value > 1 as libc::c_int {
        ps_tick_index += 1;
        ps_tick_index;
        if ps_tick_index >= cv_ps_samplesize.value {
            ps_tick_index = 0 as libc::c_int;
        }
        if ps_tick_samples_left != 0 {
            ps_tick_samples_left -= 1;
            ps_tick_samples_left;
        }
    }
}
unsafe extern "C" fn PS_DrawDescriptorHeader() {
    if cv_ps_samplesize.value > 1 as libc::c_int {
        let mut descriptor_names: [*const libc::c_char; 4] = [
            b"average\0" as *const u8 as *const libc::c_char,
            b"standard deviation\0" as *const u8 as *const libc::c_char,
            b"minimum\0" as *const u8 as *const libc::c_char,
            b"maximum\0" as *const u8 as *const libc::c_char,
        ];
        let hires: boolean = PS_HighResolution();
        let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut flags: int32_t = 0xc00 as libc::c_int | 0x800000 as libc::c_int;
        let mut samples_left: libc::c_int = if ps_frame_samples_left
            > ps_tick_samples_left
        {
            ps_frame_samples_left
        } else {
        ...
        if cv_perfstats.value == 3 as libc::c_int {
            ...
            x = 20 as libc::c_int;
            y = if hires != 0 { 5 as libc::c_int } else { 2 as libc::c_int };
        }
        if samples_left != 0 {
            str = va(
                b"Samples needed for correct results: %d\0" as *const u8
            ...
            str = va(
                b"Showing the %s of %d samples.\0" as *const u8 as *const libc::c_char,
                descriptor_names[(cv_ps_descriptor.value - 1 as libc::c_int) as usize],
                cv_ps_samplesize.value,
            );
            flags |= 0x3000 as libc::c_int;
        }
        if hires != 0 {
...
unsafe extern "C" fn PS_DrawRenderStats() {
    let hires: boolean = PS_HighResolution();
    let half_row: libc::c_int = if hires != 0 {
        5 as libc::c_int
    } else {
        4 as libc::c_int
    };
    let mut x: libc::c_int = 0;
    let mut y: libc::c_int = 0;
    let mut cy: libc::c_int = 10 as libc::c_int;
    PS_DrawDescriptorHeader();
    y = PS_DrawPerfRows(
        20 as libc::c_int,
        10 as libc::c_int,
        0x2000 as libc::c_int,
        rendertime_rows.as_mut_ptr(),
    );
    PS_DrawPerfRows(
        20 as libc::c_int,
        y + half_row,
        0x6000 as libc::c_int,
        gamelogicbrief_row.as_mut_ptr(),
    );
    if PS_IsLevelActive() != 0 {
        x = if hires != 0 { 115 as libc::c_int } else { 90 as libc::c_int };
        cy = PS_DrawPerfRows(
            x,
            10 as libc::c_int,
    ...
    if R_UsingFrameInterpolation() != 0 {
        x = if hires != 0 { 115 as libc::c_int } else { 90 as libc::c_int };
        PS_DrawPerfRows(x, cy, 0xe000 as libc::c_int, interpolation_rows.as_mut_ptr());
    }
}
unsafe extern "C" fn PS_DrawGameLogicStats() {
    let hires: boolean = PS_HighResolution();
    let mut x: libc::c_int = 0;
    let mut y: libc::c_int = 0;
    PS_DrawDescriptorHeader();
    ...
    if hires != 0 {
        V_DrawSmallString(
            212 as libc::c_int,
            10 as libc::c_int,
            0xc00 as libc::c_int | 0x800000 as libc::c_int | 0x9000 as libc::c_int,
            b"Calls:\0" as *const u8 as *const libc::c_char,
        );
    }
    x = if hires != 0 { 216 as libc::c_int } else { 170 as libc::c_int };
    y = if hires != 0 { 15 as libc::c_int } else { 10 as libc::c_int };
    PS_DrawPerfRows(x, y, 0x9000 as libc::c_int, misc_calls_rows.as_mut_ptr());
}
unsafe extern "C" fn PS_DrawThinkFrameStats() {
    let mut s: [libc::c_char; 100] = [0; 100];
    let mut i: libc::c_int = 0;
    let mut x: libc::c_int = 2 as libc::c_int;
    let mut y: libc::c_int = 4 as libc::c_int;
    let mut text_color: uint32_t = 0;
    let mut tempbuffer: [libc::c_char; 60] = [0; 60];
    let mut last_mod_name: [libc::c_char; 60] = [0; 60];
    last_mod_name[0 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
    PS_DrawDescriptorHeader();
    i = 0 as libc::c_int;
    while i < thinkframe_hooks_length {
        let mut str: *mut libc::c_char = ((*thinkframe_hooks.offset(i as isize))
            .short_src)
            .as_mut_ptr();
        let mut tempstr: *mut libc::c_char = tempbuffer.as_mut_ptr();
        let mut len: libc::c_int = strlen(str) as libc::c_int;
        let mut str_ptr: *mut libc::c_char = 0 as *mut libc::c_char;
        if strcmp(
            b".lua\0" as *const u8 as *const libc::c_char,
            str.offset(len as isize).offset(-(4 as libc::c_int as isize)),
        ) == 0 as libc::c_int
        {
        ...
        strcpy(tempstr, str);
        str_ptr = strrchr(tempstr, '|' as i32);
        if !str_ptr.is_null() {
            *str_ptr = '\0' as i32 as libc::c_char;
            str = str_ptr.offset(1 as libc::c_int as isize);
            str_ptr = strrchr(
                tempstr,
                (*::core::mem::transmute::<
                    &[u8; 2],
            ...
            if !str_ptr.is_null() {
                tempstr = str_ptr.offset(1 as libc::c_int as isize);
            }
            if strcmp(tempstr, last_mod_name.as_mut_ptr()) != 0 as libc::c_int {
                strcpy(last_mod_name.as_mut_ptr(), tempstr);
                len = strlen(tempstr) as libc::c_int;
                if len > 25 as libc::c_int {
                    tempstr = tempstr.offset((len - 25 as libc::c_int) as isize);
                }
                snprintf(
                    s.as_mut_ptr(),
                ...
                V_DrawSmallString(
                    x,
                    y,
                    0xc00 as libc::c_int | 0x800000 as libc::c_int
                        | 0x6000 as libc::c_int,
                    s.as_mut_ptr(),
                );
                y += 4 as libc::c_int;
                if y > 192 as libc::c_int {
                    y = 4 as libc::c_int;
                    x += 106 as libc::c_int;
                    if x > 214 as libc::c_int {
                        break;
                    }
                }
            }
            text_color = 0x2000 as libc::c_int as uint32_t;
        } else {
            str_ptr = strrchr(
                tempstr,
                (*::core::mem::transmute::<
            ...
            text_color = 0 as libc::c_int as uint32_t;
        }
        len = strlen(str) as libc::c_int;
        if len > 20 as libc::c_int {
            str = str.offset((len - 20 as libc::c_int) as isize);
        }
        snprintf(
            s.as_mut_ptr(),
            (::core::mem::size_of::<[libc::c_char; 100]>() as libc::c_ulong)
        ...
        V_DrawSmallString(
            x,
            y,
            ((0xc00 as libc::c_int | 0x800000 as libc::c_int) as uint32_t | text_color)
                as int32_t,
            s.as_mut_ptr(),
        );
        y += 4 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn M_DrawPerfStats() {
    if cv_perfstats.value == 1 as libc::c_int {
        PS_UpdateFrameStats();
        PS_DrawRenderStats();
    } else if cv_perfstats.value == 2 as libc::c_int {
        PS_DrawGameLogicStats();
    } else if cv_perfstats.value == 3 as libc::c_int {
        if PS_IsLevelActive() == 0 {
            return;
        }
        if PS_HighResolution() == 0 {
            V_DrawThinString(
                80 as libc::c_int,
                92 as libc::c_int,
                0xc00 as libc::c_int | 0x800000 as libc::c_int | 0x2000 as libc::c_int,
                b"Perfstats 3 is not available\0" as *const u8 as *const libc::c_char,
            );
            V_DrawThinString(
                80 as libc::c_int,
                100 as libc::c_int,
                0xc00 as libc::c_int | 0x800000 as libc::c_int | 0x2000 as libc::c_int,
                b"for resolutions below 640x400.\0" as *const u8 as *const libc::c_char,
            );
        } else {
...
unsafe extern "C" fn PS_ClearHistory() {
    let mut i: libc::c_int = 0;
    Z_FreeTags(PU_PERFSTATS as libc::c_int, PU_PERFSTATS as libc::c_int);
    i = 0 as libc::c_int;
    while i < thinkframe_hooks_length {
        let ref mut fresh0 = (*thinkframe_hooks.offset(i as isize)).time_taken.history;
        *fresh0 = 0 as *mut libc::c_void;
        i += 1;
        i;
    }
    ps_tick_index = 0 as libc::c_int;
    ps_frame_index = ps_tick_index;
    ps_tick_samples_left = 0 as libc::c_int;
    ps_frame_samples_left = ps_tick_samples_left;
}
#[no_mangle]
pub unsafe extern "C" fn PS_PerfStats_OnChange() {
    if cv_perfstats.value != 0 && cv_ps_samplesize.value > 1 as libc::c_int {
        PS_ClearHistory();
    }
}
#[no_mangle]
pub unsafe extern "C" fn PS_SampleSize_OnChange() {
    if cv_ps_samplesize.value > 1 as libc::c_int {
        PS_ClearHistory();
    }
}
unsafe extern "C" fn run_static_initializers() {
    gamelogic_rows = [
        ...
        {
            let mut init = perfstatrow {
                lores_label: b" plrthnk\0" as *const u8 as *const libc::c_char,
                hires_label: b" P_PlayerThink:  \0" as *const u8 as *const libc::c_char,
                metric: &mut ps_playerthink_time,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" thnkers\0" as *const u8 as *const libc::c_char,
                hires_label: b" P_RunThinkers:  \0" as *const u8 as *const libc::c_char,
                metric: &mut ps_thinkertime,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b"  plyobjs\0" as *const u8 as *const libc::c_char,
                hires_label: b"  Polyobjects:    \0" as *const u8 as *const libc::c_char,
                metric: &mut *ps_thlist_times
                    .as_mut_ptr()
                    .offset(THINK_POLYOBJ as libc::c_int as isize) as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                ...
                metric: &mut *ps_thlist_times
                    .as_mut_ptr()
                    .offset(THINK_MAIN as libc::c_int as isize) as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                ...
                metric: &mut *ps_thlist_times
                    .as_mut_ptr()
                    .offset(THINK_MOBJ as libc::c_int as isize) as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                ...
                metric: &mut *ps_thlist_times
                    .as_mut_ptr()
                    .offset(THINK_DYNSLOPE as libc::c_int as isize) as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                ...
                metric: &mut *ps_thlist_times
                    .as_mut_ptr()
                    .offset(THINK_PRECIP as libc::c_int as isize) as *mut ps_metric_t,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
        {
            let mut init = perfstatrow {
                lores_label: b" lthinkf\0" as *const u8 as *const libc::c_char,
                hires_label: b" LUAh_ThinkFrame:\0" as *const u8 as *const libc::c_char,
                metric: &mut ps_lua_thinkframe_time,
                flags: (1 as libc::c_int | 2 as libc::c_int) as uint8_t,
            };
            init
        },
