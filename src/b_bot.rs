...
pub const BOT_MPAI: C2RustUnnamed_6 = 3;
pub const BOT_2PHUMAN: C2RustUnnamed_6 = 2;
pub const BOT_2PAI: C2RustUnnamed_6 = 1;
pub const BOT_NONE: C2RustUnnamed_6 = 0;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const AI_SPINFOLLOW: C2RustUnnamed_7 = 6;
pub const AI_FLYCARRY: C2RustUnnamed_7 = 5;
pub const AI_FLYSTANDBY: C2RustUnnamed_7 = 4;
pub const AI_THINKFLY: C2RustUnnamed_7 = 3;
pub const AI_CATCHUP: C2RustUnnamed_7 = 2;
pub const AI_FOLLOW: C2RustUnnamed_7 = 1;
pub const AI_STANDBY: C2RustUnnamed_7 = 0;
...
pub const mobjhook_BotRespawn: C2RustUnnamed_10 = 13;
pub type C2RustUnnamed_10 = libc::c_uint;
pub const mobjhook_MAX: C2RustUnnamed_10 = 18;
pub const mobjhook_HurtMsg: C2RustUnnamed_10 = 17;
pub const mobjhook_FollowMobj: C2RustUnnamed_10 = 16;
pub const mobjhook_MapThingSpawn: C2RustUnnamed_10 = 15;
pub const mobjhook_MobjMoveBlocked: C2RustUnnamed_10 = 14;
pub const mobjhook_MobjRemoved: C2RustUnnamed_10 = 12;
pub const mobjhook_BossDeath: C2RustUnnamed_10 = 11;
pub const mobjhook_MobjDeath: C2RustUnnamed_10 = 10;
pub const mobjhook_MobjDamage: C2RustUnnamed_10 = 9;
pub const mobjhook_ShouldDamage: C2RustUnnamed_10 = 8;
pub const mobjhook_BossThinker: C2RustUnnamed_10 = 7;
pub const mobjhook_MobjThinker: C2RustUnnamed_10 = 6;
pub const mobjhook_MobjFuse: C2RustUnnamed_10 = 5;
pub const mobjhook_TouchSpecial: C2RustUnnamed_10 = 4;
pub const mobjhook_MobjMoveCollide: C2RustUnnamed_10 = 3;
pub const mobjhook_MobjLineCollide: C2RustUnnamed_10 = 2;
pub const mobjhook_MobjCollide: C2RustUnnamed_10 = 1;
pub const mobjhook_MobjSpawn: C2RustUnnamed_10 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn B_UpdateBotleader(mut player: *mut player_t) {
    let mut i: uint32_t = 0;
    let mut dist: fixed_t = 0;
    let mut neardist: fixed_t = 2147483647 as libc::c_int;
    let mut nearplayer: *mut player_t = 0 as *mut player_t;
    i = 0 as libc::c_int as uint32_t;
    while i < 32 as libc::c_int as uint32_t {
        if !(players[i as usize].bot as libc::c_int != 0
            || players[i as usize].playerstate as libc::c_uint
                != PST_LIVE as libc::c_int as libc::c_uint
            || players[i as usize].spectator != 0 || (players[i as usize].mo).is_null())
        {
            if ((*player).botleader).is_null() {
                (*player)
                    .botleader = &mut *players.as_mut_ptr().offset(i as isize)
                    as *mut player_t;
                return;
            }
            ...
            if neardist > dist {
                neardist = dist;
                nearplayer = &mut *players.as_mut_ptr().offset(i as isize)
                    as *mut player_t;
            }
        }
        i = i.wrapping_add(1);
...
#[inline]
unsafe extern "C" fn B_ResetAI(mut mem: *mut botmem_t) {
    (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
    (*mem).catchup_tics = 0 as libc::c_int as uint8_t;
}
unsafe extern "C" fn B_BuildTailsTiccmd(
    mut sonic: *mut mobj_t,
    mut tails: *mut mobj_t,
    mut cmd: *mut ticcmd_t,
) {
    let mut forward: boolean = false_0 as libc::c_int;
    let mut backward: boolean = false_0 as libc::c_int;
    let mut left: boolean = false_0 as libc::c_int;
    let mut right: boolean = false_0 as libc::c_int;
    let mut jump: boolean = false_0 as libc::c_int;
    let mut spin: boolean = false_0 as libc::c_int;
    let mut player: *mut player_t = (*sonic).player;
    let mut bot: *mut player_t = (*tails).player;
    let mut pcmd: *mut ticcmd_t = &mut (*player).cmd;
    let mut mem: *mut botmem_t = &mut (*bot).botmem;
    let mut water: boolean = (*tails).eflags as libc::c_int
        & MFE_UNDERWATER as libc::c_int;
    let mut flip: int8_t = P_MobjFlip(tails);
    let mut _2d: boolean = ((*tails).flags2 & MF2_TWOD as libc::c_int as uint32_t != 0
        || maptol & TOL_2D as libc::c_int as uint32_t != 0) as libc::c_int;
    let mut scale: fixed_t = (*tails).scale;
    let mut jump_last: boolean = (*bot).lastbuttons as libc::c_int
        & BT_JUMP as libc::c_int;
    let mut spin_last: boolean = (*bot).lastbuttons as libc::c_int
        & BT_SPIN as libc::c_int;
    let mut dist: fixed_t = P_AproxDistance(
        (*sonic).x - (*tails).x,
        (*sonic).y - (*tails).y,
    );
    let mut zdist: fixed_t = flip as libc::c_int * ((*sonic).z - (*tails).z);
    let mut ang: angle_t = (*sonic).angle;
    let mut pmom: fixed_t = P_AproxDistance((*sonic).momx, (*sonic).momy);
    let mut bmom: fixed_t = P_AproxDistance((*tails).momx, (*tails).momy);
    let mut followmax: fixed_t = 128 as libc::c_int * 8 as libc::c_int * scale;
    let mut followthres: fixed_t = 92 as libc::c_int * scale;
    let mut followmin: fixed_t = 32 as libc::c_int * scale;
    let mut comfortheight: fixed_t = 96 as libc::c_int * scale;
    let mut touchdist: fixed_t = 24 as libc::c_int * scale;
    let mut stalled: boolean = (bmom < scale >> 1 as libc::c_int && dist > followthres)
        as libc::c_int;
    let mut samepos: boolean = ((*sonic).x == (*tails).x && (*sonic).y == (*tails).y)
        as libc::c_int;
    let mut blocked: boolean = (*bot).blocked;
    if samepos == 0 {
        ang = R_PointToAngle2((*tails).x, (*tails).y, (*sonic).x, (*sonic).y);
    }
    if LUA_HookBotAI(sonic, tails, cmd) != 0 {
        return;
    }
    if sonic.is_null() || (*sonic).health <= 0 as libc::c_int {
        (*mem).thinkstate = AI_STANDBY as libc::c_int as uint8_t;
        return;
    } else if (*mem).thinkstate as libc::c_int == AI_STANDBY as libc::c_int {
        (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
    }
    if (*(*tails).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
        == CR_MACESPIN as libc::c_int
        || (*(*tails).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_GENERIC as libc::c_int
    {
        let mut isrelevant: boolean = ((*(*sonic).player)
            .powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_MACESPIN as libc::c_int
            || (*(*sonic).player).powers[pw_carry as libc::c_int as usize] as libc::c_int
                == CR_GENERIC as libc::c_int) as libc::c_int;
        if (*(*sonic).player).cmd.buttons as libc::c_int & BT_JUMP as libc::c_int != 0
            && (*(*sonic).player).pflags as libc::c_uint
                & PF_JUMPED as libc::c_int as libc::c_uint != 0 && isrelevant != 0
        {
            (*cmd)
        ...
        if isrelevant != 0 {
            ...
            (*cmd)
                .angleturn = (abs(
                ((*tails).angle).wrapping_sub((*sonic).angle) as libc::c_int,
            ) >> 16 as libc::c_int) as int16_t;
            if (*sonic).angle < (*tails).angle {
                (*cmd).angleturn = -((*cmd).angleturn as libc::c_int) as int16_t;
            }
        } else if dist
            > FixedMul(
    ...
    if water != 0 {
        followmin = 0 as libc::c_int;
        followthres = 16 as libc::c_int * scale;
        followmax >>= 1 as libc::c_int;
        if (*mem).thinkstate as libc::c_int == AI_THINKFLY as libc::c_int {
            (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
        }
    }
    if (*mem).thinkstate as libc::c_int == AI_SPINFOLLOW as libc::c_int {
        (*mem).catchup_tics = 0 as libc::c_int as uint8_t;
    } else if dist > followmax || zdist > comfortheight || stalled != 0 {
        (*mem)
            .catchup_tics = (if ((*mem).catchup_tics as libc::c_int + 2 as libc::c_int)
            < 70 as libc::c_int
        {
            (*mem).catchup_tics as libc::c_int + 2 as libc::c_int
        } else {
            70 as libc::c_int
        }) as uint8_t;
        if (*mem).catchup_tics as libc::c_int >= 70 as libc::c_int {
            (*mem).thinkstate = AI_CATCHUP as libc::c_int as uint8_t;
        }
    } else {
        (*mem)
            .catchup_tics = (if (*mem).catchup_tics as libc::c_int - 1 as libc::c_int
            > 0 as libc::c_int
        {
            (*mem).catchup_tics as libc::c_int - 1 as libc::c_int
        } else {
            0 as libc::c_int
        }) as uint8_t;
        if (*mem).thinkstate as libc::c_int == AI_CATCHUP as libc::c_int {
            (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
        }
    }
    if (*bot).pflags as libc::c_uint
        & (PF_SPINNING as libc::c_int | PF_STARTDASH as libc::c_int) as libc::c_uint != 0
    {
        (*cmd).angleturn = ((*sonic).angle >> 16 as libc::c_int) as int16_t;
    } else if (*mem).thinkstate as libc::c_int == AI_FLYCARRY as libc::c_int {
        (*cmd).angleturn = (*(*sonic).player).cmd.angleturn;
    } else {
        (*cmd).angleturn = (ang >> 16 as libc::c_int) as int16_t;
    }
    if (*player).exiting != 0
        && (*mem).thinkstate as libc::c_int == AI_THINKFLY as libc::c_int
    {
        (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
    } else {
        if (*mem).thinkstate as libc::c_int == AI_THINKFLY as libc::c_int
        ...
        {
            if jump_last == 0 {
                jump = true_0 as libc::c_int;
                (*mem).thinkstate = AI_FLYSTANDBY as libc::c_int as uint8_t;
                (*bot)
                    .pflags = ::core::mem::transmute::<
                    libc::c_uint,
                    pflags_t,
                >(
                    (*bot).pflags as libc::c_uint
                        | PF_CANCARRY as libc::c_int as libc::c_uint,
                );
            }
        }
        if !(water != 0 || pmom != 0 || bmom != 0) && (dist < touchdist && samepos == 0)
            && !((*pcmd).forwardmove as libc::c_int != 0
                || (*pcmd).sidemove as libc::c_int != 0 || (*player).dashspeed != 0)
            && P_IsObjectOnGround(sonic) != 0 && P_IsObjectOnGround(tails) != 0
            && (*player).pflags as libc::c_uint
                & PF_STASIS as libc::c_int as libc::c_uint == 0 && (*player).exiting == 0
            && (*bot).charability as libc::c_int == CA_FLY as libc::c_int
        {
            (*mem).thinkstate = AI_THINKFLY as libc::c_int as uint8_t;
        } else if (*mem).thinkstate as libc::c_int == AI_THINKFLY as libc::c_int {
            (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
        }
        if (*player).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_PLAYER as libc::c_int && (*sonic).tracer == tails
        {
            (*mem).thinkstate = AI_FLYCARRY as libc::c_int as uint8_t;
        }
        if (*mem).thinkstate as libc::c_int == AI_FLYSTANDBY as libc::c_int {
            if zdist < -(64 as libc::c_int) * scale
                || flip as libc::c_int * (*tails).momz > scale
            {
                spin = true_0 as libc::c_int;
            } else if jump_last == 0 {
                jump = true_0 as libc::c_int;
            }
            if dist > followthres || (*player).dashspeed != 0 {
                (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
            }
        } else if (*mem).thinkstate as libc::c_int == AI_FLYCARRY as libc::c_int {
            (*cmd).forwardmove = (*pcmd).forwardmove;
            (*cmd).sidemove = (*pcmd).sidemove;
            if (*pcmd).buttons as libc::c_int & BT_SPIN as libc::c_int != 0 {
                spin = true_0 as libc::c_int;
                jump = false_0 as libc::c_int;
            } else if jump_last == 0 {
                jump = true_0 as libc::c_int;
            }
            if (*player).powers[pw_carry as libc::c_int as usize] as libc::c_int
    ...
    if P_IsObjectOnGround(tails) != 0
        && (*pcmd).buttons as libc::c_int & BT_JUMP as libc::c_int == 0
        && ((*mem).thinkstate as libc::c_int == AI_FLYSTANDBY as libc::c_int
            || (*mem).thinkstate as libc::c_int == AI_FLYCARRY as libc::c_int)
    {
        (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
    }
    if (*player).pflags as libc::c_uint
        & (PF_SPINNING as libc::c_int | PF_STARTDASH as libc::c_int) as libc::c_uint == 0
        && (*mem).thinkstate as libc::c_int == AI_SPINFOLLOW as libc::c_int
    {
        (*mem).thinkstate = AI_FOLLOW as libc::c_int as uint8_t;
    } else if (*mem).thinkstate as libc::c_int == AI_FOLLOW as libc::c_int
        || (*mem).thinkstate as libc::c_int == AI_SPINFOLLOW as libc::c_int
    {
        if _2d == 0 {
            if (*player).dashspeed != 0 {
                if dist < followthres && dist > touchdist {
                    (*cmd).angleturn = (ang >> 16 as libc::c_int) as int16_t;
                    (*cmd).forwardmove = 50 as libc::c_int as int8_t;
                    (*mem).thinkstate = AI_SPINFOLLOW as libc::c_int as uint8_t;
                    ...
                    {
                        (*cmd)
                            .angleturn = ((*sonic).angle >> 16 as libc::c_int)
                            as int16_t;
                        spin = true_0 as libc::c_int;
                    }
                    (*mem).thinkstate = AI_SPINFOLLOW as libc::c_int as uint8_t;
            ...
            } else if (*player).dashspeed == (*bot).dashspeed
                && (*player).pflags as libc::c_uint
                    & PF_SPINNING as libc::c_int as libc::c_uint != 0
            {
                if (*bot).pflags as libc::c_uint
                    & PF_SPINNING as libc::c_int as libc::c_uint != 0 || spin_last == 0
                {
                    spin = true_0 as libc::c_int;
                    (*cmd).angleturn = ((*sonic).angle >> 16 as libc::c_int) as int16_t;
                    (*cmd).forwardmove = 50 as libc::c_int as int8_t;
        ...
        } else if ((*player).dashspeed != 0 && bmom == 0
            || (*player).dashspeed == (*bot).dashspeed
                && (*player).pflags as libc::c_uint
                    & PF_SPINNING as libc::c_int as libc::c_uint != 0)
            && ((*bot).pflags as libc::c_uint
                & PF_SPINNING as libc::c_int as libc::c_uint != 0 || spin_last == 0)
    ...
    if (*mem).thinkstate as libc::c_int == AI_FOLLOW as libc::c_int
        || (*mem).thinkstate as libc::c_int == AI_CATCHUP as libc::c_int
    {
        if (*mem).thinkstate as libc::c_int == AI_CATCHUP as libc::c_int
            || dist > followthres
        {
            if _2d == 0 {
                ...
                (*cmd).sidemove = 50 as libc::c_int as int8_t;
            } else {
                (*cmd).sidemove = -(50 as libc::c_int) as int8_t;
            }
        } else if dist > followmin && abs(zdist) < 192 as libc::c_int * scale {
            if _2d == 0 {
                (*cmd)
                    .forwardmove = FixedHypot(
                    (*pcmd).forwardmove as fixed_t,
                    (*pcmd).sidemove as fixed_t,
                ) as int8_t;
            } else {
                (*cmd).sidemove = (*pcmd).sidemove;
            }
            ...
            (*cmd).angleturn = ((*sonic).angle >> 16 as libc::c_int) as int16_t;
            (*cmd)
                .forwardmove = (8 as libc::c_int * (*pcmd).forwardmove as libc::c_int
                / 10 as libc::c_int) as int8_t;
            (*cmd)
                .sidemove = (8 as libc::c_int * (*pcmd).sidemove as libc::c_int
                / 10 as libc::c_int) as int8_t;
        }
    }
    if (*mem).thinkstate as libc::c_int == AI_FOLLOW as libc::c_int
        ...
        || (*mem).thinkstate as libc::c_int == AI_SPINFOLLOW as libc::c_int
            && (*player).pflags as libc::c_uint
                & PF_JUMPED as libc::c_int as libc::c_uint != 0
    {
        if (*bot).pflags as libc::c_uint & PF_THOKKED as libc::c_int as libc::c_uint != 0
        {
            (*cmd)
                .forwardmove = (if (50 as libc::c_int) < dist / scale >> 3 as libc::c_int
            {
                50 as libc::c_int
            } else {
                dist / scale >> 3 as libc::c_int
            }) as int8_t;
            if zdist < -(64 as libc::c_int) * scale {
                spin = true_0 as libc::c_int;
            } else if zdist > 0 as libc::c_int && jump_last == 0 {
                jump = true_0 as libc::c_int;
            }
        }
        if (*tails).eflags as libc::c_int & MFE_JUSTHITFLOOR as libc::c_int != 0 {
            jump = false_0 as libc::c_int;
        } else if jump_last == 0
            && (*bot).pflags as libc::c_uint & PF_JUMPED as libc::c_int as libc::c_uint
                == 0
            && (zdist > 32 as libc::c_int * scale
                && (*player).pflags as libc::c_uint
                    & PF_JUMPED as libc::c_int as libc::c_uint != 0
                || zdist > 64 as libc::c_int * scale
                    && (*mem).thinkstate as libc::c_int == AI_CATCHUP as libc::c_int
                || stalled != 0 && (*mem).catchup_tics as libc::c_int > 20 as libc::c_int
                    && (*bot).powers[pw_carry as libc::c_int as usize] as libc::c_int
        ...
        {
            jump = true_0 as libc::c_int;
        } else if (*bot).pflags as libc::c_uint
            & PF_JUMPED as libc::c_int as libc::c_uint != 0 && jump_last != 0
            && (*tails).momz * flip as libc::c_int > 0 as libc::c_int
            && (zdist > 0 as libc::c_int
                || (*mem).thinkstate as libc::c_int == AI_CATCHUP as libc::c_int)
        {
            jump = true_0 as libc::c_int;
        } else if (*bot).pflags as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn B_BuildTiccmd(
    ...
    if LUA_HookTiccmd(player, cmd, hook_BotTiccmd as libc::c_int) != 0 {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn B_KeysToTiccmd(
    mut mo: *mut mobj_t,
    mut cmd: *mut ticcmd_t,
    mut forward: boolean,
    mut backward: boolean,
    mut left: boolean,
    mut right: boolean,
    mut strafeleft: boolean,
    mut straferight: boolean,
    mut jump: boolean,
    mut spin: boolean,
) {
    let mut player: *mut player_t = (*mo).player;
    if !((*player).botleader).is_null()
        && (*(*player).botleader).powers[pw_carry as libc::c_int as usize] as libc::c_int
            != 0
        && (*(*player).botleader).powers[pw_carry as libc::c_int as usize] as libc::c_int
            != CR_PLAYER as libc::c_int
    {
    ...
    {
        if (*(*player).botleader).climbing as libc::c_int != 0
            || (*(*mo).player).pflags as libc::c_uint
                & PF_GLIDING as libc::c_int as libc::c_uint != 0
        {
            if forward != 0 {
                (*cmd)
                    .forwardmove = ((*cmd).forwardmove as libc::c_int
            ...
            if left != 0 || strafeleft != 0 {
                (*cmd)
                    .sidemove = ((*cmd).sidemove as libc::c_int
                    - ((50 as libc::c_int) << 16 as libc::c_int >> 16 as libc::c_int))
                    as int8_t;
            }
            if right != 0 || straferight != 0 {
                (*cmd)
                    .sidemove = ((*cmd).sidemove as libc::c_int
                    + ((50 as libc::c_int) << 16 as libc::c_int >> 16 as libc::c_int))
                    as int8_t;
            ...
            if left != 0 || right != 0 {
                backward = true_0 as libc::c_int;
            }
            right = false_0 as libc::c_int;
            left = right;
            if forward != 0 {
                if (*mo).angle < 0x40000000 as libc::c_int as angle_t
                    || (*mo).angle > 0xc0000000 as libc::c_uint
                {
                    right = true_0 as libc::c_int;
                } else {
                    left = true_0 as libc::c_int;
                }
            } else if backward != 0 {
                if (*mo).angle < 0x40000000 as libc::c_int as angle_t
                    || (*mo).angle > 0xc0000000 as libc::c_uint
        ...
        if left != 0 {
            (*cmd)
                .angleturn = ((*cmd).angleturn as libc::c_int + 1280 as libc::c_int)
                as int16_t;
        }
        if right != 0 {
            (*cmd)
        ...
        (*cmd)
            .forwardmove = (if (if ((*cmd).forwardmove as libc::c_int) < maxforward {
            (*cmd).forwardmove as libc::c_int
        } else {
            maxforward
        }) > -maxforward
        {
            if ((*cmd).forwardmove as libc::c_int) < maxforward {
                (*cmd).forwardmove as libc::c_int
            } else {
                maxforward
            }
        ...
        (*cmd)
            .sidemove = (if (if ((*cmd).sidemove as libc::c_int) < maxside {
            (*cmd).sidemove as libc::c_int
        } else {
            maxside
        }) > -maxside
        {
            if ((*cmd).sidemove as libc::c_int) < maxside {
                (*cmd).sidemove as libc::c_int
            } else {
                maxside
            }
...
#[no_mangle]
pub unsafe extern "C" fn B_MoveBlocked(mut player: *mut player_t) {
    (*player).blocked = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn B_CheckRespawn(mut player: *mut player_t) -> boolean {
    let mut sonic: *mut mobj_t = 0 as *mut mobj_t;
    let mut tails: *mut mobj_t = (*player).mo;
    if ((*player).botleader).is_null() {
    ...
    let mut shouldForce: uint8_t = LUA_Hook2Mobj(
        sonic,
        tails,
        mobjhook_BotRespawn as libc::c_int,
    ) as uint8_t;
    if P_MobjWasRemoved(sonic) != 0 || P_MobjWasRemoved(tails) != 0 {
    ...
    if (*sonic).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        if (*sonic).z - (*sonic).floorz
            < (if (*(*sonic).player).exiting != 0 {
                5 as libc::c_int
            } else {
                2 as libc::c_int
            }) * (*sonic).height
    ...
    } else if (*sonic).ceilingz - (*sonic).z
        < (if (*(*sonic).player).exiting != 0 {
            6 as libc::c_int
        } else {
            3 as libc::c_int
    ...
    if (*player).playerstate as libc::c_uint == PST_DEAD as libc::c_int as libc::c_uint {
        if (*player).deadtimer > 4 as libc::c_int * 35 as libc::c_int {
            return true_0 as libc::c_int;
        }
        return false_0 as libc::c_int;
    }
    if P_CheckSight(sonic, tails) == 0
        && P_AproxDistance(
            P_AproxDistance((*tails).x - (*sonic).x, (*tails).y - (*sonic).y),
            (*tails).z - (*sonic).z,
        )
            > FixedMul(
...
#[no_mangle]
pub unsafe extern "C" fn B_RespawnBot(mut playernum: int32_t) {
    ...
    let mut z: fixed_t = 0;
    let mut sonic: *mut mobj_t = 0 as *mut mobj_t;
    let mut tails: *mut mobj_t = 0 as *mut mobj_t;
    if ((*player).botleader).is_null() {
        return;
    }
    sonic = (*(*player).botleader).mo;
    ...
    B_ResetAI(&mut (*player).botmem);
    (*player).bot = BOT_2PAI as libc::c_int as uint8_t;
    ...
    if (*sonic).eflags as libc::c_int & MFE_VERTICALFLIP as libc::c_int != 0 {
        (*tails)
            ...
            as uint16_t;
        z = (*sonic).z - 512 as libc::c_int * (*sonic).scale;
        if z < (*sonic).floorz {
            z = (*sonic).floorz;
        }
    } else {
        z = (*sonic).z + (*sonic).height + 512 as libc::c_int * (*sonic).scale;
        if z > (*sonic).ceilingz - (*sonic).height {
            z = (*sonic).ceilingz - (*sonic).height;
        }
    }
    if (*sonic).flags2 & MF2_OBJECTFLIP as libc::c_int as uint32_t != 0 {
        (*tails).flags2 |= MF2_OBJECTFLIP as libc::c_int as uint32_t;
    }
    if (*sonic).flags2 & MF2_TWOD as libc::c_int as uint32_t != 0 {
        (*tails).flags2 |= MF2_TWOD as libc::c_int as uint32_t;
    }
    if (*sonic).eflags as libc::c_int & MFE_UNDERWATER as libc::c_int != 0 {
        (*tails)
            .eflags = ((*tails).eflags as libc::c_int | MFE_UNDERWATER as libc::c_int)
            as uint16_t;
    }
    (*player)
        .powers[pw_underwater as libc::c_int
        as usize] = (*(*sonic).player).powers[pw_underwater as libc::c_int as usize];
    (*player)
        .powers[pw_spacetime as libc::c_int
        as usize] = (*(*sonic).player).powers[pw_spacetime as libc::c_int as usize];
    (*player)
        .powers[pw_gravityboots as libc::c_int
        as usize] = (*(*sonic).player).powers[pw_gravityboots as libc::c_int as usize];
    (*player)
        .powers[pw_nocontrol as libc::c_int
        as usize] = (*(*sonic).player).powers[pw_nocontrol as libc::c_int as usize];
    (*player)
        .pflags = ::core::mem::transmute::<
        libc::c_uint,
        pflags_t,
...
#[no_mangle]
pub unsafe extern "C" fn B_HandleFlightIndicator(mut player: *mut player_t) {
    let mut tails: *mut mobj_t = (*player).mo;
    let mut mem: *mut botmem_t = &mut (*player).botmem;
    let mut shouldExist: boolean = 0;
    if tails.is_null() {
        return;
    }
    shouldExist = ((*mem).thinkstate as libc::c_int == AI_THINKFLY as libc::c_int
        && !((*player).botleader).is_null()
        && (*player).bot as libc::c_int == BOT_2PAI as libc::c_int
        && (*player).playerstate as libc::c_uint
            == PST_LIVE as libc::c_int as libc::c_uint) as libc::c_int;
    if P_MobjWasRemoved((*tails).hnext) != 0 {
        if shouldExist == 0 {
            return;
        }
        P_SetTarget2(
        ...
        P_SetTarget2(&mut (*(*tails).hnext).target, tails);
        P_SetTarget2(&mut (*(*tails).hnext).hprev, tails);
        P_SetMobjState((*tails).hnext, S_FLIGHTINDICATOR);
    }
    if (*(*tails).hnext).type_0 as libc::c_uint
        != MT_OVERLAY as libc::c_int as libc::c_uint
        || (*(*tails).hnext).state
            != states.as_mut_ptr().offset(S_FLIGHTINDICATOR as libc::c_int as isize)
    {
        return;
    }
    if shouldExist == 0 {
        P_RemoveMobj((*tails).hnext);
        P_SetTarget2(&mut (*tails).hnext, 0 as *mut mobj_t);
        return;
    }
    (*(*tails).hnext).drawonlyforplayer = (*player).botleader;
    if P_IsLocalPlayer((*player).botleader) != 0 {
        (*(*tails).hnext).flags2 &= !(MF2_DONTDRAW as libc::c_int) as uint32_t;
    } else {
        (*(*tails).hnext).flags2 |= MF2_DONTDRAW as libc::c_int as uint32_t;
    };
}
