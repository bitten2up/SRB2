...
extern "C" {
    ...
    fn Tag_Compare(list1: *const taglist_t, list2: *const taglist_t) -> boolean;
    ...
    fn R_GetTextureNum(texnum: int32_t) -> int32_t;
    ...
    static mut cv_ffloorclip: consvar_t;
    ...
    static mut portalline: boolean;
    static mut curdrawsegs: *mut drawseg_t;
    static mut drawsegs: *mut drawseg_t;
    static mut ds_p: *mut drawseg_t;
    static mut doorclosed: int32_t;
    fn R_FakeFlat(
        sec: *mut sector_t,
        tempsec: *mut sector_t,
        floorlightlevel: *mut int32_t,
        ceilinglightlevel: *mut int32_t,
        back: boolean,
    ) -> *mut sector_t;
    ...
    static mut windowbottom: fixed_t;
    static mut windowtop: fixed_t;
    static mut dc_lightlist: *mut r_lightlist_s;
    static mut dc_numlights: int32_t;
    static mut sprbotscreen: fixed_t;
    static mut dc_texheight: int32_t;
    static mut mceilingclip: *mut int16_t;
    static mut mfloorclip: *mut int16_t;
    static mut dc_maxlights: int32_t;
    static mut lengthcol: int32_t;
    ...
    fn R_DrawFlippedMaskedColumn(column: *mut column_t);
    ...
    static mut ffloor: [visffloor_t; 40];
    static mut numffloors: int32_t;
    static mut frontscale: [fixed_t; 1920];
    static mut ceilingplane: *mut visplane_t;
    static mut floorplane: *mut visplane_t;
    static mut firstseg: *mut drawseg_t;
    fn R_ExpandPlane(pl: *mut visplane_t, start: int32_t, stop: int32_t);
    fn R_CheckPlane(
        pl: *mut visplane_t,
        start: int32_t,
        stop: int32_t,
    ...
    static mut screenheightarray: [int16_t; 1920];
    static mut negonearray: [int16_t; 1920];
    fn Z_ReallocAlign(
        ptr: *mut libc::c_void,
        size: size_t,
        tag: int32_t,
    ...
    fn P_GetFFloorTopZAt(ffloor_0: *const ffloor_t, x: fixed_t, y: fixed_t) -> fixed_t;
    fn P_GetFFloorBottomZAt(
        ffloor_0: *const ffloor_t,
        x: fixed_t,
        y: fixed_t,
    ) -> fixed_t;
    fn P_GetLightZAt(light: *const lightlist_t, x: fixed_t, y: fixed_t) -> fixed_t;
    static mut con_clipviewtop: int32_t;
}
...
pub const COLDRAWFUNC_MAX: C2RustUnnamed_3 = 9;
pub const COLDRAWFUNC_FOG: C2RustUnnamed_3 = 8;
pub const COLDRAWFUNC_TWOSMULTIPATCHTRANS: C2RustUnnamed_3 = 7;
pub const COLDRAWFUNC_TWOSMULTIPATCH: C2RustUnnamed_3 = 6;
pub const COLDRAWFUNC_TRANSTRANS: C2RustUnnamed_3 = 5;
pub const COLDRAWFUNC_SHADOWED: C2RustUnnamed_3 = 4;
pub const COLDRAWFUNC_SHADE: C2RustUnnamed_3 = 3;
pub const COLDRAWFUNC_TRANS: C2RustUnnamed_3 = 2;
pub const COLDRAWFUNC_FUZZY: C2RustUnnamed_3 = 1;
pub const COLDRAWFUNC_BASE: C2RustUnnamed_3 = 0;
...
pub type transnum_t = libc::c_uint;
pub const NUMTRANSMAPS: transnum_t = 10;
pub const tr_trans90: transnum_t = 9;
pub const tr_trans80: transnum_t = 8;
pub const tr_trans70: transnum_t = 7;
pub const tr_trans60: transnum_t = 6;
pub const tr_trans50: transnum_t = 5;
pub const tr_trans40: transnum_t = 4;
pub const tr_trans30: transnum_t = 3;
pub const tr_trans20: transnum_t = 2;
pub const tr_trans10: transnum_t = 1;
...
pub const POF_SPLAT: C2RustUnnamed_4 = 8192;
pub const POF_NOSPECIALS: C2RustUnnamed_4 = 4096;
pub const POF_ONESIDE: C2RustUnnamed_4 = 2048;
pub const POF_LDEXEC: C2RustUnnamed_4 = 1024;
pub const POF_PUSHABLESTOP: C2RustUnnamed_4 = 512;
pub const POF_INVERTPLANESONLY: C2RustUnnamed_4 = 256;
pub const POF_INVERTPLANES: C2RustUnnamed_4 = 128;
pub const POF_INVERT: C2RustUnnamed_4 = 64;
pub const POF_RENDERALL: C2RustUnnamed_4 = 56;
pub const POF_RENDERPLANES: C2RustUnnamed_4 = 48;
pub const POF_RENDERBOTTOM: C2RustUnnamed_4 = 32;
pub const POF_RENDERTOP: C2RustUnnamed_4 = 16;
pub const POF_RENDERSIDES: C2RustUnnamed_4 = 8;
pub const POF_TESTHEIGHT: C2RustUnnamed_4 = 4;
pub const POF_SOLID: C2RustUnnamed_4 = 3;
pub const POF_CLIPPLANES: C2RustUnnamed_4 = 2;
pub const POF_CLIPLINES: C2RustUnnamed_4 = 1;
...
pub type visffloor_t = planemgr_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct planemgr_s {
    ...
    pub b_frac: fixed_t,
    pub b_step: fixed_t,
    pub f_clip: [int16_t; 1920],
    pub c_clip: [int16_t; 1920],
    pub f_pos_slope: fixed_t,
    pub b_pos_slope: fixed_t,
    pub slope: *mut pslope_s,
    pub ffloor: *mut ffloor_s,
    pub polyobj: *mut polyobj_t,
}
...
static mut segtextured: boolean = 0;
static mut markfloor: boolean = 0;
static mut markceiling: boolean = 0;
static mut maskedtexture: boolean = 0;
static mut toptexture: int32_t = 0;
static mut bottomtexture: int32_t = 0;
static mut midtexture: int32_t = 0;
static mut numthicksides: int32_t = 0;
static mut numbackffloors: int32_t = 0;
#[no_mangle]
...
static mut rw_x: int32_t = 0;
static mut rw_stopx: int32_t = 0;
static mut rw_centerangle: angle_t = 0;
static mut rw_offset: fixed_t = 0;
static mut rw_offset_top: fixed_t = 0;
static mut rw_offset_mid: fixed_t = 0;
static mut rw_offset_bot: fixed_t = 0;
static mut rw_offset2: fixed_t = 0;
...
static mut worldtop: int32_t = 0;
static mut worldbottom: int32_t = 0;
static mut worldhigh: int32_t = 0;
static mut worldlow: int32_t = 0;
static mut worldtopslope: int32_t = 0;
static mut worldbottomslope: int32_t = 0;
static mut worldhighslope: int32_t = 0;
static mut worldlowslope: int32_t = 0;
static mut rw_toptextureslide: fixed_t = 0;
static mut rw_midtextureslide: fixed_t = 0;
static mut rw_bottomtextureslide: fixed_t = 0;
static mut rw_midtextureback: fixed_t = 0;
static mut rw_midtexturebackslide: fixed_t = 0;
static mut rw_floormarked: boolean = false_0 as libc::c_int;
static mut rw_ceilingmarked: boolean = false_0 as libc::c_int;
static mut rw_silhouette: *mut int32_t = 0 as *const int32_t as *mut int32_t;
static mut rw_tsilheight: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
static mut rw_bsilheight: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
...
static mut walllights: *mut *mut lighttable_t = 0 as *const *mut lighttable_t
    as *mut *mut lighttable_t;
static mut maskedtexturecol: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
static mut maskedtextureheight: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
static mut numopenings: size_t = 0;
static mut openings: *mut int16_t = 0 as *const int16_t as *mut int16_t;
static mut lastopening: *mut int16_t = 0 as *const int16_t as *mut int16_t;
static mut texturecolumntablesize: size_t = 0;
static mut texturecolumntable: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
static mut curtexturecolumntable: *mut fixed_t = 0 as *const fixed_t as *mut fixed_t;
#[no_mangle]
pub unsafe extern "C" fn R_ClearSegTables() {
    lastopening = openings;
    curtexturecolumntable = texturecolumntable;
}
unsafe extern "C" fn R_Render2sidedMultiPatchColumn(mut column: *mut column_t) {
    ...
    dc_yl = sprtopscreen + ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int
        >> 16 as libc::c_int;
    ...
    if dc_yl <= *mceilingclip.offset(dc_x as isize) as libc::c_int {
        dc_yl = *mceilingclip.offset(dc_x as isize) as libc::c_int + 1 as libc::c_int;
    }
    if dc_yl >= vid.height || dc_yh < 0 as libc::c_int {
        return;
    }
    if dc_yl <= dc_yh && dc_yh < vid.height && dc_yh > 0 as libc::c_int {
        dc_source = (column as *mut uint8_t).offset(3 as libc::c_int as isize);
        if colfunc == colfuncs[0 as libc::c_int as usize] {
            (colfuncs[COLDRAWFUNC_TWOSMULTIPATCH as libc::c_int as usize])
                .expect("non-null function pointer")();
        } else if colfunc == colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize] {
            (colfuncs[COLDRAWFUNC_TWOSMULTIPATCHTRANS as libc::c_int as usize])
                .expect("non-null function pointer")();
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn R_GetLinedefTransTable(mut alpha: fixed_t) -> transnum_t {
    return (20 as libc::c_int
        * (((1 as libc::c_int) << 16 as libc::c_int) - alpha - 1 as libc::c_int)
        + ((1 as libc::c_int) << 16 as libc::c_int)
        >> 16 as libc::c_int + 1 as libc::c_int) as transnum_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_RenderMaskedSegRange(
    ...
    let mut pindex: size_t = 0;
    let mut col: *mut column_t = 0 as *mut column_t;
    let mut lightnum: int32_t = 0;
    let mut texnum: int32_t = 0;
    let mut i: int32_t = 0;
    let mut height: fixed_t = 0;
    let mut realbot: fixed_t = 0;
    let mut light: *mut lightlist_t = 0 as *mut lightlist_t;
    let mut rlight: *mut r_lightlist_t = 0 as *mut r_lightlist_t;
    let mut colfunc_2s: Option::<unsafe extern "C" fn(*mut column_t) -> ()> = None;
    let mut ldef: *mut line_t = 0 as *mut line_t;
    let mut front: *mut sector_t = 0 as *mut sector_t;
    let mut back: *mut sector_t = 0 as *mut sector_t;
    let mut times: int32_t = 0;
    let mut repeats: int32_t = 0;
    ...
    windowtop = sprbotscreen;
    windowbottom = windowtop;
    ldef = (*curline).linedef;
    if (*ldef).alpha == 0 {
        return;
    }
    if (*ldef).blendmode as libc::c_int == AST_FOG as libc::c_int {
        colfunc = colfuncs[COLDRAWFUNC_FOG as libc::c_int as usize];
        windowtop = (*frontsector).ceilingheight;
        windowbottom = (*frontsector).floorheight;
    } else if (*ldef).blendmode != 0 {
        if (*ldef).alpha == NUMTRANSMAPS as libc::c_int
            || (*ldef).blendmode as libc::c_int == AST_MODULATE as libc::c_int
        {
            dc_transmap = R_GetBlendTable(
                (*ldef).blendmode as libc::c_int,
                0 as libc::c_int,
            );
        } else {
            dc_transmap = R_GetBlendTable(
                (*ldef).blendmode as libc::c_int,
                R_GetLinedefTransTable((*ldef).alpha) as int32_t,
            );
        }
        colfunc = colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize];
    } else if (*ldef).alpha > 0 as libc::c_int
        && (*ldef).alpha < (1 as libc::c_int) << 16 as libc::c_int
    {
        dc_transmap = R_GetTranslucencyTable(
            R_GetLinedefTransTable((*ldef).alpha) as int32_t,
        );
        colfunc = colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize];
    } else {
    ...
    if !((*curline).polyseg).is_null()
        && (*(*curline).polyseg).translucency > 0 as libc::c_int
    {
        if (*(*curline).polyseg).translucency >= NUMTRANSMAPS as libc::c_int {
            return;
        }
        dc_transmap = R_GetTranslucencyTable((*(*curline).polyseg).translucency);
        colfunc = colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize];
    }
    range = if (*ds).x2 - (*ds).x1 > 1 as libc::c_int {
        (*ds).x2 - (*ds).x1
    } else {
        1 as libc::c_int
    };
    ...
    if (**textures.offset(texnum as isize)).holes != 0 {
        if (**textures.offset(texnum as isize)).flip as libc::c_int & 2 as libc::c_int
            != 0
        {
            colfunc_2s = Some(
                R_DrawFlippedMaskedColumn as unsafe extern "C" fn(*mut column_t) -> (),
            );
            lengthcol = (**textures.offset(texnum as isize)).height as int32_t;
        } else {
            colfunc_2s = Some(
                R_DrawMaskedColumn as unsafe extern "C" fn(*mut column_t) -> (),
            );
        }
    } else {
        colfunc_2s = Some(
            R_Render2sidedMultiPatchColumn as unsafe extern "C" fn(*mut column_t) -> (),
        );
        lengthcol = (**textures.offset(texnum as isize)).height as int32_t;
    }
    dc_numlights = 0 as libc::c_int;
    if (*frontsector).numlights != 0 {
        dc_numlights = (*frontsector).numlights;
        if dc_numlights >= dc_maxlights {
            dc_maxlights = dc_numlights;
            dc_lightlist = Z_ReallocAlign(
                dc_lightlist as *mut libc::c_void,
                (::core::mem::size_of::<r_lightlist_s>() as libc::c_ulong)
                    .wrapping_mul(dc_maxlights as libc::c_ulong),
        ...
        while i < dc_numlights {
            let mut leftheight: fixed_t = 0;
            let mut rightheight: fixed_t = 0;
            light = &mut *((*frontsector).lightlist).offset(i as isize)
                as *mut lightlist_t;
            rlight = &mut *dc_lightlist.offset(i as isize) as *mut r_lightlist_s;
            ...
            (*rlight).startheight = (*rlight).height;
            (*rlight).lightlevel = *(*light).lightlevel;
            (*rlight).extra_colormap = *(*light).extra_colormap;
            (*rlight).flags = (*light).flags as ffloortype_e;
            if colfunc != colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize]
                || (*rlight).flags as libc::c_uint
                    & FOF_FOG as libc::c_int as libc::c_uint != 0
                || !((*rlight).extra_colormap).is_null()
                    && (*(*rlight).extra_colormap).flags as libc::c_int
                        & 4 as libc::c_int != 0
            {
                lightnum = (*rlight).lightlevel as libc::c_int >> 3 as libc::c_int;
            } else {
                lightnum = 32 as libc::c_int - 1 as libc::c_int;
            }
            if !(!((*rlight).extra_colormap).is_null()
                && (*(*rlight).extra_colormap).flags as libc::c_int & 4 as libc::c_int
                    != 0)
            {
        ...
        if colfunc != colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize]
            || !((*frontsector).extra_colormap).is_null()
                && (*(*frontsector).extra_colormap).flags as libc::c_int
                    & 4 as libc::c_int != 0
        {
            lightnum = (*frontsector).lightlevel as libc::c_int >> 3 as libc::c_int;
        } else {
            lightnum = 32 as libc::c_int - 1 as libc::c_int;
        }
        if !(colfunc == colfuncs[COLDRAWFUNC_FOG as libc::c_int as usize]
            || !((*frontsector).extra_colormap).is_null()
                && (*(*frontsector).extra_colormap).flags as libc::c_int
                    & 4 as libc::c_int != 0)
        {
        ...
        if lightnum < 0 as libc::c_int {
            walllights = (scalelight[0 as libc::c_int as usize]).as_mut_ptr();
        } else if lightnum >= 32 as libc::c_int {
            walllights = (scalelight[(32 as libc::c_int - 1 as libc::c_int) as usize])
                .as_mut_ptr();
        } else {
    ...
    if (*frontsector).heightsec != -(1 as libc::c_int) {
        front = &mut *sectors.offset((*frontsector).heightsec as isize) as *mut sector_t;
    } else {
        front = frontsector;
    }
    if (*backsector).heightsec != -(1 as libc::c_int) {
        back = &mut *sectors.offset((*backsector).heightsec as isize) as *mut sector_t;
    } else {
        back = backsector;
    }
    if (*(*(*ds).curline).sidedef).repeatcnt != 0 {
        repeats = 1 as libc::c_int
            + (*(*(*ds).curline).sidedef).repeatcnt as libc::c_int;
    } else if (*ldef).flags as libc::c_int & 1024 as libc::c_int != 0 {
        let mut high: fixed_t = 0;
        let mut low: fixed_t = 0;
        ...
        repeats = (high - low) / *textureheight.offset(texnum as isize);
        if (high - low) % *textureheight.offset(texnum as isize) != 0 {
            repeats += 1;
            repeats;
        }
    } else {
    ...
    while times < repeats {
        ...
        dc_texheight = *textureheight.offset(texnum as isize) >> 16 as libc::c_int;
        dc_x = x1;
        while dc_x <= x2 {
            dc_texturemid = (*ds).maskedtextureheight[dc_x as usize];
            if (*(*curline).linedef).flags as libc::c_int & 256 as libc::c_int != 0 {
                dc_texturemid
                    += *textureheight.offset(texnum as isize) * times
                        + *textureheight.offset(texnum as isize);
            } else {
                dc_texturemid -= *textureheight.offset(texnum as isize) * times;
            }
            overflow_test = centeryfrac as int64_t
                - (dc_texturemid as int64_t * spryscale as int64_t >> 16 as libc::c_int);
                ...
                & 0xffffffff80000000 as libc::c_ulonglong != 0
            {
                if dc_numlights != 0 {
                    i = 0 as libc::c_int;
                    while i < dc_numlights {
                        rlight = &mut *dc_lightlist.offset(i as isize)
                            as *mut r_lightlist_s;
            ...
            } else if dc_numlights != 0 {
                let mut xwalllights: *mut *mut lighttable_t = 0
                    as *mut *mut lighttable_t;
                sprbotscreen = 2147483647 as libc::c_int;
                windowtop = centeryfrac - FixedMul(dc_texturemid, spryscale);
                sprtopscreen = windowtop;
                windowbottom = FixedMul(
                    *textureheight.offset(texnum as isize),
                    spryscale,
                ) + sprtopscreen;
                realbot = windowbottom;
                dc_iscale = (0xffffffff as libc::c_uint)
                    .wrapping_div(spryscale as libc::c_uint) as fixed_t;
                col = (R_GetColumn(
                    texnum,
                    *maskedtexturecol.offset(dc_x as isize) >> 16 as libc::c_int,
                ))
                    .offset(-(3 as libc::c_int as isize)) as *mut column_t;
                i = 0 as libc::c_int;
                while i < dc_numlights {
                    rlight = &mut *dc_lightlist.offset(i as isize) as *mut r_lightlist_s;
                    if !((*rlight).flags as libc::c_uint
                        & FOF_NOSHADE as libc::c_int as libc::c_uint != 0)
                    {
                        if (*rlight).lightnum < 0 as libc::c_int {
                            xwalllights = (scalelight[0 as libc::c_int as usize])
                                .as_mut_ptr();
                        } else if (*rlight).lightnum >= 32 as libc::c_int {
                            xwalllights = (scalelight[(32 as libc::c_int
                                - 1 as libc::c_int) as usize])
                                .as_mut_ptr();
                        } else {
                            xwalllights = (scalelight[(*rlight).lightnum as usize])
                                .as_mut_ptr();
                        }
                        pindex = (FixedMul(
                            spryscale,
                        ...
                        if pindex >= 48 as libc::c_int as size_t {
                            pindex = (48 as libc::c_int - 1 as libc::c_int) as size_t;
                        }
                        if !((*rlight).extra_colormap).is_null() {
                            (*rlight)
                                .rcolormap = ((*(*rlight).extra_colormap).colormap)
                                .offset(
                                    (*xwalllights.offset(pindex as isize))
                                        .offset_from(colormaps) as libc::c_long as isize,
                                );
                        } else {
                            (*rlight).rcolormap = *xwalllights.offset(pindex as isize);
                        }
                        ...
                        if height <= windowtop {
                            ...
                            if windowbottom >= realbot {
                                ...
                                colfunc_2s.expect("non-null function pointer")(col);
                                i += 1;
                                i;
                                while i < dc_numlights {
                                    rlight = &mut *dc_lightlist.offset(i as isize)
                                ...
                                colfunc_2s.expect("non-null function pointer")(col);
                                windowtop = windowbottom + 1 as libc::c_int;
                                dc_colormap = (*rlight).rcolormap;
                            }
                        }
                    }
                ...
                pindex = (FixedMul(spryscale, 640 as libc::c_int * fovtan / vid.width)
                    >> 12 as libc::c_int) as size_t;
                if pindex >= 48 as libc::c_int as size_t {
                    pindex = (48 as libc::c_int - 1 as libc::c_int) as size_t;
                }
                dc_colormap = *walllights.offset(pindex as isize);
                if !((*frontsector).extra_colormap).is_null() {
                    dc_colormap = ((*(*frontsector).extra_colormap).colormap)
                        .offset(
                            dc_colormap.offset_from(colormaps) as libc::c_long as isize,
                        );
                }
...
unsafe extern "C" fn R_DrawRepeatMaskedColumn(mut col: *mut column_t) {
    while sprtopscreen < sprbotscreen {
        R_DrawMaskedColumn(col);
        if sprtopscreen as int64_t + (dc_texheight * spryscale) as int64_t
            > 2147483647 as libc::c_int as int64_t
        {
            sprtopscreen = 2147483647 as libc::c_int;
        } else {
            sprtopscreen += dc_texheight * spryscale;
        }
    }
}
unsafe extern "C" fn R_DrawRepeatFlippedMaskedColumn(mut col: *mut column_t) {
    loop {
        R_DrawFlippedMaskedColumn(col);
        sprtopscreen += dc_texheight * spryscale;
        if !(sprtopscreen < sprbotscreen) {
            break;
        }
    };
}
unsafe extern "C" fn R_IsFFloorTranslucent(mut pfloor: *mut visffloor_t) -> boolean {
    if !((*pfloor).polyobj).is_null() {
        return ((*(*pfloor).polyobj).translucency > 0 as libc::c_int) as libc::c_int;
    }
    if !((*pfloor).ffloor).is_null() {
        return ((*(*pfloor).ffloor).fofflags as libc::c_uint
            & (FOF_TRANSLUCENT as libc::c_int | FOF_FOG as libc::c_int) as libc::c_uint)
            as boolean;
    }
    return false_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_RenderThickSideRange(
    mut ds: *mut drawseg_t,
    mut x1: int32_t,
    mut x2: int32_t,
    mut pfloor: *mut ffloor_t,
) {
    let mut pindex: size_t = 0;
    let mut col: *mut column_t = 0 as *mut column_t;
    let mut lightnum: int32_t = 0;
    let mut texnum: int32_t = 0;
    let mut tempsec: sector_t = sector_s {
        floorheight: 0,
        ceilingheight: 0,
        floorpic: 0,
        ceilingpic: 0,
        ...
        validcount: 0,
        thinglist: 0 as *mut mobj_t,
        floordata: 0 as *mut libc::c_void,
        ceilingdata: 0 as *mut libc::c_void,
        lightingdata: 0 as *mut libc::c_void,
        fadecolormapdata: 0 as *mut libc::c_void,
        floorxoffset: 0,
        flooryoffset: 0,
        ceilingxoffset: 0,
        ceilingyoffset: 0,
        ...
        floorlightlevel: 0,
        ceilinglightlevel: 0,
        floorlightabsolute: 0,
        ceilinglightabsolute: 0,
        floorlightsec: 0,
        ceilinglightsec: 0,
        crumblestate: 0,
        touching_thinglist: 0 as *mut msecnode_s,
        linecount: 0,
        lines: 0 as *mut *mut line_s,
        ffloors: 0 as *mut ffloor_t,
        attached: 0 as *mut size_t,
        attachedsolid: 0 as *mut boolean,
        numattached: 0,
        maxattached: 0,
        lightlist: 0 as *mut lightlist_t,
        numlights: 0,
        moved: 0,
        extra_colormap: 0 as *mut extracolormap_t,
        colormap_protected: 0,
        gravity: 0,
        gravityptr: 0 as *mut fixed_t,
        flags: 0 as sectorflags_t,
        specialflags: 0 as sectorspecialflags_t,
        damagetype: 0,
        triggertag: 0,
        triggerer: 0,
        friction: 0,
        cullheight: 0 as *mut line_s,
        floorspeed: 0,
        ceilspeed: 0,
        preciplist: 0 as *mut precipmobj_t,
        touching_preciplist: 0 as *mut mprecipsecnode_s,
        f_slope: 0 as *mut pslope_t,
        c_slope: 0 as *mut pslope_t,
        hasslope: 0,
        spawn_lightlevel: 0,
        spawn_extra_colormap: 0 as *mut extracolormap_t,
    };
    let mut templight: int32_t = 0;
    let mut i: int32_t = 0;
    let mut p: int32_t = 0;
    let mut bottombounds: fixed_t = viewheight << 16 as libc::c_int;
    let mut topbounds: fixed_t = (con_clipviewtop - 1 as libc::c_int)
        << 16 as libc::c_int;
    let mut offsetvalue: fixed_t = 0 as libc::c_int;
    let mut light: *mut lightlist_t = 0 as *mut lightlist_t;
    let mut rlight: *mut r_lightlist_t = 0 as *mut r_lightlist_t;
    let mut range: int32_t = 0;
    let mut newline: *mut line_t = 0 as *mut line_t;
    let mut top_frac: int64_t = 0;
    let mut top_step: int64_t = 0;
    let mut bottom_frac: int64_t = 0;
    let mut bottom_step: int64_t = 0;
    let mut slopeskew: boolean = false_0 as libc::c_int;
    let mut ffloortextureslide: fixed_t = 0 as libc::c_int;
    let mut oldx: int32_t = -(1 as libc::c_int);
    let mut left_top: fixed_t = 0;
    let mut left_bottom: fixed_t = 0;
    let mut skewslope: *mut pslope_t = 0 as *mut pslope_t;
    let mut colfunc_2s: Option::<unsafe extern "C" fn(*mut column_t) -> ()> = None;
    curline = (*ds).curline;
    backsector = (*pfloor).target;
    frontsector = if (*curline).frontsector == (*pfloor).target {
        (*curline).backsector
    } else {
        (*curline).frontsector
    };
    texnum = R_GetTextureNum(
        (*sides.offset((*(*pfloor).master).sidenum[0 as libc::c_int as usize] as isize))
            .midtexture,
    );
    colfunc = colfuncs[0 as libc::c_int as usize];
    if (*(*pfloor).master).flags as libc::c_int & 32768 as libc::c_int != 0 {
        let mut linenum: size_t = ((*curline).linedef)
            .offset_from(*((*backsector).lines).offset(0 as libc::c_int as isize))
            as libc::c_long as size_t;
        newline = (*((*(*(*pfloor).master).frontsector).lines)
            .offset(0 as libc::c_int as isize))
            .offset(linenum as isize);
        texnum = R_GetTextureNum(
            (*sides.offset((*newline).sidenum[0 as libc::c_int as usize] as isize))
                .midtexture,
        );
    }
    if (*pfloor).fofflags as libc::c_uint
        & FOF_TRANSLUCENT as libc::c_int as libc::c_uint != 0
    {
        let mut fuzzy: boolean = true_0 as libc::c_int;
        let mut trans: int32_t = 10 as libc::c_int
            * (256 as libc::c_int + 12 as libc::c_int - (*pfloor).alpha)
            / 255 as libc::c_int;
        if trans >= 10 as libc::c_int {
            return;
        }
        if (*pfloor).blend != 0 {
            dc_transmap = R_GetBlendTable((*pfloor).blend as libc::c_int, trans);
        } else {
            dc_transmap = R_GetTranslucencyTable(trans);
            if dc_transmap.is_null() || trans == 0 as libc::c_int {
                fuzzy = false_0 as libc::c_int;
            }
        }
        if fuzzy != 0 {
            colfunc = colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize];
        }
    } else if (*pfloor).fofflags as libc::c_uint & FOF_FOG as libc::c_int as libc::c_uint
        != 0
    {
        colfunc = colfuncs[COLDRAWFUNC_FOG as libc::c_int as usize];
    }
    ...
    if (*frontsector).numlights != 0 {
        ...
        while i < dc_numlights {
            let mut leftheight: fixed_t = 0;
            let mut rightheight: fixed_t = 0;
            let mut pfloorleft: fixed_t = 0;
            let mut pfloorright: fixed_t = 0;
            let mut overflow_test: int64_t = 0;
            light = &mut *((*frontsector).lightlist).offset(i as isize)
                as *mut lightlist_t;
            rlight = &mut *dc_lightlist.offset(p as isize) as *mut r_lightlist_s;
            leftheight = P_GetZAt(
                (*light).slope,
                (*ds).leftpos.x,
                (*ds).leftpos.y,
            ...
            if !(leftheight < pfloorleft && rightheight < pfloorright) {
                ...
                if leftheight > pfloorleft && rightheight > pfloorright
                    && (i + 1 as libc::c_int) < dc_numlights
                {
                    let mut nextlight: *mut lightlist_t = &mut *((*frontsector)
                        .lightlist)
                        .offset((i + 1 as libc::c_int) as isize) as *mut lightlist_t;
                    if P_GetZAt(
                        (*nextlight).slope,
                        (*ds).leftpos.x,
                        (*ds).leftpos.y,
                    ...
                    {
                        current_block_86 = 1118134448028020070;
                    } else {
                        current_block_86 = 1622411330066726685;
                    }
                } else {
                    current_block_86 = 1622411330066726685;
                }
                match current_block_86 {
                    ...
                    _ => {
                        ...
                        rightheight -= viewz;
                        overflow_test = centeryfrac as int64_t
                            - (leftheight as int64_t * (*ds).scale1 as int64_t
                                >> 16 as libc::c_int);
                        if overflow_test > 2147483647 as libc::c_int as int64_t {
                            (*rlight).height = 2147483647 as libc::c_int;
                        } else if overflow_test > -(2147483647 as libc::c_int) as int64_t
                        {
                            (*rlight).height = overflow_test as fixed_t;
                        } else {
                            (*rlight).height = -(2147483647 as libc::c_int);
                        }
                        overflow_test = centeryfrac as int64_t
                            - (rightheight as int64_t * (*ds).scale2 as int64_t
                                >> 16 as libc::c_int);
                        if overflow_test > 2147483647 as libc::c_int as int64_t {
                            (*rlight).heightstep = 2147483647 as libc::c_int;
                        } else if overflow_test > -(2147483647 as libc::c_int) as int64_t
                        {
                            (*rlight).heightstep = overflow_test as fixed_t;
                        } else {
                            (*rlight).heightstep = -(2147483647 as libc::c_int);
                        }
                        (*rlight)
                            .heightstep = ((*rlight).heightstep - (*rlight).height)
                            / range;
                        (*rlight).flags = (*light).flags as ffloortype_e;
                        if (*light).flags & FOF_CUTLEVEL as libc::c_int != 0 {
                            leftheight = P_GetZAt(
                                *(*(*light).caster).b_slope,
                                (*ds).leftpos.x,
                                (*ds).leftpos.y,
                            ...
                            overflow_test = centeryfrac as int64_t
                                - (leftheight as int64_t * (*ds).scale1 as int64_t
                                    >> 16 as libc::c_int);
                            if overflow_test > 2147483647 as libc::c_int as int64_t {
                                (*rlight).botheight = 2147483647 as libc::c_int;
                            } else if overflow_test
                                > -(2147483647 as libc::c_int) as int64_t
                            {
                                (*rlight).botheight = overflow_test as fixed_t;
                            } else {
                                (*rlight).botheight = -(2147483647 as libc::c_int);
                            }
                            overflow_test = centeryfrac as int64_t
                                - (rightheight as int64_t * (*ds).scale2 as int64_t
                                    >> 16 as libc::c_int);
                            if overflow_test > 2147483647 as libc::c_int as int64_t {
                                (*rlight).botheightstep = 2147483647 as libc::c_int;
                            } else if overflow_test
                                > -(2147483647 as libc::c_int) as int64_t
                            {
                                (*rlight).botheightstep = overflow_test as fixed_t;
                            } else {
                                (*rlight).botheightstep = -(2147483647 as libc::c_int);
                            }
                            (*rlight)
                                .botheightstep = ((*rlight).botheightstep
                                - (*rlight).botheight) / range;
                        }
                        (*rlight).lightlevel = *(*light).lightlevel;
                        (*rlight).extra_colormap = *(*light).extra_colormap;
                        if (*pfloor).fofflags as libc::c_uint
                            & FOF_FOG as libc::c_int as libc::c_uint != 0
                        {
                            ...
                            (*rlight)
                                .lightnum = (*rlight).lightlevel as libc::c_int
                                >> 3 as libc::c_int;
                        }
                        if !((*pfloor).fofflags as libc::c_uint
                            & FOF_FOG as libc::c_int as libc::c_uint != 0
        ...
        if !((*frontsector).extra_colormap).is_null()
            && (*(*frontsector).extra_colormap).flags as libc::c_int & 4 as libc::c_int
                != 0
        {
            lightnum = (*frontsector).lightlevel as libc::c_int >> 3 as libc::c_int;
        } else if (*pfloor).fofflags as libc::c_uint
            & FOF_FOG as libc::c_int as libc::c_uint != 0
        {
            lightnum = (*(*(*pfloor).master).frontsector).lightlevel as libc::c_int
                >> 3 as libc::c_int;
        } else if colfunc == colfuncs[COLDRAWFUNC_FUZZY as libc::c_int as usize] {
            lightnum = 32 as libc::c_int - 1 as libc::c_int;
        } else {
        ...
        if !((*pfloor).fofflags as libc::c_uint & FOF_FOG as libc::c_int as libc::c_uint
            != 0
            || !((*frontsector).extra_colormap).is_null()
                && (*(*frontsector).extra_colormap).flags as libc::c_int
                    & 4 as libc::c_int != 0)
    ...
    skewslope = *(*pfloor).t_slope;
    if !newline.is_null() {
        if (*newline).flags as libc::c_int & 32 as libc::c_int != 0 {
            slopeskew = true_0 as libc::c_int;
        }
    } else if (*(*pfloor).master).flags as libc::c_int & 32 as libc::c_int != 0 {
        slopeskew = true_0 as libc::c_int;
    }
    if slopeskew != 0 {
    ...
    if !newline.is_null() {
        offsetvalue = (*sides
            .offset((*newline).sidenum[0 as libc::c_int as usize] as isize))
            .rowoffset
            + (*sides.offset((*newline).sidenum[0 as libc::c_int as usize] as isize))
                .offsety_mid;
        if (*newline).flags as libc::c_int & 16 as libc::c_int != 0 {
            skewslope = *(*pfloor).b_slope;
            if slopeskew != 0 {
        ...
        offsetvalue = (*sides
            .offset((*(*pfloor).master).sidenum[0 as libc::c_int as usize] as isize))
            .rowoffset
            + (*sides
                .offset((*(*pfloor).master).sidenum[0 as libc::c_int as usize] as isize))
                .offsety_mid;
        if (*(*curline).linedef).flags as libc::c_int & 16 as libc::c_int != 0 {
            skewslope = *(*pfloor).b_slope;
            if slopeskew != 0 {
                dc_texturemid = left_bottom;
            } else {
    ...
    if slopeskew != 0 {
        let mut lineangle: angle_t = R_PointToAngle2(
            (*(*curline).v1).x,
            (*(*curline).v1).y,
            (*(*curline).v2).x,
            (*(*curline).v2).y,
        );
        if !skewslope.is_null() {
            ffloortextureslide = FixedMul(
                (*skewslope).zdelta,
                *finecosine
                    .offset(
                        (lineangle.wrapping_sub((*skewslope).xydirection)
            ...
            != 0
        {
            colfunc_2s = Some(
                R_DrawRepeatFlippedMaskedColumn
                    as unsafe extern "C" fn(*mut column_t) -> (),
            );
            lengthcol = (**textures.offset(texnum as isize)).height as int32_t;
        } else {
            colfunc_2s = Some(
                R_DrawRepeatMaskedColumn as unsafe extern "C" fn(*mut column_t) -> (),
            );
        }
    } else {
        colfunc_2s = Some(
    ...
    let mut right_top: fixed_t = 0;
    let mut right_bottom: fixed_t = 0;
    right_top = P_GetFFloorTopZAt(pfloor, (*ds).rightpos.x, (*ds).rightpos.y) - viewz;
    right_bottom = P_GetFFloorBottomZAt(pfloor, (*ds).rightpos.x, (*ds).rightpos.y)
        - viewz;
    top_frac = centeryfrac as int64_t
        - (left_top as int64_t * (*ds).scale1 as int64_t >> 16 as libc::c_int);
    bottom_frac = centeryfrac as int64_t
        - (left_bottom as int64_t * (*ds).scale1 as int64_t >> 16 as libc::c_int);
    top_step = centeryfrac as int64_t
        - (right_top as int64_t * (*ds).scale2 as int64_t >> 16 as libc::c_int);
    bottom_step = centeryfrac as int64_t
        - (right_bottom as int64_t * (*ds).scale2 as int64_t >> 16 as libc::c_int);
    top_step = (top_step - top_frac) / range as int64_t;
    bottom_step = (bottom_step - bottom_frac) / range as int64_t;
    top_frac += top_step * (x1 - (*ds).x1) as int64_t;
    bottom_frac += bottom_step * (x1 - (*ds).x1) as int64_t;
    dc_x = x1;
    while dc_x <= x2 {
        if ffloortextureslide != 0 {
            if oldx != -(1 as libc::c_int) {
                dc_texturemid
                    += FixedMul(
                        ffloortextureslide,
                        *maskedtexturecol.offset(oldx as isize)
                            - *maskedtexturecol.offset(dc_x as isize),
                    );
            }
            oldx = dc_x;
        }
        if top_frac > 2147483647 as libc::c_int as int64_t {
            windowtop = 2147483647 as libc::c_int;
            sprtopscreen = windowtop;
        } else if top_frac > -(2147483647 as libc::c_int) as int64_t {
            windowtop = top_frac as fixed_t;
            sprtopscreen = windowtop;
        } else {
            windowtop = -(2147483647 as libc::c_int);
            sprtopscreen = windowtop;
        }
        if bottom_frac > 2147483647 as libc::c_int as int64_t {
            windowbottom = 2147483647 as libc::c_int;
            sprbotscreen = windowbottom;
        } else if bottom_frac > -(2147483647 as libc::c_int) as int64_t {
            windowbottom = bottom_frac as fixed_t;
            sprbotscreen = windowbottom;
        } else {
            windowbottom = -(2147483647 as libc::c_int);
            sprbotscreen = windowbottom;
        ...
        if windowbottom < topbounds || windowtop > bottombounds {
            if dc_numlights != 0 {
                ...
                while i < dc_numlights {
                    ...
                    (*rlight).height += (*rlight).heightstep;
                    if (*rlight).flags as libc::c_uint
                        & FOF_CUTLEVEL as libc::c_int as libc::c_uint != 0
                    {
            ...
            if dc_numlights != 0 {
                let mut xwalllights: *mut *mut lighttable_t = 0
                    as *mut *mut lighttable_t;
                let mut height: fixed_t = 0;
                let mut bheight: fixed_t = 0 as libc::c_int;
                let mut solid: int32_t = 0 as libc::c_int;
                let mut lighteffect: int32_t = 0 as libc::c_int;
                i = 0 as libc::c_int;
                while i < dc_numlights {
                    rlight = &mut *dc_lightlist.offset(i as isize) as *mut r_lightlist_s;
                    lighteffect = ((*dc_lightlist.offset(i as isize)).flags
                        as libc::c_uint & FOF_NOSHADE as libc::c_int as libc::c_uint
                        == 0) as libc::c_int;
                    if lighteffect != 0 {
                        ...
                        if lightnum < 0 as libc::c_int {
                            ...
                            xwalllights = (scalelight[lightnum as usize]).as_mut_ptr();
                        }
                        pindex = (FixedMul(
                            spryscale,
                            640 as libc::c_int * fovtan / vid.width,
                            ...
                            & FOF_FOG as libc::c_int as libc::c_uint != 0
                        {
                            ...
                            {
                                (*rlight)
                                    .rcolormap = ((*(*(*(*pfloor).master).frontsector)
                                    .extra_colormap)
                                    .colormap)
                                    .offset(
                                        (*xwalllights.offset(pindex as isize))
                        ...
                        } else if !((*rlight).extra_colormap).is_null() {
                            (*rlight)
                                .rcolormap = ((*(*rlight).extra_colormap).colormap)
                                .offset(
                                    (*xwalllights.offset(pindex as isize))
                    ...
                    solid = 0 as libc::c_int;
                    if (*rlight).flags as libc::c_uint
                        & FOF_CUTSOLIDS as libc::c_int as libc::c_uint != 0
                        && (*pfloor).fofflags as libc::c_uint
                            & FOF_EXTRA as libc::c_int as libc::c_uint == 0
                    {
                        solid = 1 as libc::c_int;
                    } else if (*rlight).flags as libc::c_uint
                        & FOF_CUTEXTRA as libc::c_int as libc::c_uint != 0
                        && (*pfloor).fofflags as libc::c_uint
                            & FOF_EXTRA as libc::c_int as libc::c_uint != 0
                    {
                        if (*rlight).flags as libc::c_uint
                        ...
                        {
                            if (*rlight).flags as libc::c_uint
                                & (FOF_FOG as libc::c_int | FOF_SWIMMABLE as libc::c_int)
                                    as libc::c_uint
                                == (*pfloor).fofflags as libc::c_uint
                                    & (FOF_FOG as libc::c_int | FOF_SWIMMABLE as libc::c_int)
                                        as libc::c_uint
                ...
                if (*pfloor).fofflags as libc::c_uint
                    & FOF_FOG as libc::c_int as libc::c_uint != 0
                    && !((*(*(*pfloor).master).frontsector).extra_colormap).is_null()
                {
                    dc_colormap = ((*(*(*(*pfloor).master).frontsector).extra_colormap)
                        .colormap)
                        .offset(
                            dc_colormap.offset_from(colormaps) as libc::c_long as isize,
                        );
                } else if !((*frontsector).extra_colormap).is_null() {
                    dc_colormap = ((*(*frontsector).extra_colormap).colormap)
                        .offset(
                            dc_colormap.offset_from(colormaps) as libc::c_long as isize,
                        );
...
#[inline]
unsafe extern "C" fn R_ExpandPlaneY(
    mut pl: *mut visplane_t,
    mut x: int32_t,
    mut top: int16_t,
    mut bottom: int16_t,
) {
    if (*pl).top[x as usize] as libc::c_int > top as libc::c_int {
        (*pl).top[x as usize] = top as uint16_t;
    }
    if ((*pl).bottom[x as usize] as libc::c_int) < bottom as libc::c_int {
        (*pl).bottom[x as usize] = bottom as uint16_t;
    }
}
unsafe extern "C" fn R_FFloorCanClip(mut pfloor: *mut visffloor_t) -> boolean {
    return (cv_ffloorclip.value != 0 && R_IsFFloorTranslucent(pfloor) == 0
        && ((*pfloor).polyobj).is_null()) as libc::c_int;
}
unsafe extern "C" fn R_RenderSegLoop() {
    let mut angle: angle_t = 0;
    let mut pindex: size_t = 0;
    let mut yl: int32_t = 0;
    let mut yh: int32_t = 0;
    let mut mid: int32_t = 0;
    let mut texturecolumn: fixed_t = 0 as libc::c_int;
    let mut oldtexturecolumn: fixed_t = -(1 as libc::c_int);
    let mut top: int32_t = 0;
    let mut bottom: int32_t = 0;
    let mut i: int32_t = 0;
    while rw_x < rw_stopx {
        yl = topfrac + ((1 as libc::c_int) << 12 as libc::c_int) - 1 as libc::c_int
            >> 12 as libc::c_int;
        top = ceilingclip[rw_x as usize] as libc::c_int + 1 as libc::c_int;
        if yl < top {
            yl = top;
        }
        if markceiling != 0 {
            bottom = if yl > floorclip[rw_x as usize] as libc::c_int {
                floorclip[rw_x as usize] as libc::c_int
            } else {
                yl
            };
            bottom -= 1;
            if top <= bottom && !ceilingplane.is_null() {
                R_ExpandPlaneY(ceilingplane, rw_x, top as int16_t, bottom as int16_t);
            }
        }
        yh = bottomfrac >> 12 as libc::c_int;
        bottom = floorclip[rw_x as usize] as libc::c_int - 1 as libc::c_int;
        if yh > bottom {
            yh = bottom;
        }
        if markfloor != 0 {
            top = if yh < ceilingclip[rw_x as usize] as libc::c_int {
                ceilingclip[rw_x as usize] as libc::c_int
            } else {
                yh
            };
            top += 1;
            if top <= bottom && !floorplane.is_null() {
                R_ExpandPlaneY(floorplane, rw_x, top as int16_t, bottom as int16_t);
            }
        }
        rw_floormarked = false_0 as libc::c_int;
        rw_ceilingmarked = false_0 as libc::c_int;
        if numffloors != 0 {
            let mut fftop: int16_t = 0;
            let mut ffbottom: int16_t = 0;
            (*firstseg).frontscale[rw_x as usize] = frontscale[rw_x as usize];
            top = ceilingclip[rw_x as usize] as libc::c_int + 1 as libc::c_int;
            bottom = floorclip[rw_x as usize] as libc::c_int - 1 as libc::c_int;
            i = 0 as libc::c_int;
            while i < numffloors {
                if !(!(ffloor[i as usize].polyobj).is_null()
                    && (((*curline).polyseg).is_null()
                        || ffloor[i as usize].polyobj != (*curline).polyseg))
                {
                    if ffloor[i as usize].height < viewz {
                        let mut top_w: int32_t = (ffloor[i as usize].f_frac
                            >> 12 as libc::c_int) + 1 as libc::c_int;
                        let mut bottom_w: int32_t = ffloor[i as usize]
                            .f_clip[rw_x as usize] as int32_t;
                        if top_w < top {
                            top_w = top;
                        }
                        if bottom_w > bottom {
                        ...
                        if !(ffloor[i as usize].polyobj).is_null() && top_w >= bottom_w {
                            (*ffloor[i as usize].plane)
                                .top[rw_x as usize] = 0xffff as libc::c_int as uint16_t;
                            (*ffloor[i as usize].plane)
                                .bottom[rw_x as usize] = 0 as libc::c_int as uint16_t;
                        } else if top_w <= bottom_w {
                            fftop = top_w as int16_t;
                            ffbottom = bottom_w as int16_t;
                            (*ffloor[i as usize].plane)
                                .top[rw_x as usize] = fftop as uint16_t;
                            (*ffloor[i as usize].plane)
                                .bottom[rw_x as usize] = ffbottom as uint16_t;
                            if ffbottom as libc::c_int >= bottom - 1 as libc::c_int
                                && R_FFloorCanClip(
                                    &mut *ffloor.as_mut_ptr().offset(i as isize),
                                ) != 0 && ((*curline).polyseg).is_null()
                            {
                                rw_floormarked = true_0 as libc::c_int;
                                floorclip[rw_x as usize] = fftop;
                                if yh > fftop as libc::c_int {
                                    yh = fftop as int32_t;
                                }
                                if markfloor != 0 && !floorplane.is_null() {
                                    (*floorplane).top[rw_x as usize] = bottom as uint16_t;
                                }
                                if !rw_silhouette.is_null() {
                                    *rw_silhouette |= 1 as libc::c_int;
                                    *rw_bsilheight = 2147483647 as libc::c_int;
                                }
                            }
                        }
                    } else if ffloor[i as usize].height > viewz {
                        let mut top_w_0: int32_t = ffloor[i as usize]
                            .c_clip[rw_x as usize] as libc::c_int + 1 as libc::c_int;
                        let mut bottom_w_0: int32_t = ffloor[i as usize].f_frac
                            >> 12 as libc::c_int;
                        if top_w_0 < top {
                            top_w_0 = top;
                        }
                        if bottom_w_0 > bottom {
                            bottom_w_0 = bottom;
                        }
                        if !(ffloor[i as usize].polyobj).is_null()
                            && top_w_0 >= bottom_w_0
                        {
                            ...
                            (*ffloor[i as usize].plane)
                                .bottom[rw_x as usize] = 0 as libc::c_int as uint16_t;
                        } else if top_w_0 <= bottom_w_0 {
                            fftop = top_w_0 as int16_t;
                            ffbottom = bottom_w_0 as int16_t;
                            (*ffloor[i as usize].plane)
                                .top[rw_x as usize] = fftop as uint16_t;
                            (*ffloor[i as usize].plane)
                                .bottom[rw_x as usize] = ffbottom as uint16_t;
                            if fftop as libc::c_int <= top + 1 as libc::c_int
                                && R_FFloorCanClip(
                                    &mut *ffloor.as_mut_ptr().offset(i as isize),
                                ) != 0 && ((*curline).polyseg).is_null()
                            {
                                rw_ceilingmarked = true_0 as libc::c_int;
                                ceilingclip[rw_x as usize] = ffbottom;
                                if yl < ffbottom as libc::c_int {
                                    yl = ffbottom as int32_t;
                                }
                                if markceiling != 0 && !ceilingplane.is_null() {
                                    (*ceilingplane).bottom[rw_x as usize] = top as uint16_t;
                                }
                                if !rw_silhouette.is_null() {
                                    *rw_silhouette |= 2 as libc::c_int;
                                    *rw_tsilheight = -(2147483647 as libc::c_int)
                                        - 1 as libc::c_int;
                                }
                            }
                        }
        ...
        if oldtexturecolumn != -(1 as libc::c_int) {
            rw_bottomtexturemid
                += FixedMul(rw_bottomtextureslide, oldtexturecolumn - texturecolumn);
            rw_midtexturemid
                += FixedMul(rw_midtextureslide, oldtexturecolumn - texturecolumn);
            rw_toptexturemid
                += FixedMul(rw_toptextureslide, oldtexturecolumn - texturecolumn);
            rw_midtextureback
                += FixedMul(rw_midtexturebackslide, oldtexturecolumn - texturecolumn);
        }
        oldtexturecolumn = texturecolumn;
        let mut itexturecolumn: int32_t = texturecolumn >> 16 as libc::c_int;
        if segtextured != 0 {
            pindex = (FixedMul(rw_scale, 640 as libc::c_int * fovtan / vid.width)
                >> 12 as libc::c_int) as size_t;
            if pindex >= 48 as libc::c_int as size_t {
                pindex = (48 as libc::c_int - 1 as libc::c_int) as size_t;
            }
            ...
            dc_x = rw_x;
            dc_iscale = (0xffffffff as libc::c_uint)
                .wrapping_div(rw_scale as libc::c_uint) as fixed_t;
            if !((*frontsector).extra_colormap).is_null() {
                dc_colormap = ((*(*frontsector).extra_colormap).colormap)
        ...
        if dc_numlights != 0 {
            let mut xwalllights: *mut *mut lighttable_t = 0 as *mut *mut lighttable_t;
            i = 0 as libc::c_int;
            while i < dc_numlights {
                let mut lightnum: int32_t = 0;
                lightnum = (*dc_lightlist.offset(i as isize)).lightlevel as libc::c_int
                    >> 3 as libc::c_int;
                if ((*dc_lightlist.offset(i as isize)).extra_colormap).is_null() {
                    if (*(*curline).v1).y == (*(*curline).v2).y {
                        lightnum -= 1;
                        lightnum;
                    } else if (*(*curline).v1).x == (*(*curline).v2).x {
                ...
                if lightnum < 0 as libc::c_int {
                    xwalllights = (scalelight[0 as libc::c_int as usize]).as_mut_ptr();
                } else if lightnum >= 32 as libc::c_int {
                    xwalllights = (scalelight[(32 as libc::c_int - 1 as libc::c_int)
                        as usize])
                        .as_mut_ptr();
                } else {
                    xwalllights = (scalelight[lightnum as usize]).as_mut_ptr();
                ...
                if !((*dc_lightlist.offset(i as isize)).extra_colormap).is_null() {
                    let ref mut fresh0 = (*dc_lightlist.offset(i as isize)).rcolormap;
                    *fresh0 = ((*(*dc_lightlist.offset(i as isize)).extra_colormap)
                        .colormap)
                        .offset(
                            (*xwalllights.offset(pindex as isize)).offset_from(colormaps)
                                as libc::c_long as isize,
                        );
                } else {
                    let ref mut fresh1 = (*dc_lightlist.offset(i as isize)).rcolormap;
                    *fresh1 = *xwalllights.offset(pindex as isize);
                }
                colfunc = colfuncs[COLDRAWFUNC_SHADOWED as libc::c_int as usize];
                i += 1;
                i;
            }
        }
        frontscale[rw_x as usize] = rw_scale;
        if midtexture != 0 {
            if yl <= yh && yh >= 0 as libc::c_int && yl < viewheight {
                dc_yl = yl;
                dc_yh = yh;
                dc_texturemid = rw_midtexturemid;
                dc_source = R_GetColumn(
                    midtexture,
                    itexturecolumn + (rw_offset_mid >> 16 as libc::c_int),
                );
                dc_texheight = *textureheight.offset(midtexture as isize)
                    >> 16 as libc::c_int;
                colfunc.expect("non-null function pointer")();
                if rw_ceilingmarked == 0 {
                    ceilingclip[rw_x as usize] = viewheight as int16_t;
                }
                if rw_floormarked == 0 {
                    floorclip[rw_x as usize] = -(1 as libc::c_int) as int16_t;
                }
            } else {
                if markceiling != 0 && rw_ceilingmarked == 0 {
                    ceilingclip[rw_x
                        as usize] = (if yl >= 0 as libc::c_int {
                        if yl > viewheight {
                            viewheight as int16_t as libc::c_int
                        } else {
                            (yl as int16_t as libc::c_int - 1 as libc::c_int) as int16_t
                                as libc::c_int
                        }
                    } else {
                        -(1 as libc::c_int)
                ...
                if markfloor != 0 && rw_floormarked == 0 {
                    floorclip[rw_x
                        as usize] = (if yh < viewheight {
                        if yh < -(1 as libc::c_int) {
                            -(1 as libc::c_int)
                        } else {
                            (yh as int16_t as libc::c_int + 1 as libc::c_int) as int16_t
                                as libc::c_int
                        }
                    } else {
                        viewheight as int16_t as libc::c_int
            ...
            let mut topclip: int16_t = (if yl >= 0 as libc::c_int {
                if yl > viewheight {
                    viewheight as int16_t as libc::c_int
                } else {
                    (yl as int16_t as libc::c_int - 1 as libc::c_int) as int16_t
            ...
            let mut bottomclip: int16_t = (if yh < viewheight {
                if yh < -(1 as libc::c_int) {
                    -(1 as libc::c_int)
                } else {
                    (yh as int16_t as libc::c_int + 1 as libc::c_int) as int16_t
            ...
            if toptexture != 0 {
                mid = pixhigh >> 12 as libc::c_int;
                pixhigh += pixhighstep;
                if mid >= floorclip[rw_x as usize] as libc::c_int {
                    mid = floorclip[rw_x as usize] as libc::c_int - 1 as libc::c_int;
                }
                if mid >= yl {
                    if yl >= viewheight {
                        if rw_ceilingmarked == 0 {
                    ...
                    } else if mid >= 0 as libc::c_int {
                        dc_yl = yl;
                        dc_yh = mid;
                        dc_texturemid = rw_toptexturemid;
                        dc_source = R_GetColumn(
                            toptexture,
                            itexturecolumn + (rw_offset_top >> 16 as libc::c_int),
                        );
                        dc_texheight = *textureheight.offset(toptexture as isize)
                            >> 16 as libc::c_int;
                        colfunc.expect("non-null function pointer")();
                        ceilingclip[rw_x as usize] = mid as int16_t;
                    } else if rw_ceilingmarked == 0 {
                        ceilingclip[rw_x as usize] = -(1 as libc::c_int) as int16_t;
                    }
                } else if rw_ceilingmarked == 0 {
                    ceilingclip[rw_x as usize] = topclip;
                }
            } else if markceiling != 0 && rw_ceilingmarked == 0 {
                ceilingclip[rw_x as usize] = topclip;
            }
            if bottomtexture != 0 {
                mid = pixlow + ((1 as libc::c_int) << 12 as libc::c_int)
                    - 1 as libc::c_int >> 12 as libc::c_int;
                pixlow += pixlowstep;
                if mid <= ceilingclip[rw_x as usize] as libc::c_int {
                    mid = ceilingclip[rw_x as usize] as libc::c_int + 1 as libc::c_int;
                }
                if mid <= yh {
                    if yh < 0 as libc::c_int {
                        if rw_floormarked == 0 {
                            floorclip[rw_x as usize] = -(1 as libc::c_int) as int16_t;
                        }
                    } else if mid < viewheight {
                        dc_yl = mid;
                        dc_yh = yh;
                        dc_texturemid = rw_bottomtexturemid;
                        dc_source = R_GetColumn(
                            bottomtexture,
                            itexturecolumn + (rw_offset_bot >> 16 as libc::c_int),
                        );
                        dc_texheight = *textureheight.offset(bottomtexture as isize)
                            >> 16 as libc::c_int;
                        colfunc.expect("non-null function pointer")();
                        floorclip[rw_x as usize] = mid as int16_t;
                    } else if rw_floormarked == 0 {
                        floorclip[rw_x as usize] = viewheight as int16_t;
                    }
                } else if rw_floormarked == 0 {
                    floorclip[rw_x as usize] = bottomclip;
                }
            } else if markfloor != 0 && rw_floormarked == 0 {
                floorclip[rw_x as usize] = bottomclip;
            }
        }
        if maskedtexture != 0 || numthicksides != 0 {
            *maskedtexturecol.offset(rw_x as isize) = texturecolumn + rw_offset_mid;
            if !maskedtextureheight.is_null() {
                *maskedtextureheight
                    .offset(
                        rw_x as isize,
                    ) = if (*(*curline).linedef).flags as libc::c_int
                    & 256 as libc::c_int != 0
                {
                    if rw_midtexturemid > rw_midtextureback {
                        rw_midtexturemid
                    } else {
                        rw_midtextureback
                    }
                } else if rw_midtexturemid < rw_midtextureback {
                    rw_midtexturemid
                } else {
                    rw_midtextureback
                };
        ...
        if dc_numlights != 0 {
            i = 0 as libc::c_int;
            while i < dc_numlights {
                (*dc_lightlist.offset(i as isize)).height
                    += (*dc_lightlist.offset(i as isize)).heightstep;
                if (*dc_lightlist.offset(i as isize)).flags as libc::c_uint
                    & FOF_CUTSOLIDS as libc::c_int as libc::c_uint != 0
                {
                    (*dc_lightlist.offset(i as isize)).botheight
                        += (*dc_lightlist.offset(i as isize)).botheightstep;
                }
                i += 1;
                i;
            }
        ...
        while i < numffloors {
            if !(!((*curline).polyseg).is_null()
                && ffloor[i as usize].polyobj != (*curline).polyseg)
            {
                ffloor[i as usize].f_frac += ffloor[i as usize].f_step;
            }
            i += 1;
            i;
        }
        i = 0 as libc::c_int;
        while i < numbackffloors {
            if !(!((*curline).polyseg).is_null()
                && ffloor[i as usize].polyobj != (*curline).polyseg)
            {
                ffloor[i as usize]
                    .c_clip[rw_x
                    as usize] = (ffloor[i as usize].b_frac >> 12 as libc::c_int
                    & 0xffff as libc::c_int) as int16_t;
                ffloor[i as usize]
                    .f_clip[rw_x as usize] = ffloor[i as usize].c_clip[rw_x as usize];
                ffloor[i as usize].b_frac += ffloor[i as usize].b_step;
            }
            i += 1;
            i;
        }
...
unsafe extern "C" fn R_CalcSegDist(
    mut seg: *mut seg_t,
    mut x2: int64_t,
    mut y2: int64_t,
) -> int64_t {
    if (*(*seg).linedef).dy == 0 {
        return llabs((y2 - (*(*seg).v1).y as int64_t) as libc::c_longlong) as int64_t
    } else if (*(*seg).linedef).dx == 0 {
        return llabs((x2 - (*(*seg).v1).x as int64_t) as libc::c_longlong) as int64_t
    } else {
        let mut dx: int64_t = ((*(*seg).v2).x - (*(*seg).v1).x) as int64_t;
        let mut dy: int64_t = ((*(*seg).v2).y - (*(*seg).v1).y) as int64_t;
        let mut vdx: int64_t = x2 - (*(*seg).v1).x as int64_t;
        let mut vdy: int64_t = y2 - (*(*seg).v1).y as int64_t;
        return (dy * vdx - dx * vdy) / (*seg).length as int64_t;
    };
}
unsafe extern "C" fn R_AllocClippingTables(mut range: size_t) {
    let mut pos: size_t = lastopening.offset_from(openings) as libc::c_long as size_t;
    let mut need: size_t = range * 2 as libc::c_int as size_t;
    if pos.wrapping_add(need) < numopenings {
        return;
    }
    let mut oldopenings: *mut int16_t = openings;
    let mut oldlast: *mut int16_t = lastopening;
    if numopenings == 0 as libc::c_int as size_t {
        numopenings = 16384 as libc::c_int as size_t;
    }
    numopenings = numopenings.wrapping_add(need);
    openings = Z_ReallocAlign(
        openings as *mut libc::c_void,
        numopenings.wrapping_mul(::core::mem::size_of::<int16_t>() as libc::c_ulong),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut int16_t;
    lastopening = openings.offset(pos as isize);
    if oldopenings.is_null() {
        return;
    }
    let mut ds: *mut drawseg_t = drawsegs;
    while ds < ds_p {
        if ((*ds).sprtopclip).offset((*ds).x1 as isize) >= oldopenings
            && ((*ds).sprtopclip).offset((*ds).x1 as isize) <= oldlast
        {
            (*ds)
                .sprtopclip = openings
                .offset(
                    ((*ds).sprtopclip).offset_from(oldopenings) as libc::c_long as isize,
                );
        }
        if ((*ds).sprbottomclip).offset((*ds).x1 as isize) >= oldopenings
            && ((*ds).sprbottomclip).offset((*ds).x1 as isize) <= oldlast
        {
            (*ds)
                .sprbottomclip = openings
                .offset(
                    ((*ds).sprbottomclip).offset_from(oldopenings) as libc::c_long
                        as isize,
                );
        }
        ds = ds.offset(1);
...
unsafe extern "C" fn R_AllocTextureColumnTables(mut range: size_t) {
    let mut pos: size_t = curtexturecolumntable.offset_from(texturecolumntable)
        as libc::c_long as size_t;
    if pos.wrapping_add(range) < texturecolumntablesize {
        return;
    }
    let mut oldtable: *mut fixed_t = texturecolumntable;
    let mut oldlast: *mut fixed_t = curtexturecolumntable;
    if texturecolumntablesize == 0 as libc::c_int as size_t {
        texturecolumntablesize = 16384 as libc::c_int as size_t;
    }
    texturecolumntablesize = texturecolumntablesize.wrapping_add(range);
    texturecolumntable = Z_ReallocAlign(
        texturecolumntable as *mut libc::c_void,
        texturecolumntablesize
            .wrapping_mul(::core::mem::size_of::<fixed_t>() as libc::c_ulong),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut fixed_t;
    curtexturecolumntable = texturecolumntable.offset(pos as isize);
    if oldtable.is_null() {
        return;
    }
    let mut ds: *mut drawseg_t = drawsegs;
    while ds < ds_p {
        if ((*ds).maskedtexturecol).offset((*ds).x1 as isize) >= oldtable
            && ((*ds).maskedtexturecol).offset((*ds).x1 as isize) <= oldlast
        {
            (*ds)
                .maskedtexturecol = texturecolumntable
                .offset(
                    ((*ds).maskedtexturecol).offset_from(oldtable) as libc::c_long
                        as isize,
                );
        }
        if ((*ds).thicksidecol).offset((*ds).x1 as isize) >= oldtable
            && ((*ds).thicksidecol).offset((*ds).x1 as isize) <= oldlast
        {
            (*ds)
                .thicksidecol = texturecolumntable
                .offset(
                    ((*ds).thicksidecol).offset_from(oldtable) as libc::c_long as isize,
                );
        }
        ds = ds.offset(1);
        ds;
...
pub unsafe extern "C" fn R_StoreWallRange(mut start: int32_t, mut stop: int32_t) {
    ...
    let mut rlight: *mut r_lightlist_t = 0 as *mut r_lightlist_t;
    let mut range: int32_t = 0;
    let mut segleft: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    let mut segright: vertex_t = vertex_t {
        x: 0,
        y: 0,
        floorzset: 0,
        ceilingzset: 0,
    ...
    let mut ceilingfrontslide: fixed_t = 0;
    let mut floorfrontslide: fixed_t = 0;
    let mut ceilingbackslide: fixed_t = 0;
    let mut floorbackslide: fixed_t = 0;
    static mut maxdrawsegs: size_t = 0 as libc::c_int as size_t;
    maskedtextureheight = 0 as *mut fixed_t;
    memset(
        &mut segleft as *mut vertex_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<vertex_t>() as libc::c_ulong,
    );
    memset(
        &mut segright as *mut vertex_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<vertex_t>() as libc::c_ulong,
    );
    colfunc = colfuncs[0 as libc::c_int as usize];
    if ds_p == drawsegs.offset(maxdrawsegs as isize) {
        let mut curpos: size_t = curdrawsegs.offset_from(drawsegs) as libc::c_long
            as size_t;
        let mut pos: size_t = ds_p.offset_from(drawsegs) as libc::c_long as size_t;
        let mut newmax: size_t = if maxdrawsegs != 0 {
            maxdrawsegs * 2 as libc::c_int as size_t
        } else {
            128 as libc::c_int as size_t
        };
        if !firstseg.is_null() {
            firstseg = firstseg.offset_from(drawsegs) as libc::c_long as *mut drawseg_t;
        }
        drawsegs = Z_ReallocAlign(
            drawsegs as *mut libc::c_void,
            newmax.wrapping_mul(::core::mem::size_of::<drawseg_t>() as libc::c_ulong),
            PU_STATIC as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut drawseg_t;
        ds_p = drawsegs.offset(pos as isize);
        maxdrawsegs = newmax;
        curdrawsegs = drawsegs.offset(curpos as isize);
        if !firstseg.is_null() {
            firstseg = drawsegs.offset(firstseg as size_t as isize);
        }
    }
    ...
    offsetangle = abs(rw_normalangle.wrapping_sub(rw_angle1) as int32_t) as angle_t;
    if offsetangle > 0x40000000 as libc::c_int as angle_t {
        offsetangle = 0x40000000 as libc::c_int as angle_t;
    }
    distangle = (0x40000000 as libc::c_int as angle_t).wrapping_sub(offsetangle);
    sineval = finesine[(distangle >> 19 as libc::c_int) as usize]
        >> 16 as libc::c_int - 16 as libc::c_int;
    hyp = R_PointToDist((*(*curline).v1).x, (*(*curline).v1).y);
    rw_distance = FixedMul(hyp, sineval);
    longboi = (hyp >= 2147483647 as libc::c_int) as libc::c_int;
    if longboi != 0 {
        rw_distance = R_CalcSegDist(curline, viewx as int64_t, viewy as int64_t)
            as fixed_t;
    }
    rw_x = start;
    (*ds_p).x1 = rw_x;
    ...
    rw_scalestep = ((*ds_p).scale2 - rw_scale) / range;
    (*ds_p).scalestep = rw_scalestep;
    if (*frontsector).hasslope != 0
        || !backsector.is_null() && (*backsector).hasslope != 0
    {
        let mut temp: angle_t = 0;
        temp = (xtoviewangle[start as usize]).wrapping_add(viewangle);
        ...
        a1 = ((*(*curline).v2).y - (*(*curline).v1).y) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        b1 = ((*(*curline).v1).x - (*(*curline).v2).x) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        c1 = a1
            * ((*(*curline).v1).x as libc::c_double
                / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double)
            + b1
                * ((*(*curline).v1).y as libc::c_double
                    / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        a2 = -((finesine[(temp >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        b2 = (*finecosine.offset((temp >> 19 as libc::c_int) as isize)
            >> 16 as libc::c_int - 16 as libc::c_int) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        c2 = a2
            * (viewx as libc::c_double
                / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double)
            + b2
                * (viewy as libc::c_double
                    / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        det = a1 * b2 - a2 * b1;
        segleft
            .x = ((b2 * c1 - b1 * c2) / det
            * ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double) as fixed_t;
        (*ds_p).leftpos.x = segleft.x;
        segleft
            .y = ((a1 * c2 - a2 * c1) / det
            * ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double) as fixed_t;
        (*ds_p).leftpos.y = segleft.y;
        temp = (xtoviewangle[stop as usize]).wrapping_add(viewangle);
        ...
        let mut det_0: libc::c_double = 0.;
        a1_0 = ((*(*curline).v2).y - (*(*curline).v1).y) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        b1_0 = ((*(*curline).v1).x - (*(*curline).v2).x) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        c1_0 = a1_0
            * ((*(*curline).v1).x as libc::c_double
                / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double)
            + b1_0
                * ((*(*curline).v1).y as libc::c_double
                    / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        a2_0 = -((finesine[(temp >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        b2_0 = (*finecosine.offset((temp >> 19 as libc::c_int) as isize)
            >> 16 as libc::c_int - 16 as libc::c_int) as libc::c_double
            / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double;
        c2_0 = a2_0
            * (viewx as libc::c_double
            ...
            + b2_0
                * (viewy as libc::c_double
                    / ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double);
        det_0 = a1_0 * b2_0 - a2_0 * b1_0;
        segright
            .x = ((b2_0 * c1_0 - b1_0 * c2_0) / det_0
            * ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double) as fixed_t;
        (*ds_p).rightpos.x = segright.x;
        segright
            .y = ((a1_0 * c2_0 - a2_0 * c1_0) / det_0
            * ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_double) as fixed_t;
    ...
    worldtopslope = P_GetZAt(
        (*frontsector).c_slope,
        segright.x,
        segright.y,
        (*frontsector).ceilingheight,
    );
    worldbottom = P_GetZAt(
        (*frontsector).f_slope,
        segleft.x,
        segleft.y,
        (*frontsector).floorheight,
    );
    worldbottomslope = P_GetZAt(
        (*frontsector).f_slope,
        segright.x,
        segright.y,
        (*frontsector).floorheight,
    ...
    maskedtexture = 0 as libc::c_int;
    bottomtexture = maskedtexture;
    toptexture = bottomtexture;
    midtexture = toptexture;
    (*ds_p).maskedtexturecol = 0 as *mut fixed_t;
    numthicksides = 0 as libc::c_int;
    (*ds_p).numthicksides = numthicksides;
    (*ds_p).thicksidecol = 0 as *mut fixed_t;
    (*ds_p).tsilheight = 0 as libc::c_int;
    numbackffloors = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 40 as libc::c_int {
        (*ds_p).thicksides[i as usize] = 0 as *mut ffloor_s;
        i += 1;
        i;
    }
    if numffloors != 0 {
        ...
        while i < numffloors {
            if !(!(ffloor[i as usize].polyobj).is_null()
                && (((*(*ds_p).curline).polyseg).is_null()
                    || ffloor[i as usize].polyobj != (*(*ds_p).curline).polyseg))
            {
                ffloor[i as usize]
                    .f_pos = P_GetZAt(
                    ffloor[i as usize].slope,
                    segleft.x,
                    segleft.y,
                    ffloor[i as usize].height,
                ) - viewz;
                ffloor[i as usize]
                    .f_pos_slope = P_GetZAt(
                    ffloor[i as usize].slope,
                    segright.x,
                    segright.y,
                    ffloor[i as usize].height,
    ...
    rw_bottomtextureslide = 0 as libc::c_int;
    rw_midtextureslide = rw_bottomtextureslide;
    rw_toptextureslide = rw_midtextureslide;
    floorbackslide = 0 as libc::c_int;
    ceilingbackslide = floorbackslide;
    floorfrontslide = ceilingbackslide;
    ceilingfrontslide = floorfrontslide;
    let mut lineangle: angle_t = R_PointToAngle2(
        (*(*curline).v1).x,
        (*(*curline).v1).y,
        (*(*curline).v2).x,
    ...
    if !((*frontsector).f_slope).is_null() {
        floorfrontslide = FixedMul(
            (*(*frontsector).f_slope).zdelta,
            *finecosine
                .offset(
                    (lineangle.wrapping_sub((*(*frontsector).f_slope).xydirection)
                        >> 19 as libc::c_int) as isize,
                ) >> 16 as libc::c_int - 16 as libc::c_int,
        );
    }
    if !((*frontsector).c_slope).is_null() {
        ceilingfrontslide = FixedMul(
            (*(*frontsector).c_slope).zdelta,
            *finecosine
                .offset(
                    (lineangle.wrapping_sub((*(*frontsector).c_slope).xydirection)
                        >> 19 as libc::c_int) as isize,
                ) >> 16 as libc::c_int - 16 as libc::c_int,
        );
    }
    if !backsector.is_null() && !((*backsector).f_slope).is_null() {
        floorbackslide = FixedMul(
            (*(*backsector).f_slope).zdelta,
            *finecosine
                .offset(
                    (lineangle.wrapping_sub((*(*backsector).f_slope).xydirection)
                        >> 19 as libc::c_int) as isize,
                ) >> 16 as libc::c_int - 16 as libc::c_int,
        );
    }
    if !backsector.is_null() && !((*backsector).c_slope).is_null() {
        ceilingbackslide = FixedMul(
            (*(*backsector).c_slope).zdelta,
            *finecosine
                .offset(
                    (lineangle.wrapping_sub((*(*backsector).c_slope).xydirection)
                        >> 19 as libc::c_int) as isize,
                ) >> 16 as libc::c_int - 16 as libc::c_int,
        );
    }
    if backsector.is_null() {
        let mut texheight: fixed_t = 0;
        midtexture = R_GetTextureNum((*sidedef).midtexture);
        texheight = *textureheight.offset(midtexture as isize);
        markceiling = true_0 as libc::c_int;
        markfloor = markceiling;
        if (*linedef).flags as libc::c_int & 128 as libc::c_int != 0 {
            if (*linedef).flags as libc::c_int & 16 as libc::c_int != 0 {
                rw_midtexturemid = (*frontsector).floorheight + texheight - viewz;
            } else {
                rw_midtexturemid = (*frontsector).ceilingheight - viewz;
            }
        } else if (*linedef).flags as libc::c_int & 16 as libc::c_int != 0 {
        ...
        (*ds_p).silhouette = 3 as libc::c_int;
        (*ds_p).sprtopclip = screenheightarray.as_mut_ptr();
        (*ds_p).sprbottomclip = negonearray.as_mut_ptr();
        (*ds_p).bsilheight = 2147483647 as libc::c_int;
        (*ds_p).tsilheight = -(2147483647 as libc::c_int) - 1 as libc::c_int;
    } else {
        let mut bothceilingssky: boolean = false_0 as libc::c_int;
        let mut bothfloorssky: boolean = false_0 as libc::c_int;
        worldhigh = P_GetZAt(
            (*backsector).c_slope,
            segleft.x,
            segleft.y,
        ...
        {
            bothceilingssky = true_0 as libc::c_int;
        }
        if (*frontsector).floorpic == skyflatnum && (*backsector).floorpic == skyflatnum
        {
            bothfloorssky = true_0 as libc::c_int;
        }
        (*ds_p).sprbottomclip = 0 as *mut int16_t;
        (*ds_p).sprtopclip = (*ds_p).sprbottomclip;
        (*ds_p).silhouette = 0 as libc::c_int;
        if bothfloorssky == 0 {
            if worldbottomslope > worldlowslope || worldbottom > worldlow {
                (*ds_p).silhouette = 1 as libc::c_int;
                if P_GetSectorFloorZAt(backsector, viewx, viewy) > viewz {
                    (*ds_p).bsilheight = 2147483647 as libc::c_int;
                } else {
                    (*ds_p)
                        .bsilheight = if !((*frontsector).f_slope).is_null() {
        ...
        if bothceilingssky == 0 && bothfloorssky == 0 {
        ...
        if bothceilingssky == 0 && bothfloorssky == 0 {
            if doorclosed != 0
                || worldhigh <= worldbottom && worldhighslope <= worldbottomslope
            {
                (*ds_p).sprbottomclip = negonearray.as_mut_ptr();
                (*ds_p).bsilheight = 2147483647 as libc::c_int;
                (*ds_p).silhouette |= 1 as libc::c_int;
            }
            if doorclosed != 0 || worldlow >= worldtop && worldlowslope >= worldtopslope
            {
                (*ds_p).sprtopclip = screenheightarray.as_mut_ptr();
                (*ds_p).tsilheight = -(2147483647 as libc::c_int) - 1 as libc::c_int;
                (*ds_p).silhouette |= 2 as libc::c_int;
        ...
        if bothfloorssky != 0 {
            markfloor = false_0 as libc::c_int;
        } else if worldlow != worldbottom || worldlowslope != worldbottomslope
            || (*backsector).f_slope != (*frontsector).f_slope
            || (*backsector).floorpic != (*frontsector).floorpic
            || (*backsector).lightlevel as libc::c_int
                != (*frontsector).lightlevel as libc::c_int
            ...
            || (*frontsector).heightsec != -(1 as libc::c_int)
                && (*frontsector).floorpic != skyflatnum
            || (*backsector).floorlightlevel as libc::c_int
                != (*frontsector).floorlightlevel as libc::c_int
            || (*backsector).floorlightabsolute != (*frontsector).floorlightabsolute
            || (*backsector).floorlightsec != (*frontsector).floorlightsec
            || (*frontsector).extra_colormap != (*backsector).extra_colormap
            || (*frontsector).ffloors != (*backsector).ffloors
                && Tag_Compare(&mut (*frontsector).tags, &mut (*backsector).tags) == 0
        {
            markfloor = true_0 as libc::c_int;
        } else {
            markfloor = false_0 as libc::c_int;
        }
        if bothceilingssky != 0 {
            markceiling = false_0 as libc::c_int;
        } else if worldhigh != worldtop || worldhighslope != worldtopslope
            ...
            || (*backsector).ceilinglightlevel as libc::c_int
                != (*frontsector).ceilinglightlevel as libc::c_int
        ...
        {
            let mut texheight_0: fixed_t = 0;
            toptexture = R_GetTextureNum((*sidedef).toptexture);
            texheight_0 = *textureheight.offset(toptexture as isize);
            if (*linedef).flags as libc::c_int & 32 as libc::c_int == 0 {
                if (*linedef).flags as libc::c_int & 8 as libc::c_int != 0 {
                    rw_toptexturemid = (*frontsector).ceilingheight - viewz;
                } else {
                    rw_toptexturemid = (*backsector).ceilingheight - viewz;
                }
            } else if (*linedef).flags as libc::c_int & 8 as libc::c_int != 0 {
                rw_toptexturemid = worldtop;
                rw_toptextureslide = ceilingfrontslide;
            } else {
                rw_toptexturemid = worldhigh + texheight_0;
        ...
        R_AllocTextureColumnTables((rw_stopx - start) as size_t);
        if !frontsector.is_null() && !backsector.is_null()
            && Tag_Compare(&mut (*frontsector).tags, &mut (*backsector).tags) == 0
            && (!((*backsector).ffloors).is_null()
                || !((*frontsector).ffloors).is_null())
        {
            let mut rover: *mut ffloor_t = 0 as *mut ffloor_t;
            let mut r2: *mut ffloor_t = 0 as *mut ffloor_t;
            let mut lowcut: fixed_t = 0;
            let mut highcut: fixed_t = 0;
            let mut lowcutslope: fixed_t = 0;
            let mut highcutslope: fixed_t = 0;
            let mut high1: fixed_t = 0;
            let mut highslope1: fixed_t = 0;
            let mut low1: fixed_t = 0;
            let mut lowslope1: fixed_t = 0;
            let mut high2: fixed_t = 0;
            let mut highslope2: fixed_t = 0;
            let mut low2: fixed_t = 0;
            let mut lowslope2: fixed_t = 0;
            maskedtexture = true_0 as libc::c_int;
            maskedtexturecol = curtexturecolumntable.offset(-(rw_x as isize));
            (*ds_p).thicksidecol = maskedtexturecol;
            curtexturecolumntable = curtexturecolumntable
                .offset((rw_stopx - rw_x) as isize);
            lowcut = (if worldbottom > worldlow { worldbottom } else { worldlow })
                + viewz;
            highcut = (if worldtop < worldhigh { worldtop } else { worldhigh }) + viewz;
            lowcutslope = (if worldbottomslope > worldlowslope {
                worldbottomslope
            } else {
                worldlowslope
            }) + viewz;
            highcutslope = (if worldtopslope < worldhighslope {
                worldtopslope
            } else {
                worldhighslope
            }) + viewz;
            if !((*frontsector).ffloors).is_null() && !((*backsector).ffloors).is_null()
            {
                i = 0 as libc::c_int;
                rover = (*backsector).ffloors;
                while !rover.is_null() && i < 40 as libc::c_int {
                    ...
                    {
                        if !((*rover).fofflags as libc::c_uint
                            & FOF_ALLSIDES as libc::c_int as libc::c_uint == 0
                            && (*rover).fofflags as libc::c_uint
                                & FOF_INVERTSIDES as libc::c_int as libc::c_uint != 0)
                        {
                            if !((*rover).norender == leveltime) {
                                ...
                                if !(high1 < lowcut && highslope1 < lowcutslope
                                    || low1 > highcut && lowslope1 > highcutslope)
                                {
                                    let mut current_block_256: u64;
                                    r2 = (*frontsector).ffloors;
                                    while !r2.is_null() {
                                        if (*r2).master == (*rover).master {
                                            break;
                                        }
                                        if !((*r2).fofflags as libc::c_uint
                                            & FOF_EXISTS as libc::c_int as libc::c_uint == 0
                                            || (*r2).fofflags as libc::c_uint
                                                & FOF_RENDERSIDES as libc::c_int as libc::c_uint == 0)
                                        {
                                            if !((*r2).norender == leveltime) {
                                                    ...
                                                    & FOF_EXTRA as libc::c_int as libc::c_uint != 0
                                                {
                                                    if (*r2).fofflags as libc::c_uint
                                                        & FOF_CUTEXTRA as libc::c_int as libc::c_uint == 0
                                                    {
                                                        current_block_256 = 8499731551232998623;
                                                    } else if (*r2).fofflags as libc::c_uint
                                                        & FOF_EXTRA as libc::c_int as libc::c_uint != 0
                                                        && (*r2).fofflags as libc::c_uint
                                                            & (FOF_TRANSLUCENT as libc::c_int | FOF_FOG as libc::c_int)
                                                                as libc::c_uint
                                                            != (*rover).fofflags as libc::c_uint
                                                                & (FOF_TRANSLUCENT as libc::c_int | FOF_FOG as libc::c_int)
                                                                    as libc::c_uint
                                                    {
                                                        ...
                                                        current_block_256 = 7192749559210104566;
                                                    }
                                                } else if (*r2).fofflags as libc::c_uint
                                                    & FOF_CUTSOLIDS as libc::c_int as libc::c_uint == 0
                                                {
                                                ...
                                                match current_block_256 {
                                                    ...
                                                    _ => {
                                                        ...
                                                        if !(high2 < lowcut || highslope2 < lowcutslope
                                                            || (low2 > highcut || lowslope2 > highcutslope))
                                                        {
                                                            if !(high1 > high2 || highslope1 > highslope2
                                                                || (low1 < low2 || lowslope1 < lowslope2))
                                                            {
                                                                break;
                                                            }
                                                        }
                                    ...
                                    if r2.is_null() {
                                        (*ds_p).thicksides[i as usize] = rover;
                                        i += 1;
                                        i;
                                    }
                                }
                                            ...
                                            if !((*r2).norender == leveltime) {
                                                    ...
                                                    & FOF_EXTRA as libc::c_int as libc::c_uint != 0
                                                {
                                                    if (*r2).fofflags as libc::c_uint
                                                        & FOF_CUTEXTRA as libc::c_int as libc::c_uint == 0
                                                    {
                                                        current_block_270 = 16286683003977321678;
                                                    } else if (*r2).fofflags as libc::c_uint
                                                        & FOF_EXTRA as libc::c_int as libc::c_uint != 0
                                                        && (*r2).fofflags as libc::c_uint
                                                            & (FOF_TRANSLUCENT as libc::c_int | FOF_FOG as libc::c_int)
                                                                    ...
                                                                    as libc::c_uint
                                                    {
                                                        ...
                                                        current_block_270 = 2942740671786505091;
                                                    }
                                                } else if (*r2).fofflags as libc::c_uint
                                                    & FOF_CUTSOLIDS as libc::c_int as libc::c_uint == 0
                                                {
            ...
            } else if !((*backsector).ffloors).is_null() {
                rover = (*backsector).ffloors;
                i = 0 as libc::c_int;
                while !rover.is_null() && i < 40 as libc::c_int {
                    if !((*rover).fofflags as libc::c_uint
                            ...
                            & FOF_EXISTS as libc::c_int as libc::c_uint == 0)
                    {
                        ...
                        {
                            if !((*rover).norender == leveltime) {
                                if !(P_GetFFloorTopZAt(rover, segleft.x, segleft.y)
                                    <= worldbottom + viewz
                                    && P_GetFFloorTopZAt(rover, segright.x, segright.y)
                                        <= worldbottomslope + viewz
                                    || P_GetFFloorBottomZAt(rover, segleft.x, segleft.y)
                                        >= worldtop + viewz
                                        && P_GetFFloorBottomZAt(rover, segright.x, segright.y)
                                            >= worldtopslope + viewz)
                                {
                                    (*ds_p).thicksides[i as usize] = rover;
                                    i += 1;
            ...
            } else if !((*frontsector).ffloors).is_null() {
                rover = (*frontsector).ffloors;
                i = 0 as libc::c_int;
                while !rover.is_null() && i < 40 as libc::c_int {
                    if !((*rover).fofflags as libc::c_uint
        ...
        if (*sidedef).midtexture > 0 as libc::c_int
            && (*sidedef).midtexture < numtextures
        {
            if ((*ds_p).thicksidecol).is_null() {
                maskedtexturecol = curtexturecolumntable.offset(-(rw_x as isize));
            ...
            maskedtextureheight = ((*ds_p).maskedtextureheight).as_mut_ptr();
            if !((*curline).polyseg).is_null() {
                rw_midtexturebackslide = 0 as libc::c_int;
                rw_midtextureslide = rw_midtexturebackslide;
                if (*linedef).flags as libc::c_int & 256 as libc::c_int != 0 {
                    rw_midtextureback = (if (*(*curline).frontsector).floorheight
                        > (*(*curline).backsector).floorheight
                    {
                        (*(*curline).frontsector).floorheight
                    } else {
                        (*(*curline).backsector).floorheight
                    }) - viewz;
                    rw_midtexturemid = rw_midtextureback;
                } else {
                    rw_midtextureback = (if (*(*curline).frontsector).ceilingheight
                        < (*(*curline).backsector).ceilingheight
                    {
                        (*(*curline).frontsector).ceilingheight
                    } else {
                        (*(*curline).backsector).ceilingheight
                    }) - viewz;
                    rw_midtexturemid = rw_midtextureback;
                }
            } else if (*linedef).flags as libc::c_int & 128 as libc::c_int != 0 {
                rw_midtexturebackslide = 0 as libc::c_int;
                rw_midtextureslide = rw_midtexturebackslide;
                if (*linedef).flags as libc::c_int & 256 as libc::c_int != 0 {
                    rw_midtextureback = (if (*frontsector).floorheight
                        > (*backsector).floorheight
                    {
                        (*frontsector).floorheight
                    } else {
                    ...
                    rw_midtextureback = (if (*frontsector).ceilingheight
                        < (*backsector).ceilingheight
                    {
                        (*frontsector).ceilingheight
                    } else {
            ...
            } else if (*linedef).flags as libc::c_int & 256 as libc::c_int != 0 {
    ...
    segtextured = (midtexture != 0 || toptexture != 0 || bottomtexture != 0
        || maskedtexture != 0 || numthicksides > 0 as libc::c_int) as libc::c_int;
    if segtextured != 0 {
        offsetangle = rw_normalangle.wrapping_sub(rw_angle1);
        if offsetangle > 0x80000000 as libc::c_uint {
            offsetangle = -(offsetangle as libc::c_int) as angle_t;
        }
        if offsetangle > 0x40000000 as libc::c_int as angle_t {
            offsetangle = 0x40000000 as libc::c_int as angle_t;
        }
        sineval = finesine[(offsetangle >> 19 as libc::c_int) as usize]
            >> 16 as libc::c_int - 16 as libc::c_int;
        rw_offset = FixedMul(hyp, sineval);
        if longboi != 0 {
            let mut dx: int64_t = ((*(*curline).v2).x - (*(*curline).v1).x) as int64_t;
            let mut dy: int64_t = ((*(*curline).v2).y - (*(*curline).v1).y) as int64_t;
            let mut vdx: int64_t = (viewx - (*(*curline).v1).x) as int64_t;
            let mut vdy: int64_t = (viewy - (*(*curline).v1).y) as int64_t;
            rw_offset = ((dx * vdx - dy * vdy) / (*curline).length as int64_t)
                as fixed_t;
        }
        if rw_normalangle.wrapping_sub(rw_angle1) < 0x80000000 as libc::c_uint {
            rw_offset = -rw_offset;
        }
        ...
        rw_centerangle = (0x40000000 as libc::c_int as angle_t)
    ...
    if (*frontsector).heightsec == -(1 as libc::c_int) {
        if (*frontsector).floorpic != skyflatnum
            && P_GetSectorFloorZAt(frontsector, viewx, viewy) >= viewz
        {
            markfloor = false_0 as libc::c_int;
        }
        if (*frontsector).ceilingpic != skyflatnum
            && P_GetSectorCeilingZAt(frontsector, viewx, viewy) <= viewz
        {
            markceiling = false_0 as libc::c_int;
        }
    }
    worldtop >>= 4 as libc::c_int;
    worldbottom >>= 4 as libc::c_int;
    worldtopslope >>= 4 as libc::c_int;
    worldbottomslope >>= 4 as libc::c_int;
    if (*linedef).special as libc::c_int == 41 as libc::c_int {
        bottomstep = 0 as libc::c_int;
        topstep = bottomstep;
        bottomfrac = centeryfrac >> 4 as libc::c_int;
        topfrac = bottomfrac;
        topfrac += 1;
        topfrac;
    } else {
        topstep = -FixedMul(rw_scalestep, worldtop);
        topfrac = (centeryfrac >> 4 as libc::c_int) - FixedMul(worldtop, rw_scale);
        bottomstep = -FixedMul(rw_scalestep, worldbottom);
        bottomfrac = (centeryfrac >> 4 as libc::c_int) - FixedMul(worldbottom, rw_scale);
        if !((*frontsector).c_slope).is_null() {
            let mut topfracend: fixed_t = (centeryfrac >> 4 as libc::c_int)
                - FixedMul(worldtopslope, (*ds_p).scale2);
            topstep = (topfracend - topfrac) / range;
        }
        if !((*frontsector).f_slope).is_null() {
            let mut bottomfracend: fixed_t = (centeryfrac >> 4 as libc::c_int)
                - FixedMul(worldbottomslope, (*ds_p).scale2);
    ...
    if (*frontsector).numlights != 0 {
        ...
        while i < dc_numlights {
            ...
            if !((*light).slope).is_null() {
                (*frontsector).hasslope = true_0 as libc::c_int;
            }
            leftheight -= viewz;
            rightheight -= viewz;
            leftheight >>= 4 as libc::c_int;
            rightheight >>= 4 as libc::c_int;
            if i != 0 as libc::c_int {
                if leftheight < worldbottom && rightheight < worldbottomslope {
                    current_block_424 = 14935586237616944036;
                } else if leftheight > worldtop && rightheight > worldtopslope
                    && (i + 1 as libc::c_int) < dc_numlights
                        ...
                        .height > (*frontsector).ceilingheight
                {
                    ...
                    current_block_424 = 12009951147385167989;
                }
            } else {
                current_block_424 = 12009951147385167989;
            }
            match current_block_424 {
                12009951147385167989 => {
                    (*rlight)
                        .height = (centeryfrac >> 4 as libc::c_int)
                        - FixedMul(leftheight, rw_scale);
                    (*rlight)
                        .heightstep = (centeryfrac >> 4 as libc::c_int)
                        - FixedMul(rightheight, (*ds_p).scale2);
                    (*rlight)
                        .heightstep = ((*rlight).heightstep - (*rlight).height) / range;
                    (*rlight).flags = (*light).flags as ffloortype_e;
                    if !((*light).caster).is_null()
                        && (*(*light).caster).fofflags as libc::c_uint
                            & FOF_CUTSOLIDS as libc::c_int as libc::c_uint != 0
                    {
                        leftheight = P_GetFFloorBottomZAt(
                            (*light).caster,
                            segleft.x,
                            segleft.y,
                        );
                        rightheight = P_GetFFloorBottomZAt(
                            (*light).caster,
                            segright.x,
                            segright.y,
                        );
                        if !(*(*(*light).caster).b_slope).is_null() {
                            (*frontsector).hasslope = true_0 as libc::c_int;
                        }
                        leftheight -= viewz;
                        rightheight -= viewz;
                        ...
                        rightheight >>= 4 as libc::c_int;
                        (*rlight)
                            .botheight = (centeryfrac >> 4 as libc::c_int)
                            - FixedMul(leftheight, rw_scale);
                        (*rlight)
                            .botheightstep = (centeryfrac >> 4 as libc::c_int)
                            - FixedMul(rightheight, (*ds_p).scale2);
                        (*rlight)
                            .botheightstep = ((*rlight).botheightstep
                            - (*rlight).botheight) / range;
    ...
    if numffloors != 0 {
        i = 0 as libc::c_int;
        while i < numffloors {
            ffloor[i as usize].f_pos >>= 4 as libc::c_int;
            ffloor[i as usize].f_pos_slope >>= 4 as libc::c_int;
            if (*linedef).special as libc::c_int == 41 as libc::c_int {
                ffloor[i as usize].f_step = 0 as libc::c_int;
                ffloor[i as usize].f_frac = centeryfrac >> 4 as libc::c_int;
                topfrac += 1;
                topfrac;
            } else {
                ffloor[i as usize]
                    .f_frac = (centeryfrac >> 4 as libc::c_int)
                    - FixedMul(ffloor[i as usize].f_pos, rw_scale);
                ffloor[i as usize]
                    .f_step = ((centeryfrac >> 4 as libc::c_int)
                    - FixedMul(ffloor[i as usize].f_pos_slope, (*ds_p).scale2)
                    - ffloor[i as usize].f_frac) / range;
            }
            i += 1;
            i;
        }
    ...
    if !backsector.is_null() {
        worldhigh >>= 4 as libc::c_int;
        worldlow >>= 4 as libc::c_int;
        worldhighslope >>= 4 as libc::c_int;
        worldlowslope >>= 4 as libc::c_int;
        if toptexture != 0 {
            pixhigh = (centeryfrac >> 4 as libc::c_int) - FixedMul(worldhigh, rw_scale);
            pixhighstep = -FixedMul(rw_scalestep, worldhigh);
            if !((*backsector).c_slope).is_null() {
                let mut topfracend_0: fixed_t = (centeryfrac >> 4 as libc::c_int)
                    - FixedMul(worldhighslope, (*ds_p).scale2);
                pixhighstep = (topfracend_0 - pixhigh) / range;
            }
        }
        if bottomtexture != 0 {
            pixlow = (centeryfrac >> 4 as libc::c_int) - FixedMul(worldlow, rw_scale);
            pixlowstep = -FixedMul(rw_scalestep, worldlow);
            if !((*backsector).f_slope).is_null() {
                let mut bottomfracend_0: fixed_t = (centeryfrac >> 4 as libc::c_int)
                    - FixedMul(worldlowslope, (*ds_p).scale2);
                pixlowstep = (bottomfracend_0 - pixlow) / range;
            }
        }
        let mut rover_0: *mut ffloor_t = 0 as *mut ffloor_t;
        let mut roverleft: fixed_t = 0;
        let mut roverright: fixed_t = 0;
        let mut planevistest: fixed_t = 0;
        i = 0 as libc::c_int;
        if !((*backsector).ffloors).is_null() {
            rover_0 = (*backsector).ffloors;
            while !rover_0.is_null() && i < 40 as libc::c_int {
                if !((*rover_0).fofflags as libc::c_uint
                    & FOF_EXISTS as libc::c_int as libc::c_uint == 0
                    || (*rover_0).fofflags as libc::c_uint
                        & FOF_RENDERPLANES as libc::c_int as libc::c_uint == 0)
                {
                    if !((*rover_0).norender == leveltime) {
                        if !(*(*rover_0).b_slope).is_null()
                            || !(*(*rover_0).t_slope).is_null()
                        {
                            (*backsector).hasslope = true_0 as libc::c_int;
                        }
                        roverleft = P_GetFFloorBottomZAt(rover_0, segleft.x, segleft.y)
                            - viewz;
                        roverright = P_GetFFloorBottomZAt(
                            rover_0,
                            segright.x,
                            segright.y,
                        ) - viewz;
                        planevistest = P_GetFFloorBottomZAt(rover_0, viewx, viewy);
                        if (roverleft >> 4 as libc::c_int <= worldhigh
                            || roverright >> 4 as libc::c_int <= worldhighslope)
                            && (roverleft >> 4 as libc::c_int >= worldlow
                                || roverright >> 4 as libc::c_int >= worldlowslope)
                            && (viewz < planevistest
                                && ((*rover_0).fofflags as libc::c_uint
                                    & FOF_BOTHPLANES as libc::c_int as libc::c_uint != 0
                                    || (*rover_0).fofflags as libc::c_uint
                                        & FOF_INVERTPLANES as libc::c_int as libc::c_uint == 0)
                                || viewz > planevistest
                                    && ((*rover_0).fofflags as libc::c_uint
                                        & FOF_BOTHPLANES as libc::c_int as libc::c_uint != 0
                                        || (*rover_0).fofflags as libc::c_uint
                                            & FOF_INVERTPLANES as libc::c_int as libc::c_uint != 0))
                        {
                            ffloor[i as usize].b_pos = roverleft;
                            ffloor[i as usize].b_pos_slope = roverright;
                            ffloor[i as usize].b_pos >>= 4 as libc::c_int;
                            ffloor[i as usize].b_pos_slope >>= 4 as libc::c_int;
                            ffloor[i as usize]
                                .b_frac = (centeryfrac >> 4 as libc::c_int)
                                - FixedMul(ffloor[i as usize].b_pos, rw_scale);
                            ffloor[i as usize]
                                .b_step = (centeryfrac >> 4 as libc::c_int)
                                - FixedMul(ffloor[i as usize].b_pos_slope, (*ds_p).scale2);
                            ffloor[i as usize]
                                .b_step = (ffloor[i as usize].b_step
                                - ffloor[i as usize].b_frac) / range;
                            i += 1;
                            i;
                        }
                        ...
                        roverleft = P_GetFFloorTopZAt(rover_0, segleft.x, segleft.y)
                            - viewz;
                        roverright = P_GetFFloorTopZAt(rover_0, segright.x, segright.y)
                            - viewz;
                        planevistest = P_GetFFloorTopZAt(rover_0, viewx, viewy);
                        if (roverleft >> 4 as libc::c_int <= worldhigh
                            || roverright >> 4 as libc::c_int <= worldhighslope)
                            && (roverleft >> 4 as libc::c_int >= worldlow
                                || roverright >> 4 as libc::c_int >= worldlowslope)
        ...
        } else if !frontsector.is_null() && !((*frontsector).ffloors).is_null() {
            rover_0 = (*frontsector).ffloors;
            while !rover_0.is_null() && i < 40 as libc::c_int {
                if !((*rover_0).fofflags as libc::c_uint
                    & FOF_EXISTS as libc::c_int as libc::c_uint == 0
                    || (*rover_0).fofflags as libc::c_uint
        ...
        if !((*curline).polyseg).is_null() && !frontsector.is_null()
            && (*(*curline).polyseg).flags & POF_RENDERPLANES as libc::c_int != 0
        {
            while i < numffloors && ffloor[i as usize].polyobj != (*curline).polyseg {
                i += 1;
                i;
            }
            if i < numffloors
            ...
            {
                if (*ffloor[i as usize].plane).minx > (*ds_p).x1 {
                    (*ffloor[i as usize].plane).minx = (*ds_p).x1;
                }
                if (*ffloor[i as usize].plane).maxx < (*ds_p).x2 {
                    (*ffloor[i as usize].plane).maxx = (*ds_p).x2;
                }
                ffloor[i as usize].slope = 0 as *mut pslope_s;
                ffloor[i as usize].b_pos = (*backsector).floorheight;
                ffloor[i as usize]
                    .b_pos = ffloor[i as usize].b_pos - viewz >> 4 as libc::c_int;
                ffloor[i as usize]
                    .b_step = FixedMul(-rw_scalestep, ffloor[i as usize].b_pos);
                ffloor[i as usize]
                    .b_frac = (centeryfrac >> 4 as libc::c_int)
                    - FixedMul(ffloor[i as usize].b_pos, rw_scale);
                i += 1;
                ...
                && viewz > (*backsector).ceilingheight
            {
                ...
                ffloor[i as usize].slope = 0 as *mut pslope_s;
                ffloor[i as usize].b_pos = (*backsector).ceilingheight;
                ffloor[i as usize]
                    .b_pos = ffloor[i as usize].b_pos - viewz >> 4 as libc::c_int;
                ffloor[i as usize]
                    .b_step = FixedMul(-rw_scalestep, ffloor[i as usize].b_pos);
    ...
    if markceiling != 0 {
        if !ceilingplane.is_null() {
            ceilingplane = R_CheckPlane(ceilingplane, rw_x, rw_stopx - 1 as libc::c_int);
        } else {
            markceiling = false_0 as libc::c_int;
        }
        if !((*curline).polyseg).is_null() && (*(*curline).sidedef).toptexture == 0 {
            markceiling = false_0 as libc::c_int;
        }
    }
    if markfloor != 0 {
        if !floorplane.is_null() {
            floorplane = R_CheckPlane(floorplane, rw_x, rw_stopx - 1 as libc::c_int);
        } else {
            markfloor = false_0 as libc::c_int;
        }
        if !((*curline).polyseg).is_null() && (*(*curline).sidedef).bottomtexture == 0 {
            markfloor = false_0 as libc::c_int;
        }
    }
    (*ds_p).numffloorplanes = 0 as libc::c_int;
    if numffloors != 0 {
        if firstseg.is_null() {
            ...
            while i < numffloors {
                ffloor[i as usize]
                    ...
                    ffloor[i as usize].plane,
                    rw_x,
                    rw_stopx - 1 as libc::c_int,
                );
                (*ds_p).ffloorplanes[i as usize] = ffloor[i as usize].plane;
                i += 1;
                i;
            }
            firstseg = ds_p;
        ...
        if !((*curline).polyseg).is_null() {
            ...
            while i < numffloors {
                if !((ffloor[i as usize].polyobj).is_null()
                    || ffloor[i as usize].polyobj != (*curline).polyseg)
                {
                    if (*ffloor[i as usize].plane).minx > rw_x {
                        (*ffloor[i as usize].plane).minx = rw_x;
                    }
                    if (*ffloor[i as usize].plane).maxx < rw_stopx - 1 as libc::c_int {
                        (*ffloor[i as usize].plane).maxx = rw_stopx - 1 as libc::c_int;
                    }
                }
                i += 1;
                i;
    ...
    rw_silhouette = &mut (*ds_p).silhouette;
    rw_tsilheight = &mut (*ds_p).tsilheight;
    rw_bsilheight = &mut (*ds_p).bsilheight;
    R_RenderSegLoop();
    colfunc = colfuncs[0 as libc::c_int as usize];
    if portalline != 0 {
        (*ds_p).portalpass = (portalrender as libc::c_int + 1 as libc::c_int) as uint8_t;
    } else {
        (*ds_p).portalpass = 0 as libc::c_int as uint8_t;
    }
    if maskedtexture != 0
        || (*ds_p).silhouette & (2 as libc::c_int | 1 as libc::c_int) != 0
    {
        R_AllocClippingTables((rw_stopx - start) as size_t);
        if ((*ds_p).silhouette & 2 as libc::c_int != 0 || maskedtexture != 0)
            && ((*ds_p).sprtopclip).is_null()
        {
            M_Memcpy
                ...
                lastopening as *mut libc::c_void,
                ceilingclip.as_mut_ptr().offset(start as isize) as *const libc::c_void,
                (2 as libc::c_int * (rw_stopx - start)) as size_t,
            );
            (*ds_p).sprtopclip = lastopening.offset(-(start as isize));
            lastopening = lastopening.offset((rw_stopx - start) as isize);
        }
        if ((*ds_p).silhouette & 1 as libc::c_int != 0 || maskedtexture != 0)
            && ((*ds_p).sprbottomclip).is_null()
        {
            M_Memcpy
                ...
                lastopening as *mut libc::c_void,
                floorclip.as_mut_ptr().offset(start as isize) as *const libc::c_void,
                (2 as libc::c_int * (rw_stopx - start)) as size_t,
            );
    ...
    if maskedtexture != 0 && (*ds_p).silhouette & 2 as libc::c_int == 0 {
        (*ds_p).silhouette |= 2 as libc::c_int;
        (*ds_p)
            .tsilheight = if (*sidedef).midtexture > 0 as libc::c_int
            && (*sidedef).midtexture < numtextures
        {
            -(2147483647 as libc::c_int) - 1 as libc::c_int
        } else {
    ...
    if maskedtexture != 0 && (*ds_p).silhouette & 1 as libc::c_int == 0 {
        (*ds_p).silhouette |= 1 as libc::c_int;
        (*ds_p)
            .bsilheight = if (*sidedef).midtexture > 0 as libc::c_int
            && (*sidedef).midtexture < numtextures
        {
            2147483647 as libc::c_int
        } else {
