...
extern "C" {
    ...
    static mut aimingangle: angle_t;
    ...
    fn G_SoftwareClipAimingPitch(aiming: *mut int32_t) -> int16_t;
    static mut rendermode: rendermode_t;
    fn I_GetRefreshRate() -> uint32_t;
    static mut yslopetab: [fixed_t; 19200];
    static mut yslope: *mut fixed_t;
...
pub type levelinterpolator_type_e = libc::c_uint;
pub const LVLINTERP_DynSlope: levelinterpolator_type_e = 4;
pub const LVLINTERP_Polyobj: levelinterpolator_type_e = 3;
pub const LVLINTERP_SideScroll: levelinterpolator_type_e = 2;
pub const LVLINTERP_SectorScroll: levelinterpolator_type_e = 1;
pub const LVLINTERP_SectorPlane: levelinterpolator_type_e = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct levelinterpolator_s {
    pub type_0: levelinterpolator_type_e,
    pub thinker: *mut thinker_t,
...
pub union C2RustUnnamed_4 {
    pub sectorplane: C2RustUnnamed_9,
    pub sectorscroll: C2RustUnnamed_8,
    pub sidescroll: C2RustUnnamed_7,
    pub polyobj: C2RustUnnamed_6,
    pub dynslope: C2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_5 {
    ...
    pub oldd: vector2_t,
    pub bakd: vector2_t,
    pub oldzdelta: fixed_t,
    pub bakzdelta: fixed_t,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_6 {
    pub polyobj: *mut polyobj_t,
    pub oldvertices: *mut fixed_t,
    pub bakvertices: *mut fixed_t,
    pub vertices_size: size_t,
    pub oldcx: fixed_t,
    pub oldcy: fixed_t,
    pub bakcx: fixed_t,
    pub bakcy: fixed_t,
...
pub struct C2RustUnnamed_7 {
    pub side: *mut side_t,
    pub oldtextureoffset: fixed_t,
    pub oldrowoffset: fixed_t,
    pub baktextureoffset: fixed_t,
    pub bakrowoffset: fixed_t,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_8 {
    pub sector: *mut sector_t,
    pub oldxoffs: fixed_t,
    pub oldyoffs: fixed_t,
    pub bakxoffs: fixed_t,
    pub bakyoffs: fixed_t,
    pub ceiling: boolean,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_9 {
    pub sector: *mut sector_t,
    pub oldheight: fixed_t,
    pub bakheight: fixed_t,
    pub ceiling: boolean,
}
pub type levelinterpolator_t = levelinterpolator_s;
...
static mut fpscap_cons_t: [CV_PossibleValue_t; 5] = [
    {
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Unlimited\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"Match refresh rate\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_fpscap: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"fpscap\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Match refresh rate\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: fpscap_cons_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut ps_interp_frac: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_3 {
...
#[no_mangle]
pub static mut ps_interp_lag: ps_metric_t = {
    let mut init = ps_metric_t {
        value: C2RustUnnamed_3 {
            p: 0 as libc::c_int as precise_t,
        },
...
#[no_mangle]
pub unsafe extern "C" fn R_GetFramerateCap() -> uint32_t {
    if rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint {
        return 35 as libc::c_int as uint32_t;
    }
    if cv_fpscap.value == 0 as libc::c_int {
        return I_GetRefreshRate();
    }
    if cv_fpscap.value < 0 as libc::c_int {
        return 0 as libc::c_int as uint32_t;
    }
    return cv_fpscap.value as uint32_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_UsingFrameInterpolation() -> boolean {
    return (R_GetFramerateCap() != 35 as libc::c_int as uint32_t
        || cv_timescale.value < (1 as libc::c_int) << 16 as libc::c_int) as libc::c_int;
}
static mut p1view_old: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
    sector: 0 as *const sector_t as *mut sector_t,
    player: 0 as *const player_t as *mut player_t,
    angle: 0,
    aim: 0,
    cos: 0,
    sin: 0,
...
static mut p1view_new: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut p2view_old: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut p2view_new: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut sky1view_old: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut sky1view_new: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut sky2view_old: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut sky2view_new: viewvars_t = viewvars_t {
    x: 0,
    y: 0,
    z: 0,
    sky: 0,
...
static mut oldview: *mut viewvars_t = unsafe {
    &p1view_old as *const viewvars_t as *mut viewvars_t
};
static mut oldview_invalid: [libc::c_int; 2] = [0 as libc::c_int, 0 as libc::c_int];
#[no_mangle]
pub static mut newview: *mut viewvars_t = unsafe {
    &p1view_new as *const viewvars_t as *mut viewvars_t
};
#[no_mangle]
pub static mut viewcontext: viewcontext_e = VIEWCONTEXT_PLAYER1;
static mut levelinterpolators: *mut *mut levelinterpolator_t = 0
    as *const *mut levelinterpolator_t as *mut *mut levelinterpolator_t;
static mut levelinterpolators_len: size_t = 0;
static mut levelinterpolators_size: size_t = 0;
unsafe extern "C" fn R_LerpFixed(
    mut from: fixed_t,
    mut to: fixed_t,
    mut frac: fixed_t,
) -> fixed_t {
...
unsafe extern "C" fn R_LerpAngle(
    mut from: angle_t,
    mut to: angle_t,
    mut frac: fixed_t,
) -> angle_t {
    return from
        .wrapping_add(FixedMul(frac, to.wrapping_sub(from) as fixed_t) as angle_t);
}
unsafe extern "C" fn R_LerpVector2(
    mut from: *const vector2_t,
    mut to: *const vector2_t,
    mut frac: fixed_t,
    mut out: *mut vector2_t,
) -> *mut vector2_t {
...
unsafe extern "C" fn R_LerpVector3(
    mut from: *const vector3_t,
    mut to: *const vector3_t,
    mut frac: fixed_t,
    mut out: *mut vector3_t,
) -> *mut vector3_t {
...
unsafe extern "C" fn R_SetupFreelook(mut player: *mut player_t, mut skybox: boolean) {
    if rendermode as libc::c_uint == render_soft as libc::c_int as libc::c_uint {
        G_SoftwareClipAimingPitch(&mut aimingangle as *mut angle_t as *mut int32_t);
    }
    centeryfrac = (viewheight / 2 as libc::c_int) << 16 as libc::c_int;
    if rendermode as libc::c_uint == render_soft as libc::c_int as libc::c_uint {
        centeryfrac
            += FixedMul(
                FixedDiv(
                    (finetangent[(2048 as libc::c_int
                        + (aimingangle as int32_t >> 19 as libc::c_int)
                        & 8192 as libc::c_int - 1 as libc::c_int) as usize]
                        >> 16 as libc::c_int - 16 as libc::c_int) * 160 as libc::c_int,
                    fovtan,
                ),
                FixedDiv(
                    viewwidth << 16 as libc::c_int,
    ...
    if rendermode as libc::c_uint == render_soft as libc::c_int as libc::c_uint {
        yslope = &mut *yslopetab
            .as_mut_ptr()
            .offset((viewheight * 8 as libc::c_int - centery) as isize) as *mut fixed_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_InterpolateView(mut frac: fixed_t) {
    let mut prevview: *mut viewvars_t = oldview;
    let mut skybox: boolean = 0 as libc::c_int;
    let mut i: uint8_t = 0;
    if FixedToFloat(frac) < 0 as libc::c_int as libc::c_float {
        frac = 0 as libc::c_int;
    }
    if frac > (1 as libc::c_int) << 16 as libc::c_int {
        frac = (1 as libc::c_int) << 16 as libc::c_int;
    }
    if viewcontext as libc::c_uint == VIEWCONTEXT_SKY1 as libc::c_int as libc::c_uint
        || viewcontext as libc::c_uint
            == VIEWCONTEXT_PLAYER1 as libc::c_int as libc::c_uint
    {
        i = 0 as libc::c_int as uint8_t;
    } else {
        i = 1 as libc::c_int as uint8_t;
    }
    if oldview_invalid[i as usize] != 0 as libc::c_int {
        prevview = newview;
    }
    ...
    if newview == &mut sky1view_new as *mut viewvars_t
        || newview == &mut sky2view_new as *mut viewvars_t
    {
        skybox = 1 as libc::c_int;
    }
    R_SetupFreelook((*newview).player, skybox);
}
#[no_mangle]
pub unsafe extern "C" fn R_UpdateViewInterpolation() {
    p1view_old = p1view_new;
    p2view_old = p2view_new;
    sky1view_old = sky1view_new;
    sky2view_old = sky2view_new;
    if oldview_invalid[0 as libc::c_int as usize] > 0 as libc::c_int {
        oldview_invalid[0 as libc::c_int as usize] -= 1;
        oldview_invalid[0 as libc::c_int as usize];
    }
    if oldview_invalid[1 as libc::c_int as usize] > 0 as libc::c_int {
        oldview_invalid[1 as libc::c_int as usize] -= 1;
        oldview_invalid[1 as libc::c_int as usize];
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_ResetViewInterpolation(mut p: uint8_t) {
    if p as libc::c_int == 0 as libc::c_int {
        let mut i: uint8_t = 0;
        i = 0 as libc::c_int as uint8_t;
        while (i as libc::c_int) < 2 as libc::c_int {
            oldview_invalid[i as usize] += 1;
            oldview_invalid[i as usize];
            i = i.wrapping_add(1);
            i;
        }
    } else {
        oldview_invalid[(p as libc::c_int - 1 as libc::c_int) as usize] += 1;
        oldview_invalid[(p as libc::c_int - 1 as libc::c_int) as usize];
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_SetViewContext(mut _viewcontext: viewcontext_e) {
    viewcontext = _viewcontext;
    match viewcontext as libc::c_uint {
        0 => {
            oldview = &mut p1view_old;
            newview = &mut p1view_new;
        }
        1 => {
            oldview = &mut p2view_old;
            newview = &mut p2view_new;
        }
        2 => {
            oldview = &mut sky1view_old;
            newview = &mut sky1view_new;
        }
        3 => {
            oldview = &mut sky2view_old;
            newview = &mut sky2view_new;
        }
        _ => {
            I_Error(
                b"viewcontext value is invalid: we should never get here without an assert!!\0"
...
#[no_mangle]
pub unsafe extern "C" fn R_InterpolateFixed(
    mut from: fixed_t,
    mut to: fixed_t,
) -> fixed_t {
...
#[no_mangle]
pub unsafe extern "C" fn R_InterpolateAngle(
    mut from: angle_t,
    mut to: angle_t,
) -> angle_t {
    if R_UsingFrameInterpolation() == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn R_InterpolateMobjState(
    mut mobj: *mut mobj_t,
    mut frac: fixed_t,
    mut out: *mut interpmobjstate_t,
) {
    if frac == (1 as libc::c_int) << 16 as libc::c_int {
        (*out).x = (*mobj).x;
        (*out).y = (*mobj).y;
    ...
    (*out)
        .spritexscale = if (*mobj).resetinterp != 0 {
        (*mobj).spritexscale
    } else {
        R_LerpFixed((*mobj).old_spritexscale, (*mobj).spritexscale, frac)
    };
    (*out)
        .spriteyscale = if (*mobj).resetinterp != 0 {
        (*mobj).spriteyscale
    } else {
        R_LerpFixed((*mobj).old_spriteyscale, (*mobj).spriteyscale, frac)
    };
    ...
    if !((*mobj).player).is_null() {
        (*out)
            .angle = if (*mobj).resetinterp != 0 {
            (*(*mobj).player).drawangle
        } else {
            R_LerpAngle(
                (*(*mobj).player).old_drawangle,
                (*(*mobj).player).drawangle,
                frac,
            )
        };
        ...
        (*out)
            ...
            R_LerpAngle((*mobj).old_angle, (*mobj).angle, frac)
        };
    }
    (*out)
        .pitch = if (*mobj).resetinterp != 0 {
        (*mobj).pitch
    } else {
        R_LerpAngle((*mobj).old_pitch, (*mobj).pitch, frac)
    };
    (*out)
        .roll = if (*mobj).resetinterp != 0 {
        (*mobj).roll
    } else {
        R_LerpAngle((*mobj).old_roll, (*mobj).roll, frac)
    };
    (*out)
        .spriteroll = if (*mobj).resetinterp != 0 {
        (*mobj).spriteroll
    } else {
        R_LerpAngle((*mobj).old_spriteroll, (*mobj).spriteroll, frac)
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_InterpolatePrecipMobjState(
    ...
    if frac == (1 as libc::c_int) << 16 as libc::c_int {
        ...
        (*out).y = (*mobj).y;
        (*out).z = (*mobj).z;
        (*out).scale = (1 as libc::c_int) << 16 as libc::c_int;
        (*out).radius = (*mobj).radius;
        (*out).height = (*mobj).height;
        (*out).subsector = (*mobj).subsector;
    ...
    (*out).height = (*mobj).height;
    (*out)
        .spritexscale = R_LerpFixed(
        (*mobj).old_spritexscale,
        (*mobj).spritexscale,
        frac,
    );
    (*out)
        .spriteyscale = R_LerpFixed(
        (*mobj).old_spriteyscale,
        (*mobj).spriteyscale,
        frac,
    );
    (*out)
        .spritexoffset = R_LerpFixed(
        (*mobj).old_spritexoffset,
        (*mobj).spritexoffset,
        frac,
    );
    (*out)
        .spriteyoffset = R_LerpFixed(
        (*mobj).old_spriteyoffset,
        (*mobj).spriteyoffset,
        frac,
    );
    (*out).subsector = R_PointInSubsector((*out).x, (*out).y);
...
unsafe extern "C" fn AddInterpolator(mut interpolator: *mut levelinterpolator_t) {
    if levelinterpolators_len >= levelinterpolators_size {
        if levelinterpolators_size == 0 as libc::c_int as size_t {
            levelinterpolators_size = 128 as libc::c_int as size_t;
        } else {
            levelinterpolators_size = levelinterpolators_size
                * 2 as libc::c_int as size_t;
        }
        levelinterpolators = Z_ReallocAlign(
            levelinterpolators as *mut libc::c_void,
            (::core::mem::size_of::<*mut levelinterpolator_t>() as libc::c_ulong)
                .wrapping_mul(levelinterpolators_size),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut *mut levelinterpolator_t;
    }
    let ref mut fresh0 = *levelinterpolators.offset(levelinterpolators_len as isize);
    *fresh0 = interpolator;
    levelinterpolators_len = levelinterpolators_len
        .wrapping_add(1 as libc::c_int as size_t);
}
unsafe extern "C" fn CreateInterpolator(
    mut type_0: levelinterpolator_type_e,
    mut thinker: *mut thinker_t,
) -> *mut levelinterpolator_t {
    let mut ret: *mut levelinterpolator_t = Z_CallocAlign(
        ::core::mem::size_of::<levelinterpolator_t>() as libc::c_ulong,
        PU_LEVEL as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ) as *mut levelinterpolator_t;
    (*ret).type_0 = type_0;
    (*ret).thinker = thinker;
    AddInterpolator(ret);
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn R_CreateInterpolator_SectorPlane(
    mut thinker: *mut thinker_t,
    mut sector: *mut sector_t,
    mut ceiling: boolean,
) {
    let mut interp: *mut levelinterpolator_t = CreateInterpolator(
        LVLINTERP_SectorPlane,
        thinker,
    );
    (*interp).c2rust_unnamed.sectorplane.sector = sector;
    (*interp).c2rust_unnamed.sectorplane.ceiling = ceiling;
    if ceiling != 0 {
        (*interp).c2rust_unnamed.sectorplane.bakheight = (*sector).ceilingheight;
        (*interp)
            .c2rust_unnamed
            .sectorplane
            .oldheight = (*interp).c2rust_unnamed.sectorplane.bakheight;
    } else {
        (*interp).c2rust_unnamed.sectorplane.bakheight = (*sector).floorheight;
        (*interp)
            .c2rust_unnamed
            .sectorplane
            .oldheight = (*interp).c2rust_unnamed.sectorplane.bakheight;
...
#[no_mangle]
pub unsafe extern "C" fn R_CreateInterpolator_SectorScroll(
    mut thinker: *mut thinker_t,
    mut sector: *mut sector_t,
    mut ceiling: boolean,
) {
    ...
    (*interp).c2rust_unnamed.sectorscroll.sector = sector;
    (*interp).c2rust_unnamed.sectorscroll.ceiling = ceiling;
    if ceiling != 0 {
        (*interp).c2rust_unnamed.sectorscroll.bakxoffs = (*sector).ceilingxoffset;
        (*interp)
            .c2rust_unnamed
            .sectorscroll
            .oldxoffs = (*interp).c2rust_unnamed.sectorscroll.bakxoffs;
        (*interp).c2rust_unnamed.sectorscroll.bakyoffs = (*sector).ceilingyoffset;
        (*interp)
            .c2rust_unnamed
            .sectorscroll
            .oldyoffs = (*interp).c2rust_unnamed.sectorscroll.bakyoffs;
    } else {
        (*interp).c2rust_unnamed.sectorscroll.bakxoffs = (*sector).floorxoffset;
        (*interp)
            .c2rust_unnamed
            .sectorscroll
            .oldxoffs = (*interp).c2rust_unnamed.sectorscroll.bakxoffs;
        (*interp).c2rust_unnamed.sectorscroll.bakyoffs = (*sector).flooryoffset;
        (*interp)
            .c2rust_unnamed
            .sectorscroll
            .oldyoffs = (*interp).c2rust_unnamed.sectorscroll.bakyoffs;
...
#[no_mangle]
pub unsafe extern "C" fn R_CreateInterpolator_SideScroll(
    mut thinker: *mut thinker_t,
    mut side: *mut side_t,
) {
    let mut interp: *mut levelinterpolator_t = CreateInterpolator(
    ...
    (*interp).c2rust_unnamed.sidescroll.side = side;
    (*interp).c2rust_unnamed.sidescroll.baktextureoffset = (*side).textureoffset;
    (*interp)
        .c2rust_unnamed
        .sidescroll
        .oldtextureoffset = (*interp).c2rust_unnamed.sidescroll.baktextureoffset;
    (*interp).c2rust_unnamed.sidescroll.bakrowoffset = (*side).rowoffset;
    (*interp)
        .c2rust_unnamed
        .sidescroll
        .oldrowoffset = (*interp).c2rust_unnamed.sidescroll.bakrowoffset;
}
#[no_mangle]
pub unsafe extern "C" fn R_CreateInterpolator_Polyobj(
    mut thinker: *mut thinker_t,
    ...
    (*interp).c2rust_unnamed.polyobj.polyobj = polyobj;
    (*interp).c2rust_unnamed.polyobj.vertices_size = (*polyobj).numVertices;
    (*interp)
        .c2rust_unnamed
        .polyobj
        .oldvertices = Z_CallocAlign(
        (::core::mem::size_of::<fixed_t>() as libc::c_ulong)
            .wrapping_mul(2 as libc::c_int as libc::c_ulong)
            .wrapping_mul((*polyobj).numVertices),
        PU_LEVEL as libc::c_int,
        0 as *mut libc::c_void,
        32 as libc::c_int,
    ) as *mut fixed_t;
    ...
    while i < (*polyobj).numVertices {
        let ref mut fresh1 = *((*interp).c2rust_unnamed.polyobj.bakvertices)
            .offset((i * 2 as libc::c_int as size_t) as isize);
        *fresh1 = (**((*polyobj).vertices).offset(i as isize)).x;
        *((*interp).c2rust_unnamed.polyobj.oldvertices)
            .offset((i * 2 as libc::c_int as size_t) as isize) = *fresh1;
        let ref mut fresh2 = *((*interp).c2rust_unnamed.polyobj.bakvertices)
            .offset(
                (i * 2 as libc::c_int as size_t).wrapping_add(1 as libc::c_int as size_t)
                    as isize,
            );
        *fresh2 = (**((*polyobj).vertices).offset(i as isize)).y;
        *((*interp).c2rust_unnamed.polyobj.oldvertices)
            .offset(
                (i * 2 as libc::c_int as size_t).wrapping_add(1 as libc::c_int as size_t)
                    as isize,
    ...
    (*interp).c2rust_unnamed.polyobj.bakcx = (*polyobj).centerPt.x;
    (*interp).c2rust_unnamed.polyobj.oldcx = (*interp).c2rust_unnamed.polyobj.bakcx;
    (*interp).c2rust_unnamed.polyobj.bakcy = (*polyobj).centerPt.y;
    (*interp).c2rust_unnamed.polyobj.oldcy = (*interp).c2rust_unnamed.polyobj.bakcy;
}
#[no_mangle]
pub unsafe extern "C" fn R_CreateInterpolator_DynSlope(
    mut thinker: *mut thinker_t,
    ...
    (*interp).c2rust_unnamed.dynslope.slope = slope;
    FV3_Copy(&mut (*interp).c2rust_unnamed.dynslope.oldo, &mut (*slope).o);
    FV3_Copy(&mut (*interp).c2rust_unnamed.dynslope.bako, &mut (*slope).o);
    FV2_Copy(&mut (*interp).c2rust_unnamed.dynslope.oldd, &mut (*slope).d);
    FV2_Copy(&mut (*interp).c2rust_unnamed.dynslope.bakd, &mut (*slope).d);
    (*interp).c2rust_unnamed.dynslope.bakzdelta = (*slope).zdelta;
    (*interp)
        .c2rust_unnamed
        .dynslope
        .oldzdelta = (*interp).c2rust_unnamed.dynslope.bakzdelta;
}
#[no_mangle]
pub unsafe extern "C" fn R_InitializeLevelInterpolators() {
    levelinterpolators_len = 0 as libc::c_int as size_t;
    levelinterpolators_size = 0 as libc::c_int as size_t;
    levelinterpolators = 0 as *mut *mut levelinterpolator_t;
}
unsafe extern "C" fn UpdateLevelInterpolatorState(mut interp: *mut levelinterpolator_t) {
    let mut i: size_t = 0;
    match (*interp).type_0 as libc::c_uint {
        0 => {
            (*interp)
                .c2rust_unnamed
                .sectorplane
            ...
            (*interp)
                .c2rust_unnamed
                .sectorplane
                .bakheight = if (*interp).c2rust_unnamed.sectorplane.ceiling != 0 {
                (*(*interp).c2rust_unnamed.sectorplane.sector).ceilingheight
            } else {
                (*(*interp).c2rust_unnamed.sectorplane.sector).floorheight
            };
        }
        1 => {
            (*interp)
            ...
            (*interp)
                .c2rust_unnamed
                .sectorscroll
                .bakxoffs = if (*interp).c2rust_unnamed.sectorscroll.ceiling != 0 {
                (*(*interp).c2rust_unnamed.sectorscroll.sector).ceilingxoffset
            } else {
                (*(*interp).c2rust_unnamed.sectorscroll.sector).floorxoffset
            };
            (*interp)
                .c2rust_unnamed
                .sectorscroll
            ...
            (*interp)
                .c2rust_unnamed
                .sectorscroll
                .bakyoffs = if (*interp).c2rust_unnamed.sectorscroll.ceiling != 0 {
                (*(*interp).c2rust_unnamed.sectorscroll.sector).ceilingyoffset
            } else {
                (*(*interp).c2rust_unnamed.sectorscroll.sector).flooryoffset
            };
        }
        2 => {
            (*interp)
            ...
            (*interp)
                .c2rust_unnamed
                .sidescroll
                .baktextureoffset = (*(*interp).c2rust_unnamed.sidescroll.side)
                .textureoffset;
            (*interp)
                .c2rust_unnamed
                .sidescroll
            ...
            (*interp)
                .c2rust_unnamed
                .sidescroll
                .bakrowoffset = (*(*interp).c2rust_unnamed.sidescroll.side).rowoffset;
        }
        3 => {
            i = 0 as libc::c_int as size_t;
            while i < (*interp).c2rust_unnamed.polyobj.vertices_size {
                *((*interp).c2rust_unnamed.polyobj.oldvertices)
                    .offset(
                        (i * 2 as libc::c_int as size_t) as isize,
                    ) = *((*interp).c2rust_unnamed.polyobj.bakvertices)
                    .offset((i * 2 as libc::c_int as size_t) as isize);
                *((*interp).c2rust_unnamed.polyobj.oldvertices)
                    .offset(
                ...
                *((*interp).c2rust_unnamed.polyobj.bakvertices)
                    .offset(
                        (i * 2 as libc::c_int as size_t) as isize,
                    ) = (**((*(*interp).c2rust_unnamed.polyobj.polyobj).vertices)
                    .offset(i as isize))
                    .x;
                *((*interp).c2rust_unnamed.polyobj.bakvertices)
                    .offset(
            ...
            (*interp)
                .c2rust_unnamed
                .polyobj
                .oldcx = (*interp).c2rust_unnamed.polyobj.bakcx;
            (*interp)
                .c2rust_unnamed
                .polyobj
                .oldcy = (*interp).c2rust_unnamed.polyobj.bakcy;
            (*interp)
                .c2rust_unnamed
                .polyobj
                .bakcx = (*(*interp).c2rust_unnamed.polyobj.polyobj).centerPt.x;
            (*interp)
                .c2rust_unnamed
                .polyobj
                .bakcy = (*(*interp).c2rust_unnamed.polyobj.polyobj).centerPt.y;
        }
        4 => {
            FV3_Copy(
                &mut (*interp).c2rust_unnamed.dynslope.oldo,
                &mut (*interp).c2rust_unnamed.dynslope.bako,
            );
            FV2_Copy(
                &mut (*interp).c2rust_unnamed.dynslope.oldd,
                &mut (*interp).c2rust_unnamed.dynslope.bakd,
            );
            (*interp)
                .c2rust_unnamed
                .dynslope
            ...
            FV3_Copy(
                &mut (*interp).c2rust_unnamed.dynslope.bako,
                &mut (*(*interp).c2rust_unnamed.dynslope.slope).o,
            );
            FV2_Copy(
                &mut (*interp).c2rust_unnamed.dynslope.bakd,
                &mut (*(*interp).c2rust_unnamed.dynslope.slope).d,
            );
            (*interp)
                .c2rust_unnamed
                .dynslope
                .bakzdelta = (*(*interp).c2rust_unnamed.dynslope.slope).zdelta;
        }
        _ => {}
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_UpdateLevelInterpolators() {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < levelinterpolators_len {
        let mut interp: *mut levelinterpolator_t = *levelinterpolators
            .offset(i as isize);
...
#[no_mangle]
pub unsafe extern "C" fn R_ClearLevelInterpolatorState(mut thinker: *mut thinker_t) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < levelinterpolators_len {
        let mut interp: *mut levelinterpolator_t = *levelinterpolators
...
#[no_mangle]
pub unsafe extern "C" fn R_ApplyLevelInterpolators(mut frac: fixed_t) {
    let mut i: size_t = 0;
    let mut ii: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < levelinterpolators_len {
        ...
        match (*interp).type_0 as libc::c_uint {
            0 => {
                if (*interp).c2rust_unnamed.sectorplane.ceiling != 0 {
                    (*(*interp).c2rust_unnamed.sectorplane.sector)
                        .ceilingheight = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorplane.oldheight,
                        (*interp).c2rust_unnamed.sectorplane.bakheight,
                        frac,
                    );
                } else {
                    (*(*interp).c2rust_unnamed.sectorplane.sector)
                        .floorheight = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorplane.oldheight,
                        (*interp).c2rust_unnamed.sectorplane.bakheight,
                        frac,
                    );
            ...
            1 => {
                if (*interp).c2rust_unnamed.sectorscroll.ceiling != 0 {
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .ceilingxoffset = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorscroll.oldxoffs,
                        (*interp).c2rust_unnamed.sectorscroll.bakxoffs,
                        frac,
                    );
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .ceilingyoffset = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorscroll.oldyoffs,
                        (*interp).c2rust_unnamed.sectorscroll.bakyoffs,
                        frac,
                    );
                } else {
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .floorxoffset = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorscroll.oldxoffs,
                        (*interp).c2rust_unnamed.sectorscroll.bakxoffs,
                        frac,
                    );
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .flooryoffset = R_LerpFixed(
                        (*interp).c2rust_unnamed.sectorscroll.oldyoffs,
                        (*interp).c2rust_unnamed.sectorscroll.bakyoffs,
                        frac,
                    );
            ...
            2 => {
                (*(*interp).c2rust_unnamed.sidescroll.side)
                    .textureoffset = R_LerpFixed(
                    (*interp).c2rust_unnamed.sidescroll.oldtextureoffset,
                    (*interp).c2rust_unnamed.sidescroll.baktextureoffset,
                    frac,
                );
                (*(*interp).c2rust_unnamed.sidescroll.side)
                    .rowoffset = R_LerpFixed(
                    (*interp).c2rust_unnamed.sidescroll.oldrowoffset,
                    (*interp).c2rust_unnamed.sidescroll.bakrowoffset,
                    frac,
                );
            }
            3 => {
                ii = 0 as libc::c_int as size_t;
                while ii < (*interp).c2rust_unnamed.polyobj.vertices_size {
                    (**((*(*interp).c2rust_unnamed.polyobj.polyobj).vertices)
                        .offset(ii as isize))
                        .x = R_LerpFixed(
                        *((*interp).c2rust_unnamed.polyobj.oldvertices)
                            .offset((ii * 2 as libc::c_int as size_t) as isize),
                        *((*interp).c2rust_unnamed.polyobj.bakvertices)
                            .offset((ii * 2 as libc::c_int as size_t) as isize),
                        frac,
                    );
                ...
                (*(*interp).c2rust_unnamed.polyobj.polyobj)
                    .centerPt
                    .x = R_LerpFixed(
                    (*interp).c2rust_unnamed.polyobj.oldcx,
                    (*interp).c2rust_unnamed.polyobj.bakcx,
                    frac,
                );
                (*(*interp).c2rust_unnamed.polyobj.polyobj)
                    .centerPt
                    .y = R_LerpFixed(
                    (*interp).c2rust_unnamed.polyobj.oldcy,
                    (*interp).c2rust_unnamed.polyobj.bakcy,
                    frac,
                );
            }
            4 => {
                ...
                (*(*interp).c2rust_unnamed.dynslope.slope)
                    .zdelta = R_LerpFixed(
                    (*interp).c2rust_unnamed.dynslope.oldzdelta,
                    (*interp).c2rust_unnamed.dynslope.bakzdelta,
                    frac,
                );
            }
            _ => {}
...
#[no_mangle]
pub unsafe extern "C" fn R_RestoreLevelInterpolators() {
    let mut i: size_t = 0;
    let mut ii: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < levelinterpolators_len {
        ...
        match (*interp).type_0 as libc::c_uint {
            0 => {
                if (*interp).c2rust_unnamed.sectorplane.ceiling != 0 {
                    (*(*interp).c2rust_unnamed.sectorplane.sector)
                        .ceilingheight = (*interp).c2rust_unnamed.sectorplane.bakheight;
                } else {
                    (*(*interp).c2rust_unnamed.sectorplane.sector)
                        .floorheight = (*interp).c2rust_unnamed.sectorplane.bakheight;
                }
                (*(*interp).c2rust_unnamed.sectorplane.sector)
                    .moved = true_0 as libc::c_int;
            }
            1 => {
                if (*interp).c2rust_unnamed.sectorscroll.ceiling != 0 {
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .ceilingxoffset = (*interp).c2rust_unnamed.sectorscroll.bakxoffs;
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .ceilingyoffset = (*interp).c2rust_unnamed.sectorscroll.bakyoffs;
                } else {
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .floorxoffset = (*interp).c2rust_unnamed.sectorscroll.bakxoffs;
                    (*(*interp).c2rust_unnamed.sectorscroll.sector)
                        .flooryoffset = (*interp).c2rust_unnamed.sectorscroll.bakyoffs;
                }
            }
            2 => {
                (*(*interp).c2rust_unnamed.sidescroll.side)
                    .textureoffset = (*interp)
                    .c2rust_unnamed
                    .sidescroll
                    .baktextureoffset;
                (*(*interp).c2rust_unnamed.sidescroll.side)
                    .rowoffset = (*interp).c2rust_unnamed.sidescroll.bakrowoffset;
            }
            3 => {
                ii = 0 as libc::c_int as size_t;
                while ii < (*interp).c2rust_unnamed.polyobj.vertices_size {
                    (**((*(*interp).c2rust_unnamed.polyobj.polyobj).vertices)
                        .offset(ii as isize))
                        .x = *((*interp).c2rust_unnamed.polyobj.bakvertices)
                        .offset((ii * 2 as libc::c_int as size_t) as isize);
                    (**((*(*interp).c2rust_unnamed.polyobj.polyobj).vertices)
                        .offset(ii as isize))
                        .y = *((*interp).c2rust_unnamed.polyobj.bakvertices)
                        .offset(
                            (ii * 2 as libc::c_int as size_t)
                                .wrapping_add(1 as libc::c_int as size_t) as isize,
                        );
                ...
                (*(*interp).c2rust_unnamed.polyobj.polyobj)
                    .centerPt
                    .x = (*interp).c2rust_unnamed.polyobj.bakcx;
                (*(*interp).c2rust_unnamed.polyobj.polyobj)
                    .centerPt
                    .y = (*interp).c2rust_unnamed.polyobj.bakcy;
            }
            4 => {
                FV3_Copy(
                    &mut (*(*interp).c2rust_unnamed.dynslope.slope).o,
                ...
                (*(*interp).c2rust_unnamed.dynslope.slope)
                    .zdelta = (*interp).c2rust_unnamed.dynslope.bakzdelta;
            }
            _ => {}
        }
        i = i.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn R_DestroyLevelInterpolators(mut thinker: *mut thinker_t) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < levelinterpolators_len {
        let mut interp: *mut levelinterpolator_t = *levelinterpolators
            .offset(i as isize);
        if (*interp).thinker == thinker {
            let ref mut fresh3 = *levelinterpolators.offset(i as isize);
            *fresh3 = *levelinterpolators
                .offset(
                    levelinterpolators_len.wrapping_sub(1 as libc::c_int as size_t)
                        as isize,
                );
            levelinterpolators_len = levelinterpolators_len
                .wrapping_sub(1 as libc::c_int as size_t);
            Z_Free(interp as *mut libc::c_void);
...
static mut interpolated_mobjs: *mut *mut mobj_t = 0 as *const *mut mobj_t
    as *mut *mut mobj_t;
static mut interpolated_mobjs_len: size_t = 0 as libc::c_int as size_t;
static mut interpolated_mobjs_capacity: size_t = 0 as libc::c_int as size_t;
#[no_mangle]
pub unsafe extern "C" fn R_AddMobjInterpolator(mut mobj: *mut mobj_t) {
    if interpolated_mobjs_len >= interpolated_mobjs_capacity {
        if interpolated_mobjs_capacity == 0 as libc::c_int as size_t {
            interpolated_mobjs_capacity = 256 as libc::c_int as size_t;
        } else {
            interpolated_mobjs_capacity = interpolated_mobjs_capacity
                * 2 as libc::c_int as size_t;
        }
        interpolated_mobjs = Z_ReallocAlign(
            interpolated_mobjs as *mut libc::c_void,
            (::core::mem::size_of::<*mut mobj_t>() as libc::c_ulong)
                .wrapping_mul(interpolated_mobjs_capacity),
            PU_LEVEL as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
        ) as *mut *mut mobj_t;
    }
    let ref mut fresh4 = *interpolated_mobjs.offset(interpolated_mobjs_len as isize);
    *fresh4 = mobj;
    interpolated_mobjs_len = interpolated_mobjs_len
        .wrapping_add(1 as libc::c_int as size_t);
    R_ResetMobjInterpolationState(mobj);
    (*mobj).resetinterp = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_RemoveMobjInterpolator(mut mobj: *mut mobj_t) {
    let mut i: size_t = 0;
    if interpolated_mobjs_len == 0 as libc::c_int as size_t {
        return;
    }
    i = 0 as libc::c_int as size_t;
    while i < interpolated_mobjs_len {
        if *interpolated_mobjs.offset(i as isize) == mobj {
            let ref mut fresh5 = *interpolated_mobjs.offset(i as isize);
            *fresh5 = *interpolated_mobjs
                .offset(
                    interpolated_mobjs_len.wrapping_sub(1 as libc::c_int as size_t)
                        as isize,
                );
            interpolated_mobjs_len = interpolated_mobjs_len
                .wrapping_sub(1 as libc::c_int as size_t);
...
#[no_mangle]
pub unsafe extern "C" fn R_InitMobjInterpolators() {
    interpolated_mobjs = 0 as *mut *mut mobj_t;
    interpolated_mobjs_len = 0 as libc::c_int as size_t;
    interpolated_mobjs_capacity = 0 as libc::c_int as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn R_UpdateMobjInterpolators() {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < interpolated_mobjs_len {
        let mut mobj: *mut mobj_t = *interpolated_mobjs.offset(i as isize);
...
#[no_mangle]
pub unsafe extern "C" fn R_ResetMobjInterpolationState(mut mobj: *mut mobj_t) {
    ...
    (*mobj).resetinterp = false_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_ResetPrecipitationMobjInterpolationState(
    mut mobj: *mut precipmobj_t,
) {
    (*mobj).old_x2 = (*mobj).old_x;
    (*mobj).old_y2 = (*mobj).old_y;
