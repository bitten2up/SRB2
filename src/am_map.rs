...
pub type AMDRAWFLINEFUNC = Option::<unsafe extern "C" fn(*const fline_t, int32_t) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mline_t {
    pub a: mpoint_t,
...
static mut REDS: uint8_t = (8 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut REDRANGE: uint8_t = 16 as libc::c_int as uint8_t;
static mut GRAYS: uint8_t = (1 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut GRAYSRANGE: uint8_t = 16 as libc::c_int as uint8_t;
static mut BROWNS: uint8_t = (3 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut YELLOWS: uint8_t = (7 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut GREENS: uint8_t = (10 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut DBLACK: uint8_t = 31 as libc::c_int as uint8_t;
static mut DWHITE: uint8_t = 0 as libc::c_int as uint8_t;
static mut NOCLIMBREDS: uint8_t = 248 as libc::c_int as uint8_t;
static mut NOCLIMBREDRANGE: uint8_t = 8 as libc::c_int as uint8_t;
static mut NOCLIMBGRAYS: uint8_t = 204 as libc::c_int as uint8_t;
static mut NOCLIMBBROWNS: uint8_t = (2 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut NOCLIMBYELLOWS: uint8_t = (11 as libc::c_int * 16 as libc::c_int) as uint8_t;
static mut player_arrow: [mline_t; 7] = [
    {
        let mut init = mline_t {
            a: {
                let mut init = mpoint_t {
                    x: -(8 as libc::c_int
                        * (16 as libc::c_int
                            * ((1 as libc::c_int)
                        ...
                        + 8 as libc::c_int
                            * (16 as libc::c_int
                                * ((1 as libc::c_int)
                                    << 16 as libc::c_int - 4 as libc::c_int)) / 7 as libc::c_int
                            / 8 as libc::c_int,
                    y: 0 as libc::c_int,
                };
                init
...
static mut cross_mark: [mline_t; 2] = [
    {
        let mut init = mline_t {
            a: {
                let mut init = mpoint_t {
...
static mut thintriangle_guy: [mline_t; 3] = [
    {
        let mut init = mline_t {
            a: {
                let mut init = mpoint_t {
                    x: -(1 as libc::c_int) * ((1 as libc::c_int) << 16 as libc::c_int)
                        / 2 as libc::c_int,
                    y: -(7 as libc::c_int) * ((1 as libc::c_int) << 16 as libc::c_int)
                        / 10 as libc::c_int,
                };
                init
            },
...
static mut bigstate: boolean = 0;
static mut draw_grid: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut automapactive: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut am_recalc: boolean = false_0 as libc::c_int;
static mut am_stopped: boolean = true_0 as libc::c_int;
static mut f_x: int32_t = 0;
static mut f_y: int32_t = 0;
static mut f_w: int32_t = 0;
static mut f_h: int32_t = 0;
static mut m_keydown: [boolean; 4] = [0; 4];
...
static mut scale_mtof: fixed_t = ((1 as libc::c_int) << 16 as libc::c_int)
    / 5 as libc::c_int;
static mut scale_ftom: fixed_t = 0;
static mut plr: *mut player_t = 0 as *const player_t as *mut player_t;
static mut followplayer: boolean = true_0 as libc::c_int;
static mut AM_drawFline: AMDRAWFLINEFUNC = None;
unsafe extern "C" fn AM_activateNewScale() {
    m_x += m_w / 2 as libc::c_int;
    m_y += m_h / 2 as libc::c_int;
    m_w = FixedMul(f_w << 16 as libc::c_int, scale_ftom);
    m_h = FixedMul(f_h << 16 as libc::c_int, scale_ftom);
    m_x -= m_w / 2 as libc::c_int;
    m_y -= m_h / 2 as libc::c_int;
    m_x2 = m_x + m_w;
    m_y2 = m_y + m_h;
...
#[inline]
unsafe extern "C" fn AM_saveScaleAndLoc() {
    old_m_x = m_x;
    old_m_y = m_y;
    old_m_w = m_w;
    old_m_h = m_h;
...
#[inline]
unsafe extern "C" fn AM_restoreScaleAndLoc() {
    m_w = old_m_w;
    m_h = old_m_h;
    if followplayer == 0 {
        m_x = old_m_x;
    ...
    m_x2 = m_x + m_w;
    m_y2 = m_y + m_h;
    scale_mtof = FixedDiv(f_w << 16 as libc::c_int, m_w);
    scale_ftom = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, scale_mtof);
}
unsafe extern "C" fn AM_findMinMaxBoundaries() {
    let mut i: size_t = 0;
    let mut a: fixed_t = 0;
    let mut b: fixed_t = 0;
    min_y = 2147483647 as libc::c_int;
    min_x = min_y;
    max_y = -(2147483647 as libc::c_int);
    max_x = max_y;
    ...
    max_x >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
    min_x >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
    max_w = max_x - min_x;
    max_y >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
    min_y >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
    max_h = max_y - min_y;
    a = FixedDiv(f_w << 16 as libc::c_int, max_w);
    b = FixedDiv(f_h << 16 as libc::c_int, max_h);
    min_scale_mtof = if a < b { a } else { b };
    max_scale_mtof = FixedDiv(
        f_h << 16 as libc::c_int,
        2 as libc::c_int
            * (16 as libc::c_int
                * ((1 as libc::c_int) << 16 as libc::c_int - 4 as libc::c_int)),
    );
}
unsafe extern "C" fn AM_changeWindowLoc() {
    if m_paninc.x != 0 || m_paninc.y != 0 {
        followplayer = false_0 as libc::c_int;
        f_oldloc.x = 2147483647 as libc::c_int;
    }
    m_x += m_paninc.x;
    m_y += m_paninc.y;
    if m_x + m_w / 2 as libc::c_int > max_x {
        m_x = max_x - m_w / 2 as libc::c_int;
    } else if (m_x + m_w / 2 as libc::c_int) < min_x {
        m_x = min_x - m_w / 2 as libc::c_int;
    }
    if m_y + m_h / 2 as libc::c_int > max_y {
        m_y = max_y - m_h / 2 as libc::c_int;
    } else if (m_y + m_h / 2 as libc::c_int) < min_y {
        m_y = min_y - m_h / 2 as libc::c_int;
    }
    m_x2 = m_x + m_w;
    m_y2 = m_y + m_h;
}
unsafe extern "C" fn AM_initVariables() {
    let mut pnum: int32_t = 0;
    automapactive = true_0 as libc::c_int;
    f_oldloc.x = 2147483647 as libc::c_int;
    m_paninc.y = 0 as libc::c_int;
    m_paninc.x = m_paninc.y;
    ftom_zoommul = (1 as libc::c_int) << 16 as libc::c_int;
    mtof_zoommul = (1 as libc::c_int) << 16 as libc::c_int;
    m_w = FixedMul(f_w << 16 as libc::c_int, scale_ftom);
    m_h = FixedMul(f_h << 16 as libc::c_int, scale_ftom);
    pnum = consoleplayer;
    if playeringame[pnum as usize] == 0 {
        pnum = 0 as libc::c_int;
        while pnum < 32 as libc::c_int {
            if playeringame[pnum as usize] != 0 {
                break;
            }
            pnum += 1;
    ...
    plr = &mut *players.as_mut_ptr().offset(pnum as isize) as *mut player_t;
    if !plr.is_null() && !((*plr).mo).is_null() {
        m_x = ((*(*plr).mo).x
            >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int))
            - m_w / 2 as libc::c_int;
        m_y = ((*(*plr).mo).y
...
unsafe extern "C" fn AM_FrameBufferInit() {
    f_y = 0 as libc::c_int;
    f_x = f_y;
    f_w = vid.width;
    f_h = vid.height;
}
unsafe extern "C" fn AM_LevelInit() {
    AM_findMinMaxBoundaries();
    scale_mtof = FixedDiv(
        min_scale_mtof * 10 as libc::c_int,
...
pub unsafe extern "C" fn AM_Stop() {
    ...
    am_stopped = true_0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn AM_Start() {
    static mut lastlevel: int32_t = -(1 as libc::c_int);
    if am_stopped == 0 {
        AM_Stop();
    }
    am_stopped = false_0 as libc::c_int;
    if lastlevel != gamemap as libc::c_int || am_recalc != 0 {
        AM_FrameBufferInit();
        if lastlevel != gamemap as libc::c_int {
            AM_LevelInit();
            lastlevel = gamemap as int32_t;
        }
        am_recalc = false_0 as libc::c_int;
    }
    AM_initVariables();
}
unsafe extern "C" fn AM_minOutWindowScale() {
    scale_mtof = min_scale_mtof;
    scale_ftom = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, scale_mtof);
    AM_activateNewScale();
}
unsafe extern "C" fn AM_maxOutWindowScale() {
    scale_mtof = max_scale_mtof;
    scale_ftom = FixedDiv((1 as libc::c_int) << 16 as libc::c_int, scale_mtof);
    AM_activateNewScale();
}
unsafe extern "C" fn AM_setWindowPanning() {
    if m_keydown[2 as libc::c_int as usize] != 0 {
        m_paninc.y = FixedMul((4 as libc::c_int) << 16 as libc::c_int, scale_ftom);
    } else if m_keydown[3 as libc::c_int as usize] != 0 {
        m_paninc.y = -FixedMul((4 as libc::c_int) << 16 as libc::c_int, scale_ftom);
    } else {
        m_paninc.y = 0 as libc::c_int;
    }
    if m_keydown[0 as libc::c_int as usize] != 0 {
        m_paninc.x = FixedMul((4 as libc::c_int) << 16 as libc::c_int, scale_ftom);
    } else if m_keydown[1 as libc::c_int as usize] != 0 {
        m_paninc.x = -FixedMul((4 as libc::c_int) << 16 as libc::c_int, scale_ftom);
    } else {
        m_paninc.x = 0 as libc::c_int;
    };
}
#[no_mangle]
pub unsafe extern "C" fn AM_Responder(mut ev: *mut event_t) -> boolean {
    let mut rc: int32_t = false_0 as libc::c_int;
    if devparm != 0 || cv_debug != 0 {
        if automapactive == 0 {
            if (*ev).type_0 as libc::c_uint == ev_keydown as libc::c_int as libc::c_uint
                && (*ev).key == 9 as libc::c_int
            {
                if gamekeydown[(0x80 as libc::c_int + 56 as libc::c_int) as usize] == 0
                    && gamekeydown[(0x80 as libc::c_int + 57 as libc::c_int) as usize]
                        == 0
                {
                    bigstate = 0 as libc::c_int;
                    AM_Start();
                    rc = true_0 as libc::c_int;
                }
            }
            ...
            == ev_keydown as libc::c_int as libc::c_uint
        {
            ...
            match (*ev).key {
                235 => {
                    if followplayer == 0 {
                        m_keydown[0 as libc::c_int as usize] = true_0 as libc::c_int;
                        AM_setWindowPanning();
                    } else {
                        rc = false_0 as libc::c_int;
                    }
                }
                233 => {
                    if followplayer == 0 {
                        m_keydown[1 as libc::c_int as usize] = true_0 as libc::c_int;
                        AM_setWindowPanning();
                    } else {
                        rc = false_0 as libc::c_int;
                    }
                ...
                230 => {
                    if followplayer == 0 {
                        m_keydown[2 as libc::c_int as usize] = true_0 as libc::c_int;
                        AM_setWindowPanning();
                    } else {
                        rc = false_0 as libc::c_int;
                    }
                ...
                238 => {
                    if followplayer == 0 {
                        m_keydown[3 as libc::c_int as usize] = true_0 as libc::c_int;
                        AM_setWindowPanning();
                    } else {
                        rc = false_0 as libc::c_int;
                    }
                ...
                45 => {
                    mtof_zoommul = 50 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int) / 51 as libc::c_int;
                    ftom_zoommul = 51 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int) / 50 as libc::c_int;
                    AM_setWindowPanning();
                }
                61 => {
                    mtof_zoommul = 51 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int) / 50 as libc::c_int;
                    ftom_zoommul = 50 as libc::c_int
                        * ((1 as libc::c_int) << 16 as libc::c_int) / 51 as libc::c_int;
                    AM_setWindowPanning();
                }
                9 => {
                ...
                48 => {
                    bigstate = (bigstate == 0) as libc::c_int;
                    if bigstate != 0 {
                        AM_saveScaleAndLoc();
                ...
                102 => {
                    followplayer = (followplayer == 0) as libc::c_int;
                    f_oldloc.x = 2147483647 as libc::c_int;
                }
                103 => {
                    draw_grid = (draw_grid == 0) as libc::c_int;
                }
                _ => {
                    rc = false_0 as libc::c_int;
                }
        ...
        } else if (*ev).type_0 as libc::c_uint == ev_keyup as libc::c_int as libc::c_uint
        {
            ...
            match (*ev).key {
                235 => {
                    if followplayer == 0 {
                        m_keydown[0 as libc::c_int as usize] = false_0 as libc::c_int;
                        AM_setWindowPanning();
                    }
                }
                233 => {
                    if followplayer == 0 {
                        m_keydown[1 as libc::c_int as usize] = false_0 as libc::c_int;
                        AM_setWindowPanning();
                    }
                }
                230 => {
                    if followplayer == 0 {
                        m_keydown[2 as libc::c_int as usize] = false_0 as libc::c_int;
                        AM_setWindowPanning();
                    }
                }
                238 => {
                    if followplayer == 0 {
                        m_keydown[3 as libc::c_int as usize] = false_0 as libc::c_int;
                        AM_setWindowPanning();
                    }
                }
                45 | 61 => {
...
#[inline]
unsafe extern "C" fn AM_changeWindowScale() {
...
#[inline]
unsafe extern "C" fn AM_doFollowPlayer() {
...
pub unsafe extern "C" fn AM_Ticker() {
    ...
    if dedicated != 0 || automapactive == 0 {
        return;
    }
    if followplayer != 0 {
        AM_doFollowPlayer();
    }
    if ftom_zoommul != (1 as libc::c_int) << 16 as libc::c_int {
...
unsafe extern "C" fn AM_clearFB(mut color: int32_t) {
    V_DrawFill(f_x, f_y, f_w, f_h, color | 0x40000000 as libc::c_int);
}
unsafe extern "C" fn AM_clipMline(
    mut ml: *const mline_t,
    mut fl: *mut fline_t,
) -> boolean {
    let mut outcode1: int32_t = 0 as libc::c_int;
    let mut outcode2: int32_t = 0 as libc::c_int;
    let mut outside: int32_t = 0;
    let mut tmp: fpoint_t = {
        let mut init = fpoint_t {
            x: 0 as libc::c_int,
            y: 0 as libc::c_int,
        };
        init
    ...
    if (*ml).a.y > m_y2 {
        outcode1 = TOP as libc::c_int;
    } else if (*ml).a.y < m_y {
        outcode1 = BOTTOM as libc::c_int;
    }
    if (*ml).b.y > m_y2 {
        outcode2 = TOP as libc::c_int;
    } else if (*ml).b.y < m_y {
        outcode2 = BOTTOM as libc::c_int;
    }
    if outcode1 & outcode2 != 0 {
        return false_0 as libc::c_int;
    }
    if (*ml).a.x < m_x {
        outcode1 |= LEFT as libc::c_int;
    } else if (*ml).a.x > m_x2 {
        outcode1 |= RIGHT as libc::c_int;
    }
    if (*ml).b.x < m_x {
        outcode2 |= LEFT as libc::c_int;
    } else if (*ml).b.x > m_x2 {
        outcode2 |= RIGHT as libc::c_int;
    }
    if outcode1 & outcode2 != 0 {
        return false_0 as libc::c_int;
    }
    (*fl).a.x = f_x + (FixedMul((*ml).a.x - m_x, scale_mtof) >> 16 as libc::c_int);
    (*fl)
        .a
        .y = f_y + (f_h - (FixedMul((*ml).a.y - m_y, scale_mtof) >> 16 as libc::c_int));
    (*fl).b.x = f_x + (FixedMul((*ml).b.x - m_x, scale_mtof) >> 16 as libc::c_int);
    (*fl)
        .b
        .y = f_y + (f_h - (FixedMul((*ml).b.y - m_y, scale_mtof) >> 16 as libc::c_int));
    outcode1 = 0 as libc::c_int;
    if (*fl).a.y < 0 as libc::c_int {
        outcode1 |= TOP as libc::c_int;
    } else if (*fl).a.y >= f_h {
        outcode1 |= BOTTOM as libc::c_int;
    }
    if (*fl).a.x < 0 as libc::c_int {
        outcode1 |= LEFT as libc::c_int;
    } else if (*fl).a.x >= f_w {
        outcode1 |= RIGHT as libc::c_int;
    }
    outcode2 = 0 as libc::c_int;
    if (*fl).b.y < 0 as libc::c_int {
        outcode2 |= TOP as libc::c_int;
    } else if (*fl).b.y >= f_h {
        outcode2 |= BOTTOM as libc::c_int;
    }
    if (*fl).b.x < 0 as libc::c_int {
        outcode2 |= LEFT as libc::c_int;
    } else if (*fl).b.x >= f_w {
        outcode2 |= RIGHT as libc::c_int;
    }
    ...
    while outcode1 | outcode2 != 0 {
        ...
        if outside & TOP as libc::c_int != 0 {
            dy = (*fl).a.y - (*fl).b.y;
            dx = (*fl).b.x - (*fl).a.x;
            tmp.x = (*fl).a.x + dx * (*fl).a.y / dy;
            tmp.y = 0 as libc::c_int;
        } else if outside & BOTTOM as libc::c_int != 0 {
            dy = (*fl).a.y - (*fl).b.y;
            dx = (*fl).b.x - (*fl).a.x;
            tmp.x = (*fl).a.x + dx * ((*fl).a.y - f_h) / dy;
            tmp.y = f_h - 1 as libc::c_int;
        } else if outside & RIGHT as libc::c_int != 0 {
            dy = (*fl).b.y - (*fl).a.y;
            dx = (*fl).b.x - (*fl).a.x;
            tmp.y = (*fl).a.y + dy * (f_w - 1 as libc::c_int - (*fl).a.x) / dx;
            tmp.x = f_w - 1 as libc::c_int;
        } else if outside & LEFT as libc::c_int != 0 {
            dy = (*fl).b.y - (*fl).a.y;
            dx = (*fl).b.x - (*fl).a.x;
            tmp.y = (*fl).a.y + dy * -(*fl).a.x / dx;
            tmp.x = 0 as libc::c_int;
        }
        if outside == outcode1 {
            (*fl).a = tmp;
            outcode1 = 0 as libc::c_int;
...
unsafe extern "C" fn AM_drawPixel(mut xx: int32_t, mut yy: int32_t, mut cc: int32_t) {
    let mut dest: *mut uint8_t = screens[0 as libc::c_int as usize];
    if xx < 0 as libc::c_int || yy < 0 as libc::c_int || xx >= vid.width
        || yy >= vid.height
    {
        return;
    }
    *dest.offset((yy * vid.width + xx) as isize) = cc as uint8_t;
}
unsafe extern "C" fn AM_drawFline_soft(mut fl: *const fline_t, mut color: int32_t) {
    let mut x: int32_t = 0;
    let mut y: int32_t = 0;
    let mut dx: int32_t = 0;
    let mut dy: int32_t = 0;
    ...
    let mut ax: int32_t = 0;
    let mut ay: int32_t = 0;
    let mut d: int32_t = 0;
    dx = (*fl).b.x - (*fl).a.x;
    ax = 2 as libc::c_int * (if dx < 0 as libc::c_int { -dx } else { dx });
    sx = if dx < 0 as libc::c_int { -(1 as libc::c_int) } else { 1 as libc::c_int };
    dy = (*fl).b.y - (*fl).a.y;
    ay = 2 as libc::c_int * (if dy < 0 as libc::c_int { -dy } else { dy });
    sy = if dy < 0 as libc::c_int { -(1 as libc::c_int) } else { 1 as libc::c_int };
    x = (*fl).a.x;
    y = (*fl).a.y;
    if ax > ay {
        d = ay - ax / 2 as libc::c_int;
        loop {
...
unsafe extern "C" fn AM_drawMline(mut ml: *const mline_t, mut color: int32_t) {
    static mut fl: fline_t = fline_t {
        a: fpoint_t { x: 0, y: 0 },
        b: fpoint_t { x: 0, y: 0 },
    };
    if AM_clipMline(ml, &mut fl) != 0 {
        AM_drawFline.expect("non-null function pointer")(&mut fl, color);
    }
}
unsafe extern "C" fn AM_drawGrid(mut color: int32_t) {
    let mut x: fixed_t = 0;
    let mut y: fixed_t = 0;
    ...
    let mut gridsize: fixed_t = (128 as libc::c_int)
        << 16 as libc::c_int - 4 as libc::c_int;
    start = m_x;
    if (start - (bmaporgx >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int)))
        % gridsize != 0
    {
        start
            += gridsize
    ...
    start = m_y;
    if (start - (bmaporgy >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int)))
        % gridsize != 0
    {
        start
            += gridsize
...
#[inline]
unsafe extern "C" fn AM_drawWalls() {
    let mut i: size_t = 0;
    ...
    let mut backf1: fixed_t = 0 as libc::c_int;
    let mut backf2: fixed_t = 0 as libc::c_int;
    let mut backc1: fixed_t = 0 as libc::c_int;
    let mut backc2: fixed_t = 0 as libc::c_int;
    i = 0 as libc::c_int as size_t;
    while i < numlines {
        l
            .a
            .x = (*(*lines.offset(i as isize)).v1).x
            >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l
            .a
            .y = (*(*lines.offset(i as isize)).v1).y
            >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l
            .b
            .x = (*(*lines.offset(i as isize)).v2).x
            >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l
            .b
            .y = (*(*lines.offset(i as isize)).v2).y
            >> 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        frontf1 = P_GetZAt(
            (*(*lines.offset(i as isize)).frontsector).f_slope,
        ...
        frontc1 = P_GetZAt(
            (*(*lines.offset(i as isize)).frontsector).c_slope,
            (*(*lines.offset(i as isize)).v1).x,
            (*(*lines.offset(i as isize)).v1).y,
        ...
        if !((*lines.offset(i as isize)).backsector).is_null() {
            backf1 = P_GetZAt(
                (*(*lines.offset(i as isize)).backsector).f_slope,
                (*(*lines.offset(i as isize)).v1).x,
                (*(*lines.offset(i as isize)).v1).y,
                (*(*lines.offset(i as isize)).backsector).floorheight,
            );
            backf2 = P_GetZAt(
                (*(*lines.offset(i as isize)).backsector).f_slope,
                (*(*lines.offset(i as isize)).v2).x,
            ...
            backc1 = P_GetZAt(
                (*(*lines.offset(i as isize)).backsector).c_slope,
                (*(*lines.offset(i as isize)).v1).x,
                (*(*lines.offset(i as isize)).v1).y,
                (*(*lines.offset(i as isize)).backsector).ceilingheight,
            );
            backc2 = P_GetZAt(
                (*(*lines.offset(i as isize)).backsector).c_slope,
                (*(*lines.offset(i as isize)).v2).x,
        ...
        if ((*lines.offset(i as isize)).backsector).is_null() {
            if (*lines.offset(i as isize)).flags as libc::c_int & 64 as libc::c_int != 0
            {
                AM_drawMline(
                    &mut l,
                    NOCLIMBREDS as libc::c_int
                        + NOCLIMBREDRANGE as libc::c_int / 2 as libc::c_int,
                );
            } else {
                AM_drawMline(
                    &mut l,
                    REDS as libc::c_int + REDRANGE as libc::c_int / 2 as libc::c_int,
                );
            }
        } else if backf1 == backc1 && backf2 == backc2
            || frontf1 == frontc1 && frontf2 == frontc2
        {
            if backf1 == backc1 && backf2 == backc2 && frontf1 == frontc1
                && frontf2 == frontc2
            {
                if (*lines.offset(i as isize)).flags as libc::c_int & 64 as libc::c_int
                    != 0
                {
                    AM_drawMline(&mut l, NOCLIMBGRAYS as int32_t);
                } else {
                    AM_drawMline(&mut l, GRAYS as int32_t);
                }
            } else if (*lines.offset(i as isize)).flags as libc::c_int
                & 64 as libc::c_int != 0
            {
                AM_drawMline(&mut l, NOCLIMBREDS as int32_t);
            } else {
                AM_drawMline(&mut l, REDS as int32_t);
            }
        } else if (*lines.offset(i as isize)).flags as libc::c_int & 64 as libc::c_int
            != 0
        {
            if backf1 != frontf1 || backf2 != frontf2 {
                AM_drawMline(&mut l, NOCLIMBBROWNS as int32_t);
            } else if backc1 != frontc1 || backc2 != frontc2 {
                AM_drawMline(&mut l, NOCLIMBYELLOWS as int32_t);
            } else {
                AM_drawMline(&mut l, NOCLIMBGRAYS as int32_t);
            }
        } else if backf1 != frontf1 || backf2 != frontf2 {
            AM_drawMline(&mut l, BROWNS as int32_t);
        } else if backc1 != frontc1 || backc2 != frontc2 {
            AM_drawMline(&mut l, YELLOWS as int32_t);
        } else {
            AM_drawMline(&mut l, GRAYS as int32_t);
        }
        i = i.wrapping_add(1);
...
unsafe extern "C" fn AM_rotate(
    ...
    tmpx = FixedMul(
        *x,
        *finecosine.offset((a >> 19 as libc::c_int) as isize)
            >> 16 as libc::c_int - 16 as libc::c_int,
    )
        - FixedMul(
            *y,
            finesine[(a >> 19 as libc::c_int) as usize]
                >> 16 as libc::c_int - 16 as libc::c_int,
        );
    *y = FixedMul(
        *x,
...
unsafe extern "C" fn AM_drawLineCharacter(
    mut lineguy: *const mline_t,
    mut lineguylines: size_t,
    mut scale: fixed_t,
    mut angle: angle_t,
    mut color: int32_t,
    mut x: fixed_t,
    ...
    while i < lineguylines {
        ...
        l.b.x += x;
        l.b.y += y;
        l.a.x >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l.a.y >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l.b.x >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
        l.b.y >>= 16 as libc::c_int - (16 as libc::c_int - 4 as libc::c_int);
...
#[inline]
unsafe extern "C" fn AM_drawPlayers() {
    let mut i: int32_t = 0;
    let mut p: *mut player_t = 0 as *mut player_t;
    let mut color: int32_t = GREENS as int32_t;
    if multiplayer == 0 {
        AM_drawLineCharacter(
            player_arrow.as_ptr(),
            (::core::mem::size_of::<[mline_t; 7]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<mline_t>() as libc::c_ulong),
            (16 as libc::c_int) << 16 as libc::c_int,
            (*(*plr).mo).angle,
            DWHITE as int32_t,
            (*(*plr).mo).x,
    ...
    while i < 32 as libc::c_int {
        if !(playeringame[i as usize] == 0 || players[i as usize].spectator != 0) {
            p = &mut *players.as_mut_ptr().offset(i as isize) as *mut player_t;
            if (*p).skincolor as libc::c_int > 0 as libc::c_int {
                color = *(R_GetTranslationColormap(
                    TC_DEFAULT as libc::c_int,
                    (*p).skincolor as skincolornum_t,
                    1 as libc::c_int as uint8_t,
                ))
                    .offset((GREENS as libc::c_int + 8 as libc::c_int) as isize)
                    as int32_t;
            }
            AM_drawLineCharacter(
                player_arrow.as_ptr(),
...
#[inline]
unsafe extern "C" fn AM_drawThings(mut colors: uint8_t) {
    let mut i: size_t = 0;
    let mut t: *mut mobj_t = 0 as *mut mobj_t;
    i = 0 as libc::c_int as size_t;
    while i < numsectors {
        ...
        while !t.is_null() {
            AM_drawLineCharacter(
                ...
                (::core::mem::size_of::<[mline_t; 3]>() as libc::c_ulong)
                    .wrapping_div(::core::mem::size_of::<mline_t>() as libc::c_ulong),
                (16 as libc::c_int) << 16 as libc::c_int,
                (*t).angle,
                colors as int32_t,
...
#[inline]
unsafe extern "C" fn AM_drawCrosshair(mut color: uint8_t) {
    let scale: fixed_t = (4 as libc::c_int) << 16 as libc::c_int;
    let mut i: size_t = 0;
    ...
    i = 0 as libc::c_int as size_t;
    while i
        < (::core::mem::size_of::<[mline_t; 2]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<mline_t>() as libc::c_ulong)
    {
        fl.a.x = FixedMul(cross_mark[i as usize].a.x, scale) >> 16 as libc::c_int;
        fl.a.y = FixedMul(cross_mark[i as usize].a.y, scale) >> 16 as libc::c_int;
        fl.b.x = FixedMul(cross_mark[i as usize].b.x, scale) >> 16 as libc::c_int;
        fl.b.y = FixedMul(cross_mark[i as usize].b.y, scale) >> 16 as libc::c_int;
        fl.a.x += f_x + f_w / 2 as libc::c_int;
        fl.a.y += f_y + f_h / 2 as libc::c_int;
        fl.b.x += f_x + f_w / 2 as libc::c_int;
        fl.b.y += f_y + f_h / 2 as libc::c_int;
        AM_drawFline.expect("non-null function pointer")(&mut fl, color as int32_t);
        i = i.wrapping_add(1);
        i;
    }
}
...
pub unsafe extern "C" fn AM_Drawer() {
    ...
    AM_drawFline = Some(
        AM_drawFline_soft as unsafe extern "C" fn(*const fline_t, int32_t) -> (),
    );
    AM_clearFB(DBLACK as int32_t);
    if draw_grid != 0 {
        AM_drawGrid(GRAYS as libc::c_int + GRAYSRANGE as libc::c_int / 2 as libc::c_int);
    }
    AM_drawWalls();
    AM_drawPlayers();
    AM_drawThings(GREENS);
    if followplayer == 0 {
        AM_drawCrosshair(DWHITE);
    }
}
