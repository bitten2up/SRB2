...
extern "C" {
    ...
    static mut Gametype_ConstantNames: [*const libc::c_char; 136];
    ...
    fn LUA_PushGlobals(L: *mut lua_State, word: *const libc::c_char) -> libc::c_int;
    fn LUA_PushUserdata(
        L: *mut lua_State,
    ...
    static INT_CONST: [int_const_s; 0];
    ...
    static POWERS_LIST: [*const libc::c_char; 0];
    ...
    static TO_LIST: [*const libc::c_char; 0];
    static SD_LIST: [*const libc::c_char; 0];
    static SSF_LIST: [*const libc::c_char; 0];
    static MSF_LIST: [*const libc::c_char; 0];
    static ML_LIST: [*const libc::c_char; 0];
    static GAMETYPERULE_LIST: [*const libc::c_char; 0];
    static PLAYERFLAG_LIST: [*const libc::c_char; 0];
    static MAPTHINGFLAG_LIST: [*const libc::c_char; 0];
    static MOBJEFLAG_LIST: [*const libc::c_char; 0];
    static MOBJFLAG2_LIST: [*const libc::c_char; 0];
    static MOBJFLAG_LIST: [*const libc::c_char; 0];
...
pub const MFE_REVERSESUPER: C2RustUnnamed_0 = 12288;
pub const MFE_FORCENOSUPER: C2RustUnnamed_0 = 8192;
pub const MFE_FORCESUPER: C2RustUnnamed_0 = 4096;
pub const MFE_TRACERANGLE: C2RustUnnamed_0 = 2048;
pub const MFE_APPLYPMOMZ: C2RustUnnamed_0 = 1024;
pub const MFE_SPRUNG: C2RustUnnamed_0 = 512;
pub const MFE_PUSHED: C2RustUnnamed_0 = 256;
pub const MFE_TOUCHLAVA: C2RustUnnamed_0 = 128;
pub const MFE_GOOWATER: C2RustUnnamed_0 = 64;
pub const MFE_VERTICALFLIP: C2RustUnnamed_0 = 32;
pub const MFE_JUSTSTEPPEDDOWN: C2RustUnnamed_0 = 16;
pub const MFE_UNDERWATER: C2RustUnnamed_0 = 8;
pub const MFE_TOUCHWATER: C2RustUnnamed_0 = 4;
pub const MFE_JUSTHITFLOOR: C2RustUnnamed_0 = 2;
pub const MFE_ONGROUND: C2RustUnnamed_0 = 1;
...
pub const NUMPOWERS: C2RustUnnamed_2 = 30;
pub const pw_strong: C2RustUnnamed_2 = 29;
pub const pw_ignorelatch: C2RustUnnamed_2 = 28;
pub const pw_justlaunched: C2RustUnnamed_2 = 27;
pub const pw_dye: C2RustUnnamed_2 = 26;
pub const pw_nocontrol: C2RustUnnamed_2 = 25;
pub const pw_nights_linkfreeze: C2RustUnnamed_2 = 24;
pub const pw_nights_helper: C2RustUnnamed_2 = 23;
pub const pw_nights_superloop: C2RustUnnamed_2 = 22;
pub const pw_emeralds: C2RustUnnamed_2 = 21;
pub const pw_railring: C2RustUnnamed_2 = 20;
pub const pw_explosionring: C2RustUnnamed_2 = 19;
pub const pw_grenadering: C2RustUnnamed_2 = 18;
pub const pw_scatterring: C2RustUnnamed_2 = 17;
pub const pw_bouncering: C2RustUnnamed_2 = 16;
pub const pw_automaticring: C2RustUnnamed_2 = 15;
pub const pw_infinityring: C2RustUnnamed_2 = 14;
pub const pw_gravityboots: C2RustUnnamed_2 = 13;
pub const pw_super: C2RustUnnamed_2 = 12;
pub const pw_noautobrake: C2RustUnnamed_2 = 11;
pub const pw_justsprung: C2RustUnnamed_2 = 10;
pub const pw_pushing: C2RustUnnamed_2 = 9;
pub const pw_extralife: C2RustUnnamed_2 = 8;
pub const pw_spacetime: C2RustUnnamed_2 = 7;
pub const pw_underwater: C2RustUnnamed_2 = 6;
pub const pw_tailsfly: C2RustUnnamed_2 = 5;
pub const pw_carry: C2RustUnnamed_2 = 4;
pub const pw_shield: C2RustUnnamed_2 = 3;
pub const pw_flashing: C2RustUnnamed_2 = 2;
pub const pw_sneakers: C2RustUnnamed_2 = 1;
...
pub const NUMMENUTYPES: C2RustUnnamed_4 = 58;
pub const MN_SPECIAL: C2RustUnnamed_4 = 57;
pub const MN_AD_MAIN: C2RustUnnamed_4 = 56;
pub const MN_SR_SOUNDTEST: C2RustUnnamed_4 = 55;
pub const MN_SR_PLAYER: C2RustUnnamed_4 = 54;
pub const MN_SR_EMBLEMHINT: C2RustUnnamed_4 = 53;
pub const MN_SR_UNLOCKCHECKLIST: C2RustUnnamed_4 = 52;
pub const MN_SR_LEVELSELECT: C2RustUnnamed_4 = 51;
pub const MN_SR_PANDORA: C2RustUnnamed_4 = 50;
pub const MN_SR_MAIN: C2RustUnnamed_4 = 49;
pub const MN_OP_ERASEDATA: C2RustUnnamed_4 = 48;
pub const MN_OP_SCREENSHOTS: C2RustUnnamed_4 = 47;
pub const MN_OP_ADDONS: C2RustUnnamed_4 = 46;
pub const MN_OP_DATA: C2RustUnnamed_4 = 45;
pub const MN_OP_MONITORTOGGLE: C2RustUnnamed_4 = 44;
pub const MN_OP_SERVER: C2RustUnnamed_4 = 43;
pub const MN_OP_SOUND: C2RustUnnamed_4 = 42;
pub const MN_OP_OPENGL_LIGHTING: C2RustUnnamed_4 = 41;
pub const MN_OP_OPENGL: C2RustUnnamed_4 = 40;
pub const MN_OP_COLOR: C2RustUnnamed_4 = 39;
pub const MN_OP_VIDEOMODE: C2RustUnnamed_4 = 38;
pub const MN_OP_VIDEO: C2RustUnnamed_4 = 37;
pub const MN_OP_PLAYSTYLE: C2RustUnnamed_4 = 36;
pub const MN_OP_P2CAMERA: C2RustUnnamed_4 = 35;
pub const MN_OP_P2JOYSTICK: C2RustUnnamed_4 = 34;
pub const MN_OP_P2MOUSE: C2RustUnnamed_4 = 33;
pub const MN_OP_P2CONTROLS: C2RustUnnamed_4 = 32;
pub const MN_OP_P1CAMERA: C2RustUnnamed_4 = 31;
pub const MN_OP_JOYSTICKSET: C2RustUnnamed_4 = 30;
pub const MN_OP_P1JOYSTICK: C2RustUnnamed_4 = 29;
pub const MN_OP_P1MOUSE: C2RustUnnamed_4 = 28;
pub const MN_OP_CHANGECONTROLS: C2RustUnnamed_4 = 27;
pub const MN_OP_P1CONTROLS: C2RustUnnamed_4 = 26;
pub const MN_OP_MAIN: C2RustUnnamed_4 = 25;
pub const MN_MP_SERVER_OPTIONS: C2RustUnnamed_4 = 24;
pub const MN_MP_PLAYERSETUP: C2RustUnnamed_4 = 23;
pub const MN_MP_ROOM: C2RustUnnamed_4 = 22;
pub const MN_MP_CONNECT: C2RustUnnamed_4 = 21;
pub const MN_MP_SERVER: C2RustUnnamed_4 = 20;
pub const MN_MP_SPLITSCREEN: C2RustUnnamed_4 = 19;
pub const MN_MP_MAIN: C2RustUnnamed_4 = 18;
pub const MN_SP_MARATHON: C2RustUnnamed_4 = 17;
pub const MN_SP_NIGHTS_GHOST: C2RustUnnamed_4 = 16;
pub const MN_SP_NIGHTS_REPLAY: C2RustUnnamed_4 = 15;
pub const MN_SP_NIGHTS_GUESTREPLAY: C2RustUnnamed_4 = 14;
pub const MN_SP_NIGHTS_LEVELSELECT: C2RustUnnamed_4 = 13;
pub const MN_SP_NIGHTSATTACK: C2RustUnnamed_4 = 12;
pub const MN_SP_GHOST: C2RustUnnamed_4 = 11;
pub const MN_SP_REPLAY: C2RustUnnamed_4 = 10;
pub const MN_SP_GUESTREPLAY: C2RustUnnamed_4 = 9;
pub const MN_SP_TIMEATTACK_LEVELSELECT: C2RustUnnamed_4 = 8;
pub const MN_SP_TIMEATTACK: C2RustUnnamed_4 = 7;
pub const MN_SP_LEVELSTATS: C2RustUnnamed_4 = 6;
pub const MN_SP_LEVELSELECT: C2RustUnnamed_4 = 5;
pub const MN_SP_PLAYER: C2RustUnnamed_4 = 4;
pub const MN_SP_LOAD: C2RustUnnamed_4 = 3;
pub const MN_SP_MAIN: C2RustUnnamed_4 = 2;
pub const MN_MAIN: C2RustUnnamed_4 = 1;
pub const MN_NONE: C2RustUnnamed_4 = 0;
...
#[inline]
unsafe extern "C" fn lib_freeslot(mut L: *mut lua_State) -> libc::c_int {
    ...
    loop {
        ...
        s = Z_StrDup(luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t));
        ...
        if !word.is_null() {
            ...
            return luaL_error(
                L,
                b"Missing enum name in '%s'\n\0" as *const u8 as *const libc::c_char,
                luaL_checklstring(L, 1 as libc::c_int, 0 as *mut size_t),
            );
        }
        if fastcmp(type_0, b"SFX\0" as *const u8 as *const libc::c_char) != 0 {
            let mut sfx: sfxenum_t = sfx_None;
            strlwr(word);
            CONS_Printf(
                b"Sound sfx_%s allocated.\n\0" as *const u8 as *const libc::c_char,
                word,
            );
            sfx = S_AddSoundFx(
                word,
            ...
            if sfx as libc::c_uint != sfx_None as libc::c_int as libc::c_uint {
                lua_pushnumber(L, sfx as lua_Number);
                r += 1;
                r;
            } else {
                CONS_Alert(
                    CONS_WARNING,
                    b"Ran out of free SFX slots!\n\0" as *const u8 as *const libc::c_char,
                );
            }
        } else if fastcmp(type_0, b"SPR\0" as *const u8 as *const libc::c_char) != 0 {
            let mut wad: libc::c_char = 0;
            let mut j: spritenum_t = SPR_NULL;
            lua_getfield(
                L,
                -(10000 as libc::c_int),
                b"WAD\0" as *const u8 as *const libc::c_char,
            );
            wad = lua_tonumber(L, -(1 as libc::c_int)) as libc::c_char;
            lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            j = SPR_FIRSTFREESLOT;
            while j as libc::c_uint <= SPR_LASTFREESLOT as libc::c_int as libc::c_uint {
                if used_spr[(j as libc::c_uint)
                    .wrapping_sub(SPR_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                    .wrapping_div(8 as libc::c_int as libc::c_uint) as usize]
                    as libc::c_int
                    & (1 as libc::c_int)
                        << (j as libc::c_uint)
                            .wrapping_rem(8 as libc::c_int as libc::c_uint) != 0
                {
                    if sprnames[j as usize][4 as libc::c_int as usize] == 0
                        && memcmp(
                            (sprnames[j as usize]).as_mut_ptr() as *const libc::c_void,
                            word as *const libc::c_void,
                            4 as libc::c_int as libc::c_ulong,
                        ) == 0 as libc::c_int
                    {
                        sprnames[j as usize][4 as libc::c_int as usize] = wad;
                    }
                    j += 1;
                    j;
                } else {
                    CONS_Printf(
                        b"Sprite SPR_%s allocated.\n\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                    strncpy(
                        (sprnames[j as usize]).as_mut_ptr(),
                        word,
                        4 as libc::c_int as libc::c_ulong,
                    );
                    used_spr[(j as libc::c_uint)
                        .wrapping_sub(SPR_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                        .wrapping_div(8 as libc::c_int as libc::c_uint)
                        as usize] = (used_spr[(j as libc::c_uint)
                        .wrapping_sub(SPR_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                        .wrapping_div(8 as libc::c_int as libc::c_uint) as usize]
                        as libc::c_int
                        | (1 as libc::c_int)
                            << (j as libc::c_uint)
                                .wrapping_rem(8 as libc::c_int as libc::c_uint)) as uint8_t;
                    LUA_UpdateSprName(word, j as lua_Number);
                    lua_pushnumber(L, j as lua_Number);
                    r += 1;
                    r;
                    break;
                }
            }
            if j as libc::c_uint > SPR_LASTFREESLOT as libc::c_int as libc::c_uint {
                CONS_Alert(
                    CONS_WARNING,
                    b"Ran out of free sprite slots!\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
        } else if fastcmp(type_0, b"S\0" as *const u8 as *const libc::c_char) != 0 {
            let mut i: statenum_t = S_NULL;
            i = S_NULL;
            while (i as libc::c_uint)
                < (512 as libc::c_int * 8 as libc::c_int) as libc::c_uint
            {
                if (FREE_STATES[i as usize]).is_null() {
                    CONS_Printf(
                        b"State S_%s allocated.\n\0" as *const u8 as *const libc::c_char,
                        word,
                    );
                    FREE_STATES[i
                        as usize] = Z_MallocAlign(
                        (strlen(word)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ...
                    lua_pushnumber(
                        L,
                        (S_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                            .wrapping_add(i as libc::c_uint) as lua_Number,
                    );
                    r += 1;
                    r;
                    break;
                ...
                == (512 as libc::c_int * 8 as libc::c_int) as libc::c_uint
            {
                CONS_Alert(
                    CONS_WARNING,
                    b"Ran out of free State slots!\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
        } else if fastcmp(type_0, b"MT\0" as *const u8 as *const libc::c_char) != 0 {
            let mut i_0: mobjtype_t = MT_NULL;
            i_0 = MT_NULL;
            while (i_0 as libc::c_uint) < 512 as libc::c_int as libc::c_uint {
                if (FREE_MOBJS[i_0 as usize]).is_null() {
                    CONS_Printf(
                        b"MobjType MT_%s allocated.\n\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                    FREE_MOBJS[i_0
                    ...
                    strcpy(FREE_MOBJS[i_0 as usize], word);
                    lua_pushnumber(
                        L,
                        (MT_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                            .wrapping_add(i_0 as libc::c_uint) as lua_Number,
                    );
                    r += 1;
                    r;
                    break;
            ...
            if i_0 as libc::c_uint == 512 as libc::c_int as libc::c_uint {
                CONS_Alert(
                    CONS_WARNING,
                    b"Ran out of free MobjType slots!\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
        } else if fastcmp(type_0, b"SKINCOLOR\0" as *const u8 as *const libc::c_char)
            != 0
        {
            let mut i_1: skincolornum_t = SKINCOLOR_NONE;
            i_1 = SKINCOLOR_NONE;
            while (i_1 as libc::c_uint) < 1024 as libc::c_int as libc::c_uint {
                if (FREE_SKINCOLORS[i_1 as usize]).is_null() {
                    CONS_Printf(
                        b"Skincolor SKINCOLOR_%s allocated.\n\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                    FREE_SKINCOLORS[i_1
                    ...
                    strcpy(FREE_SKINCOLORS[i_1 as usize], word);
                    let fresh1 = numskincolors;
                    numskincolors = numskincolors.wrapping_add(1);
                    M_AddMenuColor(fresh1);
                    lua_pushnumber(
                        L,
                        (SKINCOLOR_FIRSTFREESLOT as libc::c_int as libc::c_uint)
                            .wrapping_add(i_1 as libc::c_uint) as lua_Number,
                    );
                    r += 1;
                    r;
                    break;
            ...
            if i_1 as libc::c_uint == 1024 as libc::c_int as libc::c_uint {
                CONS_Alert(
                    CONS_WARNING,
                    b"Ran out of free skincolor slots!\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
        } else if fastcmp(type_0, b"SPR2\0" as *const u8 as *const libc::c_char) != 0 {
            let mut i_2: playersprite_t = SPR2_STND;
            i_2 = SPR2_FIRSTFREESLOT;
            while (i_2 as libc::c_uint) < free_spr2 as libc::c_uint {
                if memcmp(
                    (spr2names[i_2 as usize]).as_mut_ptr() as *const libc::c_void,
                    word as *const libc::c_void,
                    4 as libc::c_int as libc::c_ulong,
                ) == 0 as libc::c_int
                {
            ...
            if i_2 as libc::c_uint >= free_spr2 as libc::c_uint {
                if (free_spr2 as libc::c_uint)
                    < NUMPLAYERSPRITES as libc::c_int as libc::c_uint
                {
                    CONS_Printf(
                        b"Sprite SPR2_%s allocated.\n\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                    strncpy(
        ...
        } else if fastcmp(type_0, b"TOL\0" as *const u8 as *const libc::c_char) != 0 {
            let mut i_3: libc::c_int = 0;
            i_3 = 0 as libc::c_int;
            while !(TYPEOFLEVEL[i_3 as usize].name).is_null() {
                if fastcmp(word, TYPEOFLEVEL[i_3 as usize].name) != 0 {
                    break;
                }
                i_3 += 1;
                i_3;
            }
            if (TYPEOFLEVEL[i_3 as usize].name).is_null() {
                if lastcustomtol == ((1 as libc::c_int) << 31 as libc::c_int) as uint32_t
                {
                    CONS_Alert(
                        CONS_WARNING,
                    ...
                    CONS_Printf(
                        b"TypeOfLevel TOL_%s allocated.\n\0" as *const u8
                            as *const libc::c_char,
                        word,
                    );
                    G_AddTOL(lastcustomtol, word);
                    lua_pushnumber(L, lastcustomtol as lua_Number);
...
unsafe extern "C" fn action_call(mut L: *mut lua_State) -> libc::c_int {
    ...
    var1 = luaL_optnumber(L, 3 as libc::c_int, 0 as libc::c_int);
    var2 = luaL_optnumber(L, 4 as libc::c_int, 0 as libc::c_int);
    if actor.is_null() {
        return luaL_error(
            L,
    ...
    ((*action).acp1).expect("non-null function pointer")(actor as *mut libc::c_void);
    return 0 as libc::c_int;
}
#[no_mangle]
pub static mut luaactions: [*const libc::c_char; 30] = [0 as *const libc::c_char; 30];
#[no_mangle]
pub static mut luaactionstack: uint8_t = 0 as libc::c_int as uint8_t;
unsafe extern "C" fn lib_dummysuper(mut L: *mut lua_State) -> libc::c_int {
    return luaL_error(
        L,
        b"Can't call super() outside of hardcode-replacing A_Action functions!\0"
            as *const u8 as *const libc::c_char,
    );
}
unsafe extern "C" fn CacheAndPushConstant(
    mut L: *mut lua_State,
    mut name: *const libc::c_char,
    mut value: lua_Number,
) {
    lua_pushstring(L, name);
    lua_pushnumber(L, value);
    lua_rawset(L, -(10002 as libc::c_int));
    lua_pushnumber(L, value);
}
unsafe extern "C" fn ScanConstants(
    mut L: *mut lua_State,
    mut mathlib: boolean,
    ...
    let mut i: fixed_t = 0;
    if strlen(word) == 1 as libc::c_int as libc::c_ulong {
        if *word as libc::c_int >= 'A' as i32 && *word as libc::c_int <= '~' as i32 {
            CacheAndPushConstant(L, word, *word as libc::c_int - 'A' as i32);
            return 1 as libc::c_int;
        }
        if mathlib != 0 {
            return luaL_error(
                L,
                b"constant '%s' could not be parsed.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"MF_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*MOBJFLAG_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *MOBJFLAG_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
            i;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"mobjflag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"MF2_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*MOBJFLAG2_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *MOBJFLAG2_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"mobjflag2 '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"MFE_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*MOBJEFLAG_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *MOBJEFLAG_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if fastcmp(p, b"REVERSESUPER\0" as *const u8 as *const libc::c_char) != 0 {
            CacheAndPushConstant(L, word, MFE_REVERSESUPER as libc::c_int);
            return 1 as libc::c_int;
        }
        if mathlib != 0 {
            return luaL_error(
                L,
                b"mobjeflag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"MTF_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*MAPTHINGFLAG_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *MAPTHINGFLAG_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"mapthingflag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"PF_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*PLAYERFLAG_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *PLAYERFLAG_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if fastcmp(p, b"FULLSTASIS\0" as *const u8 as *const libc::c_char) != 0 {
            CacheAndPushConstant(L, word, PF_FULLSTASIS as libc::c_int);
            return 1 as libc::c_int;
        } else if fastcmp(p, b"USEDOWN\0" as *const u8 as *const libc::c_char) != 0 {
            CacheAndPushConstant(L, word, PF_SPINDOWN as libc::c_int);
            return 1 as libc::c_int;
        }
        if mathlib != 0 {
            return luaL_error(
                L,
                b"playerflag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"GT_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word;
        i = 0 as libc::c_int;
        while !(Gametype_ConstantNames[i as usize]).is_null() {
            if fastcmp(p, Gametype_ConstantNames[i as usize]) != 0 {
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"gametype '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"GTR_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*GAMETYPERULE_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *GAMETYPERULE_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"game type rule '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"TOL_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        ...
        while !(TYPEOFLEVEL[i as usize].name).is_null() {
            if fastcmp(p, TYPEOFLEVEL[i as usize].name) != 0 {
                CacheAndPushConstant(
                    L,
                    word,
                    TYPEOFLEVEL[i as usize].flag as lua_Number,
                );
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"typeoflevel '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"ML_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*ML_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *ML_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if fastcmp(p, b"EFFECT1\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, 32 as libc::c_int);
            return 1 as libc::c_int;
        }
        if fastcmp(p, b"EFFECT2\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, 128 as libc::c_int);
            return 1 as libc::c_int;
        }
        if fastcmp(p, b"EFFECT3\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, 256 as libc::c_int);
            return 1 as libc::c_int;
        }
        if fastcmp(p, b"EFFECT4\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, 512 as libc::c_int);
            return 1 as libc::c_int;
        }
        if fastcmp(p, b"EFFECT5\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, 1024 as libc::c_int);
            return 1 as libc::c_int;
        }
        if mathlib != 0 {
            return luaL_error(
                L,
                b"linedef flag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"MSF_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*MSF_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *MSF_LIST.as_ptr().offset(i as isize)) != 0 {
                lua_pushnumber(L, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
            i;
        }
        if fastcmp(p, b"FLIPSPECIAL_BOTH\0" as *const u8 as *const libc::c_char) != 0 {
            lua_pushnumber(L, MSF_FLIPSPECIAL_BOTH as libc::c_int);
            return 1 as libc::c_int;
        }
        if mathlib != 0 {
            return luaL_error(
                L,
                b"sector flag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"SSF_\0" as *const u8 as *const libc::c_char,
        word,
        4 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*SSF_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *SSF_LIST.as_ptr().offset(i as isize)) != 0 {
                lua_pushnumber(L, (1 as libc::c_int) << i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"sector special flag '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"SD_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*SD_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *SD_LIST.as_ptr().offset(i as isize)) != 0 {
                lua_pushnumber(L, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"sector damagetype '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        b"TO_\0" as *const u8 as *const libc::c_char,
        word,
        3 as libc::c_int as uint16_t,
    ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while !(*TO_LIST.as_ptr().offset(i as isize)).is_null() {
            if fastcmp(p, *TO_LIST.as_ptr().offset(i as isize)) != 0 {
                lua_pushnumber(L, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"sector triggerer '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
    ...
    {
        p = word.offset(2 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while i < 512 as libc::c_int * 8 as libc::c_int {
            if (FREE_STATES[i as usize]).is_null() {
                break;
            }
            if fastcmp(p, FREE_STATES[i as usize]) != 0 {
                CacheAndPushConstant(L, word, S_FIRSTFREESLOT as libc::c_int + i);
                return 1 as libc::c_int;
            }
            i += 1;
            i;
        ...
        i = 0 as libc::c_int;
        while i < S_FIRSTFREESLOT as libc::c_int {
            if fastcmp(
                p,
                (*STATE_LIST.as_ptr().offset(i as isize))
    ...
    ) != 0
    {
        ...
        while i < 512 as libc::c_int {
            ...
            if fastcmp(p, FREE_MOBJS[i as usize]) != 0 {
                CacheAndPushConstant(L, word, MT_FIRSTFREESLOT as libc::c_int + i);
                return 1 as libc::c_int;
            }
            i += 1;
            i;
        ...
        i = 0 as libc::c_int;
        while i < MT_FIRSTFREESLOT as libc::c_int {
            if fastcmp(
                p,
    ...
    {
        p = word.offset(5 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while i < free_spr2 as fixed_t {
            if spr2names[i as usize][4 as libc::c_int as usize] == 0 {
                if spr2names[i as usize][3 as libc::c_int as usize] as libc::c_int
                    == '_' as i32 && *p.offset(3 as libc::c_int as isize) == 0
                {
                    if fastncmp(
                        p,
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"player sprite '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
        ...
        ) != 0
    {
        ...
        while i < NUMSFX as libc::c_int {
            if !((*S_sfx.as_mut_ptr().offset(i as isize)).name).is_null()
                && fastcmp(p, (*S_sfx.as_mut_ptr().offset(i as isize)).name) != 0
            {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
        ...
        ) != 0
    {
        ...
        while i < NUMSFX as libc::c_int {
            if !((*S_sfx.as_mut_ptr().offset(i as isize)).name).is_null()
                && fasticmp(p, (*S_sfx.as_mut_ptr().offset(i as isize)).name) != 0
            {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
        ...
        ) != 0
    {
        ...
        && fastncmp(
            b"pw_\0" as *const u8 as *const libc::c_char,
            word,
            3 as libc::c_int as uint16_t,
        ) != 0
    {
        p = word.offset(3 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while i < NUMPOWERS as libc::c_int {
            if fasticmp(p, *POWERS_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        ) != 0
    {
        ...
        i = 0 as libc::c_int;
        while i < NUMPOWERS as libc::c_int {
            if fastcmp(p, *POWERS_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
            i += 1;
    ...
    ) != 0
    {
        p = word.offset(4 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while i < NUMHUDITEMS as libc::c_int {
            if fastcmp(p, *HUDITEMS_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"huditem '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
    ...
    {
        p = word.offset(10 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while i < 1024 as libc::c_int {
            if (FREE_SKINCOLORS[i as usize]).is_null() {
                break;
            }
            if fastcmp(p, FREE_SKINCOLORS[i as usize]) != 0 {
                CacheAndPushConstant(
                    L,
                    word,
                    SKINCOLOR_FIRSTFREESLOT as libc::c_int + i,
                );
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        i = 0 as libc::c_int;
        while i < SKINCOLOR_FIRSTFREESLOT as libc::c_int {
            if fastcmp(p, *COLOR_ENUMS.as_mut_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        return luaL_error(
            L,
            b"skincolor '%s' could not be found.\n\0" as *const u8
                as *const libc::c_char,
            word,
        );
    } else if fastncmp(
    ...
    {
        p = word.offset(6 as libc::c_int as isize);
        i = 0 as libc::c_int;
        while *NIGHTSGRADE_LIST.as_ptr().offset(i as isize) != 0 {
            if *p as libc::c_int
                == *NIGHTSGRADE_LIST.as_ptr().offset(i as isize) as libc::c_int
            {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"NiGHTS grade '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
    ...
    ) != 0
    {
        ...
        while i < NUMMENUTYPES as libc::c_int {
            if fastcmp(p, *MENUTYPES_LIST.as_ptr().offset(i as isize)) != 0 {
                CacheAndPushConstant(L, word, i);
                return 1 as libc::c_int;
            }
            i += 1;
        ...
        if mathlib != 0 {
            return luaL_error(
                L,
                b"menutype '%s' could not be found.\n\0" as *const u8
                    as *const libc::c_char,
                word,
            );
        }
    ...
    if fastcmp(word, b"BT_USE\0" as *const u8 as *const libc::c_char) != 0 {
        CacheAndPushConstant(L, word, BT_SPIN as libc::c_int);
        return 1 as libc::c_int;
    }
    i = 0 as libc::c_int;
    while !((*INT_CONST.as_ptr().offset(i as isize)).n).is_null() {
        if fastcmp(word, (*INT_CONST.as_ptr().offset(i as isize)).n) != 0 {
            CacheAndPushConstant(L, word, (*INT_CONST.as_ptr().offset(i as isize)).v);
            return 1 as libc::c_int;
        }
        i += 1;
        i;
...
#[inline]
unsafe extern "C" fn lib_getenum(mut L: *mut lua_State) -> libc::c_int {
    let mut word: *const libc::c_char = 0 as *const libc::c_char;
    let mut i: fixed_t = 0;
    let mut mathlib: boolean = lua_toboolean(
        L,
    ...
    word = lua_tolstring(L, 2 as libc::c_int, 0 as *mut size_t);
    if mathlib == 0
        && fastncmp(
    ...
    {
        let mut caps: *mut libc::c_char = 0 as *mut libc::c_char;
        i = 0 as libc::c_int;
        while !((*actionpointers.as_mut_ptr().offset(i as isize)).name).is_null() {
            if fasticmp(word, (*actionpointers.as_mut_ptr().offset(i as isize)).name)
                != 0
            {
                LUA_PushUserdata(
                    L,
                    &mut (*actionpointers.as_mut_ptr().offset(i as isize)).action
                        as *mut actionf_t as *mut libc::c_void,
                    b"ACTIONF_T*\0" as *const u8 as *const libc::c_char,
                );
                return 1 as libc::c_int;
            }
        ...
        caps = Z_StrDup(word);
        strupr(caps);
        lua_getfield(L, -(1 as libc::c_int), caps);
        Z_Free(caps as *mut libc::c_void);
        ...
        && fastcmp(b"super\0" as *const u8 as *const libc::c_char, word) != 0
    {
        if luaactionstack == 0 {
            lua_pushcclosure(
                L,
                Some(
                    lib_dummysuper as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
                0 as libc::c_int,
            );
            return 1 as libc::c_int;
        ...
        while !((*actionpointers.as_mut_ptr().offset(i as isize)).name).is_null() {
            if fasticmp(
                ...
                (*actionpointers.as_mut_ptr().offset(i as isize)).name,
            ) != 0
            {
                LUA_PushUserdata(
                    L,
        ...
        lua_pushcclosure(
            L,
            Some(lib_dummysuper as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
            0 as libc::c_int,
        );
        return 1 as libc::c_int;
    } else if mathlib == 0 && LUA_PushGlobals(L, word) != 0
        || ScanConstants(L, mathlib, word) != 0
    {
        return 1 as libc::c_int
    }
    if mathlib != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn LUA_UpdateSprName(
    mut name: *const libc::c_char,
    mut value: lua_Number,
) {
    let mut fullname: [libc::c_char; 9] = *::core::mem::transmute::<
        &[u8; 9],
        &mut [libc::c_char; 9],
    >(b"SPR_XXXX\0");
    if gL.is_null() {
    ...
    strncpy(
        &mut *fullname.as_mut_ptr().offset(4 as libc::c_int as isize),
        name,
        4 as libc::c_int as libc::c_ulong,
    );
    lua_pushstring(gL, fullname.as_mut_ptr());
    lua_rawget(gL, -(10002 as libc::c_int));
    if !(lua_type(gL, -(1 as libc::c_int)) == 0 as libc::c_int) {
        lua_pushstring(gL, name);
        lua_pushnumber(gL, value);
        lua_rawset(gL, -(10002 as libc::c_int));
    }
    lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn LUA_EnumLib(mut L: *mut lua_State) -> libc::c_int {
    if lua_gettop(L) == 0 as libc::c_int {
    ...
    lua_pushcclosure(
        L,
        Some(lib_getenum as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        1 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_setmetatable(L, -(10002 as libc::c_int));
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_getActionName(mut L: *mut lua_State) -> libc::c_int {
    if lua_isuserdata(L, 1 as libc::c_int) != 0 {
        let mut action: *mut actionf_t = *(luaL_checkudata(
            L,
            1 as libc::c_int,
            b"ACTIONF_T*\0" as *const u8 as *const libc::c_char,
        ...
        name = LUA_GetActionName(action as *mut libc::c_void);
        if name.is_null() {
            return luaL_error(
                L,
                b"no name string could be found for this action\0" as *const u8
                    as *const libc::c_char,
            );
        }
        lua_pushstring(L, name);
        return 1 as libc::c_int;
    } else if lua_type(L, 1 as libc::c_int) == 6 as libc::c_int {
        ...
        while lua_next(L, -(2 as libc::c_int)) != 0 {
            if lua_rawequal(L, -(1 as libc::c_int), 1 as libc::c_int) != 0 {
                if lua_type(L, -(2 as libc::c_int)) == 4 as libc::c_int {
    ...
    return luaL_typerror(
        L,
        1 as libc::c_int,
        b"action userdata or Lua function\0" as *const u8 as *const libc::c_char,
    );
}
#[no_mangle]
pub unsafe extern "C" fn LUA_SOCLib(mut L: *mut lua_State) -> libc::c_int {
    lua_pushcclosure(
        L,
        Some(lib_freeslot as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"freeslot\0" as *const u8 as *const libc::c_char,
    );
    lua_pushcclosure(
        L,
        Some(lib_getActionName as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"getActionName\0" as *const u8 as *const libc::c_char,
    );
    luaL_newmetatable(L, b"ACTIONF_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(action_call as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
...
#[no_mangle]
pub unsafe extern "C" fn LUA_GetActionName(
    mut action: *mut libc::c_void,
) -> *const libc::c_char {
    let mut act: *mut actionf_t = action as *mut actionf_t;
    let mut z: size_t = 0;
    z = 0 as libc::c_int as size_t;
    while !((*actionpointers.as_mut_ptr().offset(z as isize)).name).is_null() {
        if (*actionpointers.as_mut_ptr().offset(z as isize)).action.acv == (*act).acv {
            return (*actionpointers.as_mut_ptr().offset(z as isize)).name;
        }
        z = z.wrapping_add(1);
        z;
    }
...
#[no_mangle]
pub unsafe extern "C" fn LUA_SetActionByName(
    mut state: *mut libc::c_void,
    mut actiontocompare: *const libc::c_char,
) {
    let mut st: *mut state_t = state as *mut state_t;
    let mut z: size_t = 0;
    z = 0 as libc::c_int as size_t;
    while !((*actionpointers.as_mut_ptr().offset(z as isize)).name).is_null() {
        if fasticmp(
        ...
        {
            (*st).action = (*actionpointers.as_mut_ptr().offset(z as isize)).action;
            (*st)
                .action
                .acv = (*actionpointers.as_mut_ptr().offset(z as isize)).action.acv;
            (*st)
                .action
                .acp1 = (*actionpointers.as_mut_ptr().offset(z as isize)).action.acp1;
            return;
        }
        z = z.wrapping_add(1);
        z;
...
#[no_mangle]
pub unsafe extern "C" fn LUA_GetActionNumByName(
    mut actiontocompare: *const libc::c_char,
) -> actionnum {
    let mut z: size_t = 0;
    z = 0 as libc::c_int as size_t;
