...
extern "C" {
    ...
    fn R_AddSingleSpriteDef(
        sprname: *const libc::c_char,
        spritedef: *mut spritedef_t,
        wadnum: uint16_t,
        startlump: uint16_t,
        endlump: uint16_t,
    ) -> boolean;
...
pub const CA_TWINSPIN: C2RustUnnamed_3 = 15;
pub const CA_BOUNCE: C2RustUnnamed_3 = 14;
pub const CA_JUMPTHOK: C2RustUnnamed_3 = 13;
pub const CA_AIRDRILL: C2RustUnnamed_3 = 12;
pub const CA_JUMPBOOST: C2RustUnnamed_3 = 11;
pub const CA_FALLSWITCH: C2RustUnnamed_3 = 10;
pub const CA_TELEKINESIS: C2RustUnnamed_3 = 9;
pub const CA_SLOWFALL: C2RustUnnamed_3 = 8;
pub const CA_FLOAT: C2RustUnnamed_3 = 7;
pub const CA_DOUBLEJUMP: C2RustUnnamed_3 = 6;
pub const CA_SWIM: C2RustUnnamed_3 = 5;
pub const CA_HOMINGTHOK: C2RustUnnamed_3 = 4;
pub const CA_GLIDEANDCLIMB: C2RustUnnamed_3 = 3;
pub const CA_FLY: C2RustUnnamed_3 = 2;
pub const CA_THOK: C2RustUnnamed_3 = 1;
pub const CA_NONE: C2RustUnnamed_3 = 0;
pub type C2RustUnnamed_4 = libc::c_uint;
pub const CA2_MELEE: C2RustUnnamed_4 = 3;
pub const CA2_GUNSLINGER: C2RustUnnamed_4 = 2;
pub const CA2_SPINDASH: C2RustUnnamed_4 = 1;
pub const CA2_NONE: C2RustUnnamed_4 = 0;
pub type C2RustUnnamed_5 = libc::c_int;
pub const SH_NOSTACK: C2RustUnnamed_5 = -513;
pub const SH_STACK: C2RustUnnamed_5 = 512;
pub const SH_FIREFLOWER: C2RustUnnamed_5 = 512;
pub const SH_FORCEHP: C2RustUnnamed_5 = 255;
pub const SH_FORCE: C2RustUnnamed_5 = 256;
pub const SH_THUNDERCOIN: C2RustUnnamed_5 = 4098;
pub const SH_BUBBLEWRAP: C2RustUnnamed_5 = 2049;
pub const SH_FLAMEAURA: C2RustUnnamed_5 = 1025;
pub const SH_ELEMENTAL: C2RustUnnamed_5 = 3073;
pub const SH_ATTRACT: C2RustUnnamed_5 = 4097;
pub const SH_PINK: C2RustUnnamed_5 = 4;
pub const SH_ARMAGEDDON: C2RustUnnamed_5 = 3;
pub const SH_WHIRLWIND: C2RustUnnamed_5 = 2;
pub const SH_PITY: C2RustUnnamed_5 = 1;
pub const SH_PROTECTSPIKE: C2RustUnnamed_5 = 8192;
pub const SH_PROTECTELECTRIC: C2RustUnnamed_5 = 4096;
pub const SH_PROTECTWATER: C2RustUnnamed_5 = 2048;
pub const SH_PROTECTFIRE: C2RustUnnamed_5 = 1024;
pub const SH_NONE: C2RustUnnamed_5 = 0;
...
#[no_mangle]
pub static mut numskins: int32_t = 0 as libc::c_int;
#[no_mangle]
pub static mut skins: [skin_t; 32] = [skin_t {
    name: [0; 17],
    wadnum: 0,
    flags: 0 as skinflags_t,
    realname: [0; 17],
    hudname: [0; 17],
    supername: [0; 23],
    ability: 0,
    ...
    contspeed: 0,
    contangle: 0,
    soundsid: [sfx_None; 21],
    sprites: [spritedef_t {
        numframes: 0,
        spriteframes: 0 as *const spriteframe_t as *mut spriteframe_t,
    }; 256],
    sprinfo: [spriteinfo_t {
        pivot: [spriteframepivot_t { x: 0, y: 0 }; 64],
        available: 0,
    }; 256],
}; 32];
#[no_mangle]
pub unsafe extern "C" fn P_GetSkinSprite2(
    mut skin: *mut skin_t,
    mut spr2: uint8_t,
    mut player: *mut player_t,
) -> uint8_t {
    let mut super_0: uint8_t = 0 as libc::c_int as uint8_t;
    let mut i: uint8_t = 0 as libc::c_int as uint8_t;
    if skin.is_null() {
        return 0 as libc::c_int as uint8_t;
    }
    if (spr2 as libc::c_int & !(0x80 as libc::c_int)) as playersprite_t as libc::c_uint
        >= free_spr2 as libc::c_uint
    {
        return 0 as libc::c_int as uint8_t;
    }
    while (*skin).sprites[spr2 as usize].numframes == 0
        && spr2 as libc::c_int != SPR2_STND as libc::c_int
        && {
            i = i.wrapping_add(1);
            (i as libc::c_int) < 32 as libc::c_int
        }
    {
        if spr2 as libc::c_int & 0x80 as libc::c_int != 0 {
            super_0 = 0x80 as libc::c_int as uint8_t;
            spr2 = (spr2 as libc::c_int & !(0x80 as libc::c_int)) as uint8_t;
        } else {
            match spr2 as libc::c_int {
                12 => {
                    spr2 = (if (if !player.is_null() {
                        (*player).charflags
                    } else {
                        (*skin).flags as libc::c_uint
                    }) & SF_NOJUMPSPIN as libc::c_int as libc::c_uint != 0
                    {
                        SPR2_SPNG as libc::c_int
                    } else {
                        SPR2_ROLL as libc::c_int
                    }) as uint8_t;
                }
                20 => {
                    spr2 = (if (if !player.is_null() {
                        ...
                        (*skin).ability as libc::c_int
                    }) == CA_SWIM as libc::c_int
                    {
                        SPR2_SWIM as libc::c_int
                    } else {
                        SPR2_FLY as libc::c_int
                    }) as uint8_t;
                }
                _ => {
                    spr2 = spr2defaults[spr2 as usize] as uint8_t;
                }
            }
            spr2 = (spr2 as libc::c_int | super_0 as libc::c_int) as uint8_t;
        }
    }
...
unsafe extern "C" fn Sk_SetDefaultValue(mut skin: *mut skin_t) {
    let mut i: int32_t = 0;
    memset(
        skin as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<skin_t>() as libc::c_ulong,
    );
    snprintf(
        ((*skin).name).as_mut_ptr(),
        ::core::mem::size_of::<[libc::c_char; 17]>() as libc::c_ulong,
        b"skin %u\0" as *const u8 as *const libc::c_char,
        skin.offset_from(skins.as_mut_ptr()) as libc::c_long as uint32_t,
    );
    (*skin)
        .name[(::core::mem::size_of::<[libc::c_char; 17]>() as libc::c_ulong)
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        as usize] = '\0' as i32 as libc::c_char;
    (*skin).wadnum = 32767 as libc::c_int as uint16_t;
    (*skin).flags = 0 as skinflags_t;
    strcpy(
        ((*skin).realname).as_mut_ptr(),
        b"Someone\0" as *const u8 as *const libc::c_char,
    );
    strcpy(((*skin).hudname).as_mut_ptr(), b"???\0" as *const u8 as *const libc::c_char);
    strcpy(
        ((*skin).supername).as_mut_ptr(),
        b"Someone super\0" as *const u8 as *const libc::c_char,
    );
    (*skin).starttranscolor = 96 as libc::c_int as uint8_t;
    (*skin).prefcolor = SKINCOLOR_GREEN as libc::c_int as uint16_t;
    (*skin).supercolor = SKINCOLOR_SUPERGOLD1 as libc::c_int as uint16_t;
    (*skin).prefoppositecolor = 0 as libc::c_int as uint16_t;
    (*skin).normalspeed = (36 as libc::c_int) << 16 as libc::c_int;
    (*skin).runspeed = (28 as libc::c_int) << 16 as libc::c_int;
    (*skin).thrustfactor = 5 as libc::c_int as uint8_t;
    (*skin).accelstart = 96 as libc::c_int as uint8_t;
    (*skin).acceleration = 40 as libc::c_int as uint8_t;
    (*skin).ability = CA_NONE as libc::c_int as uint8_t;
    (*skin).ability2 = CA2_SPINDASH as libc::c_int as uint8_t;
    (*skin).jumpfactor = (1 as libc::c_int) << 16 as libc::c_int;
    (*skin).actionspd = (30 as libc::c_int) << 16 as libc::c_int;
    (*skin).mindash = (15 as libc::c_int) << 16 as libc::c_int;
    (*skin).maxdash = (70 as libc::c_int) << 16 as libc::c_int;
    (*skin).radius = mobjinfo[MT_PLAYER as libc::c_int as usize].radius;
    (*skin).height = mobjinfo[MT_PLAYER as libc::c_int as usize].height;
    (*skin)
        .spinheight = FixedMul(
        (*skin).height,
        2 as libc::c_int * ((1 as libc::c_int) << 16 as libc::c_int) / 3 as libc::c_int,
    );
    (*skin).shieldscale = (1 as libc::c_int) << 16 as libc::c_int;
    (*skin).camerascale = (1 as libc::c_int) << 16 as libc::c_int;
    (*skin).thokitem = -(1 as libc::c_int);
    (*skin).spinitem = -(1 as libc::c_int);
    (*skin).revitem = -(1 as libc::c_int);
    (*skin).followitem = 0 as libc::c_int;
    (*skin).highresscale = (1 as libc::c_int) << 16 as libc::c_int;
    (*skin).contspeed = 17 as libc::c_int as uint8_t;
    (*skin).contangle = 0 as libc::c_int as uint8_t;
    i = 0 as libc::c_int;
    while i < sfx_skinsoundslot0 as libc::c_int {
        if (*S_sfx.as_mut_ptr().offset(i as isize)).skinsound != -(1 as libc::c_int) {
            (*skin)
                .soundsid[(*S_sfx.as_mut_ptr().offset(i as isize)).skinsound
                as usize] = i as sfxenum_t;
        }
        i += 1;
        i;
    }
...
pub unsafe extern "C" fn R_InitSkins() {
    numskins = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn R_GetSkinAvailabilities() -> uint32_t {
    let mut response: uint32_t = 0 as libc::c_int as uint32_t;
    ...
    while i < 80 as libc::c_int {
        if !(unlockables[i as usize].type_0 as libc::c_int != 5 as libc::c_int) {
            if unlockShift >= 32 as libc::c_int as uint32_t {
                I_Error(
                    b"Too many unlockable characters! (maximum is 32)\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
            if (*clientGamedata).unlocked[i as usize] != 0 {
                response |= ((1 as libc::c_int) << unlockShift) as uint32_t;
            }
...
#[no_mangle]
pub unsafe extern "C" fn R_SkinUsable(
    mut playernum: int32_t,
    mut skinnum: int32_t,
) -> boolean {
    let mut unlockID: int32_t = -(1 as libc::c_int);
    let mut unlockShift: uint32_t = 0 as libc::c_int as uint32_t;
    let mut i: int32_t = 0;
    ...
    if netgame != 0 && cv_forceskin.value == skinnum {
        return true_0 as libc::c_int;
    }
    if metalrecording != 0 && skinnum == 5 as libc::c_int {
        return true_0 as libc::c_int;
    }
    if playernum != -(1 as libc::c_int)
        && players[playernum as usize].bot as libc::c_int != 0
    {
        return true_0 as libc::c_int;
    }
    i = 0 as libc::c_int;
    while i < 80 as libc::c_int {
        let mut unlockSkin: int32_t = -(1 as libc::c_int);
        if !(unlockables[i as usize].type_0 as libc::c_int != 5 as libc::c_int) {
            unlockSkin = M_UnlockableSkinNum(
    ...
    if unlockID == -(1 as libc::c_int) {
        return true_0 as libc::c_int;
    }
    if (netgame != 0 || multiplayer != 0) && playernum != -(1 as libc::c_int) {
        return (players[playernum as usize].availabilities
            & ((1 as libc::c_int) << unlockShift) as uint32_t) as boolean
    } else {
        return (*clientGamedata).unlocked[unlockID as usize]
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_SkinAvailable(mut name: *const libc::c_char) -> int32_t {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < numskins {
        if strcasecmp((skins[i as usize].name).as_mut_ptr(), name) == 0 as libc::c_int {
            return i;
        }
        i += 1;
        i;
...
unsafe extern "C" fn SetSkin(mut player: *mut player_t, mut skinnum: int32_t) {
    let mut skin: *mut skin_t = &mut *skins.as_mut_ptr().offset(skinnum as isize)
        as *mut skin_t;
    let mut newcolor: uint16_t = 0 as libc::c_int as uint16_t;
    (*player).skin = skinnum;
    ...
    (*player).charflags = (*skin).flags as uint32_t;
    (*player)
        .thokitem = (if (*skin).thokitem < 0 as libc::c_int {
        mobjinfo[MT_PLAYER as libc::c_int as usize].painchance as uint32_t
    } else {
        (*skin).thokitem as uint32_t
    }) as mobjtype_t;
    (*player)
        .spinitem = (if (*skin).spinitem < 0 as libc::c_int {
        mobjinfo[MT_PLAYER as libc::c_int as usize].damage as uint32_t
    } else {
        (*skin).spinitem as uint32_t
    }) as mobjtype_t;
    (*player)
        .revitem = (if (*skin).revitem < 0 as libc::c_int {
        mobjinfo[MT_PLAYER as libc::c_int as usize].raisestate as mobjtype_t
            as libc::c_uint
    } else {
        (*skin).revitem as uint32_t
    }) as mobjtype_t;
    (*player).followitem = (*skin).followitem as mobjtype_t;
    if (*player).powers[pw_shield as libc::c_int as usize] as libc::c_int
        & SH_NOSTACK as libc::c_int == SH_PINK as libc::c_int
        && ((*player).revitem as libc::c_uint == MT_LHRT as libc::c_int as libc::c_uint
        ...
        && !(netgame != 0 || multiplayer != 0 || demoplayback != 0)
    {
        ...
        {
            CV_StealthSetValue(&mut cv_playercolor, (*skin).prefcolor as int32_t);
        } else if player
            == &mut *players.as_mut_ptr().offset(secondarydisplayplayer as isize)
                as *mut player_t
        {
            CV_StealthSetValue(&mut cv_playercolor2, (*skin).prefcolor as int32_t);
        }
        newcolor = (*skin).prefcolor;
        (*player).skincolor = newcolor;
        if (*player).bot as libc::c_int != 0 && botingame != 0 {
            botskin = (skinnum + 1 as libc::c_int) as uint8_t;
    ...
    if !((*player).mo).is_null() {
        let mut radius: fixed_t = FixedMul((*skin).radius, (*(*player).mo).scale);
        if (*player).powers[pw_carry as libc::c_int as usize] as libc::c_int
            == CR_NIGHTSMODE as libc::c_int
            && (*skin).sprites[SPR2_NFLY as libc::c_int as usize].numframes
        ...
        (*(*player).mo).skin = skin as *mut libc::c_void;
        if newcolor != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn GetPlayerDefaultSkin(mut playernum: int32_t) -> int32_t {
    let mut i: int32_t = 0;
    i = 0 as libc::c_int;
    while i < numskins {
        if R_SkinUsable(playernum, i) != 0 {
            return i;
        }
        i += 1;
        i;
    }
    I_Error(b"All characters are locked!\0" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn SetPlayerSkin(
    mut playernum: int32_t,
    ...
    let mut player: *mut player_t = &mut *players.as_mut_ptr().offset(playernum as isize)
        as *mut player_t;
    if i != -(1 as libc::c_int) && R_SkinUsable(playernum, i) != 0 {
        SetSkin(player, i);
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn SetPlayerSkinByNum(
    mut playernum: int32_t,
    mut skinnum: int32_t,
) {
    let mut player: *mut player_t = &mut *players.as_mut_ptr().offset(playernum as isize)
    ...
    if skinnum >= 0 as libc::c_int && skinnum < numskins
        && R_SkinUsable(playernum, skinnum) != 0
    {
    ...
    if P_IsLocalPlayer(player) != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Requested skin %d not found\n\0" as *const u8 as *const libc::c_char,
            skinnum,
        );
    } else if server != 0 || IsPlayerAdmin(consoleplayer) != 0 {
        CONS_Alert(
            CONS_WARNING,
            b"Player %d (%s) skin %d not found\n\0" as *const u8 as *const libc::c_char,
            playernum,
            (player_names[playernum as usize]).as_mut_ptr(),
            skinnum,
        );
...
unsafe extern "C" fn W_CheckForSkinMarkerInPwad(
    mut wadid: uint16_t,
    mut startlump: uint16_t,
) -> uint16_t {
    let mut i: uint16_t = 0;
    let mut S_SKIN: *const libc::c_char = b"S_SKIN\0" as *const u8
        as *const libc::c_char;
...
unsafe extern "C" fn W_CheckForPatchSkinMarkerInPwad(
    mut wadid: uint16_t,
    mut startlump: uint16_t,
) -> uint16_t {
    let mut i: uint16_t = 0;
    let mut P_SKIN: *const libc::c_char = b"P_SKIN\0" as *const u8
        as *const libc::c_char;
    let mut lump_p: *mut lumpinfo_t = 0 as *mut lumpinfo_t;
    if (startlump as libc::c_int)
        < (**wadfiles.offset(wadid as isize)).numlumps as libc::c_int
...
unsafe extern "C" fn R_LoadSkinSprites(
    mut wadnum: uint16_t,
    mut lump: *mut uint16_t,
    mut lastlump: *mut uint16_t,
    mut skin: *mut skin_t,
    mut start_spr2: uint8_t,
) {
    let mut newlastlump: uint16_t = 0;
    let mut sprite2: uint8_t = 0;
    *lump = (*lump as libc::c_int + 1 as libc::c_int) as uint16_t;
    *lastlump = W_CheckNumForNamePwad(
        b"S_END\0" as *const u8 as *const libc::c_char,
        wadnum,
        *lump,
    );
    newlastlump = W_CheckForSkinMarkerInPwad(wadnum, *lump);
    if (newlastlump as libc::c_int) < *lastlump as libc::c_int {
    ...
    newlastlump = W_CheckNumForNamePwad(
    ...
    newlastlump = W_CheckNumForNamePwad(
        b"S_SUPER\0" as *const u8 as *const libc::c_char,
        wadnum,
        *lump,
    );
    if (newlastlump as libc::c_int) < *lastlump as libc::c_int {
        newlastlump = newlastlump.wrapping_add(1);
        newlastlump;
        sprite2 = start_spr2;
        while (sprite2 as libc::c_uint) < free_spr2 as libc::c_uint {
            R_AddSingleSpriteDef(
                (spr2names[sprite2 as usize]).as_mut_ptr(),
                &mut *((*skin).sprites)
                    .as_mut_ptr()
                    .offset((0x80 as libc::c_int | sprite2 as libc::c_int) as isize),
                wadnum,
                newlastlump,
                *lastlump,
            );
            sprite2 = sprite2.wrapping_add(1);
            sprite2;
        }
        newlastlump = newlastlump.wrapping_sub(1);
        newlastlump;
        *lastlump = newlastlump;
    }
    sprite2 = start_spr2;
    while (sprite2 as libc::c_uint) < free_spr2 as libc::c_uint {
        R_AddSingleSpriteDef(
            (spr2names[sprite2 as usize]).as_mut_ptr(),
            &mut *((*skin).sprites).as_mut_ptr().offset(sprite2 as isize),
            wadnum,
            *lump,
            *lastlump,
        );
    ...
    if (*skin).sprites[0 as libc::c_int as usize].numframes == 0 as libc::c_int as size_t
    {
        CONS_Alert(
            CONS_ERROR,
            b"No frames found for sprite SPR2_%s\n\0" as *const u8
                as *const libc::c_char,
            (spr2names[0 as libc::c_int as usize]).as_mut_ptr(),
        );
    }
}
unsafe extern "C" fn R_ProcessPatchableFields(
    mut skin: *mut skin_t,
    mut stoken: *mut libc::c_char,
    mut value: *mut libc::c_char,
) -> boolean {
    if strcasecmp(stoken, b"startcolor\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).starttranscolor = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"flags\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).flags = get_number(value) as skinflags_t;
    } else if strcasecmp(stoken, b"ability\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).ability = get_number(value) as uint8_t;
    } else if strcasecmp(stoken, b"ability2\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).ability2 = get_number(value) as uint8_t;
    } else if strcasecmp(stoken, b"thokitem\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).thokitem = get_number(value);
    } else if strcasecmp(stoken, b"spinitem\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).spinitem = get_number(value);
    } else if strcasecmp(stoken, b"revitem\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).revitem = get_number(value);
    } else if strcasecmp(stoken, b"followitem\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).followitem = get_number(value);
    } else if strcasecmp(stoken, b"normalspeed\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).normalspeed = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"runspeed\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).runspeed = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"mindash\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).mindash = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"maxdash\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).maxdash = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"actionspd\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).actionspd = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"radius\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).radius = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"height\0" as *const u8 as *const libc::c_char) == 0 {
        (*skin).height = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"spinheight\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).spinheight = atoi(value) << 16 as libc::c_int;
    } else if strcasecmp(stoken, b"thrustfactor\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).thrustfactor = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"accelstart\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).accelstart = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"acceleration\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).acceleration = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"contspeed\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).contspeed = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"contangle\0" as *const u8 as *const libc::c_char) == 0
    {
        (*skin).contangle = atoi(value) as uint8_t;
    } else if strcasecmp(stoken, b"prefcolor\0" as *const u8 as *const libc::c_char) == 0
    {
        let mut color: uint16_t = R_GetColorByName(value);
        (*skin)
            .prefcolor = (if color as libc::c_int != 0 {
            color as libc::c_int
        } else {
            SKINCOLOR_GREEN as libc::c_int
        }) as uint16_t;
    } else if strcasecmp(
        stoken,
    ...
    {
        let mut color_0: uint16_t = R_GetColorByName(value);
        (*skin)
            .prefoppositecolor = (if color_0 as libc::c_int != 0 {
            color_0 as libc::c_int
        } else {
            SKINCOLOR_GREEN as libc::c_int
        }) as uint16_t;
    } else if strcasecmp(stoken, b"supercolor\0" as *const u8 as *const libc::c_char)
        == 0
    {
        let mut color_1: uint16_t = R_GetSuperColorByName(value);
        (*skin)
            .supercolor = (if color_1 as libc::c_int != 0 {
            color_1 as libc::c_int
        } else {
            SKINCOLOR_SUPERGOLD1 as libc::c_int
        }) as uint16_t;
    } else if strcasecmp(stoken, b"jumpfactor\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).jumpfactor = FloatToFixed(atof(value) as libc::c_float);
    } else if strcasecmp(stoken, b"highresscale\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).highresscale = FloatToFixed(atof(value) as libc::c_float);
    } else if strcasecmp(stoken, b"shieldscale\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).shieldscale = FloatToFixed(atof(value) as libc::c_float);
    } else if strcasecmp(stoken, b"camerascale\0" as *const u8 as *const libc::c_char)
        == 0
    {
        (*skin).camerascale = FloatToFixed(atof(value) as libc::c_float);
    } else if strcasecmp(stoken, b"SUPER\0" as *const u8 as *const libc::c_char) == 0 {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            (*skin)
                .flags = ::core::mem::transmute::<
                libc::c_uint,
                skinflags_t,
            >((*skin).flags as libc::c_uint | SF_SUPER as libc::c_int as libc::c_uint);
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
                libc::c_uint,
            ...
            >(
                (*skin).flags as libc::c_uint
                    & !(SF_SUPER as libc::c_int) as libc::c_uint,
            );
        }
    } else if strcasecmp(stoken, b"NOSUPERSPIN\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSUPERSPIN as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"NOSPINDASHDUST\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSPINDASHDUST as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"HIRES\0" as *const u8 as *const libc::c_char) == 0 {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            (*skin)
                ...
                libc::c_uint,
                skinflags_t,
            >((*skin).flags as libc::c_uint | SF_HIRES as libc::c_int as libc::c_uint);
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
                libc::c_uint,
            ...
            >(
                (*skin).flags as libc::c_uint
                    & !(SF_HIRES as libc::c_int) as libc::c_uint,
            );
        }
    } else if strcasecmp(stoken, b"NOSKID\0" as *const u8 as *const libc::c_char) == 0 {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            (*skin)
                ...
                libc::c_uint,
                skinflags_t,
            >((*skin).flags as libc::c_uint | SF_NOSKID as libc::c_int as libc::c_uint);
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
                libc::c_uint,
            ...
            >(
                (*skin).flags as libc::c_uint
                    & !(SF_NOSKID as libc::c_int) as libc::c_uint,
            );
        }
    } else if strcasecmp(stoken, b"NOSPEEDADJUST\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSPEEDADJUST as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"RUNONWATER\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_RUNONWATER as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"NOJUMPSPIN\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOJUMPSPIN as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"NOJUMPDAMAGE\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOJUMPDAMAGE as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"STOMPDAMAGE\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_STOMPDAMAGE as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"MARIODAMAGE\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_MARIODAMAGE as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"MACHINE\0" as *const u8 as *const libc::c_char) == 0 {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            (*skin)
                ...
                libc::c_uint,
                skinflags_t,
            >((*skin).flags as libc::c_uint | SF_MACHINE as libc::c_int as libc::c_uint);
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
                libc::c_uint,
            ...
            >(
                (*skin).flags as libc::c_uint
                    & !(SF_MACHINE as libc::c_int) as libc::c_uint,
            );
        }
    } else if strcasecmp(stoken, b"DASHMODE\0" as *const u8 as *const libc::c_char) == 0
    {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_DASHMODE as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"FASTEDGE\0" as *const u8 as *const libc::c_char) == 0
    {
        strupr(value);
        if atoi(value) != 0
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'T' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_FASTEDGE as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"MULTIABILITY\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_MULTIABILITY as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
        ...
        stoken,
        b"NONIGHTSROTATION\0" as *const u8 as *const libc::c_char,
    ) == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NONIGHTSROTATION as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"NONIGHTSSUPER\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NONIGHTSSUPER as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"NOSUPERSPRITES\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSUPERSPRITES as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
        ...
        stoken,
        b"NOSUPERJUMPBOOST\0" as *const u8 as *const libc::c_char,
    ) == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSUPERJUMPBOOST as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
    ...
    } else if strcasecmp(stoken, b"CANBUSTWALLS\0" as *const u8 as *const libc::c_char)
        == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_CANBUSTWALLS as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
        ...
        stoken,
        b"NOSHIELDABILITY\0" as *const u8 as *const libc::c_char,
    ) == 0
    {
        strupr(value);
        if atoi(value) != 0
            ...
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'Y' as i32
        {
            ...
            >(
                (*skin).flags as libc::c_uint
                    | SF_NOSHIELDABILITY as libc::c_int as libc::c_uint,
            );
        } else {
            (*skin)
                .flags = ::core::mem::transmute::<
        ...
        let mut stokenadjust: size_t = 0;
        if (*stoken.offset(0 as libc::c_int as isize) as libc::c_int == 'D' as i32
            || *stoken.offset(0 as libc::c_int as isize) as libc::c_int == 'd' as i32)
            && (*stoken.offset(1 as libc::c_int as isize) as libc::c_int == 'S' as i32
                || *stoken.offset(1 as libc::c_int as isize) as libc::c_int
                    == 's' as i32)
        {
            stokenadjust = 2 as libc::c_int as size_t;
        } else {
            stokenadjust = 4 as libc::c_int as size_t;
        }
        if (*value.offset(0 as libc::c_int as isize) as libc::c_int == 'D' as i32
            || *value.offset(0 as libc::c_int as isize) as libc::c_int == 'd' as i32)
            && (*value.offset(1 as libc::c_int as isize) as libc::c_int == 'S' as i32
                || *value.offset(1 as libc::c_int as isize) as libc::c_int == 's' as i32)
        {
            value = value.offset(2 as libc::c_int as isize);
        } else {
            value = value.offset(4 as libc::c_int as isize);
        }
        i = sfx_None;
        while (i as libc::c_uint) < sfx_skinsoundslot0 as libc::c_int as libc::c_uint {
            if !((*S_sfx.as_mut_ptr().offset(i as isize)).name).is_null() {
                if (*S_sfx.as_mut_ptr().offset(i as isize)).skinsound
                    != -(1 as libc::c_int)
                    && strcasecmp(
                        (*S_sfx.as_mut_ptr().offset(i as isize)).name,
                        stoken.offset(stokenadjust as isize),
                    ) == 0
                {
                    (*skin)
                        .soundsid[(*S_sfx.as_mut_ptr().offset(i as isize)).skinsound
                        as usize] = S_AddSoundFx(
                        value,
                        (*S_sfx.as_mut_ptr().offset(i as isize)).singularity,
                        (*S_sfx.as_mut_ptr().offset(i as isize)).pitch,
...
#[no_mangle]
pub unsafe extern "C" fn R_AddSkins(mut wadnum: uint16_t, mut mainfile: boolean) {
    let mut lump: uint16_t = 0;
    let mut lastlump: uint16_t = 0 as libc::c_int as uint16_t;
    ...
    let mut hudname: boolean = 0;
    let mut realname: boolean = 0;
    let mut supername: boolean = 0;
    loop {
        lump = W_CheckForSkinMarkerInPwad(wadnum, lastlump);
        if !(lump as libc::c_int != 32767 as libc::c_int) {
            break;
        }
        lastlump = (lump as libc::c_int + 1 as libc::c_int) as uint16_t;
        if numskins >= 32 as libc::c_int {
            CONS_Debug(
                0x8 as libc::c_int,
                b"ignored skin (%d skins maximum)\n\0" as *const u8
                    as *const libc::c_char,
                32 as libc::c_int,
            );
        } else {
            buf = W_CacheLumpNumPwad(wadnum, lump, PU_CACHE as libc::c_int)
                as *mut libc::c_char;
            size = W_LumpLengthPwad(wadnum, lump);
            buf2 = malloc(size.wrapping_add(1 as libc::c_int as size_t))
                as *mut libc::c_char;
            if buf2.is_null() {
                I_Error(
                    b"R_AddSkins: No more free memory\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
            M_Memcpy
                ...
                )(buf2 as *mut libc::c_void, buf as *const libc::c_void, size);
            *buf2.offset(size as isize) = '\0' as i32 as libc::c_char;
            skin = &mut *skins.as_mut_ptr().offset(numskins as isize) as *mut skin_t;
            Sk_SetDefaultValue(skin);
            (*skin).wadnum = wadnum;
            supername = false_0 as libc::c_int;
            realname = supername;
            hudname = realname;
            stoken = strtok(buf2, b"\r\n= \0" as *const u8 as *const libc::c_char);
            while !stoken.is_null() {
                if *stoken.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
                    && *stoken.offset(1 as libc::c_int as isize) as libc::c_int
                        == '/' as i32
                    || *stoken.offset(0 as libc::c_int as isize) as libc::c_int
                        == '#' as i32
                {
                    stoken = strtok(
                    ...
                    if value.is_null() {
                        I_Error(
                            b"R_AddSkins: syntax error in S_SKIN lump# %d(%s) in WAD %s\n\0"
                                as *const u8 as *const libc::c_char,
                            lump as libc::c_int,
                            W_CheckNameForNumPwad(wadnum, lump),
                            (**wadfiles.offset(wadnum as isize)).filename,
                        );
                    }
                    if strcasecmp(stoken, b"name\0" as *const u8 as *const libc::c_char)
                        == 0
                    {
                        let mut skinnum: int32_t = R_SkinAvailable(value);
                        strlwr(value);
                        if skinnum == -(1 as libc::c_int) {
                            strlcpy(
                                ((*skin).name).as_mut_ptr(),
                            ...
                            let stringspace: size_t = (strlen(value))
                                .wrapping_add(
                                    ::core::mem::size_of::<int32_t>() as libc::c_ulong,
                                )
                                .wrapping_add(1 as libc::c_int as libc::c_ulong);
                            let mut value2: *mut libc::c_char = Z_MallocAlign(
                                stringspace,
                            ...
                            *value2
                                .offset(
                                    stringspace.wrapping_sub(1 as libc::c_int as size_t)
                                        as isize,
                                ) = '\0' as i32 as libc::c_char;
                            if R_SkinAvailable(value2) == -(1 as libc::c_int) {
                                strlcpy(
                                    ((*skin).name).as_mut_ptr(),
                                    value2,
                                    ::core::mem::size_of::<[libc::c_char; 17]>()
                            ...
                            Z_Free(value2 as *mut libc::c_void);
                        }
                        if realname == 0 {
                            strlcpy(
                                ((*skin).realname).as_mut_ptr(),
                            ...
                            value = ((*skin).realname).as_mut_ptr();
                            while *value != 0 {
                                if *value as libc::c_int == '_' as i32 {
                                    *value = ' ' as i32 as libc::c_char;
                                } else if *value as libc::c_int == '.' as i32 {
                                    *value = '\u{1e}' as i32 as libc::c_char;
                                }
                        ...
                        if hudname == 0 {
                            strlcpy(
                                ((*skin).hudname).as_mut_ptr(),
                                ((*skin).name).as_mut_ptr(),
                                ::core::mem::size_of::<[libc::c_char; 17]>()
                                    as libc::c_ulong,
                            );
                            strupr(((*skin).hudname).as_mut_ptr());
                            value = ((*skin).hudname).as_mut_ptr();
                            while *value != 0 {
                                if *value as libc::c_int == '_' as i32 {
                                    *value = ' ' as i32 as libc::c_char;
                                } else if *value as libc::c_int == '.' as i32 {
                        ...
                        if supername == 0 {
                            let mut superstring: [libc::c_char; 23] = [0; 23];
                            strcpy(
                                superstring.as_mut_ptr(),
                    ...
                    {
                        supername = true_0 as libc::c_int;
                        strlcpy(
                            ((*skin).supername).as_mut_ptr(),
                            value,
                            ::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong,
                        );
                        value = ((*skin).supername).as_mut_ptr();
                        while *value != 0 {
                            if *value as libc::c_int == '_' as i32 {
                                *value = ' ' as i32 as libc::c_char;
                            } else if *value as libc::c_int == '.' as i32 {
                    ...
                    ) == 0
                    {
                        ...
                        if supername == 0 {
                            let mut superstring_0: [libc::c_char; 23] = [0; 23];
                            strcpy(
                                superstring_0.as_mut_ptr(),
                                b"Super \0" as *const u8 as *const libc::c_char,
                            );
                            strlcat(
                                superstring_0.as_mut_ptr(),
                    ...
                    } else if R_ProcessPatchableFields(skin, stoken, value) == 0 {
                        CONS_Debug(
                            0x400 as libc::c_int,
                            b"R_AddSkins: Unknown keyword '%s' in S_SKIN lump #%d (WAD %s)\n\0"
                                as *const u8 as *const libc::c_char,
                            stoken,
                            lump as libc::c_int,
                            (**wadfiles.offset(wadnum as isize)).filename,
            ...
            if mainfile == false_0 as libc::c_int {
                CONS_Printf(
                    b"Added skin '%s'\n\0" as *const u8 as *const libc::c_char,
                    ((*skin).name).as_mut_ptr(),
                );
...
#[no_mangle]
pub unsafe extern "C" fn R_PatchSkins(mut wadnum: uint16_t, mut mainfile: boolean) {
    let mut lump: uint16_t = 0;
    let mut lastlump: uint16_t = 0 as libc::c_int as uint16_t;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut buf2: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    let mut size: size_t = 0;
    let mut skin: *mut skin_t = 0 as *mut skin_t;
    let mut noskincomplain: boolean = 0;
    let mut realname: boolean = 0;
    let mut hudname: boolean = 0;
    let mut supername: boolean = 0;
    loop {
        lump = W_CheckForPatchSkinMarkerInPwad(wadnum, lastlump);
        if !(lump as libc::c_int != 32767 as libc::c_int) {
            break;
        }
        ...
        if buf2.is_null() {
            I_Error(
                b"R_PatchSkins: No more free memory\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        M_Memcpy
        ...
        *buf2.offset(size as isize) = '\0' as i32 as libc::c_char;
        skin = 0 as *mut skin_t;
        supername = false_0 as libc::c_int;
        hudname = supername;
        realname = hudname;
        noskincomplain = realname;
        stoken = strtok(buf2, b"\r\n= \0" as *const u8 as *const libc::c_char);
        while !stoken.is_null() {
            if *stoken.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
                && *stoken.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
                || *stoken.offset(0 as libc::c_int as isize) as libc::c_int == '#' as i32
            {
                stoken = strtok(
                    0 as *mut libc::c_char,
                    b"\r\n\0" as *const u8 as *const libc::c_char,
                ...
                if value.is_null() {
                    I_Error(
                        b"R_PatchSkins: syntax error in P_SKIN lump# %d(%s) in WAD %s\n\0"
                            as *const u8 as *const libc::c_char,
                        lump as libc::c_int,
                        W_CheckNameForNumPwad(wadnum, lump),
                        (**wadfiles.offset(wadnum as isize)).filename,
                ...
                if skin.is_null() {
                        ...
                        == 0
                    {
                        ...
                        if skinnum != -(1 as libc::c_int) {
                            skin = &mut *skins.as_mut_ptr().offset(skinnum as isize)
                                as *mut skin_t;
                        } else {
                            CONS_Debug(
                                0x400 as libc::c_int,
                                b"R_PatchSkins: unknown skin name in P_SKIN lump# %d(%s) in WAD %s\n\0"
                                    as *const u8 as *const libc::c_char,
                                lump as libc::c_int,
                                W_CheckNameForNumPwad(wadnum, lump),
                                (**wadfiles.offset(wadnum as isize)).filename,
                            );
                            noskincomplain = true_0 as libc::c_int;
                        }
                    }
                } else if strcasecmp(
                    stoken,
                ...
                ) == 0
                {
                    ...
                    CONS_Debug(
                        0x400 as libc::c_int,
                        b"R_PatchSkins: Unknown keyword '%s' in P_SKIN lump #%d (WAD %s)\n\0"
                            as *const u8 as *const libc::c_char,
                        stoken,
                        lump as libc::c_int,
                        (**wadfiles.offset(wadnum as isize)).filename,
        ...
        if skin.is_null() {
            if noskincomplain == 0 {
                CONS_Debug(
                    0x400 as libc::c_int,
                    b"R_PatchSkins: no skin name given in P_SKIN lump #%d (WAD %s)\n\0"
                        as *const u8 as *const libc::c_char,
                    lump as libc::c_int,
                    (**wadfiles.offset(wadnum as isize)).filename,
                );
...
unsafe extern "C" fn W_CheckForEitherSkinMarkerInPwad(
    mut wadid: uint16_t,
    mut startlump: uint16_t,
) -> uint16_t {
    let mut i: uint16_t = 0;
...
unsafe extern "C" fn R_RefreshSprite2ForWad(
    mut wadnum: uint16_t,
    mut start_spr2: uint8_t,
) {
    let mut lump: uint16_t = 0;
    ...
    let mut noskincomplain: boolean = 0;
    loop {
        lump = W_CheckForEitherSkinMarkerInPwad(wadnum, lastlump);
        if !(lump as libc::c_int != 32767 as libc::c_int) {
            break;
        }
        let mut skinnum: int32_t = 0 as libc::c_int;
        ...
        if buf2.is_null() {
            I_Error(
                b"R_RefreshSprite2ForWad: No more free memory\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        M_Memcpy
        ...
        *buf2.offset(size as isize) = '\0' as i32 as libc::c_char;
        skin = 0 as *mut skin_t;
        noskincomplain = false_0 as libc::c_int;
        stoken = strtok(buf2, b"\r\n= \0" as *const u8 as *const libc::c_char);
        while !stoken.is_null() {
            if *stoken.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
                && *stoken.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
                || *stoken.offset(0 as libc::c_int as isize) as libc::c_int == '#' as i32
            {
                ...
                if value.is_null() {
                    I_Error(
                        b"R_RefreshSprite2ForWad: syntax error in P_SKIN lump# %d(%s) in WAD %s\n\0"
                            as *const u8 as *const libc::c_char,
                        lump as libc::c_int,
                        W_CheckNameForNumPwad(wadnum, lump),
                        (**wadfiles.offset(wadnum as isize)).filename,
                ...
                if strcasecmp(stoken, b"name\0" as *const u8 as *const libc::c_char) == 0
                {
                    strlwr(value);
                    skinnum = R_SkinAvailable(value);
                    if skinnum != -(1 as libc::c_int) {
                        ...
                        CONS_Debug(
                            0x400 as libc::c_int,
                            b"R_RefreshSprite2ForWad: unknown skin name in P_SKIN lump# %d(%s) in WAD %s\n\0"
                                as *const u8 as *const libc::c_char,
                            lump as libc::c_int,
                            W_CheckNameForNumPwad(wadnum, lump),
                            (**wadfiles.offset(wadnum as isize)).filename,
        ...
        if skin.is_null() {
            if noskincomplain == 0 {
                CONS_Debug(
                    0x400 as libc::c_int,
                    b"R_RefreshSprite2ForWad: no skin name given in P_SKIN lump #%d (WAD %s)\n\0"
                        as *const u8 as *const libc::c_char,
                    lump as libc::c_int,
                    (**wadfiles.offset(wadnum as isize)).filename,
                );
            ...
            R_LoadSkinSprites(wadnum, &mut lump, &mut lastlump, skin, start_spr2);
        }
    };
}
static mut old_spr2: playersprite_t = SPR2_FIRSTFREESLOT;
#[no_mangle]
pub unsafe extern "C" fn R_RefreshSprite2() {
    let mut i: int32_t = 0;
    if old_spr2 as libc::c_uint > free_spr2 as libc::c_uint {
        old_spr2 = free_spr2;
    }
    if old_spr2 as libc::c_uint == free_spr2 as libc::c_uint {
        return;
    ...
    while i < numwadfiles as libc::c_int {
        R_RefreshSprite2ForWad(i as uint16_t, old_spr2 as uint8_t);
        i += 1;
        i;
    }
    old_spr2 = free_spr2;
