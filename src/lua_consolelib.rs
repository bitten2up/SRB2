...
extern "C" {
    ...
    static mut CV_Natural: [CV_PossibleValue_t; 0];
    static mut CV_TrueFalse: [CV_PossibleValue_t; 0];
    fn CV_RegisterVar(variable: *mut consvar_t);
    fn CV_FindVar(name: *const libc::c_char) -> *mut consvar_t;
    ...
    fn COM_AddLuaCommand(name: *const libc::c_char) -> libc::c_int;
    ...
    fn LUA_RawPushUserdata(L: *mut lua_State, data: *mut libc::c_void) -> lpushed_t;
...
pub const cvar_changed: cvar_e = 5;
pub const cvar_string: cvar_e = 4;
pub const cvar_value: cvar_e = 3;
pub const cvar_flags: cvar_e = 2;
pub const cvar_defaultvalue: cvar_e = 1;
pub const cvar_name: cvar_e = 0;
pub type cvar_e = libc::c_uint;
#[inline]
...
static mut this_cvar: *mut consvar_t = 0 as *const consvar_t as *mut consvar_t;
#[no_mangle]
pub unsafe extern "C" fn Got_Luacmd(mut cp: *mut *mut uint8_t, mut playernum: int32_t) {
    let mut i: uint8_t = 0;
    ...
    if !gL.is_null() {
        ...
        lua_getfield(
            gL,
            -(10000 as libc::c_int),
            b"COM_Command\0" as *const u8 as *const libc::c_char,
        );
        if lua_type(gL, -(1 as libc::c_int)) == 5 as libc::c_int {
            ...
            while tmp_i < 255 as libc::c_int as size_t
                && {
                    ...
                    buf[tmp_i as usize] as libc::c_int != '\0' as i32
                }
            {
                tmp_i = tmp_i.wrapping_add(1);
                tmp_i;
            }
            buf[tmp_i as usize] = '\0' as i32 as libc::c_char;
            strlwr(buf.as_mut_ptr());
            lua_getfield(gL, -(1 as libc::c_int), buf.as_mut_ptr());
            if lua_type(gL, -(1 as libc::c_int)) == 5 as libc::c_int {
                lua_remove(gL, -(2 as libc::c_int));
                lua_rawgeti(gL, -(1 as libc::c_int), 2 as libc::c_int);
                if lua_type(gL, -(1 as libc::c_int)) == 1 as libc::c_int {
                    flags = (if lua_toboolean(gL, -(1 as libc::c_int)) != 0 {
                        1 as libc::c_int
                    } else {
                        0 as libc::c_int
                    }) as uint8_t;
                } else {
                    flags = lua_tonumber(gL, -(1 as libc::c_int)) as uint8_t;
                }
                ...
                {
                    lua_rawgeti(gL, -(1 as libc::c_int), 1 as libc::c_int);
                    if lua_type(gL, -(1 as libc::c_int)) == 6 as libc::c_int {
                        lua_remove(gL, -(2 as libc::c_int));
                        LUA_PushUserdata(
                            gL,
                        ...
                        while (i as libc::c_int) < argc as libc::c_int {
                            let mut tmp_i_0: size_t = 0 as libc::c_int as size_t;
                            while tmp_i_0 < 255 as libc::c_int as size_t
                                && {
                                    buf[tmp_i_0
                                        as usize] = ({
                                        let mut p_tmp: *mut libc::c_char = *cp as *mut libc::c_void
                                    ...
                                    buf[tmp_i_0 as usize] as libc::c_int != '\0' as i32
                                }
                            {
                                tmp_i_0 = tmp_i_0.wrapping_add(1);
                                tmp_i_0;
                            }
                            buf[tmp_i_0 as usize] = '\0' as i32 as libc::c_char;
                            lua_pushstring(gL, buf.as_mut_ptr());
                            i = i.wrapping_add(1);
                            i;
                        }
                        LUA_Call(
    ...
    CONS_Alert(
        CONS_WARNING,
        b"Illegal lua command received from %s\n\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn COM_Lua_f() {
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: uint8_t = 0;
    let mut flags: uint8_t = 0;
    let mut len: uint16_t = 0;
    let mut playernum: int32_t = consoleplayer;
    lua_settop(gL, 0 as libc::c_int);
    lua_pushcclosure(
        gL,
    ...
    buf = Z_StrDup(COM_Argv(0 as libc::c_int as size_t));
    strlwr(buf);
    lua_getfield(gL, -(1 as libc::c_int), buf);
    lua_remove(gL, -(2 as libc::c_int));
    Z_Free(buf as *mut libc::c_void);
    lua_rawgeti(gL, -(1 as libc::c_int), 2 as libc::c_int);
    if lua_type(gL, -(1 as libc::c_int)) == 1 as libc::c_int {
        flags = (if lua_toboolean(gL, -(1 as libc::c_int)) != 0 {
            COM_ADMIN as libc::c_int
        } else {
            0 as libc::c_int
        }) as uint8_t;
    } else {
    ...
    lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    if flags as libc::c_int & COM_SPLITSCREEN as libc::c_int != 0 {
        if splitscreen == 0 {
            lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
            return;
        }
    ...
    if netgame != 0 && flags as libc::c_int & COM_LOCAL as libc::c_int == 0 {
        let mut argc: uint8_t = 0;
        lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
        if flags as libc::c_int & COM_ADMIN as libc::c_int != 0 && server == 0
        ...
        if COM_Argc() > 255 as libc::c_int as size_t {
            argc = 255 as libc::c_int as uint8_t;
        } else {
            argc = COM_Argc() as uint8_t;
        }
        if argc as libc::c_int == 255 as libc::c_int {
            len = 65535 as libc::c_int as uint16_t;
        } else {
            len = ((argc as libc::c_int + 1 as libc::c_int) * 256 as libc::c_int)
                as uint16_t;
        }
        ...
        while (i as libc::c_int) < argc as libc::c_int {
            ...
            while tmp_i < 255 as libc::c_int as size_t
                && *(COM_Argv(i as size_t)).offset(tmp_i as isize) as libc::c_int
                    != '\0' as i32
            {
                let mut p_tmp_0: *mut libc::c_char = p as *mut libc::c_void
                    as *mut libc::c_char;
                let tv_0: libc::c_char = *(COM_Argv(i as size_t)).offset(tmp_i as isize);
                memcpy(
                    p as *mut libc::c_void,
            ...
            if tmp_i < 255 as libc::c_int as size_t {
    ...
    i = 1 as libc::c_int as uint8_t;
    while (i as size_t) < COM_Argc() {
        lua_pushstring(gL, COM_Argv(i as size_t));
        i = i.wrapping_add(1);
        i;
    }
    LUA_Call(gL, COM_Argc() as libc::c_int, 0 as libc::c_int, 1 as libc::c_int);
}
unsafe extern "C" fn lib_comAddCommand(mut L: *mut lua_State) -> libc::c_int {
    let mut com_return: libc::c_int = -(1 as libc::c_int);
    let mut luaname: *const libc::c_char = luaL_checklstring(
        L,
        1 as libc::c_int,
        0 as *mut size_t,
    );
    let mut name: *mut libc::c_char = Z_StrDup(luaname);
    strlwr(name);
    ...
    if lua_gettop(L) >= 3 as libc::c_int {
        ...
        if lua_type(L, 3 as libc::c_int) == 1 as libc::c_int {
            CONS_Alert(
                CONS_WARNING,
                b"Using a boolean for admin commands is deprecated and will be removed.\nUse \"COM_ADMIN\" instead.\n\0"
                    as *const u8 as *const libc::c_char,
            );
        } else {
            luaL_checktype(L, 3 as libc::c_int, 3 as libc::c_int);
        }
    } else {
    ...
    lua_createtable(L, 2 as libc::c_int, 0 as libc::c_int);
    lua_pushvalue(L, 2 as libc::c_int);
    lua_rawseti(L, -(2 as libc::c_int), 1 as libc::c_int);
    lua_pushvalue(L, 3 as libc::c_int);
    lua_rawseti(L, -(2 as libc::c_int), 2 as libc::c_int);
    lua_setfield(L, -(2 as libc::c_int), name);
    com_return = COM_AddLuaCommand(name);
    if com_return < 0 as libc::c_int {
        Z_Free(name as *mut libc::c_void);
        return luaL_error(
            L,
            b"Couldn't add a new console command \"%s\"\0" as *const u8
                as *const libc::c_char,
            luaname,
        );
    } else if com_return == 1 as libc::c_int {
        CONS_Printf(
            b"Replaced command \"%s\"\n\0" as *const u8 as *const libc::c_char,
            name,
        );
        Z_Free(name as *mut libc::c_void);
    } else {
...
unsafe extern "C" fn lib_comBufAddText(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut plr: *mut player_t = 0 as *mut player_t;
    if n < 2 as libc::c_int {
        return luaL_error(
            L,
            b"COM_BufAddText requires two arguments: player and text.\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hud_running != 0 {
...
unsafe extern "C" fn lib_comBufInsertText(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    let mut plr: *mut player_t = 0 as *mut player_t;
    if n < 2 as libc::c_int {
        return luaL_error(
            L,
            b"COM_BufInsertText requires two arguments: player and text.\0" as *const u8
                as *const libc::c_char,
        );
    }
    if hud_running != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn LUA_CVarChanged(mut cvar: *mut libc::c_void) {
    this_cvar = cvar as *mut consvar_t;
}
unsafe extern "C" fn Lua_OnChange() {
    lua_pushcclosure(
        gL,
        Some(LUA_GetErrorMessage as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_insert(gL, 1 as libc::c_int);
    lua_getfield(
        gL,
        -(10000 as libc::c_int),
        b"CV_OnChange\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(gL, this_cvar as *mut libc::c_void);
    lua_rawget(gL, -(2 as libc::c_int));
    LUA_RawPushUserdata(gL, this_cvar as *mut libc::c_void);
    LUA_Call(gL, 1 as libc::c_int, 0 as libc::c_int, 1 as libc::c_int);
    lua_settop(gL, -(1 as libc::c_int) - 1 as libc::c_int);
    lua_remove(gL, 1 as libc::c_int);
}
unsafe extern "C" fn lib_cvRegisterVar(mut L: *mut lua_State) -> libc::c_int {
    ...
    cvar = Z_CallocAlign(
        ::core::mem::size_of::<consvar_t>() as libc::c_ulong,
    ...
    LUA_PushUserdata(
        L,
        cvar as *mut libc::c_void,
        b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
    );
    lua_pushnil(L);
    while lua_next(L, 1 as libc::c_int) != 0 {
        ...
        if lua_isnumber(L, 3 as libc::c_int) != 0 {
            i = lua_tonumber(L, 3 as libc::c_int);
        } else if lua_isstring(L, 3 as libc::c_int) != 0 {
            k = lua_tolstring(L, 3 as libc::c_int, 0 as *mut size_t);
        }
        if i == 1 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"name\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isstring(L, 4 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'name' in table passed to 'CV_RegisterVar' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
            ...
            (*cvar)
                .name = Z_StrDup(lua_tolstring(L, 4 as libc::c_int, 0 as *mut size_t));
        } else if i == 2 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"defaultvalue\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_isstring(L, 4 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'defaultvalue' in table passed to 'CV_RegisterVar' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 4 as libc::c_int),
            ...
            (*cvar)
                .defaultvalue = Z_StrDup(
                lua_tolstring(L, 4 as libc::c_int, 0 as *mut size_t),
            );
        } else if i == 3 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"flags\0" as *const u8 as *const libc::c_char) != 0
        {
            if lua_isnumber(L, 4 as libc::c_int) == 0 {
                luaL_error(
                    L,
                    b"bad value for 'flags' in table passed to 'CV_RegisterVar' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
            ...
            (*cvar).flags = lua_tonumber(L, 4 as libc::c_int);
        } else if i == 4 as libc::c_int
            || !k.is_null()
                && fasticmp(k, b"PossibleValue\0" as *const u8 as *const libc::c_char)
                    != 0
        {
            if lua_type(L, 4 as libc::c_int) == 2 as libc::c_int {
                let mut pv: *mut CV_PossibleValue_t = lua_touserdata(L, 4 as libc::c_int)
                    as *mut CV_PossibleValue_t;
                if pv == CV_OnOff.as_mut_ptr() || pv == CV_YesNo.as_mut_ptr()
                    || pv == CV_Unsigned.as_mut_ptr() || pv == CV_Natural.as_mut_ptr()
                    || pv == CV_TrueFalse.as_mut_ptr()
                {
                    (*cvar).PossibleValue = pv;
                } else {
                    luaL_error(
                        L,
                        b"bad value for 'PossibleValue' in table passed to 'CV_RegisterVar' (%s)\0"
                            as *const u8 as *const libc::c_char,
                        b"CV_PossibleValue_t expected, got unrecognised pointer\0"
                            as *const u8 as *const libc::c_char,
                    );
                }
            } else if lua_type(L, 4 as libc::c_int) == 5 as libc::c_int {
                let mut count: size_t = 0 as libc::c_int as size_t;
                let mut cvpv: *mut CV_PossibleValue_t = 0 as *mut CV_PossibleValue_t;
                lua_pushnil(L);
                while lua_next(L, 4 as libc::c_int) != 0 {
                ...
                lua_getfield(
                    L,
                    -(10000 as libc::c_int),
                    b"CV_PossibleValue\0" as *const u8 as *const libc::c_char,
                );
                lua_pushlightuserdata(L, cvar as *mut libc::c_void);
                cvpv = lua_newuserdata(
                    L,
                    (::core::mem::size_of::<CV_PossibleValue_t>() as libc::c_ulong)
                        .wrapping_mul(count.wrapping_add(1 as libc::c_int as size_t)),
                ) as *mut CV_PossibleValue_t;
                ...
                lua_pushnil(L);
                while lua_next(L, 4 as libc::c_int) != 0 {
                    if lua_type(L, 5 as libc::c_int) != 4 as libc::c_int
                        || lua_type(L, 6 as libc::c_int) != 3 as libc::c_int
                    {
                        luaL_error(
                            L,
                            b"bad value for 'PossibleValue' in table passed to 'CV_RegisterVar' (%s)\0"
                                as *const u8 as *const libc::c_char,
                            b"custom PossibleValue table requires a format of string=integer, i.e. {MIN=0, MAX=9999}\0"
                                as *const u8 as *const libc::c_char,
                        );
                    }
                    let ref mut fresh0 = (*cvpv.offset(i as isize)).strvalue;
                    *fresh0 = Z_StrDup(
                        lua_tolstring(L, 5 as libc::c_int, 0 as *mut size_t),
                    );
                    (*cvpv.offset(i as isize)).value = lua_tonumber(L, 6 as libc::c_int);
                    i += 1;
                    i;
                    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
                }
                (*cvpv.offset(i as isize)).value = 0 as libc::c_int;
                let ref mut fresh1 = (*cvpv.offset(i as isize)).strvalue;
                *fresh1 = 0 as *const libc::c_char;
                ...
                luaL_error(
                    ...
                    b"bad value for 'PossibleValue' in table passed to 'CV_RegisterVar' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s or CV_PossibleValue_t expected, got %s\0" as *const u8
                            as *const libc::c_char,
        ...
        } else if (*cvar).flags & CV_CALL as libc::c_int != 0
            && (i == 5 as libc::c_int
                || !k.is_null()
                    && fasticmp(k, b"func\0" as *const u8 as *const libc::c_char) != 0)
        {
            if !(lua_type(L, 4 as libc::c_int) == 6 as libc::c_int) {
                luaL_error(
                    L,
                    b"bad value for 'func' in table passed to 'CV_RegisterVar' (%s)\0"
                        as *const u8 as *const libc::c_char,
                    va(
                        b"%s expected, got %s\0" as *const u8 as *const libc::c_char,
                        lua_typename(L, 6 as libc::c_int),
                        lua_typename(L, lua_type(L, -(1 as libc::c_int))),
                    ),
                );
            }
            ...
            lua_rawset(L, 5 as libc::c_int);
            lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
            (*cvar).func = Some(Lua_OnChange as unsafe extern "C" fn() -> ());
        }
        lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    }
    if ((*cvar).name).is_null()
        || *((*cvar).name).offset(0 as libc::c_int as isize) as libc::c_int
            == '\0' as i32
    {
        return luaL_error(
            L,
            b"Variable has no name!\0" as *const u8 as *const libc::c_char,
        );
    }
    if ((*cvar).defaultvalue).is_null() {
        return luaL_error(
            L,
            b"Variable has no defaultvalue!\0" as *const u8 as *const libc::c_char,
        );
    }
    if (*cvar).flags & CV_NOINIT as libc::c_int != 0
        && (*cvar).flags & CV_CALL as libc::c_int == 0
    {
        return luaL_error(
            L,
            b"Variable %s has CV_NOINIT without CV_CALL\0" as *const u8
                as *const libc::c_char,
            (*cvar).name,
        );
    }
    if (*cvar).flags & CV_CALL as libc::c_int != 0 && ((*cvar).func).is_none() {
        return luaL_error(
            L,
            b"Variable %s has CV_CALL without a function\0" as *const u8
                as *const libc::c_char,
            (*cvar).name,
        );
    }
    (*cvar).flags |= CV_ALLOWLUA as libc::c_int;
    (*cvar).flags |= CV_MODIFIED as libc::c_int;
    CV_RegisterVar(cvar);
    if (*cvar).flags & CV_MODIFIED as libc::c_int != 0 {
        return luaL_error(
            L,
            b"failed to register cvar (probable conflict with internal variable/command names)\0"
                as *const u8 as *const libc::c_char,
        );
    }
    return 1 as libc::c_int;
}
unsafe extern "C" fn lib_cvFindVar(mut L: *mut lua_State) -> libc::c_int {
    ...
    LUA_PushUserdata(
        L,
        CV_FindVar(name) as *mut libc::c_void,
        b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
    );
    return 1 as libc::c_int;
}
unsafe extern "C" fn CVarSetFunction(
    mut L: *mut lua_State,
    mut Set: Option::<unsafe extern "C" fn(*mut consvar_t, *const libc::c_char) -> ()>,
    mut SetValue: Option::<unsafe extern "C" fn(*mut consvar_t, int32_t) -> ()>,
) -> libc::c_int {
    let mut cvar: *mut consvar_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut consvar_t);
    if (*cvar).flags & CV_ALLOWLUA as libc::c_int == 0 {
        return luaL_error(
            L,
            b"Variable '%s' cannot be set from Lua.\0" as *const u8
                as *const libc::c_char,
            (*cvar).name,
        );
    }
    match lua_type(L, 2 as libc::c_int) {
        4 => {
            (Some(Set.expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(cvar, lua_tolstring(L, 2 as libc::c_int, 0 as *mut size_t));
        }
        3 => {
            (Some(SetValue.expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(cvar, lua_tonumber(L, 2 as libc::c_int));
        }
        _ => {
            return luaL_typerror(
                L,
                1 as libc::c_int,
                b"string or number\0" as *const u8 as *const libc::c_char,
            );
        }
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_cvSet(mut L: *mut lua_State) -> libc::c_int {
    return CVarSetFunction(
        L,
        Some(CV_Set as unsafe extern "C" fn(*mut consvar_t, *const libc::c_char) -> ()),
        Some(CV_SetValue as unsafe extern "C" fn(*mut consvar_t, int32_t) -> ()),
    );
}
unsafe extern "C" fn lib_cvStealthSet(mut L: *mut lua_State) -> libc::c_int {
    return CVarSetFunction(
        L,
        Some(
            CV_StealthSet
                as unsafe extern "C" fn(*mut consvar_t, *const libc::c_char) -> (),
        ),
        Some(CV_StealthSetValue as unsafe extern "C" fn(*mut consvar_t, int32_t) -> ()),
    );
}
unsafe extern "C" fn lib_cvAddValue(mut L: *mut lua_State) -> libc::c_int {
    let mut cvar: *mut consvar_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
    ...
    if (*cvar).flags & CV_ALLOWLUA as libc::c_int == 0 {
        return luaL_error(
            L,
            b"Variable %s cannot be set from Lua.\0" as *const u8 as *const libc::c_char,
            (*cvar).name,
        );
    }
    CV_AddValue(cvar, luaL_checknumber(L, 2 as libc::c_int));
    return 0 as libc::c_int;
}
unsafe extern "C" fn lib_consPrintf(mut L: *mut lua_State) -> libc::c_int {
    let mut n: libc::c_int = lua_gettop(L);
    ...
    if n < 2 as libc::c_int {
        return luaL_error(
            L,
            b"CONS_Printf requires at least two arguments: player and text.\0"
                as *const u8 as *const libc::c_char,
        );
    }
    plr = *(luaL_checkudata(
    ...
    while i <= n {
        ...
        if s.is_null() {
            return luaL_error(
                L,
                b"'tostring' must return a string to 'CONS_Printf'\0" as *const u8
                    as *const libc::c_char,
            );
        }
...
static mut lib: [luaL_Reg; 10] = unsafe {
    [
        {
            let mut init = luaL_Reg {
                name: b"COM_AddCommand\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_comAddCommand
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"COM_BufAddText\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_comBufAddText
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"COM_BufInsertText\0" as *const u8 as *const libc::c_char,
                func: Some(
        ...
        {
            let mut init = luaL_Reg {
                name: b"CV_RegisterVar\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_cvRegisterVar
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"CV_FindVar\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_cvFindVar as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"CV_Set\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_cvSet as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"CV_StealthSet\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_cvStealthSet
                        as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
        ...
        {
            let mut init = luaL_Reg {
                name: b"CV_AddValue\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_cvAddValue as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
        {
            let mut init = luaL_Reg {
                name: b"CONS_Printf\0" as *const u8 as *const libc::c_char,
                func: Some(
                    lib_consPrintf as unsafe extern "C" fn(*mut lua_State) -> libc::c_int,
                ),
            };
            init
        },
...
static mut cvar_opt: [*const libc::c_char; 7] = [
    b"name\0" as *const u8 as *const libc::c_char,
    b"defaultvalue\0" as *const u8 as *const libc::c_char,
...
static mut cvar_fields_ref: libc::c_int = -(2 as libc::c_int);
unsafe extern "C" fn cvar_get(mut L: *mut lua_State) -> libc::c_int {
    let mut cvar: *mut consvar_t = *(luaL_checkudata(
        L,
        1 as libc::c_int,
        b"CONSVAR_T*\0" as *const u8 as *const libc::c_char,
    ) as *mut *mut consvar_t);
    let mut field: cvar_e = Lua_optoption(
        L,
        2 as libc::c_int,
        -(1 as libc::c_int),
        cvar_fields_ref,
    ...
    match field as libc::c_uint {
        ...
        5 => {
            lua_pushboolean(L, (*cvar).changed as libc::c_int);
        }
        _ => {
            if devparm != 0 {
                return luaL_error(
                    L,
                    b"'consvar_t' has no field named '%s'.\0" as *const u8
                        as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn LUA_ConsoleLib(mut L: *mut lua_State) -> libc::c_int {
    luaL_newmetatable(L, b"CONSVAR_T*\0" as *const u8 as *const libc::c_char);
    lua_pushcclosure(
        L,
        Some(cvar_get as unsafe extern "C" fn(*mut lua_State) -> libc::c_int),
        0 as libc::c_int,
    );
    lua_setfield(
        L,
    ...
    lua_settop(L, -(1 as libc::c_int) - 1 as libc::c_int);
    cvar_fields_ref = Lua_CreateFieldTable(L, cvar_opt.as_ptr());
    ...
    lua_setfield(
        L,
        -(10000 as libc::c_int),
        b"CV_Vars\0" as *const u8 as *const libc::c_char,
    );
    lua_createtable(L, 0 as libc::c_int, 0 as libc::c_int);
    lua_setfield(
        L,
    ...
    lua_pushlightuserdata(L, CV_OnOff.as_mut_ptr() as *mut libc::c_void);
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"CV_OnOff\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(L, CV_YesNo.as_mut_ptr() as *mut libc::c_void);
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"CV_YesNo\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(L, CV_Unsigned.as_mut_ptr() as *mut libc::c_void);
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"CV_Unsigned\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(L, CV_Natural.as_mut_ptr() as *mut libc::c_void);
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"CV_Natural\0" as *const u8 as *const libc::c_char,
    );
    lua_pushlightuserdata(L, CV_TrueFalse.as_mut_ptr() as *mut libc::c_void);
    lua_setfield(
        L,
        -(10002 as libc::c_int),
        b"CV_TrueFalse\0" as *const u8 as *const libc::c_char,
    );
