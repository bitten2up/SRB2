...
extern "C" {
    ...
    fn fopenfile(_: *const libc::c_char, _: *const libc::c_char) -> *mut FILE;
    fn vsprintf(
        _: *mut libc::c_char,
        _: *const libc::c_char,
        _: ::core::ffi::VaList,
    ...
    fn CV_InitFilterVar();
    fn CV_ToggleExecVersion(enable: boolean);
    ...
    fn CV_SaveVariables(f: *mut FILE);
    ...
    static mut gamecontrolbisdefault: [[[int32_t; 2]; 43]; 3];
    fn G_ClearAllControlKeys();
    fn G_DefineDefaultControls();
    fn G_CopyControls(
    ...
    fn GIF_open(filename: *const libc::c_char) -> int32_t;
    fn GIF_frame();
    fn GIF_close() -> int32_t;
    fn Screenshot_option_Onchange();
    fn Moviemode_mode_Onchange();
    fn Moviemode_option_Onchange();
    ...
    fn png_write_info_before_PLTE(png_ptr: png_structrp, info_ptr: png_const_inforp);
...
static mut screenshot_cons_t: [CV_PossibleValue_t; 5] = [
    {
...
#[no_mangle]
pub static mut cv_screenshot_option: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"screenshot_option\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Default\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: screenshot_cons_t.as_ptr() as *mut _,
            func: Some(Screenshot_option_Onchange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_screenshot_folder: consvar_t = {
    let mut init = consvar_s {
        name: b"screenshot_folder\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_screenshot_colorprofile: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"screenshot_colorprofile\0" as *const u8 as *const libc::c_char,
...
static mut moviemode_cons_t: [CV_PossibleValue_t; 4] = [
    {
        let mut init = CV_PossibleValue_s {
            value: MM_GIF as libc::c_int,
            strvalue: b"GIF\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: MM_APNG as libc::c_int,
            strvalue: b"aPNG\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: MM_SCREENSHOT as libc::c_int,
            strvalue: b"Screenshots\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_moviemode: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"moviemode_mode\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"GIF\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: moviemode_cons_t.as_ptr() as *mut _,
            func: Some(Moviemode_mode_Onchange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_movie_option: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"movie_option\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Default\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int | CV_CALL as libc::c_int,
            PossibleValue: screenshot_cons_t.as_ptr() as *mut _,
            func: Some(Moviemode_option_Onchange as unsafe extern "C" fn() -> ()),
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
            revert: {
...
#[no_mangle]
pub static mut cv_movie_folder: consvar_t = {
    let mut init = consvar_s {
        name: b"movie_folder\0" as *const u8 as *const libc::c_char,
        defaultvalue: b"\0" as *const u8 as *const libc::c_char,
        flags: CV_SAVE as libc::c_int,
        PossibleValue: 0 as *const CV_PossibleValue_t as *mut CV_PossibleValue_t,
        func: None,
...
static mut zlib_mem_level_t: [CV_PossibleValue_t; 10] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"(Min Memory) 1\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"2\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"3\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"4\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"5\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"6\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"7\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"(Optimal) 8\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"(Max Memory) 9\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut zlib_level_t: [CV_PossibleValue_t; 11] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
            strvalue: b"No Compression\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"(Fastest) 1\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 6 as libc::c_int,
            strvalue: b"(Optimal) 6\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 8 as libc::c_int,
            strvalue: b"8\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 9 as libc::c_int,
            strvalue: b"(Maximum) 9\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut zlib_strategy_t: [CV_PossibleValue_t; 6] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 0 as libc::c_int,
    ...
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"Filtered\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"Huffman Only\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"RLE\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 4 as libc::c_int,
            strvalue: b"Fixed\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut zlib_window_bits_t: [CV_PossibleValue_t; 8] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 9 as libc::c_int,
            strvalue: b"512\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"1k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"2k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"4k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"8k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"16k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            ...
            strvalue: b"32k\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
static mut apng_delay_t: [CV_PossibleValue_t; 5] = [
    {
        let mut init = CV_PossibleValue_s {
            value: 1 as libc::c_int,
            strvalue: b"1x\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 2 as libc::c_int,
            strvalue: b"1/2x\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 3 as libc::c_int,
            strvalue: b"1/3x\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
        let mut init = CV_PossibleValue_s {
            value: 4 as libc::c_int,
            strvalue: b"1/4x\0" as *const u8 as *const libc::c_char,
        };
        init
    },
    {
...
#[no_mangle]
pub static mut cv_zlib_memory: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"png_memory_level\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"7\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_mem_level_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_zlib_level: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"png_compress_level\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"(Optimal) 6\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_level_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_zlib_strategy: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"png_strategy\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"Normal\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_strategy_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_zlib_window_bits: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"png_window_size\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"32k\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_window_bits_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_zlib_memorya: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_memory_level\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"(Max Memory) 9\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_mem_level_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_zlib_levela: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_compress_level\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut cv_zlib_strategya: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_strategy\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"RLE\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_strategy_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
...
#[no_mangle]
pub static mut cv_zlib_window_bitsa: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_window_size\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"32k\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: zlib_window_bits_t.as_ptr() as *mut _,
            func: None,
...
#[no_mangle]
pub static mut cv_apng_delay: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_speed\0" as *const u8 as *const libc::c_char,
            defaultvalue: b"1x\0" as *const u8 as *const libc::c_char,
            flags: CV_SAVE as libc::c_int,
            PossibleValue: apng_delay_t.as_ptr() as *mut _,
            func: None,
            value: 0 as libc::c_int,
            string: 0 as *const libc::c_char,
            zstring: 0 as *const libc::c_char as *mut libc::c_char,
...
#[no_mangle]
pub static mut cv_apng_downscale: consvar_t = unsafe {
    {
        let mut init = consvar_s {
            name: b"apng_downscale\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub static mut takescreenshot: boolean = false_0 as libc::c_int;
#[no_mangle]
pub static mut moviemode: moviemode_t = MM_OFF;
#[no_mangle]
pub unsafe extern "C" fn M_MapNumber(
    mut first: libc::c_char,
    mut second: libc::c_char,
) -> int32_t {
    if *(*__ctype_b_loc()).offset(first as libc::c_int as isize) as libc::c_int
        & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        if *(*__ctype_b_loc()).offset(second as libc::c_int as isize) as libc::c_int
            & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
        {
            return (first as int32_t - '0' as i32) * 10 as libc::c_int
                + (second as int32_t - '0' as i32);
        }
...
#[no_mangle]
pub unsafe extern "C" fn FIL_WriteFile(
    ...
    handle = fopen(name, b"w+b\0" as *const u8 as *const libc::c_char);
    if handle.is_null() {
        return false_0 as libc::c_int;
    }
    count = fwrite(source, 1 as libc::c_int as libc::c_ulong, length, handle);
    fclose(handle);
    if count < length {
        return false_0 as libc::c_int;
    }
...
#[no_mangle]
pub unsafe extern "C" fn FIL_ReadFileTag(
    mut name: *const libc::c_char,
    ...
    handle = fopenfile(name, b"rb\0" as *const u8 as *const libc::c_char);
    if handle.is_null() {
        return 0 as libc::c_int as size_t;
    }
    fseek(handle, 0 as libc::c_int as libc::c_long, 2 as libc::c_int);
    length = ftell(handle) as size_t;
    ...
    *buf.offset(length as isize) = 0 as libc::c_int as uint8_t;
    *buffer = buf;
    return length;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_ConvertTextFileToBinary(
    mut textfilename: *const libc::c_char,
    mut binfilename: *const libc::c_char,
) -> boolean {
    let mut textfile: *mut FILE = 0 as *mut FILE;
    let mut binfile: *mut FILE = 0 as *mut FILE;
    let mut buffer: [uint8_t; 1024] = [0; 1024];
    let mut count: size_t = 0;
    let mut success: boolean = 0;
    textfile = fopen(textfilename, b"r\0" as *const u8 as *const libc::c_char);
    if textfile.is_null() {
        return false_0 as libc::c_int;
    }
    binfile = fopen(binfilename, b"wb\0" as *const u8 as *const libc::c_char);
    if binfile.is_null() {
        fclose(textfile);
        return false_0 as libc::c_int;
    }
    ...
    success = !(ferror(textfile) != 0 || ferror(binfile) != 0) as libc::c_int;
    fclose(textfile);
    fclose(binfile);
    return success;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_FileExists(mut name: *const libc::c_char) -> boolean {
    return access(name, 0 as libc::c_int) + 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_WriteFileOK(mut name: *const libc::c_char) -> boolean {
    return access(name, 2 as libc::c_int) + 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_ReadFileOK(mut name: *const libc::c_char) -> boolean {
    return access(name, 4 as libc::c_int) + 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_FileOK(mut name: *const libc::c_char) -> boolean {
    return access(name, 6 as libc::c_int) + 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn FIL_DefaultExtension(
...
#[no_mangle]
pub unsafe extern "C" fn FIL_ForceExtension(
    mut path: *mut libc::c_char,
    mut extension: *const libc::c_char,
) {
    let mut src: *mut libc::c_char = 0 as *mut libc::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn FIL_CheckExtension(mut in_0: *const libc::c_char) -> boolean {
    loop {
        let fresh0 = in_0;
        in_0 = in_0.offset(1);
        if !(*fresh0 != 0) {
...
#[no_mangle]
pub static mut configfile: [libc::c_char; 512] = [0; 512];
static mut gameconfig_loaded: boolean = false_0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn Command_SaveConfig_f() {
    let mut tmpstr: [libc::c_char; 512] = [0; 512];
    if COM_Argc() < 2 as libc::c_int as size_t {
        CONS_Printf(
            b"saveconfig <filename[.cfg]> [-silent] : save config to a file\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
    strcpy(tmpstr.as_mut_ptr(), COM_Argv(1 as libc::c_int as size_t));
    FIL_ForceExtension(
        tmpstr.as_mut_ptr(),
        b".cfg\0" as *const u8 as *const libc::c_char,
    );
    M_SaveConfig(tmpstr.as_mut_ptr());
    if strcasecmp(
...
#[no_mangle]
pub unsafe extern "C" fn Command_LoadConfig_f() {
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"loadconfig <filename[.cfg]> : load config from a file\n\0" as *const u8
                as *const libc::c_char,
        );
        return;
    }
    strcpy(configfile.as_mut_ptr(), COM_Argv(1 as libc::c_int as size_t));
    FIL_ForceExtension(
        configfile.as_mut_ptr(),
        b".cfg\0" as *const u8 as *const libc::c_char,
    );
    ...
    G_CopyControls(
        ...
        (gamecontroldefault[gcs_fps as libc::c_int as usize]).as_mut_ptr(),
        0 as *const int32_t,
        0 as libc::c_int,
    );
    G_CopyControls(
        gamecontrolbis.as_mut_ptr(),
        (gamecontrolbisdefault[gcs_fps as libc::c_int as usize]).as_mut_ptr(),
        0 as *const int32_t,
        0 as libc::c_int,
    );
    CV_ToggleExecVersion(true_0 as libc::c_int);
    COM_BufInsertTextEx(
        va(
            b"%s \"%s\"\n\0" as *const u8 as *const libc::c_char,
            cv_execversion.name,
            cv_execversion.defaultvalue,
        ),
        0 as com_flags_t,
    );
    CV_InitFilterVar();
    ...
    CV_ToggleExecVersion(false_0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Command_ChangeConfig_f() {
    if COM_Argc() != 2 as libc::c_int as size_t {
        CONS_Printf(
            b"changeconfig <filename[.cfg]> : save current config and load another\n\0"
                as *const u8 as *const libc::c_char,
        );
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn M_FirstLoadConfig() {
    if M_CheckParm(b"-config\0" as *const u8 as *const libc::c_char) != 0
        && M_IsNextParm() != 0
    {
        strcpy(configfile.as_mut_ptr(), M_GetNextParm());
        CONS_Printf(
            b"config file: %s\n\0" as *const u8 as *const libc::c_char,
            configfile.as_mut_ptr(),
        );
    ...
    CV_RegisterVar(&mut cv_execversion);
    CV_ToggleExecVersion(true_0 as libc::c_int);
    COM_BufInsertTextEx(
        va(
            b"%s \"%s\"\n\0" as *const u8 as *const libc::c_char,
    ...
    CV_ToggleExecVersion(false_0 as libc::c_int);
    gameconfig_loaded = true_0 as libc::c_int;
    if dedicated == 0 {
        COM_BufAddTextEx(
            va(
                b"%s \"%s\"\n\0" as *const u8 as *const libc::c_char,
                cv_skin.name,
                cv_defaultskin.string,
            ),
            0 as com_flags_t,
        );
        COM_BufAddTextEx(
        ...
        COM_BufAddTextEx(
            va(
                b"%s \"%s\"\n\0" as *const u8 as *const libc::c_char,
                cv_playercolor2.name,
                cv_defaultplayercolor2.string,
            ),
            0 as com_flags_t,
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn M_SaveConfig(mut filename: *const libc::c_char) {
    let mut f: *mut FILE = 0 as *mut FILE;
    let mut filepath: *mut libc::c_char = 0 as *mut libc::c_char;
    if gameconfig_loaded == 0 {
        return;
    }
    if !filename.is_null() {
        if (strstr(filename, b".cfg\0" as *const u8 as *const libc::c_char)).is_null() {
            CONS_Alert(
                CONS_NOTICE,
                b"Config filename must be .cfg\n\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
        if (strstr(filename, srb2home.as_mut_ptr())).is_null() {
            filepath = va(pandf, srb2home.as_mut_ptr(), filename);
        } else {
            filepath = Z_StrDup(filename);
        }
        f = fopen(filepath, b"w\0" as *const u8 as *const libc::c_char);
        if !f.is_null() {
            strcpy(configfile.as_mut_ptr(), filepath);
        } else {
            CONS_Alert(
                CONS_ERROR,
                b"Couldn't save game config file %s\n\0" as *const u8
                    as *const libc::c_char,
                filepath,
            );
            return;
        ...
        f = fopen(configfile.as_mut_ptr(), b"w\0" as *const u8 as *const libc::c_char);
        if f.is_null() {
            CONS_Alert(
                CONS_ERROR,
                b"Couldn't save game config file %s\n\0" as *const u8
    ...
    fprintf(f, b"// SRB2 configuration file.\n\0" as *const u8 as *const libc::c_char);
    fprintf(
        f,
        b"%s \"%d\"\n\0" as *const u8 as *const libc::c_char,
        cv_execversion.name,
    ...
    if dedicated == 0 {
        if tutorialmode != 0 && tutorialgcs != 0 {
            ...
            G_SaveKeySetting(f, gamecontrol.as_mut_ptr(), gamecontrolbis.as_mut_ptr());
        }
    }
    fclose(f);
}
static mut screenshot_palette: [uint8_t; 768] = [0; 768];
unsafe extern "C" fn M_CreateScreenShotPalette() {
    let mut i: size_t = 0;
    let mut j: size_t = 0;
    i = 0 as libc::c_int as size_t;
    j = 0 as libc::c_int as size_t;
    while i < 768 as libc::c_int as size_t {
        let mut locpal: RGBA_t = if cv_screenshot_colorprofile.value != 0 {
            *pLocalPalette
                .offset(
                    (((if st_palette > 0 as libc::c_int {
                        st_palette
                    } else {
                        0 as libc::c_int
        ...
        screenshot_palette[i as usize] = locpal.s.red;
        screenshot_palette[i.wrapping_add(1 as libc::c_int as size_t)
            as usize] = locpal.s.green;
        screenshot_palette[i.wrapping_add(2 as libc::c_int as size_t)
            as usize] = locpal.s.blue;
        i = i.wrapping_add(3 as libc::c_int as size_t);
        j = j.wrapping_add(1);
        j;
    }
}
unsafe extern "C" fn Newsnapshotfile(
    mut pathname: *const libc::c_char,
    mut ext: *const libc::c_char,
) -> *const libc::c_char {
    static mut freename: [libc::c_char; 13] = unsafe {
        *::core::mem::transmute::<&[u8; 13], &mut [libc::c_char; 13]>(b"srb2XXXX.ext\0")
    };
    let mut i: libc::c_int = 5000 as libc::c_int;
    let mut add: libc::c_int = i;
    let mut result: libc::c_int = 0;
    strcpy(freename.as_mut_ptr().offset(9 as libc::c_int as isize), ext);
    loop {
        freename[4 as libc::c_int
            as usize] = ('0' as i32
            + (i / 1000 as libc::c_int) as libc::c_char as libc::c_int) as libc::c_char;
        freename[5 as libc::c_int
            as usize] = ('0' as i32
            + (i / 100 as libc::c_int % 10 as libc::c_int) as libc::c_char
                as libc::c_int) as libc::c_char;
        freename[6 as libc::c_int
            as usize] = ('0' as i32
            + (i / 10 as libc::c_int % 10 as libc::c_int) as libc::c_char as libc::c_int)
            as libc::c_char;
        freename[7 as libc::c_int
            as usize] = ('0' as i32
            + (i % 10 as libc::c_int) as libc::c_char as libc::c_int) as libc::c_char;
        if FIL_WriteFileOK(va(pandf, pathname, freename.as_mut_ptr())) != 0 {
            ...
            freename[4 as libc::c_int
                as usize] = ('0' as i32
                + ((i - 1 as libc::c_int) / 1000 as libc::c_int) as libc::c_char
                    as libc::c_int) as libc::c_char;
            freename[5 as libc::c_int
                as usize] = ('0' as i32
                + ((i - 1 as libc::c_int) / 100 as libc::c_int % 10 as libc::c_int)
                    as libc::c_char as libc::c_int) as libc::c_char;
            freename[6 as libc::c_int
                as usize] = ('0' as i32
                + ((i - 1 as libc::c_int) / 10 as libc::c_int % 10 as libc::c_int)
                    as libc::c_char as libc::c_int) as libc::c_char;
            freename[7 as libc::c_int
                as usize] = ('0' as i32
                + ((i - 1 as libc::c_int) % 10 as libc::c_int) as libc::c_char
                    as libc::c_int) as libc::c_char;
            if !(FIL_WriteFileOK(va(pandf, pathname, freename.as_mut_ptr())) == 0) {
                break;
            }
        ...
        i += add * result;
        if i < 0 as libc::c_int || i > 9999 as libc::c_int {
    ...
    freename[5 as libc::c_int
        as usize] = ('0' as i32
        + (i / 100 as libc::c_int % 10 as libc::c_int) as libc::c_char as libc::c_int)
        as libc::c_char;
    freename[6 as libc::c_int
        as usize] = ('0' as i32
        + (i / 10 as libc::c_int % 10 as libc::c_int) as libc::c_char as libc::c_int)
        as libc::c_char;
    freename[7 as libc::c_int
        as usize] = ('0' as i32 + (i % 10 as libc::c_int) as libc::c_char as libc::c_int)
        as libc::c_char;
    return freename.as_mut_ptr();
}
...
unsafe extern "C" fn M_PNGhdr(
    mut png_ptr: png_structp,
    mut png_info_ptr: png_infop,
    width: png_uint_32,
    height: png_uint_32,
    mut palette: *const png_byte,
) {
    let png_interlace: png_byte = 0 as libc::c_int as png_byte;
    if !palette.is_null() {
        let mut png_PLTE: png_colorp = png_malloc(
            png_ptr as *const png_struct,
            (::core::mem::size_of::<png_color>() as libc::c_ulong)
                .wrapping_mul(256 as libc::c_int as libc::c_ulong),
        ) as png_colorp;
        let mut pal: *const png_byte = palette;
        let mut i: png_uint_16 = 0;
        i = 0 as libc::c_int as png_uint_16;
        while (i as libc::c_int) < 256 as libc::c_int {
            (*png_PLTE.offset(i as isize)).red = *pal;
            pal = pal.offset(1);
            pal;
            (*png_PLTE.offset(i as isize)).green = *pal;
            pal = pal.offset(1);
            pal;
            (*png_PLTE.offset(i as isize)).blue = *pal;
            pal = pal.offset(1);
            pal;
            i = i.wrapping_add(1);
            i;
        ...
        png_set_IHDR(
            ...
            png_interlace as libc::c_int,
            0 as libc::c_int,
            0 as libc::c_int,
        );
        png_write_info_before_PLTE(png_ptr, png_info_ptr as *const png_info);
        png_set_PLTE(
            png_ptr,
            png_info_ptr,
            png_PLTE as png_const_colorp,
            256 as libc::c_int,
        );
        png_free(png_ptr as *const png_struct, png_PLTE as png_voidp);
        png_set_filter(png_ptr, 0 as libc::c_int, 0x8 as libc::c_int);
        png_set_compression_strategy(png_ptr, 0 as libc::c_int);
    } else {
        png_set_IHDR(
            png_ptr as *const png_struct,
            png_info_ptr,
        ...
        png_write_info_before_PLTE(png_ptr, png_info_ptr as *const png_info);
        png_set_compression_strategy(png_ptr, 1 as libc::c_int);
    };
}
unsafe extern "C" fn M_PNGText(
    mut png_ptr: png_structp,
    mut png_info_ptr: png_infop,
    movie: png_byte,
) {
    let mut png_infotext: [png_text; 11] = [png_text_struct {
        compression: 0,
        ...
        lang_key: 0 as *mut libc::c_char,
    }; 11];
    let mut keytxt: [[libc::c_char; 12]; 11] = [
        *::core::mem::transmute::<
            &[u8; 12],
            &mut [libc::c_char; 12],
        >(b"Title\0\0\0\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 12], &mut [libc::c_char; 12]>(b"Description\0"),
        *::core::mem::transmute::<&[u8; 12], &mut [libc::c_char; 12]>(b"Playername\0\0"),
        *::core::mem::transmute::<
            &[u8; 12],
            &mut [libc::c_char; 12],
        >(b"Mapnum\0\0\0\0\0\0"),
        *::core::mem::transmute::<
            &[u8; 12],
            &mut [libc::c_char; 12],
        >(b"Mapname\0\0\0\0\0"),
        ...
        *::core::mem::transmute::<
            ...
            &mut [libc::c_char; 12],
        >(b"Interface\0\0\0"),
        *::core::mem::transmute::<&[u8; 12], &mut [libc::c_char; 12]>(b"Render Mode\0"),
        *::core::mem::transmute::<
            &[u8; 12],
            &mut [libc::c_char; 12],
        >(b"Revision\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 12], &mut [libc::c_char; 12]>(b"Build Date\0\0"),
        *::core::mem::transmute::<&[u8; 12], &mut [libc::c_char; 12]>(b"Build Time\0\0"),
    ];
    let mut titletxt: [libc::c_char; 27] = *::core::mem::transmute::<
        &[u8; 27],
        &mut [libc::c_char; 27],
    >(b"Sonic Robo Blast 2 v2.2.13\0");
    let mut playertxt: png_charp = cv_playername.zstring;
    let mut desctxt: [libc::c_char; 16] = *::core::mem::transmute::<
        &[u8; 16],
        &mut [libc::c_char; 16],
    >(b"SRB2 Screenshot\0");
    let mut Movietxt: [libc::c_char; 11] = *::core::mem::transmute::<
        &[u8; 11],
        &mut [libc::c_char; 11],
    >(b"SRB2 Movie\0");
    let mut i: size_t = 0;
    let mut interfacetxt: [libc::c_char; 8] = *::core::mem::transmute::<
        &[u8; 8],
        &mut [libc::c_char; 8],
    >(b"Unknown\0");
    let mut rendermodetxt: [libc::c_char; 9] = [0; 9];
    let mut maptext: [libc::c_char; 8] = [0; 8];
    let mut lvlttltext: [libc::c_char; 48] = [0; 48];
    let mut locationtxt: [libc::c_char; 40] = [0; 40];
    let mut ctrevision: [libc::c_char; 40] = [0; 40];
    let mut ctdate: [libc::c_char; 40] = [0; 40];
    let mut cttime: [libc::c_char; 40] = [0; 40];
    match rendermode as libc::c_uint {
        1 => {
            strcpy(
                rendermodetxt.as_mut_ptr(),
    ...
    if gamestate as libc::c_uint == GS_LEVEL as libc::c_int as libc::c_uint
        && (*mapheaderinfo[(gamemap as libc::c_int - 1 as libc::c_int) as usize])
            .lvlttl[0 as libc::c_int as usize] as libc::c_int != '\0' as i32
    {
        snprintf(
            lvlttltext.as_mut_ptr(),
    ...
    {
        snprintf(
            locationtxt.as_mut_ptr(),
            40 as libc::c_int as libc::c_ulong,
            b"X:%d Y:%d Z:%d A:%d\0" as *const u8 as *const libc::c_char,
            (*players[displayplayer as usize].mo).x >> 16 as libc::c_int,
            (*players[displayplayer as usize].mo).y >> 16 as libc::c_int,
            (*players[displayplayer as usize].mo).z >> 16 as libc::c_int,
            FixedInt(AngleFixed((*players[displayplayer as usize].mo).angle)),
        );
    } else {
        snprintf(
            locationtxt.as_mut_ptr(),
    ...
    memset(
        png_infotext.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[png_text; 11]>() as libc::c_ulong,
    );
    i = 0 as libc::c_int as size_t;
    while i < 11 as libc::c_int as size_t {
        png_infotext[i as usize].key = (keytxt[i as usize]).as_mut_ptr();
        i = i.wrapping_add(1);
        i;
    }
    png_infotext[0 as libc::c_int as usize].text = titletxt.as_mut_ptr();
    if movie != 0 {
        png_infotext[1 as libc::c_int as usize].text = Movietxt.as_mut_ptr();
    } else {
        png_infotext[1 as libc::c_int as usize].text = desctxt.as_mut_ptr();
    }
    png_infotext[2 as libc::c_int as usize].text = playertxt;
    png_infotext[3 as libc::c_int as usize].text = maptext.as_mut_ptr();
    png_infotext[4 as libc::c_int as usize].text = lvlttltext.as_mut_ptr();
    png_infotext[5 as libc::c_int as usize].text = locationtxt.as_mut_ptr();
    png_infotext[6 as libc::c_int as usize].text = interfacetxt.as_mut_ptr();
    png_infotext[7 as libc::c_int as usize].text = rendermodetxt.as_mut_ptr();
    png_infotext[8 as libc::c_int as usize]
        .text = strncpy(
        ctrevision.as_mut_ptr(),
        comprevision,
        (::core::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
    );
    png_infotext[9 as libc::c_int as usize]
        .text = strncpy(
        ctdate.as_mut_ptr(),
        compdate,
        (::core::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong)
    ...
    png_infotext[10 as libc::c_int as usize]
        .text = strncpy(
        cttime.as_mut_ptr(),
        comptime,
        (::core::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong)
    ...
    png_set_text(
        png_ptr as *const png_struct,
        png_info_ptr,
        png_infotext.as_mut_ptr() as png_const_textp,
        11 as libc::c_int,
    );
}
#[inline]
unsafe extern "C" fn M_PNGImage(
    mut png_ptr: png_structp,
    mut png_info_ptr: png_infop,
    height: png_uint_32,
    mut png_buf: png_bytep,
) {
    let mut pitch: png_uint_32 = png_get_rowbytes(
        png_ptr as *const png_struct,
        png_info_ptr as *const png_info,
    ) as png_uint_32;
    let mut row_pointers: png_bytepp = png_malloc(
        png_ptr as *const png_struct,
    ...
    while y < height {
        let ref mut fresh1 = *row_pointers.offset(y as isize);
        *fresh1 = png_buf;
        png_buf = png_buf.offset(pitch as isize);
        y = y.wrapping_add(1);
        y;
    }
    png_write_image(png_ptr, row_pointers);
    png_free(png_ptr as *const png_struct, row_pointers as png_voidp);
}
#[inline]
unsafe extern "C" fn M_StartMovieAPNG(mut pathname: *const libc::c_char) -> moviemode_t {
    CONS_Alert(
        CONS_ERROR,
        b"Couldn't create aPNG: this build lacks aPNG support\n\0" as *const u8
            as *const libc::c_char,
    );
    return MM_OFF;
}
#[inline]
unsafe extern "C" fn M_StartMovieGIF(mut pathname: *const libc::c_char) -> moviemode_t {
    let mut freename: *const libc::c_char = 0 as *const libc::c_char;
    freename = Newsnapshotfile(pathname, b"gif\0" as *const u8 as *const libc::c_char);
    if freename.is_null() {
        CONS_Alert(
            CONS_ERROR,
            b"Couldn't create GIF: no slots open in %s\n\0" as *const u8
                as *const libc::c_char,
            pathname,
        );
        return MM_OFF;
    }
    if GIF_open(va(pandf, pathname, freename)) == 0 {
        CONS_Alert(
            CONS_ERROR,
            b"Couldn't create GIF: error creating %s in %s\n\0" as *const u8
                as *const libc::c_char,
            freename,
            pathname,
        );
...
#[no_mangle]
pub unsafe extern "C" fn M_StartMovie() {
    let mut pathname: [libc::c_char; 512] = [0; 512];
    if moviemode as u64 != 0 {
        return;
    }
    if cv_movie_option.value == 0 as libc::c_int {
        strcpy(
            pathname.as_mut_ptr(),
            if usehome != 0 { srb2home.as_mut_ptr() } else { srb2path.as_mut_ptr() },
        );
    } else if cv_movie_option.value == 1 as libc::c_int {
        strcpy(pathname.as_mut_ptr(), srb2home.as_mut_ptr());
    } else if cv_movie_option.value == 2 as libc::c_int {
        strcpy(pathname.as_mut_ptr(), srb2path.as_mut_ptr());
    } else if cv_movie_option.value == 3 as libc::c_int
        && *cv_movie_folder.string as libc::c_int != '\0' as i32
    {
        strcpy(pathname.as_mut_ptr(), cv_movie_folder.string);
    }
    if cv_movie_option.value != 3 as libc::c_int {
        strcat(pathname.as_mut_ptr(), b"/movies/\0" as *const u8 as *const libc::c_char);
        I_mkdir(pathname.as_mut_ptr(), 0o755 as libc::c_int);
    }
    if rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint {
        I_Error(
            b"Can't make a movie without a render system\n\0" as *const u8
                as *const libc::c_char,
        );
    }
    match cv_moviemode.value {
        2 => {
            moviemode = M_StartMovieGIF(pathname.as_mut_ptr());
        }
        1 => {
            moviemode = M_StartMovieAPNG(pathname.as_mut_ptr());
        }
        3 => {
    ...
    if moviemode as libc::c_uint == MM_APNG as libc::c_int as libc::c_uint {
        CONS_Printf(
            b"Movie mode enabled (%s).\n\0" as *const u8 as *const libc::c_char,
            b"aPNG\0" as *const u8 as *const libc::c_char,
        );
    } else if moviemode as libc::c_uint == MM_GIF as libc::c_int as libc::c_uint {
        CONS_Printf(
            b"Movie mode enabled (%s).\n\0" as *const u8 as *const libc::c_char,
            b"GIF\0" as *const u8 as *const libc::c_char,
        );
    } else if moviemode as libc::c_uint == MM_SCREENSHOT as libc::c_int as libc::c_uint {
        CONS_Printf(
            b"Movie mode enabled (%s).\n\0" as *const u8 as *const libc::c_char,
            b"screenshots\0" as *const u8 as *const libc::c_char,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn M_SaveFrame() {
    static mut oldtic: tic_t = 0 as libc::c_int as tic_t;
    if oldtic == I_GetTime() {
        return
    } else {
        oldtic = I_GetTime();
    }
    match moviemode as libc::c_uint {
        3 => {
            takescreenshot = true_0 as libc::c_int;
            return;
        }
        2 => {
            GIF_frame();
...
#[no_mangle]
pub unsafe extern "C" fn M_StopMovie() {
    match moviemode as libc::c_uint {
        2 => {
            if GIF_close() == 0 {
                return;
    ...
    moviemode = MM_OFF;
    CONS_Printf(b"Movie mode disabled.\n\0" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn M_SavePNG(
    mut filename: *const libc::c_char,
    mut data: *mut libc::c_void,
    mut width: libc::c_int,
    mut height: libc::c_int,
    mut palette: *const uint8_t,
) -> boolean {
    let mut png_ptr: png_structp = 0 as *mut png_struct;
    let mut png_info_ptr: png_infop = 0 as *mut png_info;
    let mut PLTE: *const png_byte = palette as *const png_byte;
    let mut png_FILE: png_FILE_p = 0 as *mut FILE;
    png_FILE = fopen(filename, b"wb\0" as *const u8 as *const libc::c_char);
    if png_FILE.is_null() {
        CONS_Debug(
            0x8 as libc::c_int,
            b"M_SavePNG: Error on opening %s for write\n\0" as *const u8
                as *const libc::c_char,
            filename,
        );
        return false_0 as libc::c_int;
    ...
    if png_ptr.is_null() {
        CONS_Debug(
            0x8 as libc::c_int,
            b"M_SavePNG: Error on initialize libpng\n\0" as *const u8
                as *const libc::c_char,
        );
        fclose(png_FILE);
        remove(filename);
    ...
    if png_info_ptr.is_null() {
        CONS_Debug(
            0x8 as libc::c_int,
            b"M_SavePNG: Error on allocate for libpng\n\0" as *const u8
                as *const libc::c_char,
        );
        png_destroy_write_struct(&mut png_ptr, 0 as png_infopp);
        fclose(png_FILE);
        remove(filename);
        return false_0 as libc::c_int;
    }
    ...
    {
        png_destroy_write_struct(&mut png_ptr, &mut png_info_ptr);
        fclose(png_FILE);
        remove(filename);
        return false_0 as libc::c_int;
    }
    ...
    png_set_user_limits(
        png_ptr,
        1920 as libc::c_int as png_uint_32,
        1200 as libc::c_int as png_uint_32,
    );
    ...
    M_PNGhdr(png_ptr, png_info_ptr, width as png_uint_32, height as png_uint_32, PLTE);
    M_PNGText(png_ptr, png_info_ptr, false_0 as libc::c_int as png_byte);
    png_write_info(png_ptr, png_info_ptr as *const png_info);
    M_PNGImage(png_ptr, png_info_ptr, height as png_uint_32, data as png_bytep);
...
#[no_mangle]
pub unsafe extern "C" fn M_DoScreenShot() {
    let mut freename: *const libc::c_char = 0 as *const libc::c_char;
    let mut pathname: [libc::c_char; 512] = [0; 512];
    let mut ret: boolean = false_0 as libc::c_int;
    let mut linear: *mut uint8_t = 0 as *mut uint8_t;
    takescreenshot = false_0 as libc::c_int;
    if rendermode as libc::c_uint == render_none as libc::c_int as libc::c_uint {
        return;
    }
    if cv_screenshot_option.value == 0 as libc::c_int {
        strcpy(
            pathname.as_mut_ptr(),
            if usehome != 0 { srb2home.as_mut_ptr() } else { srb2path.as_mut_ptr() },
        );
    } else if cv_screenshot_option.value == 1 as libc::c_int {
        strcpy(pathname.as_mut_ptr(), srb2home.as_mut_ptr());
    } else if cv_screenshot_option.value == 2 as libc::c_int {
        strcpy(pathname.as_mut_ptr(), srb2path.as_mut_ptr());
    } else if cv_screenshot_option.value == 3 as libc::c_int
        && *cv_screenshot_folder.string as libc::c_int != '\0' as i32
    {
        strcpy(pathname.as_mut_ptr(), cv_screenshot_folder.string);
    }
    if cv_screenshot_option.value != 3 as libc::c_int {
        strcat(
            pathname.as_mut_ptr(),
            b"/screenshots/\0" as *const u8 as *const libc::c_char,
        );
    ...
    freename = Newsnapshotfile(
        pathname.as_mut_ptr(),
        b"png\0" as *const u8 as *const libc::c_char,
    );
    if rendermode as libc::c_uint == render_soft as libc::c_int as libc::c_uint {
        linear = screens[2 as libc::c_int as usize];
        I_ReadScreen(linear);
    }
    if !freename.is_null() {
        M_CreateScreenShotPalette();
        ret = M_SavePNG(
            va(pandf, pathname.as_mut_ptr(), freename),
            linear as *mut libc::c_void,
            vid.width,
            vid.height,
            screenshot_palette.as_mut_ptr(),
        );
    }
    if ret != 0 {
        if moviemode as libc::c_uint != MM_SCREENSHOT as libc::c_int as libc::c_uint {
            CONS_Printf(
                b"Screen shot %s saved in %s\n\0" as *const u8 as *const libc::c_char,
                freename,
                pathname.as_mut_ptr(),
            );
        }
        ...
        if !freename.is_null() {
            CONS_Alert(
                CONS_ERROR,
                b"Couldn't create screen shot %s in %s\n\0" as *const u8
                    as *const libc::c_char,
                freename,
                pathname.as_mut_ptr(),
            );
            ...
            CONS_Alert(
                CONS_ERROR,
                b"Couldn't create screen shot in %s (all 10000 slots used!)\n\0"
                    as *const u8 as *const libc::c_char,
                pathname.as_mut_ptr(),
            );
        }
...
#[no_mangle]
pub unsafe extern "C" fn M_ScreenshotResponder(mut ev: *mut event_t) -> boolean {
    ...
    ch = (*ev).key;
    if ch >= KEY_MOUSE1 as libc::c_int && menuactive != 0 {
        return false_0 as libc::c_int;
    }
    if ch == 0x80 as libc::c_int + 0x42 as libc::c_int
        || ch
            == gamecontrol[GC_SCREENSHOT as libc::c_int
    ...
    {
        M_ScreenShot();
    } else if ch == 0x80 as libc::c_int + 0x43 as libc::c_int
        || ch
            == gamecontrol[GC_RECORDGIF as libc::c_int
                as usize][0 as libc::c_int as usize]
        || ch
            == gamecontrol[GC_RECORDGIF as libc::c_int
                as usize][1 as libc::c_int as usize]
    {
        if moviemode as libc::c_uint != 0 {
            Some(M_StopMovie as unsafe extern "C" fn() -> ())
        } else {
            Some(M_StartMovie as unsafe extern "C" fn() -> ())
        }
...
#[no_mangle]
pub unsafe extern "C" fn M_StartupLocale() {
    CONS_Printf(b"M_StartupLocale...\n\0" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn strcatbf(
    mut s1: *mut libc::c_char,
    mut s2: *const libc::c_char,
    mut s3: *const libc::c_char,
) {
    let mut tmp: [libc::c_char; 1024] = [0; 1024];
    strcpy(tmp.as_mut_ptr(), s1);
    strcpy(s1, s2);
    strcat(s1, s3);
    strcat(s1, tmp.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn axtoi(mut hexStg: *const libc::c_char) -> int32_t {
    let mut n: int32_t = 0 as libc::c_int;
    let mut m: int32_t = 0 as libc::c_int;
    let mut count: int32_t = 0;
    let mut intValue: int32_t = 0 as libc::c_int;
    let mut digit: [int32_t; 8] = [0; 8];
    while n < 8 as libc::c_int {
        if *hexStg.offset(n as isize) as libc::c_int == '\0' as i32 {
            break;
        }
        if *hexStg.offset(n as isize) as libc::c_int >= '0' as i32
            && *hexStg.offset(n as isize) as libc::c_int <= '9' as i32
        {
            digit[n
                as usize] = *hexStg.offset(n as isize) as libc::c_int
                & 0xf as libc::c_int;
        } else if *hexStg.offset(n as isize) as libc::c_int >= 'a' as i32
            && *hexStg.offset(n as isize) as libc::c_int <= 'f' as i32
        {
            digit[n
                as usize] = (*hexStg.offset(n as isize) as libc::c_int
                & 0xf as libc::c_int) + 9 as libc::c_int;
        } else {
            if !(*hexStg.offset(n as isize) as libc::c_int >= 'A' as i32
                && *hexStg.offset(n as isize) as libc::c_int <= 'F' as i32)
            {
                break;
            }
    ...
    n = 0 as libc::c_int;
    while n < count {
        intValue = intValue | digit[n as usize] << (m << 2 as libc::c_int);
        m -= 1;
        m;
        n += 1;
        n;
...
static mut oldendPos: uint32_t = 0 as libc::c_int as uint32_t;
static mut endPos: uint32_t = 0 as libc::c_int as uint32_t;
#[no_mangle]
pub unsafe extern "C" fn M_GetToken(
    mut inputString: *const libc::c_char,
) -> *mut libc::c_char {
    static mut stringToUse: *const libc::c_char = 0 as *const libc::c_char;
    static mut startPos: uint32_t = 0 as libc::c_int as uint32_t;
    static mut stringLength: uint32_t = 0 as libc::c_int as uint32_t;
    static mut inComment: uint8_t = 0 as libc::c_int as uint8_t;
    let mut texturesToken: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut texturesTokenLength: uint32_t = 0 as libc::c_int as uint32_t;
    if !inputString.is_null() {
        stringToUse = inputString;
        startPos = 0 as libc::c_int as uint32_t;
        endPos = 0 as libc::c_int as uint32_t;
        oldendPos = endPos;
        stringLength = strlen(inputString) as uint32_t;
    } else {
        oldendPos = endPos;
        startPos = oldendPos;
    }
    if stringToUse.is_null() {
        return 0 as *mut libc::c_char;
    }
    if startPos < stringLength.wrapping_sub(1 as libc::c_int as uint32_t)
        && inComment as libc::c_int == 0 as libc::c_int
    {
        if *stringToUse.offset(startPos as isize) as libc::c_int == '/' as i32
            && *stringToUse
                .offset(startPos.wrapping_add(1 as libc::c_int as uint32_t) as isize)
                as libc::c_int == '/' as i32
        {
            inComment = 1 as libc::c_int as uint8_t;
        } else if *stringToUse.offset(startPos as isize) as libc::c_int == '/' as i32
            && *stringToUse
                .offset(startPos.wrapping_add(1 as libc::c_int as uint32_t) as isize)
                as libc::c_int == '*' as i32
        {
            inComment = 2 as libc::c_int as uint8_t;
        }
    }
    while (*stringToUse.offset(startPos as isize) as libc::c_int == ' ' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == '\t' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == '\r' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == '\n' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == '\0' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == '=' as i32
        || *stringToUse.offset(startPos as isize) as libc::c_int == ';' as i32
        || inComment as libc::c_int != 0 as libc::c_int) && startPos < stringLength
    {
        if inComment as libc::c_int == 1 as libc::c_int
            && *stringToUse.offset(startPos as isize) as libc::c_int == '\n' as i32
        {
            inComment = 0 as libc::c_int as uint8_t;
        } else if inComment as libc::c_int == 2 as libc::c_int
            && startPos < stringLength.wrapping_sub(1 as libc::c_int as uint32_t)
            && *stringToUse.offset(startPos as isize) as libc::c_int == '*' as i32
            && *stringToUse
                .offset(startPos.wrapping_add(1 as libc::c_int as uint32_t) as isize)
                as libc::c_int == '/' as i32
    ...
    if startPos == stringLength {
        ...
        || *stringToUse.offset(startPos as isize) as libc::c_int == '}' as i32
    {
        endPos = startPos.wrapping_add(1 as libc::c_int as uint32_t);
        texturesToken = Z_MallocAlign(
        ...
        *texturesToken
            .offset(0 as libc::c_int as isize) = *stringToUse.offset(startPos as isize);
        *texturesToken.offset(1 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
        return texturesToken;
    } else if *stringToUse.offset(startPos as isize) as libc::c_int == '"' as i32 {
        startPos = startPos.wrapping_add(1);
        endPos = startPos;
        while *stringToUse.offset(endPos as isize) as libc::c_int != '"' as i32
            && endPos < stringLength
        {
            endPos = endPos.wrapping_add(1);
            endPos;
        }
        let fresh2 = endPos;
        endPos = endPos.wrapping_add(1);
        texturesTokenLength = fresh2.wrapping_sub(startPos);
        texturesToken = Z_MallocAlign(
            (texturesTokenLength.wrapping_add(1 as libc::c_int as uint32_t)
                as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<libc::c_char>() as libc::c_ulong),
            PU_STATIC as libc::c_int,
            0 as *mut libc::c_void,
        ...
        M_Memcpy
            ...
            texturesToken as *mut libc::c_void,
            stringToUse.offset(startPos as isize) as *const libc::c_void,
            texturesTokenLength as size_t,
        );
        *texturesToken
            .offset(texturesTokenLength as isize) = '\0' as i32 as libc::c_char;
        return texturesToken;
    }
    endPos = startPos.wrapping_add(1 as libc::c_int as uint32_t);
    while *stringToUse.offset(endPos as isize) as libc::c_int != ' ' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '\t' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '\r' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '\n' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != ',' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '{' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '}' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != '=' as i32
        && *stringToUse.offset(endPos as isize) as libc::c_int != ';' as i32
        && inComment as libc::c_int == 0 as libc::c_int && endPos < stringLength
    {
        endPos = endPos.wrapping_add(1);
        endPos;
        if endPos < stringLength.wrapping_sub(1 as libc::c_int as uint32_t)
            && inComment as libc::c_int == 0 as libc::c_int
        {
            if *stringToUse.offset(endPos as isize) as libc::c_int == '/' as i32
                && *stringToUse
                    .offset(endPos.wrapping_add(1 as libc::c_int as uint32_t) as isize)
                    as libc::c_int == '/' as i32
            {
                inComment = 1 as libc::c_int as uint8_t;
            } else if *stringToUse.offset(endPos as isize) as libc::c_int == '/' as i32
                && *stringToUse
                    .offset(endPos.wrapping_add(1 as libc::c_int as uint32_t) as isize)
                    as libc::c_int == '*' as i32
            {
    ...
    texturesTokenLength = endPos.wrapping_sub(startPos);
    texturesToken = Z_MallocAlign(
        (texturesTokenLength.wrapping_add(1 as libc::c_int as uint32_t) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<libc::c_char>() as libc::c_ulong),
        PU_STATIC as libc::c_int,
        0 as *mut libc::c_void,
        ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ...
    *texturesToken.offset(texturesTokenLength as isize) = '\0' as i32 as libc::c_char;
    return texturesToken;
}
#[no_mangle]
pub unsafe extern "C" fn M_UnGetToken() {
    endPos = oldendPos;
}
static mut tokenizerInput: *const libc::c_char = 0 as *const libc::c_char;
static mut tokenCapacity: [uint32_t; 2] = [0 as libc::c_int as uint32_t, 0];
static mut tokenizerToken: [*mut libc::c_char; 2] = [
    0 as *const libc::c_char as *mut libc::c_char,
    0 as *const libc::c_char as *mut libc::c_char,
];
static mut tokenizerStartPos: uint32_t = 0 as libc::c_int as uint32_t;
static mut tokenizerEndPos: uint32_t = 0 as libc::c_int as uint32_t;
static mut tokenizerInputLength: uint32_t = 0 as libc::c_int as uint32_t;
static mut tokenizerInComment: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub unsafe extern "C" fn M_TokenizerOpen(mut inputString: *const libc::c_char) {
    let mut i: size_t = 0;
    tokenizerInput = inputString;
    i = 0 as libc::c_int as size_t;
    while i < 2 as libc::c_int as size_t {
        tokenCapacity[i as usize] = 1024 as libc::c_int as uint32_t;
        tokenizerToken[i
            as usize] = Z_MallocAlign(
            (tokenCapacity[i as usize] as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<libc::c_char>() as libc::c_ulong),
            PU_STATIC as libc::c_int,
            0 as *mut libc::c_void,
            ::core::mem::size_of::<*mut libc::c_void>() as libc::c_ulong as int32_t,
    ...
    tokenizerInputLength = strlen(tokenizerInput) as uint32_t;
}
#[no_mangle]
pub unsafe extern "C" fn M_TokenizerClose() {
    let mut i: size_t = 0;
    tokenizerInput = 0 as *const libc::c_char;
    i = 0 as libc::c_int as size_t;
    while i < 2 as libc::c_int as size_t {
        Z_Free(tokenizerToken[i as usize] as *mut libc::c_void);
        i = i.wrapping_add(1);
        i;
    }
    tokenizerStartPos = 0 as libc::c_int as uint32_t;
    tokenizerEndPos = 0 as libc::c_int as uint32_t;
    tokenizerInComment = 0 as libc::c_int as uint8_t;
}
unsafe extern "C" fn M_DetectComment(mut pos: *mut uint32_t) {
    if tokenizerInComment != 0 {
        return;
    }
    if *pos >= tokenizerInputLength.wrapping_sub(1 as libc::c_int as uint32_t) {
        return;
    }
    if *tokenizerInput.offset(*pos as isize) as libc::c_int != '/' as i32 {
        return;
    }
    if *tokenizerInput.offset((*pos).wrapping_add(1 as libc::c_int as uint32_t) as isize)
        as libc::c_int == '/' as i32
    {
        tokenizerInComment = 1 as libc::c_int as uint8_t;
    } else if *tokenizerInput
        .offset((*pos).wrapping_add(1 as libc::c_int as uint32_t) as isize)
        as libc::c_int == '*' as i32
    {
        tokenizerInComment = 2 as libc::c_int as uint8_t;
    }
}
unsafe extern "C" fn M_ReadTokenString(mut i: uint32_t) {
    let mut tokenLength: uint32_t = tokenizerEndPos.wrapping_sub(tokenizerStartPos);
    if tokenLength.wrapping_add(1 as libc::c_int as uint32_t) > tokenCapacity[i as usize]
    {
        tokenCapacity[i
            as usize] = tokenLength.wrapping_add(1 as libc::c_int as uint32_t);
        tokenizerToken[i
            as usize] = Z_MallocAlign(
            (tokenCapacity[i as usize] as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<libc::c_char>() as libc::c_ulong),
    ...
    M_Memcpy
        ...
        tokenizerToken[i as usize] as *mut libc::c_void,
        tokenizerInput.offset(tokenizerStartPos as isize) as *const libc::c_void,
        tokenLength as size_t,
    );
    *(tokenizerToken[i as usize])
        .offset(tokenLength as isize) = '\0' as i32 as libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn M_TokenizerRead(mut i: uint32_t) -> *const libc::c_char {
    if tokenizerInput.is_null() {
        return 0 as *const libc::c_char;
    }
    tokenizerStartPos = tokenizerEndPos;
    M_DetectComment(&mut tokenizerStartPos);
    while (*tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
        == ' ' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == '\t' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == '\r' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
        ...
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == '=' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == ';' as i32 || tokenizerInComment as libc::c_int != 0 as libc::c_int)
        && tokenizerStartPos < tokenizerInputLength
    {
        if tokenizerInComment as libc::c_int == 1 as libc::c_int
            && *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
                == '\n' as i32
        {
            tokenizerInComment = 0 as libc::c_int as uint8_t;
        } else if tokenizerInComment as libc::c_int == 2 as libc::c_int
            && tokenizerStartPos
                < tokenizerInputLength.wrapping_sub(1 as libc::c_int as uint32_t)
            && *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
                == '*' as i32
            && *tokenizerInput
                .offset(
                    tokenizerStartPos.wrapping_add(1 as libc::c_int as uint32_t) as isize,
                ) as libc::c_int == '/' as i32
        {
            tokenizerInComment = 0 as libc::c_int as uint8_t;
            tokenizerStartPos = tokenizerStartPos.wrapping_add(1);
            tokenizerStartPos;
        }
        tokenizerStartPos = tokenizerStartPos.wrapping_add(1);
        tokenizerStartPos;
    ...
    if tokenizerStartPos == tokenizerInputLength {
        ...
        return 0 as *const libc::c_char;
    } else if *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
        == ',' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == '{' as i32
        || *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
            == '}' as i32
    {
        tokenizerEndPos = tokenizerStartPos.wrapping_add(1 as libc::c_int as uint32_t);
        *(tokenizerToken[i as usize])
            .offset(
                0 as libc::c_int as isize,
            ) = *tokenizerInput.offset(tokenizerStartPos as isize);
        *(tokenizerToken[i as usize])
            .offset(1 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
        return tokenizerToken[i as usize];
    } else if *tokenizerInput.offset(tokenizerStartPos as isize) as libc::c_int
        == '"' as i32
    {
        tokenizerStartPos = tokenizerStartPos.wrapping_add(1);
        tokenizerEndPos = tokenizerStartPos;
        while *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int
            != '"' as i32 && tokenizerEndPos < tokenizerInputLength
        {
            tokenizerEndPos = tokenizerEndPos.wrapping_add(1);
            tokenizerEndPos;
        }
        M_ReadTokenString(i);
        tokenizerEndPos = tokenizerEndPos.wrapping_add(1);
    ...
    tokenizerEndPos = tokenizerStartPos.wrapping_add(1 as libc::c_int as uint32_t);
    while *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != ' ' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '\t' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '\r' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '\n' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != ',' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '{' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '}' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != '=' as i32
        && *tokenizerInput.offset(tokenizerEndPos as isize) as libc::c_int != ';' as i32
        && tokenizerInComment as libc::c_int == 0 as libc::c_int
        && tokenizerEndPos < tokenizerInputLength
    {
        tokenizerEndPos = tokenizerEndPos.wrapping_add(1);
        tokenizerEndPos;
        M_DetectComment(&mut tokenizerEndPos);
    }
    M_ReadTokenString(i);
    return tokenizerToken[i as usize];
}
#[no_mangle]
pub unsafe extern "C" fn M_TokenizerGetEndPos() -> uint32_t {
    return tokenizerEndPos;
}
#[no_mangle]
pub unsafe extern "C" fn M_TokenizerSetEndPos(mut newPos: uint32_t) {
    tokenizerEndPos = newPos;
}
#[no_mangle]
pub unsafe extern "C" fn M_CountBits(mut num: uint32_t, mut size: uint8_t) -> uint8_t {
    let mut i: uint8_t = 0;
    let mut sum: uint8_t = 0 as libc::c_int as uint8_t;
    i = 0 as libc::c_int as uint8_t;
    while (i as libc::c_int) < size as libc::c_int {
        if num & ((1 as libc::c_int) << i as libc::c_int) as uint32_t != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn GetRevisionString() -> *const libc::c_char {
    static mut rev: [libc::c_char; 9] = [
    ...
    if rev[0 as libc::c_int as usize] != 0 {
        return rev.as_mut_ptr();
    }
    if *comprevision.offset(0 as libc::c_int as isize) as libc::c_int == 'r' as i32 {
        strncpy(rev.as_mut_ptr(), comprevision, 7 as libc::c_int as libc::c_ulong);
    } else {
        snprintf(
            rev.as_mut_ptr(),
    ...
    rev[7 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
    return rev.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn sizeu1(mut num: size_t) -> *mut libc::c_char {
    static mut sizeu1_buf: [libc::c_char; 28] = [0; 28];
    sprintf(sizeu1_buf.as_mut_ptr(), b"%zu\0" as *const u8 as *const libc::c_char, num);
    return sizeu1_buf.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn sizeu2(mut num: size_t) -> *mut libc::c_char {
    static mut sizeu2_buf: [libc::c_char; 28] = [0; 28];
    sprintf(sizeu2_buf.as_mut_ptr(), b"%zu\0" as *const u8 as *const libc::c_char, num);
    return sizeu2_buf.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn sizeu3(mut num: size_t) -> *mut libc::c_char {
    static mut sizeu3_buf: [libc::c_char; 28] = [0; 28];
    sprintf(sizeu3_buf.as_mut_ptr(), b"%zu\0" as *const u8 as *const libc::c_char, num);
    return sizeu3_buf.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn sizeu4(mut num: size_t) -> *mut libc::c_char {
    static mut sizeu4_buf: [libc::c_char; 28] = [0; 28];
    sprintf(sizeu4_buf.as_mut_ptr(), b"%zu\0" as *const u8 as *const libc::c_char, num);
    return sizeu4_buf.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn sizeu5(mut num: size_t) -> *mut libc::c_char {
    static mut sizeu5_buf: [libc::c_char; 28] = [0; 28];
    sprintf(sizeu5_buf.as_mut_ptr(), b"%zu\0" as *const u8 as *const libc::c_char, num);
    return sizeu5_buf.as_mut_ptr();
}
unsafe extern "C" fn cpu_cpy(
...
#[no_mangle]
pub static mut M_Memcpy: Option::<
    unsafe extern "C" fn(
        *mut libc::c_void,
        *const libc::c_void,
        size_t,
...
#[no_mangle]
pub unsafe extern "C" fn M_SetupMemcpy() {
    if R_MMX != 0 {
        M_Memcpy = Some(
            mmx_cpy
                as unsafe extern "C" fn(
...
#[no_mangle]
pub unsafe extern "C" fn M_FileError(mut fp: *mut FILE) -> *const libc::c_char {
    if ferror(fp) != 0 {
        return strerror(*__errno_location())
    } else {
        return b"end-of-file\0" as *const u8 as *const libc::c_char
    };
}
#[no_mangle]
pub unsafe extern "C" fn M_PathParts(mut path: *const libc::c_char) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn M_IsPathAbsolute(mut path: *const libc::c_char) -> boolean {
    return (*path.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn M_MkdirEachUntil(
    mut cpath: *const libc::c_char,
    ...
    if end > 0 as libc::c_int && end <= start {
        return;
    }
    strlcpy(
        path.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn M_MkdirEach(
    mut path: *const libc::c_char,
    mut start: libc::c_int,
    mut mode: libc::c_int,
) {
    M_MkdirEachUntil(path, start, -(1 as libc::c_int), mode);
}
#[no_mangle]
pub unsafe extern "C" fn M_JumpWord(mut line: *const libc::c_char) -> libc::c_int {
    let mut c: libc::c_int = 0;
    c = *line.offset(0 as libc::c_int as isize) as libc::c_int;
    if *(*__ctype_b_loc()).offset(c as isize) as libc::c_int
        & _ISspace as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        return strspn(line, b" \0" as *const u8 as *const libc::c_char) as libc::c_int
        ...
        & _ISpunct as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        ...
        .offset(*line.offset(1 as libc::c_int as isize) as libc::c_int as isize)
...
#[no_mangle]
pub unsafe extern "C" fn M_JumpWordReverse(
    mut line: *const libc::c_char,
    mut offset: libc::c_int,
) -> libc::c_int {
    let mut is: Option::<unsafe extern "C" fn(libc::c_int) -> libc::c_int> = None;
    let mut c: libc::c_int = 0;
    offset -= 1;
    c = *line.offset(offset as isize) as libc::c_int;
    if *(*__ctype_b_loc()).offset(c as isize) as libc::c_int
        & _ISspace as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        is = Some(isspace as unsafe extern "C" fn(libc::c_int) -> libc::c_int);
    } else if *(*__ctype_b_loc()).offset(c as isize) as libc::c_int
        & _ISpunct as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        is = Some(ispunct as unsafe extern "C" fn(libc::c_int) -> libc::c_int);
    } else {
        is = Some(isalnum as unsafe extern "C" fn(libc::c_int) -> libc::c_int);
    }
    c = (Some(is.expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(*line.offset(offset as isize) as libc::c_int);
    while offset > 0 as libc::c_int
        && (Some(is.expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(*line.offset((offset - 1 as libc::c_int) as isize) as libc::c_int) == c
    {
        offset -= 1;
        offset;
    }
...
#[no_mangle]
pub unsafe extern "C" fn M_Ftrim(mut f: libc::c_double) -> *const libc::c_char {
    static mut dig: [libc::c_char; 9] = [0; 9];
    ...
    i = (strlen(dig.as_mut_ptr())).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        as libc::c_int;
    while dig[i as usize] as libc::c_int == '0' as i32 {
        i -= 1;
        i;
    }
    if dig[i as usize] as libc::c_int == '.' as i32 {
        return b"\0" as *const u8 as *const libc::c_char
    } else {
        dig[(i + 1 as libc::c_int) as usize] = '\0' as i32 as libc::c_char;
        return &mut *dig.as_mut_ptr().offset(1 as libc::c_int as isize)
            as *mut libc::c_char;
    };
}
#[no_mangle]
pub unsafe extern "C" fn M_IsStringEmpty(mut s: *const libc::c_char) -> boolean {
    let mut ch: *const libc::c_char = s;
    if s.is_null() || *s.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32
    {
        return true_0 as libc::c_int;
    }
    while !(*ch == 0) {
